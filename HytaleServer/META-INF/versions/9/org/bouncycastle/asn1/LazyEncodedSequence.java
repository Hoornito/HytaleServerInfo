...
class LazyEncodedSequence extends ASN1Sequence {
  ...
  public Enumeration getObjects() {
    ...
    return (Enumeration)((null != arrayOfByte) ? new LazyConstructionEnumeration(arrayOfByte) : super.getObjects());
  }
  ...
  private synchronized void force() {
    if (null != this.encoded) {
      ...
      try {
        ...
        throw new ASN1ParsingException("malformed ASN.1: " + String.valueOf(iOException), iOException);
      } 
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\LazyEncodedSequence.class
