...
public abstract class ASN1BMPString extends ASN1Primitive implements ASN1String {
  ...
  public static org.bouncycastle.asn1.ASN1BMPString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1BMPString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1BMPString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1BMPString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  static org.bouncycastle.asn1.ASN1BMPString createPrimitive(byte[] paramArrayOfbyte) {
    return (org.bouncycastle.asn1.ASN1BMPString)new DERBMPString(paramArrayOfbyte);
  }
  
  static org.bouncycastle.asn1.ASN1BMPString createPrimitive(char[] paramArrayOfchar) {
    return (org.bouncycastle.asn1.ASN1BMPString)new DERBMPString(paramArrayOfchar);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1BMPString.class
