...
public abstract class ASN1VisibleString extends ASN1Primitive implements ASN1String {
  ...
  public static org.bouncycastle.asn1.ASN1VisibleString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1VisibleString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1VisibleString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1VisibleString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1VisibleString.class
