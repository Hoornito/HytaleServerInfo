  ...
  ASN1BitString buildConstructedBitString(ASN1EncodableVector paramASN1EncodableVector) throws IOException {
    ...
    for (byte b = 0; b != arrayOfASN1BitString.length; b++) {
      ...
      if (aSN1Encodable instanceof ASN1BitString) {
        ...
        throw new ASN1Exception("unknown object encountered in constructed BIT STRING: " + String.valueOf(aSN1Encodable.getClass()));
      } 
    } 
  ...
  ASN1OctetString buildConstructedOctetString(ASN1EncodableVector paramASN1EncodableVector) throws IOException {
    ...
    for (byte b = 0; b != arrayOfASN1OctetString.length; b++) {
      ...
      if (aSN1Encodable instanceof ASN1OctetString) {
        ...
        throw new ASN1Exception("unknown object encountered in constructed OCTET STRING: " + String.valueOf(aSN1Encodable.getClass()));
      } 
    } 
  ...
  static ASN1Primitive createPrimitiveDERObject(int paramInt, DefiniteLengthInputStream paramDefiniteLengthInputStream, byte[][] paramArrayOfbyte) throws IOException {
    try {
      switch (paramInt) {
        ...
        case 5:
          ASN1Null.checkContentsLength(paramDefiniteLengthInputStream.getRemaining());
          return (ASN1Primitive)ASN1Null.createPrimitive();
        case 18:
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1InputStream.class
