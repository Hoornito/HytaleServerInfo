...
public class ASN1ObjectIdentifier extends ASN1Primitive {
  ...
  public static org.bouncycastle.asn1.ASN1ObjectIdentifier getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (org.bouncycastle.asn1.ASN1ObjectIdentifier)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1ObjectIdentifier getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1ObjectIdentifier)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1ObjectIdentifier tryFromID(String paramString) {
    if (paramString == null)
    ...
    if (paramString.length() <= 16385 && isValidIdentifier(paramString)) {
      ...
      if (arrayOfByte.length <= 4096)
        return new org.bouncycastle.asn1.ASN1ObjectIdentifier(arrayOfByte, paramString); 
    } 
    return null;
  }
  ...
  public org.bouncycastle.asn1.ASN1ObjectIdentifier branch(String paramString) {
    ...
    return new org.bouncycastle.asn1.ASN1ObjectIdentifier(arrayOfByte, str2);
  }
  ...
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    ...
    if (!(paramASN1Primitive instanceof org.bouncycastle.asn1.ASN1ObjectIdentifier))
      return false; 
    org.bouncycastle.asn1.ASN1ObjectIdentifier aSN1ObjectIdentifier = (org.bouncycastle.asn1.ASN1ObjectIdentifier)paramASN1Primitive;
  ...
  static org.bouncycastle.asn1.ASN1ObjectIdentifier createPrimitive(byte[] paramArrayOfbyte, boolean paramBoolean) {
    ...
    return new org.bouncycastle.asn1.ASN1ObjectIdentifier(paramBoolean ? Arrays.clone(paramArrayOfbyte) : paramArrayOfbyte, null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1ObjectIdentifier.class
