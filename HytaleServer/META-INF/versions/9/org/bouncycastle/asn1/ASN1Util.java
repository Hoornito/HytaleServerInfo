...
public abstract class ASN1Util {
  ...
  public static Object getInstanceChoiceBaseObject(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean, String paramString) {
    if (!paramBoolean) {
      String str = "Implicit tagging cannot be used with untagged choice type " + paramString + " (X.680 30.6, 30.8).";
      throw new IllegalArgumentException(str);
    } 
    if (paramASN1TaggedObject == null)
      throw new NullPointerException("'taggedObject' cannot be null"); 
    return getExplicitContextBaseObject(paramASN1TaggedObject);
  }
  
  public static Object getTaggedChoiceBaseObject(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean, String paramString) {
    if (!paramBoolean) {
      String str = "Implicit tagging cannot be used with untagged choice type " + paramString + " (X.680 30.6, 30.8).";
      throw new IllegalArgumentException(str);
    } 
  ...
  public static ASN1Object getExplicitBaseObject(ASN1TaggedObject paramASN1TaggedObject, int paramInt) {
    return checkTagClass(paramASN1TaggedObject, paramInt).getExplicitBaseObject();
  }
  ...
  public static ASN1Object getExplicitContextBaseObject(ASN1TaggedObject paramASN1TaggedObject) {
    return getExplicitBaseObject(paramASN1TaggedObject, 128);
  }
  ...
  public static ASN1Object tryGetExplicitBaseObject(ASN1TaggedObject paramASN1TaggedObject, int paramInt) {
    return !paramASN1TaggedObject.hasTagClass(paramInt) ? null : paramASN1TaggedObject.getExplicitBaseObject();
  }
  ...
  public static ASN1Object tryGetExplicitContextBaseObject(ASN1TaggedObject paramASN1TaggedObject) {
    return tryGetExplicitBaseObject(paramASN1TaggedObject, 128);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1Util.class
