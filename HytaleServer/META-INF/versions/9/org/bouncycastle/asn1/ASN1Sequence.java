...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
  ...
  public static org.bouncycastle.asn1.ASN1Sequence getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1Sequence)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1Sequence getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1Sequence)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  protected ASN1Sequence(ASN1Encodable paramASN1Encodable1, ASN1Encodable paramASN1Encodable2) {
    if (null == paramASN1Encodable1)
      throw new NullPointerException("'element1' cannot be null"); 
    if (null == paramASN1Encodable2)
      throw new NullPointerException("'element2' cannot be null"); 
    this.elements = new ASN1Encodable[] { paramASN1Encodable1, paramASN1Encodable2 };
  }
  ...
  ASN1Primitive toDERObject() {
    return (ASN1Primitive)new DERSequence(this.elements, false);
  }
  
  ASN1Primitive toDLObject() {
    return (ASN1Primitive)new DLSequence(this.elements, false);
  }
  ...
  public Iterator<ASN1Encodable> iterator() {
    return (Iterator<ASN1Encodable>)new Arrays.Iterator((Object[])this.elements);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1Sequence.class
