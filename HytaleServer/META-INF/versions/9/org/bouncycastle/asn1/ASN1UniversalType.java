...
abstract class ASN1UniversalType extends ASN1Type {
  ...
  final ASN1Primitive getContextTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return checkedCast(ASN1Util.checkContextTagClass(paramASN1TaggedObject).getBaseUniversal(paramBoolean, this));
  }
  
  final ASN1Primitive getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1UniversalType.class
