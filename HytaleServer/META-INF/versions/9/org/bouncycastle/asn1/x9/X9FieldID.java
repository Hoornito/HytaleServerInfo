...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
  ...
  public static org.bouncycastle.asn1.x9.X9FieldID getInstance(Object paramObject) {
    return (paramObject instanceof org.bouncycastle.asn1.x9.X9FieldID) ? (org.bouncycastle.asn1.x9.X9FieldID)paramObject : ((paramObject != null) ? new org.bouncycastle.asn1.x9.X9FieldID(ASN1Sequence.getInstance(paramObject)) : null);
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new DERSequence((ASN1Encodable)this.id, (ASN1Encodable)this.parameters);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\x9\X9FieldID.class
