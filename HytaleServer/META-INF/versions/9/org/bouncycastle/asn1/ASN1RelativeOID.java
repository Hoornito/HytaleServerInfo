...
public class ASN1RelativeOID extends ASN1Primitive {
  ...
  private static final ConcurrentMap<ASN1ObjectIdentifier.OidHandle, org.bouncycastle.asn1.ASN1RelativeOID> pool = new ConcurrentHashMap<>();
  ...
  public static org.bouncycastle.asn1.ASN1RelativeOID getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1RelativeOID)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1RelativeOID getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1RelativeOID)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1RelativeOID tryFromID(String paramString) {
    if (paramString == null)
    ...
    if (paramString.length() <= 16383 && isValidIdentifier(paramString, 0)) {
      ...
      if (arrayOfByte.length <= 4096)
        return new org.bouncycastle.asn1.ASN1RelativeOID(arrayOfByte, paramString); 
    } 
    return null;
  }
  ...
  public org.bouncycastle.asn1.ASN1RelativeOID branch(String paramString) {
    ...
    return new org.bouncycastle.asn1.ASN1RelativeOID(arrayOfByte, str2);
  }
  ...
  static org.bouncycastle.asn1.ASN1RelativeOID createPrimitive(byte[] paramArrayOfbyte, boolean paramBoolean) {
    ...
    org.bouncycastle.asn1.ASN1RelativeOID aSN1RelativeOID = pool.get(oidHandle);
    ...
    return new org.bouncycastle.asn1.ASN1RelativeOID(paramBoolean ? Arrays.clone(paramArrayOfbyte) : paramArrayOfbyte, null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1RelativeOID.class
