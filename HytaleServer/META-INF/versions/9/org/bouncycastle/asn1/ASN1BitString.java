...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String, ASN1BitStringParser {
  static final ASN1UniversalType TYPE = (ASN1UniversalType)new Object(org.bouncycastle.asn1.ASN1BitString.class, 3);
  ...
  public static org.bouncycastle.asn1.ASN1BitString getInstance(Object paramObject) {
    if (paramObject == null || paramObject instanceof org.bouncycastle.asn1.ASN1BitString)
      return (org.bouncycastle.asn1.ASN1BitString)paramObject; 
    if (paramObject instanceof ASN1Encodable) {
      ...
      try {
        return (org.bouncycastle.asn1.ASN1BitString)TYPE.fromByteArray((byte[])paramObject);
  ...
  public static org.bouncycastle.asn1.ASN1BitString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1BitString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1BitString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1BitString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public String getString() {
    ...
    StringBuilder stringBuilder = new StringBuilder(1 + arrayOfByte.length * 2);
    stringBuilder.append('#');
    for (byte b = 0; b != arrayOfByte.length; b++) {
      byte b1 = arrayOfByte[b];
      stringBuilder.append(table[b1 >>> 4 & 0xF]);
      stringBuilder.append(table[b1 & 0xF]);
    } 
  ...
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    if (!(paramASN1Primitive instanceof org.bouncycastle.asn1.ASN1BitString))
      return false; 
    org.bouncycastle.asn1.ASN1BitString aSN1BitString = (org.bouncycastle.asn1.ASN1BitString)paramASN1Primitive;
  ...
  ASN1Primitive toDERObject() {
    return (ASN1Primitive)new DERBitString(this.contents, false);
  }
  
  ASN1Primitive toDLObject() {
    return (ASN1Primitive)new DLBitString(this.contents, false);
  }
  
  static org.bouncycastle.asn1.ASN1BitString createPrimitive(byte[] paramArrayOfbyte) {
    ...
    if (j > 0) {
      ...
      if (b != (byte)(b & 255 << j))
        return (org.bouncycastle.asn1.ASN1BitString)new DLBitString(paramArrayOfbyte, false); 
    } 
    return (org.bouncycastle.asn1.ASN1BitString)new DERBitString(paramArrayOfbyte, false);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1BitString.class
