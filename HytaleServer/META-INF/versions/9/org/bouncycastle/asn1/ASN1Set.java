...
public abstract class ASN1Set extends ASN1Primitive implements Iterable<ASN1Encodable> {
  ...
  public static org.bouncycastle.asn1.ASN1Set getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1Set)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1Set getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1Set)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  protected ASN1Set(ASN1EncodableVector paramASN1EncodableVector, boolean paramBoolean) {
    ...
    this.sortedElements = (paramBoolean || arrayOfASN1Encodable.length < 2) ? this.elements : null;
  }
  ...
  protected ASN1Set(ASN1Encodable[] paramArrayOfASN1Encodable, boolean paramBoolean) {
    ...
    if (paramBoolean && arrayOfASN1Encodable.length >= 2)
      sort(arrayOfASN1Encodable); 
    this.elements = arrayOfASN1Encodable;
    this.sortedElements = (paramBoolean || arrayOfASN1Encodable.length < 2) ? paramArrayOfASN1Encodable : null;
  }
  
  ASN1Set(boolean paramBoolean, ASN1Encodable[] paramArrayOfASN1Encodable) {
    this.elements = paramArrayOfASN1Encodable;
    this.sortedElements = (paramBoolean || paramArrayOfASN1Encodable.length < 2) ? paramArrayOfASN1Encodable : null;
  }
  
  ASN1Set(ASN1Encodable[] paramArrayOfASN1Encodable1, ASN1Encodable[] paramArrayOfASN1Encodable2) {
    this.elements = paramArrayOfASN1Encodable1;
    this.sortedElements = paramArrayOfASN1Encodable2;
  }
  ...
  ASN1Primitive toDERObject() {
    ...
    return (ASN1Primitive)new DERSet(true, this.sortedElements);
  }
  
  ASN1Primitive toDLObject() {
    return (ASN1Primitive)new DLSet(this.elements, this.sortedElements);
  }
  ...
  public String toString() {
    ...
    byte b = 0;
    while (true) {
      stringBuilder.append(this.elements[b]);
      if (++b >= i) {
        stringBuilder.append(']');
  ...
  private static boolean lessThanOrEqual(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    int i = paramArrayOfbyte1[0] & 0xDF;
    int j = paramArrayOfbyte2[0] & 0xDF;
    if (i != j)
      return (i < j); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1Set.class
