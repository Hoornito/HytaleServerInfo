...
public class ASN1UTCTime extends ASN1Primitive {
  ...
  public static org.bouncycastle.asn1.ASN1UTCTime getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UTCTime)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1UTCTime getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UTCTime)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public String getTime() {
    ...
    if (i == str1.length() - 3)
      str2 = str2 + "00"; 
    return (i == 10) ? (str2.substring(0, 10) + "00GMT" + str2.substring(0, 10) + ":" + str2.substring(10, 13)) : (str2.substring(0, 12) + "GMT" + str2.substring(0, 12) + ":" + str2.substring(12, 15));
  }
  ...
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    return !(paramASN1Primitive instanceof org.bouncycastle.asn1.ASN1UTCTime) ? false : Arrays.areEqual(this.contents, ((org.bouncycastle.asn1.ASN1UTCTime)paramASN1Primitive).contents);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1UTCTime.class
