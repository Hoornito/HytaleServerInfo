...
public abstract class ASN1IA5String extends ASN1Primitive implements ASN1String {
  ...
  public static org.bouncycastle.asn1.ASN1IA5String getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1IA5String)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1IA5String getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1IA5String)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  static org.bouncycastle.asn1.ASN1IA5String createPrimitive(byte[] paramArrayOfbyte) {
    return (org.bouncycastle.asn1.ASN1IA5String)new DERIA5String(paramArrayOfbyte, false);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1IA5String.class
