  ...
  private byte[] getDERTime() {
    if (this.contents[this.contents.length - 1] == 90) {
      ...
      if (hasFractionalSeconds()) {
        int i;
        for (i = this.contents.length - 2; i > 0 && this.contents[i] == 48; i--);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\DERGeneralizedTime.class
