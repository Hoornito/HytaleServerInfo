...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
  ...
  public static org.bouncycastle.asn1.ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable) {
    if (paramASN1Encodable == null)
      throw new NullPointerException("'element' cannot be null"); 
    return (paramASN1Encodable instanceof org.bouncycastle.asn1.ASN1TaggedObject) ? (org.bouncycastle.asn1.ASN1TaggedObject)paramASN1Encodable : null;
  }
  
  public static org.bouncycastle.asn1.ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable, int paramInt) {
    org.bouncycastle.asn1.ASN1TaggedObject aSN1TaggedObject = getOptional(paramASN1Encodable);
    return (aSN1TaggedObject != null && aSN1TaggedObject.hasTagClass(paramInt)) ? aSN1TaggedObject : null;
  }
  
  public static org.bouncycastle.asn1.ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable, int paramInt1, int paramInt2) {
    org.bouncycastle.asn1.ASN1TaggedObject aSN1TaggedObject = getOptional(paramASN1Encodable);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1TaggedObject.class
