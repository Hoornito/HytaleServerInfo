...
public class ASN1StreamParser {
  ...
  ASN1Encodable implParseObject(int paramInt) throws IOException {
    ...
    if (j < 0) {
      ...
      org.bouncycastle.asn1.ASN1StreamParser aSN1StreamParser1 = new org.bouncycastle.asn1.ASN1StreamParser((InputStream)indefiniteLengthInputStream, this._limit, this.tmpBuffers);
      int m = paramInt & 0xC0;
      return (ASN1Encodable)((0 != m) ? new BERTaggedObjectParser(m, i, aSN1StreamParser1) : aSN1StreamParser1.parseImplicitConstructedIL(i));
    } 
    ...
    org.bouncycastle.asn1.ASN1StreamParser aSN1StreamParser = new org.bouncycastle.asn1.ASN1StreamParser((InputStream)definiteLengthInputStream, definiteLengthInputStream.getLimit(), this.tmpBuffers);
    int k = paramInt & 0xC0;
    if (0 != k) {
      boolean bool = ((paramInt & 0x20) != 0) ? true : false;
      return (ASN1Encodable)new DLTaggedObjectParser(k, i, bool, aSN1StreamParser);
    } 
  ...
  ASN1Encodable parseImplicitConstructedDL(int paramInt) throws IOException {
    switch (paramInt) {
      case 3:
        return (ASN1Encodable)new BERBitStringParser(this);
      case 8:
        return (ASN1Encodable)new DERExternalParser(this);
      case 4:
        return (ASN1Encodable)new BEROctetStringParser(this);
      case 17:
        return (ASN1Encodable)new DLSetParser(this);
      case 16:
        return (ASN1Encodable)new DLSequenceParser(this);
    } 
  ...
  ASN1Encodable parseImplicitConstructedIL(int paramInt) throws IOException {
    switch (paramInt) {
      ...
      case 8:
        return (ASN1Encodable)new DERExternalParser(this);
      case 16:
        return (ASN1Encodable)new BERSequenceParser(this);
      case 17:
        return (ASN1Encodable)new BERSetParser(this);
    } 
  ...
  ASN1Encodable parseImplicitPrimitive(int paramInt, DefiniteLengthInputStream paramDefiniteLengthInputStream) throws IOException {
    switch (paramInt) {
      case 3:
        return (ASN1Encodable)new DLBitStringParser(paramDefiniteLengthInputStream);
      case 8:
        throw new ASN1Exception("externals must use constructed encoding (see X.690 8.18)");
      case 4:
        return (ASN1Encodable)new DEROctetStringParser(paramDefiniteLengthInputStream);
      case 17:
    ...
    try {
      return (ASN1Encodable)ASN1InputStream.createPrimitiveDERObject(paramInt, paramDefiniteLengthInputStream, this.tmpBuffers);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1StreamParser.class
