...
public abstract class ASN1OctetString extends ASN1Primitive implements ASN1OctetStringParser {
  ...
  public static org.bouncycastle.asn1.ASN1OctetString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1OctetString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1OctetString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1OctetString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  ASN1Primitive toDERObject() {
    return (ASN1Primitive)new DEROctetString(this.string);
  }
  ...
  static org.bouncycastle.asn1.ASN1OctetString createPrimitive(byte[] paramArrayOfbyte) {
    return (org.bouncycastle.asn1.ASN1OctetString)new DEROctetString(paramArrayOfbyte);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1OctetString.class
