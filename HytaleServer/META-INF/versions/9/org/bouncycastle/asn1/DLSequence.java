...
public class DLSequence extends ASN1Sequence {
  ...
  public DLSequence(ASN1Encodable paramASN1Encodable1, ASN1Encodable paramASN1Encodable2) {
  ...
  ASN1BitString toASN1BitString() {
    return (ASN1BitString)new DLBitString(BERBitString.flattenBitStrings(getConstructedBitStrings()), false);
  }
  
  ASN1External toASN1External() {
    return (ASN1External)new DLExternal(this);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\DLSequence.class
