...
public class SubjectPublicKeyInfo extends ASN1Object {
  ...
  public static org.bouncycastle.asn1.x509.SubjectPublicKeyInfo getInstance(Object paramObject) {
    return (paramObject instanceof org.bouncycastle.asn1.x509.SubjectPublicKeyInfo) ? (org.bouncycastle.asn1.x509.SubjectPublicKeyInfo)paramObject : ((paramObject != null) ? new org.bouncycastle.asn1.x509.SubjectPublicKeyInfo(ASN1Sequence.getInstance(paramObject)) : null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\x509\SubjectPublicKeyInfo.class
