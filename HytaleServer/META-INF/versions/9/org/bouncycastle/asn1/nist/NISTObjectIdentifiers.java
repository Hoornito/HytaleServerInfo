...
public interface NISTObjectIdentifiers {
  ...
  public static final ASN1ObjectIdentifier id_Kmac128 = hashAlgs.branch("21");
  
  public static final ASN1ObjectIdentifier id_Kmac256 = hashAlgs.branch("22");
  ...
  public static final ASN1ObjectIdentifier id_ml_dsa_44 = sigAlgs.branch("17");
  
  public static final ASN1ObjectIdentifier id_ml_dsa_65 = sigAlgs.branch("18");
  
  public static final ASN1ObjectIdentifier id_ml_dsa_87 = sigAlgs.branch("19");
  
  public static final ASN1ObjectIdentifier id_hash_ml_dsa_44_with_sha512 = sigAlgs.branch("32");
  
  public static final ASN1ObjectIdentifier id_hash_ml_dsa_65_with_sha512 = sigAlgs.branch("33");
  
  public static final ASN1ObjectIdentifier id_hash_ml_dsa_87_with_sha512 = sigAlgs.branch("34");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_128s = sigAlgs.branch("20");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_128f = sigAlgs.branch("21");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_192s = sigAlgs.branch("22");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_192f = sigAlgs.branch("23");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_256s = sigAlgs.branch("24");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_sha2_256f = sigAlgs.branch("25");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_128s = sigAlgs.branch("26");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_128f = sigAlgs.branch("27");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_192s = sigAlgs.branch("28");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_192f = sigAlgs.branch("29");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_256s = sigAlgs.branch("30");
  
  public static final ASN1ObjectIdentifier id_slh_dsa_shake_256f = sigAlgs.branch("31");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_128s_with_sha256 = sigAlgs.branch("35");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_128f_with_sha256 = sigAlgs.branch("36");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_192s_with_sha512 = sigAlgs.branch("37");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_192f_with_sha512 = sigAlgs.branch("38");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_256s_with_sha512 = sigAlgs.branch("39");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_sha2_256f_with_sha512 = sigAlgs.branch("40");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_128s_with_shake128 = sigAlgs.branch("41");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_128f_with_shake128 = sigAlgs.branch("42");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_192s_with_shake256 = sigAlgs.branch("43");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_192f_with_shake256 = sigAlgs.branch("44");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_256s_with_shake256 = sigAlgs.branch("45");
  
  public static final ASN1ObjectIdentifier id_hash_slh_dsa_shake_256f_with_shake256 = sigAlgs.branch("46");
  
  public static final ASN1ObjectIdentifier kems = nistAlgorithm.branch("4");
  
  public static final ASN1ObjectIdentifier id_alg_ml_kem_512 = kems.branch("1");
  
  public static final ASN1ObjectIdentifier id_alg_ml_kem_768 = kems.branch("2");
  
  public static final ASN1ObjectIdentifier id_alg_ml_kem_1024 = kems.branch("3");
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\nist\NISTObjectIdentifiers.class
