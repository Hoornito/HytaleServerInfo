...
public interface PKCSObjectIdentifiers {
  ...
  public static final ASN1ObjectIdentifier id_ct = id_smime.branch("1");
  ...
  public static final ASN1ObjectIdentifier smime_alg = id_smime.branch("3");
  
  @Deprecated
  public static final ASN1ObjectIdentifier id_alg = id_smime.branch("3");
  
  public static final ASN1ObjectIdentifier id_alg_ESDH = smime_alg.branch("5");
  
  public static final ASN1ObjectIdentifier id_alg_CMS3DESwrap = smime_alg.branch("6");
  
  public static final ASN1ObjectIdentifier id_alg_CMSRC2wrap = smime_alg.branch("7");
  
  public static final ASN1ObjectIdentifier id_alg_zlibCompress = smime_alg.branch("8");
  
  public static final ASN1ObjectIdentifier id_alg_PWRI_KEK = smime_alg.branch("9");
  
  public static final ASN1ObjectIdentifier id_alg_SSDH = smime_alg.branch("10");
  
  public static final ASN1ObjectIdentifier id_rsa_KEM = smime_alg.branch("14");
  
  public static final ASN1ObjectIdentifier id_alg_hss_lms_hashsig = smime_alg.branch("17");
  
  public static final ASN1ObjectIdentifier id_alg_AEADChaCha20Poly1305 = smime_alg.branch("18");
  
  public static final ASN1ObjectIdentifier id_alg_hkdf_with_sha256 = smime_alg.branch("28");
  
  public static final ASN1ObjectIdentifier id_alg_hkdf_with_sha384 = smime_alg.branch("29");
  
  public static final ASN1ObjectIdentifier id_alg_hkdf_with_sha512 = smime_alg.branch("30");
  
  public static final ASN1ObjectIdentifier id_cti = id_smime.branch("6");
  ...
  public static final ASN1ObjectIdentifier id_aa = id_smime.branch("2");
  
  public static final ASN1ObjectIdentifier pkcs_9_at_binarySigningTime = id_aa.branch("46").intern();
  ...
  public static final ASN1ObjectIdentifier id_spq_oid = id_smime.branch("5");
  
  public static final ASN1ObjectIdentifier id_spq_ets_uri = id_spq_oid.branch("1");
  
  public static final ASN1ObjectIdentifier id_spq_ets_unotice = id_spq_oid.branch("2");
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\pkcs\PKCSObjectIdentifiers.class
