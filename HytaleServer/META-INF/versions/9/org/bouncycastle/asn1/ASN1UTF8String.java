...
public abstract class ASN1UTF8String extends ASN1Primitive implements ASN1String {
  ...
  public static org.bouncycastle.asn1.ASN1UTF8String getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UTF8String)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1UTF8String getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UTF8String)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  static org.bouncycastle.asn1.ASN1UTF8String createPrimitive(byte[] paramArrayOfbyte) {
    return (org.bouncycastle.asn1.ASN1UTF8String)new DERUTF8String(paramArrayOfbyte, false);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1UTF8String.class
