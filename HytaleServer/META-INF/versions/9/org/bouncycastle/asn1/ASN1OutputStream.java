...
public class ASN1OutputStream {
  ...
  public static org.bouncycastle.asn1.ASN1OutputStream create(OutputStream paramOutputStream) {
    return new org.bouncycastle.asn1.ASN1OutputStream(paramOutputStream);
  }
  
  public static org.bouncycastle.asn1.ASN1OutputStream create(OutputStream paramOutputStream, String paramString) {
    return (org.bouncycastle.asn1.ASN1OutputStream)(paramString.equals("DER") ? new DEROutputStream(paramOutputStream) : (paramString.equals("DL") ? new DLOutputStream(paramOutputStream) : new org.bouncycastle.asn1.ASN1OutputStream(paramOutputStream)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1OutputStream.class
