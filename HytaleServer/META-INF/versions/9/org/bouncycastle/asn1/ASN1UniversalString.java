...
public abstract class ASN1UniversalString extends ASN1Primitive implements ASN1String {
  ...
  public static org.bouncycastle.asn1.ASN1UniversalString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UniversalString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1UniversalString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1UniversalString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public final String getString() {
    ...
    StringBuilder stringBuilder = new StringBuilder(3 + 2 * (ASN1OutputStream.getLengthOfDL(i) + i));
    stringBuilder.append("#1C");
    encodeHexDL(stringBuilder, i);
    for (byte b = 0; b < i; b++)
      encodeHexByte(stringBuilder, this.contents[b]); 
  ...
  private static void encodeHexByte(StringBuilder paramStringBuilder, int paramInt) {
    paramStringBuilder.append(table[paramInt >>> 4 & 0xF]);
    paramStringBuilder.append(table[paramInt & 0xF]);
  }
  
  private static void encodeHexDL(StringBuilder paramStringBuilder, int paramInt) {
    if (paramInt < 128) {
      encodeHexByte(paramStringBuilder, paramInt);
      return;
    } 
    ...
    while (true) {
      ...
      if (paramInt == 0) {
        ...
        do {
          encodeHexByte(paramStringBuilder, arrayOfByte[b++]);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1UniversalString.class
