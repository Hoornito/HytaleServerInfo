...
public class ASN1GeneralizedTime extends ASN1Primitive {
  static final ASN1UniversalType TYPE = (ASN1UniversalType)new Object(org.bouncycastle.asn1.ASN1GeneralizedTime.class, 24);
  
  final byte[] contents;
  
  public static org.bouncycastle.asn1.ASN1GeneralizedTime getInstance(Object paramObject) {
    if (paramObject == null || paramObject instanceof org.bouncycastle.asn1.ASN1GeneralizedTime)
      return (org.bouncycastle.asn1.ASN1GeneralizedTime)paramObject; 
    ...
    if (paramObject instanceof byte[])
      try {
        return (org.bouncycastle.asn1.ASN1GeneralizedTime)TYPE.fromByteArray((byte[])paramObject);
  ...
  public static org.bouncycastle.asn1.ASN1GeneralizedTime getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1GeneralizedTime)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static org.bouncycastle.asn1.ASN1GeneralizedTime getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (org.bouncycastle.asn1.ASN1GeneralizedTime)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public String getTime() {
    ...
    c = str.charAt(i);
    if (c == '-' || c == '+')
      return str.substring(0, i) + "GMT" + str.substring(0, i) + ":" + str.substring(i, i + 3); 
    i = str.length() - 3;
    c = str.charAt(i);
    return (c == '-' || c == '+') ? (str.substring(0, i) + "GMT" + str.substring(0, i) + ":00") : (str + str);
  }
  ...
  private String calculateGMTOffset(String paramString) {
    ...
    try {
      if (timeZone.useDaylightTime()) {
        ...
        if (timeZone.inDaylightTime(simpleDateFormat.parse(paramString + "GMT" + paramString + str + ":" + convert(j))))
          j += str.equals("+") ? 1 : -1; 
      } 
    } catch (ParseException parseException) {}
  ...
  private String pruneFractionalSeconds(String paramString) {
    ...
    if (b - 1 > 3) {
      str = str.substring(0, 4) + str.substring(0, 4);
      paramString = paramString.substring(0, 14) + paramString.substring(0, 14);
    } else if (b - 1 == 1) {
      str = str.substring(0, b) + "00" + str.substring(0, b);
      paramString = paramString.substring(0, 14) + paramString.substring(0, 14);
    } else if (b - 1 == 2) {
      str = str.substring(0, b) + "0" + str.substring(0, b);
      paramString = paramString.substring(0, 14) + paramString.substring(0, 14);
    } 
    return paramString;
  }
  ...
  ASN1Primitive toDERObject() {
    return (ASN1Primitive)new DERGeneralizedTime(this.contents);
  }
  
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    return !(paramASN1Primitive instanceof org.bouncycastle.asn1.ASN1GeneralizedTime) ? false : Arrays.areEqual(this.contents, ((org.bouncycastle.asn1.ASN1GeneralizedTime)paramASN1Primitive).contents);
  }
  ...
  static org.bouncycastle.asn1.ASN1GeneralizedTime createPrimitive(byte[] paramArrayOfbyte) {
    return new org.bouncycastle.asn1.ASN1GeneralizedTime(paramArrayOfbyte);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\asn1\ASN1GeneralizedTime.class
