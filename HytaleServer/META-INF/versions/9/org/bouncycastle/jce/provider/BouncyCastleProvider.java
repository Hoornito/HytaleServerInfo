...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
  ...
  private static final String[] SYMMETRIC_GENERIC = new String[] { "PBEPBKDF1", "PBEPBKDF2", "PBEPKCS12", "TLSKDF", "SCRYPT", "HKDF" };
  ...
  private static final String[] ASYMMETRIC_GENERIC = new String[] { "X509", "IES", "COMPOSITE", "EXTERNAL", "CompositeSignatures", "NoSig" };
  
  private static final String[] ASYMMETRIC_CIPHERS = new String[] { 
      "DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal", "DSTU4145", "GM", "EdEC", 
      "LMS", "SPHINCSPlus", "Dilithium", "Falcon", "NTRU", "CONTEXT", "SLHDSA", "MLDSA", "MLKEM" };
  ...
  private void setup() {
    ...
    loadAlgorithms("org.bouncycastle.jcajce.provider.kdf.", KDFS);
    loadPQCKeys();
  ...
  private void loadServiceClass(String paramString1, String paramString2) {
    ...
    if (clazz != null)
      try {
        ...
        throw new InternalError("cannot create instance of " + paramString1 + paramString2 + "$Mappings : " + String.valueOf(exception));
      }  
  }
  ...
  private void loadPQCKeys() {
    ...
    addKeyInfoConverter(NISTObjectIdentifiers.id_alg_ml_kem_512, (AsymmetricKeyInfoConverter)new MLKEMKeyFactorySpi());
    addKeyInfoConverter(NISTObjectIdentifiers.id_alg_ml_kem_768, (AsymmetricKeyInfoConverter)new MLKEMKeyFactorySpi());
    addKeyInfoConverter(NISTObjectIdentifiers.id_alg_ml_kem_1024, (AsymmetricKeyInfoConverter)new MLKEMKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.old_falcon_512, (AsymmetricKeyInfoConverter)new FalconKeyFactorySpi(BCObjectIdentifiers.old_falcon_512));
    addKeyInfoConverter(BCObjectIdentifiers.old_falcon_1024, (AsymmetricKeyInfoConverter)new FalconKeyFactorySpi(BCObjectIdentifiers.old_falcon_1024));
    addKeyInfoConverter(BCObjectIdentifiers.falcon_512, (AsymmetricKeyInfoConverter)new FalconKeyFactorySpi(BCObjectIdentifiers.falcon_512));
    addKeyInfoConverter(BCObjectIdentifiers.falcon_1024, (AsymmetricKeyInfoConverter)new FalconKeyFactorySpi(BCObjectIdentifiers.falcon_1024));
    ...
    addKeyInfoConverter(BCObjectIdentifiers.mayo1, (AsymmetricKeyInfoConverter)new MayoKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.mayo2, (AsymmetricKeyInfoConverter)new MayoKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.mayo3, (AsymmetricKeyInfoConverter)new MayoKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.mayo5, (AsymmetricKeyInfoConverter)new MayoKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_4_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_4_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_4_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_4_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_5_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_5_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_5_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_24_5_5_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_25_8_3_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_25_8_3_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_25_8_3_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_25_8_3_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_8_4_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_8_4_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_8_4_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_8_4_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_17_2_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_17_2_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_17_2_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_37_17_2_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_49_11_3_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_49_11_3_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_49_11_3_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_49_11_3_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_56_25_2_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_56_25_2_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_56_25_2_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_56_25_2_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_60_10_4_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_60_10_4_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_60_10_4_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_60_10_4_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_66_15_3_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_66_15_3_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_66_15_3_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_66_15_3_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_75_33_2_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_75_33_2_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_75_33_2_shake_ssk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
    addKeyInfoConverter(BCObjectIdentifiers.snova_75_33_2_shake_esk, (AsymmetricKeyInfoConverter)new SnovaKeyFactorySpi());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\jce\provider\BouncyCastleProvider.class
