...
public class Fingerprint {
  ...
  public String toString() {
    ...
    for (byte b = 0; b != this.fingerprint.length; b++) {
      ...
      stringBuilder.append(encodingTable[this.fingerprint[b] >>> 4 & 0xF]);
      stringBuilder.append(encodingTable[this.fingerprint[b] & 0xF]);
    } 
    return stringBuilder.toString();
  }
  
  public boolean equals(Object paramObject) {
    return (paramObject == this) ? true : ((paramObject instanceof org.bouncycastle.util.Fingerprint) ? Arrays.areEqual(((org.bouncycastle.util.Fingerprint)paramObject).fingerprint, this.fingerprint) : false);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastl\\util\Fingerprint.class
