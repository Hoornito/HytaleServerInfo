...
public final class Arrays {
  ...
  public static boolean constantTimeAreEqual(int paramInt1, long[] paramArrayOflong1, int paramInt2, long[] paramArrayOflong2, int paramInt3) {
    if (null == paramArrayOflong1)
      throw new NullPointerException("'a' cannot be null"); 
    if (null == paramArrayOflong2)
      throw new NullPointerException("'b' cannot be null"); 
    if (paramInt1 < 0)
      throw new IllegalArgumentException("'len' cannot be negative"); 
    if (paramInt2 > paramArrayOflong1.length - paramInt1)
      throw new IndexOutOfBoundsException("'aOff' value invalid for specified length"); 
    if (paramInt3 > paramArrayOflong2.length - paramInt1)
      throw new IndexOutOfBoundsException("'bOff' value invalid for specified length"); 
    long l = 0L;
    for (byte b = 0; b < paramInt1; b++)
      l |= paramArrayOflong1[paramInt2 + b] ^ paramArrayOflong2[paramInt3 + b]; 
    return (0L == l);
  }
  
  public static boolean constantTimeAreEqual(char[] paramArrayOfchar1, char[] paramArrayOfchar2) {
    ...
    int j = paramArrayOfchar1.length ^ paramArrayOfchar2.length;
    int k;
    for (k = 0; k != i; k++)
      j |= paramArrayOfchar1[k] ^ paramArrayOfchar2[k]; 
    for (k = i; k < paramArrayOfchar2.length; k++)
      j |= (byte)paramArrayOfchar2[k] ^ (byte)(paramArrayOfchar2[k] ^ 0xFFFFFFFF); 
    return (j == 0);
  }
  
  public static boolean constantTimeAreEqual(long[] paramArrayOflong1, long[] paramArrayOflong2) {
    if (paramArrayOflong1 == null || paramArrayOflong2 == null)
      return false; 
    if (paramArrayOflong1 == paramArrayOflong2)
      return true; 
    int i = (paramArrayOflong1.length < paramArrayOflong2.length) ? paramArrayOflong1.length : paramArrayOflong2.length;
    long l = (paramArrayOflong1.length ^ paramArrayOflong2.length);
    int j;
    for (j = 0; j != i; j++)
      l |= paramArrayOflong1[j] ^ paramArrayOflong2[j]; 
    for (j = i; j < paramArrayOflong2.length; j++)
      l |= paramArrayOflong2[j] ^ paramArrayOflong2[j] ^ 0xFFFFFFFFFFFFFFFFL; 
    return (l == 0L);
  }
  ...
  public static int hashCode(Object[] paramArrayOfObject) {
    ...
    int j;
    for (j = i + 1; --i >= 0; j ^= Objects.hashCode(paramArrayOfObject[i]))
      j *= 257; 
    return j;
  }
  ...
  private static int getLength(int paramInt1, int paramInt2) {
    int i = paramInt2 - paramInt1;
    if (i < 0)
      throw new IllegalArgumentException("" + paramInt1 + " > " + paramInt1); 
    return i;
  }
  ...
  public static void reverse(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    int i = paramArrayOfbyte1.length - 1;
    for (byte b = 0; b <= i; b++)
      paramArrayOfbyte2[b] = paramArrayOfbyte1[i - b]; 
  }
  ...
  public static void reverseInPlace(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    int i = paramInt1;
    ...
    while (i < j) {
      ...
      paramArrayOfbyte[j--] = b1;
    } 
  }
  
  public static short[] reverseInPlace(short[] paramArrayOfshort) {
    if (null == paramArrayOfshort)
      return null; 
    byte b = 0;
    int i = paramArrayOfshort.length - 1;
    while (b < i) {
      short s1 = paramArrayOfshort[b];
      short s2 = paramArrayOfshort[i];
      paramArrayOfshort[b++] = s2;
      paramArrayOfshort[i--] = s1;
    } 
  ...
  public static void clear(long[] paramArrayOflong) {
    if (null != paramArrayOflong)
      java.util.Arrays.fill(paramArrayOflong, 0L); 
  }
  
  public static void clear(char[] paramArrayOfchar) {
    if (null != paramArrayOfchar)
      java.util.Arrays.fill(paramArrayOfchar, false); 
  }
  ...
  public static boolean segmentsOverlap(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    return (paramInt2 > 0 && paramInt4 > 0 && paramInt1 - paramInt3 < paramInt4 && paramInt3 - paramInt1 < paramInt2);
  }
  
  public static void validateRange(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    if (paramArrayOfbyte == null)
      throw new NullPointerException("'buf' cannot be null"); 
    if ((paramInt1 | paramArrayOfbyte.length - paramInt1 | paramInt2 - paramInt1 | paramArrayOfbyte.length - paramInt2) < 0)
      throw new IndexOutOfBoundsException("buf.length: " + paramArrayOfbyte.length + ", from: " + paramInt1 + ", to: " + paramInt2); 
  }
  
  public static void validateSegment(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    if (paramArrayOfbyte == null)
      throw new NullPointerException("'buf' cannot be null"); 
    int i = paramArrayOfbyte.length - paramInt1;
    int j = i - paramInt2;
    if ((paramInt1 | paramInt2 | i | j) < 0)
      throw new IndexOutOfBoundsException("buf.length: " + paramArrayOfbyte.length + ", off: " + paramInt1 + ", len: " + paramInt2); 
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastl\\util\Arrays.class
