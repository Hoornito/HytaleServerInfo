...
public abstract class Pack {
  ...
  public static long bigEndianToLong(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    long l = 0L;
    for (byte b = 0; b < paramInt2; b++)
  ...
  public static void littleEndianToShort(byte[] paramArrayOfbyte, int paramInt1, short[] paramArrayOfshort, int paramInt2, int paramInt3) {
    for (byte b = 0; b < paramInt3; b++) {
      paramArrayOfshort[paramInt2 + b] = littleEndianToShort(paramArrayOfbyte, paramInt1);
      paramInt1 += 2;
    } 
  }
  ...
  public static void shortToLittleEndian(short[] paramArrayOfshort, int paramInt1, int paramInt2, byte[] paramArrayOfbyte, int paramInt3) {
    for (byte b = 0; b < paramInt2; b++) {
      shortToLittleEndian(paramArrayOfshort[paramInt1 + b], paramArrayOfbyte, paramInt3);
      paramInt3 += 2;
    } 
  }
  ...
  public static long littleEndianToLong(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    long l = 0L;
    for (byte b = 0; b < paramInt2; b++)
      l |= (paramArrayOfbyte[paramInt1 + b] & 0xFFL) << b << 3; 
    return l;
  }
  ...
  public static void longToLittleEndian(long paramLong, byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    for (byte b = 0; b < paramInt2; b++)
      paramArrayOfbyte[paramInt1 + b] = (byte)(int)(paramLong >>> b << 3); 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastl\\util\Pack.class
