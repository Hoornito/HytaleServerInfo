...
public final class BigIntegers {
  ...
  public static void writeUnsignedByteArray(OutputStream paramOutputStream, BigInteger paramBigInteger) throws IOException {
    byte[] arrayOfByte = paramBigInteger.toByteArray();
    byte b = (arrayOfByte[0] == 0) ? 1 : 0;
    int i = arrayOfByte.length - b;
    paramOutputStream.write(arrayOfByte, b, i);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastl\\util\BigIntegers.class
