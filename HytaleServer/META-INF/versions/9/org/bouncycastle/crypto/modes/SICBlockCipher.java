...
public class SICBlockCipher extends StreamBlockCipher implements CTRModeCipher {
  ...
  public static CTRModeCipher newInstance(BlockCipher paramBlockCipher) {
    return new org.bouncycastle.crypto.modes.SICBlockCipher(paramBlockCipher);
  }
  ...
  private void incrementCounter(int paramInt) {
    ...
    this.counter[this.counter.length - 1] = (byte)(this.counter[this.counter.length - 1] + (byte)paramInt);
    if ((b & 0xFF) + paramInt > 255)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\modes\SICBlockCipher.class
