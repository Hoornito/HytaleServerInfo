...
public class AESEngine extends DefaultMultiBlockCipher {
  ...
  public static MultiBlockCipher newInstance() {
    return (MultiBlockCipher)new org.bouncycastle.crypto.engines.AESEngine();
  }
  ...
  private void encryptBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, int[][] paramArrayOfint) {
    ...
    byte b = 1;
    int i6;
    for (i6 = m ^ paramArrayOfint[0][3]; b < this.ROUNDS - 1; i6 = T0[i6 & 0xFF] ^ shift(T0[i7 >> 8 & 0xFF], 24) ^ shift(T0[i8 >> 16 & 0xFF], 16) ^ shift(T0[i9 >> 24 & 0xFF], 8) ^ paramArrayOfint[b++][3]) {
      int i7 = T0[n & 0xFF] ^ shift(T0[i1 >> 8 & 0xFF], 24) ^ shift(T0[i2 >> 16 & 0xFF], 16) ^ shift(T0[i6 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][0];
      int i8 = T0[i1 & 0xFF] ^ shift(T0[i2 >> 8 & 0xFF], 24) ^ shift(T0[i6 >> 16 & 0xFF], 16) ^ shift(T0[n >> 24 & 0xFF], 8) ^ paramArrayOfint[b][1];
      int i9 = T0[i2 & 0xFF] ^ shift(T0[i6 >> 8 & 0xFF], 24) ^ shift(T0[n >> 16 & 0xFF], 16) ^ shift(T0[i1 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][2];
      i6 = T0[i6 & 0xFF] ^ shift(T0[n >> 8 & 0xFF], 24) ^ shift(T0[i1 >> 16 & 0xFF], 16) ^ shift(T0[i2 >> 24 & 0xFF], 8) ^ paramArrayOfint[b++][3];
      n = T0[i7 & 0xFF] ^ shift(T0[i8 >> 8 & 0xFF], 24) ^ shift(T0[i9 >> 16 & 0xFF], 16) ^ shift(T0[i6 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][0];
      i1 = T0[i8 & 0xFF] ^ shift(T0[i9 >> 8 & 0xFF], 24) ^ shift(T0[i6 >> 16 & 0xFF], 16) ^ shift(T0[i7 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][1];
      i2 = T0[i9 & 0xFF] ^ shift(T0[i6 >> 8 & 0xFF], 24) ^ shift(T0[i7 >> 16 & 0xFF], 16) ^ shift(T0[i8 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][2];
    } 
    int i3 = T0[n & 0xFF] ^ shift(T0[i1 >> 8 & 0xFF], 24) ^ shift(T0[i2 >> 16 & 0xFF], 16) ^ shift(T0[i6 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][0];
    int i4 = T0[i1 & 0xFF] ^ shift(T0[i2 >> 8 & 0xFF], 24) ^ shift(T0[i6 >> 16 & 0xFF], 16) ^ shift(T0[n >> 24 & 0xFF], 8) ^ paramArrayOfint[b][1];
    int i5 = T0[i2 & 0xFF] ^ shift(T0[i6 >> 8 & 0xFF], 24) ^ shift(T0[n >> 16 & 0xFF], 16) ^ shift(T0[i1 >> 24 & 0xFF], 8) ^ paramArrayOfint[b][2];
    i6 = T0[i6 & 0xFF] ^ shift(T0[n >> 8 & 0xFF], 24) ^ shift(T0[i1 >> 16 & 0xFF], 16) ^ shift(T0[i2 >> 24 & 0xFF], 8) ^ paramArrayOfint[b++][3];
    i = S[i3 & 0xFF] & 0xFF ^ (S[i4 >> 8 & 0xFF] & 0xFF) << 8 ^ (this.s[i5 >> 16 & 0xFF] & 0xFF) << 16 ^ this.s[i6 >> 24 & 0xFF] << 24 ^ paramArrayOfint[b][0];
    j = this.s[i4 & 0xFF] & 0xFF ^ (S[i5 >> 8 & 0xFF] & 0xFF) << 8 ^ (S[i6 >> 16 & 0xFF] & 0xFF) << 16 ^ this.s[i3 >> 24 & 0xFF] << 24 ^ paramArrayOfint[b][1];
    k = this.s[i5 & 0xFF] & 0xFF ^ (S[i6 >> 8 & 0xFF] & 0xFF) << 8 ^ (S[i3 >> 16 & 0xFF] & 0xFF) << 16 ^ S[i4 >> 24 & 0xFF] << 24 ^ paramArrayOfint[b][2];
    m = this.s[i6 & 0xFF] & 0xFF ^ (this.s[i3 >> 8 & 0xFF] & 0xFF) << 8 ^ (this.s[i4 >> 16 & 0xFF] & 0xFF) << 16 ^ S[i5 >> 24 & 0xFF] << 24 ^ paramArrayOfint[b][3];
  ...
  private void decryptBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, int[][] paramArrayOfint) {
    ...
    int i7;
    for (i7 = m ^ paramArrayOfint[this.ROUNDS][3]; i3 > 1; i7 = Tinv0[i7 & 0xFF] ^ shift(Tinv0[i10 >> 8 & 0xFF], 24) ^ shift(Tinv0[i9 >> 16 & 0xFF], 16) ^ shift(Tinv0[i8 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3--][3]) {
      int i8 = Tinv0[n & 0xFF] ^ shift(Tinv0[i7 >> 8 & 0xFF], 24) ^ shift(Tinv0[i2 >> 16 & 0xFF], 16) ^ shift(Tinv0[i1 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][0];
      int i9 = Tinv0[i1 & 0xFF] ^ shift(Tinv0[n >> 8 & 0xFF], 24) ^ shift(Tinv0[i7 >> 16 & 0xFF], 16) ^ shift(Tinv0[i2 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][1];
      int i10 = Tinv0[i2 & 0xFF] ^ shift(Tinv0[i1 >> 8 & 0xFF], 24) ^ shift(Tinv0[n >> 16 & 0xFF], 16) ^ shift(Tinv0[i7 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][2];
      i7 = Tinv0[i7 & 0xFF] ^ shift(Tinv0[i2 >> 8 & 0xFF], 24) ^ shift(Tinv0[i1 >> 16 & 0xFF], 16) ^ shift(Tinv0[n >> 24 & 0xFF], 8) ^ paramArrayOfint[i3--][3];
      n = Tinv0[i8 & 0xFF] ^ shift(Tinv0[i7 >> 8 & 0xFF], 24) ^ shift(Tinv0[i10 >> 16 & 0xFF], 16) ^ shift(Tinv0[i9 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][0];
      i1 = Tinv0[i9 & 0xFF] ^ shift(Tinv0[i8 >> 8 & 0xFF], 24) ^ shift(Tinv0[i7 >> 16 & 0xFF], 16) ^ shift(Tinv0[i10 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][1];
      i2 = Tinv0[i10 & 0xFF] ^ shift(Tinv0[i9 >> 8 & 0xFF], 24) ^ shift(Tinv0[i8 >> 16 & 0xFF], 16) ^ shift(Tinv0[i7 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][2];
    } 
    int i4 = Tinv0[n & 0xFF] ^ shift(Tinv0[i7 >> 8 & 0xFF], 24) ^ shift(Tinv0[i2 >> 16 & 0xFF], 16) ^ shift(Tinv0[i1 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][0];
    int i5 = Tinv0[i1 & 0xFF] ^ shift(Tinv0[n >> 8 & 0xFF], 24) ^ shift(Tinv0[i7 >> 16 & 0xFF], 16) ^ shift(Tinv0[i2 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][1];
    int i6 = Tinv0[i2 & 0xFF] ^ shift(Tinv0[i1 >> 8 & 0xFF], 24) ^ shift(Tinv0[n >> 16 & 0xFF], 16) ^ shift(Tinv0[i7 >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][2];
    i7 = Tinv0[i7 & 0xFF] ^ shift(Tinv0[i2 >> 8 & 0xFF], 24) ^ shift(Tinv0[i1 >> 16 & 0xFF], 16) ^ shift(Tinv0[n >> 24 & 0xFF], 8) ^ paramArrayOfint[i3][3];
    i = Si[i4 & 0xFF] & 0xFF ^ (this.s[i7 >> 8 & 0xFF] & 0xFF) << 8 ^ (this.s[i6 >> 16 & 0xFF] & 0xFF) << 16 ^ Si[i5 >> 24 & 0xFF] << 24 ^ paramArrayOfint[0][0];
    j = this.s[i5 & 0xFF] & 0xFF ^ (this.s[i4 >> 8 & 0xFF] & 0xFF) << 8 ^ (Si[i7 >> 16 & 0xFF] & 0xFF) << 16 ^ this.s[i6 >> 24 & 0xFF] << 24 ^ paramArrayOfint[0][1];
    k = this.s[i6 & 0xFF] & 0xFF ^ (Si[i5 >> 8 & 0xFF] & 0xFF) << 8 ^ (Si[i4 >> 16 & 0xFF] & 0xFF) << 16 ^ this.s[i7 >> 24 & 0xFF] << 24 ^ paramArrayOfint[0][2];
    m = Si[i7 & 0xFF] & 0xFF ^ (this.s[i6 >> 8 & 0xFF] & 0xFF) << 8 ^ (this.s[i5 >> 16 & 0xFF] & 0xFF) << 16 ^ this.s[i4 >> 24 & 0xFF] << 24 ^ paramArrayOfint[0][3];
    Pack.intToLittleEndian(i, paramArrayOfbyte2, paramInt2 + 0);
    Pack.intToLittleEndian(j, paramArrayOfbyte2, paramInt2 + 4);
    Pack.intToLittleEndian(k, paramArrayOfbyte2, paramInt2 + 8);
    Pack.intToLittleEndian(m, paramArrayOfbyte2, paramInt2 + 12);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\engines\AESEngine.class
