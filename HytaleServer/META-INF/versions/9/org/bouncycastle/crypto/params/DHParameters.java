...
public class DHParameters implements CipherParameters {
  ...
  public DHParameters(BigInteger paramBigInteger1, BigInteger paramBigInteger2, BigInteger paramBigInteger3, int paramInt1, int paramInt2, BigInteger paramBigInteger4, DHValidationParameters paramDHValidationParameters) {
    ...
    if (paramInt1 > paramBigInteger1.bitLength() && !Properties.isOverrideSet("org.bouncycastle.dh.allow_unsafe_p_value"))
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.crypto.params.DHParameters))
      return false; 
    org.bouncycastle.crypto.params.DHParameters dHParameters = (org.bouncycastle.crypto.params.DHParameters)paramObject;
    if (getQ() != null) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\params\DHParameters.class
