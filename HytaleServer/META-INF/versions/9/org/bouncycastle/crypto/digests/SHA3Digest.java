...
public class SHA3Digest extends KeccakDigest implements SavableDigest {
  ...
  public SHA3Digest(byte[] paramArrayOfbyte) {
  ...
  public Memoable copy() {
    return (Memoable)new org.bouncycastle.crypto.digests.SHA3Digest(this);
  }
  
  public void reset(Memoable paramMemoable) {
    org.bouncycastle.crypto.digests.SHA3Digest sHA3Digest = (org.bouncycastle.crypto.digests.SHA3Digest)paramMemoable;
    copyIn(sHA3Digest);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\digests\SHA3Digest.class
