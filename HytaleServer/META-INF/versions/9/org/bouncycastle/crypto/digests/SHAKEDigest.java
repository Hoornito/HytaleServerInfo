...
public class SHAKEDigest extends KeccakDigest implements Xof, SavableDigest {
  ...
  public SHAKEDigest(byte[] paramArrayOfbyte) {
  ...
  public byte[] getEncodedState() {
    byte[] arrayOfByte = new byte[this.state.length * 8 + this.dataQueue.length + 12 + 2];
    getEncodedState(arrayOfByte);
    return arrayOfByte;
  }
  
  public Memoable copy() {
    return (Memoable)new org.bouncycastle.crypto.digests.SHAKEDigest(this);
  }
  
  public void reset(Memoable paramMemoable) {
    org.bouncycastle.crypto.digests.SHAKEDigest sHAKEDigest = (org.bouncycastle.crypto.digests.SHAKEDigest)paramMemoable;
    copyIn(sHAKEDigest);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\digests\SHAKEDigest.class
