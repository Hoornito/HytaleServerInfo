...
public class SHA512tDigest extends LongDigest {
  ...
  public SHA512tDigest(int paramInt, CryptoServicePurpose paramCryptoServicePurpose) {
    if (paramInt >= 512)
  ...
  public SHA512tDigest(org.bouncycastle.crypto.digests.SHA512tDigest paramSHA512tDigest) {
    ...
    CryptoServicesRegistrar.checkConstraints(cryptoServiceProperties());
    reset((Memoable)paramSHA512tDigest);
  }
  
  public SHA512tDigest(byte[] paramArrayOfbyte) {
    this(readDigestLength(paramArrayOfbyte), CryptoServicePurpose.values()[paramArrayOfbyte[paramArrayOfbyte.length - 1]]);
    CryptoServicesRegistrar.checkConstraints(cryptoServiceProperties());
    restoreState(paramArrayOfbyte);
  }
  
  private static int readDigestLength(byte[] paramArrayOfbyte) {
    return Pack.bigEndianToInt(paramArrayOfbyte, paramArrayOfbyte.length - 5);
  }
  ...
  public Memoable copy() {
    return (Memoable)new org.bouncycastle.crypto.digests.SHA512tDigest(this);
  }
  
  public void reset(Memoable paramMemoable) {
    org.bouncycastle.crypto.digests.SHA512tDigest sHA512tDigest = (org.bouncycastle.crypto.digests.SHA512tDigest)paramMemoable;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\digests\SHA512tDigest.class
