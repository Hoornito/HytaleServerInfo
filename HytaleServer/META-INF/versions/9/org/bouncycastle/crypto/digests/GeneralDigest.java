...
public abstract class GeneralDigest implements ExtendedDigest, Memoable {
  ...
  protected GeneralDigest(CryptoServicePurpose paramCryptoServicePurpose) {
  ...
  protected GeneralDigest(org.bouncycastle.crypto.digests.GeneralDigest paramGeneralDigest) {
    this.purpose = paramGeneralDigest.purpose;
  ...
  protected GeneralDigest(byte[] paramArrayOfbyte) {
    ...
    this.purpose = arrayOfCryptoServicePurpose[paramArrayOfbyte[paramArrayOfbyte.length - 1]];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\crypto\digests\GeneralDigest.class
