...
public class SecT163K1Point extends ECPoint.AbstractF2m {
  SecT163K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    super(paramECCurve, paramECFieldElement1, paramECFieldElement2);
  }
  
  SecT163K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement) {
    super(paramECCurve, paramECFieldElement1, paramECFieldElement2, paramArrayOfECFieldElement);
  }
  
  protected ECPoint detach() {
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement13, eCCurve.getB()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement6.isZero())
      return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement6, eCCurve.getB()); 
    ...
    ECFieldElement eCFieldElement9 = eCFieldElement2.add(eCFieldElement1).square();
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (eCFieldElement12.isZero())
      return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement12, eCCurve.getB()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT163K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT163K1Point.class
