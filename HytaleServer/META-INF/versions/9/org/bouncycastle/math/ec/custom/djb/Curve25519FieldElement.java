...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    Curve25519Field.add(this.x, ((org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    Curve25519Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    Curve25519Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    Curve25519Field.inv(((org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat256.create();
    Curve25519Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    if (Nat256.eq(arrayOfInt1, arrayOfInt14))
      return (ECFieldElement)new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt13); 
    Curve25519Field.multiply(arrayOfInt13, PRECOMP_POW2, arrayOfInt13);
    Curve25519Field.square(arrayOfInt13, arrayOfInt14);
    return (ECFieldElement)(Nat256.eq(arrayOfInt1, arrayOfInt14) ? new org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement(arrayOfInt13) : null);
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement curve25519FieldElement = (org.bouncycastle.math.ec.custom.djb.Curve25519FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\djb\Curve25519FieldElement.class
