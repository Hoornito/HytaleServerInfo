...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP224K1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224K1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224K1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224K1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat224.create();
    SecP224K1Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    if (Nat224.eq(arrayOfInt1, arrayOfInt14))
      return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt13); 
    SecP224K1Field.multiply(arrayOfInt13, PRECOMP_POW2, arrayOfInt13);
    SecP224K1Field.square(arrayOfInt13, arrayOfInt14);
    return (ECFieldElement)(Nat224.eq(arrayOfInt1, arrayOfInt14) ? new org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement(arrayOfInt13) : null);
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement secP224K1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP224K1FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP224K1FieldElement.class
