...
public class SecT193R2Point extends ECPoint.AbstractF2m {
  ...
  protected ECPoint detach() {
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement8.isZero())
      return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[] { eCFieldElement10 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT193R2Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT193R2Point.class
