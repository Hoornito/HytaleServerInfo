...
public class SecP160R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP160R1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat160.create();
    SecP160R1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat160.create();
    SecP160R1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat160.create();
    SecP160R1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat160.create();
    SecP160R1Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat160.eq(arrayOfInt1, arrayOfInt11) ? (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement(arrayOfInt10) : null;
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement secP160R1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP160R1FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP160R1FieldElement.class
