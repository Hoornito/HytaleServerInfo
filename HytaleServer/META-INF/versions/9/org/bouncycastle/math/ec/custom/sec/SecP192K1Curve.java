...
public class SecP192K1Curve extends ECCurve.AbstractFp {
  ...
  private static final ECFieldElement[] SECP192K1_AFFINE_ZS = new ECFieldElement[] { (ECFieldElement)new SecP192K1FieldElement(ECConstants.ONE) };
  ...
  protected ECCurve cloneCurve() {
    return (ECCurve)new org.bouncycastle.math.ec.custom.sec.SecP192K1Curve();
  }
  ...
  public ECFieldElement fromBigInteger(BigInteger paramBigInteger) {
    return (ECFieldElement)new SecP192K1FieldElement(paramBigInteger);
  }
  
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    return (ECPoint)new SecP192K1Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2);
  }
  
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement) {
    return (ECPoint)new SecP192K1Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2, paramArrayOfECFieldElement);
  }
  ...
  public ECFieldElement randomFieldElement(SecureRandom paramSecureRandom) {
    ...
    return (ECFieldElement)new SecP192K1FieldElement(arrayOfInt);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP192K1Curve.class
