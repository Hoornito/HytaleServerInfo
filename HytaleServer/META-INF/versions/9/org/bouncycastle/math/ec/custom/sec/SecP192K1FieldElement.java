...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP192K1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat192.create();
    SecP192K1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat192.create();
    SecP192K1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat192.create();
    SecP192K1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat192.create();
    SecP192K1Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat192.eq(arrayOfInt1, arrayOfInt13) ? (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement(arrayOfInt12) : null;
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement secP192K1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP192K1FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP192K1FieldElement.class
