...
public class SecT409K1Point extends ECPoint.AbstractF2m {
  SecT409K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    super(paramECCurve, paramECFieldElement1, paramECFieldElement2);
  }
  
  SecT409K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement) {
    super(paramECCurve, paramECFieldElement1, paramECFieldElement2, paramArrayOfECFieldElement);
  }
  
  protected ECPoint detach() {
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(eCCurve, eCFieldElement13, eCCurve.getB()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement5.isZero())
      return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(eCCurve, eCFieldElement5, eCCurve.getB()); 
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[] { eCFieldElement7 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new org.bouncycastle.math.ec.custom.sec.SecT409K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT409K1Point.class
