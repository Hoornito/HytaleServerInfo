...
public abstract class ECCurve {
  ...
  public int getAffinePointEncodingLength(boolean paramBoolean) {
    int i = getFieldElementEncodingLength();
    return paramBoolean ? (1 + i) : (1 + i * 2);
  }
  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, int paramInt2) {
    ...
    for (byte b = 0; b < paramInt2; b++) {
      ...
      eCPoint.getRawXCoord().encodeTo(arrayOfByte, j);
      j += i;
      eCPoint.getRawYCoord().encodeTo(arrayOfByte, j);
      j += i;
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\ECCurve.class
