...
public class Curve25519Point extends ECPoint.AbstractFp {
  ...
  protected ECPoint detach() {
    return (ECPoint)new org.bouncycastle.math.ec.custom.djb.Curve25519Point(null, getAffineXCoord(), getAffineYCoord());
  }
  
  public ECFieldElement getZCoord(int paramInt) {
    return (ECFieldElement)((paramInt == 1) ? getJacobianModifiedW() : super.getZCoord(paramInt));
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    ECFieldElement[] arrayOfECFieldElement = { (ECFieldElement)curve25519FieldElement9, (ECFieldElement)curve25519FieldElement10 };
    return (ECPoint)new org.bouncycastle.math.ec.custom.djb.Curve25519Point(eCCurve, (ECFieldElement)curve25519FieldElement7, (ECFieldElement)curve25519FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new org.bouncycastle.math.ec.custom.djb.Curve25519Point(getCurve(), this.x, this.y.negate(), this.zs));
  }
  ...
  protected Curve25519FieldElement getJacobianModifiedW() {
    ...
    if (curve25519FieldElement == null)
      this.zs[1] = (ECFieldElement)(curve25519FieldElement = calculateJacobianModifiedW((Curve25519FieldElement)this.zs[0], null)); 
  ...
  protected org.bouncycastle.math.ec.custom.djb.Curve25519Point twiceJacobianModified(boolean paramBoolean) {
    ...
    return new org.bouncycastle.math.ec.custom.djb.Curve25519Point(getCurve(), (ECFieldElement)curve25519FieldElement5, (ECFieldElement)curve25519FieldElement6, new ECFieldElement[] { (ECFieldElement)curve25519FieldElement7, (ECFieldElement)curve25519FieldElement8 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\djb\Curve25519Point.class
