...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP224R1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224R1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224R1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224R1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat224.create();
    SecP224R1Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat224.eq(arrayOfInt1, arrayOfInt3) ? (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement(arrayOfInt4) : null;
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement secP224R1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP224R1FieldElement)paramObject;
  ...
  private static boolean trySqrt(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    for (byte b = 1; b < 96; b++) {
      ...
      if (Nat224.isZero(arrayOfInt1)) {
        SecP224R1Field.inv(arrayOfInt5, paramArrayOfint3);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP224R1FieldElement.class
