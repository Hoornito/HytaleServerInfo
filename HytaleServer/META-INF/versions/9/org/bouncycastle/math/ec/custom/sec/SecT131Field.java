...
public class SecT131Field {
  ...
  protected static void implMulw(long[] paramArrayOflong1, long paramLong1, long paramLong2, long[] paramArrayOflong2, int paramInt) {
    ...
    long l1 = 0L;
    long l2 = paramArrayOflong1[i & 0x7] ^ paramArrayOflong1[i >>> 3 & 0x7] << 3L ^ paramArrayOflong1[i >>> 6 & 0x7] << 6L ^ paramArrayOflong1[i >>> 9 & 0x7] << 9L ^ paramArrayOflong1[i >>> 12 & 0x7] << 12L;
    byte b = 30;
    while (true) {
      i = (int)(paramLong1 >>> b);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT131Field.class
