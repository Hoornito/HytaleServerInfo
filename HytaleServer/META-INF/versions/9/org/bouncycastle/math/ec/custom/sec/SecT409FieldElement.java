...
public class SecT409FieldElement extends ECFieldElement.AbstractF2m {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecT409Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramECFieldElement).x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(arrayOfLong);
  }
  ...
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    long[] arrayOfLong = Nat448.create64();
    SecT409Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramECFieldElement).x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(arrayOfLong);
  }
  ...
  public ECFieldElement multiplyPlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement paramECFieldElement3) {
    ...
    long[] arrayOfLong2 = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramECFieldElement1).x;
    long[] arrayOfLong3 = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramECFieldElement2).x;
    long[] arrayOfLong4 = ((org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramECFieldElement3).x;
    ...
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(arrayOfLong6);
  }
  ...
  public ECFieldElement squarePlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    ...
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(arrayOfLong5);
  }
  ...
  public ECFieldElement halfTrace() {
    long[] arrayOfLong = Nat448.create64();
    SecT409Field.halfTrace(this.x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT409FieldElement(arrayOfLong);
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecT409FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecT409FieldElement secT409FieldElement = (org.bouncycastle.math.ec.custom.sec.SecT409FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT409FieldElement.class
