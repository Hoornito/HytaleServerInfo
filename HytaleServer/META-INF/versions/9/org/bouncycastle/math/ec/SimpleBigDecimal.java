...
class SimpleBigDecimal {
  ...
  public org.bouncycastle.math.ec.SimpleBigDecimal adjustScale(int paramInt) {
    if (paramInt < 0)
      throw new IllegalArgumentException("scale may not be negative"); 
    return (paramInt == this.scale) ? this : new org.bouncycastle.math.ec.SimpleBigDecimal(this.bigInt.shiftLeft(paramInt - this.scale), paramInt);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\SimpleBigDecimal.class
