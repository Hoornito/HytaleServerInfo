...
public class SecT239Field {
  ...
  public static long[] fromBigInteger(BigInteger paramBigInteger) {
    return Nat.fromBigInteger64(239, paramBigInteger);
  }
  ...
  protected static void implMulwAcc(long[] paramArrayOflong1, long paramLong1, long paramLong2, long[] paramArrayOflong2, int paramInt) {
    ...
    long l1 = 0L;
    long l2 = paramArrayOflong1[i & 0x7] ^ paramArrayOflong1[i >>> 3 & 0x7] << 3L;
    byte b = 54;
    while (true) {
      i = (int)(paramLong1 >>> b);
      ...
      if (b <= 0) {
        ...
        paramArrayOflong2[paramInt] = paramArrayOflong2[paramInt] ^ l2 & 0xFFFFFFFFFFFFFFFL;
        paramArrayOflong2[paramInt + 1] = paramArrayOflong2[paramInt + 1] ^ l2 >>> 60L ^ l1 << 4L;
        return;
      } 
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT239Field.class
