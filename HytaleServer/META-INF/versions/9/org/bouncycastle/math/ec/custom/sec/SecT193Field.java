...
public class SecT193Field {
  ...
  public static long[] fromBigInteger(BigInteger paramBigInteger) {
    return Nat.fromBigInteger64(193, paramBigInteger);
  }
  ...
  protected static void implMulwAcc(long[] paramArrayOflong1, long paramLong1, long paramLong2, long[] paramArrayOflong2, int paramInt) {
    ...
    while (true) {
      ...
      b -= 15;
      if (b <= 0) {
        paramArrayOflong2[paramInt] = paramArrayOflong2[paramInt] ^ l2 & 0x1FFFFFFFFFFFFL;
        paramArrayOflong2[paramInt + 1] = paramArrayOflong2[paramInt + 1] ^ l2 >>> 49L ^ l1 << 15L;
        return;
      } 
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT193Field.class
