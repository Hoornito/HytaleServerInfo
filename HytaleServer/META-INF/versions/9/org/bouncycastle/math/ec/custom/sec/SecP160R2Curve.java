...
public class SecP160R2Curve extends ECCurve.AbstractFp {
  ...
  private static final ECFieldElement[] SECP160R2_AFFINE_ZS = new ECFieldElement[] { (ECFieldElement)new SecP160R2FieldElement(ECConstants.ONE) };
  
  protected SecP160R2Point infinity = new SecP160R2Point((ECCurve)this, null, null);
  ...
  protected ECCurve cloneCurve() {
    return (ECCurve)new org.bouncycastle.math.ec.custom.sec.SecP160R2Curve();
  }
  ...
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    return (ECPoint)new SecP160R2Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2);
  }
  
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement) {
    return (ECPoint)new SecP160R2Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2, paramArrayOfECFieldElement);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP160R2Curve.class
