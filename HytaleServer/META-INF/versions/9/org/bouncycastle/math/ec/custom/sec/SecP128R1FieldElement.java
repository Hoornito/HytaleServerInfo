...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP128R1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat128.create();
    SecP128R1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat128.create();
    SecP128R1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat128.create();
    SecP128R1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement invert() {
    int[] arrayOfInt = Nat128.create();
    SecP128R1Field.inv(this.x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat128.eq(arrayOfInt1, arrayOfInt10) ? (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement(arrayOfInt9) : null;
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement secP128R1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP128R1FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP128R1FieldElement.class
