...
public class SecT239FieldElement extends ECFieldElement.AbstractF2m {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecT239Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramECFieldElement).x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(arrayOfLong);
  }
  ...
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    long[] arrayOfLong = Nat256.create64();
    SecT239Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramECFieldElement).x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(arrayOfLong);
  }
  ...
  public ECFieldElement multiplyPlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement paramECFieldElement3) {
    ...
    long[] arrayOfLong2 = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramECFieldElement1).x;
    long[] arrayOfLong3 = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramECFieldElement2).x;
    long[] arrayOfLong4 = ((org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramECFieldElement3).x;
    ...
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(arrayOfLong6);
  }
  ...
  public ECFieldElement squarePlusProduct(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    ...
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(arrayOfLong5);
  }
  ...
  public ECFieldElement halfTrace() {
    long[] arrayOfLong = Nat256.create64();
    SecT239Field.halfTrace(this.x, arrayOfLong);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecT239FieldElement(arrayOfLong);
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecT239FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecT239FieldElement secT239FieldElement = (org.bouncycastle.math.ec.custom.sec.SecT239FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecT239FieldElement.class
