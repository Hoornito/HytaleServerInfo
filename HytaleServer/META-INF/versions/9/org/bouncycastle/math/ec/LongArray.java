...
class LongArray implements Cloneable {
  ...
  void copyTo(long[] paramArrayOflong, int paramInt) {
    System.arraycopy(this.m_ints, 0, paramArrayOflong, paramInt, this.m_ints.length);
  }
  ...
  public org.bouncycastle.math.ec.LongArray addOne() {
    ...
    return new org.bouncycastle.math.ec.LongArray(arrayOfLong);
  }
  
  private void addShiftedByBitsSafe(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt1, int paramInt2) {
  ...
  public void addShiftedByWords(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt) {
  ...
  public org.bouncycastle.math.ec.LongArray modMultiplyLD(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    int i = degree();
    if (i == 0)
      return this; 
    ...
    org.bouncycastle.math.ec.LongArray longArray1 = this;
    org.bouncycastle.math.ec.LongArray longArray2 = paramLongArray;
    if (i > j) {
  ...
  public org.bouncycastle.math.ec.LongArray modMultiply(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    int i = degree();
    if (i == 0)
      return this; 
    int j = paramLongArray.degree();
  ...
  public org.bouncycastle.math.ec.LongArray modMultiplyAlt(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    int i = degree();
    if (i == 0)
      return this; 
    int j = paramLongArray.degree();
  ...
  public org.bouncycastle.math.ec.LongArray modReduce(int paramInt, int[] paramArrayOfint) {
    long[] arrayOfLong = Arrays.clone(this.m_ints);
    int i = reduceInPlace(arrayOfLong, 0, arrayOfLong.length, paramInt, paramArrayOfint);
    return new org.bouncycastle.math.ec.LongArray(arrayOfLong, 0, i);
  }
  
  public org.bouncycastle.math.ec.LongArray multiply(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    int i = degree();
    if (i == 0)
      return this; 
    int j = paramLongArray.degree();
    ...
    if (k == 1) {
      ...
      long[] arrayOfLong = new long[n];
      multiplyWord(l, longArray2.m_ints, m, arrayOfLong, 0);
      return new org.bouncycastle.math.ec.LongArray(arrayOfLong, 0, n);
    } 
    int i1 = j + 7 + 63 >>> 6;
    int[] arrayOfInt = new int[16];
    long[] arrayOfLong1 = new long[i1 << 4];
    ...
    while ((i3 -= n) != 0)
      addShiftedUp(arrayOfLong4, i3 - n, arrayOfLong4, i3, n, 8); 
    return new org.bouncycastle.math.ec.LongArray(arrayOfLong4, 0, n);
  }
  ...
  private static org.bouncycastle.math.ec.LongArray reduceResult(long[] paramArrayOflong, int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfint) {
    int i = reduceInPlace(paramArrayOflong, paramInt1, paramInt2, paramInt3, paramArrayOfint);
    return new org.bouncycastle.math.ec.LongArray(paramArrayOflong, paramInt1, i);
  }
  ...
  public org.bouncycastle.math.ec.LongArray modSquare(int paramInt, int[] paramArrayOfint) {
    int i = getUsedLength();
    if (i == 0)
      return this; 
    int j = i << 1;
    ...
    return new org.bouncycastle.math.ec.LongArray(arrayOfLong, 0, reduceInPlace(arrayOfLong, 0, arrayOfLong.length, paramInt, paramArrayOfint));
  }
  
  public org.bouncycastle.math.ec.LongArray modSquareN(int paramInt1, int paramInt2, int[] paramArrayOfint) {
    int i = getUsedLength();
    if (i == 0)
      return this; 
  ...
  public org.bouncycastle.math.ec.LongArray square(int paramInt, int[] paramArrayOfint) {
    int i = getUsedLength();
    if (i == 0)
      return this; 
    int j = i << 1;
    ...
    return new org.bouncycastle.math.ec.LongArray(arrayOfLong, 0, arrayOfLong.length);
  }
  ...
  public org.bouncycastle.math.ec.LongArray modInverse(int paramInt, int[] paramArrayOfint) {
    int i = degree();
    if (i == 0)
      throw new IllegalStateException(); 
    if (i == 1)
      return this; 
    org.bouncycastle.math.ec.LongArray longArray1 = (org.bouncycastle.math.ec.LongArray)clone();
    int j = paramInt + 63 >>> 6;
    org.bouncycastle.math.ec.LongArray longArray2 = new org.bouncycastle.math.ec.LongArray(j);
    reduceBit(longArray2.m_ints, 0, paramInt, paramInt, paramArrayOfint);
    org.bouncycastle.math.ec.LongArray longArray3 = new org.bouncycastle.math.ec.LongArray(j);
    longArray3.m_ints[0] = 1L;
    org.bouncycastle.math.ec.LongArray longArray4 = new org.bouncycastle.math.ec.LongArray(j);
    int[] arrayOfInt1 = { i, paramInt + 1 };
    org.bouncycastle.math.ec.LongArray[] arrayOfLongArray1 = { longArray1, longArray2 };
    int[] arrayOfInt2 = { 1, 0 };
    org.bouncycastle.math.ec.LongArray[] arrayOfLongArray2 = { longArray3, longArray4 };
    int k = 1;
    int m = arrayOfInt1[k];
    int n = arrayOfInt2[k];
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.math.ec.LongArray))
      return false; 
    org.bouncycastle.math.ec.LongArray longArray = (org.bouncycastle.math.ec.LongArray)paramObject;
    int i = getUsedLength();
  ...
  public Object clone() {
    return new org.bouncycastle.math.ec.LongArray(Arrays.clone(this.m_ints));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\LongArray.class
