...
public class SM2P256V1Point extends ECPoint.AbstractFp {
  ...
  protected ECPoint detach() {
    return (ECPoint)new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    ECFieldElement[] arrayOfECFieldElement = { (ECFieldElement)sM2P256V1FieldElement9 };
    return (ECPoint)new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(eCCurve, (ECFieldElement)sM2P256V1FieldElement7, (ECFieldElement)sM2P256V1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(eCCurve, (ECFieldElement)sM2P256V1FieldElement4, (ECFieldElement)sM2P256V1FieldElement5, new ECFieldElement[] { (ECFieldElement)sM2P256V1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\gm\SM2P256V1Point.class
