...
public class SecP384R1Field {
  ...
  public static void multiply(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3, int[] paramArrayOfint4) {
    Nat384.mul(paramArrayOfint1, paramArrayOfint2, paramArrayOfint4);
  ...
  public static void square(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    Nat384.square(paramArrayOfint1, paramArrayOfint3);
  ...
  public static void squareN(int[] paramArrayOfint1, int paramInt, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    reduce(paramArrayOfint3, paramArrayOfint2);
    while (--paramInt > 0) {
      Nat384.square(paramArrayOfint2, paramArrayOfint3);
      reduce(paramArrayOfint3, paramArrayOfint2);
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP384R1Field.class
