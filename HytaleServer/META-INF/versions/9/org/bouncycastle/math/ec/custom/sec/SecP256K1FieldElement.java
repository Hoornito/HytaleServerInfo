...
public class SecP256K1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement add(ECFieldElement paramECFieldElement) {
    ...
    SecP256K1Field.add(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement(arrayOfInt);
  }
  ...
  public ECFieldElement subtract(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    SecP256K1Field.subtract(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement multiply(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    SecP256K1Field.multiply(this.x, ((org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement)paramECFieldElement).x, arrayOfInt);
    return (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement(arrayOfInt);
  }
  
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    SecP256K1Field.inv(((org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat256.eq(arrayOfInt1, arrayOfInt15) ? (ECFieldElement)new org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement(arrayOfInt14) : null;
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement))
      return false; 
    org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement secP256K1FieldElement = (org.bouncycastle.math.ec.custom.sec.SecP256K1FieldElement)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\ec\custom\sec\SecP256K1FieldElement.class
