...
public abstract class Nat {
  ...
  public static int addToEachOther(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3) {
    ...
    for (byte b = 0; b < paramInt1; b++) {
      l += (paramArrayOfint1[paramInt2 + b] & 0xFFFFFFFFL) + (paramArrayOfint2[paramInt3 + b] & 0xFFFFFFFFL);
      paramArrayOfint1[paramInt2 + b] = (int)l;
      paramArrayOfint2[paramInt3 + b] = (int)l;
      l >>>= 32L;
    } 
    return (int)l;
  ...
  public static int cadd(int paramInt1, int paramInt2, int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    long l1 = -(paramInt2 & 0x1) & 0xFFFFFFFFL;
    long l2 = 0L;
    for (byte b = 0; b < paramInt1; b++) {
  ...
  public static int caddTo(int paramInt1, int paramInt2, int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = -(paramInt2 & 0x1) & 0xFFFFFFFFL;
    long l2 = 0L;
    for (byte b = 0; b < paramInt1; b++) {
      l2 += (paramArrayOfint2[b] & 0xFFFFFFFFL) + (paramArrayOfint1[b] & l1);
      paramArrayOfint2[b] = (int)l2;
      l2 >>>= 32L;
    } 
    return (int)l2;
  }
  ...
  public static void cmov(int paramInt1, int paramInt2, int[] paramArrayOfint1, int paramInt3, int[] paramArrayOfint2, int paramInt4) {
    paramInt2 = -(paramInt2 & 0x1);
    for (byte b = 0; b < paramInt1; b++) {
      int i = paramArrayOfint2[paramInt4 + b];
      int j = i ^ paramArrayOfint1[paramInt3 + b];
      i ^= j & paramInt2;
      paramArrayOfint2[paramInt4 + b] = i;
    } 
  }
  ...
  public static int compare(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3) {
    for (int i = paramInt1 - 1; i >= 0; i--) {
      int j = paramArrayOfint1[paramInt2 + i] ^ Integer.MIN_VALUE;
      int k = paramArrayOfint2[paramInt3 + i] ^ Integer.MIN_VALUE;
      if (j < k)
        return -1; 
      if (j > k)
        return 1; 
  ...
  public static void copy64(int paramInt, long[] paramArrayOflong1, long[] paramArrayOflong2) {
    System.arraycopy(paramArrayOflong1, 0, paramArrayOflong2, 0, paramInt);
  }
  
  public static void copy64(int paramInt1, long[] paramArrayOflong1, int paramInt2, long[] paramArrayOflong2, int paramInt3) {
    System.arraycopy(paramArrayOflong1, paramInt2, paramArrayOflong2, paramInt3, paramInt1);
  }
  ...
  public static int csub(int paramInt1, int paramInt2, int[] paramArrayOfint1, int paramInt3, int[] paramArrayOfint2, int paramInt4, int[] paramArrayOfint3, int paramInt5) {
    ...
    long l2 = 0L;
    for (byte b = 0; b < paramInt1; b++) {
      l2 += (paramArrayOfint1[paramInt3 + b] & 0xFFFFFFFFL) - (paramArrayOfint2[paramInt4 + b] & l1);
      paramArrayOfint3[paramInt5 + b] = (int)l2;
      l2 >>= 32L;
    } 
    return (int)l2;
  }
  ...
  public static int equalTo(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3) {
    int i = 0;
    for (byte b = 0; b < paramInt1; b++)
      i |= paramArrayOfint1[paramInt2 + b] ^ paramArrayOfint2[paramInt3 + b]; 
    i = i >>> 1 | i & 0x1;
    return i - 1 >> 31;
  }
  ...
  public static int getBitLength(int paramInt, int[] paramArrayOfint) {
    for (int i = paramInt - 1; i >= 0; i--) {
      int j = paramArrayOfint[i];
      if (j != 0)
        return i * 32 + 32 - Integers.numberOfLeadingZeros(j); 
    } 
    return 0;
  }
  
  public static int getBitLength(int paramInt1, int[] paramArrayOfint, int paramInt2) {
    for (int i = paramInt1 - 1; i >= 0; i--) {
  ...
  public static void mul(int[] paramArrayOfint1, int paramInt1, int paramInt2, int[] paramArrayOfint2, int paramInt3, int paramInt4, int[] paramArrayOfint3, int paramInt5) {
    ...
    for (byte b = 1; b < paramInt2; b++)
      paramArrayOfint3[paramInt5 + b + paramInt4] = mulWordAddTo(paramInt4, paramArrayOfint1[paramInt1 + b], paramArrayOfint2, paramInt3, paramArrayOfint3, paramInt5 + b); 
  }
  
  public static int mulAddTo(int paramInt, int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    long l = 0L;
    for (byte b = 0; b < paramInt; b++) {
      l += mulWordAddTo(paramInt, paramArrayOfint1[b], paramArrayOfint2, 0, paramArrayOfint3, b) & 0xFFFFFFFFL;
      l += paramArrayOfint3[b + paramInt] & 0xFFFFFFFFL;
      paramArrayOfint3[b + paramInt] = (int)l;
      l >>>= 32L;
    } 
    return (int)l;
  }
  ...
  public static int mulAddTo(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3, int[] paramArrayOfint3, int paramInt4) {
    long l = 0L;
    for (byte b = 0; b < paramInt1; b++) {
      l += mulWordAddTo(paramInt1, paramArrayOfint1[paramInt2 + b], paramArrayOfint2, paramInt3, paramArrayOfint3, paramInt4) & 0xFFFFFFFFL;
    ...
    while (true) {
      ...
      if (k <= 0) {
        ...
        for (byte b2 = 1; b2 < paramInt; b2++) {
          l1 += squareWordAddTo(paramArrayOfint1, b2, paramArrayOfint2) & 0xFFFFFFFFL;
          l1 += paramArrayOfint2[b1] & 0xFFFFFFFFL;
          paramArrayOfint2[b1++] = (int)l1;
          l1 >>>= 32L;
          l1 += paramArrayOfint2[b1] & 0xFFFFFFFFL;
          paramArrayOfint2[b1++] = (int)l1;
          l1 >>>= 32L;
  ...
  public static void square(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3) {
    ...
    while (true) {
      ...
      if (k <= 0) {
        ...
        int n = paramInt3 + 2;
        for (byte b = 1; b < paramInt1; b++) {
          l1 += squareWordAddTo(paramArrayOfint1, paramInt2, b, paramArrayOfint2, paramInt3) & 0xFFFFFFFFL;
          l1 += paramArrayOfint2[n] & 0xFFFFFFFFL;
          paramArrayOfint2[n++] = (int)l1;
          l1 >>>= 32L;
          l1 += paramArrayOfint2[n] & 0xFFFFFFFFL;
          paramArrayOfint2[n++] = (int)l1;
          l1 >>>= 32L;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\raw\Nat.class
