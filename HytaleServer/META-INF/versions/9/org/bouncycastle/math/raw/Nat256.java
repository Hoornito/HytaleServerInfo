...
public abstract class Nat256 {
  ...
  public static void mul128(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    long l9 = 0L;
    long l10 = paramArrayOfint2[0] & 0xFFFFFFFFL;
    l9 += l10 * l1;
    paramArrayOfint3[0] = (int)l9;
    l9 >>>= 32L;
    l9 += l10 * l2;
    ...
    for (byte b = 1; b < 4; b++) {
      long l11 = 0L;
      long l12 = paramArrayOfint2[b] & 0xFFFFFFFFL;
      l11 += l12 * l1 + (paramArrayOfint3[b + 0] & 0xFFFFFFFFL);
      paramArrayOfint3[b + 0] = (int)l11;
      l11 >>>= 32L;
      l11 += l12 * l2 + (paramArrayOfint3[b + 1] & 0xFFFFFFFFL);
  ...
  public static int subFrom(int[] paramArrayOfint1, int[] paramArrayOfint2, int paramInt) {
    long l = paramInt & 0xFFFFFFFFL;
    l += (paramArrayOfint2[0] & 0xFFFFFFFFL) - (paramArrayOfint1[0] & 0xFFFFFFFFL);
    paramArrayOfint2[0] = (int)l;
    l >>= 32L;
  ...
  public static int subFrom(int[] paramArrayOfint1, int paramInt1, int[] paramArrayOfint2, int paramInt2, int paramInt3) {
    long l = paramInt3 & 0xFFFFFFFFL;
    l += (paramArrayOfint2[paramInt2 + 0] & 0xFFFFFFFFL) - (paramArrayOfint1[paramInt1 + 0] & 0xFFFFFFFFL);
    paramArrayOfint2[paramInt2 + 0] = (int)l;
    l >>= 32L;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\raw\Nat256.class
