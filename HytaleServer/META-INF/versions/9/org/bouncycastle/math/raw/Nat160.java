...
public abstract class Nat160 {
  ...
  public static int mulAddTo(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    for (byte b = 0; b < 5; b++) {
      ...
      l7 >>>= 32L;
      l6 += l7 + (paramArrayOfint3[b + 5] & 0xFFFFFFFFL);
      paramArrayOfint3[b + 5] = (int)l6;
      l6 >>>= 32L;
    } 
    return (int)l6;
  }
  ...
  public static int mulAddTo(int[] paramArrayOfint1, int paramInt1, int[] paramArrayOfint2, int paramInt2, int[] paramArrayOfint3, int paramInt3) {
    ...
    for (byte b = 0; b < 5; b++) {
      ...
      l7 >>>= 32L;
      l6 += l7 + (paramArrayOfint3[paramInt3 + 5] & 0xFFFFFFFFL);
      paramArrayOfint3[paramInt3 + 5] = (int)l6;
      l6 >>>= 32L;
      paramInt3++;
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\math\raw\Nat160.class
