    ...
    for (byte b = 0; b < 8; b++) {
      for (byte b1 = 0; b1 < 8; b1++) {
        ...
        for (byte b2 = 0; b2 < this.B; b2++) {
          k += (paramArrayOfbyte[i] >>> j & 0x1) << b2;
          i += ++j >>> 3;
          j &= 0x7;
        } 
        arrayOfShort[b * 8 + b1] = (short)(k * this.q / (1 << this.B));
      } 
    } 
    return arrayOfShort;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\frodo\FrodoEngine.class
