...
class DilithiumEngine {
  ...
  public byte[][] generateKeyPairInternal(byte[] paramArrayOfbyte) {
    ...
    return new byte[][] { arrayOfByte[0], arrayOfByte[1], arrayOfByte[2], arrayOfByte[3], arrayOfByte[4], arrayOfByte[5], arrayOfByte6 };
  }
  
  public byte[] signSignatureInternal(byte[] paramArrayOfbyte1, int paramInt, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3, byte[] paramArrayOfbyte4, byte[] paramArrayOfbyte5, byte[] paramArrayOfbyte6, byte[] paramArrayOfbyte7, byte[] paramArrayOfbyte8) {
    ...
    this.shake256Digest.doFinal(arrayOfByte2, 0, 64);
    byte[] arrayOfByte4 = Arrays.copyOf(paramArrayOfbyte3, 128);
    System.arraycopy(paramArrayOfbyte8, 0, arrayOfByte4, 32, 32);
    System.arraycopy(arrayOfByte2, 0, arrayOfByte4, 64, 64);
    this.shake256Digest.update(arrayOfByte4, 0, 128);
    ...
    while (b < 'Ϩ') {
      ...
      poly.challenge(Arrays.copyOfRange(arrayOfByte1, 0, this.DilithiumCTilde));
      poly.polyNtt();
  ...
  public boolean signVerifyInternal(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, byte[] paramArrayOfbyte3, byte[] paramArrayOfbyte4) {
    byte[] arrayOfByte2 = new byte[64];
    ...
    poly.challenge(Arrays.copyOfRange(arrayOfByte3, 0, this.DilithiumCTilde));
    ...
    return Arrays.constantTimeAreEqual(arrayOfByte3, arrayOfByte4);
  }
  ...
  public byte[] signSignature(byte[] paramArrayOfbyte1, int paramInt, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3, byte[] paramArrayOfbyte4, byte[] paramArrayOfbyte5, byte[] paramArrayOfbyte6, byte[] paramArrayOfbyte7) {
    ...
    if (this.random != null)
      this.random.nextBytes(arrayOfByte); 
    return signSignatureInternal(paramArrayOfbyte1, paramInt, paramArrayOfbyte2, paramArrayOfbyte3, paramArrayOfbyte4, paramArrayOfbyte5, paramArrayOfbyte6, paramArrayOfbyte7, arrayOfByte);
  }
  ...
  public boolean signVerify(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, byte[] paramArrayOfbyte3, byte[] paramArrayOfbyte4) {
    return signVerifyInternal(paramArrayOfbyte1, paramInt1, paramArrayOfbyte2, paramInt2, paramArrayOfbyte3, paramArrayOfbyte4);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\crystals\dilithium\DilithiumEngine.class
