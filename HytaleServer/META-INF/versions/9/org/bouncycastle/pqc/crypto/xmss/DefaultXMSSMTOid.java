...
public final class DefaultXMSSMTOid implements XMSSOid {
  ...
  static {
    ...
    hashMap.put(createKey("SHA-256", 32, 16, 67, 40, 4), new org.bouncycastle.pqc.crypto.xmss.DefaultXMSSMTOid(4, "XMSSMT_SHA2_40/4_256"));
    hashMap.put(createKey("SHA-256", 32, 16, 67, 40, 8), new org.bouncycastle.pqc.crypto.xmss.DefaultXMSSMTOid(5, "XMSSMT_SHA2_40/8_256"));
    hashMap.put(createKey("SHA-256", 32, 16, 67, 60, 3), new org.bouncycastle.pqc.crypto.xmss.DefaultXMSSMTOid(6, "XMSSMT_SHA2_60/3_256"));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\xmss\DefaultXMSSMTOid.class
