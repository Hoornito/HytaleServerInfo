...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
  ...
  public boolean verify(LMSContext paramLMSContext) {
    ...
    for (byte b = 0; b < arrayOfLMSSignedPubKey.length; b++) {
      ...
      bool &= LMS.verifySignature(lMSPublicKeyParameters, lMSSignature, arrayOfByte);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\lms\HSSPublicKeyParameters.class
