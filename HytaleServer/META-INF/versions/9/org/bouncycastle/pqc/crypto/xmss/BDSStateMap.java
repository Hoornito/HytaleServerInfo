...
public class BDSStateMap implements Serializable {
  ...
  void updateState(XMSSMTParameters paramXMSSMTParameters, long paramLong, byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    ...
    OTSHashAddress oTSHashAddress = (OTSHashAddress)((OTSHashAddress.Builder)(new OTSHashAddress.Builder()).withTreeAddress(l)).withOTSAddress(j).build();
    if (j < (1 << i) - 1) {
      if (get(0) == null || j == 0)
    ...
    for (byte b = 1; b < paramXMSSMTParameters.getLayers(); b++) {
      ...
      oTSHashAddress = (OTSHashAddress)((OTSHashAddress.Builder)((OTSHashAddress.Builder)(new OTSHashAddress.Builder()).withLayerAddress(b)).withTreeAddress(l)).withOTSAddress(j).build();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\xmss\BDSStateMap.class
