...
class Utils {
  ...
  static ASN1ObjectIdentifier slhdsaOidLookup(SLHDSAParameters paramSLHDSAParameters) {
    return (ASN1ObjectIdentifier)slhdsaOids.get(paramSLHDSAParameters);
  }
  
  static SLHDSAParameters slhdsaParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (SLHDSAParameters)slhdsaParams.get(paramASN1ObjectIdentifier);
  }
  ...
  static String sphincs256LookupTreeAlgName(SPHINCS256KeyParams paramSPHINCS256KeyParams) {
    ...
    if (algorithmIdentifier.getAlgorithm().equals((ASN1Primitive)SPHINCS_SHA512_256.getAlgorithm()))
      return "SHA-512/256"; 
    throw new IllegalArgumentException("unknown tree digest: " + String.valueOf(algorithmIdentifier.getAlgorithm()));
  }
  ...
  public static String getDigestName(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)OIWObjectIdentifiers.idSHA1))
      return "SHA-1"; 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_sha224))
      return "SHA-224"; 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_sha256))
      return "SHA-256"; 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_sha384))
      return "SHA-384"; 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_sha512))
      return "SHA-512"; 
    throw new IllegalArgumentException("unrecognised digest algorithm: " + String.valueOf(paramASN1ObjectIdentifier));
  }
  
  static ASN1ObjectIdentifier sphincsPlusOidLookup(SPHINCSPlusParameters paramSPHINCSPlusParameters) {
    return (ASN1ObjectIdentifier)sphincsPlusOids.get(paramSPHINCSPlusParameters);
  }
  
  static SPHINCSPlusParameters sphincsPlusParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (SPHINCSPlusParameters)sphincsPlusParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier mcElieceOidLookup(CMCEParameters paramCMCEParameters) {
    return (ASN1ObjectIdentifier)mcElieceOids.get(paramCMCEParameters);
  }
  
  static CMCEParameters mcElieceParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (CMCEParameters)mcElieceParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier frodoOidLookup(FrodoParameters paramFrodoParameters) {
    return (ASN1ObjectIdentifier)frodoOids.get(paramFrodoParameters);
  }
  
  static FrodoParameters frodoParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (FrodoParameters)frodoParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier saberOidLookup(SABERParameters paramSABERParameters) {
    return (ASN1ObjectIdentifier)saberOids.get(paramSABERParameters);
  }
  
  static SABERParameters saberParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (SABERParameters)saberParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier picnicOidLookup(PicnicParameters paramPicnicParameters) {
    return (ASN1ObjectIdentifier)picnicOids.get(paramPicnicParameters);
  }
  
  static PicnicParameters picnicParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (PicnicParameters)picnicParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier falconOidLookup(FalconParameters paramFalconParameters) {
    return (ASN1ObjectIdentifier)falconOids.get(paramFalconParameters);
  }
  
  static FalconParameters falconParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (FalconParameters)falconParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier ntruOidLookup(NTRUParameters paramNTRUParameters) {
    return (ASN1ObjectIdentifier)ntruOids.get(paramNTRUParameters);
  }
  
  static NTRUParameters ntruParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (NTRUParameters)ntruParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier mlkemOidLookup(MLKEMParameters paramMLKEMParameters) {
    return (ASN1ObjectIdentifier)mlkemOids.get(paramMLKEMParameters);
  }
  
  static MLKEMParameters mlkemParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (MLKEMParameters)mlkemParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier ntrulprimeOidLookup(NTRULPRimeParameters paramNTRULPRimeParameters) {
    return (ASN1ObjectIdentifier)ntruprimeOids.get(paramNTRULPRimeParameters);
  }
  
  static NTRULPRimeParameters ntrulprimeParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (NTRULPRimeParameters)ntruprimeParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier sntruprimeOidLookup(SNTRUPrimeParameters paramSNTRUPrimeParameters) {
    return (ASN1ObjectIdentifier)sntruprimeOids.get(paramSNTRUPrimeParameters);
  }
  
  static SNTRUPrimeParameters sntruprimeParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (SNTRUPrimeParameters)sntruprimeParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier mldsaOidLookup(MLDSAParameters paramMLDSAParameters) {
    return (ASN1ObjectIdentifier)mldsaOids.get(paramMLDSAParameters);
  }
  
  static MLDSAParameters mldsaParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (MLDSAParameters)mldsaParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier dilithiumOidLookup(DilithiumParameters paramDilithiumParameters) {
    return (ASN1ObjectIdentifier)dilithiumOids.get(paramDilithiumParameters);
  }
  
  static DilithiumParameters dilithiumParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (DilithiumParameters)dilithiumParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier bikeOidLookup(BIKEParameters paramBIKEParameters) {
    return (ASN1ObjectIdentifier)bikeOids.get(paramBIKEParameters);
  }
  
  static BIKEParameters bikeParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (BIKEParameters)bikeParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier hqcOidLookup(HQCParameters paramHQCParameters) {
    return (ASN1ObjectIdentifier)hqcOids.get(paramHQCParameters);
  }
  
  static HQCParameters hqcParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (HQCParameters)hqcParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier rainbowOidLookup(RainbowParameters paramRainbowParameters) {
    return (ASN1ObjectIdentifier)rainbowOids.get(paramRainbowParameters);
  }
  
  static RainbowParameters rainbowParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (RainbowParameters)rainbowParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier mayoOidLookup(MayoParameters paramMayoParameters) {
    return (ASN1ObjectIdentifier)mayoOids.get(paramMayoParameters);
  }
  
  static MayoParameters mayoParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (MayoParameters)mayoParams.get(paramASN1ObjectIdentifier);
  }
  
  static ASN1ObjectIdentifier snovaOidLookup(SnovaParameters paramSnovaParameters) {
    return (ASN1ObjectIdentifier)snovaOids.get(paramSnovaParameters);
  }
  
  static SnovaParameters snovaParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (SnovaParameters)snovaParams.get(paramASN1ObjectIdentifier);
  }
  
  private static boolean isRaw(byte[] paramArrayOfbyte) {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(paramArrayOfbyte);
    int i = byteArrayInputStream.read();
    int j = readLen(byteArrayInputStream);
    return (j != byteArrayInputStream.available());
  }
  
  static ASN1OctetString parseOctetData(byte[] paramArrayOfbyte) {
    return (!isRaw(paramArrayOfbyte) && paramArrayOfbyte[0] == 4) ? ASN1OctetString.getInstance(paramArrayOfbyte) : null;
  }
  
  static ASN1Primitive parseData(byte[] paramArrayOfbyte) {
    if (!isRaw(paramArrayOfbyte)) {
      if (paramArrayOfbyte[0] == 48)
        return (ASN1Primitive)ASN1Sequence.getInstance(paramArrayOfbyte); 
      if (paramArrayOfbyte[0] == 4)
        return (ASN1Primitive)ASN1OctetString.getInstance(paramArrayOfbyte); 
      if ((paramArrayOfbyte[0] & 0xFF) == 128)
        return (ASN1Primitive)ASN1OctetString.getInstance(ASN1TaggedObject.getInstance(paramArrayOfbyte), false); 
    } 
    return null;
  }
  
  static int readLen(ByteArrayInputStream paramByteArrayInputStream) {
    int i = paramByteArrayInputStream.read();
    if (i < 0)
      return -1; 
    if (i != (i & 0x7F)) {
      int j = i & 0x7F;
      for (i = 0; j-- != 0; i = (i << 8) + paramByteArrayInputStream.read());
    } 
    return i;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypt\\util\Utils.class
