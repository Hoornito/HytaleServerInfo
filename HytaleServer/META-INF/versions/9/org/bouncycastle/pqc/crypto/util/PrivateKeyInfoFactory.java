...
public class PrivateKeyInfoFactory {
  ...
  public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter paramAsymmetricKeyParameter, ASN1Set paramASN1Set) throws IOException {
    ...
    if (paramAsymmetricKeyParameter instanceof SLHDSAPrivateKeyParameters) {
      SLHDSAPrivateKeyParameters sLHDSAPrivateKeyParameters = (SLHDSAPrivateKeyParameters)paramAsymmetricKeyParameter;
      ...
      return new PrivateKeyInfo(algorithmIdentifier, sLHDSAPrivateKeyParameters.getEncoded(), paramASN1Set);
    } 
    ...
    if (paramAsymmetricKeyParameter instanceof MLKEMPrivateKeyParameters) {
      MLKEMPrivateKeyParameters mLKEMPrivateKeyParameters = (MLKEMPrivateKeyParameters)paramAsymmetricKeyParameter;
      ...
      return (mLKEMPrivateKeyParameters.getPreferredFormat() == 1) ? new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DERTaggedObject(false, 0, (ASN1Encodable)new DEROctetString(mLKEMPrivateKeyParameters.getSeed())), paramASN1Set) : ((mLKEMPrivateKeyParameters.getPreferredFormat() == 2) ? new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DEROctetString(mLKEMPrivateKeyParameters.getEncoded()), paramASN1Set) : new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)getBasicPQCEncoding(mLKEMPrivateKeyParameters.getSeed(), mLKEMPrivateKeyParameters.getEncoded()), paramASN1Set));
    } 
    ...
    if (paramAsymmetricKeyParameter instanceof MLDSAPrivateKeyParameters) {
      MLDSAPrivateKeyParameters mLDSAPrivateKeyParameters = (MLDSAPrivateKeyParameters)paramAsymmetricKeyParameter;
      ...
      return (mLDSAPrivateKeyParameters.getPreferredFormat() == 1) ? new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DERTaggedObject(false, 0, (ASN1Encodable)new DEROctetString(mLDSAPrivateKeyParameters.getSeed())), paramASN1Set) : ((mLDSAPrivateKeyParameters.getPreferredFormat() == 2) ? new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DEROctetString(mLDSAPrivateKeyParameters.getEncoded()), paramASN1Set) : new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)getBasicPQCEncoding(mLDSAPrivateKeyParameters.getSeed(), mLDSAPrivateKeyParameters.getEncoded()), paramASN1Set));
    } 
    ...
    if (paramAsymmetricKeyParameter instanceof MayoPrivateKeyParameters) {
      MayoPrivateKeyParameters mayoPrivateKeyParameters = (MayoPrivateKeyParameters)paramAsymmetricKeyParameter;
      ...
      byte[] arrayOfByte = mayoPrivateKeyParameters.getEncoded();
      return new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DEROctetString(arrayOfByte), paramASN1Set);
    } 
    if (paramAsymmetricKeyParameter instanceof SnovaPrivateKeyParameters) {
      SnovaPrivateKeyParameters snovaPrivateKeyParameters = (SnovaPrivateKeyParameters)paramAsymmetricKeyParameter;
      ...
      byte[] arrayOfByte = snovaPrivateKeyParameters.getEncoded();
      return new PrivateKeyInfo(algorithmIdentifier, (ASN1Encodable)new DEROctetString(arrayOfByte), paramASN1Set);
    } 
  ...
  private static ASN1Sequence getBasicPQCEncoding(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    return (ASN1Sequence)new DERSequence((ASN1Encodable)new DEROctetString(paramArrayOfbyte1), (ASN1Encodable)new DEROctetString(paramArrayOfbyte2));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypt\\util\PrivateKeyInfoFactory.class
