...
public class HQCParameters implements KEMParameters {
  public static final org.bouncycastle.pqc.crypto.hqc.HQCParameters hqc128 = new org.bouncycastle.pqc.crypto.hqc.HQCParameters("hqc-128", 17669, 46, 384, 16, 31, 15, 66, 75, 4, 243079, 2241, 2321, new int[] { 
        89, 69, 153, 116, 176, 117, 111, 75, 73, 233, 
        242, 233, 65, 210, 21, 139, 103, 173, 67, 118, 
        105, 210, 174, 110, 74, 69, 228, 82, 255, 181, 
        1 });
  
  public static final org.bouncycastle.pqc.crypto.hqc.HQCParameters hqc192 = new org.bouncycastle.pqc.crypto.hqc.HQCParameters("hqc-192", 35851, 56, 640, 24, 33, 16, 100, 114, 5, 119800, 4514, 4602, new int[] { 
        45, 216, 239, 24, 253, 104, 27, 40, 107, 50, 
        163, 210, 227, 134, 224, 158, 119, 13, 158, 1, 
        238, 164, 82, 43, 15, 232, 246, 142, 50, 189, 
        29, 232, 1 });
  
  public static final org.bouncycastle.pqc.crypto.hqc.HQCParameters hqc256 = new org.bouncycastle.pqc.crypto.hqc.HQCParameters("hqc-256", 57637, 90, 640, 32, 59, 29, 131, 149, 5, 74517, 7237, 7333, new int[] { 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\hqc\HQCParameters.class
