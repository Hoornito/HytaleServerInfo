...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
  ...
  public HSSPrivateKeyParameters(LMSPrivateKeyParameters paramLMSPrivateKeyParameters, long paramLong1, long paramLong2) {
    super(true);
    this.keys = Collections.singletonList(paramLMSPrivateKeyParameters);
  ...
  public static org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters getInstance(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) throws IOException {
    org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters hSSPrivateKeyParameters = getInstance(paramArrayOfbyte1);
  ...
  public static org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters getInstance(Object paramObject) throws IOException {
    if (paramObject instanceof org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters)
      return (org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters)paramObject; 
    if (paramObject instanceof DataInputStream) {
      ...
      return new org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters(i, arrayList, arrayList1, l1, l2, bool);
    } 
    ...
    throw new IllegalArgumentException("cannot parse " + String.valueOf(paramObject));
  }
  ...
  public org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters extractKeyShard(int paramInt) {
    synchronized (this) {
      ...
      if (paramInt > this.indexLimit - this.index)
        throw new IllegalArgumentException("usageCount exceeds usages remaining in current leaf"); 
      long l1 = this.index;
      long l2 = this.index + paramInt;
      this.index = l2;
      ArrayList<LMSPrivateKeyParameters> arrayList = new ArrayList<>(getKeys());
      ArrayList<LMSSignature> arrayList1 = new ArrayList<>(getSig());
      org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters hSSPrivateKeyParameters = makeCopy(new org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters(this.l, arrayList, arrayList1, l1, l2, true));
      resetKeyToIndex();
      return hSSPrivateKeyParameters;
    } 
  }
  ...
  void resetKeyToIndex() {
    ...
    for (byte b = 1; b < arrayOfLong.length; b++) {
      ...
      int j = lMSPrivateKeyParameters1.getOtsParameters().getN();
      byte[] arrayOfByte1 = new byte[16];
      byte[] arrayOfByte2 = new byte[j];
      SeedDerive seedDerive = new SeedDerive(lMSPrivateKeyParameters1.getI(), lMSPrivateKeyParameters1.getMasterSecret(), DigestUtil.getDigest(lMSPrivateKeyParameters1.getOtsParameters()));
  ...
  void replaceConsumedKey(int paramInt) {
    LMOtsPrivateKey lMOtsPrivateKey = ((LMSPrivateKeyParameters)this.keys.get(paramInt - 1)).getCurrentOTSKey();
    int i = lMOtsPrivateKey.getParameter().getN();
    ...
    ArrayList<LMSPrivateKeyParameters> arrayList = new ArrayList<>(this.keys);
    ...
    ArrayList<LMSSignature> arrayList1 = new ArrayList<>(this.sig);
  ...
  public boolean equals(Object paramObject) {
    ...
    if (paramObject == null || getClass() != paramObject.getClass())
      return false; 
    org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters hSSPrivateKeyParameters = (org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters)paramObject;
  ...
  public synchronized byte[] getEncoded() throws IOException {
    ...
    for (LMSPrivateKeyParameters lMSPrivateKeyParameters : this.keys)
      composer.bytes((Encodable)lMSPrivateKeyParameters); 
    for (LMSSignature lMSSignature : this.sig)
      composer.bytes((Encodable)lMSSignature); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\lms\HSSPrivateKeyParameters.class
