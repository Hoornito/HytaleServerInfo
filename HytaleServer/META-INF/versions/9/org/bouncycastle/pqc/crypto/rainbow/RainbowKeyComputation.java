...
class RainbowKeyComputation {
  ...
  private void genKeyMaterial() {
    ...
    generate_S_and_T((SecureRandom)rainbowDRBG);
    this.l1_F1 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o1, this.v1, this.v1, true);
    this.l1_F2 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o1, this.v1, this.o1, false);
    this.l2_F1 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o2, this.v1, this.v1, true);
    this.l2_F2 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o2, this.v1, this.o1, false);
    this.l2_F3 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o2, this.v1, this.o2, false);
    this.l2_F5 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o2, this.o1, this.o1, true);
    this.l2_F6 = RainbowUtil.generate_random((SecureRandom)rainbowDRBG, this.o2, this.o1, this.o2, false);
    calculate_Q_from_F();
    calculate_t4();
  ...
  private void genPrivateKeyMaterial_cyclic() {
    ...
    generate_S_and_T((SecureRandom)rainbowDRBG1);
    calculate_t4();
    generate_B1_and_B2((SecureRandom)rainbowDRBG2);
    this.l1_Q1 = this.cf.obfuscate_l1_polys(this.s1, this.l2_Q1, this.l1_Q1);
    this.l1_Q2 = this.cf.obfuscate_l1_polys(this.s1, this.l2_Q2, this.l1_Q2);
    calculate_F_from_Q();
  }
  ...
  public AsymmetricCipherKeyPair genKeyPairClassical() {
    ...
    return new AsymmetricCipherKeyPair((AsymmetricKeyParameter)rainbowPublicKeyParameters, (AsymmetricKeyParameter)rainbowPrivateKeyParameters);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\rainbow\RainbowKeyComputation.class
