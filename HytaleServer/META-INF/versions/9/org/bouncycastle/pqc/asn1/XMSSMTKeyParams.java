...
public class XMSSMTKeyParams extends ASN1Object {
  ...
  private XMSSMTKeyParams(ASN1Sequence paramASN1Sequence) {
    ...
    this.layers = ASN1Integer.getInstance(paramASN1Sequence.getObjectAt(2)).intValueExact();
  ...
  public static org.bouncycastle.pqc.asn1.XMSSMTKeyParams getInstance(Object paramObject) {
    return (paramObject instanceof org.bouncycastle.pqc.asn1.XMSSMTKeyParams) ? (org.bouncycastle.pqc.asn1.XMSSMTKeyParams)paramObject : ((paramObject != null) ? new org.bouncycastle.pqc.asn1.XMSSMTKeyParams(ASN1Sequence.getInstance(paramObject)) : null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\asn1\XMSSMTKeyParams.class
