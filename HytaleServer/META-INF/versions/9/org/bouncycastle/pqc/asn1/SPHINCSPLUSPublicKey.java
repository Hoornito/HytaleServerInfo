...
public class SPHINCSPLUSPublicKey extends ASN1Object {
  ...
  public static org.bouncycastle.pqc.asn1.SPHINCSPLUSPublicKey getInstance(Object paramObject) {
    return (paramObject instanceof org.bouncycastle.pqc.asn1.SPHINCSPLUSPublicKey) ? (org.bouncycastle.pqc.asn1.SPHINCSPLUSPublicKey)paramObject : ((paramObject != null) ? new org.bouncycastle.pqc.asn1.SPHINCSPLUSPublicKey(ASN1Sequence.getInstance(paramObject)) : null);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\asn1\SPHINCSPLUSPublicKey.class
