...
public class BCHQCPrivateKey implements PrivateKey, HQCKey {
  ...
  public BCHQCPrivateKey(HQCPrivateKeyParameters paramHQCPrivateKeyParameters) {
    this.params = paramHQCPrivateKeyParameters;
  }
  
  public BCHQCPrivateKey(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
  ...
  private void init(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    ...
    this.params = (HQCPrivateKeyParameters)PrivateKeyFactory.createKey(paramPrivateKeyInfo);
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPrivateKey bCHQCPrivateKey = (org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\hqc\BCHQCPrivateKey.class
