...
public class BCBIKEPublicKey implements PublicKey, BIKEKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.bike.BCBIKEPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.bike.BCBIKEPublicKey bCBIKEPublicKey = (org.bouncycastle.pqc.jcajce.provider.bike.BCBIKEPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\bike\BCBIKEPublicKey.class
