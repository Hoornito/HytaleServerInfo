...
public class BCSnovaPublicKey implements PublicKey, SnovaKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPublicKey bCSnovaPublicKey = (org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\snova\BCSnovaPublicKey.class
