...
public class BouncyCastlePQCProvider extends Provider implements ConfigurableProvider {
  ...
  private static final String[] ALGORITHMS = new String[] { 
      "SPHINCS", "LMS", "NH", "XMSS", "SPHINCSPlus", "CMCE", "Frodo", "SABER", "Picnic", "NTRU", 
      "Falcon", "Kyber", "Dilithium", "NTRUPrime", "BIKE", "HQC", "Rainbow", "Mayo", "Snova" };
  
  public BouncyCastlePQCProvider() {
    super(PROVIDER_NAME, 1.83D, info);
  ...
  private void loadAlgorithms(String paramString, String[] paramArrayOfString) {
    for (byte b = 0; b != paramArrayOfString.length; b++) {
      Class<AlgorithmProvider> clazz = loadClass(org.bouncycastle.pqc.jcajce.provider.BouncyCastlePQCProvider.class, paramString + paramString + "$Mappings");
      if (clazz != null)
        try {
          ((AlgorithmProvider)clazz.newInstance()).configure(this);
        } catch (Exception exception) {
          throw new InternalError("cannot create instance of " + paramString + paramArrayOfString[b] + "$Mappings : " + String.valueOf(exception));
        }  
    } 
  }
  ...
  public void addAlgorithm(String paramString1, ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString2) {
    if (!containsKey(paramString1 + "." + paramString1))
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\BouncyCastlePQCProvider.class
