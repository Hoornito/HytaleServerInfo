...
public class BCCMCEPublicKey implements PublicKey, CMCEKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPublicKey bCCMCEPublicKey = (org.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\cmce\BCCMCEPublicKey.class
