...
public class BCXMSSPrivateKey implements PrivateKey, XMSSPrivateKey {
  ...
  public XMSSPrivateKey extractKeyShard(int paramInt) {
    return new org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSPrivateKey(this.treeDigest, this.keyParams.extractKeyShard(paramInt));
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSPrivateKey bCXMSSPrivateKey = (org.bouncycastle.pqc.jcajce.provider.xmss.BCXMSSPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\xmss\BCXMSSPrivateKey.class
