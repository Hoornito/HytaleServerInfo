...
public class BCNTRUPrivateKey implements PrivateKey, NTRUKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.ntru.BCNTRUPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.ntru.BCNTRUPrivateKey bCNTRUPrivateKey = (org.bouncycastle.pqc.jcajce.provider.ntru.BCNTRUPrivateKey)paramObject;
