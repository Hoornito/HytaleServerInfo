...
public class BCMayoPrivateKey implements PrivateKey, MayoKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.mayo.BCMayoPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.mayo.BCMayoPrivateKey bCMayoPrivateKey = (org.bouncycastle.pqc.jcajce.provider.mayo.BCMayoPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\mayo\BCMayoPrivateKey.class
