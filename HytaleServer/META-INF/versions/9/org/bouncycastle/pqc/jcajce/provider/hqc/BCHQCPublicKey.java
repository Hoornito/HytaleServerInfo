...
public class BCHQCPublicKey implements PublicKey, HQCKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPublicKey bCHQCPublicKey = (org.bouncycastle.pqc.jcajce.provider.hqc.BCHQCPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\hqc\BCHQCPublicKey.class
