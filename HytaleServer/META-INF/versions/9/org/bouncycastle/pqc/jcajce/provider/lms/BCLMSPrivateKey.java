...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
  ...
  public BCLMSPrivateKey(LMSKeyParameters paramLMSKeyParameters) {
    this.keyParams = (paramLMSKeyParameters instanceof HSSPrivateKeyParameters) ? paramLMSKeyParameters : (LMSKeyParameters)new HSSPrivateKeyParameters((LMSPrivateKeyParameters)paramLMSKeyParameters, ((LMSPrivateKeyParameters)paramLMSKeyParameters).getIndex(), ((LMSPrivateKeyParameters)paramLMSKeyParameters).getIndex() + ((LMSPrivateKeyParameters)paramLMSKeyParameters).getUsagesRemaining());
  }
  ...
  public LMSPrivateKey extractKeyShard(int paramInt) {
    return (this.keyParams instanceof LMSPrivateKeyParameters) ? new org.bouncycastle.pqc.jcajce.provider.lms.BCLMSPrivateKey((LMSKeyParameters)((LMSPrivateKeyParameters)this.keyParams).extractKeyShard(paramInt)) : new org.bouncycastle.pqc.jcajce.provider.lms.BCLMSPrivateKey((LMSKeyParameters)((HSSPrivateKeyParameters)this.keyParams).extractKeyShard(paramInt));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\lms\BCLMSPrivateKey.class
