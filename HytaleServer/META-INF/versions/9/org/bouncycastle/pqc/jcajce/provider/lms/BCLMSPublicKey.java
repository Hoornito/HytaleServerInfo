...
public class BCLMSPublicKey implements PublicKey, LMSKey {
  ...
  public BCLMSPublicKey(LMSKeyParameters paramLMSKeyParameters) {
    this.keyParams = (paramLMSKeyParameters instanceof HSSPublicKeyParameters) ? paramLMSKeyParameters : (LMSKeyParameters)new HSSPublicKeyParameters(1, (LMSPublicKeyParameters)paramLMSKeyParameters);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\lms\BCLMSPublicKey.class
