...
public class BCSnovaPrivateKey implements PrivateKey, SnovaKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPrivateKey bCSnovaPrivateKey = (org.bouncycastle.pqc.jcajce.provider.snova.BCSnovaPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\snova\BCSnovaPrivateKey.class
