...
public class BCDilithiumPublicKey implements DilithiumPublicKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPublicKey bCDilithiumPublicKey = (org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\dilithium\BCDilithiumPublicKey.class
