...
public class BCPicnicPublicKey implements PublicKey, PicnicKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.picnic.BCPicnicPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.picnic.BCPicnicPublicKey bCPicnicPublicKey = (org.bouncycastle.pqc.jcajce.provider.picnic.BCPicnicPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\picnic\BCPicnicPublicKey.class
