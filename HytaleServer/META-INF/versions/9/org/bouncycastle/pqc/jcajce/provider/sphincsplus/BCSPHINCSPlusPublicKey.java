...
public class BCSPHINCSPlusPublicKey implements SPHINCSPlusPublicKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.sphincsplus.BCSPHINCSPlusPublicKey) {
      org.bouncycastle.pqc.jcajce.provider.sphincsplus.BCSPHINCSPlusPublicKey bCSPHINCSPlusPublicKey = (org.bouncycastle.pqc.jcajce.provider.sphincsplus.BCSPHINCSPlusPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\sphincsplus\BCSPHINCSPlusPublicKey.class
