...
public class BCDilithiumPrivateKey implements DilithiumPrivateKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPrivateKey) {
      org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPrivateKey bCDilithiumPrivateKey = (org.bouncycastle.pqc.jcajce.provider.dilithium.BCDilithiumPrivateKey)paramObject;
  ...
  public DilithiumPublicKey getPublicKey() {
    return (DilithiumPublicKey)new BCDilithiumPublicKey(this.params.getPublicKeyParameters());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\9\org\bouncycastle\pqc\jcajce\provider\dilithium\BCDilithiumPrivateKey.class
