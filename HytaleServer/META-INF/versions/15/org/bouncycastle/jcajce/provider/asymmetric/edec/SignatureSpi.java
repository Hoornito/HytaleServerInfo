...
public class SignatureSpi extends SignatureSpi {
  ...
  static Ed25519PrivateKeyParameters getEd25519PrivateKey(byte[] paramArrayOfbyte) throws InvalidKeyException {
  ...
  static Ed25519PublicKeyParameters getEd25519PublicKey(EdECPoint paramEdECPoint) throws InvalidKeyException {
    byte[] arrayOfByte = getPublicKeyData(32, paramEdECPoint);
    return new Ed25519PublicKeyParameters(arrayOfByte, 0);
  }
  
  static Ed448PrivateKeyParameters getEd448PrivateKey(byte[] paramArrayOfbyte) throws InvalidKeyException {
  ...
  static Ed448PublicKeyParameters getEd448PublicKey(EdECPoint paramEdECPoint) throws InvalidKeyException {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\15\org\bouncycastle\jcajce\provider\asymmetric\edec\SignatureSpi.class
