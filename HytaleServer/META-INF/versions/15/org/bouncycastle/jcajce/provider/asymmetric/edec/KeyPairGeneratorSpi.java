...
public class KeyPairGeneratorSpi extends KeyPairGeneratorSpi {
  ...
  public void initialize(AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom) throws InvalidAlgorithmParameterException {
    ...
    if (null == str)
      throw new InvalidAlgorithmParameterException("invalid parameterSpec: " + String.valueOf(paramAlgorithmParameterSpec)); 
  ...
  public KeyPair generateKeyPair() {
    ...
    switch (this.algorithmInitialized) {
      case 1:
      case 2:
        return new KeyPair((PublicKey)new BC15EdDSAPublicKey(asymmetricCipherKeyPair.getPublic()), (PrivateKey)new BC15EdDSAPrivateKey(asymmetricCipherKeyPair.getPrivate()));
      case 3:
      case 4:
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\META-INF\versions\15\org\bouncycastle\jcajce\provider\asymmetric\edec\KeyPairGeneratorSpi.class
