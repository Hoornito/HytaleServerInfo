...
/* 133 */     TrafficCounter trafficCounter = new TrafficCounter(this, (ScheduledExecutorService)ctx.executor(), "ChannelTC" + ctx.channel().hashCode(), this.checkInterval);
...
/*     */         {
/*     */           public void run() {
/* 198 */             ChannelTrafficShapingHandler.this.sendAllValid(ctx, futureNow);
/*     */           }
...
/* 206 */       ToSend newToSend = this.messagesQueue.pollFirst();
/* 207 */       for (; newToSend != null; newToSend = this.messagesQueue.pollFirst()) {
