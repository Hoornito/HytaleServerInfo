...
/*  89 */     this.encoder = new Encoder(preferDirect, outboundMessageType);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 166 */       super(outboundMessageType, preferDirect);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean acceptOutboundMessage(Object msg) throws Exception {
/* 171 */       return ByteToMessageCodec.this.acceptOutboundMessage(msg);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void encode(ChannelHandlerContext ctx, I msg, ByteBuf out) throws Exception {
/* 176 */       ByteToMessageCodec.this.encode(ctx, msg, out);
/*     */     }
/*     */   }
/*     */ }
