...
/* 247 */     return (buf.getByte(offset) & 0xFF) << 8 | buf
/* 248 */       .getByte(offset + 1) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 255 */     return (buf.getByte(offset) & 0xFF) << 16 | (buf
/* 256 */       .getByte(offset + 1) & 0xFF) << 8 | buf
/* 257 */       .getByte(offset + 2) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 264 */     return (buf.getByte(offset) & Byte.MAX_VALUE) << 24 | (buf
/* 265 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 266 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 267 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 274 */     return (buf.getByte(offset) & 0xFF) << 24 | (buf
/* 275 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 276 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 277 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 292 */     ObjectUtil.checkNonEmpty(name, "name");
/*     */ 
/*     */     
/* 295 */     if (name.length() > 65535) {
/* 296 */       throw new IllegalArgumentException("name exceeds allowable length: " + name);
/*     */     }
/*     */     
/* 299 */     for (int i = 0; i < name.length(); i++) {
/* 300 */       char c = name.charAt(i);
/* 301 */       if (c == '\000') {
/* 302 */         throw new IllegalArgumentException("name contains null character: " + name);
/*     */       }
/*     */       
/* 305 */       if (c >= 'A' && c <= 'Z') {
...
/*     */       }
/* 308 */       if (c > '') {
/* 309 */         throw new IllegalArgumentException("name contains non-ascii character: " + name);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 319 */     ObjectUtil.checkNotNull(value, "value");
/* 320 */     for (int i = 0; i < value.length(); i++) {
/* 321 */       char c = value.charAt(i);
/* 322 */       if (c == '\000')
/* 323 */         throw new IllegalArgumentException("value contains null character"); 
/*     */     } 
/*     */   }
/*     */ }
