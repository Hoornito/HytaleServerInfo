...
/*     */   
/*     */   private int mask;
/*  62 */   private final Set<Short> keySet = new KeySet();
/*  63 */   private final Set<Map.Entry<Short, V>> entrySet = new EntrySet();
/*  64 */   private final Iterable<ShortObjectMap.PrimitiveEntry<V>> entries = new Iterable<ShortObjectMap.PrimitiveEntry<V>>()
/*     */     {
/*     */       public Iterator<ShortObjectMap.PrimitiveEntry<V>> iterator() {
/*  67 */         return new ShortObjectHashMap.PrimitiveIterator();
/*     */       }
/*     */     };
/*     */   
...
/*     */ 
/*     */       
/* 151 */       ShortObjectHashMap<V> source = (ShortObjectHashMap)sourceMap;
...
/* 225 */               final ShortObjectHashMap<V>.PrimitiveIterator iter = new ShortObjectHashMap.PrimitiveIterator();
/*     */ 
/*     */               
...
/* 522 */       return new ShortObjectHashMap.MapIterator();
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
...
/* 554 */         ShortObjectMap.PrimitiveEntry<V> entry = iter.next();
...
/*     */     
/*     */     public V value() {
/* 650 */       return (V)ShortObjectHashMap.toExternal((T)ShortObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */ 
/*     */     
/*     */     public void setValue(V value) {
/* 655 */       ShortObjectHashMap.this.values[this.entryIndex] = ShortObjectHashMap.toInternal((T)value);
/*     */     }
/*     */     
...
/* 663 */     private final ShortObjectHashMap<V>.PrimitiveIterator iter = new ShortObjectHashMap.PrimitiveIterator();
/*     */ 
/*     */     
/*     */     public boolean hasNext() {
...
/* 676 */       this.iter.next();
/*     */       
/* 678 */       return new ShortObjectHashMap.MapEntry(this.iter.entryIndex);
/*     */     }
/*     */ 
/*     */     
/*     */     public void remove() {
...
/*     */     public V getValue() {
/* 705 */       verifyExists();
/* 706 */       return (V)ShortObjectHashMap.toExternal((T)ShortObjectHashMap.this.values[this.entryIndex]);
/*     */     }
/*     */ 
/*     */     
/*     */     public V setValue(V value) {
/* 711 */       verifyExists();
/* 712 */       V prevValue = (V)ShortObjectHashMap.toExternal((T)ShortObjectHashMap.this.values[this.entryIndex]);
/* 713 */       ShortObjectHashMap.this.values[this.entryIndex] = ShortObjectHashMap.toInternal((T)value);
