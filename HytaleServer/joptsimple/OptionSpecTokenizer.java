...
/*     */       } 
/*     */       
/*  80 */       spec = (hasMore() && this.specification.charAt(this.index) == ':') ? handleArgumentAcceptingOption(optionCandidate) : new NoArgumentOptionSpec(optionCandidate);
/*     */       
/*  82 */       if (forHelp)
/*  83 */         spec.forHelp(); 
/*     */     } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\joptsimple\OptionSpecTokenizer.class
