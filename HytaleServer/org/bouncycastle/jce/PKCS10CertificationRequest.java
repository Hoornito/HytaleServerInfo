...
public class PKCS10CertificationRequest extends CertificationRequest {
  ...
  private static RSASSAPSSparams creatPSSParams(AlgorithmIdentifier paramAlgorithmIdentifier, int paramInt) {
    return new RSASSAPSSparams(paramAlgorithmIdentifier, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, (ASN1Encodable)paramAlgorithmIdentifier), new ASN1Integer(paramInt), RSASSAPSSparams.DEFAULT_TRAILER_FIELD);
  }
  ...
  public PKCS10CertificationRequest(String paramString1, X509Name paramX509Name, PublicKey paramPublicKey, ASN1Set paramASN1Set, PrivateKey paramPrivateKey, String paramString2) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException {
    ...
    this.sigBits = (ASN1BitString)new DERBitString(signature.sign());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\PKCS10CertificationRequest.class
