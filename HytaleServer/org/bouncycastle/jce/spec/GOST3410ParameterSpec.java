...
public class GOST3410ParameterSpec implements AlgorithmParameterSpec, GOST3410Params {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject instanceof GOST3410ParameterSpec) {
      ...
      return (this.keyParameters.equals(gOST3410ParameterSpec.keyParameters) && (this.digestParamSetOID == gOST3410ParameterSpec.digestParamSetOID || (this.digestParamSetOID != null && this.digestParamSetOID.equals(gOST3410ParameterSpec.digestParamSetOID))) && (this.encryptionParamSetOID == gOST3410ParameterSpec.encryptionParamSetOID || (this.encryptionParamSetOID != null && this.encryptionParamSetOID.equals(gOST3410ParameterSpec.encryptionParamSetOID))));
    } 
    return false;
  }
  ...
  public static GOST3410ParameterSpec fromPublicKeyAlg(GOST3410PublicKeyAlgParameters paramGOST3410PublicKeyAlgParameters) {
    return (paramGOST3410PublicKeyAlgParameters.getEncryptionParamSet() != null) ? new GOST3410ParameterSpec(paramGOST3410PublicKeyAlgParameters.getPublicKeyParamSet().getId(), paramGOST3410PublicKeyAlgParameters.getDigestParamSet().getId(), paramGOST3410PublicKeyAlgParameters.getEncryptionParamSet().getId()) : ((paramGOST3410PublicKeyAlgParameters.getDigestParamSet() != null) ? new GOST3410ParameterSpec(paramGOST3410PublicKeyAlgParameters.getPublicKeyParamSet().getId(), paramGOST3410PublicKeyAlgParameters.getDigestParamSet().getId()) : new GOST3410ParameterSpec(paramGOST3410PublicKeyAlgParameters.getPublicKeyParamSet().getId(), null));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\spec\GOST3410ParameterSpec.class
