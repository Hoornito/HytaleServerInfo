...
public class X509CRLObject extends X509CRL {
  ...
  public X509CRLObject(CertificateList paramCertificateList) throws CRLException {
    ...
    if (getVersion() == 2) {
      ...
      if (extensions != null) {
        ...
        while (enumeration.hasMoreElements()) {
          ...
          if (Extension.issuingDistributionPoint.equals((ASN1Primitive)aSN1ObjectIdentifier) || Extension.deltaCRLIndicator.equals((ASN1Primitive)aSN1ObjectIdentifier))
            continue; 
  ...
  public String toString() {
    ...
    stringBuilder.append("              Version: ").append(getVersion()).append(str);
    stringBuilder.append("             IssuerDN: ").append(getIssuerDN()).append(str);
    stringBuilder.append("          This update: ").append(getThisUpdate()).append(str);
    stringBuilder.append("          Next update: ").append(getNextUpdate()).append(str);
    ...
    if (extensions != null) {
      ...
      if (enumeration.hasMoreElements())
        stringBuilder.append("           Extensions: ").append(str); 
      while (enumeration.hasMoreElements()) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = enumeration.nextElement();
        Extension extension = extensions.getExtension(aSN1ObjectIdentifier);
        if (extension.getExtnValue() != null) {
          ...
          try {
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)Extension.cRLNumber)) {
              stringBuilder.append(new CRLNumber(ASN1Integer.getInstance(aSN1InputStream.readObject()).getPositiveValue())).append(str);
              continue;
            } 
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)Extension.deltaCRLIndicator)) {
              stringBuilder.append("Base CRL: " + new CRLNumber(ASN1Integer.getInstance(aSN1InputStream.readObject()).getPositiveValue())).append(str);
              continue;
            } 
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)Extension.issuingDistributionPoint)) {
              stringBuilder.append(IssuingDistributionPoint.getInstance(aSN1InputStream.readObject())).append(str);
              continue;
            } 
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)Extension.cRLDistributionPoints)) {
              stringBuilder.append(CRLDistPoint.getInstance(aSN1InputStream.readObject())).append(str);
              continue;
            } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\X509CRLObject.class
