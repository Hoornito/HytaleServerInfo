...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
              ...
              if (bool || validatedOcspResponse(basicOCSPResponse, this.parameters, arrayOfByte, this.parent.getOcspResponderCert(), this.helper)) {
                ...
                for (byte b = 0; b != aSN1Sequence.size(); b++) {
                  ...
                  if (aSN1Integer.equals((ASN1Primitive)singleResponse.getCertID().getSerialNumber())) {
                    ...
                    if (certID == null || !isEqualAlgId(certID.getHashAlgorithm(), singleResponse.getCertID().getHashAlgorithm())) {
                      Certificate certificate = extractCert();
  ...
  private static boolean isEqualAlgId(AlgorithmIdentifier paramAlgorithmIdentifier1, AlgorithmIdentifier paramAlgorithmIdentifier2) {
    if (paramAlgorithmIdentifier1 == paramAlgorithmIdentifier2 || paramAlgorithmIdentifier1.equals(paramAlgorithmIdentifier2))
      return true; 
    if (paramAlgorithmIdentifier1.getAlgorithm().equals((ASN1Primitive)paramAlgorithmIdentifier2.getAlgorithm())) {
      ...
      return (aSN1Encodable1 == aSN1Encodable2) ? true : ((aSN1Encodable1 == null) ? DERNull.INSTANCE.equals(aSN1Encodable2) : ((DERNull.INSTANCE.equals(aSN1Encodable1) && aSN1Encodable2 == null) ? true : aSN1Encodable1.equals(aSN1Encodable2)));
    } 
    return false;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\ProvOcspRevocationChecker.class
