...
public class PKIXCertPathValidatorSpi_8 extends CertPathValidatorSpi {
  ...
  public PKIXCertPathValidatorSpi_8(boolean paramBoolean) {
  ...
  public CertPathValidatorResult engineValidate(CertPath paramCertPath, CertPathParameters paramCertPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
    ...
    Date date1 = new Date();
    Date date2 = CertPathValidatorUtilities.getValidityDate(pKIXExtendedParameters, date1);
    ...
    ArrayList<PKIXCertPathChecker> arrayList = new ArrayList();
    ...
    try {
      ...
      throw new ExtCertPathValidatorException("Subject of trust anchor could not be (re)encoded.", runtimeException, paramCertPath, -1);
    } 
    ...
    for (j = list.size() - 1; j >= 0; j--) {
      ...
      RFC3280CertPathUtilities.processCertA(paramCertPath, pKIXExtendedParameters, date2, pKIXCertRevocationChecker, j, publicKey, bool, x500Name, x509Certificate1);
      RFC3280CertPathUtilities.processCertBC(paramCertPath, j, pKIXNameConstraintValidator, this.isForCRLCheck);
      pKIXPolicyNode1 = RFC3280CertPathUtilities.processCertD(paramCertPath, j, hashSet1, pKIXPolicyNode1, (List[])arrayOfArrayList, m, this.isForCRLCheck);
      ...
      if (i2 != i)
        if (x509Certificate2 != null && x509Certificate2.getVersion() == 1) {
          ...
          RFC3280CertPathUtilities.prepareNextCertO(paramCertPath, j, set2, arrayList);
    ...
    RFC3280CertPathUtilities.wrapupCertF(paramCertPath, j + 1, arrayList, set1);
  ...
  static void checkCertificate(X509Certificate paramX509Certificate) throws AnnotatedException {
    if (paramX509Certificate instanceof BCX509Certificate) {
      RuntimeException runtimeException = null;
      try {
        if (null != ((BCX509Certificate)paramX509Certificate).getTBSCertificateNative())
          return; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\PKIXCertPathValidatorSpi_8.class
