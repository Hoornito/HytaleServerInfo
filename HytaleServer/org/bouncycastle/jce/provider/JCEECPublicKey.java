...
public class JCEECPublicKey implements ECPublicKey, ECPublicKey, ECPointEncoder {
  ...
  public JCEECPublicKey(String paramString, ECPublicKeySpec paramECPublicKeySpec) {
    ...
    this.q = EC5Util.convertPoint(this.ecSpec, paramECPublicKeySpec.getW());
  }
  ...
  public JCEECPublicKey(ECPublicKey paramECPublicKey) {
    ...
    this.q = EC5Util.convertPoint(this.ecSpec, paramECPublicKey.getW());
  }
  ...
  private void populateFromPubKeyInfo(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) {
    ...
    if (algorithmIdentifier.getAlgorithm().equals((ASN1Primitive)CryptoProObjectIdentifiers.gostR3410_2001)) {
      ...
      byte[] arrayOfByte2 = new byte[65];
      arrayOfByte2[0] = 4;
      for (byte b = 1; b <= 32; b++) {
        arrayOfByte2[b] = arrayOfByte1[32 - b];
        arrayOfByte2[b + 32] = arrayOfByte1[64 - b];
      } 
      ...
      this.q = eCCurve.decodePoint(arrayOfByte2);
  ...
  public byte[] getEncoded() {
    ...
    if (this.algorithm.equals("ECGOST3410")) {
      ...
      byte[] arrayOfByte = getQ().getEncoded(this.withCompression);
      subjectPublicKeyInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable)x962Parameters), arrayOfByte);
    } 
  ...
  public String toString() {
    ...
    stringBuilder.append("EC Public Key").append(str);
    stringBuilder.append("            X: ").append(this.q.getAffineXCoord().toBigInteger().toString(16)).append(str);
    stringBuilder.append("            Y: ").append(this.q.getAffineYCoord().toBigInteger().toString(16)).append(str);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\JCEECPublicKey.class
