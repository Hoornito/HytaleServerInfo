...
public class PKIXAttrCertPathValidatorSpi extends CertPathValidatorSpi {
  ...
  public CertPathValidatorResult engineValidate(CertPath paramCertPath, CertPathParameters paramCertPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
    ...
    RFC3281CertPathUtilities.processAttrCert5(x509AttributeCertificate, date2);
    ...
    RFC3281CertPathUtilities.checkCRLs(x509AttributeCertificate, pKIXExtendedParameters, date1, date2, x509Certificate, paramCertPath.getCertificates(), this.helper);
    return certPathValidatorResult;
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\PKIXAttrCertPathValidatorSpi.class
