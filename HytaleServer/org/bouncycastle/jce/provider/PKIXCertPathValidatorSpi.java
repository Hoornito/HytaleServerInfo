...
public class PKIXCertPathValidatorSpi extends CertPathValidatorSpi {
  ...
  public PKIXCertPathValidatorSpi(boolean paramBoolean) {
  ...
  public CertPathValidatorResult engineValidate(CertPath paramCertPath, CertPathParameters paramCertPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
    ...
    if (pKIXExtendedParameters.isRevocationEnabled()) {
      pKIXCertRevocationChecker = new ProvCrlRevocationChecker(this.helper);
    } else {
      pKIXCertRevocationChecker = null;
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\provider\PKIXCertPathValidatorSpi.class
