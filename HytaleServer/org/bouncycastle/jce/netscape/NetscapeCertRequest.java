...
public class NetscapeCertRequest extends ASN1Object {
  ...
  public NetscapeCertRequest(ASN1Sequence paramASN1Sequence) {
    try {
      ...
      this.challenge = ((ASN1IA5String)aSN1Sequence.getObjectAt(1)).getString();
  ...
  public boolean verify(String paramString) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
    ...
    signature.update(this.content.getOctets());
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jce\netscape\NetscapeCertRequest.class
