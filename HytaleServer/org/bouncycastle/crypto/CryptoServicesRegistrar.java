...
public final class CryptoServicesRegistrar {
  ...
  private static final CryptoServicesConstraints noConstraintsImpl = new CryptoServicesConstraints() {
      public void check(CryptoServiceProperties param1CryptoServiceProperties) {}
    };
  ...
  private static Object[] lookupProperty(Property paramProperty) {
    ...
    if (map == null || !map.containsKey(paramProperty.name)) {
      arrayOfObject = globalProperties.get(paramProperty.name);
    } else {
      arrayOfObject = (Object[])map.get(paramProperty.name);
    } 
  ...
  public static <T> T getSizedProperty(Property paramProperty, int paramInt) {
    ...
    if (arrayOfObject == null)
      return null; 
    if (paramProperty.type.isAssignableFrom(DHParameters.class)) {
    ...
    } else if (paramProperty.type.isAssignableFrom(DSAParameters.class)) {
      for (byte b = 0; b != arrayOfObject.length; b++) {
  ...
  public static <T> void setThreadProperty(Property paramProperty, T... paramVarArgs) {
    ...
    if (!paramProperty.type.isAssignableFrom(paramVarArgs[0].getClass()))
  ...
  private static <T> void localSetThread(Property paramProperty, T[] paramArrayOfT) {
    ...
    map.put(paramProperty.name, paramArrayOfT);
  }
  ...
  private static <T> void localSetGlobalProperty(Property paramProperty, T... paramVarArgs) {
    ...
    globalProperties.put(paramProperty.name, (Object[])paramVarArgs);
  }
  
  public static <T> T[] clearGlobalProperty(Property paramProperty) {
    checkPermission(CanSetDefaultProperty);
    localClearThreadProperty(paramProperty);
    return (T[])globalProperties.remove(paramProperty.name);
  }
  ...
  private static Object[] localClearThreadProperty(Property paramProperty) {
    ...
    return (Object[])map.remove(paramProperty.name);
  }
  ...
  public static final class Property {
    ...
    private Property(String param1String, Class param1Class) {
      this.name = param1String;
      this.type = param1Class;
    }
  }
  
  private static class ThreadLocalSecureRandomProvider implements SecureRandomProvider {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\CryptoServicesRegistrar.class
