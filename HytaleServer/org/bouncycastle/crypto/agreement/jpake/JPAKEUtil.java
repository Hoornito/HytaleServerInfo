...
public class JPAKEUtil {
  ...
  public static BigInteger calculateS(char[] paramArrayOfchar) {
    return new BigInteger(1, Strings.toUTF8ByteArray(paramArrayOfchar));
  }
  ...
  public static void validateZeroKnowledgeProof(BigInteger paramBigInteger1, BigInteger paramBigInteger2, BigInteger paramBigInteger3, BigInteger paramBigInteger4, BigInteger[] paramArrayOfBigInteger, String paramString, Digest paramDigest) throws CryptoException {
    ...
    if (paramBigInteger4.signum() <= 0 || paramBigInteger4.compareTo(paramBigInteger1) >= 0 || !paramBigInteger4.modPow(paramBigInteger2, paramBigInteger1).equals(ONE) || !paramBigInteger3.modPow(bigInteger2, paramBigInteger1).multiply(paramBigInteger4.modPow(bigInteger3, paramBigInteger1)).mod(paramBigInteger1).equals(bigInteger1))
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\agreement\jpake\JPAKEUtil.class
