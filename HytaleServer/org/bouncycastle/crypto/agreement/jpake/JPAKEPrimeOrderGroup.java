...
public class JPAKEPrimeOrderGroup {
  ...
  JPAKEPrimeOrderGroup(BigInteger paramBigInteger1, BigInteger paramBigInteger2, BigInteger paramBigInteger3, boolean paramBoolean) {
    ...
    if (!paramBoolean) {
      ...
      if (paramBigInteger3.compareTo(BigInteger.valueOf(2L)) < 0 || paramBigInteger3.compareTo(paramBigInteger1) >= 0)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\agreement\jpake\JPAKEPrimeOrderGroup.class
