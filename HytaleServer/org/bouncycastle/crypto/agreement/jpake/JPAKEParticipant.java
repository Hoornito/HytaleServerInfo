...
public class JPAKEParticipant {
  ...
  public JPAKEParticipant(String paramString, char[] paramArrayOfchar, JPAKEPrimeOrderGroup paramJPAKEPrimeOrderGroup) {
    this(paramString, paramArrayOfchar, paramJPAKEPrimeOrderGroup, (Digest)SHA256Digest.newInstance(), CryptoServicesRegistrar.getSecureRandom());
  }
  ...
  public JPAKERound2Payload createRound2PayloadToSend() {
    ...
    BigInteger bigInteger2 = calculateS();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\agreement\jpake\JPAKEParticipant.class
