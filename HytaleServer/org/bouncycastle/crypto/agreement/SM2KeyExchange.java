...
public class SM2KeyExchange {
  ...
  public void init(CipherParameters paramCipherParameters) {
    ...
    if (paramCipherParameters instanceof ParametersWithID) {
      ...
      this.userID = checkUserID(((ParametersWithID)paramCipherParameters).getID());
    } else {
  ...
  public byte[] calculateKey(int paramInt, CipherParameters paramCipherParameters) {
    ...
    if (paramCipherParameters instanceof ParametersWithID) {
      ...
      arrayOfByte1 = checkUserID(((ParametersWithID)paramCipherParameters).getID());
    } else {
  ...
  private static byte[] checkUserID(byte[] paramArrayOfbyte) {
    if (paramArrayOfbyte.length >= 8192)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\agreement\SM2KeyExchange.class
