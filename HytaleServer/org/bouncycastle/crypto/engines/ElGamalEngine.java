...
public class ElGamalEngine implements AsymmetricBlockCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties("RSA", ConstraintUtils.bitsOfSecurityFor(this.key.getParameters().getP()), this.key, Utils.getPurpose(paramBoolean)));
  }
  ...
  public byte[] processBlock(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    BigInteger bigInteger3 = BigIntegers.createRandomBigInteger(j, this.random);
    while (true) {
      if (bigInteger3.equals(ZERO) || bigInteger3.compareTo(bigInteger1.subtract(TWO)) > 0) {
        bigInteger3 = BigIntegers.createRandomBigInteger(j, this.random);
        continue;
      } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\ElGamalEngine.class
