...
public class ThreefishEngine implements BlockCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) throws IllegalArgumentException {
    ...
    if (arrayOfByte1 != null) {
      ...
      Pack.littleEndianToLong(arrayOfByte1, 0, arrayOfLong1);
    } 
    if (arrayOfByte2 != null) {
      if (arrayOfByte2.length != 16)
        throw new IllegalArgumentException("Threefish tweak must be 16 bytes"); 
      arrayOfLong2 = new long[2];
      Pack.littleEndianToLong(arrayOfByte2, 0, arrayOfLong2);
    } 
  ...
  public int processBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) throws DataLengthException, IllegalStateException {
    ...
    Pack.littleEndianToLong(paramArrayOfbyte1, paramInt1, this.currentBlock);
    processBlock(this.currentBlock, this.currentBlock);
    Pack.longToLittleEndian(this.currentBlock, paramArrayOfbyte2, paramInt2);
    return this.blocksizeBytes;
  }
  ...
  public static void wordToBytes(long paramLong, byte[] paramArrayOfbyte, int paramInt) {
    Pack.longToLittleEndian(paramLong, paramArrayOfbyte, paramInt);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\ThreefishEngine.class
