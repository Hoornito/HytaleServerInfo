...
public class DESedeEngine extends DESBase implements BlockCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties(getAlgorithmName(), bitsOfSecurity(), paramCipherParameters, Utils.getPurpose(this.forEncryption)));
  }
  ...
  private int bitsOfSecurity() {
    return (this.workingKey1 != null && this.workingKey1 == this.workingKey3) ? 80 : 112;
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\DESedeEngine.class
