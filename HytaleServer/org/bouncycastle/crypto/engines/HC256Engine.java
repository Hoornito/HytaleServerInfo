...
public class HC256Engine implements StreamCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) throws IllegalArgumentException {
    ...
    if (cipherParameters instanceof KeyParameter) {
      ...
      init();
      CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties(getAlgorithmName(), this.key.length * 8, paramCipherParameters, Utils.getPurpose(paramBoolean)));
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\HC256Engine.class
