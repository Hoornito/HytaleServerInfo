...
public class SM4Engine implements BlockCipher {
  ...
  public int processBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) throws DataLengthException, IllegalStateException {
    ...
    Pack.intToBigEndian(this.X[3], paramArrayOfbyte2, paramInt2);
    Pack.intToBigEndian(this.X[2], paramArrayOfbyte2, paramInt2 + 4);
    Pack.intToBigEndian(this.X[1], paramArrayOfbyte2, paramInt2 + 8);
    Pack.intToBigEndian(this.X[0], paramArrayOfbyte2, paramInt2 + 12);
    return 16;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\SM4Engine.class
