...
public class Salsa20Engine implements SkippingStreamCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    if (cipherParameters == null) {
      ...
      byte[] arrayOfByte1 = ((KeyParameter)cipherParameters).getKey();
      setKey(arrayOfByte1, arrayOfByte);
      CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties(getAlgorithmName(), arrayOfByte1.length * 8, paramCipherParameters, Utils.getPurpose(paramBoolean)));
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\Salsa20Engine.class
