...
public class CamelliaLightEngine implements BlockCipher {
  ...
  private void setKey(boolean paramBoolean, byte[] paramArrayOfbyte) {
    ...
    this._keySize = paramArrayOfbyte.length;
  ...
  private int processBlock128(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) {
    ...
    for (byte b = 0; b < 4; b++)
      arrayOfInt[b] = bytes2int(paramArrayOfbyte1, paramInt1 + b * 4) ^ this.kw[b]; 
    camelliaF2(arrayOfInt, this.subkey, 0);
    camelliaF2(arrayOfInt, this.subkey, 4);
    camelliaF2(arrayOfInt, this.subkey, 8);
    camelliaFLs(arrayOfInt, this.ke, 0);
    camelliaF2(arrayOfInt, this.subkey, 12);
    camelliaF2(arrayOfInt, this.subkey, 16);
    camelliaF2(arrayOfInt, this.subkey, 20);
    camelliaFLs(arrayOfInt, this.ke, 4);
    camelliaF2(arrayOfInt, this.subkey, 24);
    camelliaF2(arrayOfInt, this.subkey, 28);
    camelliaF2(arrayOfInt, this.subkey, 32);
    arrayOfInt[2] = arrayOfInt[2] ^ this.kw[4];
    arrayOfInt[3] = arrayOfInt[3] ^ this.kw[5];
    arrayOfInt[0] = arrayOfInt[0] ^ this.kw[6];
    arrayOfInt[1] = arrayOfInt[1] ^ this.kw[7];
    int2bytes(arrayOfInt[2], paramArrayOfbyte2, paramInt2);
    int2bytes(arrayOfInt[3], paramArrayOfbyte2, paramInt2 + 4);
    int2bytes(arrayOfInt[0], paramArrayOfbyte2, paramInt2 + 8);
    int2bytes(arrayOfInt[1], paramArrayOfbyte2, paramInt2 + 12);
    return 16;
  }
  ...
  private int processBlock192or256(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) {
    ...
    camelliaF2(arrayOfInt, this.subkey, 28);
    camelliaF2(arrayOfInt, this.subkey, 32);
    camelliaFLs(arrayOfInt, this.ke, 8);
    camelliaF2(arrayOfInt, this.subkey, 36);
    camelliaF2(arrayOfInt, this.subkey, 40);
    camelliaF2(arrayOfInt, this.subkey, 44);
    arrayOfInt[2] = arrayOfInt[2] ^ this.kw[4];
    arrayOfInt[3] = arrayOfInt[3] ^ this.kw[5];
    arrayOfInt[0] = arrayOfInt[0] ^ this.kw[6];
    arrayOfInt[1] = arrayOfInt[1] ^ this.kw[7];
  ...
  public int processBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) throws IllegalStateException {
    ...
    return (this._keySize == 16) ? processBlock128(paramArrayOfbyte1, paramInt1, paramArrayOfbyte2, paramInt2) : processBlock192or256(paramArrayOfbyte1, paramInt1, paramArrayOfbyte2, paramInt2);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\CamelliaLightEngine.class
