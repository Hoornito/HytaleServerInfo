...
public class CramerShoupCoreEngine {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters, String paramString) {
    ...
    this.label = Strings.toUTF8ByteArray(paramString);
  }
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties("CramerShoup", ConstraintUtils.bitsOfSecurityFor(this.key.getParameters().getP()), this.key, Utils.getPurpose(paramBoolean)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\CramerShoupCoreEngine.class
