...
public class ISAACEngine implements StreamCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    setKey(arrayOfByte);
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties(getAlgorithmName(), (arrayOfByte.length < 32) ? (arrayOfByte.length * 8) : 256, paramCipherParameters, Utils.getPurpose(paramBoolean)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\ISAACEngine.class
