...
public class VMPCEngine implements StreamCipher {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties(getAlgorithmName(), (this.workingKey.length >= 32) ? 256 : (this.workingKey.length * 8), paramCipherParameters, Utils.getPurpose(paramBoolean)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\engines\VMPCEngine.class
