...
public class ECNewPublicKeyTransform implements ECPairTransform {
  ...
  public ECPair transform(ECPair paramECPair) {
    ...
    ECPoint[] arrayOfECPoint = { eCMultiplier.multiply(eCDomainParameters.getG(), bigInteger2), this.key.getQ().multiply(bigInteger2).add(ECAlgorithms.cleanPoint(eCDomainParameters.getCurve(), paramECPair.getY())) };
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\ec\ECNewPublicKeyTransform.class
