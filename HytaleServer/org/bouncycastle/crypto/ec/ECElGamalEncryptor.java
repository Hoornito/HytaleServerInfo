...
public class ECElGamalEncryptor implements ECEncryptor {
  ...
  public ECPair encrypt(ECPoint paramECPoint) {
    ...
    ECPoint[] arrayOfECPoint = { eCMultiplier.multiply(eCDomainParameters.getG(), bigInteger), this.key.getQ().multiply(bigInteger).add(ECAlgorithms.cleanPoint(eCDomainParameters.getCurve(), paramECPoint)) };
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\ec\ECElGamalEncryptor.class
