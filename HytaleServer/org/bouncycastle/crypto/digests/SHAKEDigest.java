...
public class SHAKEDigest extends KeccakDigest implements Xof, SavableDigest {
  ...
  public Memoable copy() {
    return (Memoable)new SHAKEDigest(this);
  }
  
  public void reset(Memoable paramMemoable) {
    SHAKEDigest sHAKEDigest = (SHAKEDigest)paramMemoable;
    copyIn(sHAKEDigest);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\SHAKEDigest.class
