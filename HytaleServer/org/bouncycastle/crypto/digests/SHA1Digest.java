...
public class SHA1Digest extends GeneralDigest implements EncodableDigest {
  ...
  public SHA1Digest(CryptoServicePurpose paramCryptoServicePurpose) {
  ...
  public byte[] getEncodedState() {
    byte[] arrayOfByte = new byte[40 + this.xOff * 4 + 1];
  ...
  protected CryptoServiceProperties cryptoServiceProperties() {
    return Utils.getDefaultProperties((Digest)this, 128, this.purpose);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\SHA1Digest.class
