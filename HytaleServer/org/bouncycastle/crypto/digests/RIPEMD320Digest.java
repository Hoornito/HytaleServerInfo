...
public class RIPEMD320Digest extends GeneralDigest {
  ...
  public RIPEMD320Digest(CryptoServicePurpose paramCryptoServicePurpose) {
  ...
  public RIPEMD320Digest(RIPEMD320Digest paramRIPEMD320Digest) {
    super(paramRIPEMD320Digest.purpose);
  ...
  public int doFinal(byte[] paramArrayOfbyte, int paramInt) {
    ...
    Pack.intToLittleEndian(this.H8, paramArrayOfbyte, paramInt + 32);
    Pack.intToLittleEndian(this.H9, paramArrayOfbyte, paramInt + 36);
    reset();
    return 40;
  }
  ...
  public void reset(Memoable paramMemoable) {
    RIPEMD320Digest rIPEMD320Digest = (RIPEMD320Digest)paramMemoable;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\RIPEMD320Digest.class
