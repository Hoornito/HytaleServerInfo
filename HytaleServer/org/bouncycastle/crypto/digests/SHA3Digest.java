...
public class SHA3Digest extends KeccakDigest implements SavableDigest {
  ...
  public Memoable copy() {
    return (Memoable)new SHA3Digest(this);
  }
  
  public void reset(Memoable paramMemoable) {
    SHA3Digest sHA3Digest = (SHA3Digest)paramMemoable;
    copyIn(sHA3Digest);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\SHA3Digest.class
