...
public class SHA256Digest extends GeneralDigest implements SavableDigest {
  ...
  public static SavableDigest newInstance(CryptoServicePurpose paramCryptoServicePurpose) {
    return new SHA256Digest(paramCryptoServicePurpose);
  }
  
  public static SavableDigest newInstance(Digest paramDigest) {
    if (paramDigest instanceof SHA256Digest)
  ...
  public static SavableDigest newInstance(byte[] paramArrayOfbyte) {
    return new SHA256Digest(paramArrayOfbyte);
  }
  ...
  private void copyIn(SHA256Digest paramSHA256Digest) {
    copyIn(paramSHA256Digest);
  ...
  public void reset(Memoable paramMemoable) {
    SHA256Digest sHA256Digest = (SHA256Digest)paramMemoable;
    copyIn(sHA256Digest);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\SHA256Digest.class
