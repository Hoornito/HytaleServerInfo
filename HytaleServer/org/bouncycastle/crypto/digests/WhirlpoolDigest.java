...
public final class WhirlpoolDigest implements ExtendedDigest, Memoable {
  ...
  private static int mulX(int paramInt) {
    return paramInt << 1 ^ -(paramInt >>> 7) & 0x11D;
  }
  
  private static long packIntoLong(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8) {
  ...
  public WhirlpoolDigest(CryptoServicePurpose paramCryptoServicePurpose) {
    this._rc[0] = 0L;
    for (byte b = 1; b <= 10; b++) {
      int i = 8 * (b - 1);
    ...
    CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties((Digest)this, getDigestSize(), paramCryptoServicePurpose));
  }
  
  public WhirlpoolDigest(WhirlpoolDigest paramWhirlpoolDigest) {
    this.purpose = paramWhirlpoolDigest.purpose;
    reset(paramWhirlpoolDigest);
    CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties((Digest)this, getDigestSize(), this.purpose));
  }
  ...
  public int doFinal(byte[] paramArrayOfbyte, int paramInt) {
    finish();
    Pack.longToBigEndian(this._hash, paramArrayOfbyte, paramInt);
    reset();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\WhirlpoolDigest.class
