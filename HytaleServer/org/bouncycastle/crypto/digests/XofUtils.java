...
public class XofUtils {
  ...
  static byte[] encode(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    return (paramArrayOfbyte.length == paramInt2) ? Arrays.concatenate(leftEncode((paramInt2 * 8)), paramArrayOfbyte) : Arrays.concatenate(leftEncode((paramInt2 * 8)), Arrays.copyOfRange(paramArrayOfbyte, paramInt1, paramInt1 + paramInt2));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\XofUtils.class
