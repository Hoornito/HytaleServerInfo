...
public class MD4Digest extends GeneralDigest {
  ...
  public MD4Digest(CryptoServicePurpose paramCryptoServicePurpose) {
    super(paramCryptoServicePurpose);
    CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties((Digest)this, 64, paramCryptoServicePurpose));
    reset();
  }
  
  public MD4Digest(MD4Digest paramMD4Digest) {
    super(paramMD4Digest.purpose);
    CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties((Digest)this, 64, this.purpose));
  ...
  public int doFinal(byte[] paramArrayOfbyte, int paramInt) {
    finish();
    Pack.intToLittleEndian(this.H1, paramArrayOfbyte, paramInt);
    Pack.intToLittleEndian(this.H2, paramArrayOfbyte, paramInt + 4);
    Pack.intToLittleEndian(this.H3, paramArrayOfbyte, paramInt + 8);
    Pack.intToLittleEndian(this.H4, paramArrayOfbyte, paramInt + 12);
    reset();
    return 16;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\digests\MD4Digest.class
