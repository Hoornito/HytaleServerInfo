...
public class DSTU7564Mac implements Mac {
  ...
  public int doFinal(byte[] paramArrayOfbyte, int paramInt) throws DataLengthException, IllegalStateException {
    ...
    this.inputLength = 0L;
    int i = this.engine.doFinal(paramArrayOfbyte, paramInt);
    reset();
    return i;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\macs\DSTU7564Mac.class
