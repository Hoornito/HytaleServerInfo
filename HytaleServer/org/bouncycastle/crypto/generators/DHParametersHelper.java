...
class DHParametersHelper {
  ...
  static BigInteger[] generateSafePrimes(int paramInt1, int paramInt2, SecureRandom paramSecureRandom) {
    ...
    int j = paramInt1 >>> 2;
    while (true) {
      BigInteger bigInteger2 = BigIntegers.createRandomPrime(i, 2, paramSecureRandom);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\DHParametersHelper.class
