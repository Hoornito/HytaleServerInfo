...
public class HKDFBytesGenerator implements DerivationFunction {
  ...
  public void init(DerivationParameters paramDerivationParameters) {
    ...
    if (hKDFParameters.skipExtract()) {
      ...
      this.hMacHash.init((CipherParameters)new KeyParameter(extractPRK(hKDFParameters.getSalt(), hKDFParameters.getIKM())));
    } 
  ...
  public byte[] extractPRK(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\HKDFBytesGenerator.class
