...
public class Argon2BytesGenerator {
  ...
  public void init(Argon2Parameters paramArgon2Parameters) {
    if (paramArgon2Parameters.getVersion() != 16 && paramArgon2Parameters.getVersion() != 19)
      throw new UnsupportedOperationException("unknown Argon2 version"); 
    if (paramArgon2Parameters.getType() != 0 && paramArgon2Parameters.getType() != 1 && paramArgon2Parameters.getType() != 2)
    ...
    if (paramArgon2Parameters.getLanes() > 16777215)
    ...
    int i = Math.max(paramArgon2Parameters.getMemory(), 8 * paramArgon2Parameters.getLanes());
    this.segmentLength = i / 4 * paramArgon2Parameters.getLanes();
    this.laneLength = this.segmentLength * 4;
    i = paramArgon2Parameters.getLanes() * this.laneLength;
  ...
  private void initialize(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, int paramInt) {
    ...
    addByteString(paramArrayOfbyte1, (Digest)blake2bDigest, paramArrayOfbyte2);
    addByteString(paramArrayOfbyte1, (Digest)blake2bDigest, this.parameters.getSalt());
    addByteString(paramArrayOfbyte1, (Digest)blake2bDigest, this.parameters.getSecret());
    addByteString(paramArrayOfbyte1, (Digest)blake2bDigest, this.parameters.getAdditional());
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\Argon2BytesGenerator.class
