...
class DHKeyGeneratorHelper {
  ...
  BigInteger calculatePrivate(DHParameters paramDHParameters, SecureRandom paramSecureRandom) {
    ...
    if (i != 0) {
      int m = i >>> 2;
      while (true) {
        BigInteger bigInteger = BigIntegers.createRandomBigInteger(i, paramSecureRandom).setBit(i - 1);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\DHKeyGeneratorHelper.class
