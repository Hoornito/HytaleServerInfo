...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
  ...
  public void init(DerivationParameters paramDerivationParameters) {
    ...
    if (kDFDoublePipelineIterationParameters.useCounter()) {
      this.maxSizeExcl = (i >= Integers.numberOfLeadingZeros(this.h)) ? Integer.MAX_VALUE : (this.h << i);
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\KDFDoublePipelineIterationBytesGenerator.class
