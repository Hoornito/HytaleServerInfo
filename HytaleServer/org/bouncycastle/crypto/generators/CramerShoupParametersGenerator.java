...
public class CramerShoupParametersGenerator {
  ...
  public CramerShoupParameters generateParameters() {
    ...
    return new CramerShoupParameters(bigInteger1, bigInteger2, bigInteger3, (Digest)SHA256Digest.newInstance());
  }
  ...
  private static class ParametersHelper {
    ...
    static BigInteger[] generateSafePrimes(int param1Int1, int param1Int2, SecureRandom param1SecureRandom) {
      ...
      int i = param1Int1 - 1;
      do {
        bigInteger2 = BigIntegers.createRandomPrime(i, 2, param1SecureRandom);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\generators\CramerShoupParametersGenerator.class
