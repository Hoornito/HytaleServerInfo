...
public class AlgorithmIdentifierFactory {
  ...
  public static AlgorithmIdentifier generateEncryptionAlgID(ASN1ObjectIdentifier paramASN1ObjectIdentifier, int paramInt, SecureRandom paramSecureRandom) throws IllegalArgumentException {
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes128_CBC) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes192_CBC) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes256_CBC) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NTTObjectIdentifiers.id_camellia128_cbc) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NTTObjectIdentifiers.id_camellia192_cbc) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NTTObjectIdentifiers.id_camellia256_cbc) || paramASN1ObjectIdentifier.equals((ASN1Primitive)KISAObjectIdentifiers.id_seedCBC)) {
      byte[] arrayOfByte = new byte[16];
      paramSecureRandom.nextBytes(arrayOfByte);
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)new DEROctetString(arrayOfByte));
    } 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes128_GCM) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes192_GCM) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes256_GCM)) {
      byte[] arrayOfByte = new byte[12];
      paramSecureRandom.nextBytes(arrayOfByte);
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)new GCMParameters(arrayOfByte, 16));
    } 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes128_CCM) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes192_CCM) || paramASN1ObjectIdentifier.equals((ASN1Primitive)NISTObjectIdentifiers.id_aes256_CCM)) {
      byte[] arrayOfByte = new byte[8];
      paramSecureRandom.nextBytes(arrayOfByte);
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)new CCMParameters(arrayOfByte, 16));
    } 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.des_EDE3_CBC) || paramASN1ObjectIdentifier.equals((ASN1Primitive)IDEA_CBC) || paramASN1ObjectIdentifier.equals((ASN1Primitive)OIWObjectIdentifiers.desCBC)) {
      byte[] arrayOfByte = new byte[8];
      paramSecureRandom.nextBytes(arrayOfByte);
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)new DEROctetString(arrayOfByte));
    } 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)CAST5_CBC)) {
      byte[] arrayOfByte = new byte[8];
      paramSecureRandom.nextBytes(arrayOfByte);
      CAST5CBCParameters cAST5CBCParameters = new CAST5CBCParameters(arrayOfByte, paramInt);
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)cAST5CBCParameters);
    } 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.rc4))
      return new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)DERNull.INSTANCE); 
    if (paramASN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.RC2_CBC)) {
      byte[] arrayOfByte = new byte[8];
      paramSecureRandom.nextBytes(arrayOfByte);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\AlgorithmIdentifierFactory.class
