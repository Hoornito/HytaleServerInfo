...
public class SubjectPublicKeyInfoFactory {
  ...
  public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter paramAsymmetricKeyParameter) throws IOException {
    ...
    if (paramAsymmetricKeyParameter instanceof HSSPublicKeyParameters) {
      ...
      return new SubjectPublicKeyInfo(algorithmIdentifier, Arrays.concatenate(new byte[] { 4, (byte)arrayOfByte.length }, arrayOfByte));
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\SubjectPublicKeyInfoFactory.class
