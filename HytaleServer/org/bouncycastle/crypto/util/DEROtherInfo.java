...
public class DEROtherInfo {
  ...
  public static final class Builder {
    ...
    public Builder(AlgorithmIdentifier param1AlgorithmIdentifier, byte[] param1ArrayOfbyte1, byte[] param1ArrayOfbyte2) {
      ...
      this.partyUInfo = DerUtil.getOctetString(param1ArrayOfbyte1);
    ...
    public DEROtherInfo build() {
      ...
      aSN1EncodableVector.add((ASN1Encodable)this.partyUInfo);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\DEROtherInfo.class
