...
public final class DigestFactory {
  ...
  static {
    ...
    cloneMap.put(createSHA1().getAlgorithmName(), new Cloner() {
          public Digest createClone(Digest param1Digest) {
            return (Digest)new SHA1Digest((SHA1Digest)param1Digest);
          }
        });
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\DigestFactory.class
