  ...
  public static AsymmetricKeyParameter createKey(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    ...
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)X9ObjectIdentifiers.id_ecPublicKey)) {
      ...
      if (x962Parameters.isNamedCurve()) {
        ...
        ECNamedDomainParameters eCNamedDomainParameters = ECNamedDomainParameters.lookup(aSN1ObjectIdentifier1);
      } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\PrivateKeyFactory.class
