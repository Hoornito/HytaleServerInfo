...
public class PublicKeyFactory {
  ...
  private static class DSTUConverter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) throws IOException {
      ...
      if (aSN1ObjectIdentifier.equals((ASN1Primitive)UAObjectIdentifiers.dstu4145le))
      ...
      if (dSTU4145Params.isNamedCurve()) {
        ...
        ECCurve.F2m f2m = new ECCurve.F2m(dSTU4145BinaryField.getM(), dSTU4145BinaryField.getK1(), dSTU4145BinaryField.getK2(), dSTU4145BinaryField.getK3(), dSTU4145ECBinary.getA(), bigInteger, null, null);
        byte[] arrayOfByte2 = dSTU4145ECBinary.getG();
        if (aSN1ObjectIdentifier.equals((ASN1Primitive)UAObjectIdentifiers.dstu4145le))
          reverseBytes(arrayOfByte2); 
        ECPoint eCPoint1 = DSTU4145PointEncoder.decodePoint((ECCurve)f2m, arrayOfByte2);
        eCDomainParameters = new ECDomainParameters((ECCurve)f2m, eCPoint1, dSTU4145ECBinary.getN());
      } 
      ECPoint eCPoint = DSTU4145PointEncoder.decodePoint(eCDomainParameters.getCurve(), arrayOfByte);
      return (AsymmetricKeyParameter)new ECPublicKeyParameters(eCPoint, eCDomainParameters);
    }
  ...
  private static class ECConverter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      ...
      if (x962Parameters.isNamedCurve()) {
        ...
        ECNamedDomainParameters eCNamedDomainParameters = ECNamedDomainParameters.lookup(aSN1ObjectIdentifier);
  ...
  private static class Ed25519Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new Ed25519PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object));
    }
  }
  ...
  private static class Ed448Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new Ed448PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object));
    }
  }
  ...
  private static class GOST3410_2001Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      ...
      ECGOST3410Parameters eCGOST3410Parameters = new ECGOST3410Parameters((ECDomainParameters)new ECNamedDomainParameters(aSN1ObjectIdentifier, ECGOST3410NamedCurves.getByOIDX9(aSN1ObjectIdentifier)), aSN1ObjectIdentifier, gOST3410PublicKeyAlgParameters.getDigestParamSet(), gOST3410PublicKeyAlgParameters.getEncryptionParamSet());
      try {
        aSN1OctetString = (ASN1OctetString)param1SubjectPublicKeyInfo.parsePublicKey();
      } catch (IOException iOException) {
      ...
      return (AsymmetricKeyParameter)new ECPublicKeyParameters(eCPoint, (ECDomainParameters)eCGOST3410Parameters);
    }
  }
  ...
  private static class GOST3410_2012Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      ...
      ECGOST3410Parameters eCGOST3410Parameters = new ECGOST3410Parameters((ECDomainParameters)new ECNamedDomainParameters(aSN1ObjectIdentifier2, ECGOST3410NamedCurves.getByOIDX9(aSN1ObjectIdentifier2)), aSN1ObjectIdentifier2, gOST3410PublicKeyAlgParameters.getDigestParamSet(), gOST3410PublicKeyAlgParameters.getEncryptionParamSet());
      try {
        aSN1OctetString = (ASN1OctetString)param1SubjectPublicKeyInfo.parsePublicKey();
      } catch (IOException iOException) {
      ...
      byte b1 = 32;
      if (aSN1ObjectIdentifier1.equals((ASN1Primitive)RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512))
        b1 = 64; 
      int i = 2 * b1;
      byte[] arrayOfByte1 = aSN1OctetString.getOctets();
      if (arrayOfByte1.length != i)
  ...
  private static class X25519Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new X25519PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object));
    }
  }
  ...
  private static class X448Converter extends SubjectPublicKeyInfoConverter {
    ...
    AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo param1SubjectPublicKeyInfo, Object param1Object) {
      return (AsymmetricKeyParameter)new X448PublicKeyParameters(PublicKeyFactory.getRawKey(param1SubjectPublicKeyInfo, param1Object));
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypt\\util\PublicKeyFactory.class
