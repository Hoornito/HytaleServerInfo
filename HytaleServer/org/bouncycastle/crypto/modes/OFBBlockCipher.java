...
public class OFBBlockCipher extends StreamBlockCipher {
  ...
  public OFBBlockCipher(BlockCipher paramBlockCipher, int paramInt) {
    ...
    if (paramInt > paramBlockCipher.getBlockSize() * 8 || paramInt < 8 || paramInt % 8 != 0)
      throw new IllegalArgumentException("0FB" + paramInt + " not supported"); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\OFBBlockCipher.class
