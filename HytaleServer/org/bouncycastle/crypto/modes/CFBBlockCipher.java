...
public class CFBBlockCipher extends StreamBlockCipher implements CFBModeCipher {
  ...
  public static CFBModeCipher newInstance(BlockCipher paramBlockCipher, int paramInt) {
    return new CFBBlockCipher(paramBlockCipher, paramInt);
  }
  
  public CFBBlockCipher(BlockCipher paramBlockCipher, int paramInt) {
    super(paramBlockCipher);
    if (paramInt > paramBlockCipher.getBlockSize() * 8 || paramInt < 8 || paramInt % 8 != 0)
      throw new IllegalArgumentException("CFB" + paramInt + " not supported"); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\CFBBlockCipher.class
