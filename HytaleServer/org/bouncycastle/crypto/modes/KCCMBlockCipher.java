...
public class KCCMBlockCipher implements AEADBlockCipher {
  ...
  private byte getFlag(boolean paramBoolean, int paramInt) {
    ...
    String str;
    for (str = Integer.toBinaryString(this.Nb_ - 1); str.length() < 4; str = (new StringBuilder(str)).insert(0, "0").toString());
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\KCCMBlockCipher.class
