...
public class CTSBlockCipher extends DefaultBufferedBlockCipher {
  ...
  public CTSBlockCipher(BlockCipher paramBlockCipher) {
    if (paramBlockCipher instanceof org.bouncycastle.crypto.StreamBlockCipher)
  ...
  public int processBytes(byte[] paramArrayOfbyte1, int paramInt1, int paramInt2, byte[] paramArrayOfbyte2, int paramInt3) throws DataLengthException, IllegalStateException {
    ...
    if (paramInt2 > m) {
      ...
      paramInt1 += m;
      paramInt2 -= m;
      if (paramArrayOfbyte1 == paramArrayOfbyte2 && Arrays.segmentsOverlap(paramInt1, paramInt2, paramInt3, j)) {
    ...
    if (this.forEncryption) {
      ...
      if (this.bufOff > i) {
        ...
        if (this.cipher instanceof CBCModeCipher) {
          BlockCipher blockCipher = ((CBCModeCipher)this.cipher).getUnderlyingCipher();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\CTSBlockCipher.class
