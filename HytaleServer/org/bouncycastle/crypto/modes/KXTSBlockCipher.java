...
public class KXTSBlockCipher extends DefaultBufferedBlockCipher {
  ...
  public int processBytes(byte[] paramArrayOfbyte1, int paramInt1, int paramInt2, byte[] paramArrayOfbyte2, int paramInt3) {
    ...
    if (paramArrayOfbyte1 == paramArrayOfbyte2 && Arrays.segmentsOverlap(paramInt1, paramInt2, paramInt3, paramInt2)) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\KXTSBlockCipher.class
