...
public class EAXBlockCipher implements AEADBlockCipher {
  ...
  public EAXBlockCipher(BlockCipher paramBlockCipher) {
    ...
    this.cipher = SICBlockCipher.newInstance(paramBlockCipher);
  }
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) throws IllegalArgumentException {
    ...
    this.cipher.init(true, (CipherParameters)new ParametersWithIV(cipherParameters, this.nonceMac));
    reset();
  }
  ...
  public int processBytes(byte[] paramArrayOfbyte1, int paramInt1, int paramInt2, byte[] paramArrayOfbyte2, int paramInt3) throws DataLengthException {
    ...
    if (paramArrayOfbyte1 == paramArrayOfbyte2 && Arrays.segmentsOverlap(paramInt1, paramInt2, paramInt3, getUpdateOutputSize(paramInt2))) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\EAXBlockCipher.class
