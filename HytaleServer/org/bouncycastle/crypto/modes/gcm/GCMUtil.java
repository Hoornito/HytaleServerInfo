...
public abstract class GCMUtil {
  ...
  static void multiply(byte[] paramArrayOfbyte, long[] paramArrayOflong) {
    long l1 = Pack.bigEndianToLong(paramArrayOfbyte, 0);
    long l2 = Pack.bigEndianToLong(paramArrayOfbyte, 8);
    long l3 = paramArrayOflong[0];
    long l4 = paramArrayOflong[1];
    ...
    Pack.longToBigEndian(l15, paramArrayOfbyte, 0);
    Pack.longToBigEndian(l16, paramArrayOfbyte, 8);
  }
  ...
  public static void multiplyP16(long[] paramArrayOflong) {
    long l1 = paramArrayOflong[0];
    long l2 = paramArrayOflong[1];
    long l3 = l2 << 48L;
    paramArrayOflong[0] = l1 >>> 16L ^ l3 ^ l3 >>> 1L ^ l3 >>> 2L ^ l3 >>> 7L;
    paramArrayOflong[1] = l2 >>> 16L | l1 << 48L;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\gcm\GCMUtil.class
