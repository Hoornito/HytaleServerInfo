...
public class NISTCTSBlockCipher extends DefaultBufferedBlockCipher {
  ...
  public NISTCTSBlockCipher(int paramInt, BlockCipher paramBlockCipher) {
    this.type = paramInt;
    this.cipher = (BlockCipher)CBCBlockCipher.newInstance(paramBlockCipher);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\modes\NISTCTSBlockCipher.class
