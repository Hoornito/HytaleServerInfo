...
public class RSADigestSigner implements Signer {
  ...
  private byte[] derEncode(byte[] paramArrayOfbyte) throws IOException {
    if (this.algId == null)
      try {
        DigestInfo.getInstance(paramArrayOfbyte);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\signers\RSADigestSigner.class
