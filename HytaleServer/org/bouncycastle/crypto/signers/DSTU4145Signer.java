...
public class DSTU4145Signer implements DSAExt {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties("DSTU4145", this.key, paramBoolean));
  }
  ...
  private static BigInteger generateRandomInteger(BigInteger paramBigInteger, SecureRandom paramSecureRandom) {
    return BigIntegers.createRandomBigInteger(paramBigInteger.bitLength() - 1, paramSecureRandom);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\signers\DSTU4145Signer.class
