...
public class ISO9796d2PSSSigner implements SignerWithRecovery {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    if (paramCipherParameters instanceof ParametersWithRandom) {
      ...
      this.random = paramBoolean ? parametersWithRandom.getRandom() : null;
      ...
      this.random = paramBoolean ? CryptoServicesRegistrar.getSecureRandom() : null;
      this.standardSalt = null;
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\signers\ISO9796d2PSSSigner.class
