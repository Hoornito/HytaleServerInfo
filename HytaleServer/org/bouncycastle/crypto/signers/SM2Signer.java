...
public class SM2Signer implements Signer, ECConstants {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    if (paramBoolean) {
      ...
      this.ecKey = (ECKeyParameters)eCPrivateKeyParameters;
      this.ecParams = eCPrivateKeyParameters.getParameters();
      BigInteger bigInteger1 = eCPrivateKeyParameters.getD();
      BigInteger bigInteger2 = this.ecParams.getN();
      if (bigInteger1.compareTo(ONE) < 0 || bigInteger1.compareTo(bigInteger2.subtract(ONE)) >= 0)
      ...
      this.ecKey = (ECKeyParameters)eCPublicKeyParameters;
  ...
  public byte[] generateSignature() throws CryptoException {
    ...
    //   215: ldc 'unable to encode signature: '
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\crypto\signers\SM2Signer.class
