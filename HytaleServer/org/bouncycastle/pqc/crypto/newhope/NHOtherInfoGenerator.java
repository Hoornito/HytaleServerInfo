...
public class NHOtherInfoGenerator {
  ...
  public static class PartyU extends NHOtherInfoGenerator {
    ...
    public DEROtherInfo generate(byte[] param1ArrayOfbyte) {
      ...
      this.used = true;
      this.otherInfoBuilder.withSuppPrivInfo(this.agreement.calculateAgreement((CipherParameters)NHOtherInfoGenerator.getPublicKey(param1ArrayOfbyte)));
