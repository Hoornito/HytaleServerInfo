...
public class NHSecretKeyProcessor {
  private final Xof xof = (Xof)new SHAKEDigest(256);
  ...
  public static class PartyUBuilder {
    ...
    public PartyUBuilder(SecureRandom param1SecureRandom) {
      ...
      this.agreement.init((CipherParameters)this.aKp.getPrivate());
    }
    ...
    public NHSecretKeyProcessor build(byte[] param1ArrayOfbyte) {
      ...
      this.used = true;
      return new NHSecretKeyProcessor(this.agreement.calculateAgreement((CipherParameters)new NHPublicKeyParameters(param1ArrayOfbyte)), this.sharedInfo);
    }
  }
