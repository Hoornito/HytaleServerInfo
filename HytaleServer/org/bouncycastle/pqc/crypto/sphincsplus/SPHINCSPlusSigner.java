...
public class SPHINCSPlusSigner implements MessageSigner {
  ...
  public byte[] generateSignature(byte[] paramArrayOfbyte) {
    ...
    if (this.random != null) {
      ...
      System.arraycopy(this.privKey.pk.seed, 0, arrayOfByte1, 0, arrayOfByte1.length);
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\sphincsplus\SPHINCSPlusSigner.class
