...
public class SPHINCS256Signer implements MessageSigner {
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    if (paramBoolean) {
      if (paramCipherParameters instanceof ParametersWithRandom) {
        this.keyData = ((SPHINCSPrivateKeyParameters)((ParametersWithRandom)paramCipherParameters).getParameters()).getKeyData();
      } else {
  ...
  boolean verify(HashFunctions paramHashFunctions, byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3) {
    ...
    int j = 1;
    for (b1 = 0; b1 < 32; b1++)
      j &= (arrayOfByte3[b1] == arrayOfByte5[b1 + 1024]) ? 1 : 0; 
    return j;
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\sphincs\SPHINCS256Signer.class
