...
public class SPHINCS256KeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
  ...
  public AsymmetricCipherKeyPair generateKeyPair() {
    ...
    return new AsymmetricCipherKeyPair(new SPHINCSPublicKeyParameters(arrayOfByte2, this.treeDigest.getAlgorithmName()), new SPHINCSPrivateKeyParameters(arrayOfByte1, this.treeDigest.getAlgorithmName()));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\sphincs\SPHINCS256KeyPairGenerator.class
