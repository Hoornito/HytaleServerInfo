...
public class FalconSigner implements MessageSigner {
  ...
  public byte[] generateSignature(byte[] paramArrayOfbyte) {
    ...
    return this.nist.crypto_sign(arrayOfByte, paramArrayOfbyte, paramArrayOfbyte.length, this.encodedkey);
  }
  ...
  public boolean verifySignature(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    ...
    return (this.nist.crypto_sign_open(arrayOfByte2, arrayOfByte1, paramArrayOfbyte1, this.encodedkey) == 0);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\falcon\FalconSigner.class
