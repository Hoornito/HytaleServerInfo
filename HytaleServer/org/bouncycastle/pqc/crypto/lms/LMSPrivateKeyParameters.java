...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
  ...
  public LMSPrivateKeyParameters extractKeyShard(int paramInt) {
    synchronized (this) {
      ...
      if (paramInt > this.maxQ - this.q)
        throw new IllegalArgumentException("usageCount exceeds usages remaining"); 
      int i = this.q;
      int j = this.q + paramInt;
      this.q = j;
      return new LMSPrivateKeyParameters(this, i, j);
    } 
  }
  ...
  private byte[] findT(CacheKey paramCacheKey) {
    synchronized (this.tCache) {
      ...
      if (arrayOfByte != null)
        return arrayOfByte; 
      arrayOfByte = calcT(paramCacheKey.index);
  ...
  private static class CacheKey {
    ...
    public boolean equals(Object param1Object) {
      return (param1Object instanceof CacheKey) ? ((((CacheKey)param1Object).index == this.index)) : false;
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\lms\LMSPrivateKeyParameters.class
