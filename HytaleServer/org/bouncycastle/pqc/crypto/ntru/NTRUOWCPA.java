...
class NTRUOWCPA {
  ...
  public OWCPAKeyPair keypair(byte[] paramArrayOfbyte) {
    ...
    polynomial4.s3ToBytes(arrayOfByte2, 0);
    polynomial6.s3ToBytes(arrayOfByte2, this.params.packTrinaryBytes());
    polynomial4.z3ToZq();
    polynomial5.z3ToZq();
    ...
    byte[] arrayOfByte3 = polynomial10.sqToBytes(arrayOfByte2.length - 2 * this.params.packTrinaryBytes());
    System.arraycopy(arrayOfByte3, 0, arrayOfByte2, 2 * this.params.packTrinaryBytes(), arrayOfByte3.length);
  ...
  public OWCPADecryptResult decrypt(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    ...
    polynomial10.s3ToBytes(arrayOfByte2, this.params.packTrinaryBytes());
    int i = 0;
    ...
    polynomial13.s3ToBytes(arrayOfByte2, 0);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\ntru\NTRUOWCPA.class
