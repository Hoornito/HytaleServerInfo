...
class XMSSVerifierUtil {
  static XMSSNode getRootNodeFromSignature(WOTSPlus paramWOTSPlus, int paramInt1, byte[] paramArrayOfbyte, XMSSReducedSignature paramXMSSReducedSignature, OTSHashAddress paramOTSHashAddress, int paramInt2) {
    if (paramArrayOfbyte.length != paramWOTSPlus.getParams().getTreeDigestSize())
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\xmss\XMSSVerifierUtil.class
