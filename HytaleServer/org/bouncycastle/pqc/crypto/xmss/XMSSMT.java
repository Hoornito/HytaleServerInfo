...
public final class XMSSMT {
  ...
  public void importState(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    ...
    XMSSMTPrivateKeyParameters xMSSMTPrivateKeyParameters = (new XMSSMTPrivateKeyParameters.Builder(this.params)).withPrivateKey(paramArrayOfbyte1).build();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\xmss\XMSSMT.class
