...
public class XMSSMTSigner implements StateAwareMessageSigner {
  ...
  public byte[] generateSignature(byte[] paramArrayOfbyte) {
    ...
    synchronized (this.privateKey) {
      ...
      try {
        ...
        byte[] arrayOfByte2 = Arrays.concatenate(arrayOfByte1, this.privateKey.getRoot(), XMSSUtil.toBytesBigEndian(l1, this.params.getTreeDigestSize()));
  ...
  public boolean verifySignature(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    ...
    byte[] arrayOfByte1 = Arrays.concatenate(xMSSMTSignature.getRandom(), this.publicKey.getRoot(), XMSSUtil.toBytesBigEndian(xMSSMTSignature.getIndex(), this.params.getTreeDigestSize()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\xmss\XMSSMTSigner.class
