...
class Poly {
  ...
  private static int rejectUniform(Poly paramPoly, int paramInt1, int paramInt2, byte[] paramArrayOfbyte, int paramInt3) {
    byte b2 = 0;
    byte b1 = b2;
  ...
  private static int rejectEta(Poly paramPoly, int paramInt1, int paramInt2, byte[] paramArrayOfbyte, int paramInt3, int paramInt4) {
    byte b2 = 0;
    byte b1 = b2;
  ...
  public void pointwiseMontgomery(Poly paramPoly1, Poly paramPoly2) {
    for (byte b = 0; b < 'Ā'; b++)
  ...
  public void addPoly(Poly paramPoly) {
    for (byte b = 0; b < 'Ā'; b++)
  ...
  public void power2Round(Poly paramPoly) {
  ...
  public void decompose(Poly paramPoly) {
  ...
  public void subtract(Poly paramPoly) {
    for (byte b = 0; b < 'Ā'; b++)
      setCoeffIndex(b, getCoeffIndex(b) - paramPoly.getCoeffIndex(b)); 
  }
  
  public int polyMakeHint(Poly paramPoly1, Poly paramPoly2) {
    int i = 0;
    for (byte b = 0; b < 'Ā'; b++) {
  ...
  public void polyUseHint(Poly paramPoly1, Poly paramPoly2) {
    for (byte b = 0; b < 'Ā'; b++)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\mldsa\Poly.class
