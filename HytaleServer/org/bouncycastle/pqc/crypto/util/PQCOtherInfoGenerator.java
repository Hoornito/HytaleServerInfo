...
public class PQCOtherInfoGenerator {
  ...
  public static class PartyU extends PQCOtherInfoGenerator {
    ...
    public PartyU(KEMParameters param1KEMParameters, AlgorithmIdentifier param1AlgorithmIdentifier, byte[] param1ArrayOfbyte1, byte[] param1ArrayOfbyte2, SecureRandom param1SecureRandom) {
      ...
      if (param1KEMParameters instanceof MLKEMParameters) {
        MLKEMKeyPairGenerator mLKEMKeyPairGenerator = new MLKEMKeyPairGenerator();
        mLKEMKeyPairGenerator.init((KeyGenerationParameters)new MLKEMKeyGenerationParameters(param1SecureRandom, (MLKEMParameters)param1KEMParameters));
        this.aKp = mLKEMKeyPairGenerator.generateKeyPair();
        this.encSE = (EncapsulatedSecretExtractor)new MLKEMExtractor((MLKEMPrivateKeyParameters)this.aKp.getPrivate());
  ...
  public static class PartyV extends PQCOtherInfoGenerator {
    ...
    public PartyV(KEMParameters param1KEMParameters, AlgorithmIdentifier param1AlgorithmIdentifier, byte[] param1ArrayOfbyte1, byte[] param1ArrayOfbyte2, SecureRandom param1SecureRandom) {
      super(param1AlgorithmIdentifier, param1ArrayOfbyte1, param1ArrayOfbyte2, param1SecureRandom);
      if (param1KEMParameters instanceof MLKEMParameters) {
        this.encSG = (EncapsulatedSecretGenerator)new MLKEMGenerator(param1SecureRandom);
      } else if (param1KEMParameters instanceof NTRUParameters) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypt\\util\PQCOtherInfoGenerator.class
