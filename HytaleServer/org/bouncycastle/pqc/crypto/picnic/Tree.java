...
class Tree {
  ...
  boolean hasLeftChild(Tree paramTree, int paramInt) {
    return (2 * paramInt + 1 < this.numNodes);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\picnic\Tree.class
