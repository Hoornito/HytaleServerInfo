...
public class RainbowPrivateKeyParameters extends RainbowKeyParameters {
  ...
  RainbowPrivateKeyParameters(RainbowParameters paramRainbowParameters, byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3) {
    super(true, paramRainbowParameters);
    RainbowPrivateKeyParameters rainbowPrivateKeyParameters = (new RainbowKeyComputation(paramRainbowParameters, paramArrayOfbyte1, paramArrayOfbyte2)).generatePrivateKey();
  ...
  public RainbowPrivateKeyParameters(RainbowParameters paramRainbowParameters, byte[] paramArrayOfbyte) {
    ...
    if (paramRainbowParameters.getVersion() == Version.COMPRESSED) {
      ...
      RainbowPrivateKeyParameters rainbowPrivateKeyParameters = (new RainbowKeyComputation(paramRainbowParameters, this.pk_seed, this.sk_seed)).generatePrivateKey();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\rainbow\RainbowPrivateKeyParameters.class
