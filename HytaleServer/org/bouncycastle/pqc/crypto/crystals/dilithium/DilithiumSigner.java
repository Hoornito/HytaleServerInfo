...
public class DilithiumSigner implements MessageSigner {
  ...
  public byte[] internalGenerateSignature(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    DilithiumEngine dilithiumEngine = this.privKey.getParameters().getEngine(this.random);
    return dilithiumEngine.signSignatureInternal(paramArrayOfbyte1, paramArrayOfbyte1.length, this.privKey.rho, this.privKey.k, this.privKey.tr, this.privKey.t0, this.privKey.s1, this.privKey.s2, paramArrayOfbyte2);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\crypto\crystals\dilithium\DilithiumSigner.class
