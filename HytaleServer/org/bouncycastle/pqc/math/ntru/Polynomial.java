...
public abstract class Polynomial {
  ...
  public byte[] s3ToBytes(int paramInt) {
    ...
    s3ToBytes(arrayOfByte, 0);
    return arrayOfByte;
  }
  
  public void s3ToBytes(byte[] paramArrayOfbyte, int paramInt) {
    int i = this.params.packDegree();
    int j = i - 5;
    byte b;
    for (b = 0; b <= j; b += 5) {
      int k = this.coeffs[b + 0] & 0xFF;
      int m = (this.coeffs[b + 1] & 0xFF) * 3;
      int n = (this.coeffs[b + 2] & 0xFF) * 9;
      int i1 = (this.coeffs[b + 3] & 0xFF) * 27;
      int i2 = (this.coeffs[b + 4] & 0xFF) * 81;
      paramArrayOfbyte[paramInt++] = (byte)(k + m + n + i1 + i2);
    } 
    if (b < i) {
      int k = i - 1;
      int m;
      for (m = this.coeffs[k] & 0xFF; --k >= b; m += this.coeffs[k] & 0xFF)
        m *= 3; 
  ...
  public void sqMul(Polynomial paramPolynomial1, Polynomial paramPolynomial2) {
    rqMul(paramPolynomial1, paramPolynomial2);
    modQPhiN();
  }
  
  public void rqMul(Polynomial paramPolynomial1, Polynomial paramPolynomial2) {
    int i = this.coeffs.length;
    for (byte b = 0; b < i; b++) {
      this.coeffs[b] = 0;
      byte b1;
  ...
  public void s3Mul(Polynomial paramPolynomial1, Polynomial paramPolynomial2) {
    rqMul(paramPolynomial1, paramPolynomial2);
    mod3PhiN();
  }
  
  public abstract void lift(Polynomial paramPolynomial);
  
  public void rqToS3(Polynomial paramPolynomial) {
    int i = this.coeffs.length;
    for (byte b = 0; b < i; b++) {
  ...
  public void r2Inv(Polynomial paramPolynomial) {
  ...
  public void rqInv(Polynomial paramPolynomial) {
    Polynomial polynomial1 = this.params.createPolynomial();
    Polynomial polynomial2 = this.params.createPolynomial();
    Polynomial polynomial3 = this.params.createPolynomial();
    Polynomial polynomial4 = this.params.createPolynomial();
  ...
  public void s3Inv(Polynomial paramPolynomial) {
    Polynomial polynomial1 = this.params.createPolynomial();
    Polynomial polynomial2 = this.params.createPolynomial();
    Polynomial polynomial3 = this.params.createPolynomial();
    Polynomial polynomial4 = this.params.createPolynomial();
  ...
  void r2Inv(Polynomial paramPolynomial1, Polynomial paramPolynomial2, Polynomial paramPolynomial3, Polynomial paramPolynomial4, Polynomial paramPolynomial5) {
    int i = this.coeffs.length;
  ...
  void rqInv(Polynomial paramPolynomial1, Polynomial paramPolynomial2, Polynomial paramPolynomial3, Polynomial paramPolynomial4, Polynomial paramPolynomial5) {
  ...
  private void r2InvToRqInv(Polynomial paramPolynomial1, Polynomial paramPolynomial2, Polynomial paramPolynomial3, Polynomial paramPolynomial4, Polynomial paramPolynomial5) {
    int i = this.coeffs.length;
    byte b;
    for (b = 0; b < i; b++)
  ...
  void s3Inv(Polynomial paramPolynomial1, Polynomial paramPolynomial2, Polynomial paramPolynomial3, Polynomial paramPolynomial4, Polynomial paramPolynomial5) {
    int i = this.coeffs.length;
    paramPolynomial5.coeffs[0] = 1;
    int j;
    for (j = 0; j < i; j++)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\math\ntru\Polynomial.class
