...
public class SPHINCSPLUSPrivateKey extends ASN1Object {
  ...
  public static SPHINCSPLUSPrivateKey getInstance(Object paramObject) {
    return (paramObject instanceof SPHINCSPLUSPrivateKey) ? (SPHINCSPLUSPrivateKey)paramObject : ((paramObject != null) ? new SPHINCSPLUSPrivateKey(ASN1Sequence.getInstance(paramObject)) : null);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\asn1\SPHINCSPLUSPrivateKey.class
