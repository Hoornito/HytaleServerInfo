...
public class FalconPrivateKey extends ASN1Object {
  ...
  public static FalconPrivateKey getInstance(Object paramObject) {
    return (paramObject instanceof FalconPrivateKey) ? (FalconPrivateKey)paramObject : ((paramObject != null) ? new FalconPrivateKey(ASN1Sequence.getInstance(paramObject)) : null);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\asn1\FalconPrivateKey.class
