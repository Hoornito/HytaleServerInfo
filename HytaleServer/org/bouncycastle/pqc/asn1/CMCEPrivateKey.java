...
public class CMCEPrivateKey extends ASN1Object {
  ...
  public static CMCEPrivateKey getInstance(Object paramObject) {
    return (paramObject instanceof CMCEPrivateKey) ? (CMCEPrivateKey)paramObject : ((paramObject != null) ? new CMCEPrivateKey(ASN1Sequence.getInstance(paramObject)) : null);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\asn1\CMCEPrivateKey.class
