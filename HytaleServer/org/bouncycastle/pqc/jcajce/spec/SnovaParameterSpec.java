...
public class SnovaParameterSpec implements AlgorithmParameterSpec {
  ...
  public static SnovaParameterSpec fromName(String paramString) {
    return (SnovaParameterSpec)parameters.get(Strings.toLowerCase(paramString));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\spec\SnovaParameterSpec.class
