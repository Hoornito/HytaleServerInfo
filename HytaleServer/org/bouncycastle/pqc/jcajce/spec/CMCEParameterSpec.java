...
public class CMCEParameterSpec implements AlgorithmParameterSpec {
  ...
  public static CMCEParameterSpec fromName(String paramString) {
    return (CMCEParameterSpec)parameters.get(Strings.toLowerCase(paramString));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\spec\CMCEParameterSpec.class
