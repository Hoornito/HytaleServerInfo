...
public class SPHINCSPlusParameterSpec implements AlgorithmParameterSpec {
  ...
  public static SPHINCSPlusParameterSpec fromName(String paramString) {
    return (SPHINCSPlusParameterSpec)parameters.get(Strings.toLowerCase(paramString));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\spec\SPHINCSPlusParameterSpec.class
