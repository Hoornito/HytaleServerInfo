...
public class PicnicParameterSpec implements AlgorithmParameterSpec {
  ...
  public static PicnicParameterSpec fromName(String paramString) {
    return (PicnicParameterSpec)parameters.get(Strings.toLowerCase(paramString));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\spec\PicnicParameterSpec.class
