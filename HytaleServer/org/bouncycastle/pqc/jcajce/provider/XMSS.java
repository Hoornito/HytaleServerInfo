...
public class XMSS {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      addSignatureAlgorithm(param1ConfigurableProvider, "SHAKE128(512)", "XMSS-SHAKE128", "org.bouncycastle.pqc.jcajce.provider.xmss.XMSSSignatureSpi$withShake128_512andPrehash", BCObjectIdentifiers.xmss_SHAKE128_512ph);
      ...
      addSignatureAlgorithm(param1ConfigurableProvider, "SHAKE256(1024)", "XMSS-SHAKE256", "org.bouncycastle.pqc.jcajce.provider.xmss.XMSSSignatureSpi$withShake256_1024andPrehash", BCObjectIdentifiers.xmss_SHAKE256_1024ph);
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature.SHAKE128(512)WITHXMSS", "SHAKE128(512)WITHXMSS-SHAKE128");
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature.SHAKE256(1024)WITHXMSS", "SHAKE256(1024)WITHXMSS-SHAKE256");
      ...
      addSignatureAlgorithm(param1ConfigurableProvider, "SHAKE128(512)", "XMSSMT-SHAKE128", "org.bouncycastle.pqc.jcajce.provider.xmss.XMSSMTSignatureSpi$withShake128_512andPrehash", BCObjectIdentifiers.xmss_mt_SHAKE128_512ph);
      ...
      addSignatureAlgorithm(param1ConfigurableProvider, "SHAKE256(1024)", "XMSSMT-SHAKE256", "org.bouncycastle.pqc.jcajce.provider.xmss.XMSSMTSignatureSpi$withShake256_1024andPrehash", BCObjectIdentifiers.xmss_mt_SHAKE256_1024ph);
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature.SHAKE128(512)WITHXMSSMT", "SHAKE128(512)WITHXMSSMT-SHAKE128");
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature.SHAKE256(1024)WITHXMSSMT", "SHAKE256(1024)WITHXMSSMT-SHAKE256");
      registerOid(param1ConfigurableProvider, PQCObjectIdentifiers.xmss, "XMSS", (AsymmetricKeyInfoConverter)new XMSSKeyFactorySpi());
      registerOid(param1ConfigurableProvider, IsaraObjectIdentifiers.id_alg_xmss, "XMSS", (AsymmetricKeyInfoConverter)new XMSSKeyFactorySpi());
      ...
      registerOid(param1ConfigurableProvider, IsaraObjectIdentifiers.id_alg_xmssmt, "XMSSMT", (AsymmetricKeyInfoConverter)new XMSSMTKeyFactorySpi());
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\XMSS.class
