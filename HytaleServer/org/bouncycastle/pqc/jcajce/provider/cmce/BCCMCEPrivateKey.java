...
public class BCCMCEPrivateKey implements PrivateKey, CMCEKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCCMCEPrivateKey) {
      BCCMCEPrivateKey bCCMCEPrivateKey = (BCCMCEPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\cmce\BCCMCEPrivateKey.class
