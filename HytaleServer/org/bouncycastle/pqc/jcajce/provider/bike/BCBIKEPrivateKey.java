...
public class BCBIKEPrivateKey implements PrivateKey, BIKEKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCBIKEPrivateKey) {
      BCBIKEPrivateKey bCBIKEPrivateKey = (BCBIKEPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\bike\BCBIKEPrivateKey.class
