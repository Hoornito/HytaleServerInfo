...
public class SABERKeyGeneratorSpi extends KeyGeneratorSpi {
  ...
  protected SecretKey engineGenerateKey() {
    if (this.genSpec != null) {
      ...
      SecretWithEncapsulation secretWithEncapsulation = sABERKEMGenerator.generateEncapsulated((AsymmetricKeyParameter)bCSABERPublicKey.getKeyParams());
    ...
    SABERKEMExtractor sABERKEMExtractor = new SABERKEMExtractor((SABERKeyParameters)bCSABERPrivateKey.getKeyParams());
    byte[] arrayOfByte1 = this.extSpec.getEncapsulation();
    byte[] arrayOfByte2 = sABERKEMExtractor.extractSecret(arrayOfByte1);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\saber\SABERKeyGeneratorSpi.class
