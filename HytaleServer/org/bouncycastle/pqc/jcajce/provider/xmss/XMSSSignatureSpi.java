...
public class XMSSSignatureSpi extends Signature implements StateAwareSignature {
  ...
  public static class withShake128andPrehash extends XMSSSignatureSpi {
    public withShake128andPrehash() {
      super("SHAKE128withXMSS-SHAKE128", (Digest)new SHAKEDigest(128), new XMSSSigner());
    }
  }
  
  public static class withShake256 extends XMSSSignatureSpi {
    public withShake256() {
      super("XMSS-SHAKE256", (Digest)new NullDigest(), new XMSSSigner());
    }
  }
  ...
  public static class withShake256andPrehash extends XMSSSignatureSpi {
    public withShake256andPrehash() {
      super("SHAKE256withXMSS-SHAKE256", (Digest)new SHAKEDigest(256), new XMSSSigner());
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\xmss\XMSSSignatureSpi.class
