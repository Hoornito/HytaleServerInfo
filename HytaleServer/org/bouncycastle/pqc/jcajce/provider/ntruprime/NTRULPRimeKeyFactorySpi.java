...
public class NTRULPRimeKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
  ...
  public final KeySpec engineGetKeySpec(Key paramKey, Class<?> paramClass) throws InvalidKeySpecException {
    ...
    } else if (paramKey instanceof BCNTRULPRimePublicKey) {
