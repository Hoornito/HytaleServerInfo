...
public class NTRULPRimeKeyGeneratorSpi extends KeyGeneratorSpi {
  ...
  protected SecretKey engineGenerateKey() {
    if (this.genSpec != null) {
      ...
      SecretWithEncapsulation secretWithEncapsulation = nTRULPRimeKEMGenerator.generateEncapsulated((AsymmetricKeyParameter)bCNTRULPRimePublicKey.getKeyParams());
    ...
    byte[] arrayOfByte2 = nTRULPRimeKEMExtractor.extractSecret(arrayOfByte1);
