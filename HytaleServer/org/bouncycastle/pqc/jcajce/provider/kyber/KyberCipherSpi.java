...
class KyberCipherSpi extends CipherSpi {
  ...
  KyberCipherSpi(MLKEMParameters paramMLKEMParameters) {
    this.kyberParameters = paramMLKEMParameters;
    this.algorithmName = Strings.toUpperCase(paramMLKEMParameters.getName());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\kyber\KyberCipherSpi.class
