...
public class BCKyberPrivateKey implements KyberPrivateKey {
  ...
  public BCKyberPrivateKey(MLKEMPrivateKeyParameters paramMLKEMPrivateKeyParameters) {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCKyberPrivateKey) {
      BCKyberPrivateKey bCKyberPrivateKey = (BCKyberPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\kyber\BCKyberPrivateKey.class
