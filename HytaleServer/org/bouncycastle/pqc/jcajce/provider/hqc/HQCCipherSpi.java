...
class HQCCipherSpi extends CipherSpi {
  ...
  protected byte[] engineWrap(Key paramKey) throws IllegalBlockSizeException, InvalidKeyException {
    ...
    try {
      ...
      KeyParameter keyParameter = new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), secretWithEncapsulation.getSecret()));
  ...
  protected Key engineUnwrap(byte[] paramArrayOfbyte, String paramString, int paramInt) throws InvalidKeyException, NoSuchAlgorithmException {
    ...
    try {
      ...
      Wrapper wrapper = WrapUtil.getWrapper(this.kemParameterSpec.getKeyAlgorithmName());
      KeyParameter keyParameter = new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), arrayOfByte1));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\hqc\HQCCipherSpi.class
