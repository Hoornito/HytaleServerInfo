...
public class BCPicnicPrivateKey implements PrivateKey, PicnicKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCPicnicPrivateKey) {
      BCPicnicPrivateKey bCPicnicPrivateKey = (BCPicnicPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\picnic\BCPicnicPrivateKey.class
