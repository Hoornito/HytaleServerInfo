...
public class BCMayoPublicKey implements PublicKey, MayoKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCMayoPublicKey) {
      BCMayoPublicKey bCMayoPublicKey = (BCMayoPublicKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provider\mayo\BCMayoPublicKey.class
