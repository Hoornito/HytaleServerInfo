...
public abstract class AsymmetricBlockCipher extends CipherSpiExt {
  ...
  public final int getOutputSize(int paramInt) {
    ...
    int j = getBlockSize();
    return (i > j) ? 0 : ((this.opMode == 1) ? this.cipherTextSize : this.maxPlainTextSize);
  }
  ...
  public final void initEncrypt(Key paramKey, AlgorithmParameterSpec paramAlgorithmParameterSpec) throws InvalidKeyException, InvalidAlgorithmParameterException {
    initEncrypt(paramKey, paramAlgorithmParameterSpec, CryptoServicesRegistrar.getSecureRandom());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pqc\jcajce\provide\\util\AsymmetricBlockCipher.class
