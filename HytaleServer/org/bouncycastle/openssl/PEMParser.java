...
public class PEMParser extends PemReader {
  ...
  private static class ECCurveParamsParser implements PemObjectParser {
    ...
    public Object parseObject(PemObject param1PemObject) throws IOException {
      try {
        ...
        return (aSN1Primitive instanceof org.bouncycastle.asn1.ASN1ObjectIdentifier) ? aSN1Primitive : ((aSN1Primitive instanceof ASN1Sequence) ? X9ECParameters.getInstance(aSN1Primitive) : null);
      } catch (IOException iOException) {
        throw iOException;
      } catch (Exception exception) {
  ...
  private static class ECDSAKeyPairParser implements PEMKeyPairParser {
    ...
    public PEMKeyPair parse(byte[] param1ArrayOfbyte) throws IOException {
      try {
        ...
        AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable)eCPrivateKey.getParametersObject());
        ...
        if (aSN1BitString != null)
          subjectPublicKeyInfo = new SubjectPublicKeyInfo(algorithmIdentifier, aSN1BitString.getBytes()); 
  ...
  private static class PKCS7Parser implements PemObjectParser {
    ...
    public Object parseObject(PemObject param1PemObject) throws IOException {
      try {
        return ContentInfo.getInstance(param1PemObject.getContent());
      } catch (Exception exception) {
  ...
  private static class RSAPublicKeyParser implements PemObjectParser {
    public Object parseObject(PemObject param1PemObject) throws IOException {
      try {
        ...
        return new SubjectPublicKeyInfo(algorithmIdentifier, (ASN1Encodable)rSAPublicKey);
      } catch (IOException iOException) {
        throw iOException;
      } catch (Exception exception) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\openssl\PEMParser.class
