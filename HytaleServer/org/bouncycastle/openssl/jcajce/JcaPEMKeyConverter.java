...
public class JcaPEMKeyConverter {
  ...
  public JcaPEMKeyConverter setAlgorithmMapping(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    this.algorithms.put(paramASN1ObjectIdentifier, paramString);
    return this;
  }
  ...
  private KeyFactory getKeyFactory(AlgorithmIdentifier paramAlgorithmIdentifier) throws NoSuchAlgorithmException, NoSuchProviderException {
    ...
    String str = (String)this.algorithms.get(aSN1ObjectIdentifier);
    if (str == null)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\openssl\jcajce\JcaPEMKeyConverter.class
