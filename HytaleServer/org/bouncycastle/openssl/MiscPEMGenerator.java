...
public class MiscPEMGenerator implements PemObjectGenerator {
  ...
  private PemObject createPemObject(Object paramObject) throws IOException {
    ...
    if (paramObject instanceof X509CertificateHolder) {
      ...
      if (aSN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.rsaEncryption)) {
      ...
      } else if (aSN1ObjectIdentifier.equals((ASN1Primitive)dsaOids[0]) || aSN1ObjectIdentifier.equals((ASN1Primitive)dsaOids[1])) {
        str = "DSA PRIVATE KEY";
        ...
        str = "PRIVATE KEY";
        arrayOfByte = privateKeyInfo.getEncoded();
      } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\openssl\MiscPEMGenerator.class
