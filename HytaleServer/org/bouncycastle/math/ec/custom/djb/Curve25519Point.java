...
public class Curve25519Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new Curve25519Point(eCCurve, (ECFieldElement)curve25519FieldElement7, (ECFieldElement)curve25519FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new Curve25519Point(getCurve(), this.x, this.y.negate(), this.zs));
  }
  ...
  protected Curve25519FieldElement getJacobianModifiedW() {
    ...
    if (curve25519FieldElement == null)
      this.zs[1] = (ECFieldElement)(curve25519FieldElement = calculateJacobianModifiedW((Curve25519FieldElement)this.zs[0], (int[])null)); 
  ...
  protected Curve25519Point twiceJacobianModified(boolean paramBoolean) {
    ...
    return new Curve25519Point(getCurve(), (ECFieldElement)curve25519FieldElement5, (ECFieldElement)curve25519FieldElement6, new ECFieldElement[] { (ECFieldElement)curve25519FieldElement7, (ECFieldElement)curve25519FieldElement8 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\djb\Curve25519Point.class
