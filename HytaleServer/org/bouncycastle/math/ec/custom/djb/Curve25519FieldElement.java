...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    Curve25519Field.inv(((Curve25519FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    if (Nat256.eq(arrayOfInt1, arrayOfInt14))
      return (ECFieldElement)new Curve25519FieldElement(arrayOfInt13); 
    Curve25519Field.multiply(arrayOfInt13, PRECOMP_POW2, arrayOfInt13);
    Curve25519Field.square(arrayOfInt13, arrayOfInt14);
    return (ECFieldElement)(Nat256.eq(arrayOfInt1, arrayOfInt14) ? new Curve25519FieldElement(arrayOfInt13) : null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\djb\Curve25519FieldElement.class
