...
public class SecT571R1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (secT571FieldElement2.isZero()) {
      ...
      if (secT571FieldElement7.isZero())
        return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)secT571FieldElement7, (ECFieldElement)SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)secT571FieldElement7, (ECFieldElement)secT571FieldElement8, new ECFieldElement[] { (ECFieldElement)secT571FieldElement9 });
  }
  ...
  public ECPoint twice() {
    ...
    if (Nat576.isZero64(arrayOfLong6))
      return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)new SecT571FieldElement(arrayOfLong6), (ECFieldElement)SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)secT571FieldElement4, (ECFieldElement)secT571FieldElement6, new ECFieldElement[] { (ECFieldElement)secT571FieldElement5 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (Nat576.isZero64(arrayOfLong11))
      return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)new SecT571FieldElement(arrayOfLong11), (ECFieldElement)SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return (ECPoint)new SecT571R1Point(eCCurve, (ECFieldElement)secT571FieldElement7, (ECFieldElement)secT571FieldElement9, new ECFieldElement[] { (ECFieldElement)secT571FieldElement8 });
  }
  ...
  public ECPoint negate() {
    ...
    return (ECPoint)new SecT571R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecT571R1Point.class
