...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224R1Field.inv(((SecP224R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat224.eq(arrayOfInt1, arrayOfInt3) ? (ECFieldElement)new SecP224R1FieldElement(arrayOfInt4) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP224R1FieldElement.class
