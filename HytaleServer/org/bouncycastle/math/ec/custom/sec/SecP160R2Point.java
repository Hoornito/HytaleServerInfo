...
public class SecP160R2Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecP160R2Point(eCCurve, (ECFieldElement)secP160R2FieldElement7, (ECFieldElement)secP160R2FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SecP160R2Point(eCCurve, (ECFieldElement)secP160R2FieldElement4, (ECFieldElement)secP160R2FieldElement5, new ECFieldElement[] { (ECFieldElement)secP160R2FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SecP160R2Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP160R2Point.class
