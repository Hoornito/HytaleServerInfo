...
public class SecP192K1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecP192K1Point(eCCurve, (ECFieldElement)secP192K1FieldElement7, (ECFieldElement)secP192K1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SecP192K1Point(eCCurve, (ECFieldElement)secP192K1FieldElement4, (ECFieldElement)secP192K1FieldElement5, new ECFieldElement[] { (ECFieldElement)secP192K1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SecP192K1Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP192K1Point.class
