...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat224.create();
    SecP224K1Field.inv(((SecP224K1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    if (Nat224.eq(arrayOfInt1, arrayOfInt14))
      return (ECFieldElement)new SecP224K1FieldElement(arrayOfInt13); 
    SecP224K1Field.multiply(arrayOfInt13, PRECOMP_POW2, arrayOfInt13);
    SecP224K1Field.square(arrayOfInt13, arrayOfInt14);
    return (ECFieldElement)(Nat224.eq(arrayOfInt1, arrayOfInt14) ? new SecP224K1FieldElement(arrayOfInt13) : null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP224K1FieldElement.class
