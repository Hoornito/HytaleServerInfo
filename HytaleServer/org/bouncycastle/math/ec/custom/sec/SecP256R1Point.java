...
public class SecP256R1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecP256R1Point(eCCurve, (ECFieldElement)secP256R1FieldElement7, (ECFieldElement)secP256R1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SecP256R1Point(eCCurve, (ECFieldElement)secP256R1FieldElement4, (ECFieldElement)secP256R1FieldElement5, new ECFieldElement[] { (ECFieldElement)secP256R1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SecP256R1Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP256R1Point.class
