...
public class SecP160K1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecP160K1Point(eCCurve, (ECFieldElement)secP160R2FieldElement7, (ECFieldElement)secP160R2FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SecP160K1Point(eCCurve, (ECFieldElement)secP160R2FieldElement4, (ECFieldElement)secP160R2FieldElement5, new ECFieldElement[] { (ECFieldElement)secP160R2FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SecP160K1Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP160K1Point.class
