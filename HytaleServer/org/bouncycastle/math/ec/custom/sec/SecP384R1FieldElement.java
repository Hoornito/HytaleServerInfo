...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat.create(12);
    SecP384R1Field.inv(((SecP384R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat.eq(12, arrayOfInt1, arrayOfInt4) ? (ECFieldElement)new SecP384R1FieldElement(arrayOfInt3) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP384R1FieldElement.class
