...
public class SecP256R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    SecP256R1Field.inv(((SecP256R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat256.eq(arrayOfInt1, arrayOfInt4) ? (ECFieldElement)new SecP256R1FieldElement(arrayOfInt3) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP256R1FieldElement.class
