...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat160.create();
    SecP160R2Field.inv(((SecP160R2FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat160.eq(arrayOfInt1, arrayOfInt13) ? (ECFieldElement)new SecP160R2FieldElement(arrayOfInt12) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP160R2FieldElement.class
