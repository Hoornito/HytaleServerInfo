...
public class SecP192R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat192.create();
    SecP192R1Field.inv(((SecP192R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat192.eq(arrayOfInt1, arrayOfInt3) ? (ECFieldElement)new SecP192R1FieldElement(arrayOfInt2) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP192R1FieldElement.class
