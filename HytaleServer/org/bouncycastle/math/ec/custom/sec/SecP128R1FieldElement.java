...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat128.create();
    SecP128R1Field.inv(((SecP128R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat128.eq(arrayOfInt1, arrayOfInt10) ? (ECFieldElement)new SecP128R1FieldElement(arrayOfInt9) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP128R1FieldElement.class
