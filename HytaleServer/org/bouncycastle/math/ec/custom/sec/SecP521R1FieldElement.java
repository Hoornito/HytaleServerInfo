...
public class SecP521R1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat.create(17);
    SecP521R1Field.inv(((SecP521R1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat.eq(17, arrayOfInt1, arrayOfInt4) ? (ECFieldElement)new SecP521R1FieldElement(arrayOfInt3) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\sec\SecP521R1FieldElement.class
