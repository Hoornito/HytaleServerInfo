...
public class SM2P256V1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SM2P256V1Point(eCCurve, (ECFieldElement)sM2P256V1FieldElement7, (ECFieldElement)sM2P256V1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SM2P256V1Point(eCCurve, (ECFieldElement)sM2P256V1FieldElement4, (ECFieldElement)sM2P256V1FieldElement5, new ECFieldElement[] { (ECFieldElement)sM2P256V1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SM2P256V1Point(this.curve, this.x, this.y.negate(), this.zs));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\gm\SM2P256V1Point.class
