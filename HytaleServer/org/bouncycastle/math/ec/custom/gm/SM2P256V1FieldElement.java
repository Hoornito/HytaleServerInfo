...
public class SM2P256V1FieldElement extends ECFieldElement.AbstractFp {
  ...
  public ECFieldElement divide(ECFieldElement paramECFieldElement) {
    int[] arrayOfInt = Nat256.create();
    SM2P256V1Field.inv(((SM2P256V1FieldElement)paramECFieldElement).x, arrayOfInt);
  ...
  public ECFieldElement sqrt() {
    ...
    return Nat256.eq(arrayOfInt1, arrayOfInt11) ? (ECFieldElement)new SM2P256V1FieldElement(arrayOfInt9) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\custom\gm\SM2P256V1FieldElement.class
