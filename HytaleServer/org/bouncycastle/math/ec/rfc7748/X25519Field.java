...
public abstract class X25519Field {
  ...
  public static void decode(byte[] paramArrayOfbyte, int[] paramArrayOfint) {
    decode128(paramArrayOfbyte, 0, paramArrayOfint, 0);
    decode128(paramArrayOfbyte, 16, paramArrayOfint, 5);
  ...
  public static void decode(byte[] paramArrayOfbyte, int paramInt1, int[] paramArrayOfint, int paramInt2) {
    decode128(paramArrayOfbyte, paramInt1, paramArrayOfint, paramInt2);
    decode128(paramArrayOfbyte, paramInt1 + 16, paramArrayOfint, paramInt2 + 5);
    paramArrayOfint[paramInt2 + 9] = paramArrayOfint[paramInt2 + 9] & 0xFFFFFF;
  }
  ...
  public static void encode(int[] paramArrayOfint, byte[] paramArrayOfbyte) {
    encode128(paramArrayOfint, 0, paramArrayOfbyte, 0);
    encode128(paramArrayOfint, 5, paramArrayOfbyte, 16);
  }
  ...
  public static void encode(int[] paramArrayOfint, int paramInt1, byte[] paramArrayOfbyte, int paramInt2) {
    encode128(paramArrayOfint, paramInt1, paramArrayOfbyte, paramInt2);
    encode128(paramArrayOfint, paramInt1 + 5, paramArrayOfbyte, paramInt2 + 16);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\rfc7748\X25519Field.class
