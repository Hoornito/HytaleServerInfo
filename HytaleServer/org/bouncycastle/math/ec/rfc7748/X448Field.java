...
public abstract class X448Field {
  ...
  public static void decode(byte[] paramArrayOfbyte, int[] paramArrayOfint) {
    decode56(paramArrayOfbyte, 0, paramArrayOfint, 0);
    decode56(paramArrayOfbyte, 7, paramArrayOfint, 2);
    decode56(paramArrayOfbyte, 14, paramArrayOfint, 4);
    decode56(paramArrayOfbyte, 21, paramArrayOfint, 6);
    decode56(paramArrayOfbyte, 28, paramArrayOfint, 8);
    decode56(paramArrayOfbyte, 35, paramArrayOfint, 10);
    decode56(paramArrayOfbyte, 42, paramArrayOfint, 12);
    decode56(paramArrayOfbyte, 49, paramArrayOfint, 14);
  }
  ...
  public static void decode(byte[] paramArrayOfbyte, int paramInt1, int[] paramArrayOfint, int paramInt2) {
    decode56(paramArrayOfbyte, paramInt1, paramArrayOfint, paramInt2);
    decode56(paramArrayOfbyte, paramInt1 + 7, paramArrayOfint, paramInt2 + 2);
    decode56(paramArrayOfbyte, paramInt1 + 14, paramArrayOfint, paramInt2 + 4);
    decode56(paramArrayOfbyte, paramInt1 + 21, paramArrayOfint, paramInt2 + 6);
    decode56(paramArrayOfbyte, paramInt1 + 28, paramArrayOfint, paramInt2 + 8);
    decode56(paramArrayOfbyte, paramInt1 + 35, paramArrayOfint, paramInt2 + 10);
    decode56(paramArrayOfbyte, paramInt1 + 42, paramArrayOfint, paramInt2 + 12);
    decode56(paramArrayOfbyte, paramInt1 + 49, paramArrayOfint, paramInt2 + 14);
  }
  ...
  public static void encode(int[] paramArrayOfint, byte[] paramArrayOfbyte) {
    encode56(paramArrayOfint, 0, paramArrayOfbyte, 0);
    encode56(paramArrayOfint, 2, paramArrayOfbyte, 7);
    encode56(paramArrayOfint, 4, paramArrayOfbyte, 14);
    encode56(paramArrayOfint, 6, paramArrayOfbyte, 21);
    encode56(paramArrayOfint, 8, paramArrayOfbyte, 28);
    encode56(paramArrayOfint, 10, paramArrayOfbyte, 35);
    encode56(paramArrayOfint, 12, paramArrayOfbyte, 42);
    encode56(paramArrayOfint, 14, paramArrayOfbyte, 49);
  }
  ...
  public static void encode(int[] paramArrayOfint, int paramInt1, byte[] paramArrayOfbyte, int paramInt2) {
    encode56(paramArrayOfint, paramInt1, paramArrayOfbyte, paramInt2);
    encode56(paramArrayOfint, paramInt1 + 2, paramArrayOfbyte, paramInt2 + 7);
    encode56(paramArrayOfint, paramInt1 + 4, paramArrayOfbyte, paramInt2 + 14);
    encode56(paramArrayOfint, paramInt1 + 6, paramArrayOfbyte, paramInt2 + 21);
    encode56(paramArrayOfint, paramInt1 + 8, paramArrayOfbyte, paramInt2 + 28);
    encode56(paramArrayOfint, paramInt1 + 10, paramArrayOfbyte, paramInt2 + 35);
    encode56(paramArrayOfint, paramInt1 + 12, paramArrayOfbyte, paramInt2 + 42);
    encode56(paramArrayOfint, paramInt1 + 14, paramArrayOfbyte, paramInt2 + 49);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\rfc7748\X448Field.class
