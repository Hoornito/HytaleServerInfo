...
public abstract class ECFieldElement implements ECConstants {
  ...
  public void encodeTo(byte[] paramArrayOfbyte, int paramInt) {
    BigIntegers.asUnsignedByteArray(toBigInteger(), paramArrayOfbyte, paramInt, getEncodedLength());
  }
  ...
  public static abstract class AbstractF2m extends ECFieldElement {
    public ECFieldElement halfTrace() {
      ...
      int j = i + 1 >>> 1;
      int k = 31 - Integers.numberOfLeadingZeros(j);
      int m = 1;
      ECFieldElement eCFieldElement = this;
      while (k > 0) {
        eCFieldElement = eCFieldElement.squarePow(m << 1).add(eCFieldElement);
        m = j >>> --k;
        if (0 != (m & 0x1))
  ...
  public static class F2m extends AbstractF2m {
    ...
    F2m(int param1Int, int[] param1ArrayOfint, LongArray param1LongArray) {
      this.m = param1Int;
  ...
  public static class Fp extends AbstractFp {
    ...
    protected BigInteger modInverse(BigInteger param1BigInteger) {
      return BigIntegers.modOddInverse(this.q, param1BigInteger);
    }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\math\ec\ECFieldElement.class
