...
public class AttributeCertificateHolder implements Selector {
  ...
  public int getDigestedObjectType() {
    return (this.holder.getObjectDigestInfo() != null) ? this.holder.getObjectDigestInfo().getDigestedObjectType().intValueExact() : -1;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\AttributeCertificateHolder.class
