...
class MSOutlookKeyIdCalculator {
  ...
  private static abstract class GeneralDigest {
    ...
    GeneralDigest(GeneralDigest param1GeneralDigest) {
      copyIn(param1GeneralDigest);
    }
    
    void copyIn(GeneralDigest param1GeneralDigest) {
    ...
    abstract void processWord(byte[] param1ArrayOfbyte, int param1Int);
    
    abstract void processLength(long param1Long);
  ...
  private static class SHA1Digest extends GeneralDigest {
    ...
    void processWord(byte[] param1ArrayOfbyte, int param1Int) {
    ...
    void processLength(long param1Long) {
      if (this.xOff > 14)
        processBlock(); 
    ...
    int doFinal(byte[] param1ArrayOfbyte, int param1Int) {
      finish();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\selector\MSOutlookKeyIdCalculator.class
