...
public class X509CertificateHolderSelector implements Selector {
  ...
  public X509CertificateHolderSelector(X500Name paramX500Name, BigInteger paramBigInteger, byte[] paramArrayOfbyte) {
    ...
    this.subjectKeyId = Arrays.clone(paramArrayOfbyte);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\selector\X509CertificateHolderSelector.class
