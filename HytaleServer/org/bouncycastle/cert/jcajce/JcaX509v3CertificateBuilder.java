...
public class JcaX509v3CertificateBuilder extends X509v3CertificateBuilder {
  public JcaX509v3CertificateBuilder(X500Name paramX500Name1, BigInteger paramBigInteger, Date paramDate1, Date paramDate2, X500Name paramX500Name2, SubjectPublicKeyInfo paramSubjectPublicKeyInfo) {
    super(paramX500Name1, paramBigInteger, paramDate1, paramDate2, paramX500Name2, paramSubjectPublicKeyInfo);
  }
  ...
  public JcaX509v3CertificateBuilder(X500Name paramX500Name1, BigInteger paramBigInteger, Date paramDate1, Date paramDate2, X500Name paramX500Name2, PublicKey paramPublicKey) {
    super(paramX500Name1, paramBigInteger, paramDate1, paramDate2, paramX500Name2, getSubjectPublicKeyInfo(paramPublicKey));
  }
  ...
  public JcaX509v3CertificateBuilder(X500Name paramX500Name1, BigInteger paramBigInteger, Time paramTime1, Time paramTime2, X500Name paramX500Name2, PublicKey paramPublicKey) {
    super(paramX500Name1, paramBigInteger, paramTime1, paramTime2, paramX500Name2, getSubjectPublicKeyInfo(paramPublicKey));
  }
  ...
  public JcaX509v3CertificateBuilder(X500Principal paramX500Principal1, BigInteger paramBigInteger, Date paramDate1, Date paramDate2, X500Principal paramX500Principal2, PublicKey paramPublicKey) {
    super(X500Name.getInstance(paramX500Principal1.getEncoded()), paramBigInteger, paramDate1, paramDate2, X500Name.getInstance(paramX500Principal2.getEncoded()), getSubjectPublicKeyInfo(paramPublicKey));
  }
  ...
  public JcaX509v3CertificateBuilder(X509Certificate paramX509Certificate) throws CertificateEncodingException {
    super(new JcaX509CertificateHolder(paramX509Certificate));
  }
  ...
  private static SubjectPublicKeyInfo getSubjectPublicKeyInfo(PublicKey paramPublicKey) {
    return SubjectPublicKeyInfo.getInstance(paramPublicKey.getEncoded());
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\jcajce\JcaX509v3CertificateBuilder.class
