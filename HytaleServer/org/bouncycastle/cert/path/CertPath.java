    ...
    for (byte b = 0; b != paramArrayOfCertPathValidation.length; b++) {
      for (int i = this.certificates.length - 1; i >= 0; i--) {
        try {
          ...
          certPathValidationResultBuilder.addException(i, b, certPathValidationException);
        } 
      } 
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\path\CertPath.class
