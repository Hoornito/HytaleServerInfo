...
public class RevokedStatus implements CertificateStatus {
  ...
  public RevokedStatus(Date paramDate) {
    this.info = new RevokedInfo(new ASN1GeneralizedTime(paramDate));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\ocsp\RevokedStatus.class
