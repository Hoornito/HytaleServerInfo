...
public class ProtectedPKIMessageBuilder {
  ...
  public ProtectedPKIMessageBuilder setBody(int paramInt, CertificateReqMessages paramCertificateReqMessages) {
    if (!CertificateReqMessages.isCertificateRequestMessages(paramInt))
      throw new IllegalArgumentException("body type " + paramInt + " does not match CMP type CertReqMessages"); 
    this.body = new PKIBody(paramInt, (ASN1Encodable)paramCertificateReqMessages.toASN1Structure());
    return this;
  }
  
  public ProtectedPKIMessageBuilder setBody(int paramInt, CertificateRepMessage paramCertificateRepMessage) {
    if (!CertificateRepMessage.isCertificateRepMessage(paramInt))
      throw new IllegalArgumentException("body type " + paramInt + " does not match CMP type CertRepMessage"); 
    this.body = new PKIBody(paramInt, (ASN1Encodable)paramCertificateRepMessage.toASN1Structure());
    return this;
  }
  
  public ProtectedPKIMessageBuilder setBody(int paramInt, CertificateConfirmationContent paramCertificateConfirmationContent) {
    if (!CertificateConfirmationContent.isCertificateConfirmationContent(paramInt))
      throw new IllegalArgumentException("body type " + paramInt + " does not match CMP type CertConfirmContent"); 
    this.body = new PKIBody(paramInt, (ASN1Encodable)paramCertificateConfirmationContent.toASN1Structure());
    return this;
  }
  
  public ProtectedPKIMessageBuilder setBody(POPODecryptionKeyChallengeContent paramPOPODecryptionKeyChallengeContent) {
    this.body = new PKIBody(5, (ASN1Encodable)paramPOPODecryptionKeyChallengeContent.toASN1Structure());
    return this;
  }
  
  public ProtectedPKIMessageBuilder setBody(POPODecryptionKeyResponseContent paramPOPODecryptionKeyResponseContent) {
    this.body = new PKIBody(6, (ASN1Encodable)paramPOPODecryptionKeyResponseContent.toASN1Structure());
    return this;
  }
  ...
  private ProtectedPKIMessage finaliseMessage(PKIHeader paramPKIHeader, DERBitString paramDERBitString) {
    if (!this.extraCerts.isEmpty()) {
      ...
      return new ProtectedPKIMessage(new PKIMessage(paramPKIHeader, this.body, (ASN1BitString)paramDERBitString, arrayOfCMPCertificate));
    } 
    return new ProtectedPKIMessage(new PKIMessage(paramPKIHeader, this.body, (ASN1BitString)paramDERBitString));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cert\cmp\ProtectedPKIMessageBuilder.class
