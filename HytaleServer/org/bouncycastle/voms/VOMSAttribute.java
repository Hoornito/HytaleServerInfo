  ...
  public VOMSAttribute(X509AttributeCertificateHolder paramX509AttributeCertificateHolder) {
    ...
    try {
      for (byte b = 0; b != arrayOfAttribute.length; b++) {
        ...
        String str = ((ASN1IA5String)ietfAttrSyntax.getPolicyAuthority().getNames()[0].getName()).getString();
        int i = str.indexOf("://");
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\voms\VOMSAttribute.class
