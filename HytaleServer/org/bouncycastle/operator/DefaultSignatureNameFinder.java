...
public class DefaultSignatureNameFinder implements AlgorithmNameFinder {
  ...
  private static void addSignatureName(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    if (oids.containsKey(paramASN1ObjectIdentifier))
      throw new IllegalStateException("object identifier already present in addSignatureName"); 
    oids.put(paramASN1ObjectIdentifier, paramString);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\operator\DefaultSignatureNameFinder.class
