...
public class JceKTSKeyWrapper extends AsymmetricKeyWrapper {
  ...
  public byte[] generateWrappedKey(GenericKey paramGenericKey) throws OperatorException {
    Cipher cipher = this.helper.createAsymmetricWrapper(getAlgorithmIdentifier(), new HashMap<>());
    try {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\operator\jcajce\JceKTSKeyWrapper.class
