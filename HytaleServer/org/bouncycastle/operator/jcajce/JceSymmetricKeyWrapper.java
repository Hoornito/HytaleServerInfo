...
public class JceSymmetricKeyWrapper extends SymmetricKeyWrapper {
  ...
  static AlgorithmIdentifier determineKeyEncAlg(String paramString, int paramInt) {
    ...
    if (paramString.startsWith("AES") || paramString.startsWith(NISTObjectIdentifiers.aes.getId())) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\operator\jcajce\JceSymmetricKeyWrapper.class
