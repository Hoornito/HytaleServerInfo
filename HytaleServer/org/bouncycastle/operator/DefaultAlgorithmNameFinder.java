...
public class DefaultAlgorithmNameFinder implements AlgorithmNameFinder {
  ...
  private static void addAlgorithm(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    if (algorithms.containsKey(paramASN1ObjectIdentifier))
      throw new IllegalStateException("algOid already present in addAlgorithm"); 
    algorithms.put(paramASN1ObjectIdentifier, paramString);
  }
  
  public boolean hasAlgorithmName(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return algorithms.containsKey(paramASN1ObjectIdentifier);
  }
  
  public String getAlgorithmName(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    String str = (String)algorithms.get(paramASN1ObjectIdentifier);
  ...
  public String getAlgorithmName(AlgorithmIdentifier paramAlgorithmIdentifier) {
    return getAlgorithmName(paramAlgorithmIdentifier.getAlgorithm());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\operator\DefaultAlgorithmNameFinder.class
