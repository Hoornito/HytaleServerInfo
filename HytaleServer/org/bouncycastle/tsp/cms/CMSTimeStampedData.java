...
public class CMSTimeStampedData {
  ...
  private void initialize(ContentInfo paramContentInfo) {
    ...
    if (CMSObjectIdentifiers.timestampedData.equals((ASN1Primitive)paramContentInfo.getContentType())) {
  ...
  public CMSTimeStampedData addTimeStamp(TimeStampToken paramTimeStampToken) throws CMSException {
    ...
    return new CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData, (ASN1Encodable)new TimeStampedData(this.timeStampedData.getDataUriIA5(), this.timeStampedData.getMetaData(), this.timeStampedData.getContent(), new Evidence(new TimeStampTokenEvidence(arrayOfTimeStampAndCRL2)))));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\tsp\cms\CMSTimeStampedData.class
