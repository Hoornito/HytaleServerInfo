...
class X509CRLStoreSelector extends X509CRLSelector implements Selector {
  ...
  public boolean match(Object paramObject) {
    ...
    try {
      ...
      if (arrayOfByte != null)
        aSN1Integer = ASN1Integer.getInstance(JcaX509ExtensionUtils.parseExtensionValue(arrayOfByte)); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pkix\jcajce\X509CRLStoreSelector.class
