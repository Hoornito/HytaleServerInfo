...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
        ...
        if (!isSelfIssued(x509Certificate)) {
          ...
          if (aSN1Sequence2 != null) {
            if (aSN1Sequence2.size() > 1024) {
              ErrorBundle errorBundle = createErrorBundle("CertPathReviewer.subjAltNameExtError");
              throw new CertPathReviewerException(errorBundle, this.certPath, i);
            } 
  ...
  private void checkSignatures() {
    ...
    for (int i = this.certs.size() - 1; i >= 0; i--) {
      ...
      if (publicKey != null) {
        ...
        if (arrayOfByte != null) {
          AuthorityKeyIdentifier authorityKeyIdentifier = AuthorityKeyIdentifier.getInstance(ASN1OctetString.getInstance(arrayOfByte).getOctets());
  ...
  protected Collection getTrustAnchors(X509Certificate paramX509Certificate, Set paramSet) throws CertPathReviewerException {
    ...
    try {
      ...
      if (arrayOfByte != null) {
        AuthorityKeyIdentifier authorityKeyIdentifier = AuthorityKeyIdentifier.getInstance(JcaX509ExtensionUtils.parseExtensionValue(arrayOfByte));
        BigInteger bigInteger = authorityKeyIdentifier.getAuthorityCertSerialNumber();
        if (bigInteger != null) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pkix\jcajce\PKIXCertPathReviewer.class
