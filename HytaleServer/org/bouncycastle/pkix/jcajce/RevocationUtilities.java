...
class RevocationUtilities {
  ...
  static List<PKIXCRLStore> getAdditionalStoresFromCRLDistributionPoint(CRLDistPoint paramCRLDistPoint, Map<GeneralName, PKIXCRLStore> paramMap) throws AnnotatedException {
    ...
    for (DistributionPoint distributionPoint : arrayOfDistributionPoint) {
      ...
      if (distributionPointName != null && distributionPointName.getType() == 0) {
        ...
        for (GeneralName generalName : arrayOfGeneralName) {
          PKIXCRLStore pKIXCRLStore = paramMap.get(generalName);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pkix\jcajce\RevocationUtilities.class
