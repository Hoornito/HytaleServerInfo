...
public class LocalizedMessage {
  ...
  public String toString() {
    ...
    stringBuilder.append("Resource: \"").append(this.resource);
    stringBuilder.append("\" Id: \"").append(this.id).append("\"");
    stringBuilder.append(" Arguments: ").append((this.arguments.getArguments()).length).append(" normal");
    if (this.extraArgs != null && (this.extraArgs.getArguments()).length > 0)
      stringBuilder.append(", ").append((this.extraArgs.getArguments()).length).append(" extra"); 
    stringBuilder.append(" Encoding: ").append(this.encoding);
    stringBuilder.append(" ClassLoader: ").append(this.loader);
    ...
    FilteredArguments(Object[] param1ArrayOfObject) {
      ...
      for (byte b = 0; b < param1ArrayOfObject.length; b++) {
        if (param1ArrayOfObject[b] instanceof TrustedInput) {
          ...
          if (param1ArrayOfObject[b] instanceof org.bouncycastle.pkix.util.filter.UntrustedUrlInput) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pki\\util\LocalizedMessage.class
