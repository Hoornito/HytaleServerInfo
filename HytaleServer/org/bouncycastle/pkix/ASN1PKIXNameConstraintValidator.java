...
class ASN1PKIXNameConstraintValidator implements NameConstraintValidator {
  ...
  public void checkPermitted(GeneralName paramGeneralName) throws NameConstraintValidatorException {
    ...
    switch (paramGeneralName.getTagNo()) {
      ...
      case 1:
        ...
        break;
      case 2:
        checkPermittedDNS(this.permittedSubtreesDNS, ASN1IA5String.getInstance(paramGeneralName.getName()).getString());
        break;
      case 4:
        checkPermittedDN(X500Name.getInstance(paramGeneralName.getName()));
        break;
      case 6:
        checkPermittedURI(this.permittedSubtreesURI, ASN1IA5String.getInstance(paramGeneralName.getName()).getString());
        break;
      case 7:
  ...
  public void checkExcluded(GeneralName paramGeneralName) throws NameConstraintValidatorException {
    ...
    switch (paramGeneralName.getTagNo()) {
      ...
      case 1:
        ...
        break;
      case 2:
        checkExcludedDNS(this.excludedSubtreesDNS, ASN1IA5String.getInstance(paramGeneralName.getName()).getString());
        break;
      case 4:
        checkExcludedDN(X500Name.getInstance(paramGeneralName.getName()));
        break;
      case 6:
        checkExcludedURI(this.excludedSubtreesURI, ASN1IA5String.getInstance(paramGeneralName.getName()).getString());
        break;
      case 7:
        arrayOfByte = ASN1OctetString.getInstance(paramGeneralName.getName()).getOctets();
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof ASN1PKIXNameConstraintValidator))
      return false; 
    ASN1PKIXNameConstraintValidator aSN1PKIXNameConstraintValidator = (ASN1PKIXNameConstraintValidator)paramObject;
  ...
  private Set intersectOtherName(Set<?> paramSet1, Set<?> paramSet2) {
    HashSet hashSet = new HashSet(paramSet1);
    hashSet.retainAll(paramSet2);
    return hashSet;
  }
  
  private Set unionOtherName(Set<?> paramSet, OtherName paramOtherName) {
    HashSet<OtherName> hashSet = new HashSet(paramSet);
  ...
  private void checkPermittedOtherName(Set paramSet, OtherName paramOtherName) throws NameConstraintValidatorException {
    if (paramSet == null)
      return; 
    for (OtherName otherName : paramSet) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pkix\ASN1PKIXNameConstraintValidator.class
