...
public class CMSSignedGenerator {
  ...
  protected CMSSignedGenerator(DigestAlgorithmIdentifierFinder paramDigestAlgorithmIdentifierFinder) {
    this.digestAlgIdFinder = paramDigestAlgorithmIdentifierFinder;
  }
  ...
  public void addOtherRevocationInfo(ASN1ObjectIdentifier paramASN1ObjectIdentifier, ASN1Encodable paramASN1Encodable) {
    OtherRevocationInfoFormat otherRevocationInfoFormat = new OtherRevocationInfoFormat(paramASN1ObjectIdentifier, paramASN1Encodable);
    CMSUtils.validateInfoFormat(otherRevocationInfoFormat);
    this.crls.add(new DERTaggedObject(false, 1, (ASN1Encodable)otherRevocationInfoFormat));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\CMSSignedGenerator.class
