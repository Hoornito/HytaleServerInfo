...
public abstract class KeyAgreeRecipientInfoGenerator implements RecipientInfoGenerator {
  ...
  protected OriginatorPublicKey createOriginatorPublicKey(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) {
    return new OriginatorPublicKey(paramSubjectPublicKeyInfo.getAlgorithm(), paramSubjectPublicKeyInfo.getPublicKeyData().getBytes());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\KeyAgreeRecipientInfoGenerator.class
