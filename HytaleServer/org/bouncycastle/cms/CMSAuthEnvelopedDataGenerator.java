...
public class CMSAuthEnvelopedDataGenerator extends CMSAuthEnvelopedGenerator {
  private CMSAuthEnvelopedData doGenerate(CMSTypedData paramCMSTypedData, OutputAEADEncryptor paramOutputAEADEncryptor) throws CMSException {
    ...
    try {
      ...
      if (CMSAlgorithm.ChaCha20Poly1305.equals((ASN1Primitive)paramOutputAEADEncryptor.getAlgorithmIdentifier().getAlgorithm())) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\CMSAuthEnvelopedDataGenerator.class
