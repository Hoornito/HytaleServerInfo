...
public abstract class JceKTSKeyTransRecipient implements KeyTransRecipient {
  ...
  protected Key extractSecretKey(AlgorithmIdentifier paramAlgorithmIdentifier1, AlgorithmIdentifier paramAlgorithmIdentifier2, byte[] paramArrayOfbyte) throws CMSException {
    ...
    try {
      Key key = this.helper.getJceKey(paramAlgorithmIdentifier2, jceKTSKeyUnwrapper.generateUnwrappedKey(paramAlgorithmIdentifier2, paramArrayOfbyte));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\jcajce\JceKTSKeyTransRecipient.class
