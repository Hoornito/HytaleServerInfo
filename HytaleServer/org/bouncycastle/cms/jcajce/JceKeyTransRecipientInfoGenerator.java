...
public class JceKeyTransRecipientInfoGenerator extends KeyTransRecipientInfoGenerator {
  ...
  public JceKeyTransRecipientInfoGenerator(X509Certificate paramX509Certificate, AsymmetricKeyWrapper paramAsymmetricKeyWrapper) throws CertificateEncodingException {
    super(new IssuerAndSerialNumber((new JcaX509CertificateHolder(paramX509Certificate)).toASN1Structure()), paramAsymmetricKeyWrapper);
  }
  ...
  public JceKeyTransRecipientInfoGenerator(byte[] paramArrayOfbyte, AsymmetricKeyWrapper paramAsymmetricKeyWrapper) {
    super(paramArrayOfbyte, paramAsymmetricKeyWrapper);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\jcajce\JceKeyTransRecipientInfoGenerator.class
