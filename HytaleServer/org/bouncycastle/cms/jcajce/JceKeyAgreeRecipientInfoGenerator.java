...
public class JceKeyAgreeRecipientInfoGenerator extends KeyAgreeRecipientInfoGenerator {
  ...
  public JceKeyAgreeRecipientInfoGenerator(ASN1ObjectIdentifier paramASN1ObjectIdentifier1, PrivateKey paramPrivateKey, PublicKey paramPublicKey, ASN1ObjectIdentifier paramASN1ObjectIdentifier2) {
    ...
    this.senderPrivateKey = CMSUtils.cleanPrivateKey(paramPrivateKey);
  }
  ...
  public JceKeyAgreeRecipientInfoGenerator setKeyWrappingProvider(Provider paramProvider) {
    this.wrappingHelper = new EnvelopedDataHelper(new ProviderJcaJceExtHelper(paramProvider));
    return this;
  }
  
  public JceKeyAgreeRecipientInfoGenerator setKeyWrappingProvider(String paramString) {
    this.wrappingHelper = new EnvelopedDataHelper(new NamedJcaJceExtHelper(paramString));
    return this;
  }
      ...
      try {
        ...
        if (CMSUtils.isMQV(aSN1ObjectIdentifier)) {
          ...
          if (this.userKeyingMaterial != null) {
            ...
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.id_alg_SSDH))
        ...
        EnvelopedDataHelper envelopedDataHelper = (this.wrappingHelper != null) ? this.wrappingHelper : this.helper;
        Cipher cipher = envelopedDataHelper.createCipher(aSN1ObjectIdentifier1);
        if (aSN1ObjectIdentifier1.equals((ASN1Primitive)CryptoProObjectIdentifiers.id_Gost28147_89_None_KeyWrap) || aSN1ObjectIdentifier1.equals((ASN1Primitive)CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_KeyWrap)) {
          ...
          byte[] arrayOfByte = cipher.wrap(envelopedDataHelper.getJceKey(paramGenericKey));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\jcajce\JceKeyAgreeRecipientInfoGenerator.class
