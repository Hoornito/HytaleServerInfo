...
public class SignerInfoGeneratorBuilder {
  ...
  private SignerInfoGenerator createGenerator(ContentSigner paramContentSigner, SignerIdentifier paramSignerIdentifier) throws OperatorCreationException {
    ...
    if (this.contentDigest != null) {
      ...
      if (paramContentSigner instanceof ExtendedContentSigner)
        algorithmIdentifier = ((ExtendedContentSigner)paramContentSigner).getDigestAlgorithmIdentifier(); 
      if (algorithmIdentifier == null)
        algorithmIdentifier = this.digAlgFinder.find(paramContentSigner.getAlgorithmIdentifier()); 
      if (algorithmIdentifier != null) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\SignerInfoGeneratorBuilder.class
