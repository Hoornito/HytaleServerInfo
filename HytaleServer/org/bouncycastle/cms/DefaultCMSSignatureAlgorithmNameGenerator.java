...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
  ...
  private void addEntries(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString1, String paramString2) {
    addDigestAlg(paramASN1ObjectIdentifier, paramString1);
    addEncryptionAlg(paramASN1ObjectIdentifier, paramString2);
  }
  
  private void addSimpleAlg(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    if (this.simpleAlgs.containsKey(paramASN1ObjectIdentifier))
      throw new IllegalStateException("object identifier already present in addSimpleAlg"); 
    this.simpleAlgs.put(paramASN1ObjectIdentifier, paramString);
  }
  
  private void addDigestAlg(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    if (this.digestAlgs.containsKey(paramASN1ObjectIdentifier))
  ...
  private void addEncryptionAlg(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    if (this.encryptionAlgs.containsKey(paramASN1ObjectIdentifier))
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\cms\DefaultCMSSignatureAlgorithmNameGenerator.class
