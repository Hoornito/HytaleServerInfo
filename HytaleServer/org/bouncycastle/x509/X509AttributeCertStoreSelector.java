...
public class X509AttributeCertStoreSelector implements Selector {
  ...
  public boolean match(Object paramObject) {
    ...
    if (!this.targetNames.isEmpty() || !this.targetGroups.isEmpty()) {
      byte[] arrayOfByte = x509AttributeCertificate.getExtensionValue(Extension.targetInformation.getId());
      if (arrayOfByte != null) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\x509\X509AttributeCertStoreSelector.class
