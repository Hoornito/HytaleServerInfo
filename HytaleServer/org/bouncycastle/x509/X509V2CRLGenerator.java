...
public class X509V2CRLGenerator {
  ...
  private X509CRL generateJcaObject(TBSCertList paramTBSCertList, byte[] paramArrayOfbyte) throws CRLException {
    ...
    return (X509CRL)new X509CRLObject(CertificateList.getInstance(new DERSequence(aSN1EncodableVector)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\x509\X509V2CRLGenerator.class
