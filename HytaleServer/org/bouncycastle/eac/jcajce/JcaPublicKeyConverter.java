...
public class JcaPublicKeyConverter {
  ...
  public PublicKeyDataObject getPublicKeyDataObject(ASN1ObjectIdentifier paramASN1ObjectIdentifier, PublicKey paramPublicKey) {
    ...
    ECCurve eCCurve = convertCurve(ellipticCurve, eCParameterSpec.getOrder(), eCParameterSpec.getCofactor());
    ECPoint eCPoint1 = convertPoint(eCCurve, eCParameterSpec.getGenerator());
    ECPoint eCPoint2 = convertPoint(eCCurve, eCPublicKey.getW());
    return (PublicKeyDataObject)new ECDSAPublicKey(paramASN1ObjectIdentifier, ((ECFieldFp)ellipticCurve.getField()).getP(), ellipticCurve.getA(), ellipticCurve.getB(), eCPoint1.getEncoded(false), eCParameterSpec.getOrder(), eCPoint2.getEncoded(false), eCParameterSpec.getCofactor());
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\eac\jcajce\JcaPublicKeyConverter.class
