...
public class PKIXExtendedParameters implements CertPathParameters {
  ...
  private PKIXExtendedParameters(Builder paramBuilder) {
    ...
    this.validityDate = paramBuilder.validityDate;
  ...
  public static class Builder {
    ...
    public Builder(PKIXParameters param1PKIXParameters) {
      ...
      this.validityDate = param1PKIXParameters.getDate();
    ...
    public Builder(PKIXExtendedParameters param1PKIXExtendedParameters) {
      ...
      this.validityDate = param1PKIXExtendedParameters.validityDate;
      this.date = param1PKIXExtendedParameters.date;
      this.targetConstraints = param1PKIXExtendedParameters.targetConstraints;
      this.extraCertStores = new ArrayList<>(param1PKIXExtendedParameters.extraCertStores);
      this.namedCertificateStoreMap = new HashMap<>(param1PKIXExtendedParameters.namedCertificateStoreMap);
      this.extraCRLStores = new ArrayList<>(param1PKIXExtendedParameters.extraCRLStores);
      this.namedCRLStoreMap = new HashMap<>(param1PKIXExtendedParameters.namedCRLStoreMap);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\PKIXExtendedParameters.class
