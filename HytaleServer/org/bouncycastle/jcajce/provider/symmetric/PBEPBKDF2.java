...
public class PBEPBKDF2 {
  ...
  static {
    ...
    prfCodes.put(PKCSObjectIdentifiers.id_hmacWithSHA512_224, Integers.valueOf(15));
    prfCodes.put(PKCSObjectIdentifiers.id_hmacWithSHA512_256, Integers.valueOf(16));
    ...
    prfCodes.put(IANAObjectIdentifiers.hmacRIPEMD160, Integers.valueOf(2));
  ...
  public static class AlgParams extends BaseAlgorithmParameters {
    ...
    protected AlgorithmParameterSpec localEngineGetParameterSpec(Class<PBEParameterSpec> param1Class) throws InvalidParameterSpecException {
      if (param1Class == PBEParameterSpec.class || param1Class == AlgorithmParameterSpec.class)
  ...
  public static class Mappings extends AlgorithmProvider {
    ...
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.PBKDF2WITHHMACSHA512-224", PREFIX + "$PBKDF2withSHA512_224");
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.PBKDF2WITHHMACSHA512-256", PREFIX + "$PBKDF2withSHA512_256");
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.PBKDF2WITHHMACSM3", PREFIX + "$PBKDF2withSM3");
    }
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\PBEPBKDF2.class
