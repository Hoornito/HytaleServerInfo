...
public class BaseStreamCipher extends BaseWrapCipher implements PBE {
  ...
  protected BaseStreamCipher(StreamCipher paramStreamCipher, int paramInt1, int paramInt2) {
    this(paramStreamCipher, paramInt1, paramInt2, -1);
  }
  ...
  protected AlgorithmParameters engineGetParameters() {
    if (this.engineParams == null) {
      ...
      if (this.ivParam != null) {
        String str = this.cipher.getAlgorithmName();
        if (str.indexOf('/') >= 0)
          str = str.substring(0, str.indexOf('/')); 
        if (str.startsWith("ChaCha7539")) {
          str = "ChaCha7539";
  ...
  protected void engineSetMode(String paramString) throws NoSuchAlgorithmException {
    if (!paramString.equalsIgnoreCase("ECB") && !paramString.equals("NONE"))
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetri\\util\BaseStreamCipher.class
