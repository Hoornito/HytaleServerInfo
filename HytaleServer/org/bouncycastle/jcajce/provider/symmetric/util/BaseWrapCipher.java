...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
  ...
  protected BaseWrapCipher(int paramInt, Wrapper paramWrapper) {
    this(paramInt, paramWrapper, 0);
  }
  ...
  protected BaseWrapCipher(int paramInt1, Wrapper paramWrapper, int paramInt2) {
    this.pbeKeySize = paramInt1;
    this.wrapEngine = paramWrapper;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetri\\util\BaseWrapCipher.class
