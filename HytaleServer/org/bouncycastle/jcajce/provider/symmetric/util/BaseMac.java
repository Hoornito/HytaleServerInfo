...
public class BaseMac extends MacSpi implements PBE {
  ...
  protected BaseMac(int paramInt, Mac paramMac) {
  ...
  protected void engineInit(Key paramKey, AlgorithmParameterSpec paramAlgorithmParameterSpec) throws InvalidKeyException, InvalidAlgorithmParameterException {
    ...
    if (paramAlgorithmParameterSpec instanceof AEADParameterSpec) {
      ...
      aEADParameters = GcmSpecUtil.extractAeadParameters(keyParameter2, paramAlgorithmParameterSpec);
    } else if (!(paramAlgorithmParameterSpec instanceof PBEParameterSpec)) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetri\\util\BaseMac.class
