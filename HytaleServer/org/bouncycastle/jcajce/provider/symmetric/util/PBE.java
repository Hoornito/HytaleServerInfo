  ...
  public static class Util {
    private static PBEParametersGenerator makePBEGenerator(int param1Int1, int param1Int2) {
      ...
      if (param1Int1 == 1 || param1Int1 == 5) {
        switch (param1Int2) {
          case 5:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new MD2Digest(CryptoServicePurpose.PRF));
          case 0:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createMD5PRF());
          case 1:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA1PRF());
          case 2:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new RIPEMD160Digest(CryptoServicePurpose.PRF));
          case 3:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new TigerDigest(CryptoServicePurpose.PRF));
          case 4:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA256PRF());
          case 6:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new GOST3411Digest(CryptoServicePurpose.PRF));
          case 7:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA224PRF());
          case 8:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA384PRF());
          case 9:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA512PRF());
          case 15:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA512_224PRF());
          case 16:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA512_256PRF());
          case 10:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA3_224PRF());
          case 11:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA3_256PRF());
          case 12:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA3_384PRF());
          case 13:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator(DigestFactory.createSHA3_512PRF());
          case 14:
            return (PBEParametersGenerator)new PKCS5S2ParametersGenerator((Digest)new SM3Digest(CryptoServicePurpose.PRF));
        } 
      ...
      if (param1Int1 == 2) {
        switch (param1Int2) {
          case 5:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator((Digest)new MD2Digest(CryptoServicePurpose.PRF));
          case 0:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createMD5PRF());
          case 1:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createSHA1PRF());
          case 2:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator((Digest)new RIPEMD160Digest(CryptoServicePurpose.PRF));
          case 3:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator((Digest)new TigerDigest(CryptoServicePurpose.PRF));
          case 4:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createSHA256PRF());
          case 6:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator((Digest)new GOST3411Digest(CryptoServicePurpose.PRF));
          case 7:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createSHA224PRF());
          case 8:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createSHA384PRF());
          case 9:
            return (PBEParametersGenerator)new PKCS12ParametersGenerator(DigestFactory.createSHA512PRF());
        } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetri\\util\PBE.class
