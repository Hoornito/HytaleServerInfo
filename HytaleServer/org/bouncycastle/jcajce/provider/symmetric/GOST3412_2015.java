...
public class GOST3412_2015 {
  public static class CBC extends BaseBlockCipher {
    public CBC() {
      super((BlockCipher)new G3413CBCBlockCipher((BlockCipher)new GOST3412_2015Engine()), false, 128);
    }
  }
  
  public static class CTR extends BaseBlockCipher {
    public CTR() {
      super(new BufferedBlockCipher((BlockCipher)new G3413CTRBlockCipher((BlockCipher)new GOST3412_2015Engine())), true, 64);
    }
  }
  ...
  public static class GCFB extends BaseBlockCipher {
    public GCFB() {
      super(new BufferedBlockCipher((BlockCipher)new G3413CFBBlockCipher((BlockCipher)new GOST3412_2015Engine())), false, 128);
    }
  }
  
  public static class GCFB8 extends BaseBlockCipher {
    public GCFB8() {
      super(new BufferedBlockCipher((BlockCipher)new G3413CFBBlockCipher((BlockCipher)new GOST3412_2015Engine(), 8)), false, 128);
    }
  }
  ...
  public static class Mac extends BaseMac {
    public Mac() {
      super((org.bouncycastle.crypto.Mac)new CMac((BlockCipher)new GOST3412_2015Engine()));
    }
  }
  ...
  public static class OFB extends BaseBlockCipher {
    public OFB() {
      super(new BufferedBlockCipher((BlockCipher)new G3413OFBBlockCipher((BlockCipher)new GOST3412_2015Engine())), false, 128);
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\GOST3412_2015.class
