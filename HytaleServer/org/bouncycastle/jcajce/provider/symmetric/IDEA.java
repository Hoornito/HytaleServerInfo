...
public final class IDEA {
  ...
  public static class AlgParams extends BaseAlgorithmParameters {
    ...
    protected void engineInit(byte[] param1ArrayOfbyte, String param1String) throws IOException {
      ...
      if (param1String.equals("ASN.1")) {
        IDEACBCPar iDEACBCPar = IDEACBCPar.getInstance(param1ArrayOfbyte);
  ...
  public static class CBC extends BaseBlockCipher {
    public CBC() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)new IDEAEngine()), 64);
    }
  }
  ...
  public static class PBEWithSHAAndIDEA extends BaseBlockCipher {
    public PBEWithSHAAndIDEA() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)new IDEAEngine()), 2, 1, 128, 8);
    }
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\IDEA.class
