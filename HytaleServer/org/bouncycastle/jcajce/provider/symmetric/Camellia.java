...
public final class Camellia {
  ...
  public static class CBC128 extends BaseBlockCipher {
    public CBC128() {
      super(128, (BlockCipher)new CBCBlockCipher((BlockCipher)new CamelliaEngine()), 128);
    }
  }
  
  public static class CBC192 extends BaseBlockCipher {
    public CBC192() {
      super(192, (BlockCipher)new CBCBlockCipher((BlockCipher)new CamelliaEngine()), 128);
    }
  }
  
  public static class CBC256 extends BaseBlockCipher {
    public CBC256() {
      super(256, (BlockCipher)new CBCBlockCipher((BlockCipher)new CamelliaEngine()), 128);
    }
  }
  ...
  public static class GMAC extends BaseMac {
    public GMAC() {
      super((Mac)new GMac(GCMBlockCipher.newInstance((BlockCipher)new CamelliaEngine())));
    }
  }
  ...
  public static class Mappings extends SymmetricAlgorithmProvider {
    ...
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia128_cbc, PREFIX + "$CBC128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia192_cbc, PREFIX + "$CBC192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia256_cbc, PREFIX + "$CBC256");
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia128_wrap, PREFIX + "$Wrap128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia192_wrap, PREFIX + "$Wrap192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NTTObjectIdentifiers.id_camellia256_wrap, PREFIX + "$Wrap256");
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.CAMELLIA", PREFIX + "$KeyFactory");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", NTTObjectIdentifiers.id_camellia128_cbc, "CAMELLIA");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", NTTObjectIdentifiers.id_camellia192_cbc, "CAMELLIA");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", NTTObjectIdentifiers.id_camellia256_cbc, "CAMELLIA");
  ...
  public static class Wrap128 extends BaseWrapCipher {
    public Wrap128() {
      super(128, (Wrapper)new CamelliaWrapEngine());
    }
  }
  
  public static class Wrap192 extends BaseWrapCipher {
    public Wrap192() {
      super(192, (Wrapper)new CamelliaWrapEngine());
    }
  }
  
  public static class Wrap256 extends BaseWrapCipher {
    public Wrap256() {
      super(256, (Wrapper)new CamelliaWrapEngine());
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\Camellia.class
