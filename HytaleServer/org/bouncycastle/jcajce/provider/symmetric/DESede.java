...
public final class DESede {
  ...
  public static class CBC extends BaseBlockCipher {
    public CBC() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)new DESedeEngine()), 64);
    }
  }
  ...
  public static class Mappings extends AlgorithmProvider {
    ...
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.PBEWITHSHA1ANDDESEDE", "PBEWITHSHAAND3-KEYTRIPLEDES-CBC");
      ...
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.PBE", "PBEWITHSHAAND3-KEYTRIPLEDES-CBC");
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\DESede.class
