...
public final class AES {
  ...
  public static class AESCCMMAC extends BaseMac {
    public AESCCMMAC() {
      super(new AES.CCMMac());
    }
  }
  
  public static class AESCCMMAC128 extends BaseMac {
    public AESCCMMAC128() {
      super(128, new AES.CCMMac());
    }
  }
  
  public static class AESCCMMAC192 extends BaseMac {
    public AESCCMMAC192() {
      super(192, new AES.CCMMac());
    }
  }
  
  public static class AESCCMMAC256 extends BaseMac {
    public AESCCMMAC256() {
      super(256, new AES.CCMMac());
    }
  }
  
  public static class AESCMAC extends BaseMac {
    public AESCMAC() {
      super((Mac)new CMac((BlockCipher)AESEngine.newInstance()));
    }
  }
  
  public static class AESGMAC extends BaseMac {
    public AESGMAC() {
      super((Mac)new GMac(GCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance())));
    }
  }
  ...
  public static class CBC extends BaseBlockCipher {
    public CBC() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 128);
    }
  }
  
  public static class CBC128 extends BaseBlockCipher {
    public CBC128() {
      super(128, (BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 128);
    }
  }
  
  public static class CBC192 extends BaseBlockCipher {
    public CBC192() {
      super(192, (BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 128);
    }
  }
  ...
  public static class CCM extends BaseBlockCipher {
    public CCM() {
      super((AEADBlockCipher)CCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), false, 12);
    }
  }
  
  public static class CCM128 extends BaseBlockCipher {
    public CCM128() {
      super(128, (AEADBlockCipher)CCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), false, 12);
    }
  }
  
  public static class CCM192 extends BaseBlockCipher {
    public CCM192() {
      super(192, (AEADBlockCipher)CCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), false, 12);
    }
  }
  
  public static class CCM256 extends BaseBlockCipher {
    public CCM256() {
      super(256, (AEADBlockCipher)CCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), false, 12);
    }
  }
  
  static class CCMMac implements Mac {
    private final CCMModeCipher ccm = CCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance());
    
    private int macLength = 8;
    
    public void init(CipherParameters param1CipherParameters) throws IllegalArgumentException {
      this.ccm.init(true, param1CipherParameters);
    ...
    public void update(byte param1Byte) throws IllegalStateException {
      this.ccm.processAADByte(param1Byte);
    }
    
    public void update(byte[] param1ArrayOfbyte, int param1Int1, int param1Int2) throws DataLengthException, IllegalStateException {
      this.ccm.processAADBytes(param1ArrayOfbyte, param1Int1, param1Int2);
    }
    
    public int doFinal(byte[] param1ArrayOfbyte, int param1Int) throws DataLengthException, IllegalStateException {
      try {
        return this.ccm.doFinal(param1ArrayOfbyte, 0);
  ...
  public static class CFB extends BaseBlockCipher {
    public CFB() {
      super((BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)CFBBlockCipher.newInstance((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class CFB128 extends BaseBlockCipher {
    public CFB128() {
      super(128, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)CFBBlockCipher.newInstance((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class CFB192 extends BaseBlockCipher {
    public CFB192() {
      super(192, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)CFBBlockCipher.newInstance((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class CFB256 extends BaseBlockCipher {
    public CFB256() {
      super(256, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)CFBBlockCipher.newInstance((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  ...
  public static class GCM extends BaseBlockCipher {
    public GCM() {
      super((AEADBlockCipher)GCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()));
    }
  }
  
  public static class GCM128 extends BaseBlockCipher {
    public GCM128() {
      super(128, (AEADBlockCipher)GCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()));
    }
  }
  
  public static class GCM192 extends BaseBlockCipher {
    public GCM192() {
      super(192, (AEADBlockCipher)GCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()));
    }
  }
  
  public static class GCM256 extends BaseBlockCipher {
    public GCM256() {
      super(256, (AEADBlockCipher)GCMBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()));
    }
  }
  ...
  public static class Mappings extends SymmetricAlgorithmProvider {
    ...
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_ECB, PREFIX + "$ECB128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_ECB, PREFIX + "$ECB192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_ECB, PREFIX + "$ECB256");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CBC, PREFIX + "$CBC128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CBC, PREFIX + "$CBC192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CBC, PREFIX + "$CBC256");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_OFB, PREFIX + "$OFB128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_OFB, PREFIX + "$OFB192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_OFB, PREFIX + "$OFB256");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CFB, PREFIX + "$CFB128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CFB, PREFIX + "$CFB192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CFB, PREFIX + "$CFB256");
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_wrap, PREFIX + "$Wrap128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_wrap, PREFIX + "$Wrap192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_wrap, PREFIX + "$Wrap256");
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_wrap_pad, PREFIX + "$WrapPad128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_wrap_pad, PREFIX + "$WrapPad192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_wrap_pad, PREFIX + "$WrapPad256");
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_CCM, PREFIX + "$CCM128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_CCM, PREFIX + "$CCM192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_CCM, PREFIX + "$CCM256");
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes128_GCM, PREFIX + "$GCM128");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes192_GCM, PREFIX + "$GCM192");
      param1ConfigurableProvider.addAlgorithm("Cipher", NISTObjectIdentifiers.id_aes256_GCM, PREFIX + "$GCM256");
      ...
      param1ConfigurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes128_CCM.getId(), PREFIX + "$AESCCMMAC128");
      param1ConfigurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes192_CCM.getId(), PREFIX + "$AESCCMMAC192");
      param1ConfigurableProvider.addAlgorithm("Mac." + NISTObjectIdentifiers.id_aes256_CCM.getId(), PREFIX + "$AESCCMMAC256");
  ...
  public static class OFB extends BaseBlockCipher {
    public OFB() {
      super((BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)new OFBBlockCipher((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class OFB128 extends BaseBlockCipher {
    public OFB128() {
      super(128, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)new OFBBlockCipher((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class OFB192 extends BaseBlockCipher {
    public OFB192() {
      super(192, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)new OFBBlockCipher((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class OFB256 extends BaseBlockCipher {
    public OFB256() {
      super(256, (BufferedBlockCipher)new DefaultBufferedBlockCipher((BlockCipher)new OFBBlockCipher((BlockCipher)AESEngine.newInstance(), 128)), 128);
    }
  }
  
  public static class PBEWithAESCBC extends BaseBlockCipher {
    public PBEWithAESCBC() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()));
    }
  }
  ...
  public static class PBEWithSHA1AESCBC128 extends BaseBlockCipher {
    public PBEWithSHA1AESCBC128() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 1, 128, 16);
    }
  }
  
  public static class PBEWithSHA1AESCBC192 extends BaseBlockCipher {
    public PBEWithSHA1AESCBC192() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 1, 192, 16);
    }
  }
  
  public static class PBEWithSHA1AESCBC256 extends BaseBlockCipher {
    public PBEWithSHA1AESCBC256() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 1, 256, 16);
    }
  }
  
  public static class PBEWithSHA256AESCBC128 extends BaseBlockCipher {
    public PBEWithSHA256AESCBC128() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 4, 128, 16);
    }
  }
  
  public static class PBEWithSHA256AESCBC192 extends BaseBlockCipher {
    public PBEWithSHA256AESCBC192() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 4, 192, 16);
    }
  }
  
  public static class PBEWithSHA256AESCBC256 extends BaseBlockCipher {
    public PBEWithSHA256AESCBC256() {
      super((BlockCipher)CBCBlockCipher.newInstance((BlockCipher)AESEngine.newInstance()), 2, 4, 256, 16);
    }
  }
  ...
  public static class Poly1305 extends BaseMac {
    public Poly1305() {
      super((Mac)new org.bouncycastle.crypto.macs.Poly1305((BlockCipher)AESEngine.newInstance()));
    }
  }
  ...
  public static class RFC3211Wrap extends BaseWrapCipher {
    public RFC3211Wrap() {
      super((Wrapper)new RFC3211WrapEngine((BlockCipher)AESEngine.newInstance()), 16);
    }
  }
  
  public static class RFC5649Wrap extends BaseWrapCipher {
    public RFC5649Wrap() {
      super((Wrapper)new RFC5649WrapEngine((BlockCipher)AESEngine.newInstance()));
    }
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\symmetric\AES.class
