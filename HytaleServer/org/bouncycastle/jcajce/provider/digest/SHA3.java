...
public class SHA3 {
  ...
  public static class KeyFactoryKMAC extends BaseSecretKeyFactory {
    public KeyFactoryKMAC(int param1Int, ASN1ObjectIdentifier param1ASN1ObjectIdentifier) {
      super("KMAC" + param1Int, param1ASN1ObjectIdentifier);
    }
  }
  ...
  public static class KeyFactorySHA3 extends BaseSecretKeyFactory {
    public KeyFactorySHA3(int param1Int, ASN1ObjectIdentifier param1ASN1ObjectIdentifier) {
      super("HmacSHA3-" + param1Int, param1ASN1ObjectIdentifier);
    }
  }
  ...
  public static class Mappings extends DigestAlgorithmProvider {
    ...
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.HMACSHA3-224", PREFIX + "$KeyFactory224");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_hmacWithSHA3_224, "HMACSHA3-224");
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.HMACSHA3-256", PREFIX + "$KeyFactory256");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_hmacWithSHA3_256, "HMACSHA3-256");
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.HMACSHA3-384", PREFIX + "$KeyFactory384");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_hmacWithSHA3_384, "HMACSHA3-384");
      ...
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.HMACSHA3-512", PREFIX + "$KeyFactory512");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_hmacWithSHA3_512, "HMACSHA3-512");
      addKMACAlgorithm(param1ConfigurableProvider, "128", PREFIX + "$KMac128", PREFIX + "$KeyGenerator256");
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.KMAC128", PREFIX + "$KeyFactoryKMAC128");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_Kmac128, "KMAC128");
      addKMACAlgorithm(param1ConfigurableProvider, "256", PREFIX + "$KMac256", PREFIX + "$KeyGenerator512");
      param1ConfigurableProvider.addAlgorithm("SecretKeyFactory.KMAC256", PREFIX + "$KeyFactoryKMAC256");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory." + NISTObjectIdentifiers.id_Kmac256, "KMAC256");
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\digest\SHA3.class
