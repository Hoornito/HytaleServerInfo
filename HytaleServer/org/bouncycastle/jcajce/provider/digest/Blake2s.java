...
public class Blake2s {
  public static class Blake2s128 extends BCMessageDigest implements Cloneable {
    public Blake2s128() {
      super((Digest)new Blake2sDigest(128));
    }
    
    public Object clone() throws CloneNotSupportedException {
      Blake2s128 blake2s128 = (Blake2s128)super.clone();
      blake2s128.digest = (Digest)new Blake2sDigest((Blake2sDigest)this.digest);
      return blake2s128;
    }
  }
  ...
  public static class Blake2s160 extends BCMessageDigest implements Cloneable {
    public Blake2s160() {
      super((Digest)new Blake2sDigest(160));
    }
    
    public Object clone() throws CloneNotSupportedException {
      Blake2s160 blake2s160 = (Blake2s160)super.clone();
      blake2s160.digest = (Digest)new Blake2sDigest((Blake2sDigest)this.digest);
      return blake2s160;
    }
  }
  ...
  public static class Blake2s224 extends BCMessageDigest implements Cloneable {
    public Blake2s224() {
      super((Digest)new Blake2sDigest(224));
    }
    
    public Object clone() throws CloneNotSupportedException {
      Blake2s224 blake2s224 = (Blake2s224)super.clone();
      blake2s224.digest = (Digest)new Blake2sDigest((Blake2sDigest)this.digest);
      return blake2s224;
    }
  }
  ...
  public static class Blake2s256 extends BCMessageDigest implements Cloneable {
    public Blake2s256() {
      super((Digest)new Blake2sDigest(256));
    }
    
    public Object clone() throws CloneNotSupportedException {
      Blake2s256 blake2s256 = (Blake2s256)super.clone();
      blake2s256.digest = (Digest)new Blake2sDigest((Blake2sDigest)this.digest);
      return blake2s256;
    }
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\digest\Blake2s.class
