...
public class BCXDHPublicKey implements XDHPublicKey {
  ...
  private void populateFromPubKeyInfo(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) {
    ...
    if (EdECObjectIdentifiers.id_X448.equals((ASN1Primitive)paramSubjectPublicKeyInfo.getAlgorithm().getAlgorithm())) {
      this.xdhPublicKey = (AsymmetricKeyParameter)new X448PublicKeyParameters(arrayOfByte);
    } else {
      this.xdhPublicKey = (AsymmetricKeyParameter)new X25519PublicKeyParameters(arrayOfByte);
    } 
  }
  
  public String getAlgorithm() {
    return Properties.isOverrideSet("org.bouncycastle.emulate.oracle") ? "XDH" : ((this.xdhPublicKey instanceof X448PublicKeyParameters) ? "X448" : "X25519");
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\edec\BCXDHPublicKey.class
