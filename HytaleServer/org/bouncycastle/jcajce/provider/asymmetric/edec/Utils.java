...
class Utils {
  ...
  static String keyToString(String paramString1, String paramString2, AsymmetricKeyParameter paramAsymmetricKeyParameter) {
    ...
    stringBuilder.append(paramString2).append(" ").append(paramString1).append(" [").append(generateKeyFingerprint(arrayOfByte)).append("]").append(str).append("    public data: ").append(Hex.toHexString(arrayOfByte)).append(str);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\edec\Utils.class
