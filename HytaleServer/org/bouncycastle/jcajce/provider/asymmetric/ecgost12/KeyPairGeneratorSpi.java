...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
  ...
  public void initialize(AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom) throws InvalidAlgorithmParameterException {
    if (paramAlgorithmParameterSpec instanceof GOST3410ParameterSpec) {
      ...
      ASN1ObjectIdentifier aSN1ObjectIdentifier = ECGOST3410NamedCurves.getOID(str);
      if (aSN1ObjectIdentifier.equals((ASN1Primitive)RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetB) || aSN1ObjectIdentifier.equals((ASN1Primitive)RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetC) || aSN1ObjectIdentifier.equals((ASN1Primitive)RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetD)) {
        init(new GOST3410ParameterSpec(ECGOST3410NamedCurves.getOID(str), null), paramSecureRandom);
      } else {
  ...
  private void init(GOST3410ParameterSpec paramGOST3410ParameterSpec, SecureRandom paramSecureRandom) throws InvalidAlgorithmParameterException {
    X9ECParameters x9ECParameters = ECGOST3410NamedCurves.getByOIDX9(paramGOST3410ParameterSpec.getPublicKeyParamSet());
    if (x9ECParameters == null)
      throw new InvalidAlgorithmParameterException("unknown curve: " + paramGOST3410ParameterSpec.getPublicKeyParamSet()); 
    this.ecParams = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(paramGOST3410ParameterSpec.getPublicKeyParamSet()), x9ECParameters.getCurve(), x9ECParameters.getG(), x9ECParameters.getN(), x9ECParameters.getH(), x9ECParameters.getSeed());
    this.param = new ECKeyGenerationParameters((ECDomainParameters)new ECGOST3410Parameters((ECDomainParameters)new ECNamedDomainParameters(paramGOST3410ParameterSpec.getPublicKeyParamSet(), x9ECParameters), paramGOST3410ParameterSpec.getPublicKeyParamSet(), paramGOST3410ParameterSpec.getDigestParamSet(), paramGOST3410ParameterSpec.getEncryptionParamSet()), paramSecureRandom);
    this.engine.init((KeyGenerationParameters)this.param);
    this.initialised = true;
  }
  ...
  public KeyPair generateKeyPair() {
    ...
    if (this.ecParams instanceof ECParameterSpec) {
      ...
      BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey1 = new BCECGOST3410_2012PublicKey(this.algorithm, eCPublicKeyParameters, eCParameterSpec1);
      return new KeyPair(bCECGOST3410_2012PublicKey1, new BCECGOST3410_2012PrivateKey(this.algorithm, eCPrivateKeyParameters, bCECGOST3410_2012PublicKey1, eCParameterSpec1));
    } 
    if (this.ecParams == null)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\ecgost12\KeyPairGeneratorSpi.class
