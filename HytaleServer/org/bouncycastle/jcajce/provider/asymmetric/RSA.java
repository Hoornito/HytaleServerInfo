...
public class RSA {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.rsaEncryption, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$PKCS1v1_5Padding", RSA.generalRsaAttributes);
      param1ConfigurableProvider.addAlgorithm("Cipher", X509ObjectIdentifiers.id_ea_rsa, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$PKCS1v1_5Padding", RSA.generalRsaAttributes);
      ...
      param1ConfigurableProvider.addAlgorithm("Cipher.RSA/OAEP", "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$OAEPPadding", RSA.generalRsaAttributes);
      param1ConfigurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_RSAES_OAEP, "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$OAEPPadding", RSA.generalRsaAttributes);
      param1ConfigurableProvider.addAlgorithm("Cipher.RSA/ISO9796-1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.CipherSpi$ISO9796d1Padding", RSA.generalRsaAttributes);
      ...
      param1ConfigurableProvider.addAlgorithm("KeyFactory.RSASSA-PSS", "org.bouncycastle.jcajce.provider.asymmetric.rsa.KeyFactorySpi");
      param1ConfigurableProvider.addAlgorithm("KeyPairGenerator.RSASSA-PSS", "org.bouncycastle.jcajce.provider.asymmetric.rsa.KeyPairGeneratorSpi$PSS");
      ...
      param1ConfigurableProvider.addAlgorithm("Signature.RSASSA-PSS", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$PSSwithRSA", RSA.generalRsaAttributes);
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + PKCSObjectIdentifiers.id_RSASSA_PSS, "RSASSA-PSS");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature.OID." + PKCSObjectIdentifiers.id_RSASSA_PSS, "RSASSA-PSS");
      param1ConfigurableProvider.addAlgorithm("Signature.RSA", "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$noneRSA", RSA.generalRsaAttributes);
      param1ConfigurableProvider.addAlgorithm("Signature.RAWRSASSA-PSS", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$nonePSS", RSA.generalRsaAttributes);
      ...
      addPSSSignature(param1ConfigurableProvider, "SHA224", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA224withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA256", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA256withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA384", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA384withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA512", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA512(224)", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_224withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA512(256)", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_256withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA3-224", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_224withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA3-256", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_256withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA3-384", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_384withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHA3-512", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_512withRSA");
      addPSSSignature(param1ConfigurableProvider, "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHAKE128WithRSAPSS", CMSObjectIdentifiers.id_RSASSA_PSS_SHAKE128);
      addPSSSignature(param1ConfigurableProvider, "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHAKE256WithRSAPSS", CMSObjectIdentifiers.id_RSASSA_PSS_SHAKE256);
      addPSSSignature(param1ConfigurableProvider, "SHA224", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA224withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA256", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA256withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA384", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA384withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA512", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA512(224)", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_224withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA512(256)", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_256withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA224", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA224withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA256", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA256withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA384", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA384withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA512", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA512(224)", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_224withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA512(256)", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA512_256withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA3-224", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_224withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA3-256", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_256withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA3-384", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_384withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA3-512", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_512withRSAandSHAKE128");
      addPSSSignature(param1ConfigurableProvider, "SHA3-224", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_224withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA3-256", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_256withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA3-384", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_384withRSAandSHAKE256");
      addPSSSignature(param1ConfigurableProvider, "SHA3-512", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA3_512withRSAandSHAKE256");
      ...
      if (param1ConfigurableProvider.hasAlgorithm("MessageDigest", "SHA1")) {
        ...
        addPSSSignature(param1ConfigurableProvider, "SHA1", "MGF1", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSA");
        addPSSSignature(param1ConfigurableProvider, "SHA1", "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSAandSHAKE128");
        addPSSSignature(param1ConfigurableProvider, "SHA1", "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSAandSHAKE256");
    ...
    private void addDigestSignature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2, ASN1ObjectIdentifier param1ASN1ObjectIdentifier) {
      ...
      param1ConfigurableProvider.addAttributes("Signature." + str1, RSA.generalRsaAttributes);
    }
    ...
    private void addISO9796Signature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2) {
      ...
      param1ConfigurableProvider.addAttributes("Signature." + param1String1 + "WITHRSA/ISO9796-2", RSA.generalRsaAttributes);
    }
    
    private void addPSSSignature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2, String param1String3) {
      String str = "WITHRSAAND" + param1String2;
      if (param1String2.equals("MGF1")) {
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSA/PSS", param1String1 + str);
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSA/PSS", param1String1 + str);
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WITHRSA/PSS", param1String1 + str);
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSASSA-PSS", param1String1 + str);
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSASSA-PSS", param1String1 + str);
        param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WITHRSASSA-PSS", param1String1 + str);
      } 
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSAand" + param1String2, param1String1 + str);
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSAAnd" + param1String2, param1String1 + str);
      param1ConfigurableProvider.addAlgorithm("Signature." + param1String1 + "WITHRSAAND" + param1String2, param1String3);
      param1ConfigurableProvider.addAttributes("Signature." + param1String1 + "WITHRSAAND" + param1String2, RSA.generalRsaAttributes);
    }
    
    private void addPSSSignature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2, ASN1ObjectIdentifier param1ASN1ObjectIdentifier) {
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSA/PSS", param1String1 + "WITHRSAPSS");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSA/PSS", param1String1 + "WITHRSAPSS");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "withRSASSA-PSS", param1String1 + "WITHRSAPSS");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WithRSASSA-PSS", param1String1 + "WITHRSAPSS");
      param1ConfigurableProvider.addAlgorithm("Alg.Alias.Signature." + param1String1 + "WITHRSASSA-PSS", param1String1 + "WITHRSAPSS");
      param1ConfigurableProvider.addAlgorithm("Signature", param1ASN1ObjectIdentifier, param1String2);
      param1ConfigurableProvider.addAlgorithm("Signature." + param1String1 + "WITHRSAPSS", param1String2);
      param1ConfigurableProvider.addAttributes("Signature." + param1String1 + "WITHRSAPSS", RSA.generalRsaAttributes);
    }
    ...
    private void addX931Signature(ConfigurableProvider param1ConfigurableProvider, String param1String1, String param1String2) {
      ...
      param1ConfigurableProvider.addAttributes("Signature." + param1String1 + "WITHRSA/X9.31", RSA.generalRsaAttributes);
    }
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\RSA.class
