...
public class PKCS12BagAttributeCarrierImpl implements PKCS12BagAttributeCarrier {
  ...
  public boolean hasFriendlyName() {
    ASN1Encodable aSN1Encodable = getBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName);
    return (aSN1Encodable != null);
  }
  
  public void setFriendlyName(String paramString) {
    DERBMPString dERBMPString = new DERBMPString(paramString);
    setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, (ASN1Encodable)dERBMPString);
  }
  ...
  public void writeObject(ObjectOutputStream paramObjectOutputStream) throws IOException {
    if (this.pkcs12Ordering.size() == 0) {
      ...
      Enumeration enumeration = getBagAttributeKeys();
      while (enumeration.hasMoreElements()) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = ASN1ObjectIdentifier.getInstance(enumeration.nextElement());
        aSN1OutputStream.writeObject((ASN1Primitive)aSN1ObjectIdentifier);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetri\\util\PKCS12BagAttributeCarrierImpl.class
