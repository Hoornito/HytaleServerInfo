...
class X509CRLObject extends X509CRLImpl {
  ...
  private static boolean isIndirectCRL(CertificateList paramCertificateList) throws CRLException {
    try {
      byte[] arrayOfByte = getExtensionOctets(paramCertificateList, Extension.issuingDistributionPoint);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\X509CRLObject.class
