...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
  ...
  private static BasicConstraints createBasicConstraints(Certificate paramCertificate) throws CertificateParsingException {
    try {
      ...
      return (null == arrayOfByte) ? null : BasicConstraints.getInstance(arrayOfByte);
  ...
  private static boolean[] createKeyUsage(Certificate paramCertificate) throws CertificateParsingException {
    try {
      byte[] arrayOfByte1 = getExtensionOctets(paramCertificate, Extension.keyUsage);
      if (null == arrayOfByte1)
        return null; 
      ASN1BitString aSN1BitString = ASN1BitString.getInstance(arrayOfByte1);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\X509CertificateObject.class
