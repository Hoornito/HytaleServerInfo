...
class X509SignatureUtil {
  ...
  static void prettyPrintSignature(byte[] paramArrayOfbyte, StringBuilder paramStringBuilder, String paramString) {
    if (paramArrayOfbyte.length > 20) {
      paramStringBuilder.append("            Signature: ").append(Hex.toHexString(paramArrayOfbyte, 0, 20)).append(paramString);
      ...
      paramStringBuilder.append("            Signature: ").append(Hex.toHexString(paramArrayOfbyte)).append(paramString);
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\X509SignatureUtil.class
