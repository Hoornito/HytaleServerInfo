...
public class CertificateFactory extends CertificateFactorySpi {
  ...
  private Certificate readPEMCertificate(InputStream paramInputStream, boolean paramBoolean) throws IOException, CertificateParsingException {
    return getCertificate(PEM_CERT_PARSER.readPEMObject(paramInputStream, paramBoolean));
  }
  ...
  private CRL readPEMCRL(InputStream paramInputStream, boolean paramBoolean) throws IOException, CRLException {
    return getCRL(PEM_CRL_PARSER.readPEMObject(paramInputStream, paramBoolean));
  }
  ...
  public Certificate engineGenerateCertificate(InputStream paramInputStream) throws CertificateException {
    return doGenerateCertificate(paramInputStream, true);
  }
  
  private Certificate doGenerateCertificate(InputStream paramInputStream, boolean paramBoolean) throws CertificateException {
    ...
    try {
      ...
      if (i == -1)
        return null; 
      inputStream.reset();
      return (i != 48) ? readPEMCertificate(inputStream, paramBoolean) : readDERCertificate(new ASN1InputStream(inputStream));
  ...
  public Collection engineGenerateCertificates(InputStream paramInputStream) throws CertificateException {
    ...
    while ((certificate = doGenerateCertificate(bufferedInputStream, arrayList.isEmpty())) != null)
      arrayList.add(certificate); 
    return arrayList;
  }
  
  public CRL engineGenerateCRL(InputStream paramInputStream) throws CRLException {
    return doGenerateCRL(paramInputStream, true);
  }
  
  private CRL doGenerateCRL(InputStream paramInputStream, boolean paramBoolean) throws CRLException {
    ...
    try {
      ...
      if (i == -1)
        return null; 
      inputStream.reset();
      return (i != 48) ? readPEMCRL(inputStream, paramBoolean) : readDERCRL(new ASN1InputStream(inputStream, true));
  ...
  public Collection engineGenerateCRLs(InputStream paramInputStream) throws CRLException {
    ...
    BufferedInputStream bufferedInputStream = new BufferedInputStream(paramInputStream);
    CRL cRL;
    while ((cRL = doGenerateCRL(bufferedInputStream, arrayList.isEmpty())) != null)
      arrayList.add(cRL); 
    return arrayList;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\x509\CertificateFactory.class
