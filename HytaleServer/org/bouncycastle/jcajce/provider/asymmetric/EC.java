...
public class EC {
  ...
  static {
    ...
    Enumeration<String> enumeration1 = ECNamedCurveTable.getNames();
    Hashtable<Object, Object> hashtable = new Hashtable<>();
    while (enumeration1.hasMoreElements()) {
      String str1 = enumeration1.nextElement();
      ECNamedCurveParameterSpec eCNamedCurveParameterSpec = ECNamedCurveTable.getParameterSpec(str1);
      if (eCNamedCurveParameterSpec == null)
        continue; 
      ASN1ObjectIdentifier aSN1ObjectIdentifier = ECNamedCurveTable.getOID(str1);
      if (aSN1ObjectIdentifier == null)
        continue; 
      String str2 = aSN1ObjectIdentifier.getId();
      Vector<String> vector1 = (Vector)hashtable.get(str2);
      if (vector1 == null) {
        vector1 = new Vector();
        hashtable.put(str2, vector1);
      } 
    ...
    while (enumeration2.hasMoreElements()) {
      ...
      Vector<String> vector1 = (Vector)hashtable.get(str);
      ...
      if (X9ObjectIdentifiers.prime256v1.equals((ASN1Primitive)aSN1ObjectIdentifier)) {
        stringBuffer1.append("secp256r1,NIST P-256,X9.62 prime256v1");
      } else if (X9ObjectIdentifiers.prime192v1.equals((ASN1Primitive)aSN1ObjectIdentifier)) {
        stringBuffer1.append("secp192r1,NIST P-192,X9.62 prime192v1");
      } else {
        if (aSN1ObjectIdentifier.on(X9ObjectIdentifiers.primeCurve) || aSN1ObjectIdentifier.on(X9ObjectIdentifiers.cTwoCurve))
          stringBuffer1.append("X9.62 "); 
        for (byte b1 = 0; b1 < vector1.size(); b1++) {
          if (b1 > 0)
            stringBuffer1.append(","); 
          String str1 = vector1.elementAt(b1);
          if ((aSN1ObjectIdentifier.on(SECObjectIdentifiers.ellipticCurve) || X9ObjectIdentifiers.prime256v1.equals((ASN1Primitive)aSN1ObjectIdentifier) || X9ObjectIdentifiers.prime192v1.equals((ASN1Primitive)aSN1ObjectIdentifier)) && (str1.startsWith("K-") || str1.startsWith("B-") || str1.startsWith("P-")))
            stringBuffer1.append("NIST "); 
          stringBuffer1.append(str1);
        } 
      } 
      stringBuffer1.append(",").append(str).append("]");
    ...
    ecSupportCurves.put("SupportedCurves", stringBuffer.toString());
  }
  
  public static class Mappings extends AsymmetricAlgorithmProvider {
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      param1ConfigurableProvider.addAlgorithm("AlgorithmParameters.EC", "org.bouncycastle.jcajce.provider.asymmetric.ec.AlgorithmParametersSpi", EC.ecSupportCurves);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\EC.class
