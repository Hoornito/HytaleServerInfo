...
public class AlgorithmParametersSpi extends AlgorithmParametersSpi {
  ...
  protected void engineInit(AlgorithmParameterSpec paramAlgorithmParameterSpec) throws InvalidParameterSpecException {
    if (paramAlgorithmParameterSpec instanceof ECGenParameterSpec) {
      ...
      this.ecParameterSpec = (ECParameterSpec)new ECNamedCurveSpec(this.curveName, eCParameterSpec.getCurve(), eCParameterSpec.getGenerator(), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()));
  ...
  protected byte[] engineGetEncoded(String paramString) throws IOException {
    if (isASN1FormatString(paramString)) {
      ...
      if (this.ecParameterSpec == null) {
        ...
        ECParameterSpec eCParameterSpec = EC5Util.convertSpec(this.ecParameterSpec);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\ec\AlgorithmParametersSpi.class
