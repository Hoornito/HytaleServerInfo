...
public abstract class GMKeyPairGeneratorSpi extends KeyPairGenerator {
  public GMKeyPairGeneratorSpi(String paramString) {
    super(paramString);
  }
  ...
  public static class BaseSM2 extends GMKeyPairGeneratorSpi {
    ...
    public BaseSM2(String param1String, ProviderConfiguration param1ProviderConfiguration) {
      super(param1String);
    }
    ...
    public void initialize(int param1Int, SecureRandom param1SecureRandom) {
      ...
      ECNamedCurveGenParameterSpec eCNamedCurveGenParameterSpec = (ECNamedCurveGenParameterSpec)ecParameters.get(Integers.valueOf(param1Int));
      if (eCNamedCurveGenParameterSpec == null)
        throw new InvalidParameterException("unknown key size."); 
      try {
        initialize((AlgorithmParameterSpec)eCNamedCurveGenParameterSpec, param1SecureRandom);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\ec\GMKeyPairGeneratorSpi.class
