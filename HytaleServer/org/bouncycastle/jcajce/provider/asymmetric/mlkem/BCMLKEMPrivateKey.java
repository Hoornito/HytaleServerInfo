...
public class BCMLKEMPrivateKey implements MLKEMPrivateKey, BCKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (paramObject instanceof BCMLKEMPrivateKey) {
      BCMLKEMPrivateKey bCMLKEMPrivateKey = (BCMLKEMPrivateKey)paramObject;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\mlkem\BCMLKEMPrivateKey.class
