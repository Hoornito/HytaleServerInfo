  ...
  public void initialize(AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom) throws InvalidAlgorithmParameterException {
    if (paramAlgorithmParameterSpec instanceof ECParameterSpec) {
      ...
      if (eCParameterSpec instanceof DSTU4145ParameterSpec) {
        ...
        this.param = new ECKeyGenerationParameters((ECDomainParameters)new DSTU4145Parameters(new ECDomainParameters(eCCurve, eCPoint, eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor())), dSTU4145ParameterSpec.getDKE()), paramSecureRandom);
      } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\dstu\KeyPairGeneratorSpi.class
