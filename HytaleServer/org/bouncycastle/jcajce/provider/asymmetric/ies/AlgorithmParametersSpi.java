...
public class AlgorithmParametersSpi extends AlgorithmParametersSpi {
  ...
  protected byte[] engineGetEncoded() {
    try {
      ...
      byte[] arrayOfByte = this.currentSpec.getNonce();
      if (arrayOfByte != null) {
        ASN1EncodableVector aSN1EncodableVector1 = new ASN1EncodableVector();
        aSN1EncodableVector1.add((ASN1Encodable)new ASN1Integer(this.currentSpec.getCipherKeySize()));
        aSN1EncodableVector1.add((ASN1Encodable)new DEROctetString(arrayOfByte));
        aSN1EncodableVector.add((ASN1Encodable)new DERSequence(aSN1EncodableVector1));
      } 
      aSN1EncodableVector.add(this.currentSpec.getPointCompression() ? (ASN1Encodable)ASN1Boolean.TRUE : (ASN1Encodable)ASN1Boolean.FALSE);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\ies\AlgorithmParametersSpi.class
