...
public class SLHDSAKeyFactorySpi extends BaseKeyFactorySpi {
  ...
  public SLHDSAKeyFactorySpi(Set<ASN1ObjectIdentifier> paramSet) {
    super(paramSet);
  }
  
  public SLHDSAKeyFactorySpi(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
  ...
  public final Key engineTranslateKey(Key paramKey) throws InvalidKeyException {
    if (paramKey instanceof BCSLHDSAPrivateKey || paramKey instanceof BCSLHDSAPublicKey)
      return paramKey; 
    throw new InvalidKeyException("Unsupported key type");
  }
  
  public PrivateKey generatePrivate(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    return (PrivateKey)new BCSLHDSAPrivateKey(paramPrivateKeyInfo);
  }
  
  public PublicKey generatePublic(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) throws IOException {
    return (PublicKey)new BCSLHDSAPublicKey(paramSubjectPublicKeyInfo);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\slhdsa\SLHDSAKeyFactorySpi.class
