...
public class PSSSignatureSpi extends SignatureSpi {
  ...
  protected void engineInitVerify(PublicKey paramPublicKey) throws InvalidKeyException {
    ...
    this.pss.init(false, (CipherParameters)this.key);
  ...
  protected void engineInitSign(PrivateKey paramPrivateKey) throws InvalidKeyException {
    ...
    this.pss = new PSSSigner(this.signer, this.contentDigest, this.mgfDigest, this.saltLength, this.trailer);
    if (this.random != null) {
      this.pss.init(true, (CipherParameters)new ParametersWithRandom((CipherParameters)this.key, this.random));
    } else {
      this.pss.init(true, (CipherParameters)this.key);
    } 
    this.isInitState = true;
  }
  ...
  public static class SHA1withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA1withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA1", "SHAKE128", null, 20, 1));
    }
  }
  
  public static class SHA1withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA1withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA1", "SHAKE256", null, 20, 1));
    }
  }
  ...
  public static class SHA224withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA224withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-224", "SHAKE128", null, 28, 1));
    }
  }
  
  public static class SHA224withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA224withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-224", "SHAKE256", null, 28, 1));
    }
  }
  ...
  public static class SHA256withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA256withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-256", "SHAKE128", null, 32, 1));
    }
  }
  
  public static class SHA256withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA256withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-256", "SHAKE256", null, 32, 1));
    }
  }
  ...
  public static class SHA384withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA384withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-384", "SHAKE128", null, 48, 1));
    }
  }
  
  public static class SHA384withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA384withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-384", "SHAKE256", null, 48, 1));
    }
  }
  ...
  public static class SHA3_224withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA3_224withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-224", "SHAKE128", null, 28, 1));
    }
  }
  
  public static class SHA3_224withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA3_224withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-224", "SHAKE256", null, 28, 1));
    }
  }
  ...
  public static class SHA3_256withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA3_256withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-256", "SHAKE128", null, 32, 1));
    }
  }
  
  public static class SHA3_256withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA3_256withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-256", "SHAKE256", null, 32, 1));
    }
  }
  ...
  public static class SHA3_384withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA3_384withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-384", "SHAKE128", null, 48, 1));
    }
  }
  
  public static class SHA3_384withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA3_384withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-384", "SHAKE256", null, 48, 1));
    }
  }
  ...
  public static class SHA3_512withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA3_512withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-512", "SHAKE128", null, 64, 1));
    }
  }
  
  public static class SHA3_512withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA3_512withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA3-512", "SHAKE256", null, 64, 1));
    }
  }
  ...
  public static class SHA512_224withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA512_224withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512(224)", "SHAKE128", null, 28, 1));
    }
  }
  
  public static class SHA512_224withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA512_224withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512(224)", "SHAKE256", null, 28, 1));
    }
  }
  ...
  public static class SHA512_256withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA512_256withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512(256)", "SHAKE128", null, 32, 1));
    }
  }
  
  public static class SHA512_256withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA512_256withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512(256)", "SHAKE256", null, 32, 1));
    }
  }
  ...
  public static class SHA512withRSAandSHAKE128 extends PSSSignatureSpi {
    public SHA512withRSAandSHAKE128() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512", "SHAKE128", null, 64, 1));
    }
  }
  
  public static class SHA512withRSAandSHAKE256 extends PSSSignatureSpi {
    public SHA512withRSAandSHAKE256() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHA-512", "SHAKE256", null, 64, 1));
    }
  }
  
  public static class SHAKE128WithRSAPSS extends PSSSignatureSpi {
    public SHAKE128WithRSAPSS() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHAKE128", "SHAKE128", null, 32, 1));
    }
  }
  
  public static class SHAKE256WithRSAPSS extends PSSSignatureSpi {
    public SHAKE256WithRSAPSS() {
      super((AsymmetricBlockCipher)new RSABlindedEngine(), new PSSParameterSpec("SHAKE256", "SHAKE256", null, 64, 1));
    }
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\rsa\PSSSignatureSpi.class
