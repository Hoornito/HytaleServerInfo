...
public class BCRSAPrivateKey implements RSAPrivateKey, PKCS12BagAttributeCarrier, BCKey {
  ...
  public String toString() {
    ...
    stringBuilder.append("RSA Private Key [").append(RSAUtil.generateKeyFingerprint(getModulus())).append("],[]").append(str);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\rsa\BCRSAPrivateKey.class
