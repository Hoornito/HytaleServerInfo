...
public class KeyFactorySpi extends BaseKeyFactorySpi {
  protected KeySpec engineGetKeySpec(Key paramKey, Class paramClass) throws InvalidKeySpecException {
    ...
    if (paramClass.isAssignableFrom(OpenSSHPublicKeySpec.class) && paramKey instanceof RSAPublicKey)
      try {
        return (KeySpec)new OpenSSHPublicKeySpec(OpenSSHPublicKeyUtil.encodePublicKey((AsymmetricKeyParameter)new RSAKeyParameters(false, ((RSAPublicKey)paramKey).getModulus(), ((RSAPublicKey)paramKey).getPublicExponent())));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\rsa\KeyFactorySpi.class
