...
public class KeyFactorySpi extends BaseKeyFactorySpi {
  ...
  public PrivateKey generatePrivate(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    ...
    if (aSN1ObjectIdentifier.equals((ASN1Primitive)X9ObjectIdentifiers.dhpublicnumber))
      return new BCElGamalPrivateKey(paramPrivateKeyInfo); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\elgamal\KeyFactorySpi.class
