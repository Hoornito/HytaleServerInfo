...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
  ...
  public void initialize(int paramInt, SecureRandom paramSecureRandom) {
    ...
    DSAParameterSpec dSAParameterSpec = BouncyCastleProvider.CONFIGURATION.getDSADefaultParameters(paramInt);
        ...
        synchronized (lock) {
          if (params.containsKey(integer)) {
            ...
            if (this.strength == 1024) {
              ...
              dSAParametersGenerator = new DSAParametersGenerator((Digest)SHA256Digest.newInstance());
              dSAParametersGenerator.init(dSAParameterGenerationParameters);
            } else {
              dSAParametersGenerator = new DSAParametersGenerator();
              dSAParametersGenerator.init(this.strength, i, this.random);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\dsa\KeyPairGeneratorSpi.class
