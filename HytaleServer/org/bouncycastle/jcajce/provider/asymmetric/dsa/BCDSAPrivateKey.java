...
public class BCDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
  ...
  public String toString() {
    ...
    stringBuilder.append("DSA Private Key [").append(DSAUtil.generateKeyFingerprint(bigInteger, getParams())).append("]").append(str);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\provider\asymmetric\dsa\BCDSAPrivateKey.class
