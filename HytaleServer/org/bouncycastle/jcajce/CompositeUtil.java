...
class CompositeUtil {
  private static final Map<String, ASN1ObjectIdentifier> algorithmOids = new HashMap<>();
  
  static ASN1ObjectIdentifier getOid(String paramString) {
    ASN1ObjectIdentifier aSN1ObjectIdentifier = algorithmOids.get(Strings.toUpperCase(paramString));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\jcajce\CompositeUtil.class
