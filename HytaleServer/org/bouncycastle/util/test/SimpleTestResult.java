...
public class SimpleTestResult implements TestResult {
  ...
  public static String failedMessage(String paramString1, String paramString2, String paramString3, String paramString4) {
    ...
    stringBuilder.append(" failing ").append(paramString2);
    stringBuilder.append(SEPARATOR).append("    expected: ").append(paramString3);
    stringBuilder.append(SEPARATOR).append("    got     : ").append(paramString4);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastl\\util\test\SimpleTestResult.class
