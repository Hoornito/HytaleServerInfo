...
public abstract class SimpleTest implements Test {
  ...
  public void isTrue(String paramString, boolean paramBoolean) {
    if (!paramBoolean)
      throw new TestFailedException(SimpleTestResult.failed(this, paramString)); 
  }
  ...
  public void fail(String paramString, Object paramObject1, Object paramObject2) {
  ...
  public boolean areEqual(byte[] paramArrayOfbyte1, int paramInt1, int paramInt2, byte[] paramArrayOfbyte2, int paramInt3, int paramInt4) {
  ...
  public Exception testException(String paramString1, String paramString2, TestExceptionOperation paramTestExceptionOperation) {
    try {
      ...
      isTrue(exception.getMessage(), (exception.getClass().getName().indexOf(paramString2) >= 0));
      return exception;
    } 
    return null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastl\\util\test\SimpleTest.class
