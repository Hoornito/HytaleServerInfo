...
public class SignedPublicKeyAndChallenge implements Encodable {
  ...
  public boolean verify(String paramString) throws NoSuchAlgorithmException, SignatureException, NoSuchProviderException, InvalidKeyException {
    ...
    try {
      ...
      return signature.verify(this.spkacSeq.getSignature().getOctets());
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\mozilla\SignedPublicKeyAndChallenge.class
