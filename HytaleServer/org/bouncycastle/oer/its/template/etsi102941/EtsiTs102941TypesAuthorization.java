...
public class EtsiTs102941TypesAuthorization {
  ...
  public static final OERDefinition.Builder InnerAtRequest = OERDefinition.seq(new Object[] { EtsiTs102941BaseTypes.PublicKeys.label("publicKeys"), OERDefinition.octets(32).label("hmacKey"), SharedAtRequest.label("sharedAtRequest"), EtsiTs102941BaseTypes.EcSignature.label("ecSignature"), OERDefinition.extension(new Object[0]) }).typeName("InnerAtRequest");
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\oer\its\template\etsi102941\EtsiTs102941TypesAuthorization.class
