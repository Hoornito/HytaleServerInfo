...
public class DeltaCertificateRequestAttributeValueBuilder {
  ...
  public DeltaCertificateRequestAttributeValue build() {
    ...
    if (this.subject != null)
      aSN1EncodableVector.add((ASN1Encodable)new DERTaggedObject(true, 0, (ASN1Encodable)this.subject)); 
    aSN1EncodableVector.add((ASN1Encodable)this.subjectPublicKey);
    if (this.signatureAlgorithm != null)
      aSN1EncodableVector.add((ASN1Encodable)new DERTaggedObject(true, 2, (ASN1Encodable)this.signatureAlgorithm)); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\pkcs\DeltaCertificateRequestAttributeValueBuilder.class
