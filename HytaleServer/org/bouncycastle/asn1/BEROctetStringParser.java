...
public class BEROctetStringParser implements ASN1OctetStringParser {
  ...
  static BEROctetString parse(ASN1StreamParser paramASN1StreamParser) throws IOException {
    return new BEROctetString(Streams.readAll(new ConstructedOctetStream(paramASN1StreamParser)));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\BEROctetStringParser.class
