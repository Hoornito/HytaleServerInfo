...
public class ASN1Integer extends ASN1Primitive {
  static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1Integer.class, 2) {
      ASN1Primitive fromImplicitPrimitive(DEROctetString param1DEROctetString) {
        return ASN1Integer.createPrimitive(param1DEROctetString.getOctets());
      }
    };
  ...
  public static ASN1Integer getInstance(Object paramObject) {
    ...
    if (paramObject instanceof byte[])
      try {
        return (ASN1Integer)TYPE.fromByteArray((byte[])paramObject);
  ...
  public static ASN1Integer getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1Integer)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static ASN1Integer getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1Integer)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public boolean hasValue(int paramInt) {
    return (this.bytes.length - this.start <= 4 && intValue(this.bytes, this.start, -1) == paramInt);
  }
  
  public boolean hasValue(long paramLong) {
    return (this.bytes.length - this.start <= 8 && longValue(this.bytes, this.start, -1) == paramLong);
  }
  ...
  static ASN1Integer createPrimitive(byte[] paramArrayOfbyte) {
    return new ASN1Integer(paramArrayOfbyte, false);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1Integer.class
