...
public class GetCRL extends ASN1Object {
  ...
  private GetCRL(ASN1Sequence paramASN1Sequence) {
    ...
    if (paramASN1Sequence.size() > b && paramASN1Sequence.getObjectAt(b).toASN1Primitive() instanceof ASN1BitString)
      this.reasons = new ReasonFlags(ASN1BitString.getInstance(paramASN1Sequence.getObjectAt(b))); 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmc\GetCRL.class
