...
public class RevokeRequest extends ASN1Object {
  ...
  public RevokeRequest(X500Name paramX500Name, ASN1Integer paramASN1Integer, CRLReason paramCRLReason, ASN1GeneralizedTime paramASN1GeneralizedTime, ASN1OctetString paramASN1OctetString, ASN1UTF8String paramASN1UTF8String) {
    ...
    this.comment = paramASN1UTF8String;
  }
  ...
  private RevokeRequest(ASN1Sequence paramASN1Sequence) {
    ...
    if (paramASN1Sequence.size() > b && paramASN1Sequence.getObjectAt(b).toASN1Primitive() instanceof ASN1UTF8String)
      this.comment = ASN1UTF8String.getInstance(paramASN1Sequence.getObjectAt(b)); 
  }
  ...
  public DERUTF8String getComment() {
    return (null == this.comment || this.comment instanceof DERUTF8String) ? (DERUTF8String)this.comment : new DERUTF8String(this.comment.getString());
  }
  ...
  public void setComment(ASN1UTF8String paramASN1UTF8String) {
    this.comment = paramASN1UTF8String;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmc\RevokeRequest.class
