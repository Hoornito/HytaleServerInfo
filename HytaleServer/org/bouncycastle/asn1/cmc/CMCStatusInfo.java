...
public class CMCStatusInfo extends ASN1Object {
  ...
  CMCStatusInfo(CMCStatus paramCMCStatus, ASN1Sequence paramASN1Sequence, ASN1UTF8String paramASN1UTF8String, OtherInfo paramOtherInfo) {
  ...
  private CMCStatusInfo(ASN1Sequence paramASN1Sequence) {
    ...
    if (paramASN1Sequence.size() > 3) {
      ...
      if (paramASN1Sequence.getObjectAt(2) instanceof ASN1UTF8String) {
        this.statusString = ASN1UTF8String.getInstance(paramASN1Sequence.getObjectAt(2));
        this.otherInfo = null;
      } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmc\CMCStatusInfo.class
