...
public class CertificationRequest extends ASN1Object {
  ...
  public CertificationRequest(X500Name paramX500Name, AlgorithmIdentifier paramAlgorithmIdentifier1, ASN1BitString paramASN1BitString1, ASN1Set paramASN1Set, AlgorithmIdentifier paramAlgorithmIdentifier2, ASN1BitString paramASN1BitString2) {
    this.certificationRequestInfo = new CertificationRequestInfo(paramX500Name, paramAlgorithmIdentifier1, paramASN1BitString1, paramASN1Set);
    this.signatureAlgorithm = paramAlgorithmIdentifier2;
    this.signature = paramASN1BitString2;
  }
  ...
  private CertificationRequest(ASN1Sequence paramASN1Sequence) {
    ...
    this.signature = ASN1BitString.getInstance(paramASN1Sequence.getObjectAt(2));
  }
  ...
  private static class CertificationRequestInfo extends ASN1Object {
    ...
    private CertificationRequestInfo(X500Name param1X500Name, AlgorithmIdentifier param1AlgorithmIdentifier, ASN1BitString param1ASN1BitString, ASN1Set param1ASN1Set) {
      this.version = CertificationRequest.ZERO;
      this.subject = param1X500Name;
      this.subjectPublicKeyInfo = (ASN1Sequence)new DERSequence(new ASN1Encodable[] { (ASN1Encodable)param1AlgorithmIdentifier, (ASN1Encodable)param1ASN1BitString });
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmc\CertificationRequest.class
