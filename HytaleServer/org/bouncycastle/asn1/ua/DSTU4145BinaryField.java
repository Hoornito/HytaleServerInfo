...
public class DSTU4145BinaryField extends ASN1Object {
  ...
  private DSTU4145BinaryField(ASN1Sequence paramASN1Sequence) {
    this.m = ASN1Integer.getInstance(paramASN1Sequence.getObjectAt(0)).intPositiveValueExact();
    if (paramASN1Sequence.getObjectAt(1) instanceof ASN1Integer) {
      this.k = ((ASN1Integer)paramASN1Sequence.getObjectAt(1)).intPositiveValueExact();
      ...
      this.k = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0)).intPositiveValueExact();
      this.j = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1)).intPositiveValueExact();
      this.l = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).intPositiveValueExact();
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn\\ua\DSTU4145BinaryField.class
