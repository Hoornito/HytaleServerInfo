...
public class PKIFailureInfo extends DERBitString {
  ...
  public static final int systemUnavail = -2147483648;
  ...
  public PKIFailureInfo(int paramInt) {
    super(getBytes(paramInt), getPadBits(paramInt));
  }
  
  public PKIFailureInfo(ASN1BitString paramASN1BitString) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmp\PKIFailureInfo.class
