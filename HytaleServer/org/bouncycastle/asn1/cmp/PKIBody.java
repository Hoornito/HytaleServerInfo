...
public class PKIBody extends ASN1Object implements ASN1Choice {
  ...
  private PKIBody(ASN1TaggedObject paramASN1TaggedObject) {
    ...
    try {
      this.body = getBodyForType(this.tagNo, (ASN1Encodable)paramASN1TaggedObject.getExplicitBaseObject());
    } catch (ClassCastException classCastException) {
      throw Exceptions.illegalArgumentException("malformed body found: " + classCastException.getMessage(), classCastException);
    } catch (IllegalArgumentException illegalArgumentException) {
      throw Exceptions.illegalArgumentException("malformed body found: " + illegalArgumentException.getMessage(), illegalArgumentException);
    } 
  }
  ...
  private static ASN1Encodable getBodyForType(int paramInt, ASN1Encodable paramASN1Encodable) {
    try {
      ...
      throw new IllegalArgumentException("body type of " + paramInt + " has incorrect type got: " + paramASN1Encodable.getClass());
    } catch (IllegalArgumentException illegalArgumentException) {
      throw new IllegalArgumentException("body type of " + paramInt + " has incorrect type got: " + paramASN1Encodable.getClass());
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cmp\PKIBody.class
