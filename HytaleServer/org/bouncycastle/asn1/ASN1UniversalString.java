...
public abstract class ASN1UniversalString extends ASN1Primitive implements ASN1String {
  ...
  public static ASN1UniversalString getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1UniversalString)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static ASN1UniversalString getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1UniversalString)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1UniversalString.class
