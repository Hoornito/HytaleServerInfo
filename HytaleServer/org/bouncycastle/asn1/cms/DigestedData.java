...
public class DigestedData extends ASN1Object {
  ...
  public DigestedData(AlgorithmIdentifier paramAlgorithmIdentifier, ContentInfo paramContentInfo, byte[] paramArrayOfbyte) {
    ...
    this.digest = (ASN1OctetString)new DEROctetString(Arrays.clone(paramArrayOfbyte));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cms\DigestedData.class
