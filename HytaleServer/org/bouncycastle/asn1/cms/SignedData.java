...
public class SignedData extends ASN1Object {
  ...
  public SignedData(ASN1Set paramASN1Set1, ContentInfo paramContentInfo, ASN1Set paramASN1Set2, ASN1Set paramASN1Set3, ASN1Set paramASN1Set4) {
    ...
    this.digsBer = paramASN1Set1 instanceof org.bouncycastle.asn1.BERSet;
    ...
    this.sigsBer = paramASN1Set4 instanceof org.bouncycastle.asn1.BERSet;
  }
  ...
  private ASN1Integer calculateVersion(ASN1ObjectIdentifier paramASN1ObjectIdentifier, ASN1Set paramASN1Set1, ASN1Set paramASN1Set2, ASN1Set paramASN1Set3) {
    ...
    return bool2 ? VERSION_5 : (bool4 ? VERSION_4 : (bool3 ? VERSION_3 : (checkForVersion3(paramASN1Set3) ? VERSION_3 : (!CMSObjectIdentifiers.data.equals((ASN1Primitive)paramASN1ObjectIdentifier) ? VERSION_3 : VERSION_1))));
  }
  ...
  private boolean checkForVersion3(ASN1Set paramASN1Set) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      if (signerInfo.getVersion().hasValue(3))
        return true; 
    } 
    return false;
  }
  ...
  private SignedData(ASN1Sequence paramASN1Sequence) {
    ...
    ASN1Set aSN1Set;
    for (aSN1Set = null; enumeration.hasMoreElements(); aSN1Set = (ASN1Set)aSN1Primitive) {
    ...
    this.digsBer = this.digestAlgorithms instanceof org.bouncycastle.asn1.BERSet;
    this.sigsBer = this.signerInfos instanceof org.bouncycastle.asn1.BERSet;
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    ...
    return (ASN1Primitive)((!this.contentInfo.isDefiniteLength() || this.digsBer || this.sigsBer || this.crlsBer || this.certsBer) ? new BERSequence(aSN1EncodableVector) : new DLSequence(aSN1EncodableVector));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cms\SignedData.class
