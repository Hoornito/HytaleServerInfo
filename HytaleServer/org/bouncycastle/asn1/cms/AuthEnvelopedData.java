...
public class AuthEnvelopedData extends ASN1Object {
  ...
  public AuthEnvelopedData(OriginatorInfo paramOriginatorInfo, ASN1Set paramASN1Set1, EncryptedContentInfo paramEncryptedContentInfo, ASN1Set paramASN1Set2, ASN1OctetString paramASN1OctetString, ASN1Set paramASN1Set3) {
    ...
    if (!paramEncryptedContentInfo.getContentType().equals((ASN1Primitive)CMSObjectIdentifiers.data) && (paramASN1Set2 == null || paramASN1Set2.size() == 0))
  ...
  public static AuthEnvelopedData getInstance(Object paramObject) {
    return (paramObject instanceof AuthEnvelopedData) ? (AuthEnvelopedData)paramObject : ((paramObject != null) ? new AuthEnvelopedData(ASN1Sequence.getInstance(paramObject)) : null);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\cms\AuthEnvelopedData.class
