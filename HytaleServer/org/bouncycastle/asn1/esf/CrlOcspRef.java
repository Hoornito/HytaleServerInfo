  ...
  private CrlOcspRef(ASN1Sequence paramASN1Sequence) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      switch (aSN1TaggedObject.getTagNo()) {
        case 0:
          this.crlids = CrlListID.getInstance(aSN1TaggedObject.getExplicitBaseObject());
          continue;
        case 1:
          this.ocspids = OcspListID.getInstance(aSN1TaggedObject.getExplicitBaseObject());
          continue;
        case 2:
          this.otherRev = OtherRevRefs.getInstance(aSN1TaggedObject.getExplicitBaseObject());
          continue;
      } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\esf\CrlOcspRef.class
