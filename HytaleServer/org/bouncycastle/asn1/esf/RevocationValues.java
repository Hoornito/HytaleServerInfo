  ...
  private RevocationValues(ASN1Sequence paramASN1Sequence) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      switch (aSN1TaggedObject.getTagNo()) {
        case 0:
          aSN1Sequence1 = (ASN1Sequence)aSN1TaggedObject.getExplicitBaseObject();
          ...
          continue;
        case 1:
          aSN1Sequence2 = (ASN1Sequence)aSN1TaggedObject.getExplicitBaseObject();
          ...
          continue;
        case 2:
          this.otherRevVals = OtherRevVals.getInstance(aSN1TaggedObject.getExplicitBaseObject());
          continue;
      } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\esf\RevocationValues.class
