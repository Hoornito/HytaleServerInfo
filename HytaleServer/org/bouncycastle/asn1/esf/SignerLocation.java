...
public class SignerLocation extends ASN1Object {
  ...
  public SignerLocation(ASN1UTF8String paramASN1UTF8String1, ASN1UTF8String paramASN1UTF8String2, ASN1Sequence paramASN1Sequence) {
    this(DirectoryString.getInstance(paramASN1UTF8String1), DirectoryString.getInstance(paramASN1UTF8String2), paramASN1Sequence);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\esf\SignerLocation.class
