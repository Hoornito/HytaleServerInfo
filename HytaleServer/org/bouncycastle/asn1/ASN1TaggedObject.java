...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
  ...
  public static ASN1TaggedObject getInstance(Object paramObject, int paramInt) {
    return ASN1Util.checkTagClass(checkInstance(paramObject), paramInt);
  }
  
  public static ASN1TaggedObject getInstance(Object paramObject, int paramInt1, int paramInt2) {
  ...
  public static ASN1TaggedObject getInstance(ASN1TaggedObject paramASN1TaggedObject, int paramInt, boolean paramBoolean) {
    return ASN1Util.getExplicitBaseTagged(checkInstance(paramASN1TaggedObject, paramBoolean), paramInt);
  }
  
  public static ASN1TaggedObject getInstance(ASN1TaggedObject paramASN1TaggedObject, int paramInt1, int paramInt2, boolean paramBoolean) {
    return ASN1Util.getExplicitBaseTagged(checkInstance(paramASN1TaggedObject, paramBoolean), paramInt1, paramInt2);
  }
  
  public static ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable) {
    if (paramASN1Encodable == null)
      throw new NullPointerException("'element' cannot be null"); 
    return (paramASN1Encodable instanceof ASN1TaggedObject) ? (ASN1TaggedObject)paramASN1Encodable : null;
  }
  
  public static ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable, int paramInt) {
    ASN1TaggedObject aSN1TaggedObject = getOptional(paramASN1Encodable);
    return (aSN1TaggedObject != null && aSN1TaggedObject.hasTagClass(paramInt)) ? aSN1TaggedObject : null;
  }
  
  public static ASN1TaggedObject getOptional(ASN1Encodable paramASN1Encodable, int paramInt1, int paramInt2) {
    ASN1TaggedObject aSN1TaggedObject = getOptional(paramASN1Encodable);
    return (aSN1TaggedObject != null && aSN1TaggedObject.hasTag(paramInt1, paramInt2)) ? aSN1TaggedObject : null;
  }
  
  private static ASN1TaggedObject checkInstance(Object paramObject) {
    if (paramObject == null)
      throw new NullPointerException("'obj' cannot be null"); 
    return getInstance(paramObject);
  }
  
  private static ASN1TaggedObject checkInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    if (!paramBoolean)
  ...
  static ASN1Primitive createConstructedDL(int paramInt1, int paramInt2, ASN1EncodableVector paramASN1EncodableVector) {
    ...
    return bool ? new DLTaggedObject(3, paramInt1, paramInt2, paramASN1EncodableVector.get(0)) : new DLTaggedObject(4, paramInt1, paramInt2, DLFactory.createSequence(paramASN1EncodableVector));
  }
  
  static ASN1Primitive createConstructedIL(int paramInt1, int paramInt2, ASN1EncodableVector paramASN1EncodableVector) {
    boolean bool = (paramASN1EncodableVector.size() == 1) ? true : false;
    return bool ? new BERTaggedObject(3, paramInt1, paramInt2, paramASN1EncodableVector.get(0)) : new BERTaggedObject(4, paramInt1, paramInt2, BERFactory.createSequence(paramASN1EncodableVector));
  }
  
  static ASN1Primitive createPrimitive(int paramInt1, int paramInt2, byte[] paramArrayOfbyte) {
    return new DLTaggedObject(4, paramInt1, paramInt2, new DEROctetString(paramArrayOfbyte));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1TaggedObject.class
