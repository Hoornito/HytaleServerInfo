...
public class ValidationParams extends ASN1Object {
  ...
  public ValidationParams(byte[] paramArrayOfbyte, int paramInt) {
    ...
    this.seed = (ASN1BitString)new DERBitString(paramArrayOfbyte);
  ...
  public ValidationParams(DERBitString paramDERBitString, ASN1Integer paramASN1Integer) {
    ...
    this.seed = (ASN1BitString)paramDERBitString;
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new DERSequence((ASN1Encodable)this.seed, (ASN1Encodable)this.pgenCounter);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x9\ValidationParams.class
