...
public class ASN1StreamParser {
  ...
  ASN1Encodable implParseObject(int paramInt) throws IOException {
    ...
    if (j < 0) {
      ...
      int m = paramInt & 0xC0;
      return (0 != m) ? new BERTaggedObjectParser(m, i, aSN1StreamParser1) : aSN1StreamParser1.parseImplicitConstructedIL(i);
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1StreamParser.class
