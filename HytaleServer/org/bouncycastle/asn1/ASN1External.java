...
public abstract class ASN1External extends ASN1Primitive {
  ...
  public static ASN1External getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1External)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static ASN1External getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1External)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1External.class
