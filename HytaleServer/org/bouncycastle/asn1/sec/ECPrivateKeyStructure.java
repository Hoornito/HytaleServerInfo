...
public class ECPrivateKeyStructure extends ASN1Object {
  ...
  public ECPrivateKeyStructure(BigInteger paramBigInteger) {
    ...
    this.seq = (ASN1Sequence)new DERSequence((ASN1Encodable)new ASN1Integer(1L), (ASN1Encodable)new DEROctetString(arrayOfByte));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\sec\ECPrivateKeyStructure.class
