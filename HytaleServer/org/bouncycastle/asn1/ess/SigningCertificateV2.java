...
public class SigningCertificateV2 extends ASN1Object {
  ...
  public SigningCertificateV2(ESSCertIDv2[] paramArrayOfESSCertIDv2) {
    this.certs = (ASN1Sequence)new DERSequence((ASN1Encodable[])paramArrayOfESSCertIDv2);
  }
  ...
  public SigningCertificateV2(ESSCertIDv2[] paramArrayOfESSCertIDv2, PolicyInformation[] paramArrayOfPolicyInformation) {
    ...
    if (paramArrayOfPolicyInformation != null)
      this.policies = (ASN1Sequence)new DERSequence((ASN1Encodable[])paramArrayOfPolicyInformation); 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ess\SigningCertificateV2.class
