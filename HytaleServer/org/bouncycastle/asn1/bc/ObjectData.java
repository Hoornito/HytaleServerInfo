...
public class ObjectData extends ASN1Object {
  ...
  private ObjectData(ASN1Sequence paramASN1Sequence) {
    ...
    this.identifier = ASN1UTF8String.getInstance(paramASN1Sequence.getObjectAt(1)).getString();
    ...
    this.comment = (paramASN1Sequence.size() == 6) ? ASN1UTF8String.getInstance(paramASN1Sequence.getObjectAt(5)).getString() : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\bc\ObjectData.class
