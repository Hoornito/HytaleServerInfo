...
public class ObjectStoreIntegrityCheck extends ASN1Object implements ASN1Choice {
  ...
  private ObjectStoreIntegrityCheck(ASN1Encodable paramASN1Encodable) {
    if (paramASN1Encodable instanceof org.bouncycastle.asn1.ASN1Sequence || paramASN1Encodable instanceof PbkdMacIntegrityCheck) {
      ...
      this.type = 1;
      this.integrityCheck = SignatureCheck.getInstance(((ASN1TaggedObject)paramASN1Encodable).getExplicitBaseObject());
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\bc\ObjectStoreIntegrityCheck.class
