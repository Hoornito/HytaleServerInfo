...
public class LinkedCertificate extends ASN1Object {
    ...
    if (paramASN1Sequence.size() > 2)
      for (byte b = 2; b != paramASN1Sequence.size(); b++) {
        ...
        switch (aSN1TaggedObject.getTagNo()) {
          case 0:
            this.certIssuer = X500Name.getInstance(aSN1TaggedObject, true);
            break;
          case 1:
  ...
  public ASN1Primitive toASN1Primitive() {
    ...
    if (this.certIssuer != null)
      aSN1EncodableVector.add((ASN1Encodable)new DERTaggedObject(true, 0, (ASN1Encodable)this.certIssuer)); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\bc\LinkedCertificate.class
