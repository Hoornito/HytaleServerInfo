...
public class EncryptedData extends ASN1Object {
  ...
  private EncryptedData(ASN1Sequence paramASN1Sequence) {
    ASN1Integer aSN1Integer = (ASN1Integer)paramASN1Sequence.getObjectAt(0);
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new BERSequence((ASN1Encodable)new ASN1Integer(0L), (ASN1Encodable)this.data);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\EncryptedData.class
