...
public class SafeBag extends ASN1Object {
  ...
  private SafeBag(ASN1Sequence paramASN1Sequence) {
    ...
    this.bagValue = (ASN1Encodable)((ASN1TaggedObject)paramASN1Sequence.getObjectAt(1)).getExplicitBaseObject();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\SafeBag.class
