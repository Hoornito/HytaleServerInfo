...
public class PrivateKeyInfo extends ASN1Object {
  ...
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, byte[] paramArrayOfbyte) throws IOException {
    this(paramAlgorithmIdentifier, paramArrayOfbyte, (ASN1Set)null, (byte[])null);
  }
  
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, ASN1Encodable paramASN1Encodable) throws IOException {
    this(paramAlgorithmIdentifier, paramASN1Encodable, (ASN1Set)null, (byte[])null);
  }
  ...
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, ASN1Encodable paramASN1Encodable, ASN1Set paramASN1Set) throws IOException {
    this(paramAlgorithmIdentifier, paramASN1Encodable, paramASN1Set, (byte[])null);
  }
  
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, byte[] paramArrayOfbyte, ASN1Set paramASN1Set) throws IOException {
    this(paramAlgorithmIdentifier, paramArrayOfbyte, paramASN1Set, (byte[])null);
  }
  ...
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, ASN1Encodable paramASN1Encodable, ASN1Set paramASN1Set, byte[] paramArrayOfbyte) throws IOException {
    this(paramAlgorithmIdentifier, paramASN1Encodable.toASN1Primitive().getEncoded("DER"), paramASN1Set, paramArrayOfbyte);
  }
  
  public PrivateKeyInfo(AlgorithmIdentifier paramAlgorithmIdentifier, byte[] paramArrayOfbyte1, ASN1Set paramASN1Set, byte[] paramArrayOfbyte2) {
    this.version = new ASN1Integer((paramArrayOfbyte2 != null) ? BigIntegers.ONE : BigIntegers.ZERO);
    this.privateKeyAlgorithm = paramAlgorithmIdentifier;
    this.privateKey = (ASN1OctetString)new DEROctetString(paramArrayOfbyte1);
    this.attributes = paramASN1Set;
    this.publicKey = (paramArrayOfbyte2 == null) ? null : (ASN1BitString)new DERBitString(paramArrayOfbyte2);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\PrivateKeyInfo.class
