...
public class MacData extends ASN1Object {
  ...
  private MacData(ASN1Sequence paramASN1Sequence) {
    ...
    this.salt = Arrays.clone(ASN1OctetString.getInstance(paramASN1Sequence.getObjectAt(1)).getOctets());
    if (paramASN1Sequence.size() == 3) {
      this.iterationCount = ASN1Integer.getInstance(paramASN1Sequence.getObjectAt(2)).getValue();
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\MacData.class
