...
public class CRLBag extends ASN1Object {
  ...
  private CRLBag(ASN1Sequence paramASN1Sequence) {
    this.crlId = ASN1ObjectIdentifier.getInstance(paramASN1Sequence.getObjectAt(0));
    this.crlValue = (ASN1Encodable)ASN1TaggedObject.getInstance(paramASN1Sequence.getObjectAt(1)).getExplicitBaseObject();
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new DERSequence((ASN1Encodable)this.crlId, (ASN1Encodable)new DERTaggedObject(0, this.crlValue));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\CRLBag.class
