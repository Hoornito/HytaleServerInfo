...
public class ContentInfo extends ASN1Object implements PKCSObjectIdentifiers {
  ...
  private ContentInfo(ASN1Sequence paramASN1Sequence) {
    ...
    if (enumeration.hasMoreElements())
      this.content = (ASN1Encodable)((ASN1TaggedObject)enumeration.nextElement()).getExplicitBaseObject(); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\pkcs\ContentInfo.class
