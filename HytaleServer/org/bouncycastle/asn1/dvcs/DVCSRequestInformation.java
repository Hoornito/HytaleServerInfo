...
public class DVCSRequestInformation extends ASN1Object {
  ...
  public String toString() {
    ...
    stringBuilder.append("DVCSRequestInformation {\n");
    if (this.version != 1)
      stringBuilder.append("version: " + this.version + "\n"); 
    stringBuilder.append("service: " + this.service + "\n");
    if (this.nonce != null)
      stringBuilder.append("nonce: " + this.nonce + "\n"); 
    if (this.requestTime != null)
      stringBuilder.append("requestTime: " + this.requestTime + "\n"); 
    if (this.requester != null)
      stringBuilder.append("requester: " + this.requester + "\n"); 
    if (this.requestPolicy != null)
      stringBuilder.append("requestPolicy: " + this.requestPolicy + "\n"); 
    if (this.dvcs != null)
      stringBuilder.append("dvcs: " + this.dvcs + "\n"); 
    if (this.dataLocations != null)
      stringBuilder.append("dataLocations: " + this.dataLocations + "\n"); 
    if (this.extensions != null)
      stringBuilder.append("extensions: " + this.extensions + "\n"); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\dvcs\DVCSRequestInformation.class
