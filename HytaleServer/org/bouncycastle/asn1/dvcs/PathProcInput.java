...
public class PathProcInput extends ASN1Object {
  ...
  public PathProcInput(PolicyInformation[] paramArrayOfPolicyInformation) {
    this.acceptablePolicySet = copy(paramArrayOfPolicyInformation);
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    ASN1EncodableVector aSN1EncodableVector1 = new ASN1EncodableVector(4);
  ...
  private PolicyInformation[] copy(PolicyInformation[] paramArrayOfPolicyInformation) {
    PolicyInformation[] arrayOfPolicyInformation = new PolicyInformation[paramArrayOfPolicyInformation.length];
    System.arraycopy(paramArrayOfPolicyInformation, 0, arrayOfPolicyInformation, 0, arrayOfPolicyInformation.length);
    return arrayOfPolicyInformation;
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\dvcs\PathProcInput.class
