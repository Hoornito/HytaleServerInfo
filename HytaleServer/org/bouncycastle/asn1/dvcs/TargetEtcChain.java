...
public class TargetEtcChain extends ASN1Object {
  ...
  public String toString() {
    ...
    stringBuilder.append("TargetEtcChain {\n");
    stringBuilder.append("target: " + this.target + "\n");
    if (this.chain != null)
      stringBuilder.append("chain: " + this.chain + "\n"); 
    if (this.pathProcInput != null)
      stringBuilder.append("pathProcInput: " + this.pathProcInput + "\n"); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\dvcs\TargetEtcChain.class
