...
public class CertEtcToken extends ASN1Object implements ASN1Choice {
  ...
  private CertEtcToken(ASN1TaggedObject paramASN1TaggedObject) {
    ...
    switch (this.tagNo) {
      case 0:
        ...
        return;
      case 1:
        this.value = (ASN1Encodable)ESSCertID.getInstance(paramASN1TaggedObject.getExplicitBaseObject());
        return;
      case 2:
        this.value = (ASN1Encodable)PKIStatusInfo.getInstance(paramASN1TaggedObject, false);
        return;
      case 3:
        this.value = (ASN1Encodable)ContentInfo.getInstance(paramASN1TaggedObject.getExplicitBaseObject());
        return;
      case 4:
        this.value = (ASN1Encodable)CertificateList.getInstance(paramASN1TaggedObject, false);
        return;
      case 5:
        this.value = (ASN1Encodable)CertStatus.getInstance(paramASN1TaggedObject.getExplicitBaseObject());
        return;
      case 6:
      ...
      case 7:
        ...
        return;
      case 8:
        this.value = (ASN1Encodable)SMIMECapabilities.getInstance(paramASN1TaggedObject.getExplicitBaseObject());
        return;
    } 
  ...
  public static CertEtcToken getInstance(Object paramObject) {
    return (paramObject instanceof CertEtcToken) ? (CertEtcToken)paramObject : ((paramObject instanceof ASN1TaggedObject) ? new CertEtcToken(ASN1TaggedObject.getInstance(paramObject, 128)) : ((paramObject != null) ? new CertEtcToken(Extension.getInstance(paramObject)) : null));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\dvcs\CertEtcToken.class
