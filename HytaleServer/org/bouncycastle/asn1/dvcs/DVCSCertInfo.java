...
public class DVCSCertInfo extends ASN1Object {
  ...
  public String toString() {
    ...
    stringBuilder.append("dvReqInfo: " + this.dvReqInfo + "\n");
    stringBuilder.append("messageImprint: " + this.messageImprint + "\n");
    stringBuilder.append("serialNumber: " + this.serialNumber + "\n");
    stringBuilder.append("responseTime: " + this.responseTime + "\n");
    if (this.dvStatus != null)
      stringBuilder.append("dvStatus: " + this.dvStatus + "\n"); 
    if (this.policy != null)
      stringBuilder.append("policy: " + this.policy + "\n"); 
    if (this.reqSignature != null)
      stringBuilder.append("reqSignature: " + this.reqSignature + "\n"); 
    if (this.certs != null)
      stringBuilder.append("certs: " + this.certs + "\n"); 
    if (this.extensions != null)
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\dvcs\DVCSCertInfo.class
