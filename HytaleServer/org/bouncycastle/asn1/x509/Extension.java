...
public class Extension extends ASN1Object {
  ...
  public Extension(ASN1ObjectIdentifier paramASN1ObjectIdentifier, boolean paramBoolean, byte[] paramArrayOfbyte) {
    this(paramASN1ObjectIdentifier, paramBoolean, (ASN1OctetString)new DEROctetString(Arrays.clone(paramArrayOfbyte)));
  }
  ...
  public static Extension create(ASN1ObjectIdentifier paramASN1ObjectIdentifier, boolean paramBoolean, ASN1Encodable paramASN1Encodable) throws IOException {
    return new Extension(paramASN1ObjectIdentifier, paramBoolean, (ASN1OctetString)new DEROctetString(paramASN1Encodable.toASN1Primitive().getEncoded()));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\Extension.class
