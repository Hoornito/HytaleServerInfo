...
public class IssuingDistributionPoint extends ASN1Object {
  ...
  public IssuingDistributionPoint(DistributionPointName paramDistributionPointName, boolean paramBoolean1, boolean paramBoolean2, ReasonFlags paramReasonFlags, boolean paramBoolean3, boolean paramBoolean4) {
    if ((paramBoolean2 && (paramBoolean1 || paramBoolean4)) || (paramBoolean1 && paramBoolean4))
  ...
  public String toString() {
    ...
    if (this.onlyContainsUserCerts)
      appendObject(stringBuilder, str, "onlyContainsUserCerts", booleanToString(this.onlyContainsUserCerts)); 
    if (this.onlyContainsCACerts)
      appendObject(stringBuilder, str, "onlyContainsCACerts", booleanToString(this.onlyContainsCACerts)); 
    if (this.onlySomeReasons != null)
      appendObject(stringBuilder, str, "onlySomeReasons", this.onlySomeReasons.toString()); 
    if (this.onlyContainsAttributeCerts)
      appendObject(stringBuilder, str, "onlyContainsAttributeCerts", booleanToString(this.onlyContainsAttributeCerts)); 
    if (this.indirectCRL)
      appendObject(stringBuilder, str, "indirectCRL", booleanToString(this.indirectCRL)); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\IssuingDistributionPoint.class
