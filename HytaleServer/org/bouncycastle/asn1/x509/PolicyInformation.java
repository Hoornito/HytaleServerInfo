...
public class PolicyInformation extends ASN1Object {
  ...
  public String toString() {
    ...
    stringBuilder.append("Policy information: ");
    stringBuilder.append(this.policyIdentifier);
    if (this.policyQualifiers != null) {
      StringBuilder stringBuilder1 = new StringBuilder();
      for (byte b = 0; b < this.policyQualifiers.size(); b++) {
        if (stringBuilder1.length() != 0)
          stringBuilder1.append(", "); 
        stringBuilder1.append(PolicyQualifierInfo.getInstance(this.policyQualifiers.getObjectAt(b)));
      } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\PolicyInformation.class
