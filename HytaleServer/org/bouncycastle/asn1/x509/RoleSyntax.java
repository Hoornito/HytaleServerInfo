...
public class RoleSyntax extends ASN1Object {
  ...
  public String toString() {
    ...
    if (this.roleAuthority == null || (this.roleAuthority.getNames()).length == 0) {
      ...
      stringBuilder.append('[').append(arrayOfString[0]);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\RoleSyntax.class
