...
public class GeneralNames extends ASN1Object {
  ...
  public String toString() {
    ...
    for (byte b = 0; b != this.names.length; b++) {
      ...
      stringBuilder.append(this.names[b]);
      stringBuilder.append(str);
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\GeneralNames.class
