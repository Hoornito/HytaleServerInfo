...
public class DisplayText extends ASN1Object implements ASN1Choice {
  ...
  private DisplayText(ASN1String paramASN1String) {
    ...
    if (paramASN1String instanceof org.bouncycastle.asn1.ASN1UTF8String) {
      this.contentType = 2;
    } else if (paramASN1String instanceof org.bouncycastle.asn1.ASN1BMPString) {
      this.contentType = 1;
    } else if (paramASN1String instanceof org.bouncycastle.asn1.ASN1IA5String) {
      this.contentType = 0;
    } else if (paramASN1String instanceof org.bouncycastle.asn1.ASN1VisibleString) {
      this.contentType = 3;
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\DisplayText.class
