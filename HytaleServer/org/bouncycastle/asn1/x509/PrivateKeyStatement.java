...
public class PrivateKeyStatement extends ASN1Object {
  ...
  public static PrivateKeyStatement getInstance(Object paramObject) {
    return (paramObject instanceof PrivateKeyStatement) ? (PrivateKeyStatement)paramObject : ((paramObject != null) ? new PrivateKeyStatement(ASN1Sequence.getInstance(paramObject)) : null);
  }
  
  private PrivateKeyStatement(ASN1Sequence paramASN1Sequence) {
  ...
  public PrivateKeyStatement(IssuerAndSerialNumber paramIssuerAndSerialNumber) {
    this.signer = paramIssuerAndSerialNumber;
    this.cert = null;
  }
  
  public PrivateKeyStatement(Certificate paramCertificate) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\PrivateKeyStatement.class
