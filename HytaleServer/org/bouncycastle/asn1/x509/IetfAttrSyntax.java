...
public class IetfAttrSyntax extends ASN1Object {
  ...
  public Object[] getValues() {
    ...
    ASN1UTF8String[] arrayOfASN1UTF8String = new ASN1UTF8String[this.values.size()];
    for (byte b = 0; b != arrayOfASN1UTF8String.length; b++)
      arrayOfASN1UTF8String[b] = this.values.elementAt(b); 
    return (Object[])arrayOfASN1UTF8String;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\IetfAttrSyntax.class
