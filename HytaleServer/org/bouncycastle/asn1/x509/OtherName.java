...
public class OtherName extends ASN1Object {
  ...
  private OtherName(ASN1Sequence paramASN1Sequence) {
    ...
    this.value = (ASN1Encodable)ASN1TaggedObject.getInstance(paramASN1Sequence.getObjectAt(1)).getExplicitBaseObject();
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new DERSequence((ASN1Encodable)this.typeID, (ASN1Encodable)new DERTaggedObject(true, 0, this.value));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\OtherName.class
