...
public class IssuerSerial extends ASN1Object {
  ...
  private IssuerSerial(ASN1Sequence paramASN1Sequence) {
    ...
    if (paramASN1Sequence.size() == 3)
      this.issuerUID = ASN1BitString.getInstance(paramASN1Sequence.getObjectAt(2)); 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\IssuerSerial.class
