...
public class Extensions extends ASN1Object {
  ...
  public static Extension getExtension(Extensions paramExtensions, ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (null == paramExtensions) ? null : paramExtensions.getExtension(paramASN1ObjectIdentifier);
  }
  
  public static ASN1Encodable getExtensionParsedValue(Extensions paramExtensions, ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (null == paramExtensions) ? null : paramExtensions.getExtensionParsedValue(paramASN1ObjectIdentifier);
  }
  
  public static ASN1OctetString getExtensionValue(Extensions paramExtensions, ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (null == paramExtensions) ? null : paramExtensions.getExtensionValue(paramASN1ObjectIdentifier);
  }
  ...
  public Extensions(Extension[] paramArrayOfExtension) {
    if (paramArrayOfExtension == null || paramArrayOfExtension.length == 0)
  ...
  public ASN1Encodable getExtensionParsedValue(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    ...
    return (extension == null) ? null : extension.getParsedValue();
  }
  
  public ASN1OctetString getExtensionValue(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    Extension extension = getExtension(paramASN1ObjectIdentifier);
    return (extension == null) ? null : extension.getExtnValue();
  }
  ...
  public boolean hasAnyCriticalExtensions() {
    for (byte b = 0; b != this.ordering.size(); b++) {
      ...
      if (((Extension)this.extensions.get(object)).isCritical())
        return true; 
    } 
    return false;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\Extensions.class
