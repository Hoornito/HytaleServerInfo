...
public class AuthorityKeyIdentifier extends ASN1Object {
  ...
  public static AuthorityKeyIdentifier getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return new AuthorityKeyIdentifier(ASN1Sequence.getInstance(paramASN1TaggedObject, paramBoolean));
  }
  ...
  public static AuthorityKeyIdentifier fromExtensions(Extensions paramExtensions) {
    return getInstance(Extensions.getExtensionParsedValue(paramExtensions, Extension.authorityKeyIdentifier));
  }
  ...
  public AuthorityKeyIdentifier(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) {
    this(paramSubjectPublicKeyInfo, (GeneralNames)null, (BigInteger)null);
  }
  ...
  public AuthorityKeyIdentifier(byte[] paramArrayOfbyte, GeneralNames paramGeneralNames, BigInteger paramBigInteger) {
    this.keyIdentifier = (paramArrayOfbyte != null) ? (ASN1OctetString)new DEROctetString(Arrays.clone(paramArrayOfbyte)) : null;
    this.certissuer = paramGeneralNames;
    this.certserno = (paramBigInteger != null) ? new ASN1Integer(paramBigInteger) : null;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\AuthorityKeyIdentifier.class
