...
public class RSAPublicKeyStructure extends ASN1Object {
  ...
  public ASN1Primitive toASN1Primitive() {
    return (ASN1Primitive)new DERSequence((ASN1Encodable)new ASN1Integer(getModulus()), (ASN1Encodable)new ASN1Integer(getPublicExponent()));
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\RSAPublicKeyStructure.class
