...
public class V2TBSCertListGenerator {
  ...
  public void addCRLEntry(ASN1Integer paramASN1Integer, Time paramTime, int paramInt, ASN1GeneralizedTime paramASN1GeneralizedTime) {
    if (paramInt != 0) {
      ...
      internalAddCRLEntry(paramASN1Integer, paramTime, (ASN1Sequence)new DERSequence((ASN1Encodable)createInvalidityDateExtension(paramASN1GeneralizedTime)));
    } else {
  ...
  private static ASN1Sequence createReasonExtension(int paramInt) {
    ...
    try {
      return (ASN1Sequence)new DERSequence((ASN1Encodable)Extension.reasonCode, (ASN1Encodable)new DEROctetString(cRLReason.getEncoded()));
  ...
  private static ASN1Sequence createInvalidityDateExtension(ASN1GeneralizedTime paramASN1GeneralizedTime) {
    try {
      return (ASN1Sequence)new DERSequence((ASN1Encodable)Extension.invalidityDate, (ASN1Encodable)new DEROctetString(paramASN1GeneralizedTime.getEncoded()));
    } catch (IOException iOException) {
      throw new IllegalArgumentException("error encoding reason: " + iOException);
    } 
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\V2TBSCertListGenerator.class
