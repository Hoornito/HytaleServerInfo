...
public class CertificatePolicies extends ASN1Object {
  ...
  public String toString() {
    ...
    for (byte b = 0; b < this.policyInformation.length; b++) {
      ...
      stringBuilder.append(this.policyInformation[b]);
    } 
    return "CertificatePolicies: [" + stringBuilder + "]";
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\CertificatePolicies.class
