...
public class GeneralName extends ASN1Object implements ASN1Choice {
  ...
  public static GeneralName getInstance(Object paramObject) {
    ...
    if (paramObject instanceof ASN1TaggedObject) {
      ...
      switch (i) {
        ...
        case 2:
        case 6:
          return new GeneralName(i, (ASN1Encodable)ASN1IA5String.getInstance(aSN1TaggedObject, false));
        case 4:
  ...
  public String toString() {
    ...
    switch (this.tag) {
      ...
      case 2:
      case 6:
        stringBuilder.append(ASN1IA5String.getInstance(this.obj).getString());
        return stringBuilder.toString();
      case 4:
        stringBuilder.append(X500Name.getInstance(this.obj).toString());
        return stringBuilder.toString();
    } 
  ...
  public ASN1Primitive toASN1Primitive() {
    boolean bool = (this.tag == 4) ? true : false;
    return (ASN1Primitive)new DERTaggedObject(bool, this.tag, this.obj);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\GeneralName.class
