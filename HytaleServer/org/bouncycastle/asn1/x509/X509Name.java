...
public class X509Name extends ASN1Object {
  ...
  public static X509Name getInstance(Object paramObject) {
    return (paramObject instanceof X509Name) ? (X509Name)paramObject : ((paramObject instanceof X500Name) ? new X509Name(ASN1Sequence.getInstance(((X500Name)paramObject).toASN1Primitive())) : ((paramObject != null) ? new X509Name(ASN1Sequence.getInstance(paramObject)) : null));
  }
  ...
  public X509Name(ASN1Sequence paramASN1Sequence) {
    ...
    while (enumeration.hasMoreElements()) {
      ...
      for (byte b = 0; b < aSN1Set.size(); b++) {
        ...
        if (aSN1Encodable instanceof ASN1String && !(aSN1Encodable instanceof org.bouncycastle.asn1.ASN1UniversalString)) {
  ...
  public ASN1Primitive toASN1Primitive() {
    if (this.seq == null) {
      ...
      for (byte b = 0; b != this.ordering.size(); b++) {
        ...
        aSN1ObjectIdentifier = this.ordering.elementAt(b);
        ASN1Primitive aSN1Primitive = this.converter.getConvertedValue(aSN1ObjectIdentifier, this.values.elementAt(b));
        aSN1EncodableVector2.add((ASN1Encodable)new DERSequence((ASN1Encodable)aSN1ObjectIdentifier, (ASN1Encodable)aSN1Primitive));
      } 
      aSN1EncodableVector1.add((ASN1Encodable)new DERSet(aSN1EncodableVector2));
    ...
    for (k = j; k != b1; k += b2) {
      ...
      for (byte b = 0; b < i; b++) {
        if (!arrayOfBoolean[b]) {
          ...
          if (aSN1ObjectIdentifier.equals((ASN1Primitive)aSN1ObjectIdentifier1)) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\X509Name.class
