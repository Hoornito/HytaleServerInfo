...
public class ObjectDigestInfo extends ASN1Object {
  ...
  public ObjectDigestInfo(int paramInt, ASN1ObjectIdentifier paramASN1ObjectIdentifier, AlgorithmIdentifier paramAlgorithmIdentifier, byte[] paramArrayOfbyte) {
    ...
    this.objectDigest = (ASN1BitString)new DERBitString(paramArrayOfbyte);
  }
  ...
  private ObjectDigestInfo(ASN1Sequence paramASN1Sequence) {
    ...
    this.objectDigest = ASN1BitString.getInstance(paramASN1Sequence.getObjectAt(2 + b));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\ObjectDigestInfo.class
