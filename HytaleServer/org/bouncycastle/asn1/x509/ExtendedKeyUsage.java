...
public class ExtendedKeyUsage extends ASN1Object {
  ...
  public static ExtendedKeyUsage fromExtensions(Extensions paramExtensions) {
    return getInstance(Extensions.getExtensionParsedValue(paramExtensions, Extension.extendedKeyUsage));
  }
  ...
  public ExtendedKeyUsage(KeyPurposeId[] paramArrayOfKeyPurposeId) {
    ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(paramArrayOfKeyPurposeId.length);
  ...
  public ExtendedKeyUsage(Vector paramVector) {
    ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(paramVector.size());
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x509\ExtendedKeyUsage.class
