...
public class CertificateHolderAuthorization extends ASN1Object {
  ...
  public ASN1Primitive toASN1Primitive() {
    DERSequence dERSequence = new DERSequence((ASN1Encodable)this.oid, (ASN1Encodable)EACTagged.create(19, new byte[] { this.accessRights }));
    return (ASN1Primitive)EACTagged.create(76, (ASN1Sequence)dERSequence);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\eac\CertificateHolderAuthorization.class
