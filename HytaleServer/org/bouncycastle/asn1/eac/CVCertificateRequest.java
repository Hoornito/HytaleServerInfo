...
public class CVCertificateRequest extends ASN1Object {
  ...
  public ASN1Primitive toASN1Primitive() {
    ...
    DERSequence dERSequence = new DERSequence((ASN1Encodable)this.certificateBody, (ASN1Encodable)EACTagged.create(55, this.innerSignature));
    return (ASN1Primitive)EACTagged.create(33, (ASN1Sequence)dERSequence);
  }
}


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\eac\CVCertificateRequest.class
