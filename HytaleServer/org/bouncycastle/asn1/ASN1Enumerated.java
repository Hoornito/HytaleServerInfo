...
public class ASN1Enumerated extends ASN1Primitive {
  ...
  public static ASN1Enumerated getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1Enumerated)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static ASN1Enumerated getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1Enumerated)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1Enumerated.class
