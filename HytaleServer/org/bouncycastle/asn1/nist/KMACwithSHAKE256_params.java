...
public class KMACwithSHAKE256_params extends ASN1Object {
  ...
  public KMACwithSHAKE256_params(int paramInt) {
    this.outputLength = paramInt;
    this.customizationString = EMPTY_STRING;
  }
  
  public KMACwithSHAKE256_params(int paramInt, byte[] paramArrayOfbyte) {
    this.outputLength = paramInt;
    this.customizationString = Arrays.clone(paramArrayOfbyte);
  }
  
  public static KMACwithSHAKE256_params getInstance(Object paramObject) {
    return (paramObject instanceof KMACwithSHAKE256_params) ? (KMACwithSHAKE256_params)paramObject : ((paramObject != null) ? new KMACwithSHAKE256_params(ASN1Sequence.getInstance(paramObject)) : null);
  }
  
  private KMACwithSHAKE256_params(ASN1Sequence paramASN1Sequence) {
