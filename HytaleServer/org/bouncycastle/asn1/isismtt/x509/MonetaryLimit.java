...
public class MonetaryLimit extends ASN1Object {
  ...
  public MonetaryLimit(String paramString, int paramInt1, int paramInt2) {
    this.currency = (ASN1PrintableString)new DERPrintableString(paramString, true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\isismtt\x509\MonetaryLimit.class
