...
public class ProfessionInfo extends ASN1Object {
  ...
  private ProfessionInfo(ASN1Sequence paramASN1Sequence) {
    ...
    if (enumeration.hasMoreElements()) {
      ...
      if (aSN1Encodable instanceof ASN1Sequence) {
        ...
        this.registrationNumber = ASN1PrintableString.getInstance(aSN1Encodable).getString();
  ...
  public ProfessionInfo(NamingAuthority paramNamingAuthority, DirectoryString[] paramArrayOfDirectoryString, ASN1ObjectIdentifier[] paramArrayOfASN1ObjectIdentifier, String paramString, ASN1OctetString paramASN1OctetString) {
    ...
    this.professionItems = (ASN1Sequence)new DERSequence((ASN1Encodable[])paramArrayOfDirectoryString);
    if (paramArrayOfASN1ObjectIdentifier != null)
      this.professionOIDs = (ASN1Sequence)new DERSequence((ASN1Encodable[])paramArrayOfASN1ObjectIdentifier); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\isismtt\x509\ProfessionInfo.class
