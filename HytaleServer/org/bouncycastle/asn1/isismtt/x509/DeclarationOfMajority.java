...
public class DeclarationOfMajority extends ASN1Object implements ASN1Choice {
  ...
  public DeclarationOfMajority(boolean paramBoolean, String paramString) {
    ...
    if (paramBoolean) {
      ...
      this.declaration = (ASN1TaggedObject)new DERTaggedObject(false, 1, (ASN1Encodable)new DERSequence((ASN1Encodable)ASN1Boolean.FALSE, (ASN1Encodable)new DERPrintableString(paramString, true)));
    } 
  }
  ...
  public static DeclarationOfMajority getInstance(Object paramObject) {
    ...
    if (paramObject instanceof ASN1TaggedObject)
      return new DeclarationOfMajority(ASN1TaggedObject.getInstance(paramObject, 128)); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\isismtt\x509\DeclarationOfMajority.class
