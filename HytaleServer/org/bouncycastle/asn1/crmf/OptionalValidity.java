...
public class OptionalValidity extends ASN1Object {
  ...
  public static OptionalValidity getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return new OptionalValidity(ASN1Sequence.getInstance(paramASN1TaggedObject, paramBoolean));
  }
  
  public static OptionalValidity getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return new OptionalValidity(ASN1Sequence.getTagged(paramASN1TaggedObject, paramBoolean));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\crmf\OptionalValidity.class
