...
public class PKIArchiveOptions extends ASN1Object implements ASN1Choice {
  ...
  public static PKIArchiveOptions getInstance(Object paramObject) {
    ...
    if (paramObject instanceof ASN1TaggedObject)
      return new PKIArchiveOptions(ASN1TaggedObject.getInstance(paramObject, 128)); 
  ...
  private PKIArchiveOptions(ASN1TaggedObject paramASN1TaggedObject) {
    switch (paramASN1TaggedObject.getTagNo()) {
      case 0:
        this.value = (ASN1Encodable)EncryptedKey.getInstance(paramASN1TaggedObject.getExplicitBaseObject());
        return;
      case 1:
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\crmf\PKIArchiveOptions.class
