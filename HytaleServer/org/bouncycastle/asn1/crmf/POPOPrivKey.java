...
public class POPOPrivKey extends ASN1Object implements ASN1Choice {
  ...
  private POPOPrivKey(ASN1TaggedObject paramASN1TaggedObject) {
    ...
    switch (this.tagNo) {
      case 0:
        this.obj = (ASN1Encodable)ASN1BitString.getInstance(paramASN1TaggedObject, false);
        return;
      case 1:
        this.obj = (ASN1Encodable)SubsequentMessage.valueOf(ASN1Integer.getInstance(paramASN1TaggedObject, false).intValueExact());
        return;
      case 2:
        this.obj = (ASN1Encodable)ASN1BitString.getInstance(paramASN1TaggedObject, false);
        return;
  ...
  public POPOPrivKey(PKMACValue paramPKMACValue) {
    this.tagNo = 3;
    this.obj = (ASN1Encodable)paramPKMACValue;
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\crmf\POPOPrivKey.class
