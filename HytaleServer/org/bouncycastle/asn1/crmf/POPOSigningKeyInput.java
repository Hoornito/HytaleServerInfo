...
public class POPOSigningKeyInput extends ASN1Object {
  ...
  private POPOSigningKeyInput(ASN1Sequence paramASN1Sequence) {
    ...
    if (aSN1Encodable instanceof ASN1TaggedObject) {
      ...
      this.sender = GeneralName.getInstance(ASN1Util.getExplicitContextBaseObject(aSN1TaggedObject, 0));
    } else {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\crmf\POPOSigningKeyInput.class
