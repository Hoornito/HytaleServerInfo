...
public class EncryptedKey extends ASN1Object implements ASN1Choice {
  ...
  public static EncryptedKey getInstance(Object paramObject) {
    return (paramObject instanceof EncryptedKey) ? (EncryptedKey)paramObject : ((paramObject instanceof ASN1TaggedObject) ? new EncryptedKey(EnvelopedData.getInstance((ASN1TaggedObject)paramObject, false)) : new EncryptedKey(EncryptedValue.getInstance(paramObject)));
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\crmf\EncryptedKey.class
