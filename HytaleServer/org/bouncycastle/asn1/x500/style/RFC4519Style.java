...
public class RFC4519Style extends AbstractX500NameStyle {
  ...
  public RDN[] fromString(String paramString) {
    ...
    for (byte b = 0; b != arrayOfRDN1.length; b++)
      arrayOfRDN2[arrayOfRDN2.length - b - 1] = arrayOfRDN1[b]; 
    return arrayOfRDN2;
  }
  ...
  public String toString(X500Name paramX500Name) {
    ...
    for (int i = arrayOfRDN.length - 1; i >= 0; i--) {
      ...
      IETFUtils.appendRDN(stringBuilder, arrayOfRDN[i], this.defaultSymbols);
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x500\style\RFC4519Style.class
