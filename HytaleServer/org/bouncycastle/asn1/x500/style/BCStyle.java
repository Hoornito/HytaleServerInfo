...
public class BCStyle extends AbstractX500NameStyle {
  ...
  protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    return (ASN1Encodable)((paramASN1ObjectIdentifier.equals((ASN1Primitive)EmailAddress) || paramASN1ObjectIdentifier.equals((ASN1Primitive)DC)) ? new DERIA5String(paramString) : (paramASN1ObjectIdentifier.equals((ASN1Primitive)DATE_OF_BIRTH) ? new ASN1GeneralizedTime(paramString) : ((paramASN1ObjectIdentifier.equals((ASN1Primitive)C) || paramASN1ObjectIdentifier.equals((ASN1Primitive)SERIALNUMBER) || paramASN1ObjectIdentifier.equals((ASN1Primitive)DN_QUALIFIER) || paramASN1ObjectIdentifier.equals((ASN1Primitive)TELEPHONE_NUMBER) || paramASN1ObjectIdentifier.equals((ASN1Primitive)JURISDICTION_C)) ? new DERPrintableString(paramString) : super.encodeStringValue(paramASN1ObjectIdentifier, paramString))));
  }
  
  public String oidToDisplayName(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (String)this.defaultSymbols.get(paramASN1ObjectIdentifier);
  }
  ...
  public String toString(X500Name paramX500Name) {
    ...
    for (byte b = 0; b < arrayOfRDN.length; b++) {
      ...
      IETFUtils.appendRDN(stringBuilder, arrayOfRDN[b], this.defaultSymbols);
    } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\x500\style\BCStyle.class
