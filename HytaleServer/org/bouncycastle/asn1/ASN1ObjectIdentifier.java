...
public class ASN1ObjectIdentifier extends ASN1Primitive {
  ...
  public static ASN1ObjectIdentifier getInstance(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    ...
    return (ASN1ObjectIdentifier)TYPE.getContextTagged(paramASN1TaggedObject, paramBoolean);
  }
  
  public static ASN1ObjectIdentifier getTagged(ASN1TaggedObject paramASN1TaggedObject, boolean paramBoolean) {
    return (ASN1ObjectIdentifier)TYPE.getTagged(paramASN1TaggedObject, paramBoolean);
  }
  ...
  public ASN1ObjectIdentifier branch(String paramString) {
    ...
    return new ASN1ObjectIdentifier(arrayOfByte, str2);
  }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\asn1\ASN1ObjectIdentifier.class
