...
class HttpUtil {
  ...
  static class Headers extends HashMap<String, String[]> {
    ...
    public String getFirstValueOrEmpty(String param1String) {
      String[] arrayOfString = getValues(param1String);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\bouncycastle\est\HttpUtil.class
