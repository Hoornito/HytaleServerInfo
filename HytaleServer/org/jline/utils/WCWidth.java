...
/*  76 */     if (ucs == 0) return 0; 
/*  77 */     if (ucs < 32 || (ucs >= 127 && ucs < 160)) return -1;
/*     */ 
/*     */     
/*  80 */     if (bisearch(ucs, combining, combining.length - 1)) return 0;
/*     */ 
/*     */     
/*  83 */     return 1 + ((
/*  84 */       ucs >= 4352 && (ucs <= 4447 || ucs == 9001 || ucs == 9002 || (ucs >= 11904 && ucs <= 42191 && ucs != 12351) || (ucs >= 44032 && ucs <= 55203) || (ucs >= 63744 && ucs <= 64255) || (ucs >= 65040 && ucs <= 65049) || (ucs >= 65072 && ucs <= 65135) || (ucs >= 65280 && ucs <= 65376) || (ucs >= 65504 && ucs <= 65510) || (ucs >= 126976 && ucs <= 130798) || (ucs >= 131072 && ucs <= 196605) || (ucs >= 196608 && ucs <= 262141))) ? 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 170 */     if (ucs < (table[0]).first || ucs > (table[max]).last) return false; 
/* 171 */     while (max >= min) {
/* 172 */       int mid = (min + max) / 2;
/* 173 */       if (ucs > (table[mid]).last) { min = mid + 1; continue; }
/* 174 */        if (ucs < (table[mid]).first) { max = mid - 1; continue; }
/* 175 */        return true;
/*     */     } 
/*     */     
/* 178 */     return false;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\jlin\\utils\WCWidth.class
