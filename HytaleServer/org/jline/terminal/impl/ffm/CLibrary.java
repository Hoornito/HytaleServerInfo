...
/*      */   
/*   51 */   static class winsize { static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_SHORT
/*   52 */           .withName("ws_row"), (MemoryLayout)ValueLayout.JAVA_SHORT
/*   53 */           .withName("ws_col"), (MemoryLayout)ValueLayout.JAVA_SHORT, (MemoryLayout)ValueLayout.JAVA_SHORT });
/*      */ 
/*      */ 
/*      */     
/*   57 */     private static final VarHandle ws_col = FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("ws_col") }); private static final VarHandle ws_row = FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("ws_row") });
/*      */     
/*      */     static {
/*      */     
/*      */     }
/*      */     
/*   63 */     private final MemorySegment seg = Arena.ofAuto().allocate((MemoryLayout)LAYOUT);
/*      */ 
/*      */     
...
/*  108 */         LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_LONG
/*  109 */               .withName("c_iflag"), (MemoryLayout)ValueLayout.JAVA_LONG
/*  110 */               .withName("c_oflag"), (MemoryLayout)ValueLayout.JAVA_LONG
/*  111 */               .withName("c_cflag"), (MemoryLayout)ValueLayout.JAVA_LONG
/*  112 */               .withName("c_lflag"), 
/*  113 */               (MemoryLayout)MemoryLayout.sequenceLayout(32L, (MemoryLayout)ValueLayout.JAVA_BYTE).withName("c_cc"), (MemoryLayout)ValueLayout.JAVA_LONG
/*  114 */               .withName("c_ispeed"), (MemoryLayout)ValueLayout.JAVA_LONG
/*  115 */               .withName("c_ospeed") });
/*  116 */       } else if (OSUtils.IS_LINUX) {
/*  117 */         LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT
/*  118 */               .withName("c_iflag"), (MemoryLayout)ValueLayout.JAVA_INT
/*  119 */               .withName("c_oflag"), (MemoryLayout)ValueLayout.JAVA_INT
/*  120 */               .withName("c_cflag"), (MemoryLayout)ValueLayout.JAVA_INT
/*  121 */               .withName("c_lflag"), (MemoryLayout)ValueLayout.JAVA_BYTE
/*  122 */               .withName("c_line"), 
/*  123 */               (MemoryLayout)MemoryLayout.sequenceLayout(32L, (MemoryLayout)ValueLayout.JAVA_BYTE).withName("c_cc"), 
/*  124 */               (MemoryLayout)MemoryLayout.paddingLayout(3L), (MemoryLayout)ValueLayout.JAVA_INT
/*  125 */               .withName("c_ispeed"), (MemoryLayout)ValueLayout.JAVA_INT
...
/*  131 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_iflag") }));
/*  132 */     private static final VarHandle c_oflag = adjust2LinuxHandle(
/*  133 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_oflag") }));
/*  134 */     private static final VarHandle c_cflag = adjust2LinuxHandle(
/*  135 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_cflag") }));
/*  136 */     private static final VarHandle c_lflag = adjust2LinuxHandle(
/*  137 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_lflag") }));
...
/*  140 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_ispeed") }));
/*  141 */     private static final VarHandle c_ospeed = adjust2LinuxHandle(
/*  142 */         FfmTerminalProvider.lookupVarHandle((MemoryLayout)LAYOUT, new MemoryLayout.PathElement[] { MemoryLayout.PathElement.groupElement("c_ospeed") }));
...
/*      */     
/*      */     termios() {
/*  160 */       this.seg = Arena.ofAuto().allocate((MemoryLayout)LAYOUT);
/*      */     }
/*      */     
...
/*  452 */         .find("ioctl").get(), 
/*  453 */         FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT, (MemoryLayout)ValueLayout.JAVA_LONG, (MemoryLayout)ValueLayout.ADDRESS }), new Linker.Option[] {
/*      */           
/*  455 */           Linker.Option.firstVariadicArg(2)
/*      */         });
/*  457 */     isatty = linker.downcallHandle(lookup
/*  458 */         .find("isatty").get(), FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT }), new Linker.Option[0]);
/*      */     
/*  460 */     tcsetattr = linker.downcallHandle(lookup
/*  461 */         .find("tcsetattr").get(), 
/*  462 */         FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT, (MemoryLayout)ValueLayout.JAVA_INT, (MemoryLayout)ValueLayout.ADDRESS }), new Linker.Option[0]);
/*      */ 
/*      */     
/*  465 */     tcgetattr = linker.downcallHandle(lookup
/*  466 */         .find("tcgetattr").get(), 
/*  467 */         FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT, (MemoryLayout)ValueLayout.ADDRESS }), new Linker.Option[0]);
/*      */     
/*  469 */     ttyname_r = linker.downcallHandle(lookup
/*  470 */         .find("ttyname_r").get(), 
/*  471 */         FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT, (MemoryLayout)ValueLayout.ADDRESS, (MemoryLayout)ValueLayout.JAVA_LONG }), new Linker.Option[0]);
/*      */ 
/*      */     
...
/*  541 */           .get(), 
/*  542 */           FunctionDescriptor.of((MemoryLayout)ValueLayout.JAVA_INT, new MemoryLayout[] { (MemoryLayout)ValueLayout.ADDRESS, (MemoryLayout)ValueLayout.ADDRESS, (MemoryLayout)ValueLayout.ADDRESS, (MemoryLayout)ValueLayout.ADDRESS, (MemoryLayout)ValueLayout.ADDRESS }), new Linker.Option[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\jline\terminal\impl\ffm\CLibrary.class
