...
/* 281 */     MemorySegment length = arena.allocate((MemoryLayout)ValueLayout.JAVA_INT, 1L);
/*     */ 
/*     */     
...
/* 327 */       .find(name)
/* 328 */       .map(addr -> Linker.nativeLinker().downcallHandle(addr, fdesc, new Linker.Option[0]))
/* 329 */       .orElse(null);
/*     */   }
/*     */   
...
/*     */       
/* 347 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT }));
/*     */   
/* 349 */   static final MethodHandle GetStdHandle$MH = downcallHandle("GetStdHandle", FunctionDescriptor.of((MemoryLayout)C_POINTER$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_INT$LAYOUT }));
/* 350 */   static final MethodHandle FormatMessageW$MH = downcallHandle("FormatMessageW", 
/*     */       
/* 352 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 363 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_SHORT$LAYOUT }));
/* 364 */   static final MethodHandle SetConsoleMode$MH = downcallHandle("SetConsoleMode", 
/* 365 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT }));
/* 366 */   static final MethodHandle GetConsoleMode$MH = downcallHandle("GetConsoleMode", 
/*     */       
/* 368 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */ 
/*     */   
/* 371 */   static final MethodHandle SetConsoleTitleW$MH = downcallHandle("SetConsoleTitleW", FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT }));
/* 372 */   static final MethodHandle SetConsoleCursorPosition$MH = downcallHandle("SetConsoleCursorPosition", 
/*     */       
/* 374 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)COORD.LAYOUT }));
/* 375 */   static final MethodHandle FillConsoleOutputCharacterW$MH = downcallHandle("FillConsoleOutputCharacterW", 
/*     */       
/* 377 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_WCHAR$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)COORD.LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */   
/* 379 */   static final MethodHandle FillConsoleOutputAttribute$MH = downcallHandle("FillConsoleOutputAttribute", 
/*     */       
/* 381 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_SHORT$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)COORD.LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */   
/* 383 */   static final MethodHandle WriteConsoleW$MH = downcallHandle("WriteConsoleW", 
/*     */       
/* 385 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 395 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */   
/* 397 */   static final MethodHandle PeekConsoleInputW$MH = downcallHandle("PeekConsoleInputW", 
/*     */       
/* 399 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_INT$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */ 
/*     */   
/* 402 */   static final MethodHandle GetConsoleScreenBufferInfo$MH = downcallHandle("GetConsoleScreenBufferInfo", 
/*     */       
/* 404 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */   
/* 406 */   static final MethodHandle ScrollConsoleScreenBufferW$MH = downcallHandle("ScrollConsoleScreenBufferW", 
/*     */       
/* 408 */       FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)C_POINTER$LAYOUT, (MemoryLayout)COORD.LAYOUT, (MemoryLayout)C_POINTER$LAYOUT }));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 416 */   static final MethodHandle GetLastError$MH = downcallHandle("GetLastError", FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[0]));
/*     */   
/* 418 */   static final MethodHandle GetFileType$MH = downcallHandle("GetFileType", FunctionDescriptor.of((MemoryLayout)C_INT$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_POINTER$LAYOUT }));
/*     */   
/* 420 */   static final MethodHandle _get_osfhandle$MH = downcallHandle("_get_osfhandle", FunctionDescriptor.of((MemoryLayout)C_POINTER$LAYOUT, new MemoryLayout[] { (MemoryLayout)C_INT$LAYOUT }));
/*     */   
/*     */   public static final class INPUT_RECORD {
/* 423 */     static final MemoryLayout LAYOUT = (MemoryLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_SHORT
/* 424 */           .withName("EventType"), (MemoryLayout)ValueLayout.JAVA_SHORT, 
/*     */           
/* 426 */           (MemoryLayout)MemoryLayout.unionLayout(new MemoryLayout[] {
/* 427 */               Kernel32.KEY_EVENT_RECORD.LAYOUT.withName("KeyEvent"), Kernel32.MOUSE_EVENT_RECORD.LAYOUT
/* 428 */               .withName("MouseEvent"), (MemoryLayout)Kernel32.WINDOW_BUFFER_SIZE_RECORD.LAYOUT
/* 429 */               .withName("WindowBufferSizeEvent"), (MemoryLayout)Kernel32.MENU_EVENT_RECORD.LAYOUT
/* 430 */               .withName("MenuEvent"), (MemoryLayout)Kernel32.FOCUS_EVENT_RECORD.LAYOUT
...
/*     */   {
/* 470 */     static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.C_DWORD$LAYOUT.withName("dwCommandId") });
/* 471 */     static final VarHandle COMMAND_ID = Kernel32.varHandle((MemoryLayout)LAYOUT, "dwCommandId");
/*     */     
/*     */     private final MemorySegment seg;
/*     */     
...
/* 480 */       this(arena.allocate((MemoryLayout)LAYOUT));
/*     */     }
/*     */     
...
/*     */   {
/* 499 */     static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.C_INT$LAYOUT.withName("bSetFocus") });
/* 500 */     static final VarHandle SET_FOCUS = Kernel32.varHandle((MemoryLayout)LAYOUT, "bSetFocus");
/*     */     
/*     */     private final MemorySegment seg;
/*     */     
...
/* 509 */       this(arena.allocate((MemoryLayout)LAYOUT));
/*     */     }
/*     */     
...
/*     */   {
/* 532 */     static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.COORD.LAYOUT.withName("size") });
/* 533 */     static final long SIZE_OFFSET = Kernel32.byteOffset((MemoryLayout)LAYOUT, "size");
/*     */     
/*     */     private final MemorySegment seg;
/*     */     
...
/* 542 */       this(arena.allocate((MemoryLayout)LAYOUT));
/*     */     }
/*     */     
...
/*     */   {
/* 560 */     static final MemoryLayout LAYOUT = (MemoryLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.COORD.LAYOUT
/* 561 */           .withName("dwMousePosition"), (MemoryLayout)Kernel32.C_DWORD$LAYOUT
/* 562 */           .withName("dwButtonState"), (MemoryLayout)Kernel32.C_DWORD$LAYOUT
/* 563 */           .withName("dwControlKeyState"), (MemoryLayout)Kernel32.C_DWORD$LAYOUT
...
/*     */   {
/* 612 */     static final MemoryLayout LAYOUT = (MemoryLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)ValueLayout.JAVA_INT
/* 613 */           .withName("bKeyDown"), (MemoryLayout)ValueLayout.JAVA_SHORT
/* 614 */           .withName("wRepeatCount"), (MemoryLayout)ValueLayout.JAVA_SHORT
/* 615 */           .withName("wVirtualKeyCode"), (MemoryLayout)ValueLayout.JAVA_SHORT
/* 616 */           .withName("wVirtualScanCode"), 
/* 617 */           (MemoryLayout)MemoryLayout.unionLayout(new MemoryLayout[] {
/* 618 */               (MemoryLayout)ValueLayout.JAVA_CHAR.withName("UnicodeChar"), (MemoryLayout)ValueLayout.JAVA_BYTE
/* 619 */               .withName("AsciiChar")
/* 620 */             }).withName("uChar"), (MemoryLayout)ValueLayout.JAVA_INT
...
/*     */   {
/* 773 */     static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.C_SHORT$LAYOUT.withName("x"), (MemoryLayout)Kernel32.C_SHORT$LAYOUT.withName("y") });
/* 774 */     static final VarHandle x$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "x");
/* 775 */     static final VarHandle y$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "y");
/*     */     
/*     */     private final MemorySegment seg;
/*     */     
/*     */     public COORD() {
...
/* 784 */       this(arena.allocate((MemoryLayout)LAYOUT));
/*     */     }
/*     */     
/*     */     public COORD(Arena arena, short x, short y) {
/* 788 */       this(arena.allocate((MemoryLayout)LAYOUT));
/* 789 */       x(x);
/* 790 */       y(y);
/*     */     }
/*     */     
...
/* 818 */       return new COORD(arena.allocate((MemoryLayout)LAYOUT).copyFrom(this.seg));
/*     */     }
/*     */   }
/*     */   
/*     */   public static final class SMALL_RECT
/*     */   {
/* 824 */     static final GroupLayout LAYOUT = (GroupLayout)MemoryLayout.structLayout(new MemoryLayout[] { (MemoryLayout)Kernel32.C_SHORT$LAYOUT
/* 825 */           .withName("Left"), (MemoryLayout)Kernel32.C_SHORT$LAYOUT
/* 826 */           .withName("Top"), (MemoryLayout)Kernel32.C_SHORT$LAYOUT
/* 827 */           .withName("Right"), (MemoryLayout)Kernel32.C_SHORT$LAYOUT
/* 828 */           .withName("Bottom") });
/* 829 */     static final VarHandle Left$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "Left");
/* 830 */     static final VarHandle Top$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "Top");
/* 831 */     static final VarHandle Right$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "Right");
/* 832 */     static final VarHandle Bottom$VH = Kernel32.varHandle((MemoryLayout)LAYOUT, "Bottom");
/*     */     
/*     */     private final MemorySegment seg;
/*     */     
/*     */     public SMALL_RECT() {
...
/* 841 */       this(arena.allocate((MemoryLayout)LAYOUT));
/*     */     }
/*     */     
...
/* 901 */       return new SMALL_RECT(arena.allocate((MemoryLayout)LAYOUT).copyFrom(this.seg));
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\org\jline\terminal\impl\ffm\Kernel32.class
