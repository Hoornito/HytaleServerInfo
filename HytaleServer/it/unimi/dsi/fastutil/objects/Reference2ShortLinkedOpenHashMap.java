...
/*      */     
/*      */     public K getKey() {
/*  932 */       return Reference2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  937 */       return Reference2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  942 */       return Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  947 */       return Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  952 */       short oldValue = Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*  953 */       Reference2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  954 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceShortPair<K> right(short v) {
/*  959 */       Reference2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  960 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  971 */       return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  990 */       return (Reference2ShortLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  995 */       return System.identityHashCode(Reference2ShortLinkedOpenHashMap.this.key[this.index]) ^ Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1000 */       return (new StringBuilder()).append(Reference2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ShortLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1168 */       this.next = Reference2ShortLinkedOpenHashMap.this.first;
/* 1169 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1173 */       if (from == null) {
/* 1174 */         if (Reference2ShortLinkedOpenHashMap.this.containsNullKey) {
/* 1175 */           this.next = (int)Reference2ShortLinkedOpenHashMap.this.link[Reference2ShortLinkedOpenHashMap.this.n];
/* 1176 */           this.prev = Reference2ShortLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1178 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1180 */       if (Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.last] == from) {
/* 1181 */         this.prev = Reference2ShortLinkedOpenHashMap.this.last;
/* 1182 */         this.index = Reference2ShortLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1186 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */       
/* 1188 */       while (Reference2ShortLinkedOpenHashMap.this.key[pos] != null) {
/* 1189 */         if (Reference2ShortLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1191 */           this.next = (int)Reference2ShortLinkedOpenHashMap.this.link[pos];
/* 1192 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1195 */         pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1214 */       if (this.next == -1) {
/* 1215 */         this.index = Reference2ShortLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1218 */       int pos = Reference2ShortLinkedOpenHashMap.this.first;
/* 1219 */       this.index = 1;
/* 1220 */       while (pos != this.prev) {
/* 1221 */         pos = (int)Reference2ShortLinkedOpenHashMap.this.link[pos];
/* 1222 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1239 */       this.next = (int)Reference2ShortLinkedOpenHashMap.this.link[this.curr];
...
/* 1248 */       this.prev = (int)(Reference2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1257 */         this.next = (int)Reference2ShortLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1270 */         this.index--;
/* 1271 */         this.prev = (int)(Reference2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1272 */       else { this.next = (int)Reference2ShortLinkedOpenHashMap.this.link[this.curr]; }
/* 1273 */        Reference2ShortLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1276 */       if (this.prev == -1) { Reference2ShortLinkedOpenHashMap.this.first = this.next; }
/* 1277 */       else { Reference2ShortLinkedOpenHashMap.this.link[this.prev] = Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^ (Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1278 */        if (this.next == -1) { Reference2ShortLinkedOpenHashMap.this.last = this.prev; }
/* 1279 */       else { Reference2ShortLinkedOpenHashMap.this.link[this.next] = Reference2ShortLinkedOpenHashMap.this.link[this.next] ^ (Reference2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1280 */        int pos = this.curr;
/* 1281 */       this.curr = -1;
/* 1282 */       if (pos == Reference2ShortLinkedOpenHashMap.this.n) {
/* 1283 */         Reference2ShortLinkedOpenHashMap.this.containsNullKey = false;
/* 1284 */         Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1287 */         K[] key = Reference2ShortLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1290 */           pos = (last = pos) + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1292 */             if ((curr = key[pos]) == null) {
/* 1293 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1296 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ShortLinkedOpenHashMap.this.mask;
/* 1297 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1298 */               break;  pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1300 */           key[last] = curr;
/* 1301 */           Reference2ShortLinkedOpenHashMap.this.value[last] = Reference2ShortLinkedOpenHashMap.this.value[pos];
/* 1302 */           if (this.next == pos) this.next = last; 
/* 1303 */           if (this.prev == pos) this.prev = last; 
/* 1304 */           Reference2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ShortMap.Entry<K>>> implements ObjectListIterator<Reference2ShortMap.Entry<K>> {
...
/* 1343 */       action.accept(new Reference2ShortLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ShortLinkedOpenHashMap<K>.MapEntry next() {
/* 1348 */       return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ShortLinkedOpenHashMap<K>.MapEntry previous() {
/* 1353 */       return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2ShortMap.Entry<K>>> implements ObjectListIterator<Reference2ShortMap.Entry<K>> {
/* 1364 */     final Reference2ShortLinkedOpenHashMap<K>.MapEntry entry = new Reference2ShortLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1398 */       return new Reference2ShortLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1416 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ShortLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1441 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1442 */       return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ShortMap.Entry<K> last() {
/* 1447 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1448 */       return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1459 */       if (k == null) return (Reference2ShortLinkedOpenHashMap.this.containsNullKey && Reference2ShortLinkedOpenHashMap.this.value[Reference2ShortLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1461 */       K[] key = Reference2ShortLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1464 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ShortLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1465 */       if (k == curr) return (Reference2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1468 */         if ((curr = key[pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1469 */         if (k == curr) return (Reference2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1481 */       if (k == null) {
/* 1482 */         if (Reference2ShortLinkedOpenHashMap.this.containsNullKey && Reference2ShortLinkedOpenHashMap.this.value[Reference2ShortLinkedOpenHashMap.this.n] == v) {
/* 1483 */           Reference2ShortLinkedOpenHashMap.this.removeNullEntry();
/* 1484 */           return true;
/*      */         } 
/* 1486 */         return false;
/*      */       } 
/*      */       
/* 1489 */       K[] key = Reference2ShortLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1492 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ShortLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1493 */       if (curr == k) {
/* 1494 */         if (Reference2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1495 */           Reference2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1496 */           return true;
/*      */         } 
/* 1498 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1501 */         if ((curr = key[pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1502 */         if (curr == k && 
/* 1503 */           Reference2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Reference2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1513 */       return Reference2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1518 */       Reference2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1531 */       return new Reference2ShortLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1542 */       return new Reference2ShortLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1555 */       return new Reference2ShortLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
/* 1561 */       for (int i = Reference2ShortLinkedOpenHashMap.this.size, next = Reference2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1562 */         int curr = next;
/* 1563 */         next = (int)Reference2ShortLinkedOpenHashMap.this.link[curr];
/* 1564 */         consumer.accept(new Reference2ShortLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1571 */       Reference2ShortLinkedOpenHashMap<K>.MapEntry entry = new Reference2ShortLinkedOpenHashMap.MapEntry();
/* 1572 */       for (int i = Reference2ShortLinkedOpenHashMap.this.size, next = Reference2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         entry.index = next;
/* 1574 */         next = (int)Reference2ShortLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1601 */       return Reference2ShortLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1613 */       action.accept(Reference2ShortLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1618 */       return Reference2ShortLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1627 */       return new Reference2ShortLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1632 */       return new Reference2ShortLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1642 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ShortLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1648 */       for (int i = Reference2ShortLinkedOpenHashMap.this.size, next = Reference2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1649 */         int curr = next;
/* 1650 */         next = (int)Reference2ShortLinkedOpenHashMap.this.link[curr];
/* 1651 */         consumer.accept(Reference2ShortLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1657 */       return Reference2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1662 */       return Reference2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1667 */       int oldSize = Reference2ShortLinkedOpenHashMap.this.size;
/* 1668 */       Reference2ShortLinkedOpenHashMap.this.removeShort(k);
/* 1669 */       return (Reference2ShortLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1674 */       Reference2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1679 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1680 */       return Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1685 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1686 */       return Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1727 */       return Reference2ShortLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1739 */       action.accept(Reference2ShortLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1744 */       return Reference2ShortLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1755 */             return (ShortIterator)new Reference2ShortLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */             return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ShortLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1771 */             for (int i = Reference2ShortLinkedOpenHashMap.this.size, next = Reference2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1772 */               int curr = next;
/* 1773 */               next = (int)Reference2ShortLinkedOpenHashMap.this.link[curr];
/* 1774 */               consumer.accept(Reference2ShortLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1780 */             return Reference2ShortLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1785 */             return Reference2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1790 */             Reference2ShortLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1910 */       c = (Reference2ShortLinkedOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortLinkedOpenHashMap.class
