...
/* 201 */     return new ObjectArraySet<>((Object[])a);
/*     */   }
/*     */   
/*     */   private int findKey(Object o) {
/* 205 */     for (int i = this.size; i-- != 0;) { if (Objects.equals(this.a[i], o)) return i;  }
/* 206 */      return -1;
/*     */   }
/*     */ 
/*     */ 
...
/* 218 */           return (this.next < ObjectArraySet.this.size);
/*     */         }
/*     */ 
/*     */         
/*     */         public K next() {
/* 223 */           if (!hasNext()) throw new NoSuchElementException(); 
/* 224 */           return (K)ObjectArraySet.this.a[this.next++];
/*     */         }
/*     */ 
/*     */         
/*     */         public void remove() {
/* 229 */           int tail = ObjectArraySet.this.size-- - this.next--;
/* 230 */           System.arraycopy(ObjectArraySet.this.a, this.next + 1, ObjectArraySet.this.a, this.next, tail);
/* 231 */           ObjectArraySet.this.a[ObjectArraySet.this.size] = null;
/*     */         }
/*     */ 
/*     */         
/*     */         public int skip(int n) {
/* 236 */           if (n < 0) throw new IllegalArgumentException("Argument must be nonnegative: " + n); 
/* 237 */           int remaining = ObjectArraySet.this.size - this.next;
/* 238 */           if (n < remaining) {
/* 239 */             this.next += n;
/* 240 */             return n;
/*     */           } 
/* 242 */           n = remaining;
/* 243 */           this.next = ObjectArraySet.this.size;
/* 244 */           return n;
/*     */         }
/*     */       };
/*     */   }
...
/*     */     
/*     */     public Spliterator() {
/* 258 */       this(0, ObjectArraySet.this.size, false);
/*     */     }
/*     */     
...
/* 269 */       return this.hasSplit ? this.max : ObjectArraySet.this.size;
/*     */     }
/*     */ 
/*     */     
...
/* 286 */       action.accept((K)ObjectArraySet.this.a[this.pos++]);
/* 287 */       return true;
/*     */     }
/*     */ 
/*     */ 
...
/* 294 */         action.accept((K)ObjectArraySet.this.a[this.pos]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
...
/*     */     ObjectArraySet<K> c;
/*     */     try {
/* 431 */       c = (ObjectArraySet<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\ObjectArraySet.class
