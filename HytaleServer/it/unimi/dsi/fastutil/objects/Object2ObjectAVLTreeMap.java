...
/*  628 */     while (j-- != 0) {
/*  629 */       V ev = i.next();
/*  630 */       if (Objects.equals(ev, v)) return true; 
/*      */     } 
/*  632 */     return false;
/*      */   }
/*      */ 
...
/*  859 */       return (Objects.equals(this.key, e.getKey()) && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  864 */       return this.key.hashCode() ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  969 */       this.next = Object2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  973 */       if ((this.next = Object2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  974 */         if (Object2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1027 */       updatePrevious();
/* 1028 */       updateNext();
/* 1029 */       Object2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1030 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1084 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ObjectMap.Entry<Object2ObjectMap.Entry<K, V>, V>>()
/*      */         {
...
/* 1094 */             return new Object2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/* 1099 */             return new Object2ObjectAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1108 */             Object2ObjectAVLTreeMap.Entry<K, V> f = Object2ObjectAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1118 */             Object2ObjectAVLTreeMap.Entry<K, V> f = Object2ObjectAVLTreeMap.this.findKey((K)e.getKey());
/* 1119 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1120 */             Object2ObjectAVLTreeMap.this.remove(f.key);
/* 1121 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1126 */             return Object2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1131 */             Object2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ObjectMap.Entry<K, V> first() {
/* 1136 */             return Object2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ObjectMap.Entry<K, V> last() {
/* 1141 */             return Object2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) {
/* 1146 */             return Object2ObjectAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
/* 1151 */             return Object2ObjectAVLTreeMap.this.headMap(to.getKey()).object2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
/* 1156 */             return Object2ObjectAVLTreeMap.this.tailMap(from.getKey()).object2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1193 */       return new Object2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1198 */       return new Object2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1248 */     if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */         {
/*      */           public ObjectIterator<V> iterator() {
/* 1251 */             return new Object2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1256 */             return Object2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1261 */             return Object2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1266 */             Object2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1328 */       if (!bottom && !top && Object2ObjectAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1329 */       this.from = from;
/* 1330 */       this.bottom = bottom;
/* 1331 */       this.to = to;
/* 1332 */       this.top = top;
/* 1333 */       this.defRetValue = Object2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1352 */       return ((this.bottom || Object2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
/* 1357 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ObjectMap.Entry<Object2ObjectMap.Entry<K, V>, V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator() {
/* 1360 */               return new Object2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/* 1365 */               return new Object2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2ObjectMap.Entry<K, V>> comparator() {
/* 1370 */               return Object2ObjectAVLTreeMap.this.object2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1378 */               Object2ObjectAVLTreeMap.Entry<K, V> f = Object2ObjectAVLTreeMap.this.findKey((K)e.getKey());
/* 1379 */               return (f != null && Object2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1387 */               Object2ObjectAVLTreeMap.Entry<K, V> f = Object2ObjectAVLTreeMap.this.findKey((K)e.getKey());
/* 1388 */               if (f != null && Object2ObjectAVLTreeMap.Submap.this.in(f.key)) Object2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1389 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1401 */               return !(new Object2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1406 */               Object2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ObjectMap.Entry<K, V> first() {
/* 1411 */               return Object2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ObjectMap.Entry<K, V> last() {
/* 1416 */               return Object2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) {
/* 1421 */               return Object2ObjectAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) {
/* 1426 */               return Object2ObjectAVLTreeMap.Submap.this.headMap(to.getKey()).object2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) {
/* 1431 */               return Object2ObjectAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ObjectEntrySet();
/*      */             }
/*      */           }; 
/* 1434 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractObject2ObjectSortedMap<K, V>.KeySet { private KeySet() {}
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1440 */         return new Object2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1445 */         return new Object2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ObjectCollection<V> values() {
/* 1457 */       if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1460 */               return new Object2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1465 */               return Object2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1470 */               return Object2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1475 */               Object2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1485 */       return (in((K)k) && Object2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/* 1494 */         if (Objects.equals(ev, v)) return true; 
/*      */       } 
/* 1496 */       return false;
/*      */     }
/*      */ 
...
/*      */     
/*      */     public V get(Object k) {
/* 1503 */       K kk = (K)k; Object2ObjectAVLTreeMap.Entry<K, V> e;
/* 1504 */       return (in(kk) && (e = Object2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(K k, V v) {
/* 1509 */       Object2ObjectAVLTreeMap.this.modified = false;
...
/* 1511 */       V oldValue = Object2ObjectAVLTreeMap.this.put(k, v);
/* 1512 */       return Object2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(Object k) {
/* 1518 */       Object2ObjectAVLTreeMap.this.modified = false;
/* 1519 */       if (!in((K)k)) return this.defRetValue; 
/* 1520 */       V oldValue = (V)Object2ObjectAVLTreeMap.this.remove(k);
/* 1521 */       return Object2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1542 */       return Object2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectSortedMap<K, V> headMap(K to) {
/* 1547 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1548 */       return (Object2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectSortedMap<K, V> tailMap(K from) {
/* 1553 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1554 */       return (Object2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
/* 1559 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1560 */       if (!this.top) to = (Object2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1561 */       if (!this.bottom) from = (Object2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1572 */       if (Object2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1576 */       if (this.bottom) { e = Object2ObjectAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1578 */       { e = Object2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1580 */         if (Object2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1584 */       if (e == null || (!this.top && Object2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1585 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2ObjectAVLTreeMap.Entry<K, V> e;
/* 1594 */       if (Object2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1598 */       if (this.top) { e = Object2ObjectAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1600 */       { e = Object2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1602 */         if (Object2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1606 */       if (e == null || (!this.bottom && Object2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1607 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1612 */       Object2ObjectAVLTreeMap.Entry<K, V> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1619 */       Object2ObjectAVLTreeMap.Entry<K, V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1635 */         this.next = Object2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1639 */         this();
/* 1640 */         if (this.next != null) {
/* 1641 */           if (!Object2ObjectAVLTreeMap.Submap.this.bottom && Object2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1642 */           else if (!Object2ObjectAVLTreeMap.Submap.this.top && Object2ObjectAVLTreeMap.this.compare(k, (this.prev = Object2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1644 */           { this.next = Object2ObjectAVLTreeMap.this.locateKey(k);
/* 1645 */             if (Object2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1656 */         if (!Object2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Object2ObjectAVLTreeMap.this.compare(this.prev.key, Object2ObjectAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1661 */         this.next = this.next.next();
/* 1662 */         if (!Object2ObjectAVLTreeMap.Submap.this.top && this.next != null && Object2ObjectAVLTreeMap.this.compare(this.next.key, Object2ObjectAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1750 */       c = (Object2ObjectAVLTreeMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectAVLTreeMap.class
