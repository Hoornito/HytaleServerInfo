...
/*      */     
/*      */     public K getKey() {
/*  596 */       return Reference2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  601 */       return Reference2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  606 */       return Reference2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  611 */       return Reference2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  616 */       long oldValue = Reference2LongOpenHashMap.this.value[this.index];
/*  617 */       Reference2LongOpenHashMap.this.value[this.index] = v;
/*  618 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceLongPair<K> right(long v) {
/*  623 */       Reference2LongOpenHashMap.this.value[this.index] = v;
/*  624 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  635 */       return Long.valueOf(Reference2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  654 */       return (Reference2LongOpenHashMap.this.key[this.index] == e.getKey() && Reference2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  659 */       return System.identityHashCode(Reference2LongOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Reference2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  664 */       return (new StringBuilder()).append(Reference2LongOpenHashMap.this.key[this.index]).append("=>").append(Reference2LongOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  675 */     int pos = Reference2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  681 */     int last = -1;
/*      */     
/*  683 */     int c = Reference2LongOpenHashMap.this.size;
/*      */     
/*  685 */     boolean mustReturnNullKey = Reference2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  704 */         return this.last = Reference2LongOpenHashMap.this.n;
/*      */       } 
/*  706 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  708 */         if (--this.pos < 0) {
/*      */           
/*  710 */           this.last = Integer.MIN_VALUE;
/*  711 */           K k = this.wrapped.get(-this.pos - 1);
/*  712 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask;
/*  713 */           for (; k != key[p]; p = p + 1 & Reference2LongOpenHashMap.this.mask);
/*  714 */           return p;
/*      */         } 
...
/*  723 */         acceptOnIndex(action, this.last = Reference2LongOpenHashMap.this.n);
/*  724 */         this.c--;
/*      */       } 
/*  726 */       K[] key = Reference2LongOpenHashMap.this.key;
/*  727 */       while (this.c != 0) {
/*  728 */         if (--this.pos < 0) {
/*      */           
/*  730 */           this.last = Integer.MIN_VALUE;
/*  731 */           K k = this.wrapped.get(-this.pos - 1);
/*  732 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask;
/*  733 */           for (; k != key[p]; p = p + 1 & Reference2LongOpenHashMap.this.mask);
...
/*  753 */       K[] key = Reference2LongOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  755 */         pos = (last = pos) + 1 & Reference2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  757 */           if ((curr = key[pos]) == null) {
/*  758 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  761 */           int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2LongOpenHashMap.this.mask;
/*  762 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  763 */             break;  pos = pos + 1 & Reference2LongOpenHashMap.this.mask;
/*      */         } 
/*  765 */         if (pos < last) {
...
/*      */         } 
/*  769 */         key[last] = curr;
/*  770 */         Reference2LongOpenHashMap.this.value[last] = Reference2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  775 */       if (this.last == -1) throw new IllegalStateException(); 
/*  776 */       if (this.last == Reference2LongOpenHashMap.this.n)
/*  777 */       { Reference2LongOpenHashMap.this.containsNullKey = false;
/*  778 */         Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n] = null; }
/*  779 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  782 */       { Reference2LongOpenHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, null));
/*  783 */         this.last = -1;
/*      */         return; }
/*      */       
/*  786 */       Reference2LongOpenHashMap.this.size--;
/*  787 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2LongMap.Entry<K>>> implements ObjectIterator<Reference2LongMap.Entry<K>> { public Reference2LongOpenHashMap<K>.MapEntry next() {
/*  803 */       return this.entry = new Reference2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  809 */       action.accept(this.entry = new Reference2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  820 */       this.entry = new Reference2LongOpenHashMap.MapEntry();
/*      */     }
...
/*  841 */     int pos = 0;
/*      */     
/*  843 */     int max = Reference2LongOpenHashMap.this.n;
/*      */     
/*  845 */     int c = 0;
/*      */     
/*  847 */     boolean mustReturnNull = Reference2LongOpenHashMap.this.containsNullKey;
/*      */     
...
/*  867 */         this.c++;
/*  868 */         acceptOnIndex(action, Reference2LongOpenHashMap.this.n);
/*  869 */         return true;
/*      */       } 
/*  871 */       K[] key = Reference2LongOpenHashMap.this.key;
...
/*  886 */         this.c++;
/*  887 */         acceptOnIndex(action, Reference2LongOpenHashMap.this.n);
/*      */       } 
/*  889 */       K[] key = Reference2LongOpenHashMap.this.key;
...
/*      */       {
/*  902 */         return (Reference2LongOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  907 */       return Math.min((Reference2LongOpenHashMap.this.size - this.c), (long)(Reference2LongOpenHashMap.this.realSize() / Reference2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  935 */         n--;
/*      */       } 
/*  937 */       K[] key = Reference2LongOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2LongMap.Entry<K>> action, int index) {
/*  965 */       action.accept(new Reference2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  977 */       return new Reference2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2LongMap.Entry<K>> fastIterator() {
/*  982 */       return new Reference2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2LongMap.Entry<K>> spliterator() {
/*  987 */       return new Reference2LongOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  999 */       if (k == null) return (Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == v);
/*      */       
/* 1001 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1004 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask]) == null) return false; 
/* 1005 */       if (k == curr) return (Reference2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1008 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenHashMap.this.mask]) == null) return false; 
/* 1009 */         if (k == curr) return (Reference2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1021 */       if (k == null) {
/* 1022 */         if (Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == v) {
/* 1023 */           Reference2LongOpenHashMap.this.removeNullEntry();
/* 1024 */           return true;
/*      */         } 
/* 1026 */         return false;
/*      */       } 
/*      */       
/* 1029 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1032 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask]) == null) return false; 
/* 1033 */       if (curr == k) {
/* 1034 */         if (Reference2LongOpenHashMap.this.value[pos] == v) {
/* 1035 */           Reference2LongOpenHashMap.this.removeEntry(pos);
/* 1036 */           return true;
/*      */         } 
/* 1038 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1041 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenHashMap.this.mask]) == null) return false; 
/* 1042 */         if (curr == k && 
/* 1043 */           Reference2LongOpenHashMap.this.value[pos] == v) {
/* 1044 */           Reference2LongOpenHashMap.this.removeEntry(pos);
/* 1045 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1053 */       return Reference2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1058 */       Reference2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/* 1064 */       if (Reference2LongOpenHashMap.this.containsNullKey) consumer.accept(new Reference2LongOpenHashMap.MapEntry(Reference2LongOpenHashMap.this.n)); 
/* 1065 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenHashMap.this.key[pos] != null) consumer.accept(new Reference2LongOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/* 1071 */       Reference2LongOpenHashMap<K>.MapEntry entry = new Reference2LongOpenHashMap.MapEntry();
/* 1072 */       if (Reference2LongOpenHashMap.this.containsNullKey) {
/* 1073 */         entry.index = Reference2LongOpenHashMap.this.n;
/* 1074 */         consumer.accept(entry);
/*      */       } 
/* 1076 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenHashMap.this.key[pos] != null) {
...
/* 1107 */       action.accept(Reference2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1112 */       return Reference2LongOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1133 */       action.accept(Reference2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1145 */       return new Reference2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1150 */       return new Reference2LongOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1156 */       if (Reference2LongOpenHashMap.this.containsNullKey) consumer.accept(Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n]); 
/* 1157 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0; ) {
/* 1158 */         K k = Reference2LongOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1165 */       return Reference2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1170 */       return Reference2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1175 */       int oldSize = Reference2LongOpenHashMap.this.size;
/* 1176 */       Reference2LongOpenHashMap.this.removeLong(k);
/* 1177 */       return (Reference2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1182 */       Reference2LongOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1210 */       action.accept(Reference2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1215 */       return Reference2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1236 */       action.accept(Reference2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1250 */             return new Reference2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1255 */             return new Reference2LongOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1261 */             if (Reference2LongOpenHashMap.this.containsNullKey) consumer.accept(Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n]); 
/* 1262 */             for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenHashMap.this.key[pos] != null) consumer.accept(Reference2LongOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1267 */             return Reference2LongOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1272 */             return Reference2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1277 */             Reference2LongOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1375 */       c = (Reference2LongOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongOpenHashMap.class
