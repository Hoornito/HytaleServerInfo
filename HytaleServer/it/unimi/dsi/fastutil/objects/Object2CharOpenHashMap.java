...
/*      */     
/*      */     public K getKey() {
/*  597 */       return Object2CharOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  602 */       return Object2CharOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  607 */       return Object2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  612 */       return Object2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  617 */       char oldValue = Object2CharOpenHashMap.this.value[this.index];
/*  618 */       Object2CharOpenHashMap.this.value[this.index] = v;
/*  619 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectCharPair<K> right(char v) {
/*  624 */       Object2CharOpenHashMap.this.value[this.index] = v;
/*  625 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  636 */       return Character.valueOf(Object2CharOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  655 */       return (Objects.equals(Object2CharOpenHashMap.this.key[this.index], e.getKey()) && Object2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  660 */       return ((Object2CharOpenHashMap.this.key[this.index] == null) ? 0 : Object2CharOpenHashMap.this.key[this.index].hashCode()) ^ Object2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  665 */       return (new StringBuilder()).append(Object2CharOpenHashMap.this.key[this.index]).append("=>").append(Object2CharOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  676 */     int pos = Object2CharOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  682 */     int last = -1;
/*      */     
/*  684 */     int c = Object2CharOpenHashMap.this.size;
/*      */     
/*  686 */     boolean mustReturnNullKey = Object2CharOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  705 */         return this.last = Object2CharOpenHashMap.this.n;
/*      */       } 
/*  707 */       K[] key = Object2CharOpenHashMap.this.key;
/*      */       while (true) {
/*  709 */         if (--this.pos < 0) {
/*      */           
/*  711 */           this.last = Integer.MIN_VALUE;
/*  712 */           K k = this.wrapped.get(-this.pos - 1);
/*  713 */           int p = HashCommon.mix(k.hashCode()) & Object2CharOpenHashMap.this.mask;
/*  714 */           for (; !k.equals(key[p]); p = p + 1 & Object2CharOpenHashMap.this.mask);
/*  715 */           return p;
/*      */         } 
...
/*  724 */         acceptOnIndex(action, this.last = Object2CharOpenHashMap.this.n);
/*  725 */         this.c--;
/*      */       } 
/*  727 */       K[] key = Object2CharOpenHashMap.this.key;
/*  728 */       while (this.c != 0) {
/*  729 */         if (--this.pos < 0) {
/*      */           
/*  731 */           this.last = Integer.MIN_VALUE;
/*  732 */           K k = this.wrapped.get(-this.pos - 1);
/*  733 */           int p = HashCommon.mix(k.hashCode()) & Object2CharOpenHashMap.this.mask;
/*  734 */           for (; !k.equals(key[p]); p = p + 1 & Object2CharOpenHashMap.this.mask);
...
/*  754 */       K[] key = Object2CharOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  756 */         pos = (last = pos) + 1 & Object2CharOpenHashMap.this.mask;
/*      */         while (true) {
/*  758 */           if ((curr = key[pos]) == null) {
/*  759 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  762 */           int slot = HashCommon.mix(curr.hashCode()) & Object2CharOpenHashMap.this.mask;
/*  763 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  764 */             break;  pos = pos + 1 & Object2CharOpenHashMap.this.mask;
/*      */         } 
/*  766 */         if (pos < last) {
...
/*      */         } 
/*  770 */         key[last] = curr;
/*  771 */         Object2CharOpenHashMap.this.value[last] = Object2CharOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  776 */       if (this.last == -1) throw new IllegalStateException(); 
/*  777 */       if (this.last == Object2CharOpenHashMap.this.n)
/*  778 */       { Object2CharOpenHashMap.this.containsNullKey = false;
/*  779 */         Object2CharOpenHashMap.this.key[Object2CharOpenHashMap.this.n] = null; }
/*  780 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  783 */       { Object2CharOpenHashMap.this.removeChar(this.wrapped.set(-this.pos - 1, null));
/*  784 */         this.last = -1;
/*      */         return; }
/*      */       
/*  787 */       Object2CharOpenHashMap.this.size--;
/*  788 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2CharMap.Entry<K>>> implements ObjectIterator<Object2CharMap.Entry<K>> { public Object2CharOpenHashMap<K>.MapEntry next() {
/*  804 */       return this.entry = new Object2CharOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  810 */       action.accept(this.entry = new Object2CharOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  821 */       this.entry = new Object2CharOpenHashMap.MapEntry();
/*      */     }
...
/*  842 */     int pos = 0;
/*      */     
/*  844 */     int max = Object2CharOpenHashMap.this.n;
/*      */     
/*  846 */     int c = 0;
/*      */     
/*  848 */     boolean mustReturnNull = Object2CharOpenHashMap.this.containsNullKey;
/*      */     
...
/*  868 */         this.c++;
/*  869 */         acceptOnIndex(action, Object2CharOpenHashMap.this.n);
/*  870 */         return true;
/*      */       } 
/*  872 */       K[] key = Object2CharOpenHashMap.this.key;
...
/*  887 */         this.c++;
/*  888 */         acceptOnIndex(action, Object2CharOpenHashMap.this.n);
/*      */       } 
/*  890 */       K[] key = Object2CharOpenHashMap.this.key;
...
/*      */       {
/*  903 */         return (Object2CharOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  908 */       return Math.min((Object2CharOpenHashMap.this.size - this.c), (long)(Object2CharOpenHashMap.this.realSize() / Object2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  936 */         n--;
/*      */       } 
/*  938 */       K[] key = Object2CharOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Object2CharMap.Entry<K>> action, int index) {
/*  966 */       action.accept(new Object2CharOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  978 */       return new Object2CharOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Object2CharMap.Entry<K>> fastIterator() {
/*  983 */       return new Object2CharOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Object2CharMap.Entry<K>> spliterator() {
/*  988 */       return new Object2CharOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1000 */       if (k == null) return (Object2CharOpenHashMap.this.containsNullKey && Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n] == v);
/*      */       
/* 1002 */       K[] key = Object2CharOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1005 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2CharOpenHashMap.this.mask]) == null) return false; 
/* 1006 */       if (k.equals(curr)) return (Object2CharOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1009 */         if ((curr = key[pos = pos + 1 & Object2CharOpenHashMap.this.mask]) == null) return false; 
/* 1010 */         if (k.equals(curr)) return (Object2CharOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1022 */       if (k == null) {
/* 1023 */         if (Object2CharOpenHashMap.this.containsNullKey && Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n] == v) {
/* 1024 */           Object2CharOpenHashMap.this.removeNullEntry();
/* 1025 */           return true;
/*      */         } 
/* 1027 */         return false;
/*      */       } 
/*      */       
/* 1030 */       K[] key = Object2CharOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1033 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2CharOpenHashMap.this.mask]) == null) return false; 
/* 1034 */       if (curr.equals(k)) {
/* 1035 */         if (Object2CharOpenHashMap.this.value[pos] == v) {
/* 1036 */           Object2CharOpenHashMap.this.removeEntry(pos);
/* 1037 */           return true;
/*      */         } 
/* 1039 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1042 */         if ((curr = key[pos = pos + 1 & Object2CharOpenHashMap.this.mask]) == null) return false; 
/* 1043 */         if (curr.equals(k) && 
/* 1044 */           Object2CharOpenHashMap.this.value[pos] == v) {
/* 1045 */           Object2CharOpenHashMap.this.removeEntry(pos);
/* 1046 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1054 */       return Object2CharOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1059 */       Object2CharOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
/* 1065 */       if (Object2CharOpenHashMap.this.containsNullKey) consumer.accept(new Object2CharOpenHashMap.MapEntry(Object2CharOpenHashMap.this.n)); 
/* 1066 */       for (int pos = Object2CharOpenHashMap.this.n; pos-- != 0;) { if (Object2CharOpenHashMap.this.key[pos] != null) consumer.accept(new Object2CharOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
/* 1072 */       Object2CharOpenHashMap<K>.MapEntry entry = new Object2CharOpenHashMap.MapEntry();
/* 1073 */       if (Object2CharOpenHashMap.this.containsNullKey) {
/* 1074 */         entry.index = Object2CharOpenHashMap.this.n;
/* 1075 */         consumer.accept(entry);
/*      */       } 
/* 1077 */       for (int pos = Object2CharOpenHashMap.this.n; pos-- != 0;) { if (Object2CharOpenHashMap.this.key[pos] != null) {
...
/* 1108 */       action.accept(Object2CharOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1113 */       return Object2CharOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1134 */       action.accept(Object2CharOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1146 */       return new Object2CharOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1151 */       return new Object2CharOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1157 */       if (Object2CharOpenHashMap.this.containsNullKey) consumer.accept(Object2CharOpenHashMap.this.key[Object2CharOpenHashMap.this.n]); 
/* 1158 */       for (int pos = Object2CharOpenHashMap.this.n; pos-- != 0; ) {
/* 1159 */         K k = Object2CharOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1166 */       return Object2CharOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1171 */       return Object2CharOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1176 */       int oldSize = Object2CharOpenHashMap.this.size;
/* 1177 */       Object2CharOpenHashMap.this.removeChar(k);
/* 1178 */       return (Object2CharOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1183 */       Object2CharOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1211 */       action.accept(Object2CharOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1216 */       return Object2CharOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1237 */       action.accept(Object2CharOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1251 */             return new Object2CharOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public CharSpliterator spliterator() {
/* 1256 */             return new Object2CharOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1262 */             if (Object2CharOpenHashMap.this.containsNullKey) consumer.accept(Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n]); 
/* 1263 */             for (int pos = Object2CharOpenHashMap.this.n; pos-- != 0;) { if (Object2CharOpenHashMap.this.key[pos] != null) consumer.accept(Object2CharOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Object2CharOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1273 */             return Object2CharOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1278 */             Object2CharOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1376 */       c = (Object2CharOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2CharOpenHashMap.class
