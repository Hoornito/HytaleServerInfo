...
/*  107 */     this.value = new long[this.n + 1];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  233 */     long oldValue = this.value[pos];
/*  234 */     this.size--;
/*  235 */     shiftKeys(pos);
...
/*  243 */     long oldValue = this.value[this.n];
/*  244 */     this.size--;
...
/*  294 */     long oldValue = this.value[pos];
...
/*  504 */     long newValue = mappingFunction.applyAsLong(k);
...
/*  516 */     long newValue = mappingFunction.getLong(key);
...
/*  527 */     Long newValue = remappingFunction.apply(k, Long.valueOf(this.value[pos]));
...
/*      */     } 
/*  533 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  540 */     int pos = find(k);
/*  541 */     Long newValue = remappingFunction.apply(k, (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  549 */     long newVal = newValue.longValue();
/*  550 */     if (pos < 0) {
...
/*  566 */        return v;
/*      */     } 
/*  568 */     Long newValue = remappingFunction.apply(Long.valueOf(this.value[pos]), Long.valueOf(v));
...
/*      */     } 
/*  574 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     implements Reference2LongMap.Entry<K>, Map.Entry<K, Long>, ReferenceLongPair<K>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  619 */       return Reference2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  624 */       return Reference2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  629 */       return Reference2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  634 */       return Reference2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  639 */       long oldValue = Reference2LongOpenCustomHashMap.this.value[this.index];
/*  640 */       Reference2LongOpenCustomHashMap.this.value[this.index] = v;
/*  641 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceLongPair<K> right(long v) {
/*  646 */       Reference2LongOpenCustomHashMap.this.value[this.index] = v;
/*  647 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  658 */       return Long.valueOf(Reference2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long setValue(Long v) {
/*  669 */       return Long.valueOf(setValue(v.longValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  676 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  677 */       return (Reference2LongOpenCustomHashMap.this.strategy.equals(Reference2LongOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  682 */       return Reference2LongOpenCustomHashMap.this.strategy.hashCode(Reference2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Reference2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  687 */       return (new StringBuilder()).append(Reference2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2LongOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  698 */     int pos = Reference2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  704 */     int last = -1;
/*      */     
/*  706 */     int c = Reference2LongOpenCustomHashMap.this.size;
/*      */     
/*  708 */     boolean mustReturnNullKey = Reference2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  727 */         return this.last = Reference2LongOpenCustomHashMap.this.n;
/*      */       } 
/*  729 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  731 */         if (--this.pos < 0) {
/*      */           
/*  733 */           this.last = Integer.MIN_VALUE;
/*  734 */           K k = this.wrapped.get(-this.pos - 1);
/*  735 */           int p = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2LongOpenCustomHashMap.this.mask;
/*  736 */           for (; !Reference2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2LongOpenCustomHashMap.this.mask);
/*  737 */           return p;
/*      */         } 
...
/*  746 */         acceptOnIndex(action, this.last = Reference2LongOpenCustomHashMap.this.n);
/*  747 */         this.c--;
/*      */       } 
...
/*  756 */           for (; !Reference2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2LongOpenCustomHashMap.this.mask);
...
/*  776 */       K[] key = Reference2LongOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  778 */         pos = (last = pos) + 1 & Reference2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  780 */           if ((curr = key[pos]) == null) {
/*  781 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  784 */           int slot = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2LongOpenCustomHashMap.this.mask;
/*  785 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  786 */             break;  pos = pos + 1 & Reference2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  788 */         if (pos < last) {
...
/*      */         } 
/*  792 */         key[last] = curr;
/*  793 */         Reference2LongOpenCustomHashMap.this.value[last] = Reference2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  798 */       if (this.last == -1) throw new IllegalStateException(); 
/*  799 */       if (this.last == Reference2LongOpenCustomHashMap.this.n)
/*  800 */       { Reference2LongOpenCustomHashMap.this.containsNullKey = false;
/*  801 */         Reference2LongOpenCustomHashMap.this.key[Reference2LongOpenCustomHashMap.this.n] = null; }
/*  802 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  805 */       { Reference2LongOpenCustomHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, null));
/*  806 */         this.last = -1;
/*      */         return; }
/*      */       
/*  809 */       Reference2LongOpenCustomHashMap.this.size--;
/*  810 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2LongMap.Entry<K>>> implements ObjectIterator<Reference2LongMap.Entry<K>> { public Reference2LongOpenCustomHashMap<K>.MapEntry next() {
/*  826 */       return this.entry = new Reference2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  832 */       action.accept(this.entry = new Reference2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2LongMap.Entry<K>>> implements ObjectIterator<Reference2LongMap.Entry<K>> {
/*      */     private FastEntryIterator() {
/*  843 */       this.entry = new Reference2LongOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  864 */     int pos = 0;
/*      */     
/*  866 */     int max = Reference2LongOpenCustomHashMap.this.n;
/*      */     
/*  868 */     int c = 0;
/*      */     
/*  870 */     boolean mustReturnNull = Reference2LongOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  890 */         this.c++;
/*  891 */         acceptOnIndex(action, Reference2LongOpenCustomHashMap.this.n);
/*  892 */         return true;
/*      */       } 
/*  894 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
...
/*  909 */         this.c++;
/*  910 */         acceptOnIndex(action, Reference2LongOpenCustomHashMap.this.n);
/*      */       } 
/*  912 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
...
/*      */       {
/*  925 */         return (Reference2LongOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  930 */       return Math.min((Reference2LongOpenCustomHashMap.this.size - this.c), (long)(Reference2LongOpenCustomHashMap.this.realSize() / Reference2LongOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  958 */         n--;
/*      */       } 
/*  960 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Reference2LongMap.Entry<K>>, EntrySpliterator> implements ObjectSpliterator<Reference2LongMap.Entry<K>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2LongMap.Entry<K>> action, int index) {
/*  988 */       action.accept(new Reference2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1000 */       return new Reference2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2LongMap.Entry<K>> fastIterator() {
/* 1005 */       return new Reference2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2LongMap.Entry<K>> spliterator() {
/* 1010 */       return new Reference2LongOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1019 */       if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1020 */       K k = (K)e.getKey();
/* 1021 */       long v = ((Long)e.getValue()).longValue();
/* 1022 */       if (Reference2LongOpenCustomHashMap.this.strategy.equals(k, null)) return (Reference2LongOpenCustomHashMap.this.containsNullKey && Reference2LongOpenCustomHashMap.this.value[Reference2LongOpenCustomHashMap.this.n] == v);
/*      */       
/* 1024 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1027 */       if ((curr = key[pos = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2LongOpenCustomHashMap.this.mask]) == null) return false; 
/* 1028 */       if (Reference2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1031 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenCustomHashMap.this.mask]) == null) return false; 
/* 1032 */         if (Reference2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1041 */       if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1042 */       K k = (K)e.getKey();
/* 1043 */       long v = ((Long)e.getValue()).longValue();
/* 1044 */       if (Reference2LongOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1045 */         if (Reference2LongOpenCustomHashMap.this.containsNullKey && Reference2LongOpenCustomHashMap.this.value[Reference2LongOpenCustomHashMap.this.n] == v) {
/* 1046 */           Reference2LongOpenCustomHashMap.this.removeNullEntry();
/* 1047 */           return true;
/*      */         } 
/* 1049 */         return false;
/*      */       } 
/*      */       
/* 1052 */       K[] key = Reference2LongOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1055 */       if ((curr = key[pos = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2LongOpenCustomHashMap.this.mask]) == null) return false; 
/* 1056 */       if (Reference2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1057 */         if (Reference2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1058 */           Reference2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1059 */           return true;
/*      */         } 
/* 1061 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1064 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenCustomHashMap.this.mask]) == null) return false; 
/* 1065 */         if (Reference2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1066 */           Reference2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1067 */           Reference2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1068 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1076 */       return Reference2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1081 */       Reference2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/* 1087 */       if (Reference2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(new Reference2LongOpenCustomHashMap.MapEntry(Reference2LongOpenCustomHashMap.this.n)); 
/* 1088 */       for (int pos = Reference2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Reference2LongOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/* 1094 */       Reference2LongOpenCustomHashMap<K>.MapEntry entry = new Reference2LongOpenCustomHashMap.MapEntry();
/* 1095 */       if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
/* 1096 */         entry.index = Reference2LongOpenCustomHashMap.this.n;
/* 1097 */         consumer.accept(entry);
/*      */       } 
/* 1099 */       for (int pos = Reference2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenCustomHashMap.this.key[pos] != null) {
...
/* 1130 */       action.accept(Reference2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1135 */       return Reference2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1156 */       action.accept(Reference2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1168 */       return new Reference2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1173 */       return new Reference2LongOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1179 */       if (Reference2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2LongOpenCustomHashMap.this.key[Reference2LongOpenCustomHashMap.this.n]); 
/* 1180 */       for (int pos = Reference2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1181 */         K k = Reference2LongOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1188 */       return Reference2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1193 */       return Reference2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1198 */       int oldSize = Reference2LongOpenCustomHashMap.this.size;
/* 1199 */       Reference2LongOpenCustomHashMap.this.removeLong(k);
/* 1200 */       return (Reference2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1205 */       Reference2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1233 */       action.accept(Reference2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1238 */       return Reference2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1259 */       action.accept(Reference2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1270 */     if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1273 */             return new Reference2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1278 */             return new Reference2LongOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1284 */             if (Reference2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2LongOpenCustomHashMap.this.value[Reference2LongOpenCustomHashMap.this.n]); 
/* 1285 */             for (int pos = Reference2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2LongOpenCustomHashMap.this.key[pos] != null) consumer.accept(Reference2LongOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1290 */             return Reference2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1295 */             return Reference2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1300 */             Reference2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1364 */     K[] key = this.key;
/* 1365 */     long[] value = this.value;
/* 1366 */     int mask = newN - 1;
/* 1367 */     K[] newKey = (K[])new Object[newN + 1];
/* 1368 */     long[] newValue = new long[newN + 1];
/* 1369 */     int i = this.n;
...
/*      */     try {
/* 1398 */       c = (Reference2LongOpenCustomHashMap<K>)super.clone();
...
/* 1407 */     c.value = (long[])this.value.clone();
...
/* 1427 */       t ^= HashCommon.long2int(this.value[i]);
/* 1428 */       h += t;
/* 1429 */       i++;
/*      */     } 
/*      */     
/* 1432 */     if (this.containsNullKey) h += HashCommon.long2int(this.value[this.n]); 
/* 1433 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1437 */     K[] key = this.key;
/* 1438 */     long[] value = this.value;
...
/* 1455 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1458 */     for (int i = this.size; i-- != 0; ) {
/* 1459 */       int pos; K k = (K)s.readObject();
/* 1460 */       long v = s.readLong();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongOpenCustomHashMap.class
