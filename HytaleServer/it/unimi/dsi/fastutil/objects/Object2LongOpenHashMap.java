...
/*  102 */     this.value = new long[this.n + 1];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  210 */     long oldValue = this.value[pos];
/*  211 */     this.size--;
/*  212 */     shiftKeys(pos);
...
/*  220 */     long oldValue = this.value[this.n];
/*  221 */     this.size--;
...
/*      */     } 
/*  265 */     long oldValue = this.value[pos];
/*  266 */     this.value[pos] = v;
/*  267 */     return oldValue;
/*      */   }
/*      */   
/*      */   private long addToValue(int pos, long incr) {
/*  271 */     long oldValue = this.value[pos];
...
/*  443 */     if (k.equals(curr) && v == this.value[pos]) {
/*  444 */       removeEntry(pos);
/*  445 */       return true;
/*      */     } 
/*      */     while (true) {
/*  448 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  449 */       if (k.equals(curr) && v == this.value[pos]) {
/*  450 */         removeEntry(pos);
/*  451 */         return true;
/*      */       } 
/*      */     } 
...
/*  470 */     long oldValue = this.value[pos];
...
/*  481 */     long newValue = mappingFunction.applyAsLong(k);
...
/*  493 */     long newValue = mappingFunction.getLong(key);
...
/*  504 */     Long newValue = remappingFunction.apply(k, Long.valueOf(this.value[pos]));
/*  505 */     if (newValue == null) {
/*  506 */       if (k == null) { removeNullEntry(); }
/*  507 */       else { removeEntry(pos); }
/*  508 */        return this.defRetValue;
/*      */     } 
/*  510 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  517 */     int pos = find(k);
/*  518 */     Long newValue = remappingFunction.apply(k, (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  526 */     long newVal = newValue.longValue();
/*  527 */     if (pos < 0) {
...
/*  543 */        return v;
/*      */     } 
/*  545 */     Long newValue = remappingFunction.apply(Long.valueOf(this.value[pos]), Long.valueOf(v));
/*  546 */     if (newValue == null) {
/*  547 */       if (k == null) { removeNullEntry(); }
/*  548 */       else { removeEntry(pos); }
/*  549 */        return this.defRetValue;
/*      */     } 
/*  551 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  596 */       return Object2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  601 */       return Object2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  606 */       return Object2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  611 */       return Object2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  616 */       long oldValue = Object2LongOpenHashMap.this.value[this.index];
/*  617 */       Object2LongOpenHashMap.this.value[this.index] = v;
/*  618 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectLongPair<K> right(long v) {
/*  623 */       Object2LongOpenHashMap.this.value[this.index] = v;
/*  624 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  635 */       return Long.valueOf(Object2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long setValue(Long v) {
/*  646 */       return Long.valueOf(setValue(v.longValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  653 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  654 */       return (Objects.equals(Object2LongOpenHashMap.this.key[this.index], e.getKey()) && Object2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  659 */       return ((Object2LongOpenHashMap.this.key[this.index] == null) ? 0 : Object2LongOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.long2int(Object2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  664 */       return (new StringBuilder()).append(Object2LongOpenHashMap.this.key[this.index]).append("=>").append(Object2LongOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  675 */     int pos = Object2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  681 */     int last = -1;
/*      */     
/*  683 */     int c = Object2LongOpenHashMap.this.size;
/*      */     
/*  685 */     boolean mustReturnNullKey = Object2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  704 */         return this.last = Object2LongOpenHashMap.this.n;
/*      */       } 
/*  706 */       K[] key = Object2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  708 */         if (--this.pos < 0) {
/*      */           
/*  710 */           this.last = Integer.MIN_VALUE;
/*  711 */           K k = this.wrapped.get(-this.pos - 1);
/*  712 */           int p = HashCommon.mix(k.hashCode()) & Object2LongOpenHashMap.this.mask;
/*  713 */           for (; !k.equals(key[p]); p = p + 1 & Object2LongOpenHashMap.this.mask);
/*  714 */           return p;
/*      */         } 
...
/*  723 */         acceptOnIndex(action, this.last = Object2LongOpenHashMap.this.n);
/*  724 */         this.c--;
/*      */       } 
/*  726 */       K[] key = Object2LongOpenHashMap.this.key;
/*  727 */       while (this.c != 0) {
/*  728 */         if (--this.pos < 0) {
/*      */           
/*  730 */           this.last = Integer.MIN_VALUE;
/*  731 */           K k = this.wrapped.get(-this.pos - 1);
/*  732 */           int p = HashCommon.mix(k.hashCode()) & Object2LongOpenHashMap.this.mask;
/*  733 */           for (; !k.equals(key[p]); p = p + 1 & Object2LongOpenHashMap.this.mask);
...
/*  753 */       K[] key = Object2LongOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  755 */         pos = (last = pos) + 1 & Object2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  757 */           if ((curr = key[pos]) == null) {
/*  758 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  761 */           int slot = HashCommon.mix(curr.hashCode()) & Object2LongOpenHashMap.this.mask;
/*  762 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  763 */             break;  pos = pos + 1 & Object2LongOpenHashMap.this.mask;
/*      */         } 
/*  765 */         if (pos < last) {
...
/*      */         } 
/*  769 */         key[last] = curr;
/*  770 */         Object2LongOpenHashMap.this.value[last] = Object2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  775 */       if (this.last == -1) throw new IllegalStateException(); 
/*  776 */       if (this.last == Object2LongOpenHashMap.this.n)
/*  777 */       { Object2LongOpenHashMap.this.containsNullKey = false;
/*  778 */         Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n] = null; }
/*  779 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  782 */       { Object2LongOpenHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, null));
/*  783 */         this.last = -1;
/*      */         return; }
/*      */       
/*  786 */       Object2LongOpenHashMap.this.size--;
/*  787 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2LongMap.Entry<K>>> implements ObjectIterator<Object2LongMap.Entry<K>> { public Object2LongOpenHashMap<K>.MapEntry next() {
/*  803 */       return this.entry = new Object2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  809 */       action.accept(this.entry = new Object2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Object2LongMap.Entry<K>>> implements ObjectIterator<Object2LongMap.Entry<K>> {
/*      */     private FastEntryIterator() {
/*  820 */       this.entry = new Object2LongOpenHashMap.MapEntry();
/*      */     }
...
/*  841 */     int pos = 0;
/*      */     
/*  843 */     int max = Object2LongOpenHashMap.this.n;
/*      */     
/*  845 */     int c = 0;
/*      */     
/*  847 */     boolean mustReturnNull = Object2LongOpenHashMap.this.containsNullKey;
/*      */     
...
/*  867 */         this.c++;
/*  868 */         acceptOnIndex(action, Object2LongOpenHashMap.this.n);
/*  869 */         return true;
/*      */       } 
/*  871 */       K[] key = Object2LongOpenHashMap.this.key;
...
/*  886 */         this.c++;
/*  887 */         acceptOnIndex(action, Object2LongOpenHashMap.this.n);
/*      */       } 
/*  889 */       K[] key = Object2LongOpenHashMap.this.key;
...
/*      */       {
/*  902 */         return (Object2LongOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  907 */       return Math.min((Object2LongOpenHashMap.this.size - this.c), (long)(Object2LongOpenHashMap.this.realSize() / Object2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  935 */         n--;
/*      */       } 
/*  937 */       K[] key = Object2LongOpenHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Object2LongMap.Entry<K>>, EntrySpliterator> implements ObjectSpliterator<Object2LongMap.Entry<K>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Object2LongMap.Entry<K>> action, int index) {
/*  965 */       action.accept(new Object2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  977 */       return new Object2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Object2LongMap.Entry<K>> fastIterator() {
/*  982 */       return new Object2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Object2LongMap.Entry<K>> spliterator() {
/*  987 */       return new Object2LongOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/*  997 */       K k = (K)e.getKey();
/*  998 */       long v = ((Long)e.getValue()).longValue();
/*  999 */       if (k == null) return (Object2LongOpenHashMap.this.containsNullKey && Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n] == v);
/*      */       
/* 1001 */       K[] key = Object2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1004 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2LongOpenHashMap.this.mask]) == null) return false; 
/* 1005 */       if (k.equals(curr)) return (Object2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1008 */         if ((curr = key[pos = pos + 1 & Object2LongOpenHashMap.this.mask]) == null) return false; 
/* 1009 */         if (k.equals(curr)) return (Object2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1018 */       if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1019 */       K k = (K)e.getKey();
/* 1020 */       long v = ((Long)e.getValue()).longValue();
/* 1021 */       if (k == null) {
/* 1022 */         if (Object2LongOpenHashMap.this.containsNullKey && Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n] == v) {
/* 1023 */           Object2LongOpenHashMap.this.removeNullEntry();
/* 1024 */           return true;
/*      */         } 
/* 1026 */         return false;
/*      */       } 
/*      */       
/* 1029 */       K[] key = Object2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1032 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2LongOpenHashMap.this.mask]) == null) return false; 
/* 1033 */       if (curr.equals(k)) {
/* 1034 */         if (Object2LongOpenHashMap.this.value[pos] == v) {
/* 1035 */           Object2LongOpenHashMap.this.removeEntry(pos);
/* 1036 */           return true;
/*      */         } 
/* 1038 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1041 */         if ((curr = key[pos = pos + 1 & Object2LongOpenHashMap.this.mask]) == null) return false; 
/* 1042 */         if (curr.equals(k) && 
/* 1043 */           Object2LongOpenHashMap.this.value[pos] == v) {
/* 1044 */           Object2LongOpenHashMap.this.removeEntry(pos);
/* 1045 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1053 */       return Object2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1058 */       Object2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
/* 1064 */       if (Object2LongOpenHashMap.this.containsNullKey) consumer.accept(new Object2LongOpenHashMap.MapEntry(Object2LongOpenHashMap.this.n)); 
/* 1065 */       for (int pos = Object2LongOpenHashMap.this.n; pos-- != 0;) { if (Object2LongOpenHashMap.this.key[pos] != null) consumer.accept(new Object2LongOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
/* 1071 */       Object2LongOpenHashMap<K>.MapEntry entry = new Object2LongOpenHashMap.MapEntry();
/* 1072 */       if (Object2LongOpenHashMap.this.containsNullKey) {
/* 1073 */         entry.index = Object2LongOpenHashMap.this.n;
/* 1074 */         consumer.accept(entry);
/*      */       } 
/* 1076 */       for (int pos = Object2LongOpenHashMap.this.n; pos-- != 0;) { if (Object2LongOpenHashMap.this.key[pos] != null) {
...
/* 1107 */       action.accept(Object2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1112 */       return Object2LongOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1133 */       action.accept(Object2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1145 */       return new Object2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1150 */       return new Object2LongOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1156 */       if (Object2LongOpenHashMap.this.containsNullKey) consumer.accept(Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n]); 
/* 1157 */       for (int pos = Object2LongOpenHashMap.this.n; pos-- != 0; ) {
/* 1158 */         K k = Object2LongOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1165 */       return Object2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1170 */       return Object2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1175 */       int oldSize = Object2LongOpenHashMap.this.size;
/* 1176 */       Object2LongOpenHashMap.this.removeLong(k);
/* 1177 */       return (Object2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1182 */       Object2LongOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1210 */       action.accept(Object2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1215 */       return Object2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1236 */       action.accept(Object2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1247 */     if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1250 */             return new Object2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1255 */             return new Object2LongOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1261 */             if (Object2LongOpenHashMap.this.containsNullKey) consumer.accept(Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n]); 
/* 1262 */             for (int pos = Object2LongOpenHashMap.this.n; pos-- != 0;) { if (Object2LongOpenHashMap.this.key[pos] != null) consumer.accept(Object2LongOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1267 */             return Object2LongOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1272 */             return Object2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1277 */             Object2LongOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1341 */     K[] key = this.key;
/* 1342 */     long[] value = this.value;
/* 1343 */     int mask = newN - 1;
/* 1344 */     K[] newKey = (K[])new Object[newN + 1];
/* 1345 */     long[] newValue = new long[newN + 1];
/* 1346 */     int i = this.n;
...
/*      */     try {
/* 1375 */       c = (Object2LongOpenHashMap<K>)super.clone();
...
/* 1384 */     c.value = (long[])this.value.clone();
/* 1385 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1403 */       t ^= HashCommon.long2int(this.value[i]);
/* 1404 */       h += t;
/* 1405 */       i++;
/*      */     } 
/*      */     
/* 1408 */     if (this.containsNullKey) h += HashCommon.long2int(this.value[this.n]); 
/* 1409 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1413 */     K[] key = this.key;
/* 1414 */     long[] value = this.value;
...
/* 1431 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1434 */     for (int i = this.size; i-- != 0; ) {
/* 1435 */       int pos; K k = (K)s.readObject();
/* 1436 */       long v = s.readLong();
/* 1437 */       if (k == null) {
/* 1438 */         pos = this.n;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2LongOpenHashMap.class
