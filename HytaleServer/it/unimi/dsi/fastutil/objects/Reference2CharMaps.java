...
/*  44 */     ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  45 */     return (entries instanceof Reference2CharMap.FastEntrySet) ? ((Reference2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  61 */     if (entries instanceof Reference2CharMap.FastEntrySet) { ((Reference2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  77 */     final ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  78 */     return (entries instanceof Reference2CharMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2CharMap.Entry<Reference2CharMap.Entry<K>>>()
/*     */       {
/*     */         public ObjectIterator<Reference2CharMap.Entry<K>> iterator() {
/*  81 */           return ((Reference2CharMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  91 */           ((Reference2CharMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  93 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 162 */       return Reference2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
/* 245 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractReference2CharMap.BasicEntry<>(this.key, this.value)); 
...
/* 258 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     extends Reference2CharFunctions.SynchronizedFunction<K> implements Reference2CharMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 376 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Character>> entrySet() {
/* 390 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     extends Reference2CharFunctions.UnmodifiableFunction<K> implements Reference2CharMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2CharMap<? extends K> map;
/*     */     protected transient ObjectSet<Reference2CharMap.Entry<K>> entries;
/*     */     protected transient ReferenceSet<K> keys;
/*     */     protected transient CharCollection values;
/*     */     
/*     */     protected UnmodifiableMap(Reference2CharMap<? extends K> m) {
/* 655 */       super(m);
/* 656 */       this.map = m;
/*     */     }
/*     */ 
...
/*     */     
/*     */     public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
/* 683 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable((ObjectSet)this.map.reference2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Character>> entrySet() {
/* 696 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */ 
/*     */   
/*     */   public static <K> Reference2CharMap<K> unmodifiable(Reference2CharMap<? extends K> m) {
/* 880 */     return new UnmodifiableMap<>(m);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharMaps.class
