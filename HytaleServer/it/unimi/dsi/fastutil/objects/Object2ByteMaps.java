...
/*  44 */     ObjectSet<Object2ByteMap.Entry<K>> entries = map.object2ByteEntrySet();
/*  45 */     return (entries instanceof Object2ByteMap.FastEntrySet) ? ((Object2ByteMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     ObjectSet<Object2ByteMap.Entry<K>> entries = map.object2ByteEntrySet();
/*  61 */     if (entries instanceof Object2ByteMap.FastEntrySet) { ((Object2ByteMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  77 */     final ObjectSet<Object2ByteMap.Entry<K>> entries = map.object2ByteEntrySet();
/*  78 */     return (entries instanceof Object2ByteMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Object2ByteMap.Entry<Object2ByteMap.Entry<K>>>()
/*     */       {
/*     */         public ObjectIterator<Object2ByteMap.Entry<K>> iterator() {
/*  81 */           return ((Object2ByteMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  91 */           ((Object2ByteMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  93 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 162 */       return Object2ByteMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
/* 245 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractObject2ByteMap.BasicEntry<>(this.key, this.value)); 
...
/* 258 */       return (ObjectSet)object2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSet<K> keySet() {
...
/*     */     extends Object2ByteFunctions.SynchronizedFunction<K> implements Object2ByteMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 376 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2ByteEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Byte>> entrySet() {
/* 390 */       return (ObjectSet)object2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSet<K> keySet() {
...
/*     */     extends Object2ByteFunctions.UnmodifiableFunction<K> implements Object2ByteMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     protected transient ByteCollection values;
/*     */     
/*     */     protected UnmodifiableMap(Object2ByteMap<? extends K> m) {
/* 655 */       super(m);
/* 656 */       this.map = m;
/*     */     }
/*     */ 
...
/*     */     
/*     */     public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
/* 683 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable((ObjectSet)this.map.object2ByteEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Byte>> entrySet() {
/* 696 */       return (ObjectSet)object2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ByteMaps.class
