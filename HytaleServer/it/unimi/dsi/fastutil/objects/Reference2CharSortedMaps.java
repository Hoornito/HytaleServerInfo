...
/*  56 */     ObjectSortedSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  57 */     return (entries instanceof Reference2CharSortedMap.FastSortedEntrySet) ? ((Reference2CharSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     ObjectSortedSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  73 */     Objects.requireNonNull((Reference2CharSortedMap.FastSortedEntrySet)entries); return (entries instanceof Reference2CharSortedMap.FastSortedEntrySet) ? (Reference2CharSortedMap.FastSortedEntrySet)entries::fastIterator : entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2CharSortedMap<K> headMap(K to) {
/* 124 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2CharSortedMap<K> tailMap(K from) {
/* 130 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     
/*     */     public ObjectSortedSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
/* 195 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new AbstractReference2CharMap.BasicEntry<>(this.key, this.value), (Comparator)Reference2CharSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Reference2CharMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Character>> entrySet() {
/* 208 */       return (ObjectSortedSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 221 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 228 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 235 */       return Reference2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     extends Reference2CharMaps.SynchronizedMap<K> implements Reference2CharSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
/* 335 */       if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2CharEntrySet(), this.sync); 
/* 336 */       return (ObjectSortedSet<Reference2CharMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Character>> entrySet() {
/* 348 */       return (ObjectSortedSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/*     */     extends Reference2CharMaps.UnmodifiableMap<K> implements Reference2CharSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2CharSortedMap<K> sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
/* 429 */       if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2CharEntrySet()); 
/* 430 */       return (ObjectSortedSet<Reference2CharMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Character>> entrySet() {
/* 442 */       return (ObjectSortedSet)reference2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharSortedMaps.class
