...
/*      */     K curr;
/*      */     int pos;
/*  286 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return -(pos + 1); 
/*  287 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
...
/*      */           return;
/*      */         } 
/*  343 */         int slot = HashCommon.mix(System.identityHashCode(curr)) & this.mask;
...
/*      */     K curr;
/*      */     int pos;
/*  364 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return this.defRetValue; 
/*  365 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  367 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return this.defRetValue; 
/*  368 */       if (k == curr) return removeEntry(pos); 
/*      */     } 
/*      */   }
/*      */   
...
/*      */     K curr;
/*      */     int pos;
/*  492 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return this.defRetValue; 
/*  493 */     if (k == curr) {
...
/*      */     K curr;
/*      */     int pos;
/*  527 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return this.defRetValue; 
/*  528 */     if (k == curr) {
...
/*      */         } 
/*  569 */         while ((curr = key[pos = pos + 1 & this.mask]) != null) { if (curr == k) {
...
/*  611 */       K[] key = this.key;
/*      */       K curr;
/*  613 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) != null) {
/*  614 */         if (curr == k) {
/*  615 */           moveIndexToLast(pos);
/*  616 */           return setValue(pos, v);
/*      */         } 
/*  618 */         while ((curr = key[pos = pos + 1 & this.mask]) != null) { if (curr == k) {
...
/*      */     K curr;
/*      */     int pos;
/*  648 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return this.defRetValue; 
/*  649 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
...
/*      */     K curr;
/*      */     int pos;
/*  665 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return false; 
/*  666 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
...
/*  677 */     K[] key = this.key;
/*  678 */     if (this.containsNullKey && Objects.equals(value[this.n], v)) return true; 
/*  679 */     for (int i = this.n; i-- != 0;) { if (key[i] != null && Objects.equals(value[i], v)) return true;  }
/*  680 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  692 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return defaultValue; 
/*  693 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
...
/*  714 */     if (k == null) {
/*  715 */       if (this.containsNullKey && Objects.equals(v, this.value[this.n])) {
/*  716 */         removeNullEntry();
/*  717 */         return true;
/*      */       } 
/*  719 */       return false;
...
/*      */     K curr;
/*      */     int pos;
/*  725 */     if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask]) == null) return false; 
/*  726 */     if (k == curr && Objects.equals(v, this.value[pos])) {
/*  727 */       removeEntry(pos);
/*  728 */       return true;
/*      */     } 
/*      */     while (true) {
/*  731 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  732 */       if (k == curr && Objects.equals(v, this.value[pos])) {
/*  733 */         removeEntry(pos);
/*  734 */         return true;
/*      */       } 
/*      */     } 
...
/*  742 */     int pos = find(k);
/*  743 */     if (pos < 0 || !Objects.equals(oldValue, this.value[pos])) return false; 
...
/*      */     implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>, ReferenceObjectPair<K, V>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  871 */       return Reference2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  876 */       return Reference2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  881 */       return Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  886 */       return Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  891 */       V oldValue = Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*  892 */       Reference2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  893 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceObjectPair<K, V> right(V v) {
/*  898 */       Reference2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  899 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  907 */       return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey() && Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  912 */       return System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[this.index]) ^ ((Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null) ? 0 : Reference2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  917 */       return (new StringBuilder()).append(Reference2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1085 */       this.next = Reference2ObjectLinkedOpenHashMap.this.first;
/* 1086 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1090 */       if (from == null) {
/* 1091 */         if (Reference2ObjectLinkedOpenHashMap.this.containsNullKey) {
/* 1092 */           this.next = (int)Reference2ObjectLinkedOpenHashMap.this.link[Reference2ObjectLinkedOpenHashMap.this.n];
/* 1093 */           this.prev = Reference2ObjectLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1095 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1097 */       if (Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last] == from) {
/* 1098 */         this.prev = Reference2ObjectLinkedOpenHashMap.this.last;
/* 1099 */         this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1103 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */       
/* 1105 */       while (Reference2ObjectLinkedOpenHashMap.this.key[pos] != null) {
/* 1106 */         if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1108 */           this.next = (int)Reference2ObjectLinkedOpenHashMap.this.link[pos];
/* 1109 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1112 */         pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1131 */       if (this.next == -1) {
/* 1132 */         this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1135 */       int pos = Reference2ObjectLinkedOpenHashMap.this.first;
/* 1136 */       this.index = 1;
/* 1137 */       while (pos != this.prev) {
/* 1138 */         pos = (int)Reference2ObjectLinkedOpenHashMap.this.link[pos];
/* 1139 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1156 */       this.next = (int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/* 1165 */       this.prev = (int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1174 */         this.next = (int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1187 */         this.index--;
/* 1188 */         this.prev = (int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1189 */       else { this.next = (int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr]; }
/* 1190 */        Reference2ObjectLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1193 */       if (this.prev == -1) { Reference2ObjectLinkedOpenHashMap.this.first = this.next; }
/* 1194 */       else { Reference2ObjectLinkedOpenHashMap.this.link[this.prev] = Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1195 */        if (this.next == -1) { Reference2ObjectLinkedOpenHashMap.this.last = this.prev; }
/* 1196 */       else { Reference2ObjectLinkedOpenHashMap.this.link[this.next] = Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ (Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1197 */        int pos = this.curr;
/* 1198 */       this.curr = -1;
/* 1199 */       if (pos == Reference2ObjectLinkedOpenHashMap.this.n) {
/* 1200 */         Reference2ObjectLinkedOpenHashMap.this.containsNullKey = false;
/* 1201 */         Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.n] = null;
/* 1202 */         Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1205 */         K[] key = Reference2ObjectLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1208 */           pos = (last = pos) + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1210 */             if ((curr = key[pos]) == null) {
/* 1211 */               key[last] = null;
/* 1212 */               Reference2ObjectLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1215 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ObjectLinkedOpenHashMap.this.mask;
/* 1216 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1217 */               break;  pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1219 */           key[last] = curr;
/* 1220 */           Reference2ObjectLinkedOpenHashMap.this.value[last] = Reference2ObjectLinkedOpenHashMap.this.value[pos];
/* 1221 */           if (this.next == pos) this.next = last; 
/* 1222 */           if (this.prev == pos) this.prev = last; 
/* 1223 */           Reference2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>> implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
...
/* 1262 */       action.accept(new Reference2ObjectLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry next() {
/* 1267 */       return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry previous() {
/* 1272 */       return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>> implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
/* 1283 */     final Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry entry = new Reference2ObjectLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1317 */       return new Reference2ObjectLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1335 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1360 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1361 */       return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ObjectMap.Entry<K, V> last() {
/* 1366 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1367 */       return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1377 */       if (k == null) return (Reference2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n], v));
/*      */       
/* 1379 */       K[] key = Reference2ObjectLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1382 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1383 */       if (k == curr) return Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/* 1386 */         if ((curr = key[pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1387 */         if (k == curr) return Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1398 */       if (k == null) {
/* 1399 */         if (Reference2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[Reference2ObjectLinkedOpenHashMap.this.n], v)) {
/* 1400 */           Reference2ObjectLinkedOpenHashMap.this.removeNullEntry();
/* 1401 */           return true;
/*      */         } 
/* 1403 */         return false;
/*      */       } 
/*      */       
/* 1406 */       K[] key = Reference2ObjectLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1410 */       if (curr == k) {
/* 1411 */         if (Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1412 */           Reference2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1413 */           return true;
/*      */         } 
/* 1415 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1418 */         if ((curr = key[pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1419 */         if (curr == k && 
/* 1420 */           Objects.equals(Reference2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1421 */           Reference2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1422 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1430 */       return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1435 */       Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1448 */       return new Reference2ObjectLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1459 */       return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1472 */       return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
/* 1478 */       for (int i = Reference2ObjectLinkedOpenHashMap.this.size, next = Reference2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1479 */         int curr = next;
/* 1480 */         next = (int)Reference2ObjectLinkedOpenHashMap.this.link[curr];
/* 1481 */         consumer.accept(new Reference2ObjectLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1488 */       Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry entry = new Reference2ObjectLinkedOpenHashMap.MapEntry();
/* 1489 */       for (int i = Reference2ObjectLinkedOpenHashMap.this.size, next = Reference2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1490 */         entry.index = next;
/* 1491 */         next = (int)Reference2ObjectLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1518 */       return Reference2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       action.accept(Reference2ObjectLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1535 */       return Reference2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1544 */       return new Reference2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1549 */       return new Reference2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1559 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1565 */       for (int i = Reference2ObjectLinkedOpenHashMap.this.size, next = Reference2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1566 */         int curr = next;
/* 1567 */         next = (int)Reference2ObjectLinkedOpenHashMap.this.link[curr];
/* 1568 */         consumer.accept(Reference2ObjectLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1574 */       return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1579 */       return Reference2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1584 */       int oldSize = Reference2ObjectLinkedOpenHashMap.this.size;
/* 1585 */       Reference2ObjectLinkedOpenHashMap.this.remove(k);
/* 1586 */       return (Reference2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1591 */       Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1596 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1597 */       return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1602 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1603 */       return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1644 */       return Reference2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1656 */       action.accept(Reference2ObjectLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1661 */       return Reference2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1667 */     if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 80;
/*      */           
/*      */           public ObjectIterator<V> iterator() {
/* 1672 */             return new Reference2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1682 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ObjectLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1688 */             for (int i = Reference2ObjectLinkedOpenHashMap.this.size, next = Reference2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1689 */               int curr = next;
/* 1690 */               next = (int)Reference2ObjectLinkedOpenHashMap.this.link[curr];
/* 1691 */               consumer.accept(Reference2ObjectLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1697 */             return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1702 */             return Reference2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1707 */             Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */       else
/* 1783 */       { pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
...
/*      */     try {
/* 1827 */       c = (Reference2ObjectLinkedOpenHashMap<K, V>)super.clone();
...
/* 1855 */       if (this != this.key[i]) t = System.identityHashCode(this.key[i]); 
/* 1856 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1857 */       h += t;
/* 1858 */       i++;
/*      */     } 
/*      */     
/* 1861 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1862 */     return h;
/*      */   }
/*      */   
...
/*      */       } else {
/* 1897 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ObjectLinkedOpenHashMap.class
