...
/*  699 */     K[] key = this.key;
/*  700 */     if (this.containsNullKey && Objects.equals(value[this.n], v)) return true; 
/*  701 */     for (int i = this.n; i-- != 0;) { if (key[i] != null && Objects.equals(value[i], v)) return true;  }
/*  702 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  737 */       if (this.containsNullKey && Objects.equals(v, this.value[this.n])) {
/*  738 */         removeNullEntry();
/*  739 */         return true;
/*      */       } 
/*  741 */       return false;
...
/*  748 */     if (this.strategy.equals(k, curr) && Objects.equals(v, this.value[pos])) {
/*  749 */       removeEntry(pos);
/*  750 */       return true;
/*      */     } 
/*      */     while (true) {
/*  753 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  754 */       if (this.strategy.equals(k, curr) && Objects.equals(v, this.value[pos])) {
/*  755 */         removeEntry(pos);
/*  756 */         return true;
/*      */       } 
/*      */     } 
...
/*  764 */     int pos = find(k);
/*  765 */     if (pos < 0 || !Objects.equals(oldValue, this.value[pos])) return false; 
...
/*      */     
/*      */     public K getKey() {
/*  893 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  898 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  903 */       return Object2ObjectLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  908 */       return Object2ObjectLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  913 */       V oldValue = Object2ObjectLinkedOpenCustomHashMap.this.value[this.index];
/*  914 */       Object2ObjectLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  915 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public Pair<K, V> right(V v) {
/*  920 */       Object2ObjectLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  921 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  929 */       return (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(Object2ObjectLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  934 */       return Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ObjectLinkedOpenCustomHashMap.this.key[this.index]) ^ ((Object2ObjectLinkedOpenCustomHashMap.this.value[this.index] == null) ? 0 : Object2ObjectLinkedOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  939 */       return (new StringBuilder()).append(Object2ObjectLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ObjectLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1107 */       this.next = Object2ObjectLinkedOpenCustomHashMap.this.first;
/* 1108 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1112 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1113 */         if (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1114 */           this.next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[Object2ObjectLinkedOpenCustomHashMap.this.n];
/* 1115 */           this.prev = Object2ObjectLinkedOpenCustomHashMap.this.n; return;
/*      */         } 
/* 1117 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1119 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.last], from)) {
/* 1120 */         this.prev = Object2ObjectLinkedOpenCustomHashMap.this.last;
/* 1121 */         this.index = Object2ObjectLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1125 */       int pos = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ObjectLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1127 */       while (Object2ObjectLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1128 */         if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(Object2ObjectLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1130 */           this.next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[pos];
/* 1131 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1134 */         pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1153 */       if (this.next == -1) {
/* 1154 */         this.index = Object2ObjectLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1157 */       int pos = Object2ObjectLinkedOpenCustomHashMap.this.first;
/* 1158 */       this.index = 1;
/* 1159 */       while (pos != this.prev) {
/* 1160 */         pos = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[pos];
/* 1161 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1178 */       this.next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1187 */       this.prev = (int)(Object2ObjectLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/* 1196 */         this.next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[this.curr];
...
/*      */       { 
/* 1209 */         this.index--;
/* 1210 */         this.prev = (int)(Object2ObjectLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L); }
/* 1211 */       else { this.next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[this.curr]; }
/* 1212 */        Object2ObjectLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */       
/* 1215 */       if (this.prev == -1) { Object2ObjectLinkedOpenCustomHashMap.this.first = this.next; }
/* 1216 */       else { Object2ObjectLinkedOpenCustomHashMap.this.link[this.prev] = Object2ObjectLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2ObjectLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1217 */        if (this.next == -1) { Object2ObjectLinkedOpenCustomHashMap.this.last = this.prev; }
/* 1218 */       else { Object2ObjectLinkedOpenCustomHashMap.this.link[this.next] = Object2ObjectLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2ObjectLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1219 */        int pos = this.curr;
/* 1220 */       this.curr = -1;
/* 1221 */       if (pos == Object2ObjectLinkedOpenCustomHashMap.this.n) {
/* 1222 */         Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1223 */         Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.n] = null;
/* 1224 */         Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1227 */         K[] key = Object2ObjectLinkedOpenCustomHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1230 */           pos = (last = pos) + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1232 */             if ((curr = key[pos]) == null) {
/* 1233 */               key[last] = null;
/* 1234 */               Object2ObjectLinkedOpenCustomHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1237 */             int slot = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ObjectLinkedOpenCustomHashMap.this.mask;
/* 1238 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1239 */               break;  pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1241 */           key[last] = curr;
/* 1242 */           Object2ObjectLinkedOpenCustomHashMap.this.value[last] = Object2ObjectLinkedOpenCustomHashMap.this.value[pos];
/* 1243 */           if (this.next == pos) this.next = last; 
/* 1244 */           if (this.prev == pos) this.prev = last; 
/* 1245 */           Object2ObjectLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1284 */       action.accept(new Object2ObjectLinkedOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectLinkedOpenCustomHashMap<K, V>.MapEntry next() {
/* 1289 */       return this.entry = new Object2ObjectLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectLinkedOpenCustomHashMap<K, V>.MapEntry previous() {
/* 1294 */       return this.entry = new Object2ObjectLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1305 */     final Object2ObjectLinkedOpenCustomHashMap<K, V>.MapEntry entry = new Object2ObjectLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1339 */       return new Object2ObjectLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1357 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1382 */       if (Object2ObjectLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1383 */       return new Object2ObjectLinkedOpenCustomHashMap.MapEntry(Object2ObjectLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectMap.Entry<K, V> last() {
/* 1388 */       if (Object2ObjectLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1389 */       return new Object2ObjectLinkedOpenCustomHashMap.MapEntry(Object2ObjectLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1399 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, null)) return (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n], v));
/*      */       
/* 1401 */       K[] key = Object2ObjectLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1404 */       if ((curr = key[pos = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1405 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/* 1408 */         if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1409 */         if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1420 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1421 */         if (Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[Object2ObjectLinkedOpenCustomHashMap.this.n], v)) {
/* 1422 */           Object2ObjectLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1423 */           return true;
/*      */         } 
/* 1425 */         return false;
/*      */       } 
/*      */       
/* 1428 */       K[] key = Object2ObjectLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1431 */       if ((curr = key[pos = HashCommon.mix(Object2ObjectLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1432 */       if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1433 */         if (Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v)) {
/* 1434 */           Object2ObjectLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1435 */           return true;
/*      */         } 
/* 1437 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1440 */         if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1441 */         if (Object2ObjectLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1442 */           Objects.equals(Object2ObjectLinkedOpenCustomHashMap.this.value[pos], v)) {
/* 1443 */           Object2ObjectLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1444 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1452 */       return Object2ObjectLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1457 */       Object2ObjectLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1470 */       return new Object2ObjectLinkedOpenCustomHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1481 */       return new Object2ObjectLinkedOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1494 */       return new Object2ObjectLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
/* 1500 */       for (int i = Object2ObjectLinkedOpenCustomHashMap.this.size, next = Object2ObjectLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1501 */         int curr = next;
/* 1502 */         next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[curr];
/* 1503 */         consumer.accept(new Object2ObjectLinkedOpenCustomHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1510 */       Object2ObjectLinkedOpenCustomHashMap<K, V>.MapEntry entry = new Object2ObjectLinkedOpenCustomHashMap.MapEntry();
/* 1511 */       for (int i = Object2ObjectLinkedOpenCustomHashMap.this.size, next = Object2ObjectLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1512 */         entry.index = next;
/* 1513 */         next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1540 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       action.accept(Object2ObjectLinkedOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1557 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1566 */       return new Object2ObjectLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1571 */       return new Object2ObjectLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1587 */       for (int i = Object2ObjectLinkedOpenCustomHashMap.this.size, next = Object2ObjectLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[curr];
/* 1590 */         consumer.accept(Object2ObjectLinkedOpenCustomHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1596 */       return Object2ObjectLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1601 */       return Object2ObjectLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1606 */       int oldSize = Object2ObjectLinkedOpenCustomHashMap.this.size;
/* 1607 */       Object2ObjectLinkedOpenCustomHashMap.this.remove(k);
/* 1608 */       return (Object2ObjectLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1613 */       Object2ObjectLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1618 */       if (Object2ObjectLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1619 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1624 */       if (Object2ObjectLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Object2ObjectLinkedOpenCustomHashMap.this.key[Object2ObjectLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1666 */       return Object2ObjectLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1678 */       action.accept(Object2ObjectLinkedOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1683 */       return Object2ObjectLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public ObjectCollection<V> values() {
/* 1689 */     if (this.values == null) this.values = new AbstractObjectCollection<V>()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 80;
/*      */           
/*      */           public ObjectIterator<V> iterator() {
/* 1694 */             return new Object2ObjectLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1704 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenCustomHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1710 */             for (int i = Object2ObjectLinkedOpenCustomHashMap.this.size, next = Object2ObjectLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1711 */               int curr = next;
/* 1712 */               next = (int)Object2ObjectLinkedOpenCustomHashMap.this.link[curr];
/* 1713 */               consumer.accept(Object2ObjectLinkedOpenCustomHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1719 */             return Object2ObjectLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1724 */             return Object2ObjectLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1729 */             Object2ObjectLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1849 */       c = (Object2ObjectLinkedOpenCustomHashMap<K, V>)super.clone();
...
/* 1879 */       if (this != this.value[i]) t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1880 */       h += t;
/* 1881 */       i++;
/*      */     } 
/*      */     
/* 1884 */     if (this.containsNullKey) h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1885 */     return h;
/*      */   }
/*      */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectLinkedOpenCustomHashMap.class
