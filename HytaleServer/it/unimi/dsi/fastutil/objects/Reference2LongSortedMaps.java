...
/*  56 */     ObjectSortedSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  57 */     return (entries instanceof Reference2LongSortedMap.FastSortedEntrySet) ? ((Reference2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     ObjectSortedSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  73 */     Objects.requireNonNull((Reference2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Reference2LongSortedMap.FastSortedEntrySet) ? (Reference2LongSortedMap.FastSortedEntrySet)entries::fastIterator : entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2LongSortedMap<K> headMap(K to) {
/* 124 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2LongSortedMap<K> tailMap(K from) {
/* 130 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     
/*     */     public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
/* 195 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new AbstractReference2LongMap.BasicEntry<>(this.key, this.value), (Comparator)Reference2LongSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Reference2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 208 */       return (ObjectSortedSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 221 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 228 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 235 */       return Reference2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/* 261 */     return new Singleton<>(key, value.longValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 277 */     return new Singleton<>(key, value.longValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Reference2LongMaps.SynchronizedMap<K> implements Reference2LongSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
/* 335 */       if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2LongEntrySet(), this.sync); 
/* 336 */       return (ObjectSortedSet<Reference2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 348 */       return (ObjectSortedSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/*     */     extends Reference2LongMaps.UnmodifiableMap<K> implements Reference2LongSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2LongSortedMap<K> sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
/* 429 */       if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2LongEntrySet()); 
/* 430 */       return (ObjectSortedSet<Reference2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 442 */       return (ObjectSortedSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongSortedMaps.class
