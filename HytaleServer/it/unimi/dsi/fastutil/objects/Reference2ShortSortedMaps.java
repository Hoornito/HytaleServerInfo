...
/*  56 */     ObjectSortedSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
/*  57 */     return (entries instanceof Reference2ShortSortedMap.FastSortedEntrySet) ? ((Reference2ShortSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     ObjectSortedSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
/*  73 */     Objects.requireNonNull((Reference2ShortSortedMap.FastSortedEntrySet)entries); return (entries instanceof Reference2ShortSortedMap.FastSortedEntrySet) ? (Reference2ShortSortedMap.FastSortedEntrySet)entries::fastIterator : entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2ShortSortedMap<K> headMap(K to) {
/* 124 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2ShortSortedMap<K> tailMap(K from) {
/* 130 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     
/*     */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
/* 195 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new AbstractReference2ShortMap.BasicEntry<>(this.key, this.value), (Comparator)Reference2ShortSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Reference2ShortMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Short>> entrySet() {
/* 208 */       return (ObjectSortedSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 221 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 228 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 235 */       return Reference2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/* 261 */     return new Singleton<>(key, value.shortValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 277 */     return new Singleton<>(key, value.shortValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Reference2ShortMaps.SynchronizedMap<K> implements Reference2ShortSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
/* 335 */       if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2ShortEntrySet(), this.sync); 
/* 336 */       return (ObjectSortedSet<Reference2ShortMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Short>> entrySet() {
/* 348 */       return (ObjectSortedSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/*     */     extends Reference2ShortMaps.UnmodifiableMap<K> implements Reference2ShortSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2ShortSortedMap<K> sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
/* 429 */       if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2ShortEntrySet()); 
/* 430 */       return (ObjectSortedSet<Reference2ShortMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Short>> entrySet() {
/* 442 */       return (ObjectSortedSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortSortedMaps.class
