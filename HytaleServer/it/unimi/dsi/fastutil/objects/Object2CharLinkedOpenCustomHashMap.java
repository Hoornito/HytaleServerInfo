...
/*  153 */     this.value = new char[this.n + 1];
...
/*  291 */     char oldValue = this.value[this.n];
/*  292 */     this.size--;
...
/*      */     } 
/*  346 */     char oldValue = this.value[pos];
/*  347 */     this.value[pos] = v;
/*  348 */     return oldValue;
/*      */   }
/*      */   
/*      */   private char addToValue(int pos, char incr) {
/*  352 */     char oldValue = this.value[pos];
/*  353 */     this.value[pos] = (char)(oldValue + incr);
/*  354 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */       } 
/*  385 */     }  this.key[pos] = k;
/*  386 */     this.value[pos] = (char)(this.defRetValue + incr);
/*  387 */     if (this.size == 0) {
...
/*  449 */     char oldValue = this.value[pos];
...
/*  827 */     char oldValue = this.value[pos];
...
/*  838 */     char newValue = SafeMath.safeIntToChar(mappingFunction.applyAsInt(k));
...
/*  850 */     char newValue = mappingFunction.getChar(key);
...
/*  861 */     Character newValue = remappingFunction.apply(k, Character.valueOf(this.value[pos]));
...
/*      */     } 
/*  867 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  874 */     int pos = find(k);
/*  875 */     Character newValue = remappingFunction.apply(k, (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  883 */     char newVal = newValue.charValue();
/*  884 */     if (pos < 0) {
...
/*  900 */        return v;
/*      */     } 
/*  902 */     Character newValue = remappingFunction.apply(Character.valueOf(this.value[pos]), Character.valueOf(v));
...
/*      */     } 
/*  908 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     implements Object2CharMap.Entry<K>, Map.Entry<K, Character>, ObjectCharPair<K>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  954 */       return Object2CharLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
...
/*  964 */       return Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  969 */       return Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  974 */       char oldValue = Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*  975 */       Object2CharLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  976 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectCharPair<K> right(char v) {
/*  981 */       Object2CharLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  982 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  993 */       return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1004 */       return Character.valueOf(setValue(v.charValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1011 */       Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
/* 1012 */       return (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2CharLinkedOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1017 */       return Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(Object2CharLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1022 */       return (new StringBuilder()).append(Object2CharLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2CharLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1190 */       this.next = Object2CharLinkedOpenCustomHashMap.this.first;
/* 1191 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1195 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1196 */         if (Object2CharLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1197 */           this.next = (int)Object2CharLinkedOpenCustomHashMap.this.link[Object2CharLinkedOpenCustomHashMap.this.n];
/* 1198 */           this.prev = Object2CharLinkedOpenCustomHashMap.this.n; return;
/*      */         } 
/* 1200 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1202 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.last], from)) {
/* 1203 */         this.prev = Object2CharLinkedOpenCustomHashMap.this.last;
/* 1204 */         this.index = Object2CharLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1208 */       int pos = HashCommon.mix(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2CharLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1210 */       while (Object2CharLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1211 */         if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1213 */           this.next = (int)Object2CharLinkedOpenCustomHashMap.this.link[pos];
/* 1214 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1217 */         pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1236 */       if (this.next == -1) {
/* 1237 */         this.index = Object2CharLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1240 */       int pos = Object2CharLinkedOpenCustomHashMap.this.first;
/* 1241 */       this.index = 1;
/* 1242 */       while (pos != this.prev) {
/* 1243 */         pos = (int)Object2CharLinkedOpenCustomHashMap.this.link[pos];
/* 1244 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1261 */       this.next = (int)Object2CharLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1270 */       this.prev = (int)(Object2CharLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/* 1279 */         this.next = (int)Object2CharLinkedOpenCustomHashMap.this.link[this.curr];
...
/*      */       { 
/* 1292 */         this.index--;
/* 1293 */         this.prev = (int)(Object2CharLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L); }
/* 1294 */       else { this.next = (int)Object2CharLinkedOpenCustomHashMap.this.link[this.curr]; }
/* 1295 */        Object2CharLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */       
/* 1298 */       if (this.prev == -1) { Object2CharLinkedOpenCustomHashMap.this.first = this.next; }
/* 1299 */       else { Object2CharLinkedOpenCustomHashMap.this.link[this.prev] = Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1300 */        if (this.next == -1) { Object2CharLinkedOpenCustomHashMap.this.last = this.prev; }
/* 1301 */       else { Object2CharLinkedOpenCustomHashMap.this.link[this.next] = Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1302 */        int pos = this.curr;
/* 1303 */       this.curr = -1;
/* 1304 */       if (pos == Object2CharLinkedOpenCustomHashMap.this.n) {
/* 1305 */         Object2CharLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1306 */         Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1309 */         K[] key = Object2CharLinkedOpenCustomHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1312 */           pos = (last = pos) + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1314 */             if ((curr = key[pos]) == null) {
/* 1315 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1318 */             int slot = HashCommon.mix(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2CharLinkedOpenCustomHashMap.this.mask;
/* 1319 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1320 */               break;  pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1322 */           key[last] = curr;
/* 1323 */           Object2CharLinkedOpenCustomHashMap.this.value[last] = Object2CharLinkedOpenCustomHashMap.this.value[pos];
/* 1324 */           if (this.next == pos) this.next = last; 
/* 1325 */           if (this.prev == pos) this.prev = last; 
/* 1326 */           Object2CharLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2CharMap.Entry<K>>> implements ObjectListIterator<Object2CharMap.Entry<K>> {
...
/* 1365 */       action.accept(new Object2CharLinkedOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharLinkedOpenCustomHashMap<K>.MapEntry next() {
/* 1370 */       return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharLinkedOpenCustomHashMap<K>.MapEntry previous() {
/* 1375 */       return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Object2CharMap.Entry<K>>> implements ObjectListIterator<Object2CharMap.Entry<K>> {
/* 1386 */     final Object2CharLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2CharLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1420 */       return new Object2CharLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1438 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1463 */       if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1464 */       return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharMap.Entry<K> last() {
/* 1469 */       if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1470 */       return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1478 */       if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1479 */       K k = (K)e.getKey();
/* 1480 */       char v = ((Character)e.getValue()).charValue();
/* 1481 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(k, null)) return (Object2CharLinkedOpenCustomHashMap.this.containsNullKey && Object2CharLinkedOpenCustomHashMap.this.value[Object2CharLinkedOpenCustomHashMap.this.n] == v);
/*      */       
/* 1483 */       K[] key = Object2CharLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1486 */       if ((curr = key[pos = HashCommon.mix(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1487 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return (Object2CharLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1490 */         if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1491 */         if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return (Object2CharLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1500 */       if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1501 */       K k = (K)e.getKey();
/* 1502 */       char v = ((Character)e.getValue()).charValue();
/* 1503 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1504 */         if (Object2CharLinkedOpenCustomHashMap.this.containsNullKey && Object2CharLinkedOpenCustomHashMap.this.value[Object2CharLinkedOpenCustomHashMap.this.n] == v) {
/* 1505 */           Object2CharLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1506 */           return true;
/*      */         } 
/* 1508 */         return false;
/*      */       } 
/*      */       
/* 1511 */       K[] key = Object2CharLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1514 */       if ((curr = key[pos = HashCommon.mix(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1515 */       if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1516 */         if (Object2CharLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1517 */           Object2CharLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1518 */           return true;
/*      */         } 
/* 1520 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1523 */         if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1524 */         if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1525 */           Object2CharLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1526 */           Object2CharLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1527 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1535 */       return Object2CharLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1540 */       Object2CharLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1553 */       return new Object2CharLinkedOpenCustomHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1564 */       return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1577 */       return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
/* 1583 */       for (int i = Object2CharLinkedOpenCustomHashMap.this.size, next = Object2CharLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1584 */         int curr = next;
/* 1585 */         next = (int)Object2CharLinkedOpenCustomHashMap.this.link[curr];
/* 1586 */         consumer.accept(new Object2CharLinkedOpenCustomHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1593 */       Object2CharLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2CharLinkedOpenCustomHashMap.MapEntry();
/* 1594 */       for (int i = Object2CharLinkedOpenCustomHashMap.this.size, next = Object2CharLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1595 */         entry.index = next;
/* 1596 */         next = (int)Object2CharLinkedOpenCustomHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1623 */       return Object2CharLinkedOpenCustomHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1635 */       action.accept(Object2CharLinkedOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1640 */       return Object2CharLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1649 */       return new Object2CharLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1654 */       return new Object2CharLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1664 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1670 */       for (int i = Object2CharLinkedOpenCustomHashMap.this.size, next = Object2CharLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1671 */         int curr = next;
/* 1672 */         next = (int)Object2CharLinkedOpenCustomHashMap.this.link[curr];
/* 1673 */         consumer.accept(Object2CharLinkedOpenCustomHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/* 1684 */       return Object2CharLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1689 */       int oldSize = Object2CharLinkedOpenCustomHashMap.this.size;
/* 1690 */       Object2CharLinkedOpenCustomHashMap.this.removeChar(k);
/* 1691 */       return (Object2CharLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1696 */       Object2CharLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1701 */       if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1702 */       return Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1707 */       if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1708 */       return Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1749 */       return Object2CharLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1761 */       action.accept(Object2CharLinkedOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1766 */       return Object2CharLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public CharCollection values() {
/* 1772 */     if (this.values == null) this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public CharIterator iterator() {
/* 1777 */             return (CharIterator)new Object2CharLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1787 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenCustomHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1793 */             for (int i = Object2CharLinkedOpenCustomHashMap.this.size, next = Object2CharLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1794 */               int curr = next;
/* 1795 */               next = (int)Object2CharLinkedOpenCustomHashMap.this.link[curr];
/* 1796 */               consumer.accept(Object2CharLinkedOpenCustomHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1802 */             return Object2CharLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1807 */             return Object2CharLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1812 */             Object2CharLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1876 */     K[] key = this.key;
/* 1877 */     char[] value = this.value;
/* 1878 */     int mask = newN - 1;
/* 1879 */     K[] newKey = (K[])new Object[newN + 1];
/* 1880 */     char[] newValue = new char[newN + 1];
...
/*      */     try {
/* 1932 */       c = (Object2CharLinkedOpenCustomHashMap<K>)super.clone();
...
/* 1941 */     c.value = (char[])this.value.clone();
...
/* 1990 */     char[] value = this.value = new char[this.n + 1];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2CharLinkedOpenCustomHashMap.class
