...
/*  400 */     if (k.equals(curr) && v == this.value[pos]) {
/*  401 */       removeEntry(pos);
/*  402 */       return true;
/*      */     } 
/*      */     while (true) {
/*  405 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  406 */       if (k.equals(curr) && v == this.value[pos]) {
/*  407 */         removeEntry(pos);
/*  408 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  544 */       return Object2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  549 */       return Object2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  554 */       return Object2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  559 */       return Object2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  564 */       V oldValue = Object2ReferenceOpenHashMap.this.value[this.index];
/*  565 */       Object2ReferenceOpenHashMap.this.value[this.index] = v;
/*  566 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectReferencePair<K, V> right(V v) {
/*  571 */       Object2ReferenceOpenHashMap.this.value[this.index] = v;
/*  572 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  580 */       return (Objects.equals(Object2ReferenceOpenHashMap.this.key[this.index], e.getKey()) && Object2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  585 */       return ((Object2ReferenceOpenHashMap.this.key[this.index] == null) ? 0 : Object2ReferenceOpenHashMap.this.key[this.index].hashCode()) ^ ((Object2ReferenceOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Object2ReferenceOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  590 */       return (new StringBuilder()).append(Object2ReferenceOpenHashMap.this.key[this.index]).append("=>").append(Object2ReferenceOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  601 */     int pos = Object2ReferenceOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  607 */     int last = -1;
/*      */     
/*  609 */     int c = Object2ReferenceOpenHashMap.this.size;
/*      */     
/*  611 */     boolean mustReturnNullKey = Object2ReferenceOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  630 */         return this.last = Object2ReferenceOpenHashMap.this.n;
/*      */       } 
/*  632 */       K[] key = Object2ReferenceOpenHashMap.this.key;
/*      */       while (true) {
/*  634 */         if (--this.pos < 0) {
/*      */           
/*  636 */           this.last = Integer.MIN_VALUE;
/*  637 */           K k = this.wrapped.get(-this.pos - 1);
/*  638 */           int p = HashCommon.mix(k.hashCode()) & Object2ReferenceOpenHashMap.this.mask;
/*  639 */           for (; !k.equals(key[p]); p = p + 1 & Object2ReferenceOpenHashMap.this.mask);
/*  640 */           return p;
/*      */         } 
...
/*  649 */         acceptOnIndex(action, this.last = Object2ReferenceOpenHashMap.this.n);
/*  650 */         this.c--;
/*      */       } 
/*  652 */       K[] key = Object2ReferenceOpenHashMap.this.key;
/*  653 */       while (this.c != 0) {
/*  654 */         if (--this.pos < 0) {
/*      */           
/*  656 */           this.last = Integer.MIN_VALUE;
/*  657 */           K k = this.wrapped.get(-this.pos - 1);
/*  658 */           int p = HashCommon.mix(k.hashCode()) & Object2ReferenceOpenHashMap.this.mask;
/*  659 */           for (; !k.equals(key[p]); p = p + 1 & Object2ReferenceOpenHashMap.this.mask);
...
/*  679 */       K[] key = Object2ReferenceOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  681 */         pos = (last = pos) + 1 & Object2ReferenceOpenHashMap.this.mask;
/*      */         while (true) {
/*  683 */           if ((curr = key[pos]) == null) {
/*  684 */             key[last] = null;
/*  685 */             Object2ReferenceOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  688 */           int slot = HashCommon.mix(curr.hashCode()) & Object2ReferenceOpenHashMap.this.mask;
/*  689 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  690 */             break;  pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask;
/*      */         } 
/*  692 */         if (pos < last) {
...
/*      */         } 
/*  696 */         key[last] = curr;
/*  697 */         Object2ReferenceOpenHashMap.this.value[last] = Object2ReferenceOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  702 */       if (this.last == -1) throw new IllegalStateException(); 
/*  703 */       if (this.last == Object2ReferenceOpenHashMap.this.n)
/*  704 */       { Object2ReferenceOpenHashMap.this.containsNullKey = false;
/*  705 */         Object2ReferenceOpenHashMap.this.key[Object2ReferenceOpenHashMap.this.n] = null;
/*  706 */         Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n] = null; }
/*  707 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  710 */       { Object2ReferenceOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
/*  711 */         this.last = -1;
/*      */         return; }
/*      */       
/*  714 */       Object2ReferenceOpenHashMap.this.size--;
/*  715 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>> implements ObjectIterator<Object2ReferenceMap.Entry<K, V>> { public Object2ReferenceOpenHashMap<K, V>.MapEntry next() {
/*  731 */       return this.entry = new Object2ReferenceOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  737 */       action.accept(this.entry = new Object2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  748 */       this.entry = new Object2ReferenceOpenHashMap.MapEntry();
/*      */     }
...
/*  769 */     int pos = 0;
/*      */     
/*  771 */     int max = Object2ReferenceOpenHashMap.this.n;
/*      */     
/*  773 */     int c = 0;
/*      */     
/*  775 */     boolean mustReturnNull = Object2ReferenceOpenHashMap.this.containsNullKey;
/*      */     
...
/*  795 */         this.c++;
/*  796 */         acceptOnIndex(action, Object2ReferenceOpenHashMap.this.n);
/*  797 */         return true;
/*      */       } 
/*  799 */       K[] key = Object2ReferenceOpenHashMap.this.key;
...
/*  814 */         this.c++;
/*  815 */         acceptOnIndex(action, Object2ReferenceOpenHashMap.this.n);
/*      */       } 
/*  817 */       K[] key = Object2ReferenceOpenHashMap.this.key;
...
/*      */       {
/*  830 */         return (Object2ReferenceOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  835 */       return Math.min((Object2ReferenceOpenHashMap.this.size - this.c), (long)(Object2ReferenceOpenHashMap.this.realSize() / Object2ReferenceOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  863 */         n--;
/*      */       } 
/*  865 */       K[] key = Object2ReferenceOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Object2ReferenceMap.Entry<K, V>> action, int index) {
/*  893 */       action.accept(new Object2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  905 */       return new Object2ReferenceOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/*  910 */       return new Object2ReferenceOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Object2ReferenceMap.Entry<K, V>> spliterator() {
/*  915 */       return new Object2ReferenceOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  926 */       if (k == null) return (Object2ReferenceOpenHashMap.this.containsNullKey && Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n] == v);
/*      */       
/*  928 */       K[] key = Object2ReferenceOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  931 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ReferenceOpenHashMap.this.mask]) == null) return false; 
/*  932 */       if (k.equals(curr)) return (Object2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  935 */         if ((curr = key[pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask]) == null) return false; 
/*  936 */         if (k.equals(curr)) return (Object2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  947 */       if (k == null) {
/*  948 */         if (Object2ReferenceOpenHashMap.this.containsNullKey && Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n] == v) {
/*  949 */           Object2ReferenceOpenHashMap.this.removeNullEntry();
/*  950 */           return true;
/*      */         } 
/*  952 */         return false;
/*      */       } 
/*      */       
/*  955 */       K[] key = Object2ReferenceOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  958 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ReferenceOpenHashMap.this.mask]) == null) return false; 
/*  959 */       if (curr.equals(k)) {
/*  960 */         if (Object2ReferenceOpenHashMap.this.value[pos] == v) {
/*  961 */           Object2ReferenceOpenHashMap.this.removeEntry(pos);
/*  962 */           return true;
/*      */         } 
/*  964 */         return false;
/*      */       } 
/*      */       while (true) {
/*  967 */         if ((curr = key[pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask]) == null) return false; 
/*  968 */         if (curr.equals(k) && 
/*  969 */           Object2ReferenceOpenHashMap.this.value[pos] == v) {
/*  970 */           Object2ReferenceOpenHashMap.this.removeEntry(pos);
/*  971 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  979 */       return Object2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/*  984 */       Object2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
/*  990 */       if (Object2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(new Object2ReferenceOpenHashMap.MapEntry(Object2ReferenceOpenHashMap.this.n)); 
/*  991 */       for (int pos = Object2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Object2ReferenceOpenHashMap.this.key[pos] != null) consumer.accept(new Object2ReferenceOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
/*  997 */       Object2ReferenceOpenHashMap<K, V>.MapEntry entry = new Object2ReferenceOpenHashMap.MapEntry();
/*  998 */       if (Object2ReferenceOpenHashMap.this.containsNullKey) {
/*  999 */         entry.index = Object2ReferenceOpenHashMap.this.n;
/* 1000 */         consumer.accept(entry);
/*      */       } 
/* 1002 */       for (int pos = Object2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Object2ReferenceOpenHashMap.this.key[pos] != null) {
...
/* 1033 */       action.accept(Object2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1038 */       return Object2ReferenceOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1059 */       action.accept(Object2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1071 */       return new Object2ReferenceOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1076 */       return new Object2ReferenceOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1082 */       if (Object2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Object2ReferenceOpenHashMap.this.key[Object2ReferenceOpenHashMap.this.n]); 
/* 1083 */       for (int pos = Object2ReferenceOpenHashMap.this.n; pos-- != 0; ) {
/* 1084 */         K k = Object2ReferenceOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1091 */       return Object2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1096 */       return Object2ReferenceOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1101 */       int oldSize = Object2ReferenceOpenHashMap.this.size;
/* 1102 */       Object2ReferenceOpenHashMap.this.remove(k);
/* 1103 */       return (Object2ReferenceOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Object2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1136 */       action.accept(Object2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1141 */       return Object2ReferenceOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1162 */       action.accept(Object2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1176 */             return new Object2ReferenceOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1181 */             return new Object2ReferenceOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1187 */             if (Object2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n]); 
/* 1188 */             for (int pos = Object2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Object2ReferenceOpenHashMap.this.key[pos] != null) consumer.accept(Object2ReferenceOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1193 */             return Object2ReferenceOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1198 */             return Object2ReferenceOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1203 */             Object2ReferenceOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1301 */       c = (Object2ReferenceOpenHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ReferenceOpenHashMap.class
