...
/*  149 */     this.value = new char[this.n + 1];
...
/*  258 */     char oldValue = this.value[pos];
/*  259 */     this.size--;
/*  260 */     fixPointers(pos);
/*  261 */     shiftKeys(pos);
...
/*  269 */     char oldValue = this.value[this.n];
/*  270 */     this.size--;
...
/*      */     } 
/*  324 */     char oldValue = this.value[pos];
/*  325 */     this.value[pos] = v;
/*  326 */     return oldValue;
/*      */   }
/*      */   
/*      */   private char addToValue(int pos, char incr) {
/*  330 */     char oldValue = this.value[pos];
/*  331 */     this.value[pos] = (char)(oldValue + incr);
/*  332 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */       } 
/*  363 */     }  this.key[pos] = k;
/*  364 */     this.value[pos] = (char)(this.defRetValue + incr);
/*  365 */     if (this.size == 0) {
...
/*  427 */     char oldValue = this.value[pos];
...
/*  778 */     if (k == curr && v == this.value[pos]) {
/*  779 */       removeEntry(pos);
/*  780 */       return true;
/*      */     } 
/*      */     while (true) {
...
/*  805 */     char oldValue = this.value[pos];
...
/*  816 */     char newValue = SafeMath.safeIntToChar(mappingFunction.applyAsInt(k));
...
/*  828 */     char newValue = mappingFunction.getChar(key);
...
/*  839 */     Character newValue = remappingFunction.apply(k, Character.valueOf(this.value[pos]));
/*  840 */     if (newValue == null) {
/*  841 */       if (k == null) { removeNullEntry(); }
/*  842 */       else { removeEntry(pos); }
/*  843 */        return this.defRetValue;
/*      */     } 
/*  845 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  852 */     int pos = find(k);
/*  853 */     Character newValue = remappingFunction.apply(k, (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  861 */     char newVal = newValue.charValue();
/*  862 */     if (pos < 0) {
...
/*  878 */        return v;
/*      */     } 
/*  880 */     Character newValue = remappingFunction.apply(Character.valueOf(this.value[pos]), Character.valueOf(v));
/*  881 */     if (newValue == null) {
/*  882 */       if (k == null) { removeNullEntry(); }
/*  883 */       else { removeEntry(pos); }
/*  884 */        return this.defRetValue;
/*      */     } 
/*  886 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  932 */       return Reference2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  937 */       return Reference2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  942 */       return Reference2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  947 */       return Reference2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  952 */       char oldValue = Reference2CharLinkedOpenHashMap.this.value[this.index];
/*  953 */       Reference2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  954 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceCharPair<K> right(char v) {
/*  959 */       Reference2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  960 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  971 */       return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  982 */       return Character.valueOf(setValue(v.charValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  989 */       Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
/*  990 */       return (Reference2CharLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  995 */       return System.identityHashCode(Reference2CharLinkedOpenHashMap.this.key[this.index]) ^ Reference2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1000 */       return (new StringBuilder()).append(Reference2CharLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2CharLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1168 */       this.next = Reference2CharLinkedOpenHashMap.this.first;
/* 1169 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1173 */       if (from == null) {
/* 1174 */         if (Reference2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1175 */           this.next = (int)Reference2CharLinkedOpenHashMap.this.link[Reference2CharLinkedOpenHashMap.this.n];
/* 1176 */           this.prev = Reference2CharLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1178 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1180 */       if (Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.last] == from) {
/* 1181 */         this.prev = Reference2CharLinkedOpenHashMap.this.last;
/* 1182 */         this.index = Reference2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1186 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1188 */       while (Reference2CharLinkedOpenHashMap.this.key[pos] != null) {
/* 1189 */         if (Reference2CharLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1191 */           this.next = (int)Reference2CharLinkedOpenHashMap.this.link[pos];
/* 1192 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1195 */         pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1214 */       if (this.next == -1) {
/* 1215 */         this.index = Reference2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1218 */       int pos = Reference2CharLinkedOpenHashMap.this.first;
/* 1219 */       this.index = 1;
/* 1220 */       while (pos != this.prev) {
/* 1221 */         pos = (int)Reference2CharLinkedOpenHashMap.this.link[pos];
/* 1222 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1239 */       this.next = (int)Reference2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1248 */       this.prev = (int)(Reference2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1257 */         this.next = (int)Reference2CharLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1270 */         this.index--;
/* 1271 */         this.prev = (int)(Reference2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1272 */       else { this.next = (int)Reference2CharLinkedOpenHashMap.this.link[this.curr]; }
/* 1273 */        Reference2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1276 */       if (this.prev == -1) { Reference2CharLinkedOpenHashMap.this.first = this.next; }
/* 1277 */       else { Reference2CharLinkedOpenHashMap.this.link[this.prev] = Reference2CharLinkedOpenHashMap.this.link[this.prev] ^ (Reference2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1278 */        if (this.next == -1) { Reference2CharLinkedOpenHashMap.this.last = this.prev; }
/* 1279 */       else { Reference2CharLinkedOpenHashMap.this.link[this.next] = Reference2CharLinkedOpenHashMap.this.link[this.next] ^ (Reference2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1280 */        int pos = this.curr;
/* 1281 */       this.curr = -1;
/* 1282 */       if (pos == Reference2CharLinkedOpenHashMap.this.n) {
/* 1283 */         Reference2CharLinkedOpenHashMap.this.containsNullKey = false;
/* 1284 */         Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1287 */         K[] key = Reference2CharLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1290 */           pos = (last = pos) + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1292 */             if ((curr = key[pos]) == null) {
/* 1293 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1296 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2CharLinkedOpenHashMap.this.mask;
/* 1297 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1298 */               break;  pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1300 */           key[last] = curr;
/* 1301 */           Reference2CharLinkedOpenHashMap.this.value[last] = Reference2CharLinkedOpenHashMap.this.value[pos];
/* 1302 */           if (this.next == pos) this.next = last; 
/* 1303 */           if (this.prev == pos) this.prev = last; 
/* 1304 */           Reference2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2CharMap.Entry<K>>> implements ObjectListIterator<Reference2CharMap.Entry<K>> {
...
/* 1343 */       action.accept(new Reference2CharLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2CharLinkedOpenHashMap<K>.MapEntry next() {
/* 1348 */       return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2CharLinkedOpenHashMap<K>.MapEntry previous() {
/* 1353 */       return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2CharMap.Entry<K>>> implements ObjectListIterator<Reference2CharMap.Entry<K>> {
/* 1364 */     final Reference2CharLinkedOpenHashMap<K>.MapEntry entry = new Reference2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1398 */       return new Reference2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1416 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1441 */       if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1442 */       return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2CharMap.Entry<K> last() {
/* 1447 */       if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1448 */       return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1456 */       if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1457 */       K k = (K)e.getKey();
/* 1458 */       char v = ((Character)e.getValue()).charValue();
/* 1459 */       if (k == null) return (Reference2CharLinkedOpenHashMap.this.containsNullKey && Reference2CharLinkedOpenHashMap.this.value[Reference2CharLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1461 */       K[] key = Reference2CharLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1464 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1465 */       if (k == curr) return (Reference2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1468 */         if ((curr = key[pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1469 */         if (k == curr) return (Reference2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1481 */       if (k == null) {
/* 1482 */         if (Reference2CharLinkedOpenHashMap.this.containsNullKey && Reference2CharLinkedOpenHashMap.this.value[Reference2CharLinkedOpenHashMap.this.n] == v) {
/* 1483 */           Reference2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1484 */           return true;
/*      */         } 
/* 1486 */         return false;
/*      */       } 
/*      */       
/* 1489 */       K[] key = Reference2CharLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1492 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1493 */       if (curr == k) {
/* 1494 */         if (Reference2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1495 */           Reference2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1496 */           return true;
/*      */         } 
/* 1498 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1501 */         if ((curr = key[pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1502 */         if (curr == k && 
/* 1503 */           Reference2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Reference2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1513 */       return Reference2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1518 */       Reference2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1531 */       return new Reference2CharLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1542 */       return new Reference2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1555 */       return new Reference2CharLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
/* 1561 */       for (int i = Reference2CharLinkedOpenHashMap.this.size, next = Reference2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1562 */         int curr = next;
/* 1563 */         next = (int)Reference2CharLinkedOpenHashMap.this.link[curr];
/* 1564 */         consumer.accept(new Reference2CharLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1571 */       Reference2CharLinkedOpenHashMap<K>.MapEntry entry = new Reference2CharLinkedOpenHashMap.MapEntry();
/* 1572 */       for (int i = Reference2CharLinkedOpenHashMap.this.size, next = Reference2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         entry.index = next;
/* 1574 */         next = (int)Reference2CharLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1601 */       return Reference2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1613 */       action.accept(Reference2CharLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1618 */       return Reference2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1627 */       return new Reference2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1632 */       return new Reference2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1642 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1648 */       for (int i = Reference2CharLinkedOpenHashMap.this.size, next = Reference2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1649 */         int curr = next;
/* 1650 */         next = (int)Reference2CharLinkedOpenHashMap.this.link[curr];
/* 1651 */         consumer.accept(Reference2CharLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1657 */       return Reference2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1662 */       return Reference2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1667 */       int oldSize = Reference2CharLinkedOpenHashMap.this.size;
/* 1668 */       Reference2CharLinkedOpenHashMap.this.removeChar(k);
/* 1669 */       return (Reference2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1674 */       Reference2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1679 */       if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1680 */       return Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1685 */       if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1686 */       return Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1727 */       return Reference2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1739 */       action.accept(Reference2CharLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1744 */       return Reference2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public CharCollection values() {
/* 1750 */     if (this.values == null) this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public CharIterator iterator() {
/* 1755 */             return (CharIterator)new Reference2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2CharLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1771 */             for (int i = Reference2CharLinkedOpenHashMap.this.size, next = Reference2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1772 */               int curr = next;
/* 1773 */               next = (int)Reference2CharLinkedOpenHashMap.this.link[curr];
/* 1774 */               consumer.accept(Reference2CharLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1780 */             return Reference2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1785 */             return Reference2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1790 */             Reference2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1854 */     K[] key = this.key;
/* 1855 */     char[] value = this.value;
/* 1856 */     int mask = newN - 1;
/* 1857 */     K[] newKey = (K[])new Object[newN + 1];
/* 1858 */     char[] newValue = new char[newN + 1];
...
/*      */     try {
/* 1910 */       c = (Reference2CharLinkedOpenHashMap<K>)super.clone();
...
/* 1919 */     c.value = (char[])this.value.clone();
...
/* 1967 */     char[] value = this.value = new char[this.n + 1];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharLinkedOpenHashMap.class
