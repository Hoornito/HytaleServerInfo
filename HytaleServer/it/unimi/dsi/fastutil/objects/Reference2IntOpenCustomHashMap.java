...
/*      */     
/*      */     public K getKey() {
/*  619 */       return Reference2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  624 */       return Reference2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  629 */       return Reference2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  634 */       return Reference2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  639 */       int oldValue = Reference2IntOpenCustomHashMap.this.value[this.index];
/*  640 */       Reference2IntOpenCustomHashMap.this.value[this.index] = v;
/*  641 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceIntPair<K> right(int v) {
/*  646 */       Reference2IntOpenCustomHashMap.this.value[this.index] = v;
/*  647 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  658 */       return Integer.valueOf(Reference2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  677 */       return (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  682 */       return Reference2IntOpenCustomHashMap.this.strategy.hashCode(Reference2IntOpenCustomHashMap.this.key[this.index]) ^ Reference2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  687 */       return (new StringBuilder()).append(Reference2IntOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2IntOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  698 */     int pos = Reference2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  704 */     int last = -1;
/*      */     
/*  706 */     int c = Reference2IntOpenCustomHashMap.this.size;
/*      */     
/*  708 */     boolean mustReturnNullKey = Reference2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  727 */         return this.last = Reference2IntOpenCustomHashMap.this.n;
/*      */       } 
/*  729 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  731 */         if (--this.pos < 0) {
/*      */           
/*  733 */           this.last = Integer.MIN_VALUE;
/*  734 */           K k = this.wrapped.get(-this.pos - 1);
/*  735 */           int p = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask;
/*  736 */           for (; !Reference2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2IntOpenCustomHashMap.this.mask);
/*  737 */           return p;
/*      */         } 
...
/*  746 */         acceptOnIndex(action, this.last = Reference2IntOpenCustomHashMap.this.n);
/*  747 */         this.c--;
/*      */       } 
...
/*  756 */           for (; !Reference2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2IntOpenCustomHashMap.this.mask);
...
/*  776 */       K[] key = Reference2IntOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  778 */         pos = (last = pos) + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  780 */           if ((curr = key[pos]) == null) {
/*  781 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  784 */           int slot = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2IntOpenCustomHashMap.this.mask;
/*  785 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  786 */             break;  pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  788 */         if (pos < last) {
...
/*      */         } 
/*  792 */         key[last] = curr;
/*  793 */         Reference2IntOpenCustomHashMap.this.value[last] = Reference2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  798 */       if (this.last == -1) throw new IllegalStateException(); 
/*  799 */       if (this.last == Reference2IntOpenCustomHashMap.this.n)
/*  800 */       { Reference2IntOpenCustomHashMap.this.containsNullKey = false;
/*  801 */         Reference2IntOpenCustomHashMap.this.key[Reference2IntOpenCustomHashMap.this.n] = null; }
/*  802 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  805 */       { Reference2IntOpenCustomHashMap.this.removeInt(this.wrapped.set(-this.pos - 1, null));
/*  806 */         this.last = -1;
/*      */         return; }
/*      */       
/*  809 */       Reference2IntOpenCustomHashMap.this.size--;
/*  810 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2IntMap.Entry<K>>> implements ObjectIterator<Reference2IntMap.Entry<K>> { public Reference2IntOpenCustomHashMap<K>.MapEntry next() {
/*  826 */       return this.entry = new Reference2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  832 */       action.accept(this.entry = new Reference2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  843 */       this.entry = new Reference2IntOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  864 */     int pos = 0;
/*      */     
/*  866 */     int max = Reference2IntOpenCustomHashMap.this.n;
/*      */     
/*  868 */     int c = 0;
/*      */     
/*  870 */     boolean mustReturnNull = Reference2IntOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  890 */         this.c++;
/*  891 */         acceptOnIndex(action, Reference2IntOpenCustomHashMap.this.n);
/*  892 */         return true;
/*      */       } 
/*  894 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
...
/*  909 */         this.c++;
/*  910 */         acceptOnIndex(action, Reference2IntOpenCustomHashMap.this.n);
/*      */       } 
/*  912 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
...
/*      */       {
/*  925 */         return (Reference2IntOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  930 */       return Math.min((Reference2IntOpenCustomHashMap.this.size - this.c), (long)(Reference2IntOpenCustomHashMap.this.realSize() / Reference2IntOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  958 */         n--;
/*      */       } 
/*  960 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2IntMap.Entry<K>> action, int index) {
/*  988 */       action.accept(new Reference2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1000 */       return new Reference2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
/* 1005 */       return new Reference2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2IntMap.Entry<K>> spliterator() {
/* 1010 */       return new Reference2IntOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1022 */       if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, null)) return (Reference2IntOpenCustomHashMap.this.containsNullKey && Reference2IntOpenCustomHashMap.this.value[Reference2IntOpenCustomHashMap.this.n] == v);
/*      */       
/* 1024 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1027 */       if ((curr = key[pos = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask]) == null) return false; 
/* 1028 */       if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1031 */         if ((curr = key[pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask]) == null) return false; 
/* 1032 */         if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1044 */       if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1045 */         if (Reference2IntOpenCustomHashMap.this.containsNullKey && Reference2IntOpenCustomHashMap.this.value[Reference2IntOpenCustomHashMap.this.n] == v) {
/* 1046 */           Reference2IntOpenCustomHashMap.this.removeNullEntry();
/* 1047 */           return true;
/*      */         } 
/* 1049 */         return false;
/*      */       } 
/*      */       
/* 1052 */       K[] key = Reference2IntOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1055 */       if ((curr = key[pos = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask]) == null) return false; 
/* 1056 */       if (Reference2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1057 */         if (Reference2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1058 */           Reference2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1059 */           return true;
/*      */         } 
/* 1061 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1064 */         if ((curr = key[pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask]) == null) return false; 
/* 1065 */         if (Reference2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1066 */           Reference2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1067 */           Reference2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1068 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1076 */       return Reference2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1081 */       Reference2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
/* 1087 */       if (Reference2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(new Reference2IntOpenCustomHashMap.MapEntry(Reference2IntOpenCustomHashMap.this.n)); 
/* 1088 */       for (int pos = Reference2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2IntOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Reference2IntOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
/* 1094 */       Reference2IntOpenCustomHashMap<K>.MapEntry entry = new Reference2IntOpenCustomHashMap.MapEntry();
/* 1095 */       if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
/* 1096 */         entry.index = Reference2IntOpenCustomHashMap.this.n;
/* 1097 */         consumer.accept(entry);
/*      */       } 
/* 1099 */       for (int pos = Reference2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2IntOpenCustomHashMap.this.key[pos] != null) {
...
/* 1130 */       action.accept(Reference2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1135 */       return Reference2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1156 */       action.accept(Reference2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1168 */       return new Reference2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1173 */       return new Reference2IntOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1179 */       if (Reference2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2IntOpenCustomHashMap.this.key[Reference2IntOpenCustomHashMap.this.n]); 
/* 1180 */       for (int pos = Reference2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1181 */         K k = Reference2IntOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1188 */       return Reference2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1193 */       return Reference2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1198 */       int oldSize = Reference2IntOpenCustomHashMap.this.size;
/* 1199 */       Reference2IntOpenCustomHashMap.this.removeInt(k);
/* 1200 */       return (Reference2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1205 */       Reference2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1233 */       action.accept(Reference2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1238 */       return Reference2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1259 */       action.accept(Reference2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1273 */             return new Reference2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1278 */             return new Reference2IntOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1284 */             if (Reference2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2IntOpenCustomHashMap.this.value[Reference2IntOpenCustomHashMap.this.n]); 
/* 1285 */             for (int pos = Reference2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2IntOpenCustomHashMap.this.key[pos] != null) consumer.accept(Reference2IntOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1290 */             return Reference2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1295 */             return Reference2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1300 */             Reference2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1398 */       c = (Reference2IntOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2IntOpenCustomHashMap.class
