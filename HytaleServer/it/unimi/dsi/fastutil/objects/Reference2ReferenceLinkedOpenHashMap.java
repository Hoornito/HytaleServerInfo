...
/*  726 */     if (k == curr && v == this.value[pos]) {
/*  727 */       removeEntry(pos);
/*  728 */       return true;
/*      */     } 
/*      */     while (true) {
/*  731 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  732 */       if (k == curr && v == this.value[pos]) {
/*  733 */         removeEntry(pos);
/*  734 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V>, ReferenceReferencePair<K, V>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  871 */       return Reference2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  876 */       return Reference2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  881 */       return Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  886 */       return Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  891 */       V oldValue = Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  892 */       Reference2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  893 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceReferencePair<K, V> right(V v) {
/*  898 */       Reference2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  899 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  907 */       return (Reference2ReferenceLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  912 */       return System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.key[this.index]) ^ ((Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  917 */       return (new StringBuilder()).append(Reference2ReferenceLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ReferenceLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1085 */       this.next = Reference2ReferenceLinkedOpenHashMap.this.first;
/* 1086 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1090 */       if (from == null) {
/* 1091 */         if (Reference2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1092 */           this.next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[Reference2ReferenceLinkedOpenHashMap.this.n];
/* 1093 */           this.prev = Reference2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1095 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1097 */       if (Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last] == from) {
/* 1098 */         this.prev = Reference2ReferenceLinkedOpenHashMap.this.last;
/* 1099 */         this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1103 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1105 */       while (Reference2ReferenceLinkedOpenHashMap.this.key[pos] != null) {
/* 1106 */         if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1108 */           this.next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1109 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1112 */         pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1131 */       if (this.next == -1) {
/* 1132 */         this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1135 */       int pos = Reference2ReferenceLinkedOpenHashMap.this.first;
/* 1136 */       this.index = 1;
/* 1137 */       while (pos != this.prev) {
/* 1138 */         pos = (int)Reference2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1139 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1156 */       this.next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1165 */       this.prev = (int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1174 */         this.next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1187 */         this.index--;
/* 1188 */         this.prev = (int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1189 */       else { this.next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1190 */        Reference2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1193 */       if (this.prev == -1) { Reference2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1194 */       else { Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] = Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1195 */        if (this.next == -1) { Reference2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1196 */       else { Reference2ReferenceLinkedOpenHashMap.this.link[this.next] = Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1197 */        int pos = this.curr;
/* 1198 */       this.curr = -1;
/* 1199 */       if (pos == Reference2ReferenceLinkedOpenHashMap.this.n) {
/* 1200 */         Reference2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1201 */         Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.n] = null;
/* 1202 */         Reference2ReferenceLinkedOpenHashMap.this.value[Reference2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1205 */         K[] key = Reference2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1208 */           pos = (last = pos) + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1210 */             if ((curr = key[pos]) == null) {
/* 1211 */               key[last] = null;
/* 1212 */               Reference2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1215 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/* 1216 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1217 */               break;  pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1219 */           key[last] = curr;
/* 1220 */           Reference2ReferenceLinkedOpenHashMap.this.value[last] = Reference2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1221 */           if (this.next == pos) this.next = last; 
/* 1222 */           if (this.prev == pos) this.prev = last; 
/* 1223 */           Reference2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>> implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>> {
...
/* 1262 */       action.accept(new Reference2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry next() {
/* 1267 */       return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry previous() {
/* 1272 */       return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>> implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>> {
/* 1283 */     final Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1317 */       return new Reference2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1335 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1360 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1361 */       return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2ReferenceMap.Entry<K, V> last() {
/* 1366 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1367 */       return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1377 */       if (k == null) return (Reference2ReferenceLinkedOpenHashMap.this.containsNullKey && Reference2ReferenceLinkedOpenHashMap.this.value[Reference2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1379 */       K[] key = Reference2ReferenceLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1382 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ReferenceLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1383 */       if (k == curr) return (Reference2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1386 */         if ((curr = key[pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1387 */         if (k == curr) return (Reference2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1398 */       if (k == null) {
/* 1399 */         if (Reference2ReferenceLinkedOpenHashMap.this.containsNullKey && Reference2ReferenceLinkedOpenHashMap.this.value[Reference2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1400 */           Reference2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1401 */           return true;
/*      */         } 
/* 1403 */         return false;
/*      */       } 
/*      */       
/* 1406 */       K[] key = Reference2ReferenceLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ReferenceLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1410 */       if (curr == k) {
/* 1411 */         if (Reference2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1412 */           Reference2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1413 */           return true;
/*      */         } 
/* 1415 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1418 */         if ((curr = key[pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1419 */         if (curr == k && 
/* 1420 */           Reference2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1421 */           Reference2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1422 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1430 */       return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1435 */       Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1448 */       return new Reference2ReferenceLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1459 */       return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1472 */       return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
/* 1478 */       for (int i = Reference2ReferenceLinkedOpenHashMap.this.size, next = Reference2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1479 */         int curr = next;
/* 1480 */         next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1481 */         consumer.accept(new Reference2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1488 */       Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry();
/* 1489 */       for (int i = Reference2ReferenceLinkedOpenHashMap.this.size, next = Reference2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1490 */         entry.index = next;
/* 1491 */         next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1518 */       return Reference2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       action.accept(Reference2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1535 */       return Reference2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1544 */       return new Reference2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1549 */       return new Reference2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1559 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1565 */       for (int i = Reference2ReferenceLinkedOpenHashMap.this.size, next = Reference2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1566 */         int curr = next;
/* 1567 */         next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1568 */         consumer.accept(Reference2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1574 */       return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1579 */       return Reference2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1584 */       int oldSize = Reference2ReferenceLinkedOpenHashMap.this.size;
/* 1585 */       Reference2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1586 */       return (Reference2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1591 */       Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1596 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1597 */       return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1602 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1603 */       return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1644 */       return Reference2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1656 */       action.accept(Reference2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1661 */       return Reference2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1672 */             return new Reference2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1682 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1688 */             for (int i = Reference2ReferenceLinkedOpenHashMap.this.size, next = Reference2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1689 */               int curr = next;
/* 1690 */               next = (int)Reference2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1691 */               consumer.accept(Reference2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1697 */             return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1702 */             return Reference2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1707 */             Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1827 */       c = (Reference2ReferenceLinkedOpenHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ReferenceLinkedOpenHashMap.class
