...
/*  652 */     while (j-- != 0) {
/*  653 */       float ev = i.nextFloat();
/*  654 */       if (Float.floatToIntBits(ev) == Float.floatToIntBits(v)) return true; 
/*      */     } 
/*  656 */     return false;
/*      */   }
/*      */ 
...
/*  882 */       Map.Entry<K, Float> e = (Map.Entry<K, Float>)o;
/*  883 */       return (Objects.equals(this.key, e.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  888 */       return this.key.hashCode() ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  993 */       this.next = Object2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  997 */       if ((this.next = Object2FloatAVLTreeMap.this.locateKey(k)) != null)
/*  998 */         if (Object2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1051 */       updatePrevious();
/* 1052 */       updateNext();
/* 1053 */       Object2FloatAVLTreeMap.this.removeFloat(this.curr.key);
/* 1054 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1108 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2FloatMap.Entry<Object2FloatMap.Entry<K>>>()
/*      */         {
...
/* 1118 */             return new Object2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/* 1123 */             return new Object2FloatAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1132 */             if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1133 */             Object2FloatAVLTreeMap.Entry<K> f = Object2FloatAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1143 */             if (!(e.getValue() instanceof Float)) return false; 
/* 1144 */             Object2FloatAVLTreeMap.Entry<K> f = Object2FloatAVLTreeMap.this.findKey((K)e.getKey());
/* 1145 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1146 */             Object2FloatAVLTreeMap.this.removeFloat(f.key);
/* 1147 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1152 */             return Object2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1157 */             Object2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2FloatMap.Entry<K> first() {
/* 1162 */             return Object2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2FloatMap.Entry<K> last() {
/* 1167 */             return Object2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) {
/* 1172 */             return Object2FloatAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
/* 1177 */             return Object2FloatAVLTreeMap.this.headMap(to.getKey()).object2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
/* 1182 */             return Object2FloatAVLTreeMap.this.tailMap(from.getKey()).object2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1219 */       return new Object2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1224 */       return new Object2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1274 */     if (this.values == null) this.values = (FloatCollection)new AbstractFloatCollection()
/*      */         {
/*      */           public FloatIterator iterator() {
/* 1277 */             return (FloatIterator)new Object2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1282 */             return Object2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1287 */             return Object2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1292 */             Object2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1354 */       if (!bottom && !top && Object2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1355 */       this.from = from;
/* 1356 */       this.bottom = bottom;
/* 1357 */       this.to = to;
/* 1358 */       this.top = top;
/* 1359 */       this.defRetValue = Object2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1378 */       return ((this.bottom || Object2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
/* 1383 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2FloatMap.Entry<Object2FloatMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator() {
/* 1386 */               return new Object2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/* 1391 */               return new Object2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2FloatMap.Entry<K>> comparator() {
/* 1396 */               return Object2FloatAVLTreeMap.this.object2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1405 */               Object2FloatAVLTreeMap.Entry<K> f = Object2FloatAVLTreeMap.this.findKey((K)e.getKey());
/* 1406 */               return (f != null && Object2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1414 */               if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1415 */               Object2FloatAVLTreeMap.Entry<K> f = Object2FloatAVLTreeMap.this.findKey((K)e.getKey());
/* 1416 */               if (f != null && Object2FloatAVLTreeMap.Submap.this.in(f.key)) Object2FloatAVLTreeMap.Submap.this.removeFloat(f.key); 
/* 1417 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1429 */               return !(new Object2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1434 */               Object2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2FloatMap.Entry<K> first() {
/* 1439 */               return Object2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2FloatMap.Entry<K> last() {
/* 1444 */               return Object2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) {
/* 1449 */               return Object2FloatAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
/* 1454 */               return Object2FloatAVLTreeMap.Submap.this.headMap(to.getKey()).object2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
/* 1459 */               return Object2FloatAVLTreeMap.Submap.this.tailMap(from.getKey()).object2FloatEntrySet();
/*      */             }
/*      */           }; 
/* 1462 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractObject2FloatSortedMap<K>.KeySet { private KeySet() {}
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1468 */         return new Object2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1473 */         return new Object2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public FloatCollection values() {
/* 1485 */       if (this.values == null) this.values = (FloatCollection)new AbstractFloatCollection()
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1488 */               return (FloatIterator)new Object2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1493 */               return Object2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1498 */               return Object2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1503 */               Object2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1513 */       return (in((K)k) && Object2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/* 1521 */         float ev = (i.nextEntry()).value;
/* 1522 */         if (Float.floatToIntBits(ev) == Float.floatToIntBits(v)) return true; 
/*      */       } 
/* 1524 */       return false;
/*      */     }
/*      */ 
...
/*      */     
/*      */     public float getFloat(Object k) {
/* 1531 */       K kk = (K)k; Object2FloatAVLTreeMap.Entry<K> e;
/* 1532 */       return (in(kk) && (e = Object2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(K k, float v) {
/* 1537 */       Object2FloatAVLTreeMap.this.modified = false;
...
/* 1539 */       float oldValue = Object2FloatAVLTreeMap.this.put(k, v);
/* 1540 */       return Object2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float removeFloat(Object k) {
/* 1546 */       Object2FloatAVLTreeMap.this.modified = false;
/* 1547 */       if (!in((K)k)) return this.defRetValue; 
/* 1548 */       float oldValue = Object2FloatAVLTreeMap.this.removeFloat(k);
/* 1549 */       return Object2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1570 */       return Object2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> headMap(K to) {
/* 1575 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1576 */       return (Object2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> tailMap(K from) {
/* 1581 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1582 */       return (Object2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> subMap(K from, K to) {
/* 1587 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1588 */       if (!this.top) to = (Object2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1589 */       if (!this.bottom) from = (Object2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1600 */       if (Object2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1604 */       if (this.bottom) { e = Object2FloatAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1606 */       { e = Object2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1608 */         if (Object2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1612 */       if (e == null || (!this.top && Object2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1613 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2FloatAVLTreeMap.Entry<K> e;
/* 1622 */       if (Object2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1626 */       if (this.top) { e = Object2FloatAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1628 */       { e = Object2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1630 */         if (Object2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1634 */       if (e == null || (!this.bottom && Object2FloatAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1635 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1640 */       Object2FloatAVLTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1647 */       Object2FloatAVLTreeMap.Entry<K> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1663 */         this.next = Object2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1667 */         this();
/* 1668 */         if (this.next != null) {
/* 1669 */           if (!Object2FloatAVLTreeMap.Submap.this.bottom && Object2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1670 */           else if (!Object2FloatAVLTreeMap.Submap.this.top && Object2FloatAVLTreeMap.this.compare(k, (this.prev = Object2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1672 */           { this.next = Object2FloatAVLTreeMap.this.locateKey(k);
/* 1673 */             if (Object2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1684 */         if (!Object2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Object2FloatAVLTreeMap.this.compare(this.prev.key, Object2FloatAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1689 */         this.next = this.next.next();
/* 1690 */         if (!Object2FloatAVLTreeMap.Submap.this.top && this.next != null && Object2FloatAVLTreeMap.this.compare(this.next.key, Object2FloatAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1778 */       c = (Object2FloatAVLTreeMap<K>)super.clone();
...
/* 1851 */     if (n == 1) {
/* 1852 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readFloat());
...
/*      */ 
/*      */       
/* 1860 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readFloat());
/* 1861 */       entry.right(new Entry<>((K)s.readObject(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatAVLTreeMap.class
