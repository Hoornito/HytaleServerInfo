...
/*  44 */     ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  45 */     return (entries instanceof Reference2LongMap.FastEntrySet) ? ((Reference2LongMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  61 */     if (entries instanceof Reference2LongMap.FastEntrySet) { ((Reference2LongMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  77 */     final ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  78 */     return (entries instanceof Reference2LongMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2LongMap.Entry<Reference2LongMap.Entry<K>>>()
/*     */       {
/*     */         public ObjectIterator<Reference2LongMap.Entry<K>> iterator() {
/*  81 */           return ((Reference2LongMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  91 */           ((Reference2LongMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  93 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 162 */       return Reference2LongMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
/* 245 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry<>(this.key, this.value)); 
...
/* 258 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     
/*     */     public int hashCode() {
/* 280 */       return System.identityHashCode(this.key) ^ HashCommon.long2int(this.value);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */     extends Reference2LongFunctions.SynchronizedFunction<K> implements Reference2LongMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 376 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Long>> entrySet() {
/* 390 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     extends Reference2LongFunctions.UnmodifiableFunction<K> implements Reference2LongMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2LongMap<? extends K> map;
/*     */     protected transient ObjectSet<Reference2LongMap.Entry<K>> entries;
/*     */     protected transient ReferenceSet<K> keys;
/*     */     protected transient LongCollection values;
/*     */     
/*     */     protected UnmodifiableMap(Reference2LongMap<? extends K> m) {
/* 655 */       super(m);
/* 656 */       this.map = m;
/*     */     }
/*     */ 
...
/*     */     
/*     */     public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
/* 683 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable((ObjectSet)this.map.reference2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Long>> entrySet() {
/* 696 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */ 
/*     */   
/*     */   public static <K> Reference2LongMap<K> unmodifiable(Reference2LongMap<? extends K> m) {
/* 880 */     return new UnmodifiableMap<>(m);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongMaps.class
