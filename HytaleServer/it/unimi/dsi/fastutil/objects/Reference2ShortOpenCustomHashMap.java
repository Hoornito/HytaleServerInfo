...
/*  108 */     this.value = new short[this.n + 1];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  234 */     short oldValue = this.value[pos];
/*  235 */     this.size--;
/*  236 */     shiftKeys(pos);
...
/*  244 */     short oldValue = this.value[this.n];
/*  245 */     this.size--;
...
/*      */     } 
/*  289 */     short oldValue = this.value[pos];
/*  290 */     this.value[pos] = v;
/*  291 */     return oldValue;
/*      */   }
/*      */   
/*      */   private short addToValue(int pos, short incr) {
/*  295 */     short oldValue = this.value[pos];
/*  296 */     this.value[pos] = (short)(oldValue + incr);
/*  297 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*  505 */     short newValue = SafeMath.safeIntToShort(mappingFunction.applyAsInt(k));
...
/*  517 */     short newValue = mappingFunction.getShort(key);
...
/*  528 */     Short newValue = remappingFunction.apply(k, Short.valueOf(this.value[pos]));
...
/*      */     } 
/*  534 */     this.value[pos] = newValue.shortValue(); return newValue.shortValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  541 */     int pos = find(k);
/*  542 */     Short newValue = remappingFunction.apply(k, (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  550 */     short newVal = newValue.shortValue();
/*  551 */     if (pos < 0) {
...
/*  567 */        return v;
/*      */     } 
/*  569 */     Short newValue = remappingFunction.apply(Short.valueOf(this.value[pos]), Short.valueOf(v));
...
/*      */     } 
/*  575 */     this.value[pos] = newValue.shortValue(); return newValue.shortValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  620 */       return Reference2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  625 */       return Reference2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  630 */       return Reference2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  635 */       return Reference2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  640 */       short oldValue = Reference2ShortOpenCustomHashMap.this.value[this.index];
/*  641 */       Reference2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  642 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceShortPair<K> right(short v) {
/*  647 */       Reference2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  648 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  659 */       return Short.valueOf(Reference2ShortOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short setValue(Short v) {
/*  670 */       return Short.valueOf(setValue(v.shortValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  677 */       Map.Entry<K, Short> e = (Map.Entry<K, Short>)o;
/*  678 */       return (Reference2ShortOpenCustomHashMap.this.strategy.equals(Reference2ShortOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  683 */       return Reference2ShortOpenCustomHashMap.this.strategy.hashCode(Reference2ShortOpenCustomHashMap.this.key[this.index]) ^ Reference2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  688 */       return (new StringBuilder()).append(Reference2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ShortOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  699 */     int pos = Reference2ShortOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  705 */     int last = -1;
/*      */     
/*  707 */     int c = Reference2ShortOpenCustomHashMap.this.size;
/*      */     
/*  709 */     boolean mustReturnNullKey = Reference2ShortOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  728 */         return this.last = Reference2ShortOpenCustomHashMap.this.n;
/*      */       } 
/*  730 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  732 */         if (--this.pos < 0) {
/*      */           
/*  734 */           this.last = Integer.MIN_VALUE;
/*  735 */           K k = this.wrapped.get(-this.pos - 1);
/*  736 */           int p = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask;
/*  737 */           for (; !Reference2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ShortOpenCustomHashMap.this.mask);
/*  738 */           return p;
/*      */         } 
...
/*  747 */         acceptOnIndex(action, this.last = Reference2ShortOpenCustomHashMap.this.n);
/*  748 */         this.c--;
/*      */       } 
/*  750 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
/*  751 */       while (this.c != 0) {
/*  752 */         if (--this.pos < 0) {
/*      */           
/*  754 */           this.last = Integer.MIN_VALUE;
/*  755 */           K k = this.wrapped.get(-this.pos - 1);
/*  756 */           int p = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask;
/*  757 */           for (; !Reference2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ShortOpenCustomHashMap.this.mask);
...
/*  777 */       K[] key = Reference2ShortOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  779 */         pos = (last = pos) + 1 & Reference2ShortOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  781 */           if ((curr = key[pos]) == null) {
/*  782 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  785 */           int slot = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ShortOpenCustomHashMap.this.mask;
/*  786 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  787 */             break;  pos = pos + 1 & Reference2ShortOpenCustomHashMap.this.mask;
/*      */         } 
/*  789 */         if (pos < last) {
...
/*      */         } 
/*  793 */         key[last] = curr;
/*  794 */         Reference2ShortOpenCustomHashMap.this.value[last] = Reference2ShortOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  799 */       if (this.last == -1) throw new IllegalStateException(); 
/*  800 */       if (this.last == Reference2ShortOpenCustomHashMap.this.n)
/*  801 */       { Reference2ShortOpenCustomHashMap.this.containsNullKey = false;
/*  802 */         Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n] = null; }
/*  803 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  806 */       { Reference2ShortOpenCustomHashMap.this.removeShort(this.wrapped.set(-this.pos - 1, null));
/*  807 */         this.last = -1;
/*      */         return; }
/*      */       
/*  810 */       Reference2ShortOpenCustomHashMap.this.size--;
/*  811 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ShortMap.Entry<K>>> implements ObjectIterator<Reference2ShortMap.Entry<K>> { public Reference2ShortOpenCustomHashMap<K>.MapEntry next() {
/*  827 */       return this.entry = new Reference2ShortOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  833 */       action.accept(this.entry = new Reference2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  844 */       this.entry = new Reference2ShortOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  865 */     int pos = 0;
/*      */     
/*  867 */     int max = Reference2ShortOpenCustomHashMap.this.n;
/*      */     
/*  869 */     int c = 0;
/*      */     
/*  871 */     boolean mustReturnNull = Reference2ShortOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  891 */         this.c++;
/*  892 */         acceptOnIndex(action, Reference2ShortOpenCustomHashMap.this.n);
/*  893 */         return true;
/*      */       } 
/*  895 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
...
/*  910 */         this.c++;
/*  911 */         acceptOnIndex(action, Reference2ShortOpenCustomHashMap.this.n);
/*      */       } 
/*  913 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
...
/*      */       {
/*  926 */         return (Reference2ShortOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  931 */       return Math.min((Reference2ShortOpenCustomHashMap.this.size - this.c), (long)(Reference2ShortOpenCustomHashMap.this.realSize() / Reference2ShortOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  959 */         n--;
/*      */       } 
/*  961 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2ShortMap.Entry<K>> action, int index) {
/*  989 */       action.accept(new Reference2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1001 */       return new Reference2ShortOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator() {
/* 1006 */       return new Reference2ShortOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2ShortMap.Entry<K>> spliterator() {
/* 1011 */       return new Reference2ShortOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1020 */       if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1021 */       K k = (K)e.getKey();
/* 1022 */       short v = ((Short)e.getValue()).shortValue();
/* 1023 */       if (Reference2ShortOpenCustomHashMap.this.strategy.equals(k, null)) return (Reference2ShortOpenCustomHashMap.this.containsNullKey && Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n] == v);
/*      */       
/* 1025 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1028 */       if ((curr = key[pos = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask]) == null) return false; 
/* 1029 */       if (Reference2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1032 */         if ((curr = key[pos = pos + 1 & Reference2ShortOpenCustomHashMap.this.mask]) == null) return false; 
/* 1033 */         if (Reference2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1042 */       if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1043 */       K k = (K)e.getKey();
/* 1044 */       short v = ((Short)e.getValue()).shortValue();
/* 1045 */       if (Reference2ShortOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1046 */         if (Reference2ShortOpenCustomHashMap.this.containsNullKey && Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n] == v) {
/* 1047 */           Reference2ShortOpenCustomHashMap.this.removeNullEntry();
/* 1048 */           return true;
/*      */         } 
/* 1050 */         return false;
/*      */       } 
/*      */       
/* 1053 */       K[] key = Reference2ShortOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1056 */       if ((curr = key[pos = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask]) == null) return false; 
/* 1057 */       if (Reference2ShortOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1058 */         if (Reference2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1059 */           Reference2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1060 */           return true;
/*      */         } 
/* 1062 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1065 */         if ((curr = key[pos = pos + 1 & Reference2ShortOpenCustomHashMap.this.mask]) == null) return false; 
/* 1066 */         if (Reference2ShortOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1067 */           Reference2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1068 */           Reference2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1069 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1077 */       return Reference2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1082 */       Reference2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
/* 1088 */       if (Reference2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(new Reference2ShortOpenCustomHashMap.MapEntry(Reference2ShortOpenCustomHashMap.this.n)); 
/* 1089 */       for (int pos = Reference2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ShortOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Reference2ShortOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
/* 1095 */       Reference2ShortOpenCustomHashMap<K>.MapEntry entry = new Reference2ShortOpenCustomHashMap.MapEntry();
/* 1096 */       if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
/* 1097 */         entry.index = Reference2ShortOpenCustomHashMap.this.n;
/* 1098 */         consumer.accept(entry);
/*      */       } 
/* 1100 */       for (int pos = Reference2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ShortOpenCustomHashMap.this.key[pos] != null) {
...
/* 1131 */       action.accept(Reference2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1136 */       return Reference2ShortOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1157 */       action.accept(Reference2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1169 */       return new Reference2ShortOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1174 */       return new Reference2ShortOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1180 */       if (Reference2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n]); 
/* 1181 */       for (int pos = Reference2ShortOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1182 */         K k = Reference2ShortOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1189 */       return Reference2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1194 */       return Reference2ShortOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1199 */       int oldSize = Reference2ShortOpenCustomHashMap.this.size;
/* 1200 */       Reference2ShortOpenCustomHashMap.this.removeShort(k);
/* 1201 */       return (Reference2ShortOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1206 */       Reference2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1234 */       action.accept(Reference2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1239 */       return Reference2ShortOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1260 */       action.accept(Reference2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1271 */     if (this.values == null) this.values = (ShortCollection)new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1274 */             return new Reference2ShortOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ShortSpliterator spliterator() {
/* 1279 */             return new Reference2ShortOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1285 */             if (Reference2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n]); 
/* 1286 */             for (int pos = Reference2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ShortOpenCustomHashMap.this.key[pos] != null) consumer.accept(Reference2ShortOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1291 */             return Reference2ShortOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1296 */             return Reference2ShortOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1301 */             Reference2ShortOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1365 */     K[] key = this.key;
/* 1366 */     short[] value = this.value;
/* 1367 */     int mask = newN - 1;
/* 1368 */     K[] newKey = (K[])new Object[newN + 1];
/* 1369 */     short[] newValue = new short[newN + 1];
/* 1370 */     int i = this.n;
...
/*      */     try {
/* 1399 */       c = (Reference2ShortOpenCustomHashMap<K>)super.clone();
...
/* 1408 */     c.value = (short[])this.value.clone();
...
/* 1456 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1459 */     for (int i = this.size; i-- != 0; ) {
/* 1460 */       int pos; K k = (K)s.readObject();
/* 1461 */       short v = s.readShort();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortOpenCustomHashMap.class
