...
/*      */ 
/*      */ 
/*      */ public class Object2ShortRBTreeMap<K>
...
/*  837 */       Map.Entry<K, Short> e = (Map.Entry<K, Short>)o;
/*  838 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Object2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  950 */       if ((this.next = Object2ShortRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Object2ShortRBTreeMap.this.removeShort(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ShortMap.Entry<Object2ShortMap.Entry<K>>>()
/*      */         {
...
/* 1061 */             return new Object2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) {
/* 1066 */             return new Object2ShortRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1075 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1076 */             Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
...
/* 1086 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1087 */             Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1088 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1089 */             Object2ShortRBTreeMap.this.removeShort(f.key);
/* 1090 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1095 */             return Object2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1100 */             Object2ShortRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ShortMap.Entry<K> first() {
/* 1105 */             return Object2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ShortMap.Entry<K> last() {
/* 1110 */             return Object2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> to) {
/* 1115 */             return Object2ShortRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> to) {
/* 1120 */             return Object2ShortRBTreeMap.this.headMap(to.getKey()).object2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from) {
/* 1125 */             return Object2ShortRBTreeMap.this.tailMap(from.getKey()).object2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1162 */       return new Object2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1167 */       return new Object2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1217 */     if (this.values == null) this.values = (ShortCollection)new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1220 */             return (ShortIterator)new Object2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1225 */             return Object2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1230 */             return Object2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1235 */             Object2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1297 */       if (!bottom && !top && Object2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1298 */       this.from = from;
/* 1299 */       this.bottom = bottom;
/* 1300 */       this.to = to;
/* 1301 */       this.top = top;
/* 1302 */       this.defRetValue = Object2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1321 */       return ((this.bottom || Object2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ShortRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
/* 1326 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ShortMap.Entry<Object2ShortMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator() {
/* 1329 */               return new Object2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) {
/* 1334 */               return new Object2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2ShortMap.Entry<K>> comparator() {
/* 1339 */               return Object2ShortRBTreeMap.this.object2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1347 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1348 */               Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1349 */               return (f != null && Object2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1358 */               Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1359 */               if (f != null && Object2ShortRBTreeMap.Submap.this.in(f.key)) Object2ShortRBTreeMap.Submap.this.removeShort(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Object2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Object2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ShortMap.Entry<K> first() {
/* 1382 */               return Object2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ShortMap.Entry<K> last() {
/* 1387 */               return Object2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> to) {
/* 1392 */               return Object2ShortRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> to) {
/* 1397 */               return Object2ShortRBTreeMap.Submap.this.headMap(to.getKey()).object2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from) {
/* 1402 */               return Object2ShortRBTreeMap.Submap.this.tailMap(from.getKey()).object2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1411 */         return new Object2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1416 */         return new Object2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ShortCollection values() {
/* 1428 */       if (this.values == null) this.values = (ShortCollection)new AbstractShortCollection()
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1431 */               return (ShortIterator)new Object2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1436 */               return Object2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Object2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Object2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1456 */       return (in((K)k) && Object2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short getShort(Object k) {
/* 1474 */       K kk = (K)k; Object2ShortRBTreeMap.Entry<K> e;
/* 1475 */       return (in(kk) && (e = Object2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(K k, short v) {
/* 1480 */       Object2ShortRBTreeMap.this.modified = false;
...
/* 1482 */       short oldValue = Object2ShortRBTreeMap.this.put(k, v);
/* 1483 */       return Object2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short removeShort(Object k) {
/* 1489 */       Object2ShortRBTreeMap.this.modified = false;
/* 1490 */       if (!in((K)k)) return this.defRetValue; 
/* 1491 */       short oldValue = Object2ShortRBTreeMap.this.removeShort(k);
/* 1492 */       return Object2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1513 */       return Object2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ShortSortedMap<K> headMap(K to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Object2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ShortSortedMap<K> tailMap(K from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Object2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ShortSortedMap<K> subMap(K from, K to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Object2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Object2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Object2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Object2ShortRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Object2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2ShortRBTreeMap.Entry<K> e;
/* 1565 */       if (Object2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Object2ShortRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Object2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1583 */       Object2ShortRBTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1590 */       Object2ShortRBTreeMap.Entry<K> e = lastEntry();
...
/*      */       extends Object2ShortRBTreeMap<K>.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Object2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Object2ShortRBTreeMap.Submap.this.bottom && Object2ShortRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Object2ShortRBTreeMap.Submap.this.top && Object2ShortRBTreeMap.this.compare(k, (this.prev = Object2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Object2ShortRBTreeMap.this.locateKey(k);
/* 1616 */             if (Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Object2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Object2ShortRBTreeMap.this.compare(this.prev.key, Object2ShortRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Object2ShortRBTreeMap.Submap.this.top && this.next != null && Object2ShortRBTreeMap.this.compare(this.next.key, Object2ShortRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Object2ShortRBTreeMap<K>)super.clone();
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readShort());
...
/*      */ 
/*      */       
/* 1804 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readShort());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry<>((K)s.readObject(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ShortRBTreeMap.class
