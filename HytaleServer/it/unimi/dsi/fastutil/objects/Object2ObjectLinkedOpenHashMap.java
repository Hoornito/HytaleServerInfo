...
/*  726 */     if (k.equals(curr) && Objects.equals(v, this.value[pos])) {
/*  727 */       removeEntry(pos);
/*  728 */       return true;
/*      */     } 
/*      */     while (true) {
/*  731 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  732 */       if (k.equals(curr) && Objects.equals(v, this.value[pos])) {
/*  733 */         removeEntry(pos);
/*  734 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  871 */       return Object2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  876 */       return Object2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  881 */       return Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  886 */       return Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  891 */       V oldValue = Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*  892 */       Object2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  893 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public Pair<K, V> right(V v) {
/*  898 */       Object2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  899 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  907 */       return (Objects.equals(Object2ObjectLinkedOpenHashMap.this.key[this.index], e.getKey()) && Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  912 */       return ((Object2ObjectLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2ObjectLinkedOpenHashMap.this.key[this.index].hashCode()) ^ ((Object2ObjectLinkedOpenHashMap.this.value[this.index] == null) ? 0 : Object2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  917 */       return (new StringBuilder()).append(Object2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1085 */       this.next = Object2ObjectLinkedOpenHashMap.this.first;
/* 1086 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1090 */       if (from == null) {
/* 1091 */         if (Object2ObjectLinkedOpenHashMap.this.containsNullKey) {
/* 1092 */           this.next = (int)Object2ObjectLinkedOpenHashMap.this.link[Object2ObjectLinkedOpenHashMap.this.n];
/* 1093 */           this.prev = Object2ObjectLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1095 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1097 */       if (Objects.equals(Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last], from)) {
/* 1098 */         this.prev = Object2ObjectLinkedOpenHashMap.this.last;
/* 1099 */         this.index = Object2ObjectLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1103 */       int pos = HashCommon.mix(from.hashCode()) & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */       
/* 1105 */       while (Object2ObjectLinkedOpenHashMap.this.key[pos] != null) {
/* 1106 */         if (Object2ObjectLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1108 */           this.next = (int)Object2ObjectLinkedOpenHashMap.this.link[pos];
/* 1109 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1112 */         pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1131 */       if (this.next == -1) {
/* 1132 */         this.index = Object2ObjectLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1135 */       int pos = Object2ObjectLinkedOpenHashMap.this.first;
/* 1136 */       this.index = 1;
/* 1137 */       while (pos != this.prev) {
/* 1138 */         pos = (int)Object2ObjectLinkedOpenHashMap.this.link[pos];
/* 1139 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1156 */       this.next = (int)Object2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/* 1165 */       this.prev = (int)(Object2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1174 */         this.next = (int)Object2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1187 */         this.index--;
/* 1188 */         this.prev = (int)(Object2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1189 */       else { this.next = (int)Object2ObjectLinkedOpenHashMap.this.link[this.curr]; }
/* 1190 */        Object2ObjectLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1193 */       if (this.prev == -1) { Object2ObjectLinkedOpenHashMap.this.first = this.next; }
/* 1194 */       else { Object2ObjectLinkedOpenHashMap.this.link[this.prev] = Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1195 */        if (this.next == -1) { Object2ObjectLinkedOpenHashMap.this.last = this.prev; }
/* 1196 */       else { Object2ObjectLinkedOpenHashMap.this.link[this.next] = Object2ObjectLinkedOpenHashMap.this.link[this.next] ^ (Object2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1197 */        int pos = this.curr;
/* 1198 */       this.curr = -1;
/* 1199 */       if (pos == Object2ObjectLinkedOpenHashMap.this.n) {
/* 1200 */         Object2ObjectLinkedOpenHashMap.this.containsNullKey = false;
/* 1201 */         Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.n] = null;
/* 1202 */         Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1205 */         K[] key = Object2ObjectLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1208 */           pos = (last = pos) + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1210 */             if ((curr = key[pos]) == null) {
/* 1211 */               key[last] = null;
/* 1212 */               Object2ObjectLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1215 */             int slot = HashCommon.mix(curr.hashCode()) & Object2ObjectLinkedOpenHashMap.this.mask;
/* 1216 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1217 */               break;  pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1219 */           key[last] = curr;
/* 1220 */           Object2ObjectLinkedOpenHashMap.this.value[last] = Object2ObjectLinkedOpenHashMap.this.value[pos];
/* 1221 */           if (this.next == pos) this.next = last; 
/* 1222 */           if (this.prev == pos) this.prev = last; 
/* 1223 */           Object2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1262 */       action.accept(new Object2ObjectLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectLinkedOpenHashMap<K, V>.MapEntry next() {
/* 1267 */       return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectLinkedOpenHashMap<K, V>.MapEntry previous() {
/* 1272 */       return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1283 */     final Object2ObjectLinkedOpenHashMap<K, V>.MapEntry entry = new Object2ObjectLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1317 */       return new Object2ObjectLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1335 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1360 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1361 */       return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ObjectMap.Entry<K, V> last() {
/* 1366 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1367 */       return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1377 */       if (k == null) return (Object2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n], v));
/*      */       
/* 1379 */       K[] key = Object2ObjectLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1382 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1383 */       if (k.equals(curr)) return Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/* 1386 */         if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1387 */         if (k.equals(curr)) return Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1398 */       if (k == null) {
/* 1399 */         if (Object2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[Object2ObjectLinkedOpenHashMap.this.n], v)) {
/* 1400 */           Object2ObjectLinkedOpenHashMap.this.removeNullEntry();
/* 1401 */           return true;
/*      */         } 
/* 1403 */         return false;
/*      */       } 
/*      */       
/* 1406 */       K[] key = Object2ObjectLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1410 */       if (curr.equals(k)) {
/* 1411 */         if (Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1412 */           Object2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1413 */           return true;
/*      */         } 
/* 1415 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1418 */         if ((curr = key[pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1419 */         if (curr.equals(k) && 
/* 1420 */           Objects.equals(Object2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1421 */           Object2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1422 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1430 */       return Object2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1435 */       Object2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1448 */       return new Object2ObjectLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1459 */       return new Object2ObjectLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1472 */       return new Object2ObjectLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
/* 1478 */       for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1479 */         int curr = next;
/* 1480 */         next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1481 */         consumer.accept(new Object2ObjectLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1488 */       Object2ObjectLinkedOpenHashMap<K, V>.MapEntry entry = new Object2ObjectLinkedOpenHashMap.MapEntry();
/* 1489 */       for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1490 */         entry.index = next;
/* 1491 */         next = (int)Object2ObjectLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1518 */       return Object2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       action.accept(Object2ObjectLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1535 */       return Object2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1544 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1549 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1559 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1565 */       for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1566 */         int curr = next;
/* 1567 */         next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1568 */         consumer.accept(Object2ObjectLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1574 */       return Object2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1579 */       return Object2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1584 */       int oldSize = Object2ObjectLinkedOpenHashMap.this.size;
/* 1585 */       Object2ObjectLinkedOpenHashMap.this.remove(k);
/* 1586 */       return (Object2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1591 */       Object2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1596 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1597 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1602 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1603 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1644 */       return Object2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1656 */       action.accept(Object2ObjectLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1661 */       return Object2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1672 */             return new Object2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1682 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2ObjectLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1688 */             for (int i = Object2ObjectLinkedOpenHashMap.this.size, next = Object2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1689 */               int curr = next;
/* 1690 */               next = (int)Object2ObjectLinkedOpenHashMap.this.link[curr];
/* 1691 */               consumer.accept(Object2ObjectLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1697 */             return Object2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1702 */             return Object2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1707 */             Object2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1827 */       c = (Object2ObjectLinkedOpenHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectLinkedOpenHashMap.class
