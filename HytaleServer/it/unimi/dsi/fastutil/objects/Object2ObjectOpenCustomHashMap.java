...
/*      */     
/*      */     public K getKey() {
/*  567 */       return Object2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  572 */       return Object2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  577 */       return Object2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  582 */       return Object2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  587 */       V oldValue = Object2ObjectOpenCustomHashMap.this.value[this.index];
/*  588 */       Object2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  589 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public Pair<K, V> right(V v) {
/*  594 */       Object2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  595 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  603 */       return (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], e.getKey()) && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  608 */       return Object2ObjectOpenCustomHashMap.this.strategy.hashCode(Object2ObjectOpenCustomHashMap.this.key[this.index]) ^ ((Object2ObjectOpenCustomHashMap.this.value[this.index] == null) ? 0 : Object2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  613 */       return (new StringBuilder()).append(Object2ObjectOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ObjectOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  624 */     int pos = Object2ObjectOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  630 */     int last = -1;
/*      */     
/*  632 */     int c = Object2ObjectOpenCustomHashMap.this.size;
/*      */     
/*  634 */     boolean mustReturnNullKey = Object2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  653 */         return this.last = Object2ObjectOpenCustomHashMap.this.n;
/*      */       } 
/*  655 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  657 */         if (--this.pos < 0) {
/*      */           
/*  659 */           this.last = Integer.MIN_VALUE;
/*  660 */           K k = this.wrapped.get(-this.pos - 1);
/*  661 */           int p = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask;
/*  662 */           for (; !Object2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Object2ObjectOpenCustomHashMap.this.mask);
/*  663 */           return p;
/*      */         } 
...
/*  672 */         acceptOnIndex(action, this.last = Object2ObjectOpenCustomHashMap.this.n);
/*  673 */         this.c--;
/*      */       } 
/*  675 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
/*  676 */       while (this.c != 0) {
/*  677 */         if (--this.pos < 0) {
/*      */           
/*  679 */           this.last = Integer.MIN_VALUE;
/*  680 */           K k = this.wrapped.get(-this.pos - 1);
/*  681 */           int p = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask;
/*  682 */           for (; !Object2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Object2ObjectOpenCustomHashMap.this.mask);
...
/*  702 */       K[] key = Object2ObjectOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  704 */         pos = (last = pos) + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  706 */           if ((curr = key[pos]) == null) {
/*  707 */             key[last] = null;
/*  708 */             Object2ObjectOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  711 */           int slot = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ObjectOpenCustomHashMap.this.mask;
/*  712 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  713 */             break;  pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*      */         } 
/*  715 */         if (pos < last) {
...
/*      */         } 
/*  719 */         key[last] = curr;
/*  720 */         Object2ObjectOpenCustomHashMap.this.value[last] = Object2ObjectOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  725 */       if (this.last == -1) throw new IllegalStateException(); 
/*  726 */       if (this.last == Object2ObjectOpenCustomHashMap.this.n)
/*  727 */       { Object2ObjectOpenCustomHashMap.this.containsNullKey = false;
/*  728 */         Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n] = null;
/*  729 */         Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n] = null; }
/*  730 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  733 */       { Object2ObjectOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
/*  734 */         this.last = -1;
/*      */         return; }
/*      */       
/*  737 */       Object2ObjectOpenCustomHashMap.this.size--;
/*  738 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2ObjectMap.Entry<K, V>>> implements ObjectIterator<Object2ObjectMap.Entry<K, V>> { public Object2ObjectOpenCustomHashMap<K, V>.MapEntry next() {
/*  754 */       return this.entry = new Object2ObjectOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  760 */       action.accept(this.entry = new Object2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  771 */       this.entry = new Object2ObjectOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  792 */     int pos = 0;
/*      */     
/*  794 */     int max = Object2ObjectOpenCustomHashMap.this.n;
/*      */     
/*  796 */     int c = 0;
/*      */     
/*  798 */     boolean mustReturnNull = Object2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  818 */         this.c++;
/*  819 */         acceptOnIndex(action, Object2ObjectOpenCustomHashMap.this.n);
/*  820 */         return true;
/*      */       } 
/*  822 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
...
/*  837 */         this.c++;
/*  838 */         acceptOnIndex(action, Object2ObjectOpenCustomHashMap.this.n);
/*      */       } 
/*  840 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
...
/*      */       {
/*  853 */         return (Object2ObjectOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  858 */       return Math.min((Object2ObjectOpenCustomHashMap.this.size - this.c), (long)(Object2ObjectOpenCustomHashMap.this.realSize() / Object2ObjectOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  886 */         n--;
/*      */       } 
/*  888 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Object2ObjectMap.Entry<K, V>> action, int index) {
/*  916 */       action.accept(new Object2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  928 */       return new Object2ObjectOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator() {
/*  933 */       return new Object2ObjectOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Object2ObjectMap.Entry<K, V>> spliterator() {
/*  938 */       return new Object2ObjectOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  949 */       if (Object2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) return (Object2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n], v));
/*      */       
/*  951 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  954 */       if ((curr = key[pos = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask]) == null) return false; 
/*  955 */       if (Object2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Object2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  958 */         if ((curr = key[pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask]) == null) return false; 
/*  959 */         if (Object2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Object2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  970 */       if (Object2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  971 */         if (Object2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n], v)) {
/*  972 */           Object2ObjectOpenCustomHashMap.this.removeNullEntry();
/*  973 */           return true;
/*      */         } 
/*  975 */         return false;
/*      */       } 
/*      */       
/*  978 */       K[] key = Object2ObjectOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  981 */       if ((curr = key[pos = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask]) == null) return false; 
/*  982 */       if (Object2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  983 */         if (Objects.equals(Object2ObjectOpenCustomHashMap.this.value[pos], v)) {
/*  984 */           Object2ObjectOpenCustomHashMap.this.removeEntry(pos);
/*  985 */           return true;
/*      */         } 
/*  987 */         return false;
/*      */       } 
/*      */       while (true) {
/*  990 */         if ((curr = key[pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask]) == null) return false; 
/*  991 */         if (Object2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  992 */           Objects.equals(Object2ObjectOpenCustomHashMap.this.value[pos], v)) {
/*  993 */           Object2ObjectOpenCustomHashMap.this.removeEntry(pos);
/*  994 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1002 */       return Object2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1007 */       Object2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
/* 1013 */       if (Object2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(new Object2ObjectOpenCustomHashMap.MapEntry(Object2ObjectOpenCustomHashMap.this.n)); 
/* 1014 */       for (int pos = Object2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Object2ObjectOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
/* 1020 */       Object2ObjectOpenCustomHashMap<K, V>.MapEntry entry = new Object2ObjectOpenCustomHashMap.MapEntry();
/* 1021 */       if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
/* 1022 */         entry.index = Object2ObjectOpenCustomHashMap.this.n;
/* 1023 */         consumer.accept(entry);
/*      */       } 
/* 1025 */       for (int pos = Object2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenCustomHashMap.this.key[pos] != null) {
...
/* 1056 */       action.accept(Object2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1061 */       return Object2ObjectOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1082 */       action.accept(Object2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1094 */       return new Object2ObjectOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1099 */       return new Object2ObjectOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1105 */       if (Object2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n]); 
/* 1106 */       for (int pos = Object2ObjectOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1107 */         K k = Object2ObjectOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1114 */       return Object2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1119 */       return Object2ObjectOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1124 */       int oldSize = Object2ObjectOpenCustomHashMap.this.size;
/* 1125 */       Object2ObjectOpenCustomHashMap.this.remove(k);
/* 1126 */       return (Object2ObjectOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1131 */       Object2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1159 */       action.accept(Object2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1164 */       return Object2ObjectOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1185 */       action.accept(Object2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1199 */             return new Object2ObjectOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1204 */             return new Object2ObjectOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1210 */             if (Object2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n]); 
/* 1211 */             for (int pos = Object2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Object2ObjectOpenCustomHashMap.this.key[pos] != null) consumer.accept(Object2ObjectOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1216 */             return Object2ObjectOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1221 */             return Object2ObjectOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1226 */             Object2ObjectOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1324 */       c = (Object2ObjectOpenCustomHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectOpenCustomHashMap.class
