...
/*  63 */     ObjectIterator<Reference2ByteMap.Entry<K>> i = reference2ByteEntrySet().iterator();
/*  64 */     while (i.hasNext()) { if (((Reference2ByteMap.Entry)i.next()).getKey() == k) return true;  }
/*  65 */      return false;
/*     */   }
/*     */ 
/*     */ 
...
/*  83 */     ObjectIterator<Reference2ByteMap.Entry<K>> i = reference2ByteEntrySet().iterator();
/*  84 */     while (i.hasNext()) { if (((Reference2ByteMap.Entry)i.next()).getByteValue() == v) return true;  }
/*  85 */      return false;
/*     */   }
/*     */ 
/*     */   
...
/* 137 */       if (o instanceof Reference2ByteMap.Entry) {
/* 138 */         Reference2ByteMap.Entry<K> entry = (Reference2ByteMap.Entry<K>)o;
/* 139 */         return (this.key == entry.getKey() && this.value == entry.getByteValue());
/*     */       } 
...
/* 145 */       return (this.key == key && this.value == ((Byte)value).byteValue());
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/* 174 */       if (o instanceof Reference2ByteMap.Entry) {
/* 175 */         Reference2ByteMap.Entry<K> entry = (Reference2ByteMap.Entry<K>)o;
...
/* 190 */       if (o instanceof Reference2ByteMap.Entry) {
/* 191 */         Reference2ByteMap.Entry<K> entry = (Reference2ByteMap.Entry<K>)o;
...
/* 230 */           return AbstractReference2ByteMap.this.containsKey(k);
/*     */         }
/*     */ 
/*     */         
/*     */         public int size() {
/* 235 */           return AbstractReference2ByteMap.this.size();
/*     */         }
/*     */ 
/*     */         
/*     */         public void clear() {
/* 240 */           AbstractReference2ByteMap.this.clear();
/*     */         }
/*     */ 
/*     */         
/*     */         public ObjectIterator<K> iterator() {
/* 245 */           return new ObjectIterator<K>() {
/* 246 */               private final ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator(AbstractReference2ByteMap.this);
/*     */ 
/*     */               
/*     */               public K next() {
/* 250 */                 return ((Reference2ByteMap.Entry<K>)this.i.next()).getKey();
/*     */               }
/*     */ 
/*     */               
...
/* 272 */           return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractReference2ByteMap.this), 65);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 294 */           return AbstractReference2ByteMap.this.containsValue(k);
/*     */         }
/*     */ 
/*     */         
/*     */         public int size() {
/* 299 */           return AbstractReference2ByteMap.this.size();
/*     */         }
/*     */ 
/*     */         
/*     */         public void clear() {
/* 304 */           AbstractReference2ByteMap.this.clear();
/*     */         }
/*     */ 
/*     */         
/*     */         public ByteIterator iterator() {
/* 309 */           return new ByteIterator() {
/* 310 */               private final ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator(AbstractReference2ByteMap.this);
/*     */ 
/*     */               
/*     */               public byte nextByte() {
/* 314 */                 return ((Reference2ByteMap.Entry)this.i.next()).getByteValue();
/*     */               }
/*     */ 
/*     */               
/*     */               public boolean hasNext() {
...
/* 336 */           return ByteSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractReference2ByteMap.this), 320);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 345 */     if (m instanceof Reference2ByteMap) {
/* 346 */       ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator((Reference2ByteMap)m);
/* 347 */       while (i.hasNext()) {
/* 348 */         Reference2ByteMap.Entry<? extends K> e = i.next();
...
/*     */   public int hashCode() {
/* 371 */     int h = 0, n = size();
/* 372 */     ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator(this);
/* 373 */     for (; n-- != 0; h += ((Reference2ByteMap.Entry)i.next()).hashCode());
/* 374 */     return h;
/*     */   }
/*     */ 
/*     */   
...
/* 383 */     return reference2ByteEntrySet().containsAll(m.entrySet());
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 388 */     StringBuilder s = new StringBuilder();
/* 389 */     ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator(this);
/* 390 */     int n = size();
/*     */     
...
/* 396 */       else { s.append(", "); }
/* 397 */        Reference2ByteMap.Entry<K> e = i.next();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\AbstractReference2ByteMap.class
