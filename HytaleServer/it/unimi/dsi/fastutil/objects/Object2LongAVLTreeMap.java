...
/*  882 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  883 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  888 */       return this.key.hashCode() ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  993 */       this.next = Object2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  997 */       if ((this.next = Object2LongAVLTreeMap.this.locateKey(k)) != null)
/*  998 */         if (Object2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1051 */       updatePrevious();
/* 1052 */       updateNext();
/* 1053 */       Object2LongAVLTreeMap.this.removeLong(this.curr.key);
/* 1054 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1108 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */         {
...
/* 1118 */             return new Object2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1123 */             return new Object2LongAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1132 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1133 */             Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1143 */             if (!(e.getValue() instanceof Long)) return false; 
/* 1144 */             Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1145 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1146 */             Object2LongAVLTreeMap.this.removeLong(f.key);
/* 1147 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1152 */             return Object2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1157 */             Object2LongAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2LongMap.Entry<K> first() {
/* 1162 */             return Object2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2LongMap.Entry<K> last() {
/* 1167 */             return Object2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1172 */             return Object2LongAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1177 */             return Object2LongAVLTreeMap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1182 */             return Object2LongAVLTreeMap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1219 */       return new Object2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1224 */       return new Object2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1277 */             return (LongIterator)new Object2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1282 */             return Object2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1287 */             return Object2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1292 */             Object2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1354 */       if (!bottom && !top && Object2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1355 */       this.from = from;
/* 1356 */       this.bottom = bottom;
/* 1357 */       this.to = to;
/* 1358 */       this.top = top;
/* 1359 */       this.defRetValue = Object2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1378 */       return ((this.bottom || Object2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 1383 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/* 1386 */               return new Object2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1391 */               return new Object2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2LongMap.Entry<K>> comparator() {
/* 1396 */               return Object2LongAVLTreeMap.this.object2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1405 */               Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1406 */               return (f != null && Object2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1414 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1415 */               Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1416 */               if (f != null && Object2LongAVLTreeMap.Submap.this.in(f.key)) Object2LongAVLTreeMap.Submap.this.removeLong(f.key); 
/* 1417 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1429 */               return !(new Object2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1434 */               Object2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2LongMap.Entry<K> first() {
/* 1439 */               return Object2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2LongMap.Entry<K> last() {
/* 1444 */               return Object2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1449 */               return Object2LongAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1454 */               return Object2LongAVLTreeMap.Submap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1459 */               return Object2LongAVLTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1468 */         return new Object2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1473 */         return new Object2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public LongCollection values() {
/* 1485 */       if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1488 */               return (LongIterator)new Object2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1493 */               return Object2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1498 */               return Object2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1503 */               Object2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1513 */       return (in((K)k) && Object2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1521 */         long ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public long getLong(Object k) {
/* 1531 */       K kk = (K)k; Object2LongAVLTreeMap.Entry<K> e;
/* 1532 */       return (in(kk) && (e = Object2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(K k, long v) {
/* 1537 */       Object2LongAVLTreeMap.this.modified = false;
...
/* 1539 */       long oldValue = Object2LongAVLTreeMap.this.put(k, v);
/* 1540 */       return Object2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long removeLong(Object k) {
/* 1546 */       Object2LongAVLTreeMap.this.modified = false;
/* 1547 */       if (!in((K)k)) return this.defRetValue; 
/* 1548 */       long oldValue = Object2LongAVLTreeMap.this.removeLong(k);
/* 1549 */       return Object2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1570 */       return Object2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> headMap(K to) {
/* 1575 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1576 */       return (Object2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> tailMap(K from) {
/* 1581 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1582 */       return (Object2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> subMap(K from, K to) {
/* 1587 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1588 */       if (!this.top) to = (Object2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1589 */       if (!this.bottom) from = (Object2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1600 */       if (Object2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1604 */       if (this.bottom) { e = Object2LongAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1606 */       { e = Object2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1608 */         if (Object2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1612 */       if (e == null || (!this.top && Object2LongAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1613 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2LongAVLTreeMap.Entry<K> e;
/* 1622 */       if (Object2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1626 */       if (this.top) { e = Object2LongAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1628 */       { e = Object2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1630 */         if (Object2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1634 */       if (e == null || (!this.bottom && Object2LongAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1635 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1640 */       Object2LongAVLTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1647 */       Object2LongAVLTreeMap.Entry<K> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1663 */         this.next = Object2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1667 */         this();
/* 1668 */         if (this.next != null) {
/* 1669 */           if (!Object2LongAVLTreeMap.Submap.this.bottom && Object2LongAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1670 */           else if (!Object2LongAVLTreeMap.Submap.this.top && Object2LongAVLTreeMap.this.compare(k, (this.prev = Object2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1672 */           { this.next = Object2LongAVLTreeMap.this.locateKey(k);
/* 1673 */             if (Object2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1684 */         if (!Object2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Object2LongAVLTreeMap.this.compare(this.prev.key, Object2LongAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1689 */         this.next = this.next.next();
/* 1690 */         if (!Object2LongAVLTreeMap.Submap.this.top && this.next != null && Object2LongAVLTreeMap.this.compare(this.next.key, Object2LongAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1778 */       c = (Object2LongAVLTreeMap<K>)super.clone();
...
/* 1851 */     if (n == 1) {
/* 1852 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
...
/*      */ 
/*      */       
/* 1860 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
/* 1861 */       entry.right(new Entry<>((K)s.readObject(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2LongAVLTreeMap.class
