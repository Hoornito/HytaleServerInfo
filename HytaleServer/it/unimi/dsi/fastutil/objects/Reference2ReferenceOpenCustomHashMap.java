...
/*      */     
/*      */     public K getKey() {
/*  567 */       return Reference2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  572 */       return Reference2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  577 */       return Reference2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  582 */       return Reference2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  587 */       V oldValue = Reference2ReferenceOpenCustomHashMap.this.value[this.index];
/*  588 */       Reference2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  589 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceReferencePair<K, V> right(V v) {
/*  594 */       Reference2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  595 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  603 */       return (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  608 */       return Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(Reference2ReferenceOpenCustomHashMap.this.key[this.index]) ^ ((Reference2ReferenceOpenCustomHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Reference2ReferenceOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  613 */       return (new StringBuilder()).append(Reference2ReferenceOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ReferenceOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  624 */     int pos = Reference2ReferenceOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  630 */     int last = -1;
/*      */     
/*  632 */     int c = Reference2ReferenceOpenCustomHashMap.this.size;
/*      */     
/*  634 */     boolean mustReturnNullKey = Reference2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  653 */         return this.last = Reference2ReferenceOpenCustomHashMap.this.n;
/*      */       } 
...
/*  661 */           int p = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask;
/*  662 */           for (; !Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ReferenceOpenCustomHashMap.this.mask);
/*  663 */           return p;
/*      */         } 
...
/*  672 */         acceptOnIndex(action, this.last = Reference2ReferenceOpenCustomHashMap.this.n);
/*  673 */         this.c--;
/*      */       } 
/*  675 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
/*  676 */       while (this.c != 0) {
/*  677 */         if (--this.pos < 0) {
/*      */           
/*  679 */           this.last = Integer.MIN_VALUE;
/*  680 */           K k = this.wrapped.get(-this.pos - 1);
/*  681 */           int p = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask;
/*  682 */           for (; !Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ReferenceOpenCustomHashMap.this.mask);
...
/*  702 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  704 */         pos = (last = pos) + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  706 */           if ((curr = key[pos]) == null) {
/*  707 */             key[last] = null;
/*  708 */             Reference2ReferenceOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  711 */           int slot = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ReferenceOpenCustomHashMap.this.mask;
/*  712 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  713 */             break;  pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/*      */         } 
/*  715 */         if (pos < last) {
...
/*      */         } 
/*  719 */         key[last] = curr;
/*  720 */         Reference2ReferenceOpenCustomHashMap.this.value[last] = Reference2ReferenceOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  725 */       if (this.last == -1) throw new IllegalStateException(); 
/*  726 */       if (this.last == Reference2ReferenceOpenCustomHashMap.this.n)
/*  727 */       { Reference2ReferenceOpenCustomHashMap.this.containsNullKey = false;
/*  728 */         Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.n] = null;
/*  729 */         Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n] = null; }
/*  730 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  733 */       { Reference2ReferenceOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
/*  734 */         this.last = -1;
/*      */         return; }
/*      */       
/*  737 */       Reference2ReferenceOpenCustomHashMap.this.size--;
/*  738 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>> implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> { public Reference2ReferenceOpenCustomHashMap<K, V>.MapEntry next() {
/*  754 */       return this.entry = new Reference2ReferenceOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  760 */       action.accept(this.entry = new Reference2ReferenceOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>> implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
/*      */     private FastEntryIterator() {
/*  771 */       this.entry = new Reference2ReferenceOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  792 */     int pos = 0;
/*      */     
/*  794 */     int max = Reference2ReferenceOpenCustomHashMap.this.n;
/*      */     
/*  796 */     int c = 0;
/*      */     
/*  798 */     boolean mustReturnNull = Reference2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  818 */         this.c++;
/*  819 */         acceptOnIndex(action, Reference2ReferenceOpenCustomHashMap.this.n);
/*  820 */         return true;
/*      */       } 
/*  822 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
...
/*  837 */         this.c++;
/*  838 */         acceptOnIndex(action, Reference2ReferenceOpenCustomHashMap.this.n);
/*      */       } 
/*  840 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
...
/*      */       {
/*  853 */         return (Reference2ReferenceOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  858 */       return Math.min((Reference2ReferenceOpenCustomHashMap.this.size - this.c), (long)(Reference2ReferenceOpenCustomHashMap.this.realSize() / Reference2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  886 */         n--;
/*      */       } 
/*  888 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>, EntrySpliterator> implements ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action, int index) {
/*  916 */       action.accept(new Reference2ReferenceOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  928 */       return new Reference2ReferenceOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/*  933 */       return new Reference2ReferenceOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> spliterator() {
/*  938 */       return new Reference2ReferenceOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  949 */       if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, null)) return (Reference2ReferenceOpenCustomHashMap.this.containsNullKey && Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n] == v);
/*      */       
/*  951 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  954 */       if ((curr = key[pos = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask]) == null) return false; 
/*  955 */       if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  958 */         if ((curr = key[pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask]) == null) return false; 
/*  959 */         if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  970 */       if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  971 */         if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey && Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n] == v) {
/*  972 */           Reference2ReferenceOpenCustomHashMap.this.removeNullEntry();
/*  973 */           return true;
/*      */         } 
/*  975 */         return false;
/*      */       } 
/*      */       
/*  978 */       K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  981 */       if ((curr = key[pos = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask]) == null) return false; 
/*  982 */       if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  983 */         if (Reference2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  984 */           Reference2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  985 */           return true;
/*      */         } 
/*  987 */         return false;
/*      */       } 
/*      */       while (true) {
/*  990 */         if ((curr = key[pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask]) == null) return false; 
/*  991 */         if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  992 */           Reference2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  993 */           Reference2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  994 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1002 */       return Reference2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1007 */       Reference2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
/* 1013 */       if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(new Reference2ReferenceOpenCustomHashMap.MapEntry(Reference2ReferenceOpenCustomHashMap.this.n)); 
/* 1014 */       for (int pos = Reference2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ReferenceOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Reference2ReferenceOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
/* 1020 */       Reference2ReferenceOpenCustomHashMap<K, V>.MapEntry entry = new Reference2ReferenceOpenCustomHashMap.MapEntry();
/* 1021 */       if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
/* 1022 */         entry.index = Reference2ReferenceOpenCustomHashMap.this.n;
/* 1023 */         consumer.accept(entry);
/*      */       } 
/* 1025 */       for (int pos = Reference2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ReferenceOpenCustomHashMap.this.key[pos] != null) {
...
/* 1056 */       action.accept(Reference2ReferenceOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1061 */       return Reference2ReferenceOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1082 */       action.accept(Reference2ReferenceOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1094 */       return new Reference2ReferenceOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1099 */       return new Reference2ReferenceOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1105 */       if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.n]); 
/* 1106 */       for (int pos = Reference2ReferenceOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1107 */         K k = Reference2ReferenceOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1114 */       return Reference2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1119 */       return Reference2ReferenceOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1124 */       int oldSize = Reference2ReferenceOpenCustomHashMap.this.size;
/* 1125 */       Reference2ReferenceOpenCustomHashMap.this.remove(k);
/* 1126 */       return (Reference2ReferenceOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1131 */       Reference2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1159 */       action.accept(Reference2ReferenceOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1164 */       return Reference2ReferenceOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1185 */       action.accept(Reference2ReferenceOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1199 */             return new Reference2ReferenceOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1204 */             return new Reference2ReferenceOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1210 */             if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n]); 
/* 1211 */             for (int pos = Reference2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ReferenceOpenCustomHashMap.this.key[pos] != null) consumer.accept(Reference2ReferenceOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1216 */             return Reference2ReferenceOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1221 */             return Reference2ReferenceOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1226 */             Reference2ReferenceOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1324 */       c = (Reference2ReferenceOpenCustomHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ReferenceOpenCustomHashMap.class
