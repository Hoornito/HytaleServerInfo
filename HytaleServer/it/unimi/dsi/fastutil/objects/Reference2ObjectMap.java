...
/* 159 */     return (ObjectSet)reference2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 216 */     ObjectSet<Entry<K, V>> entrySet = reference2ObjectEntrySet();
...
/* 279 */     if (!Objects.equals(curValue, value) || (curValue == defaultReturnValue() && !containsKey(key))) return false; 
/* 280 */     remove(key);
/* 281 */     return true;
/*     */   }
/*     */ 
...
/* 298 */     if (!Objects.equals(curValue, oldValue) || (curValue == defaultReturnValue() && !containsKey(key))) return false; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ObjectMap.class
