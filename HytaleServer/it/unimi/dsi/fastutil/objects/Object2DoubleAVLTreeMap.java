...
/*      */ 
/*      */ 
/*      */ public class Object2DoubleAVLTreeMap<K>
...
/*  652 */     while (j-- != 0) {
/*  653 */       double ev = i.nextDouble();
/*  654 */       if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v)) return true; 
/*      */     } 
/*  656 */     return false;
/*      */   }
/*      */ 
...
/*  858 */       double oldValue = this.value;
...
/*  882 */       Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
/*  883 */       return (Objects.equals(this.key, e.getKey()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  888 */       return this.key.hashCode() ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  993 */       this.next = Object2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  997 */       if ((this.next = Object2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  998 */         if (Object2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1051 */       updatePrevious();
/* 1052 */       updateNext();
/* 1053 */       Object2DoubleAVLTreeMap.this.removeDouble(this.curr.key);
/* 1054 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1108 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */         {
...
/* 1118 */             return new Object2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1123 */             return new Object2DoubleAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1132 */             if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1133 */             Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1143 */             if (!(e.getValue() instanceof Double)) return false; 
/* 1144 */             Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1145 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double)e.getValue()).doubleValue())) return false; 
/* 1146 */             Object2DoubleAVLTreeMap.this.removeDouble(f.key);
/* 1147 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1152 */             return Object2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1157 */             Object2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2DoubleMap.Entry<K> first() {
/* 1162 */             return Object2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2DoubleMap.Entry<K> last() {
/* 1167 */             return Object2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1172 */             return Object2DoubleAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1177 */             return Object2DoubleAVLTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1182 */             return Object2DoubleAVLTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1219 */       return new Object2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1224 */       return new Object2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1277 */             return (DoubleIterator)new Object2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1282 */             return Object2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1287 */             return Object2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1292 */             Object2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1354 */       if (!bottom && !top && Object2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1355 */       this.from = from;
/* 1356 */       this.bottom = bottom;
/* 1357 */       this.to = to;
/* 1358 */       this.top = top;
/* 1359 */       this.defRetValue = Object2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1378 */       return ((this.bottom || Object2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
/* 1383 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/* 1386 */               return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1391 */               return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2DoubleMap.Entry<K>> comparator() {
/* 1396 */               return Object2DoubleAVLTreeMap.this.object2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1405 */               Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1406 */               return (f != null && Object2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1414 */               if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1415 */               Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1416 */               if (f != null && Object2DoubleAVLTreeMap.Submap.this.in(f.key)) Object2DoubleAVLTreeMap.Submap.this.removeDouble(f.key); 
/* 1417 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1429 */               return !(new Object2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1434 */               Object2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2DoubleMap.Entry<K> first() {
/* 1439 */               return Object2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2DoubleMap.Entry<K> last() {
/* 1444 */               return Object2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1449 */               return Object2DoubleAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1454 */               return Object2DoubleAVLTreeMap.Submap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1459 */               return Object2DoubleAVLTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1468 */         return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1473 */         return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public DoubleCollection values() {
/* 1485 */       if (this.values == null) this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1488 */               return (DoubleIterator)new Object2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1493 */               return Object2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1498 */               return Object2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1503 */               Object2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1513 */       return (in((K)k) && Object2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/* 1521 */         double ev = (i.nextEntry()).value;
/* 1522 */         if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v)) return true; 
/*      */       } 
/* 1524 */       return false;
/*      */     }
/*      */ 
...
/*      */     
/*      */     public double getDouble(Object k) {
/* 1531 */       K kk = (K)k; Object2DoubleAVLTreeMap.Entry<K> e;
/* 1532 */       return (in(kk) && (e = Object2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(K k, double v) {
/* 1537 */       Object2DoubleAVLTreeMap.this.modified = false;
...
/* 1539 */       double oldValue = Object2DoubleAVLTreeMap.this.put(k, v);
/* 1540 */       return Object2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double removeDouble(Object k) {
/* 1546 */       Object2DoubleAVLTreeMap.this.modified = false;
/* 1547 */       if (!in((K)k)) return this.defRetValue; 
/* 1548 */       double oldValue = Object2DoubleAVLTreeMap.this.removeDouble(k);
/* 1549 */       return Object2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1570 */       return Object2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleSortedMap<K> headMap(K to) {
/* 1575 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1576 */       return (Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleSortedMap<K> tailMap(K from) {
/* 1581 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1582 */       return (Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleSortedMap<K> subMap(K from, K to) {
/* 1587 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1588 */       if (!this.top) to = (Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1589 */       if (!this.bottom) from = (Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1600 */       if (Object2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1604 */       if (this.bottom) { e = Object2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1606 */       { e = Object2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1608 */         if (Object2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1612 */       if (e == null || (!this.top && Object2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1613 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2DoubleAVLTreeMap.Entry<K> e;
/* 1622 */       if (Object2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1626 */       if (this.top) { e = Object2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1628 */       { e = Object2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1630 */         if (Object2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1634 */       if (e == null || (!this.bottom && Object2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1635 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1640 */       Object2DoubleAVLTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1647 */       Object2DoubleAVLTreeMap.Entry<K> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1663 */         this.next = Object2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1667 */         this();
/* 1668 */         if (this.next != null) {
/* 1669 */           if (!Object2DoubleAVLTreeMap.Submap.this.bottom && Object2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1670 */           else if (!Object2DoubleAVLTreeMap.Submap.this.top && Object2DoubleAVLTreeMap.this.compare(k, (this.prev = Object2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1672 */           { this.next = Object2DoubleAVLTreeMap.this.locateKey(k);
/* 1673 */             if (Object2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1684 */         if (!Object2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Object2DoubleAVLTreeMap.this.compare(this.prev.key, Object2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1689 */         this.next = this.next.next();
/* 1690 */         if (!Object2DoubleAVLTreeMap.Submap.this.top && this.next != null && Object2DoubleAVLTreeMap.this.compare(this.next.key, Object2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1778 */       c = (Object2DoubleAVLTreeMap<K>)super.clone();
...
/* 1851 */     if (n == 1) {
/* 1852 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
...
/*      */ 
/*      */       
/* 1860 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
/* 1861 */       entry.right(new Entry<>((K)s.readObject(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleAVLTreeMap.class
