...
/*      */     
/*      */     public K getKey() {
/*  932 */       return Object2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  937 */       return Object2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  942 */       return Object2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  947 */       return Object2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  952 */       char oldValue = Object2CharLinkedOpenHashMap.this.value[this.index];
/*  953 */       Object2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  954 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectCharPair<K> right(char v) {
/*  959 */       Object2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  960 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  971 */       return Character.valueOf(Object2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  990 */       return (Objects.equals(Object2CharLinkedOpenHashMap.this.key[this.index], e.getKey()) && Object2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  995 */       return ((Object2CharLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2CharLinkedOpenHashMap.this.key[this.index].hashCode()) ^ Object2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1000 */       return (new StringBuilder()).append(Object2CharLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2CharLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1168 */       this.next = Object2CharLinkedOpenHashMap.this.first;
/* 1169 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1173 */       if (from == null) {
/* 1174 */         if (Object2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1175 */           this.next = (int)Object2CharLinkedOpenHashMap.this.link[Object2CharLinkedOpenHashMap.this.n];
/* 1176 */           this.prev = Object2CharLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1178 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1180 */       if (Objects.equals(Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.last], from)) {
/* 1181 */         this.prev = Object2CharLinkedOpenHashMap.this.last;
/* 1182 */         this.index = Object2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1186 */       int pos = HashCommon.mix(from.hashCode()) & Object2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1188 */       while (Object2CharLinkedOpenHashMap.this.key[pos] != null) {
/* 1189 */         if (Object2CharLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1191 */           this.next = (int)Object2CharLinkedOpenHashMap.this.link[pos];
/* 1192 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1195 */         pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1214 */       if (this.next == -1) {
/* 1215 */         this.index = Object2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1218 */       int pos = Object2CharLinkedOpenHashMap.this.first;
/* 1219 */       this.index = 1;
/* 1220 */       while (pos != this.prev) {
/* 1221 */         pos = (int)Object2CharLinkedOpenHashMap.this.link[pos];
/* 1222 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1239 */       this.next = (int)Object2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1248 */       this.prev = (int)(Object2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1257 */         this.next = (int)Object2CharLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1270 */         this.index--;
/* 1271 */         this.prev = (int)(Object2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1272 */       else { this.next = (int)Object2CharLinkedOpenHashMap.this.link[this.curr]; }
/* 1273 */        Object2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1276 */       if (this.prev == -1) { Object2CharLinkedOpenHashMap.this.first = this.next; }
/* 1277 */       else { Object2CharLinkedOpenHashMap.this.link[this.prev] = Object2CharLinkedOpenHashMap.this.link[this.prev] ^ (Object2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1278 */        if (this.next == -1) { Object2CharLinkedOpenHashMap.this.last = this.prev; }
/* 1279 */       else { Object2CharLinkedOpenHashMap.this.link[this.next] = Object2CharLinkedOpenHashMap.this.link[this.next] ^ (Object2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1280 */        int pos = this.curr;
/* 1281 */       this.curr = -1;
/* 1282 */       if (pos == Object2CharLinkedOpenHashMap.this.n) {
/* 1283 */         Object2CharLinkedOpenHashMap.this.containsNullKey = false;
/* 1284 */         Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1287 */         K[] key = Object2CharLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1290 */           pos = (last = pos) + 1 & Object2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1292 */             if ((curr = key[pos]) == null) {
/* 1293 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1296 */             int slot = HashCommon.mix(curr.hashCode()) & Object2CharLinkedOpenHashMap.this.mask;
/* 1297 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1298 */               break;  pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1300 */           key[last] = curr;
/* 1301 */           Object2CharLinkedOpenHashMap.this.value[last] = Object2CharLinkedOpenHashMap.this.value[pos];
/* 1302 */           if (this.next == pos) this.next = last; 
/* 1303 */           if (this.prev == pos) this.prev = last; 
/* 1304 */           Object2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1343 */       action.accept(new Object2CharLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharLinkedOpenHashMap<K>.MapEntry next() {
/* 1348 */       return this.entry = new Object2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharLinkedOpenHashMap<K>.MapEntry previous() {
/* 1353 */       return this.entry = new Object2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1364 */     final Object2CharLinkedOpenHashMap<K>.MapEntry entry = new Object2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1398 */       return new Object2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1416 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1441 */       if (Object2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1442 */       return new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2CharMap.Entry<K> last() {
/* 1447 */       if (Object2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1448 */       return new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1459 */       if (k == null) return (Object2CharLinkedOpenHashMap.this.containsNullKey && Object2CharLinkedOpenHashMap.this.value[Object2CharLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1461 */       K[] key = Object2CharLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1464 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1465 */       if (k.equals(curr)) return (Object2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1468 */         if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1469 */         if (k.equals(curr)) return (Object2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1481 */       if (k == null) {
/* 1482 */         if (Object2CharLinkedOpenHashMap.this.containsNullKey && Object2CharLinkedOpenHashMap.this.value[Object2CharLinkedOpenHashMap.this.n] == v) {
/* 1483 */           Object2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1484 */           return true;
/*      */         } 
/* 1486 */         return false;
/*      */       } 
/*      */       
/* 1489 */       K[] key = Object2CharLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1492 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1493 */       if (curr.equals(k)) {
/* 1494 */         if (Object2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1495 */           Object2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1496 */           return true;
/*      */         } 
/* 1498 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1501 */         if ((curr = key[pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1502 */         if (curr.equals(k) && 
/* 1503 */           Object2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Object2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1513 */       return Object2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1518 */       Object2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1531 */       return new Object2CharLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1542 */       return new Object2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1555 */       return new Object2CharLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
/* 1561 */       for (int i = Object2CharLinkedOpenHashMap.this.size, next = Object2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1562 */         int curr = next;
/* 1563 */         next = (int)Object2CharLinkedOpenHashMap.this.link[curr];
/* 1564 */         consumer.accept(new Object2CharLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1571 */       Object2CharLinkedOpenHashMap<K>.MapEntry entry = new Object2CharLinkedOpenHashMap.MapEntry();
/* 1572 */       for (int i = Object2CharLinkedOpenHashMap.this.size, next = Object2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         entry.index = next;
/* 1574 */         next = (int)Object2CharLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1601 */       return Object2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1613 */       action.accept(Object2CharLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1618 */       return Object2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1627 */       return new Object2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1632 */       return new Object2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1642 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1648 */       for (int i = Object2CharLinkedOpenHashMap.this.size, next = Object2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1649 */         int curr = next;
/* 1650 */         next = (int)Object2CharLinkedOpenHashMap.this.link[curr];
/* 1651 */         consumer.accept(Object2CharLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1657 */       return Object2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1662 */       return Object2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1667 */       int oldSize = Object2CharLinkedOpenHashMap.this.size;
/* 1668 */       Object2CharLinkedOpenHashMap.this.removeChar(k);
/* 1669 */       return (Object2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1674 */       Object2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1679 */       if (Object2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1680 */       return Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1685 */       if (Object2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1686 */       return Object2CharLinkedOpenHashMap.this.key[Object2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1727 */       return Object2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1739 */       action.accept(Object2CharLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1744 */       return Object2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1755 */             return (CharIterator)new Object2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2CharLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1771 */             for (int i = Object2CharLinkedOpenHashMap.this.size, next = Object2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1772 */               int curr = next;
/* 1773 */               next = (int)Object2CharLinkedOpenHashMap.this.link[curr];
/* 1774 */               consumer.accept(Object2CharLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1780 */             return Object2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1785 */             return Object2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1790 */             Object2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1910 */       c = (Object2CharLinkedOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2CharLinkedOpenHashMap.class
