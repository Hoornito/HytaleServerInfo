...
/*  56 */     ObjectSortedSet<Object2LongMap.Entry<K>> entries = map.object2LongEntrySet();
/*  57 */     return (entries instanceof Object2LongSortedMap.FastSortedEntrySet) ? ((Object2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     ObjectSortedSet<Object2LongMap.Entry<K>> entries = map.object2LongEntrySet();
/*  73 */     Objects.requireNonNull((Object2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Object2LongSortedMap.FastSortedEntrySet) ? (Object2LongSortedMap.FastSortedEntrySet)entries::fastIterator : entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Object2LongSortedMap<K> headMap(K to) {
/* 124 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Object2LongSortedMap<K> tailMap(K from) {
/* 130 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     
/*     */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 195 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new AbstractObject2LongMap.BasicEntry<>(this.key, this.value), (Comparator)Object2LongSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Object2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 208 */       return (ObjectSortedSet)object2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/* 221 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 228 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 235 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     extends Object2LongMaps.SynchronizedMap<K> implements Object2LongSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 335 */       if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.object2LongEntrySet(), this.sync); 
/* 336 */       return (ObjectSortedSet<Object2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 348 */       return (ObjectSortedSet)object2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/*     */     extends Object2LongMaps.UnmodifiableMap<K> implements Object2LongSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Object2LongSortedMap<K> sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 429 */       if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.object2LongEntrySet()); 
/* 430 */       return (ObjectSortedSet<Object2LongMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 442 */       return (ObjectSortedSet)object2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2LongSortedMaps.class
