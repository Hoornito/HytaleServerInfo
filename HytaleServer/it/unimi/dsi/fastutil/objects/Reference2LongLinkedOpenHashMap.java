...
/*      */     
/*      */     public K getKey() {
/*  931 */       return Reference2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  936 */       return Reference2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  941 */       return Reference2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  946 */       return Reference2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  951 */       long oldValue = Reference2LongLinkedOpenHashMap.this.value[this.index];
/*  952 */       Reference2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  953 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceLongPair<K> right(long v) {
/*  958 */       Reference2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  959 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  970 */       return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  989 */       return (Reference2LongLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  994 */       return System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Reference2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  999 */       return (new StringBuilder()).append(Reference2LongLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2LongLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1167 */       this.next = Reference2LongLinkedOpenHashMap.this.first;
/* 1168 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1172 */       if (from == null) {
/* 1173 */         if (Reference2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1174 */           this.next = (int)Reference2LongLinkedOpenHashMap.this.link[Reference2LongLinkedOpenHashMap.this.n];
/* 1175 */           this.prev = Reference2LongLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1177 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1179 */       if (Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last] == from) {
/* 1180 */         this.prev = Reference2LongLinkedOpenHashMap.this.last;
/* 1181 */         this.index = Reference2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1185 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1187 */       while (Reference2LongLinkedOpenHashMap.this.key[pos] != null) {
/* 1188 */         if (Reference2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1190 */           this.next = (int)Reference2LongLinkedOpenHashMap.this.link[pos];
/* 1191 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1194 */         pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1213 */       if (this.next == -1) {
/* 1214 */         this.index = Reference2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1217 */       int pos = Reference2LongLinkedOpenHashMap.this.first;
/* 1218 */       this.index = 1;
/* 1219 */       while (pos != this.prev) {
/* 1220 */         pos = (int)Reference2LongLinkedOpenHashMap.this.link[pos];
/* 1221 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1238 */       this.next = (int)Reference2LongLinkedOpenHashMap.this.link[this.curr];
...
/* 1247 */       this.prev = (int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1256 */         this.next = (int)Reference2LongLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1269 */         this.index--;
/* 1270 */         this.prev = (int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1271 */       else { this.next = (int)Reference2LongLinkedOpenHashMap.this.link[this.curr]; }
/* 1272 */        Reference2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1275 */       if (this.prev == -1) { Reference2LongLinkedOpenHashMap.this.first = this.next; }
/* 1276 */       else { Reference2LongLinkedOpenHashMap.this.link[this.prev] = Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ (Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1277 */        if (this.next == -1) { Reference2LongLinkedOpenHashMap.this.last = this.prev; }
/* 1278 */       else { Reference2LongLinkedOpenHashMap.this.link[this.next] = Reference2LongLinkedOpenHashMap.this.link[this.next] ^ (Reference2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1279 */        int pos = this.curr;
/* 1280 */       this.curr = -1;
/* 1281 */       if (pos == Reference2LongLinkedOpenHashMap.this.n) {
/* 1282 */         Reference2LongLinkedOpenHashMap.this.containsNullKey = false;
/* 1283 */         Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1286 */         K[] key = Reference2LongLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1289 */           pos = (last = pos) + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1291 */             if ((curr = key[pos]) == null) {
/* 1292 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1295 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2LongLinkedOpenHashMap.this.mask;
/* 1296 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1297 */               break;  pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1299 */           key[last] = curr;
/* 1300 */           Reference2LongLinkedOpenHashMap.this.value[last] = Reference2LongLinkedOpenHashMap.this.value[pos];
/* 1301 */           if (this.next == pos) this.next = last; 
/* 1302 */           if (this.prev == pos) this.prev = last; 
/* 1303 */           Reference2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2LongMap.Entry<K>>> implements ObjectListIterator<Reference2LongMap.Entry<K>> {
...
/* 1342 */       action.accept(new Reference2LongLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2LongLinkedOpenHashMap<K>.MapEntry next() {
/* 1347 */       return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2LongLinkedOpenHashMap<K>.MapEntry previous() {
/* 1352 */       return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2LongMap.Entry<K>>> implements ObjectListIterator<Reference2LongMap.Entry<K>> {
/* 1363 */     final Reference2LongLinkedOpenHashMap<K>.MapEntry entry = new Reference2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1397 */       return new Reference2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1415 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2LongLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1440 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1441 */       return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2LongMap.Entry<K> last() {
/* 1446 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1447 */       return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1458 */       if (k == null) return (Reference2LongLinkedOpenHashMap.this.containsNullKey && Reference2LongLinkedOpenHashMap.this.value[Reference2LongLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1460 */       K[] key = Reference2LongLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1463 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1464 */       if (k == curr) return (Reference2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1467 */         if ((curr = key[pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1468 */         if (k == curr) return (Reference2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1480 */       if (k == null) {
/* 1481 */         if (Reference2LongLinkedOpenHashMap.this.containsNullKey && Reference2LongLinkedOpenHashMap.this.value[Reference2LongLinkedOpenHashMap.this.n] == v) {
/* 1482 */           Reference2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1483 */           return true;
/*      */         } 
/* 1485 */         return false;
/*      */       } 
/*      */       
/* 1488 */       K[] key = Reference2LongLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1491 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1492 */       if (curr == k) {
/* 1493 */         if (Reference2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1494 */           Reference2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1495 */           return true;
/*      */         } 
/* 1497 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1500 */         if ((curr = key[pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1501 */         if (curr == k && 
/* 1502 */           Reference2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1503 */           Reference2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1504 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1512 */       return Reference2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1517 */       Reference2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       return new Reference2LongLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Reference2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1554 */       return new Reference2LongLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/* 1560 */       for (int i = Reference2LongLinkedOpenHashMap.this.size, next = Reference2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1561 */         int curr = next;
/* 1562 */         next = (int)Reference2LongLinkedOpenHashMap.this.link[curr];
/* 1563 */         consumer.accept(new Reference2LongLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1570 */       Reference2LongLinkedOpenHashMap<K>.MapEntry entry = new Reference2LongLinkedOpenHashMap.MapEntry();
/* 1571 */       for (int i = Reference2LongLinkedOpenHashMap.this.size, next = Reference2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1572 */         entry.index = next;
/* 1573 */         next = (int)Reference2LongLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1600 */       return Reference2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1612 */       action.accept(Reference2LongLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1617 */       return Reference2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1626 */       return new Reference2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1631 */       return new Reference2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1641 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2LongLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1647 */       for (int i = Reference2LongLinkedOpenHashMap.this.size, next = Reference2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1648 */         int curr = next;
/* 1649 */         next = (int)Reference2LongLinkedOpenHashMap.this.link[curr];
/* 1650 */         consumer.accept(Reference2LongLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1656 */       return Reference2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1661 */       return Reference2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1666 */       int oldSize = Reference2LongLinkedOpenHashMap.this.size;
/* 1667 */       Reference2LongLinkedOpenHashMap.this.removeLong(k);
/* 1668 */       return (Reference2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1673 */       Reference2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1678 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1679 */       return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1684 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1685 */       return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1726 */       return Reference2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1738 */       action.accept(Reference2LongLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1743 */       return Reference2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1754 */             return (LongIterator)new Reference2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1764 */             return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2LongLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1770 */             for (int i = Reference2LongLinkedOpenHashMap.this.size, next = Reference2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1771 */               int curr = next;
/* 1772 */               next = (int)Reference2LongLinkedOpenHashMap.this.link[curr];
/* 1773 */               consumer.accept(Reference2LongLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1779 */             return Reference2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1784 */             return Reference2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1789 */             Reference2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1909 */       c = (Reference2LongLinkedOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongLinkedOpenHashMap.class
