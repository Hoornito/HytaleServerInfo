...
/*      */     
/*      */     public K getKey() {
/*  597 */       return Reference2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  602 */       return Reference2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  607 */       return Reference2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  612 */       return Reference2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  617 */       byte oldValue = Reference2ByteOpenHashMap.this.value[this.index];
/*  618 */       Reference2ByteOpenHashMap.this.value[this.index] = v;
/*  619 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceBytePair<K> right(byte v) {
/*  624 */       Reference2ByteOpenHashMap.this.value[this.index] = v;
/*  625 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  636 */       return Byte.valueOf(Reference2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  655 */       return (Reference2ByteOpenHashMap.this.key[this.index] == e.getKey() && Reference2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  660 */       return System.identityHashCode(Reference2ByteOpenHashMap.this.key[this.index]) ^ Reference2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  665 */       return (new StringBuilder()).append(Reference2ByteOpenHashMap.this.key[this.index]).append("=>").append(Reference2ByteOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  676 */     int pos = Reference2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  682 */     int last = -1;
/*      */     
/*  684 */     int c = Reference2ByteOpenHashMap.this.size;
/*      */     
/*  686 */     boolean mustReturnNullKey = Reference2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  705 */         return this.last = Reference2ByteOpenHashMap.this.n;
/*      */       } 
/*  707 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  709 */         if (--this.pos < 0) {
/*      */           
/*  711 */           this.last = Integer.MIN_VALUE;
/*  712 */           K k = this.wrapped.get(-this.pos - 1);
/*  713 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask;
/*  714 */           for (; k != key[p]; p = p + 1 & Reference2ByteOpenHashMap.this.mask);
/*  715 */           return p;
/*      */         } 
...
/*  724 */         acceptOnIndex(action, this.last = Reference2ByteOpenHashMap.this.n);
/*  725 */         this.c--;
/*      */       } 
/*  727 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*  728 */       while (this.c != 0) {
/*  729 */         if (--this.pos < 0) {
/*      */           
/*  731 */           this.last = Integer.MIN_VALUE;
/*  732 */           K k = this.wrapped.get(-this.pos - 1);
/*  733 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask;
/*  734 */           for (; k != key[p]; p = p + 1 & Reference2ByteOpenHashMap.this.mask);
...
/*  754 */       K[] key = Reference2ByteOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  756 */         pos = (last = pos) + 1 & Reference2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  758 */           if ((curr = key[pos]) == null) {
/*  759 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  762 */           int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ByteOpenHashMap.this.mask;
/*  763 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  764 */             break;  pos = pos + 1 & Reference2ByteOpenHashMap.this.mask;
/*      */         } 
/*  766 */         if (pos < last) {
...
/*      */         } 
/*  770 */         key[last] = curr;
/*  771 */         Reference2ByteOpenHashMap.this.value[last] = Reference2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  776 */       if (this.last == -1) throw new IllegalStateException(); 
/*  777 */       if (this.last == Reference2ByteOpenHashMap.this.n)
/*  778 */       { Reference2ByteOpenHashMap.this.containsNullKey = false;
/*  779 */         Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n] = null; }
/*  780 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  783 */       { Reference2ByteOpenHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  784 */         this.last = -1;
/*      */         return; }
/*      */       
/*  787 */       Reference2ByteOpenHashMap.this.size--;
/*  788 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ByteMap.Entry<K>>> implements ObjectIterator<Reference2ByteMap.Entry<K>> { public Reference2ByteOpenHashMap<K>.MapEntry next() {
/*  804 */       return this.entry = new Reference2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  810 */       action.accept(this.entry = new Reference2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  821 */       this.entry = new Reference2ByteOpenHashMap.MapEntry();
/*      */     }
...
/*  842 */     int pos = 0;
/*      */     
/*  844 */     int max = Reference2ByteOpenHashMap.this.n;
/*      */     
/*  846 */     int c = 0;
/*      */     
/*  848 */     boolean mustReturnNull = Reference2ByteOpenHashMap.this.containsNullKey;
/*      */     
...
/*  868 */         this.c++;
/*  869 */         acceptOnIndex(action, Reference2ByteOpenHashMap.this.n);
/*  870 */         return true;
/*      */       } 
/*  872 */       K[] key = Reference2ByteOpenHashMap.this.key;
...
/*  887 */         this.c++;
/*  888 */         acceptOnIndex(action, Reference2ByteOpenHashMap.this.n);
/*      */       } 
/*  890 */       K[] key = Reference2ByteOpenHashMap.this.key;
...
/*      */       {
/*  903 */         return (Reference2ByteOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  908 */       return Math.min((Reference2ByteOpenHashMap.this.size - this.c), (long)(Reference2ByteOpenHashMap.this.realSize() / Reference2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  936 */         n--;
/*      */       } 
/*  938 */       K[] key = Reference2ByteOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
/*  966 */       action.accept(new Reference2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  978 */       return new Reference2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/*  983 */       return new Reference2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2ByteMap.Entry<K>> spliterator() {
/*  988 */       return new Reference2ByteOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1000 */       if (k == null) return (Reference2ByteOpenHashMap.this.containsNullKey && Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n] == v);
/*      */       
/* 1002 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1005 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask]) == null) return false; 
/* 1006 */       if (k == curr) return (Reference2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1009 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenHashMap.this.mask]) == null) return false; 
/* 1010 */         if (k == curr) return (Reference2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1022 */       if (k == null) {
/* 1023 */         if (Reference2ByteOpenHashMap.this.containsNullKey && Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n] == v) {
/* 1024 */           Reference2ByteOpenHashMap.this.removeNullEntry();
/* 1025 */           return true;
/*      */         } 
/* 1027 */         return false;
/*      */       } 
/*      */       
/* 1030 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1033 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask]) == null) return false; 
/* 1034 */       if (curr == k) {
/* 1035 */         if (Reference2ByteOpenHashMap.this.value[pos] == v) {
/* 1036 */           Reference2ByteOpenHashMap.this.removeEntry(pos);
/* 1037 */           return true;
/*      */         } 
/* 1039 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1042 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenHashMap.this.mask]) == null) return false; 
/* 1043 */         if (curr == k && 
/* 1044 */           Reference2ByteOpenHashMap.this.value[pos] == v) {
/* 1045 */           Reference2ByteOpenHashMap.this.removeEntry(pos);
/* 1046 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1054 */       return Reference2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1059 */       Reference2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1065 */       if (Reference2ByteOpenHashMap.this.containsNullKey) consumer.accept(new Reference2ByteOpenHashMap.MapEntry(Reference2ByteOpenHashMap.this.n)); 
/* 1066 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenHashMap.this.key[pos] != null) consumer.accept(new Reference2ByteOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1072 */       Reference2ByteOpenHashMap<K>.MapEntry entry = new Reference2ByteOpenHashMap.MapEntry();
/* 1073 */       if (Reference2ByteOpenHashMap.this.containsNullKey) {
/* 1074 */         entry.index = Reference2ByteOpenHashMap.this.n;
/* 1075 */         consumer.accept(entry);
/*      */       } 
/* 1077 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenHashMap.this.key[pos] != null) {
...
/* 1108 */       action.accept(Reference2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1113 */       return Reference2ByteOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1134 */       action.accept(Reference2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1146 */       return new Reference2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1151 */       return new Reference2ByteOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1157 */       if (Reference2ByteOpenHashMap.this.containsNullKey) consumer.accept(Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n]); 
/* 1158 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0; ) {
/* 1159 */         K k = Reference2ByteOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1166 */       return Reference2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1171 */       return Reference2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1176 */       int oldSize = Reference2ByteOpenHashMap.this.size;
/* 1177 */       Reference2ByteOpenHashMap.this.removeByte(k);
/* 1178 */       return (Reference2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1183 */       Reference2ByteOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1211 */       action.accept(Reference2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1216 */       return Reference2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1237 */       action.accept(Reference2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1251 */             return new Reference2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1256 */             return new Reference2ByteOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1262 */             if (Reference2ByteOpenHashMap.this.containsNullKey) consumer.accept(Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n]); 
/* 1263 */             for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenHashMap.this.key[pos] != null) consumer.accept(Reference2ByteOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Reference2ByteOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1273 */             return Reference2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1278 */             Reference2ByteOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1376 */       c = (Reference2ByteOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteOpenHashMap.class
