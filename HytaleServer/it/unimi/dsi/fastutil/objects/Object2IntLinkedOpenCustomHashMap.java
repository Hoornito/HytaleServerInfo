...
/*      */ 
/*      */   
/*      */   public Object2IntLinkedOpenCustomHashMap(int expected, float f, Hash.Strategy<? super K> strategy) {
...
/*  152 */     this.value = new int[this.n + 1];
...
/*  279 */     int oldValue = this.value[pos];
/*  280 */     this.size--;
/*  281 */     fixPointers(pos);
/*  282 */     shiftKeys(pos);
...
/*  290 */     int oldValue = this.value[this.n];
/*  291 */     this.size--;
...
/*      */     } 
/*  345 */     int oldValue = this.value[pos];
/*  346 */     this.value[pos] = v;
/*  347 */     return oldValue;
/*      */   }
/*      */   
/*      */   private int addToValue(int pos, int incr) {
/*  351 */     int oldValue = this.value[pos];
...
/*  448 */     int oldValue = this.value[pos];
...
/*  826 */     int oldValue = this.value[pos];
...
/*  837 */     int newValue = mappingFunction.applyAsInt(k);
...
/*  849 */     int newValue = mappingFunction.getInt(key);
...
/*  860 */     Integer newValue = remappingFunction.apply(k, Integer.valueOf(this.value[pos]));
...
/*      */     } 
/*  866 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  873 */     int pos = find(k);
/*  874 */     Integer newValue = remappingFunction.apply(k, (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  882 */     int newVal = newValue.intValue();
/*  883 */     if (pos < 0) {
...
/*  899 */        return v;
/*      */     } 
/*  901 */     Integer newValue = remappingFunction.apply(Integer.valueOf(this.value[pos]), Integer.valueOf(v));
...
/*      */     } 
/*  907 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  953 */       return Object2IntLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  958 */       return Object2IntLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  963 */       return Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  968 */       return Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  973 */       int oldValue = Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*  974 */       Object2IntLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  975 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIntPair<K> right(int v) {
/*  980 */       Object2IntLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  981 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  992 */       return Integer.valueOf(Object2IntLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1003 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1010 */       Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
/* 1011 */       return (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2IntLinkedOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1016 */       return Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(Object2IntLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1021 */       return (new StringBuilder()).append(Object2IntLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2IntLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1189 */       this.next = Object2IntLinkedOpenCustomHashMap.this.first;
/* 1190 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1194 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1195 */         if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1196 */           this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[Object2IntLinkedOpenCustomHashMap.this.n];
/* 1197 */           this.prev = Object2IntLinkedOpenCustomHashMap.this.n; return;
/*      */         } 
/* 1199 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1201 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last], from)) {
/* 1202 */         this.prev = Object2IntLinkedOpenCustomHashMap.this.last;
/* 1203 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1207 */       int pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1209 */       while (Object2IntLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1210 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1212 */           this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[pos];
/* 1213 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1216 */         pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1235 */       if (this.next == -1) {
/* 1236 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1239 */       int pos = Object2IntLinkedOpenCustomHashMap.this.first;
/* 1240 */       this.index = 1;
/* 1241 */       while (pos != this.prev) {
/* 1242 */         pos = (int)Object2IntLinkedOpenCustomHashMap.this.link[pos];
/* 1243 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1260 */       this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1269 */       this.prev = (int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/* 1278 */         this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr];
...
/*      */       { 
/* 1291 */         this.index--;
/* 1292 */         this.prev = (int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L); }
/* 1293 */       else { this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr]; }
/* 1294 */        Object2IntLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */       
/* 1297 */       if (this.prev == -1) { Object2IntLinkedOpenCustomHashMap.this.first = this.next; }
/* 1298 */       else { Object2IntLinkedOpenCustomHashMap.this.link[this.prev] = Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1299 */        if (this.next == -1) { Object2IntLinkedOpenCustomHashMap.this.last = this.prev; }
/* 1300 */       else { Object2IntLinkedOpenCustomHashMap.this.link[this.next] = Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1301 */        int pos = this.curr;
/* 1302 */       this.curr = -1;
/* 1303 */       if (pos == Object2IntLinkedOpenCustomHashMap.this.n) {
/* 1304 */         Object2IntLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1305 */         Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1308 */         K[] key = Object2IntLinkedOpenCustomHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1311 */           pos = (last = pos) + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1313 */             if ((curr = key[pos]) == null) {
/* 1314 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1317 */             int slot = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/* 1318 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1319 */               break;  pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1321 */           key[last] = curr;
/* 1322 */           Object2IntLinkedOpenCustomHashMap.this.value[last] = Object2IntLinkedOpenCustomHashMap.this.value[pos];
/* 1323 */           if (this.next == pos) this.next = last; 
/* 1324 */           if (this.prev == pos) this.prev = last; 
/* 1325 */           Object2IntLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1364 */       action.accept(new Object2IntLinkedOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2IntLinkedOpenCustomHashMap<K>.MapEntry next() {
/* 1369 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2IntLinkedOpenCustomHashMap<K>.MapEntry previous() {
/* 1374 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1385 */     final Object2IntLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2IntLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1419 */       return new Object2IntLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1437 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2IntLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1462 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1463 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2IntMap.Entry<K> last() {
/* 1468 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1469 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1477 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1478 */       K k = (K)e.getKey();
/* 1479 */       int v = ((Integer)e.getValue()).intValue();
/* 1480 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, null)) return (Object2IntLinkedOpenCustomHashMap.this.containsNullKey && Object2IntLinkedOpenCustomHashMap.this.value[Object2IntLinkedOpenCustomHashMap.this.n] == v);
/*      */       
/* 1482 */       K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1485 */       if ((curr = key[pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1486 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1489 */         if ((curr = key[pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1490 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) return (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1499 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1500 */       K k = (K)e.getKey();
/* 1501 */       int v = ((Integer)e.getValue()).intValue();
/* 1502 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1503 */         if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey && Object2IntLinkedOpenCustomHashMap.this.value[Object2IntLinkedOpenCustomHashMap.this.n] == v) {
/* 1504 */           Object2IntLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1505 */           return true;
/*      */         } 
/* 1507 */         return false;
/*      */       } 
/*      */       
/* 1510 */       K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1513 */       if ((curr = key[pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1514 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1515 */         if (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1516 */           Object2IntLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1517 */           return true;
/*      */         } 
/* 1519 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1522 */         if ((curr = key[pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask]) == null) return false; 
/* 1523 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1524 */           Object2IntLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1525 */           Object2IntLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1526 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1534 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1539 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Object2IntLinkedOpenCustomHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1563 */       return new Object2IntLinkedOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1576 */       return new Object2IntLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
/* 1582 */       for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1583 */         int curr = next;
/* 1584 */         next = (int)Object2IntLinkedOpenCustomHashMap.this.link[curr];
/* 1585 */         consumer.accept(new Object2IntLinkedOpenCustomHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1592 */       Object2IntLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2IntLinkedOpenCustomHashMap.MapEntry();
/* 1593 */       for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1594 */         entry.index = next;
/* 1595 */         next = (int)Object2IntLinkedOpenCustomHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1622 */       return Object2IntLinkedOpenCustomHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1634 */       action.accept(Object2IntLinkedOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1639 */       return Object2IntLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1648 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1653 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1663 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2IntLinkedOpenCustomHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1669 */       for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1670 */         int curr = next;
/* 1671 */         next = (int)Object2IntLinkedOpenCustomHashMap.this.link[curr];
/* 1672 */         consumer.accept(Object2IntLinkedOpenCustomHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1678 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1683 */       return Object2IntLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1688 */       int oldSize = Object2IntLinkedOpenCustomHashMap.this.size;
/* 1689 */       Object2IntLinkedOpenCustomHashMap.this.removeInt(k);
/* 1690 */       return (Object2IntLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1695 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1700 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1701 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1706 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1748 */       return Object2IntLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1760 */       action.accept(Object2IntLinkedOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1765 */       return Object2IntLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public IntCollection values() {
/* 1771 */     if (this.values == null) this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public IntIterator iterator() {
/* 1776 */             return (IntIterator)new Object2IntLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1786 */             return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2IntLinkedOpenCustomHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1792 */             for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1793 */               int curr = next;
/* 1794 */               next = (int)Object2IntLinkedOpenCustomHashMap.this.link[curr];
/* 1795 */               consumer.accept(Object2IntLinkedOpenCustomHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1801 */             return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1806 */             return Object2IntLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1811 */             Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1875 */     K[] key = this.key;
/* 1876 */     int[] value = this.value;
/* 1877 */     int mask = newN - 1;
/* 1878 */     K[] newKey = (K[])new Object[newN + 1];
/* 1879 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1931 */       c = (Object2IntLinkedOpenCustomHashMap<K>)super.clone();
...
/* 1940 */     c.value = (int[])this.value.clone();
...
/* 1989 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2IntLinkedOpenCustomHashMap.class
