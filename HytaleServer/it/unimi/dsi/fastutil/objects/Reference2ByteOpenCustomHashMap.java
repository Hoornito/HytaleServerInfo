...
/*      */     
/*      */     public K getKey() {
/*  620 */       return Reference2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  625 */       return Reference2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  630 */       return Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  635 */       return Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  640 */       byte oldValue = Reference2ByteOpenCustomHashMap.this.value[this.index];
/*  641 */       Reference2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  642 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceBytePair<K> right(byte v) {
/*  647 */       Reference2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  648 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  659 */       return Byte.valueOf(Reference2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  678 */       return (Reference2ByteOpenCustomHashMap.this.strategy.equals(Reference2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  683 */       return Reference2ByteOpenCustomHashMap.this.strategy.hashCode(Reference2ByteOpenCustomHashMap.this.key[this.index]) ^ Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  688 */       return (new StringBuilder()).append(Reference2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ByteOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  699 */     int pos = Reference2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  705 */     int last = -1;
/*      */     
/*  707 */     int c = Reference2ByteOpenCustomHashMap.this.size;
/*      */     
/*  709 */     boolean mustReturnNullKey = Reference2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  728 */         return this.last = Reference2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  730 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  732 */         if (--this.pos < 0) {
/*      */           
/*  734 */           this.last = Integer.MIN_VALUE;
/*  735 */           K k = this.wrapped.get(-this.pos - 1);
/*  736 */           int p = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  737 */           for (; !Reference2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ByteOpenCustomHashMap.this.mask);
/*  738 */           return p;
/*      */         } 
...
/*  747 */         acceptOnIndex(action, this.last = Reference2ByteOpenCustomHashMap.this.n);
/*  748 */         this.c--;
/*      */       } 
/*  750 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*  751 */       while (this.c != 0) {
/*  752 */         if (--this.pos < 0) {
/*      */           
/*  754 */           this.last = Integer.MIN_VALUE;
/*  755 */           K k = this.wrapped.get(-this.pos - 1);
/*  756 */           int p = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  757 */           for (; !Reference2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Reference2ByteOpenCustomHashMap.this.mask);
...
/*  777 */       K[] key = Reference2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  779 */         pos = (last = pos) + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  781 */           if ((curr = key[pos]) == null) {
/*  782 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  785 */           int slot = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  786 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  787 */             break;  pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  789 */         if (pos < last) {
...
/*      */         } 
/*  793 */         key[last] = curr;
/*  794 */         Reference2ByteOpenCustomHashMap.this.value[last] = Reference2ByteOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  799 */       if (this.last == -1) throw new IllegalStateException(); 
/*  800 */       if (this.last == Reference2ByteOpenCustomHashMap.this.n)
/*  801 */       { Reference2ByteOpenCustomHashMap.this.containsNullKey = false;
/*  802 */         Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n] = null; }
/*  803 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  806 */       { Reference2ByteOpenCustomHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  807 */         this.last = -1;
/*      */         return; }
/*      */       
/*  810 */       Reference2ByteOpenCustomHashMap.this.size--;
/*  811 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2ByteMap.Entry<K>>> implements ObjectIterator<Reference2ByteMap.Entry<K>> { public Reference2ByteOpenCustomHashMap<K>.MapEntry next() {
/*  827 */       return this.entry = new Reference2ByteOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  833 */       action.accept(this.entry = new Reference2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2ByteMap.Entry<K>>> implements ObjectIterator<Reference2ByteMap.Entry<K>> {
/*      */     private FastEntryIterator() {
/*  844 */       this.entry = new Reference2ByteOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  865 */     int pos = 0;
/*      */     
/*  867 */     int max = Reference2ByteOpenCustomHashMap.this.n;
/*      */     
/*  869 */     int c = 0;
/*      */     
/*  871 */     boolean mustReturnNull = Reference2ByteOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  891 */         this.c++;
/*  892 */         acceptOnIndex(action, Reference2ByteOpenCustomHashMap.this.n);
/*  893 */         return true;
/*      */       } 
/*  895 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
...
/*  910 */         this.c++;
/*  911 */         acceptOnIndex(action, Reference2ByteOpenCustomHashMap.this.n);
/*      */       } 
/*  913 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
...
/*      */       {
/*  926 */         return (Reference2ByteOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  931 */       return Math.min((Reference2ByteOpenCustomHashMap.this.size - this.c), (long)(Reference2ByteOpenCustomHashMap.this.realSize() / Reference2ByteOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  959 */         n--;
/*      */       } 
/*  961 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Reference2ByteMap.Entry<K>>, EntrySpliterator> implements ObjectSpliterator<Reference2ByteMap.Entry<K>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
/*  989 */       action.accept(new Reference2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1001 */       return new Reference2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/* 1006 */       return new Reference2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Reference2ByteMap.Entry<K>> spliterator() {
/* 1011 */       return new Reference2ByteOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1023 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) return (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v);
/*      */       
/* 1025 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1028 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null) return false; 
/* 1029 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1032 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null) return false; 
/* 1033 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1045 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1046 */         if (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v) {
/* 1047 */           Reference2ByteOpenCustomHashMap.this.removeNullEntry();
/* 1048 */           return true;
/*      */         } 
/* 1050 */         return false;
/*      */       } 
/*      */       
/* 1053 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1056 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null) return false; 
/* 1057 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1058 */         if (Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1059 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1060 */           return true;
/*      */         } 
/* 1062 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1065 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null) return false; 
/* 1066 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1067 */           Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1068 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1069 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1077 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1082 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1088 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(new Reference2ByteOpenCustomHashMap.MapEntry(Reference2ByteOpenCustomHashMap.this.n)); 
/* 1089 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) consumer.accept(new Reference2ByteOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1095 */       Reference2ByteOpenCustomHashMap<K>.MapEntry entry = new Reference2ByteOpenCustomHashMap.MapEntry();
/* 1096 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
/* 1097 */         entry.index = Reference2ByteOpenCustomHashMap.this.n;
/* 1098 */         consumer.accept(entry);
/*      */       } 
/* 1100 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) {
...
/* 1131 */       action.accept(Reference2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1136 */       return Reference2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1157 */       action.accept(Reference2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1169 */       return new Reference2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1174 */       return new Reference2ByteOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1180 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n]); 
/* 1181 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1182 */         K k = Reference2ByteOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1189 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1194 */       return Reference2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1199 */       int oldSize = Reference2ByteOpenCustomHashMap.this.size;
/* 1200 */       Reference2ByteOpenCustomHashMap.this.removeByte(k);
/* 1201 */       return (Reference2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1206 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1234 */       action.accept(Reference2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1239 */       return Reference2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1260 */       action.accept(Reference2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1274 */             return new Reference2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1279 */             return new Reference2ByteOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1285 */             if (Reference2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n]); 
/* 1286 */             for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) consumer.accept(Reference2ByteOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1291 */             return Reference2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1296 */             return Reference2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1301 */             Reference2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1399 */       c = (Reference2ByteOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteOpenCustomHashMap.class
