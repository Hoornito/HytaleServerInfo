...
/*  882 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/*  883 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  993 */       this.next = Object2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  997 */       if ((this.next = Object2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  998 */         if (Object2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1051 */       updatePrevious();
/* 1052 */       updateNext();
/* 1053 */       Object2ByteAVLTreeMap.this.removeByte(this.curr.key);
/* 1054 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1108 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ByteMap.Entry<Object2ByteMap.Entry<K>>>()
/*      */         {
...
/* 1118 */             return new Object2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from) {
/* 1123 */             return new Object2ByteAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1132 */             if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1133 */             Object2ByteAVLTreeMap.Entry<K> f = Object2ByteAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1143 */             if (!(e.getValue() instanceof Byte)) return false; 
/* 1144 */             Object2ByteAVLTreeMap.Entry<K> f = Object2ByteAVLTreeMap.this.findKey((K)e.getKey());
/* 1145 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1146 */             Object2ByteAVLTreeMap.this.removeByte(f.key);
/* 1147 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1152 */             return Object2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1157 */             Object2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ByteMap.Entry<K> first() {
/* 1162 */             return Object2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2ByteMap.Entry<K> last() {
/* 1167 */             return Object2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> to) {
/* 1172 */             return Object2ByteAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
/* 1177 */             return Object2ByteAVLTreeMap.this.headMap(to.getKey()).object2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from) {
/* 1182 */             return Object2ByteAVLTreeMap.this.tailMap(from.getKey()).object2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1219 */       return new Object2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1224 */       return new Object2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1274 */     if (this.values == null) this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1277 */             return (ByteIterator)new Object2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1282 */             return Object2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1287 */             return Object2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1292 */             Object2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1354 */       if (!bottom && !top && Object2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1355 */       this.from = from;
/* 1356 */       this.bottom = bottom;
/* 1357 */       this.to = to;
/* 1358 */       this.top = top;
/* 1359 */       this.defRetValue = Object2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1378 */       return ((this.bottom || Object2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
/* 1383 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ByteMap.Entry<Object2ByteMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator() {
/* 1386 */               return new Object2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from) {
/* 1391 */               return new Object2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2ByteMap.Entry<K>> comparator() {
/* 1396 */               return Object2ByteAVLTreeMap.this.object2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1405 */               Object2ByteAVLTreeMap.Entry<K> f = Object2ByteAVLTreeMap.this.findKey((K)e.getKey());
/* 1406 */               return (f != null && Object2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1414 */               if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1415 */               Object2ByteAVLTreeMap.Entry<K> f = Object2ByteAVLTreeMap.this.findKey((K)e.getKey());
/* 1416 */               if (f != null && Object2ByteAVLTreeMap.Submap.this.in(f.key)) Object2ByteAVLTreeMap.Submap.this.removeByte(f.key); 
/* 1417 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1429 */               return !(new Object2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1434 */               Object2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ByteMap.Entry<K> first() {
/* 1439 */               return Object2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2ByteMap.Entry<K> last() {
/* 1444 */               return Object2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> to) {
/* 1449 */               return Object2ByteAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
/* 1454 */               return Object2ByteAVLTreeMap.Submap.this.headMap(to.getKey()).object2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from) {
/* 1459 */               return Object2ByteAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1468 */         return new Object2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1473 */         return new Object2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ByteCollection values() {
/* 1485 */       if (this.values == null) this.values = (ByteCollection)new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1488 */               return (ByteIterator)new Object2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1493 */               return Object2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1498 */               return Object2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1503 */               Object2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1513 */       return (in((K)k) && Object2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/* 1521 */         byte ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public byte getByte(Object k) {
/* 1531 */       K kk = (K)k; Object2ByteAVLTreeMap.Entry<K> e;
/* 1532 */       return (in(kk) && (e = Object2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(K k, byte v) {
/* 1537 */       Object2ByteAVLTreeMap.this.modified = false;
...
/* 1539 */       byte oldValue = Object2ByteAVLTreeMap.this.put(k, v);
/* 1540 */       return Object2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte removeByte(Object k) {
/* 1546 */       Object2ByteAVLTreeMap.this.modified = false;
/* 1547 */       if (!in((K)k)) return this.defRetValue; 
/* 1548 */       byte oldValue = Object2ByteAVLTreeMap.this.removeByte(k);
/* 1549 */       return Object2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1570 */       return Object2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ByteSortedMap<K> headMap(K to) {
/* 1575 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1576 */       return (Object2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ByteSortedMap<K> tailMap(K from) {
/* 1581 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1582 */       return (Object2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2ByteSortedMap<K> subMap(K from, K to) {
/* 1587 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1588 */       if (!this.top) to = (Object2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1589 */       if (!this.bottom) from = (Object2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1600 */       if (Object2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1604 */       if (this.bottom) { e = Object2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1606 */       { e = Object2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1608 */         if (Object2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1612 */       if (e == null || (!this.top && Object2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1613 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2ByteAVLTreeMap.Entry<K> e;
/* 1622 */       if (Object2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1626 */       if (this.top) { e = Object2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1628 */       { e = Object2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1630 */         if (Object2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1634 */       if (e == null || (!this.bottom && Object2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1635 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1640 */       Object2ByteAVLTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1647 */       Object2ByteAVLTreeMap.Entry<K> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1663 */         this.next = Object2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1667 */         this();
/* 1668 */         if (this.next != null) {
/* 1669 */           if (!Object2ByteAVLTreeMap.Submap.this.bottom && Object2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1670 */           else if (!Object2ByteAVLTreeMap.Submap.this.top && Object2ByteAVLTreeMap.this.compare(k, (this.prev = Object2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1672 */           { this.next = Object2ByteAVLTreeMap.this.locateKey(k);
/* 1673 */             if (Object2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1684 */         if (!Object2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Object2ByteAVLTreeMap.this.compare(this.prev.key, Object2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1689 */         this.next = this.next.next();
/* 1690 */         if (!Object2ByteAVLTreeMap.Submap.this.top && this.next != null && Object2ByteAVLTreeMap.this.compare(this.next.key, Object2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1778 */       c = (Object2ByteAVLTreeMap<K>)super.clone();
...
/* 1851 */     if (n == 1) {
/* 1852 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readByte());
...
/*      */ 
/*      */       
/* 1860 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readByte());
/* 1861 */       entry.right(new Entry<>((K)s.readObject(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2ByteAVLTreeMap.class
