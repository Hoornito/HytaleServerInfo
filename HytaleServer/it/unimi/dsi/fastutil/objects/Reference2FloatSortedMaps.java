...
/*  56 */     ObjectSortedSet<Reference2FloatMap.Entry<K>> entries = map.reference2FloatEntrySet();
/*  57 */     return (entries instanceof Reference2FloatSortedMap.FastSortedEntrySet) ? ((Reference2FloatSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     ObjectSortedSet<Reference2FloatMap.Entry<K>> entries = map.reference2FloatEntrySet();
/*  73 */     Objects.requireNonNull((Reference2FloatSortedMap.FastSortedEntrySet)entries); return (entries instanceof Reference2FloatSortedMap.FastSortedEntrySet) ? (Reference2FloatSortedMap.FastSortedEntrySet)entries::fastIterator : entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2FloatSortedMap<K> headMap(K to) {
/* 124 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public Reference2FloatSortedMap<K> tailMap(K from) {
/* 130 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     
/*     */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
/* 195 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new AbstractReference2FloatMap.BasicEntry<>(this.key, this.value), (Comparator)Reference2FloatSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Reference2FloatMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 208 */       return (ObjectSortedSet)reference2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 221 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 228 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 235 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public K firstKey() {
...
/*     */     extends Reference2FloatMaps.SynchronizedMap<K> implements Reference2FloatSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
/* 335 */       if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2FloatEntrySet(), this.sync); 
/* 336 */       return (ObjectSortedSet<Reference2FloatMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 348 */       return (ObjectSortedSet)reference2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/*     */     extends Reference2FloatMaps.UnmodifiableMap<K> implements Reference2FloatSortedMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Reference2FloatSortedMap<K> sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() {
/* 429 */       if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2FloatEntrySet()); 
/* 430 */       return (ObjectSortedSet<Reference2FloatMap.Entry<K>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 442 */       return (ObjectSortedSet)reference2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2FloatSortedMaps.class
