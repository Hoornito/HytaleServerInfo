...
/*  268 */     int oldValue = this.value[this.n];
/*  269 */     this.size--;
...
/*  329 */     int oldValue = this.value[pos];
...
/*  426 */     int oldValue = this.value[pos];
...
/*  777 */     if (k == curr && v == this.value[pos]) {
/*  778 */       removeEntry(pos);
/*  779 */       return true;
/*      */     } 
/*      */     while (true) {
/*  782 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  783 */       if (k == curr && v == this.value[pos]) {
/*  784 */         removeEntry(pos);
/*  785 */         return true;
/*      */       } 
/*      */     } 
...
/*  804 */     int oldValue = this.value[pos];
...
/*  815 */     int newValue = mappingFunction.applyAsInt(k);
...
/*  827 */     int newValue = mappingFunction.getInt(key);
...
/*  838 */     Integer newValue = remappingFunction.apply(k, Integer.valueOf(this.value[pos]));
/*  839 */     if (newValue == null) {
/*  840 */       if (k == null) { removeNullEntry(); }
/*  841 */       else { removeEntry(pos); }
/*  842 */        return this.defRetValue;
/*      */     } 
/*  844 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  851 */     int pos = find(k);
/*  852 */     Integer newValue = remappingFunction.apply(k, (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  860 */     int newVal = newValue.intValue();
/*  861 */     if (pos < 0) {
...
/*  877 */        return v;
/*      */     } 
/*  879 */     Integer newValue = remappingFunction.apply(Integer.valueOf(this.value[pos]), Integer.valueOf(v));
/*  880 */     if (newValue == null) {
/*  881 */       if (k == null) { removeNullEntry(); }
/*  882 */       else { removeEntry(pos); }
/*  883 */        return this.defRetValue;
/*      */     } 
/*  885 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  931 */       return Reference2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  936 */       return Reference2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  941 */       return Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  946 */       return Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  951 */       int oldValue = Reference2IntLinkedOpenHashMap.this.value[this.index];
/*  952 */       Reference2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  953 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ReferenceIntPair<K> right(int v) {
/*  958 */       Reference2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  959 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  970 */       return Integer.valueOf(Reference2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  981 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  988 */       Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
/*  989 */       return (Reference2IntLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  994 */       return System.identityHashCode(Reference2IntLinkedOpenHashMap.this.key[this.index]) ^ Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  999 */       return (new StringBuilder()).append(Reference2IntLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2IntLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1167 */       this.next = Reference2IntLinkedOpenHashMap.this.first;
/* 1168 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1172 */       if (from == null) {
/* 1173 */         if (Reference2IntLinkedOpenHashMap.this.containsNullKey) {
/* 1174 */           this.next = (int)Reference2IntLinkedOpenHashMap.this.link[Reference2IntLinkedOpenHashMap.this.n];
/* 1175 */           this.prev = Reference2IntLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1177 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1179 */       if (Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.last] == from) {
/* 1180 */         this.prev = Reference2IntLinkedOpenHashMap.this.last;
/* 1181 */         this.index = Reference2IntLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1185 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2IntLinkedOpenHashMap.this.mask;
/*      */       
/* 1187 */       while (Reference2IntLinkedOpenHashMap.this.key[pos] != null) {
/* 1188 */         if (Reference2IntLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1190 */           this.next = (int)Reference2IntLinkedOpenHashMap.this.link[pos];
/* 1191 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1194 */         pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1213 */       if (this.next == -1) {
/* 1214 */         this.index = Reference2IntLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1217 */       int pos = Reference2IntLinkedOpenHashMap.this.first;
/* 1218 */       this.index = 1;
/* 1219 */       while (pos != this.prev) {
/* 1220 */         pos = (int)Reference2IntLinkedOpenHashMap.this.link[pos];
/* 1221 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1238 */       this.next = (int)Reference2IntLinkedOpenHashMap.this.link[this.curr];
...
/* 1247 */       this.prev = (int)(Reference2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1256 */         this.next = (int)Reference2IntLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1269 */         this.index--;
/* 1270 */         this.prev = (int)(Reference2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1271 */       else { this.next = (int)Reference2IntLinkedOpenHashMap.this.link[this.curr]; }
/* 1272 */        Reference2IntLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1275 */       if (this.prev == -1) { Reference2IntLinkedOpenHashMap.this.first = this.next; }
/* 1276 */       else { Reference2IntLinkedOpenHashMap.this.link[this.prev] = Reference2IntLinkedOpenHashMap.this.link[this.prev] ^ (Reference2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1277 */        if (this.next == -1) { Reference2IntLinkedOpenHashMap.this.last = this.prev; }
/* 1278 */       else { Reference2IntLinkedOpenHashMap.this.link[this.next] = Reference2IntLinkedOpenHashMap.this.link[this.next] ^ (Reference2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1279 */        int pos = this.curr;
/* 1280 */       this.curr = -1;
/* 1281 */       if (pos == Reference2IntLinkedOpenHashMap.this.n) {
/* 1282 */         Reference2IntLinkedOpenHashMap.this.containsNullKey = false;
/* 1283 */         Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1286 */         K[] key = Reference2IntLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1289 */           pos = (last = pos) + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1291 */             if ((curr = key[pos]) == null) {
/* 1292 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1295 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2IntLinkedOpenHashMap.this.mask;
/* 1296 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1297 */               break;  pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1299 */           key[last] = curr;
/* 1300 */           Reference2IntLinkedOpenHashMap.this.value[last] = Reference2IntLinkedOpenHashMap.this.value[pos];
/* 1301 */           if (this.next == pos) this.next = last; 
/* 1302 */           if (this.prev == pos) this.prev = last; 
/* 1303 */           Reference2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Reference2IntMap.Entry<K>>> implements ObjectListIterator<Reference2IntMap.Entry<K>> {
...
/* 1342 */       action.accept(new Reference2IntLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2IntLinkedOpenHashMap<K>.MapEntry next() {
/* 1347 */       return this.entry = new Reference2IntLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2IntLinkedOpenHashMap<K>.MapEntry previous() {
/* 1352 */       return this.entry = new Reference2IntLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Reference2IntMap.Entry<K>>> implements ObjectListIterator<Reference2IntMap.Entry<K>> {
/* 1363 */     final Reference2IntLinkedOpenHashMap<K>.MapEntry entry = new Reference2IntLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1397 */       return new Reference2IntLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1415 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2IntLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1440 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1441 */       return new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Reference2IntMap.Entry<K> last() {
/* 1446 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1447 */       return new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1455 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1456 */       K k = (K)e.getKey();
/* 1457 */       int v = ((Integer)e.getValue()).intValue();
/* 1458 */       if (k == null) return (Reference2IntLinkedOpenHashMap.this.containsNullKey && Reference2IntLinkedOpenHashMap.this.value[Reference2IntLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1460 */       K[] key = Reference2IntLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1463 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2IntLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1464 */       if (k == curr) return (Reference2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1467 */         if ((curr = key[pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1468 */         if (k == curr) return (Reference2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1480 */       if (k == null) {
/* 1481 */         if (Reference2IntLinkedOpenHashMap.this.containsNullKey && Reference2IntLinkedOpenHashMap.this.value[Reference2IntLinkedOpenHashMap.this.n] == v) {
/* 1482 */           Reference2IntLinkedOpenHashMap.this.removeNullEntry();
/* 1483 */           return true;
/*      */         } 
/* 1485 */         return false;
/*      */       } 
/*      */       
/* 1488 */       K[] key = Reference2IntLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1491 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2IntLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1492 */       if (curr == k) {
/* 1493 */         if (Reference2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1494 */           Reference2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1495 */           return true;
/*      */         } 
/* 1497 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1500 */         if ((curr = key[pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1501 */         if (curr == k && 
/* 1502 */           Reference2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1503 */           Reference2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1504 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1512 */       return Reference2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1517 */       Reference2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       return new Reference2IntLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Reference2IntLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1554 */       return new Reference2IntLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
/* 1560 */       for (int i = Reference2IntLinkedOpenHashMap.this.size, next = Reference2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1561 */         int curr = next;
/* 1562 */         next = (int)Reference2IntLinkedOpenHashMap.this.link[curr];
/* 1563 */         consumer.accept(new Reference2IntLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1570 */       Reference2IntLinkedOpenHashMap<K>.MapEntry entry = new Reference2IntLinkedOpenHashMap.MapEntry();
/* 1571 */       for (int i = Reference2IntLinkedOpenHashMap.this.size, next = Reference2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1572 */         entry.index = next;
/* 1573 */         next = (int)Reference2IntLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1600 */       return Reference2IntLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1612 */       action.accept(Reference2IntLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1617 */       return Reference2IntLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1626 */       return new Reference2IntLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1631 */       return new Reference2IntLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1641 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2IntLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1647 */       for (int i = Reference2IntLinkedOpenHashMap.this.size, next = Reference2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1648 */         int curr = next;
/* 1649 */         next = (int)Reference2IntLinkedOpenHashMap.this.link[curr];
/* 1650 */         consumer.accept(Reference2IntLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1656 */       return Reference2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1661 */       return Reference2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1666 */       int oldSize = Reference2IntLinkedOpenHashMap.this.size;
/* 1667 */       Reference2IntLinkedOpenHashMap.this.removeInt(k);
/* 1668 */       return (Reference2IntLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1673 */       Reference2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1678 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1679 */       return Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1684 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1685 */       return Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1726 */       return Reference2IntLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1738 */       action.accept(Reference2IntLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1743 */       return Reference2IntLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public IntCollection values() {
/* 1749 */     if (this.values == null) this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public IntIterator iterator() {
/* 1754 */             return (IntIterator)new Reference2IntLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1764 */             return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Reference2IntLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1770 */             for (int i = Reference2IntLinkedOpenHashMap.this.size, next = Reference2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1771 */               int curr = next;
/* 1772 */               next = (int)Reference2IntLinkedOpenHashMap.this.link[curr];
/* 1773 */               consumer.accept(Reference2IntLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1779 */             return Reference2IntLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1784 */             return Reference2IntLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1789 */             Reference2IntLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1853 */     K[] key = this.key;
/* 1854 */     int[] value = this.value;
/* 1855 */     int mask = newN - 1;
/* 1856 */     K[] newKey = (K[])new Object[newN + 1];
/* 1857 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1909 */       c = (Reference2IntLinkedOpenHashMap<K>)super.clone();
...
/* 1918 */     c.value = (int[])this.value.clone();
...
/*      */     } 
/*      */     
/* 1943 */     if (this.containsNullKey) h += this.value[this.n]; 
/* 1944 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1948 */     K[] key = this.key;
/* 1949 */     int[] value = this.value;
...
/* 1966 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2IntLinkedOpenHashMap.class
