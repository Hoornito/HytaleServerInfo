...
/*  837 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  838 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  843 */       return this.key.hashCode() ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Object2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  950 */       if ((this.next = Object2LongRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Object2LongRBTreeMap.this.removeLong(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */         {
...
/* 1061 */             return new Object2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1066 */             return new Object2LongRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1075 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1076 */             Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey((K)e.getKey());
...
/* 1086 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1087 */             Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey((K)e.getKey());
/* 1088 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1089 */             Object2LongRBTreeMap.this.removeLong(f.key);
/* 1090 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1095 */             return Object2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1100 */             Object2LongRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2LongMap.Entry<K> first() {
/* 1105 */             return Object2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2LongMap.Entry<K> last() {
/* 1110 */             return Object2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1115 */             return Object2LongRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1120 */             return Object2LongRBTreeMap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1125 */             return Object2LongRBTreeMap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1162 */       return new Object2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1167 */       return new Object2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1217 */     if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1220 */             return (LongIterator)new Object2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1225 */             return Object2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1230 */             return Object2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1235 */             Object2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1297 */       if (!bottom && !top && Object2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1298 */       this.from = from;
/* 1299 */       this.bottom = bottom;
/* 1300 */       this.to = to;
/* 1301 */       this.top = top;
/* 1302 */       this.defRetValue = Object2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1321 */       return ((this.bottom || Object2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2LongRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 1326 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/* 1329 */               return new Object2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1334 */               return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2LongMap.Entry<K>> comparator() {
/* 1339 */               return Object2LongRBTreeMap.this.object2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1347 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1348 */               Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey((K)e.getKey());
/* 1349 */               return (f != null && Object2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1358 */               Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey((K)e.getKey());
/* 1359 */               if (f != null && Object2LongRBTreeMap.Submap.this.in(f.key)) Object2LongRBTreeMap.Submap.this.removeLong(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Object2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Object2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2LongMap.Entry<K> first() {
/* 1382 */               return Object2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2LongMap.Entry<K> last() {
/* 1387 */               return Object2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1392 */               return Object2LongRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1397 */               return Object2LongRBTreeMap.Submap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1402 */               return Object2LongRBTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */             }
/*      */           }; 
/* 1405 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractObject2LongSortedMap<K>.KeySet { private KeySet() {}
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1411 */         return new Object2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1416 */         return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public LongCollection values() {
/* 1428 */       if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1431 */               return (LongIterator)new Object2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1436 */               return Object2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Object2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Object2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1456 */       return (in((K)k) && Object2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long getLong(Object k) {
/* 1474 */       K kk = (K)k; Object2LongRBTreeMap.Entry<K> e;
/* 1475 */       return (in(kk) && (e = Object2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(K k, long v) {
/* 1480 */       Object2LongRBTreeMap.this.modified = false;
...
/* 1482 */       long oldValue = Object2LongRBTreeMap.this.put(k, v);
/* 1483 */       return Object2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long removeLong(Object k) {
/* 1489 */       Object2LongRBTreeMap.this.modified = false;
/* 1490 */       if (!in((K)k)) return this.defRetValue; 
/* 1491 */       long oldValue = Object2LongRBTreeMap.this.removeLong(k);
/* 1492 */       return Object2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1513 */       return Object2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> headMap(K to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Object2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> tailMap(K from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Object2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2LongSortedMap<K> subMap(K from, K to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Object2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Object2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Object2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Object2LongRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Object2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Object2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2LongRBTreeMap.Entry<K> e;
/* 1565 */       if (Object2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Object2LongRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Object2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Object2LongRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1583 */       Object2LongRBTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1590 */       Object2LongRBTreeMap.Entry<K> e = lastEntry();
...
/*      */       extends Object2LongRBTreeMap<K>.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Object2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Object2LongRBTreeMap.Submap.this.bottom && Object2LongRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Object2LongRBTreeMap.Submap.this.top && Object2LongRBTreeMap.this.compare(k, (this.prev = Object2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Object2LongRBTreeMap.this.locateKey(k);
/* 1616 */             if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Object2LongRBTreeMap.Submap.this.bottom && this.prev != null && Object2LongRBTreeMap.this.compare(this.prev.key, Object2LongRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Object2LongRBTreeMap.Submap.this.top && this.next != null && Object2LongRBTreeMap.this.compare(this.next.key, Object2LongRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Object2LongMap.Entry<K>> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1721 */       c = (Object2LongRBTreeMap<K>)super.clone();
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
...
/*      */ 
/*      */       
/* 1804 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry<>((K)s.readObject(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2LongRBTreeMap.class
