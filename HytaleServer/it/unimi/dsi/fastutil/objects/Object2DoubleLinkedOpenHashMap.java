...
/*  777 */     if (k.equals(curr) && Double.doubleToLongBits(v) == Double.doubleToLongBits(this.value[pos])) {
/*  778 */       removeEntry(pos);
/*  779 */       return true;
/*      */     } 
/*      */     while (true) {
/*  782 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  783 */       if (k.equals(curr) && Double.doubleToLongBits(v) == Double.doubleToLongBits(this.value[pos])) {
/*  784 */         removeEntry(pos);
/*  785 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  931 */       return Object2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  936 */       return Object2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  941 */       return Object2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  946 */       return Object2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  951 */       double oldValue = Object2DoubleLinkedOpenHashMap.this.value[this.index];
/*  952 */       Object2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  953 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectDoublePair<K> right(double v) {
/*  958 */       Object2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  959 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  970 */       return Double.valueOf(Object2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  989 */       return (Objects.equals(Object2DoubleLinkedOpenHashMap.this.key[this.index], e.getKey()) && Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  994 */       return ((Object2DoubleLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2DoubleLinkedOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.double2int(Object2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  999 */       return (new StringBuilder()).append(Object2DoubleLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2DoubleLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1167 */       this.next = Object2DoubleLinkedOpenHashMap.this.first;
/* 1168 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1172 */       if (from == null) {
/* 1173 */         if (Object2DoubleLinkedOpenHashMap.this.containsNullKey) {
/* 1174 */           this.next = (int)Object2DoubleLinkedOpenHashMap.this.link[Object2DoubleLinkedOpenHashMap.this.n];
/* 1175 */           this.prev = Object2DoubleLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1177 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1179 */       if (Objects.equals(Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.last], from)) {
/* 1180 */         this.prev = Object2DoubleLinkedOpenHashMap.this.last;
/* 1181 */         this.index = Object2DoubleLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1185 */       int pos = HashCommon.mix(from.hashCode()) & Object2DoubleLinkedOpenHashMap.this.mask;
/*      */       
/* 1187 */       while (Object2DoubleLinkedOpenHashMap.this.key[pos] != null) {
/* 1188 */         if (Object2DoubleLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1190 */           this.next = (int)Object2DoubleLinkedOpenHashMap.this.link[pos];
/* 1191 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1194 */         pos = pos + 1 & Object2DoubleLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1213 */       if (this.next == -1) {
/* 1214 */         this.index = Object2DoubleLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1217 */       int pos = Object2DoubleLinkedOpenHashMap.this.first;
/* 1218 */       this.index = 1;
/* 1219 */       while (pos != this.prev) {
/* 1220 */         pos = (int)Object2DoubleLinkedOpenHashMap.this.link[pos];
/* 1221 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1238 */       this.next = (int)Object2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/* 1247 */       this.prev = (int)(Object2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1256 */         this.next = (int)Object2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1269 */         this.index--;
/* 1270 */         this.prev = (int)(Object2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1271 */       else { this.next = (int)Object2DoubleLinkedOpenHashMap.this.link[this.curr]; }
/* 1272 */        Object2DoubleLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1275 */       if (this.prev == -1) { Object2DoubleLinkedOpenHashMap.this.first = this.next; }
/* 1276 */       else { Object2DoubleLinkedOpenHashMap.this.link[this.prev] = Object2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (Object2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1277 */        if (this.next == -1) { Object2DoubleLinkedOpenHashMap.this.last = this.prev; }
/* 1278 */       else { Object2DoubleLinkedOpenHashMap.this.link[this.next] = Object2DoubleLinkedOpenHashMap.this.link[this.next] ^ (Object2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1279 */        int pos = this.curr;
/* 1280 */       this.curr = -1;
/* 1281 */       if (pos == Object2DoubleLinkedOpenHashMap.this.n) {
/* 1282 */         Object2DoubleLinkedOpenHashMap.this.containsNullKey = false;
/* 1283 */         Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1286 */         K[] key = Object2DoubleLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1289 */           pos = (last = pos) + 1 & Object2DoubleLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1291 */             if ((curr = key[pos]) == null) {
/* 1292 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1295 */             int slot = HashCommon.mix(curr.hashCode()) & Object2DoubleLinkedOpenHashMap.this.mask;
/* 1296 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1297 */               break;  pos = pos + 1 & Object2DoubleLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1299 */           key[last] = curr;
/* 1300 */           Object2DoubleLinkedOpenHashMap.this.value[last] = Object2DoubleLinkedOpenHashMap.this.value[pos];
/* 1301 */           if (this.next == pos) this.next = last; 
/* 1302 */           if (this.prev == pos) this.prev = last; 
/* 1303 */           Object2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1342 */       action.accept(new Object2DoubleLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleLinkedOpenHashMap<K>.MapEntry next() {
/* 1347 */       return this.entry = new Object2DoubleLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleLinkedOpenHashMap<K>.MapEntry previous() {
/* 1352 */       return this.entry = new Object2DoubleLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1363 */     final Object2DoubleLinkedOpenHashMap<K>.MapEntry entry = new Object2DoubleLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1397 */       return new Object2DoubleLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1415 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2DoubleLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1440 */       if (Object2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1441 */       return new Object2DoubleLinkedOpenHashMap.MapEntry(Object2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2DoubleMap.Entry<K> last() {
/* 1446 */       if (Object2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1447 */       return new Object2DoubleLinkedOpenHashMap.MapEntry(Object2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1458 */       if (k == null) return (Object2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[Object2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1460 */       K[] key = Object2DoubleLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1463 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2DoubleLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1464 */       if (k.equals(curr)) return (Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1467 */         if ((curr = key[pos = pos + 1 & Object2DoubleLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1468 */         if (k.equals(curr)) return (Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1480 */       if (k == null) {
/* 1481 */         if (Object2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[Object2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1482 */           Object2DoubleLinkedOpenHashMap.this.removeNullEntry();
/* 1483 */           return true;
/*      */         } 
/* 1485 */         return false;
/*      */       } 
/*      */       
/* 1488 */       K[] key = Object2DoubleLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1491 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2DoubleLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1492 */       if (curr.equals(k)) {
/* 1493 */         if (Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1494 */           Object2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1495 */           return true;
/*      */         } 
/* 1497 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1500 */         if ((curr = key[pos = pos + 1 & Object2DoubleLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1501 */         if (curr.equals(k) && 
/* 1502 */           Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1503 */           Object2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1504 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1512 */       return Object2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1517 */       Object2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       return new Object2DoubleLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Object2DoubleLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1554 */       return new Object2DoubleLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
/* 1560 */       for (int i = Object2DoubleLinkedOpenHashMap.this.size, next = Object2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1561 */         int curr = next;
/* 1562 */         next = (int)Object2DoubleLinkedOpenHashMap.this.link[curr];
/* 1563 */         consumer.accept(new Object2DoubleLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1570 */       Object2DoubleLinkedOpenHashMap<K>.MapEntry entry = new Object2DoubleLinkedOpenHashMap.MapEntry();
/* 1571 */       for (int i = Object2DoubleLinkedOpenHashMap.this.size, next = Object2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1572 */         entry.index = next;
/* 1573 */         next = (int)Object2DoubleLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1600 */       return Object2DoubleLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1612 */       action.accept(Object2DoubleLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1617 */       return Object2DoubleLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1626 */       return new Object2DoubleLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1631 */       return new Object2DoubleLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1641 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2DoubleLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1647 */       for (int i = Object2DoubleLinkedOpenHashMap.this.size, next = Object2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1648 */         int curr = next;
/* 1649 */         next = (int)Object2DoubleLinkedOpenHashMap.this.link[curr];
/* 1650 */         consumer.accept(Object2DoubleLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1656 */       return Object2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1661 */       return Object2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1666 */       int oldSize = Object2DoubleLinkedOpenHashMap.this.size;
/* 1667 */       Object2DoubleLinkedOpenHashMap.this.removeDouble(k);
/* 1668 */       return (Object2DoubleLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1673 */       Object2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1678 */       if (Object2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1679 */       return Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1684 */       if (Object2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1685 */       return Object2DoubleLinkedOpenHashMap.this.key[Object2DoubleLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1726 */       return Object2DoubleLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1738 */       action.accept(Object2DoubleLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1743 */       return Object2DoubleLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1754 */             return (DoubleIterator)new Object2DoubleLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1764 */             return DoubleSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2DoubleLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1770 */             for (int i = Object2DoubleLinkedOpenHashMap.this.size, next = Object2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1771 */               int curr = next;
/* 1772 */               next = (int)Object2DoubleLinkedOpenHashMap.this.link[curr];
/* 1773 */               consumer.accept(Object2DoubleLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1779 */             return Object2DoubleLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1784 */             return Object2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1789 */             Object2DoubleLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1909 */       c = (Object2DoubleLinkedOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleLinkedOpenHashMap.class
