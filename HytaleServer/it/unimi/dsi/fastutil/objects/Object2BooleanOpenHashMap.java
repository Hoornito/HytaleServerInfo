...
/*      */           return;
/*      */         } 
/*  289 */         int slot = HashCommon.mix(curr.hashCode()) & this.mask;
...
/*      */     K curr;
/*      */     int pos;
/*  309 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  310 */     if (k.equals(curr)) return removeEntry(pos); 
/*      */     while (true) {
/*  312 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return this.defRetValue; 
/*  313 */       if (k.equals(curr)) return removeEntry(pos);
/*      */     
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  325 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  326 */     if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  329 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return this.defRetValue; 
/*  330 */       if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  342 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return false; 
/*  343 */     if (k.equals(curr)) return true;
/*      */     
/*      */     while (true) {
/*  346 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  347 */       if (k.equals(curr)) return true;
/*      */     
/*      */     } 
/*      */   }
/*      */   
...
/*      */     K curr;
/*      */     int pos;
/*  369 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return defaultValue; 
/*  370 */     if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  373 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return defaultValue; 
/*  374 */       if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  402 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return false; 
/*  403 */     if (k.equals(curr) && v == this.value[pos]) {
/*  404 */       removeEntry(pos);
/*  405 */       return true;
/*      */     } 
/*      */     while (true) {
/*  408 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  409 */       if (k.equals(curr) && v == this.value[pos]) {
/*  410 */         removeEntry(pos);
/*  411 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  556 */       return Object2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  561 */       return Object2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  566 */       return Object2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  571 */       return Object2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  576 */       boolean oldValue = Object2BooleanOpenHashMap.this.value[this.index];
/*  577 */       Object2BooleanOpenHashMap.this.value[this.index] = v;
/*  578 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBooleanPair<K> right(boolean v) {
/*  583 */       Object2BooleanOpenHashMap.this.value[this.index] = v;
/*  584 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  595 */       return Boolean.valueOf(Object2BooleanOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  614 */       return (Objects.equals(Object2BooleanOpenHashMap.this.key[this.index], e.getKey()) && Object2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  619 */       return ((Object2BooleanOpenHashMap.this.key[this.index] == null) ? 0 : Object2BooleanOpenHashMap.this.key[this.index].hashCode()) ^ (Object2BooleanOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  624 */       return (new StringBuilder()).append(Object2BooleanOpenHashMap.this.key[this.index]).append("=>").append(Object2BooleanOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  635 */     int pos = Object2BooleanOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  641 */     int last = -1;
/*      */     
/*  643 */     int c = Object2BooleanOpenHashMap.this.size;
/*      */     
/*  645 */     boolean mustReturnNullKey = Object2BooleanOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  664 */         return this.last = Object2BooleanOpenHashMap.this.n;
/*      */       } 
/*  666 */       K[] key = Object2BooleanOpenHashMap.this.key;
/*      */       while (true) {
/*  668 */         if (--this.pos < 0) {
/*      */           
/*  670 */           this.last = Integer.MIN_VALUE;
/*  671 */           K k = this.wrapped.get(-this.pos - 1);
/*  672 */           int p = HashCommon.mix(k.hashCode()) & Object2BooleanOpenHashMap.this.mask;
/*  673 */           for (; !k.equals(key[p]); p = p + 1 & Object2BooleanOpenHashMap.this.mask);
/*  674 */           return p;
/*      */         } 
...
/*  683 */         acceptOnIndex(action, this.last = Object2BooleanOpenHashMap.this.n);
/*  684 */         this.c--;
/*      */       } 
/*  686 */       K[] key = Object2BooleanOpenHashMap.this.key;
/*  687 */       while (this.c != 0) {
/*  688 */         if (--this.pos < 0) {
/*      */           
/*  690 */           this.last = Integer.MIN_VALUE;
/*  691 */           K k = this.wrapped.get(-this.pos - 1);
/*  692 */           int p = HashCommon.mix(k.hashCode()) & Object2BooleanOpenHashMap.this.mask;
/*  693 */           for (; !k.equals(key[p]); p = p + 1 & Object2BooleanOpenHashMap.this.mask);
...
/*  713 */       K[] key = Object2BooleanOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  715 */         pos = (last = pos) + 1 & Object2BooleanOpenHashMap.this.mask;
/*      */         while (true) {
/*  717 */           if ((curr = key[pos]) == null) {
/*  718 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  721 */           int slot = HashCommon.mix(curr.hashCode()) & Object2BooleanOpenHashMap.this.mask;
/*  722 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  723 */             break;  pos = pos + 1 & Object2BooleanOpenHashMap.this.mask;
/*      */         } 
/*  725 */         if (pos < last) {
/*  726 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList<>(2); 
/*  727 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  729 */         key[last] = curr;
/*  730 */         Object2BooleanOpenHashMap.this.value[last] = Object2BooleanOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  735 */       if (this.last == -1) throw new IllegalStateException(); 
/*  736 */       if (this.last == Object2BooleanOpenHashMap.this.n)
/*  737 */       { Object2BooleanOpenHashMap.this.containsNullKey = false;
/*  738 */         Object2BooleanOpenHashMap.this.key[Object2BooleanOpenHashMap.this.n] = null; }
/*  739 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  742 */       { Object2BooleanOpenHashMap.this.removeBoolean(this.wrapped.set(-this.pos - 1, null));
/*  743 */         this.last = -1;
/*      */         return; }
/*      */       
/*  746 */       Object2BooleanOpenHashMap.this.size--;
/*  747 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Object2BooleanMap.Entry<K>>> implements ObjectIterator<Object2BooleanMap.Entry<K>> { public Object2BooleanOpenHashMap<K>.MapEntry next() {
/*  763 */       return this.entry = new Object2BooleanOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  769 */       action.accept(this.entry = new Object2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  780 */       this.entry = new Object2BooleanOpenHashMap.MapEntry();
/*      */     }
...
/*  801 */     int pos = 0;
/*      */     
/*  803 */     int max = Object2BooleanOpenHashMap.this.n;
/*      */     
/*  805 */     int c = 0;
/*      */     
/*  807 */     boolean mustReturnNull = Object2BooleanOpenHashMap.this.containsNullKey;
/*      */     
...
/*  827 */         this.c++;
/*  828 */         acceptOnIndex(action, Object2BooleanOpenHashMap.this.n);
/*  829 */         return true;
/*      */       } 
/*  831 */       K[] key = Object2BooleanOpenHashMap.this.key;
...
/*  846 */         this.c++;
/*  847 */         acceptOnIndex(action, Object2BooleanOpenHashMap.this.n);
/*      */       } 
/*  849 */       K[] key = Object2BooleanOpenHashMap.this.key;
...
/*      */       {
/*  862 */         return (Object2BooleanOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  867 */       return Math.min((Object2BooleanOpenHashMap.this.size - this.c), (long)(Object2BooleanOpenHashMap.this.realSize() / Object2BooleanOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  895 */         n--;
/*      */       } 
/*  897 */       K[] key = Object2BooleanOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Object2BooleanMap.Entry<K>> action, int index) {
/*  925 */       action.accept(new Object2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  937 */       return new Object2BooleanOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Object2BooleanMap.Entry<K>> fastIterator() {
/*  942 */       return new Object2BooleanOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Object2BooleanMap.Entry<K>> spliterator() {
/*  947 */       return new Object2BooleanOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  959 */       if (k == null) return (Object2BooleanOpenHashMap.this.containsNullKey && Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n] == v);
/*      */       
/*  961 */       K[] key = Object2BooleanOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  964 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2BooleanOpenHashMap.this.mask]) == null) return false; 
/*  965 */       if (k.equals(curr)) return (Object2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  968 */         if ((curr = key[pos = pos + 1 & Object2BooleanOpenHashMap.this.mask]) == null) return false; 
/*  969 */         if (k.equals(curr)) return (Object2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  981 */       if (k == null) {
/*  982 */         if (Object2BooleanOpenHashMap.this.containsNullKey && Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n] == v) {
/*  983 */           Object2BooleanOpenHashMap.this.removeNullEntry();
/*  984 */           return true;
/*      */         } 
/*  986 */         return false;
/*      */       } 
/*      */       
/*  989 */       K[] key = Object2BooleanOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  992 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2BooleanOpenHashMap.this.mask]) == null) return false; 
/*  993 */       if (curr.equals(k)) {
/*  994 */         if (Object2BooleanOpenHashMap.this.value[pos] == v) {
/*  995 */           Object2BooleanOpenHashMap.this.removeEntry(pos);
/*  996 */           return true;
/*      */         } 
/*  998 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1001 */         if ((curr = key[pos = pos + 1 & Object2BooleanOpenHashMap.this.mask]) == null) return false; 
/* 1002 */         if (curr.equals(k) && 
/* 1003 */           Object2BooleanOpenHashMap.this.value[pos] == v) {
/* 1004 */           Object2BooleanOpenHashMap.this.removeEntry(pos);
/* 1005 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1013 */       return Object2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1018 */       Object2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
/* 1024 */       if (Object2BooleanOpenHashMap.this.containsNullKey) consumer.accept(new Object2BooleanOpenHashMap.MapEntry(Object2BooleanOpenHashMap.this.n)); 
/* 1025 */       for (int pos = Object2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Object2BooleanOpenHashMap.this.key[pos] != null) consumer.accept(new Object2BooleanOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
/* 1031 */       Object2BooleanOpenHashMap<K>.MapEntry entry = new Object2BooleanOpenHashMap.MapEntry();
/* 1032 */       if (Object2BooleanOpenHashMap.this.containsNullKey) {
/* 1033 */         entry.index = Object2BooleanOpenHashMap.this.n;
/* 1034 */         consumer.accept(entry);
/*      */       } 
/* 1036 */       for (int pos = Object2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Object2BooleanOpenHashMap.this.key[pos] != null) {
...
/* 1067 */       action.accept(Object2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1072 */       return Object2BooleanOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super K> action, int index) {
/* 1093 */       action.accept(Object2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1105 */       return new Object2BooleanOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<K> spliterator() {
/* 1110 */       return new Object2BooleanOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1116 */       if (Object2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Object2BooleanOpenHashMap.this.key[Object2BooleanOpenHashMap.this.n]); 
/* 1117 */       for (int pos = Object2BooleanOpenHashMap.this.n; pos-- != 0; ) {
/* 1118 */         K k = Object2BooleanOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1125 */       return Object2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1130 */       return Object2BooleanOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1135 */       int oldSize = Object2BooleanOpenHashMap.this.size;
/* 1136 */       Object2BooleanOpenHashMap.this.removeBoolean(k);
/* 1137 */       return (Object2BooleanOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1142 */       Object2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1170 */       action.accept(Object2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1175 */       return Object2BooleanOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1196 */       action.accept(Object2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1210 */             return new Object2BooleanOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1215 */             return new Object2BooleanOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1221 */             if (Object2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n]); 
/* 1222 */             for (int pos = Object2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Object2BooleanOpenHashMap.this.key[pos] != null) consumer.accept(Object2BooleanOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1227 */             return Object2BooleanOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1232 */             return Object2BooleanOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Object2BooleanOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1309 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null) while (newKey[pos = pos + 1 & mask] != null); 
...
/*      */     try {
/* 1335 */       c = (Object2BooleanOpenHashMap<K>)super.clone();
...
/* 1362 */       if (this != this.key[i]) t = this.key[i].hashCode(); 
...
/*      */       } else {
/* 1401 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2BooleanOpenHashMap.class
