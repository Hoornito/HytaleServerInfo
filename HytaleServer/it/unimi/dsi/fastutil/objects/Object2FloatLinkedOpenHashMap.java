...
/*  778 */     if (k.equals(curr) && Float.floatToIntBits(v) == Float.floatToIntBits(this.value[pos])) {
/*  779 */       removeEntry(pos);
/*  780 */       return true;
/*      */     } 
/*      */     while (true) {
/*  783 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  784 */       if (k.equals(curr) && Float.floatToIntBits(v) == Float.floatToIntBits(this.value[pos])) {
/*  785 */         removeEntry(pos);
/*  786 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  932 */       return Object2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  937 */       return Object2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  942 */       return Object2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  947 */       return Object2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  952 */       float oldValue = Object2FloatLinkedOpenHashMap.this.value[this.index];
/*  953 */       Object2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  954 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectFloatPair<K> right(float v) {
/*  959 */       Object2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  960 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  971 */       return Float.valueOf(Object2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  990 */       return (Objects.equals(Object2FloatLinkedOpenHashMap.this.key[this.index], e.getKey()) && Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  995 */       return ((Object2FloatLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2FloatLinkedOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.float2int(Object2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1000 */       return (new StringBuilder()).append(Object2FloatLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2FloatLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1168 */       this.next = Object2FloatLinkedOpenHashMap.this.first;
/* 1169 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1173 */       if (from == null) {
/* 1174 */         if (Object2FloatLinkedOpenHashMap.this.containsNullKey) {
/* 1175 */           this.next = (int)Object2FloatLinkedOpenHashMap.this.link[Object2FloatLinkedOpenHashMap.this.n];
/* 1176 */           this.prev = Object2FloatLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1178 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1180 */       if (Objects.equals(Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.last], from)) {
/* 1181 */         this.prev = Object2FloatLinkedOpenHashMap.this.last;
/* 1182 */         this.index = Object2FloatLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1186 */       int pos = HashCommon.mix(from.hashCode()) & Object2FloatLinkedOpenHashMap.this.mask;
/*      */       
/* 1188 */       while (Object2FloatLinkedOpenHashMap.this.key[pos] != null) {
/* 1189 */         if (Object2FloatLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1191 */           this.next = (int)Object2FloatLinkedOpenHashMap.this.link[pos];
/* 1192 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1195 */         pos = pos + 1 & Object2FloatLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1214 */       if (this.next == -1) {
/* 1215 */         this.index = Object2FloatLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1218 */       int pos = Object2FloatLinkedOpenHashMap.this.first;
/* 1219 */       this.index = 1;
/* 1220 */       while (pos != this.prev) {
/* 1221 */         pos = (int)Object2FloatLinkedOpenHashMap.this.link[pos];
/* 1222 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1239 */       this.next = (int)Object2FloatLinkedOpenHashMap.this.link[this.curr];
...
/* 1248 */       this.prev = (int)(Object2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1257 */         this.next = (int)Object2FloatLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1270 */         this.index--;
/* 1271 */         this.prev = (int)(Object2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1272 */       else { this.next = (int)Object2FloatLinkedOpenHashMap.this.link[this.curr]; }
/* 1273 */        Object2FloatLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1276 */       if (this.prev == -1) { Object2FloatLinkedOpenHashMap.this.first = this.next; }
/* 1277 */       else { Object2FloatLinkedOpenHashMap.this.link[this.prev] = Object2FloatLinkedOpenHashMap.this.link[this.prev] ^ (Object2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1278 */        if (this.next == -1) { Object2FloatLinkedOpenHashMap.this.last = this.prev; }
/* 1279 */       else { Object2FloatLinkedOpenHashMap.this.link[this.next] = Object2FloatLinkedOpenHashMap.this.link[this.next] ^ (Object2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1280 */        int pos = this.curr;
/* 1281 */       this.curr = -1;
/* 1282 */       if (pos == Object2FloatLinkedOpenHashMap.this.n) {
/* 1283 */         Object2FloatLinkedOpenHashMap.this.containsNullKey = false;
/* 1284 */         Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1287 */         K[] key = Object2FloatLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1290 */           pos = (last = pos) + 1 & Object2FloatLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1292 */             if ((curr = key[pos]) == null) {
/* 1293 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1296 */             int slot = HashCommon.mix(curr.hashCode()) & Object2FloatLinkedOpenHashMap.this.mask;
/* 1297 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1298 */               break;  pos = pos + 1 & Object2FloatLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1300 */           key[last] = curr;
/* 1301 */           Object2FloatLinkedOpenHashMap.this.value[last] = Object2FloatLinkedOpenHashMap.this.value[pos];
/* 1302 */           if (this.next == pos) this.next = last; 
/* 1303 */           if (this.prev == pos) this.prev = last; 
/* 1304 */           Object2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1343 */       action.accept(new Object2FloatLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatLinkedOpenHashMap<K>.MapEntry next() {
/* 1348 */       return this.entry = new Object2FloatLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatLinkedOpenHashMap<K>.MapEntry previous() {
/* 1353 */       return this.entry = new Object2FloatLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1364 */     final Object2FloatLinkedOpenHashMap<K>.MapEntry entry = new Object2FloatLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1398 */       return new Object2FloatLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1416 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2FloatLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1441 */       if (Object2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1442 */       return new Object2FloatLinkedOpenHashMap.MapEntry(Object2FloatLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatMap.Entry<K> last() {
/* 1447 */       if (Object2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1448 */       return new Object2FloatLinkedOpenHashMap.MapEntry(Object2FloatLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1459 */       if (k == null) return (Object2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[Object2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1461 */       K[] key = Object2FloatLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1464 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2FloatLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1465 */       if (k.equals(curr)) return (Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1468 */         if ((curr = key[pos = pos + 1 & Object2FloatLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1469 */         if (k.equals(curr)) return (Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1481 */       if (k == null) {
/* 1482 */         if (Object2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[Object2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1483 */           Object2FloatLinkedOpenHashMap.this.removeNullEntry();
/* 1484 */           return true;
/*      */         } 
/* 1486 */         return false;
/*      */       } 
/*      */       
/* 1489 */       K[] key = Object2FloatLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1492 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2FloatLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1493 */       if (curr.equals(k)) {
/* 1494 */         if (Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1495 */           Object2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1496 */           return true;
/*      */         } 
/* 1498 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1501 */         if ((curr = key[pos = pos + 1 & Object2FloatLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1502 */         if (curr.equals(k) && 
/* 1503 */           Float.floatToIntBits(Object2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1504 */           Object2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1513 */       return Object2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1518 */       Object2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1531 */       return new Object2FloatLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1542 */       return new Object2FloatLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1555 */       return new Object2FloatLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
/* 1561 */       for (int i = Object2FloatLinkedOpenHashMap.this.size, next = Object2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1562 */         int curr = next;
/* 1563 */         next = (int)Object2FloatLinkedOpenHashMap.this.link[curr];
/* 1564 */         consumer.accept(new Object2FloatLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1571 */       Object2FloatLinkedOpenHashMap<K>.MapEntry entry = new Object2FloatLinkedOpenHashMap.MapEntry();
/* 1572 */       for (int i = Object2FloatLinkedOpenHashMap.this.size, next = Object2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         entry.index = next;
/* 1574 */         next = (int)Object2FloatLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1601 */       return Object2FloatLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1613 */       action.accept(Object2FloatLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1618 */       return Object2FloatLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1627 */       return new Object2FloatLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1632 */       return new Object2FloatLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1642 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2FloatLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1648 */       for (int i = Object2FloatLinkedOpenHashMap.this.size, next = Object2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1649 */         int curr = next;
/* 1650 */         next = (int)Object2FloatLinkedOpenHashMap.this.link[curr];
/* 1651 */         consumer.accept(Object2FloatLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1657 */       return Object2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1662 */       return Object2FloatLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1667 */       int oldSize = Object2FloatLinkedOpenHashMap.this.size;
/* 1668 */       Object2FloatLinkedOpenHashMap.this.removeFloat(k);
/* 1669 */       return (Object2FloatLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1674 */       Object2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1679 */       if (Object2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1680 */       return Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1685 */       if (Object2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1686 */       return Object2FloatLinkedOpenHashMap.this.key[Object2FloatLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1727 */       return Object2FloatLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1739 */       action.accept(Object2FloatLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1744 */       return Object2FloatLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1755 */             return (FloatIterator)new Object2FloatLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */             return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2FloatLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1771 */             for (int i = Object2FloatLinkedOpenHashMap.this.size, next = Object2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1772 */               int curr = next;
/* 1773 */               next = (int)Object2FloatLinkedOpenHashMap.this.link[curr];
/* 1774 */               consumer.accept(Object2FloatLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1780 */             return Object2FloatLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1785 */             return Object2FloatLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1790 */             Object2FloatLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1910 */       c = (Object2FloatLinkedOpenHashMap<K>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatLinkedOpenHashMap.class
