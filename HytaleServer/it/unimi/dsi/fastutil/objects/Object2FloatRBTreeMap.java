...
/*  617 */     while (j-- != 0) {
/*  618 */       float ev = i.nextFloat();
/*  619 */       if (Float.floatToIntBits(ev) == Float.floatToIntBits(v)) return true; 
/*      */     } 
/*  621 */     return false;
/*      */   }
/*      */ 
...
/*  837 */       Map.Entry<K, Float> e = (Map.Entry<K, Float>)o;
/*  838 */       return (Objects.equals(this.key, e.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  843 */       return this.key.hashCode() ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Object2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(K k) {
/*  950 */       if ((this.next = Object2FloatRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Object2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Object2FloatRBTreeMap.this.removeFloat(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2FloatMap.Entry<Object2FloatMap.Entry<K>>>()
/*      */         {
...
/* 1061 */             return new Object2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/* 1066 */             return new Object2FloatRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1075 */             if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1076 */             Object2FloatRBTreeMap.Entry<K> f = Object2FloatRBTreeMap.this.findKey((K)e.getKey());
...
/* 1086 */             if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1087 */             Object2FloatRBTreeMap.Entry<K> f = Object2FloatRBTreeMap.this.findKey((K)e.getKey());
/* 1088 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1089 */             Object2FloatRBTreeMap.this.removeFloat(f.key);
/* 1090 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1095 */             return Object2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1100 */             Object2FloatRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2FloatMap.Entry<K> first() {
/* 1105 */             return Object2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Object2FloatMap.Entry<K> last() {
/* 1110 */             return Object2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) {
/* 1115 */             return Object2FloatRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
/* 1120 */             return Object2FloatRBTreeMap.this.headMap(to.getKey()).object2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
/* 1125 */             return Object2FloatRBTreeMap.this.tailMap(from.getKey()).object2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1162 */       return new Object2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1167 */       return new Object2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1217 */     if (this.values == null) this.values = (FloatCollection)new AbstractFloatCollection()
/*      */         {
/*      */           public FloatIterator iterator() {
/* 1220 */             return (FloatIterator)new Object2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1225 */             return Object2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1230 */             return Object2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1235 */             Object2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1297 */       if (!bottom && !top && Object2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1298 */       this.from = from;
/* 1299 */       this.bottom = bottom;
/* 1300 */       this.to = to;
/* 1301 */       this.top = top;
/* 1302 */       this.defRetValue = Object2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1321 */       return ((this.bottom || Object2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
/* 1326 */       if (this.entries == null) this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2FloatMap.Entry<Object2FloatMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator() {
/* 1329 */               return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/* 1334 */               return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Object2FloatMap.Entry<K>> comparator() {
/* 1339 */               return Object2FloatRBTreeMap.this.object2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1347 */               if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1348 */               Object2FloatRBTreeMap.Entry<K> f = Object2FloatRBTreeMap.this.findKey((K)e.getKey());
/* 1349 */               return (f != null && Object2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1358 */               Object2FloatRBTreeMap.Entry<K> f = Object2FloatRBTreeMap.this.findKey((K)e.getKey());
/* 1359 */               if (f != null && Object2FloatRBTreeMap.Submap.this.in(f.key)) Object2FloatRBTreeMap.Submap.this.removeFloat(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Object2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Object2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2FloatMap.Entry<K> first() {
/* 1382 */               return Object2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Object2FloatMap.Entry<K> last() {
/* 1387 */               return Object2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) {
/* 1392 */               return Object2FloatRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
/* 1397 */               return Object2FloatRBTreeMap.Submap.this.headMap(to.getKey()).object2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
/* 1402 */               return Object2FloatRBTreeMap.Submap.this.tailMap(from.getKey()).object2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1411 */         return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1416 */         return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public FloatCollection values() {
/* 1428 */       if (this.values == null) this.values = (FloatCollection)new AbstractFloatCollection()
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1431 */               return (FloatIterator)new Object2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1436 */               return Object2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Object2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Object2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/* 1456 */       return (in((K)k) && Object2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float getFloat(Object k) {
/* 1474 */       K kk = (K)k; Object2FloatRBTreeMap.Entry<K> e;
/* 1475 */       return (in(kk) && (e = Object2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(K k, float v) {
/* 1480 */       Object2FloatRBTreeMap.this.modified = false;
...
/* 1482 */       float oldValue = Object2FloatRBTreeMap.this.put(k, v);
/* 1483 */       return Object2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float removeFloat(Object k) {
/* 1489 */       Object2FloatRBTreeMap.this.modified = false;
/* 1490 */       if (!in((K)k)) return this.defRetValue; 
/* 1491 */       float oldValue = Object2FloatRBTreeMap.this.removeFloat(k);
/* 1492 */       return Object2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1513 */       return Object2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> headMap(K to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Object2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> tailMap(K from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Object2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2FloatSortedMap<K> subMap(K from, K to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Object2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Object2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Object2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Object2FloatRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Object2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Object2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Object2FloatRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Object2FloatRBTreeMap.Entry<K> e;
/* 1565 */       if (Object2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Object2FloatRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Object2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Object2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Object2FloatRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public K firstKey() {
/* 1583 */       Object2FloatRBTreeMap.Entry<K> e = firstEntry();
...
/*      */     
/*      */     public K lastKey() {
/* 1590 */       Object2FloatRBTreeMap.Entry<K> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Object2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(K k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Object2FloatRBTreeMap.Submap.this.bottom && Object2FloatRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Object2FloatRBTreeMap.Submap.this.top && Object2FloatRBTreeMap.this.compare(k, (this.prev = Object2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Object2FloatRBTreeMap.this.locateKey(k);
/* 1616 */             if (Object2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Object2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Object2FloatRBTreeMap.this.compare(this.prev.key, Object2FloatRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Object2FloatRBTreeMap.Submap.this.top && this.next != null && Object2FloatRBTreeMap.this.compare(this.next.key, Object2FloatRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Object2FloatRBTreeMap<K>)super.clone();
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readFloat());
...
/*      */ 
/*      */       
/* 1804 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readFloat());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry<>((K)s.readObject(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatRBTreeMap.class
