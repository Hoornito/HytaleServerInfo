...
/*      */           return;
/*      */         } 
/*  347 */         int slot = HashCommon.mix(curr.hashCode()) & this.mask;
...
/*      */     K curr;
/*      */     int pos;
/*  368 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  369 */     if (k.equals(curr)) return removeEntry(pos); 
/*      */     while (true) {
/*  371 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return this.defRetValue; 
/*  372 */       if (k.equals(curr)) return removeEntry(pos); 
/*      */     } 
/*      */   }
/*      */   
...
/*      */     K curr;
/*      */     int pos;
/*  494 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  495 */     if (k.equals(curr)) {
...
/*      */     K curr;
/*      */     int pos;
/*  529 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  530 */     if (k.equals(curr)) {
...
/*  564 */       K[] key = this.key;
/*      */       K curr;
/*  566 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) != null) {
/*  567 */         if (curr.equals(k)) {
/*  568 */           moveIndexToFirst(pos);
/*  569 */           return setValue(pos, v);
/*      */         } 
/*  571 */         while ((curr = key[pos = pos + 1 & this.mask]) != null) { if (curr.equals(k)) {
...
/*      */     K curr;
/*      */     int pos;
/*  650 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return this.defRetValue; 
/*  651 */     if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  654 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return this.defRetValue; 
/*  655 */       if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  667 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return false; 
/*  668 */     if (k.equals(curr)) return true;
/*      */     
/*      */     while (true) {
/*  671 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  672 */       if (k.equals(curr)) return true;
/*      */     
/*      */     } 
/*      */   }
/*      */   
...
/*      */     K curr;
/*      */     int pos;
/*  694 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return defaultValue; 
/*  695 */     if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  698 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return defaultValue; 
/*  699 */       if (k.equals(curr)) return this.value[pos];
/*      */     
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     K curr;
/*      */     int pos;
/*  727 */     if ((curr = key[pos = HashCommon.mix(k.hashCode()) & this.mask]) == null) return false; 
/*  728 */     if (k.equals(curr) && v == this.value[pos]) {
/*  729 */       removeEntry(pos);
/*  730 */       return true;
/*      */     } 
/*      */     while (true) {
/*  733 */       if ((curr = key[pos = pos + 1 & this.mask]) == null) return false; 
/*  734 */       if (k.equals(curr) && v == this.value[pos]) {
/*  735 */         removeEntry(pos);
/*  736 */         return true;
/*      */       } 
/*      */     } 
...
/*      */     
/*      */     public K getKey() {
/*  882 */       return Object2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public K left() {
/*  887 */       return Object2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  892 */       return Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  897 */       return Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  902 */       boolean oldValue = Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*  903 */       Object2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  904 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectBooleanPair<K> right(boolean v) {
/*  909 */       Object2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  910 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  921 */       return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  940 */       return (Objects.equals(Object2BooleanLinkedOpenHashMap.this.key[this.index], e.getKey()) && Object2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  945 */       return ((Object2BooleanLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2BooleanLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2BooleanLinkedOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  950 */       return (new StringBuilder()).append(Object2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1118 */       this.next = Object2BooleanLinkedOpenHashMap.this.first;
/* 1119 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(K from) {
/* 1123 */       if (from == null) {
/* 1124 */         if (Object2BooleanLinkedOpenHashMap.this.containsNullKey) {
/* 1125 */           this.next = (int)Object2BooleanLinkedOpenHashMap.this.link[Object2BooleanLinkedOpenHashMap.this.n];
/* 1126 */           this.prev = Object2BooleanLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1128 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1130 */       if (Objects.equals(Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last], from)) {
/* 1131 */         this.prev = Object2BooleanLinkedOpenHashMap.this.last;
/* 1132 */         this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1136 */       int pos = HashCommon.mix(from.hashCode()) & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */       
/* 1138 */       while (Object2BooleanLinkedOpenHashMap.this.key[pos] != null) {
/* 1139 */         if (Object2BooleanLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1141 */           this.next = (int)Object2BooleanLinkedOpenHashMap.this.link[pos];
/* 1142 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1145 */         pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1164 */       if (this.next == -1) {
/* 1165 */         this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1168 */       int pos = Object2BooleanLinkedOpenHashMap.this.first;
/* 1169 */       this.index = 1;
/* 1170 */       while (pos != this.prev) {
/* 1171 */         pos = (int)Object2BooleanLinkedOpenHashMap.this.link[pos];
/* 1172 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1189 */       this.next = (int)Object2BooleanLinkedOpenHashMap.this.link[this.curr];
...
/* 1198 */       this.prev = (int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1207 */         this.next = (int)Object2BooleanLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1220 */         this.index--;
/* 1221 */         this.prev = (int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1222 */       else { this.next = (int)Object2BooleanLinkedOpenHashMap.this.link[this.curr]; }
/* 1223 */        Object2BooleanLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1226 */       if (this.prev == -1) { Object2BooleanLinkedOpenHashMap.this.first = this.next; }
/* 1227 */       else { Object2BooleanLinkedOpenHashMap.this.link[this.prev] = Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^ (Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1228 */        if (this.next == -1) { Object2BooleanLinkedOpenHashMap.this.last = this.prev; }
/* 1229 */       else { Object2BooleanLinkedOpenHashMap.this.link[this.next] = Object2BooleanLinkedOpenHashMap.this.link[this.next] ^ (Object2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1230 */        int pos = this.curr;
/* 1231 */       this.curr = -1;
/* 1232 */       if (pos == Object2BooleanLinkedOpenHashMap.this.n) {
/* 1233 */         Object2BooleanLinkedOpenHashMap.this.containsNullKey = false;
/* 1234 */         Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1237 */         K[] key = Object2BooleanLinkedOpenHashMap.this.key; while (true) {
/*      */           K curr;
/*      */           int last;
/* 1240 */           pos = (last = pos) + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1242 */             if ((curr = key[pos]) == null) {
/* 1243 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1246 */             int slot = HashCommon.mix(curr.hashCode()) & Object2BooleanLinkedOpenHashMap.this.mask;
/* 1247 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1248 */               break;  pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1250 */           key[last] = curr;
/* 1251 */           Object2BooleanLinkedOpenHashMap.this.value[last] = Object2BooleanLinkedOpenHashMap.this.value[pos];
/* 1252 */           if (this.next == pos) this.next = last; 
/* 1253 */           if (this.prev == pos) this.prev = last; 
/* 1254 */           Object2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1293 */       action.accept(new Object2BooleanLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2BooleanLinkedOpenHashMap<K>.MapEntry next() {
/* 1298 */       return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2BooleanLinkedOpenHashMap<K>.MapEntry previous() {
/* 1303 */       return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1314 */     final Object2BooleanLinkedOpenHashMap<K>.MapEntry entry = new Object2BooleanLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1348 */       return new Object2BooleanLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1366 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2BooleanLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1391 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1392 */       return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Object2BooleanMap.Entry<K> last() {
/* 1397 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1398 */       return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1409 */       if (k == null) return (Object2BooleanLinkedOpenHashMap.this.containsNullKey && Object2BooleanLinkedOpenHashMap.this.value[Object2BooleanLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1411 */       K[] key = Object2BooleanLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1414 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2BooleanLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1415 */       if (k.equals(curr)) return (Object2BooleanLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1418 */         if ((curr = key[pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1419 */         if (k.equals(curr)) return (Object2BooleanLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1431 */       if (k == null) {
/* 1432 */         if (Object2BooleanLinkedOpenHashMap.this.containsNullKey && Object2BooleanLinkedOpenHashMap.this.value[Object2BooleanLinkedOpenHashMap.this.n] == v) {
/* 1433 */           Object2BooleanLinkedOpenHashMap.this.removeNullEntry();
/* 1434 */           return true;
/*      */         } 
/* 1436 */         return false;
/*      */       } 
/*      */       
/* 1439 */       K[] key = Object2BooleanLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1442 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2BooleanLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1443 */       if (curr.equals(k)) {
/* 1444 */         if (Object2BooleanLinkedOpenHashMap.this.value[pos] == v) {
/* 1445 */           Object2BooleanLinkedOpenHashMap.this.removeEntry(pos);
/* 1446 */           return true;
/*      */         } 
/* 1448 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1451 */         if ((curr = key[pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask]) == null) return false; 
/* 1452 */         if (curr.equals(k) && 
/* 1453 */           Object2BooleanLinkedOpenHashMap.this.value[pos] == v) {
/* 1454 */           Object2BooleanLinkedOpenHashMap.this.removeEntry(pos);
/* 1455 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1463 */       return Object2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1468 */       Object2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1481 */       return new Object2BooleanLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1492 */       return new Object2BooleanLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1505 */       return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
/* 1511 */       for (int i = Object2BooleanLinkedOpenHashMap.this.size, next = Object2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1512 */         int curr = next;
/* 1513 */         next = (int)Object2BooleanLinkedOpenHashMap.this.link[curr];
/* 1514 */         consumer.accept(new Object2BooleanLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1521 */       Object2BooleanLinkedOpenHashMap<K>.MapEntry entry = new Object2BooleanLinkedOpenHashMap.MapEntry();
/* 1522 */       for (int i = Object2BooleanLinkedOpenHashMap.this.size, next = Object2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1523 */         entry.index = next;
/* 1524 */         next = (int)Object2BooleanLinkedOpenHashMap.this.link[next];
...
/*      */     
/*      */     public K previous() {
/* 1551 */       return Object2BooleanLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1563 */       action.accept(Object2BooleanLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public K next() {
/* 1568 */       return Object2BooleanLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1577 */       return new Object2BooleanLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1582 */       return new Object2BooleanLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1592 */       return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2BooleanLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1598 */       for (int i = Object2BooleanLinkedOpenHashMap.this.size, next = Object2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         int curr = next;
/* 1600 */         next = (int)Object2BooleanLinkedOpenHashMap.this.link[curr];
/* 1601 */         consumer.accept(Object2BooleanLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1607 */       return Object2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(Object k) {
/* 1612 */       return Object2BooleanLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(Object k) {
/* 1617 */       int oldSize = Object2BooleanLinkedOpenHashMap.this.size;
/* 1618 */       Object2BooleanLinkedOpenHashMap.this.removeBoolean(k);
/* 1619 */       return (Object2BooleanLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1624 */       Object2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public K first() {
/* 1629 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1630 */       return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public K last() {
/* 1635 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1636 */       return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public Comparator<? super K> comparator() {
...
/* 1677 */       return Object2BooleanLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1689 */       action.accept(Object2BooleanLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1694 */       return Object2BooleanLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1705 */             return (BooleanIterator)new Object2BooleanLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1715 */             return BooleanSpliterators.asSpliterator(iterator(), Size64.sizeOf(Object2BooleanLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1721 */             for (int i = Object2BooleanLinkedOpenHashMap.this.size, next = Object2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1722 */               int curr = next;
/* 1723 */               next = (int)Object2BooleanLinkedOpenHashMap.this.link[curr];
/* 1724 */               consumer.accept(Object2BooleanLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1730 */             return Object2BooleanLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1735 */             return Object2BooleanLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1740 */             Object2BooleanLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */       else
/* 1816 */       { pos = HashCommon.mix(key[i].hashCode()) & mask;
...
/*      */     try {
/* 1860 */       c = (Object2BooleanLinkedOpenHashMap<K>)super.clone();
...
/* 1888 */       if (this != this.key[i]) t = this.key[i].hashCode(); 
...
/*      */       } else {
/* 1930 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Object2BooleanLinkedOpenHashMap.class
