...
/*  44 */     ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
/*  45 */     return (entries instanceof Reference2ShortMap.FastEntrySet) ? ((Reference2ShortMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
/*  61 */     if (entries instanceof Reference2ShortMap.FastEntrySet) { ((Reference2ShortMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  77 */     final ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
/*  78 */     return (entries instanceof Reference2ShortMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2ShortMap.Entry<Reference2ShortMap.Entry<K>>>()
/*     */       {
/*     */         public ObjectIterator<Reference2ShortMap.Entry<K>> iterator() {
/*  81 */           return ((Reference2ShortMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  91 */           ((Reference2ShortMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  93 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 162 */       return Reference2ShortMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
/* 245 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractReference2ShortMap.BasicEntry<>(this.key, this.value)); 
...
/* 258 */       return (ObjectSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     extends Reference2ShortFunctions.SynchronizedFunction<K> implements Reference2ShortMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 376 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2ShortEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Short>> entrySet() {
/* 390 */       return (ObjectSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     extends Reference2ShortFunctions.UnmodifiableFunction<K> implements Reference2ShortMap<K>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     protected transient ShortCollection values;
/*     */     
/*     */     protected UnmodifiableMap(Reference2ShortMap<? extends K> m) {
/* 655 */       super(m);
/* 656 */       this.map = m;
/*     */     }
/*     */ 
...
/*     */     
/*     */     public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
/* 683 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable((ObjectSet)this.map.reference2ShortEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Short>> entrySet() {
/* 696 */       return (ObjectSet)reference2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortMaps.class
