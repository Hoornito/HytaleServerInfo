...
/*  232 */     int oldValue = this.value[pos];
/*  233 */     this.size--;
/*  234 */     shiftKeys(pos);
...
/*  241 */     int oldValue = this.value[this.n];
/*  242 */     this.size--;
...
/*  256 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  258 */     int[] key = this.key;
/*      */     
/*      */     int curr, pos;
...
/*  291 */     int oldValue = this.value[pos];
...
/*      */     int pos;
/*  311 */     if (this.strategy.equals(k, 0)) {
...
/*  361 */     if (this.strategy.equals(k, 0)) {
...
/*  380 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
...
/*  397 */     if (this.strategy.equals(k, 0)) return this.containsNullKey;
/*      */     
...
/*  413 */     int[] value = this.value;
/*  414 */     int[] key = this.key;
...
/*  424 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
...
/*  451 */     if (this.strategy.equals(k, 0)) {
...
/*  490 */     int oldValue = this.value[pos];
...
/*  501 */     int newValue = mappingFunction.applyAsInt(k);
...
/*  513 */     int newValue = mappingFunction.get(key);
...
/*  524 */     Integer newValue = mappingFunction.apply(k);
/*  525 */     if (newValue == null) return this.defRetValue; 
/*  526 */     int v = newValue.intValue();
...
/*  537 */     Integer newValue = remappingFunction.apply(Integer.valueOf(k), Integer.valueOf(this.value[pos]));
/*  538 */     if (newValue == null) {
/*  539 */       if (this.strategy.equals(k, 0)) { removeNullEntry(); }
/*  540 */       else { removeEntry(pos); }
/*  541 */        return this.defRetValue;
/*      */     } 
/*  543 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  550 */     int pos = find(k);
/*  551 */     Integer newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
/*  552 */     if (newValue == null) {
/*  553 */       if (pos >= 0)
/*  554 */         if (this.strategy.equals(k, 0)) { removeNullEntry(); }
/*  555 */         else { removeEntry(pos); }
/*      */          
/*  557 */       return this.defRetValue;
/*      */     } 
/*  559 */     int newVal = newValue.intValue();
/*  560 */     if (pos < 0) {
...
/*  576 */        return v;
/*      */     } 
/*  578 */     Integer newValue = remappingFunction.apply(Integer.valueOf(this.value[pos]), Integer.valueOf(v));
/*  579 */     if (newValue == null) {
/*  580 */       if (this.strategy.equals(k, 0)) { removeNullEntry(); }
/*  581 */       else { removeEntry(pos); }
/*  582 */        return this.defRetValue;
/*      */     } 
/*  584 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  629 */       return Int2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  634 */       return Int2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  639 */       return Int2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  644 */       return Int2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  649 */       int oldValue = Int2IntOpenCustomHashMap.this.value[this.index];
/*  650 */       Int2IntOpenCustomHashMap.this.value[this.index] = v;
/*  651 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntIntPair right(int v) {
/*  656 */       Int2IntOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  668 */       return Integer.valueOf(Int2IntOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       return Integer.valueOf(Int2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  690 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  697 */       Map.Entry<Integer, Integer> e = (Map.Entry<Integer, Integer>)o;
/*  698 */       return (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Int2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  703 */       return Int2IntOpenCustomHashMap.this.strategy.hashCode(Int2IntOpenCustomHashMap.this.key[this.index]) ^ Int2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  708 */       return Int2IntOpenCustomHashMap.this.key[this.index] + "=>" + Int2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  719 */     int pos = Int2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  725 */     int last = -1;
/*      */     
/*  727 */     int c = Int2IntOpenCustomHashMap.this.size;
/*      */     
/*  729 */     boolean mustReturnNullKey = Int2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  748 */         return this.last = Int2IntOpenCustomHashMap.this.n;
/*      */       } 
/*  750 */       int[] key = Int2IntOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  752 */         if (--this.pos < 0) {
/*      */           
/*  754 */           this.last = Integer.MIN_VALUE;
/*  755 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  756 */           int p = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask;
/*  757 */           for (; !Int2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2IntOpenCustomHashMap.this.mask);
/*  758 */           return p;
/*      */         } 
...
/*  767 */         acceptOnIndex(action, this.last = Int2IntOpenCustomHashMap.this.n);
/*  768 */         this.c--;
/*      */       } 
/*  770 */       int[] key = Int2IntOpenCustomHashMap.this.key;
/*  771 */       while (this.c != 0) {
/*  772 */         if (--this.pos < 0) {
/*      */           
/*  774 */           this.last = Integer.MIN_VALUE;
/*  775 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  776 */           int p = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask;
/*  777 */           for (; !Int2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2IntOpenCustomHashMap.this.mask);
...
/*  797 */       int[] key = Int2IntOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  799 */         pos = (last = pos) + 1 & Int2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  801 */           if ((curr = key[pos]) == 0) {
/*  802 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  805 */           int slot = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2IntOpenCustomHashMap.this.mask;
/*  806 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  807 */             break;  pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  809 */         if (pos < last) {
/*  810 */           if (this.wrapped == null) this.wrapped = new IntArrayList(2); 
/*  811 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  813 */         key[last] = curr;
/*  814 */         Int2IntOpenCustomHashMap.this.value[last] = Int2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  819 */       if (this.last == -1) throw new IllegalStateException(); 
/*  820 */       if (this.last == Int2IntOpenCustomHashMap.this.n)
/*  821 */       { Int2IntOpenCustomHashMap.this.containsNullKey = false; }
/*  822 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  825 */       { Int2IntOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  826 */         this.last = -1;
/*      */         return; }
/*      */       
/*  829 */       Int2IntOpenCustomHashMap.this.size--;
/*  830 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2IntMap.Entry>> implements ObjectIterator<Int2IntMap.Entry> { public Int2IntOpenCustomHashMap.MapEntry next() {
/*  846 */       return this.entry = new Int2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  852 */       action.accept(this.entry = new Int2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  863 */       this.entry = new Int2IntOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  884 */     int pos = 0;
/*      */     
/*  886 */     int max = Int2IntOpenCustomHashMap.this.n;
/*      */     
/*  888 */     int c = 0;
/*      */     
/*  890 */     boolean mustReturnNull = Int2IntOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  910 */         this.c++;
/*  911 */         acceptOnIndex(action, Int2IntOpenCustomHashMap.this.n);
/*  912 */         return true;
/*      */       } 
/*  914 */       int[] key = Int2IntOpenCustomHashMap.this.key;
...
/*  929 */         this.c++;
/*  930 */         acceptOnIndex(action, Int2IntOpenCustomHashMap.this.n);
/*      */       } 
/*  932 */       int[] key = Int2IntOpenCustomHashMap.this.key;
...
/*      */       {
/*  945 */         return (Int2IntOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  950 */       return Math.min((Int2IntOpenCustomHashMap.this.size - this.c), (long)(Int2IntOpenCustomHashMap.this.realSize() / Int2IntOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  978 */         n--;
/*      */       } 
/*  980 */       int[] key = Int2IntOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2IntMap.Entry> action, int index) {
/* 1008 */       action.accept(new Int2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1020 */       return new Int2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2IntMap.Entry> fastIterator() {
/* 1025 */       return new Int2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2IntMap.Entry> spliterator() {
/* 1030 */       return new Int2IntOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1043 */       if (Int2IntOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2IntOpenCustomHashMap.this.containsNullKey && Int2IntOpenCustomHashMap.this.value[Int2IntOpenCustomHashMap.this.n] == v);
/*      */       
/* 1045 */       int[] key = Int2IntOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1048 */       if ((curr = key[pos = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1049 */       if (Int2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1052 */         if ((curr = key[pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1053 */         if (Int2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1062 */       if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1063 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1064 */       int k = ((Integer)e.getKey()).intValue();
/* 1065 */       int v = ((Integer)e.getValue()).intValue();
/* 1066 */       if (Int2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1067 */         if (Int2IntOpenCustomHashMap.this.containsNullKey && Int2IntOpenCustomHashMap.this.value[Int2IntOpenCustomHashMap.this.n] == v) {
/* 1068 */           Int2IntOpenCustomHashMap.this.removeNullEntry();
/* 1069 */           return true;
/*      */         } 
/* 1071 */         return false;
/*      */       } 
/*      */       
/* 1074 */       int[] key = Int2IntOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1077 */       if ((curr = key[pos = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1078 */       if (Int2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1079 */         if (Int2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1080 */           Int2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1081 */           return true;
/*      */         } 
/* 1083 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1086 */         if ((curr = key[pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1087 */         if (Int2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1088 */           Int2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1089 */           Int2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1090 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1098 */       return Int2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1103 */       Int2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2IntMap.Entry> consumer) {
/* 1109 */       if (Int2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2IntOpenCustomHashMap.MapEntry(Int2IntOpenCustomHashMap.this.n)); 
/* 1110 */       for (int pos = Int2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2IntOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2IntOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2IntMap.Entry> consumer) {
/* 1116 */       Int2IntOpenCustomHashMap.MapEntry entry = new Int2IntOpenCustomHashMap.MapEntry();
/* 1117 */       if (Int2IntOpenCustomHashMap.this.containsNullKey) {
/* 1118 */         entry.index = Int2IntOpenCustomHashMap.this.n;
/* 1119 */         consumer.accept(entry);
/*      */       } 
/* 1121 */       for (int pos = Int2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2IntOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1152 */       action.accept(Int2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1157 */       return Int2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1178 */       action.accept(Int2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1190 */       return new Int2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1195 */       return new Int2IntOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1201 */       if (Int2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2IntOpenCustomHashMap.this.key[Int2IntOpenCustomHashMap.this.n]); 
/* 1202 */       for (int pos = Int2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1203 */         int k = Int2IntOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1210 */       return Int2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1215 */       return Int2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1220 */       int oldSize = Int2IntOpenCustomHashMap.this.size;
/* 1221 */       Int2IntOpenCustomHashMap.this.remove(k);
/* 1222 */       return (Int2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1227 */       Int2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*      */   {
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1255 */       action.accept(Int2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1260 */       return Int2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1281 */       action.accept(Int2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1292 */     if (this.values == null) this.values = new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1295 */             return new Int2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1300 */             return new Int2IntOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1306 */             if (Int2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2IntOpenCustomHashMap.this.value[Int2IntOpenCustomHashMap.this.n]); 
/* 1307 */             for (int pos = Int2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2IntOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2IntOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1312 */             return Int2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1317 */             return Int2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1322 */             Int2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1386 */     int[] key = this.key;
/* 1387 */     int[] value = this.value;
/* 1388 */     int mask = newN - 1;
/* 1389 */     int[] newKey = new int[newN + 1];
/* 1390 */     int[] newValue = new int[newN + 1];
/* 1391 */     int i = this.n;
...
/*      */     try {
/* 1420 */       c = (Int2IntOpenCustomHashMap)super.clone();
...
/* 1428 */     c.key = (int[])this.key.clone();
/* 1429 */     c.value = (int[])this.value.clone();
...
/* 1475 */     int[] key = this.key = new int[this.n + 1];
/* 1476 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1479 */     for (int i = this.size; i-- != 0; ) {
/* 1480 */       int pos, k = s.readInt();
/* 1481 */       int v = s.readInt();
/* 1482 */       if (this.strategy.equals(k, 0)) {
/* 1483 */         pos = this.n;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2IntOpenCustomHashMap.class
