...
/*  94 */     this(m.size());
/*  95 */     int i = 0;
/*  96 */     for (ObjectIterator<Int2ShortMap.Entry> objectIterator = m.int2ShortEntrySet().iterator(); objectIterator.hasNext(); ) { Int2ShortMap.Entry e = objectIterator.next();
...
/* 110 */     this(m.size());
/* 111 */     int i = 0;
/* 112 */     for (Map.Entry<? extends Integer, ? extends Short> e : m.entrySet()) {
...
/* 145 */       return new ObjectIterator<Int2ShortMap.Entry>() {
/* 146 */           int curr = -1; int next = 0;
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 150 */             return (this.next < Int2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 157 */             return new AbstractInt2ShortMap.BasicEntry(Int2ShortArrayMap.this.key[this.curr = this.next], Int2ShortArrayMap.this.value[this.next++]);
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
...
/* 163 */             this.curr = -1;
/* 164 */             int tail = Int2ShortArrayMap.this.size-- - this.next--;
/* 165 */             System.arraycopy(Int2ShortArrayMap.this.key, this.next + 1, Int2ShortArrayMap.this.key, this.next, tail);
/* 166 */             System.arraycopy(Int2ShortArrayMap.this.value, this.next + 1, Int2ShortArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
...
/* 173 */             int max = Int2ShortArrayMap.this.size;
/* 174 */             while (this.next < max) {
/* 175 */               action.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortArrayMap.this.key[this.curr = this.next], Int2ShortArrayMap.this.value[this.next++]));
/*     */             }
/*     */           }
/*     */         };
/*     */     }
...
/* 183 */       return new ObjectIterator<Int2ShortMap.Entry>() {
/* 184 */           int next = 0; int curr = -1;
/* 185 */           final AbstractInt2ShortMap.BasicEntry entry = new AbstractInt2ShortMap.BasicEntry();
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 189 */             return (this.next < Int2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 196 */             this.entry.key = Int2ShortArrayMap.this.key[this.curr = this.next];
/* 197 */             this.entry.value = Int2ShortArrayMap.this.value[this.next++];
...
/* 204 */             this.curr = -1;
/* 205 */             int tail = Int2ShortArrayMap.this.size-- - this.next--;
/* 206 */             System.arraycopy(Int2ShortArrayMap.this.key, this.next + 1, Int2ShortArrayMap.this.key, this.next, tail);
/* 207 */             System.arraycopy(Int2ShortArrayMap.this.value, this.next + 1, Int2ShortArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           public void forEachRemaining(Consumer<? super Int2ShortMap.Entry> action) {
/* 214 */             int max = Int2ShortArrayMap.this.size;
/* 215 */             while (this.next < max) {
/* 216 */               this.entry.key = Int2ShortArrayMap.this.key[this.curr = this.next];
/* 217 */               this.entry.value = Int2ShortArrayMap.this.value[this.next++];
...
/* 239 */         return new AbstractInt2ShortMap.BasicEntry(Int2ShortArrayMap.this.key[location], Int2ShortArrayMap.this.value[location]);
/*     */       }
/*     */ 
/*     */       
...
/* 250 */       return new EntrySetSpliterator(0, Int2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 258 */       for (int i = 0, max = Int2ShortArrayMap.this.size; i < max; i++) {
/* 259 */         action.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortArrayMap.this.key[i], Int2ShortArrayMap.this.value[i]));
/*     */       }
/*     */     }
/*     */ 
/*     */ 
...
/* 267 */       AbstractInt2ShortMap.BasicEntry entry = new AbstractInt2ShortMap.BasicEntry();
/*     */       
/* 269 */       for (int i = 0, max = Int2ShortArrayMap.this.size; i < max; i++) {
/* 270 */         entry.key = Int2ShortArrayMap.this.key[i];
/* 271 */         entry.value = Int2ShortArrayMap.this.value[i];
...
/*     */     
/*     */     public int size() {
/* 278 */       return Int2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 289 */       return (Int2ShortArrayMap.this.containsKey(k) && Int2ShortArrayMap.this.get(k) == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 301 */       int oldPos = Int2ShortArrayMap.this.findKey(k);
/* 302 */       if (oldPos == -1 || v != Int2ShortArrayMap.this.value[oldPos]) return false; 
/* 303 */       int tail = Int2ShortArrayMap.this.size - oldPos - 1;
/* 304 */       System.arraycopy(Int2ShortArrayMap.this.key, oldPos + 1, Int2ShortArrayMap.this.key, oldPos, tail);
/* 305 */       System.arraycopy(Int2ShortArrayMap.this.value, oldPos + 1, Int2ShortArrayMap.this.value, oldPos, tail);
/* 306 */       Int2ShortArrayMap.this.size--;
/* 307 */       return true;
/*     */     }
/*     */   }
/*     */ 
...
/* 398 */       return (Int2ShortArrayMap.this.findKey(k) != -1);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean remove(int k) {
/* 403 */       int oldPos = Int2ShortArrayMap.this.findKey(k);
/* 404 */       if (oldPos == -1) return false; 
/* 405 */       int tail = Int2ShortArrayMap.this.size - oldPos - 1;
/* 406 */       System.arraycopy(Int2ShortArrayMap.this.key, oldPos + 1, Int2ShortArrayMap.this.key, oldPos, tail);
/* 407 */       System.arraycopy(Int2ShortArrayMap.this.value, oldPos + 1, Int2ShortArrayMap.this.value, oldPos, tail);
/* 408 */       Int2ShortArrayMap.this.size--;
/* 409 */       return true;
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 419 */             return (this.pos < Int2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 426 */             return Int2ShortArrayMap.this.key[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 431 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 432 */             int tail = Int2ShortArrayMap.this.size - this.pos;
/* 433 */             System.arraycopy(Int2ShortArrayMap.this.key, this.pos, Int2ShortArrayMap.this.key, this.pos - 1, tail);
/* 434 */             System.arraycopy(Int2ShortArrayMap.this.value, this.pos, Int2ShortArrayMap.this.value, this.pos - 1, tail);
/* 435 */             Int2ShortArrayMap.this.size--;
/* 436 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 443 */             int max = Int2ShortArrayMap.this.size;
/* 444 */             while (this.pos < max)
/* 445 */               action.accept(Int2ShortArrayMap.this.key[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 465 */         return Int2ShortArrayMap.this.key[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(IntConsumer action) {
/* 477 */         int max = Int2ShortArrayMap.this.size;
/* 478 */         while (this.pos < max) {
/* 479 */           action.accept(Int2ShortArrayMap.this.key[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 486 */       return new KeySetSpliterator(0, Int2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 493 */       for (int i = 0, max = Int2ShortArrayMap.this.size; i < max; i++) {
/* 494 */         action.accept(Int2ShortArrayMap.this.key[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 500 */       return Int2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 505 */       Int2ShortArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/* 518 */       return Int2ShortArrayMap.this.containsValue(v);
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 528 */             return (this.pos < Int2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 535 */             return Int2ShortArrayMap.this.value[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 540 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 541 */             int tail = Int2ShortArrayMap.this.size - this.pos;
/* 542 */             System.arraycopy(Int2ShortArrayMap.this.key, this.pos, Int2ShortArrayMap.this.key, this.pos - 1, tail);
/* 543 */             System.arraycopy(Int2ShortArrayMap.this.value, this.pos, Int2ShortArrayMap.this.value, this.pos - 1, tail);
/* 544 */             Int2ShortArrayMap.this.size--;
/* 545 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 552 */             int max = Int2ShortArrayMap.this.size;
/* 553 */             while (this.pos < max)
/* 554 */               action.accept(Int2ShortArrayMap.this.value[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 574 */         return Int2ShortArrayMap.this.value[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(ShortConsumer action) {
/* 586 */         int max = Int2ShortArrayMap.this.size;
/* 587 */         while (this.pos < max) {
/* 588 */           action.accept(Int2ShortArrayMap.this.value[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 595 */       return new ValuesSpliterator(0, Int2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 602 */       for (int i = 0, max = Int2ShortArrayMap.this.size; i < max; i++) {
/* 603 */         action.accept(Int2ShortArrayMap.this.value[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 609 */       return Int2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 614 */       Int2ShortArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/*     */     Int2ShortArrayMap c;
/*     */     try {
/* 638 */       c = (Int2ShortArrayMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortArrayMap.class
