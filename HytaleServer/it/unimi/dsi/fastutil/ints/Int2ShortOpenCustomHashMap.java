...
/*  543 */     Short newValue = remappingFunction.apply(Integer.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Short newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  635 */       return Int2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  640 */       return Int2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  645 */       return Int2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  650 */       return Int2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  655 */       short oldValue = Int2ShortOpenCustomHashMap.this.value[this.index];
/*  656 */       Int2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntShortPair right(short v) {
/*  662 */       Int2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Integer.valueOf(Int2ShortOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Short.valueOf(Int2ShortOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Integer, Short> e = (Map.Entry<Integer, Short>)o;
/*  704 */       return (Int2ShortOpenCustomHashMap.this.strategy.equals(Int2ShortOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Int2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Int2ShortOpenCustomHashMap.this.strategy.hashCode(Int2ShortOpenCustomHashMap.this.key[this.index]) ^ Int2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Int2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Int2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Int2ShortOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Int2ShortOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Int2ShortOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Int2ShortOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ShortOpenCustomHashMap.this.mask;
/*  763 */           for (; !Int2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ShortOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Int2ShortOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
...
/*  783 */           for (; !Int2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ShortOpenCustomHashMap.this.mask);
...
/*  803 */       int[] key = Int2ShortOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  805 */         pos = (last = pos) + 1 & Int2ShortOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ShortOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Int2ShortOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Int2ShortOpenCustomHashMap.this.value[last] = Int2ShortOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Int2ShortOpenCustomHashMap.this.n)
/*  827 */       { Int2ShortOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Int2ShortOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Int2ShortOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2ShortMap.Entry>> implements ObjectIterator<Int2ShortMap.Entry> { public Int2ShortOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Int2ShortOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Int2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Int2ShortOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Int2ShortOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Int2ShortOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Int2ShortOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Int2ShortOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Int2ShortOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Int2ShortOpenCustomHashMap.this.size - this.c), (long)(Int2ShortOpenCustomHashMap.this.realSize() / Int2ShortOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Int2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2ShortMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2ShortMap.Entry> action, int index) {
/* 1014 */       action.accept(new Int2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Int2ShortOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2ShortMap.Entry> fastIterator() {
/* 1031 */       return new Int2ShortOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2ShortMap.Entry> spliterator() {
/* 1036 */       return new Int2ShortOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Int2ShortOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2ShortOpenCustomHashMap.this.containsNullKey && Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Int2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Int2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Int2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Int2ShortOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1073 */         if (Int2ShortOpenCustomHashMap.this.containsNullKey && Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n] == v) {
/* 1074 */           Int2ShortOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       int[] key = Int2ShortOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Int2ShortOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Int2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Int2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Int2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Int2ShortOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Int2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Int2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Int2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Int2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2ShortMap.Entry> consumer) {
/* 1115 */       if (Int2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2ShortOpenCustomHashMap.MapEntry(Int2ShortOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Int2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2ShortOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2ShortMap.Entry> consumer) {
/* 1122 */       Int2ShortOpenCustomHashMap.MapEntry entry = new Int2ShortOpenCustomHashMap.MapEntry();
/* 1123 */       if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Int2ShortOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Int2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Int2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1163 */       return Int2ShortOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1184 */       action.accept(Int2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Int2ShortOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1201 */       return new Int2ShortOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1207 */       if (Int2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ShortOpenCustomHashMap.this.key[Int2ShortOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Int2ShortOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         int k = Int2ShortOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Int2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1221 */       return Int2ShortOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1226 */       int oldSize = Int2ShortOpenCustomHashMap.this.size;
/* 1227 */       Int2ShortOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Int2ShortOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Int2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Int2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1266 */       return Int2ShortOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1287 */       action.accept(Int2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Int2ShortOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ShortSpliterator spliterator() {
/* 1306 */             return new Int2ShortOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1312 */             if (Int2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Int2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2ShortOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Int2ShortOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1323 */             return Int2ShortOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Int2ShortOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Int2ShortOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortOpenCustomHashMap.class
