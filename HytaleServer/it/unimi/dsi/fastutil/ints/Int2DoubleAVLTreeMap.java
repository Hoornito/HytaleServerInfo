...
/*      */ 
/*      */ 
/*      */ public class Int2DoubleAVLTreeMap
...
/*  885 */       Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
/*  886 */       return (this.key == ((Integer)e.getKey()).intValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Int2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  998 */       if ((this.next = Int2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Int2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2DoubleMap.Entry>)new AbstractObjectSortedSet<Int2DoubleMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1147 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1149 */             Int2DoubleAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Int2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Int2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2DoubleMap.Entry first() {
/* 1165 */             return Int2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2DoubleMap.Entry last() {
/* 1170 */             return Int2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) {
/* 1175 */             return Int2DoubleAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) {
/* 1180 */             return Int2DoubleAVLTreeMap.this.headMap(to.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) {
/* 1185 */             return Int2DoubleAVLTreeMap.this.tailMap(from.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Int2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1227 */       return new Int2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (DoubleIterator)new Int2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1285 */             return Int2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Int2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Int2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Int2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Int2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Int2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2DoubleMap.Entry>)new AbstractObjectSortedSet<Int2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2DoubleMap.Entry> comparator() {
/* 1399 */               return Int2DoubleAVLTreeMap.this.int2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1410 */               return (f != null && Int2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1421 */               if (f != null && Int2DoubleAVLTreeMap.Submap.this.in(f.key)) Int2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Int2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Int2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2DoubleMap.Entry first() {
/* 1444 */               return Int2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2DoubleMap.Entry last() {
/* 1449 */               return Int2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) {
/* 1454 */               return Int2DoubleAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) {
/* 1459 */               return Int2DoubleAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) {
/* 1464 */               return Int2DoubleAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1473 */         return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1478 */         return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1493 */               return (DoubleIterator)new Int2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1498 */               return Int2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Int2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1518 */       return (in(k) && Int2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(int k) {
/* 1536 */       int kk = k; Int2DoubleAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Int2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(int k, double v) {
/* 1542 */       Int2DoubleAVLTreeMap.this.modified = false;
...
/* 1544 */       double oldValue = Int2DoubleAVLTreeMap.this.put(k, v);
/* 1545 */       return Int2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(int k) {
/* 1551 */       Int2DoubleAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       double oldValue = Int2DoubleAVLTreeMap.this.remove(k);
/* 1554 */       return Int2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1575 */       return Int2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2DoubleSortedMap headMap(int to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2DoubleSortedMap tailMap(int from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2DoubleSortedMap subMap(int from, int to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Int2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Int2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Int2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2DoubleAVLTreeMap.Entry e;
/* 1627 */       if (Int2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Int2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Int2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1645 */       Int2DoubleAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1652 */       Int2DoubleAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Int2DoubleAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Int2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Int2DoubleAVLTreeMap.Submap.this.bottom && Int2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Int2DoubleAVLTreeMap.Submap.this.top && Int2DoubleAVLTreeMap.this.compare(k, (this.prev = Int2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Int2DoubleAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Int2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Int2DoubleAVLTreeMap.this.compare(this.prev.key, Int2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Int2DoubleAVLTreeMap.Submap.this.top && this.next != null && Int2DoubleAVLTreeMap.this.compare(this.next.key, Int2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Int2DoubleAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readInt(), s.readDouble());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readInt(), s.readDouble());
/* 1866 */       entry.right(new Entry(s.readInt(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleAVLTreeMap.class
