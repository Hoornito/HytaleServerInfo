...
/*  61 */     return (entries instanceof Int2BooleanSortedMap.FastSortedEntrySet) ? ((Int2BooleanSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Int2BooleanMap.Entry> entries = map.int2BooleanEntrySet();
/*  77 */     Objects.requireNonNull((Int2BooleanSortedMap.FastSortedEntrySet)entries); return (entries instanceof Int2BooleanSortedMap.FastSortedEntrySet) ? (Int2BooleanSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Int2BooleanMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Int2BooleanMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Integer, Boolean>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2BooleanSortedMap headMap(int to) {
/* 125 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2BooleanSortedMap tailMap(int from) {
/* 130 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Int2BooleanMap.Entry>)ObjectSortedSets.singleton(new AbstractInt2BooleanMap.BasicEntry(this.key, this.value), Int2BooleanSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Int2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Boolean>> entrySet() {
/* 248 */       return (ObjectSortedSet)int2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/* 260 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2BooleanSortedMap headMap(int to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2BooleanSortedMap tailMap(int from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Int2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public int firstIntKey() {
...
/* 369 */     return new Singleton(key.intValue(), value.booleanValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Int2BooleanMaps.SynchronizedMap implements Int2BooleanSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Int2BooleanMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.int2BooleanEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Int2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Boolean>> entrySet() {
/* 440 */       return (ObjectSortedSet)int2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/*     */     extends Int2BooleanMaps.UnmodifiableMap implements Int2BooleanSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2BooleanSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Int2BooleanMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.int2BooleanEntrySet()); 
/* 581 */       return (ObjectSortedSet<Int2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanSortedMaps.class
