...
/* 150 */     return (ObjectSet)int2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = int2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), Short.valueOf(entry.getShortValue()));
...
/* 502 */     Short newValue = remappingFunction.apply(Integer.valueOf(key), Short.valueOf(oldValue));
...
/* 534 */     Short newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Short.valueOf(oldValue) : null);
...
/* 763 */       return Integer.valueOf(getIntKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortMap.class
