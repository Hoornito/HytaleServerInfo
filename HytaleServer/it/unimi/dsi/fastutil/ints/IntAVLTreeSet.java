...
/*      */     
/*      */     SetIterator() {
/*  940 */       this.next = IntAVLTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(int k) {
/*  944 */       if ((this.next = IntAVLTreeSet.this.locateKey(k)) != null) {
/*  945 */         if (IntAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1013 */       updatePrevious();
/* 1014 */       updateNext();
/* 1015 */       IntAVLTreeSet.this.remove(this.curr.key);
/* 1016 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/* 1037 */     return new Subset(0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public IntSortedSet tailSet(int from) {
/* 1042 */     return new Subset(from, false, 0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1080 */       if (!bottom && !top && IntAVLTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1081 */       this.from = from;
...
/* 1103 */       return ((this.bottom || IntAVLTreeSet.this.compare(k, this.from) >= 0) && (this.top || IntAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1108 */       return (in(k) && IntAVLTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(int k) {
...
/* 1114 */       return IntAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1119 */       if (!in(k)) return false; 
/* 1120 */       return IntAVLTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1141 */       return IntAVLTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator() {
...
/* 1157 */       return (IntAVLTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSortedSet tailSet(int from) {
/* 1162 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1163 */       return (IntAVLTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSortedSet subSet(int from, int to) {
/* 1168 */       if (this.top && this.bottom) return new Subset(from, false, to, false); 
/* 1169 */       if (!this.top) to = (IntAVLTreeSet.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1170 */       if (!this.bottom) from = (IntAVLTreeSet.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1181 */       if (IntAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1185 */       if (this.bottom) { e = IntAVLTreeSet.this.firstEntry; }
/*      */       else
/* 1187 */       { e = IntAVLTreeSet.this.locateKey(this.from);
/*      */         
/* 1189 */         if (IntAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1193 */       if (e == null || (!this.top && IntAVLTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1194 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       IntAVLTreeSet.Entry e;
/* 1203 */       if (IntAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1207 */       if (this.top) { e = IntAVLTreeSet.this.lastEntry; }
/*      */       else
/* 1209 */       { e = IntAVLTreeSet.this.locateKey(this.to);
/*      */         
/* 1211 */         if (IntAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1215 */       if (e == null || (!this.bottom && IntAVLTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1216 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstInt() {
/* 1221 */       IntAVLTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastInt() {
/* 1228 */       IntAVLTreeSet.Entry e = lastEntry();
...
/*      */       extends IntAVLTreeSet.SetIterator
/*      */     {
/*      */       SubsetIterator() {
/* 1244 */         this.next = IntAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(int k) {
/* 1248 */         this();
/* 1249 */         if (this.next != null) {
/* 1250 */           if (!IntAVLTreeSet.Subset.this.bottom && IntAVLTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1251 */           else if (!IntAVLTreeSet.Subset.this.top && IntAVLTreeSet.this.compare(k, (this.prev = IntAVLTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1253 */           { this.next = IntAVLTreeSet.this.locateKey(k);
/* 1254 */             if (IntAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1271 */         if (!IntAVLTreeSet.Subset.this.top && this.next != null && IntAVLTreeSet.this.compare(this.next.key, IntAVLTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     IntAVLTreeSet c;
/*      */     try {
/* 1290 */       c = (IntAVLTreeSet)super.clone();
...
/* 1342 */     for (; n-- != 0; s.writeInt(i.nextInt()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1355 */     if (n == 1) {
/* 1356 */       Entry entry = new Entry(s.readInt());
...
/*      */ 
/*      */       
/* 1364 */       Entry entry = new Entry(s.readInt());
/* 1365 */       entry.right(new Entry(s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\IntAVLTreeSet.class
