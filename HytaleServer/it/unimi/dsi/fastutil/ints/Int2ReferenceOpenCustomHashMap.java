...
/*  582 */       return Int2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  587 */       return Int2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  592 */       return Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  597 */       return Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  602 */       V oldValue = Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*  603 */       Int2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  604 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntReferencePair<V> right(V v) {
/*  609 */       Int2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  610 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  621 */       return Integer.valueOf(Int2ReferenceOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  629 */       return (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Int2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  634 */       return Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[this.index]) ^ ((Int2ReferenceOpenCustomHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Int2ReferenceOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  639 */       return Int2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  650 */     int pos = Int2ReferenceOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  656 */     int last = -1;
/*      */     
/*  658 */     int c = Int2ReferenceOpenCustomHashMap.this.size;
/*      */     
/*  660 */     boolean mustReturnNullKey = Int2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  679 */         return this.last = Int2ReferenceOpenCustomHashMap.this.n;
/*      */       } 
/*  681 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  683 */         if (--this.pos < 0) {
/*      */           
/*  685 */           this.last = Integer.MIN_VALUE;
/*  686 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  687 */           int p = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*  688 */           for (; !Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ReferenceOpenCustomHashMap.this.mask);
/*  689 */           return p;
/*      */         } 
...
/*  698 */         acceptOnIndex(action, this.last = Int2ReferenceOpenCustomHashMap.this.n);
/*  699 */         this.c--;
/*      */       } 
/*  701 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
/*  702 */       while (this.c != 0) {
/*  703 */         if (--this.pos < 0) {
/*      */           
/*  705 */           this.last = Integer.MIN_VALUE;
/*  706 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  707 */           int p = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*  708 */           for (; !Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ReferenceOpenCustomHashMap.this.mask);
...
/*  728 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  730 */         pos = (last = pos) + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  732 */           if ((curr = key[pos]) == 0) {
/*  733 */             key[last] = 0;
/*  734 */             Int2ReferenceOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  737 */           int slot = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*  738 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  739 */             break;  pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*      */         } 
/*  741 */         if (pos < last) {
...
/*      */         } 
/*  745 */         key[last] = curr;
/*  746 */         Int2ReferenceOpenCustomHashMap.this.value[last] = Int2ReferenceOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  751 */       if (this.last == -1) throw new IllegalStateException(); 
/*  752 */       if (this.last == Int2ReferenceOpenCustomHashMap.this.n)
/*  753 */       { Int2ReferenceOpenCustomHashMap.this.containsNullKey = false;
/*  754 */         Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] = null; }
/*  755 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  758 */       { Int2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  759 */         this.last = -1;
/*      */         return; }
/*      */       
/*  762 */       Int2ReferenceOpenCustomHashMap.this.size--;
/*  763 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>> implements ObjectIterator<Int2ReferenceMap.Entry<V>> { public Int2ReferenceOpenCustomHashMap<V>.MapEntry next() {
/*  779 */       return this.entry = new Int2ReferenceOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  785 */       action.accept(this.entry = new Int2ReferenceOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>> implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
/*      */     private FastEntryIterator() {
/*  796 */       this.entry = new Int2ReferenceOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  817 */     int pos = 0;
/*      */     
/*  819 */     int max = Int2ReferenceOpenCustomHashMap.this.n;
/*      */     
/*  821 */     int c = 0;
/*      */     
/*  823 */     boolean mustReturnNull = Int2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  843 */         this.c++;
/*  844 */         acceptOnIndex(action, Int2ReferenceOpenCustomHashMap.this.n);
/*  845 */         return true;
/*      */       } 
/*  847 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
...
/*  862 */         this.c++;
/*  863 */         acceptOnIndex(action, Int2ReferenceOpenCustomHashMap.this.n);
/*      */       } 
/*  865 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
...
/*      */       {
/*  878 */         return (Int2ReferenceOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  883 */       return Math.min((Int2ReferenceOpenCustomHashMap.this.size - this.c), (long)(Int2ReferenceOpenCustomHashMap.this.realSize() / Int2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  911 */         n--;
/*      */       } 
/*  913 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Int2ReferenceMap.Entry<V>>, EntrySpliterator> implements ObjectSpliterator<Int2ReferenceMap.Entry<V>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
/*  941 */       action.accept(new Int2ReferenceOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  953 */       return new Int2ReferenceOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/*  958 */       return new Int2ReferenceOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2ReferenceMap.Entry<V>> spliterator() {
/*  963 */       return new Int2ReferenceOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  975 */       if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2ReferenceOpenCustomHashMap.this.containsNullKey && Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] == v);
/*      */       
/*  977 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/*  980 */       if ((curr = key[pos = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) return false; 
/*  981 */       if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  984 */         if ((curr = key[pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) return false; 
/*  985 */         if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  997 */       if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, 0)) {
/*  998 */         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey && Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] == v) {
/*  999 */           Int2ReferenceOpenCustomHashMap.this.removeNullEntry();
/* 1000 */           return true;
/*      */         } 
/* 1002 */         return false;
/*      */       } 
/*      */       
/* 1005 */       int[] key = Int2ReferenceOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1008 */       if ((curr = key[pos = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1009 */       if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1010 */         if (Int2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/* 1011 */           Int2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/* 1012 */           return true;
/*      */         } 
/* 1014 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1018 */         if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1019 */           Int2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/* 1020 */           Int2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/* 1021 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1029 */       return Int2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1034 */       Int2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
/* 1040 */       if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2ReferenceOpenCustomHashMap.MapEntry(Int2ReferenceOpenCustomHashMap.this.n)); 
/* 1041 */       for (int pos = Int2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2ReferenceOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
/* 1047 */       Int2ReferenceOpenCustomHashMap<V>.MapEntry entry = new Int2ReferenceOpenCustomHashMap.MapEntry();
/* 1048 */       if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
/* 1049 */         entry.index = Int2ReferenceOpenCustomHashMap.this.n;
/* 1050 */         consumer.accept(entry);
/*      */       } 
/* 1052 */       for (int pos = Int2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1083 */       action.accept(Int2ReferenceOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1088 */       return Int2ReferenceOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1109 */       action.accept(Int2ReferenceOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1121 */       return new Int2ReferenceOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1126 */       return new Int2ReferenceOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1132 */       if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n]); 
/* 1133 */       for (int pos = Int2ReferenceOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1134 */         int k = Int2ReferenceOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1141 */       return Int2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1146 */       return Int2ReferenceOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1151 */       int oldSize = Int2ReferenceOpenCustomHashMap.this.size;
/* 1152 */       Int2ReferenceOpenCustomHashMap.this.remove(k);
/* 1153 */       return (Int2ReferenceOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1158 */       Int2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1186 */       action.accept(Int2ReferenceOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1191 */       return Int2ReferenceOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1212 */       action.accept(Int2ReferenceOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1226 */             return new Int2ReferenceOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1231 */             return new Int2ReferenceOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1237 */             if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n]); 
/* 1238 */             for (int pos = Int2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2ReferenceOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1243 */             return Int2ReferenceOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1248 */             return Int2ReferenceOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1253 */             Int2ReferenceOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1351 */       c = (Int2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceOpenCustomHashMap.class
