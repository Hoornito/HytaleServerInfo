...
/* 150 */     return (ObjectSet)int2FloatEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = int2FloatEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), Float.valueOf(entry.getFloatValue()));
...
/* 502 */     Float newValue = remappingFunction.apply(Integer.valueOf(key), Float.valueOf(oldValue));
...
/* 534 */     Float newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Float.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatMap.class
