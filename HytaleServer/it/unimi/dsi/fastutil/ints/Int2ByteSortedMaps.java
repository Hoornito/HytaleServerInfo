...
/*  61 */     return (entries instanceof Int2ByteSortedMap.FastSortedEntrySet) ? ((Int2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Int2ByteMap.Entry> entries = map.int2ByteEntrySet();
/*  77 */     Objects.requireNonNull((Int2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Int2ByteSortedMap.FastSortedEntrySet) ? (Int2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Int2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Int2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Integer, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2ByteSortedMap headMap(int to) {
/* 125 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2ByteSortedMap tailMap(int from) {
/* 130 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Int2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractInt2ByteMap.BasicEntry(this.key, this.value), Int2ByteSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Int2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Byte>> entrySet() {
/* 248 */       return (ObjectSortedSet)int2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/* 260 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2ByteSortedMap headMap(int to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2ByteSortedMap tailMap(int from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Int2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public int firstIntKey() {
...
/* 369 */     return new Singleton(key.intValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Int2ByteMaps.SynchronizedMap implements Int2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Int2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.int2ByteEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Int2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Byte>> entrySet() {
/* 440 */       return (ObjectSortedSet)int2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/*     */     extends Int2ByteMaps.UnmodifiableMap implements Int2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2ByteSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Int2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.int2ByteEntrySet()); 
/* 581 */       return (ObjectSortedSet<Int2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteSortedMaps.class
