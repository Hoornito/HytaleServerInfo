...
/*  865 */       Map.Entry<Integer, Boolean> e = (Map.Entry<Integer, Boolean>)o;
/*  866 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  974 */       this.next = Int2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  978 */       if ((this.next = Int2BooleanAVLTreeMap.this.locateKey(k)) != null)
/*  979 */         if (Int2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1032 */       updatePrevious();
/* 1033 */       updateNext();
/* 1034 */       Int2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1035 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1089 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2BooleanMap.Entry>)new AbstractObjectSortedSet<Int2BooleanMap.Entry>()
/*      */         {
...
/* 1099 */             return (ObjectBidirectionalIterator<Int2BooleanMap.Entry>)new Int2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) {
/* 1104 */             return (ObjectBidirectionalIterator<Int2BooleanMap.Entry>)new Int2BooleanAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             if (!(e.getKey() instanceof Integer)) return false; 
/* 1114 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1115 */             Int2BooleanAVLTreeMap.Entry f = Int2BooleanAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1125 */             if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1126 */             if (!(e.getValue() instanceof Boolean)) return false; 
/* 1127 */             Int2BooleanAVLTreeMap.Entry f = Int2BooleanAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1128 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1129 */             Int2BooleanAVLTreeMap.this.remove(f.key);
/* 1130 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1135 */             return Int2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1140 */             Int2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2BooleanMap.Entry first() {
/* 1145 */             return Int2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2BooleanMap.Entry last() {
/* 1150 */             return Int2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) {
/* 1155 */             return Int2BooleanAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) {
/* 1160 */             return Int2BooleanAVLTreeMap.this.headMap(to.getIntKey()).int2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) {
/* 1165 */             return Int2BooleanAVLTreeMap.this.tailMap(from.getIntKey()).int2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Int2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1207 */       return new Int2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (BooleanIterator)new Int2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1265 */             return Int2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1270 */             return Int2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1275 */             Int2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1288 */     return new Submap(0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Int2BooleanSortedMap tailMap(int from) {
/* 1293 */     return new Submap(from, false, 0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1337 */       if (!bottom && !top && Int2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Int2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Int2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2BooleanAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 1366 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2BooleanMap.Entry>)new AbstractObjectSortedSet<Int2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() {
/* 1369 */               return (ObjectBidirectionalIterator<Int2BooleanMap.Entry>)new Int2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Int2BooleanMap.Entry>)new Int2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2BooleanMap.Entry> comparator() {
/* 1379 */               return Int2BooleanAVLTreeMap.this.int2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1387 */               if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1389 */               Int2BooleanAVLTreeMap.Entry f = Int2BooleanAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1390 */               return (f != null && Int2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1398 */               if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1399 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1400 */               Int2BooleanAVLTreeMap.Entry f = Int2BooleanAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1401 */               if (f != null && Int2BooleanAVLTreeMap.Submap.this.in(f.key)) Int2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1402 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1407 */               int c = 0;
/* 1408 */               for (ObjectBidirectionalIterator<Int2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1409 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1414 */               return !(new Int2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1419 */               Int2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2BooleanMap.Entry first() {
/* 1424 */               return Int2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2BooleanMap.Entry last() {
/* 1429 */               return Int2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) {
/* 1434 */               return Int2BooleanAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) {
/* 1439 */               return Int2BooleanAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) {
/* 1444 */               return Int2BooleanAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1453 */         return new Int2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1458 */         return new Int2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1473 */               return (BooleanIterator)new Int2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1478 */               return Int2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1483 */               return Int2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1488 */               Int2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1498 */       return (in(k) && Int2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(int k) {
/* 1516 */       int kk = k; Int2BooleanAVLTreeMap.Entry e;
/* 1517 */       return (in(kk) && (e = Int2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(int k, boolean v) {
/* 1522 */       Int2BooleanAVLTreeMap.this.modified = false;
...
/* 1524 */       boolean oldValue = Int2BooleanAVLTreeMap.this.put(k, v);
/* 1525 */       return Int2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1531 */       Int2BooleanAVLTreeMap.this.modified = false;
/* 1532 */       if (!in(k)) return this.defRetValue; 
/* 1533 */       boolean oldValue = Int2BooleanAVLTreeMap.this.remove(k);
/* 1534 */       return Int2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1555 */       return Int2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2BooleanSortedMap headMap(int to) {
/* 1560 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1561 */       return (Int2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2BooleanSortedMap tailMap(int from) {
/* 1566 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1567 */       return (Int2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2BooleanSortedMap subMap(int from, int to) {
/* 1572 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1573 */       if (!this.top) to = (Int2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1574 */       if (!this.bottom) from = (Int2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1585 */       if (Int2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1589 */       if (this.bottom) { e = Int2BooleanAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1591 */       { e = Int2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1593 */         if (Int2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1597 */       if (e == null || (!this.top && Int2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1598 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2BooleanAVLTreeMap.Entry e;
/* 1607 */       if (Int2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1611 */       if (this.top) { e = Int2BooleanAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1613 */       { e = Int2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1615 */         if (Int2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1619 */       if (e == null || (!this.bottom && Int2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1620 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1625 */       Int2BooleanAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1632 */       Int2BooleanAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1648 */         this.next = Int2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1652 */         this();
/* 1653 */         if (this.next != null) {
/* 1654 */           if (!Int2BooleanAVLTreeMap.Submap.this.bottom && Int2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1655 */           else if (!Int2BooleanAVLTreeMap.Submap.this.top && Int2BooleanAVLTreeMap.this.compare(k, (this.prev = Int2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1657 */           { this.next = Int2BooleanAVLTreeMap.this.locateKey(k);
/* 1658 */             if (Int2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1669 */         if (!Int2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Int2BooleanAVLTreeMap.this.compare(this.prev.key, Int2BooleanAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1674 */         this.next = this.next.next();
/* 1675 */         if (!Int2BooleanAVLTreeMap.Submap.this.top && this.next != null && Int2BooleanAVLTreeMap.this.compare(this.next.key, Int2BooleanAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1763 */       c = (Int2BooleanAVLTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readInt(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readInt(), s.readBoolean());
/* 1846 */       entry.right(new Entry(s.readInt(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanAVLTreeMap.class
