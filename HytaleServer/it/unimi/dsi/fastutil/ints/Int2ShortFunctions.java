...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Int2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Int2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.intValue(), value.shortValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractInt2ShortFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2ShortFunction function;
/*     */     
...
/* 544 */       Short v = this.function.apply(Integer.valueOf(key));
...
/* 551 */       Short v = this.function.apply(Integer.valueOf(key));
...
/* 597 */     if (f instanceof Int2ShortFunction) return (Int2ShortFunction)f; 
/* 598 */     if (f instanceof IntUnaryOperator) return key -> SafeMath.safeIntToShort(((IntUnaryOperator)f).applyAsInt(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortFunctions.class
