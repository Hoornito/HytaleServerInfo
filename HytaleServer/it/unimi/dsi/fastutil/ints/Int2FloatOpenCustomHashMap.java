...
/*  543 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  635 */       return Int2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  640 */       return Int2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  645 */       return Int2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  650 */       return Int2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  655 */       float oldValue = Int2FloatOpenCustomHashMap.this.value[this.index];
/*  656 */       Int2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntFloatPair right(float v) {
/*  662 */       Int2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Integer.valueOf(Int2FloatOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Float.valueOf(Int2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
/*  704 */       return (Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Int2FloatOpenCustomHashMap.this.strategy.hashCode(Int2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Int2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Int2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Int2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Int2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Int2FloatOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Int2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Int2FloatOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask;
/*  763 */           for (; !Int2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2FloatOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Int2FloatOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
...
/*  783 */           for (; !Int2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2FloatOpenCustomHashMap.this.mask);
...
/*  803 */       int[] key = Int2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  805 */         pos = (last = pos) + 1 & Int2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2FloatOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Int2FloatOpenCustomHashMap.this.value[last] = Int2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Int2FloatOpenCustomHashMap.this.n)
/*  827 */       { Int2FloatOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Int2FloatOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Int2FloatOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2FloatMap.Entry>> implements ObjectIterator<Int2FloatMap.Entry> { public Int2FloatOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Int2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Int2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Int2FloatOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Int2FloatOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Int2FloatOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Int2FloatOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Int2FloatOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Int2FloatOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Int2FloatOpenCustomHashMap.this.size - this.c), (long)(Int2FloatOpenCustomHashMap.this.realSize() / Int2FloatOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2FloatMap.Entry> action, int index) {
/* 1014 */       action.accept(new Int2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Int2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
/* 1031 */       return new Int2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2FloatMap.Entry> spliterator() {
/* 1036 */       return new Int2FloatOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1051 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1073 */         if (Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1074 */           Int2FloatOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       int[] key = Int2FloatOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1086 */           Int2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1095 */           Int2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Int2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Int2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
/* 1115 */       if (Int2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2FloatOpenCustomHashMap.MapEntry(Int2FloatOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Int2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2FloatOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2FloatOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
/* 1122 */       Int2FloatOpenCustomHashMap.MapEntry entry = new Int2FloatOpenCustomHashMap.MapEntry();
/* 1123 */       if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Int2FloatOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Int2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2FloatOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Int2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1163 */       return Int2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1184 */       action.accept(Int2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Int2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1201 */       return new Int2FloatOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1207 */       if (Int2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Int2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         int k = Int2FloatOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Int2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1221 */       return Int2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1226 */       int oldSize = Int2FloatOpenCustomHashMap.this.size;
/* 1227 */       Int2FloatOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Int2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Int2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Int2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1266 */       return Int2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1287 */       action.accept(Int2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Int2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1306 */             return new Int2FloatOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1312 */             if (Int2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Int2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2FloatOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2FloatOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Int2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1323 */             return Int2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Int2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Int2FloatOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatOpenCustomHashMap.class
