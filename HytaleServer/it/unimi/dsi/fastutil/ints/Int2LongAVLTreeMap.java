...
/*      */ 
/*      */ 
/*      */ public class Int2LongAVLTreeMap
...
/*  885 */       Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
/*  886 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Int2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  998 */       if ((this.next = Int2LongAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Int2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Int2LongAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2LongMap.Entry>)new AbstractObjectSortedSet<Int2LongMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Int2LongAVLTreeMap.Entry f = Int2LongAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1147 */             Int2LongAVLTreeMap.Entry f = Int2LongAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1148 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1149 */             Int2LongAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Int2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Int2LongAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2LongMap.Entry first() {
/* 1165 */             return Int2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2LongMap.Entry last() {
/* 1170 */             return Int2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry to) {
/* 1175 */             return Int2LongAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry to) {
/* 1180 */             return Int2LongAVLTreeMap.this.headMap(to.getIntKey()).int2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from) {
/* 1185 */             return Int2LongAVLTreeMap.this.tailMap(from.getIntKey()).int2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Int2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1227 */       return new Int2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (LongIterator)new Int2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1285 */             return Int2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Int2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Int2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Int2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Int2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Int2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2LongMap.Entry>)new AbstractObjectSortedSet<Int2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2LongMap.Entry> comparator() {
/* 1399 */               return Int2LongAVLTreeMap.this.int2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Int2LongAVLTreeMap.Entry f = Int2LongAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1410 */               return (f != null && Int2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Int2LongAVLTreeMap.Entry f = Int2LongAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1421 */               if (f != null && Int2LongAVLTreeMap.Submap.this.in(f.key)) Int2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Int2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Int2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Int2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2LongMap.Entry first() {
/* 1444 */               return Int2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2LongMap.Entry last() {
/* 1449 */               return Int2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry to) {
/* 1454 */               return Int2LongAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry to) {
/* 1459 */               return Int2LongAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from) {
/* 1464 */               return Int2LongAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2LongEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractInt2LongSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1473 */         return new Int2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1478 */         return new Int2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public LongIterator iterator() {
/* 1493 */               return (LongIterator)new Int2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1498 */               return Int2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Int2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Int2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1518 */       return (in(k) && Int2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(int k) {
/* 1536 */       int kk = k; Int2LongAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Int2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(int k, long v) {
/* 1542 */       Int2LongAVLTreeMap.this.modified = false;
...
/* 1544 */       long oldValue = Int2LongAVLTreeMap.this.put(k, v);
/* 1545 */       return Int2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(int k) {
/* 1551 */       Int2LongAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       long oldValue = Int2LongAVLTreeMap.this.remove(k);
/* 1554 */       return Int2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1575 */       return Int2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongSortedMap headMap(int to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Int2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongSortedMap tailMap(int from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Int2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongSortedMap subMap(int from, int to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Int2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Int2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Int2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Int2LongAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Int2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Int2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Int2LongAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2LongAVLTreeMap.Entry e;
/* 1627 */       if (Int2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Int2LongAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Int2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Int2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Int2LongAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1645 */       Int2LongAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1652 */       Int2LongAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Int2LongAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Int2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Int2LongAVLTreeMap.Submap.this.bottom && Int2LongAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Int2LongAVLTreeMap.Submap.this.top && Int2LongAVLTreeMap.this.compare(k, (this.prev = Int2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Int2LongAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Int2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Int2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Int2LongAVLTreeMap.this.compare(this.prev.key, Int2LongAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Int2LongAVLTreeMap.Submap.this.top && this.next != null && Int2LongAVLTreeMap.this.compare(this.next.key, Int2LongAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Int2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Int2LongAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readInt(), s.readLong());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readInt(), s.readLong());
/* 1866 */       entry.right(new Entry(s.readInt(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongAVLTreeMap.class
