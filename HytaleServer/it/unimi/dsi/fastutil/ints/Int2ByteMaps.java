...
/*  50 */     return (entries instanceof Int2ByteMap.FastEntrySet) ? ((Int2ByteMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Int2ByteMap.Entry> entries = map.int2ByteEntrySet();
/*  66 */     if (entries instanceof Int2ByteMap.FastEntrySet) { ((Int2ByteMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Int2ByteMap.Entry> entries = map.int2ByteEntrySet();
/*  83 */     return (entries instanceof Int2ByteMap.FastEntrySet) ? new ObjectIterable<Int2ByteMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Int2ByteMap.Entry> iterator() {
/*  86 */           return ((Int2ByteMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Int2ByteMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Int2ByteMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractInt2ByteMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)int2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* 316 */     return new Singleton(key.intValue(), value.byteValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Int2ByteFunctions.SynchronizedFunction implements Int2ByteMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2ByteEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Byte>> entrySet() {
/* 381 */       return (ObjectSet)int2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/*     */     extends Int2ByteFunctions.UnmodifiableFunction implements Int2ByteMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2ByteMap map;
/*     */     protected transient ObjectSet<Int2ByteMap.Entry> entries;
/*     */     protected transient IntSet keys;
...
/*     */     
/*     */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2ByteEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Byte>> entrySet() {
/* 712 */       return (ObjectSet)int2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteMaps.class
