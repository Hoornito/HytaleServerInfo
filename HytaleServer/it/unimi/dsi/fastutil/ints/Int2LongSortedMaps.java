...
/*  61 */     return (entries instanceof Int2LongSortedMap.FastSortedEntrySet) ? ((Int2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Int2LongMap.Entry> entries = map.int2LongEntrySet();
/*  77 */     Objects.requireNonNull((Int2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Int2LongSortedMap.FastSortedEntrySet) ? (Int2LongSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Int2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Int2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Integer, Long>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2LongSortedMap headMap(int to) {
/* 125 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2LongSortedMap tailMap(int from) {
/* 130 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Int2LongMap.Entry>)ObjectSortedSets.singleton(new AbstractInt2LongMap.BasicEntry(this.key, this.value), Int2LongSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Int2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Long>> entrySet() {
/* 248 */       return (ObjectSortedSet)int2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/* 260 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2LongSortedMap headMap(int to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int2LongSortedMap tailMap(int from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Int2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public int firstIntKey() {
...
/* 369 */     return new Singleton(key.intValue(), value.longValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Int2LongMaps.SynchronizedMap implements Int2LongSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Int2LongMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.int2LongEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Int2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Integer, Long>> entrySet() {
/* 440 */       return (ObjectSortedSet)int2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSortedSet keySet() {
...
/*     */     extends Int2LongMaps.UnmodifiableMap implements Int2LongSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2LongSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Int2LongMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.int2LongEntrySet()); 
/* 581 */       return (ObjectSortedSet<Int2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongSortedMaps.class
