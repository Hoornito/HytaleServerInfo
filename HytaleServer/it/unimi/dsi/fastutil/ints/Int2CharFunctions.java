...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Int2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Int2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.intValue(), value.charValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractInt2CharFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2CharFunction function;
/*     */     
...
/* 544 */       Character v = this.function.apply(Integer.valueOf(key));
...
/* 551 */       Character v = this.function.apply(Integer.valueOf(key));
...
/* 597 */     if (f instanceof Int2CharFunction) return (Int2CharFunction)f; 
/* 598 */     if (f instanceof IntUnaryOperator) return key -> SafeMath.safeIntToChar(((IntUnaryOperator)f).applyAsInt(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2CharFunctions.class
