...
/*  519 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  532 */     int pos = find(k);
/*  533 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  611 */       return Int2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  616 */       return Int2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  621 */       return Int2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  626 */       return Int2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  631 */       long oldValue = Int2LongOpenHashMap.this.value[this.index];
/*  632 */       Int2LongOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntLongPair right(long v) {
/*  638 */       Int2LongOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  650 */       return Integer.valueOf(Int2LongOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Long.valueOf(Int2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
/*  680 */       return (Int2LongOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Int2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Int2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Int2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Int2LongOpenHashMap.this.key[this.index] + "=>" + Int2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Int2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Int2LongOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Int2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Int2LongOpenHashMap.this.n;
/*      */       } 
/*  732 */       int[] key = Int2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Int2LongOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Int2LongOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
...
/*  749 */         acceptOnIndex(action, this.last = Int2LongOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       int[] key = Int2LongOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Int2LongOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Int2LongOpenHashMap.this.mask);
...
/*  779 */       int[] key = Int2LongOpenHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  781 */         pos = (last = pos) + 1 & Int2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == 0) {
/*  784 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Int2LongOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Int2LongOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Int2LongOpenHashMap.this.value[last] = Int2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Int2LongOpenHashMap.this.n)
/*  803 */       { Int2LongOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Int2LongOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Int2LongOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2LongMap.Entry>> implements ObjectIterator<Int2LongMap.Entry> { public Int2LongOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Int2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     private Int2LongOpenHashMap.MapEntry entry;
/*      */     private EntryIterator() {}
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2LongMap.Entry> action, int index) {
/*  834 */       action.accept(this.entry = new Int2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Int2LongOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Int2LongOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Int2LongOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Int2LongOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       int[] key = Int2LongOpenHashMap.this.key;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Int2LongOpenHashMap.this.n);
/*      */       } 
/*  914 */       int[] key = Int2LongOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Int2LongOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Int2LongOpenHashMap.this.size - this.c), (long)(Int2LongOpenHashMap.this.realSize() / Int2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       int[] key = Int2LongOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2LongMap.Entry> action, int index) {
/*  990 */       action.accept(new Int2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Int2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2LongMap.Entry> fastIterator() {
/* 1007 */       return new Int2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2LongMap.Entry> spliterator() {
/* 1012 */       return new Int2LongOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */       if (k == 0) return (Int2LongOpenHashMap.this.containsNullKey && Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n] == v);
/*      */       
/* 1027 */       int[] key = Int2LongOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1031 */       if (k == curr) return (Int2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Int2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1035 */         if (k == curr) return (Int2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == 0) {
/* 1049 */         if (Int2LongOpenHashMap.this.containsNullKey && Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n] == v) {
/* 1050 */           Int2LongOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       int[] key = Int2LongOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Int2LongOpenHashMap.this.value[pos] == v) {
/* 1062 */           Int2LongOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Int2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Int2LongOpenHashMap.this.value[pos] == v) {
/* 1071 */           Int2LongOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Int2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Int2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1091 */       if (Int2LongOpenHashMap.this.containsNullKey) consumer.accept(new Int2LongOpenHashMap.MapEntry(Int2LongOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Int2LongOpenHashMap.this.n; pos-- != 0;) { if (Int2LongOpenHashMap.this.key[pos] != 0) consumer.accept(new Int2LongOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1098 */       Int2LongOpenHashMap.MapEntry entry = new Int2LongOpenHashMap.MapEntry();
/* 1099 */       if (Int2LongOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Int2LongOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Int2LongOpenHashMap.this.n; pos-- != 0;) { if (Int2LongOpenHashMap.this.key[pos] != 0) {
...
/* 1134 */       action.accept(Int2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1139 */       return Int2LongOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1160 */       action.accept(Int2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Int2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1177 */       return new Int2LongOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1183 */       if (Int2LongOpenHashMap.this.containsNullKey) consumer.accept(Int2LongOpenHashMap.this.key[Int2LongOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Int2LongOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         int k = Int2LongOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1192 */       return Int2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1197 */       return Int2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1202 */       int oldSize = Int2LongOpenHashMap.this.size;
/* 1203 */       Int2LongOpenHashMap.this.remove(k);
/* 1204 */       return (Int2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Int2LongOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Int2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1242 */       return Int2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1263 */       action.accept(Int2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Int2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1282 */             return new Int2LongOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1288 */             if (Int2LongOpenHashMap.this.containsNullKey) consumer.accept(Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Int2LongOpenHashMap.this.n; pos-- != 0;) { if (Int2LongOpenHashMap.this.key[pos] != 0) consumer.accept(Int2LongOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Int2LongOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1299 */             return Int2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Int2LongOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1402 */       c = (Int2LongOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongOpenHashMap.class
