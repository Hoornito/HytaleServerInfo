...
/*  50 */     return (entries instanceof Int2FloatMap.FastEntrySet) ? ((Int2FloatMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Int2FloatMap.Entry> entries = map.int2FloatEntrySet();
/*  66 */     if (entries instanceof Int2FloatMap.FastEntrySet) { ((Int2FloatMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Int2FloatMap.Entry> entries = map.int2FloatEntrySet();
/*  83 */     return (entries instanceof Int2FloatMap.FastEntrySet) ? new ObjectIterable<Int2FloatMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Int2FloatMap.Entry> iterator() {
/*  86 */           return ((Int2FloatMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Int2FloatMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Int2FloatMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractInt2FloatMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)int2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* 316 */     return new Singleton(key.intValue(), value.floatValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Int2FloatFunctions.SynchronizedFunction implements Int2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2FloatEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Float>> entrySet() {
/* 381 */       return (ObjectSet)int2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/*     */     extends Int2FloatFunctions.UnmodifiableFunction implements Int2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2FloatMap map;
/*     */     protected transient ObjectSet<Int2FloatMap.Entry> entries;
/*     */     protected transient IntSet keys;
...
/*     */     
/*     */     public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2FloatEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Float>> entrySet() {
/* 712 */       return (ObjectSet)int2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatMaps.class
