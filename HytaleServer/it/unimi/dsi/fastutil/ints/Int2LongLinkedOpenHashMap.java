...
/*  853 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  866 */     int pos = find(k);
/*  867 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*      */     implements Int2LongMap.Entry, Map.Entry<Integer, Long>, IntLongPair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  946 */       return Int2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  951 */       return Int2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  956 */       return Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  961 */       return Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  966 */       long oldValue = Int2LongLinkedOpenHashMap.this.value[this.index];
/*  967 */       Int2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntLongPair right(long v) {
/*  973 */       Int2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  985 */       return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
/* 1015 */       return (Int2LongLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Int2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Int2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Int2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Int2LongLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(int from) {
/* 1198 */       if (from == 0) {
/* 1199 */         if (Int2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Int2LongLinkedOpenHashMap.this.link[Int2LongLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Int2LongLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Int2LongLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Int2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Int2LongLinkedOpenHashMap.this.key[pos] != 0) {
/* 1214 */         if (Int2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Int2LongLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Int2LongLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Int2LongLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Int2LongLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Int2LongLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Int2LongLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Int2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Int2LongLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Int2LongLinkedOpenHashMap.this.link[this.prev] = Int2LongLinkedOpenHashMap.this.link[this.prev] ^ (Int2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Int2LongLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Int2LongLinkedOpenHashMap.this.link[this.next] = Int2LongLinkedOpenHashMap.this.link[this.next] ^ (Int2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Int2LongLinkedOpenHashMap.this.n) {
/* 1308 */         Int2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           int curr, last;
/* 1314 */           pos = (last = pos) + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == 0) {
/* 1317 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Int2LongLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Int2LongLinkedOpenHashMap.this.value[last] = Int2LongLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Int2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2LongMap.Entry>> implements ObjectListIterator<Int2LongMap.Entry> {
...
/* 1367 */       action.accept(new Int2LongLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Int2LongMap.Entry>> implements ObjectListIterator<Int2LongMap.Entry> {
/* 1388 */     final Int2LongLinkedOpenHashMap.MapEntry entry = new Int2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Int2LongLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2LongMap.Entry last() {
/* 1471 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1484 */       if (k == 0) return (Int2LongLinkedOpenHashMap.this.containsNullKey && Int2LongLinkedOpenHashMap.this.value[Int2LongLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1490 */       if (k == curr) return (Int2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1494 */         if (k == curr) return (Int2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1507 */       if (k == 0) {
/* 1508 */         if (Int2LongLinkedOpenHashMap.this.containsNullKey && Int2LongLinkedOpenHashMap.this.value[Int2LongLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Int2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Int2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Int2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Int2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Int2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Int2LongLinkedOpenHashMap.EntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1587 */       for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Int2LongLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Int2LongLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Int2LongLinkedOpenHashMap.MapEntry entry = new Int2LongLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Int2LongLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Int2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Int2LongLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1644 */       return Int2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1658 */       return new Int2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2LongLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1674 */       for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Int2LongLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Int2LongLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1688 */       return Int2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1693 */       int oldSize = Int2LongLinkedOpenHashMap.this.size;
/* 1694 */       Int2LongLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Int2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstInt() {
/* 1705 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public int lastInt() {
/* 1711 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public IntComparator comparator() {
...
/* 1753 */       return Int2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Int2LongLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1770 */       return Int2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (LongIterator)new Int2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2LongLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1797 */             for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Int2LongLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Int2LongLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Int2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1811 */             return Int2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Int2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1936 */       c = (Int2LongLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongLinkedOpenHashMap.class
