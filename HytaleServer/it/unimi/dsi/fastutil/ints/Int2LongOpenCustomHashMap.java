...
/*  542 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  634 */       return Int2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  639 */       return Int2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Int2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  649 */       return Int2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  654 */       long oldValue = Int2LongOpenCustomHashMap.this.value[this.index];
/*  655 */       Int2LongOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntLongPair right(long v) {
/*  661 */       Int2LongOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Integer.valueOf(Int2LongOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Long.valueOf(Int2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
/*  703 */       return (Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Int2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Int2LongOpenCustomHashMap.this.strategy.hashCode(Int2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Int2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Int2LongOpenCustomHashMap.this.key[this.index] + "=>" + Int2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Int2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Int2LongOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Int2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Int2LongOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       int[] key = Int2LongOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Int2LongOpenCustomHashMap.this.mask;
/*  762 */           for (; !Int2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2LongOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Int2LongOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
...
/*  782 */           for (; !Int2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2LongOpenCustomHashMap.this.mask);
...
/*  802 */       int[] key = Int2LongOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  804 */         pos = (last = pos) + 1 & Int2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == 0) {
/*  807 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2LongOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Int2LongOpenCustomHashMap.this.value[last] = Int2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Int2LongOpenCustomHashMap.this.n)
/*  826 */       { Int2LongOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Int2LongOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Int2LongOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2LongMap.Entry>> implements ObjectIterator<Int2LongMap.Entry> { public Int2LongOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Int2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Int2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Int2LongOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Int2LongOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Int2LongOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Int2LongOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       int[] key = Int2LongOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Int2LongOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       int[] key = Int2LongOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Int2LongOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Int2LongOpenCustomHashMap.this.size - this.c), (long)(Int2LongOpenCustomHashMap.this.realSize() / Int2LongOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       int[] key = Int2LongOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Int2LongMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2LongMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2LongMap.Entry> action, int index) {
/* 1013 */       action.accept(new Int2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Int2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2LongMap.Entry> fastIterator() {
/* 1030 */       return new Int2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2LongMap.Entry> spliterator() {
/* 1035 */       return new Int2LongOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Int2LongOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2LongOpenCustomHashMap.this.containsNullKey && Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       int[] key = Int2LongOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Int2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Int2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Int2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Int2LongOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1072 */         if (Int2LongOpenCustomHashMap.this.containsNullKey && Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n] == v) {
/* 1073 */           Int2LongOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       int[] key = Int2LongOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Int2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Int2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Int2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Int2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Int2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Int2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Int2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Int2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Int2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1114 */       if (Int2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2LongOpenCustomHashMap.MapEntry(Int2LongOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Int2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2LongOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2LongOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1121 */       Int2LongOpenCustomHashMap.MapEntry entry = new Int2LongOpenCustomHashMap.MapEntry();
/* 1122 */       if (Int2LongOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Int2LongOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Int2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2LongOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1157 */       action.accept(Int2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1162 */       return Int2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1183 */       action.accept(Int2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Int2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1200 */       return new Int2LongOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1206 */       if (Int2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Int2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         int k = Int2LongOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Int2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1220 */       return Int2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1225 */       int oldSize = Int2LongOpenCustomHashMap.this.size;
/* 1226 */       Int2LongOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Int2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Int2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Int2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1265 */       return Int2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1286 */       action.accept(Int2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Int2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1305 */             return new Int2LongOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1311 */             if (Int2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Int2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2LongOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2LongOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Int2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1322 */             return Int2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Int2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Int2LongOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongOpenCustomHashMap.class
