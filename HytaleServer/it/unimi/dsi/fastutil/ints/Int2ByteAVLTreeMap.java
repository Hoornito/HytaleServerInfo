...
/*  885 */       Map.Entry<Integer, Byte> e = (Map.Entry<Integer, Byte>)o;
/*  886 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Int2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  998 */       if ((this.next = Int2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Int2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2ByteMap.Entry>)new AbstractObjectSortedSet<Int2ByteMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1147 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1148 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1149 */             Int2ByteAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Int2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Int2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ByteMap.Entry first() {
/* 1165 */             return Int2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ByteMap.Entry last() {
/* 1170 */             return Int2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) {
/* 1175 */             return Int2ByteAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) {
/* 1180 */             return Int2ByteAVLTreeMap.this.headMap(to.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) {
/* 1185 */             return Int2ByteAVLTreeMap.this.tailMap(from.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Int2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1227 */       return new Int2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ByteIterator)new Int2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1285 */             return Int2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Int2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Int2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Int2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Int2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Int2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2ByteMap.Entry>)new AbstractObjectSortedSet<Int2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2ByteMap.Entry> comparator() {
/* 1399 */               return Int2ByteAVLTreeMap.this.int2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1410 */               return (f != null && Int2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1421 */               if (f != null && Int2ByteAVLTreeMap.Submap.this.in(f.key)) Int2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Int2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Int2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Int2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ByteMap.Entry first() {
/* 1444 */               return Int2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ByteMap.Entry last() {
/* 1449 */               return Int2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) {
/* 1454 */               return Int2ByteAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) {
/* 1459 */               return Int2ByteAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) {
/* 1464 */               return Int2ByteAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1473 */         return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1478 */         return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1493 */               return (ByteIterator)new Int2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1498 */               return Int2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Int2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Int2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1518 */       return (in(k) && Int2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(int k) {
/* 1536 */       int kk = k; Int2ByteAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Int2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(int k, byte v) {
/* 1542 */       Int2ByteAVLTreeMap.this.modified = false;
...
/* 1544 */       byte oldValue = Int2ByteAVLTreeMap.this.put(k, v);
/* 1545 */       return Int2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(int k) {
/* 1551 */       Int2ByteAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       byte oldValue = Int2ByteAVLTreeMap.this.remove(k);
/* 1554 */       return Int2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1575 */       return Int2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ByteSortedMap headMap(int to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Int2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ByteSortedMap tailMap(int from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Int2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ByteSortedMap subMap(int from, int to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Int2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Int2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Int2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Int2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Int2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2ByteAVLTreeMap.Entry e;
/* 1627 */       if (Int2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Int2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Int2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1645 */       Int2ByteAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1652 */       Int2ByteAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Int2ByteAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Int2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Int2ByteAVLTreeMap.Submap.this.bottom && Int2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Int2ByteAVLTreeMap.Submap.this.top && Int2ByteAVLTreeMap.this.compare(k, (this.prev = Int2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Int2ByteAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Int2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Int2ByteAVLTreeMap.this.compare(this.prev.key, Int2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Int2ByteAVLTreeMap.Submap.this.top && this.next != null && Int2ByteAVLTreeMap.this.compare(this.next.key, Int2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Int2ByteAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readInt(), s.readByte());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readInt(), s.readByte());
/* 1866 */       entry.right(new Entry(s.readInt(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteAVLTreeMap.class
