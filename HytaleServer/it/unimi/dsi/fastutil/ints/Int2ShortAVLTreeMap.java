...
/*  166 */     this(k, v, (Comparator<? super Integer>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  192 */     return (this.actualComparator == null) ? Integer.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  885 */       Map.Entry<Integer, Short> e = (Map.Entry<Integer, Short>)o;
/*  886 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Int2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  998 */       if ((this.next = Int2ShortAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Int2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Int2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1133 */             if (!(e.getKey() instanceof Integer)) return false; 
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1135 */             Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1145 */             if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1146 */             if (!(e.getValue() instanceof Short)) return false; 
/* 1147 */             Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1148 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1149 */             Int2ShortAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Int2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Int2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ShortMap.Entry first() {
/* 1165 */             return Int2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ShortMap.Entry last() {
/* 1170 */             return Int2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1175 */             return Int2ShortAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1180 */             return Int2ShortAVLTreeMap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1185 */             return Int2ShortAVLTreeMap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Int2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1227 */       return new Int2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ShortIterator)new Int2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1285 */             return Int2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Int2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Int2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1308 */     return new Submap(0, true, to, false);
/*      */   }
/*      */ 
/*      */   
...
/* 1357 */       if (!bottom && !top && Int2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Int2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Int2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2ShortMap.Entry> comparator() {
/* 1399 */               return Int2ShortAVLTreeMap.this.int2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1407 */               if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1409 */               Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1410 */               return (f != null && Int2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1418 */               if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1420 */               Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1421 */               if (f != null && Int2ShortAVLTreeMap.Submap.this.in(f.key)) Int2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Int2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Int2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Int2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ShortMap.Entry first() {
/* 1444 */               return Int2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ShortMap.Entry last() {
/* 1449 */               return Int2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1454 */               return Int2ShortAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1459 */               return Int2ShortAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1464 */               return Int2ShortAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractInt2ShortSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1473 */         return new Int2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1478 */         return new Int2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1493 */               return (ShortIterator)new Int2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1498 */               return Int2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Int2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Int2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1518 */       return (in(k) && Int2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(int k) {
/* 1536 */       int kk = k; Int2ShortAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Int2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(int k, short v) {
/* 1542 */       Int2ShortAVLTreeMap.this.modified = false;
...
/* 1544 */       short oldValue = Int2ShortAVLTreeMap.this.put(k, v);
/* 1545 */       return Int2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(int k) {
/* 1551 */       Int2ShortAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       short oldValue = Int2ShortAVLTreeMap.this.remove(k);
/* 1554 */       return Int2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1575 */       return Int2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap headMap(int to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Int2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap tailMap(int from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Int2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap subMap(int from, int to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Int2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Int2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Int2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Int2ShortAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Int2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Int2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Int2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2ShortAVLTreeMap.Entry e;
/* 1627 */       if (Int2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Int2ShortAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Int2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Int2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Int2ShortAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1645 */       Int2ShortAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1652 */       Int2ShortAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Int2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Int2ShortAVLTreeMap.Submap.this.bottom && Int2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Int2ShortAVLTreeMap.Submap.this.top && Int2ShortAVLTreeMap.this.compare(k, (this.prev = Int2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Int2ShortAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Int2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Int2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Int2ShortAVLTreeMap.this.compare(this.prev.key, Int2ShortAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Int2ShortAVLTreeMap.Submap.this.top && this.next != null && Int2ShortAVLTreeMap.this.compare(this.next.key, Int2ShortAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Int2ShortMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Int2ShortAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readInt(), s.readShort());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readInt(), s.readShort());
/* 1866 */       entry.right(new Entry(s.readInt(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortAVLTreeMap.class
