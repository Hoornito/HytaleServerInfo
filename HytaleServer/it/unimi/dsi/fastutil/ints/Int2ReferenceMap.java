...
/* 164 */     return (ObjectSet)int2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 256 */     ObjectSet<Entry<V>> entrySet = int2ReferenceEntrySet();
/* 257 */     Consumer<Entry<V>> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), entry.getValue());
...
/* 468 */     V newValue = remappingFunction.apply(Integer.valueOf(key), oldValue);
...
/* 499 */     V newValue = remappingFunction.apply(Integer.valueOf(key), contained ? oldValue : null);
...
/* 568 */       return Integer.valueOf(getIntKey());
/*     */     }
/*     */     
/*     */     int getIntKey();
/*     */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceMap.class
