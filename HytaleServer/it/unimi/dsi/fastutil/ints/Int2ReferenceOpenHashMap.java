...
/*  559 */       return Int2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  564 */       return Int2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  569 */       return Int2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  574 */       return Int2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  579 */       V oldValue = Int2ReferenceOpenHashMap.this.value[this.index];
/*  580 */       Int2ReferenceOpenHashMap.this.value[this.index] = v;
/*  581 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntReferencePair<V> right(V v) {
/*  586 */       Int2ReferenceOpenHashMap.this.value[this.index] = v;
/*  587 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  598 */       return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  606 */       return (Int2ReferenceOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Int2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  611 */       return Int2ReferenceOpenHashMap.this.key[this.index] ^ ((Int2ReferenceOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Int2ReferenceOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  616 */       return Int2ReferenceOpenHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  627 */     int pos = Int2ReferenceOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  633 */     int last = -1;
/*      */     
/*  635 */     int c = Int2ReferenceOpenHashMap.this.size;
/*      */     
/*  637 */     boolean mustReturnNullKey = Int2ReferenceOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  656 */         return this.last = Int2ReferenceOpenHashMap.this.n;
/*      */       } 
/*  658 */       int[] key = Int2ReferenceOpenHashMap.this.key;
/*      */       while (true) {
/*  660 */         if (--this.pos < 0) {
/*      */           
/*  662 */           this.last = Integer.MIN_VALUE;
/*  663 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  664 */           int p = HashCommon.mix(k) & Int2ReferenceOpenHashMap.this.mask;
/*  665 */           for (; k != key[p]; p = p + 1 & Int2ReferenceOpenHashMap.this.mask);
/*  666 */           return p;
/*      */         } 
...
/*  675 */         acceptOnIndex(action, this.last = Int2ReferenceOpenHashMap.this.n);
/*  676 */         this.c--;
/*      */       } 
/*  678 */       int[] key = Int2ReferenceOpenHashMap.this.key;
/*  679 */       while (this.c != 0) {
/*  680 */         if (--this.pos < 0) {
/*      */           
/*  682 */           this.last = Integer.MIN_VALUE;
/*  683 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  684 */           int p = HashCommon.mix(k) & Int2ReferenceOpenHashMap.this.mask;
/*  685 */           for (; k != key[p]; p = p + 1 & Int2ReferenceOpenHashMap.this.mask);
...
/*  705 */       int[] key = Int2ReferenceOpenHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  707 */         pos = (last = pos) + 1 & Int2ReferenceOpenHashMap.this.mask;
/*      */         while (true) {
/*  709 */           if ((curr = key[pos]) == 0) {
/*  710 */             key[last] = 0;
/*  711 */             Int2ReferenceOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  714 */           int slot = HashCommon.mix(curr) & Int2ReferenceOpenHashMap.this.mask;
/*  715 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  716 */             break;  pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/*      */         } 
/*  718 */         if (pos < last) {
...
/*      */         } 
/*  722 */         key[last] = curr;
/*  723 */         Int2ReferenceOpenHashMap.this.value[last] = Int2ReferenceOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  728 */       if (this.last == -1) throw new IllegalStateException(); 
/*  729 */       if (this.last == Int2ReferenceOpenHashMap.this.n)
/*  730 */       { Int2ReferenceOpenHashMap.this.containsNullKey = false;
/*  731 */         Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n] = null; }
/*  732 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  735 */       { Int2ReferenceOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  736 */         this.last = -1;
/*      */         return; }
/*      */       
/*  739 */       Int2ReferenceOpenHashMap.this.size--;
/*  740 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>> implements ObjectIterator<Int2ReferenceMap.Entry<V>> { public Int2ReferenceOpenHashMap<V>.MapEntry next() {
/*  756 */       return this.entry = new Int2ReferenceOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  762 */       action.accept(this.entry = new Int2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  773 */       this.entry = new Int2ReferenceOpenHashMap.MapEntry();
/*      */     }
...
/*  794 */     int pos = 0;
/*      */     
/*  796 */     int max = Int2ReferenceOpenHashMap.this.n;
/*      */     
/*  798 */     int c = 0;
/*      */     
/*  800 */     boolean mustReturnNull = Int2ReferenceOpenHashMap.this.containsNullKey;
/*      */     
...
/*  820 */         this.c++;
/*  821 */         acceptOnIndex(action, Int2ReferenceOpenHashMap.this.n);
/*  822 */         return true;
/*      */       } 
/*  824 */       int[] key = Int2ReferenceOpenHashMap.this.key;
...
/*  839 */         this.c++;
/*  840 */         acceptOnIndex(action, Int2ReferenceOpenHashMap.this.n);
/*      */       } 
/*  842 */       int[] key = Int2ReferenceOpenHashMap.this.key;
...
/*      */       {
/*  855 */         return (Int2ReferenceOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  860 */       return Math.min((Int2ReferenceOpenHashMap.this.size - this.c), (long)(Int2ReferenceOpenHashMap.this.realSize() / Int2ReferenceOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  888 */         n--;
/*      */       } 
/*  890 */       int[] key = Int2ReferenceOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
/*  918 */       action.accept(new Int2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  930 */       return new Int2ReferenceOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/*  935 */       return new Int2ReferenceOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2ReferenceMap.Entry<V>> spliterator() {
/*  940 */       return new Int2ReferenceOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  952 */       if (k == 0) return (Int2ReferenceOpenHashMap.this.containsNullKey && Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n] == v);
/*      */       
/*  954 */       int[] key = Int2ReferenceOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/*  957 */       if ((curr = key[pos = HashCommon.mix(k) & Int2ReferenceOpenHashMap.this.mask]) == 0) return false; 
/*  958 */       if (k == curr) return (Int2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  961 */         if ((curr = key[pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask]) == 0) return false; 
/*  962 */         if (k == curr) return (Int2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  974 */       if (k == 0) {
/*  975 */         if (Int2ReferenceOpenHashMap.this.containsNullKey && Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n] == v) {
/*  976 */           Int2ReferenceOpenHashMap.this.removeNullEntry();
/*  977 */           return true;
/*      */         } 
/*  979 */         return false;
/*      */       } 
/*      */       
/*  982 */       int[] key = Int2ReferenceOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/*  985 */       if ((curr = key[pos = HashCommon.mix(k) & Int2ReferenceOpenHashMap.this.mask]) == 0) return false; 
/*  986 */       if (curr == k) {
/*  987 */         if (Int2ReferenceOpenHashMap.this.value[pos] == v) {
/*  988 */           Int2ReferenceOpenHashMap.this.removeEntry(pos);
/*  989 */           return true;
/*      */         } 
/*  991 */         return false;
/*      */       } 
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask]) == 0) return false; 
/*  995 */         if (curr == k && 
/*  996 */           Int2ReferenceOpenHashMap.this.value[pos] == v) {
/*  997 */           Int2ReferenceOpenHashMap.this.removeEntry(pos);
/*  998 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1006 */       return Int2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1011 */       Int2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
/* 1017 */       if (Int2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(new Int2ReferenceOpenHashMap.MapEntry(Int2ReferenceOpenHashMap.this.n)); 
/* 1018 */       for (int pos = Int2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenHashMap.this.key[pos] != 0) consumer.accept(new Int2ReferenceOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
/* 1024 */       Int2ReferenceOpenHashMap<V>.MapEntry entry = new Int2ReferenceOpenHashMap.MapEntry();
/* 1025 */       if (Int2ReferenceOpenHashMap.this.containsNullKey) {
/* 1026 */         entry.index = Int2ReferenceOpenHashMap.this.n;
/* 1027 */         consumer.accept(entry);
/*      */       } 
/* 1029 */       for (int pos = Int2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenHashMap.this.key[pos] != 0) {
...
/* 1060 */       action.accept(Int2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1065 */       return Int2ReferenceOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1086 */       action.accept(Int2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1098 */       return new Int2ReferenceOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1103 */       return new Int2ReferenceOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1109 */       if (Int2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Int2ReferenceOpenHashMap.this.key[Int2ReferenceOpenHashMap.this.n]); 
/* 1110 */       for (int pos = Int2ReferenceOpenHashMap.this.n; pos-- != 0; ) {
/* 1111 */         int k = Int2ReferenceOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1118 */       return Int2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1123 */       return Int2ReferenceOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1128 */       int oldSize = Int2ReferenceOpenHashMap.this.size;
/* 1129 */       Int2ReferenceOpenHashMap.this.remove(k);
/* 1130 */       return (Int2ReferenceOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1135 */       Int2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1163 */       action.accept(Int2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1168 */       return Int2ReferenceOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1189 */       action.accept(Int2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1203 */             return new Int2ReferenceOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1208 */             return new Int2ReferenceOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1214 */             if (Int2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n]); 
/* 1215 */             for (int pos = Int2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Int2ReferenceOpenHashMap.this.key[pos] != 0) consumer.accept(Int2ReferenceOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1220 */             return Int2ReferenceOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1225 */             return Int2ReferenceOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1230 */             Int2ReferenceOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1328 */       c = (Int2ReferenceOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceOpenHashMap.class
