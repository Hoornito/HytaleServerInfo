...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Int2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Int2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.intValue(), value.doubleValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractInt2DoubleFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2DoubleFunction function;
/*     */     
...
/* 544 */       Double v = this.function.apply(Integer.valueOf(key));
...
/* 551 */       Double v = this.function.apply(Integer.valueOf(key));
...
/* 597 */     if (f instanceof Int2DoubleFunction) return (Int2DoubleFunction)f; 
/* 598 */     if (f instanceof IntToDoubleFunction) { Objects.requireNonNull((IntToDoubleFunction)f); return (IntToDoubleFunction)f::applyAsDouble; }
/* 599 */      return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleFunctions.class
