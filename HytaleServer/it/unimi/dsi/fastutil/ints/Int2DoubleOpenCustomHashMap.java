...
/*  261 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  263 */     int[] key = this.key;
/*      */     
/*      */     int curr, pos;
...
/*      */     int pos;
/*  316 */     if (this.strategy.equals(k, 0)) {
...
/*  346 */     int[] key = this.key; while (true) {
/*      */       int curr, last;
...
/*  385 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
...
/*  402 */     if (this.strategy.equals(k, 0)) return this.containsNullKey;
/*      */     
...
/*  421 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0 && Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)) return true;  }
/*  422 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  429 */     if (this.strategy.equals(k, 0)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
...
/*  456 */     if (this.strategy.equals(k, 0)) {
...
/*  542 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), Double.valueOf(this.value[pos]));
/*  543 */     if (newValue == null) {
/*  544 */       if (this.strategy.equals(k, 0)) { removeNullEntry(); }
...
/*  555 */     int pos = find(k);
/*  556 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
/*  557 */     if (newValue == null) {
/*  558 */       if (pos >= 0)
/*  559 */         if (this.strategy.equals(k, 0)) { removeNullEntry(); }
...
/*  585 */       if (this.strategy.equals(k, 0)) { removeNullEntry(); }
...
/*  634 */       return Int2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  639 */       return Int2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  644 */       return Int2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  649 */       return Int2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  654 */       double oldValue = Int2DoubleOpenCustomHashMap.this.value[this.index];
/*  655 */       Int2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntDoublePair right(double v) {
/*  661 */       Int2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Integer.valueOf(Int2DoubleOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Double.valueOf(Int2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
/*  703 */       return (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Int2DoubleOpenCustomHashMap.this.strategy.hashCode(Int2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Int2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Int2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Int2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Int2DoubleOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Int2DoubleOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Int2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Int2DoubleOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask;
/*  762 */           for (; !Int2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2DoubleOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Int2DoubleOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask;
/*  782 */           for (; !Int2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2DoubleOpenCustomHashMap.this.mask);
...
/*  802 */       int[] key = Int2DoubleOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  804 */         pos = (last = pos) + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == 0) {
/*  807 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2DoubleOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
/*  815 */           if (this.wrapped == null) this.wrapped = new IntArrayList(2); 
/*  816 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Int2DoubleOpenCustomHashMap.this.value[last] = Int2DoubleOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Int2DoubleOpenCustomHashMap.this.n)
/*  826 */       { Int2DoubleOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Int2DoubleOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Int2DoubleOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2DoubleMap.Entry>> implements ObjectIterator<Int2DoubleMap.Entry> { public Int2DoubleOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Int2DoubleOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Int2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Int2DoubleOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Int2DoubleOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Int2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Int2DoubleOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Int2DoubleOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Int2DoubleOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Int2DoubleOpenCustomHashMap.this.size - this.c), (long)(Int2DoubleOpenCustomHashMap.this.realSize() / Int2DoubleOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Int2DoubleMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2DoubleMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2DoubleMap.Entry> action, int index) {
/* 1013 */       action.accept(new Int2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Int2DoubleOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2DoubleMap.Entry> fastIterator() {
/* 1030 */       return new Int2DoubleOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2DoubleMap.Entry> spliterator() {
/* 1035 */       return new Int2DoubleOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1044 */       if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1045 */       if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1046 */       int k = ((Integer)e.getKey()).intValue();
/* 1047 */       double v = ((Double)e.getValue()).doubleValue();
/* 1048 */       if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1050 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1067 */       if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1068 */       if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1069 */       int k = ((Integer)e.getKey()).intValue();
/* 1070 */       double v = ((Double)e.getValue()).doubleValue();
/* 1071 */       if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1072 */         if (Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1073 */           Int2DoubleOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       int[] key = Int2DoubleOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1085 */           Int2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1094 */           Int2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Int2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Int2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1114 */       if (Int2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2DoubleOpenCustomHashMap.MapEntry(Int2DoubleOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Int2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2DoubleOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1121 */       Int2DoubleOpenCustomHashMap.MapEntry entry = new Int2DoubleOpenCustomHashMap.MapEntry();
/* 1122 */       if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Int2DoubleOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Int2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1157 */       action.accept(Int2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1162 */       return Int2DoubleOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1183 */       action.accept(Int2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Int2DoubleOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1200 */       return new Int2DoubleOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1206 */       if (Int2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2DoubleOpenCustomHashMap.this.key[Int2DoubleOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Int2DoubleOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         int k = Int2DoubleOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Int2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1220 */       return Int2DoubleOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1225 */       int oldSize = Int2DoubleOpenCustomHashMap.this.size;
/* 1226 */       Int2DoubleOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Int2DoubleOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Int2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Int2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1265 */       return Int2DoubleOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1286 */       action.accept(Int2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Int2DoubleOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1305 */             return new Int2DoubleOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1311 */             if (Int2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Int2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2DoubleOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Int2DoubleOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1322 */             return Int2DoubleOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Int2DoubleOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1391 */     int[] key = this.key;
/* 1392 */     double[] value = this.value;
/* 1393 */     int mask = newN - 1;
/* 1394 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1425 */       c = (Int2DoubleOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleOpenCustomHashMap.class
