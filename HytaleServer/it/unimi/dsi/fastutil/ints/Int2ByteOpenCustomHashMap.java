...
/*  543 */     Byte newValue = remappingFunction.apply(Integer.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Byte newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  635 */       return Int2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  640 */       return Int2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  645 */       return Int2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  650 */       return Int2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  655 */       byte oldValue = Int2ByteOpenCustomHashMap.this.value[this.index];
/*  656 */       Int2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBytePair right(byte v) {
/*  662 */       Int2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Integer.valueOf(Int2ByteOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Byte.valueOf(Int2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Integer, Byte> e = (Map.Entry<Integer, Byte>)o;
/*  704 */       return (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue()) && Int2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Int2ByteOpenCustomHashMap.this.strategy.hashCode(Int2ByteOpenCustomHashMap.this.key[this.index]) ^ Int2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Int2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Int2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Int2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Int2ByteOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Int2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Int2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask;
/*  763 */           for (; !Int2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ByteOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Int2ByteOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask;
/*  783 */           for (; !Int2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Int2ByteOpenCustomHashMap.this.mask);
...
/*  803 */       int[] key = Int2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  805 */         pos = (last = pos) + 1 & Int2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ByteOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */       else
/*      */       
/*  831 */       { Int2ByteOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Int2ByteOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2ByteMap.Entry>> implements ObjectIterator<Int2ByteMap.Entry> { public Int2ByteOpenCustomHashMap.MapEntry next() {
...
/*  858 */       action.accept(this.entry = new Int2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Int2ByteOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Int2ByteOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Int2ByteOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Int2ByteOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Int2ByteOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Int2ByteOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Int2ByteOpenCustomHashMap.this.size - this.c), (long)(Int2ByteOpenCustomHashMap.this.realSize() / Int2ByteOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2ByteMap.Entry> action, int index) {
/* 1014 */       action.accept(new Int2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Int2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2ByteMap.Entry> fastIterator() {
/* 1031 */       return new Int2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2ByteMap.Entry> spliterator() {
/* 1036 */       return new Int2ByteOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Int2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) return (Int2ByteOpenCustomHashMap.this.containsNullKey && Int2ByteOpenCustomHashMap.this.value[Int2ByteOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Int2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Int2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Int2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Int2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
/* 1073 */         if (Int2ByteOpenCustomHashMap.this.containsNullKey && Int2ByteOpenCustomHashMap.this.value[Int2ByteOpenCustomHashMap.this.n] == v) {
/* 1074 */           Int2ByteOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       int[] key = Int2ByteOpenCustomHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Int2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Int2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Int2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Int2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Int2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Int2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Int2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Int2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2ByteMap.Entry> consumer) {
/* 1115 */       if (Int2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(new Int2ByteOpenCustomHashMap.MapEntry(Int2ByteOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Int2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ByteOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Int2ByteOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2ByteMap.Entry> consumer) {
/* 1122 */       Int2ByteOpenCustomHashMap.MapEntry entry = new Int2ByteOpenCustomHashMap.MapEntry();
/* 1123 */       if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Int2ByteOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Int2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ByteOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Int2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1163 */       return Int2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1184 */       action.accept(Int2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Int2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1201 */       return new Int2ByteOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1207 */       if (Int2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ByteOpenCustomHashMap.this.key[Int2ByteOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Int2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         int k = Int2ByteOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Int2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1221 */       return Int2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1226 */       int oldSize = Int2ByteOpenCustomHashMap.this.size;
/* 1227 */       Int2ByteOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Int2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Int2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Int2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1266 */       return Int2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1287 */       action.accept(Int2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Int2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1306 */             return new Int2ByteOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1312 */             if (Int2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Int2ByteOpenCustomHashMap.this.value[Int2ByteOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Int2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Int2ByteOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Int2ByteOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Int2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1323 */             return Int2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Int2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Int2ByteOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteOpenCustomHashMap.class
