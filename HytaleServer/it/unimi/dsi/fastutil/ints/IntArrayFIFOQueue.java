...
/*     */ 
/*     */     
/*  64 */     this.array = new int[Math.max(1, capacity + 1)];
...
/*  86 */     int t = this.array[this.start];
...
/* 101 */     int t = this.array[--this.end];
/* 102 */     reduce();
/* 103 */     return t;
/*     */   }
/*     */   
/*     */   private final void resize(int size, int newLength) {
/* 107 */     int[] newArray = new int[newLength];
...
/*     */   public void trim() {
/* 167 */     int size = size();
/* 168 */     int[] newArray = new int[size + 1];
...
/* 198 */     this.array = new int[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 199 */     for (int i = 0; i < this.end; ) { this.array[i] = s.readInt(); i++; }
/*     */   
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\IntArrayFIFOQueue.class
