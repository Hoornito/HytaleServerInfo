...
/*  854 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  947 */       return Int2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  952 */       return Int2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  957 */       return Int2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  962 */       return Int2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  967 */       float oldValue = Int2FloatLinkedOpenHashMap.this.value[this.index];
/*  968 */       Int2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntFloatPair right(float v) {
/*  974 */       Int2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  986 */       return Integer.valueOf(Int2FloatLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Float.valueOf(Int2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
/* 1016 */       return (Int2FloatLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return Int2FloatLinkedOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Int2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Int2FloatLinkedOpenHashMap.this.key[this.index] + "=>" + Int2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Int2FloatLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(int from) {
/* 1199 */       if (from == 0) {
/* 1200 */         if (Int2FloatLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Int2FloatLinkedOpenHashMap.this.link[Int2FloatLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Int2FloatLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Int2FloatLinkedOpenHashMap.this.key[Int2FloatLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Int2FloatLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Int2FloatLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = HashCommon.mix(from) & Int2FloatLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Int2FloatLinkedOpenHashMap.this.key[pos] != 0) {
/* 1215 */         if (Int2FloatLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Int2FloatLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Int2FloatLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Int2FloatLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Int2FloatLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Int2FloatLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Int2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Int2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Int2FloatLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Int2FloatLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Int2FloatLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Int2FloatLinkedOpenHashMap.this.link[this.prev] = Int2FloatLinkedOpenHashMap.this.link[this.prev] ^ (Int2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Int2FloatLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Int2FloatLinkedOpenHashMap.this.link[this.next] = Int2FloatLinkedOpenHashMap.this.link[this.next] ^ (Int2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Int2FloatLinkedOpenHashMap.this.n) {
/* 1309 */         Int2FloatLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         int[] key = Int2FloatLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           int curr, last;
/* 1315 */           pos = (last = pos) + 1 & Int2FloatLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == 0) {
/* 1318 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = HashCommon.mix(curr) & Int2FloatLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Int2FloatLinkedOpenHashMap.this.value[last] = Int2FloatLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Int2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2FloatMap.Entry>> implements ObjectListIterator<Int2FloatMap.Entry> {
...
/* 1368 */       action.accept(new Int2FloatLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2FloatLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Int2FloatLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2FloatLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Int2FloatLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Int2FloatMap.Entry>> implements ObjectListIterator<Int2FloatMap.Entry> {
/* 1389 */     final Int2FloatLinkedOpenHashMap.MapEntry entry = new Int2FloatLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Int2FloatMap.Entry>)new Int2FloatLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Int2FloatLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Int2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2FloatMap.Entry last() {
/* 1472 */       if (Int2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == 0) return (Int2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[Int2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1487 */       int[] key = Int2FloatLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1490 */       if ((curr = key[pos = HashCommon.mix(k) & Int2FloatLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1491 */       if (k == curr) return (Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1495 */         if (k == curr) return (Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == 0) {
/* 1509 */         if (Int2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[Int2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1510 */           Int2FloatLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       int[] key = Int2FloatLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1519 */       if ((curr = key[pos = HashCommon.mix(k) & Int2FloatLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1522 */           Int2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Float.floatToIntBits(Int2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1531 */           Int2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Int2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Int2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Int2FloatLinkedOpenHashMap.EntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Int2FloatLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Int2FloatLinkedOpenHashMap.FastEntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
/* 1588 */       for (int i = Int2FloatLinkedOpenHashMap.this.size, next = Int2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Int2FloatLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Int2FloatLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Int2FloatLinkedOpenHashMap.MapEntry entry = new Int2FloatLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Int2FloatLinkedOpenHashMap.this.size, next = Int2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Int2FloatLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Int2FloatLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Int2FloatLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1645 */       return Int2FloatLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Int2FloatLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public IntListIterator iterator() {
/* 1659 */       return new Int2FloatLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2FloatLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1675 */       for (int i = Int2FloatLinkedOpenHashMap.this.size, next = Int2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Int2FloatLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Int2FloatLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Int2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1689 */       return Int2FloatLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1694 */       int oldSize = Int2FloatLinkedOpenHashMap.this.size;
/* 1695 */       Int2FloatLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Int2FloatLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Int2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstInt() {
/* 1706 */       if (Int2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Int2FloatLinkedOpenHashMap.this.key[Int2FloatLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public int lastInt() {
/* 1712 */       if (Int2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Int2FloatLinkedOpenHashMap.this.key[Int2FloatLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public IntComparator comparator() {
...
/* 1754 */       return Int2FloatLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Int2FloatLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1771 */       return Int2FloatLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (FloatIterator)new Int2FloatLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Int2FloatLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1798 */             for (int i = Int2FloatLinkedOpenHashMap.this.size, next = Int2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Int2FloatLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Int2FloatLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Int2FloatLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1812 */             return Int2FloatLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Int2FloatLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Int2FloatLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatLinkedOpenHashMap.class
