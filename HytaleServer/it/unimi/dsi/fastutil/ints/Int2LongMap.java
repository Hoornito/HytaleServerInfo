...
/* 150 */     return (ObjectSet)int2LongEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = int2LongEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), Long.valueOf(entry.getLongValue()));
...
/* 502 */     Long newValue = remappingFunction.apply(Integer.valueOf(key), Long.valueOf(oldValue));
...
/* 534 */     Long newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Long.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2LongMap.class
