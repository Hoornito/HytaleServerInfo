...
/*  323 */     int[] key = this.key; while (true) {
/*      */       int curr, last;
...
/*  519 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  532 */     int pos = find(k);
/*  533 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*  611 */       return Int2DoubleOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int leftInt() {
/*  616 */       return Int2DoubleOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  621 */       return Int2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  626 */       return Int2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  631 */       double oldValue = Int2DoubleOpenHashMap.this.value[this.index];
/*  632 */       Int2DoubleOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public IntDoublePair right(double v) {
/*  638 */       Int2DoubleOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  650 */       return Integer.valueOf(Int2DoubleOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Double.valueOf(Int2DoubleOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
/*  680 */       return (Int2DoubleOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Int2DoubleOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Int2DoubleOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Int2DoubleOpenHashMap.this.key[this.index] + "=>" + Int2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Int2DoubleOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Int2DoubleOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Int2DoubleOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Int2DoubleOpenHashMap.this.n;
/*      */       } 
/*  732 */       int[] key = Int2DoubleOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Int2DoubleOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Int2DoubleOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
...
/*  749 */         acceptOnIndex(action, this.last = Int2DoubleOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       int[] key = Int2DoubleOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Int2DoubleOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Int2DoubleOpenHashMap.this.mask);
...
/*  779 */       int[] key = Int2DoubleOpenHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  781 */         pos = (last = pos) + 1 & Int2DoubleOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == 0) {
/*  784 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Int2DoubleOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Int2DoubleOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
/*  792 */           if (this.wrapped == null) this.wrapped = new IntArrayList(2); 
/*  793 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Int2DoubleOpenHashMap.this.value[last] = Int2DoubleOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Int2DoubleOpenHashMap.this.n)
/*  803 */       { Int2DoubleOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Int2DoubleOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Int2DoubleOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Int2DoubleMap.Entry>> implements ObjectIterator<Int2DoubleMap.Entry> { public Int2DoubleOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Int2DoubleOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  834 */       action.accept(this.entry = new Int2DoubleOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Int2DoubleOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Int2DoubleOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Int2DoubleOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Int2DoubleOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       int[] key = Int2DoubleOpenHashMap.this.key;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Int2DoubleOpenHashMap.this.n);
/*      */       } 
/*  914 */       int[] key = Int2DoubleOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Int2DoubleOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Int2DoubleOpenHashMap.this.size - this.c), (long)(Int2DoubleOpenHashMap.this.realSize() / Int2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       int[] key = Int2DoubleOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Int2DoubleMap.Entry> action, int index) {
/*  990 */       action.accept(new Int2DoubleOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Int2DoubleOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Int2DoubleMap.Entry> fastIterator() {
/* 1007 */       return new Int2DoubleOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Int2DoubleMap.Entry> spliterator() {
/* 1012 */       return new Int2DoubleOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1021 */       if (e.getKey() == null || !(e.getKey() instanceof Integer)) return false; 
/* 1022 */       if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1023 */       int k = ((Integer)e.getKey()).intValue();
/* 1024 */       double v = ((Double)e.getValue()).doubleValue();
/* 1025 */       if (k == 0) return (Int2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1027 */       int[] key = Int2DoubleOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Int2DoubleOpenHashMap.this.mask]) == 0) return false; 
/* 1031 */       if (k == curr) return (Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Int2DoubleOpenHashMap.this.mask]) == 0) return false; 
/* 1035 */         if (k == curr) return (Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == 0) {
/* 1049 */         if (Int2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1050 */           Int2DoubleOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       int[] key = Int2DoubleOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Int2DoubleOpenHashMap.this.mask]) == 0) return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1062 */           Int2DoubleOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Int2DoubleOpenHashMap.this.mask]) == 0) return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1071 */           Int2DoubleOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Int2DoubleOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Int2DoubleOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1091 */       if (Int2DoubleOpenHashMap.this.containsNullKey) consumer.accept(new Int2DoubleOpenHashMap.MapEntry(Int2DoubleOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Int2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenHashMap.this.key[pos] != 0) consumer.accept(new Int2DoubleOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1098 */       Int2DoubleOpenHashMap.MapEntry entry = new Int2DoubleOpenHashMap.MapEntry();
/* 1099 */       if (Int2DoubleOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Int2DoubleOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Int2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenHashMap.this.key[pos] != 0) {
...
/* 1134 */       action.accept(Int2DoubleOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1139 */       return Int2DoubleOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1160 */       action.accept(Int2DoubleOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Int2DoubleOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntSpliterator spliterator() {
/* 1177 */       return new Int2DoubleOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1183 */       if (Int2DoubleOpenHashMap.this.containsNullKey) consumer.accept(Int2DoubleOpenHashMap.this.key[Int2DoubleOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Int2DoubleOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         int k = Int2DoubleOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1192 */       return Int2DoubleOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(int k) {
/* 1197 */       return Int2DoubleOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(int k) {
/* 1202 */       int oldSize = Int2DoubleOpenHashMap.this.size;
/* 1203 */       Int2DoubleOpenHashMap.this.remove(k);
/* 1204 */       return (Int2DoubleOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Int2DoubleOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Int2DoubleOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1242 */       return Int2DoubleOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1263 */       action.accept(Int2DoubleOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Int2DoubleOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1282 */             return new Int2DoubleOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1288 */             if (Int2DoubleOpenHashMap.this.containsNullKey) consumer.accept(Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Int2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Int2DoubleOpenHashMap.this.key[pos] != 0) consumer.accept(Int2DoubleOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Int2DoubleOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1299 */             return Int2DoubleOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Int2DoubleOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1368 */     int[] key = this.key;
/* 1369 */     double[] value = this.value;
/* 1370 */     int mask = newN - 1;
/* 1371 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1402 */       c = (Int2DoubleOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleOpenHashMap.class
