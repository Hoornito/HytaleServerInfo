...
/* 150 */     return (ObjectSet)int2CharEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = int2CharEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), Character.valueOf(entry.getCharValue()));
...
/* 502 */     Character newValue = remappingFunction.apply(Integer.valueOf(key), Character.valueOf(oldValue));
...
/* 534 */     Character newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Character.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2CharMap.class
