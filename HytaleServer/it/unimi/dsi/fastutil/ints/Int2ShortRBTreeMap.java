...
/*  839 */       Map.Entry<Integer, Short> e = (Map.Entry<Integer, Short>)o;
/*  840 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Int2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(int k) {
/*  950 */       if ((this.next = Int2ShortRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Int2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Int2ShortRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortRBTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Int2ShortRBTreeMap.Entry f = Int2ShortRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1089 */             Int2ShortRBTreeMap.Entry f = Int2ShortRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1090 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1091 */             Int2ShortRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Int2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Int2ShortRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ShortMap.Entry first() {
/* 1107 */             return Int2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Int2ShortMap.Entry last() {
/* 1112 */             return Int2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1117 */             return Int2ShortRBTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1122 */             return Int2ShortRBTreeMap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1127 */             return Int2ShortRBTreeMap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Int2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1169 */       return new Int2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (ShortIterator)new Int2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1227 */             return Int2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Int2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Int2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Int2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Int2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Int2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ShortRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Int2ShortMap.Entry> comparator() {
/* 1341 */               return Int2ShortRBTreeMap.this.int2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Int2ShortRBTreeMap.Entry f = Int2ShortRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1352 */               return (f != null && Int2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Int2ShortRBTreeMap.Entry f = Int2ShortRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1363 */               if (f != null && Int2ShortRBTreeMap.Submap.this.in(f.key)) Int2ShortRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Int2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Int2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Int2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ShortMap.Entry first() {
/* 1386 */               return Int2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Int2ShortMap.Entry last() {
/* 1391 */               return Int2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1396 */               return Int2ShortRBTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1401 */               return Int2ShortRBTreeMap.Submap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1406 */               return Int2ShortRBTreeMap.Submap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public IntBidirectionalIterator iterator() {
/* 1415 */         return new Int2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1420 */         return new Int2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1435 */               return (ShortIterator)new Int2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1440 */               return Int2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Int2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Int2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1460 */       return (in(k) && Int2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(int k) {
/* 1478 */       int kk = k; Int2ShortRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Int2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(int k, short v) {
/* 1484 */       Int2ShortRBTreeMap.this.modified = false;
...
/* 1486 */       short oldValue = Int2ShortRBTreeMap.this.put(k, v);
/* 1487 */       return Int2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(int k) {
/* 1493 */       Int2ShortRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       short oldValue = Int2ShortRBTreeMap.this.remove(k);
/* 1496 */       return Int2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1517 */       return Int2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap headMap(int to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Int2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap tailMap(int from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Int2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Int2ShortSortedMap subMap(int from, int to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Int2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Int2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Int2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Int2ShortRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Int2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Int2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Int2ShortRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Int2ShortRBTreeMap.Entry e;
/* 1569 */       if (Int2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Int2ShortRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Int2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Int2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Int2ShortRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public int firstIntKey() {
/* 1587 */       Int2ShortRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public int lastIntKey() {
/* 1594 */       Int2ShortRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Int2ShortRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Int2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(int k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Int2ShortRBTreeMap.Submap.this.bottom && Int2ShortRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Int2ShortRBTreeMap.Submap.this.top && Int2ShortRBTreeMap.this.compare(k, (this.prev = Int2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Int2ShortRBTreeMap.this.locateKey(k);
/* 1620 */             if (Int2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Int2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Int2ShortRBTreeMap.this.compare(this.prev.key, Int2ShortRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Int2ShortRBTreeMap.Submap.this.top && this.next != null && Int2ShortRBTreeMap.this.compare(this.next.key, Int2ShortRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Int2ShortRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readInt(), s.readShort());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readInt(), s.readShort());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readInt(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortRBTreeMap.class
