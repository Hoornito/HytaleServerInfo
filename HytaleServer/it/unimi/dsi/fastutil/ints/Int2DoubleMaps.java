...
/*  50 */     return (entries instanceof Int2DoubleMap.FastEntrySet) ? ((Int2DoubleMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Int2DoubleMap.Entry> entries = map.int2DoubleEntrySet();
/*  66 */     if (entries instanceof Int2DoubleMap.FastEntrySet) { ((Int2DoubleMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Int2DoubleMap.Entry> entries = map.int2DoubleEntrySet();
/*  83 */     return (entries instanceof Int2DoubleMap.FastEntrySet) ? new ObjectIterable<Int2DoubleMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Int2DoubleMap.Entry> iterator() {
/*  86 */           return ((Int2DoubleMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Int2DoubleMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Int2DoubleMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractInt2DoubleMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)int2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* 316 */     return new Singleton(key.intValue(), value.doubleValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Int2DoubleFunctions.SynchronizedFunction implements Int2DoubleMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2DoubleEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Double>> entrySet() {
/* 381 */       return (ObjectSet)int2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/*     */     extends Int2DoubleFunctions.UnmodifiableFunction implements Int2DoubleMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2DoubleMap map;
/*     */     protected transient ObjectSet<Int2DoubleMap.Entry> entries;
/*     */     protected transient IntSet keys;
...
/*     */     
/*     */     public ObjectSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2DoubleEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Double>> entrySet() {
/* 712 */       return (ObjectSet)int2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleMaps.class
