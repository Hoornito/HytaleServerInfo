...
/*  50 */     return (entries instanceof Int2CharMap.FastEntrySet) ? ((Int2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Int2CharMap.Entry> entries = map.int2CharEntrySet();
/*  66 */     if (entries instanceof Int2CharMap.FastEntrySet) { ((Int2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Int2CharMap.Entry> entries = map.int2CharEntrySet();
/*  83 */     return (entries instanceof Int2CharMap.FastEntrySet) ? new ObjectIterable<Int2CharMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Int2CharMap.Entry> iterator() {
/*  86 */           return ((Int2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Int2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Int2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractInt2CharMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)int2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* 316 */     return new Singleton(key.intValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Int2CharFunctions.SynchronizedFunction implements Int2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Character>> entrySet() {
/* 381 */       return (ObjectSet)int2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/*     */     extends Int2CharFunctions.UnmodifiableFunction implements Int2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2CharMap map;
/*     */     protected transient ObjectSet<Int2CharMap.Entry> entries;
/*     */     protected transient IntSet keys;
...
/*     */     
/*     */     public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Integer, Character>> entrySet() {
/* 712 */       return (ObjectSet)int2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public IntSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2CharMaps.class
