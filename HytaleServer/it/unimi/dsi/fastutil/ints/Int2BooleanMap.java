...
/* 150 */     return (ObjectSet)int2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = int2BooleanEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Integer.valueOf(entry.getIntKey()), Boolean.valueOf(entry.getBooleanValue()));
...
/* 502 */     Boolean newValue = remappingFunction.apply(Integer.valueOf(key), Boolean.valueOf(oldValue));
...
/* 534 */     Boolean newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
...
/* 604 */       return Integer.valueOf(getIntKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanMap.class
