...
/*  820 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return HashCommon.float2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Float2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  930 */       if ((this.next = Float2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Float2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Float2ObjectRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>>)new Float2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from) {
/* 1046 */             return (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>>)new Float2ObjectRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1056 */             Float2ObjectRBTreeMap.Entry<V> f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1067 */             Float2ObjectRBTreeMap.Entry<V> f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1068 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1069 */             Float2ObjectRBTreeMap.this.remove(f.key);
/* 1070 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1075 */             return Float2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1080 */             Float2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ObjectMap.Entry<V> first() {
/* 1085 */             return Float2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ObjectMap.Entry<V> last() {
/* 1090 */             return Float2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> from, Float2ObjectMap.Entry<V> to) {
/* 1095 */             return Float2ObjectRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> to) {
/* 1100 */             return Float2ObjectRBTreeMap.this.headMap(to.getFloatKey()).float2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from) {
/* 1105 */             return Float2ObjectRBTreeMap.this.tailMap(from.getFloatKey()).float2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1142 */       return new Float2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1147 */       return new Float2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1200 */             return (ObjectIterator<V>)new Float2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1205 */             return Float2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1210 */             return Float2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1215 */             Float2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1277 */       if (!bottom && !top && Float2ObjectRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1278 */       this.from = from;
/* 1279 */       this.bottom = bottom;
/* 1280 */       this.to = to;
/* 1281 */       this.top = top;
/* 1282 */       this.defRetValue = Float2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1301 */       return ((this.bottom || Float2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 1306 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator() {
/* 1309 */               return (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>>)new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from) {
/* 1314 */               return (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>>)new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2ObjectMap.Entry<V>> comparator() {
/* 1319 */               return Float2ObjectRBTreeMap.this.float2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1328 */               Float2ObjectRBTreeMap.Entry<V> f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1329 */               return (f != null && Float2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1338 */               Float2ObjectRBTreeMap.Entry<V> f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1339 */               if (f != null && Float2ObjectRBTreeMap.Submap.this.in(f.key)) Float2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1340 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1345 */               int c = 0;
/* 1346 */               for (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1347 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1352 */               return !(new Float2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1357 */               Float2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ObjectMap.Entry<V> first() {
/* 1362 */               return Float2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ObjectMap.Entry<V> last() {
/* 1367 */               return Float2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> from, Float2ObjectMap.Entry<V> to) {
/* 1372 */               return Float2ObjectRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> to) {
/* 1377 */               return Float2ObjectRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from) {
/* 1382 */               return Float2ObjectRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1391 */         return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1396 */         return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1411 */               return (ObjectIterator<V>)new Float2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1416 */               return Float2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1421 */               return Float2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1426 */               Float2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1436 */       return (in(k) && Float2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(float k) {
/* 1454 */       float kk = k; Float2ObjectRBTreeMap.Entry<V> e;
/* 1455 */       return (in(kk) && (e = Float2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(float k, V v) {
/* 1460 */       Float2ObjectRBTreeMap.this.modified = false;
...
/* 1462 */       V oldValue = Float2ObjectRBTreeMap.this.put(k, v);
/* 1463 */       return Float2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(float k) {
/* 1469 */       Float2ObjectRBTreeMap.this.modified = false;
/* 1470 */       if (!in(k)) return this.defRetValue; 
/* 1471 */       V oldValue = Float2ObjectRBTreeMap.this.remove(k);
/* 1472 */       return Float2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1493 */       return Float2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ObjectSortedMap<V> headMap(float to) {
/* 1498 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1499 */       return (Float2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ObjectSortedMap<V> tailMap(float from) {
/* 1504 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1505 */       return (Float2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ObjectSortedMap<V> subMap(float from, float to) {
/* 1510 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1511 */       if (!this.top) to = (Float2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1512 */       if (!this.bottom) from = (Float2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1523 */       if (Float2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1527 */       if (this.bottom) { e = Float2ObjectRBTreeMap.this.firstEntry; }
/*      */       else
/* 1529 */       { e = Float2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1531 */         if (Float2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1535 */       if (e == null || (!this.top && Float2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1536 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2ObjectRBTreeMap.Entry<V> e;
/* 1545 */       if (Float2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1549 */       if (this.top) { e = Float2ObjectRBTreeMap.this.lastEntry; }
/*      */       else
/* 1551 */       { e = Float2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1553 */         if (Float2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1557 */       if (e == null || (!this.bottom && Float2ObjectRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1558 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1563 */       Float2ObjectRBTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1570 */       Float2ObjectRBTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1586 */         this.next = Float2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1590 */         this();
/* 1591 */         if (this.next != null) {
/* 1592 */           if (!Float2ObjectRBTreeMap.Submap.this.bottom && Float2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1593 */           else if (!Float2ObjectRBTreeMap.Submap.this.top && Float2ObjectRBTreeMap.this.compare(k, (this.prev = Float2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1595 */           { this.next = Float2ObjectRBTreeMap.this.locateKey(k);
/* 1596 */             if (Float2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1607 */         if (!Float2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Float2ObjectRBTreeMap.this.compare(this.prev.key, Float2ObjectRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1612 */         this.next = this.next.next();
/* 1613 */         if (!Float2ObjectRBTreeMap.Submap.this.top && this.next != null && Float2ObjectRBTreeMap.this.compare(this.next.key, Float2ObjectRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1701 */       c = (Float2ObjectRBTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ObjectRBTreeMap.class
