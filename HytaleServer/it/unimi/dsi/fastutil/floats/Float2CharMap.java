...
/* 150 */     return (ObjectSet)float2CharEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2CharEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Character.valueOf(entry.getCharValue()));
...
/* 502 */     Character newValue = remappingFunction.apply(Float.valueOf(key), Character.valueOf(oldValue));
...
/* 534 */     Character newValue = remappingFunction.apply(Float.valueOf(key), contained ? Character.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2CharMap.class
