...
/*  865 */       Map.Entry<Float, Boolean> e = (Map.Entry<Float, Boolean>)o;
/*  866 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  871 */       return HashCommon.float2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  974 */       this.next = Float2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  978 */       if ((this.next = Float2BooleanAVLTreeMap.this.locateKey(k)) != null)
/*  979 */         if (Float2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1032 */       updatePrevious();
/* 1033 */       updateNext();
/* 1034 */       Float2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1035 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1089 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2BooleanMap.Entry>)new AbstractObjectSortedSet<Float2BooleanMap.Entry>()
/*      */         {
...
/* 1099 */             return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1104 */             return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             if (!(e.getKey() instanceof Float)) return false; 
/* 1114 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1115 */             Float2BooleanAVLTreeMap.Entry f = Float2BooleanAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1125 */             if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1126 */             if (!(e.getValue() instanceof Boolean)) return false; 
/* 1127 */             Float2BooleanAVLTreeMap.Entry f = Float2BooleanAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1128 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1129 */             Float2BooleanAVLTreeMap.this.remove(f.key);
/* 1130 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1135 */             return Float2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1140 */             Float2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2BooleanMap.Entry first() {
/* 1145 */             return Float2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2BooleanMap.Entry last() {
/* 1150 */             return Float2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) {
/* 1155 */             return Float2BooleanAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) {
/* 1160 */             return Float2BooleanAVLTreeMap.this.headMap(to.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) {
/* 1165 */             return Float2BooleanAVLTreeMap.this.tailMap(from.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Float2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1207 */       return new Float2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (BooleanIterator)new Float2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1265 */             return Float2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1270 */             return Float2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1275 */             Float2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1288 */     return new Submap(0.0F, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Float2BooleanSortedMap tailMap(float from) {
/* 1293 */     return new Submap(from, false, 0.0F, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1337 */       if (!bottom && !top && Float2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Float2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Float2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2BooleanAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
/* 1366 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2BooleanMap.Entry>)new AbstractObjectSortedSet<Float2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator() {
/* 1369 */               return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2BooleanMap.Entry> comparator() {
/* 1379 */               return Float2BooleanAVLTreeMap.this.float2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1387 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1389 */               Float2BooleanAVLTreeMap.Entry f = Float2BooleanAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1390 */               return (f != null && Float2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1398 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1399 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1400 */               Float2BooleanAVLTreeMap.Entry f = Float2BooleanAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1401 */               if (f != null && Float2BooleanAVLTreeMap.Submap.this.in(f.key)) Float2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1402 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1407 */               int c = 0;
/* 1408 */               for (ObjectBidirectionalIterator<Float2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1409 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1414 */               return !(new Float2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1419 */               Float2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2BooleanMap.Entry first() {
/* 1424 */               return Float2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2BooleanMap.Entry last() {
/* 1429 */               return Float2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) {
/* 1434 */               return Float2BooleanAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) {
/* 1439 */               return Float2BooleanAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) {
/* 1444 */               return Float2BooleanAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1453 */         return new Float2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1458 */         return new Float2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1473 */               return (BooleanIterator)new Float2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1478 */               return Float2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1483 */               return Float2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1488 */               Float2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1498 */       return (in(k) && Float2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(float k) {
/* 1516 */       float kk = k; Float2BooleanAVLTreeMap.Entry e;
/* 1517 */       return (in(kk) && (e = Float2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(float k, boolean v) {
/* 1522 */       Float2BooleanAVLTreeMap.this.modified = false;
...
/* 1524 */       boolean oldValue = Float2BooleanAVLTreeMap.this.put(k, v);
/* 1525 */       return Float2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1531 */       Float2BooleanAVLTreeMap.this.modified = false;
/* 1532 */       if (!in(k)) return this.defRetValue; 
/* 1533 */       boolean oldValue = Float2BooleanAVLTreeMap.this.remove(k);
/* 1534 */       return Float2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1555 */       return Float2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap headMap(float to) {
/* 1560 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1561 */       return (Float2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap tailMap(float from) {
/* 1566 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1567 */       return (Float2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap subMap(float from, float to) {
/* 1572 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1573 */       if (!this.top) to = (Float2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1574 */       if (!this.bottom) from = (Float2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1585 */       if (Float2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1589 */       if (this.bottom) { e = Float2BooleanAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1591 */       { e = Float2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1593 */         if (Float2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1597 */       if (e == null || (!this.top && Float2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1598 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2BooleanAVLTreeMap.Entry e;
/* 1607 */       if (Float2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1611 */       if (this.top) { e = Float2BooleanAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1613 */       { e = Float2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1615 */         if (Float2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1619 */       if (e == null || (!this.bottom && Float2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1620 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1625 */       Float2BooleanAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1632 */       Float2BooleanAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1648 */         this.next = Float2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1652 */         this();
/* 1653 */         if (this.next != null) {
/* 1654 */           if (!Float2BooleanAVLTreeMap.Submap.this.bottom && Float2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1655 */           else if (!Float2BooleanAVLTreeMap.Submap.this.top && Float2BooleanAVLTreeMap.this.compare(k, (this.prev = Float2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1657 */           { this.next = Float2BooleanAVLTreeMap.this.locateKey(k);
/* 1658 */             if (Float2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1669 */         if (!Float2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Float2BooleanAVLTreeMap.this.compare(this.prev.key, Float2BooleanAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1674 */         this.next = this.next.next();
/* 1675 */         if (!Float2BooleanAVLTreeMap.Submap.this.top && this.next != null && Float2BooleanAVLTreeMap.this.compare(this.next.key, Float2BooleanAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1763 */       c = (Float2BooleanAVLTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readFloat(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readFloat(), s.readBoolean());
/* 1846 */       entry.right(new Entry(s.readFloat(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanAVLTreeMap.class
