...
/*  61 */     return (entries instanceof Float2ObjectSortedMap.FastSortedEntrySet) ? ((Float2ObjectSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Float2ObjectMap.Entry<V>> entries = map.float2ObjectEntrySet();
/*  77 */     Objects.requireNonNull((Float2ObjectSortedMap.FastSortedEntrySet)entries); return (entries instanceof Float2ObjectSortedMap.FastSortedEntrySet) ? (Float2ObjectSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Float2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 121 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 133 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 251 */       if (this.entries == null) this.entries = (ObjectSet<Float2ObjectMap.Entry<V>>)ObjectSortedSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(this.key, this.value), Float2ObjectSortedMaps.entryComparator(this.comparator)); 
/* 252 */       return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/* 264 */       return (ObjectSortedSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/* 277 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 284 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 291 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public float firstFloatKey() {
...
/*     */     extends Float2ObjectMaps.SynchronizedMap<V> implements Float2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 446 */       if (this.entries == null) this.entries = (ObjectSet<Float2ObjectMap.Entry<V>>)ObjectSortedSets.synchronize(this.sortedMap.float2ObjectEntrySet(), this.sync); 
/* 447 */       return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/* 459 */       return (ObjectSortedSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/*     */     extends Float2ObjectMaps.UnmodifiableMap<V> implements Float2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 599 */       if (this.entries == null) this.entries = (ObjectSet<Float2ObjectMap.Entry<V>>)ObjectSortedSets.unmodifiable(this.sortedMap.float2ObjectEntrySet()); 
/* 600 */       return (ObjectSortedSet<Float2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/* 612 */       return (ObjectSortedSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ObjectSortedMaps.class
