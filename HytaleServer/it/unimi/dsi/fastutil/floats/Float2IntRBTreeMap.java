...
/*  839 */       Map.Entry<Float, Integer> e = (Map.Entry<Float, Integer>)o;
/*  840 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Float2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  950 */       if ((this.next = Float2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Float2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Float2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2IntMap.Entry>)new AbstractObjectSortedSet<Float2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Float2IntRBTreeMap.Entry f = Float2IntRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1089 */             Float2IntRBTreeMap.Entry f = Float2IntRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Float2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Float2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Float2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2IntMap.Entry first() {
/* 1107 */             return Float2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2IntMap.Entry last() {
/* 1112 */             return Float2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry from, Float2IntMap.Entry to) {
/* 1117 */             return Float2IntRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry to) {
/* 1122 */             return Float2IntRBTreeMap.this.headMap(to.getFloatKey()).float2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry from) {
/* 1127 */             return Float2IntRBTreeMap.this.tailMap(from.getFloatKey()).float2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Float2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1169 */       return new Float2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (IntIterator)new Float2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Float2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Float2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Float2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Float2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Float2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Float2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2IntMap.Entry>)new AbstractObjectSortedSet<Float2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2IntMap.Entry> comparator() {
/* 1341 */               return Float2IntRBTreeMap.this.float2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Float2IntRBTreeMap.Entry f = Float2IntRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1352 */               return (f != null && Float2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Float2IntRBTreeMap.Entry f = Float2IntRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1363 */               if (f != null && Float2IntRBTreeMap.Submap.this.in(f.key)) Float2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Float2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Float2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Float2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2IntMap.Entry first() {
/* 1386 */               return Float2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2IntMap.Entry last() {
/* 1391 */               return Float2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry from, Float2IntMap.Entry to) {
/* 1396 */               return Float2IntRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry to) {
/* 1401 */               return Float2IntRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry from) {
/* 1406 */               return Float2IntRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2IntEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractFloat2IntSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1415 */         return new Float2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1420 */         return new Float2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Float2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Float2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Float2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Float2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1460 */       return (in(k) && Float2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(float k) {
/* 1478 */       float kk = k; Float2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Float2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(float k, int v) {
/* 1484 */       Float2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Float2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Float2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(float k) {
/* 1493 */       Float2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Float2IntRBTreeMap.this.remove(k);
/* 1496 */       return Float2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1517 */       return Float2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntSortedMap headMap(float to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Float2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntSortedMap tailMap(float from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Float2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntSortedMap subMap(float from, float to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Float2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Float2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Float2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Float2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Float2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Float2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Float2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2IntRBTreeMap.Entry e;
/* 1569 */       if (Float2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Float2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Float2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Float2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Float2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1587 */       Float2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1594 */       Float2IntRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Float2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Float2IntRBTreeMap.Submap.this.bottom && Float2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Float2IntRBTreeMap.Submap.this.top && Float2IntRBTreeMap.this.compare(k, (this.prev = Float2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Float2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Float2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Float2IntRBTreeMap.Submap.this.bottom && this.prev != null && Float2IntRBTreeMap.this.compare(this.prev.key, Float2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Float2IntRBTreeMap.Submap.this.top && this.next != null && Float2IntRBTreeMap.this.compare(this.next.key, Float2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Float2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Float2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readFloat(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readFloat(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readFloat(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2IntRBTreeMap.class
