...
/*  49 */     return (entries instanceof Float2ObjectMap.FastEntrySet) ? ((Float2ObjectMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  64 */     ObjectSet<Float2ObjectMap.Entry<V>> entries = map.float2ObjectEntrySet();
/*  65 */     if (entries instanceof Float2ObjectMap.FastEntrySet) { ((Float2ObjectMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  81 */     final ObjectSet<Float2ObjectMap.Entry<V>> entries = map.float2ObjectEntrySet();
/*  82 */     return (entries instanceof Float2ObjectMap.FastEntrySet) ? new ObjectIterable<Float2ObjectMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() {
/*  85 */           return ((Float2ObjectMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  95 */           ((Float2ObjectMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  97 */       } : (ObjectIterable<Float2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 135 */       return (ObjectSet<Float2ObjectMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 140 */       return FloatSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 155 */       return Float2ObjectMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 227 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(this.key, this.value)); 
...
/* 240 */       return (ObjectSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 245 */       if (this.keys == null) this.keys = FloatSets.singleton(this.key); 
...
/*     */     
/*     */     public int hashCode() {
/* 262 */       return HashCommon.float2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */   
/*     */   public static <V> Float2ObjectMap<V> singleton(Float key, V value) {
/* 307 */     return new Singleton<>(key.floatValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Float2ObjectFunctions.SynchronizedFunction<V> implements Float2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 345 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.float2ObjectEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, V>> entrySet() {
/* 359 */       return (ObjectSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 364 */       synchronized (this.sync) {
/* 365 */         if (this.keys == null) this.keys = FloatSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Float2ObjectFunctions.UnmodifiableFunction<V> implements Float2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 659 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.float2ObjectEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, V>> entrySet() {
/* 672 */       return (ObjectSet)float2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 677 */       if (this.keys == null) this.keys = FloatSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ObjectMaps.class
