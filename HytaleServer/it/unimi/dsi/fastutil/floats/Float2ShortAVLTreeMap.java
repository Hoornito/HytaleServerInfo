...
/*  885 */       Map.Entry<Float, Short> e = (Map.Entry<Float, Short>)o;
/*  886 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.float2int(this.key) ^ this.value;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Float2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  998 */       if ((this.next = Float2ShortAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Float2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Float2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2ShortMap.Entry>)new AbstractObjectSortedSet<Float2ShortMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Float2ShortMap.Entry>)new Float2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Float2ShortMap.Entry>)new Float2ShortAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Float2ShortAVLTreeMap.Entry f = Float2ShortAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1147 */             Float2ShortAVLTreeMap.Entry f = Float2ShortAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1148 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1149 */             Float2ShortAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Float2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Float2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ShortMap.Entry first() {
/* 1165 */             return Float2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ShortMap.Entry last() {
/* 1170 */             return Float2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry from, Float2ShortMap.Entry to) {
/* 1175 */             return Float2ShortAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry to) {
/* 1180 */             return Float2ShortAVLTreeMap.this.headMap(to.getFloatKey()).float2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry from) {
/* 1185 */             return Float2ShortAVLTreeMap.this.tailMap(from.getFloatKey()).float2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Float2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1227 */       return new Float2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ShortIterator)new Float2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1285 */             return Float2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Float2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Float2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Float2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Float2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Float2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2ShortMap.Entry>)new AbstractObjectSortedSet<Float2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Float2ShortMap.Entry>)new Float2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Float2ShortMap.Entry>)new Float2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2ShortMap.Entry> comparator() {
/* 1399 */               return Float2ShortAVLTreeMap.this.float2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Float2ShortAVLTreeMap.Entry f = Float2ShortAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1410 */               return (f != null && Float2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Float2ShortAVLTreeMap.Entry f = Float2ShortAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1421 */               if (f != null && Float2ShortAVLTreeMap.Submap.this.in(f.key)) Float2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Float2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Float2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Float2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ShortMap.Entry first() {
/* 1444 */               return Float2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ShortMap.Entry last() {
/* 1449 */               return Float2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry from, Float2ShortMap.Entry to) {
/* 1454 */               return Float2ShortAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry to) {
/* 1459 */               return Float2ShortAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry from) {
/* 1464 */               return Float2ShortAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ShortEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractFloat2ShortSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1473 */         return new Float2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1478 */         return new Float2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1493 */               return (ShortIterator)new Float2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1498 */               return Float2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Float2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Float2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1518 */       return (in(k) && Float2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(float k) {
/* 1536 */       float kk = k; Float2ShortAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Float2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(float k, short v) {
/* 1542 */       Float2ShortAVLTreeMap.this.modified = false;
...
/* 1544 */       short oldValue = Float2ShortAVLTreeMap.this.put(k, v);
/* 1545 */       return Float2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(float k) {
/* 1551 */       Float2ShortAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       short oldValue = Float2ShortAVLTreeMap.this.remove(k);
/* 1554 */       return Float2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1575 */       return Float2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortSortedMap headMap(float to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Float2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortSortedMap tailMap(float from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Float2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortSortedMap subMap(float from, float to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Float2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Float2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Float2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Float2ShortAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Float2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Float2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Float2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2ShortAVLTreeMap.Entry e;
/* 1627 */       if (Float2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Float2ShortAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Float2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Float2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Float2ShortAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1645 */       Float2ShortAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1652 */       Float2ShortAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Float2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Float2ShortAVLTreeMap.Submap.this.bottom && Float2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Float2ShortAVLTreeMap.Submap.this.top && Float2ShortAVLTreeMap.this.compare(k, (this.prev = Float2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Float2ShortAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Float2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Float2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Float2ShortAVLTreeMap.this.compare(this.prev.key, Float2ShortAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Float2ShortAVLTreeMap.Submap.this.top && this.next != null && Float2ShortAVLTreeMap.this.compare(this.next.key, Float2ShortAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Float2ShortMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Float2ShortAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readFloat(), s.readShort());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readFloat(), s.readShort());
/* 1866 */       entry.right(new Entry(s.readFloat(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ShortAVLTreeMap.class
