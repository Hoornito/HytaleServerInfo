...
/*  306 */     float[] key = this.key; while (true) {
/*      */       float curr; int last;
/*  308 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  310 */         if (Float.floatToIntBits(curr = key[pos]) == 0) {
/*  311 */           key[last] = 0.0F;
/*      */           return;
/*      */         } 
...
/*  326 */     if (this.strategy.equals(k, 0.0F)) {
/*  327 */       if (this.containsNullKey) return removeNullEntry(); 
/*  328 */       return this.defRetValue;
/*      */     } 
/*      */     
/*  331 */     float[] key = this.key;
/*      */     float curr;
/*      */     int pos;
/*  334 */     if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0) return this.defRetValue; 
/*  335 */     if (this.strategy.equals(k, curr)) return removeEntry(pos); 
/*      */     while (true) {
/*  337 */       if (Float.floatToIntBits(curr = key[pos = pos + 1 & this.mask]) == 0) return this.defRetValue; 
...
/*  345 */     if (this.strategy.equals(k, 0.0F)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  347 */     float[] key = this.key;
/*      */     float curr;
/*      */     int pos;
/*  350 */     if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0) return this.defRetValue; 
...
/*  362 */     if (this.strategy.equals(k, 0.0F)) return this.containsNullKey;
/*      */     
/*  364 */     float[] key = this.key;
/*      */     float curr;
/*      */     int pos;
/*  367 */     if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0) return false; 
/*  368 */     if (this.strategy.equals(k, curr)) return true;
/*      */     
/*      */     while (true) {
/*  371 */       if (Float.floatToIntBits(curr = key[pos = pos + 1 & this.mask]) == 0) return false; 
...
/*  379 */     float[] key = this.key;
/*  380 */     if (this.containsNullKey && value[this.n] == v) return true; 
/*  381 */     for (int i = this.n; i-- != 0;) { if (Float.floatToIntBits(key[i]) != 0 && value[i] == v) return true;  }
/*  382 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  389 */     if (this.strategy.equals(k, 0.0F)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  391 */     float[] key = this.key;
/*      */     float curr;
/*      */     int pos;
/*  394 */     if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0) return defaultValue; 
/*  395 */     if (this.strategy.equals(k, curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  398 */       if (Float.floatToIntBits(curr = key[pos = pos + 1 & this.mask]) == 0) return defaultValue; 
...
/*  416 */     if (this.strategy.equals(k, 0.0F)) {
...
/*      */     } 
/*      */     
/*  424 */     float[] key = this.key;
/*      */     float curr;
/*      */     int pos;
/*  427 */     if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0) return false; 
/*  428 */     if (this.strategy.equals(k, curr) && v == this.value[pos]) {
/*  429 */       removeEntry(pos);
/*  430 */       return true;
/*      */     } 
/*      */     while (true) {
/*  433 */       if (Float.floatToIntBits(curr = key[pos = pos + 1 & this.mask]) == 0) return false; 
...
/*  502 */     Boolean newValue = remappingFunction.apply(Float.valueOf(k), Boolean.valueOf(this.value[pos]));
/*  503 */     if (newValue == null) {
/*  504 */       if (this.strategy.equals(k, 0.0F)) { removeNullEntry(); }
...
/*  515 */     int pos = find(k);
/*  516 */     Boolean newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
/*  517 */     if (newValue == null) {
/*  518 */       if (pos >= 0)
/*  519 */         if (this.strategy.equals(k, 0.0F)) { removeNullEntry(); }
...
/*  594 */       return Float2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  599 */       return Float2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  604 */       return Float2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  609 */       return Float2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  614 */       boolean oldValue = Float2BooleanOpenCustomHashMap.this.value[this.index];
/*  615 */       Float2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  616 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBooleanPair right(boolean v) {
/*  621 */       Float2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  622 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  633 */       return Float.valueOf(Float2BooleanOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  644 */       return Boolean.valueOf(Float2BooleanOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       Map.Entry<Float, Boolean> e = (Map.Entry<Float, Boolean>)o;
/*  663 */       return (Float2BooleanOpenCustomHashMap.this.strategy.equals(Float2BooleanOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  668 */       return Float2BooleanOpenCustomHashMap.this.strategy.hashCode(Float2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Float2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  673 */       return Float2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Float2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  684 */     int pos = Float2BooleanOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  690 */     int last = -1;
/*      */     
/*  692 */     int c = Float2BooleanOpenCustomHashMap.this.size;
/*      */     
/*  694 */     boolean mustReturnNullKey = Float2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  713 */         return this.last = Float2BooleanOpenCustomHashMap.this.n;
/*      */       } 
/*  715 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  717 */         if (--this.pos < 0) {
/*      */           
/*  719 */           this.last = Integer.MIN_VALUE;
/*  720 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  721 */           int p = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Float2BooleanOpenCustomHashMap.this.mask;
/*  722 */           for (; !Float2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2BooleanOpenCustomHashMap.this.mask);
/*  723 */           return p;
/*      */         } 
/*  725 */         if (Float.floatToIntBits(key[this.pos]) != 0) return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  732 */         acceptOnIndex(action, this.last = Float2BooleanOpenCustomHashMap.this.n);
/*  733 */         this.c--;
/*      */       } 
/*  735 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*  736 */       while (this.c != 0) {
/*  737 */         if (--this.pos < 0) {
/*      */           
/*  739 */           this.last = Integer.MIN_VALUE;
/*  740 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  741 */           int p = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Float2BooleanOpenCustomHashMap.this.mask;
/*  742 */           for (; !Float2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2BooleanOpenCustomHashMap.this.mask);
/*  743 */           acceptOnIndex(action, p);
/*  744 */           this.c--; continue;
/*  745 */         }  if (Float.floatToIntBits(key[this.pos]) != 0) {
...
/*  762 */       float[] key = Float2BooleanOpenCustomHashMap.this.key; while (true) {
/*      */         float curr; int last;
/*  764 */         pos = (last = pos) + 1 & Float2BooleanOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if (Float.floatToIntBits(curr = key[pos]) == 0) {
/*  767 */             key[last] = 0.0F;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2BooleanOpenCustomHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  772 */             break;  pos = pos + 1 & Float2BooleanOpenCustomHashMap.this.mask;
/*      */         } 
/*  774 */         if (pos < last) {
/*  775 */           if (this.wrapped == null) this.wrapped = new FloatArrayList(2); 
/*  776 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  778 */         key[last] = curr;
/*  779 */         Float2BooleanOpenCustomHashMap.this.value[last] = Float2BooleanOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  784 */       if (this.last == -1) throw new IllegalStateException(); 
/*  785 */       if (this.last == Float2BooleanOpenCustomHashMap.this.n)
/*  786 */       { Float2BooleanOpenCustomHashMap.this.containsNullKey = false; }
/*  787 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  790 */       { Float2BooleanOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 1));
/*  791 */         this.last = -1;
/*      */         return; }
/*      */       
/*  794 */       Float2BooleanOpenCustomHashMap.this.size--;
/*  795 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2BooleanMap.Entry>> implements ObjectIterator<Float2BooleanMap.Entry> { public Float2BooleanOpenCustomHashMap.MapEntry next() {
/*  811 */       return this.entry = new Float2BooleanOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  817 */       action.accept(this.entry = new Float2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  828 */       this.entry = new Float2BooleanOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  849 */     int pos = 0;
/*      */     
/*  851 */     int max = Float2BooleanOpenCustomHashMap.this.n;
/*      */     
/*  853 */     int c = 0;
/*      */     
/*  855 */     boolean mustReturnNull = Float2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  875 */         this.c++;
/*  876 */         acceptOnIndex(action, Float2BooleanOpenCustomHashMap.this.n);
/*  877 */         return true;
/*      */       } 
/*  879 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*  880 */       while (this.pos < this.max) {
/*  881 */         if (Float.floatToIntBits(key[this.pos]) != 0) {
/*  882 */           this.c++;
...
/*  894 */         this.c++;
/*  895 */         acceptOnIndex(action, Float2BooleanOpenCustomHashMap.this.n);
/*      */       } 
/*  897 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
...
/*      */       {
/*  910 */         return (Float2BooleanOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  915 */       return Math.min((Float2BooleanOpenCustomHashMap.this.size - this.c), (long)(Float2BooleanOpenCustomHashMap.this.realSize() / Float2BooleanOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  943 */         n--;
/*      */       } 
/*  945 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*  946 */       while (this.pos < this.max && n > 0L) {
/*  947 */         if (Float.floatToIntBits(key[this.pos++]) != 0) {
/*  948 */           skipped++;
/*  949 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Float2BooleanMap.Entry> action, int index) {
/*  973 */       action.accept(new Float2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  985 */       return new Float2BooleanOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Float2BooleanMap.Entry> fastIterator() {
/*  990 */       return new Float2BooleanOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Float2BooleanMap.Entry> spliterator() {
/*  995 */       return new Float2BooleanOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1008 */       if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0F)) return (Float2BooleanOpenCustomHashMap.this.containsNullKey && Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n] == v);
/*      */       
/* 1010 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1013 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Float2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1014 */       if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1017 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1018 */         if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1027 */       if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1028 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1029 */       float k = ((Float)e.getKey()).floatValue();
/* 1030 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1031 */       if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
/* 1032 */         if (Float2BooleanOpenCustomHashMap.this.containsNullKey && Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n] == v) {
/* 1033 */           Float2BooleanOpenCustomHashMap.this.removeNullEntry();
/* 1034 */           return true;
/*      */         } 
/* 1036 */         return false;
/*      */       } 
/*      */       
/* 1039 */       float[] key = Float2BooleanOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1042 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Float2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1043 */       if (Float2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1044 */         if (Float2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1045 */           Float2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1046 */           return true;
/*      */         } 
/* 1048 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1051 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1052 */         if (Float2BooleanOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1053 */           Float2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1054 */           Float2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1055 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1063 */       return Float2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1068 */       Float2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
/* 1074 */       if (Float2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(new Float2BooleanOpenCustomHashMap.MapEntry(Float2BooleanOpenCustomHashMap.this.n)); 
/* 1075 */       for (int pos = Float2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(new Float2BooleanOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
/* 1081 */       Float2BooleanOpenCustomHashMap.MapEntry entry = new Float2BooleanOpenCustomHashMap.MapEntry();
/* 1082 */       if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
/* 1083 */         entry.index = Float2BooleanOpenCustomHashMap.this.n;
/* 1084 */         consumer.accept(entry);
/*      */       } 
/* 1086 */       for (int pos = Float2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[pos]) != 0) {
...
/* 1117 */       action.accept(Float2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1122 */       return Float2BooleanOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1143 */       action.accept(Float2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1155 */       return new Float2BooleanOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSpliterator spliterator() {
/* 1160 */       return new Float2BooleanOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1166 */       if (Float2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n]); 
/* 1167 */       for (int pos = Float2BooleanOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1168 */         float k = Float2BooleanOpenCustomHashMap.this.key[pos];
/* 1169 */         if (Float.floatToIntBits(k) != 0) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1175 */       return Float2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1180 */       return Float2BooleanOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1185 */       int oldSize = Float2BooleanOpenCustomHashMap.this.size;
/* 1186 */       Float2BooleanOpenCustomHashMap.this.remove(k);
/* 1187 */       return (Float2BooleanOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1192 */       Float2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1220 */       action.accept(Float2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1225 */       return Float2BooleanOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1246 */       action.accept(Float2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1260 */             return new Float2BooleanOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1265 */             return new Float2BooleanOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1271 */             if (Float2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n]); 
/* 1272 */             for (int pos = Float2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(Float2BooleanOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1277 */             return Float2BooleanOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1282 */             return Float2BooleanOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1287 */             Float2BooleanOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1351 */     float[] key = this.key;
/* 1352 */     boolean[] value = this.value;
/* 1353 */     int mask = newN - 1;
/* 1354 */     float[] newKey = new float[newN + 1];
/* 1355 */     boolean[] newValue = new boolean[newN + 1];
/* 1356 */     int i = this.n;
/* 1357 */     for (int j = realSize(); j-- != 0; ) {
/* 1358 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1359 */       if (Float.floatToIntBits(newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0) while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
...
/*      */     try {
/* 1385 */       c = (Float2BooleanOpenCustomHashMap)super.clone();
...
/* 1393 */     c.key = (float[])this.key.clone();
...
/* 1412 */       for (; Float.floatToIntBits(this.key[i]) == 0; i++);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanOpenCustomHashMap.class
