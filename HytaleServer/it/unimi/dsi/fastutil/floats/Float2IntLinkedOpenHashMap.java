...
/*  853 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  866 */     int pos = find(k);
/*  867 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*  946 */       return Float2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  951 */       return Float2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  956 */       return Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  961 */       return Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  966 */       int oldValue = Float2IntLinkedOpenHashMap.this.value[this.index];
/*  967 */       Float2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatIntPair right(int v) {
/*  973 */       Float2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  985 */       return Float.valueOf(Float2IntLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Integer.valueOf(Float2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Float, Integer> e = (Map.Entry<Float, Integer>)o;
/* 1015 */       return (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return HashCommon.float2int(Float2IntLinkedOpenHashMap.this.key[this.index]) ^ Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Float2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Float2IntLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(float from) {
/* 1198 */       if (Float.floatToIntBits(from) == 0) {
/* 1199 */         if (Float2IntLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Float2IntLinkedOpenHashMap.this.link[Float2IntLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Float2IntLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last]) == Float.floatToIntBits(from)) {
/* 1206 */         this.prev = Float2IntLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Float2IntLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2IntLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) != 0) {
/* 1214 */         if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) == Float.floatToIntBits(from)) {
/*      */           
/* 1216 */           this.next = (int)Float2IntLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Float2IntLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Float2IntLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Float2IntLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Float2IntLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Float2IntLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Float2IntLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Float2IntLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Float2IntLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Float2IntLinkedOpenHashMap.this.link[this.prev] = Float2IntLinkedOpenHashMap.this.link[this.prev] ^ (Float2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Float2IntLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Float2IntLinkedOpenHashMap.this.link[this.next] = Float2IntLinkedOpenHashMap.this.link[this.next] ^ (Float2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Float2IntLinkedOpenHashMap.this.n) {
/* 1308 */         Float2IntLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         float[] key = Float2IntLinkedOpenHashMap.this.key; while (true) {
/*      */           float curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if (Float.floatToIntBits(curr = key[pos]) == 0) {
/* 1317 */               key[last] = 0.0F;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2IntLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Float2IntLinkedOpenHashMap.this.value[last] = Float2IntLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Float2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2IntMap.Entry>> implements ObjectListIterator<Float2IntMap.Entry> {
...
/* 1367 */       action.accept(new Float2IntLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Float2IntMap.Entry>> implements ObjectListIterator<Float2IntMap.Entry> {
/* 1388 */     final Float2IntLinkedOpenHashMap.MapEntry entry = new Float2IntLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Float2IntLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2IntMap.Entry last() {
/* 1471 */       if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1484 */       if (Float.floatToIntBits(k) == 0) return (Float2IntLinkedOpenHashMap.this.containsNullKey && Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       float[] key = Float2IntLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1489 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1490 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1494 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */         if (Float2IntLinkedOpenHashMap.this.containsNullKey && Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Float2IntLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       float[] key = Float2IntLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1518 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1519 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1520 */         if (Float2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Float2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1528 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1529 */           Float2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Float2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Float2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Float2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Float2IntLinkedOpenHashMap.EntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Float2IntLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Float2IntLinkedOpenHashMap.FastEntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
/* 1587 */       for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Float2IntLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Float2IntLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Float2IntLinkedOpenHashMap.MapEntry entry = new Float2IntLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Float2IntLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Float2IntLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Float2IntLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1644 */       return Float2IntLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Float2IntLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatListIterator iterator() {
/* 1658 */       return new Float2IntLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2IntLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1674 */       for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Float2IntLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Float2IntLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Float2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1688 */       return Float2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1693 */       int oldSize = Float2IntLinkedOpenHashMap.this.size;
/* 1694 */       Float2IntLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Float2IntLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Float2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloat() {
/* 1705 */       if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public float lastFloat() {
/* 1711 */       if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatComparator comparator() {
...
/* 1753 */       return Float2IntLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Float2IntLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1770 */       return Float2IntLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (IntIterator)new Float2IntLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2IntLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1797 */             for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Float2IntLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Float2IntLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Float2IntLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1811 */             return Float2IntLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Float2IntLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1936 */       c = (Float2IntLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2IntLinkedOpenHashMap.class
