...
/*  839 */       Map.Entry<Float, Long> e = (Map.Entry<Float, Long>)o;
/*  840 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return HashCommon.float2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Float2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  950 */       if ((this.next = Float2LongRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Float2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Float2LongRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2LongMap.Entry>)new AbstractObjectSortedSet<Float2LongMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Float2LongRBTreeMap.Entry f = Float2LongRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1089 */             Float2LongRBTreeMap.Entry f = Float2LongRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1090 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1091 */             Float2LongRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Float2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Float2LongRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2LongMap.Entry first() {
/* 1107 */             return Float2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2LongMap.Entry last() {
/* 1112 */             return Float2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) {
/* 1117 */             return Float2LongRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) {
/* 1122 */             return Float2LongRBTreeMap.this.headMap(to.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) {
/* 1127 */             return Float2LongRBTreeMap.this.tailMap(from.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Float2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1169 */       return new Float2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (LongIterator)new Float2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1227 */             return Float2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Float2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Float2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Float2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Float2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Float2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2LongRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2LongMap.Entry>)new AbstractObjectSortedSet<Float2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2LongMap.Entry> comparator() {
/* 1341 */               return Float2LongRBTreeMap.this.float2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Float2LongRBTreeMap.Entry f = Float2LongRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1352 */               return (f != null && Float2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Float2LongRBTreeMap.Entry f = Float2LongRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1363 */               if (f != null && Float2LongRBTreeMap.Submap.this.in(f.key)) Float2LongRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Float2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Float2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Float2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2LongMap.Entry first() {
/* 1386 */               return Float2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2LongMap.Entry last() {
/* 1391 */               return Float2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) {
/* 1396 */               return Float2LongRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) {
/* 1401 */               return Float2LongRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) {
/* 1406 */               return Float2LongRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractFloat2LongSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1415 */         return new Float2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1420 */         return new Float2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public LongIterator iterator() {
/* 1435 */               return (LongIterator)new Float2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1440 */               return Float2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Float2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Float2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1460 */       return (in(k) && Float2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(float k) {
/* 1478 */       float kk = k; Float2LongRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Float2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(float k, long v) {
/* 1484 */       Float2LongRBTreeMap.this.modified = false;
...
/* 1486 */       long oldValue = Float2LongRBTreeMap.this.put(k, v);
/* 1487 */       return Float2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(float k) {
/* 1493 */       Float2LongRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       long oldValue = Float2LongRBTreeMap.this.remove(k);
/* 1496 */       return Float2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1517 */       return Float2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap headMap(float to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Float2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap tailMap(float from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Float2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap subMap(float from, float to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Float2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Float2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Float2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Float2LongRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Float2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Float2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Float2LongRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2LongRBTreeMap.Entry e;
/* 1569 */       if (Float2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Float2LongRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Float2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Float2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Float2LongRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1587 */       Float2LongRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1594 */       Float2LongRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Float2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Float2LongRBTreeMap.Submap.this.bottom && Float2LongRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Float2LongRBTreeMap.Submap.this.top && Float2LongRBTreeMap.this.compare(k, (this.prev = Float2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Float2LongRBTreeMap.this.locateKey(k);
/* 1620 */             if (Float2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Float2LongRBTreeMap.Submap.this.bottom && this.prev != null && Float2LongRBTreeMap.this.compare(this.prev.key, Float2LongRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Float2LongRBTreeMap.Submap.this.top && this.next != null && Float2LongRBTreeMap.this.compare(this.next.key, Float2LongRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Float2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Float2LongRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readFloat(), s.readLong());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readFloat(), s.readLong());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readFloat(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2LongRBTreeMap.class
