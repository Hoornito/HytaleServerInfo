...
/*      */ 
/*      */ 
/*      */ public class Float2ByteRBTreeMap
...
/*  839 */       Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
/*  840 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Float2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  950 */       if ((this.next = Float2ByteRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Float2ByteRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1089 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1090 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1091 */             Float2ByteRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Float2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Float2ByteRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ByteMap.Entry first() {
/* 1107 */             return Float2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ByteMap.Entry last() {
/* 1112 */             return Float2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1117 */             return Float2ByteRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1122 */             return Float2ByteRBTreeMap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1127 */             return Float2ByteRBTreeMap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Float2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1169 */       return new Float2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (ByteIterator)new Float2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1227 */             return Float2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Float2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Float2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Float2ByteRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Float2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Float2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ByteRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2ByteMap.Entry> comparator() {
/* 1341 */               return Float2ByteRBTreeMap.this.float2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1352 */               return (f != null && Float2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1363 */               if (f != null && Float2ByteRBTreeMap.Submap.this.in(f.key)) Float2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Float2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Float2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Float2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ByteMap.Entry first() {
/* 1386 */               return Float2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ByteMap.Entry last() {
/* 1391 */               return Float2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1396 */               return Float2ByteRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1401 */               return Float2ByteRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1406 */               return Float2ByteRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1415 */         return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1420 */         return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1435 */               return (ByteIterator)new Float2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1440 */               return Float2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Float2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Float2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1460 */       return (in(k) && Float2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(float k) {
/* 1478 */       float kk = k; Float2ByteRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Float2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(float k, byte v) {
/* 1484 */       Float2ByteRBTreeMap.this.modified = false;
...
/* 1486 */       byte oldValue = Float2ByteRBTreeMap.this.put(k, v);
/* 1487 */       return Float2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(float k) {
/* 1493 */       Float2ByteRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       byte oldValue = Float2ByteRBTreeMap.this.remove(k);
/* 1496 */       return Float2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1517 */       return Float2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ByteSortedMap headMap(float to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Float2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ByteSortedMap tailMap(float from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Float2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ByteSortedMap subMap(float from, float to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Float2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Float2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Float2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Float2ByteRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Float2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2ByteRBTreeMap.Entry e;
/* 1569 */       if (Float2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Float2ByteRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Float2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1587 */       Float2ByteRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1594 */       Float2ByteRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Float2ByteRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Float2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Float2ByteRBTreeMap.Submap.this.bottom && Float2ByteRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Float2ByteRBTreeMap.Submap.this.top && Float2ByteRBTreeMap.this.compare(k, (this.prev = Float2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Float2ByteRBTreeMap.this.locateKey(k);
/* 1620 */             if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Float2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Float2ByteRBTreeMap.this.compare(this.prev.key, Float2ByteRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Float2ByteRBTreeMap.Submap.this.top && this.next != null && Float2ByteRBTreeMap.this.compare(this.next.key, Float2ByteRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Float2ByteRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readFloat(), s.readByte());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readFloat(), s.readByte());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readFloat(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteRBTreeMap.class
