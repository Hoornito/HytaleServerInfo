...
/* 150 */     return (ObjectSet)float2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2BooleanEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Boolean.valueOf(entry.getBooleanValue()));
...
/* 502 */     Boolean newValue = remappingFunction.apply(Float.valueOf(key), Boolean.valueOf(oldValue));
...
/* 534 */     Boolean newValue = remappingFunction.apply(Float.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
...
/* 604 */       return Float.valueOf(getFloatKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanMap.class
