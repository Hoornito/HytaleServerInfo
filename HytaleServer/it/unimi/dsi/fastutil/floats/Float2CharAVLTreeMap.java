...
/*  885 */       Map.Entry<Float, Character> e = (Map.Entry<Float, Character>)o;
/*  886 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Float2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  998 */       if ((this.next = Float2CharAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Float2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Float2CharAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1147 */             Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1148 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1149 */             Float2CharAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Float2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Float2CharAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2CharMap.Entry first() {
/* 1165 */             return Float2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2CharMap.Entry last() {
/* 1170 */             return Float2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1175 */             return Float2CharAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1180 */             return Float2CharAVLTreeMap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1185 */             return Float2CharAVLTreeMap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Float2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1227 */       return new Float2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (CharIterator)new Float2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1285 */             return Float2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Float2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Float2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Float2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Float2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Float2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2CharAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2CharMap.Entry> comparator() {
/* 1399 */               return Float2CharAVLTreeMap.this.float2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1410 */               return (f != null && Float2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1421 */               if (f != null && Float2CharAVLTreeMap.Submap.this.in(f.key)) Float2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Float2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Float2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Float2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2CharMap.Entry first() {
/* 1444 */               return Float2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2CharMap.Entry last() {
/* 1449 */               return Float2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1454 */               return Float2CharAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1459 */               return Float2CharAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1464 */               return Float2CharAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1473 */         return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1478 */         return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1493 */               return (CharIterator)new Float2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1498 */               return Float2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Float2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Float2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1518 */       return (in(k) && Float2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(float k) {
/* 1536 */       float kk = k; Float2CharAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Float2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(float k, char v) {
/* 1542 */       Float2CharAVLTreeMap.this.modified = false;
...
/* 1544 */       char oldValue = Float2CharAVLTreeMap.this.put(k, v);
/* 1545 */       return Float2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(float k) {
/* 1551 */       Float2CharAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       char oldValue = Float2CharAVLTreeMap.this.remove(k);
/* 1554 */       return Float2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1575 */       return Float2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap headMap(float to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Float2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap tailMap(float from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Float2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap subMap(float from, float to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Float2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Float2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Float2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Float2CharAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Float2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Float2CharAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Float2CharAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2CharAVLTreeMap.Entry e;
/* 1627 */       if (Float2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Float2CharAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Float2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Float2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Float2CharAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1645 */       Float2CharAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1652 */       Float2CharAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Float2CharAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Float2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Float2CharAVLTreeMap.Submap.this.bottom && Float2CharAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Float2CharAVLTreeMap.Submap.this.top && Float2CharAVLTreeMap.this.compare(k, (this.prev = Float2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Float2CharAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Float2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Float2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Float2CharAVLTreeMap.this.compare(this.prev.key, Float2CharAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Float2CharAVLTreeMap.Submap.this.top && this.next != null && Float2CharAVLTreeMap.this.compare(this.next.key, Float2CharAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Float2CharAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readFloat(), s.readChar());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readFloat(), s.readChar());
/* 1866 */       entry.right(new Entry(s.readFloat(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2CharAVLTreeMap.class
