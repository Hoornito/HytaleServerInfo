...
/*  885 */       Map.Entry<Float, Long> e = (Map.Entry<Float, Long>)o;
/*  886 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.float2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Float2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  998 */       if ((this.next = Float2LongAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Float2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Float2LongAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2LongMap.Entry>)new AbstractObjectSortedSet<Float2LongMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1147 */             Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1148 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1149 */             Float2LongAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Float2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Float2LongAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2LongMap.Entry first() {
/* 1165 */             return Float2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2LongMap.Entry last() {
/* 1170 */             return Float2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) {
/* 1175 */             return Float2LongAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) {
/* 1180 */             return Float2LongAVLTreeMap.this.headMap(to.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) {
/* 1185 */             return Float2LongAVLTreeMap.this.tailMap(from.getFloatKey()).float2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Float2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1227 */       return new Float2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (LongIterator)new Float2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1285 */             return Float2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Float2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Float2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Float2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Float2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Float2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2LongMap.Entry>)new AbstractObjectSortedSet<Float2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Float2LongMap.Entry>)new Float2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2LongMap.Entry> comparator() {
/* 1399 */               return Float2LongAVLTreeMap.this.float2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1410 */               return (f != null && Float2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1421 */               if (f != null && Float2LongAVLTreeMap.Submap.this.in(f.key)) Float2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Float2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Float2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Float2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2LongMap.Entry first() {
/* 1444 */               return Float2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2LongMap.Entry last() {
/* 1449 */               return Float2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) {
/* 1454 */               return Float2LongAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) {
/* 1459 */               return Float2LongAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) {
/* 1464 */               return Float2LongAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1473 */         return new Float2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1478 */         return new Float2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public LongIterator iterator() {
/* 1493 */               return (LongIterator)new Float2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1498 */               return Float2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Float2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Float2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1518 */       return (in(k) && Float2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(float k) {
/* 1536 */       float kk = k; Float2LongAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Float2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(float k, long v) {
/* 1542 */       Float2LongAVLTreeMap.this.modified = false;
...
/* 1544 */       long oldValue = Float2LongAVLTreeMap.this.put(k, v);
/* 1545 */       return Float2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(float k) {
/* 1551 */       Float2LongAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       long oldValue = Float2LongAVLTreeMap.this.remove(k);
/* 1554 */       return Float2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1575 */       return Float2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap headMap(float to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Float2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap tailMap(float from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Float2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2LongSortedMap subMap(float from, float to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Float2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Float2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Float2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Float2LongAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Float2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Float2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Float2LongAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2LongAVLTreeMap.Entry e;
/* 1627 */       if (Float2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Float2LongAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Float2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Float2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Float2LongAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1645 */       Float2LongAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1652 */       Float2LongAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Float2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Float2LongAVLTreeMap.Submap.this.bottom && Float2LongAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Float2LongAVLTreeMap.Submap.this.top && Float2LongAVLTreeMap.this.compare(k, (this.prev = Float2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Float2LongAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Float2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Float2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Float2LongAVLTreeMap.this.compare(this.prev.key, Float2LongAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Float2LongAVLTreeMap.Submap.this.top && this.next != null && Float2LongAVLTreeMap.this.compare(this.next.key, Float2LongAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Float2LongAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readFloat(), s.readLong());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readFloat(), s.readLong());
/* 1866 */       entry.right(new Entry(s.readFloat(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2LongAVLTreeMap.class
