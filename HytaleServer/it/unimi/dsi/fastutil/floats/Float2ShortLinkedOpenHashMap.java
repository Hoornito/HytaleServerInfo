...
/*  854 */     Short newValue = remappingFunction.apply(Float.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Short newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  947 */       return Float2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  952 */       return Float2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  957 */       return Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  962 */       return Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  967 */       short oldValue = Float2ShortLinkedOpenHashMap.this.value[this.index];
/*  968 */       Float2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatShortPair right(short v) {
/*  974 */       Float2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  986 */       return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Float, Short> e = (Map.Entry<Float, Short>)o;
/* 1016 */       return (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return HashCommon.float2int(Float2ShortLinkedOpenHashMap.this.key[this.index]) ^ Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Float2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Float2ShortLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(float from) {
/* 1199 */       if (Float.floatToIntBits(from) == 0) {
/* 1200 */         if (Float2ShortLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Float2ShortLinkedOpenHashMap.this.link[Float2ShortLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Float2ShortLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.last]) == Float.floatToIntBits(from)) {
/* 1207 */         this.prev = Float2ShortLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Float2ShortLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2ShortLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) != 0) {
/* 1215 */         if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) == Float.floatToIntBits(from)) {
/*      */           
/* 1217 */           this.next = (int)Float2ShortLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Float2ShortLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Float2ShortLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Float2ShortLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Float2ShortLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Float2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Float2ShortLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Float2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Float2ShortLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Float2ShortLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Float2ShortLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Float2ShortLinkedOpenHashMap.this.link[this.prev] = Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ (Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Float2ShortLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Float2ShortLinkedOpenHashMap.this.link[this.next] = Float2ShortLinkedOpenHashMap.this.link[this.next] ^ (Float2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Float2ShortLinkedOpenHashMap.this.n) {
/* 1309 */         Float2ShortLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         float[] key = Float2ShortLinkedOpenHashMap.this.key; while (true) {
/*      */           float curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if (Float.floatToIntBits(curr = key[pos]) == 0) {
/* 1318 */               key[last] = 0.0F;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ShortLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Float2ShortLinkedOpenHashMap.this.value[last] = Float2ShortLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Float2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2ShortMap.Entry>> implements ObjectListIterator<Float2ShortMap.Entry> {
...
/* 1368 */       action.accept(new Float2ShortLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Float2ShortMap.Entry>> implements ObjectListIterator<Float2ShortMap.Entry> {
/* 1389 */     final Float2ShortLinkedOpenHashMap.MapEntry entry = new Float2ShortLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Float2ShortMap.Entry>)new Float2ShortLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Float2ShortLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ShortMap.Entry last() {
/* 1472 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (Float.floatToIntBits(k) == 0) return (Float2ShortLinkedOpenHashMap.this.containsNullKey && Float2ShortLinkedOpenHashMap.this.value[Float2ShortLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1487 */       float[] key = Float2ShortLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1490 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ShortLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1491 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1494 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1495 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1509 */         if (Float2ShortLinkedOpenHashMap.this.containsNullKey && Float2ShortLinkedOpenHashMap.this.value[Float2ShortLinkedOpenHashMap.this.n] == v) {
/* 1510 */           Float2ShortLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       float[] key = Float2ShortLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1519 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ShortLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1520 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1521 */         if (Float2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1522 */           Float2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1529 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1530 */           Float2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1531 */           Float2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Float2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Float2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Float2ShortLinkedOpenHashMap.EntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Float2ShortLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Float2ShortLinkedOpenHashMap.FastEntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2ShortMap.Entry> consumer) {
/* 1588 */       for (int i = Float2ShortLinkedOpenHashMap.this.size, next = Float2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Float2ShortLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Float2ShortLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Float2ShortLinkedOpenHashMap.MapEntry entry = new Float2ShortLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Float2ShortLinkedOpenHashMap.this.size, next = Float2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Float2ShortLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Float2ShortLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Float2ShortLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1645 */       return Float2ShortLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Float2ShortLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
...
/* 1669 */       return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2ShortLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1675 */       for (int i = Float2ShortLinkedOpenHashMap.this.size, next = Float2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Float2ShortLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Float2ShortLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Float2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1689 */       return Float2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1694 */       int oldSize = Float2ShortLinkedOpenHashMap.this.size;
/* 1695 */       Float2ShortLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Float2ShortLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Float2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloat() {
/* 1706 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public float lastFloat() {
/* 1712 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatComparator comparator() {
...
/* 1754 */       return Float2ShortLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Float2ShortLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1771 */       return Float2ShortLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (ShortIterator)new Float2ShortLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2ShortLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1798 */             for (int i = Float2ShortLinkedOpenHashMap.this.size, next = Float2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Float2ShortLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Float2ShortLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Float2ShortLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1812 */             return Float2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Float2ShortLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Float2ShortLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ShortLinkedOpenHashMap.class
