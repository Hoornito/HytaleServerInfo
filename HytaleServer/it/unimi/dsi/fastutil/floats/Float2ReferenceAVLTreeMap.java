...
/*  865 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  870 */       return HashCommon.float2int(this.key) ^ ((this.value == null) ? 0 : System.identityHashCode(this.value));
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Float2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  977 */       if ((this.next = Float2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Float2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Float2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1124 */             Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1125 */             if (f == null || f.getValue() != e.getValue()) return false; 
/* 1126 */             Float2ReferenceAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Float2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Float2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ReferenceMap.Entry<V> first() {
/* 1142 */             return Float2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2ReferenceMap.Entry<V> last() {
/* 1147 */             return Float2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) {
/* 1152 */             return Float2ReferenceAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) {
/* 1157 */             return Float2ReferenceAVLTreeMap.this.headMap(to.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) {
/* 1162 */             return Float2ReferenceAVLTreeMap.this.tailMap(from.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Float2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1204 */       return new Float2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Float2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Float2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Float2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Float2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Float2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Float2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Float2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ReferenceAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2ReferenceMap.Entry<V>> comparator() {
/* 1376 */               return Float2ReferenceAVLTreeMap.this.float2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1385 */               Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1386 */               return (f != null && Float2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1395 */               Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1396 */               if (f != null && Float2ReferenceAVLTreeMap.Submap.this.in(f.key)) Float2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Float2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Float2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ReferenceMap.Entry<V> first() {
/* 1419 */               return Float2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2ReferenceMap.Entry<V> last() {
/* 1424 */               return Float2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) {
/* 1429 */               return Float2ReferenceAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) {
/* 1434 */               return Float2ReferenceAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) {
/* 1439 */               return Float2ReferenceAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1448 */         return new Float2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1453 */         return new Float2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Float2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Float2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Float2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Float2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1493 */       return (in(k) && Float2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(float k) {
/* 1511 */       float kk = k; Float2ReferenceAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Float2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(float k, V v) {
/* 1517 */       Float2ReferenceAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Float2ReferenceAVLTreeMap.this.put(k, v);
/* 1520 */       return Float2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(float k) {
/* 1526 */       Float2ReferenceAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Float2ReferenceAVLTreeMap.this.remove(k);
/* 1529 */       return Float2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1550 */       return Float2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceSortedMap<V> headMap(float to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Float2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceSortedMap<V> tailMap(float from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Float2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceSortedMap<V> subMap(float from, float to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Float2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Float2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Float2ReferenceAVLTreeMap.Entry<V> e;
/* 1580 */       if (Float2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Float2ReferenceAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Float2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Float2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Float2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2ReferenceAVLTreeMap.Entry<V> e;
/* 1602 */       if (Float2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Float2ReferenceAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Float2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Float2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Float2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1620 */       Float2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1627 */       Float2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Float2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Float2ReferenceAVLTreeMap.Submap.this.bottom && Float2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Float2ReferenceAVLTreeMap.Submap.this.top && Float2ReferenceAVLTreeMap.this.compare(k, (this.prev = Float2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Float2ReferenceAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Float2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Float2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Float2ReferenceAVLTreeMap.this.compare(this.prev.key, Float2ReferenceAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Float2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Float2ReferenceAVLTreeMap.this.compare(this.next.key, Float2ReferenceAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     Float2ReferenceAVLTreeMap<V> c;
/*      */     try {
/* 1758 */       c = (Float2ReferenceAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceAVLTreeMap.class
