...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Float2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Float2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Float2LongFunction singleton(Float key, Long value) {
/* 179 */     return new Singleton(key.floatValue(), value.longValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractFloat2LongFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2LongFunction function;
/*     */     
...
/* 550 */       Long v = this.function.apply(Float.valueOf(key));
...
/* 557 */       Long v = this.function.apply(Float.valueOf(key));
...
/* 603 */     if (f instanceof Float2LongFunction) return (Float2LongFunction)f; 
/* 604 */     if (f instanceof DoubleToLongFunction) { Objects.requireNonNull((DoubleToLongFunction)f); return (DoubleToLongFunction)f::applyAsLong; }
/* 605 */      return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2LongFunctions.class
