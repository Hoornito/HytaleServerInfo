...
/*   62 */     if (length == 0) return FloatArrays.EMPTY_ARRAY; 
...
/*   84 */     if (capacity == 0) { this.a = FloatArrays.EMPTY_ARRAY; }
/*   85 */     else { this.a = new float[capacity]; }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*  100 */     this.a = FloatArrays.DEFAULT_EMPTY_ARRAY;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  109 */     if (c instanceof FloatArrayList) {
/*  110 */       this.a = copyArrayFromSafe((FloatArrayList)c);
/*  111 */       this.size = this.a.length;
/*      */     } else {
/*  113 */       initArrayFromCapacity(c.size());
/*  114 */       if (c instanceof FloatList) {
/*  115 */         ((FloatList)c).getElements(0, this.a, 0, this.size = c.size());
/*      */       } else {
/*  117 */         this.size = FloatIterators.unwrap(FloatIterators.asFloatIterator(c.iterator()), this.a);
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  128 */     if (c instanceof FloatArrayList) {
/*  129 */       this.a = copyArrayFromSafe((FloatArrayList)c);
/*  130 */       this.size = this.a.length;
/*      */     } else {
/*  132 */       initArrayFromCapacity(c.size());
/*  133 */       if (c instanceof FloatList) {
/*  134 */         ((FloatList)c).getElements(0, this.a, 0, this.size = c.size());
/*      */       } else {
/*  136 */         this.size = FloatIterators.unwrap(c.iterator(), this.a);
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  147 */     if (l instanceof FloatArrayList) {
/*  148 */       this.a = copyArrayFromSafe((FloatArrayList)l);
...
/*  184 */     this();
/*  185 */     for (; i.hasNext(); add(((Float)i.next()).floatValue()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  194 */     this();
/*  195 */     for (; i.hasNext(); add(i.nextFloat()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  220 */     FloatArrayList l = new FloatArrayList(a, true);
/*  221 */     l.size = length;
/*  222 */     return l;
/*      */   }
/*      */ 
...
/*  267 */     if (capacity <= this.a.length || (this.a == FloatArrays.DEFAULT_EMPTY_ARRAY && capacity <= 10))
/*  268 */       return;  this.a = FloatArrays.ensureCapacity(this.a, capacity, this.size);
...
/*  281 */       return;  if (this.a != FloatArrays.DEFAULT_EMPTY_ARRAY) { capacity = (int)Math.max(Math.min(this.a.length + (this.a.length >> 1), 2147483639L), capacity); }
/*  282 */     else if (capacity < 10) { capacity = 10; }
/*  283 */      this.a = FloatArrays.forceCapacity(this.a, capacity, this.size);
...
/*  313 */     for (int i = 0; i < this.size; ) { if (Float.floatToIntBits(k) == Float.floatToIntBits(this.a[i])) return i;  i++; }
/*  314 */      return -1;
/*      */   }
/*      */ 
/*      */   
/*      */   public int lastIndexOf(float k) {
/*  319 */     for (int i = this.size; i-- != 0;) { if (Float.floatToIntBits(k) == Float.floatToIntBits(this.a[i])) return i;  }
/*  320 */      return -1;
/*      */   }
/*      */ 
/*      */   
...
/*  363 */     if (size > this.a.length) this.a = FloatArrays.forceCapacity(this.a, size, this.size); 
/*  364 */     if (size > this.size) Arrays.fill(this.a, this.size, size, 0.0F); 
/*  365 */     this.size = size;
/*      */   }
/*      */ 
/*      */   
...
/*  399 */       return;  float[] t = new float[Math.max(n, this.size)];
...
/*  416 */       return FloatArrayList.this.a;
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloat(int i) {
/*  421 */       ensureRestrictedIndex(i);
/*  422 */       return FloatArrayList.this.a[i + this.from];
/*      */     }
/*      */     
...
/*  434 */         return FloatArrayList.this.a[FloatArrayList.SubList.this.from + i];
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void add(int i, float k) {
/*  439 */         FloatArrayList.SubList.this.add(i, k);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void set(int i, float k) {
/*  444 */         FloatArrayList.SubList.this.set(i, k);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void remove(int i) {
/*  449 */         FloatArrayList.SubList.this.removeFloat(i);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final int getMaxPos() {
/*  454 */         return FloatArrayList.SubList.this.to - FloatArrayList.SubList.this.from;
/*      */       }
/*      */ 
/*      */       
/*      */       public float nextFloat() {
/*  459 */         if (!hasNext()) throw new NoSuchElementException(); 
/*  460 */         return FloatArrayList.this.a[FloatArrayList.SubList.this.from + (this.lastReturned = this.pos++)];
/*      */       }
/*      */ 
/*      */       
/*      */       public float previousFloat() {
/*  465 */         if (!hasPrevious()) throw new NoSuchElementException(); 
/*  466 */         return FloatArrayList.this.a[FloatArrayList.SubList.this.from + (this.lastReturned = --this.pos)];
/*      */       }
/*      */ 
/*      */       
/*      */       public void forEachRemaining(FloatConsumer action) {
/*  471 */         int max = FloatArrayList.SubList.this.to - FloatArrayList.SubList.this.from;
/*  472 */         while (this.pos < max) {
/*  473 */           action.accept(FloatArrayList.this.a[FloatArrayList.SubList.this.from + (this.lastReturned = this.pos++)]);
/*      */         }
/*      */       }
/*      */     }
/*      */ 
...
/*      */       SubListSpliterator() {
/*  486 */         super(FloatArrayList.SubList.this.from);
/*      */       }
/*      */       
...
/*  495 */         return FloatArrayList.SubList.this.to;
/*      */       }
/*      */ 
/*      */       
/*      */       protected final float get(int i) {
/*  500 */         return FloatArrayList.this.a[i];
/*      */       }
/*      */ 
/*      */       
...
/*  511 */         action.accept(FloatArrayList.this.a[this.pos++]);
/*  512 */         return true;
/*      */       }
/*      */ 
/*      */       
...
/*  519 */           action.accept(FloatArrayList.this.a[this.pos++]);
/*      */         }
/*      */       }
/*      */     }
/*      */ 
...
/*  530 */       if (FloatArrayList.this.a == otherA && this.from == otherAFrom && this.to == otherATo) return true; 
...
/*      */ 
/*      */       
/*  540 */       while (pos < this.to) { if (FloatArrayList.this.a[pos++] != otherA[otherPos++]) return false;  }
/*  541 */        return true;
/*      */     }
/*      */ 
/*      */     
...
/*  549 */       if (o instanceof FloatArrayList) {
/*      */         
/*  551 */         FloatArrayList other = (FloatArrayList)o;
...
/*  563 */       if (FloatArrayList.this.a == otherA && this.from == otherAFrom && this.to == otherATo) return 0;
/*      */       
/*      */       int i;
/*      */       int j;
/*  567 */       for (i = this.from, j = otherAFrom; i < this.to && i < otherATo; i++, j++) {
/*  568 */         float e1 = FloatArrayList.this.a[i];
/*  569 */         float e2 = otherA[j]; int r;
/*  570 */         if ((r = Float.compare(e1, e2)) != 0) return r; 
/*      */       } 
...
/*  577 */       if (l instanceof FloatArrayList) {
/*      */         
/*  579 */         FloatArrayList other = (FloatArrayList)l;
...
/*  614 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/*  642 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/*  660 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/*  674 */     if (c instanceof FloatList) {
/*  675 */       return addAll(index, (FloatList)c);
/*      */     }
...
/*  682 */     FloatIterator i = c.iterator();
/*  683 */     this.size += n;
/*  684 */     for (; n-- != 0; this.a[index++] = i.nextFloat());
...
/*  722 */     return new FloatListIterator() {
/*  723 */         int pos = index; int last = -1;
/*      */ 
/*      */         
/*      */         public boolean hasNext() {
/*  727 */           return (this.pos < FloatArrayList.this.size);
/*      */         }
/*      */ 
/*      */         
...
/*  738 */           return FloatArrayList.this.a[this.last = this.pos++];
/*      */         }
/*      */ 
/*      */         
/*      */         public float previousFloat() {
/*  743 */           if (!hasPrevious()) throw new NoSuchElementException(); 
/*  744 */           return FloatArrayList.this.a[this.last = --this.pos];
/*      */         }
/*      */ 
/*      */         
...
/*  759 */           FloatArrayList.this.add(this.pos++, k);
/*  760 */           this.last = -1;
/*      */         }
/*      */ 
/*      */         
...
/*  766 */           FloatArrayList.this.set(this.last, k);
/*      */         }
/*      */ 
/*      */         
/*      */         public void remove() {
/*  771 */           if (this.last == -1) throw new IllegalStateException(); 
/*  772 */           FloatArrayList.this.removeFloat(this.last);
/*      */           
...
/*      */         
/*      */         public void forEachRemaining(FloatConsumer action) {
/*  780 */           while (this.pos < FloatArrayList.this.size) {
/*  781 */             action.accept(FloatArrayList.this.a[this.last = this.pos++]);
/*      */           }
/*      */         }
/*      */ 
/*      */         
...
/*  788 */           int remaining = FloatArrayList.this.size - this.pos;
/*  789 */           if (n < remaining) {
/*  790 */             this.pos -= n;
/*      */           } else {
/*  792 */             n = remaining;
...
/*  802 */           int remaining = FloatArrayList.this.size - this.pos;
/*  803 */           if (n < remaining) {
/*  804 */             this.pos += n;
/*      */           } else {
/*  806 */             n = remaining;
/*  807 */             this.pos = FloatArrayList.this.size;
/*      */           } 
...
/*      */     
/*      */     public Spliterator() {
/*  824 */       this(0, FloatArrayList.this.size, false);
/*      */     }
/*      */     
...
/*  835 */       return this.hasSplit ? this.max : FloatArrayList.this.size;
/*      */     }
/*      */ 
/*      */     
...
/*  851 */       action.accept(FloatArrayList.this.a[this.pos++]);
/*  852 */       return true;
/*      */     }
/*      */ 
/*      */     
...
/*  858 */         action.accept(FloatArrayList.this.a[this.pos]);
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/*  912 */     if (comp == null) {
/*  913 */       FloatArrays.stableSort(this.a, 0, this.size);
/*      */     } else {
/*  915 */       FloatArrays.stableSort(this.a, 0, this.size, comp);
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/*  921 */     if (comp == null) {
/*  922 */       FloatArrays.unstableSort(this.a, 0, this.size);
/*      */     } else {
/*  924 */       FloatArrays.unstableSort(this.a, 0, this.size, comp);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  931 */     FloatArrayList cloned = null;
/*      */     
/*  933 */     if (getClass() == FloatArrayList.class) {
/*      */ 
/*      */       
/*  936 */       cloned = new FloatArrayList(copyArraySafe(this.a, this.size), false);
/*  937 */       cloned.size = this.size;
/*      */     } else {
/*      */       try {
/*  940 */         cloned = (FloatArrayList)super.clone();
...
/*  980 */     if (o instanceof FloatArrayList)
/*      */     {
/*  982 */       return equals((FloatArrayList)o);
/*      */     }
...
/* 1011 */       float e1 = a1[i];
/* 1012 */       float e2 = a2[i]; int r;
/* 1013 */       if ((r = Float.compare(e1, e2)) != 0) return r; 
/*      */     } 
...
/*      */   
/*      */   public int compareTo(List<? extends Float> l) {
/* 1020 */     if (l instanceof FloatArrayList) {
/* 1021 */       return compareTo((FloatArrayList)l);
/*      */     }
...
/* 1032 */     for (int i = 0; i < this.size; ) { s.writeFloat(this.a[i]); i++; }
/*      */   
/*      */   }
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1036 */     s.defaultReadObject();
/* 1037 */     this.a = new float[this.size];
/* 1038 */     for (int i = 0; i < this.size; ) { this.a[i] = s.readFloat(); i++; }
/*      */   
/*      */   }
/*      */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\FloatArrayList.class
