...
/* 150 */     return (ObjectSet)float2LongEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2LongEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Long.valueOf(entry.getLongValue()));
...
/* 502 */     Long newValue = remappingFunction.apply(Float.valueOf(key), Long.valueOf(oldValue));
...
/* 534 */     Long newValue = remappingFunction.apply(Float.valueOf(key), contained ? Long.valueOf(oldValue) : null);
...
/* 775 */       return Float.valueOf(getFloatKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2LongMap.class
