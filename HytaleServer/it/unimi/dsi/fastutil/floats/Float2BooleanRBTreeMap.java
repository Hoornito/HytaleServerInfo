...
/*  819 */       Map.Entry<Float, Boolean> e = (Map.Entry<Float, Boolean>)o;
/*  820 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return HashCommon.float2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Float2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  930 */       if ((this.next = Float2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Float2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Float2BooleanRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2BooleanMap.Entry>)new AbstractObjectSortedSet<Float2BooleanMap.Entry>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1046 */             return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1057 */             Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1067 */             if (!(e.getKey() instanceof Float)) return false; 
/* 1068 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1069 */             Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1070 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1071 */             Float2BooleanRBTreeMap.this.remove(f.key);
/* 1072 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1077 */             return Float2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1082 */             Float2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2BooleanMap.Entry first() {
/* 1087 */             return Float2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2BooleanMap.Entry last() {
/* 1092 */             return Float2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) {
/* 1097 */             return Float2BooleanRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) {
/* 1102 */             return Float2BooleanRBTreeMap.this.headMap(to.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) {
/* 1107 */             return Float2BooleanRBTreeMap.this.tailMap(from.getFloatKey()).float2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1144 */       return new Float2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1149 */       return new Float2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1202 */             return (BooleanIterator)new Float2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1207 */             return Float2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1212 */             return Float2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1217 */             Float2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1230 */     return new Submap(0.0F, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Float2BooleanSortedMap tailMap(float from) {
/* 1235 */     return new Submap(from, false, 0.0F, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1279 */       if (!bottom && !top && Float2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1280 */       this.from = from;
/* 1281 */       this.bottom = bottom;
/* 1282 */       this.to = to;
/* 1283 */       this.top = top;
/* 1284 */       this.defRetValue = Float2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1303 */       return ((this.bottom || Float2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
/* 1308 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2BooleanMap.Entry>)new AbstractObjectSortedSet<Float2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator() {
/* 1311 */               return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1316 */               return (ObjectBidirectionalIterator<Float2BooleanMap.Entry>)new Float2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2BooleanMap.Entry> comparator() {
/* 1321 */               return Float2BooleanRBTreeMap.this.float2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1329 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1330 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1331 */               Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1332 */               return (f != null && Float2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1340 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1341 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1342 */               Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1343 */               if (f != null && Float2BooleanRBTreeMap.Submap.this.in(f.key)) Float2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1344 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1349 */               int c = 0;
/* 1350 */               for (ObjectBidirectionalIterator<Float2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1351 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1356 */               return !(new Float2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1361 */               Float2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2BooleanMap.Entry first() {
/* 1366 */               return Float2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2BooleanMap.Entry last() {
/* 1371 */               return Float2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) {
/* 1376 */               return Float2BooleanRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) {
/* 1381 */               return Float2BooleanRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) {
/* 1386 */               return Float2BooleanRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2BooleanEntrySet();
/*      */             }
/*      */           }; 
/* 1389 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractFloat2BooleanSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1395 */         return new Float2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1400 */         return new Float2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1415 */               return (BooleanIterator)new Float2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1420 */               return Float2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1425 */               return Float2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1430 */               Float2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1440 */       return (in(k) && Float2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(float k) {
/* 1458 */       float kk = k; Float2BooleanRBTreeMap.Entry e;
/* 1459 */       return (in(kk) && (e = Float2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(float k, boolean v) {
/* 1464 */       Float2BooleanRBTreeMap.this.modified = false;
...
/* 1466 */       boolean oldValue = Float2BooleanRBTreeMap.this.put(k, v);
/* 1467 */       return Float2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1473 */       Float2BooleanRBTreeMap.this.modified = false;
/* 1474 */       if (!in(k)) return this.defRetValue; 
/* 1475 */       boolean oldValue = Float2BooleanRBTreeMap.this.remove(k);
/* 1476 */       return Float2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1497 */       return Float2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap headMap(float to) {
/* 1502 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1503 */       return (Float2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap tailMap(float from) {
/* 1508 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1509 */       return (Float2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2BooleanSortedMap subMap(float from, float to) {
/* 1514 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1515 */       if (!this.top) to = (Float2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1516 */       if (!this.bottom) from = (Float2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1527 */       if (Float2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1531 */       if (this.bottom) { e = Float2BooleanRBTreeMap.this.firstEntry; }
/*      */       else
/* 1533 */       { e = Float2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1535 */         if (Float2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1539 */       if (e == null || (!this.top && Float2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1540 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2BooleanRBTreeMap.Entry e;
/* 1549 */       if (Float2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1553 */       if (this.top) { e = Float2BooleanRBTreeMap.this.lastEntry; }
/*      */       else
/* 1555 */       { e = Float2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1557 */         if (Float2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1561 */       if (e == null || (!this.bottom && Float2BooleanRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1562 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1567 */       Float2BooleanRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1574 */       Float2BooleanRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1590 */         this.next = Float2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null) {
/* 1596 */           if (!Float2BooleanRBTreeMap.Submap.this.bottom && Float2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1597 */           else if (!Float2BooleanRBTreeMap.Submap.this.top && Float2BooleanRBTreeMap.this.compare(k, (this.prev = Float2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1599 */           { this.next = Float2BooleanRBTreeMap.this.locateKey(k);
/* 1600 */             if (Float2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1611 */         if (!Float2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Float2BooleanRBTreeMap.this.compare(this.prev.key, Float2BooleanRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1616 */         this.next = this.next.next();
/* 1617 */         if (!Float2BooleanRBTreeMap.Submap.this.top && this.next != null && Float2BooleanRBTreeMap.this.compare(this.next.key, Float2BooleanRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Float2BooleanMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1705 */       c = (Float2BooleanRBTreeMap)super.clone();
...
/* 1778 */     if (n == 1) {
/* 1779 */       Entry entry = new Entry(s.readFloat(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1788 */       Entry entry = new Entry(s.readFloat(), s.readBoolean());
/* 1789 */       entry.black(true);
/* 1790 */       entry.right(new Entry(s.readFloat(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanRBTreeMap.class
