...
/*  421 */     for (int i = this.n; i-- != 0;) { if (Float.floatToIntBits(key[i]) != 0 && value[i] == v) return true;  }
/*  422 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  542 */     Long newValue = remappingFunction.apply(Float.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Long newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  634 */       return Float2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  639 */       return Float2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Float2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  649 */       return Float2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  654 */       long oldValue = Float2LongOpenCustomHashMap.this.value[this.index];
/*  655 */       Float2LongOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatLongPair right(long v) {
/*  661 */       Float2LongOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  673 */       return Float.valueOf(Float2LongOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Long.valueOf(Float2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Float, Long> e = (Map.Entry<Float, Long>)o;
/*  703 */       return (Float2LongOpenCustomHashMap.this.strategy.equals(Float2LongOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Float2LongOpenCustomHashMap.this.strategy.hashCode(Float2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Float2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Float2LongOpenCustomHashMap.this.key[this.index] + "=>" + Float2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Float2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Float2LongOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Float2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Float2LongOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       float[] key = Float2LongOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Float2LongOpenCustomHashMap.this.mask;
/*  762 */           for (; !Float2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2LongOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Float2LongOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       float[] key = Float2LongOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Float2LongOpenCustomHashMap.this.mask;
/*  782 */           for (; !Float2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2LongOpenCustomHashMap.this.mask);
...
/*  802 */       float[] key = Float2LongOpenCustomHashMap.this.key; while (true) {
/*      */         float curr; int last;
/*  804 */         pos = (last = pos) + 1 & Float2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if (Float.floatToIntBits(curr = key[pos]) == 0) {
/*  807 */             key[last] = 0.0F;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2LongOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Float2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Float2LongOpenCustomHashMap.this.value[last] = Float2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Float2LongOpenCustomHashMap.this.n)
/*  826 */       { Float2LongOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Float2LongOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Float2LongOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2LongMap.Entry>> implements ObjectIterator<Float2LongMap.Entry> { public Float2LongOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Float2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Float2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Float2LongOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Float2LongOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Float2LongOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Float2LongOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       float[] key = Float2LongOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Float2LongOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       float[] key = Float2LongOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Float2LongOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Float2LongOpenCustomHashMap.this.size - this.c), (long)(Float2LongOpenCustomHashMap.this.realSize() / Float2LongOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       float[] key = Float2LongOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Float2LongMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2LongMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Float2LongMap.Entry> action, int index) {
/* 1013 */       action.accept(new Float2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Float2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Float2LongMap.Entry> fastIterator() {
/* 1030 */       return new Float2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Float2LongMap.Entry> spliterator() {
/* 1035 */       return new Float2LongOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Float2LongOpenCustomHashMap.this.strategy.equals(k, 0.0F)) return (Float2LongOpenCustomHashMap.this.containsNullKey && Float2LongOpenCustomHashMap.this.value[Float2LongOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       float[] key = Float2LongOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1053 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Float2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Float2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Float2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Float2LongOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
/* 1072 */         if (Float2LongOpenCustomHashMap.this.containsNullKey && Float2LongOpenCustomHashMap.this.value[Float2LongOpenCustomHashMap.this.n] == v) {
/* 1073 */           Float2LongOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       float[] key = Float2LongOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1082 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Float2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Float2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Float2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Float2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Float2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Float2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Float2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Float2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Float2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
/* 1114 */       if (Float2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(new Float2LongOpenCustomHashMap.MapEntry(Float2LongOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Float2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(new Float2LongOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2LongMap.Entry> consumer) {
/* 1121 */       Float2LongOpenCustomHashMap.MapEntry entry = new Float2LongOpenCustomHashMap.MapEntry();
/* 1122 */       if (Float2LongOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Float2LongOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Float2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) != 0) {
...
/* 1157 */       action.accept(Float2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1162 */       return Float2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1183 */       action.accept(Float2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Float2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSpliterator spliterator() {
/* 1200 */       return new Float2LongOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1206 */       if (Float2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2LongOpenCustomHashMap.this.key[Float2LongOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Float2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         float k = Float2LongOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Float2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1220 */       return Float2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1225 */       int oldSize = Float2LongOpenCustomHashMap.this.size;
/* 1226 */       Float2LongOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Float2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Float2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Float2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1265 */       return Float2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1286 */       action.accept(Float2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Float2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1305 */             return new Float2LongOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1311 */             if (Float2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2LongOpenCustomHashMap.this.value[Float2LongOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Float2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(Float2LongOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Float2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1322 */             return Float2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Float2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Float2LongOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2LongOpenCustomHashMap.class
