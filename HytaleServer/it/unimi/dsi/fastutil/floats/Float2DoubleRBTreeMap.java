...
/*  839 */       Map.Entry<Float, Double> e = (Map.Entry<Float, Double>)o;
/*  840 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return HashCommon.float2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Float2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  950 */       if ((this.next = Float2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Float2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Float2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2DoubleMap.Entry>)new AbstractObjectSortedSet<Float2DoubleMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1089 */             Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1091 */             Float2DoubleRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Float2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Float2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2DoubleMap.Entry first() {
/* 1107 */             return Float2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2DoubleMap.Entry last() {
/* 1112 */             return Float2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry from, Float2DoubleMap.Entry to) {
/* 1117 */             return Float2DoubleRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry to) {
/* 1122 */             return Float2DoubleRBTreeMap.this.headMap(to.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry from) {
/* 1127 */             return Float2DoubleRBTreeMap.this.tailMap(from.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Float2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1169 */       return new Float2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (DoubleIterator)new Float2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1227 */             return Float2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Float2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Float2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Float2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Float2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/*      */     
/*      */     public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2DoubleMap.Entry>)new AbstractObjectSortedSet<Float2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2DoubleMap.Entry> comparator() {
/* 1341 */               return Float2DoubleRBTreeMap.this.float2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1352 */               return (f != null && Float2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1363 */               if (f != null && Float2DoubleRBTreeMap.Submap.this.in(f.key)) Float2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Float2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Float2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Float2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2DoubleMap.Entry first() {
/* 1386 */               return Float2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2DoubleMap.Entry last() {
/* 1391 */               return Float2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry from, Float2DoubleMap.Entry to) {
/* 1396 */               return Float2DoubleRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry to) {
/* 1401 */               return Float2DoubleRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry from) {
/* 1406 */               return Float2DoubleRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1415 */         return new Float2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1420 */         return new Float2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1435 */               return (DoubleIterator)new Float2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1440 */               return Float2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Float2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Float2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1460 */       return (in(k) && Float2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(float k) {
/* 1478 */       float kk = k; Float2DoubleRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Float2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(float k, double v) {
/* 1484 */       Float2DoubleRBTreeMap.this.modified = false;
...
/* 1486 */       double oldValue = Float2DoubleRBTreeMap.this.put(k, v);
/* 1487 */       return Float2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(float k) {
/* 1493 */       Float2DoubleRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       double oldValue = Float2DoubleRBTreeMap.this.remove(k);
/* 1496 */       return Float2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1517 */       return Float2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2DoubleSortedMap headMap(float to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Float2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2DoubleSortedMap tailMap(float from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Float2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2DoubleSortedMap subMap(float from, float to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Float2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Float2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Float2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Float2DoubleRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Float2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Float2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Float2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2DoubleRBTreeMap.Entry e;
/* 1569 */       if (Float2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Float2DoubleRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Float2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Float2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Float2DoubleRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1587 */       Float2DoubleRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1594 */       Float2DoubleRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Float2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Float2DoubleRBTreeMap.Submap.this.bottom && Float2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Float2DoubleRBTreeMap.Submap.this.top && Float2DoubleRBTreeMap.this.compare(k, (this.prev = Float2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Float2DoubleRBTreeMap.this.locateKey(k);
/* 1620 */             if (Float2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Float2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Float2DoubleRBTreeMap.this.compare(this.prev.key, Float2DoubleRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Float2DoubleRBTreeMap.Submap.this.top && this.next != null && Float2DoubleRBTreeMap.this.compare(this.next.key, Float2DoubleRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Float2DoubleRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readFloat(), s.readDouble());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readFloat(), s.readDouble());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readFloat(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleRBTreeMap.class
