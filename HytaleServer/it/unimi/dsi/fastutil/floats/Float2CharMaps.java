...
/*  50 */     return (entries instanceof Float2CharMap.FastEntrySet) ? ((Float2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Float2CharMap.Entry> entries = map.float2CharEntrySet();
/*  66 */     if (entries instanceof Float2CharMap.FastEntrySet) { ((Float2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Float2CharMap.Entry> entries = map.float2CharEntrySet();
/*  83 */     return (entries instanceof Float2CharMap.FastEntrySet) ? new ObjectIterable<Float2CharMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Float2CharMap.Entry> iterator() {
/*  86 */           return ((Float2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Float2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Float2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractFloat2CharMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)float2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
...
/* 316 */     return new Singleton(key.floatValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Float2CharFunctions.SynchronizedFunction implements Float2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.float2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, Character>> entrySet() {
/* 381 */       return (ObjectSet)float2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
...
/*     */     extends Float2CharFunctions.UnmodifiableFunction implements Float2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2CharMap map;
/*     */     protected transient ObjectSet<Float2CharMap.Entry> entries;
/*     */     protected transient FloatSet keys;
...
/*     */     
/*     */     public ObjectSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.float2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, Character>> entrySet() {
/* 712 */       return (ObjectSet)float2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2CharMaps.class
