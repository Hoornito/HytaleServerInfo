...
/* 150 */     return (ObjectSet)float2DoubleEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2DoubleEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Double.valueOf(entry.getDoubleValue()));
...
/* 502 */     Double newValue = remappingFunction.apply(Float.valueOf(key), Double.valueOf(oldValue));
...
/* 534 */     Double newValue = remappingFunction.apply(Float.valueOf(key), contained ? Double.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleMap.class
