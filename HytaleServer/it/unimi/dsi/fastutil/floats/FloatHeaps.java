...
/*  45 */         float t = heap[child];
/*  46 */         int right = child + 1;
/*  47 */         if (right < size && Float.compare(heap[right], t) < 0) t = heap[child = right]; 
/*  48 */         if (Float.compare(e, t) <= 0)
/*  49 */           break;  heap[i] = t;
/*  50 */         i = child;
/*     */       }  }
/*  52 */     else { int child; while ((child = (i << 1) + 1) < size) {
/*  53 */         float t = heap[child];
...
/*  78 */         int parent = i - 1 >>> 1;
/*  79 */         float t = heap[parent];
/*  80 */         if (Float.compare(t, e) <= 0)
/*  81 */           break;  heap[i] = t;
/*  82 */         i = parent;
/*     */       }  }
/*  84 */     else { while (i != 0) {
/*  85 */         int parent = i - 1 >>> 1;
/*  86 */         float t = heap[parent];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\FloatHeaps.class
