...
/* 150 */     return (ObjectSet)float2IntEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2IntEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Integer.valueOf(entry.getIntValue()));
...
/* 502 */     Integer newValue = remappingFunction.apply(Float.valueOf(key), Integer.valueOf(oldValue));
...
/* 534 */     Integer newValue = remappingFunction.apply(Float.valueOf(key), contained ? Integer.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2IntMap.class
