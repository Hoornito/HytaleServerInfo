...
/*  61 */     return (entries instanceof Float2CharSortedMap.FastSortedEntrySet) ? ((Float2CharSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Float2CharMap.Entry> entries = map.float2CharEntrySet();
/*  77 */     Objects.requireNonNull((Float2CharSortedMap.FastSortedEntrySet)entries); return (entries instanceof Float2CharSortedMap.FastSortedEntrySet) ? (Float2CharSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Float2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Float2CharMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Float, Character>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2CharSortedMap headMap(float to) {
/* 125 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2CharSortedMap tailMap(float from) {
/* 130 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Float2CharMap.Entry>)ObjectSortedSets.singleton(new AbstractFloat2CharMap.BasicEntry(this.key, this.value), Float2CharSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Float2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, Character>> entrySet() {
/* 248 */       return (ObjectSortedSet)float2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/* 260 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2CharSortedMap headMap(float to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2CharSortedMap tailMap(float from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Float2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public float firstFloatKey() {
...
/* 369 */     return new Singleton(key.floatValue(), value.charValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Float2CharMaps.SynchronizedMap implements Float2CharSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Float2CharMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.float2CharEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Float2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, Character>> entrySet() {
/* 440 */       return (ObjectSortedSet)float2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/*     */     extends Float2CharMaps.UnmodifiableMap implements Float2CharSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2CharSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Float2CharMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.float2CharEntrySet()); 
/* 581 */       return (ObjectSortedSet<Float2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2CharSortedMaps.class
