...
/*  50 */     return (entries instanceof Float2ReferenceMap.FastEntrySet) ? ((Float2ReferenceMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
/*  66 */     if (entries instanceof Float2ReferenceMap.FastEntrySet) { ((Float2ReferenceMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
/*  83 */     return (entries instanceof Float2ReferenceMap.FastEntrySet) ? new ObjectIterable<Float2ReferenceMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Float2ReferenceMap.Entry<V>> iterator() {
/*  86 */           return ((Float2ReferenceMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Float2ReferenceMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Float2ReferenceMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 136 */       return (ObjectSet<Float2ReferenceMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 156 */       return Float2ReferenceMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
/* 228 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<>(this.key, this.value)); 
...
/* 241 */       return (ObjectSet)float2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 246 */       if (this.keys == null) this.keys = FloatSets.singleton(this.key); 
...
/*     */     
/*     */     public int hashCode() {
/* 263 */       return HashCommon.float2int(this.key) ^ ((this.value == null) ? 0 : System.identityHashCode(this.value));
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */   
/*     */   public static <V> Float2ReferenceMap<V> singleton(Float key, V value) {
/* 308 */     return new Singleton<>(key.floatValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Float2ReferenceFunctions.SynchronizedFunction<V> implements Float2ReferenceMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 346 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.float2ReferenceEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, V>> entrySet() {
/* 360 */       return (ObjectSet)float2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 365 */       synchronized (this.sync) {
/* 366 */         if (this.keys == null) this.keys = FloatSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Float2ReferenceFunctions.UnmodifiableFunction<V> implements Float2ReferenceMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
/* 660 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.float2ReferenceEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Float, V>> entrySet() {
/* 673 */       return (ObjectSet)float2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public FloatSet keySet() {
/* 678 */       if (this.keys == null) this.keys = FloatSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceMaps.class
