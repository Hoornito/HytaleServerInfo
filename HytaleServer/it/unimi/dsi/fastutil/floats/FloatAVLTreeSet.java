...
/*  843 */       Entry e = (Entry)o;
/*  844 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(e.key));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  849 */       return HashCommon.float2int(this.key);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     SetIterator() {
/*  940 */       this.next = FloatAVLTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(float k) {
/*  944 */       if ((this.next = FloatAVLTreeSet.this.locateKey(k)) != null) {
/*  945 */         if (FloatAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1013 */       updatePrevious();
/* 1014 */       updateNext();
/* 1015 */       FloatAVLTreeSet.this.remove(this.curr.key);
/* 1016 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/* 1037 */     return new Subset(0.0F, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public FloatSortedSet tailSet(float from) {
/* 1042 */     return new Subset(from, false, 0.0F, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1080 */       if (!bottom && !top && FloatAVLTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1081 */       this.from = from;
...
/* 1103 */       return ((this.bottom || FloatAVLTreeSet.this.compare(k, this.from) >= 0) && (this.top || FloatAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1108 */       return (in(k) && FloatAVLTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(float k) {
...
/* 1114 */       return FloatAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1119 */       if (!in(k)) return false; 
/* 1120 */       return FloatAVLTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1141 */       return FloatAVLTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator() {
...
/* 1157 */       return (FloatAVLTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSortedSet tailSet(float from) {
/* 1162 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1163 */       return (FloatAVLTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSortedSet subSet(float from, float to) {
/* 1168 */       if (this.top && this.bottom) return new Subset(from, false, to, false); 
/* 1169 */       if (!this.top) to = (FloatAVLTreeSet.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1170 */       if (!this.bottom) from = (FloatAVLTreeSet.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1181 */       if (FloatAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1185 */       if (this.bottom) { e = FloatAVLTreeSet.this.firstEntry; }
/*      */       else
/* 1187 */       { e = FloatAVLTreeSet.this.locateKey(this.from);
/*      */         
/* 1189 */         if (FloatAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1193 */       if (e == null || (!this.top && FloatAVLTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1194 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       FloatAVLTreeSet.Entry e;
/* 1203 */       if (FloatAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1207 */       if (this.top) { e = FloatAVLTreeSet.this.lastEntry; }
/*      */       else
/* 1209 */       { e = FloatAVLTreeSet.this.locateKey(this.to);
/*      */         
/* 1211 */         if (FloatAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1215 */       if (e == null || (!this.bottom && FloatAVLTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1216 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloat() {
/* 1221 */       FloatAVLTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloat() {
/* 1228 */       FloatAVLTreeSet.Entry e = lastEntry();
...
/*      */     {
/*      */       SubsetIterator() {
/* 1244 */         this.next = FloatAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(float k) {
/* 1248 */         this();
/* 1249 */         if (this.next != null) {
/* 1250 */           if (!FloatAVLTreeSet.Subset.this.bottom && FloatAVLTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1251 */           else if (!FloatAVLTreeSet.Subset.this.top && FloatAVLTreeSet.this.compare(k, (this.prev = FloatAVLTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1253 */           { this.next = FloatAVLTreeSet.this.locateKey(k);
/* 1254 */             if (FloatAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1265 */         if (!FloatAVLTreeSet.Subset.this.bottom && this.prev != null && FloatAVLTreeSet.this.compare(this.prev.key, FloatAVLTreeSet.Subset.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1270 */         this.next = this.next.next();
/* 1271 */         if (!FloatAVLTreeSet.Subset.this.top && this.next != null && FloatAVLTreeSet.this.compare(this.next.key, FloatAVLTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     FloatAVLTreeSet c;
/*      */     try {
/* 1290 */       c = (FloatAVLTreeSet)super.clone();
...
/* 1342 */     for (; n-- != 0; s.writeFloat(i.nextFloat()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1355 */     if (n == 1) {
/* 1356 */       Entry entry = new Entry(s.readFloat());
...
/*      */ 
/*      */       
/* 1364 */       Entry entry = new Entry(s.readFloat());
/* 1365 */       entry.right(new Entry(s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\FloatAVLTreeSet.class
