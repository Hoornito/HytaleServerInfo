...
/*  684 */     for (int i = this.n; i-- != 0;) { if (Float.floatToIntBits(key[i]) != 0 && value[i] == v) return true;  }
/*  685 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  731 */     if (Float.floatToIntBits(k) == Float.floatToIntBits(curr) && v == this.value[pos]) {
/*  732 */       removeEntry(pos);
/*  733 */       return true;
/*      */     } 
/*      */     while (true) {
/*  736 */       if (Float.floatToIntBits(curr = key[pos = pos + 1 & this.mask]) == 0) return false; 
/*  737 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr) && v == this.value[pos]) {
/*  738 */         removeEntry(pos);
/*  739 */         return true;
/*      */       } 
/*      */     } 
...
/*  887 */       return Float2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  892 */       return Float2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Float2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Float2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Float2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  908 */       Float2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatReferencePair<V> right(V v) {
/*  914 */       Float2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  926 */       return Float.valueOf(Float2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  934 */       return (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return HashCommon.float2int(Float2ReferenceLinkedOpenHashMap.this.key[this.index]) ^ ((Float2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Float2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Float2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Float2ReferenceLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(float from) {
/* 1117 */       if (Float.floatToIntBits(from) == 0) {
/* 1118 */         if (Float2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Float2ReferenceLinkedOpenHashMap.this.link[Float2ReferenceLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Float2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.last]) == Float.floatToIntBits(from)) {
/* 1125 */         this.prev = Float2ReferenceLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Float2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[pos]) != 0) {
/* 1133 */         if (Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[pos]) == Float.floatToIntBits(from)) {
/*      */           
/* 1135 */           this.next = (int)Float2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Float2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Float2ReferenceLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Float2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Float2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Float2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Float2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Float2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Float2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Float2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Float2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Float2ReferenceLinkedOpenHashMap.this.link[this.prev] = Float2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Float2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Float2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Float2ReferenceLinkedOpenHashMap.this.link[this.next] = Float2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Float2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Float2ReferenceLinkedOpenHashMap.this.n) {
/* 1227 */         Float2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Float2ReferenceLinkedOpenHashMap.this.value[Float2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         float[] key = Float2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           float curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Float2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if (Float.floatToIntBits(curr = key[pos]) == 0) {
/* 1237 */               key[last] = 0.0F;
/* 1238 */               Float2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ReferenceLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Float2ReferenceLinkedOpenHashMap.this.value[last] = Float2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Float2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2ReferenceMap.Entry<V>>> implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
...
/* 1288 */       action.accept(new Float2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Float2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Float2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Float2ReferenceMap.Entry<V>>> implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
/* 1309 */     final Float2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Float2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Float2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Float2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2ReferenceMap.Entry<V> last() {
/* 1392 */       if (Float2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1404 */       if (Float.floatToIntBits(k) == 0) return (Float2ReferenceLinkedOpenHashMap.this.containsNullKey && Float2ReferenceLinkedOpenHashMap.this.value[Float2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1406 */       float[] key = Float2ReferenceLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1409 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1410 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1413 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1414 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1427 */         if (Float2ReferenceLinkedOpenHashMap.this.containsNullKey && Float2ReferenceLinkedOpenHashMap.this.value[Float2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1428 */           Float2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       float[] key = Float2ReferenceLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1437 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1438 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1439 */         if (Float2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1440 */           Float2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1447 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1448 */           Float2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1449 */           Float2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Float2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Float2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Float2ReferenceLinkedOpenHashMap.EntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Float2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Float2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Float2ReferenceLinkedOpenHashMap.this.size, next = Float2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Float2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Float2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Float2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Float2ReferenceLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Float2ReferenceLinkedOpenHashMap.this.size, next = Float2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Float2ReferenceLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Float2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Float2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1563 */       return Float2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Float2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatListIterator iterator() {
/* 1577 */       return new Float2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2ReferenceLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1593 */       for (int i = Float2ReferenceLinkedOpenHashMap.this.size, next = Float2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Float2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Float2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Float2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1607 */       return Float2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1612 */       int oldSize = Float2ReferenceLinkedOpenHashMap.this.size;
/* 1613 */       Float2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Float2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Float2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloat() {
/* 1624 */       if (Float2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public float lastFloat() {
/* 1630 */       if (Float2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Float2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Float2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Float2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Float2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Float2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Float2ReferenceLinkedOpenHashMap.this.size, next = Float2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Float2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Float2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Float2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Float2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Float2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1855 */       c = (Float2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceLinkedOpenHashMap.class
