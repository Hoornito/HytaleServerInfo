...
/*  520 */     Byte newValue = remappingFunction.apply(Float.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Byte newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  612 */       return Float2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  617 */       return Float2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  622 */       return Float2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  627 */       return Float2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  632 */       byte oldValue = Float2ByteOpenHashMap.this.value[this.index];
/*  633 */       Float2ByteOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBytePair right(byte v) {
/*  639 */       Float2ByteOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  651 */       return Float.valueOf(Float2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Byte.valueOf(Float2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
/*  681 */       return (Float.floatToIntBits(Float2ByteOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return HashCommon.float2int(Float2ByteOpenHashMap.this.key[this.index]) ^ Float2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Float2ByteOpenHashMap.this.key[this.index] + "=>" + Float2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Float2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Float2ByteOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Float2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Float2ByteOpenHashMap.this.n;
/*      */       } 
/*  733 */       float[] key = Float2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask;
/*  740 */           for (; Float.floatToIntBits(k) != Float.floatToIntBits(key[p]); p = p + 1 & Float2ByteOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Float2ByteOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       float[] key = Float2ByteOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask;
/*  760 */           for (; Float.floatToIntBits(k) != Float.floatToIntBits(key[p]); p = p + 1 & Float2ByteOpenHashMap.this.mask);
...
/*  780 */       float[] key = Float2ByteOpenHashMap.this.key; while (true) {
/*      */         float curr; int last;
/*  782 */         pos = (last = pos) + 1 & Float2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if (Float.floatToIntBits(curr = key[pos]) == 0) {
/*  785 */             key[last] = 0.0F;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ByteOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Float2ByteOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */       else
/*      */       
/*  808 */       { Float2ByteOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Float2ByteOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2ByteMap.Entry>> implements ObjectIterator<Float2ByteMap.Entry> { public Float2ByteOpenHashMap.MapEntry next() {
...
/*  835 */       action.accept(this.entry = new Float2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Float2ByteOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Float2ByteOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Float2ByteOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Float2ByteOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       float[] key = Float2ByteOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Float2ByteOpenHashMap.this.n);
/*      */       } 
/*  915 */       float[] key = Float2ByteOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Float2ByteOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Float2ByteOpenHashMap.this.size - this.c), (long)(Float2ByteOpenHashMap.this.realSize() / Float2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       float[] key = Float2ByteOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Float2ByteMap.Entry> action, int index) {
/*  991 */       action.accept(new Float2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Float2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Float2ByteMap.Entry> fastIterator() {
/* 1008 */       return new Float2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Float2ByteMap.Entry> spliterator() {
/* 1013 */       return new Float2ByteOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (Float.floatToIntBits(k) == 0) return (Float2ByteOpenHashMap.this.containsNullKey && Float2ByteOpenHashMap.this.value[Float2ByteOpenHashMap.this.n] == v);
/*      */       
/* 1028 */       float[] key = Float2ByteOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1031 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1032 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1035 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1036 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) return (Float2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1050 */         if (Float2ByteOpenHashMap.this.containsNullKey && Float2ByteOpenHashMap.this.value[Float2ByteOpenHashMap.this.n] == v) {
/* 1051 */           Float2ByteOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       float[] key = Float2ByteOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1060 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1061 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1062 */         if (Float2ByteOpenHashMap.this.value[pos] == v) {
/* 1063 */           Float2ByteOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1070 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1071 */           Float2ByteOpenHashMap.this.value[pos] == v) {
/* 1072 */           Float2ByteOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Float2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Float2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2ByteMap.Entry> consumer) {
/* 1092 */       if (Float2ByteOpenHashMap.this.containsNullKey) consumer.accept(new Float2ByteOpenHashMap.MapEntry(Float2ByteOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Float2ByteOpenHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2ByteOpenHashMap.this.key[pos]) != 0) consumer.accept(new Float2ByteOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2ByteMap.Entry> consumer) {
/* 1099 */       Float2ByteOpenHashMap.MapEntry entry = new Float2ByteOpenHashMap.MapEntry();
/* 1100 */       if (Float2ByteOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Float2ByteOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Float2ByteOpenHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2ByteOpenHashMap.this.key[pos]) != 0) {
...
/* 1135 */       action.accept(Float2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1140 */       return Float2ByteOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1161 */       action.accept(Float2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Float2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSpliterator spliterator() {
/* 1178 */       return new Float2ByteOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1184 */       if (Float2ByteOpenHashMap.this.containsNullKey) consumer.accept(Float2ByteOpenHashMap.this.key[Float2ByteOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Float2ByteOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         float k = Float2ByteOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Float2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1198 */       return Float2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1203 */       int oldSize = Float2ByteOpenHashMap.this.size;
/* 1204 */       Float2ByteOpenHashMap.this.remove(k);
/* 1205 */       return (Float2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Float2ByteOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Float2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1243 */       return Float2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1264 */       action.accept(Float2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Float2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1283 */             return new Float2ByteOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1289 */             if (Float2ByteOpenHashMap.this.containsNullKey) consumer.accept(Float2ByteOpenHashMap.this.value[Float2ByteOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Float2ByteOpenHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2ByteOpenHashMap.this.key[pos]) != 0) consumer.accept(Float2ByteOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Float2ByteOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1300 */             return Float2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Float2ByteOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Float2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteOpenHashMap.class
