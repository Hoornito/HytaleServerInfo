...
/* 156 */     return (ObjectSet)float2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     ObjectSet<Entry<V>> entrySet = float2ObjectEntrySet();
/* 249 */     Consumer<Entry<V>> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), entry.getValue());
...
/* 460 */     V newValue = remappingFunction.apply(Float.valueOf(key), oldValue);
...
/* 491 */     V newValue = remappingFunction.apply(Float.valueOf(key), contained ? oldValue : null);
...
/* 560 */       return Float.valueOf(getFloatKey());
/*     */     }
/*     */     
/*     */     float getFloatKey();
/*     */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ObjectMap.class
