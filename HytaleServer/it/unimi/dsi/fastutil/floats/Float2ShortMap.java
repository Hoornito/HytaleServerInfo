...
/* 150 */     return (ObjectSet)float2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = float2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Float.valueOf(entry.getFloatKey()), Short.valueOf(entry.getShortValue()));
...
/* 502 */     Short newValue = remappingFunction.apply(Float.valueOf(key), Short.valueOf(oldValue));
...
/* 534 */     Short newValue = remappingFunction.apply(Float.valueOf(key), contained ? Short.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2ShortMap.class
