...
/*  167 */     this(k, v, (Comparator<? super Float>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  193 */     return (this.actualComparator == null) ? Float.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  839 */       Map.Entry<Float, Character> e = (Map.Entry<Float, Character>)o;
/*  840 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return HashCommon.float2int(this.key) ^ this.value;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Float2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(float k) {
/*  950 */       if ((this.next = Float2CharRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Float2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Float2CharRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1075 */             if (!(e.getKey() instanceof Float)) return false; 
/* 1076 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1077 */             Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1087 */             if (!(e.getKey() instanceof Float)) return false; 
/* 1088 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1089 */             Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1090 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1091 */             Float2CharRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Float2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Float2CharRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2CharMap.Entry first() {
/* 1107 */             return Float2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Float2CharMap.Entry last() {
/* 1112 */             return Float2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1117 */             return Float2CharRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1122 */             return Float2CharRBTreeMap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1127 */             return Float2CharRBTreeMap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Float2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1169 */       return new Float2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (CharIterator)new Float2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1227 */             return Float2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Float2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Float2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1250 */     return new Submap(0.0F, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Float2CharSortedMap tailMap(float from) {
/* 1255 */     return new Submap(from, false, 0.0F, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1299 */       if (!bottom && !top && Float2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Float2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Float2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2CharRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Float2CharMap.Entry> comparator() {
/* 1341 */               return Float2CharRBTreeMap.this.float2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1349 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1350 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1351 */               Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1352 */               return (f != null && Float2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1360 */               if (e.getKey() == null || !(e.getKey() instanceof Float)) return false; 
/* 1361 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1362 */               Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1363 */               if (f != null && Float2CharRBTreeMap.Submap.this.in(f.key)) Float2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Float2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Float2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Float2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2CharMap.Entry first() {
/* 1386 */               return Float2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Float2CharMap.Entry last() {
/* 1391 */               return Float2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1396 */               return Float2CharRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1401 */               return Float2CharRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1406 */               return Float2CharRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractFloat2CharSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public FloatBidirectionalIterator iterator() {
/* 1415 */         return new Float2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1420 */         return new Float2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1435 */               return (CharIterator)new Float2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1440 */               return Float2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Float2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Float2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1460 */       return (in(k) && Float2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(float k) {
/* 1478 */       float kk = k; Float2CharRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Float2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(float k, char v) {
/* 1484 */       Float2CharRBTreeMap.this.modified = false;
...
/* 1486 */       char oldValue = Float2CharRBTreeMap.this.put(k, v);
/* 1487 */       return Float2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(float k) {
/* 1493 */       Float2CharRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       char oldValue = Float2CharRBTreeMap.this.remove(k);
/* 1496 */       return Float2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1517 */       return Float2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap headMap(float to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Float2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap tailMap(float from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Float2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Float2CharSortedMap subMap(float from, float to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Float2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Float2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Float2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Float2CharRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Float2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Float2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Float2CharRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Float2CharRBTreeMap.Entry e;
/* 1569 */       if (Float2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Float2CharRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Float2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Float2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Float2CharRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public float firstFloatKey() {
/* 1587 */       Float2CharRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1594 */       Float2CharRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Float2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(float k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Float2CharRBTreeMap.Submap.this.bottom && Float2CharRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Float2CharRBTreeMap.Submap.this.top && Float2CharRBTreeMap.this.compare(k, (this.prev = Float2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Float2CharRBTreeMap.this.locateKey(k);
/* 1620 */             if (Float2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Float2CharRBTreeMap.Submap.this.bottom && this.prev != null && Float2CharRBTreeMap.this.compare(this.prev.key, Float2CharRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Float2CharRBTreeMap.Submap.this.top && this.next != null && Float2CharRBTreeMap.this.compare(this.next.key, Float2CharRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Float2CharMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Float2CharRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readFloat(), s.readChar());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readFloat(), s.readChar());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readFloat(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2CharRBTreeMap.class
