...
/*  542 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*      */     implements Float2IntMap.Entry, Map.Entry<Float, Integer>, FloatIntPair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  634 */       return Float2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float leftFloat() {
/*  639 */       return Float2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  644 */       return Float2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  649 */       return Float2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  654 */       int oldValue = Float2IntOpenCustomHashMap.this.value[this.index];
/*  655 */       Float2IntOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatIntPair right(int v) {
/*  661 */       Float2IntOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  673 */       return Float.valueOf(Float2IntOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Integer.valueOf(Float2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       return (Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Float2IntOpenCustomHashMap.this.strategy.hashCode(Float2IntOpenCustomHashMap.this.key[this.index]) ^ Float2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Float2IntOpenCustomHashMap.this.key[this.index] + "=>" + Float2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Float2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Float2IntOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Float2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Float2IntOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       float[] key = Float2IntOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask;
/*  762 */           for (; !Float2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2IntOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Float2IntOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       float[] key = Float2IntOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           float k = this.wrapped.getFloat(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask;
/*  782 */           for (; !Float2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Float2IntOpenCustomHashMap.this.mask);
...
/*  802 */       float[] key = Float2IntOpenCustomHashMap.this.key; while (true) {
/*      */         float curr; int last;
/*  804 */         pos = (last = pos) + 1 & Float2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if (Float.floatToIntBits(curr = key[pos]) == 0) {
/*  807 */             key[last] = 0.0F;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2IntOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Float2IntOpenCustomHashMap.this.value[last] = Float2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Float2IntOpenCustomHashMap.this.n)
/*  826 */       { Float2IntOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Float2IntOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Float2IntOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Float2IntMap.Entry>> implements ObjectIterator<Float2IntMap.Entry> { public Float2IntOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Float2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Float2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Float2IntOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Float2IntOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Float2IntOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Float2IntOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       float[] key = Float2IntOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Float2IntOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       float[] key = Float2IntOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Float2IntOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Float2IntOpenCustomHashMap.this.size - this.c), (long)(Float2IntOpenCustomHashMap.this.realSize() / Float2IntOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       float[] key = Float2IntOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Float2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2IntMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Float2IntMap.Entry> action, int index) {
/* 1013 */       action.accept(new Float2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Float2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Float2IntMap.Entry> fastIterator() {
/* 1030 */       return new Float2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Float2IntMap.Entry> spliterator() {
/* 1035 */       return new Float2IntOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Float2IntOpenCustomHashMap.this.strategy.equals(k, 0.0F)) return (Float2IntOpenCustomHashMap.this.containsNullKey && Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       float[] key = Float2IntOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1053 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Float2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Float2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Float2IntOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
/* 1072 */         if (Float2IntOpenCustomHashMap.this.containsNullKey && Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n] == v) {
/* 1073 */           Float2IntOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       float[] key = Float2IntOpenCustomHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1082 */       if (Float.floatToIntBits(curr = key[pos = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Float2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Float2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Float2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Float2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Float2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Float2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Float2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Float2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
/* 1114 */       if (Float2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(new Float2IntOpenCustomHashMap.MapEntry(Float2IntOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Float2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(new Float2IntOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2IntMap.Entry> consumer) {
/* 1121 */       Float2IntOpenCustomHashMap.MapEntry entry = new Float2IntOpenCustomHashMap.MapEntry();
/* 1122 */       if (Float2IntOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Float2IntOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Float2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[pos]) != 0) {
...
/* 1157 */       action.accept(Float2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1162 */       return Float2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1183 */       action.accept(Float2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Float2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatSpliterator spliterator() {
/* 1200 */       return new Float2IntOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(FloatConsumer consumer) {
/* 1206 */       if (Float2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2IntOpenCustomHashMap.this.key[Float2IntOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Float2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         float k = Float2IntOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Float2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(float k) {
/* 1220 */       return Float2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(float k) {
/* 1225 */       int oldSize = Float2IntOpenCustomHashMap.this.size;
/* 1226 */       Float2IntOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Float2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Float2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Float2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1265 */       return Float2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1286 */       action.accept(Float2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Float2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1305 */             return new Float2IntOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1311 */             if (Float2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Float2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[pos]) != 0) consumer.accept(Float2IntOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Float2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1322 */             return Float2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Float2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Float2IntOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\floats\Float2IntOpenCustomHashMap.class
