...
/* 158 */     return new BooleanBigListIterators.AbstractIndexBasedBigListIterator(0L, index)
/*     */       {
/*     */         protected final boolean get(long i) {
/* 161 */           return AbstractBooleanBigList.this.getBoolean(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void add(long i, boolean k) {
/* 166 */           AbstractBooleanBigList.this.add(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void set(long i, boolean k) {
/* 171 */           AbstractBooleanBigList.this.set(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void remove(long i) {
/* 176 */           AbstractBooleanBigList.this.removeBoolean(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final long getMaxPos() {
/* 181 */           return AbstractBooleanBigList.this.size64();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/*     */     
/*     */     protected final boolean get(long i) {
/* 206 */       return this.l.getBoolean(i);
/*     */     }
/*     */ 
/*     */     
...
/* 228 */     BooleanBigListIterator i = listIterator();
/*     */     
/* 230 */     while (i.hasNext()) {
/* 231 */       boolean e = i.nextBoolean();
...
/* 239 */     BooleanBigListIterator i = listIterator(size64());
/*     */     
/* 241 */     while (i.hasPrevious()) {
/* 242 */       boolean e = i.previousBoolean();
...
/* 250 */     long i = size64();
/* 251 */     if (size > i) { for (; i++ < size; add(false)); }
...
/* 260 */     return (this instanceof RandomAccess) ? new BooleanRandomAccessSubList(this, from, to) : new BooleanSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 274 */         action.accept(getBoolean(i));
/*     */       }
/*     */     } else {
...
/* 290 */     ensureIndex(to);
/* 291 */     BooleanBigListIterator i = listIterator(from);
/* 292 */     long n = to - from;
...
/*     */     //   43: ladd
/*     */     //   44: lstore #4
/*     */     //   46: invokestatic get : ([[ZJ)Z
/*     */     //   49: invokevirtual add : (JZ)V
/*     */     //   52: goto -> 20
/*     */     //   55: aload_0
/*     */     //   56: lload_1
/*     */     //   57: invokevirtual listIterator : (J)Lit/unimi/dsi/fastutil/booleans/BooleanBigListIterator;
/*     */     //   60: astore #8
/*     */     //   62: lload #6
/*     */     //   64: dup2
/*     */     //   65: lconst_1
...
/*     */     //   81: ladd
/*     */     //   82: lstore #4
/*     */     //   84: invokestatic get : ([[ZJ)Z
/*     */     //   87: invokeinterface add : (Z)V
/*     */     //   92: goto -> 62
/*     */     //   95: return
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
...
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	descriptor
/*     */     //   62	33	8	iter	Lit/unimi/dsi/fastutil/booleans/BooleanBigListIterator;
/*     */     //   0	96	0	this	Lit/unimi/dsi/fastutil/booleans/AbstractBooleanBigList;
/*     */     //   0	96	1	index	J
/*     */     //   0	96	3	a	[[Z
/*     */     //   0	96	4	offset	J
/*     */     //   0	96	6	length	J
...
/*     */     //   107: ladd
/*     */     //   108: lstore #8
/*     */     //   110: invokevirtual getBoolean : (J)Z
/*     */     //   113: invokestatic set : ([[ZJZ)V
/*     */     //   116: goto -> 82
/*     */     //   119: goto -> 162
/*     */     //   122: aload_0
/*     */     //   123: lload_1
/*     */     //   124: invokevirtual listIterator : (J)Lit/unimi/dsi/fastutil/booleans/BooleanBigListIterator;
/*     */     //   127: astore #8
/*     */     //   129: lload #6
/*     */     //   131: dup2
/*     */     //   132: lconst_1
...
/*     */     //   147: lstore #4
/*     */     //   149: aload #8
/*     */     //   151: invokeinterface nextBoolean : ()Z
/*     */     //   156: invokestatic set : ([[ZJZ)V
/*     */     //   159: goto -> 129
/*     */     //   162: return
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
...
/*     */     //   start	length	slot	name	descriptor
/*     */     //   82	37	8	current	J
/*     */     //   129	33	8	i	Lit/unimi/dsi/fastutil/booleans/BooleanBigListIterator;
/*     */     //   0	163	0	this	Lit/unimi/dsi/fastutil/booleans/AbstractBooleanBigList;
/*     */     //   0	163	1	from	J
/*     */     //   0	163	3	a	[[Z
/*     */     //   0	163	4	offset	J
/*     */     //   0	163	6	length	J
...
/*     */       }
/*     */     } else {
/* 360 */       BooleanBigListIterator iter = listIterator(index);
/* 361 */       long i = 0L;
/* 362 */       if (i < length) {
/* 363 */         iter.nextBoolean();
...
/*     */   
/*     */   public int hashCode() {
/* 398 */     BooleanIterator i = iterator();
/* 399 */     int h = 1;
/* 400 */     long s = size64();
/* 401 */     while (s-- != 0L) {
/* 402 */       boolean k = i.nextBoolean();
/* 403 */       h = 31 * h + (k ? 1231 : 1237);
/*     */     } 
/* 405 */     return h;
/*     */   }
/*     */ 
...
/* 415 */     if (l instanceof BooleanBigList) {
/* 416 */       BooleanBigListIterator booleanBigListIterator1 = listIterator(), booleanBigListIterator2 = ((BooleanBigList)l).listIterator();
/* 417 */       while (s-- != 0L) { if (booleanBigListIterator1.nextBoolean() != booleanBigListIterator2.nextBoolean()) return false;  }
/* 418 */        return true;
/*     */     } 
...
/* 438 */     if (l instanceof BooleanBigList) {
/* 439 */       BooleanBigListIterator booleanBigListIterator1 = listIterator(), booleanBigListIterator2 = ((BooleanBigList)l).listIterator();
/*     */ 
/*     */       
/* 442 */       while (booleanBigListIterator1.hasNext() && booleanBigListIterator2.hasNext()) {
/* 443 */         boolean e1 = booleanBigListIterator1.nextBoolean();
/* 444 */         boolean e2 = booleanBigListIterator2.nextBoolean(); int r;
/* 445 */         if ((r = Boolean.compare(e1, e2)) != 0) return r; 
/*     */       } 
/* 447 */       return booleanBigListIterator2.hasNext() ? -1 : (booleanBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 449 */     BigListIterator<? extends Boolean> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 465 */     return removeBoolean(size64() - 1L);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean topBoolean() {
/* 470 */     if (isEmpty()) throw new NoSuchElementException(); 
/* 471 */     return getBoolean(size64() - 1L);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean peekBoolean(int i) {
/* 476 */     return getBoolean(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 537 */     return Boolean.valueOf(set(index, ok.booleanValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 549 */     return Boolean.valueOf(getBoolean(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 573 */     return lastIndexOf(((Boolean)ok).booleanValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 585 */     return Boolean.valueOf(removeBoolean(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Boolean pop() {
/* 609 */     return Boolean.valueOf(popBoolean());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Boolean top() {
/* 621 */     return Boolean.valueOf(topBoolean());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 633 */     return Boolean.valueOf(peekBoolean(i));
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 638 */     StringBuilder s = new StringBuilder();
/* 639 */     BooleanIterator i = iterator();
/* 640 */     long n = size64();
/*     */     
...
/* 709 */       this.to--;
/* 710 */       return this.l.removeBoolean(this.from + index);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean set(long index, boolean k) {
...
/*     */       
/*     */       protected final boolean get(long i) {
/* 759 */         return AbstractBooleanBigList.BooleanSubList.this.l.getBoolean(AbstractBooleanBigList.BooleanSubList.this.from + i);
/*     */       }
/*     */ 
/*     */ 
/*     */       
/*     */       protected final void add(long i, boolean k) {
/* 765 */         AbstractBooleanBigList.BooleanSubList.this.add(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void set(long i, boolean k) {
/* 770 */         AbstractBooleanBigList.BooleanSubList.this.set(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void remove(long i) {
/* 775 */         AbstractBooleanBigList.BooleanSubList.this.removeBoolean(i);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final long getMaxPos() {
/* 780 */         return AbstractBooleanBigList.BooleanSubList.this.to - AbstractBooleanBigList.BooleanSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(boolean k) {
/* 785 */         super.add(k);
/* 786 */         assert AbstractBooleanBigList.BooleanSubList.this.assertRange();
/*     */       }
/*     */ 
/*     */       
/*     */       public void remove() {
/* 791 */         super.remove();
/* 792 */         assert AbstractBooleanBigList.BooleanSubList.this.assertRange();
/*     */       }
/*     */     }
/*     */     
...
/* 805 */         return this.parent.nextIndex() - AbstractBooleanBigList.BooleanSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public long previousIndex() {
/* 810 */         return this.parent.previousIndex() - AbstractBooleanBigList.BooleanSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasNext() {
/* 815 */         return (this.parent.nextIndex() < AbstractBooleanBigList.BooleanSubList.this.to);
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasPrevious() {
/* 820 */         return (this.parent.previousIndex() >= AbstractBooleanBigList.BooleanSubList.this.from);
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean nextBoolean() {
/* 825 */         if (!hasNext()) throw new NoSuchElementException(); 
/* 826 */         return this.parent.nextBoolean();
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean previousBoolean() {
/* 831 */         if (!hasPrevious()) throw new NoSuchElementException(); 
/* 832 */         return this.parent.previousBoolean();
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(boolean k) {
...
/*     */ 
/*     */         
/* 858 */         if (parentNewPos < AbstractBooleanBigList.BooleanSubList.this.from - 1L) parentNewPos = AbstractBooleanBigList.BooleanSubList.this.from - 1L; 
...
/* 868 */         if (parentNewPos > AbstractBooleanBigList.BooleanSubList.this.to) parentNewPos = AbstractBooleanBigList.BooleanSubList.this.to; 
...
/* 886 */       return (this.l instanceof RandomAccess) ? new AbstractBooleanBigList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator();
/*     */     }
/*     */ 
/*     */     
/*     */     public BooleanBigList subList(long from, long to) {
...
/*     */ 
/*     */       
/* 896 */       return new BooleanSubList(this, from, to);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean rem(boolean k) {
...
/* 903 */       this.to--;
/* 904 */       this.l.removeBoolean(this.from + index);
...
/*     */ 
/*     */       
/* 934 */       return new BooleanRandomAccessSubList(this, from, to);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\booleans\AbstractBooleanBigList.class
