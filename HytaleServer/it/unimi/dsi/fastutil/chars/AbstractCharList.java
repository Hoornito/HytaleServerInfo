...
/* 114 */     if (c instanceof CharCollection) {
/* 115 */       return addAll(index, (CharCollection)c);
/*     */     }
/* 117 */     ensureIndex(index);
/* 118 */     Iterator<? extends Character> i = c.iterator();
/* 119 */     boolean retVal = i.hasNext();
/* 120 */     for (; i.hasNext(); add(index++, ((Character)i.next()).charValue()));
/* 121 */     return retVal;
/*     */   }
/*     */ 
/*     */ 
...
/* 163 */     return new CharIterators.AbstractIndexBasedListIterator(0, index)
/*     */       {
/*     */         protected final char get(int i) {
/* 166 */           return AbstractCharList.this.getChar(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void add(int i, char k) {
/* 171 */           AbstractCharList.this.add(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void set(int i, char k) {
/* 176 */           AbstractCharList.this.set(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void remove(int i) {
/* 181 */           AbstractCharList.this.removeChar(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final int getMaxPos() {
/* 186 */           return AbstractCharList.this.size();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 233 */     CharListIterator i = listIterator();
/*     */     
/* 235 */     while (i.hasNext()) {
/* 236 */       char e = i.nextChar();
...
/* 244 */     CharListIterator i = listIterator(size());
/*     */     
/* 246 */     while (i.hasPrevious()) {
/* 247 */       char e = i.previousChar();
...
/* 257 */     else { for (; i-- != size; removeChar(i)); }
/*     */   
/*     */   }
/*     */   
...
/* 265 */     return (this instanceof RandomAccess) ? new CharRandomAccessSubList(this, from, to) : new CharSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 298 */     CharListIterator i = listIterator(from);
/* 299 */     int n = to - from;
...
/*     */     } else {
/* 321 */       CharListIterator iter = listIterator(index);
...
/* 346 */     CharArrays.ensureOffsetLength(a, offset, length);
...
/* 350 */       for (; length-- != 0; a[offset++] = getChar(current++));
/*     */     } else {
/* 352 */       CharListIterator i = listIterator(from);
/* 353 */       for (; length-- != 0; a[offset++] = i.nextChar());
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 360 */     CharArrays.ensureOffsetLength(a, offset, length);
...
/*     */       }
/*     */     } else {
/* 367 */       CharListIterator iter = listIterator(index);
/* 368 */       int i = 0;
/* 369 */       while (i < length) {
/* 370 */         iter.nextChar();
...
/*     */   
/*     */   public int hashCode() {
/* 393 */     CharIterator i = iterator();
/* 394 */     int h = 1, s = size();
/* 395 */     while (s-- != 0) {
/* 396 */       char k = i.nextChar();
/* 397 */       h = 31 * h + k;
/*     */     } 
/* 399 */     return h;
/*     */   }
...
/* 409 */     if (l instanceof CharList) {
/* 410 */       CharListIterator charListIterator1 = listIterator(), charListIterator2 = ((CharList)l).listIterator();
/* 411 */       while (s-- != 0) { if (charListIterator1.nextChar() != charListIterator2.nextChar()) return false;  }
/* 412 */        return true;
/*     */     } 
...
/* 433 */     if (l instanceof CharList) {
/* 434 */       CharListIterator charListIterator1 = listIterator(), charListIterator2 = ((CharList)l).listIterator();
/*     */ 
/*     */       
/* 437 */       while (charListIterator1.hasNext() && charListIterator2.hasNext()) {
/* 438 */         char e1 = charListIterator1.nextChar();
/* 439 */         char e2 = charListIterator2.nextChar(); int r;
/* 440 */         if ((r = Character.compare(e1, e2)) != 0) return r; 
/*     */       } 
/* 442 */       return charListIterator2.hasNext() ? -1 : (charListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 444 */     ListIterator<? extends Character> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 460 */     return removeChar(size() - 1);
/*     */   }
/*     */ 
/*     */   
/*     */   public char topChar() {
/* 465 */     if (isEmpty()) throw new NoSuchElementException(); 
/* 466 */     return getChar(size() - 1);
/*     */   }
/*     */ 
/*     */   
/*     */   public char peekChar(int i) {
/* 471 */     return getChar(size() - 1 - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 491 */     int size = size();
/* 492 */     if (size == 0) return CharArrays.EMPTY_ARRAY; 
/* 493 */     char[] ret = new char[size];
...
/* 511 */     CharIterator i = c.iterator();
/* 512 */     boolean retVal = i.hasNext();
/* 513 */     for (; i.hasNext(); add(index++, i.nextChar()));
/* 514 */     return retVal;
/*     */   }
/*     */ 
/*     */ 
...
/* 595 */       return this.l.getChar(this.from + index);
/*     */     }
/*     */ 
/*     */     
...
/* 601 */       this.to--;
/* 602 */       return this.l.removeChar(this.from + index);
/*     */     }
/*     */ 
/*     */     
/*     */     public char set(int index, char k) {
...
/*     */       
/*     */       protected final char get(int i) {
/* 658 */         return AbstractCharList.CharSubList.this.l.getChar(AbstractCharList.CharSubList.this.from + i);
/*     */       }
/*     */ 
/*     */ 
/*     */       
/*     */       protected final void add(int i, char k) {
/* 664 */         AbstractCharList.CharSubList.this.add(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void set(int i, char k) {
/* 669 */         AbstractCharList.CharSubList.this.set(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void remove(int i) {
/* 674 */         AbstractCharList.CharSubList.this.removeChar(i);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final int getMaxPos() {
/* 679 */         return AbstractCharList.CharSubList.this.to - AbstractCharList.CharSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(char k) {
/* 684 */         super.add(k);
/* 685 */         assert AbstractCharList.CharSubList.this.assertRange();
/*     */       }
/*     */ 
/*     */       
/*     */       public void remove() {
/* 690 */         super.remove();
/* 691 */         assert AbstractCharList.CharSubList.this.assertRange();
/*     */       }
/*     */     }
/*     */     
...
/* 704 */         return this.parent.nextIndex() - AbstractCharList.CharSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public int previousIndex() {
/* 709 */         return this.parent.previousIndex() - AbstractCharList.CharSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasNext() {
/* 714 */         return (this.parent.nextIndex() < AbstractCharList.CharSubList.this.to);
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasPrevious() {
/* 719 */         return (this.parent.previousIndex() >= AbstractCharList.CharSubList.this.from);
/*     */       }
/*     */ 
/*     */       
/*     */       public char nextChar() {
/* 724 */         if (!hasNext()) throw new NoSuchElementException(); 
/* 725 */         return this.parent.nextChar();
/*     */       }
/*     */ 
/*     */       
/*     */       public char previousChar() {
/* 730 */         if (!hasPrevious()) throw new NoSuchElementException(); 
/* 731 */         return this.parent.previousChar();
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(char k) {
...
/*     */ 
/*     */         
/* 757 */         if (parentNewPos < AbstractCharList.CharSubList.this.from - 1) parentNewPos = AbstractCharList.CharSubList.this.from - 1; 
...
/* 767 */         if (parentNewPos > AbstractCharList.CharSubList.this.to) parentNewPos = AbstractCharList.CharSubList.this.to; 
...
/* 785 */       return (this.l instanceof RandomAccess) ? new AbstractCharList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharList subList(int from, int to) {
...
/*     */ 
/*     */       
/* 795 */       return new CharSubList(this, from, to);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean rem(char k) {
...
/* 802 */       this.to--;
/* 803 */       this.l.removeChar(this.from + index);
...
/*     */ 
/*     */       
/* 835 */       return new CharRandomAccessSubList(this, from, to);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\AbstractCharList.class
