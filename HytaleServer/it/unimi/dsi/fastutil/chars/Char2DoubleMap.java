...
/* 150 */     return (ObjectSet)char2DoubleEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = char2DoubleEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Character.valueOf(entry.getCharKey()), Double.valueOf(entry.getDoubleValue()));
...
/* 502 */     Double newValue = remappingFunction.apply(Character.valueOf(key), Double.valueOf(oldValue));
...
/* 534 */     Double newValue = remappingFunction.apply(Character.valueOf(key), contained ? Double.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleMap.class
