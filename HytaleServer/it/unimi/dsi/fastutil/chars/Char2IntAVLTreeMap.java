...
/*  885 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2IntAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2IntAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1147 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1148 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1149 */             Char2IntAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2IntAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2IntMap.Entry first() {
/* 1165 */             return Char2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2IntMap.Entry last() {
/* 1170 */             return Char2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1175 */             return Char2IntAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1180 */             return Char2IntAVLTreeMap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1185 */             return Char2IntAVLTreeMap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (IntIterator)new Char2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1285 */             return Char2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Char2IntAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2IntMap.Entry> comparator() {
/* 1399 */               return Char2IntAVLTreeMap.this.char2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2IntAVLTreeMap.Submap.this.in(f.key)) Char2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2IntMap.Entry first() {
/* 1444 */               return Char2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2IntMap.Entry last() {
/* 1449 */               return Char2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1454 */               return Char2IntAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1459 */               return Char2IntAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1464 */               return Char2IntAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1493 */               return (IntIterator)new Char2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1498 */               return Char2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(char k) {
/* 1536 */       char kk = k; Char2IntAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(char k, int v) {
/* 1542 */       Char2IntAVLTreeMap.this.modified = false;
...
/* 1544 */       int oldValue = Char2IntAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(char k) {
/* 1551 */       Char2IntAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       int oldValue = Char2IntAVLTreeMap.this.remove(k);
/* 1554 */       return Char2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Char2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2IntAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2IntAVLTreeMap.Entry e;
/* 1627 */       if (Char2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2IntAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2IntAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2IntAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Char2IntAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2IntAVLTreeMap.Submap.this.bottom && Char2IntAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2IntAVLTreeMap.Submap.this.top && Char2IntAVLTreeMap.this.compare(k, (this.prev = Char2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2IntAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Char2IntAVLTreeMap.this.compare(this.prev.key, Char2IntAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2IntAVLTreeMap.Submap.this.top && this.next != null && Char2IntAVLTreeMap.this.compare(this.next.key, Char2IntAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Char2IntAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readInt());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readInt());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntAVLTreeMap.class
