...
/*  50 */     return (entries instanceof Char2LongMap.FastEntrySet) ? ((Char2LongMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Char2LongMap.Entry> entries = map.char2LongEntrySet();
/*  66 */     if (entries instanceof Char2LongMap.FastEntrySet) { ((Char2LongMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Char2LongMap.Entry> entries = map.char2LongEntrySet();
/*  83 */     return (entries instanceof Char2LongMap.FastEntrySet) ? new ObjectIterable<Char2LongMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Char2LongMap.Entry> iterator() {
/*  86 */           return ((Char2LongMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Char2LongMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Char2LongMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractChar2LongMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)char2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/* 316 */     return new Singleton(key.charValue(), value.longValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Char2LongFunctions.SynchronizedFunction implements Char2LongMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.char2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Long>> entrySet() {
/* 381 */       return (ObjectSet)char2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/*     */     extends Char2LongFunctions.UnmodifiableFunction implements Char2LongMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2LongMap map;
/*     */     protected transient ObjectSet<Char2LongMap.Entry> entries;
/*     */     protected transient CharSet keys;
...
/*     */     
/*     */     public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.char2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Long>> entrySet() {
/* 712 */       return (ObjectSet)char2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2LongMaps.class
