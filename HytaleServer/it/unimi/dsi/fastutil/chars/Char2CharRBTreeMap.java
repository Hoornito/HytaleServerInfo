...
/*      */ 
/*      */ 
/*      */ public class Char2CharRBTreeMap
...
/*   87 */     this.actualComparator = CharComparators.asCharComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  163 */     this(k, v, (Comparator<? super Character>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     return (this.actualComparator == null) ? Character.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  248 */     Entry e = add(k);
/*  249 */     char oldValue = e.value;
/*  250 */     e.value = (char)(e.value + incr);
/*  251 */     return oldValue;
/*      */   }
/*      */ 
/*      */   
...
/*  835 */       Map.Entry<Character, Character> e = (Map.Entry<Character, Character>)o;
/*  836 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  942 */       this.next = Char2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  946 */       if ((this.next = Char2CharRBTreeMap.this.locateKey(k)) != null)
/*  947 */         if (Char2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1000 */       updatePrevious();
/* 1001 */       updateNext();
/* 1002 */       Char2CharRBTreeMap.this.remove(this.curr.key);
/* 1003 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1047 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2CharMap.Entry>)new AbstractObjectSortedSet<Char2CharMap.Entry>()
/*      */         {
...
/* 1057 */             return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from) {
/* 1062 */             return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1071 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1072 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1073 */             Char2CharRBTreeMap.Entry f = Char2CharRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1083 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1084 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1085 */             Char2CharRBTreeMap.Entry f = Char2CharRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1086 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1087 */             Char2CharRBTreeMap.this.remove(f.key);
/* 1088 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1093 */             return Char2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1098 */             Char2CharRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2CharMap.Entry first() {
/* 1103 */             return Char2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2CharMap.Entry last() {
/* 1108 */             return Char2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry to) {
/* 1113 */             return Char2CharRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry to) {
/* 1118 */             return Char2CharRBTreeMap.this.headMap(to.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from) {
/* 1123 */             return Char2CharRBTreeMap.this.tailMap(from.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1160 */       return new Char2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1165 */       return new Char2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */     if (this.values == null) this.values = new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1218 */             return new Char2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1223 */             return Char2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1228 */             return Char2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1233 */             Char2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1246 */     return new Submap(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Char2CharSortedMap tailMap(char from) {
/* 1251 */     return new Submap(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1295 */       if (!bottom && !top && Char2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1296 */       this.from = from;
/* 1297 */       this.bottom = bottom;
/* 1298 */       this.to = to;
/* 1299 */       this.top = top;
/* 1300 */       this.defRetValue = Char2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1319 */       return ((this.bottom || Char2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2CharRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
/* 1324 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2CharMap.Entry>)new AbstractObjectSortedSet<Char2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator() {
/* 1327 */               return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from) {
/* 1332 */               return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2CharMap.Entry> comparator() {
/* 1337 */               return Char2CharRBTreeMap.this.char2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1345 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1346 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1347 */               Char2CharRBTreeMap.Entry f = Char2CharRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1348 */               return (f != null && Char2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1356 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1357 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1358 */               Char2CharRBTreeMap.Entry f = Char2CharRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1359 */               if (f != null && Char2CharRBTreeMap.Submap.this.in(f.key)) Char2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1365 */               int c = 0;
/* 1366 */               for (ObjectBidirectionalIterator<Char2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1367 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Char2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Char2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2CharMap.Entry first() {
/* 1382 */               return Char2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2CharMap.Entry last() {
/* 1387 */               return Char2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry to) {
/* 1392 */               return Char2CharRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry to) {
/* 1397 */               return Char2CharRBTreeMap.Submap.this.headMap(to.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from) {
/* 1402 */               return Char2CharRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1411 */         return new Char2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1416 */         return new Char2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public CharCollection values() {
/* 1428 */       if (this.values == null) this.values = new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1431 */               return new Char2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1436 */               return Char2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Char2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Char2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1456 */       return (in(k) && Char2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(char k) {
/* 1474 */       char kk = k; Char2CharRBTreeMap.Entry e;
/* 1475 */       return (in(kk) && (e = Char2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(char k, char v) {
/* 1480 */       Char2CharRBTreeMap.this.modified = false;
...
/* 1482 */       char oldValue = Char2CharRBTreeMap.this.put(k, v);
/* 1483 */       return Char2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(char k) {
/* 1489 */       Char2CharRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k)) return this.defRetValue; 
/* 1491 */       char oldValue = Char2CharRBTreeMap.this.remove(k);
/* 1492 */       return Char2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1513 */       return Char2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharSortedMap headMap(char to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Char2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharSortedMap tailMap(char from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Char2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharSortedMap subMap(char from, char to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Char2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Char2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Char2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Char2CharRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Char2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Char2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Char2CharRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2CharRBTreeMap.Entry e;
/* 1565 */       if (Char2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Char2CharRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Char2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Char2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Char2CharRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1583 */       Char2CharRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1590 */       Char2CharRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Char2CharRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Char2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Char2CharRBTreeMap.Submap.this.bottom && Char2CharRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Char2CharRBTreeMap.Submap.this.top && Char2CharRBTreeMap.this.compare(k, (this.prev = Char2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Char2CharRBTreeMap.this.locateKey(k);
/* 1616 */             if (Char2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Char2CharRBTreeMap.Submap.this.bottom && this.prev != null && Char2CharRBTreeMap.this.compare(this.prev.key, Char2CharRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Char2CharRBTreeMap.Submap.this.top && this.next != null && Char2CharRBTreeMap.this.compare(this.next.key, Char2CharRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Char2CharRBTreeMap)super.clone();
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry entry = new Entry(s.readChar(), s.readChar());
...
/*      */ 
/*      */       
/* 1804 */       Entry entry = new Entry(s.readChar(), s.readChar());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry(s.readChar(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2CharRBTreeMap.class
