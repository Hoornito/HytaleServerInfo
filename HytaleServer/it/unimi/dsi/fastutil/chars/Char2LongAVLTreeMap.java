...
/*  885 */       Map.Entry<Character, Long> e = (Map.Entry<Character, Long>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return this.key ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2LongAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2LongAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2LongMap.Entry>)new AbstractObjectSortedSet<Char2LongMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1147 */             Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1148 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1149 */             Char2LongAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2LongAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2LongMap.Entry first() {
/* 1165 */             return Char2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2LongMap.Entry last() {
/* 1170 */             return Char2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) {
/* 1175 */             return Char2LongAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) {
/* 1180 */             return Char2LongAVLTreeMap.this.headMap(to.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) {
/* 1185 */             return Char2LongAVLTreeMap.this.tailMap(from.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (LongIterator)new Char2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1285 */             return Char2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Char2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2LongMap.Entry>)new AbstractObjectSortedSet<Char2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2LongMap.Entry> comparator() {
/* 1399 */               return Char2LongAVLTreeMap.this.char2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2LongAVLTreeMap.Submap.this.in(f.key)) Char2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2LongMap.Entry first() {
/* 1444 */               return Char2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2LongMap.Entry last() {
/* 1449 */               return Char2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) {
/* 1454 */               return Char2LongAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) {
/* 1459 */               return Char2LongAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) {
/* 1464 */               return Char2LongAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2LongSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public LongIterator iterator() {
/* 1493 */               return (LongIterator)new Char2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1498 */               return Char2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(char k) {
/* 1536 */       char kk = k; Char2LongAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(char k, long v) {
/* 1542 */       Char2LongAVLTreeMap.this.modified = false;
...
/* 1544 */       long oldValue = Char2LongAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(char k) {
/* 1551 */       Char2LongAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       long oldValue = Char2LongAVLTreeMap.this.remove(k);
/* 1554 */       return Char2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Char2LongAVLTreeMap.Entry e;
/* 1605 */       if (Char2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2LongAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2LongAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2LongAVLTreeMap.Entry e;
/* 1627 */       if (Char2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2LongAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2LongAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2LongAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2LongAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2LongAVLTreeMap.Submap.this.bottom && Char2LongAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2LongAVLTreeMap.Submap.this.top && Char2LongAVLTreeMap.this.compare(k, (this.prev = Char2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2LongAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Char2LongAVLTreeMap.this.compare(this.prev.key, Char2LongAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2LongAVLTreeMap.Submap.this.top && this.next != null && Char2LongAVLTreeMap.this.compare(this.next.key, Char2LongAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Char2LongAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readLong());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readLong());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2LongAVLTreeMap.class
