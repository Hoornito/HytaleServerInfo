...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Char2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Char2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.charValue(), value.longValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractChar2LongFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2LongFunction function;
/*     */     
...
/* 550 */       Long v = this.function.apply(Character.valueOf(key));
...
/* 557 */       Long v = this.function.apply(Character.valueOf(key));
...
/* 603 */     if (f instanceof Char2LongFunction) return (Char2LongFunction)f; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2LongFunctions.class
