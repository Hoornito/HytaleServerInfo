...
/*  819 */       Map.Entry<Character, V> e = (Map.Entry<Character, V>)o;
/*  820 */       return (this.key == ((Character)e.getKey()).charValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return this.key ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Char2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  930 */       if ((this.next = Char2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Char2ObjectRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1046 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1055 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1056 */             Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1066 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1067 */             Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1068 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1069 */             Char2ObjectRBTreeMap.this.remove(f.key);
/* 1070 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1075 */             return Char2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1080 */             Char2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ObjectMap.Entry<V> first() {
/* 1085 */             return Char2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ObjectMap.Entry<V> last() {
/* 1090 */             return Char2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1095 */             return Char2ObjectRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1100 */             return Char2ObjectRBTreeMap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1105 */             return Char2ObjectRBTreeMap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1142 */       return new Char2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1147 */       return new Char2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1200 */             return (ObjectIterator<V>)new Char2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1205 */             return Char2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1210 */             return Char2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1215 */             Char2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1228 */     return new Submap(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Char2ObjectSortedMap<V> tailMap(char from) {
/* 1233 */     return new Submap(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1277 */       if (!bottom && !top && Char2ObjectRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1278 */       this.from = from;
...
/* 1301 */       return ((this.bottom || Char2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
/* 1306 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator() {
/* 1309 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1314 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2ObjectMap.Entry<V>> comparator() {
/* 1319 */               return Char2ObjectRBTreeMap.this.char2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1327 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1328 */               Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1329 */               return (f != null && Char2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1337 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1338 */               Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1339 */               if (f != null && Char2ObjectRBTreeMap.Submap.this.in(f.key)) Char2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1340 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1345 */               int c = 0;
/* 1346 */               for (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1347 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1352 */               return !(new Char2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1357 */               Char2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ObjectMap.Entry<V> first() {
/* 1362 */               return Char2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ObjectMap.Entry<V> last() {
/* 1367 */               return Char2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1372 */               return Char2ObjectRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1377 */               return Char2ObjectRBTreeMap.Submap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1382 */               return Char2ObjectRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */           }; 
/* 1385 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2ObjectSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1391 */         return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1396 */         return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1411 */               return (ObjectIterator<V>)new Char2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1416 */               return Char2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1421 */               return Char2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1426 */               Char2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1436 */       return (in(k) && Char2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(char k) {
/* 1454 */       char kk = k; Char2ObjectRBTreeMap.Entry<V> e;
/* 1455 */       return (in(kk) && (e = Char2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(char k, V v) {
/* 1460 */       Char2ObjectRBTreeMap.this.modified = false;
...
/* 1462 */       V oldValue = Char2ObjectRBTreeMap.this.put(k, v);
/* 1463 */       return Char2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(char k) {
/* 1469 */       Char2ObjectRBTreeMap.this.modified = false;
/* 1470 */       if (!in(k)) return this.defRetValue; 
/* 1471 */       V oldValue = Char2ObjectRBTreeMap.this.remove(k);
/* 1472 */       return Char2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1493 */       return Char2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> headMap(char to) {
/* 1498 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1499 */       return (Char2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> tailMap(char from) {
/* 1504 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1505 */       return (Char2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> subMap(char from, char to) {
/* 1510 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1511 */       if (!this.top) to = (Char2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1512 */       if (!this.bottom) from = (Char2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1523 */       if (Char2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1527 */       if (this.bottom) { e = Char2ObjectRBTreeMap.this.firstEntry; }
/*      */       else
/* 1529 */       { e = Char2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1531 */         if (Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1535 */       if (e == null || (!this.top && Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1536 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2ObjectRBTreeMap.Entry<V> e;
/* 1545 */       if (Char2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1549 */       if (this.top) { e = Char2ObjectRBTreeMap.this.lastEntry; }
/*      */       else
/* 1551 */       { e = Char2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1553 */         if (Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1557 */       if (e == null || (!this.bottom && Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1558 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1563 */       Char2ObjectRBTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1570 */       Char2ObjectRBTreeMap.Entry<V> e = lastEntry();
...
/*      */       extends Char2ObjectRBTreeMap<V>.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1586 */         this.next = Char2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1590 */         this();
/* 1591 */         if (this.next != null) {
/* 1592 */           if (!Char2ObjectRBTreeMap.Submap.this.bottom && Char2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1593 */           else if (!Char2ObjectRBTreeMap.Submap.this.top && Char2ObjectRBTreeMap.this.compare(k, (this.prev = Char2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1595 */           { this.next = Char2ObjectRBTreeMap.this.locateKey(k);
/* 1596 */             if (Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1607 */         if (!Char2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Char2ObjectRBTreeMap.this.compare(this.prev.key, Char2ObjectRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1612 */         this.next = this.next.next();
/* 1613 */         if (!Char2ObjectRBTreeMap.Submap.this.top && this.next != null && Char2ObjectRBTreeMap.this.compare(this.next.key, Char2ObjectRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1701 */       c = (Char2ObjectRBTreeMap<V>)super.clone();
...
/* 1774 */     if (n == 1) {
/* 1775 */       Entry<V> entry = new Entry<>(s.readChar(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1784 */       Entry<V> entry = new Entry<>(s.readChar(), (V)s.readObject());
/* 1785 */       entry.black(true);
/* 1786 */       entry.right(new Entry<>(s.readChar(), (V)s.readObject()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectRBTreeMap.class
