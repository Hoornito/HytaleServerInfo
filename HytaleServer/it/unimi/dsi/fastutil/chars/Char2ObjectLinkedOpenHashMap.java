...
/*  684 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Objects.equals(value[i], v)) return true;  }
/*  685 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  887 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  892 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*  908 */       Char2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharObjectPair<V> right(V v) {
/*  914 */       Char2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  926 */       return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  934 */       return (Char2ObjectLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index] ^ ((Char2ObjectLinkedOpenHashMap.this.value[this.index] == null) ? 0 : Char2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Char2ObjectLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1117 */       if (from == '\000') {
/* 1118 */         if (Char2ObjectLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Char2ObjectLinkedOpenHashMap.this.link[Char2ObjectLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Char2ObjectLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.last] == from) {
/* 1125 */         this.prev = Char2ObjectLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Char2ObjectLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = HashCommon.mix(from) & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Char2ObjectLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1133 */         if (Char2ObjectLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1135 */           this.next = (int)Char2ObjectLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Char2ObjectLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Char2ObjectLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Char2ObjectLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Char2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Char2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Char2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Char2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Char2ObjectLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Char2ObjectLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Char2ObjectLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Char2ObjectLinkedOpenHashMap.this.link[this.prev] = Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Char2ObjectLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Char2ObjectLinkedOpenHashMap.this.link[this.next] = Char2ObjectLinkedOpenHashMap.this.link[this.next] ^ (Char2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Char2ObjectLinkedOpenHashMap.this.n) {
/* 1227 */         Char2ObjectLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Char2ObjectLinkedOpenHashMap.this.value[Char2ObjectLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         char[] key = Char2ObjectLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if ((curr = key[pos]) == '\000') {
/* 1237 */               key[last] = Character.MIN_VALUE;
/* 1238 */               Char2ObjectLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = HashCommon.mix(curr) & Char2ObjectLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Char2ObjectLinkedOpenHashMap.this.value[last] = Char2ObjectLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Char2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ObjectMap.Entry<V>>> implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
...
/* 1288 */       action.accept(new Char2ObjectLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2ObjectMap.Entry<V>>> implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
/* 1309 */     final Char2ObjectLinkedOpenHashMap<V>.MapEntry entry = new Char2ObjectLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2ObjectLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectMap.Entry<V> last() {
/* 1392 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1404 */       if (k == '\000') return (Char2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[Char2ObjectLinkedOpenHashMap.this.n], v));
/*      */       
/* 1406 */       char[] key = Char2ObjectLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ObjectLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1410 */       if (k == curr) return Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/* 1413 */         if ((curr = key[pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1414 */         if (k == curr) return Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1426 */       if (k == '\000') {
/* 1427 */         if (Char2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[Char2ObjectLinkedOpenHashMap.this.n], v)) {
/* 1428 */           Char2ObjectLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       char[] key = Char2ObjectLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1437 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ObjectLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1438 */       if (curr == k) {
/* 1439 */         if (Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1440 */           Char2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if ((curr = key[pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1447 */         if (curr == k && 
/* 1448 */           Objects.equals(Char2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1449 */           Char2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Char2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Char2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Char2ObjectLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Char2ObjectLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Char2ObjectLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Char2ObjectLinkedOpenHashMap.this.size, next = Char2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Char2ObjectLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Char2ObjectLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Char2ObjectLinkedOpenHashMap<V>.MapEntry entry = new Char2ObjectLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Char2ObjectLinkedOpenHashMap.this.size, next = Char2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Char2ObjectLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Char2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Char2ObjectLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1563 */       return Char2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Char2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1577 */       return new Char2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ObjectLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1593 */       for (int i = Char2ObjectLinkedOpenHashMap.this.size, next = Char2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Char2ObjectLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Char2ObjectLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Char2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1607 */       return Char2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1612 */       int oldSize = Char2ObjectLinkedOpenHashMap.this.size;
/* 1613 */       Char2ObjectLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Char2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Char2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1624 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1630 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Char2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Char2ObjectLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Char2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Char2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ObjectLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Char2ObjectLinkedOpenHashMap.this.size, next = Char2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Char2ObjectLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Char2ObjectLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Char2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Char2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Char2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1855 */       c = (Char2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectLinkedOpenHashMap.class
