...
/* 150 */     return (ObjectSet)char2ByteEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = char2ByteEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Character.valueOf(entry.getCharKey()), Byte.valueOf(entry.getByteValue()));
...
/* 502 */     Byte newValue = remappingFunction.apply(Character.valueOf(key), Byte.valueOf(oldValue));
...
/* 534 */     Byte newValue = remappingFunction.apply(Character.valueOf(key), contained ? Byte.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteMap.class
