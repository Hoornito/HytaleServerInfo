...
/*   90 */     this.actualComparator = CharComparators.asCharComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  166 */     this(k, v, (Comparator<? super Character>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  192 */     return (this.actualComparator == null) ? Character.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  885 */       Map.Entry<Character, Short> e = (Map.Entry<Character, Short>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return this.key ^ this.value;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2ShortAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2ShortMap.Entry>)new AbstractObjectSortedSet<Char2ShortMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2ShortMap.Entry>)new Char2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2ShortMap.Entry>)new Char2ShortAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1133 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1135 */             Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1145 */             if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1146 */             if (!(e.getValue() instanceof Short)) return false; 
/* 1147 */             Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1148 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1149 */             Char2ShortAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ShortMap.Entry first() {
/* 1165 */             return Char2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ShortMap.Entry last() {
/* 1170 */             return Char2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry to) {
/* 1175 */             return Char2ShortAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry to) {
/* 1180 */             return Char2ShortAVLTreeMap.this.headMap(to.getCharKey()).char2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from) {
/* 1185 */             return Char2ShortAVLTreeMap.this.tailMap(from.getCharKey()).char2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ShortIterator)new Char2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1285 */             return Char2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1308 */     return new Submap(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Char2ShortSortedMap tailMap(char from) {
/* 1313 */     return new Submap(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1357 */       if (!bottom && !top && Char2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2ShortMap.Entry>)new AbstractObjectSortedSet<Char2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2ShortMap.Entry>)new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2ShortMap.Entry>)new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2ShortMap.Entry> comparator() {
/* 1399 */               return Char2ShortAVLTreeMap.this.char2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1407 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1409 */               Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1418 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1420 */               Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2ShortAVLTreeMap.Submap.this.in(f.key)) Char2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ShortMap.Entry first() {
/* 1444 */               return Char2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ShortMap.Entry last() {
/* 1449 */               return Char2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry to) {
/* 1454 */               return Char2ShortAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry to) {
/* 1459 */               return Char2ShortAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from) {
/* 1464 */               return Char2ShortAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2ShortEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2ShortSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1493 */               return (ShortIterator)new Char2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1498 */               return Char2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(char k) {
/* 1536 */       char kk = k; Char2ShortAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(char k, short v) {
/* 1542 */       Char2ShortAVLTreeMap.this.modified = false;
...
/* 1544 */       short oldValue = Char2ShortAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(char k) {
/* 1551 */       Char2ShortAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       short oldValue = Char2ShortAVLTreeMap.this.remove(k);
/* 1554 */       return Char2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ShortSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ShortSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ShortSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Char2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2ShortAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2ShortAVLTreeMap.Entry e;
/* 1627 */       if (Char2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2ShortAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2ShortAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2ShortAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2ShortAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2ShortAVLTreeMap.Submap.this.bottom && Char2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2ShortAVLTreeMap.Submap.this.top && Char2ShortAVLTreeMap.this.compare(k, (this.prev = Char2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2ShortAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Char2ShortAVLTreeMap.this.compare(this.prev.key, Char2ShortAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2ShortAVLTreeMap.Submap.this.top && this.next != null && Char2ShortAVLTreeMap.this.compare(this.next.key, Char2ShortAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2ShortMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Char2ShortAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readShort());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readShort());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortAVLTreeMap.class
