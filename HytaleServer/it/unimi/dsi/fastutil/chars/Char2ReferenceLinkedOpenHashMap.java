...
/*  150 */     this.key = new char[this.n + 1];
...
/*  288 */     if (k == '\000') return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  290 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  293 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return -(pos + 1); 
/*  294 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
/*  297 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return -(pos + 1); 
...
/*      */     } 
/*      */     
/*  368 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  371 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  372 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  374 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*      */     } 
/*      */     
/*  494 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  497 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  498 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  504 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  505 */       if (k == curr) {
...
/*      */     } 
/*      */     
/*  529 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  532 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  533 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  539 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  540 */       if (k == curr) {
...
/*      */     } else {
/*      */       
/*  567 */       char[] key = this.key;
/*      */       char curr;
/*  569 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  570 */         if (curr == k) {
/*  571 */           moveIndexToFirst(pos);
/*  572 */           return setValue(pos, v);
/*      */         } 
/*  574 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) {
...
/*      */   
/*      */   public V get(char k) {
/*  648 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  650 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  653 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  654 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  657 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  665 */     if (k == '\000') return this.containsNullKey;
/*      */     
/*  667 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  670 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  671 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  674 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  682 */     char[] key = this.key;
/*  683 */     if (this.containsNullKey && value[this.n] == v) return true; 
/*  684 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  685 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  692 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  694 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  697 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return defaultValue; 
/*  698 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  701 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return defaultValue; 
...
/*      */     char curr;
/*      */     int pos;
/*  730 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  731 */     if (k == curr && v == this.value[pos]) {
/*  732 */       removeEntry(pos);
/*  733 */       return true;
/*      */     } 
/*      */     while (true) {
/*  736 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  793 */     V newValue = remappingFunction.apply(Character.valueOf(k), this.value[pos]);
/*  794 */     if (newValue == null) {
/*  795 */       if (k == '\000') { removeNullEntry(); }
...
/*  806 */     int pos = find(k);
/*  807 */     V newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? this.value[pos] : null);
/*  808 */     if (newValue == null) {
/*  809 */       if (pos >= 0)
/*  810 */         if (k == '\000') { removeNullEntry(); }
...
/*  854 */     Arrays.fill(this.key, false);
...
/*      */     implements Char2ReferenceMap.Entry<V>, Map.Entry<Character, V>, CharReferencePair<V>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  887 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  892 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  908 */       Char2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharReferencePair<V> right(V v) {
/*  914 */       Char2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  926 */       return Character.valueOf(Char2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  933 */       Map.Entry<Character, V> e = (Map.Entry<Character, V>)o;
/*  934 */       return (Char2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index] ^ ((Char2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Char2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Char2ReferenceLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1117 */       if (from == '\000') {
/* 1118 */         if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Char2ReferenceLinkedOpenHashMap.this.link[Char2ReferenceLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Char2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.last] == from) {
/* 1125 */         this.prev = Char2ReferenceLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Char2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = HashCommon.mix(from) & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Char2ReferenceLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1133 */         if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1135 */           this.next = (int)Char2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Char2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Char2ReferenceLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Char2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Char2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Char2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Char2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Char2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Char2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Char2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Char2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Char2ReferenceLinkedOpenHashMap.this.link[this.prev] = Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Char2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Char2ReferenceLinkedOpenHashMap.this.link[this.next] = Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Char2ReferenceLinkedOpenHashMap.this.n) {
/* 1227 */         Char2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         char[] key = Char2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if ((curr = key[pos]) == '\000') {
/* 1237 */               key[last] = Character.MIN_VALUE;
/* 1238 */               Char2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = HashCommon.mix(curr) & Char2ReferenceLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Char2ReferenceLinkedOpenHashMap.this.value[last] = Char2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Char2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ReferenceMap.Entry<V>>> implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
...
/* 1288 */       action.accept(new Char2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Char2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Char2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2ReferenceMap.Entry<V>>> implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
/* 1309 */     final Char2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Char2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>>)new Char2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ReferenceMap.Entry<V> last() {
/* 1392 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1401 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1402 */       char k = ((Character)e.getKey()).charValue();
/* 1403 */       V v = (V)e.getValue();
/* 1404 */       if (k == '\000') return (Char2ReferenceLinkedOpenHashMap.this.containsNullKey && Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1406 */       char[] key = Char2ReferenceLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ReferenceLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1410 */       if (k == curr) return (Char2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1413 */         if ((curr = key[pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1414 */         if (k == curr) return (Char2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1423 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1424 */       char k = ((Character)e.getKey()).charValue();
/* 1425 */       V v = (V)e.getValue();
/* 1426 */       if (k == '\000') {
/* 1427 */         if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey && Char2ReferenceLinkedOpenHashMap.this.value[Char2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1428 */           Char2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       char[] key = Char2ReferenceLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1437 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ReferenceLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1438 */       if (curr == k) {
/* 1439 */         if (Char2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1440 */           Char2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if ((curr = key[pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1447 */         if (curr == k && 
/* 1448 */           Char2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1449 */           Char2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Char2ReferenceLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Char2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Char2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Char2ReferenceLinkedOpenHashMap.this.size, next = Char2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Char2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Char2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Char2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Char2ReferenceLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Char2ReferenceLinkedOpenHashMap.this.size, next = Char2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Char2ReferenceLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Char2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Char2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1563 */       return Char2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Char2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1577 */       return new Char2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ReferenceLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1593 */       for (int i = Char2ReferenceLinkedOpenHashMap.this.size, next = Char2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Char2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Char2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1607 */       return Char2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1612 */       int oldSize = Char2ReferenceLinkedOpenHashMap.this.size;
/* 1613 */       Char2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Char2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1624 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1630 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Char2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Char2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Char2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Char2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Char2ReferenceLinkedOpenHashMap.this.size, next = Char2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Char2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Char2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Char2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1799 */     char[] key = this.key;
/* 1800 */     V[] value = this.value;
/* 1801 */     int mask = newN - 1;
/* 1802 */     char[] newKey = new char[newN + 1];
...
/* 1809 */       int pos; if (key[i] == '\000') { pos = newN; }
/*      */       else
/* 1811 */       { pos = HashCommon.mix(key[i]) & mask;
/* 1812 */         for (; newKey[pos] != '\000'; pos = pos + 1 & mask); }
/*      */       
...
/*      */     try {
/* 1855 */       c = (Char2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1863 */     c.key = (char[])this.key.clone();
...
/* 1911 */     char[] key = this.key = new char[this.n + 1];
...
/* 1919 */       int pos; char k = s.readChar();
...
/* 1926 */         for (; key[pos] != '\000'; pos = pos + 1 & this.mask);
/*      */       } 
/* 1928 */       key[pos] = k;
/* 1929 */       value[pos] = v;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceLinkedOpenHashMap.class
