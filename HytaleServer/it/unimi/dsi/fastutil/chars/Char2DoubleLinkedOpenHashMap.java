...
/*  732 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)) return true;  }
/*  733 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  853 */     Double newValue = remappingFunction.apply(Character.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  866 */     int pos = find(k);
/*  867 */     Double newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*      */     implements Char2DoubleMap.Entry, Map.Entry<Character, Double>, CharDoublePair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  946 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  951 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  956 */       return Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  961 */       return Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  966 */       double oldValue = Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*  967 */       Char2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharDoublePair right(double v) {
/*  973 */       Char2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  985 */       return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/* 1015 */       return (Char2DoubleLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Char2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Char2DoubleLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1198 */       if (from == '\000') {
/* 1199 */         if (Char2DoubleLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Char2DoubleLinkedOpenHashMap.this.link[Char2DoubleLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Char2DoubleLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Char2DoubleLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Char2DoubleLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Char2DoubleLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1214 */         if (Char2DoubleLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Char2DoubleLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Char2DoubleLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Char2DoubleLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Char2DoubleLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Char2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Char2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Char2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Char2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Char2DoubleLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Char2DoubleLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Char2DoubleLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Char2DoubleLinkedOpenHashMap.this.link[this.prev] = Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Char2DoubleLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Char2DoubleLinkedOpenHashMap.this.link[this.next] = Char2DoubleLinkedOpenHashMap.this.link[this.next] ^ (Char2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Char2DoubleLinkedOpenHashMap.this.n) {
/* 1308 */         Char2DoubleLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         char[] key = Char2DoubleLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == '\000') {
/* 1317 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Char2DoubleLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Char2DoubleLinkedOpenHashMap.this.value[last] = Char2DoubleLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Char2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2DoubleMap.Entry>> implements ObjectListIterator<Char2DoubleMap.Entry> {
...
/* 1367 */       action.accept(new Char2DoubleLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2DoubleMap.Entry>> implements ObjectListIterator<Char2DoubleMap.Entry> {
/* 1388 */     final Char2DoubleLinkedOpenHashMap.MapEntry entry = new Char2DoubleLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleMap.Entry last() {
/* 1471 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1484 */       if (k == '\000') return (Char2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[Char2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1486 */       char[] key = Char2DoubleLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Char2DoubleLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1490 */       if (k == curr) return (Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1494 */         if (k == curr) return (Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1507 */       if (k == '\000') {
/* 1508 */         if (Char2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[Char2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1509 */           Char2DoubleLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       char[] key = Char2DoubleLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Char2DoubleLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1521 */           Char2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Double.doubleToLongBits(Char2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1530 */           Char2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Char2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Char2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Char2DoubleLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Char2DoubleLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Char2DoubleLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1590 */         consumer.accept(new Char2DoubleLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Char2DoubleLinkedOpenHashMap.MapEntry entry = new Char2DoubleLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Char2DoubleLinkedOpenHashMap.this.size, next = Char2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Char2DoubleLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Char2DoubleLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Char2DoubleLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1644 */       return Char2DoubleLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Char2DoubleLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1658 */       return new Char2DoubleLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1674 */       for (int i = Char2DoubleLinkedOpenHashMap.this.size, next = Char2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Char2DoubleLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Char2DoubleLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Char2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1688 */       return Char2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1693 */       int oldSize = Char2DoubleLinkedOpenHashMap.this.size;
/* 1694 */       Char2DoubleLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Char2DoubleLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Char2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1705 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1711 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/* 1753 */       return Char2DoubleLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Char2DoubleLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1770 */       return Char2DoubleLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (DoubleIterator)new Char2DoubleLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return DoubleSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2DoubleLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1797 */             for (int i = Char2DoubleLinkedOpenHashMap.this.size, next = Char2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Char2DoubleLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Char2DoubleLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Char2DoubleLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1811 */             return Char2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Char2DoubleLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1936 */       c = (Char2DoubleLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleLinkedOpenHashMap.class
