...
/* 150 */     return (ObjectSet)char2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 254 */     return (value == null) ? false : containsValue(((Short)value).shortValue());
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   default void forEach(BiConsumer<? super Character, ? super Short> consumer) {
/* 260 */     ObjectSet<Entry> entrySet = char2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Character.valueOf(entry.getCharKey()), Short.valueOf(entry.getShortValue()));
...
/* 317 */     short v = get(key), drv = defaultReturnValue();
...
/* 404 */     short newValue = SafeMath.safeIntToShort(mappingFunction.applyAsInt(key));
...
/* 430 */     short v = get(key), drv = defaultReturnValue();
/* 431 */     if (v != drv || containsKey(key)) return v; 
/* 432 */     Short mappedValue = mappingFunction.apply(key);
/* 433 */     if (mappedValue == null) return drv; 
/* 434 */     short newValue = mappedValue.shortValue();
...
/* 500 */     short oldValue = get(key), drv = defaultReturnValue();
/* 501 */     if (oldValue == drv && !containsKey(key)) return drv; 
/* 502 */     Short newValue = remappingFunction.apply(Character.valueOf(key), Short.valueOf(oldValue));
/* 503 */     if (newValue == null) {
/* 504 */       remove(key);
/* 505 */       return drv;
/*     */     } 
/* 507 */     short newVal = newValue.shortValue();
/* 508 */     put(key, newVal);
/* 509 */     return newVal;
/*     */   }
/*     */ 
...
/* 532 */     short oldValue = get(key), drv = defaultReturnValue();
/* 533 */     boolean contained = (oldValue != drv || containsKey(key));
/* 534 */     Short newValue = remappingFunction.apply(Character.valueOf(key), contained ? Short.valueOf(oldValue) : null);
/* 535 */     if (newValue == null) {
/* 536 */       if (contained) remove(key); 
/* 537 */       return drv;
/*     */     } 
/* 539 */     short newVal = newValue.shortValue();
/* 540 */     put(key, newVal);
/* 541 */     return newVal;
/*     */   }
/*     */ 
...
/*     */     
/* 566 */     short oldValue = get(key), drv = defaultReturnValue();
/*     */     
/* 568 */     if (oldValue != drv || containsKey(key)) {
/* 569 */       Short mergedValue = remappingFunction.apply(Short.valueOf(oldValue), Short.valueOf(value));
/* 570 */       if (mergedValue == null) {
/* 571 */         remove(key);
/* 572 */         return drv;
/*     */       } 
/* 574 */       newValue = mergedValue.shortValue();
/*     */     } else {
/* 576 */       newValue = value;
/*     */     } 
...
/* 604 */     short oldValue = get(key), drv = defaultReturnValue();
/* 605 */     short newValue = (oldValue != drv || containsKey(key)) ? remappingFunction.apply(oldValue, value) : value;
...
/* 634 */     return mergeShort(key, value, (remappingFunction instanceof ShortBinaryOperator) ? (ShortBinaryOperator)remappingFunction : ((x, y) -> SafeMath.safeIntToShort(remappingFunction.applyAsInt(x, y))));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 763 */       return Character.valueOf(getCharKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 788 */       return Short.valueOf(getShortValue());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 799 */       return Short.valueOf(setValue(value.shortValue()));
/*     */     }
/*     */     
/*     */     char getCharKey();
/*     */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortMap.class
