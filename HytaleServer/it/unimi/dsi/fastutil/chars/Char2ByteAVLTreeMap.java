...
/*  885 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1147 */             Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1148 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1149 */             Char2ByteAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ByteMap.Entry first() {
/* 1165 */             return Char2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ByteMap.Entry last() {
/* 1170 */             return Char2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1175 */             return Char2ByteAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1180 */             return Char2ByteAVLTreeMap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1185 */             return Char2ByteAVLTreeMap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ByteIterator)new Char2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1285 */             return Char2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Char2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2ByteMap.Entry> comparator() {
/* 1399 */               return Char2ByteAVLTreeMap.this.char2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2ByteAVLTreeMap.Submap.this.in(f.key)) Char2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ByteMap.Entry first() {
/* 1444 */               return Char2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ByteMap.Entry last() {
/* 1449 */               return Char2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1454 */               return Char2ByteAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1459 */               return Char2ByteAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1464 */               return Char2ByteAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2ByteSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1493 */               return (ByteIterator)new Char2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1498 */               return Char2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(char k) {
/* 1536 */       char kk = k; Char2ByteAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(char k, byte v) {
/* 1542 */       Char2ByteAVLTreeMap.this.modified = false;
...
/* 1544 */       byte oldValue = Char2ByteAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(char k) {
/* 1551 */       Char2ByteAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       byte oldValue = Char2ByteAVLTreeMap.this.remove(k);
/* 1554 */       return Char2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Char2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2ByteAVLTreeMap.Entry e;
/* 1627 */       if (Char2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2ByteAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2ByteAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2ByteAVLTreeMap.Submap.this.bottom && Char2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2ByteAVLTreeMap.Submap.this.top && Char2ByteAVLTreeMap.this.compare(k, (this.prev = Char2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2ByteAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Char2ByteAVLTreeMap.this.compare(this.prev.key, Char2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2ByteAVLTreeMap.Submap.this.top && this.next != null && Char2ByteAVLTreeMap.this.compare(this.next.key, Char2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2ByteMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Char2ByteAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readByte());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readByte());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteAVLTreeMap.class
