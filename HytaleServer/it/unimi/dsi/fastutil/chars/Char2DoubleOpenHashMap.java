...
/*  238 */     if (k == '\000') return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  240 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  243 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return -(pos + 1); 
/*  244 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
/*  247 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return -(pos + 1); 
...
/*      */     } else {
/*      */       
/*  299 */       char[] key = this.key;
/*      */       char curr;
/*  301 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  302 */         if (curr == k) return addToValue(pos, incr); 
/*  303 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) return addToValue(pos, incr);  }
/*      */       
/*      */       } 
/*  306 */     }  this.key[pos] = k;
...
/*  323 */     char[] key = this.key; while (true) {
/*      */       char curr; int last;
/*  325 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  327 */         if ((curr = key[pos]) == '\000') {
/*  328 */           key[last] = Character.MIN_VALUE;
/*      */           return;
/*      */         } 
...
/*      */     } 
/*      */     
/*  348 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  351 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
...
/*  362 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  364 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  367 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  368 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  371 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  379 */     if (k == '\000') return this.containsNullKey;
/*      */     
/*  381 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  384 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  385 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  388 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  396 */     char[] key = this.key;
/*  397 */     if (this.containsNullKey && Double.doubleToLongBits(value[this.n]) == Double.doubleToLongBits(v)) return true; 
/*  398 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)) return true;  }
/*  399 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  406 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  408 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  411 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return defaultValue; 
/*  412 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  415 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return defaultValue; 
...
/*      */     char curr;
/*      */     int pos;
/*  444 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  445 */     if (k == curr && Double.doubleToLongBits(v) == Double.doubleToLongBits(this.value[pos])) {
/*  446 */       removeEntry(pos);
/*  447 */       return true;
/*      */     } 
/*      */     while (true) {
/*  450 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  519 */     Double newValue = remappingFunction.apply(Character.valueOf(k), Double.valueOf(this.value[pos]));
/*  520 */     if (newValue == null) {
/*  521 */       if (k == '\000') { removeNullEntry(); }
...
/*  532 */     int pos = find(k);
/*  533 */     Double newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
/*  534 */     if (newValue == null) {
/*  535 */       if (pos >= 0)
/*  536 */         if (k == '\000') { removeNullEntry(); }
...
/*  580 */     Arrays.fill(this.key, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  611 */       return Char2DoubleOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  616 */       return Char2DoubleOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  621 */       return Char2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  626 */       return Char2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  631 */       double oldValue = Char2DoubleOpenHashMap.this.value[this.index];
/*  632 */       Char2DoubleOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharDoublePair right(double v) {
/*  638 */       Char2DoubleOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  650 */       return Character.valueOf(Char2DoubleOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Double.valueOf(Char2DoubleOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  680 */       return (Char2DoubleOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Char2DoubleOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Char2DoubleOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Char2DoubleOpenHashMap.this.key[this.index] + "=>" + Char2DoubleOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Char2DoubleOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Char2DoubleOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Char2DoubleOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Char2DoubleOpenHashMap.this.n;
/*      */       } 
/*  732 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Char2DoubleOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Char2DoubleOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
/*  742 */         if (key[this.pos] != '\000') return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  749 */         acceptOnIndex(action, this.last = Char2DoubleOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Char2DoubleOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Char2DoubleOpenHashMap.this.mask);
/*  760 */           acceptOnIndex(action, p);
/*  761 */           this.c--; continue;
/*  762 */         }  if (key[this.pos] != '\000') {
...
/*  779 */       char[] key = Char2DoubleOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  781 */         pos = (last = pos) + 1 & Char2DoubleOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == '\000') {
/*  784 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Char2DoubleOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Char2DoubleOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
/*  792 */           if (this.wrapped == null) this.wrapped = new CharArrayList(2); 
/*  793 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Char2DoubleOpenHashMap.this.value[last] = Char2DoubleOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Char2DoubleOpenHashMap.this.n)
/*  803 */       { Char2DoubleOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Char2DoubleOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Char2DoubleOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2DoubleMap.Entry>> implements ObjectIterator<Char2DoubleMap.Entry> { public Char2DoubleOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Char2DoubleOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  834 */       action.accept(this.entry = new Char2DoubleOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Char2DoubleOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Char2DoubleOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Char2DoubleOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Char2DoubleOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*  897 */       while (this.pos < this.max) {
/*  898 */         if (key[this.pos] != '\000') {
/*  899 */           this.c++;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Char2DoubleOpenHashMap.this.n);
/*      */       } 
/*  914 */       char[] key = Char2DoubleOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Char2DoubleOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Char2DoubleOpenHashMap.this.size - this.c), (long)(Char2DoubleOpenHashMap.this.realSize() / Char2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*  963 */       while (this.pos < this.max && n > 0L) {
/*  964 */         if (key[this.pos++] != '\000') {
/*  965 */           skipped++;
/*  966 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2DoubleMap.Entry> action, int index) {
/*  990 */       action.accept(new Char2DoubleOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Char2DoubleOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2DoubleMap.Entry> fastIterator() {
/* 1007 */       return new Char2DoubleOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2DoubleMap.Entry> spliterator() {
/* 1012 */       return new Char2DoubleOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1021 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1022 */       if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1023 */       char k = ((Character)e.getKey()).charValue();
/* 1024 */       double v = ((Double)e.getValue()).doubleValue();
/* 1025 */       if (k == '\000') return (Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1027 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Char2DoubleOpenHashMap.this.mask]) == '\000') return false; 
/* 1031 */       if (k == curr) return (Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Char2DoubleOpenHashMap.this.mask]) == '\000') return false; 
/* 1035 */         if (k == curr) return (Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == '\000') {
/* 1049 */         if (Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1050 */           Char2DoubleOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       char[] key = Char2DoubleOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Char2DoubleOpenHashMap.this.mask]) == '\000') return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1062 */           Char2DoubleOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Char2DoubleOpenHashMap.this.mask]) == '\000') return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1071 */           Char2DoubleOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Char2DoubleOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Char2DoubleOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
/* 1091 */       if (Char2DoubleOpenHashMap.this.containsNullKey) consumer.accept(new Char2DoubleOpenHashMap.MapEntry(Char2DoubleOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Char2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenHashMap.this.key[pos] != '\000') consumer.accept(new Char2DoubleOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
/* 1098 */       Char2DoubleOpenHashMap.MapEntry entry = new Char2DoubleOpenHashMap.MapEntry();
/* 1099 */       if (Char2DoubleOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Char2DoubleOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Char2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenHashMap.this.key[pos] != '\000') {
...
/* 1134 */       action.accept(Char2DoubleOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1139 */       return Char2DoubleOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1160 */       action.accept(Char2DoubleOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Char2DoubleOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1177 */       return new Char2DoubleOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1183 */       if (Char2DoubleOpenHashMap.this.containsNullKey) consumer.accept(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Char2DoubleOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         char k = Char2DoubleOpenHashMap.this.key[pos];
/* 1186 */         if (k != '\000') consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1192 */       return Char2DoubleOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1197 */       return Char2DoubleOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1202 */       int oldSize = Char2DoubleOpenHashMap.this.size;
/* 1203 */       Char2DoubleOpenHashMap.this.remove(k);
/* 1204 */       return (Char2DoubleOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Char2DoubleOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Char2DoubleOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1242 */       return Char2DoubleOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1263 */       action.accept(Char2DoubleOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Char2DoubleOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1282 */             return new Char2DoubleOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1288 */             if (Char2DoubleOpenHashMap.this.containsNullKey) consumer.accept(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Char2DoubleOpenHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenHashMap.this.key[pos] != '\000') consumer.accept(Char2DoubleOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Char2DoubleOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1299 */             return Char2DoubleOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Char2DoubleOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1368 */     char[] key = this.key;
/* 1369 */     double[] value = this.value;
/* 1370 */     int mask = newN - 1;
/* 1371 */     char[] newKey = new char[newN + 1];
/* 1372 */     double[] newValue = new double[newN + 1];
/* 1373 */     int i = this.n;
/* 1374 */     for (int j = realSize(); j-- != 0; ) {
/* 1375 */       while (key[--i] == '\000'); int pos;
/* 1376 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000') while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1402 */       c = (Char2DoubleOpenHashMap)super.clone();
...
/* 1410 */     c.key = (char[])this.key.clone();
...
/* 1468 */         for (; key[pos] != '\000'; pos = pos + 1 & this.mask);
/*      */       } 
/* 1470 */       key[pos] = k;
/* 1471 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleOpenHashMap.class
