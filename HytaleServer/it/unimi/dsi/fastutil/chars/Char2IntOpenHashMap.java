...
/*  398 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  399 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  519 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  532 */     int pos = find(k);
/*  533 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*  611 */       return Char2IntOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  616 */       return Char2IntOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  621 */       return Char2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  626 */       return Char2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  631 */       int oldValue = Char2IntOpenHashMap.this.value[this.index];
/*  632 */       Char2IntOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharIntPair right(int v) {
/*  638 */       Char2IntOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  650 */       return Character.valueOf(Char2IntOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Integer.valueOf(Char2IntOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/*  680 */       return (Char2IntOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Char2IntOpenHashMap.this.key[this.index] ^ Char2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Char2IntOpenHashMap.this.key[this.index] + "=>" + Char2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Char2IntOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Char2IntOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Char2IntOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Char2IntOpenHashMap.this.n;
/*      */       } 
/*  732 */       char[] key = Char2IntOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Char2IntOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Char2IntOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
...
/*  749 */         acceptOnIndex(action, this.last = Char2IntOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       char[] key = Char2IntOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Char2IntOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Char2IntOpenHashMap.this.mask);
...
/*  779 */       char[] key = Char2IntOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  781 */         pos = (last = pos) + 1 & Char2IntOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == '\000') {
/*  784 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Char2IntOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Char2IntOpenHashMap.this.value[last] = Char2IntOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Char2IntOpenHashMap.this.n)
/*  803 */       { Char2IntOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Char2IntOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Char2IntOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectIterator<Char2IntMap.Entry> { public Char2IntOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Char2IntOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     private Char2IntOpenHashMap.MapEntry entry;
/*      */     private EntryIterator() {}
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2IntMap.Entry> action, int index) {
/*  834 */       action.accept(this.entry = new Char2IntOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Char2IntOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Char2IntOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Char2IntOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Char2IntOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       char[] key = Char2IntOpenHashMap.this.key;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Char2IntOpenHashMap.this.n);
/*      */       } 
/*  914 */       char[] key = Char2IntOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Char2IntOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Char2IntOpenHashMap.this.size - this.c), (long)(Char2IntOpenHashMap.this.realSize() / Char2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       char[] key = Char2IntOpenHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Char2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2IntMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2IntMap.Entry> action, int index) {
/*  990 */       action.accept(new Char2IntOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Char2IntOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2IntMap.Entry> fastIterator() {
/* 1007 */       return new Char2IntOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2IntMap.Entry> spliterator() {
/* 1012 */       return new Char2IntOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */       if (k == '\000') return (Char2IntOpenHashMap.this.containsNullKey && Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.n] == v);
/*      */       
/* 1027 */       char[] key = Char2IntOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Char2IntOpenHashMap.this.mask]) == '\000') return false; 
/* 1031 */       if (k == curr) return (Char2IntOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Char2IntOpenHashMap.this.mask]) == '\000') return false; 
/* 1035 */         if (k == curr) return (Char2IntOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == '\000') {
/* 1049 */         if (Char2IntOpenHashMap.this.containsNullKey && Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.n] == v) {
/* 1050 */           Char2IntOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       char[] key = Char2IntOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Char2IntOpenHashMap.this.mask]) == '\000') return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Char2IntOpenHashMap.this.value[pos] == v) {
/* 1062 */           Char2IntOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Char2IntOpenHashMap.this.mask]) == '\000') return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Char2IntOpenHashMap.this.value[pos] == v) {
/* 1071 */           Char2IntOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Char2IntOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Char2IntOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
/* 1091 */       if (Char2IntOpenHashMap.this.containsNullKey) consumer.accept(new Char2IntOpenHashMap.MapEntry(Char2IntOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Char2IntOpenHashMap.this.n; pos-- != 0;) { if (Char2IntOpenHashMap.this.key[pos] != '\000') consumer.accept(new Char2IntOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
/* 1098 */       Char2IntOpenHashMap.MapEntry entry = new Char2IntOpenHashMap.MapEntry();
/* 1099 */       if (Char2IntOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Char2IntOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Char2IntOpenHashMap.this.n; pos-- != 0;) { if (Char2IntOpenHashMap.this.key[pos] != '\000') {
...
/* 1134 */       action.accept(Char2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1139 */       return Char2IntOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1160 */       action.accept(Char2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Char2IntOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1177 */       return new Char2IntOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1183 */       if (Char2IntOpenHashMap.this.containsNullKey) consumer.accept(Char2IntOpenHashMap.this.key[Char2IntOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Char2IntOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         char k = Char2IntOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1192 */       return Char2IntOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1197 */       return Char2IntOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1202 */       int oldSize = Char2IntOpenHashMap.this.size;
/* 1203 */       Char2IntOpenHashMap.this.remove(k);
/* 1204 */       return (Char2IntOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Char2IntOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Char2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1242 */       return Char2IntOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1263 */       action.accept(Char2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Char2IntOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1282 */             return new Char2IntOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1288 */             if (Char2IntOpenHashMap.this.containsNullKey) consumer.accept(Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Char2IntOpenHashMap.this.n; pos-- != 0;) { if (Char2IntOpenHashMap.this.key[pos] != '\000') consumer.accept(Char2IntOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Char2IntOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1299 */             return Char2IntOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Char2IntOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1402 */       c = (Char2IntOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntOpenHashMap.class
