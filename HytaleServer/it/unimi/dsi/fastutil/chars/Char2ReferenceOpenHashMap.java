...
/*  357 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  358 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  559 */       return Char2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  564 */       return Char2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  569 */       return Char2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  574 */       return Char2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  579 */       V oldValue = Char2ReferenceOpenHashMap.this.value[this.index];
/*  580 */       Char2ReferenceOpenHashMap.this.value[this.index] = v;
/*  581 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharReferencePair<V> right(V v) {
/*  586 */       Char2ReferenceOpenHashMap.this.value[this.index] = v;
/*  587 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  598 */       return Character.valueOf(Char2ReferenceOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  606 */       return (Char2ReferenceOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  611 */       return Char2ReferenceOpenHashMap.this.key[this.index] ^ ((Char2ReferenceOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Char2ReferenceOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  616 */       return Char2ReferenceOpenHashMap.this.key[this.index] + "=>" + Char2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  627 */     int pos = Char2ReferenceOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  633 */     int last = -1;
/*      */     
/*  635 */     int c = Char2ReferenceOpenHashMap.this.size;
/*      */     
/*  637 */     boolean mustReturnNullKey = Char2ReferenceOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  656 */         return this.last = Char2ReferenceOpenHashMap.this.n;
/*      */       } 
/*  658 */       char[] key = Char2ReferenceOpenHashMap.this.key;
/*      */       while (true) {
/*  660 */         if (--this.pos < 0) {
/*      */           
/*  662 */           this.last = Integer.MIN_VALUE;
/*  663 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  664 */           int p = HashCommon.mix(k) & Char2ReferenceOpenHashMap.this.mask;
/*  665 */           for (; k != key[p]; p = p + 1 & Char2ReferenceOpenHashMap.this.mask);
/*  666 */           return p;
/*      */         } 
...
/*  675 */         acceptOnIndex(action, this.last = Char2ReferenceOpenHashMap.this.n);
/*  676 */         this.c--;
/*      */       } 
/*  678 */       char[] key = Char2ReferenceOpenHashMap.this.key;
/*  679 */       while (this.c != 0) {
/*  680 */         if (--this.pos < 0) {
/*      */           
/*  682 */           this.last = Integer.MIN_VALUE;
/*  683 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  684 */           int p = HashCommon.mix(k) & Char2ReferenceOpenHashMap.this.mask;
/*  685 */           for (; k != key[p]; p = p + 1 & Char2ReferenceOpenHashMap.this.mask);
...
/*  705 */       char[] key = Char2ReferenceOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  707 */         pos = (last = pos) + 1 & Char2ReferenceOpenHashMap.this.mask;
/*      */         while (true) {
/*  709 */           if ((curr = key[pos]) == '\000') {
/*  710 */             key[last] = Character.MIN_VALUE;
/*  711 */             Char2ReferenceOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  714 */           int slot = HashCommon.mix(curr) & Char2ReferenceOpenHashMap.this.mask;
/*  715 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  716 */             break;  pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask;
/*      */         } 
/*  718 */         if (pos < last) {
...
/*      */         } 
/*  722 */         key[last] = curr;
/*  723 */         Char2ReferenceOpenHashMap.this.value[last] = Char2ReferenceOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  728 */       if (this.last == -1) throw new IllegalStateException(); 
/*  729 */       if (this.last == Char2ReferenceOpenHashMap.this.n)
/*  730 */       { Char2ReferenceOpenHashMap.this.containsNullKey = false;
/*  731 */         Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n] = null; }
/*  732 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  735 */       { Char2ReferenceOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  736 */         this.last = -1;
/*      */         return; }
/*      */       
/*  739 */       Char2ReferenceOpenHashMap.this.size--;
/*  740 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ReferenceMap.Entry<V>>> implements ObjectIterator<Char2ReferenceMap.Entry<V>> { public Char2ReferenceOpenHashMap<V>.MapEntry next() {
/*  756 */       return this.entry = new Char2ReferenceOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  762 */       action.accept(this.entry = new Char2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  773 */       this.entry = new Char2ReferenceOpenHashMap.MapEntry();
/*      */     }
...
/*  794 */     int pos = 0;
/*      */     
/*  796 */     int max = Char2ReferenceOpenHashMap.this.n;
/*      */     
/*  798 */     int c = 0;
/*      */     
/*  800 */     boolean mustReturnNull = Char2ReferenceOpenHashMap.this.containsNullKey;
/*      */     
...
/*  820 */         this.c++;
/*  821 */         acceptOnIndex(action, Char2ReferenceOpenHashMap.this.n);
/*  822 */         return true;
/*      */       } 
/*  824 */       char[] key = Char2ReferenceOpenHashMap.this.key;
...
/*  839 */         this.c++;
/*  840 */         acceptOnIndex(action, Char2ReferenceOpenHashMap.this.n);
/*      */       } 
/*  842 */       char[] key = Char2ReferenceOpenHashMap.this.key;
...
/*      */       {
/*  855 */         return (Char2ReferenceOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  860 */       return Math.min((Char2ReferenceOpenHashMap.this.size - this.c), (long)(Char2ReferenceOpenHashMap.this.realSize() / Char2ReferenceOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  888 */         n--;
/*      */       } 
/*  890 */       char[] key = Char2ReferenceOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2ReferenceMap.Entry<V>> action, int index) {
/*  918 */       action.accept(new Char2ReferenceOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  930 */       return new Char2ReferenceOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator() {
/*  935 */       return new Char2ReferenceOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2ReferenceMap.Entry<V>> spliterator() {
/*  940 */       return new Char2ReferenceOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  952 */       if (k == '\000') return (Char2ReferenceOpenHashMap.this.containsNullKey && Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n] == v);
/*      */       
/*  954 */       char[] key = Char2ReferenceOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  957 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ReferenceOpenHashMap.this.mask]) == '\000') return false; 
/*  958 */       if (k == curr) return (Char2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  961 */         if ((curr = key[pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask]) == '\000') return false; 
/*  962 */         if (k == curr) return (Char2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  974 */       if (k == '\000') {
/*  975 */         if (Char2ReferenceOpenHashMap.this.containsNullKey && Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n] == v) {
/*  976 */           Char2ReferenceOpenHashMap.this.removeNullEntry();
/*  977 */           return true;
/*      */         } 
/*  979 */         return false;
/*      */       } 
/*      */       
/*  982 */       char[] key = Char2ReferenceOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  985 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ReferenceOpenHashMap.this.mask]) == '\000') return false; 
/*  986 */       if (curr == k) {
/*  987 */         if (Char2ReferenceOpenHashMap.this.value[pos] == v) {
/*  988 */           Char2ReferenceOpenHashMap.this.removeEntry(pos);
/*  989 */           return true;
/*      */         } 
/*  991 */         return false;
/*      */       } 
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask]) == '\000') return false; 
/*  995 */         if (curr == k && 
/*  996 */           Char2ReferenceOpenHashMap.this.value[pos] == v) {
/*  997 */           Char2ReferenceOpenHashMap.this.removeEntry(pos);
/*  998 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1006 */       return Char2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1011 */       Char2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
/* 1017 */       if (Char2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(new Char2ReferenceOpenHashMap.MapEntry(Char2ReferenceOpenHashMap.this.n)); 
/* 1018 */       for (int pos = Char2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Char2ReferenceOpenHashMap.this.key[pos] != '\000') consumer.accept(new Char2ReferenceOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
/* 1024 */       Char2ReferenceOpenHashMap<V>.MapEntry entry = new Char2ReferenceOpenHashMap.MapEntry();
/* 1025 */       if (Char2ReferenceOpenHashMap.this.containsNullKey) {
/* 1026 */         entry.index = Char2ReferenceOpenHashMap.this.n;
/* 1027 */         consumer.accept(entry);
/*      */       } 
/* 1029 */       for (int pos = Char2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Char2ReferenceOpenHashMap.this.key[pos] != '\000') {
...
/* 1060 */       action.accept(Char2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1065 */       return Char2ReferenceOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1086 */       action.accept(Char2ReferenceOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1098 */       return new Char2ReferenceOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1103 */       return new Char2ReferenceOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1109 */       if (Char2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.n]); 
/* 1110 */       for (int pos = Char2ReferenceOpenHashMap.this.n; pos-- != 0; ) {
/* 1111 */         char k = Char2ReferenceOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1118 */       return Char2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1123 */       return Char2ReferenceOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1128 */       int oldSize = Char2ReferenceOpenHashMap.this.size;
/* 1129 */       Char2ReferenceOpenHashMap.this.remove(k);
/* 1130 */       return (Char2ReferenceOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1135 */       Char2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1163 */       action.accept(Char2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1168 */       return Char2ReferenceOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1189 */       action.accept(Char2ReferenceOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1203 */             return new Char2ReferenceOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1208 */             return new Char2ReferenceOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1214 */             if (Char2ReferenceOpenHashMap.this.containsNullKey) consumer.accept(Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n]); 
/* 1215 */             for (int pos = Char2ReferenceOpenHashMap.this.n; pos-- != 0;) { if (Char2ReferenceOpenHashMap.this.key[pos] != '\000') consumer.accept(Char2ReferenceOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1220 */             return Char2ReferenceOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1225 */             return Char2ReferenceOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1230 */             Char2ReferenceOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1328 */       c = (Char2ReferenceOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceOpenHashMap.class
