...
/*  49 */     return (entries instanceof Char2ObjectMap.FastEntrySet) ? ((Char2ObjectMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  64 */     ObjectSet<Char2ObjectMap.Entry<V>> entries = map.char2ObjectEntrySet();
/*  65 */     if (entries instanceof Char2ObjectMap.FastEntrySet) { ((Char2ObjectMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  81 */     final ObjectSet<Char2ObjectMap.Entry<V>> entries = map.char2ObjectEntrySet();
/*  82 */     return (entries instanceof Char2ObjectMap.FastEntrySet) ? new ObjectIterable<Char2ObjectMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Char2ObjectMap.Entry<V>> iterator() {
/*  85 */           return ((Char2ObjectMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  95 */           ((Char2ObjectMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  97 */       } : (ObjectIterable<Char2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 135 */       return (ObjectSet<Char2ObjectMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
/* 140 */       return CharSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 155 */       return Char2ObjectMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
/* 227 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractChar2ObjectMap.BasicEntry<>(this.key, this.value)); 
...
/* 240 */       return (ObjectSet)char2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
/* 245 */       if (this.keys == null) this.keys = CharSets.singleton(this.key); 
...
/* 307 */     return new Singleton<>(key.charValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Char2ObjectFunctions.SynchronizedFunction<V> implements Char2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 345 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.char2ObjectEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, V>> entrySet() {
/* 359 */       return (ObjectSet)char2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
/* 364 */       synchronized (this.sync) {
/* 365 */         if (this.keys == null) this.keys = CharSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Char2ObjectFunctions.UnmodifiableFunction<V> implements Char2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     protected transient ObjectCollection<V> values;
/*     */     
/*     */     protected UnmodifiableMap(Char2ObjectMap<? extends V> m) {
/* 642 */       super(m);
/* 643 */       this.map = m;
/*     */     }
/*     */ 
...
/*     */     
/*     */     public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
/* 659 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.char2ObjectEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, V>> entrySet() {
/* 672 */       return (ObjectSet)char2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
/* 677 */       if (this.keys == null) this.keys = CharSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectMaps.class
