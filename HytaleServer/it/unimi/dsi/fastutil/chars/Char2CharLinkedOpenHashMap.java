...
/*  147 */     this.key = new char[this.n + 1];
/*  148 */     this.value = new char[this.n + 1];
...
/*  283 */     if (k == '\000') return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  285 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  288 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return -(pos + 1); 
/*  289 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
/*  292 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return -(pos + 1); 
...
/*      */     } 
/*  321 */     char oldValue = this.value[pos];
/*  322 */     this.value[pos] = v;
/*  323 */     return oldValue;
/*      */   }
/*      */   
/*      */   private char addToValue(int pos, char incr) {
/*  327 */     char oldValue = this.value[pos];
/*  328 */     this.value[pos] = (char)(oldValue + incr);
/*  329 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */     } else {
/*      */       
/*  353 */       char[] key = this.key;
/*      */       char curr;
/*  355 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  356 */         if (curr == k) return addToValue(pos, incr); 
/*  357 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) return addToValue(pos, incr);  }
/*      */       
/*      */       } 
/*  360 */     }  this.key[pos] = k;
/*  361 */     this.value[pos] = (char)(this.defRetValue + incr);
/*  362 */     if (this.size == 0) {
...
/*      */     char curr;
/*      */     int pos;
/*  415 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  416 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  418 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  419 */       if (k == curr) return removeEntry(pos); 
/*      */     } 
/*      */   }
/*      */   
/*      */   private char setValue(int pos, char v) {
/*  424 */     char oldValue = this.value[pos];
...
/*      */     } 
/*      */     
/*  536 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  539 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  540 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  546 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  547 */       if (k == curr) {
...
/*      */     } 
/*      */     
/*  571 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  574 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  575 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  581 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  582 */       if (k == curr) {
...
/*      */     } else {
/*      */       
/*  609 */       char[] key = this.key;
/*      */       char curr;
/*  611 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  612 */         if (curr == k) {
/*  613 */           moveIndexToFirst(pos);
/*  614 */           return setValue(pos, v);
/*      */         } 
/*  616 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) {
...
/*      */     } else {
/*      */       
/*  658 */       char[] key = this.key;
/*      */       char curr;
/*  660 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  661 */         if (curr == k) {
/*  662 */           moveIndexToLast(pos);
/*  663 */           return setValue(pos, v);
/*      */         } 
/*  665 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) {
...
/*  690 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  692 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  695 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  696 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  699 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  707 */     if (k == '\000') return this.containsNullKey;
/*      */     
/*  709 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  712 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  713 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  716 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  726 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  727 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  734 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  736 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  739 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return defaultValue; 
/*  740 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  743 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return defaultValue; 
...
/*      */     } 
/*      */     
/*  769 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  772 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  773 */     if (k == curr && v == this.value[pos]) {
/*  774 */       removeEntry(pos);
/*  775 */       return true;
/*      */     } 
/*      */     while (true) {
/*  778 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  800 */     char oldValue = this.value[pos];
...
/*  811 */     char newValue = SafeMath.safeIntToChar(mappingFunction.applyAsInt(k));
...
/*  823 */     char newValue = mappingFunction.get(key);
...
/*  834 */     Character newValue = mappingFunction.apply(k);
/*  835 */     if (newValue == null) return this.defRetValue; 
/*  836 */     char v = newValue.charValue();
...
/*  847 */     Character newValue = remappingFunction.apply(Character.valueOf(k), Character.valueOf(this.value[pos]));
/*  848 */     if (newValue == null) {
/*  849 */       if (k == '\000') { removeNullEntry(); }
/*  850 */       else { removeEntry(pos); }
/*  851 */        return this.defRetValue;
/*      */     } 
/*  853 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  860 */     int pos = find(k);
/*  861 */     Character newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
/*  862 */     if (newValue == null) {
/*  863 */       if (pos >= 0)
/*  864 */         if (k == '\000') { removeNullEntry(); }
/*  865 */         else { removeEntry(pos); }
/*      */          
/*  867 */       return this.defRetValue;
/*      */     } 
/*  869 */     char newVal = newValue.charValue();
/*  870 */     if (pos < 0) {
...
/*  886 */        return v;
/*      */     } 
/*  888 */     Character newValue = remappingFunction.apply(Character.valueOf(this.value[pos]), Character.valueOf(v));
/*  889 */     if (newValue == null) {
/*  890 */       if (k == '\000') { removeNullEntry(); }
/*  891 */       else { removeEntry(pos); }
/*  892 */        return this.defRetValue;
/*      */     } 
/*  894 */     this.value[pos] = newValue.charValue(); return newValue.charValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  908 */     Arrays.fill(this.key, false);
...
/*  945 */       return Char2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  950 */       return Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  955 */       return Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  960 */       char oldValue = Char2CharLinkedOpenHashMap.this.value[this.index];
/*  961 */       Char2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  962 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharCharPair right(char v) {
/*  967 */       Char2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  979 */       return Character.valueOf(Char2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  990 */       return Character.valueOf(Char2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1001 */       return Character.valueOf(setValue(v.charValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1008 */       Map.Entry<Character, Character> e = (Map.Entry<Character, Character>)o;
/* 1009 */       return (Char2CharLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1014 */       return Char2CharLinkedOpenHashMap.this.key[this.index] ^ Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1019 */       return Char2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1187 */       this.next = Char2CharLinkedOpenHashMap.this.first;
/* 1188 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1192 */       if (from == '\000') {
/* 1193 */         if (Char2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1194 */           this.next = (int)Char2CharLinkedOpenHashMap.this.link[Char2CharLinkedOpenHashMap.this.n];
/* 1195 */           this.prev = Char2CharLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1197 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1199 */       if (Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.last] == from) {
/* 1200 */         this.prev = Char2CharLinkedOpenHashMap.this.last;
/* 1201 */         this.index = Char2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1205 */       int pos = HashCommon.mix(from) & Char2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1207 */       while (Char2CharLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1208 */         if (Char2CharLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1210 */           this.next = (int)Char2CharLinkedOpenHashMap.this.link[pos];
/* 1211 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1214 */         pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1233 */       if (this.next == -1) {
/* 1234 */         this.index = Char2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1237 */       int pos = Char2CharLinkedOpenHashMap.this.first;
/* 1238 */       this.index = 1;
/* 1239 */       while (pos != this.prev) {
/* 1240 */         pos = (int)Char2CharLinkedOpenHashMap.this.link[pos];
/* 1241 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1258 */       this.next = (int)Char2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1267 */       this.prev = (int)(Char2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1276 */         this.next = (int)Char2CharLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1289 */         this.index--;
/* 1290 */         this.prev = (int)(Char2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1291 */       else { this.next = (int)Char2CharLinkedOpenHashMap.this.link[this.curr]; }
/* 1292 */        Char2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1295 */       if (this.prev == -1) { Char2CharLinkedOpenHashMap.this.first = this.next; }
/* 1296 */       else { Char2CharLinkedOpenHashMap.this.link[this.prev] = Char2CharLinkedOpenHashMap.this.link[this.prev] ^ (Char2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1297 */        if (this.next == -1) { Char2CharLinkedOpenHashMap.this.last = this.prev; }
/* 1298 */       else { Char2CharLinkedOpenHashMap.this.link[this.next] = Char2CharLinkedOpenHashMap.this.link[this.next] ^ (Char2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1299 */        int pos = this.curr;
/* 1300 */       this.curr = -1;
/* 1301 */       if (pos == Char2CharLinkedOpenHashMap.this.n) {
/* 1302 */         Char2CharLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1305 */         char[] key = Char2CharLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1308 */           pos = (last = pos) + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1310 */             if ((curr = key[pos]) == '\000') {
/* 1311 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1314 */             int slot = HashCommon.mix(curr) & Char2CharLinkedOpenHashMap.this.mask;
/* 1315 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1316 */               break;  pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1318 */           key[last] = curr;
/* 1319 */           Char2CharLinkedOpenHashMap.this.value[last] = Char2CharLinkedOpenHashMap.this.value[pos];
/* 1320 */           if (this.next == pos) this.next = last; 
/* 1321 */           if (this.prev == pos) this.prev = last; 
/* 1322 */           Char2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2CharMap.Entry>> implements ObjectListIterator<Char2CharMap.Entry> {
...
/* 1361 */       action.accept(new Char2CharLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharLinkedOpenHashMap.MapEntry next() {
/* 1366 */       return this.entry = new Char2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharLinkedOpenHashMap.MapEntry previous() {
/* 1371 */       return this.entry = new Char2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2CharMap.Entry>> implements ObjectListIterator<Char2CharMap.Entry> {
/* 1382 */     final Char2CharLinkedOpenHashMap.MapEntry entry = new Char2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1416 */       return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1434 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1459 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1460 */       return new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2CharMap.Entry last() {
/* 1465 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1474 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1475 */       if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1476 */       char k = ((Character)e.getKey()).charValue();
/* 1477 */       char v = ((Character)e.getValue()).charValue();
/* 1478 */       if (k == '\000') return (Char2CharLinkedOpenHashMap.this.containsNullKey && Char2CharLinkedOpenHashMap.this.value[Char2CharLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1480 */       char[] key = Char2CharLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1483 */       if ((curr = key[pos = HashCommon.mix(k) & Char2CharLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1484 */       if (k == curr) return (Char2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1487 */         if ((curr = key[pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1488 */         if (k == curr) return (Char2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1497 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1498 */       if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1499 */       char k = ((Character)e.getKey()).charValue();
/* 1500 */       char v = ((Character)e.getValue()).charValue();
/* 1501 */       if (k == '\000') {
/* 1502 */         if (Char2CharLinkedOpenHashMap.this.containsNullKey && Char2CharLinkedOpenHashMap.this.value[Char2CharLinkedOpenHashMap.this.n] == v) {
/* 1503 */           Char2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1504 */           return true;
/*      */         } 
/* 1506 */         return false;
/*      */       } 
/*      */       
/* 1509 */       char[] key = Char2CharLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1512 */       if ((curr = key[pos = HashCommon.mix(k) & Char2CharLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1513 */       if (curr == k) {
/* 1514 */         if (Char2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1515 */           Char2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1516 */           return true;
/*      */         } 
/* 1518 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1521 */         if ((curr = key[pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1522 */         if (curr == k && 
/* 1523 */           Char2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1524 */           Char2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1525 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1533 */       return Char2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1538 */       Char2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1551 */       return new Char2CharLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1562 */       return new Char2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1575 */       return new Char2CharLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2CharMap.Entry> consumer) {
/* 1581 */       for (int i = Char2CharLinkedOpenHashMap.this.size, next = Char2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1582 */         int curr = next;
/* 1583 */         next = (int)Char2CharLinkedOpenHashMap.this.link[curr];
/* 1584 */         consumer.accept(new Char2CharLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1591 */       Char2CharLinkedOpenHashMap.MapEntry entry = new Char2CharLinkedOpenHashMap.MapEntry();
/* 1592 */       for (int i = Char2CharLinkedOpenHashMap.this.size, next = Char2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1593 */         entry.index = next;
/* 1594 */         next = (int)Char2CharLinkedOpenHashMap.this.link[next];
...
/* 1621 */       return Char2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1633 */       action.accept(Char2CharLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1638 */       return Char2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1647 */       return new Char2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1652 */       return new Char2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1662 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2CharLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1668 */       for (int i = Char2CharLinkedOpenHashMap.this.size, next = Char2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1669 */         int curr = next;
/* 1670 */         next = (int)Char2CharLinkedOpenHashMap.this.link[curr];
/* 1671 */         consumer.accept(Char2CharLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1677 */       return Char2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1682 */       return Char2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1687 */       int oldSize = Char2CharLinkedOpenHashMap.this.size;
/* 1688 */       Char2CharLinkedOpenHashMap.this.remove(k);
/* 1689 */       return (Char2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1694 */       Char2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1699 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1700 */       return Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1705 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/*      */   {
/*      */     public char previousChar() {
/* 1747 */       return Char2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1759 */       action.accept(Char2CharLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1764 */       return Char2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public CharCollection values() {
/* 1770 */     if (this.values == null) this.values = new AbstractCharCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public CharIterator iterator() {
/* 1775 */             return new Char2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/*      */           
/*      */           public CharSpliterator spliterator() {
/* 1785 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2CharLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1791 */             for (int i = Char2CharLinkedOpenHashMap.this.size, next = Char2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1792 */               int curr = next;
/* 1793 */               next = (int)Char2CharLinkedOpenHashMap.this.link[curr];
/* 1794 */               consumer.accept(Char2CharLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1800 */             return Char2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1805 */             return Char2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1810 */             Char2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1874 */     char[] key = this.key;
/* 1875 */     char[] value = this.value;
/* 1876 */     int mask = newN - 1;
/* 1877 */     char[] newKey = new char[newN + 1];
/* 1878 */     char[] newValue = new char[newN + 1];
...
/* 1884 */       int pos; if (key[i] == '\000') { pos = newN; }
/*      */       else
/* 1886 */       { pos = HashCommon.mix(key[i]) & mask;
/* 1887 */         for (; newKey[pos] != '\000'; pos = pos + 1 & mask); }
/*      */       
...
/*      */     try {
/* 1930 */       c = (Char2CharLinkedOpenHashMap)super.clone();
...
/* 1938 */     c.key = (char[])this.key.clone();
/* 1939 */     c.value = (char[])this.value.clone();
...
/* 1985 */     char[] key = this.key = new char[this.n + 1];
/* 1986 */     char[] value = this.value = new char[this.n + 1];
...
/* 1993 */       int pos; char k = s.readChar();
/* 1994 */       char v = s.readChar();
/* 1995 */       if (k == '\000') {
/* 1996 */         pos = this.n;
/* 1997 */         this.containsNullKey = true;
/*      */       } else {
/* 1999 */         pos = HashCommon.mix(k) & this.mask;
/* 2000 */         for (; key[pos] != '\000'; pos = pos + 1 & this.mask);
/*      */       } 
/* 2002 */       key[pos] = k;
/* 2003 */       value[pos] = v;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2CharLinkedOpenHashMap.class
