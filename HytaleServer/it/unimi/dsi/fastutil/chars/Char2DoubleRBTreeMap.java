...
/*  839 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  840 */       return (this.key == ((Character)e.getKey()).charValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Char2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  950 */       if ((this.next = Char2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Char2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Char2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1089 */             Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1091 */             Char2DoubleRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Char2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Char2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2DoubleMap.Entry first() {
/* 1107 */             return Char2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2DoubleMap.Entry last() {
/* 1112 */             return Char2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1117 */             return Char2DoubleRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1122 */             return Char2DoubleRBTreeMap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1127 */             return Char2DoubleRBTreeMap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Char2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1169 */       return new Char2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (DoubleIterator)new Char2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1227 */             return Char2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Char2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Char2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Char2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Char2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Char2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2DoubleMap.Entry> comparator() {
/* 1341 */               return Char2DoubleRBTreeMap.this.char2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1352 */               return (f != null && Char2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1363 */               if (f != null && Char2DoubleRBTreeMap.Submap.this.in(f.key)) Char2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Char2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Char2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Char2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2DoubleMap.Entry first() {
/* 1386 */               return Char2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2DoubleMap.Entry last() {
/* 1391 */               return Char2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1396 */               return Char2DoubleRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1401 */               return Char2DoubleRBTreeMap.Submap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1406 */               return Char2DoubleRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1415 */         return new Char2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1420 */         return new Char2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1435 */               return (DoubleIterator)new Char2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1440 */               return Char2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Char2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Char2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1460 */       return (in(k) && Char2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(char k) {
/* 1478 */       char kk = k; Char2DoubleRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Char2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(char k, double v) {
/* 1484 */       Char2DoubleRBTreeMap.this.modified = false;
...
/* 1486 */       double oldValue = Char2DoubleRBTreeMap.this.put(k, v);
/* 1487 */       return Char2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(char k) {
/* 1493 */       Char2DoubleRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       double oldValue = Char2DoubleRBTreeMap.this.remove(k);
/* 1496 */       return Char2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1517 */       return Char2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap headMap(char to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Char2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap tailMap(char from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Char2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap subMap(char from, char to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Char2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Char2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Char2DoubleRBTreeMap.Entry e;
/* 1547 */       if (Char2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Char2DoubleRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Char2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Char2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Char2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2DoubleRBTreeMap.Entry e;
/* 1569 */       if (Char2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Char2DoubleRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Char2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Char2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Char2DoubleRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1587 */       Char2DoubleRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1594 */       Char2DoubleRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Char2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Char2DoubleRBTreeMap.Submap.this.bottom && Char2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Char2DoubleRBTreeMap.Submap.this.top && Char2DoubleRBTreeMap.this.compare(k, (this.prev = Char2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Char2DoubleRBTreeMap.this.locateKey(k);
/* 1620 */             if (Char2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Char2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Char2DoubleRBTreeMap.this.compare(this.prev.key, Char2DoubleRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Char2DoubleRBTreeMap.Submap.this.top && this.next != null && Char2DoubleRBTreeMap.this.compare(this.next.key, Char2DoubleRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Char2DoubleRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readChar(), s.readDouble());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readChar(), s.readDouble());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readChar(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleRBTreeMap.class
