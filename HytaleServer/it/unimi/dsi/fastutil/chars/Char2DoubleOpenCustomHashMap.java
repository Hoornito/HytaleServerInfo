...
/*  421 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)) return true;  }
/*  422 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  542 */     Double newValue = remappingFunction.apply(Character.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Double newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*  634 */       return Char2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  639 */       return Char2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  644 */       return Char2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  649 */       return Char2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  654 */       double oldValue = Char2DoubleOpenCustomHashMap.this.value[this.index];
/*  655 */       Char2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharDoublePair right(double v) {
/*  661 */       Char2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Character.valueOf(Char2DoubleOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Double.valueOf(Char2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  703 */       return (Char2DoubleOpenCustomHashMap.this.strategy.equals(Char2DoubleOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Char2DoubleOpenCustomHashMap.this.strategy.hashCode(Char2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Char2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Char2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Char2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Char2DoubleOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Char2DoubleOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Char2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Char2DoubleOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask;
/*  762 */           for (; !Char2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2DoubleOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Char2DoubleOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask;
/*  782 */           for (; !Char2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2DoubleOpenCustomHashMap.this.mask);
...
/*  802 */       char[] key = Char2DoubleOpenCustomHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  804 */         pos = (last = pos) + 1 & Char2DoubleOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == '\000') {
/*  807 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2DoubleOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Char2DoubleOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Char2DoubleOpenCustomHashMap.this.value[last] = Char2DoubleOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Char2DoubleOpenCustomHashMap.this.n)
/*  826 */       { Char2DoubleOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Char2DoubleOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Char2DoubleOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2DoubleMap.Entry>> implements ObjectIterator<Char2DoubleMap.Entry> { public Char2DoubleOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Char2DoubleOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Char2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Char2DoubleOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Char2DoubleOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Char2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Char2DoubleOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Char2DoubleOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Char2DoubleOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Char2DoubleOpenCustomHashMap.this.size - this.c), (long)(Char2DoubleOpenCustomHashMap.this.realSize() / Char2DoubleOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Char2DoubleMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2DoubleMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2DoubleMap.Entry> action, int index) {
/* 1013 */       action.accept(new Char2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Char2DoubleOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2DoubleMap.Entry> fastIterator() {
/* 1030 */       return new Char2DoubleOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2DoubleMap.Entry> spliterator() {
/* 1035 */       return new Char2DoubleOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, false)) return (Char2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1050 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1054 */       if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Char2DoubleOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1058 */         if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, false)) {
/* 1072 */         if (Char2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1073 */           Char2DoubleOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       char[] key = Char2DoubleOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1083 */       if (Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1085 */           Char2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Char2DoubleOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1092 */         if (Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1094 */           Char2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Char2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Char2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
/* 1114 */       if (Char2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(new Char2DoubleOpenCustomHashMap.MapEntry(Char2DoubleOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Char2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(new Char2DoubleOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
/* 1121 */       Char2DoubleOpenCustomHashMap.MapEntry entry = new Char2DoubleOpenCustomHashMap.MapEntry();
/* 1122 */       if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Char2DoubleOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Char2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenCustomHashMap.this.key[pos] != '\000') {
...
/* 1157 */       action.accept(Char2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1162 */       return Char2DoubleOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1183 */       action.accept(Char2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Char2DoubleOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1200 */       return new Char2DoubleOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1206 */       if (Char2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2DoubleOpenCustomHashMap.this.key[Char2DoubleOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Char2DoubleOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         char k = Char2DoubleOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Char2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1220 */       return Char2DoubleOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1225 */       int oldSize = Char2DoubleOpenCustomHashMap.this.size;
/* 1226 */       Char2DoubleOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Char2DoubleOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Char2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Char2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1265 */       return Char2DoubleOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1286 */       action.accept(Char2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Char2DoubleOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1305 */             return new Char2DoubleOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1311 */             if (Char2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Char2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2DoubleOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(Char2DoubleOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Char2DoubleOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1322 */             return Char2DoubleOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Char2DoubleOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Char2DoubleOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleOpenCustomHashMap.class
