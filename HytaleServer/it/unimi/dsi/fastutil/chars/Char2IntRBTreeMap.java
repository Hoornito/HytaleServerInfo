...
/*  839 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/*  840 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Char2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  950 */       if ((this.next = Char2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Char2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Char2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1089 */             Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Char2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Char2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Char2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2IntMap.Entry first() {
/* 1107 */             return Char2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2IntMap.Entry last() {
/* 1112 */             return Char2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1117 */             return Char2IntRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1122 */             return Char2IntRBTreeMap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1127 */             return Char2IntRBTreeMap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Char2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1169 */       return new Char2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (IntIterator)new Char2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Char2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Char2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Char2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Char2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Char2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Char2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2IntMap.Entry> comparator() {
/* 1341 */               return Char2IntRBTreeMap.this.char2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1352 */               return (f != null && Char2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1363 */               if (f != null && Char2IntRBTreeMap.Submap.this.in(f.key)) Char2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Char2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Char2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Char2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2IntMap.Entry first() {
/* 1386 */               return Char2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2IntMap.Entry last() {
/* 1391 */               return Char2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1396 */               return Char2IntRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1401 */               return Char2IntRBTreeMap.Submap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1406 */               return Char2IntRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2IntSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1415 */         return new Char2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1420 */         return new Char2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Char2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Char2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Char2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Char2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1460 */       return (in(k) && Char2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(char k) {
/* 1478 */       char kk = k; Char2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Char2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(char k, int v) {
/* 1484 */       Char2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Char2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Char2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(char k) {
/* 1493 */       Char2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Char2IntRBTreeMap.this.remove(k);
/* 1496 */       return Char2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1517 */       return Char2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap headMap(char to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Char2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap tailMap(char from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Char2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntSortedMap subMap(char from, char to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Char2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Char2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Char2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Char2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Char2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Char2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Char2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2IntRBTreeMap.Entry e;
/* 1569 */       if (Char2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Char2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Char2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Char2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Char2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1587 */       Char2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1594 */       Char2IntRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Char2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Char2IntRBTreeMap.Submap.this.bottom && Char2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Char2IntRBTreeMap.Submap.this.top && Char2IntRBTreeMap.this.compare(k, (this.prev = Char2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Char2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Char2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Char2IntRBTreeMap.Submap.this.bottom && this.prev != null && Char2IntRBTreeMap.this.compare(this.prev.key, Char2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Char2IntRBTreeMap.Submap.this.top && this.next != null && Char2IntRBTreeMap.this.compare(this.next.key, Char2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     Char2IntRBTreeMap c;
/*      */     try {
/* 1725 */       c = (Char2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readChar(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readChar(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readChar(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntRBTreeMap.class
