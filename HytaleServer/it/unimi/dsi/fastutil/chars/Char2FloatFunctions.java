...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Char2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Char2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.charValue(), value.floatValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractChar2FloatFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2FloatFunction function;
/*     */     
...
/* 550 */       Float v = this.function.apply(Character.valueOf(key));
...
/* 557 */       Float v = this.function.apply(Character.valueOf(key));
...
/* 603 */     if (f instanceof Char2FloatFunction) return (Char2FloatFunction)f; 
/* 604 */     if (f instanceof IntToDoubleFunction) return key -> SafeMath.safeDoubleToFloat(((IntToDoubleFunction)f).applyAsDouble(key)); 
/* 605 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatFunctions.class
