...
/*  283 */     char[] key = this.key; while (true) {
/*      */       char curr; int last;
/*  285 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  287 */         if ((curr = key[pos]) == '\000') {
/*  288 */           key[last] = Character.MIN_VALUE;
/*      */           return;
/*      */         } 
...
/*      */     } 
/*      */     
/*  308 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  311 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  312 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  314 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  322 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  324 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  327 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  328 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  331 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  339 */     if (k == '\000') return this.containsNullKey;
/*      */     
/*  341 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  344 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  345 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  348 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  358 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  359 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  366 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  368 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  371 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return defaultValue; 
/*  372 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  375 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return defaultValue; 
...
/*      */     } 
/*      */     
/*  401 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  404 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  405 */     if (k == curr && v == this.value[pos]) {
/*  406 */       removeEntry(pos);
/*  407 */       return true;
/*      */     } 
/*      */     while (true) {
/*  410 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  479 */     Boolean newValue = remappingFunction.apply(Character.valueOf(k), Boolean.valueOf(this.value[pos]));
/*  480 */     if (newValue == null) {
/*  481 */       if (k == '\000') { removeNullEntry(); }
...
/*  492 */     int pos = find(k);
/*  493 */     Boolean newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
/*  494 */     if (newValue == null) {
/*  495 */       if (pos >= 0)
/*  496 */         if (k == '\000') { removeNullEntry(); }
...
/*  540 */     Arrays.fill(this.key, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  571 */       return Char2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  576 */       return Char2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  581 */       return Char2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  586 */       return Char2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  591 */       boolean oldValue = Char2BooleanOpenHashMap.this.value[this.index];
/*  592 */       Char2BooleanOpenHashMap.this.value[this.index] = v;
/*  593 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBooleanPair right(boolean v) {
/*  598 */       Char2BooleanOpenHashMap.this.value[this.index] = v;
/*  599 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  610 */       return Character.valueOf(Char2BooleanOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  621 */       return Boolean.valueOf(Char2BooleanOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */       Map.Entry<Character, Boolean> e = (Map.Entry<Character, Boolean>)o;
/*  640 */       return (Char2BooleanOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  645 */       return Char2BooleanOpenHashMap.this.key[this.index] ^ (Char2BooleanOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
...
/*      */   {
/*  661 */     int pos = Char2BooleanOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  671 */     boolean mustReturnNullKey = Char2BooleanOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  690 */         return this.last = Char2BooleanOpenHashMap.this.n;
/*      */       } 
/*  692 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*      */       while (true) {
/*  694 */         if (--this.pos < 0) {
/*      */           
/*  696 */           this.last = Integer.MIN_VALUE;
/*  697 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  698 */           int p = HashCommon.mix(k) & Char2BooleanOpenHashMap.this.mask;
/*  699 */           for (; k != key[p]; p = p + 1 & Char2BooleanOpenHashMap.this.mask);
/*  700 */           return p;
/*      */         } 
/*  702 */         if (key[this.pos] != '\000') return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  709 */         acceptOnIndex(action, this.last = Char2BooleanOpenHashMap.this.n);
/*  710 */         this.c--;
/*      */       } 
/*  712 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*  713 */       while (this.c != 0) {
/*  714 */         if (--this.pos < 0) {
/*      */           
/*  716 */           this.last = Integer.MIN_VALUE;
/*  717 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  718 */           int p = HashCommon.mix(k) & Char2BooleanOpenHashMap.this.mask;
/*  719 */           for (; k != key[p]; p = p + 1 & Char2BooleanOpenHashMap.this.mask);
/*  720 */           acceptOnIndex(action, p);
/*  721 */           this.c--; continue;
/*  722 */         }  if (key[this.pos] != '\000') {
...
/*  739 */       char[] key = Char2BooleanOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  741 */         pos = (last = pos) + 1 & Char2BooleanOpenHashMap.this.mask;
/*      */         while (true) {
/*  743 */           if ((curr = key[pos]) == '\000') {
/*  744 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  747 */           int slot = HashCommon.mix(curr) & Char2BooleanOpenHashMap.this.mask;
/*  748 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  749 */             break;  pos = pos + 1 & Char2BooleanOpenHashMap.this.mask;
/*      */         } 
/*  751 */         if (pos < last) {
/*  752 */           if (this.wrapped == null) this.wrapped = new CharArrayList(2); 
/*  753 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  755 */         key[last] = curr;
/*  756 */         Char2BooleanOpenHashMap.this.value[last] = Char2BooleanOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  761 */       if (this.last == -1) throw new IllegalStateException(); 
/*  762 */       if (this.last == Char2BooleanOpenHashMap.this.n)
/*  763 */       { Char2BooleanOpenHashMap.this.containsNullKey = false; }
/*  764 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  767 */       { Char2BooleanOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  768 */         this.last = -1;
/*      */         return; }
/*      */       
/*  771 */       Char2BooleanOpenHashMap.this.size--;
/*  772 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2BooleanMap.Entry>> implements ObjectIterator<Char2BooleanMap.Entry> { public Char2BooleanOpenHashMap.MapEntry next() {
/*  788 */       return this.entry = new Char2BooleanOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  794 */       action.accept(this.entry = new Char2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  805 */       this.entry = new Char2BooleanOpenHashMap.MapEntry();
/*      */     }
...
/*  826 */     int pos = 0;
/*      */     
/*  828 */     int max = Char2BooleanOpenHashMap.this.n;
/*      */     
/*  830 */     int c = 0;
/*      */     
/*  832 */     boolean mustReturnNull = Char2BooleanOpenHashMap.this.containsNullKey;
/*      */     
...
/*  852 */         this.c++;
/*  853 */         acceptOnIndex(action, Char2BooleanOpenHashMap.this.n);
/*  854 */         return true;
/*      */       } 
/*  856 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*  857 */       while (this.pos < this.max) {
/*  858 */         if (key[this.pos] != '\000') {
/*  859 */           this.c++;
...
/*  871 */         this.c++;
/*  872 */         acceptOnIndex(action, Char2BooleanOpenHashMap.this.n);
/*      */       } 
/*  874 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*  875 */       while (this.pos < this.max) {
/*  876 */         if (key[this.pos] != '\000') {
...
/*      */       {
/*  887 */         return (Char2BooleanOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  892 */       return Math.min((Char2BooleanOpenHashMap.this.size - this.c), (long)(Char2BooleanOpenHashMap.this.realSize() / Char2BooleanOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  920 */         n--;
/*      */       } 
/*  922 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*  923 */       while (this.pos < this.max && n > 0L) {
/*  924 */         if (key[this.pos++] != '\000') {
/*  925 */           skipped++;
/*  926 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2BooleanMap.Entry> action, int index) {
/*  950 */       action.accept(new Char2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  962 */       return new Char2BooleanOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2BooleanMap.Entry> fastIterator() {
/*  967 */       return new Char2BooleanOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2BooleanMap.Entry> spliterator() {
/*  972 */       return new Char2BooleanOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  981 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/*  982 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/*  983 */       char k = ((Character)e.getKey()).charValue();
/*  984 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/*  985 */       if (k == '\000') return (Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == v);
/*      */       
/*  987 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  990 */       if ((curr = key[pos = HashCommon.mix(k) & Char2BooleanOpenHashMap.this.mask]) == '\000') return false; 
/*  991 */       if (k == curr) return (Char2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Char2BooleanOpenHashMap.this.mask]) == '\000') return false; 
/*  995 */         if (k == curr) return (Char2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1008 */       if (k == '\000') {
/* 1009 */         if (Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == v) {
/* 1010 */           Char2BooleanOpenHashMap.this.removeNullEntry();
/* 1011 */           return true;
/*      */         } 
/* 1013 */         return false;
/*      */       } 
/*      */       
/* 1016 */       char[] key = Char2BooleanOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1019 */       if ((curr = key[pos = HashCommon.mix(k) & Char2BooleanOpenHashMap.this.mask]) == '\000') return false; 
/* 1020 */       if (curr == k) {
/* 1021 */         if (Char2BooleanOpenHashMap.this.value[pos] == v) {
/* 1022 */           Char2BooleanOpenHashMap.this.removeEntry(pos);
/* 1023 */           return true;
/*      */         } 
/* 1025 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1028 */         if ((curr = key[pos = pos + 1 & Char2BooleanOpenHashMap.this.mask]) == '\000') return false; 
/* 1029 */         if (curr == k && 
/* 1030 */           Char2BooleanOpenHashMap.this.value[pos] == v) {
/* 1031 */           Char2BooleanOpenHashMap.this.removeEntry(pos);
/* 1032 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1040 */       return Char2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1045 */       Char2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
/* 1051 */       if (Char2BooleanOpenHashMap.this.containsNullKey) consumer.accept(new Char2BooleanOpenHashMap.MapEntry(Char2BooleanOpenHashMap.this.n)); 
/* 1052 */       for (int pos = Char2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Char2BooleanOpenHashMap.this.key[pos] != '\000') consumer.accept(new Char2BooleanOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
/* 1058 */       Char2BooleanOpenHashMap.MapEntry entry = new Char2BooleanOpenHashMap.MapEntry();
/* 1059 */       if (Char2BooleanOpenHashMap.this.containsNullKey) {
/* 1060 */         entry.index = Char2BooleanOpenHashMap.this.n;
/* 1061 */         consumer.accept(entry);
/*      */       } 
/* 1063 */       for (int pos = Char2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Char2BooleanOpenHashMap.this.key[pos] != '\000') {
...
/* 1094 */       action.accept(Char2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1099 */       return Char2BooleanOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1120 */       action.accept(Char2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1132 */       return new Char2BooleanOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1137 */       return new Char2BooleanOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1143 */       if (Char2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Char2BooleanOpenHashMap.this.key[Char2BooleanOpenHashMap.this.n]); 
/* 1144 */       for (int pos = Char2BooleanOpenHashMap.this.n; pos-- != 0; ) {
/* 1145 */         char k = Char2BooleanOpenHashMap.this.key[pos];
/* 1146 */         if (k != '\000') consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1152 */       return Char2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1157 */       return Char2BooleanOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1162 */       int oldSize = Char2BooleanOpenHashMap.this.size;
/* 1163 */       Char2BooleanOpenHashMap.this.remove(k);
/* 1164 */       return (Char2BooleanOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1169 */       Char2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1197 */       action.accept(Char2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1202 */       return Char2BooleanOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1223 */       action.accept(Char2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1237 */             return new Char2BooleanOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1242 */             return new Char2BooleanOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1248 */             if (Char2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n]); 
/* 1249 */             for (int pos = Char2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Char2BooleanOpenHashMap.this.key[pos] != '\000') consumer.accept(Char2BooleanOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1254 */             return Char2BooleanOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1259 */             return Char2BooleanOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1264 */             Char2BooleanOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1328 */     char[] key = this.key;
/* 1329 */     boolean[] value = this.value;
/* 1330 */     int mask = newN - 1;
/* 1331 */     char[] newKey = new char[newN + 1];
/* 1332 */     boolean[] newValue = new boolean[newN + 1];
/* 1333 */     int i = this.n;
/* 1334 */     for (int j = realSize(); j-- != 0; ) {
/* 1335 */       while (key[--i] == '\000'); int pos;
/* 1336 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000') while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1362 */       c = (Char2BooleanOpenHashMap)super.clone();
...
/* 1370 */     c.key = (char[])this.key.clone();
...
/* 1428 */         for (; key[pos] != '\000'; pos = pos + 1 & this.mask);
/*      */       } 
/* 1430 */       key[pos] = k;
/* 1431 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanOpenHashMap.class
