...
/* 150 */     return (ObjectSet)char2IntEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = char2IntEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Character.valueOf(entry.getCharKey()), Integer.valueOf(entry.getIntValue()));
...
/* 502 */     Integer newValue = remappingFunction.apply(Character.valueOf(key), Integer.valueOf(oldValue));
...
/* 534 */     Integer newValue = remappingFunction.apply(Character.valueOf(key), contained ? Integer.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntMap.class
