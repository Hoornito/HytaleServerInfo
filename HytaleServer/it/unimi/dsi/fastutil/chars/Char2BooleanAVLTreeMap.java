...
/*      */     extends AbstractChar2BooleanMap.BasicEntry
...
/*  865 */       Map.Entry<Character, Boolean> e = (Map.Entry<Character, Boolean>)o;
/*  866 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  974 */       this.next = Char2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  978 */       if ((this.next = Char2BooleanAVLTreeMap.this.locateKey(k)) != null)
/*  979 */         if (Char2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1032 */       updatePrevious();
/* 1033 */       updateNext();
/* 1034 */       Char2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1035 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1089 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */         {
...
/* 1099 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1104 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1114 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1115 */             Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1125 */             if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1126 */             if (!(e.getValue() instanceof Boolean)) return false; 
/* 1127 */             Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1128 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1129 */             Char2BooleanAVLTreeMap.this.remove(f.key);
/* 1130 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1135 */             return Char2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1140 */             Char2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2BooleanMap.Entry first() {
/* 1145 */             return Char2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2BooleanMap.Entry last() {
/* 1150 */             return Char2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1155 */             return Char2BooleanAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1160 */             return Char2BooleanAVLTreeMap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1165 */             return Char2BooleanAVLTreeMap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Char2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1207 */       return new Char2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (BooleanIterator)new Char2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1265 */             return Char2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1270 */             return Char2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1275 */             Char2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1288 */     return new Submap(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Char2BooleanSortedMap tailMap(char from) {
/* 1293 */     return new Submap(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1337 */       if (!bottom && !top && Char2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Char2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Char2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2BooleanAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 1366 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator() {
/* 1369 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2BooleanMap.Entry> comparator() {
/* 1379 */               return Char2BooleanAVLTreeMap.this.char2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1387 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1389 */               Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1390 */               return (f != null && Char2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1398 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1399 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1400 */               Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1401 */               if (f != null && Char2BooleanAVLTreeMap.Submap.this.in(f.key)) Char2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1402 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1407 */               int c = 0;
/* 1408 */               for (ObjectBidirectionalIterator<Char2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1409 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1414 */               return !(new Char2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1419 */               Char2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2BooleanMap.Entry first() {
/* 1424 */               return Char2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2BooleanMap.Entry last() {
/* 1429 */               return Char2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1434 */               return Char2BooleanAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1439 */               return Char2BooleanAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1444 */               return Char2BooleanAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */           }; 
/* 1447 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2BooleanSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1453 */         return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1458 */         return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1473 */               return (BooleanIterator)new Char2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1478 */               return Char2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1483 */               return Char2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1488 */               Char2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1498 */       return (in(k) && Char2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(char k) {
/* 1516 */       char kk = k; Char2BooleanAVLTreeMap.Entry e;
/* 1517 */       return (in(kk) && (e = Char2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(char k, boolean v) {
/* 1522 */       Char2BooleanAVLTreeMap.this.modified = false;
...
/* 1524 */       boolean oldValue = Char2BooleanAVLTreeMap.this.put(k, v);
/* 1525 */       return Char2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1531 */       Char2BooleanAVLTreeMap.this.modified = false;
/* 1532 */       if (!in(k)) return this.defRetValue; 
/* 1533 */       boolean oldValue = Char2BooleanAVLTreeMap.this.remove(k);
/* 1534 */       return Char2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1555 */       return Char2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap headMap(char to) {
/* 1560 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1561 */       return (Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap tailMap(char from) {
/* 1566 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1567 */       return (Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap subMap(char from, char to) {
/* 1572 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1573 */       if (!this.top) to = (Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1574 */       if (!this.bottom) from = (Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1585 */       if (Char2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1589 */       if (this.bottom) { e = Char2BooleanAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1591 */       { e = Char2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1593 */         if (Char2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1597 */       if (e == null || (!this.top && Char2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1598 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2BooleanAVLTreeMap.Entry e;
/* 1607 */       if (Char2BooleanAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1611 */       if (this.top) { e = Char2BooleanAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1613 */       { e = Char2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1615 */         if (Char2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1619 */       if (e == null || (!this.bottom && Char2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1620 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1625 */       Char2BooleanAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1632 */       Char2BooleanAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Char2BooleanAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1648 */         this.next = Char2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1652 */         this();
/* 1653 */         if (this.next != null) {
/* 1654 */           if (!Char2BooleanAVLTreeMap.Submap.this.bottom && Char2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1655 */           else if (!Char2BooleanAVLTreeMap.Submap.this.top && Char2BooleanAVLTreeMap.this.compare(k, (this.prev = Char2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1657 */           { this.next = Char2BooleanAVLTreeMap.this.locateKey(k);
/* 1658 */             if (Char2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1669 */         if (!Char2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Char2BooleanAVLTreeMap.this.compare(this.prev.key, Char2BooleanAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1674 */         this.next = this.next.next();
/* 1675 */         if (!Char2BooleanAVLTreeMap.Submap.this.top && this.next != null && Char2BooleanAVLTreeMap.this.compare(this.next.key, Char2BooleanAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2BooleanMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1763 */       c = (Char2BooleanAVLTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
/* 1846 */       entry.right(new Entry(s.readChar(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanAVLTreeMap.class
