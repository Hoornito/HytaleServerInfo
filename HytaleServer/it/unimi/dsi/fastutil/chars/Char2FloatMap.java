...
/* 150 */     return (ObjectSet)char2FloatEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = char2FloatEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Character.valueOf(entry.getCharKey()), Float.valueOf(entry.getFloatValue()));
...
/* 502 */     Float newValue = remappingFunction.apply(Character.valueOf(key), Float.valueOf(oldValue));
...
/* 534 */     Float newValue = remappingFunction.apply(Character.valueOf(key), contained ? Float.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatMap.class
