...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Char2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Char2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.charValue(), value.doubleValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractChar2DoubleFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2DoubleFunction function;
/*     */     
...
/* 550 */       Double v = this.function.apply(Character.valueOf(key));
...
/* 557 */       Double v = this.function.apply(Character.valueOf(key));
...
/* 603 */     if (f instanceof Char2DoubleFunction) return (Char2DoubleFunction)f; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleFunctions.class
