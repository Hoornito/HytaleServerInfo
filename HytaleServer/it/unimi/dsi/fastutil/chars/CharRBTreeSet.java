...
/*      */     
/*      */     SetIterator() {
/*  897 */       this.next = CharRBTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(char k) {
/*  901 */       if ((this.next = CharRBTreeSet.this.locateKey(k)) != null) {
/*  902 */         if (CharRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/*  970 */       updatePrevious();
/*  971 */       updateNext();
/*  972 */       CharRBTreeSet.this.remove(this.curr.key);
/*  973 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*  994 */     return new Subset(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public CharSortedSet tailSet(char from) {
/*  999 */     return new Subset(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1037 */       if (!bottom && !top && CharRBTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1038 */       this.from = from;
...
/* 1060 */       return ((this.bottom || CharRBTreeSet.this.compare(k, this.from) >= 0) && (this.top || CharRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1066 */       return (in(k) && CharRBTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(char k) {
...
/* 1072 */       return CharRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1079 */       return CharRBTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1100 */       return CharRBTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator() {
...
/* 1116 */       return (CharRBTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSortedSet tailSet(char from) {
/* 1121 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1122 */       return (CharRBTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSortedSet subSet(char from, char to) {
/* 1127 */       if (this.top && this.bottom) return new Subset(from, false, to, false); 
/* 1128 */       if (!this.top) to = (CharRBTreeSet.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1129 */       if (!this.bottom) from = (CharRBTreeSet.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1140 */       if (CharRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1144 */       if (this.bottom) { e = CharRBTreeSet.this.firstEntry; }
/*      */       else
/* 1146 */       { e = CharRBTreeSet.this.locateKey(this.from);
/*      */         
/* 1148 */         if (CharRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1152 */       if (e == null || (!this.top && CharRBTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1153 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       CharRBTreeSet.Entry e;
/* 1162 */       if (CharRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1166 */       if (this.top) { e = CharRBTreeSet.this.lastEntry; }
/*      */       else
/* 1168 */       { e = CharRBTreeSet.this.locateKey(this.to);
/*      */         
/* 1170 */         if (CharRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1174 */       if (e == null || (!this.bottom && CharRBTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1175 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1180 */       CharRBTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastChar() {
/* 1187 */       CharRBTreeSet.Entry e = lastEntry();
...
/*      */     {
/*      */       SubsetIterator() {
/* 1203 */         this.next = CharRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(char k) {
/* 1207 */         this();
/* 1208 */         if (this.next != null) {
/* 1209 */           if (!CharRBTreeSet.Subset.this.bottom && CharRBTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1210 */           else if (!CharRBTreeSet.Subset.this.top && CharRBTreeSet.this.compare(k, (this.prev = CharRBTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1212 */           { this.next = CharRBTreeSet.this.locateKey(k);
/* 1213 */             if (CharRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1224 */         if (!CharRBTreeSet.Subset.this.bottom && this.prev != null && CharRBTreeSet.this.compare(this.prev.key, CharRBTreeSet.Subset.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1229 */         this.next = this.next.next();
/* 1230 */         if (!CharRBTreeSet.Subset.this.top && this.next != null && CharRBTreeSet.this.compare(this.next.key, CharRBTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     CharRBTreeSet c;
/*      */     try {
/* 1249 */       c = (CharRBTreeSet)super.clone();
...
/* 1301 */     for (; n-- != 0; s.writeChar(i.nextChar()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1314 */     if (n == 1) {
/* 1315 */       Entry entry = new Entry(s.readChar());
...
/*      */ 
/*      */       
/* 1324 */       Entry entry = new Entry(s.readChar());
/* 1325 */       entry.black(true);
/* 1326 */       entry.right(new Entry(s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\CharRBTreeSet.class
