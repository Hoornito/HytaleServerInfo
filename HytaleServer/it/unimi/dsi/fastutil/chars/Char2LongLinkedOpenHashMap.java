...
/*  853 */     Long newValue = remappingFunction.apply(Character.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  866 */     int pos = find(k);
/*  867 */     Long newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  946 */       return Char2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  951 */       return Char2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  956 */       return Char2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  961 */       return Char2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  966 */       long oldValue = Char2LongLinkedOpenHashMap.this.value[this.index];
/*  967 */       Char2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharLongPair right(long v) {
/*  973 */       Char2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  985 */       return Character.valueOf(Char2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Long.valueOf(Char2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Character, Long> e = (Map.Entry<Character, Long>)o;
/* 1015 */       return (Char2LongLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Char2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Char2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Char2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Char2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Char2LongLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1198 */       if (from == '\000') {
/* 1199 */         if (Char2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Char2LongLinkedOpenHashMap.this.link[Char2LongLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Char2LongLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Char2LongLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Char2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Char2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Char2LongLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1214 */         if (Char2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Char2LongLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Char2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Char2LongLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Char2LongLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Char2LongLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Char2LongLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Char2LongLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Char2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Char2LongLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Char2LongLinkedOpenHashMap.this.link[this.prev] = Char2LongLinkedOpenHashMap.this.link[this.prev] ^ (Char2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Char2LongLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Char2LongLinkedOpenHashMap.this.link[this.next] = Char2LongLinkedOpenHashMap.this.link[this.next] ^ (Char2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Char2LongLinkedOpenHashMap.this.n) {
/* 1308 */         Char2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         char[] key = Char2LongLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == '\000') {
/* 1317 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Char2LongLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Char2LongLinkedOpenHashMap.this.value[last] = Char2LongLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Char2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2LongMap.Entry>> implements ObjectListIterator<Char2LongMap.Entry> {
...
/* 1367 */       action.accept(new Char2LongLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2LongMap.Entry>> implements ObjectListIterator<Char2LongMap.Entry> {
/* 1388 */     final Char2LongLinkedOpenHashMap.MapEntry entry = new Char2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2LongLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2LongMap.Entry last() {
/* 1471 */       if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1484 */       if (k == '\000') return (Char2LongLinkedOpenHashMap.this.containsNullKey && Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       char[] key = Char2LongLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Char2LongLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1490 */       if (k == curr) return (Char2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1494 */         if (k == curr) return (Char2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1507 */       if (k == '\000') {
/* 1508 */         if (Char2LongLinkedOpenHashMap.this.containsNullKey && Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Char2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       char[] key = Char2LongLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Char2LongLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Char2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Char2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Char2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Char2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Char2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Char2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Char2LongLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Char2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Char2LongLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
/* 1587 */       for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Char2LongLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Char2LongLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Char2LongLinkedOpenHashMap.MapEntry entry = new Char2LongLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Char2LongLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Char2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Char2LongLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1644 */       return Char2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Char2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1658 */       return new Char2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2LongLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1674 */       for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Char2LongLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Char2LongLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Char2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1688 */       return Char2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1693 */       int oldSize = Char2LongLinkedOpenHashMap.this.size;
/* 1694 */       Char2LongLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Char2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Char2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1705 */       if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1711 */       if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/* 1753 */       return Char2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Char2LongLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1770 */       return Char2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (LongIterator)new Char2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2LongLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1797 */             for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Char2LongLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Char2LongLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Char2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1811 */             return Char2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Char2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1936 */       c = (Char2LongLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2LongLinkedOpenHashMap.class
