...
/*  380 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Objects.equals(value[i], v)) return true;  }
/*  381 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  582 */       return Char2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  587 */       return Char2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  592 */       return Char2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  597 */       return Char2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  602 */       V oldValue = Char2ObjectOpenCustomHashMap.this.value[this.index];
/*  603 */       Char2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  604 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharObjectPair<V> right(V v) {
/*  609 */       Char2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  610 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  621 */       return Character.valueOf(Char2ObjectOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  629 */       return (Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Objects.equals(Char2ObjectOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  634 */       return Char2ObjectOpenCustomHashMap.this.strategy.hashCode(Char2ObjectOpenCustomHashMap.this.key[this.index]) ^ ((Char2ObjectOpenCustomHashMap.this.value[this.index] == null) ? 0 : Char2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  639 */       return Char2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Char2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  650 */     int pos = Char2ObjectOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  656 */     int last = -1;
/*      */     
/*  658 */     int c = Char2ObjectOpenCustomHashMap.this.size;
/*      */     
/*  660 */     boolean mustReturnNullKey = Char2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  679 */         return this.last = Char2ObjectOpenCustomHashMap.this.n;
/*      */       } 
/*  681 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  683 */         if (--this.pos < 0) {
/*      */           
/*  685 */           this.last = Integer.MIN_VALUE;
/*  686 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  687 */           int p = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask;
/*  688 */           for (; !Char2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2ObjectOpenCustomHashMap.this.mask);
/*  689 */           return p;
/*      */         } 
...
/*  698 */         acceptOnIndex(action, this.last = Char2ObjectOpenCustomHashMap.this.n);
/*  699 */         this.c--;
/*      */       } 
/*  701 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
/*  702 */       while (this.c != 0) {
/*  703 */         if (--this.pos < 0) {
/*      */           
/*  705 */           this.last = Integer.MIN_VALUE;
/*  706 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  707 */           int p = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask;
/*  708 */           for (; !Char2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2ObjectOpenCustomHashMap.this.mask);
...
/*  728 */       char[] key = Char2ObjectOpenCustomHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  730 */         pos = (last = pos) + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  732 */           if ((curr = key[pos]) == '\000') {
/*  733 */             key[last] = Character.MIN_VALUE;
/*  734 */             Char2ObjectOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  737 */           int slot = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2ObjectOpenCustomHashMap.this.mask;
/*  738 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  739 */             break;  pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*      */         } 
/*  741 */         if (pos < last) {
...
/*      */         } 
/*  745 */         key[last] = curr;
/*  746 */         Char2ObjectOpenCustomHashMap.this.value[last] = Char2ObjectOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  751 */       if (this.last == -1) throw new IllegalStateException(); 
/*  752 */       if (this.last == Char2ObjectOpenCustomHashMap.this.n)
/*  753 */       { Char2ObjectOpenCustomHashMap.this.containsNullKey = false;
/*  754 */         Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n] = null; }
/*  755 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  758 */       { Char2ObjectOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  759 */         this.last = -1;
/*      */         return; }
/*      */       
/*  762 */       Char2ObjectOpenCustomHashMap.this.size--;
/*  763 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ObjectMap.Entry<V>>> implements ObjectIterator<Char2ObjectMap.Entry<V>> { public Char2ObjectOpenCustomHashMap<V>.MapEntry next() {
/*  779 */       return this.entry = new Char2ObjectOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  785 */       action.accept(this.entry = new Char2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  796 */       this.entry = new Char2ObjectOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  817 */     int pos = 0;
/*      */     
/*  819 */     int max = Char2ObjectOpenCustomHashMap.this.n;
/*      */     
/*  821 */     int c = 0;
/*      */     
/*  823 */     boolean mustReturnNull = Char2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  843 */         this.c++;
/*  844 */         acceptOnIndex(action, Char2ObjectOpenCustomHashMap.this.n);
/*  845 */         return true;
/*      */       } 
/*  847 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
...
/*  862 */         this.c++;
/*  863 */         acceptOnIndex(action, Char2ObjectOpenCustomHashMap.this.n);
/*      */       } 
/*  865 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
...
/*      */       {
/*  878 */         return (Char2ObjectOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  883 */       return Math.min((Char2ObjectOpenCustomHashMap.this.size - this.c), (long)(Char2ObjectOpenCustomHashMap.this.realSize() / Char2ObjectOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  911 */         n--;
/*      */       } 
/*  913 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2ObjectMap.Entry<V>> action, int index) {
/*  941 */       action.accept(new Char2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  953 */       return new Char2ObjectOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator() {
/*  958 */       return new Char2ObjectOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2ObjectMap.Entry<V>> spliterator() {
/*  963 */       return new Char2ObjectOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  975 */       if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, false)) return (Char2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n], v));
/*      */       
/*  977 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  980 */       if ((curr = key[pos = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask]) == '\000') return false; 
/*  981 */       if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Char2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  984 */         if ((curr = key[pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask]) == '\000') return false; 
/*  985 */         if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Char2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  997 */       if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, false)) {
/*  998 */         if (Char2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n], v)) {
/*  999 */           Char2ObjectOpenCustomHashMap.this.removeNullEntry();
/* 1000 */           return true;
/*      */         } 
/* 1002 */         return false;
/*      */       } 
/*      */       
/* 1005 */       char[] key = Char2ObjectOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1008 */       if ((curr = key[pos = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1009 */       if (Char2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1010 */         if (Objects.equals(Char2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1011 */           Char2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1012 */           return true;
/*      */         } 
/* 1014 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1018 */         if (Char2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1019 */           Objects.equals(Char2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1020 */           Char2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1021 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1029 */       return Char2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1034 */       Char2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
/* 1040 */       if (Char2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(new Char2ObjectOpenCustomHashMap.MapEntry(Char2ObjectOpenCustomHashMap.this.n)); 
/* 1041 */       for (int pos = Char2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2ObjectOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(new Char2ObjectOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
/* 1047 */       Char2ObjectOpenCustomHashMap<V>.MapEntry entry = new Char2ObjectOpenCustomHashMap.MapEntry();
/* 1048 */       if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
/* 1049 */         entry.index = Char2ObjectOpenCustomHashMap.this.n;
/* 1050 */         consumer.accept(entry);
/*      */       } 
/* 1052 */       for (int pos = Char2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2ObjectOpenCustomHashMap.this.key[pos] != '\000') {
...
/* 1083 */       action.accept(Char2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1088 */       return Char2ObjectOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1109 */       action.accept(Char2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1121 */       return new Char2ObjectOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1126 */       return new Char2ObjectOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1132 */       if (Char2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2ObjectOpenCustomHashMap.this.key[Char2ObjectOpenCustomHashMap.this.n]); 
/* 1133 */       for (int pos = Char2ObjectOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1134 */         char k = Char2ObjectOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1141 */       return Char2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1146 */       return Char2ObjectOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1151 */       int oldSize = Char2ObjectOpenCustomHashMap.this.size;
/* 1152 */       Char2ObjectOpenCustomHashMap.this.remove(k);
/* 1153 */       return (Char2ObjectOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1158 */       Char2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1186 */       action.accept(Char2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1191 */       return Char2ObjectOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1212 */       action.accept(Char2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1226 */             return new Char2ObjectOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1231 */             return new Char2ObjectOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1237 */             if (Char2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n]); 
/* 1238 */             for (int pos = Char2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2ObjectOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(Char2ObjectOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1243 */             return Char2ObjectOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1248 */             return Char2ObjectOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1253 */             Char2ObjectOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1351 */       c = (Char2ObjectOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectOpenCustomHashMap.class
