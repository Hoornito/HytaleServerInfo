...
/*  839 */       Map.Entry<Character, Float> e = (Map.Entry<Character, Float>)o;
/*  840 */       return (this.key == ((Character)e.getKey()).charValue() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Char2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  950 */       if ((this.next = Char2FloatRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Char2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Char2FloatRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1089 */             Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1090 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1091 */             Char2FloatRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Char2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Char2FloatRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2FloatMap.Entry first() {
/* 1107 */             return Char2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2FloatMap.Entry last() {
/* 1112 */             return Char2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1117 */             return Char2FloatRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1122 */             return Char2FloatRBTreeMap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1127 */             return Char2FloatRBTreeMap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Char2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1169 */       return new Char2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (FloatIterator)new Char2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1227 */             return Char2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Char2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Char2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Char2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Char2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Char2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2FloatMap.Entry> comparator() {
/* 1341 */               return Char2FloatRBTreeMap.this.char2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1352 */               return (f != null && Char2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1363 */               if (f != null && Char2FloatRBTreeMap.Submap.this.in(f.key)) Char2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Char2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Char2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Char2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2FloatMap.Entry first() {
/* 1386 */               return Char2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2FloatMap.Entry last() {
/* 1391 */               return Char2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1396 */               return Char2FloatRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1401 */               return Char2FloatRBTreeMap.Submap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1406 */               return Char2FloatRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1415 */         return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1420 */         return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1435 */               return (FloatIterator)new Char2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1440 */               return Char2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Char2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Char2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1460 */       return (in(k) && Char2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(char k) {
/* 1478 */       char kk = k; Char2FloatRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Char2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(char k, float v) {
/* 1484 */       Char2FloatRBTreeMap.this.modified = false;
...
/* 1486 */       float oldValue = Char2FloatRBTreeMap.this.put(k, v);
/* 1487 */       return Char2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(char k) {
/* 1493 */       Char2FloatRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       float oldValue = Char2FloatRBTreeMap.this.remove(k);
/* 1496 */       return Char2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1517 */       return Char2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap headMap(char to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Char2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap tailMap(char from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Char2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap subMap(char from, char to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Char2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Char2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Char2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Char2FloatRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Char2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Char2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Char2FloatRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2FloatRBTreeMap.Entry e;
/* 1569 */       if (Char2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Char2FloatRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Char2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Char2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Char2FloatRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1587 */       Char2FloatRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1594 */       Char2FloatRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Char2FloatRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Char2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Char2FloatRBTreeMap.Submap.this.bottom && Char2FloatRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Char2FloatRBTreeMap.Submap.this.top && Char2FloatRBTreeMap.this.compare(k, (this.prev = Char2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Char2FloatRBTreeMap.this.locateKey(k);
/* 1620 */             if (Char2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Char2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Char2FloatRBTreeMap.this.compare(this.prev.key, Char2FloatRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Char2FloatRBTreeMap.Submap.this.top && this.next != null && Char2FloatRBTreeMap.this.compare(this.next.key, Char2FloatRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Char2FloatRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readChar(), s.readFloat());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readChar(), s.readFloat());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readChar(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatRBTreeMap.class
