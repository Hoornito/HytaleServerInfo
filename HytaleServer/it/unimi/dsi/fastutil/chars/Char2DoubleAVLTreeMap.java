...
/*  885 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return this.key ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1147 */             Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1149 */             Char2DoubleAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2DoubleMap.Entry first() {
/* 1165 */             return Char2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2DoubleMap.Entry last() {
/* 1170 */             return Char2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1175 */             return Char2DoubleAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1180 */             return Char2DoubleAVLTreeMap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1185 */             return Char2DoubleAVLTreeMap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (DoubleIterator)new Char2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1285 */             return Char2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Char2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2DoubleMap.Entry> comparator() {
/* 1399 */               return Char2DoubleAVLTreeMap.this.char2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2DoubleAVLTreeMap.Submap.this.in(f.key)) Char2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2DoubleMap.Entry first() {
/* 1444 */               return Char2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2DoubleMap.Entry last() {
/* 1449 */               return Char2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1454 */               return Char2DoubleAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1459 */               return Char2DoubleAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1464 */               return Char2DoubleAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2DoubleSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1493 */               return (DoubleIterator)new Char2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1498 */               return Char2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(char k) {
/* 1536 */       char kk = k; Char2DoubleAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(char k, double v) {
/* 1542 */       Char2DoubleAVLTreeMap.this.modified = false;
...
/* 1544 */       double oldValue = Char2DoubleAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(char k) {
/* 1551 */       Char2DoubleAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       double oldValue = Char2DoubleAVLTreeMap.this.remove(k);
/* 1554 */       return Char2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2DoubleSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Char2DoubleAVLTreeMap.Entry e;
/* 1605 */       if (Char2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2DoubleAVLTreeMap.Entry e;
/* 1627 */       if (Char2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2DoubleAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2DoubleAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2DoubleAVLTreeMap.Submap.this.bottom && Char2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2DoubleAVLTreeMap.Submap.this.top && Char2DoubleAVLTreeMap.this.compare(k, (this.prev = Char2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2DoubleAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Char2DoubleAVLTreeMap.this.compare(this.prev.key, Char2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2DoubleAVLTreeMap.Submap.this.top && this.next != null && Char2DoubleAVLTreeMap.this.compare(this.next.key, Char2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2DoubleMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Char2DoubleAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readDouble());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readDouble());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleAVLTreeMap.class
