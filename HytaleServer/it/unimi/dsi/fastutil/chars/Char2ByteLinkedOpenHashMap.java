...
/*  854 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     implements Char2ByteMap.Entry, Map.Entry<Character, Byte>, CharBytePair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  947 */       return Char2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  952 */       return Char2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  957 */       return Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  962 */       return Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  967 */       byte oldValue = Char2ByteLinkedOpenHashMap.this.value[this.index];
/*  968 */       Char2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBytePair right(byte v) {
/*  974 */       Char2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  986 */       return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/* 1016 */       return (Char2ByteLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return Char2ByteLinkedOpenHashMap.this.key[this.index] ^ Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Char2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Char2ByteLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1199 */       if (from == '\000') {
/* 1200 */         if (Char2ByteLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Char2ByteLinkedOpenHashMap.this.link[Char2ByteLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Char2ByteLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Char2ByteLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Char2ByteLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = HashCommon.mix(from) & Char2ByteLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Char2ByteLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1215 */         if (Char2ByteLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Char2ByteLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Char2ByteLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Char2ByteLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Char2ByteLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Char2ByteLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Char2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Char2ByteLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Char2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Char2ByteLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Char2ByteLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Char2ByteLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Char2ByteLinkedOpenHashMap.this.link[this.prev] = Char2ByteLinkedOpenHashMap.this.link[this.prev] ^ (Char2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Char2ByteLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Char2ByteLinkedOpenHashMap.this.link[this.next] = Char2ByteLinkedOpenHashMap.this.link[this.next] ^ (Char2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Char2ByteLinkedOpenHashMap.this.n) {
/* 1309 */         Char2ByteLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         char[] key = Char2ByteLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == '\000') {
/* 1318 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = HashCommon.mix(curr) & Char2ByteLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Char2ByteLinkedOpenHashMap.this.value[last] = Char2ByteLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Char2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ByteMap.Entry>> implements ObjectListIterator<Char2ByteMap.Entry> {
...
/* 1368 */       action.accept(new Char2ByteLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2ByteMap.Entry>> implements ObjectListIterator<Char2ByteMap.Entry> {
/* 1389 */     final Char2ByteLinkedOpenHashMap.MapEntry entry = new Char2ByteLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2ByteLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ByteMap.Entry last() {
/* 1472 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == '\000') return (Char2ByteLinkedOpenHashMap.this.containsNullKey && Char2ByteLinkedOpenHashMap.this.value[Char2ByteLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1487 */       char[] key = Char2ByteLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1490 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1491 */       if (k == curr) return (Char2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1495 */         if (k == curr) return (Char2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == '\000') {
/* 1509 */         if (Char2ByteLinkedOpenHashMap.this.containsNullKey && Char2ByteLinkedOpenHashMap.this.value[Char2ByteLinkedOpenHashMap.this.n] == v) {
/* 1510 */           Char2ByteLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       char[] key = Char2ByteLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1519 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Char2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1522 */           Char2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Char2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1531 */           Char2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Char2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Char2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Char2ByteLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Char2ByteLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Char2ByteLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
/* 1588 */       for (int i = Char2ByteLinkedOpenHashMap.this.size, next = Char2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Char2ByteLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Char2ByteLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Char2ByteLinkedOpenHashMap.MapEntry entry = new Char2ByteLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Char2ByteLinkedOpenHashMap.this.size, next = Char2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Char2ByteLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Char2ByteLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Char2ByteLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1645 */       return Char2ByteLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Char2ByteLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1659 */       return new Char2ByteLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ByteLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1675 */       for (int i = Char2ByteLinkedOpenHashMap.this.size, next = Char2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Char2ByteLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Char2ByteLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Char2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1689 */       return Char2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1694 */       int oldSize = Char2ByteLinkedOpenHashMap.this.size;
/* 1695 */       Char2ByteLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Char2ByteLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Char2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1706 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1712 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/* 1754 */       return Char2ByteLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Char2ByteLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1771 */       return Char2ByteLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (ByteIterator)new Char2ByteLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return ByteSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2ByteLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1798 */             for (int i = Char2ByteLinkedOpenHashMap.this.size, next = Char2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Char2ByteLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Char2ByteLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Char2ByteLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1812 */             return Char2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Char2ByteLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Char2ByteLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteLinkedOpenHashMap.class
