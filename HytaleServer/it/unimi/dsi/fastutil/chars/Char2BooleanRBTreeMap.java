...
/*  819 */       Map.Entry<Character, Boolean> e = (Map.Entry<Character, Boolean>)o;
/*  820 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Char2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  930 */       if ((this.next = Char2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Char2BooleanRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1046 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1057 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1067 */             if (!(e.getKey() instanceof Character)) return false; 
/* 1068 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1069 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1070 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1071 */             Char2BooleanRBTreeMap.this.remove(f.key);
/* 1072 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1077 */             return Char2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1082 */             Char2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2BooleanMap.Entry first() {
/* 1087 */             return Char2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2BooleanMap.Entry last() {
/* 1092 */             return Char2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1097 */             return Char2BooleanRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1102 */             return Char2BooleanRBTreeMap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1107 */             return Char2BooleanRBTreeMap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1144 */       return new Char2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1149 */       return new Char2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1202 */             return (BooleanIterator)new Char2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1207 */             return Char2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1212 */             return Char2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1217 */             Char2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1230 */     return new Submap(false, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Char2BooleanSortedMap tailMap(char from) {
/* 1235 */     return new Submap(from, false, false, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1279 */       if (!bottom && !top && Char2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1280 */       this.from = from;
/* 1281 */       this.bottom = bottom;
/* 1282 */       this.to = to;
/* 1283 */       this.top = top;
/* 1284 */       this.defRetValue = Char2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1303 */       return ((this.bottom || Char2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 1308 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator() {
/* 1311 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1316 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2BooleanMap.Entry> comparator() {
/* 1321 */               return Char2BooleanRBTreeMap.this.char2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1329 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1330 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1331 */               Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1332 */               return (f != null && Char2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1340 */               if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1341 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1342 */               Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1343 */               if (f != null && Char2BooleanRBTreeMap.Submap.this.in(f.key)) Char2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1344 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1349 */               int c = 0;
/* 1350 */               for (ObjectBidirectionalIterator<Char2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1351 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1356 */               return !(new Char2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1361 */               Char2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2BooleanMap.Entry first() {
/* 1366 */               return Char2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2BooleanMap.Entry last() {
/* 1371 */               return Char2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1376 */               return Char2BooleanRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1381 */               return Char2BooleanRBTreeMap.Submap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1386 */               return Char2BooleanRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1395 */         return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1400 */         return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1415 */               return (BooleanIterator)new Char2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1420 */               return Char2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1425 */               return Char2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1430 */               Char2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1440 */       return (in(k) && Char2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(char k) {
/* 1458 */       char kk = k; Char2BooleanRBTreeMap.Entry e;
/* 1459 */       return (in(kk) && (e = Char2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(char k, boolean v) {
/* 1464 */       Char2BooleanRBTreeMap.this.modified = false;
...
/* 1466 */       boolean oldValue = Char2BooleanRBTreeMap.this.put(k, v);
/* 1467 */       return Char2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1473 */       Char2BooleanRBTreeMap.this.modified = false;
/* 1474 */       if (!in(k)) return this.defRetValue; 
/* 1475 */       boolean oldValue = Char2BooleanRBTreeMap.this.remove(k);
/* 1476 */       return Char2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1497 */       return Char2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap headMap(char to) {
/* 1502 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1503 */       return (Char2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap tailMap(char from) {
/* 1508 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1509 */       return (Char2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2BooleanSortedMap subMap(char from, char to) {
/* 1514 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1515 */       if (!this.top) to = (Char2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1516 */       if (!this.bottom) from = (Char2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1527 */       if (Char2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1531 */       if (this.bottom) { e = Char2BooleanRBTreeMap.this.firstEntry; }
/*      */       else
/* 1533 */       { e = Char2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1535 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1539 */       if (e == null || (!this.top && Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1540 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2BooleanRBTreeMap.Entry e;
/* 1549 */       if (Char2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1553 */       if (this.top) { e = Char2BooleanRBTreeMap.this.lastEntry; }
/*      */       else
/* 1555 */       { e = Char2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1557 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1561 */       if (e == null || (!this.bottom && Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1562 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1567 */       Char2BooleanRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1574 */       Char2BooleanRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Char2BooleanRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1590 */         this.next = Char2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null) {
/* 1596 */           if (!Char2BooleanRBTreeMap.Submap.this.bottom && Char2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1597 */           else if (!Char2BooleanRBTreeMap.Submap.this.top && Char2BooleanRBTreeMap.this.compare(k, (this.prev = Char2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1599 */           { this.next = Char2BooleanRBTreeMap.this.locateKey(k);
/* 1600 */             if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1611 */         if (!Char2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Char2BooleanRBTreeMap.this.compare(this.prev.key, Char2BooleanRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1616 */         this.next = this.next.next();
/* 1617 */         if (!Char2BooleanRBTreeMap.Submap.this.top && this.next != null && Char2BooleanRBTreeMap.this.compare(this.next.key, Char2BooleanRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1705 */       c = (Char2BooleanRBTreeMap)super.clone();
...
/* 1778 */     if (n == 1) {
/* 1779 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1788 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
/* 1789 */       entry.black(true);
/* 1790 */       entry.right(new Entry(s.readChar(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanRBTreeMap.class
