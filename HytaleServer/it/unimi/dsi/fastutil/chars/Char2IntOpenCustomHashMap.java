...
/*  542 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*  634 */       return Char2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  639 */       return Char2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  644 */       return Char2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  649 */       return Char2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  654 */       int oldValue = Char2IntOpenCustomHashMap.this.value[this.index];
/*  655 */       Char2IntOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharIntPair right(int v) {
/*  661 */       Char2IntOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Character.valueOf(Char2IntOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Integer.valueOf(Char2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/*  703 */       return (Char2IntOpenCustomHashMap.this.strategy.equals(Char2IntOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Char2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Char2IntOpenCustomHashMap.this.strategy.hashCode(Char2IntOpenCustomHashMap.this.key[this.index]) ^ Char2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Char2IntOpenCustomHashMap.this.key[this.index] + "=>" + Char2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Char2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Char2IntOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Char2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Char2IntOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       char[] key = Char2IntOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask;
/*  762 */           for (; !Char2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2IntOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Char2IntOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       char[] key = Char2IntOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask;
/*  782 */           for (; !Char2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2IntOpenCustomHashMap.this.mask);
...
/*  802 */       char[] key = Char2IntOpenCustomHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  804 */         pos = (last = pos) + 1 & Char2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == '\000') {
/*  807 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2IntOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Char2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Char2IntOpenCustomHashMap.this.value[last] = Char2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Char2IntOpenCustomHashMap.this.n)
/*  826 */       { Char2IntOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Char2IntOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Char2IntOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectIterator<Char2IntMap.Entry> { public Char2IntOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Char2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Char2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Char2IntOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Char2IntOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Char2IntOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Char2IntOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       char[] key = Char2IntOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Char2IntOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       char[] key = Char2IntOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Char2IntOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Char2IntOpenCustomHashMap.this.size - this.c), (long)(Char2IntOpenCustomHashMap.this.realSize() / Char2IntOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       char[] key = Char2IntOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2IntMap.Entry> action, int index) {
/* 1013 */       action.accept(new Char2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Char2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2IntMap.Entry> fastIterator() {
/* 1030 */       return new Char2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2IntMap.Entry> spliterator() {
/* 1035 */       return new Char2IntOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Char2IntOpenCustomHashMap.this.strategy.equals(k, false)) return (Char2IntOpenCustomHashMap.this.containsNullKey && Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       char[] key = Char2IntOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1054 */       if (Char2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Char2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Char2IntOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1058 */         if (Char2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Char2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Char2IntOpenCustomHashMap.this.strategy.equals(k, false)) {
/* 1072 */         if (Char2IntOpenCustomHashMap.this.containsNullKey && Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n] == v) {
/* 1073 */           Char2IntOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       char[] key = Char2IntOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1083 */       if (Char2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Char2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Char2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Char2IntOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1092 */         if (Char2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Char2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Char2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Char2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Char2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
/* 1114 */       if (Char2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(new Char2IntOpenCustomHashMap.MapEntry(Char2IntOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Char2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2IntOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(new Char2IntOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
/* 1121 */       Char2IntOpenCustomHashMap.MapEntry entry = new Char2IntOpenCustomHashMap.MapEntry();
/* 1122 */       if (Char2IntOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Char2IntOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Char2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2IntOpenCustomHashMap.this.key[pos] != '\000') {
...
/* 1157 */       action.accept(Char2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1162 */       return Char2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1183 */       action.accept(Char2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Char2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1200 */       return new Char2IntOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1206 */       if (Char2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Char2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         char k = Char2IntOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Char2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1220 */       return Char2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1225 */       int oldSize = Char2IntOpenCustomHashMap.this.size;
/* 1226 */       Char2IntOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Char2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Char2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Char2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1265 */       return Char2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1286 */       action.accept(Char2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Char2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1305 */             return new Char2IntOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1311 */             if (Char2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Char2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2IntOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(Char2IntOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Char2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1322 */             return Char2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Char2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Char2IntOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntOpenCustomHashMap.class
