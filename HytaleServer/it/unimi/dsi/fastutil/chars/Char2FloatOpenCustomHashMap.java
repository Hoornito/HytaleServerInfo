...
/*  422 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && Float.floatToIntBits(value[i]) == Float.floatToIntBits(v)) return true;  }
/*  423 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  543 */     Float newValue = remappingFunction.apply(Character.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Float newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  635 */       return Char2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  640 */       return Char2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  645 */       return Char2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  650 */       return Char2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  655 */       float oldValue = Char2FloatOpenCustomHashMap.this.value[this.index];
/*  656 */       Char2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharFloatPair right(float v) {
/*  662 */       Char2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Character.valueOf(Char2FloatOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Float.valueOf(Char2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Character, Float> e = (Map.Entry<Character, Float>)o;
/*  704 */       return (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Char2FloatOpenCustomHashMap.this.strategy.hashCode(Char2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Char2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Char2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Char2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Char2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Char2FloatOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Char2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Char2FloatOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
/*  763 */           for (; !Char2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2FloatOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Char2FloatOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
/*  783 */           for (; !Char2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Char2FloatOpenCustomHashMap.this.mask);
...
/*  803 */       char[] key = Char2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  805 */         pos = (last = pos) + 1 & Char2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == '\000') {
/*  808 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2FloatOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Char2FloatOpenCustomHashMap.this.value[last] = Char2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Char2FloatOpenCustomHashMap.this.n)
/*  827 */       { Char2FloatOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Char2FloatOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Char2FloatOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2FloatMap.Entry>> implements ObjectIterator<Char2FloatMap.Entry> { public Char2FloatOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Char2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Char2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Char2FloatOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Char2FloatOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Char2FloatOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Char2FloatOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Char2FloatOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Char2FloatOpenCustomHashMap.this.size - this.c), (long)(Char2FloatOpenCustomHashMap.this.realSize() / Char2FloatOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Char2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2FloatMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2FloatMap.Entry> action, int index) {
/* 1014 */       action.accept(new Char2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Char2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2FloatMap.Entry> fastIterator() {
/* 1031 */       return new Char2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2FloatMap.Entry> spliterator() {
/* 1036 */       return new Char2FloatOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, false)) return (Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1051 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1055 */       if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1059 */         if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, false)) {
/* 1073 */         if (Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1074 */           Char2FloatOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       char[] key = Char2FloatOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1084 */       if (Char2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1086 */           Char2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask]) == '\000') return false; 
/* 1093 */         if (Char2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1095 */           Char2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Char2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Char2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
/* 1115 */       if (Char2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(new Char2FloatOpenCustomHashMap.MapEntry(Char2FloatOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Char2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2FloatOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(new Char2FloatOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
/* 1122 */       Char2FloatOpenCustomHashMap.MapEntry entry = new Char2FloatOpenCustomHashMap.MapEntry();
/* 1123 */       if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Char2FloatOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Char2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2FloatOpenCustomHashMap.this.key[pos] != '\000') {
...
/* 1158 */       action.accept(Char2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1163 */       return Char2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1184 */       action.accept(Char2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Char2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1201 */       return new Char2FloatOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1207 */       if (Char2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Char2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         char k = Char2FloatOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Char2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1221 */       return Char2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1226 */       int oldSize = Char2FloatOpenCustomHashMap.this.size;
/* 1227 */       Char2FloatOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Char2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Char2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Char2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1266 */       return Char2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1287 */       action.accept(Char2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Char2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1306 */             return new Char2FloatOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1312 */             if (Char2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Char2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Char2FloatOpenCustomHashMap.this.key[pos] != '\000') consumer.accept(Char2FloatOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Char2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1323 */             return Char2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Char2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Char2FloatOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatOpenCustomHashMap.class
