...
/*  520 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  612 */       return Char2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  617 */       return Char2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  622 */       return Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  627 */       return Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  632 */       byte oldValue = Char2ByteOpenHashMap.this.value[this.index];
/*  633 */       Char2ByteOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBytePair right(byte v) {
/*  639 */       Char2ByteOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  651 */       return Character.valueOf(Char2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Byte.valueOf(Char2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/*  681 */       return (Char2ByteOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return Char2ByteOpenHashMap.this.key[this.index] ^ Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Char2ByteOpenHashMap.this.key[this.index] + "=>" + Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Char2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Char2ByteOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Char2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Char2ByteOpenHashMap.this.n;
/*      */       } 
/*  733 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Char2ByteOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Char2ByteOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       char[] key = Char2ByteOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Char2ByteOpenHashMap.this.mask);
...
/*  780 */       char[] key = Char2ByteOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  782 */         pos = (last = pos) + 1 & Char2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == '\000') {
/*  785 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(curr) & Char2ByteOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Char2ByteOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Char2ByteOpenHashMap.this.value[last] = Char2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Char2ByteOpenHashMap.this.n)
/*  804 */       { Char2ByteOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Char2ByteOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Char2ByteOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2ByteMap.Entry>> implements ObjectIterator<Char2ByteMap.Entry> { public Char2ByteOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Char2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Char2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Char2ByteOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Char2ByteOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Char2ByteOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Char2ByteOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       char[] key = Char2ByteOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Char2ByteOpenHashMap.this.n);
/*      */       } 
/*  915 */       char[] key = Char2ByteOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Char2ByteOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Char2ByteOpenHashMap.this.size - this.c), (long)(Char2ByteOpenHashMap.this.realSize() / Char2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       char[] key = Char2ByteOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Char2ByteMap.Entry> action, int index) {
/*  991 */       action.accept(new Char2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Char2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
/* 1008 */       return new Char2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Char2ByteMap.Entry> spliterator() {
/* 1013 */       return new Char2ByteOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (k == '\000') return (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v);
/*      */       
/* 1028 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask]) == '\000') return false; 
/* 1032 */       if (k == curr) return (Char2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Char2ByteOpenHashMap.this.mask]) == '\000') return false; 
/* 1036 */         if (k == curr) return (Char2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == '\000') {
/* 1050 */         if (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v) {
/* 1051 */           Char2ByteOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask]) == '\000') return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Char2ByteOpenHashMap.this.value[pos] == v) {
/* 1063 */           Char2ByteOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Char2ByteOpenHashMap.this.mask]) == '\000') return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Char2ByteOpenHashMap.this.value[pos] == v) {
/* 1072 */           Char2ByteOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Char2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Char2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
/* 1092 */       if (Char2ByteOpenHashMap.this.containsNullKey) consumer.accept(new Char2ByteOpenHashMap.MapEntry(Char2ByteOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) { if (Char2ByteOpenHashMap.this.key[pos] != '\000') consumer.accept(new Char2ByteOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
/* 1099 */       Char2ByteOpenHashMap.MapEntry entry = new Char2ByteOpenHashMap.MapEntry();
/* 1100 */       if (Char2ByteOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Char2ByteOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) { if (Char2ByteOpenHashMap.this.key[pos] != '\000') {
...
/* 1135 */       action.accept(Char2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1140 */       return Char2ByteOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1161 */       action.accept(Char2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Char2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharSpliterator spliterator() {
/* 1178 */       return new Char2ByteOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1184 */       if (Char2ByteOpenHashMap.this.containsNullKey) consumer.accept(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         char k = Char2ByteOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Char2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1198 */       return Char2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1203 */       int oldSize = Char2ByteOpenHashMap.this.size;
/* 1204 */       Char2ByteOpenHashMap.this.remove(k);
/* 1205 */       return (Char2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Char2ByteOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Char2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1243 */       return Char2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1264 */       action.accept(Char2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Char2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1283 */             return new Char2ByteOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1289 */             if (Char2ByteOpenHashMap.this.containsNullKey) consumer.accept(Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) { if (Char2ByteOpenHashMap.this.key[pos] != '\000') consumer.accept(Char2ByteOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Char2ByteOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1300 */             return Char2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Char2ByteOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Char2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteOpenHashMap.class
