...
/*   53 */       char t = l.getChar(i);
/*   54 */       l.set(i, l.getChar(p));
/*   55 */       l.set(p, t);
/*      */     } 
/*   57 */     return l;
/*      */   }
...
/*  244 */       return CharIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/*  249 */       return CharIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator listIterator(int i) {
/*  254 */       if (i == 0) return CharIterators.EMPTY_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  313 */       return CharLists.EMPTY_LIST;
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*  333 */       return CharLists.EMPTY_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  399 */       return new char[] { this.element };
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator listIterator() {
/*  404 */       return CharIterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
...
/*  414 */       return CharSpliterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator listIterator(int i) {
/*  419 */       if (i > 1 || i < 0) throw new IndexOutOfBoundsException(); 
/*  420 */       CharListIterator l = listIterator();
/*  421 */       if (i == 1) l.nextChar(); 
/*  422 */       return l;
/*      */     }
/*      */ 
/*      */ 
...
/*  431 */       if (from != 0 || to != 1) return CharLists.EMPTY_LIST; 
/*  432 */       return this;
/*      */     }
/*      */ 
/*      */     
...
/*  438 */       action.accept(Character.valueOf(this.element));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean addAll(int i, Collection<? extends Character> c) {
...
/*  531 */       return new Object[] { Character.valueOf(this.element) };
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  634 */     return new Singleton(((Character)element).charValue());
/*      */   }
/*      */   
...
/*  656 */         return this.list.getChar(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*  677 */         return this.list.removeChar(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     public char getChar(int i) {
/* 1009 */       return this.list.getChar(i);
/*      */     }
/*      */ 
/*      */     
/*      */     public char set(int i, char k) {
...
/*      */     
/*      */     public CharListIterator listIterator() {
/* 1090 */       return CharIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
...
/*      */     
/*      */     public CharListIterator listIterator(int i) {
/* 1100 */       return CharIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */ 
/*      */     
/*      */     public CharList subList(int from, int to) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\CharLists.class
