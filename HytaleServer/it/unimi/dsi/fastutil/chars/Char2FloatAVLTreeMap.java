...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(Comparator<? super Character> c) {
/*   99 */     this();
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(Map<? extends Character, ? extends Float> m) {
/*  110 */     this();
/*  111 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(SortedMap<Character, Float> m) {
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(Char2FloatMap m) {
/*  130 */     this();
/*  131 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(Char2FloatSortedMap m) {
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(char[] k, float[] v, Comparator<? super Character> c) {
/*  153 */     this(c);
...
/*      */ 
/*      */   
/*      */   public Char2FloatAVLTreeMap(char[] k, float[] v) {
...
/*  885 */       Map.Entry<Character, Float> e = (Map.Entry<Character, Float>)o;
/*  886 */       return (this.key == ((Character)e.getKey()).charValue() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Char2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  998 */       if ((this.next = Char2FloatAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Char2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Char2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1147 */             Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1148 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1149 */             Char2FloatAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Char2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Char2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2FloatMap.Entry first() {
/* 1165 */             return Char2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2FloatMap.Entry last() {
/* 1170 */             return Char2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1175 */             return Char2FloatAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1180 */             return Char2FloatAVLTreeMap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1185 */             return Char2FloatAVLTreeMap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Char2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1227 */       return new Char2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (FloatIterator)new Char2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1285 */             return Char2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Char2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Char2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Char2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Char2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Char2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2FloatMap.Entry> comparator() {
/* 1399 */               return Char2FloatAVLTreeMap.this.char2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1410 */               return (f != null && Char2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               if (f != null && Char2FloatAVLTreeMap.Submap.this.in(f.key)) Char2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Char2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Char2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Char2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2FloatMap.Entry first() {
/* 1444 */               return Char2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2FloatMap.Entry last() {
/* 1449 */               return Char2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1454 */               return Char2FloatAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1459 */               return Char2FloatAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1464 */               return Char2FloatAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractChar2FloatSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1473 */         return new Char2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1478 */         return new Char2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1493 */               return (FloatIterator)new Char2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1498 */               return Char2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Char2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Char2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1518 */       return (in(k) && Char2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(char k) {
/* 1536 */       char kk = k; Char2FloatAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(char k, float v) {
/* 1542 */       Char2FloatAVLTreeMap.this.modified = false;
...
/* 1544 */       float oldValue = Char2FloatAVLTreeMap.this.put(k, v);
/* 1545 */       return Char2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(char k) {
/* 1551 */       Char2FloatAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       float oldValue = Char2FloatAVLTreeMap.this.remove(k);
/* 1554 */       return Char2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1575 */       return Char2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap headMap(char to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Char2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap tailMap(char from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Char2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2FloatSortedMap subMap(char from, char to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Char2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Char2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Char2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Char2FloatAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Char2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Char2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Char2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2FloatAVLTreeMap.Entry e;
/* 1627 */       if (Char2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Char2FloatAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Char2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Char2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Char2FloatAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1645 */       Char2FloatAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1652 */       Char2FloatAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Char2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Char2FloatAVLTreeMap.Submap.this.bottom && Char2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Char2FloatAVLTreeMap.Submap.this.top && Char2FloatAVLTreeMap.this.compare(k, (this.prev = Char2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Char2FloatAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Char2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Char2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Char2FloatAVLTreeMap.this.compare(this.prev.key, Char2FloatAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Char2FloatAVLTreeMap.Submap.this.top && this.next != null && Char2FloatAVLTreeMap.this.compare(this.next.key, Char2FloatAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Char2FloatMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Char2FloatAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readChar(), s.readFloat());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readChar(), s.readFloat());
/* 1866 */       entry.right(new Entry(s.readChar(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatAVLTreeMap.class
