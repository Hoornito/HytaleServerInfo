...
/*  94 */     this(m.size());
/*  95 */     int i = 0;
/*  96 */     for (ObjectIterator<Char2ShortMap.Entry> objectIterator = m.char2ShortEntrySet().iterator(); objectIterator.hasNext(); ) { Char2ShortMap.Entry e = objectIterator.next();
...
/* 110 */     this(m.size());
/* 111 */     int i = 0;
/* 112 */     for (Map.Entry<? extends Character, ? extends Short> e : m.entrySet()) {
...
/* 145 */       return new ObjectIterator<Char2ShortMap.Entry>() {
/* 146 */           int curr = -1; int next = 0;
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 150 */             return (this.next < Char2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 157 */             return new AbstractChar2ShortMap.BasicEntry(Char2ShortArrayMap.this.key[this.curr = this.next], Char2ShortArrayMap.this.value[this.next++]);
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
...
/* 163 */             this.curr = -1;
/* 164 */             int tail = Char2ShortArrayMap.this.size-- - this.next--;
/* 165 */             System.arraycopy(Char2ShortArrayMap.this.key, this.next + 1, Char2ShortArrayMap.this.key, this.next, tail);
/* 166 */             System.arraycopy(Char2ShortArrayMap.this.value, this.next + 1, Char2ShortArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
...
/* 173 */             int max = Char2ShortArrayMap.this.size;
/* 174 */             while (this.next < max) {
/* 175 */               action.accept(new AbstractChar2ShortMap.BasicEntry(Char2ShortArrayMap.this.key[this.curr = this.next], Char2ShortArrayMap.this.value[this.next++]));
/*     */             }
/*     */           }
/*     */         };
/*     */     }
...
/* 183 */       return new ObjectIterator<Char2ShortMap.Entry>() {
/* 184 */           int next = 0; int curr = -1;
/* 185 */           final AbstractChar2ShortMap.BasicEntry entry = new AbstractChar2ShortMap.BasicEntry();
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 189 */             return (this.next < Char2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 196 */             this.entry.key = Char2ShortArrayMap.this.key[this.curr = this.next];
/* 197 */             this.entry.value = Char2ShortArrayMap.this.value[this.next++];
...
/* 204 */             this.curr = -1;
/* 205 */             int tail = Char2ShortArrayMap.this.size-- - this.next--;
/* 206 */             System.arraycopy(Char2ShortArrayMap.this.key, this.next + 1, Char2ShortArrayMap.this.key, this.next, tail);
/* 207 */             System.arraycopy(Char2ShortArrayMap.this.value, this.next + 1, Char2ShortArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           public void forEachRemaining(Consumer<? super Char2ShortMap.Entry> action) {
/* 214 */             int max = Char2ShortArrayMap.this.size;
/* 215 */             while (this.next < max) {
/* 216 */               this.entry.key = Char2ShortArrayMap.this.key[this.curr = this.next];
/* 217 */               this.entry.value = Char2ShortArrayMap.this.value[this.next++];
...
/* 239 */         return new AbstractChar2ShortMap.BasicEntry(Char2ShortArrayMap.this.key[location], Char2ShortArrayMap.this.value[location]);
/*     */       }
/*     */ 
/*     */       
...
/* 250 */       return new EntrySetSpliterator(0, Char2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 258 */       for (int i = 0, max = Char2ShortArrayMap.this.size; i < max; i++) {
/* 259 */         action.accept(new AbstractChar2ShortMap.BasicEntry(Char2ShortArrayMap.this.key[i], Char2ShortArrayMap.this.value[i]));
/*     */       }
/*     */     }
/*     */ 
/*     */ 
...
/* 267 */       AbstractChar2ShortMap.BasicEntry entry = new AbstractChar2ShortMap.BasicEntry();
/*     */       
/* 269 */       for (int i = 0, max = Char2ShortArrayMap.this.size; i < max; i++) {
/* 270 */         entry.key = Char2ShortArrayMap.this.key[i];
/* 271 */         entry.value = Char2ShortArrayMap.this.value[i];
...
/*     */     
/*     */     public int size() {
/* 278 */       return Char2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 289 */       return (Char2ShortArrayMap.this.containsKey(k) && Char2ShortArrayMap.this.get(k) == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 301 */       int oldPos = Char2ShortArrayMap.this.findKey(k);
/* 302 */       if (oldPos == -1 || v != Char2ShortArrayMap.this.value[oldPos]) return false; 
/* 303 */       int tail = Char2ShortArrayMap.this.size - oldPos - 1;
/* 304 */       System.arraycopy(Char2ShortArrayMap.this.key, oldPos + 1, Char2ShortArrayMap.this.key, oldPos, tail);
/* 305 */       System.arraycopy(Char2ShortArrayMap.this.value, oldPos + 1, Char2ShortArrayMap.this.value, oldPos, tail);
/* 306 */       Char2ShortArrayMap.this.size--;
/* 307 */       return true;
/*     */     }
/*     */   }
/*     */ 
...
/* 398 */       return (Char2ShortArrayMap.this.findKey(k) != -1);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean remove(char k) {
/* 403 */       int oldPos = Char2ShortArrayMap.this.findKey(k);
/* 404 */       if (oldPos == -1) return false; 
/* 405 */       int tail = Char2ShortArrayMap.this.size - oldPos - 1;
/* 406 */       System.arraycopy(Char2ShortArrayMap.this.key, oldPos + 1, Char2ShortArrayMap.this.key, oldPos, tail);
/* 407 */       System.arraycopy(Char2ShortArrayMap.this.value, oldPos + 1, Char2ShortArrayMap.this.value, oldPos, tail);
/* 408 */       Char2ShortArrayMap.this.size--;
/* 409 */       return true;
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 419 */             return (this.pos < Char2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 426 */             return Char2ShortArrayMap.this.key[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 431 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 432 */             int tail = Char2ShortArrayMap.this.size - this.pos;
/* 433 */             System.arraycopy(Char2ShortArrayMap.this.key, this.pos, Char2ShortArrayMap.this.key, this.pos - 1, tail);
/* 434 */             System.arraycopy(Char2ShortArrayMap.this.value, this.pos, Char2ShortArrayMap.this.value, this.pos - 1, tail);
/* 435 */             Char2ShortArrayMap.this.size--;
/* 436 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 443 */             int max = Char2ShortArrayMap.this.size;
/* 444 */             while (this.pos < max)
/* 445 */               action.accept(Char2ShortArrayMap.this.key[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 465 */         return Char2ShortArrayMap.this.key[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(CharConsumer action) {
/* 477 */         int max = Char2ShortArrayMap.this.size;
/* 478 */         while (this.pos < max) {
/* 479 */           action.accept(Char2ShortArrayMap.this.key[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 486 */       return new KeySetSpliterator(0, Char2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 493 */       for (int i = 0, max = Char2ShortArrayMap.this.size; i < max; i++) {
/* 494 */         action.accept(Char2ShortArrayMap.this.key[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 500 */       return Char2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 505 */       Char2ShortArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/* 518 */       return Char2ShortArrayMap.this.containsValue(v);
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 528 */             return (this.pos < Char2ShortArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 535 */             return Char2ShortArrayMap.this.value[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 540 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 541 */             int tail = Char2ShortArrayMap.this.size - this.pos;
/* 542 */             System.arraycopy(Char2ShortArrayMap.this.key, this.pos, Char2ShortArrayMap.this.key, this.pos - 1, tail);
/* 543 */             System.arraycopy(Char2ShortArrayMap.this.value, this.pos, Char2ShortArrayMap.this.value, this.pos - 1, tail);
/* 544 */             Char2ShortArrayMap.this.size--;
/* 545 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 552 */             int max = Char2ShortArrayMap.this.size;
/* 553 */             while (this.pos < max)
/* 554 */               action.accept(Char2ShortArrayMap.this.value[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 574 */         return Char2ShortArrayMap.this.value[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(ShortConsumer action) {
/* 586 */         int max = Char2ShortArrayMap.this.size;
/* 587 */         while (this.pos < max) {
/* 588 */           action.accept(Char2ShortArrayMap.this.value[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 595 */       return new ValuesSpliterator(0, Char2ShortArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 602 */       for (int i = 0, max = Char2ShortArrayMap.this.size; i < max; i++) {
/* 603 */         action.accept(Char2ShortArrayMap.this.value[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 609 */       return Char2ShortArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 614 */       Char2ShortArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/*     */     try {
/* 638 */       c = (Char2ShortArrayMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortArrayMap.class
