...
/*  865 */       return (this.key == ((Character)e.getKey()).charValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Char2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(char k) {
/*  977 */       if ((this.next = Char2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Char2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Char2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             Char2ObjectAVLTreeMap.Entry<V> f = Char2ObjectAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1124 */             Char2ObjectAVLTreeMap.Entry<V> f = Char2ObjectAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1125 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1126 */             Char2ObjectAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Char2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Char2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ObjectMap.Entry<V> first() {
/* 1142 */             return Char2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Char2ObjectMap.Entry<V> last() {
/* 1147 */             return Char2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1152 */             return Char2ObjectAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1157 */             return Char2ObjectAVLTreeMap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1162 */             return Char2ObjectAVLTreeMap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Char2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1204 */       return new Char2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Char2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Char2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Char2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Char2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Char2ObjectAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Char2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Char2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Char2ObjectMap.Entry<V>> comparator() {
/* 1376 */               return Char2ObjectAVLTreeMap.this.char2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1385 */               Char2ObjectAVLTreeMap.Entry<V> f = Char2ObjectAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1386 */               return (f != null && Char2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1395 */               Char2ObjectAVLTreeMap.Entry<V> f = Char2ObjectAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1396 */               if (f != null && Char2ObjectAVLTreeMap.Submap.this.in(f.key)) Char2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Char2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Char2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ObjectMap.Entry<V> first() {
/* 1419 */               return Char2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Char2ObjectMap.Entry<V> last() {
/* 1424 */               return Char2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1429 */               return Char2ObjectAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1434 */               return Char2ObjectAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1439 */               return Char2ObjectAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public CharBidirectionalIterator iterator() {
/* 1448 */         return new Char2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1453 */         return new Char2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Char2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Char2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Char2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Char2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1493 */       return (in(k) && Char2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(char k) {
/* 1511 */       char kk = k; Char2ObjectAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Char2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(char k, V v) {
/* 1517 */       Char2ObjectAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Char2ObjectAVLTreeMap.this.put(k, v);
/* 1520 */       return Char2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(char k) {
/* 1526 */       Char2ObjectAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Char2ObjectAVLTreeMap.this.remove(k);
/* 1529 */       return Char2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1550 */       return Char2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> headMap(char to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Char2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> tailMap(char from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Char2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2ObjectSortedMap<V> subMap(char from, char to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Char2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Char2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Char2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Char2ObjectAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Char2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Char2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Char2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Char2ObjectAVLTreeMap.Entry<V> e;
/* 1602 */       if (Char2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Char2ObjectAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Char2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Char2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Char2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstCharKey() {
/* 1620 */       Char2ObjectAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public char lastCharKey() {
/* 1627 */       Char2ObjectAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Char2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(char k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Char2ObjectAVLTreeMap.Submap.this.bottom && Char2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Char2ObjectAVLTreeMap.Submap.this.top && Char2ObjectAVLTreeMap.this.compare(k, (this.prev = Char2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Char2ObjectAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Char2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Char2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Char2ObjectAVLTreeMap.this.compare(this.prev.key, Char2ObjectAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Char2ObjectAVLTreeMap.Submap.this.top && this.next != null && Char2ObjectAVLTreeMap.this.compare(this.next.key, Char2ObjectAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Char2ObjectAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectAVLTreeMap.class
