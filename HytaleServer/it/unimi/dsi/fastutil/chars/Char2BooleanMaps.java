...
/*  50 */     return (entries instanceof Char2BooleanMap.FastEntrySet) ? ((Char2BooleanMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Char2BooleanMap.Entry> entries = map.char2BooleanEntrySet();
/*  66 */     if (entries instanceof Char2BooleanMap.FastEntrySet) { ((Char2BooleanMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Char2BooleanMap.Entry> entries = map.char2BooleanEntrySet();
/*  83 */     return (entries instanceof Char2BooleanMap.FastEntrySet) ? new ObjectIterable<Char2BooleanMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Char2BooleanMap.Entry> iterator() {
/*  86 */           return ((Char2BooleanMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Char2BooleanMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Char2BooleanMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractChar2BooleanMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)char2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/* 316 */     return new Singleton(key.charValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Char2BooleanFunctions.SynchronizedFunction implements Char2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.char2BooleanEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Boolean>> entrySet() {
/* 381 */       return (ObjectSet)char2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/*     */     extends Char2BooleanFunctions.UnmodifiableFunction implements Char2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2BooleanMap map;
/*     */     protected transient ObjectSet<Char2BooleanMap.Entry> entries;
/*     */     protected transient CharSet keys;
...
/*     */     
/*     */     public ObjectSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.char2BooleanEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Boolean>> entrySet() {
/* 712 */       return (ObjectSet)char2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public CharSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanMaps.class
