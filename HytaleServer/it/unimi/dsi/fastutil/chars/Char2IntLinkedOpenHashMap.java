...
/*  154 */     this.value = new int[this.n + 1];
...
/*  273 */     int oldValue = this.value[this.n];
/*  274 */     this.size--;
...
/*  289 */     if (k == '\000') return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  291 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  294 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return -(pos + 1); 
/*  295 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
/*  298 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return -(pos + 1); 
...
/*  333 */     int oldValue = this.value[pos];
...
/*      */       char curr;
/*  361 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  362 */         if (curr == k) return addToValue(pos, incr); 
/*  363 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) return addToValue(pos, incr);  }
/*      */       
/*      */       } 
/*  366 */     }  this.key[pos] = k;
...
/*  392 */     char[] key = this.key; while (true) {
/*      */       char curr; int last;
/*  394 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  396 */         if ((curr = key[pos]) == '\000') {
/*  397 */           key[last] = Character.MIN_VALUE;
/*      */           return;
/*      */         } 
/*  400 */         int slot = HashCommon.mix(curr) & this.mask;
...
/*      */     char curr;
/*      */     int pos;
/*  421 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  422 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  424 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  425 */       if (k == curr) return removeEntry(pos); 
/*      */     } 
/*      */   }
/*      */   
/*      */   private int setValue(int pos, int v) {
/*  430 */     int oldValue = this.value[pos];
...
/*      */     } 
/*      */     
/*  542 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  545 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  546 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  552 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  553 */       if (k == curr) {
...
/*      */     } 
/*      */     
/*  577 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  580 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  581 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  587 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
/*  588 */       if (k == curr) {
...
/*      */     } else {
/*      */       
/*  664 */       char[] key = this.key;
/*      */       char curr;
/*  666 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != '\000') {
/*  667 */         if (curr == k) {
/*  668 */           moveIndexToLast(pos);
/*  669 */           return setValue(pos, v);
/*      */         } 
/*  671 */         while ((curr = key[pos = pos + 1 & this.mask]) != '\000') { if (curr == k) {
...
/*  696 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  698 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  701 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return this.defRetValue; 
/*  702 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  705 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return this.defRetValue; 
...
/*  713 */     if (k == '\000') return this.containsNullKey;
/*      */     
/*  715 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  718 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  719 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  722 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  729 */     int[] value = this.value;
/*  730 */     char[] key = this.key;
/*  731 */     if (this.containsNullKey && value[this.n] == v) return true; 
/*  732 */     for (int i = this.n; i-- != 0;) { if (key[i] != '\000' && value[i] == v) return true;  }
/*  733 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  740 */     if (k == '\000') return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  742 */     char[] key = this.key;
/*      */     char curr;
/*      */     int pos;
/*  745 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return defaultValue; 
/*  746 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  749 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return defaultValue; 
...
/*      */     char curr;
/*      */     int pos;
/*  778 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == '\000') return false; 
/*  779 */     if (k == curr && v == this.value[pos]) {
/*  780 */       removeEntry(pos);
/*  781 */       return true;
/*      */     } 
/*      */     while (true) {
/*  784 */       if ((curr = key[pos = pos + 1 & this.mask]) == '\000') return false; 
...
/*  806 */     int oldValue = this.value[pos];
...
/*  817 */     int newValue = mappingFunction.applyAsInt(k);
...
/*  829 */     int newValue = mappingFunction.get(key);
...
/*  840 */     Integer newValue = mappingFunction.apply(k);
/*  841 */     if (newValue == null) return this.defRetValue; 
/*  842 */     int v = newValue.intValue();
...
/*  853 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), Integer.valueOf(this.value[pos]));
/*  854 */     if (newValue == null) {
/*  855 */       if (k == '\000') { removeNullEntry(); }
/*  856 */       else { removeEntry(pos); }
/*  857 */        return this.defRetValue;
/*      */     } 
/*  859 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  866 */     int pos = find(k);
/*  867 */     Integer newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
/*  868 */     if (newValue == null) {
/*  869 */       if (pos >= 0)
/*  870 */         if (k == '\000') { removeNullEntry(); }
/*  871 */         else { removeEntry(pos); }
/*      */          
/*  873 */       return this.defRetValue;
/*      */     } 
/*  875 */     int newVal = newValue.intValue();
/*  876 */     if (pos < 0) {
...
/*  892 */        return v;
/*      */     } 
/*  894 */     Integer newValue = remappingFunction.apply(Integer.valueOf(this.value[pos]), Integer.valueOf(v));
/*  895 */     if (newValue == null) {
/*  896 */       if (k == '\000') { removeNullEntry(); }
/*  897 */       else { removeEntry(pos); }
/*  898 */        return this.defRetValue;
/*      */     } 
/*  900 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     implements Char2IntMap.Entry, Map.Entry<Character, Integer>, CharIntPair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  946 */       return Char2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char leftChar() {
/*  951 */       return Char2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  956 */       return Char2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  961 */       return Char2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  966 */       int oldValue = Char2IntLinkedOpenHashMap.this.value[this.index];
/*  967 */       Char2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public CharIntPair right(int v) {
/*  973 */       Char2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  985 */       return Character.valueOf(Char2IntLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Integer.valueOf(Char2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1007 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1014 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/* 1015 */       return (Char2IntLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Char2IntLinkedOpenHashMap.this.key[this.index] ^ Char2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Char2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Char2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Char2IntLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(char from) {
/* 1198 */       if (from == '\000') {
/* 1199 */         if (Char2IntLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Char2IntLinkedOpenHashMap.this.link[Char2IntLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Char2IntLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Char2IntLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Char2IntLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Char2IntLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Char2IntLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1214 */         if (Char2IntLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Char2IntLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Char2IntLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Char2IntLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Char2IntLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Char2IntLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Char2IntLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Char2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Char2IntLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Char2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Char2IntLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Char2IntLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Char2IntLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Char2IntLinkedOpenHashMap.this.link[this.prev] = Char2IntLinkedOpenHashMap.this.link[this.prev] ^ (Char2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Char2IntLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Char2IntLinkedOpenHashMap.this.link[this.next] = Char2IntLinkedOpenHashMap.this.link[this.next] ^ (Char2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Char2IntLinkedOpenHashMap.this.n) {
/* 1308 */         Char2IntLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         char[] key = Char2IntLinkedOpenHashMap.this.key; while (true) {
/*      */           char curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Char2IntLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == '\000') {
/* 1317 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Char2IntLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Char2IntLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Char2IntLinkedOpenHashMap.this.value[last] = Char2IntLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Char2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectListIterator<Char2IntMap.Entry> {
...
/* 1367 */       action.accept(new Char2IntLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Char2IntLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Char2IntLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectListIterator<Char2IntMap.Entry> {
/* 1388 */     final Char2IntLinkedOpenHashMap.MapEntry entry = new Char2IntLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Char2IntLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Char2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Char2IntLinkedOpenHashMap.MapEntry(Char2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Char2IntMap.Entry last() {
/* 1471 */       if (Char2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Char2IntLinkedOpenHashMap.MapEntry(Char2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1480 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1481 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1482 */       char k = ((Character)e.getKey()).charValue();
/* 1483 */       int v = ((Integer)e.getValue()).intValue();
/* 1484 */       if (k == '\000') return (Char2IntLinkedOpenHashMap.this.containsNullKey && Char2IntLinkedOpenHashMap.this.value[Char2IntLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       char[] key = Char2IntLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Char2IntLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1490 */       if (k == curr) return (Char2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Char2IntLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1494 */         if (k == curr) return (Char2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1503 */       if (e.getKey() == null || !(e.getKey() instanceof Character)) return false; 
/* 1504 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1505 */       char k = ((Character)e.getKey()).charValue();
/* 1506 */       int v = ((Integer)e.getValue()).intValue();
/* 1507 */       if (k == '\000') {
/* 1508 */         if (Char2IntLinkedOpenHashMap.this.containsNullKey && Char2IntLinkedOpenHashMap.this.value[Char2IntLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Char2IntLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       char[] key = Char2IntLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Char2IntLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Char2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Char2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Char2IntLinkedOpenHashMap.this.mask]) == '\000') return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Char2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Char2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Char2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Char2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Char2IntLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Char2IntLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Char2IntLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
/* 1587 */       for (int i = Char2IntLinkedOpenHashMap.this.size, next = Char2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Char2IntLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Char2IntLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Char2IntLinkedOpenHashMap.MapEntry entry = new Char2IntLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Char2IntLinkedOpenHashMap.this.size, next = Char2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Char2IntLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Char2IntLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Char2IntLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1644 */       return Char2IntLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Char2IntLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public CharListIterator iterator() {
/* 1658 */       return new Char2IntLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2IntLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(CharConsumer consumer) {
/* 1674 */       for (int i = Char2IntLinkedOpenHashMap.this.size, next = Char2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Char2IntLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Char2IntLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Char2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(char k) {
/* 1688 */       return Char2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1693 */       int oldSize = Char2IntLinkedOpenHashMap.this.size;
/* 1694 */       Char2IntLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Char2IntLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Char2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public char firstChar() {
/* 1705 */       if (Char2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public char lastChar() {
/* 1711 */       if (Char2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public CharComparator comparator() {
...
/* 1753 */       return Char2IntLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Char2IntLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1770 */       return Char2IntLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
/*      */   public IntCollection values() {
/* 1776 */     if (this.values == null) this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           private static final int SPLITERATOR_CHARACTERISTICS = 336;
/*      */           
/*      */           public IntIterator iterator() {
/* 1781 */             return (IntIterator)new Char2IntLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Char2IntLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1797 */             for (int i = Char2IntLinkedOpenHashMap.this.size, next = Char2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Char2IntLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Char2IntLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Char2IntLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1811 */             return Char2IntLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Char2IntLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1880 */     char[] key = this.key;
/* 1881 */     int[] value = this.value;
/* 1882 */     int mask = newN - 1;
/* 1883 */     char[] newKey = new char[newN + 1];
/* 1884 */     int[] newValue = new int[newN + 1];
...
/* 1890 */       int pos; if (key[i] == '\000') { pos = newN; }
/*      */       else
/* 1892 */       { pos = HashCommon.mix(key[i]) & mask;
/* 1893 */         for (; newKey[pos] != '\000'; pos = pos + 1 & mask); }
/*      */       
...
/*      */     try {
/* 1936 */       c = (Char2IntLinkedOpenHashMap)super.clone();
...
/* 1944 */     c.key = (char[])this.key.clone();
/* 1945 */     c.value = (int[])this.value.clone();
...
/*      */     } 
/*      */     
/* 1970 */     if (this.containsNullKey) h += this.value[this.n]; 
/* 1971 */     return h;
/*      */   }
/*      */   
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1975 */     char[] key = this.key;
/* 1976 */     int[] value = this.value;
/* 1977 */     EntryIterator i = new EntryIterator();
/* 1978 */     s.defaultWriteObject();
/* 1979 */     for (int j = this.size; j-- != 0; ) {
/* 1980 */       int e = i.nextEntry();
/* 1981 */       s.writeChar(key[e]);
/* 1982 */       s.writeInt(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1991 */     char[] key = this.key = new char[this.n + 1];
/* 1992 */     int[] value = this.value = new int[this.n + 1];
...
/* 1999 */       int pos; char k = s.readChar();
/* 2000 */       int v = s.readInt();
/* 2001 */       if (k == '\000') {
/* 2002 */         pos = this.n;
/* 2003 */         this.containsNullKey = true;
/*      */       } else {
/* 2005 */         pos = HashCommon.mix(k) & this.mask;
/* 2006 */         for (; key[pos] != '\000'; pos = pos + 1 & this.mask);
/*      */       } 
/* 2008 */       key[pos] = k;
/* 2009 */       value[pos] = v;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\Char2IntLinkedOpenHashMap.class
