...
/*  62 */     this(refArray, capacity, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  83 */     this(refArray, refArray.length, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 101 */     this.heap = a;
/* 102 */     this.size = size;
/* 103 */     CharSemiIndirectHeaps.makeHeap(refArray, a, size, c);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 170 */     CharSemiIndirectHeaps.upHeap(this.refArray, this.heap, this.size, this.size - 1, this.c);
/*     */   }
/*     */ 
/*     */   
/*     */   public int dequeue() {
...
/* 178 */     if (this.size != 0) CharSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c); 
/* 179 */     return result;
/*     */   }
/*     */ 
/*     */   
...
/*     */   
/*     */   public void changed() {
/* 198 */     CharSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 237 */     return (this.c == null) ? CharSemiIndirectHeaps.front(this.refArray, this.heap, this.size, a) : CharSemiIndirectHeaps.front(this.refArray, this.heap, this.size, a, this.c);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\chars\CharHeapSemiIndirectPriorityQueue.class
