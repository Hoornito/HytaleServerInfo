...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Long2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Long2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Long2ByteFunction singleton(Long key, Byte value) {
/* 179 */     return new Singleton(key.longValue(), value.byteValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractLong2ByteFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2ByteFunction function;
/*     */     
...
/* 544 */       Byte v = this.function.apply(Long.valueOf(key));
...
/* 551 */       Byte v = this.function.apply(Long.valueOf(key));
...
/* 597 */     if (f instanceof Long2ByteFunction) return (Long2ByteFunction)f; 
/* 598 */     if (f instanceof LongToIntFunction) return key -> SafeMath.safeIntToByte(((LongToIntFunction)f).applyAsInt(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteFunctions.class
