...
/*  399 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && Float.floatToIntBits(value[i]) == Float.floatToIntBits(v)) return true;  }
/*  400 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  520 */     Float newValue = remappingFunction.apply(Long.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Float newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  612 */       return Long2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  617 */       return Long2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  622 */       return Long2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  627 */       return Long2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  632 */       float oldValue = Long2FloatOpenHashMap.this.value[this.index];
/*  633 */       Long2FloatOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongFloatPair right(float v) {
/*  639 */       Long2FloatOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  651 */       return Long.valueOf(Long2FloatOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Float.valueOf(Long2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
/*  681 */       return (Long2FloatOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return HashCommon.long2int(Long2FloatOpenHashMap.this.key[this.index]) ^ HashCommon.float2int(Long2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Long2FloatOpenHashMap.this.key[this.index] + "=>" + Long2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Long2FloatOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Long2FloatOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Long2FloatOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Long2FloatOpenHashMap.this.n;
/*      */       } 
/*  733 */       long[] key = Long2FloatOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  739 */           int p = (int)HashCommon.mix(k) & Long2FloatOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Long2FloatOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Long2FloatOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       long[] key = Long2FloatOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  759 */           int p = (int)HashCommon.mix(k) & Long2FloatOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Long2FloatOpenHashMap.this.mask);
...
/*  780 */       long[] key = Long2FloatOpenHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  782 */         pos = (last = pos) + 1 & Long2FloatOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == 0L) {
/*  785 */             key[last] = 0L;
/*      */             return;
/*      */           } 
/*  788 */           int slot = (int)HashCommon.mix(curr) & Long2FloatOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Long2FloatOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Long2FloatOpenHashMap.this.value[last] = Long2FloatOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Long2FloatOpenHashMap.this.n)
/*  804 */       { Long2FloatOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Long2FloatOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Long2FloatOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2FloatMap.Entry>> implements ObjectIterator<Long2FloatMap.Entry> { public Long2FloatOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Long2FloatOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Long2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Long2FloatOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Long2FloatOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Long2FloatOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Long2FloatOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       long[] key = Long2FloatOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Long2FloatOpenHashMap.this.n);
/*      */       } 
/*  915 */       long[] key = Long2FloatOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Long2FloatOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Long2FloatOpenHashMap.this.size - this.c), (long)(Long2FloatOpenHashMap.this.realSize() / Long2FloatOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       long[] key = Long2FloatOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2FloatMap.Entry> action, int index) {
/*  991 */       action.accept(new Long2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Long2FloatOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2FloatMap.Entry> fastIterator() {
/* 1008 */       return new Long2FloatOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2FloatMap.Entry> spliterator() {
/* 1013 */       return new Long2FloatOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (k == 0L) return (Long2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1028 */       long[] key = Long2FloatOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2FloatOpenHashMap.this.mask]) == 0L) return false; 
/* 1032 */       if (k == curr) return (Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Long2FloatOpenHashMap.this.mask]) == 0L) return false; 
/* 1036 */         if (k == curr) return (Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == 0L) {
/* 1050 */         if (Long2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1051 */           Long2FloatOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       long[] key = Long2FloatOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2FloatOpenHashMap.this.mask]) == 0L) return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1063 */           Long2FloatOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Long2FloatOpenHashMap.this.mask]) == 0L) return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1072 */           Long2FloatOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Long2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Long2FloatOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
/* 1092 */       if (Long2FloatOpenHashMap.this.containsNullKey) consumer.accept(new Long2FloatOpenHashMap.MapEntry(Long2FloatOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Long2FloatOpenHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenHashMap.this.key[pos] != 0L) consumer.accept(new Long2FloatOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
/* 1099 */       Long2FloatOpenHashMap.MapEntry entry = new Long2FloatOpenHashMap.MapEntry();
/* 1100 */       if (Long2FloatOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Long2FloatOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Long2FloatOpenHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenHashMap.this.key[pos] != 0L) {
...
/* 1135 */       action.accept(Long2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1140 */       return Long2FloatOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1161 */       action.accept(Long2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Long2FloatOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1178 */       return new Long2FloatOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1184 */       if (Long2FloatOpenHashMap.this.containsNullKey) consumer.accept(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Long2FloatOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         long k = Long2FloatOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Long2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1198 */       return Long2FloatOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1203 */       int oldSize = Long2FloatOpenHashMap.this.size;
/* 1204 */       Long2FloatOpenHashMap.this.remove(k);
/* 1205 */       return (Long2FloatOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Long2FloatOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Long2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1243 */       return Long2FloatOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1264 */       action.accept(Long2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Long2FloatOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1283 */             return new Long2FloatOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1289 */             if (Long2FloatOpenHashMap.this.containsNullKey) consumer.accept(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Long2FloatOpenHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenHashMap.this.key[pos] != 0L) consumer.accept(Long2FloatOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Long2FloatOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1300 */             return Long2FloatOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Long2FloatOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Long2FloatOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatOpenHashMap.class
