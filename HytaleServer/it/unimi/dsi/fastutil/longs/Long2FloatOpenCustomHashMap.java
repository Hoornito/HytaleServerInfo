...
/*  422 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && Float.floatToIntBits(value[i]) == Float.floatToIntBits(v)) return true;  }
/*  423 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  543 */     Float newValue = remappingFunction.apply(Long.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Float newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  635 */       return Long2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  640 */       return Long2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  645 */       return Long2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  650 */       return Long2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  655 */       float oldValue = Long2FloatOpenCustomHashMap.this.value[this.index];
/*  656 */       Long2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongFloatPair right(float v) {
/*  662 */       Long2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  674 */       return Long.valueOf(Long2FloatOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Float.valueOf(Long2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
/*  704 */       return (Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue()) && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Long2FloatOpenCustomHashMap.this.strategy.hashCode(Long2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Long2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Long2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Long2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Long2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Long2FloatOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Long2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Long2FloatOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Long2FloatOpenCustomHashMap.this.mask;
/*  763 */           for (; !Long2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2FloatOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Long2FloatOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Long2FloatOpenCustomHashMap.this.mask;
/*  783 */           for (; !Long2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2FloatOpenCustomHashMap.this.mask);
...
/*  803 */       long[] key = Long2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  805 */         pos = (last = pos) + 1 & Long2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0L) {
/*  808 */             key[last] = 0L;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2FloatOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Long2FloatOpenCustomHashMap.this.value[last] = Long2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Long2FloatOpenCustomHashMap.this.n)
/*  827 */       { Long2FloatOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Long2FloatOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Long2FloatOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2FloatMap.Entry>> implements ObjectIterator<Long2FloatMap.Entry> { public Long2FloatOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Long2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Long2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Long2FloatOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Long2FloatOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Long2FloatOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Long2FloatOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Long2FloatOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Long2FloatOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Long2FloatOpenCustomHashMap.this.size - this.c), (long)(Long2FloatOpenCustomHashMap.this.realSize() / Long2FloatOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Long2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2FloatMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2FloatMap.Entry> action, int index) {
/* 1014 */       action.accept(new Long2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Long2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2FloatMap.Entry> fastIterator() {
/* 1031 */       return new Long2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2FloatMap.Entry> spliterator() {
/* 1036 */       return new Long2FloatOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) return (Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1051 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Long2FloatOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1055 */       if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1059 */         if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/* 1073 */         if (Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1074 */           Long2FloatOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       long[] key = Long2FloatOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Long2FloatOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1084 */       if (Long2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1086 */           Long2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1093 */         if (Long2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1095 */           Long2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Long2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Long2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
/* 1115 */       if (Long2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(new Long2FloatOpenCustomHashMap.MapEntry(Long2FloatOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Long2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(new Long2FloatOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
/* 1122 */       Long2FloatOpenCustomHashMap.MapEntry entry = new Long2FloatOpenCustomHashMap.MapEntry();
/* 1123 */       if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Long2FloatOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Long2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenCustomHashMap.this.key[pos] != 0L) {
...
/* 1158 */       action.accept(Long2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1163 */       return Long2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1184 */       action.accept(Long2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Long2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1201 */       return new Long2FloatOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1207 */       if (Long2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2FloatOpenCustomHashMap.this.key[Long2FloatOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Long2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         long k = Long2FloatOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Long2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1221 */       return Long2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1226 */       int oldSize = Long2FloatOpenCustomHashMap.this.size;
/* 1227 */       Long2FloatOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Long2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Long2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Long2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1266 */       return Long2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1287 */       action.accept(Long2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Long2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1306 */             return new Long2FloatOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1312 */             if (Long2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Long2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2FloatOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(Long2FloatOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Long2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1323 */             return Long2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Long2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Long2FloatOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatOpenCustomHashMap.class
