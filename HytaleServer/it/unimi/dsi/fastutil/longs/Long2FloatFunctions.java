...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Long2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Long2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Long2FloatFunction singleton(Long key, Float value) {
/* 179 */     return new Singleton(key.longValue(), value.floatValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractLong2FloatFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2FloatFunction function;
/*     */     
...
/* 544 */       Float v = this.function.apply(Long.valueOf(key));
...
/* 551 */       Float v = this.function.apply(Long.valueOf(key));
...
/* 597 */     if (f instanceof Long2FloatFunction) return (Long2FloatFunction)f; 
/* 598 */     if (f instanceof LongToDoubleFunction) return key -> SafeMath.safeDoubleToFloat(((LongToDoubleFunction)f).applyAsDouble(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatFunctions.class
