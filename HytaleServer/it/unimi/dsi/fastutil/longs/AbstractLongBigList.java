...
/* 158 */     return new LongBigListIterators.AbstractIndexBasedBigListIterator(0L, index)
/*     */       {
/*     */         protected final long get(long i) {
/* 161 */           return AbstractLongBigList.this.getLong(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void add(long i, long k) {
/* 166 */           AbstractLongBigList.this.add(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void set(long i, long k) {
/* 171 */           AbstractLongBigList.this.set(i, k);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final void remove(long i) {
/* 176 */           AbstractLongBigList.this.removeLong(i);
/*     */         }
/*     */ 
/*     */         
/*     */         protected final long getMaxPos() {
/* 181 */           return AbstractLongBigList.this.size64();
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 228 */     LongBigListIterator i = listIterator();
/*     */     
/* 230 */     while (i.hasNext()) {
/* 231 */       long e = i.nextLong();
...
/* 239 */     LongBigListIterator i = listIterator(size64());
/*     */     
/* 241 */     while (i.hasPrevious()) {
/* 242 */       long e = i.previousLong();
...
/* 250 */     long i = size64();
/* 251 */     if (size > i) { for (; i++ < size; add(0L)); }
...
/* 260 */     return (this instanceof RandomAccess) ? new LongRandomAccessSubList(this, from, to) : new LongSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 290 */     ensureIndex(to);
/* 291 */     LongBigListIterator i = listIterator(from);
/* 292 */     long n = to - from;
...
/*     */     //   43: ladd
/*     */     //   44: lstore #4
/*     */     //   46: invokestatic get : ([[JJ)J
/*     */     //   49: invokevirtual add : (JJ)V
/*     */     //   52: goto -> 20
/*     */     //   55: aload_0
/*     */     //   56: lload_1
/*     */     //   57: invokevirtual listIterator : (J)Lit/unimi/dsi/fastutil/longs/LongBigListIterator;
/*     */     //   60: astore #8
/*     */     //   62: lload #6
/*     */     //   64: dup2
/*     */     //   65: lconst_1
...
/*     */     //   81: ladd
/*     */     //   82: lstore #4
/*     */     //   84: invokestatic get : ([[JJ)J
/*     */     //   87: invokeinterface add : (J)V
/*     */     //   92: goto -> 62
/*     */     //   95: return
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
...
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	descriptor
/*     */     //   62	33	8	iter	Lit/unimi/dsi/fastutil/longs/LongBigListIterator;
/*     */     //   0	96	0	this	Lit/unimi/dsi/fastutil/longs/AbstractLongBigList;
/*     */     //   0	96	1	index	J
/*     */     //   0	96	3	a	[[J
/*     */     //   0	96	4	offset	J
/*     */     //   0	96	6	length	J
...
/*     */     //   107: ladd
/*     */     //   108: lstore #8
/*     */     //   110: invokevirtual getLong : (J)J
/*     */     //   113: invokestatic set : ([[JJJ)V
/*     */     //   116: goto -> 82
/*     */     //   119: goto -> 162
/*     */     //   122: aload_0
/*     */     //   123: lload_1
/*     */     //   124: invokevirtual listIterator : (J)Lit/unimi/dsi/fastutil/longs/LongBigListIterator;
/*     */     //   127: astore #8
/*     */     //   129: lload #6
/*     */     //   131: dup2
/*     */     //   132: lconst_1
...
/*     */     //   147: lstore #4
/*     */     //   149: aload #8
/*     */     //   151: invokeinterface nextLong : ()J
/*     */     //   156: invokestatic set : ([[JJJ)V
/*     */     //   159: goto -> 129
/*     */     //   162: return
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
...
/*     */     //   start	length	slot	name	descriptor
/*     */     //   82	37	8	current	J
/*     */     //   129	33	8	i	Lit/unimi/dsi/fastutil/longs/LongBigListIterator;
/*     */     //   0	163	0	this	Lit/unimi/dsi/fastutil/longs/AbstractLongBigList;
/*     */     //   0	163	1	from	J
/*     */     //   0	163	3	a	[[J
/*     */     //   0	163	4	offset	J
/*     */     //   0	163	6	length	J
...
/*     */       }
/*     */     } else {
/* 360 */       LongBigListIterator iter = listIterator(index);
/* 361 */       long i = 0L;
/* 362 */       while (i < length) {
/* 363 */         iter.nextLong();
...
/*     */   
/*     */   public int hashCode() {
/* 398 */     LongIterator i = iterator();
/* 399 */     int h = 1;
/* 400 */     long s = size64();
/* 401 */     while (s-- != 0L) {
/* 402 */       long k = i.nextLong();
/* 403 */       h = 31 * h + HashCommon.long2int(k);
/*     */     } 
/* 405 */     return h;
/*     */   }
/*     */ 
...
/* 415 */     if (l instanceof LongBigList) {
/* 416 */       LongBigListIterator longBigListIterator1 = listIterator(), longBigListIterator2 = ((LongBigList)l).listIterator();
/* 417 */       while (s-- != 0L) { if (longBigListIterator1.nextLong() != longBigListIterator2.nextLong()) return false;  }
/* 418 */        return true;
/*     */     } 
...
/* 438 */     if (l instanceof LongBigList) {
/* 439 */       LongBigListIterator longBigListIterator1 = listIterator(), longBigListIterator2 = ((LongBigList)l).listIterator();
/*     */ 
/*     */       
/* 442 */       while (longBigListIterator1.hasNext() && longBigListIterator2.hasNext()) {
/* 443 */         long e1 = longBigListIterator1.nextLong();
/* 444 */         long e2 = longBigListIterator2.nextLong(); int r;
/* 445 */         if ((r = Long.compare(e1, e2)) != 0) return r; 
/*     */       } 
/* 447 */       return longBigListIterator2.hasNext() ? -1 : (longBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 449 */     BigListIterator<? extends Long> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 465 */     return removeLong(size64() - 1L);
/*     */   }
/*     */ 
/*     */   
/*     */   public long topLong() {
/* 470 */     if (isEmpty()) throw new NoSuchElementException(); 
/* 471 */     return getLong(size64() - 1L);
/*     */   }
/*     */ 
/*     */   
/*     */   public long peekLong(int i) {
/* 476 */     return getLong(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 537 */     return Long.valueOf(set(index, ok.longValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 549 */     return Long.valueOf(getLong(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 561 */     return indexOf(((Long)ok).longValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 573 */     return lastIndexOf(((Long)ok).longValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 585 */     return Long.valueOf(removeLong(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Long pop() {
/* 609 */     return Long.valueOf(popLong());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Long top() {
/* 621 */     return Long.valueOf(topLong());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 633 */     return Long.valueOf(peekLong(i));
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 638 */     StringBuilder s = new StringBuilder();
/* 639 */     LongIterator i = iterator();
/* 640 */     long n = size64();
/*     */     
...
/* 703 */       return this.l.getLong(this.from + index);
/*     */     }
/*     */ 
/*     */     
...
/* 709 */       this.to--;
/* 710 */       return this.l.removeLong(this.from + index);
/*     */     }
/*     */ 
/*     */     
/*     */     public long set(long index, long k) {
...
/*     */       
/*     */       protected final long get(long i) {
/* 759 */         return AbstractLongBigList.LongSubList.this.l.getLong(AbstractLongBigList.LongSubList.this.from + i);
/*     */       }
/*     */ 
/*     */ 
/*     */       
/*     */       protected final void add(long i, long k) {
/* 765 */         AbstractLongBigList.LongSubList.this.add(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void set(long i, long k) {
/* 770 */         AbstractLongBigList.LongSubList.this.set(i, k);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final void remove(long i) {
/* 775 */         AbstractLongBigList.LongSubList.this.removeLong(i);
/*     */       }
/*     */ 
/*     */       
/*     */       protected final long getMaxPos() {
/* 780 */         return AbstractLongBigList.LongSubList.this.to - AbstractLongBigList.LongSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(long k) {
/* 785 */         super.add(k);
/* 786 */         assert AbstractLongBigList.LongSubList.this.assertRange();
/*     */       }
/*     */ 
/*     */       
/*     */       public void remove() {
/* 791 */         super.remove();
/* 792 */         assert AbstractLongBigList.LongSubList.this.assertRange();
/*     */       }
/*     */     }
/*     */     
...
/* 805 */         return this.parent.nextIndex() - AbstractLongBigList.LongSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public long previousIndex() {
/* 810 */         return this.parent.previousIndex() - AbstractLongBigList.LongSubList.this.from;
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasNext() {
/* 815 */         return (this.parent.nextIndex() < AbstractLongBigList.LongSubList.this.to);
/*     */       }
/*     */ 
/*     */       
/*     */       public boolean hasPrevious() {
/* 820 */         return (this.parent.previousIndex() >= AbstractLongBigList.LongSubList.this.from);
/*     */       }
/*     */ 
/*     */       
/*     */       public long nextLong() {
/* 825 */         if (!hasNext()) throw new NoSuchElementException(); 
/* 826 */         return this.parent.nextLong();
/*     */       }
/*     */ 
/*     */       
/*     */       public long previousLong() {
/* 831 */         if (!hasPrevious()) throw new NoSuchElementException(); 
/* 832 */         return this.parent.previousLong();
/*     */       }
/*     */ 
/*     */       
/*     */       public void add(long k) {
...
/*     */ 
/*     */         
/* 858 */         if (parentNewPos < AbstractLongBigList.LongSubList.this.from - 1L) parentNewPos = AbstractLongBigList.LongSubList.this.from - 1L; 
...
/* 868 */         if (parentNewPos > AbstractLongBigList.LongSubList.this.to) parentNewPos = AbstractLongBigList.LongSubList.this.to; 
...
/* 886 */       return (this.l instanceof RandomAccess) ? new AbstractLongBigList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongBigList subList(long from, long to) {
...
/*     */ 
/*     */       
/* 896 */       return new LongSubList(this, from, to);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean rem(long k) {
...
/* 903 */       this.to--;
/* 904 */       this.l.removeLong(this.from + index);
...
/*     */ 
/*     */       
/* 934 */       return new LongRandomAccessSubList(this, from, to);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\AbstractLongBigList.class
