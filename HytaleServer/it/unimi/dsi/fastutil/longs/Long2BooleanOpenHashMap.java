...
/*  283 */     long[] key = this.key; while (true) {
/*      */       long curr; int last;
/*  285 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  287 */         if ((curr = key[pos]) == 0L) {
/*  288 */           key[last] = 0L;
/*      */           return;
/*      */         } 
/*  291 */         int slot = (int)HashCommon.mix(curr) & this.mask;
...
/*      */     } 
/*      */     
/*  308 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  311 */     if ((curr = key[pos = (int)HashCommon.mix(k) & this.mask]) == 0L) return this.defRetValue; 
/*  312 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  314 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return this.defRetValue; 
...
/*  322 */     if (k == 0L) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  324 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  327 */     if ((curr = key[pos = (int)HashCommon.mix(k) & this.mask]) == 0L) return this.defRetValue; 
/*  328 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  331 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return this.defRetValue; 
...
/*  339 */     if (k == 0L) return this.containsNullKey;
/*      */     
/*  341 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  344 */     if ((curr = key[pos = (int)HashCommon.mix(k) & this.mask]) == 0L) return false; 
/*  345 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  348 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  358 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && value[i] == v) return true;  }
/*  359 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  366 */     if (k == 0L) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  368 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  371 */     if ((curr = key[pos = (int)HashCommon.mix(k) & this.mask]) == 0L) return defaultValue; 
/*  372 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  375 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return defaultValue; 
...
/*      */     } 
/*      */     
/*  401 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  404 */     if ((curr = key[pos = (int)HashCommon.mix(k) & this.mask]) == 0L) return false; 
/*  405 */     if (k == curr && v == this.value[pos]) {
/*  406 */       removeEntry(pos);
/*  407 */       return true;
/*      */     } 
/*      */     while (true) {
/*  410 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  479 */     Boolean newValue = remappingFunction.apply(Long.valueOf(k), Boolean.valueOf(this.value[pos]));
/*  480 */     if (newValue == null) {
/*  481 */       if (k == 0L) { removeNullEntry(); }
...
/*  492 */     int pos = find(k);
/*  493 */     Boolean newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
/*  494 */     if (newValue == null) {
/*  495 */       if (pos >= 0)
/*  496 */         if (k == 0L) { removeNullEntry(); }
...
/*  571 */       return Long2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  576 */       return Long2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  581 */       return Long2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  586 */       return Long2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  591 */       boolean oldValue = Long2BooleanOpenHashMap.this.value[this.index];
/*  592 */       Long2BooleanOpenHashMap.this.value[this.index] = v;
/*  593 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBooleanPair right(boolean v) {
/*  598 */       Long2BooleanOpenHashMap.this.value[this.index] = v;
/*  599 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  610 */       return Long.valueOf(Long2BooleanOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  621 */       return Boolean.valueOf(Long2BooleanOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */       Map.Entry<Long, Boolean> e = (Map.Entry<Long, Boolean>)o;
/*  640 */       return (Long2BooleanOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Long2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  645 */       return HashCommon.long2int(Long2BooleanOpenHashMap.this.key[this.index]) ^ (Long2BooleanOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
...
/*      */   {
/*  661 */     int pos = Long2BooleanOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  671 */     boolean mustReturnNullKey = Long2BooleanOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  690 */         return this.last = Long2BooleanOpenHashMap.this.n;
/*      */       } 
/*  692 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*      */       while (true) {
/*  694 */         if (--this.pos < 0) {
/*      */           
/*  696 */           this.last = Integer.MIN_VALUE;
/*  697 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  698 */           int p = (int)HashCommon.mix(k) & Long2BooleanOpenHashMap.this.mask;
/*  699 */           for (; k != key[p]; p = p + 1 & Long2BooleanOpenHashMap.this.mask);
/*  700 */           return p;
/*      */         } 
/*  702 */         if (key[this.pos] != 0L) return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  709 */         acceptOnIndex(action, this.last = Long2BooleanOpenHashMap.this.n);
/*  710 */         this.c--;
/*      */       } 
/*  712 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*  713 */       while (this.c != 0) {
/*  714 */         if (--this.pos < 0) {
/*      */           
/*  716 */           this.last = Integer.MIN_VALUE;
/*  717 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  718 */           int p = (int)HashCommon.mix(k) & Long2BooleanOpenHashMap.this.mask;
/*  719 */           for (; k != key[p]; p = p + 1 & Long2BooleanOpenHashMap.this.mask);
/*  720 */           acceptOnIndex(action, p);
/*  721 */           this.c--; continue;
/*  722 */         }  if (key[this.pos] != 0L) {
...
/*  739 */       long[] key = Long2BooleanOpenHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  741 */         pos = (last = pos) + 1 & Long2BooleanOpenHashMap.this.mask;
/*      */         while (true) {
/*  743 */           if ((curr = key[pos]) == 0L) {
/*  744 */             key[last] = 0L;
/*      */             return;
/*      */           } 
/*  747 */           int slot = (int)HashCommon.mix(curr) & Long2BooleanOpenHashMap.this.mask;
/*  748 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  749 */             break;  pos = pos + 1 & Long2BooleanOpenHashMap.this.mask;
/*      */         } 
/*  751 */         if (pos < last) {
/*  752 */           if (this.wrapped == null) this.wrapped = new LongArrayList(2); 
/*  753 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  755 */         key[last] = curr;
/*  756 */         Long2BooleanOpenHashMap.this.value[last] = Long2BooleanOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  761 */       if (this.last == -1) throw new IllegalStateException(); 
/*  762 */       if (this.last == Long2BooleanOpenHashMap.this.n)
/*  763 */       { Long2BooleanOpenHashMap.this.containsNullKey = false; }
/*  764 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  767 */       { Long2BooleanOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  768 */         this.last = -1;
/*      */         return; }
/*      */       
/*  771 */       Long2BooleanOpenHashMap.this.size--;
/*  772 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2BooleanMap.Entry>> implements ObjectIterator<Long2BooleanMap.Entry> { public Long2BooleanOpenHashMap.MapEntry next() {
/*  788 */       return this.entry = new Long2BooleanOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  794 */       action.accept(this.entry = new Long2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  805 */       this.entry = new Long2BooleanOpenHashMap.MapEntry();
/*      */     }
...
/*  826 */     int pos = 0;
/*      */     
/*  828 */     int max = Long2BooleanOpenHashMap.this.n;
/*      */     
/*  830 */     int c = 0;
/*      */     
/*  832 */     boolean mustReturnNull = Long2BooleanOpenHashMap.this.containsNullKey;
/*      */     
...
/*  852 */         this.c++;
/*  853 */         acceptOnIndex(action, Long2BooleanOpenHashMap.this.n);
/*  854 */         return true;
/*      */       } 
/*  856 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*  857 */       while (this.pos < this.max) {
/*  858 */         if (key[this.pos] != 0L) {
/*  859 */           this.c++;
...
/*  871 */         this.c++;
/*  872 */         acceptOnIndex(action, Long2BooleanOpenHashMap.this.n);
/*      */       } 
/*  874 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*  875 */       while (this.pos < this.max) {
/*  876 */         if (key[this.pos] != 0L) {
...
/*      */       {
/*  887 */         return (Long2BooleanOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  892 */       return Math.min((Long2BooleanOpenHashMap.this.size - this.c), (long)(Long2BooleanOpenHashMap.this.realSize() / Long2BooleanOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  920 */         n--;
/*      */       } 
/*  922 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*  923 */       while (this.pos < this.max && n > 0L) {
/*  924 */         if (key[this.pos++] != 0L) {
/*  925 */           skipped++;
/*  926 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2BooleanMap.Entry> action, int index) {
/*  950 */       action.accept(new Long2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  962 */       return new Long2BooleanOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2BooleanMap.Entry> fastIterator() {
/*  967 */       return new Long2BooleanOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2BooleanMap.Entry> spliterator() {
/*  972 */       return new Long2BooleanOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  981 */       if (e.getKey() == null || !(e.getKey() instanceof Long)) return false; 
/*  982 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/*  983 */       long k = ((Long)e.getKey()).longValue();
/*  984 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/*  985 */       if (k == 0L) return (Long2BooleanOpenHashMap.this.containsNullKey && Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n] == v);
/*      */       
/*  987 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/*  990 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2BooleanOpenHashMap.this.mask]) == 0L) return false; 
/*  991 */       if (k == curr) return (Long2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Long2BooleanOpenHashMap.this.mask]) == 0L) return false; 
/*  995 */         if (k == curr) return (Long2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1008 */       if (k == 0L) {
/* 1009 */         if (Long2BooleanOpenHashMap.this.containsNullKey && Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n] == v) {
/* 1010 */           Long2BooleanOpenHashMap.this.removeNullEntry();
/* 1011 */           return true;
/*      */         } 
/* 1013 */         return false;
/*      */       } 
/*      */       
/* 1016 */       long[] key = Long2BooleanOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1019 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2BooleanOpenHashMap.this.mask]) == 0L) return false; 
/* 1020 */       if (curr == k) {
/* 1021 */         if (Long2BooleanOpenHashMap.this.value[pos] == v) {
/* 1022 */           Long2BooleanOpenHashMap.this.removeEntry(pos);
/* 1023 */           return true;
/*      */         } 
/* 1025 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1028 */         if ((curr = key[pos = pos + 1 & Long2BooleanOpenHashMap.this.mask]) == 0L) return false; 
/* 1029 */         if (curr == k && 
/* 1030 */           Long2BooleanOpenHashMap.this.value[pos] == v) {
/* 1031 */           Long2BooleanOpenHashMap.this.removeEntry(pos);
/* 1032 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1040 */       return Long2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1045 */       Long2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
/* 1051 */       if (Long2BooleanOpenHashMap.this.containsNullKey) consumer.accept(new Long2BooleanOpenHashMap.MapEntry(Long2BooleanOpenHashMap.this.n)); 
/* 1052 */       for (int pos = Long2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenHashMap.this.key[pos] != 0L) consumer.accept(new Long2BooleanOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
/* 1058 */       Long2BooleanOpenHashMap.MapEntry entry = new Long2BooleanOpenHashMap.MapEntry();
/* 1059 */       if (Long2BooleanOpenHashMap.this.containsNullKey) {
/* 1060 */         entry.index = Long2BooleanOpenHashMap.this.n;
/* 1061 */         consumer.accept(entry);
/*      */       } 
/* 1063 */       for (int pos = Long2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenHashMap.this.key[pos] != 0L) {
...
/* 1094 */       action.accept(Long2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1099 */       return Long2BooleanOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1120 */       action.accept(Long2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1132 */       return new Long2BooleanOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1137 */       return new Long2BooleanOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1143 */       if (Long2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Long2BooleanOpenHashMap.this.key[Long2BooleanOpenHashMap.this.n]); 
/* 1144 */       for (int pos = Long2BooleanOpenHashMap.this.n; pos-- != 0; ) {
/* 1145 */         long k = Long2BooleanOpenHashMap.this.key[pos];
/* 1146 */         if (k != 0L) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1152 */       return Long2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1157 */       return Long2BooleanOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1162 */       int oldSize = Long2BooleanOpenHashMap.this.size;
/* 1163 */       Long2BooleanOpenHashMap.this.remove(k);
/* 1164 */       return (Long2BooleanOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1169 */       Long2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1197 */       action.accept(Long2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1202 */       return Long2BooleanOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1223 */       action.accept(Long2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1237 */             return new Long2BooleanOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1242 */             return new Long2BooleanOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1248 */             if (Long2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n]); 
/* 1249 */             for (int pos = Long2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenHashMap.this.key[pos] != 0L) consumer.accept(Long2BooleanOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1254 */             return Long2BooleanOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1259 */             return Long2BooleanOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1264 */             Long2BooleanOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1328 */     long[] key = this.key;
/* 1329 */     boolean[] value = this.value;
/* 1330 */     int mask = newN - 1;
/* 1331 */     long[] newKey = new long[newN + 1];
/* 1332 */     boolean[] newValue = new boolean[newN + 1];
/* 1333 */     int i = this.n;
/* 1334 */     for (int j = realSize(); j-- != 0; ) {
/* 1335 */       while (key[--i] == 0L); int pos;
/* 1336 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L) while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1362 */       c = (Long2BooleanOpenHashMap)super.clone();
...
/* 1370 */     c.key = (long[])this.key.clone();
...
/* 1388 */       for (; this.key[i] == 0L; i++);
/* 1389 */       t = HashCommon.long2int(this.key[i]);
...
/* 1416 */     long[] key = this.key = new long[this.n + 1];
/* 1417 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1420 */     for (int i = this.size; i-- != 0; ) {
/* 1421 */       int pos; long k = s.readLong();
/* 1422 */       boolean v = s.readBoolean();
/* 1423 */       if (k == 0L) {
/* 1424 */         pos = this.n;
/* 1425 */         this.containsNullKey = true;
/*      */       } else {
/* 1427 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1428 */         for (; key[pos] != 0L; pos = pos + 1 & this.mask);
/*      */       } 
/* 1430 */       key[pos] = k;
/* 1431 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanOpenHashMap.class
