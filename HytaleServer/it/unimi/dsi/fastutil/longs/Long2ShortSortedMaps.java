...
/*  61 */     return (entries instanceof Long2ShortSortedMap.FastSortedEntrySet) ? ((Long2ShortSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Long2ShortMap.Entry> entries = map.long2ShortEntrySet();
/*  77 */     Objects.requireNonNull((Long2ShortSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2ShortSortedMap.FastSortedEntrySet) ? (Long2ShortSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Long2ShortMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Long2ShortMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Long, Short>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ShortSortedMap headMap(long to) {
/* 125 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ShortSortedMap tailMap(long from) {
/* 130 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Long2ShortMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2ShortMap.BasicEntry(this.key, this.value), Long2ShortSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Long2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Short>> entrySet() {
/* 248 */       return (ObjectSortedSet)long2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 260 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ShortSortedMap headMap(long to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ShortSortedMap tailMap(long from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Long2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public long firstLongKey() {
...
/* 369 */     return new Singleton(key.longValue(), value.shortValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Long2ShortMaps.SynchronizedMap implements Long2ShortSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Long2ShortMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2ShortEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Long2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Short>> entrySet() {
/* 440 */       return (ObjectSortedSet)long2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/*     */     extends Long2ShortMaps.UnmodifiableMap implements Long2ShortSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2ShortSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Long2ShortMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2ShortEntrySet()); 
/* 581 */       return (ObjectSortedSet<Long2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortSortedMaps.class
