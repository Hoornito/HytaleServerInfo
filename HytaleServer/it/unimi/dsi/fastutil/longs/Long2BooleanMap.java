...
/* 150 */     return (ObjectSet)long2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = long2BooleanEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Long.valueOf(entry.getLongKey()), Boolean.valueOf(entry.getBooleanValue()));
...
/* 502 */     Boolean newValue = remappingFunction.apply(Long.valueOf(key), Boolean.valueOf(oldValue));
...
/* 534 */     Boolean newValue = remappingFunction.apply(Long.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
...
/*     */     @Deprecated
/*     */     default Long getKey() {
/* 604 */       return Long.valueOf(getLongKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanMap.class
