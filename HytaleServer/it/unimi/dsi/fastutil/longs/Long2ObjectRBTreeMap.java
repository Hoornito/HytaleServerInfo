...
/*  820 */       return (this.key == ((Long)e.getKey()).longValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return HashCommon.long2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Long2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  930 */       if ((this.next = Long2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Long2ObjectRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1046 */             return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1056 */             Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1067 */             Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1068 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1069 */             Long2ObjectRBTreeMap.this.remove(f.key);
/* 1070 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1075 */             return Long2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1080 */             Long2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ObjectMap.Entry<V> first() {
/* 1085 */             return Long2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ObjectMap.Entry<V> last() {
/* 1090 */             return Long2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) {
/* 1095 */             return Long2ObjectRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) {
/* 1100 */             return Long2ObjectRBTreeMap.this.headMap(to.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) {
/* 1105 */             return Long2ObjectRBTreeMap.this.tailMap(from.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1142 */       return new Long2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1147 */       return new Long2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1200 */             return (ObjectIterator<V>)new Long2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1205 */             return Long2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1210 */             return Long2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1215 */             Long2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1277 */       if (!bottom && !top && Long2ObjectRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1278 */       this.from = from;
/* 1279 */       this.bottom = bottom;
/* 1280 */       this.to = to;
/* 1281 */       this.top = top;
/* 1282 */       this.defRetValue = Long2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1301 */       return ((this.bottom || Long2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 1306 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1309 */               return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1314 */               return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2ObjectMap.Entry<V>> comparator() {
/* 1319 */               return Long2ObjectRBTreeMap.this.long2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1328 */               Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1329 */               return (f != null && Long2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1338 */               Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1339 */               if (f != null && Long2ObjectRBTreeMap.Submap.this.in(f.key)) Long2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1340 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1345 */               int c = 0;
/* 1346 */               for (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1347 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1352 */               return !(new Long2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1357 */               Long2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ObjectMap.Entry<V> first() {
/* 1362 */               return Long2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ObjectMap.Entry<V> last() {
/* 1367 */               return Long2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) {
/* 1372 */               return Long2ObjectRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) {
/* 1377 */               return Long2ObjectRBTreeMap.Submap.this.headMap(to.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) {
/* 1382 */               return Long2ObjectRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */           }; 
/* 1385 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractLong2ObjectSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1391 */         return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1396 */         return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1411 */               return (ObjectIterator<V>)new Long2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1416 */               return Long2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1421 */               return Long2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1426 */               Long2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1436 */       return (in(k) && Long2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(long k) {
/* 1454 */       long kk = k; Long2ObjectRBTreeMap.Entry<V> e;
/* 1455 */       return (in(kk) && (e = Long2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(long k, V v) {
/* 1460 */       Long2ObjectRBTreeMap.this.modified = false;
...
/* 1462 */       V oldValue = Long2ObjectRBTreeMap.this.put(k, v);
/* 1463 */       return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(long k) {
/* 1469 */       Long2ObjectRBTreeMap.this.modified = false;
/* 1470 */       if (!in(k)) return this.defRetValue; 
/* 1471 */       V oldValue = Long2ObjectRBTreeMap.this.remove(k);
/* 1472 */       return Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1493 */       return Long2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ObjectSortedMap<V> headMap(long to) {
/* 1498 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1499 */       return (Long2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ObjectSortedMap<V> tailMap(long from) {
/* 1504 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1505 */       return (Long2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ObjectSortedMap<V> subMap(long from, long to) {
/* 1510 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1511 */       if (!this.top) to = (Long2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1512 */       if (!this.bottom) from = (Long2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1523 */       if (Long2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1527 */       if (this.bottom) { e = Long2ObjectRBTreeMap.this.firstEntry; }
/*      */       else
/* 1529 */       { e = Long2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1531 */         if (Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1535 */       if (e == null || (!this.top && Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1536 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2ObjectRBTreeMap.Entry<V> e;
/* 1545 */       if (Long2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1549 */       if (this.top) { e = Long2ObjectRBTreeMap.this.lastEntry; }
/*      */       else
/* 1551 */       { e = Long2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1553 */         if (Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1557 */       if (e == null || (!this.bottom && Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1558 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1563 */       Long2ObjectRBTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1570 */       Long2ObjectRBTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1586 */         this.next = Long2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1590 */         this();
/* 1591 */         if (this.next != null) {
/* 1592 */           if (!Long2ObjectRBTreeMap.Submap.this.bottom && Long2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1593 */           else if (!Long2ObjectRBTreeMap.Submap.this.top && Long2ObjectRBTreeMap.this.compare(k, (this.prev = Long2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1595 */           { this.next = Long2ObjectRBTreeMap.this.locateKey(k);
/* 1596 */             if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1607 */         if (!Long2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Long2ObjectRBTreeMap.this.compare(this.prev.key, Long2ObjectRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1612 */         this.next = this.next.next();
/* 1613 */         if (!Long2ObjectRBTreeMap.Submap.this.top && this.next != null && Long2ObjectRBTreeMap.this.compare(this.next.key, Long2ObjectRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1701 */       c = (Long2ObjectRBTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectRBTreeMap.class
