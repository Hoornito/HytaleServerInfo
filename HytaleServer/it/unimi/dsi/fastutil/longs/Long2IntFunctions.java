...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Long2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Long2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.longValue(), value.intValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractLong2IntFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2IntFunction function;
/*     */     
...
/* 544 */       Integer v = this.function.apply(Long.valueOf(key));
...
/* 551 */       Integer v = this.function.apply(Long.valueOf(key));
...
/* 597 */     if (f instanceof Long2IntFunction) return (Long2IntFunction)f; 
/* 598 */     if (f instanceof LongToIntFunction) { Objects.requireNonNull((LongToIntFunction)f); return (LongToIntFunction)f::applyAsInt; }
/* 599 */      return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2IntFunctions.class
