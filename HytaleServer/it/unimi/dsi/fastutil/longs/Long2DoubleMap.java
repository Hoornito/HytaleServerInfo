...
/* 150 */     return (ObjectSet)long2DoubleEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = long2DoubleEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Long.valueOf(entry.getLongKey()), Double.valueOf(entry.getDoubleValue()));
...
/* 502 */     Double newValue = remappingFunction.apply(Long.valueOf(key), Double.valueOf(oldValue));
...
/* 534 */     Double newValue = remappingFunction.apply(Long.valueOf(key), contained ? Double.valueOf(oldValue) : null);
...
/*     */     @Deprecated
/*     */     default Long getKey() {
/* 775 */       return Long.valueOf(getLongKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleMap.class
