...
/*  61 */     return (entries instanceof Long2CharSortedMap.FastSortedEntrySet) ? ((Long2CharSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Long2CharMap.Entry> entries = map.long2CharEntrySet();
/*  77 */     Objects.requireNonNull((Long2CharSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2CharSortedMap.FastSortedEntrySet) ? (Long2CharSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Long2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Long2CharMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Long, Character>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2CharSortedMap headMap(long to) {
/* 125 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2CharSortedMap tailMap(long from) {
/* 130 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Long2CharMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2CharMap.BasicEntry(this.key, this.value), Long2CharSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Long2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Character>> entrySet() {
/* 248 */       return (ObjectSortedSet)long2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 260 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2CharSortedMap headMap(long to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2CharSortedMap tailMap(long from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Long2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public long firstLongKey() {
...
/* 369 */     return new Singleton(key.longValue(), value.charValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Long2CharMaps.SynchronizedMap implements Long2CharSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Long2CharMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2CharEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Long2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Character>> entrySet() {
/* 440 */       return (ObjectSortedSet)long2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/*     */     extends Long2CharMaps.UnmodifiableMap implements Long2CharSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2CharSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Long2CharMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2CharEntrySet()); 
/* 581 */       return (ObjectSortedSet<Long2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2CharSortedMaps.class
