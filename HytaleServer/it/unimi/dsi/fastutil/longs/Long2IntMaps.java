...
/*  49 */     ObjectSet<Long2IntMap.Entry> entries = map.long2IntEntrySet();
/*  50 */     return (entries instanceof Long2IntMap.FastEntrySet) ? ((Long2IntMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Long2IntMap.Entry> entries = map.long2IntEntrySet();
/*  66 */     if (entries instanceof Long2IntMap.FastEntrySet) { ((Long2IntMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Long2IntMap.Entry> entries = map.long2IntEntrySet();
/*  83 */     return (entries instanceof Long2IntMap.FastEntrySet) ? new ObjectIterable<Long2IntMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Long2IntMap.Entry> iterator() {
/*  86 */           return ((Long2IntMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Long2IntMap.FastEntrySet)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Long2IntMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 147 */       return (ObjectSet<Long2IntMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Long2IntMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Long2IntMap.Entry> long2IntEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractLong2IntMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/* 316 */     return new Singleton(key.longValue(), value.intValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Long2IntFunctions.SynchronizedFunction implements Long2IntMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.long2IntEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Integer>> entrySet() {
/* 381 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/*     */     extends Long2IntFunctions.UnmodifiableFunction implements Long2IntMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2IntMap map;
/*     */     protected transient ObjectSet<Long2IntMap.Entry> entries;
/*     */     protected transient LongSet keys;
...
/*     */     
/*     */     public ObjectSet<Long2IntMap.Entry> long2IntEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.long2IntEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Integer>> entrySet() {
/* 712 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2IntMaps.class
