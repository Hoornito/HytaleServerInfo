...
/*  839 */       Map.Entry<Long, Short> e = (Map.Entry<Long, Short>)o;
/*  840 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Long2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  950 */       if ((this.next = Long2ShortRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Long2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Long2ShortRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2ShortMap.Entry>)new AbstractObjectSortedSet<Long2ShortMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Long2ShortRBTreeMap.Entry f = Long2ShortRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1089 */             Long2ShortRBTreeMap.Entry f = Long2ShortRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1090 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1091 */             Long2ShortRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Long2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Long2ShortRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ShortMap.Entry first() {
/* 1107 */             return Long2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ShortMap.Entry last() {
/* 1112 */             return Long2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry from, Long2ShortMap.Entry to) {
/* 1117 */             return Long2ShortRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry to) {
/* 1122 */             return Long2ShortRBTreeMap.this.headMap(to.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry from) {
/* 1127 */             return Long2ShortRBTreeMap.this.tailMap(from.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Long2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1169 */       return new Long2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (ShortIterator)new Long2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1227 */             return Long2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Long2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Long2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Long2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Long2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Long2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ShortRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2ShortMap.Entry>)new AbstractObjectSortedSet<Long2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2ShortMap.Entry> comparator() {
/* 1341 */               return Long2ShortRBTreeMap.this.long2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Long2ShortRBTreeMap.Entry f = Long2ShortRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1352 */               return (f != null && Long2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Long2ShortRBTreeMap.Entry f = Long2ShortRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1363 */               if (f != null && Long2ShortRBTreeMap.Submap.this.in(f.key)) Long2ShortRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Long2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Long2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Long2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ShortMap.Entry first() {
/* 1386 */               return Long2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ShortMap.Entry last() {
/* 1391 */               return Long2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry from, Long2ShortMap.Entry to) {
/* 1396 */               return Long2ShortRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry to) {
/* 1401 */               return Long2ShortRBTreeMap.Submap.this.headMap(to.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry from) {
/* 1406 */               return Long2ShortRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1415 */         return new Long2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1420 */         return new Long2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1435 */               return (ShortIterator)new Long2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1440 */               return Long2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Long2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Long2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1460 */       return (in(k) && Long2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(long k) {
/* 1478 */       long kk = k; Long2ShortRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Long2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(long k, short v) {
/* 1484 */       Long2ShortRBTreeMap.this.modified = false;
...
/* 1486 */       short oldValue = Long2ShortRBTreeMap.this.put(k, v);
/* 1487 */       return Long2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(long k) {
/* 1493 */       Long2ShortRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       short oldValue = Long2ShortRBTreeMap.this.remove(k);
/* 1496 */       return Long2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1517 */       return Long2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ShortSortedMap headMap(long to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Long2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ShortSortedMap tailMap(long from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Long2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ShortSortedMap subMap(long from, long to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Long2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Long2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Long2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Long2ShortRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Long2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Long2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Long2ShortRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2ShortRBTreeMap.Entry e;
/* 1569 */       if (Long2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Long2ShortRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Long2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Long2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Long2ShortRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1587 */       Long2ShortRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1594 */       Long2ShortRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Long2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Long2ShortRBTreeMap.Submap.this.bottom && Long2ShortRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Long2ShortRBTreeMap.Submap.this.top && Long2ShortRBTreeMap.this.compare(k, (this.prev = Long2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Long2ShortRBTreeMap.this.locateKey(k);
/* 1620 */             if (Long2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Long2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Long2ShortRBTreeMap.this.compare(this.prev.key, Long2ShortRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Long2ShortRBTreeMap.Submap.this.top && this.next != null && Long2ShortRBTreeMap.this.compare(this.next.key, Long2ShortRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Long2ShortRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readLong(), s.readShort());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readLong(), s.readShort());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readLong(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortRBTreeMap.class
