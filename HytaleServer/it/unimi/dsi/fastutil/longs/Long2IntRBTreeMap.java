...
/*  839 */       Map.Entry<Long, Integer> e = (Map.Entry<Long, Integer>)o;
/*  840 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Long2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  950 */       if ((this.next = Long2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Long2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Long2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2IntMap.Entry>)new AbstractObjectSortedSet<Long2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Long2IntMap.Entry>)new Long2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Long2IntMap.Entry>)new Long2IntRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1089 */             Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Long2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Long2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Long2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2IntMap.Entry first() {
/* 1107 */             return Long2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2IntMap.Entry last() {
/* 1112 */             return Long2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry to) {
/* 1117 */             return Long2IntRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry to) {
/* 1122 */             return Long2IntRBTreeMap.this.headMap(to.getLongKey()).long2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from) {
/* 1127 */             return Long2IntRBTreeMap.this.tailMap(from.getLongKey()).long2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Long2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1169 */       return new Long2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (IntIterator)new Long2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Long2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Long2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Long2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Long2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Long2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Long2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2IntMap.Entry>)new AbstractObjectSortedSet<Long2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Long2IntMap.Entry>)new Long2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Long2IntMap.Entry>)new Long2IntRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2IntMap.Entry> comparator() {
/* 1341 */               return Long2IntRBTreeMap.this.long2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1352 */               return (f != null && Long2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1363 */               if (f != null && Long2IntRBTreeMap.Submap.this.in(f.key)) Long2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Long2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Long2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Long2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2IntMap.Entry first() {
/* 1386 */               return Long2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2IntMap.Entry last() {
/* 1391 */               return Long2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry to) {
/* 1396 */               return Long2IntRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry to) {
/* 1401 */               return Long2IntRBTreeMap.Submap.this.headMap(to.getLongKey()).long2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from) {
/* 1406 */               return Long2IntRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1415 */         return new Long2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1420 */         return new Long2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Long2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Long2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Long2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Long2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1460 */       return (in(k) && Long2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(long k) {
/* 1478 */       long kk = k; Long2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Long2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(long k, int v) {
/* 1484 */       Long2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Long2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Long2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(long k) {
/* 1493 */       Long2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Long2IntRBTreeMap.this.remove(k);
/* 1496 */       return Long2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1517 */       return Long2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2IntSortedMap headMap(long to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Long2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2IntSortedMap tailMap(long from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Long2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2IntSortedMap subMap(long from, long to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Long2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Long2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Long2IntRBTreeMap.Entry e;
/* 1547 */       if (Long2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Long2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Long2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Long2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Long2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2IntRBTreeMap.Entry e;
/* 1569 */       if (Long2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Long2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Long2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Long2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Long2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1587 */       Long2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1594 */       Long2IntRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Long2IntRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Long2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Long2IntRBTreeMap.Submap.this.bottom && Long2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Long2IntRBTreeMap.Submap.this.top && Long2IntRBTreeMap.this.compare(k, (this.prev = Long2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Long2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Long2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Long2IntRBTreeMap.Submap.this.bottom && this.prev != null && Long2IntRBTreeMap.this.compare(this.prev.key, Long2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Long2IntRBTreeMap.Submap.this.top && this.next != null && Long2IntRBTreeMap.this.compare(this.next.key, Long2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     Long2IntRBTreeMap c;
/*      */     try {
/* 1725 */       c = (Long2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readLong(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readLong(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readLong(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2IntRBTreeMap.class
