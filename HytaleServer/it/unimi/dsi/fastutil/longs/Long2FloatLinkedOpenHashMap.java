...
/*  733 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && Float.floatToIntBits(value[i]) == Float.floatToIntBits(v)) return true;  }
/*  734 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  854 */     Float newValue = remappingFunction.apply(Long.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Float newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*      */     implements Long2FloatMap.Entry, Map.Entry<Long, Float>, LongFloatPair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  947 */       return Long2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  952 */       return Long2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  957 */       return Long2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  962 */       return Long2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  967 */       float oldValue = Long2FloatLinkedOpenHashMap.this.value[this.index];
/*  968 */       Long2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongFloatPair right(float v) {
/*  974 */       Long2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  986 */       return Long.valueOf(Long2FloatLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Float.valueOf(Long2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
/* 1016 */       return (Long2FloatLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return HashCommon.long2int(Long2FloatLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.float2int(Long2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Long2FloatLinkedOpenHashMap.this.key[this.index] + "=>" + Long2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Long2FloatLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(long from) {
/* 1199 */       if (from == 0L) {
/* 1200 */         if (Long2FloatLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Long2FloatLinkedOpenHashMap.this.link[Long2FloatLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Long2FloatLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Long2FloatLinkedOpenHashMap.this.key[Long2FloatLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Long2FloatLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Long2FloatLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = (int)HashCommon.mix(from) & Long2FloatLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Long2FloatLinkedOpenHashMap.this.key[pos] != 0L) {
/* 1215 */         if (Long2FloatLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Long2FloatLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Long2FloatLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Long2FloatLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Long2FloatLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Long2FloatLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Long2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Long2FloatLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Long2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Long2FloatLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Long2FloatLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Long2FloatLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Long2FloatLinkedOpenHashMap.this.link[this.prev] = Long2FloatLinkedOpenHashMap.this.link[this.prev] ^ (Long2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Long2FloatLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Long2FloatLinkedOpenHashMap.this.link[this.next] = Long2FloatLinkedOpenHashMap.this.link[this.next] ^ (Long2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Long2FloatLinkedOpenHashMap.this.n) {
/* 1309 */         Long2FloatLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         long[] key = Long2FloatLinkedOpenHashMap.this.key; while (true) {
/*      */           long curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Long2FloatLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == 0L) {
/* 1318 */               key[last] = 0L;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = (int)HashCommon.mix(curr) & Long2FloatLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Long2FloatLinkedOpenHashMap.this.value[last] = Long2FloatLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Long2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2FloatMap.Entry>> implements ObjectListIterator<Long2FloatMap.Entry> {
...
/* 1368 */       action.accept(new Long2FloatLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Long2FloatLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Long2FloatLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Long2FloatMap.Entry>> implements ObjectListIterator<Long2FloatMap.Entry> {
/* 1389 */     final Long2FloatLinkedOpenHashMap.MapEntry entry = new Long2FloatLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Long2FloatLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Long2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Long2FloatLinkedOpenHashMap.MapEntry(Long2FloatLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatMap.Entry last() {
/* 1472 */       if (Long2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Long2FloatLinkedOpenHashMap.MapEntry(Long2FloatLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == 0L) return (Long2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[Long2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1487 */       long[] key = Long2FloatLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1490 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1491 */       if (k == curr) return (Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1495 */         if (k == curr) return (Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == 0L) {
/* 1509 */         if (Long2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[Long2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1510 */           Long2FloatLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       long[] key = Long2FloatLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1519 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1522 */           Long2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Long2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1531 */           Long2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Long2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Long2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Long2FloatLinkedOpenHashMap.EntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Long2FloatLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Long2FloatLinkedOpenHashMap.FastEntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
/* 1588 */       for (int i = Long2FloatLinkedOpenHashMap.this.size, next = Long2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Long2FloatLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Long2FloatLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Long2FloatLinkedOpenHashMap.MapEntry entry = new Long2FloatLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Long2FloatLinkedOpenHashMap.this.size, next = Long2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Long2FloatLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Long2FloatLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Long2FloatLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1645 */       return Long2FloatLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Long2FloatLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public LongListIterator iterator() {
/* 1659 */       return new Long2FloatLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2FloatLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1675 */       for (int i = Long2FloatLinkedOpenHashMap.this.size, next = Long2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Long2FloatLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Long2FloatLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Long2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1689 */       return Long2FloatLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1694 */       int oldSize = Long2FloatLinkedOpenHashMap.this.size;
/* 1695 */       Long2FloatLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Long2FloatLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Long2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLong() {
/* 1706 */       if (Long2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Long2FloatLinkedOpenHashMap.this.key[Long2FloatLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public long lastLong() {
/* 1712 */       if (Long2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Long2FloatLinkedOpenHashMap.this.key[Long2FloatLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public LongComparator comparator() {
...
/* 1754 */       return Long2FloatLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Long2FloatLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1771 */       return Long2FloatLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (FloatIterator)new Long2FloatLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2FloatLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1798 */             for (int i = Long2FloatLinkedOpenHashMap.this.size, next = Long2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Long2FloatLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Long2FloatLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Long2FloatLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1812 */             return Long2FloatLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Long2FloatLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Long2FloatLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatLinkedOpenHashMap.class
