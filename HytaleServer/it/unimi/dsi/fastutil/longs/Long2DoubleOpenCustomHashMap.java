...
/*  421 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)) return true;  }
/*  422 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  542 */     Double newValue = remappingFunction.apply(Long.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Double newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*  634 */       return Long2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  639 */       return Long2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  644 */       return Long2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  649 */       return Long2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  654 */       double oldValue = Long2DoubleOpenCustomHashMap.this.value[this.index];
/*  655 */       Long2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongDoublePair right(double v) {
/*  661 */       Long2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  673 */       return Long.valueOf(Long2DoubleOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Double.valueOf(Long2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Long, Double> e = (Map.Entry<Long, Double>)o;
/*  703 */       return (Long2DoubleOpenCustomHashMap.this.strategy.equals(Long2DoubleOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue()) && Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Long2DoubleOpenCustomHashMap.this.strategy.hashCode(Long2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Long2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Long2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Long2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Long2DoubleOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Long2DoubleOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Long2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Long2DoubleOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Long2DoubleOpenCustomHashMap.this.mask;
/*  762 */           for (; !Long2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2DoubleOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Long2DoubleOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Long2DoubleOpenCustomHashMap.this.mask;
/*  782 */           for (; !Long2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2DoubleOpenCustomHashMap.this.mask);
...
/*  802 */       long[] key = Long2DoubleOpenCustomHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  804 */         pos = (last = pos) + 1 & Long2DoubleOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == 0L) {
/*  807 */             key[last] = 0L;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2DoubleOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Long2DoubleOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Long2DoubleOpenCustomHashMap.this.value[last] = Long2DoubleOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Long2DoubleOpenCustomHashMap.this.n)
/*  826 */       { Long2DoubleOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Long2DoubleOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Long2DoubleOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2DoubleMap.Entry>> implements ObjectIterator<Long2DoubleMap.Entry> { public Long2DoubleOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Long2DoubleOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Long2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Long2DoubleOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Long2DoubleOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Long2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Long2DoubleOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Long2DoubleOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Long2DoubleOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Long2DoubleOpenCustomHashMap.this.size - this.c), (long)(Long2DoubleOpenCustomHashMap.this.realSize() / Long2DoubleOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2DoubleMap.Entry> action, int index) {
/* 1013 */       action.accept(new Long2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Long2DoubleOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2DoubleMap.Entry> fastIterator() {
/* 1030 */       return new Long2DoubleOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2DoubleMap.Entry> spliterator() {
/* 1035 */       return new Long2DoubleOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) return (Long2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1050 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Long2DoubleOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1054 */       if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Long2DoubleOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1058 */         if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/* 1072 */         if (Long2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1073 */           Long2DoubleOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       long[] key = Long2DoubleOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Long2DoubleOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1083 */       if (Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1085 */           Long2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Long2DoubleOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1092 */         if (Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1094 */           Long2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Long2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Long2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
/* 1114 */       if (Long2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(new Long2DoubleOpenCustomHashMap.MapEntry(Long2DoubleOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Long2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2DoubleOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(new Long2DoubleOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2DoubleMap.Entry> consumer) {
/* 1121 */       Long2DoubleOpenCustomHashMap.MapEntry entry = new Long2DoubleOpenCustomHashMap.MapEntry();
/* 1122 */       if (Long2DoubleOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Long2DoubleOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Long2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2DoubleOpenCustomHashMap.this.key[pos] != 0L) {
...
/* 1157 */       action.accept(Long2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1162 */       return Long2DoubleOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1183 */       action.accept(Long2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Long2DoubleOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1200 */       return new Long2DoubleOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1206 */       if (Long2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2DoubleOpenCustomHashMap.this.key[Long2DoubleOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Long2DoubleOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         long k = Long2DoubleOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Long2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1220 */       return Long2DoubleOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1225 */       int oldSize = Long2DoubleOpenCustomHashMap.this.size;
/* 1226 */       Long2DoubleOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Long2DoubleOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Long2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Long2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1265 */       return Long2DoubleOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1286 */       action.accept(Long2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Long2DoubleOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1305 */             return new Long2DoubleOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1311 */             if (Long2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Long2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2DoubleOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(Long2DoubleOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Long2DoubleOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1322 */             return Long2DoubleOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Long2DoubleOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Long2DoubleOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleOpenCustomHashMap.class
