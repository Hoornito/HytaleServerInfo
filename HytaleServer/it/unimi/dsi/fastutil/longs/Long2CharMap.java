...
/*     */   extends Long2CharFunction, Map<Long, Character>
/*     */ {
...
/*     */   
/*     */   @Deprecated
/*     */   default ObjectSet<Map.Entry<Long, Character>> entrySet() {
/* 150 */     return (ObjectSet)long2CharEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = long2CharEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Long.valueOf(entry.getLongKey()), Character.valueOf(entry.getCharValue()));
...
/* 502 */     Character newValue = remappingFunction.apply(Long.valueOf(key), Character.valueOf(oldValue));
...
/* 534 */     Character newValue = remappingFunction.apply(Long.valueOf(key), contained ? Character.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2CharMap.class
