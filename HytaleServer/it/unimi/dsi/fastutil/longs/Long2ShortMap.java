...
/* 150 */     return (ObjectSet)long2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = long2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Long.valueOf(entry.getLongKey()), Short.valueOf(entry.getShortValue()));
...
/* 502 */     Short newValue = remappingFunction.apply(Long.valueOf(key), Short.valueOf(oldValue));
...
/* 534 */     Short newValue = remappingFunction.apply(Long.valueOf(key), contained ? Short.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortMap.class
