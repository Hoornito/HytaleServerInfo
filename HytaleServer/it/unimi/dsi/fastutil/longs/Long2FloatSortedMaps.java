...
/*  61 */     return (entries instanceof Long2FloatSortedMap.FastSortedEntrySet) ? ((Long2FloatSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Long2FloatMap.Entry> entries = map.long2FloatEntrySet();
/*  77 */     Objects.requireNonNull((Long2FloatSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2FloatSortedMap.FastSortedEntrySet) ? (Long2FloatSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Long2FloatMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Long2FloatMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Long, Float>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2FloatSortedMap headMap(long to) {
/* 125 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2FloatSortedMap tailMap(long from) {
/* 130 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Long2FloatMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2FloatMap.BasicEntry(this.key, this.value), Long2FloatSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Long2FloatMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Float>> entrySet() {
/* 248 */       return (ObjectSortedSet)long2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 260 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2FloatSortedMap headMap(long to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2FloatSortedMap tailMap(long from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Long2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public long firstLongKey() {
...
/* 369 */     return new Singleton(key.longValue(), value.floatValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Long2FloatMaps.SynchronizedMap implements Long2FloatSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Long2FloatMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2FloatEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Long2FloatMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Float>> entrySet() {
/* 440 */       return (ObjectSortedSet)long2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/*     */     extends Long2FloatMaps.UnmodifiableMap implements Long2FloatSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2FloatSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Long2FloatMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2FloatEntrySet()); 
/* 581 */       return (ObjectSortedSet<Long2FloatMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatSortedMaps.class
