...
/*  60 */     ObjectSortedSet<Long2ByteMap.Entry> entries = map.long2ByteEntrySet();
/*  61 */     return (entries instanceof Long2ByteSortedMap.FastSortedEntrySet) ? ((Long2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Long2ByteMap.Entry> entries = map.long2ByteEntrySet();
/*  77 */     Objects.requireNonNull((Long2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2ByteSortedMap.FastSortedEntrySet) ? (Long2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Long2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Long2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Long, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap headMap(long to) {
/* 125 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap tailMap(long from) {
/* 130 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2ByteMap.BasicEntry(this.key, this.value), Long2ByteSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Byte>> entrySet() {
/* 248 */       return (ObjectSortedSet)long2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 260 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap headMap(long to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap tailMap(long from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public long firstLongKey() {
...
/* 353 */     return new Singleton(key.longValue(), value.byteValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 369 */     return new Singleton(key.longValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Long2ByteMaps.SynchronizedMap implements Long2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2ByteEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Byte>> entrySet() {
/* 440 */       return (ObjectSortedSet)long2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/*     */     extends Long2ByteMaps.UnmodifiableMap implements Long2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2ByteSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2ByteEntrySet()); 
/* 581 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Byte>> entrySet() {
/* 593 */       return (ObjectSortedSet)long2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteSortedMaps.class
