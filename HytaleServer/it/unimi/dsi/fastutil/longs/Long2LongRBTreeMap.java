...
/*   87 */     this.actualComparator = LongComparators.asLongComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  163 */     this(k, v, (Comparator<? super Long>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     return (this.actualComparator == null) ? Long.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  835 */       Map.Entry<Long, Long> e = (Map.Entry<Long, Long>)o;
/*  836 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  841 */       return HashCommon.long2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  942 */       this.next = Long2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  946 */       if ((this.next = Long2LongRBTreeMap.this.locateKey(k)) != null)
/*  947 */         if (Long2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1000 */       updatePrevious();
/* 1001 */       updateNext();
/* 1002 */       Long2LongRBTreeMap.this.remove(this.curr.key);
/* 1003 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1047 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */         {
...
/* 1057 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1062 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1071 */             if (!(e.getKey() instanceof Long)) return false; 
/* 1072 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1073 */             Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1083 */             if (!(e.getKey() instanceof Long)) return false; 
/* 1084 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1085 */             Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1086 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1087 */             Long2LongRBTreeMap.this.remove(f.key);
/* 1088 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1093 */             return Long2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1098 */             Long2LongRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2LongMap.Entry first() {
/* 1103 */             return Long2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2LongMap.Entry last() {
/* 1108 */             return Long2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1113 */             return Long2LongRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1118 */             return Long2LongRBTreeMap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1123 */             return Long2LongRBTreeMap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1160 */       return new Long2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1165 */       return new Long2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */     if (this.values == null) this.values = new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1218 */             return new Long2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1223 */             return Long2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1228 */             return Long2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1233 */             Long2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1246 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Long2LongSortedMap tailMap(long from) {
/* 1251 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1295 */       if (!bottom && !top && Long2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1296 */       this.from = from;
/* 1297 */       this.bottom = bottom;
/* 1298 */       this.to = to;
/* 1299 */       this.top = top;
/* 1300 */       this.defRetValue = Long2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1319 */       return ((this.bottom || Long2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2LongRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
/* 1324 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator() {
/* 1327 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1332 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2LongMap.Entry> comparator() {
/* 1337 */               return Long2LongRBTreeMap.this.long2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1345 */               if (e.getKey() == null || !(e.getKey() instanceof Long)) return false; 
/* 1346 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1347 */               Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1348 */               return (f != null && Long2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1356 */               if (e.getKey() == null || !(e.getKey() instanceof Long)) return false; 
/* 1357 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1358 */               Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1359 */               if (f != null && Long2LongRBTreeMap.Submap.this.in(f.key)) Long2LongRBTreeMap.Submap.this.remove(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1365 */               int c = 0;
/* 1366 */               for (ObjectBidirectionalIterator<Long2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1367 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Long2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Long2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2LongMap.Entry first() {
/* 1382 */               return Long2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2LongMap.Entry last() {
/* 1387 */               return Long2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1392 */               return Long2LongRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1397 */               return Long2LongRBTreeMap.Submap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1402 */               return Long2LongRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1411 */         return new Long2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1416 */         return new Long2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public LongCollection values() {
/* 1428 */       if (this.values == null) this.values = new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1431 */               return new Long2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1436 */               return Long2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Long2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Long2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1456 */       return (in(k) && Long2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(long k) {
/* 1474 */       long kk = k; Long2LongRBTreeMap.Entry e;
/* 1475 */       return (in(kk) && (e = Long2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(long k, long v) {
/* 1480 */       Long2LongRBTreeMap.this.modified = false;
...
/* 1482 */       long oldValue = Long2LongRBTreeMap.this.put(k, v);
/* 1483 */       return Long2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(long k) {
/* 1489 */       Long2LongRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k)) return this.defRetValue; 
/* 1491 */       long oldValue = Long2LongRBTreeMap.this.remove(k);
/* 1492 */       return Long2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1513 */       return Long2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2LongSortedMap headMap(long to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Long2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2LongSortedMap tailMap(long from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Long2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2LongSortedMap subMap(long from, long to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Long2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Long2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Long2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Long2LongRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Long2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Long2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Long2LongRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2LongRBTreeMap.Entry e;
/* 1565 */       if (Long2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Long2LongRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Long2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Long2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Long2LongRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1583 */       Long2LongRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1590 */       Long2LongRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Long2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Long2LongRBTreeMap.Submap.this.bottom && Long2LongRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Long2LongRBTreeMap.Submap.this.top && Long2LongRBTreeMap.this.compare(k, (this.prev = Long2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Long2LongRBTreeMap.this.locateKey(k);
/* 1616 */             if (Long2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Long2LongRBTreeMap.Submap.this.bottom && this.prev != null && Long2LongRBTreeMap.this.compare(this.prev.key, Long2LongRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Long2LongRBTreeMap.Submap.this.top && this.next != null && Long2LongRBTreeMap.this.compare(this.next.key, Long2LongRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Long2LongRBTreeMap)super.clone();
...
/* 1779 */       s.writeLong(e.key);
/* 1780 */       s.writeLong(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry entry = new Entry(s.readLong(), s.readLong());
...
/*      */ 
/*      */       
/* 1804 */       Entry entry = new Entry(s.readLong(), s.readLong());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry(s.readLong(), s.readLong()));
...
/* 1816 */     top.key = s.readLong();
/* 1817 */     top.value = s.readLong();
/* 1818 */     top.black(true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2LongRBTreeMap.class
