...
/*  61 */     return (entries instanceof Long2ObjectSortedMap.FastSortedEntrySet) ? ((Long2ObjectSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Long2ObjectMap.Entry<V>> entries = map.long2ObjectEntrySet();
/*  77 */     Objects.requireNonNull((Long2ObjectSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2ObjectSortedMap.FastSortedEntrySet) ? (Long2ObjectSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Long2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 121 */       return Long2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 133 */       return Long2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 251 */       if (this.entries == null) this.entries = (ObjectSet<Long2ObjectMap.Entry<V>>)ObjectSortedSets.singleton(new AbstractLong2ObjectMap.BasicEntry<>(this.key, this.value), Long2ObjectSortedMaps.entryComparator(this.comparator)); 
/* 252 */       return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, V>> entrySet() {
/* 264 */       return (ObjectSortedSet)long2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 277 */       return Long2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 284 */       return Long2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 291 */       return Long2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public long firstLongKey() {
...
/*     */     extends Long2ObjectMaps.SynchronizedMap<V> implements Long2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 446 */       if (this.entries == null) this.entries = (ObjectSet<Long2ObjectMap.Entry<V>>)ObjectSortedSets.synchronize(this.sortedMap.long2ObjectEntrySet(), this.sync); 
/* 447 */       return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, V>> entrySet() {
/* 459 */       return (ObjectSortedSet)long2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/*     */     extends Long2ObjectMaps.UnmodifiableMap<V> implements Long2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 599 */       if (this.entries == null) this.entries = (ObjectSet<Long2ObjectMap.Entry<V>>)ObjectSortedSets.unmodifiable(this.sortedMap.long2ObjectEntrySet()); 
/* 600 */       return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, V>> entrySet() {
/* 612 */       return (ObjectSortedSet)long2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectSortedMaps.class
