...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Long2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Long2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.longValue(), value.charValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractLong2CharFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2CharFunction function;
/*     */     
...
/* 544 */       Character v = this.function.apply(Long.valueOf(key));
...
/* 551 */       Character v = this.function.apply(Long.valueOf(key));
...
/* 597 */     if (f instanceof Long2CharFunction) return (Long2CharFunction)f; 
/* 598 */     if (f instanceof LongToIntFunction) return key -> SafeMath.safeIntToChar(((LongToIntFunction)f).applyAsInt(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2CharFunctions.class
