...
/*  306 */     long[] key = this.key; while (true) {
/*      */       long curr; int last;
/*  308 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  310 */         if ((curr = key[pos]) == 0L) {
/*  311 */           key[last] = 0L;
/*      */           return;
/*      */         } 
...
/*  326 */     if (this.strategy.equals(k, 0L)) {
/*  327 */       if (this.containsNullKey) return removeNullEntry(); 
/*  328 */       return this.defRetValue;
/*      */     } 
/*      */     
/*  331 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  334 */     if ((curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return this.defRetValue; 
/*  335 */     if (this.strategy.equals(k, curr)) return removeEntry(pos); 
/*      */     while (true) {
/*  337 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return this.defRetValue; 
...
/*  345 */     if (this.strategy.equals(k, 0L)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  347 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  350 */     if ((curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return this.defRetValue; 
...
/*  362 */     if (this.strategy.equals(k, 0L)) return this.containsNullKey;
/*      */     
/*  364 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  367 */     if ((curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return false; 
/*  368 */     if (this.strategy.equals(k, curr)) return true;
/*      */     
/*      */     while (true) {
/*  371 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  381 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && value[i] == v) return true;  }
/*  382 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  389 */     if (this.strategy.equals(k, 0L)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  391 */     long[] key = this.key;
/*      */     long curr;
/*      */     int pos;
/*  394 */     if ((curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return defaultValue; 
/*  395 */     if (this.strategy.equals(k, curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  398 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return defaultValue; 
...
/*  416 */     if (this.strategy.equals(k, 0L)) {
...
/*      */     long curr;
/*      */     int pos;
/*  427 */     if ((curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return false; 
/*  428 */     if (this.strategy.equals(k, curr) && v == this.value[pos]) {
/*  429 */       removeEntry(pos);
/*  430 */       return true;
/*      */     } 
/*      */     while (true) {
/*  433 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  502 */     Boolean newValue = remappingFunction.apply(Long.valueOf(k), Boolean.valueOf(this.value[pos]));
/*  503 */     if (newValue == null) {
/*  504 */       if (this.strategy.equals(k, 0L)) { removeNullEntry(); }
...
/*  515 */     int pos = find(k);
/*  516 */     Boolean newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
/*  517 */     if (newValue == null) {
/*  518 */       if (pos >= 0)
/*  519 */         if (this.strategy.equals(k, 0L)) { removeNullEntry(); }
...
/*  594 */       return Long2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  599 */       return Long2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  604 */       return Long2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  609 */       return Long2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  614 */       boolean oldValue = Long2BooleanOpenCustomHashMap.this.value[this.index];
/*  615 */       Long2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  616 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBooleanPair right(boolean v) {
/*  621 */       Long2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  622 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  633 */       return Long.valueOf(Long2BooleanOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  644 */       return Boolean.valueOf(Long2BooleanOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       Map.Entry<Long, Boolean> e = (Map.Entry<Long, Boolean>)o;
/*  663 */       return (Long2BooleanOpenCustomHashMap.this.strategy.equals(Long2BooleanOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue()) && Long2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  668 */       return Long2BooleanOpenCustomHashMap.this.strategy.hashCode(Long2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Long2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  673 */       return Long2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Long2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  684 */     int pos = Long2BooleanOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  690 */     int last = -1;
/*      */     
/*  692 */     int c = Long2BooleanOpenCustomHashMap.this.size;
/*      */     
/*  694 */     boolean mustReturnNullKey = Long2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  713 */         return this.last = Long2BooleanOpenCustomHashMap.this.n;
/*      */       } 
/*  715 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  717 */         if (--this.pos < 0) {
/*      */           
/*  719 */           this.last = Integer.MIN_VALUE;
/*  720 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  721 */           int p = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask;
/*  722 */           for (; !Long2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2BooleanOpenCustomHashMap.this.mask);
/*  723 */           return p;
/*      */         } 
/*  725 */         if (key[this.pos] != 0L) return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  732 */         acceptOnIndex(action, this.last = Long2BooleanOpenCustomHashMap.this.n);
/*  733 */         this.c--;
/*      */       } 
...
/*  742 */           for (; !Long2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2BooleanOpenCustomHashMap.this.mask);
/*  743 */           acceptOnIndex(action, p);
/*  744 */           this.c--; continue;
/*  745 */         }  if (key[this.pos] != 0L) {
...
/*  762 */       long[] key = Long2BooleanOpenCustomHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  764 */         pos = (last = pos) + 1 & Long2BooleanOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == 0L) {
/*  767 */             key[last] = 0L;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2BooleanOpenCustomHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  772 */             break;  pos = pos + 1 & Long2BooleanOpenCustomHashMap.this.mask;
/*      */         } 
/*  774 */         if (pos < last) {
/*  775 */           if (this.wrapped == null) this.wrapped = new LongArrayList(2); 
/*  776 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  778 */         key[last] = curr;
/*  779 */         Long2BooleanOpenCustomHashMap.this.value[last] = Long2BooleanOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  784 */       if (this.last == -1) throw new IllegalStateException(); 
/*  785 */       if (this.last == Long2BooleanOpenCustomHashMap.this.n)
/*  786 */       { Long2BooleanOpenCustomHashMap.this.containsNullKey = false; }
/*  787 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  790 */       { Long2BooleanOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  791 */         this.last = -1;
/*      */         return; }
/*      */       
/*  794 */       Long2BooleanOpenCustomHashMap.this.size--;
/*  795 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2BooleanMap.Entry>> implements ObjectIterator<Long2BooleanMap.Entry> { public Long2BooleanOpenCustomHashMap.MapEntry next() {
/*  811 */       return this.entry = new Long2BooleanOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  817 */       action.accept(this.entry = new Long2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  828 */       this.entry = new Long2BooleanOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  849 */     int pos = 0;
/*      */     
/*  851 */     int max = Long2BooleanOpenCustomHashMap.this.n;
/*      */     
/*  853 */     int c = 0;
/*      */     
/*  855 */     boolean mustReturnNull = Long2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  875 */         this.c++;
/*  876 */         acceptOnIndex(action, Long2BooleanOpenCustomHashMap.this.n);
/*  877 */         return true;
/*      */       } 
/*  879 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
/*  880 */       while (this.pos < this.max) {
/*  881 */         if (key[this.pos] != 0L) {
/*  882 */           this.c++;
...
/*  894 */         this.c++;
/*  895 */         acceptOnIndex(action, Long2BooleanOpenCustomHashMap.this.n);
/*      */       } 
/*  897 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
...
/*      */       {
/*  910 */         return (Long2BooleanOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  915 */       return Math.min((Long2BooleanOpenCustomHashMap.this.size - this.c), (long)(Long2BooleanOpenCustomHashMap.this.realSize() / Long2BooleanOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  943 */         n--;
/*      */       } 
/*  945 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
/*  946 */       while (this.pos < this.max && n > 0L) {
/*  947 */         if (key[this.pos++] != 0L) {
/*  948 */           skipped++;
/*  949 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     extends MapSpliterator<Consumer<? super Long2BooleanMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2BooleanMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2BooleanMap.Entry> action, int index) {
/*  973 */       action.accept(new Long2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  985 */       return new Long2BooleanOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2BooleanMap.Entry> fastIterator() {
/*  990 */       return new Long2BooleanOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2BooleanMap.Entry> spliterator() {
/*  995 */       return new Long2BooleanOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1004 */       if (e.getKey() == null || !(e.getKey() instanceof Long)) return false; 
/* 1005 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1006 */       long k = ((Long)e.getKey()).longValue();
/* 1007 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1008 */       if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) return (Long2BooleanOpenCustomHashMap.this.containsNullKey && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n] == v);
/*      */       
/* 1010 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1013 */       if ((curr = key[pos = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1014 */       if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Long2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1018 */         if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Long2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1027 */       if (e.getKey() == null || !(e.getKey() instanceof Long)) return false; 
/* 1028 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1029 */       long k = ((Long)e.getKey()).longValue();
/* 1030 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1031 */       if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/* 1032 */         if (Long2BooleanOpenCustomHashMap.this.containsNullKey && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n] == v) {
/* 1033 */           Long2BooleanOpenCustomHashMap.this.removeNullEntry();
/* 1034 */           return true;
/*      */         } 
/* 1036 */         return false;
/*      */       } 
/*      */       
/* 1039 */       long[] key = Long2BooleanOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1042 */       if ((curr = key[pos = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1043 */       if (Long2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1044 */         if (Long2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1045 */           Long2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1046 */           return true;
/*      */         } 
/* 1048 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1051 */         if ((curr = key[pos = pos + 1 & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1052 */         if (Long2BooleanOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1053 */           Long2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1054 */           Long2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1055 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1063 */       return Long2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1068 */       Long2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
/* 1074 */       if (Long2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(new Long2BooleanOpenCustomHashMap.MapEntry(Long2BooleanOpenCustomHashMap.this.n)); 
/* 1075 */       for (int pos = Long2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(new Long2BooleanOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
/* 1081 */       Long2BooleanOpenCustomHashMap.MapEntry entry = new Long2BooleanOpenCustomHashMap.MapEntry();
/* 1082 */       if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
/* 1083 */         entry.index = Long2BooleanOpenCustomHashMap.this.n;
/* 1084 */         consumer.accept(entry);
/*      */       } 
/* 1086 */       for (int pos = Long2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) {
...
/* 1117 */       action.accept(Long2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1122 */       return Long2BooleanOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1143 */       action.accept(Long2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1155 */       return new Long2BooleanOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1160 */       return new Long2BooleanOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1166 */       if (Long2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.n]); 
/* 1167 */       for (int pos = Long2BooleanOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1168 */         long k = Long2BooleanOpenCustomHashMap.this.key[pos];
/* 1169 */         if (k != 0L) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1175 */       return Long2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1180 */       return Long2BooleanOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1185 */       int oldSize = Long2BooleanOpenCustomHashMap.this.size;
/* 1186 */       Long2BooleanOpenCustomHashMap.this.remove(k);
/* 1187 */       return (Long2BooleanOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1192 */       Long2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1220 */       action.accept(Long2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1225 */       return Long2BooleanOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1246 */       action.accept(Long2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1260 */             return new Long2BooleanOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1265 */             return new Long2BooleanOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1271 */             if (Long2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n]); 
/* 1272 */             for (int pos = Long2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(Long2BooleanOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1277 */             return Long2BooleanOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1282 */             return Long2BooleanOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1287 */             Long2BooleanOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1351 */     long[] key = this.key;
/* 1352 */     boolean[] value = this.value;
/* 1353 */     int mask = newN - 1;
/* 1354 */     long[] newKey = new long[newN + 1];
/* 1355 */     boolean[] newValue = new boolean[newN + 1];
/* 1356 */     int i = this.n;
/* 1357 */     for (int j = realSize(); j-- != 0; ) {
/* 1358 */       while (key[--i] == 0L); int pos;
/* 1359 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L) while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1385 */       c = (Long2BooleanOpenCustomHashMap)super.clone();
...
/* 1393 */     c.key = (long[])this.key.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanOpenCustomHashMap.class
