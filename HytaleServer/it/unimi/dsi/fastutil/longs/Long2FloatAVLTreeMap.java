...
/*  885 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
/*  886 */       return (this.key == ((Long)e.getKey()).longValue() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Long2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  998 */       if ((this.next = Long2FloatAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Long2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Long2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1147 */             Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1148 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1149 */             Long2FloatAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Long2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Long2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2FloatMap.Entry first() {
/* 1165 */             return Long2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2FloatMap.Entry last() {
/* 1170 */             return Long2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1175 */             return Long2FloatAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1180 */             return Long2FloatAVLTreeMap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1185 */             return Long2FloatAVLTreeMap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Long2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1227 */       return new Long2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (FloatIterator)new Long2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1285 */             return Long2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Long2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Long2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Long2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Long2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Long2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2FloatMap.Entry> comparator() {
/* 1399 */               return Long2FloatAVLTreeMap.this.long2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1410 */               return (f != null && Long2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1421 */               if (f != null && Long2FloatAVLTreeMap.Submap.this.in(f.key)) Long2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Long2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Long2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Long2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2FloatMap.Entry first() {
/* 1444 */               return Long2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2FloatMap.Entry last() {
/* 1449 */               return Long2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1454 */               return Long2FloatAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1459 */               return Long2FloatAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1464 */               return Long2FloatAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1473 */         return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1478 */         return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1493 */               return (FloatIterator)new Long2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1498 */               return Long2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Long2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Long2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1518 */       return (in(k) && Long2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(long k) {
/* 1536 */       long kk = k; Long2FloatAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Long2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(long k, float v) {
/* 1542 */       Long2FloatAVLTreeMap.this.modified = false;
...
/* 1544 */       float oldValue = Long2FloatAVLTreeMap.this.put(k, v);
/* 1545 */       return Long2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(long k) {
/* 1551 */       Long2FloatAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       float oldValue = Long2FloatAVLTreeMap.this.remove(k);
/* 1554 */       return Long2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1575 */       return Long2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatSortedMap headMap(long to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Long2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatSortedMap tailMap(long from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Long2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2FloatSortedMap subMap(long from, long to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Long2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Long2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Long2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Long2FloatAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Long2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Long2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Long2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2FloatAVLTreeMap.Entry e;
/* 1627 */       if (Long2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Long2FloatAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Long2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Long2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Long2FloatAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1645 */       Long2FloatAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1652 */       Long2FloatAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Long2FloatAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Long2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Long2FloatAVLTreeMap.Submap.this.bottom && Long2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Long2FloatAVLTreeMap.Submap.this.top && Long2FloatAVLTreeMap.this.compare(k, (this.prev = Long2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Long2FloatAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Long2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Long2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Long2FloatAVLTreeMap.this.compare(this.prev.key, Long2FloatAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Long2FloatAVLTreeMap.Submap.this.top && this.next != null && Long2FloatAVLTreeMap.this.compare(this.next.key, Long2FloatAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Long2FloatAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readLong(), s.readFloat());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readLong(), s.readFloat());
/* 1866 */       entry.right(new Entry(s.readLong(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatAVLTreeMap.class
