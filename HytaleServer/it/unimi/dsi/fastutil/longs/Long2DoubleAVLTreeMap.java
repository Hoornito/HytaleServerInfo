...
/*  885 */       Map.Entry<Long, Double> e = (Map.Entry<Long, Double>)o;
/*  886 */       return (this.key == ((Long)e.getKey()).longValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.long2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Long2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  998 */       if ((this.next = Long2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Long2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2DoubleMap.Entry>)new AbstractObjectSortedSet<Long2DoubleMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1147 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1149 */             Long2DoubleAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Long2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Long2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2DoubleMap.Entry first() {
/* 1165 */             return Long2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2DoubleMap.Entry last() {
/* 1170 */             return Long2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) {
/* 1175 */             return Long2DoubleAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) {
/* 1180 */             return Long2DoubleAVLTreeMap.this.headMap(to.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) {
/* 1185 */             return Long2DoubleAVLTreeMap.this.tailMap(from.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Long2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1227 */       return new Long2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (DoubleIterator)new Long2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1285 */             return Long2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Long2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Long2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Long2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Long2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Long2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2DoubleMap.Entry>)new AbstractObjectSortedSet<Long2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2DoubleMap.Entry> comparator() {
/* 1399 */               return Long2DoubleAVLTreeMap.this.long2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1410 */               return (f != null && Long2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1421 */               if (f != null && Long2DoubleAVLTreeMap.Submap.this.in(f.key)) Long2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Long2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Long2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2DoubleMap.Entry first() {
/* 1444 */               return Long2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2DoubleMap.Entry last() {
/* 1449 */               return Long2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) {
/* 1454 */               return Long2DoubleAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) {
/* 1459 */               return Long2DoubleAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) {
/* 1464 */               return Long2DoubleAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractLong2DoubleSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1473 */         return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1478 */         return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1493 */               return (DoubleIterator)new Long2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1498 */               return Long2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Long2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1518 */       return (in(k) && Long2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(long k) {
/* 1536 */       long kk = k; Long2DoubleAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Long2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(long k, double v) {
/* 1542 */       Long2DoubleAVLTreeMap.this.modified = false;
...
/* 1544 */       double oldValue = Long2DoubleAVLTreeMap.this.put(k, v);
/* 1545 */       return Long2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(long k) {
/* 1551 */       Long2DoubleAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       double oldValue = Long2DoubleAVLTreeMap.this.remove(k);
/* 1554 */       return Long2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1575 */       return Long2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2DoubleSortedMap headMap(long to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2DoubleSortedMap tailMap(long from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2DoubleSortedMap subMap(long from, long to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Long2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Long2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Long2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2DoubleAVLTreeMap.Entry e;
/* 1627 */       if (Long2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Long2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Long2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1645 */       Long2DoubleAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1652 */       Long2DoubleAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Long2DoubleAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Long2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Long2DoubleAVLTreeMap.Submap.this.bottom && Long2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Long2DoubleAVLTreeMap.Submap.this.top && Long2DoubleAVLTreeMap.this.compare(k, (this.prev = Long2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Long2DoubleAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Long2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Long2DoubleAVLTreeMap.this.compare(this.prev.key, Long2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Long2DoubleAVLTreeMap.Submap.this.top && this.next != null && Long2DoubleAVLTreeMap.this.compare(this.next.key, Long2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Long2DoubleMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Long2DoubleAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readLong(), s.readDouble());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readLong(), s.readDouble());
/* 1866 */       entry.right(new Entry(s.readLong(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleAVLTreeMap.class
