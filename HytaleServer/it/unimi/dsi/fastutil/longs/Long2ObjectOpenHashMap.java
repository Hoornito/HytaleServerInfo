...
/*  357 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0L && Objects.equals(value[i], v)) return true;  }
/*  358 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  559 */       return Long2ObjectOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  564 */       return Long2ObjectOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  569 */       return Long2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  574 */       return Long2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  579 */       V oldValue = Long2ObjectOpenHashMap.this.value[this.index];
/*  580 */       Long2ObjectOpenHashMap.this.value[this.index] = v;
/*  581 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongObjectPair<V> right(V v) {
/*  586 */       Long2ObjectOpenHashMap.this.value[this.index] = v;
/*  587 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  598 */       return Long.valueOf(Long2ObjectOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  606 */       return (Long2ObjectOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Objects.equals(Long2ObjectOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  611 */       return HashCommon.long2int(Long2ObjectOpenHashMap.this.key[this.index]) ^ ((Long2ObjectOpenHashMap.this.value[this.index] == null) ? 0 : Long2ObjectOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  616 */       return Long2ObjectOpenHashMap.this.key[this.index] + "=>" + Long2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  627 */     int pos = Long2ObjectOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  633 */     int last = -1;
/*      */     
/*  635 */     int c = Long2ObjectOpenHashMap.this.size;
/*      */     
/*  637 */     boolean mustReturnNullKey = Long2ObjectOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  656 */         return this.last = Long2ObjectOpenHashMap.this.n;
/*      */       } 
/*  658 */       long[] key = Long2ObjectOpenHashMap.this.key;
/*      */       while (true) {
/*  660 */         if (--this.pos < 0) {
/*      */           
/*  662 */           this.last = Integer.MIN_VALUE;
/*  663 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  664 */           int p = (int)HashCommon.mix(k) & Long2ObjectOpenHashMap.this.mask;
/*  665 */           for (; k != key[p]; p = p + 1 & Long2ObjectOpenHashMap.this.mask);
/*  666 */           return p;
/*      */         } 
...
/*  675 */         acceptOnIndex(action, this.last = Long2ObjectOpenHashMap.this.n);
/*  676 */         this.c--;
/*      */       } 
/*  678 */       long[] key = Long2ObjectOpenHashMap.this.key;
/*  679 */       while (this.c != 0) {
/*  680 */         if (--this.pos < 0) {
/*      */           
/*  682 */           this.last = Integer.MIN_VALUE;
/*  683 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  684 */           int p = (int)HashCommon.mix(k) & Long2ObjectOpenHashMap.this.mask;
/*  685 */           for (; k != key[p]; p = p + 1 & Long2ObjectOpenHashMap.this.mask);
...
/*  705 */       long[] key = Long2ObjectOpenHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  707 */         pos = (last = pos) + 1 & Long2ObjectOpenHashMap.this.mask;
/*      */         while (true) {
/*  709 */           if ((curr = key[pos]) == 0L) {
/*  710 */             key[last] = 0L;
/*  711 */             Long2ObjectOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  714 */           int slot = (int)HashCommon.mix(curr) & Long2ObjectOpenHashMap.this.mask;
/*  715 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  716 */             break;  pos = pos + 1 & Long2ObjectOpenHashMap.this.mask;
/*      */         } 
/*  718 */         if (pos < last) {
...
/*      */         } 
/*  722 */         key[last] = curr;
/*  723 */         Long2ObjectOpenHashMap.this.value[last] = Long2ObjectOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  728 */       if (this.last == -1) throw new IllegalStateException(); 
/*  729 */       if (this.last == Long2ObjectOpenHashMap.this.n)
/*  730 */       { Long2ObjectOpenHashMap.this.containsNullKey = false;
/*  731 */         Long2ObjectOpenHashMap.this.value[Long2ObjectOpenHashMap.this.n] = null; }
/*  732 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  735 */       { Long2ObjectOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  736 */         this.last = -1;
/*      */         return; }
/*      */       
/*  739 */       Long2ObjectOpenHashMap.this.size--;
/*  740 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2ObjectMap.Entry<V>>> implements ObjectIterator<Long2ObjectMap.Entry<V>> { public Long2ObjectOpenHashMap<V>.MapEntry next() {
/*  756 */       return this.entry = new Long2ObjectOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  762 */       action.accept(this.entry = new Long2ObjectOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  773 */       this.entry = new Long2ObjectOpenHashMap.MapEntry();
/*      */     }
...
/*  794 */     int pos = 0;
/*      */     
/*  796 */     int max = Long2ObjectOpenHashMap.this.n;
/*      */     
/*  798 */     int c = 0;
/*      */     
/*  800 */     boolean mustReturnNull = Long2ObjectOpenHashMap.this.containsNullKey;
/*      */     
...
/*  820 */         this.c++;
/*  821 */         acceptOnIndex(action, Long2ObjectOpenHashMap.this.n);
/*  822 */         return true;
/*      */       } 
/*  824 */       long[] key = Long2ObjectOpenHashMap.this.key;
...
/*  839 */         this.c++;
/*  840 */         acceptOnIndex(action, Long2ObjectOpenHashMap.this.n);
/*      */       } 
/*  842 */       long[] key = Long2ObjectOpenHashMap.this.key;
...
/*      */       {
/*  855 */         return (Long2ObjectOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  860 */       return Math.min((Long2ObjectOpenHashMap.this.size - this.c), (long)(Long2ObjectOpenHashMap.this.realSize() / Long2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  888 */         n--;
/*      */       } 
/*  890 */       long[] key = Long2ObjectOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2ObjectMap.Entry<V>> action, int index) {
/*  918 */       action.accept(new Long2ObjectOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  930 */       return new Long2ObjectOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator() {
/*  935 */       return new Long2ObjectOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2ObjectMap.Entry<V>> spliterator() {
/*  940 */       return new Long2ObjectOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  952 */       if (k == 0L) return (Long2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenHashMap.this.value[Long2ObjectOpenHashMap.this.n], v));
/*      */       
/*  954 */       long[] key = Long2ObjectOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/*  957 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ObjectOpenHashMap.this.mask]) == 0L) return false; 
/*  958 */       if (k == curr) return Objects.equals(Long2ObjectOpenHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  961 */         if ((curr = key[pos = pos + 1 & Long2ObjectOpenHashMap.this.mask]) == 0L) return false; 
/*  962 */         if (k == curr) return Objects.equals(Long2ObjectOpenHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  974 */       if (k == 0L) {
/*  975 */         if (Long2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenHashMap.this.value[Long2ObjectOpenHashMap.this.n], v)) {
/*  976 */           Long2ObjectOpenHashMap.this.removeNullEntry();
/*  977 */           return true;
/*      */         } 
/*  979 */         return false;
/*      */       } 
/*      */       
/*  982 */       long[] key = Long2ObjectOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/*  985 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ObjectOpenHashMap.this.mask]) == 0L) return false; 
/*  986 */       if (curr == k) {
/*  987 */         if (Objects.equals(Long2ObjectOpenHashMap.this.value[pos], v)) {
/*  988 */           Long2ObjectOpenHashMap.this.removeEntry(pos);
/*  989 */           return true;
/*      */         } 
/*  991 */         return false;
/*      */       } 
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Long2ObjectOpenHashMap.this.mask]) == 0L) return false; 
/*  995 */         if (curr == k && 
/*  996 */           Objects.equals(Long2ObjectOpenHashMap.this.value[pos], v)) {
/*  997 */           Long2ObjectOpenHashMap.this.removeEntry(pos);
/*  998 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1006 */       return Long2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1011 */       Long2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
/* 1017 */       if (Long2ObjectOpenHashMap.this.containsNullKey) consumer.accept(new Long2ObjectOpenHashMap.MapEntry(Long2ObjectOpenHashMap.this.n)); 
/* 1018 */       for (int pos = Long2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Long2ObjectOpenHashMap.this.key[pos] != 0L) consumer.accept(new Long2ObjectOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
/* 1024 */       Long2ObjectOpenHashMap<V>.MapEntry entry = new Long2ObjectOpenHashMap.MapEntry();
/* 1025 */       if (Long2ObjectOpenHashMap.this.containsNullKey) {
/* 1026 */         entry.index = Long2ObjectOpenHashMap.this.n;
/* 1027 */         consumer.accept(entry);
/*      */       } 
/* 1029 */       for (int pos = Long2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Long2ObjectOpenHashMap.this.key[pos] != 0L) {
...
/* 1060 */       action.accept(Long2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1065 */       return Long2ObjectOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1086 */       action.accept(Long2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1098 */       return new Long2ObjectOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1103 */       return new Long2ObjectOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1109 */       if (Long2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Long2ObjectOpenHashMap.this.key[Long2ObjectOpenHashMap.this.n]); 
/* 1110 */       for (int pos = Long2ObjectOpenHashMap.this.n; pos-- != 0; ) {
/* 1111 */         long k = Long2ObjectOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1118 */       return Long2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1123 */       return Long2ObjectOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1128 */       int oldSize = Long2ObjectOpenHashMap.this.size;
/* 1129 */       Long2ObjectOpenHashMap.this.remove(k);
/* 1130 */       return (Long2ObjectOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1135 */       Long2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1163 */       action.accept(Long2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1168 */       return Long2ObjectOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1189 */       action.accept(Long2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1203 */             return new Long2ObjectOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1208 */             return new Long2ObjectOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1214 */             if (Long2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Long2ObjectOpenHashMap.this.value[Long2ObjectOpenHashMap.this.n]); 
/* 1215 */             for (int pos = Long2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Long2ObjectOpenHashMap.this.key[pos] != 0L) consumer.accept(Long2ObjectOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1220 */             return Long2ObjectOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1225 */             return Long2ObjectOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1230 */             Long2ObjectOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1328 */       c = (Long2ObjectOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectOpenHashMap.class
