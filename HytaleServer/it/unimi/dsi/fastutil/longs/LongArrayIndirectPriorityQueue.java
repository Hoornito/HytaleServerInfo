...
/*  68 */     this(refArray, capacity, (LongComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  89 */     this(refArray, refArray.length, (LongComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */     long first = this.refArray[this.array[firstIndex]];
/* 158 */     if (this.c == null) { while (i-- != 0) {
/* 159 */         if (this.refArray[this.array[i]] < first) first = this.refArray[this.array[firstIndex = i]]; 
/*     */       }  }
/* 161 */     else { while (i-- != 0) {
...
/* 170 */     int i = this.size;
/* 171 */     int lastIndex = --i;
/* 172 */     long last = this.refArray[this.array[lastIndex]];
/* 173 */     if (this.c == null)
/* 174 */     { while (i-- != 0) { if (last < this.refArray[this.array[i]]) last = this.refArray[this.array[lastIndex = i]];  }
/*     */        }
...
/* 211 */     { if (this.c == null)
/* 212 */       { if (this.refArray[x] < this.refArray[this.array[this.firstIndex]]) this.firstIndex = this.size;  }
...
/* 287 */     long top = this.refArray[this.array[findFirst()]];
/* 288 */     int i = this.size, c = 0;
/* 289 */     while (i-- != 0) { if (top == this.refArray[this.array[i]]) a[c++] = this.array[i];  }
/* 290 */      return c;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\LongArrayIndirectPriorityQueue.class
