...
/*  885 */       Map.Entry<Long, Byte> e = (Map.Entry<Long, Byte>)o;
/*  886 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Long2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  998 */       if ((this.next = Long2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Long2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Long2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2ByteMap.Entry>)new AbstractObjectSortedSet<Long2ByteMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Long2ByteMap.Entry>)new Long2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Long2ByteMap.Entry>)new Long2ByteAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1147 */             Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1148 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1149 */             Long2ByteAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Long2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Long2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ByteMap.Entry first() {
/* 1165 */             return Long2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2ByteMap.Entry last() {
/* 1170 */             return Long2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry to) {
/* 1175 */             return Long2ByteAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry to) {
/* 1180 */             return Long2ByteAVLTreeMap.this.headMap(to.getLongKey()).long2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from) {
/* 1185 */             return Long2ByteAVLTreeMap.this.tailMap(from.getLongKey()).long2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Long2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1227 */       return new Long2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ByteIterator)new Long2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1285 */             return Long2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Long2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Long2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Long2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Long2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Long2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2ByteMap.Entry>)new AbstractObjectSortedSet<Long2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Long2ByteMap.Entry>)new Long2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Long2ByteMap.Entry>)new Long2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2ByteMap.Entry> comparator() {
/* 1399 */               return Long2ByteAVLTreeMap.this.long2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1410 */               return (f != null && Long2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1421 */               if (f != null && Long2ByteAVLTreeMap.Submap.this.in(f.key)) Long2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Long2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Long2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Long2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ByteMap.Entry first() {
/* 1444 */               return Long2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2ByteMap.Entry last() {
/* 1449 */               return Long2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry to) {
/* 1454 */               return Long2ByteAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry to) {
/* 1459 */               return Long2ByteAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from) {
/* 1464 */               return Long2ByteAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2ByteEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractLong2ByteSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1473 */         return new Long2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1478 */         return new Long2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1493 */               return (ByteIterator)new Long2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1498 */               return Long2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Long2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Long2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1518 */       return (in(k) && Long2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(long k) {
/* 1536 */       long kk = k; Long2ByteAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Long2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(long k, byte v) {
/* 1542 */       Long2ByteAVLTreeMap.this.modified = false;
...
/* 1544 */       byte oldValue = Long2ByteAVLTreeMap.this.put(k, v);
/* 1545 */       return Long2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(long k) {
/* 1551 */       Long2ByteAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       byte oldValue = Long2ByteAVLTreeMap.this.remove(k);
/* 1554 */       return Long2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1575 */       return Long2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteSortedMap headMap(long to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Long2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteSortedMap tailMap(long from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Long2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteSortedMap subMap(long from, long to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Long2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Long2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Long2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Long2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Long2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Long2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Long2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2ByteAVLTreeMap.Entry e;
/* 1627 */       if (Long2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Long2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Long2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Long2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Long2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1645 */       Long2ByteAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1652 */       Long2ByteAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Long2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Long2ByteAVLTreeMap.Submap.this.bottom && Long2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Long2ByteAVLTreeMap.Submap.this.top && Long2ByteAVLTreeMap.this.compare(k, (this.prev = Long2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Long2ByteAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Long2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Long2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Long2ByteAVLTreeMap.this.compare(this.prev.key, Long2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Long2ByteAVLTreeMap.Submap.this.top && this.next != null && Long2ByteAVLTreeMap.this.compare(this.next.key, Long2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Long2ByteMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Long2ByteAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readLong(), s.readByte());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readLong(), s.readByte());
/* 1866 */       entry.right(new Entry(s.readLong(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteAVLTreeMap.class
