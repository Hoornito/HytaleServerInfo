...
/*  543 */     Byte newValue = remappingFunction.apply(Long.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Byte newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  635 */       return Long2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  640 */       return Long2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  645 */       return Long2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  650 */       return Long2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  655 */       byte oldValue = Long2ByteOpenCustomHashMap.this.value[this.index];
/*  656 */       Long2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBytePair right(byte v) {
/*  662 */       Long2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  674 */       return Long.valueOf(Long2ByteOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Byte.valueOf(Long2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Long, Byte> e = (Map.Entry<Long, Byte>)o;
/*  704 */       return (Long2ByteOpenCustomHashMap.this.strategy.equals(Long2ByteOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue()) && Long2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Long2ByteOpenCustomHashMap.this.strategy.hashCode(Long2ByteOpenCustomHashMap.this.key[this.index]) ^ Long2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Long2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Long2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Long2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Long2ByteOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Long2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Long2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ByteOpenCustomHashMap.this.mask;
/*  763 */           for (; !Long2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2ByteOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Long2ByteOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ByteOpenCustomHashMap.this.mask;
/*  783 */           for (; !Long2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Long2ByteOpenCustomHashMap.this.mask);
...
/*  813 */             break;  pos = pos + 1 & Long2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Long2ByteOpenCustomHashMap.this.value[last] = Long2ByteOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Long2ByteOpenCustomHashMap.this.n)
/*  827 */       { Long2ByteOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Long2ByteOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Long2ByteOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2ByteMap.Entry>> implements ObjectIterator<Long2ByteMap.Entry> { public Long2ByteOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Long2ByteOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Long2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Long2ByteOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Long2ByteOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Long2ByteOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Long2ByteOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Long2ByteOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Long2ByteOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Long2ByteOpenCustomHashMap.this.size - this.c), (long)(Long2ByteOpenCustomHashMap.this.realSize() / Long2ByteOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Long2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2ByteMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Long2ByteMap.Entry> action, int index) {
/* 1014 */       action.accept(new Long2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Long2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Long2ByteMap.Entry> fastIterator() {
/* 1031 */       return new Long2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Long2ByteMap.Entry> spliterator() {
/* 1036 */       return new Long2ByteOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, 0L)) return (Long2ByteOpenCustomHashMap.this.containsNullKey && Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1055 */       if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Long2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Long2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1059 */         if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Long2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/* 1073 */         if (Long2ByteOpenCustomHashMap.this.containsNullKey && Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n] == v) {
/* 1074 */           Long2ByteOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       long[] key = Long2ByteOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1084 */       if (Long2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Long2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Long2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Long2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1093 */         if (Long2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Long2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Long2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Long2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Long2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
/* 1115 */       if (Long2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(new Long2ByteOpenCustomHashMap.MapEntry(Long2ByteOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Long2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2ByteOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(new Long2ByteOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2ByteMap.Entry> consumer) {
/* 1122 */       Long2ByteOpenCustomHashMap.MapEntry entry = new Long2ByteOpenCustomHashMap.MapEntry();
/* 1123 */       if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Long2ByteOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Long2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2ByteOpenCustomHashMap.this.key[pos] != 0L) {
...
/* 1158 */       action.accept(Long2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1163 */       return Long2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1184 */       action.accept(Long2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Long2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongSpliterator spliterator() {
/* 1201 */       return new Long2ByteOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1207 */       if (Long2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Long2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         long k = Long2ByteOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Long2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1221 */       return Long2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1226 */       int oldSize = Long2ByteOpenCustomHashMap.this.size;
/* 1227 */       Long2ByteOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Long2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Long2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Long2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1266 */       return Long2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1287 */       action.accept(Long2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Long2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1306 */             return new Long2ByteOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1312 */             if (Long2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Long2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Long2ByteOpenCustomHashMap.this.key[pos] != 0L) consumer.accept(Long2ByteOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Long2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1323 */             return Long2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Long2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Long2ByteOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteOpenCustomHashMap.class
