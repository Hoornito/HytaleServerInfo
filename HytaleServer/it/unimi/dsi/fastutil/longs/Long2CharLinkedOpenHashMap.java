...
/*  854 */     Character newValue = remappingFunction.apply(Long.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Character newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
...
/*  947 */       return Long2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  952 */       return Long2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  957 */       return Long2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  962 */       return Long2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  967 */       char oldValue = Long2CharLinkedOpenHashMap.this.value[this.index];
/*  968 */       Long2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongCharPair right(char v) {
/*  974 */       Long2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  986 */       return Long.valueOf(Long2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Character.valueOf(Long2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
/* 1016 */       return (Long2CharLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Long2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return HashCommon.long2int(Long2CharLinkedOpenHashMap.this.key[this.index]) ^ Long2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Long2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Long2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Long2CharLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(long from) {
/* 1199 */       if (from == 0L) {
/* 1200 */         if (Long2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Long2CharLinkedOpenHashMap.this.link[Long2CharLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Long2CharLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Long2CharLinkedOpenHashMap.this.key[Long2CharLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Long2CharLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Long2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = (int)HashCommon.mix(from) & Long2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Long2CharLinkedOpenHashMap.this.key[pos] != 0L) {
/* 1215 */         if (Long2CharLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Long2CharLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Long2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Long2CharLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Long2CharLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Long2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Long2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Long2CharLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Long2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Long2CharLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Long2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Long2CharLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Long2CharLinkedOpenHashMap.this.link[this.prev] = Long2CharLinkedOpenHashMap.this.link[this.prev] ^ (Long2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Long2CharLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Long2CharLinkedOpenHashMap.this.link[this.next] = Long2CharLinkedOpenHashMap.this.link[this.next] ^ (Long2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Long2CharLinkedOpenHashMap.this.n) {
/* 1309 */         Long2CharLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         long[] key = Long2CharLinkedOpenHashMap.this.key; while (true) {
/*      */           long curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Long2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == 0L) {
/* 1318 */               key[last] = 0L;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = (int)HashCommon.mix(curr) & Long2CharLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Long2CharLinkedOpenHashMap.this.value[last] = Long2CharLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Long2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2CharMap.Entry>> implements ObjectListIterator<Long2CharMap.Entry> {
...
/* 1368 */       action.accept(new Long2CharLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Long2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Long2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Long2CharMap.Entry>> implements ObjectListIterator<Long2CharMap.Entry> {
/* 1389 */     final Long2CharLinkedOpenHashMap.MapEntry entry = new Long2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Long2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Long2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharMap.Entry last() {
/* 1472 */       if (Long2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == 0L) return (Long2CharLinkedOpenHashMap.this.containsNullKey && Long2CharLinkedOpenHashMap.this.value[Long2CharLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1487 */       long[] key = Long2CharLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1490 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2CharLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1491 */       if (k == curr) return (Long2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1495 */         if (k == curr) return (Long2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == 0L) {
/* 1509 */         if (Long2CharLinkedOpenHashMap.this.containsNullKey && Long2CharLinkedOpenHashMap.this.value[Long2CharLinkedOpenHashMap.this.n] == v) {
/* 1510 */           Long2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       long[] key = Long2CharLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1519 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2CharLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Long2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1522 */           Long2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Long2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1531 */           Long2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Long2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Long2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Long2CharLinkedOpenHashMap.EntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Long2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Long2CharLinkedOpenHashMap.FastEntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2CharMap.Entry> consumer) {
/* 1588 */       for (int i = Long2CharLinkedOpenHashMap.this.size, next = Long2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Long2CharLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Long2CharLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Long2CharLinkedOpenHashMap.MapEntry entry = new Long2CharLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Long2CharLinkedOpenHashMap.this.size, next = Long2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Long2CharLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Long2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Long2CharLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1645 */       return Long2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Long2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public LongListIterator iterator() {
/* 1659 */       return new Long2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2CharLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1675 */       for (int i = Long2CharLinkedOpenHashMap.this.size, next = Long2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Long2CharLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Long2CharLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Long2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1689 */       return Long2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1694 */       int oldSize = Long2CharLinkedOpenHashMap.this.size;
/* 1695 */       Long2CharLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Long2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Long2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLong() {
/* 1706 */       if (Long2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Long2CharLinkedOpenHashMap.this.key[Long2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public long lastLong() {
/* 1712 */       if (Long2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Long2CharLinkedOpenHashMap.this.key[Long2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public LongComparator comparator() {
...
/* 1754 */       return Long2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Long2CharLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1771 */       return Long2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (CharIterator)new Long2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2CharLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1798 */             for (int i = Long2CharLinkedOpenHashMap.this.size, next = Long2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Long2CharLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Long2CharLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Long2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1812 */             return Long2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Long2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Long2CharLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2CharLinkedOpenHashMap.class
