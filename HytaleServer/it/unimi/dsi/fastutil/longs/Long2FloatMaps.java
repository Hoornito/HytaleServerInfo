...
/*  50 */     return (entries instanceof Long2FloatMap.FastEntrySet) ? ((Long2FloatMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Long2FloatMap.Entry> entries = map.long2FloatEntrySet();
/*  66 */     if (entries instanceof Long2FloatMap.FastEntrySet) { ((Long2FloatMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Long2FloatMap.Entry> entries = map.long2FloatEntrySet();
/*  83 */     return (entries instanceof Long2FloatMap.FastEntrySet) ? new ObjectIterable<Long2FloatMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Long2FloatMap.Entry> iterator() {
/*  86 */           return ((Long2FloatMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Long2FloatMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Long2FloatMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractLong2FloatMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)long2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/*     */     
/*     */     public int hashCode() {
/* 271 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */   
/*     */   public static Long2FloatMap singleton(Long key, Float value) {
/* 316 */     return new Singleton(key.longValue(), value.floatValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Long2FloatFunctions.SynchronizedFunction implements Long2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.long2FloatEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Float>> entrySet() {
/* 381 */       return (ObjectSet)long2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/*     */     extends Long2FloatFunctions.UnmodifiableFunction implements Long2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2FloatMap map;
/*     */     protected transient ObjectSet<Long2FloatMap.Entry> entries;
/*     */     protected transient LongSet keys;
...
/*     */     
/*     */     public ObjectSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.long2FloatEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Float>> entrySet() {
/* 712 */       return (ObjectSet)long2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public LongSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatMaps.class
