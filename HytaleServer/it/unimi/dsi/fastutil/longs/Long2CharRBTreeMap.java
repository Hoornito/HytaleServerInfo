...
/*      */ 
/*      */ 
/*      */ public class Long2CharRBTreeMap
...
/*      */     extends AbstractLong2CharMap.BasicEntry
...
/*  839 */       Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
/*  840 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return HashCommon.long2int(this.key) ^ this.value;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Long2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(long k) {
/*  950 */       if ((this.next = Long2CharRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Long2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Long2CharRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1089 */             Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1090 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1091 */             Long2CharRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Long2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Long2CharRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2CharMap.Entry first() {
/* 1107 */             return Long2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Long2CharMap.Entry last() {
/* 1112 */             return Long2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1117 */             return Long2CharRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1122 */             return Long2CharRBTreeMap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1127 */             return Long2CharRBTreeMap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Long2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1169 */       return new Long2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (CharIterator)new Long2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1227 */             return Long2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Long2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Long2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Long2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Long2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Long2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2CharRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Long2CharMap.Entry> comparator() {
/* 1341 */               return Long2CharRBTreeMap.this.long2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1352 */               return (f != null && Long2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1363 */               if (f != null && Long2CharRBTreeMap.Submap.this.in(f.key)) Long2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Long2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Long2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Long2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2CharMap.Entry first() {
/* 1386 */               return Long2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Long2CharMap.Entry last() {
/* 1391 */               return Long2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1396 */               return Long2CharRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1401 */               return Long2CharRBTreeMap.Submap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1406 */               return Long2CharRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractLong2CharSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public LongBidirectionalIterator iterator() {
/* 1415 */         return new Long2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1420 */         return new Long2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1435 */               return (CharIterator)new Long2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1440 */               return Long2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Long2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Long2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1460 */       return (in(k) && Long2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(long k) {
/* 1478 */       long kk = k; Long2CharRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Long2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(long k, char v) {
/* 1484 */       Long2CharRBTreeMap.this.modified = false;
...
/* 1486 */       char oldValue = Long2CharRBTreeMap.this.put(k, v);
/* 1487 */       return Long2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(long k) {
/* 1493 */       Long2CharRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       char oldValue = Long2CharRBTreeMap.this.remove(k);
/* 1496 */       return Long2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1517 */       return Long2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharSortedMap headMap(long to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Long2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharSortedMap tailMap(long from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Long2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2CharSortedMap subMap(long from, long to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Long2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Long2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Long2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Long2CharRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Long2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Long2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Long2CharRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Long2CharRBTreeMap.Entry e;
/* 1569 */       if (Long2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Long2CharRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Long2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Long2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Long2CharRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLongKey() {
/* 1587 */       Long2CharRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public long lastLongKey() {
/* 1594 */       Long2CharRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Long2CharRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Long2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(long k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Long2CharRBTreeMap.Submap.this.bottom && Long2CharRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Long2CharRBTreeMap.Submap.this.top && Long2CharRBTreeMap.this.compare(k, (this.prev = Long2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Long2CharRBTreeMap.this.locateKey(k);
/* 1620 */             if (Long2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Long2CharRBTreeMap.Submap.this.bottom && this.prev != null && Long2CharRBTreeMap.this.compare(this.prev.key, Long2CharRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Long2CharRBTreeMap.Submap.this.top && this.next != null && Long2CharRBTreeMap.this.compare(this.next.key, Long2CharRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Long2CharMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Long2CharRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readLong(), s.readChar());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readLong(), s.readChar());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readLong(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2CharRBTreeMap.class
