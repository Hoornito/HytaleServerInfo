...
/*  854 */     Byte newValue = remappingFunction.apply(Long.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Byte newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     implements Long2ByteMap.Entry, Map.Entry<Long, Byte>, LongBytePair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  947 */       return Long2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long leftLong() {
/*  952 */       return Long2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  957 */       return Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  962 */       return Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  967 */       byte oldValue = Long2ByteLinkedOpenHashMap.this.value[this.index];
/*  968 */       Long2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBytePair right(byte v) {
/*  974 */       Long2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  986 */       return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Long, Byte> e = (Map.Entry<Long, Byte>)o;
/* 1016 */       return (Long2ByteLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Long2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return HashCommon.long2int(Long2ByteLinkedOpenHashMap.this.key[this.index]) ^ Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Long2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Long2ByteLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(long from) {
/* 1199 */       if (from == 0L) {
/* 1200 */         if (Long2ByteLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Long2ByteLinkedOpenHashMap.this.link[Long2ByteLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Long2ByteLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Long2ByteLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Long2ByteLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = (int)HashCommon.mix(from) & Long2ByteLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Long2ByteLinkedOpenHashMap.this.key[pos] != 0L) {
/* 1215 */         if (Long2ByteLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Long2ByteLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Long2ByteLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Long2ByteLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Long2ByteLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Long2ByteLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Long2ByteLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Long2ByteLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Long2ByteLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Long2ByteLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Long2ByteLinkedOpenHashMap.this.link[this.prev] = Long2ByteLinkedOpenHashMap.this.link[this.prev] ^ (Long2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Long2ByteLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Long2ByteLinkedOpenHashMap.this.link[this.next] = Long2ByteLinkedOpenHashMap.this.link[this.next] ^ (Long2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Long2ByteLinkedOpenHashMap.this.n) {
/* 1309 */         Long2ByteLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         long[] key = Long2ByteLinkedOpenHashMap.this.key; while (true) {
/*      */           long curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == 0L) {
/* 1318 */               key[last] = 0L;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = (int)HashCommon.mix(curr) & Long2ByteLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Long2ByteLinkedOpenHashMap.this.value[last] = Long2ByteLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Long2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Long2ByteMap.Entry>> implements ObjectListIterator<Long2ByteMap.Entry> {
...
/* 1368 */       action.accept(new Long2ByteLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Long2ByteMap.Entry>> implements ObjectListIterator<Long2ByteMap.Entry> {
/* 1389 */     final Long2ByteLinkedOpenHashMap.MapEntry entry = new Long2ByteLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Long2ByteMap.Entry>)new Long2ByteLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Long2ByteLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Long2ByteMap.Entry last() {
/* 1472 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == 0L) return (Long2ByteLinkedOpenHashMap.this.containsNullKey && Long2ByteLinkedOpenHashMap.this.value[Long2ByteLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1487 */       long[] key = Long2ByteLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1490 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ByteLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1491 */       if (k == curr) return (Long2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1495 */         if (k == curr) return (Long2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == 0L) {
/* 1509 */         if (Long2ByteLinkedOpenHashMap.this.containsNullKey && Long2ByteLinkedOpenHashMap.this.value[Long2ByteLinkedOpenHashMap.this.n] == v) {
/* 1510 */           Long2ByteLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       long[] key = Long2ByteLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1519 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ByteLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Long2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1522 */           Long2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Long2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1531 */           Long2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Long2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Long2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Long2ByteLinkedOpenHashMap.EntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Long2ByteLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Long2ByteLinkedOpenHashMap.FastEntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
/* 1588 */       for (int i = Long2ByteLinkedOpenHashMap.this.size, next = Long2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Long2ByteLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Long2ByteLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Long2ByteLinkedOpenHashMap.MapEntry entry = new Long2ByteLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Long2ByteLinkedOpenHashMap.this.size, next = Long2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Long2ByteLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Long2ByteLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Long2ByteLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1645 */       return Long2ByteLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Long2ByteLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public LongListIterator iterator() {
/* 1659 */       return new Long2ByteLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2ByteLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1675 */       for (int i = Long2ByteLinkedOpenHashMap.this.size, next = Long2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Long2ByteLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Long2ByteLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Long2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(long k) {
/* 1689 */       return Long2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1694 */       int oldSize = Long2ByteLinkedOpenHashMap.this.size;
/* 1695 */       Long2ByteLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Long2ByteLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Long2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public long firstLong() {
/* 1706 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public long lastLong() {
/* 1712 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public LongComparator comparator() {
...
/* 1754 */       return Long2ByteLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Long2ByteLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1771 */       return Long2ByteLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (ByteIterator)new Long2ByteLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return ByteSpliterators.asSpliterator(iterator(), Size64.sizeOf(Long2ByteLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1798 */             for (int i = Long2ByteLinkedOpenHashMap.this.size, next = Long2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Long2ByteLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Long2ByteLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Long2ByteLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1812 */             return Long2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Long2ByteLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Long2ByteLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteLinkedOpenHashMap.class
