...
/*  93 */     this(m.size());
/*  94 */     int i = 0;
/*  95 */     for (ObjectIterator<Double2IntMap.Entry> objectIterator = m.double2IntEntrySet().iterator(); objectIterator.hasNext(); ) { Double2IntMap.Entry e = objectIterator.next();
...
/* 109 */     this(m.size());
/* 110 */     int i = 0;
/* 111 */     for (Map.Entry<? extends Double, ? extends Integer> e : m.entrySet()) {
...
/* 144 */       return new ObjectIterator<Double2IntMap.Entry>() {
/* 145 */           int curr = -1; int next = 0;
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 149 */             return (this.next < Double2IntArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 156 */             return new AbstractDouble2IntMap.BasicEntry(Double2IntArrayMap.this.key[this.curr = this.next], Double2IntArrayMap.this.value[this.next++]);
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
...
/* 162 */             this.curr = -1;
/* 163 */             int tail = Double2IntArrayMap.this.size-- - this.next--;
/* 164 */             System.arraycopy(Double2IntArrayMap.this.key, this.next + 1, Double2IntArrayMap.this.key, this.next, tail);
/* 165 */             System.arraycopy(Double2IntArrayMap.this.value, this.next + 1, Double2IntArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */             int max = Double2IntArrayMap.this.size;
/* 173 */             while (this.next < max) {
/* 174 */               action.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntArrayMap.this.key[this.curr = this.next], Double2IntArrayMap.this.value[this.next++]));
/*     */             }
/*     */           }
/*     */         };
/*     */     }
...
/* 182 */       return new ObjectIterator<Double2IntMap.Entry>() {
/* 183 */           int next = 0; int curr = -1;
/* 184 */           final AbstractDouble2IntMap.BasicEntry entry = new AbstractDouble2IntMap.BasicEntry();
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 188 */             return (this.next < Double2IntArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 195 */             this.entry.key = Double2IntArrayMap.this.key[this.curr = this.next];
/* 196 */             this.entry.value = Double2IntArrayMap.this.value[this.next++];
...
/* 203 */             this.curr = -1;
/* 204 */             int tail = Double2IntArrayMap.this.size-- - this.next--;
/* 205 */             System.arraycopy(Double2IntArrayMap.this.key, this.next + 1, Double2IntArrayMap.this.key, this.next, tail);
/* 206 */             System.arraycopy(Double2IntArrayMap.this.value, this.next + 1, Double2IntArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           public void forEachRemaining(Consumer<? super Double2IntMap.Entry> action) {
/* 213 */             int max = Double2IntArrayMap.this.size;
/* 214 */             while (this.next < max) {
/* 215 */               this.entry.key = Double2IntArrayMap.this.key[this.curr = this.next];
/* 216 */               this.entry.value = Double2IntArrayMap.this.value[this.next++];
...
/* 238 */         return new AbstractDouble2IntMap.BasicEntry(Double2IntArrayMap.this.key[location], Double2IntArrayMap.this.value[location]);
/*     */       }
/*     */ 
/*     */       
...
/* 249 */       return new EntrySetSpliterator(0, Double2IntArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 257 */       for (int i = 0, max = Double2IntArrayMap.this.size; i < max; i++) {
/* 258 */         action.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntArrayMap.this.key[i], Double2IntArrayMap.this.value[i]));
/*     */       }
/*     */     }
/*     */ 
/*     */ 
...
/* 266 */       AbstractDouble2IntMap.BasicEntry entry = new AbstractDouble2IntMap.BasicEntry();
/*     */       
/* 268 */       for (int i = 0, max = Double2IntArrayMap.this.size; i < max; i++) {
/* 269 */         entry.key = Double2IntArrayMap.this.key[i];
/* 270 */         entry.value = Double2IntArrayMap.this.value[i];
...
/*     */     
/*     */     public int size() {
/* 277 */       return Double2IntArrayMap.this.size;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 288 */       return (Double2IntArrayMap.this.containsKey(k) && Double2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 300 */       int oldPos = Double2IntArrayMap.this.findKey(k);
/* 301 */       if (oldPos == -1 || v != Double2IntArrayMap.this.value[oldPos]) return false; 
/* 302 */       int tail = Double2IntArrayMap.this.size - oldPos - 1;
/* 303 */       System.arraycopy(Double2IntArrayMap.this.key, oldPos + 1, Double2IntArrayMap.this.key, oldPos, tail);
/* 304 */       System.arraycopy(Double2IntArrayMap.this.value, oldPos + 1, Double2IntArrayMap.this.value, oldPos, tail);
/* 305 */       Double2IntArrayMap.this.size--;
/* 306 */       return true;
/*     */     }
/*     */   }
/*     */ 
...
/* 397 */       return (Double2IntArrayMap.this.findKey(k) != -1);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean remove(double k) {
/* 402 */       int oldPos = Double2IntArrayMap.this.findKey(k);
/* 403 */       if (oldPos == -1) return false; 
/* 404 */       int tail = Double2IntArrayMap.this.size - oldPos - 1;
/* 405 */       System.arraycopy(Double2IntArrayMap.this.key, oldPos + 1, Double2IntArrayMap.this.key, oldPos, tail);
/* 406 */       System.arraycopy(Double2IntArrayMap.this.value, oldPos + 1, Double2IntArrayMap.this.value, oldPos, tail);
/* 407 */       Double2IntArrayMap.this.size--;
/* 408 */       return true;
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 418 */             return (this.pos < Double2IntArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 425 */             return Double2IntArrayMap.this.key[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 430 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 431 */             int tail = Double2IntArrayMap.this.size - this.pos;
/* 432 */             System.arraycopy(Double2IntArrayMap.this.key, this.pos, Double2IntArrayMap.this.key, this.pos - 1, tail);
/* 433 */             System.arraycopy(Double2IntArrayMap.this.value, this.pos, Double2IntArrayMap.this.value, this.pos - 1, tail);
/* 434 */             Double2IntArrayMap.this.size--;
/* 435 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 442 */             int max = Double2IntArrayMap.this.size;
/* 443 */             while (this.pos < max)
/* 444 */               action.accept(Double2IntArrayMap.this.key[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 464 */         return Double2IntArrayMap.this.key[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(DoubleConsumer action) {
/* 476 */         int max = Double2IntArrayMap.this.size;
/* 477 */         while (this.pos < max) {
/* 478 */           action.accept(Double2IntArrayMap.this.key[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 485 */       return new KeySetSpliterator(0, Double2IntArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 492 */       for (int i = 0, max = Double2IntArrayMap.this.size; i < max; i++) {
/* 493 */         action.accept(Double2IntArrayMap.this.key[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 499 */       return Double2IntArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 504 */       Double2IntArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/* 517 */       return Double2IntArrayMap.this.containsValue(v);
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 527 */             return (this.pos < Double2IntArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 534 */             return Double2IntArrayMap.this.value[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 539 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 540 */             int tail = Double2IntArrayMap.this.size - this.pos;
/* 541 */             System.arraycopy(Double2IntArrayMap.this.key, this.pos, Double2IntArrayMap.this.key, this.pos - 1, tail);
/* 542 */             System.arraycopy(Double2IntArrayMap.this.value, this.pos, Double2IntArrayMap.this.value, this.pos - 1, tail);
/* 543 */             Double2IntArrayMap.this.size--;
/* 544 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 551 */             int max = Double2IntArrayMap.this.size;
/* 552 */             while (this.pos < max)
/* 553 */               action.accept(Double2IntArrayMap.this.value[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 573 */         return Double2IntArrayMap.this.value[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(IntConsumer action) {
/* 585 */         int max = Double2IntArrayMap.this.size;
/* 586 */         while (this.pos < max) {
/* 587 */           action.accept(Double2IntArrayMap.this.value[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 594 */       return new ValuesSpliterator(0, Double2IntArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 601 */       for (int i = 0, max = Double2IntArrayMap.this.size; i < max; i++) {
/* 602 */         action.accept(Double2IntArrayMap.this.value[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 608 */       return Double2IntArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 613 */       Double2IntArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/*     */     try {
/* 637 */       c = (Double2IntArrayMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntArrayMap.class
