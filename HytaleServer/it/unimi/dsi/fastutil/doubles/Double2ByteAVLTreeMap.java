...
/*      */ 
/*      */ 
/*      */ public class Double2ByteAVLTreeMap
...
/*  249 */     Entry e = add(k);
/*  250 */     byte oldValue = e.value;
/*  251 */     e.value = (byte)(e.value + incr);
/*  252 */     return oldValue;
/*      */   }
/*      */ 
/*      */   
...
/*      */     extends AbstractDouble2ByteMap.BasicEntry
...
/*  885 */       Map.Entry<Double, Byte> e = (Map.Entry<Double, Byte>)o;
/*  886 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.double2int(this.key) ^ this.value;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Double2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  998 */       if ((this.next = Double2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Double2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Double2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ByteMap.Entry>)new AbstractObjectSortedSet<Double2ByteMap.Entry>()
/*      */         {
/*      */           final Comparator<? super Double2ByteMap.Entry> comparator;
/*      */           
...
/* 1119 */             return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1133 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1135 */             Double2ByteAVLTreeMap.Entry f = Double2ByteAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1145 */             if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1146 */             if (!(e.getValue() instanceof Byte)) return false; 
/* 1147 */             Double2ByteAVLTreeMap.Entry f = Double2ByteAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1148 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1149 */             Double2ByteAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Double2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Double2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ByteMap.Entry first() {
/* 1165 */             return Double2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ByteMap.Entry last() {
/* 1170 */             return Double2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) {
/* 1175 */             return Double2ByteAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) {
/* 1180 */             return Double2ByteAVLTreeMap.this.headMap(to.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) {
/* 1185 */             return Double2ByteAVLTreeMap.this.tailMap(from.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Double2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1227 */       return new Double2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1277 */     if (this.values == null) this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1280 */             return (ByteIterator)new Double2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1285 */             return Double2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Double2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Double2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1308 */     return new Submap(0.0D, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Double2ByteSortedMap tailMap(double from) {
/* 1313 */     return new Submap(from, false, 0.0D, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1357 */       if (!bottom && !top && Double2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Double2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Double2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ByteMap.Entry>)new AbstractObjectSortedSet<Double2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ByteMap.Entry> comparator() {
/* 1399 */               return Double2ByteAVLTreeMap.this.double2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1407 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1409 */               Double2ByteAVLTreeMap.Entry f = Double2ByteAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1410 */               return (f != null && Double2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1418 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1420 */               Double2ByteAVLTreeMap.Entry f = Double2ByteAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1421 */               if (f != null && Double2ByteAVLTreeMap.Submap.this.in(f.key)) Double2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Double2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Double2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Double2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ByteMap.Entry first() {
/* 1444 */               return Double2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ByteMap.Entry last() {
/* 1449 */               return Double2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) {
/* 1454 */               return Double2ByteAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) {
/* 1459 */               return Double2ByteAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) {
/* 1464 */               return Double2ByteAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2ByteSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1473 */         return new Double2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1478 */         return new Double2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ByteCollection values() {
/* 1490 */       if (this.values == null) this.values = (ByteCollection)new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1493 */               return (ByteIterator)new Double2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1498 */               return Double2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Double2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Double2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1518 */       return (in(k) && Double2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/* 1526 */         byte ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public byte get(double k) {
/* 1536 */       double kk = k; Double2ByteAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Double2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(double k, byte v) {
/* 1542 */       Double2ByteAVLTreeMap.this.modified = false;
...
/* 1544 */       byte oldValue = Double2ByteAVLTreeMap.this.put(k, v);
/* 1545 */       return Double2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(double k) {
/* 1551 */       Double2ByteAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       byte oldValue = Double2ByteAVLTreeMap.this.remove(k);
/* 1554 */       return Double2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1575 */       return Double2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap headMap(double to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Double2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap tailMap(double from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Double2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap subMap(double from, double to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Double2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Double2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Double2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Double2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Double2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Double2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Double2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ByteAVLTreeMap.Entry e;
/* 1627 */       if (Double2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Double2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Double2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Double2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Double2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1645 */       Double2ByteAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1652 */       Double2ByteAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Double2ByteAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Double2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Double2ByteAVLTreeMap.Submap.this.bottom && Double2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Double2ByteAVLTreeMap.Submap.this.top && Double2ByteAVLTreeMap.this.compare(k, (this.prev = Double2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Double2ByteAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Double2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Double2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Double2ByteAVLTreeMap.this.compare(this.prev.key, Double2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Double2ByteAVLTreeMap.Submap.this.top && this.next != null && Double2ByteAVLTreeMap.this.compare(this.next.key, Double2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Double2ByteMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Double2ByteAVLTreeMap)super.clone();
...
/* 1841 */       s.writeDouble(e.key);
/* 1842 */       s.writeByte(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readDouble(), s.readByte());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readDouble(), s.readByte());
/* 1866 */       entry.right(new Entry(s.readDouble(), s.readByte()));
...
/* 1877 */     top.key = s.readDouble();
/* 1878 */     top.value = s.readByte();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteAVLTreeMap.class
