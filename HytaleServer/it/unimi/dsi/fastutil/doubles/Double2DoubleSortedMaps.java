...
/*  61 */     return (entries instanceof Double2DoubleSortedMap.FastSortedEntrySet) ? ((Double2DoubleSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Double2DoubleMap.Entry> entries = map.double2DoubleEntrySet();
/*  77 */     Objects.requireNonNull((Double2DoubleSortedMap.FastSortedEntrySet)entries); return (entries instanceof Double2DoubleSortedMap.FastSortedEntrySet) ? (Double2DoubleSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Double2DoubleMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Double2DoubleMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Double, Double>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2DoubleSortedMap headMap(double to) {
/* 125 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2DoubleSortedMap tailMap(double from) {
/* 130 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Double2DoubleMap.Entry>)ObjectSortedSets.singleton(new AbstractDouble2DoubleMap.BasicEntry(this.key, this.value), Double2DoubleSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Double2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Double>> entrySet() {
/* 248 */       return (ObjectSortedSet)double2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 260 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2DoubleSortedMap headMap(double to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2DoubleSortedMap tailMap(double from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Double2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public double firstDoubleKey() {
...
/* 369 */     return new Singleton(key.doubleValue(), value.doubleValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Double2DoubleMaps.SynchronizedMap implements Double2DoubleSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Double2DoubleMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.double2DoubleEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Double2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Double>> entrySet() {
/* 440 */       return (ObjectSortedSet)double2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/*     */     extends Double2DoubleMaps.UnmodifiableMap implements Double2DoubleSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2DoubleSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Double2DoubleMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.double2DoubleEntrySet()); 
/* 581 */       return (ObjectSortedSet<Double2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleSortedMaps.class
