...
/*  885 */       Map.Entry<Double, Long> e = (Map.Entry<Double, Long>)o;
/*  886 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  891 */       return HashCommon.double2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Double2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  998 */       if ((this.next = Double2LongAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Double2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Double2LongAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2LongMap.Entry>)new AbstractObjectSortedSet<Double2LongMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Double2LongMap.Entry>)new Double2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Double2LongMap.Entry>)new Double2LongAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1135 */             Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1146 */             if (!(e.getValue() instanceof Long)) return false; 
/* 1147 */             Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1148 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1149 */             Double2LongAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Double2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Double2LongAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2LongMap.Entry first() {
/* 1165 */             return Double2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2LongMap.Entry last() {
/* 1170 */             return Double2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) {
/* 1175 */             return Double2LongAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) {
/* 1180 */             return Double2LongAVLTreeMap.this.headMap(to.getDoubleKey()).double2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) {
/* 1185 */             return Double2LongAVLTreeMap.this.tailMap(from.getDoubleKey()).double2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Double2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1227 */       return new Double2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1277 */     if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1280 */             return (LongIterator)new Double2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1285 */             return Double2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Double2LongAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Double2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Double2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Double2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Double2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2LongMap.Entry>)new AbstractObjectSortedSet<Double2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Double2LongMap.Entry>)new Double2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Double2LongMap.Entry>)new Double2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2LongMap.Entry> comparator() {
/* 1399 */               return Double2LongAVLTreeMap.this.double2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1409 */               Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1410 */               return (f != null && Double2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1420 */               Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1421 */               if (f != null && Double2LongAVLTreeMap.Submap.this.in(f.key)) Double2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Double2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Double2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Double2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2LongMap.Entry first() {
/* 1444 */               return Double2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2LongMap.Entry last() {
/* 1449 */               return Double2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) {
/* 1454 */               return Double2LongAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) {
/* 1459 */               return Double2LongAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) {
/* 1464 */               return Double2LongAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1473 */         return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1478 */         return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public LongCollection values() {
/* 1490 */       if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1493 */               return (LongIterator)new Double2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1498 */               return Double2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Double2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Double2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1518 */       return (in(k) && Double2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1526 */         long ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public long get(double k) {
/* 1536 */       double kk = k; Double2LongAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Double2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(double k, long v) {
/* 1542 */       Double2LongAVLTreeMap.this.modified = false;
...
/* 1544 */       long oldValue = Double2LongAVLTreeMap.this.put(k, v);
/* 1545 */       return Double2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(double k) {
/* 1551 */       Double2LongAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       long oldValue = Double2LongAVLTreeMap.this.remove(k);
/* 1554 */       return Double2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1575 */       return Double2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2LongSortedMap headMap(double to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Double2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2LongSortedMap tailMap(double from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Double2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2LongSortedMap subMap(double from, double to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Double2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Double2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Double2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Double2LongAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Double2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Double2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Double2LongAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2LongAVLTreeMap.Entry e;
/* 1627 */       if (Double2LongAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Double2LongAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Double2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Double2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Double2LongAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1645 */       Double2LongAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1652 */       Double2LongAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Double2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Double2LongAVLTreeMap.Submap.this.bottom && Double2LongAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Double2LongAVLTreeMap.Submap.this.top && Double2LongAVLTreeMap.this.compare(k, (this.prev = Double2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Double2LongAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Double2LongAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Double2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Double2LongAVLTreeMap.this.compare(this.prev.key, Double2LongAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Double2LongAVLTreeMap.Submap.this.top && this.next != null && Double2LongAVLTreeMap.this.compare(this.next.key, Double2LongAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Double2LongAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readDouble(), s.readLong());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readDouble(), s.readLong());
/* 1866 */       entry.right(new Entry(s.readDouble(), s.readLong()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2LongAVLTreeMap.class
