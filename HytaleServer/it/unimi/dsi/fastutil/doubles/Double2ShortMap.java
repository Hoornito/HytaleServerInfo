...
/* 150 */     return (ObjectSet)double2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = double2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Double.valueOf(entry.getDoubleKey()), Short.valueOf(entry.getShortValue()));
...
/* 502 */     Short newValue = remappingFunction.apply(Double.valueOf(key), Short.valueOf(oldValue));
...
/* 534 */     Short newValue = remappingFunction.apply(Double.valueOf(key), contained ? Short.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortMap.class
