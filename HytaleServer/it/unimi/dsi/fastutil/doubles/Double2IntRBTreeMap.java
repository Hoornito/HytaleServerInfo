...
/*  839 */       Map.Entry<Double, Integer> e = (Map.Entry<Double, Integer>)o;
/*  840 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Double2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  950 */       if ((this.next = Double2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Double2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Double2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2IntMap.Entry>)new AbstractObjectSortedSet<Double2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1076 */             if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1077 */             Double2IntRBTreeMap.Entry f = Double2IntRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1088 */             if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1089 */             Double2IntRBTreeMap.Entry f = Double2IntRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Double2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Double2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Double2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2IntMap.Entry first() {
/* 1107 */             return Double2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2IntMap.Entry last() {
/* 1112 */             return Double2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) {
/* 1117 */             return Double2IntRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) {
/* 1122 */             return Double2IntRBTreeMap.this.headMap(to.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) {
/* 1127 */             return Double2IntRBTreeMap.this.tailMap(from.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Double2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1169 */       return new Double2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1219 */     if (this.values == null) this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1222 */             return (IntIterator)new Double2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Double2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Double2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Double2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Double2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Double2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Double2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2IntMap.Entry>)new AbstractObjectSortedSet<Double2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2IntMap.Entry> comparator() {
/* 1341 */               return Double2IntRBTreeMap.this.double2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1350 */               if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1351 */               Double2IntRBTreeMap.Entry f = Double2IntRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1352 */               return (f != null && Double2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1361 */               if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1362 */               Double2IntRBTreeMap.Entry f = Double2IntRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1363 */               if (f != null && Double2IntRBTreeMap.Submap.this.in(f.key)) Double2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Double2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Double2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Double2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2IntMap.Entry first() {
/* 1386 */               return Double2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2IntMap.Entry last() {
/* 1391 */               return Double2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) {
/* 1396 */               return Double2IntRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) {
/* 1401 */               return Double2IntRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) {
/* 1406 */               return Double2IntRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2IntSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1415 */         return new Double2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1420 */         return new Double2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public IntCollection values() {
/* 1432 */       if (this.values == null) this.values = (IntCollection)new AbstractIntCollection()
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Double2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Double2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Double2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Double2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1460 */       return (in(k) && Double2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(double k) {
/* 1478 */       double kk = k; Double2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Double2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(double k, int v) {
/* 1484 */       Double2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Double2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Double2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(double k) {
/* 1493 */       Double2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Double2IntRBTreeMap.this.remove(k);
/* 1496 */       return Double2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1517 */       return Double2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap headMap(double to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Double2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap tailMap(double from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Double2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap subMap(double from, double to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Double2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Double2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Double2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Double2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Double2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Double2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Double2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2IntRBTreeMap.Entry e;
/* 1569 */       if (Double2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Double2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Double2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Double2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Double2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1587 */       Double2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1594 */       Double2IntRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Double2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Double2IntRBTreeMap.Submap.this.bottom && Double2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Double2IntRBTreeMap.Submap.this.top && Double2IntRBTreeMap.this.compare(k, (this.prev = Double2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Double2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Double2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Double2IntRBTreeMap.Submap.this.bottom && this.prev != null && Double2IntRBTreeMap.this.compare(this.prev.key, Double2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Double2IntRBTreeMap.Submap.this.top && this.next != null && Double2IntRBTreeMap.this.compare(this.next.key, Double2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Double2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Double2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readDouble(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readDouble(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readDouble(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntRBTreeMap.class
