...
/*  520 */     Short newValue = remappingFunction.apply(Double.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Short newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  612 */       return Double2ShortOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  617 */       return Double2ShortOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  622 */       return Double2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  627 */       return Double2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  632 */       short oldValue = Double2ShortOpenHashMap.this.value[this.index];
/*  633 */       Double2ShortOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleShortPair right(short v) {
/*  639 */       Double2ShortOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  651 */       return Double.valueOf(Double2ShortOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Short.valueOf(Double2ShortOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Double, Short> e = (Map.Entry<Double, Short>)o;
/*  681 */       return (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Double2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return HashCommon.double2int(Double2ShortOpenHashMap.this.key[this.index]) ^ Double2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Double2ShortOpenHashMap.this.key[this.index] + "=>" + Double2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Double2ShortOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Double2ShortOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Double2ShortOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Double2ShortOpenHashMap.this.n;
/*      */       } 
/*  733 */       double[] key = Double2ShortOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  739 */           int p = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ShortOpenHashMap.this.mask;
/*  740 */           for (; Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]); p = p + 1 & Double2ShortOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Double2ShortOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       double[] key = Double2ShortOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  759 */           int p = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ShortOpenHashMap.this.mask;
/*  760 */           for (; Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]); p = p + 1 & Double2ShortOpenHashMap.this.mask);
...
/*  780 */       double[] key = Double2ShortOpenHashMap.this.key; while (true) {
/*      */         double curr; int last;
/*  782 */         pos = (last = pos) + 1 & Double2ShortOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  785 */             key[last] = 0.0D;
/*      */             return;
/*      */           } 
/*  788 */           int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2ShortOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Double2ShortOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Double2ShortOpenHashMap.this.value[last] = Double2ShortOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Double2ShortOpenHashMap.this.n)
/*  804 */       { Double2ShortOpenHashMap.this.containsNullKey = false; }
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2ShortMap.Entry>> implements ObjectIterator<Double2ShortMap.Entry> { public Double2ShortOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Double2ShortOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Double2ShortOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Double2ShortOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Double2ShortOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Double2ShortOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Double2ShortOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       double[] key = Double2ShortOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Double2ShortOpenHashMap.this.n);
/*      */       } 
/*  915 */       double[] key = Double2ShortOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Double2ShortOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Double2ShortOpenHashMap.this.size - this.c), (long)(Double2ShortOpenHashMap.this.realSize() / Double2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       double[] key = Double2ShortOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Double2ShortMap.Entry> action, int index) {
/*  991 */       action.accept(new Double2ShortOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Double2ShortOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Double2ShortMap.Entry> fastIterator() {
/* 1008 */       return new Double2ShortOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Double2ShortMap.Entry> spliterator() {
/* 1013 */       return new Double2ShortOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (Double.doubleToLongBits(k) == 0L) return (Double2ShortOpenHashMap.this.containsNullKey && Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n] == v);
/*      */       
/* 1028 */       double[] key = Double2ShortOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1031 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ShortOpenHashMap.this.mask]) == 0L) return false; 
/* 1032 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Double2ShortOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1035 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ShortOpenHashMap.this.mask]) == 0L) return false; 
/* 1036 */         if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Double2ShortOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1050 */         if (Double2ShortOpenHashMap.this.containsNullKey && Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n] == v) {
/* 1051 */           Double2ShortOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       double[] key = Double2ShortOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1060 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ShortOpenHashMap.this.mask]) == 0L) return false; 
/* 1061 */       if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
/* 1062 */         if (Double2ShortOpenHashMap.this.value[pos] == v) {
/* 1063 */           Double2ShortOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ShortOpenHashMap.this.mask]) == 0L) return false; 
/* 1070 */         if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) && 
/* 1071 */           Double2ShortOpenHashMap.this.value[pos] == v) {
/* 1072 */           Double2ShortOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Double2ShortOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Double2ShortOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2ShortMap.Entry> consumer) {
/* 1092 */       if (Double2ShortOpenHashMap.this.containsNullKey) consumer.accept(new Double2ShortOpenHashMap.MapEntry(Double2ShortOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Double2ShortOpenHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) consumer.accept(new Double2ShortOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Double2ShortMap.Entry> consumer) {
/* 1099 */       Double2ShortOpenHashMap.MapEntry entry = new Double2ShortOpenHashMap.MapEntry();
/* 1100 */       if (Double2ShortOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Double2ShortOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Double2ShortOpenHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) {
...
/* 1135 */       action.accept(Double2ShortOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1140 */       return Double2ShortOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1161 */       action.accept(Double2ShortOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Double2ShortOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleSpliterator spliterator() {
/* 1178 */       return new Double2ShortOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1184 */       if (Double2ShortOpenHashMap.this.containsNullKey) consumer.accept(Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Double2ShortOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         double k = Double2ShortOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Double2ShortOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1198 */       return Double2ShortOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1203 */       int oldSize = Double2ShortOpenHashMap.this.size;
/* 1204 */       Double2ShortOpenHashMap.this.remove(k);
/* 1205 */       return (Double2ShortOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Double2ShortOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Double2ShortOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1243 */       return Double2ShortOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1264 */       action.accept(Double2ShortOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Double2ShortOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ShortSpliterator spliterator() {
/* 1283 */             return new Double2ShortOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1289 */             if (Double2ShortOpenHashMap.this.containsNullKey) consumer.accept(Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Double2ShortOpenHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) consumer.accept(Double2ShortOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Double2ShortOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1300 */             return Double2ShortOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Double2ShortOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Double2ShortOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortOpenHashMap.class
