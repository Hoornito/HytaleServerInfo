...
/*  61 */     return (entries instanceof Double2BooleanSortedMap.FastSortedEntrySet) ? ((Double2BooleanSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Double2BooleanMap.Entry> entries = map.double2BooleanEntrySet();
/*  77 */     Objects.requireNonNull((Double2BooleanSortedMap.FastSortedEntrySet)entries); return (entries instanceof Double2BooleanSortedMap.FastSortedEntrySet) ? (Double2BooleanSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Double2BooleanMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Double2BooleanMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Double, Boolean>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2BooleanSortedMap headMap(double to) {
/* 125 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2BooleanSortedMap tailMap(double from) {
/* 130 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Double2BooleanMap.Entry>)ObjectSortedSets.singleton(new AbstractDouble2BooleanMap.BasicEntry(this.key, this.value), Double2BooleanSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Double2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Boolean>> entrySet() {
/* 248 */       return (ObjectSortedSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 260 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2BooleanSortedMap headMap(double to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2BooleanSortedMap tailMap(double from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Double2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public double firstDoubleKey() {
...
/* 369 */     return new Singleton(key.doubleValue(), value.booleanValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Double2BooleanMaps.SynchronizedMap implements Double2BooleanSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Double2BooleanMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.double2BooleanEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Double2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Boolean>> entrySet() {
/* 440 */       return (ObjectSortedSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/*     */     extends Double2BooleanMaps.UnmodifiableMap implements Double2BooleanSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2BooleanSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Double2BooleanMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.double2BooleanEntrySet()); 
/* 581 */       return (ObjectSortedSet<Double2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Boolean>> entrySet() {
/* 593 */       return (ObjectSortedSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanSortedMaps.class
