...
/*  46 */     assert i < size;
/*  47 */     int e = heap[i];
/*  48 */     double E = refArray[e];
/*     */     
/*  50 */     if (c == null) { int child; while ((child = (i << 1) + 1) < size) {
/*  51 */         int t = heap[child];
/*  52 */         int right = child + 1;
/*  53 */         if (right < size && Double.compare(refArray[heap[right]], refArray[t]) < 0) t = heap[child = right]; 
/*  54 */         if (Double.compare(E, refArray[t]) <= 0)
/*  55 */           break;  heap[i] = t;
/*  56 */         inv[heap[i]] = i;
/*  57 */         i = child;
/*     */       }  }
...
/*  88 */     assert i < size;
/*  89 */     int e = heap[i];
/*  90 */     double E = refArray[e];
/*  91 */     if (c == null) { while (i != 0) {
/*  92 */         int parent = i - 1 >>> 1;
/*  93 */         int t = heap[parent];
/*  94 */         if (Double.compare(refArray[t], E) <= 0)
/*  95 */           break;  heap[i] = t;
/*  96 */         inv[heap[i]] = i;
/*  97 */         i = parent;
/*     */       }  }
...
/* 123 */     DoubleArrays.ensureOffsetLength(refArray, offset, length);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\DoubleIndirectHeaps.class
