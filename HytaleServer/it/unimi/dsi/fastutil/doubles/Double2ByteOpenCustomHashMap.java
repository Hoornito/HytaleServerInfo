...
/*  543 */     Byte newValue = remappingFunction.apply(Double.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Byte newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  635 */       return Double2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  640 */       return Double2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  645 */       return Double2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  650 */       return Double2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  655 */       byte oldValue = Double2ByteOpenCustomHashMap.this.value[this.index];
/*  656 */       Double2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBytePair right(byte v) {
/*  662 */       Double2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Double.valueOf(Double2ByteOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Byte.valueOf(Double2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Double, Byte> e = (Map.Entry<Double, Byte>)o;
/*  704 */       return (Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[this.index], ((Double)e.getKey()).doubleValue()) && Double2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Double2ByteOpenCustomHashMap.this.strategy.hashCode(Double2ByteOpenCustomHashMap.this.key[this.index]) ^ Double2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Double2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Double2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Double2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Double2ByteOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Double2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Double2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Double2ByteOpenCustomHashMap.this.mask;
/*  763 */           for (; !Double2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2ByteOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Double2ByteOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Double2ByteOpenCustomHashMap.this.mask;
/*  783 */           for (; !Double2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2ByteOpenCustomHashMap.this.mask);
...
/*  803 */       double[] key = Double2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         double curr; int last;
/*  805 */         pos = (last = pos) + 1 & Double2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  808 */             key[last] = 0.0D;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Double2ByteOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Double2ByteOpenCustomHashMap.this.value[last] = Double2ByteOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Double2ByteOpenCustomHashMap.this.n)
/*  827 */       { Double2ByteOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Double2ByteOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Double2ByteOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2ByteMap.Entry>> implements ObjectIterator<Double2ByteMap.Entry> { public Double2ByteOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Double2ByteOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Double2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Double2ByteOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Double2ByteOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Double2ByteOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Double2ByteOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Double2ByteOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Double2ByteOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Double2ByteOpenCustomHashMap.this.size - this.c), (long)(Double2ByteOpenCustomHashMap.this.realSize() / Double2ByteOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Double2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2ByteMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Double2ByteMap.Entry> action, int index) {
/* 1014 */       action.accept(new Double2ByteOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Double2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Double2ByteMap.Entry> fastIterator() {
/* 1031 */       return new Double2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Double2ByteMap.Entry> spliterator() {
/* 1036 */       return new Double2ByteOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Double2ByteOpenCustomHashMap.this.strategy.equals(k, 0.0D)) return (Double2ByteOpenCustomHashMap.this.containsNullKey && Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1054 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Double2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1055 */       if (Double2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1059 */         if (Double2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Double2ByteOpenCustomHashMap.this.strategy.equals(k, 0.0D)) {
/* 1073 */         if (Double2ByteOpenCustomHashMap.this.containsNullKey && Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n] == v) {
/* 1074 */           Double2ByteOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       double[] key = Double2ByteOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1083 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Double2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1084 */       if (Double2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Double2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Double2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1093 */         if (Double2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Double2ByteOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Double2ByteOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Double2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Double2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
/* 1115 */       if (Double2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(new Double2ByteOpenCustomHashMap.MapEntry(Double2ByteOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Double2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(new Double2ByteOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
/* 1122 */       Double2ByteOpenCustomHashMap.MapEntry entry = new Double2ByteOpenCustomHashMap.MapEntry();
/* 1123 */       if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Double2ByteOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Double2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[pos]) != 0L) {
...
/* 1158 */       action.accept(Double2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1163 */       return Double2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1184 */       action.accept(Double2ByteOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Double2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleSpliterator spliterator() {
/* 1201 */       return new Double2ByteOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1207 */       if (Double2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2ByteOpenCustomHashMap.this.key[Double2ByteOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Double2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         double k = Double2ByteOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Double2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1221 */       return Double2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1226 */       int oldSize = Double2ByteOpenCustomHashMap.this.size;
/* 1227 */       Double2ByteOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Double2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Double2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Double2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1266 */       return Double2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1287 */       action.accept(Double2ByteOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Double2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1306 */             return new Double2ByteOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1312 */             if (Double2ByteOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Double2ByteOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(Double2ByteOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Double2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1323 */             return Double2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Double2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Double2ByteOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteOpenCustomHashMap.class
