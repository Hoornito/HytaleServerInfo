...
/*  839 */       Map.Entry<Double, Byte> e = (Map.Entry<Double, Byte>)o;
/*  840 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Double2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  950 */       if ((this.next = Double2ByteRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Double2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Double2ByteRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ByteMap.Entry>)new AbstractObjectSortedSet<Double2ByteMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1089 */             Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1090 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1091 */             Double2ByteRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Double2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Double2ByteRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ByteMap.Entry first() {
/* 1107 */             return Double2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ByteMap.Entry last() {
/* 1112 */             return Double2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) {
/* 1117 */             return Double2ByteRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) {
/* 1122 */             return Double2ByteRBTreeMap.this.headMap(to.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) {
/* 1127 */             return Double2ByteRBTreeMap.this.tailMap(from.getDoubleKey()).double2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Double2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1169 */       return new Double2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (ByteIterator)new Double2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1227 */             return Double2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Double2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Double2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Double2ByteRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Double2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Double2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ByteRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ByteMap.Entry>)new AbstractObjectSortedSet<Double2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Double2ByteMap.Entry>)new Double2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ByteMap.Entry> comparator() {
/* 1341 */               return Double2ByteRBTreeMap.this.double2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1352 */               return (f != null && Double2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1363 */               if (f != null && Double2ByteRBTreeMap.Submap.this.in(f.key)) Double2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Double2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Double2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Double2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ByteMap.Entry first() {
/* 1386 */               return Double2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ByteMap.Entry last() {
/* 1391 */               return Double2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) {
/* 1396 */               return Double2ByteRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) {
/* 1401 */               return Double2ByteRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) {
/* 1406 */               return Double2ByteRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1415 */         return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1420 */         return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1435 */               return (ByteIterator)new Double2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1440 */               return Double2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Double2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Double2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1460 */       return (in(k) && Double2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(double k) {
/* 1478 */       double kk = k; Double2ByteRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Double2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(double k, byte v) {
/* 1484 */       Double2ByteRBTreeMap.this.modified = false;
...
/* 1486 */       byte oldValue = Double2ByteRBTreeMap.this.put(k, v);
/* 1487 */       return Double2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(double k) {
/* 1493 */       Double2ByteRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       byte oldValue = Double2ByteRBTreeMap.this.remove(k);
/* 1496 */       return Double2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1517 */       return Double2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap headMap(double to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Double2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap tailMap(double from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Double2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ByteSortedMap subMap(double from, double to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Double2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Double2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Double2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Double2ByteRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Double2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Double2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Double2ByteRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ByteRBTreeMap.Entry e;
/* 1569 */       if (Double2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Double2ByteRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Double2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Double2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Double2ByteRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1587 */       Double2ByteRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1594 */       Double2ByteRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Double2ByteRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Double2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Double2ByteRBTreeMap.Submap.this.bottom && Double2ByteRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Double2ByteRBTreeMap.Submap.this.top && Double2ByteRBTreeMap.this.compare(k, (this.prev = Double2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Double2ByteRBTreeMap.this.locateKey(k);
/* 1620 */             if (Double2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Double2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Double2ByteRBTreeMap.this.compare(this.prev.key, Double2ByteRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Double2ByteRBTreeMap.Submap.this.top && this.next != null && Double2ByteRBTreeMap.this.compare(this.next.key, Double2ByteRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Double2ByteRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readDouble(), s.readByte());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readDouble(), s.readByte());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readDouble(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteRBTreeMap.class
