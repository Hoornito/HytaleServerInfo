...
/*     */ 
/*     */     
/*  64 */     this.array = new double[Math.max(1, capacity + 1)];
...
/*  86 */     double t = this.array[this.start];
...
/* 101 */     double t = this.array[--this.end];
/* 102 */     reduce();
/* 103 */     return t;
/*     */   }
/*     */   
/*     */   private final void resize(int size, int newLength) {
/* 107 */     double[] newArray = new double[newLength];
...
/*     */   public void trim() {
/* 167 */     int size = size();
/* 168 */     double[] newArray = new double[size + 1];
...
/* 190 */       s.writeDouble(this.array[i++]);
...
/* 198 */     this.array = new double[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 199 */     for (int i = 0; i < this.end; ) { this.array[i] = s.readDouble(); i++; }
/*     */   
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\DoubleArrayFIFOQueue.class
