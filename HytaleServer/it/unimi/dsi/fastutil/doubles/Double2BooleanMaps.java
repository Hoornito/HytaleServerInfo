...
/*  50 */     return (entries instanceof Double2BooleanMap.FastEntrySet) ? ((Double2BooleanMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Double2BooleanMap.Entry> entries = map.double2BooleanEntrySet();
/*  66 */     if (entries instanceof Double2BooleanMap.FastEntrySet) { ((Double2BooleanMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Double2BooleanMap.Entry> entries = map.double2BooleanEntrySet();
/*  83 */     return (entries instanceof Double2BooleanMap.FastEntrySet) ? new ObjectIterable<Double2BooleanMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Double2BooleanMap.Entry> iterator() {
/*  86 */           return ((Double2BooleanMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Double2BooleanMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Double2BooleanMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractDouble2BooleanMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */     
/*     */     public int hashCode() {
/* 271 */       return HashCommon.double2int(this.key) ^ (this.value ? 1231 : 1237);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */   
/*     */   public static Double2BooleanMap singleton(Double key, Boolean value) {
/* 316 */     return new Singleton(key.doubleValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Double2BooleanFunctions.SynchronizedFunction implements Double2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.double2BooleanEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Boolean>> entrySet() {
/* 381 */       return (ObjectSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */     extends Double2BooleanFunctions.UnmodifiableFunction implements Double2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2BooleanMap map;
/*     */     protected transient ObjectSet<Double2BooleanMap.Entry> entries;
/*     */     protected transient DoubleSet keys;
...
/*     */     
/*     */     public ObjectSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.double2BooleanEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Boolean>> entrySet() {
/* 712 */       return (ObjectSet)double2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanMaps.class
