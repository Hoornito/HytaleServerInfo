...
/* 164 */     return (ObjectSet)double2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 256 */     ObjectSet<Entry<V>> entrySet = double2ReferenceEntrySet();
/* 257 */     Consumer<Entry<V>> wrappingConsumer = entry -> consumer.accept(Double.valueOf(entry.getDoubleKey()), entry.getValue());
...
/*     */ 
/*     */   
/*     */   default V computeIfAbsent(double key, Double2ReferenceFunction<? extends V> mappingFunction) {
...
/* 468 */     V newValue = remappingFunction.apply(Double.valueOf(key), oldValue);
...
/* 499 */     V newValue = remappingFunction.apply(Double.valueOf(key), contained ? oldValue : null);
...
/* 568 */       return Double.valueOf(getDoubleKey());
/*     */     }
/*     */     
/*     */     double getDoubleKey();
/*     */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceMap.class
