...
/*  885 */       Map.Entry<Double, Character> e = (Map.Entry<Double, Character>)o;
/*  886 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Double2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  998 */       if ((this.next = Double2CharAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Double2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Double2CharAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1135 */             Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1146 */             if (!(e.getValue() instanceof Character)) return false; 
/* 1147 */             Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1148 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1149 */             Double2CharAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Double2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Double2CharAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2CharMap.Entry first() {
/* 1165 */             return Double2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2CharMap.Entry last() {
/* 1170 */             return Double2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1175 */             return Double2CharAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1180 */             return Double2CharAVLTreeMap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1185 */             return Double2CharAVLTreeMap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Double2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1227 */       return new Double2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1277 */     if (this.values == null) this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1280 */             return (CharIterator)new Double2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1285 */             return Double2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Double2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Double2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Double2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Double2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Double2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2CharAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2CharMap.Entry> comparator() {
/* 1399 */               return Double2CharAVLTreeMap.this.double2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1409 */               Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1410 */               return (f != null && Double2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1420 */               Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1421 */               if (f != null && Double2CharAVLTreeMap.Submap.this.in(f.key)) Double2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Double2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Double2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Double2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2CharMap.Entry first() {
/* 1444 */               return Double2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2CharMap.Entry last() {
/* 1449 */               return Double2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1454 */               return Double2CharAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1459 */               return Double2CharAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1464 */               return Double2CharAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2CharSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1473 */         return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1478 */         return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public CharCollection values() {
/* 1490 */       if (this.values == null) this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1493 */               return (CharIterator)new Double2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1498 */               return Double2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Double2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Double2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1518 */       return (in(k) && Double2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1526 */         char ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public char get(double k) {
/* 1536 */       double kk = k; Double2CharAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Double2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(double k, char v) {
/* 1542 */       Double2CharAVLTreeMap.this.modified = false;
...
/* 1544 */       char oldValue = Double2CharAVLTreeMap.this.put(k, v);
/* 1545 */       return Double2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(double k) {
/* 1551 */       Double2CharAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       char oldValue = Double2CharAVLTreeMap.this.remove(k);
/* 1554 */       return Double2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1575 */       return Double2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2CharSortedMap headMap(double to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Double2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2CharSortedMap tailMap(double from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Double2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2CharSortedMap subMap(double from, double to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Double2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Double2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Double2CharAVLTreeMap.Entry e;
/* 1605 */       if (Double2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Double2CharAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Double2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Double2CharAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Double2CharAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2CharAVLTreeMap.Entry e;
/* 1627 */       if (Double2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Double2CharAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Double2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Double2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Double2CharAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1645 */       Double2CharAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1652 */       Double2CharAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Double2CharAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Double2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Double2CharAVLTreeMap.Submap.this.bottom && Double2CharAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Double2CharAVLTreeMap.Submap.this.top && Double2CharAVLTreeMap.this.compare(k, (this.prev = Double2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Double2CharAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Double2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Double2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Double2CharAVLTreeMap.this.compare(this.prev.key, Double2CharAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Double2CharAVLTreeMap.Submap.this.top && this.next != null && Double2CharAVLTreeMap.this.compare(this.next.key, Double2CharAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Double2CharMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Double2CharAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readDouble(), s.readChar());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readDouble(), s.readChar());
/* 1866 */       entry.right(new Entry(s.readDouble(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharAVLTreeMap.class
