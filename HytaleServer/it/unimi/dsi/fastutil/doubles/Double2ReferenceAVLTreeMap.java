...
/*  165 */     this(k, v, (Comparator<? super Double>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  191 */     return (this.actualComparator == null) ? Double.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  864 */       Map.Entry<Double, V> e = (Map.Entry<Double, V>)o;
/*  865 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  870 */       return HashCommon.double2int(this.key) ^ ((this.value == null) ? 0 : System.identityHashCode(this.value));
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Double2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  977 */       if ((this.next = Double2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Double2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Double2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Double2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>>)new Double2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>>)new Double2ReferenceAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1112 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1113 */             Double2ReferenceAVLTreeMap.Entry<V> f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1123 */             if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1124 */             Double2ReferenceAVLTreeMap.Entry<V> f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1125 */             if (f == null || f.getValue() != e.getValue()) return false; 
/* 1126 */             Double2ReferenceAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Double2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Double2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ReferenceMap.Entry<V> first() {
/* 1142 */             return Double2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ReferenceMap.Entry<V> last() {
/* 1147 */             return Double2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
...
/* 1152 */             return Double2ReferenceAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> to) {
/* 1157 */             return Double2ReferenceAVLTreeMap.this.headMap(to.getDoubleKey()).double2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from) {
/* 1162 */             return Double2ReferenceAVLTreeMap.this.tailMap(from.getDoubleKey()).double2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Double2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1204 */       return new Double2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Double2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Double2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Double2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Double2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Double2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Double2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Double2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ReferenceAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Double2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>>)new Double2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>>)new Double2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ReferenceMap.Entry<V>> comparator() {
/* 1376 */               return Double2ReferenceAVLTreeMap.this.double2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1384 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1385 */               Double2ReferenceAVLTreeMap.Entry<V> f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1386 */               return (f != null && Double2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1394 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1395 */               Double2ReferenceAVLTreeMap.Entry<V> f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1396 */               if (f != null && Double2ReferenceAVLTreeMap.Submap.this.in(f.key)) Double2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Double2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Double2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ReferenceMap.Entry<V> first() {
/* 1419 */               return Double2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ReferenceMap.Entry<V> last() {
/* 1424 */               return Double2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ReferenceMap.Entry<V>> subSet(Double2ReferenceMap.Entry<V> from, Double2ReferenceMap.Entry<V> to) {
/* 1429 */               return Double2ReferenceAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> to) {
/* 1434 */               return Double2ReferenceAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from) {
/* 1439 */               return Double2ReferenceAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ReferenceEntrySet();
/*      */             }
/*      */           }; 
/* 1442 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2ReferenceSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1448 */         return new Double2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1453 */         return new Double2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Double2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Double2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Double2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Double2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1493 */       return (in(k) && Double2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(double k) {
/* 1511 */       double kk = k; Double2ReferenceAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Double2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(double k, V v) {
/* 1517 */       Double2ReferenceAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Double2ReferenceAVLTreeMap.this.put(k, v);
/* 1520 */       return Double2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(double k) {
/* 1526 */       Double2ReferenceAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Double2ReferenceAVLTreeMap.this.remove(k);
/* 1529 */       return Double2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1550 */       return Double2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceSortedMap<V> headMap(double to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Double2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceSortedMap<V> tailMap(double from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Double2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceSortedMap<V> subMap(double from, double to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Double2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Double2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Double2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Double2ReferenceAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Double2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Double2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Double2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ReferenceAVLTreeMap.Entry<V> e;
/* 1602 */       if (Double2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Double2ReferenceAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Double2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Double2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Double2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1620 */       Double2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1627 */       Double2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Double2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Double2ReferenceAVLTreeMap.Submap.this.bottom && Double2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Double2ReferenceAVLTreeMap.Submap.this.top && Double2ReferenceAVLTreeMap.this.compare(k, (this.prev = Double2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Double2ReferenceAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Double2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Double2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Double2ReferenceAVLTreeMap.this.compare(this.prev.key, Double2ReferenceAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Double2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Double2ReferenceAVLTreeMap.this.compare(this.next.key, Double2ReferenceAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Double2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1831 */     if (n == 1) {
/* 1832 */       Entry<V> entry = new Entry<>(s.readDouble(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1840 */       Entry<V> entry = new Entry<>(s.readDouble(), (V)s.readObject());
/* 1841 */       entry.right(new Entry<>(s.readDouble(), (V)s.readObject()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceAVLTreeMap.class
