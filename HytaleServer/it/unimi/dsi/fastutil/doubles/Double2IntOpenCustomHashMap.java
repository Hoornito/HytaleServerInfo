...
/*  542 */     Integer newValue = remappingFunction.apply(Double.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Integer newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*  634 */       return Double2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  639 */       return Double2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  644 */       return Double2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  649 */       return Double2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  654 */       int oldValue = Double2IntOpenCustomHashMap.this.value[this.index];
/*  655 */       Double2IntOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleIntPair right(int v) {
/*  661 */       Double2IntOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Double.valueOf(Double2IntOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Integer.valueOf(Double2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       return (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[this.index], ((Double)e.getKey()).doubleValue()) && Double2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Double2IntOpenCustomHashMap.this.strategy.hashCode(Double2IntOpenCustomHashMap.this.key[this.index]) ^ Double2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Double2IntOpenCustomHashMap.this.key[this.index] + "=>" + Double2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Double2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Double2IntOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Double2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Double2IntOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       double[] key = Double2IntOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask;
/*  762 */           for (; !Double2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2IntOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Double2IntOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       double[] key = Double2IntOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask;
/*  782 */           for (; !Double2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2IntOpenCustomHashMap.this.mask);
...
/*  802 */       double[] key = Double2IntOpenCustomHashMap.this.key; while (true) {
/*      */         double curr; int last;
/*  804 */         pos = (last = pos) + 1 & Double2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  807 */             key[last] = 0.0D;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Double2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Double2IntOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Double2IntOpenCustomHashMap.this.value[last] = Double2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Double2IntOpenCustomHashMap.this.n)
/*  826 */       { Double2IntOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Double2IntOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Double2IntOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2IntMap.Entry>> implements ObjectIterator<Double2IntMap.Entry> { public Double2IntOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Double2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Double2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Double2IntOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Double2IntOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Double2IntOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Double2IntOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       double[] key = Double2IntOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Double2IntOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       double[] key = Double2IntOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Double2IntOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Double2IntOpenCustomHashMap.this.size - this.c), (long)(Double2IntOpenCustomHashMap.this.realSize() / Double2IntOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       double[] key = Double2IntOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Double2IntMap.Entry> action, int index) {
/* 1013 */       action.accept(new Double2IntOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Double2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Double2IntMap.Entry> fastIterator() {
/* 1030 */       return new Double2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Double2IntMap.Entry> spliterator() {
/* 1035 */       return new Double2IntOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Double2IntOpenCustomHashMap.this.strategy.equals(k, 0.0D)) return (Double2IntOpenCustomHashMap.this.containsNullKey && Double2IntOpenCustomHashMap.this.value[Double2IntOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       double[] key = Double2IntOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1053 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1054 */       if (Double2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1058 */         if (Double2IntOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Double2IntOpenCustomHashMap.this.strategy.equals(k, 0.0D)) {
/* 1072 */         if (Double2IntOpenCustomHashMap.this.containsNullKey && Double2IntOpenCustomHashMap.this.value[Double2IntOpenCustomHashMap.this.n] == v) {
/* 1073 */           Double2IntOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       double[] key = Double2IntOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1082 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1083 */       if (Double2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Double2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1092 */         if (Double2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double2IntOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Double2IntOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Double2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Double2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2IntMap.Entry> consumer) {
/* 1114 */       if (Double2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(new Double2IntOpenCustomHashMap.MapEntry(Double2IntOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Double2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2IntOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(new Double2IntOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Double2IntMap.Entry> consumer) {
/* 1121 */       Double2IntOpenCustomHashMap.MapEntry entry = new Double2IntOpenCustomHashMap.MapEntry();
/* 1122 */       if (Double2IntOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Double2IntOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Double2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2IntOpenCustomHashMap.this.key[pos]) != 0L) {
...
/* 1157 */       action.accept(Double2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1162 */       return Double2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1183 */       action.accept(Double2IntOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Double2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleSpliterator spliterator() {
/* 1200 */       return new Double2IntOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1206 */       if (Double2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2IntOpenCustomHashMap.this.key[Double2IntOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Double2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         double k = Double2IntOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Double2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1220 */       return Double2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1225 */       int oldSize = Double2IntOpenCustomHashMap.this.size;
/* 1226 */       Double2IntOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Double2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Double2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Double2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1265 */       return Double2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1286 */       action.accept(Double2IntOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Double2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1305 */             return new Double2IntOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1311 */             if (Double2IntOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2IntOpenCustomHashMap.this.value[Double2IntOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Double2IntOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2IntOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(Double2IntOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Double2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1322 */             return Double2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Double2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Double2IntOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntOpenCustomHashMap.class
