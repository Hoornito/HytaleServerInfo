...
/*  94 */     this(m.size());
/*  95 */     int i = 0;
/*  96 */     for (ObjectIterator<Double2FloatMap.Entry> objectIterator = m.double2FloatEntrySet().iterator(); objectIterator.hasNext(); ) { Double2FloatMap.Entry e = objectIterator.next();
...
/* 110 */     this(m.size());
/* 111 */     int i = 0;
/* 112 */     for (Map.Entry<? extends Double, ? extends Float> e : m.entrySet()) {
...
/* 145 */       return new ObjectIterator<Double2FloatMap.Entry>() {
/* 146 */           int curr = -1; int next = 0;
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 150 */             return (this.next < Double2FloatArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 157 */             return new AbstractDouble2FloatMap.BasicEntry(Double2FloatArrayMap.this.key[this.curr = this.next], Double2FloatArrayMap.this.value[this.next++]);
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
...
/* 163 */             this.curr = -1;
/* 164 */             int tail = Double2FloatArrayMap.this.size-- - this.next--;
/* 165 */             System.arraycopy(Double2FloatArrayMap.this.key, this.next + 1, Double2FloatArrayMap.this.key, this.next, tail);
/* 166 */             System.arraycopy(Double2FloatArrayMap.this.value, this.next + 1, Double2FloatArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
...
/* 173 */             int max = Double2FloatArrayMap.this.size;
/* 174 */             while (this.next < max) {
/* 175 */               action.accept(new AbstractDouble2FloatMap.BasicEntry(Double2FloatArrayMap.this.key[this.curr = this.next], Double2FloatArrayMap.this.value[this.next++]));
/*     */             }
/*     */           }
/*     */         };
/*     */     }
...
/* 183 */       return new ObjectIterator<Double2FloatMap.Entry>() {
/* 184 */           int next = 0; int curr = -1;
/* 185 */           final AbstractDouble2FloatMap.BasicEntry entry = new AbstractDouble2FloatMap.BasicEntry();
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 189 */             return (this.next < Double2FloatArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 196 */             this.entry.key = Double2FloatArrayMap.this.key[this.curr = this.next];
/* 197 */             this.entry.value = Double2FloatArrayMap.this.value[this.next++];
...
/* 204 */             this.curr = -1;
/* 205 */             int tail = Double2FloatArrayMap.this.size-- - this.next--;
/* 206 */             System.arraycopy(Double2FloatArrayMap.this.key, this.next + 1, Double2FloatArrayMap.this.key, this.next, tail);
/* 207 */             System.arraycopy(Double2FloatArrayMap.this.value, this.next + 1, Double2FloatArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           public void forEachRemaining(Consumer<? super Double2FloatMap.Entry> action) {
/* 214 */             int max = Double2FloatArrayMap.this.size;
/* 215 */             while (this.next < max) {
/* 216 */               this.entry.key = Double2FloatArrayMap.this.key[this.curr = this.next];
/* 217 */               this.entry.value = Double2FloatArrayMap.this.value[this.next++];
...
/* 239 */         return new AbstractDouble2FloatMap.BasicEntry(Double2FloatArrayMap.this.key[location], Double2FloatArrayMap.this.value[location]);
/*     */       }
/*     */ 
/*     */       
...
/* 250 */       return new EntrySetSpliterator(0, Double2FloatArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 258 */       for (int i = 0, max = Double2FloatArrayMap.this.size; i < max; i++) {
/* 259 */         action.accept(new AbstractDouble2FloatMap.BasicEntry(Double2FloatArrayMap.this.key[i], Double2FloatArrayMap.this.value[i]));
/*     */       }
/*     */     }
/*     */ 
/*     */ 
...
/* 267 */       AbstractDouble2FloatMap.BasicEntry entry = new AbstractDouble2FloatMap.BasicEntry();
/*     */       
/* 269 */       for (int i = 0, max = Double2FloatArrayMap.this.size; i < max; i++) {
/* 270 */         entry.key = Double2FloatArrayMap.this.key[i];
/* 271 */         entry.value = Double2FloatArrayMap.this.value[i];
...
/*     */     
/*     */     public int size() {
/* 278 */       return Double2FloatArrayMap.this.size;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 289 */       return (Double2FloatArrayMap.this.containsKey(k) && Float.floatToIntBits(Double2FloatArrayMap.this.get(k)) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 301 */       int oldPos = Double2FloatArrayMap.this.findKey(k);
/* 302 */       if (oldPos == -1 || Float.floatToIntBits(v) != Float.floatToIntBits(Double2FloatArrayMap.this.value[oldPos])) return false; 
/* 303 */       int tail = Double2FloatArrayMap.this.size - oldPos - 1;
/* 304 */       System.arraycopy(Double2FloatArrayMap.this.key, oldPos + 1, Double2FloatArrayMap.this.key, oldPos, tail);
/* 305 */       System.arraycopy(Double2FloatArrayMap.this.value, oldPos + 1, Double2FloatArrayMap.this.value, oldPos, tail);
/* 306 */       Double2FloatArrayMap.this.size--;
/* 307 */       return true;
/*     */     }
/*     */   }
/*     */ 
...
/* 398 */       return (Double2FloatArrayMap.this.findKey(k) != -1);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean remove(double k) {
/* 403 */       int oldPos = Double2FloatArrayMap.this.findKey(k);
/* 404 */       if (oldPos == -1) return false; 
/* 405 */       int tail = Double2FloatArrayMap.this.size - oldPos - 1;
/* 406 */       System.arraycopy(Double2FloatArrayMap.this.key, oldPos + 1, Double2FloatArrayMap.this.key, oldPos, tail);
/* 407 */       System.arraycopy(Double2FloatArrayMap.this.value, oldPos + 1, Double2FloatArrayMap.this.value, oldPos, tail);
/* 408 */       Double2FloatArrayMap.this.size--;
/* 409 */       return true;
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 419 */             return (this.pos < Double2FloatArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 426 */             return Double2FloatArrayMap.this.key[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 431 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 432 */             int tail = Double2FloatArrayMap.this.size - this.pos;
/* 433 */             System.arraycopy(Double2FloatArrayMap.this.key, this.pos, Double2FloatArrayMap.this.key, this.pos - 1, tail);
/* 434 */             System.arraycopy(Double2FloatArrayMap.this.value, this.pos, Double2FloatArrayMap.this.value, this.pos - 1, tail);
/* 435 */             Double2FloatArrayMap.this.size--;
/* 436 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 443 */             int max = Double2FloatArrayMap.this.size;
/* 444 */             while (this.pos < max)
/* 445 */               action.accept(Double2FloatArrayMap.this.key[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 465 */         return Double2FloatArrayMap.this.key[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(DoubleConsumer action) {
/* 477 */         int max = Double2FloatArrayMap.this.size;
/* 478 */         while (this.pos < max) {
/* 479 */           action.accept(Double2FloatArrayMap.this.key[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 486 */       return new KeySetSpliterator(0, Double2FloatArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 493 */       for (int i = 0, max = Double2FloatArrayMap.this.size; i < max; i++) {
/* 494 */         action.accept(Double2FloatArrayMap.this.key[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 500 */       return Double2FloatArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 505 */       Double2FloatArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/* 518 */       return Double2FloatArrayMap.this.containsValue(v);
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 528 */             return (this.pos < Double2FloatArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 535 */             return Double2FloatArrayMap.this.value[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 540 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 541 */             int tail = Double2FloatArrayMap.this.size - this.pos;
/* 542 */             System.arraycopy(Double2FloatArrayMap.this.key, this.pos, Double2FloatArrayMap.this.key, this.pos - 1, tail);
/* 543 */             System.arraycopy(Double2FloatArrayMap.this.value, this.pos, Double2FloatArrayMap.this.value, this.pos - 1, tail);
/* 544 */             Double2FloatArrayMap.this.size--;
/* 545 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 552 */             int max = Double2FloatArrayMap.this.size;
/* 553 */             while (this.pos < max)
/* 554 */               action.accept(Double2FloatArrayMap.this.value[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 574 */         return Double2FloatArrayMap.this.value[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(FloatConsumer action) {
/* 586 */         int max = Double2FloatArrayMap.this.size;
/* 587 */         while (this.pos < max) {
/* 588 */           action.accept(Double2FloatArrayMap.this.value[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 595 */       return new ValuesSpliterator(0, Double2FloatArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 602 */       for (int i = 0, max = Double2FloatArrayMap.this.size; i < max; i++) {
/* 603 */         action.accept(Double2FloatArrayMap.this.value[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 609 */       return Double2FloatArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 614 */       Double2FloatArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/*     */     try {
/* 638 */       c = (Double2FloatArrayMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatArrayMap.class
