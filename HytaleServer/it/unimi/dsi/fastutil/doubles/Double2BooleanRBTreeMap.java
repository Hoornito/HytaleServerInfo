...
/*  819 */       Map.Entry<Double, Boolean> e = (Map.Entry<Double, Boolean>)o;
/*  820 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return HashCommon.double2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Double2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  930 */       if ((this.next = Double2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Double2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Double2BooleanRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2BooleanMap.Entry>)new AbstractObjectSortedSet<Double2BooleanMap.Entry>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Double2BooleanMap.Entry>)new Double2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from) {
/* 1046 */             return (ObjectBidirectionalIterator<Double2BooleanMap.Entry>)new Double2BooleanRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1057 */             Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1067 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1068 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1069 */             Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1070 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1071 */             Double2BooleanRBTreeMap.this.remove(f.key);
/* 1072 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1077 */             return Double2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1082 */             Double2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2BooleanMap.Entry first() {
/* 1087 */             return Double2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2BooleanMap.Entry last() {
/* 1092 */             return Double2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry from, Double2BooleanMap.Entry to) {
/* 1097 */             return Double2BooleanRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry to) {
/* 1102 */             return Double2BooleanRBTreeMap.this.headMap(to.getDoubleKey()).double2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from) {
/* 1107 */             return Double2BooleanRBTreeMap.this.tailMap(from.getDoubleKey()).double2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1144 */       return new Double2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1149 */       return new Double2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1202 */             return (BooleanIterator)new Double2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1207 */             return Double2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1212 */             return Double2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1217 */             Double2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1230 */     return new Submap(0.0D, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Double2BooleanSortedMap tailMap(double from) {
/* 1235 */     return new Submap(from, false, 0.0D, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1279 */       if (!bottom && !top && Double2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1280 */       this.from = from;
/* 1281 */       this.bottom = bottom;
/* 1282 */       this.to = to;
/* 1283 */       this.top = top;
/* 1284 */       this.defRetValue = Double2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1303 */       return ((this.bottom || Double2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 1308 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2BooleanMap.Entry>)new AbstractObjectSortedSet<Double2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator() {
/* 1311 */               return (ObjectBidirectionalIterator<Double2BooleanMap.Entry>)new Double2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from) {
/* 1316 */               return (ObjectBidirectionalIterator<Double2BooleanMap.Entry>)new Double2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2BooleanMap.Entry> comparator() {
/* 1321 */               return Double2BooleanRBTreeMap.this.double2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1329 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1330 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1331 */               Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1332 */               return (f != null && Double2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1340 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1341 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1342 */               Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1343 */               if (f != null && Double2BooleanRBTreeMap.Submap.this.in(f.key)) Double2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1344 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1349 */               int c = 0;
/* 1350 */               for (ObjectBidirectionalIterator<Double2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1351 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1356 */               return !(new Double2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1361 */               Double2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2BooleanMap.Entry first() {
/* 1366 */               return Double2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2BooleanMap.Entry last() {
/* 1371 */               return Double2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry from, Double2BooleanMap.Entry to) {
/* 1376 */               return Double2BooleanRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry to) {
/* 1381 */               return Double2BooleanRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from) {
/* 1386 */               return Double2BooleanRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1395 */         return new Double2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1400 */         return new Double2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1415 */               return (BooleanIterator)new Double2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1420 */               return Double2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1425 */               return Double2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1430 */               Double2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1440 */       return (in(k) && Double2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(double k) {
/* 1458 */       double kk = k; Double2BooleanRBTreeMap.Entry e;
/* 1459 */       return (in(kk) && (e = Double2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(double k, boolean v) {
/* 1464 */       Double2BooleanRBTreeMap.this.modified = false;
...
/* 1466 */       boolean oldValue = Double2BooleanRBTreeMap.this.put(k, v);
/* 1467 */       return Double2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1473 */       Double2BooleanRBTreeMap.this.modified = false;
/* 1474 */       if (!in(k)) return this.defRetValue; 
/* 1475 */       boolean oldValue = Double2BooleanRBTreeMap.this.remove(k);
/* 1476 */       return Double2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1497 */       return Double2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2BooleanSortedMap headMap(double to) {
/* 1502 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1503 */       return (Double2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2BooleanSortedMap tailMap(double from) {
/* 1508 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1509 */       return (Double2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2BooleanSortedMap subMap(double from, double to) {
/* 1514 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1515 */       if (!this.top) to = (Double2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1516 */       if (!this.bottom) from = (Double2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1527 */       if (Double2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1531 */       if (this.bottom) { e = Double2BooleanRBTreeMap.this.firstEntry; }
/*      */       else
/* 1533 */       { e = Double2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1535 */         if (Double2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1539 */       if (e == null || (!this.top && Double2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1540 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2BooleanRBTreeMap.Entry e;
/* 1549 */       if (Double2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1553 */       if (this.top) { e = Double2BooleanRBTreeMap.this.lastEntry; }
/*      */       else
/* 1555 */       { e = Double2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1557 */         if (Double2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1561 */       if (e == null || (!this.bottom && Double2BooleanRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1562 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1567 */       Double2BooleanRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1574 */       Double2BooleanRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1590 */         this.next = Double2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null) {
/* 1596 */           if (!Double2BooleanRBTreeMap.Submap.this.bottom && Double2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1597 */           else if (!Double2BooleanRBTreeMap.Submap.this.top && Double2BooleanRBTreeMap.this.compare(k, (this.prev = Double2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1599 */           { this.next = Double2BooleanRBTreeMap.this.locateKey(k);
/* 1600 */             if (Double2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1611 */         if (!Double2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Double2BooleanRBTreeMap.this.compare(this.prev.key, Double2BooleanRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1616 */         this.next = this.next.next();
/* 1617 */         if (!Double2BooleanRBTreeMap.Submap.this.top && this.next != null && Double2BooleanRBTreeMap.this.compare(this.next.key, Double2BooleanRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1705 */       c = (Double2BooleanRBTreeMap)super.clone();
...
/* 1778 */     if (n == 1) {
/* 1779 */       Entry entry = new Entry(s.readDouble(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1788 */       Entry entry = new Entry(s.readDouble(), s.readBoolean());
/* 1789 */       entry.black(true);
/* 1790 */       entry.right(new Entry(s.readDouble(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanRBTreeMap.class
