...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Double2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Double2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2DoubleFunction singleton(Double key, Double value) {
/* 179 */     return new Singleton(key.doubleValue(), value.doubleValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractDouble2DoubleFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2DoubleFunction function;
/*     */     
...
/* 544 */       Double v = this.function.apply(Double.valueOf(key));
...
/* 551 */       Double v = this.function.apply(Double.valueOf(key));
...
/* 597 */     if (f instanceof Double2DoubleFunction) return (Double2DoubleFunction)f; 
/* 598 */     if (f instanceof DoubleUnaryOperator) { Objects.requireNonNull((DoubleUnaryOperator)f); return (DoubleUnaryOperator)f::applyAsDouble; }
/* 599 */      return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleFunctions.class
