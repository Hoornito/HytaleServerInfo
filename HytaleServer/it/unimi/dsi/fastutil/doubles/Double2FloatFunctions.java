...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Double2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Double2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2FloatFunction singleton(Double key, Float value) {
/* 179 */     return new Singleton(key.doubleValue(), value.floatValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractDouble2FloatFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2FloatFunction function;
/*     */     
...
/* 544 */       Float v = this.function.apply(Double.valueOf(key));
...
/* 551 */       Float v = this.function.apply(Double.valueOf(key));
...
/* 597 */     if (f instanceof Double2FloatFunction) return (Double2FloatFunction)f; 
/* 598 */     if (f instanceof DoubleUnaryOperator) return key -> SafeMath.safeDoubleToFloat(((DoubleUnaryOperator)f).applyAsDouble(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatFunctions.class
