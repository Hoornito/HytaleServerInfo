...
/*  684 */     for (int i = this.n; i-- != 0;) { if (Double.doubleToLongBits(key[i]) != 0L && value[i] == v) return true;  }
/*  685 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  731 */     if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) && v == this.value[pos]) {
/*  732 */       removeEntry(pos);
/*  733 */       return true;
/*      */     } 
/*      */     while (true) {
/*  736 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
/*  737 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) && v == this.value[pos]) {
/*  738 */         removeEntry(pos);
/*  739 */         return true;
/*      */       } 
/*      */     } 
...
/*  887 */       return Double2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  892 */       return Double2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  908 */       Double2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleReferencePair<V> right(V v) {
/*  914 */       Double2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  926 */       return Double.valueOf(Double2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  934 */       return (Double.doubleToLongBits(Double2ReferenceLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Double2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return HashCommon.double2int(Double2ReferenceLinkedOpenHashMap.this.key[this.index]) ^ ((Double2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Double2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Double2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Double2ReferenceLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(double from) {
/* 1117 */       if (Double.doubleToLongBits(from) == 0L) {
/* 1118 */         if (Double2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Double2ReferenceLinkedOpenHashMap.this.link[Double2ReferenceLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Double2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Double.doubleToLongBits(Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.last]) == Double.doubleToLongBits(from)) {
/* 1125 */         this.prev = Double2ReferenceLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Double2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(from)) & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Double.doubleToLongBits(Double2ReferenceLinkedOpenHashMap.this.key[pos]) != 0L) {
/* 1133 */         if (Double.doubleToLongBits(Double2ReferenceLinkedOpenHashMap.this.key[pos]) == Double.doubleToLongBits(from)) {
/*      */           
/* 1135 */           this.next = (int)Double2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Double2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Double2ReferenceLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Double2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Double2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Double2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Double2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Double2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Double2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Double2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Double2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Double2ReferenceLinkedOpenHashMap.this.link[this.prev] = Double2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Double2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Double2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Double2ReferenceLinkedOpenHashMap.this.link[this.next] = Double2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Double2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Double2ReferenceLinkedOpenHashMap.this.n) {
/* 1227 */         Double2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Double2ReferenceLinkedOpenHashMap.this.value[Double2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         double[] key = Double2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           double curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/* 1237 */               key[last] = 0.0D;
/* 1238 */               Double2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2ReferenceLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Double2ReferenceLinkedOpenHashMap.this.value[last] = Double2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Double2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2ReferenceMap.Entry<V>>> implements ObjectListIterator<Double2ReferenceMap.Entry<V>> {
...
/* 1288 */       action.accept(new Double2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Double2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Double2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Double2ReferenceMap.Entry<V>>> implements ObjectListIterator<Double2ReferenceMap.Entry<V>> {
/* 1309 */     final Double2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Double2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>>)new Double2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Double2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ReferenceMap.Entry<V> last() {
/* 1392 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1404 */       if (Double.doubleToLongBits(k) == 0L) return (Double2ReferenceLinkedOpenHashMap.this.containsNullKey && Double2ReferenceLinkedOpenHashMap.this.value[Double2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1406 */       double[] key = Double2ReferenceLinkedOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1409 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ReferenceLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1410 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Double2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1413 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1414 */         if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Double2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1427 */         if (Double2ReferenceLinkedOpenHashMap.this.containsNullKey && Double2ReferenceLinkedOpenHashMap.this.value[Double2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1428 */           Double2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       double[] key = Double2ReferenceLinkedOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1437 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ReferenceLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1438 */       if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
/* 1439 */         if (Double2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1440 */           Double2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1447 */         if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) && 
/* 1448 */           Double2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1449 */           Double2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Double2ReferenceLinkedOpenHashMap.EntryIterator(from.getDoubleKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Double2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Double2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getDoubleKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Double2ReferenceLinkedOpenHashMap.this.size, next = Double2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Double2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Double2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Double2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Double2ReferenceLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Double2ReferenceLinkedOpenHashMap.this.size, next = Double2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Double2ReferenceLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Double2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Double2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1563 */       return Double2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Double2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleListIterator iterator() {
/* 1577 */       return new Double2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return DoubleSpliterators.asSpliterator(iterator(), Size64.sizeOf(Double2ReferenceLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1593 */       for (int i = Double2ReferenceLinkedOpenHashMap.this.size, next = Double2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Double2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Double2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1607 */       return Double2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1612 */       int oldSize = Double2ReferenceLinkedOpenHashMap.this.size;
/* 1613 */       Double2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Double2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDouble() {
/* 1624 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public double lastDouble() {
/* 1630 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Double2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Double2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Double2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Double2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Double2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Double2ReferenceLinkedOpenHashMap.this.size, next = Double2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Double2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Double2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Double2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1855 */       c = (Double2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceLinkedOpenHashMap.class
