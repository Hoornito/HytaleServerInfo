...
/*  865 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  870 */       return HashCommon.double2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Double2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  977 */       if ((this.next = Double2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Double2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Double2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             Double2ObjectAVLTreeMap.Entry<V> f = Double2ObjectAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1124 */             Double2ObjectAVLTreeMap.Entry<V> f = Double2ObjectAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1125 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1126 */             Double2ObjectAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Double2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Double2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ObjectMap.Entry<V> first() {
/* 1142 */             return Double2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ObjectMap.Entry<V> last() {
/* 1147 */             return Double2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) {
/* 1152 */             return Double2ObjectAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) {
/* 1157 */             return Double2ObjectAVLTreeMap.this.headMap(to.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) {
/* 1162 */             return Double2ObjectAVLTreeMap.this.tailMap(from.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Double2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1204 */       return new Double2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Double2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Double2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Double2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Double2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Double2ObjectAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Double2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Double2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ObjectMap.Entry<V>> comparator() {
/* 1376 */               return Double2ObjectAVLTreeMap.this.double2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1385 */               Double2ObjectAVLTreeMap.Entry<V> f = Double2ObjectAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1386 */               return (f != null && Double2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1395 */               Double2ObjectAVLTreeMap.Entry<V> f = Double2ObjectAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1396 */               if (f != null && Double2ObjectAVLTreeMap.Submap.this.in(f.key)) Double2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Double2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Double2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ObjectMap.Entry<V> first() {
/* 1419 */               return Double2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ObjectMap.Entry<V> last() {
/* 1424 */               return Double2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) {
/* 1429 */               return Double2ObjectAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) {
/* 1434 */               return Double2ObjectAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) {
/* 1439 */               return Double2ObjectAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1448 */         return new Double2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1453 */         return new Double2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Double2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Double2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Double2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Double2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1493 */       return (in(k) && Double2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(double k) {
/* 1511 */       double kk = k; Double2ObjectAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Double2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(double k, V v) {
/* 1517 */       Double2ObjectAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Double2ObjectAVLTreeMap.this.put(k, v);
/* 1520 */       return Double2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(double k) {
/* 1526 */       Double2ObjectAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Double2ObjectAVLTreeMap.this.remove(k);
/* 1529 */       return Double2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1550 */       return Double2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> headMap(double to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Double2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> tailMap(double from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Double2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> subMap(double from, double to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Double2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Double2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Double2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Double2ObjectAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Double2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Double2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Double2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ObjectAVLTreeMap.Entry<V> e;
/* 1602 */       if (Double2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Double2ObjectAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Double2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Double2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Double2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1620 */       Double2ObjectAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1627 */       Double2ObjectAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Double2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Double2ObjectAVLTreeMap.Submap.this.bottom && Double2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Double2ObjectAVLTreeMap.Submap.this.top && Double2ObjectAVLTreeMap.this.compare(k, (this.prev = Double2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Double2ObjectAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Double2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Double2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Double2ObjectAVLTreeMap.this.compare(this.prev.key, Double2ObjectAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Double2ObjectAVLTreeMap.Submap.this.top && this.next != null && Double2ObjectAVLTreeMap.this.compare(this.next.key, Double2ObjectAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Double2ObjectAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ObjectAVLTreeMap.class
