...
/*  885 */       Map.Entry<Double, Integer> e = (Map.Entry<Double, Integer>)o;
/*  886 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Double2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  998 */       if ((this.next = Double2IntAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Double2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Double2IntAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2IntMap.Entry>)new AbstractObjectSortedSet<Double2IntMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1147 */             Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1148 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1149 */             Double2IntAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Double2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Double2IntAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2IntMap.Entry first() {
/* 1165 */             return Double2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2IntMap.Entry last() {
/* 1170 */             return Double2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) {
/* 1175 */             return Double2IntAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) {
/* 1180 */             return Double2IntAVLTreeMap.this.headMap(to.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) {
/* 1185 */             return Double2IntAVLTreeMap.this.tailMap(from.getDoubleKey()).double2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Double2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1227 */       return new Double2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (IntIterator)new Double2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1285 */             return Double2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Double2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Double2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Double2IntAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Double2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Double2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2IntMap.Entry>)new AbstractObjectSortedSet<Double2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Double2IntMap.Entry>)new Double2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2IntMap.Entry> comparator() {
/* 1399 */               return Double2IntAVLTreeMap.this.double2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1410 */               return (f != null && Double2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1421 */               if (f != null && Double2IntAVLTreeMap.Submap.this.in(f.key)) Double2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Double2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Double2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Double2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2IntMap.Entry first() {
/* 1444 */               return Double2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2IntMap.Entry last() {
/* 1449 */               return Double2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) {
/* 1454 */               return Double2IntAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) {
/* 1459 */               return Double2IntAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) {
/* 1464 */               return Double2IntAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1473 */         return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1478 */         return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1493 */               return (IntIterator)new Double2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1498 */               return Double2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Double2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Double2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1518 */       return (in(k) && Double2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(double k) {
/* 1536 */       double kk = k; Double2IntAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Double2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(double k, int v) {
/* 1542 */       Double2IntAVLTreeMap.this.modified = false;
...
/* 1544 */       int oldValue = Double2IntAVLTreeMap.this.put(k, v);
/* 1545 */       return Double2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(double k) {
/* 1551 */       Double2IntAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       int oldValue = Double2IntAVLTreeMap.this.remove(k);
/* 1554 */       return Double2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1575 */       return Double2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap headMap(double to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Double2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap tailMap(double from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Double2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2IntSortedMap subMap(double from, double to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Double2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Double2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Double2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Double2IntAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Double2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Double2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Double2IntAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2IntAVLTreeMap.Entry e;
/* 1627 */       if (Double2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Double2IntAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Double2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Double2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Double2IntAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1645 */       Double2IntAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1652 */       Double2IntAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Double2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Double2IntAVLTreeMap.Submap.this.bottom && Double2IntAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Double2IntAVLTreeMap.Submap.this.top && Double2IntAVLTreeMap.this.compare(k, (this.prev = Double2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Double2IntAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Double2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Double2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Double2IntAVLTreeMap.this.compare(this.prev.key, Double2IntAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Double2IntAVLTreeMap.Submap.this.top && this.next != null && Double2IntAVLTreeMap.this.compare(this.next.key, Double2IntAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Double2IntAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readDouble(), s.readInt());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readDouble(), s.readInt());
/* 1866 */       entry.right(new Entry(s.readDouble(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntAVLTreeMap.class
