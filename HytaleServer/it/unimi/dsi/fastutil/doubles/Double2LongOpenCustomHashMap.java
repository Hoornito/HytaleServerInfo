...
/*  110 */     this.key = new double[this.n + 1];
...
/*  261 */     if (this.strategy.equals(k, 0.0D)) return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  263 */     double[] key = this.key;
/*      */     double curr;
/*      */     int pos;
/*  266 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return -(pos + 1); 
/*  267 */     if (this.strategy.equals(k, curr)) return pos;
/*      */     
/*      */     while (true) {
/*  270 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return -(pos + 1); 
...
/*      */     int pos;
/*  316 */     if (this.strategy.equals(k, 0.0D)) {
...
/*      */       double curr;
/*  324 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) != 0L) {
/*  325 */         if (this.strategy.equals(curr, k)) return addToValue(pos, incr); 
/*  326 */         while (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) != 0L) { if (this.strategy.equals(curr, k)) return addToValue(pos, incr);  }
/*      */       
/*      */       } 
/*  329 */     }  this.key[pos] = k;
...
/*      */       while (true) {
/*  350 */         if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  351 */           key[last] = 0.0D;
/*      */           return;
/*      */         } 
...
/*  366 */     if (this.strategy.equals(k, 0.0D)) {
...
/*      */     double curr;
/*      */     int pos;
/*  374 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return this.defRetValue; 
/*  375 */     if (this.strategy.equals(k, curr)) return removeEntry(pos); 
/*      */     while (true) {
/*  377 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return this.defRetValue; 
...
/*  385 */     if (this.strategy.equals(k, 0.0D)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  387 */     double[] key = this.key;
/*      */     double curr;
/*      */     int pos;
/*  390 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return this.defRetValue; 
/*  391 */     if (this.strategy.equals(k, curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  394 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return this.defRetValue; 
...
/*  402 */     if (this.strategy.equals(k, 0.0D)) return this.containsNullKey;
/*      */     
/*  404 */     double[] key = this.key;
/*      */     double curr;
/*      */     int pos;
/*  407 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return false; 
/*  408 */     if (this.strategy.equals(k, curr)) return true;
/*      */     
/*      */     while (true) {
/*  411 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  421 */     for (int i = this.n; i-- != 0;) { if (Double.doubleToLongBits(key[i]) != 0L && value[i] == v) return true;  }
/*  422 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  429 */     if (this.strategy.equals(k, 0.0D)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  431 */     double[] key = this.key;
/*      */     double curr;
/*      */     int pos;
/*  434 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return defaultValue; 
/*  435 */     if (this.strategy.equals(k, curr)) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  438 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return defaultValue; 
...
/*  456 */     if (this.strategy.equals(k, 0.0D)) {
...
/*      */     } 
/*      */     
/*  464 */     double[] key = this.key;
/*      */     double curr;
/*      */     int pos;
/*  467 */     if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) == 0L) return false; 
/*  468 */     if (this.strategy.equals(k, curr) && v == this.value[pos]) {
/*  469 */       removeEntry(pos);
/*  470 */       return true;
/*      */     } 
/*      */     while (true) {
/*  473 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
...
/*  542 */     Long newValue = remappingFunction.apply(Double.valueOf(k), Long.valueOf(this.value[pos]));
/*  543 */     if (newValue == null) {
/*  544 */       if (this.strategy.equals(k, 0.0D)) { removeNullEntry(); }
...
/*  555 */     int pos = find(k);
/*  556 */     Long newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
/*  557 */     if (newValue == null) {
/*  558 */       if (pos >= 0)
/*  559 */         if (this.strategy.equals(k, 0.0D)) { removeNullEntry(); }
...
/*  585 */       if (this.strategy.equals(k, 0.0D)) { removeNullEntry(); }
...
/*  634 */       return Double2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  639 */       return Double2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Double2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  649 */       return Double2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  654 */       long oldValue = Double2LongOpenCustomHashMap.this.value[this.index];
/*  655 */       Double2LongOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleLongPair right(long v) {
/*  661 */       Double2LongOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  673 */       return Double.valueOf(Double2LongOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Long.valueOf(Double2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Double, Long> e = (Map.Entry<Double, Long>)o;
/*  703 */       return (Double2LongOpenCustomHashMap.this.strategy.equals(Double2LongOpenCustomHashMap.this.key[this.index], ((Double)e.getKey()).doubleValue()) && Double2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Double2LongOpenCustomHashMap.this.strategy.hashCode(Double2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Double2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Double2LongOpenCustomHashMap.this.key[this.index] + "=>" + Double2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Double2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Double2LongOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Double2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Double2LongOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Double2LongOpenCustomHashMap.this.mask;
/*  762 */           for (; !Double2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2LongOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
/*  765 */         if (Double.doubleToLongBits(key[this.pos]) != 0L) return this.last = this.pos; 
/*      */       } 
/*      */     }
/*      */     
...
/*  772 */         acceptOnIndex(action, this.last = Double2LongOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Double2LongOpenCustomHashMap.this.mask;
/*  782 */           for (; !Double2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Double2LongOpenCustomHashMap.this.mask);
/*  783 */           acceptOnIndex(action, p);
/*  784 */           this.c--; continue;
/*  785 */         }  if (Double.doubleToLongBits(key[this.pos]) != 0L) {
...
/*  802 */       double[] key = Double2LongOpenCustomHashMap.this.key; while (true) {
/*      */         double curr; int last;
/*  804 */         pos = (last = pos) + 1 & Double2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  807 */             key[last] = 0.0D;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Double2LongOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
/*  815 */           if (this.wrapped == null) this.wrapped = new DoubleArrayList(2); 
/*  816 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Double2LongOpenCustomHashMap.this.value[last] = Double2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Double2LongOpenCustomHashMap.this.n)
/*  826 */       { Double2LongOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Double2LongOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Double2LongOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2LongMap.Entry>> implements ObjectIterator<Double2LongMap.Entry> { public Double2LongOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Double2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Double2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  868 */       this.entry = new Double2LongOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Double2LongOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Double2LongOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Double2LongOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*  920 */       while (this.pos < this.max) {
/*  921 */         if (Double.doubleToLongBits(key[this.pos]) != 0L) {
/*  922 */           this.c++;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Double2LongOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*  938 */       while (this.pos < this.max) {
/*  939 */         if (Double.doubleToLongBits(key[this.pos]) != 0L) {
...
/*      */       {
/*  950 */         return (Double2LongOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Double2LongOpenCustomHashMap.this.size - this.c), (long)(Double2LongOpenCustomHashMap.this.realSize() / Double2LongOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*  986 */       while (this.pos < this.max && n > 0L) {
/*  987 */         if (Double.doubleToLongBits(key[this.pos++]) != 0L) {
/*  988 */           skipped++;
/*  989 */           n--;
/*      */         } 
/*      */       } 
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Double2LongMap.Entry> action, int index) {
/* 1013 */       action.accept(new Double2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Double2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Double2LongMap.Entry> fastIterator() {
/* 1030 */       return new Double2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Double2LongMap.Entry> spliterator() {
/* 1035 */       return new Double2LongOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Double2LongOpenCustomHashMap.this.strategy.equals(k, 0.0D)) return (Double2LongOpenCustomHashMap.this.containsNullKey && Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1053 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Double2LongOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1054 */       if (Double2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1058 */         if (Double2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1067 */       if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1068 */       if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1069 */       double k = ((Double)e.getKey()).doubleValue();
/* 1070 */       long v = ((Long)e.getValue()).longValue();
/* 1071 */       if (Double2LongOpenCustomHashMap.this.strategy.equals(k, 0.0D)) {
/* 1072 */         if (Double2LongOpenCustomHashMap.this.containsNullKey && Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n] == v) {
/* 1073 */           Double2LongOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       double[] key = Double2LongOpenCustomHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1082 */       if (Double.doubleToLongBits(curr = key[pos = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Double2LongOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1083 */       if (Double2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Double2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask]) == 0L) return false; 
/* 1092 */         if (Double2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Double2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Double2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Double2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
/* 1114 */       if (Double2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(new Double2LongOpenCustomHashMap.MapEntry(Double2LongOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Double2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(new Double2LongOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
/* 1121 */       Double2LongOpenCustomHashMap.MapEntry entry = new Double2LongOpenCustomHashMap.MapEntry();
/* 1122 */       if (Double2LongOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Double2LongOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Double2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[pos]) != 0L) {
...
/* 1157 */       action.accept(Double2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1162 */       return Double2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1183 */       action.accept(Double2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Double2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleSpliterator spliterator() {
/* 1200 */       return new Double2LongOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1206 */       if (Double2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Double2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         double k = Double2LongOpenCustomHashMap.this.key[pos];
/* 1209 */         if (Double.doubleToLongBits(k) != 0L) consumer.accept(k);
/*      */       
/*      */       } 
/*      */     }
/*      */     
/*      */     public int size() {
/* 1215 */       return Double2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1220 */       return Double2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1225 */       int oldSize = Double2LongOpenCustomHashMap.this.size;
/* 1226 */       Double2LongOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Double2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Double2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Double2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1265 */       return Double2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1286 */       action.accept(Double2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Double2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1305 */             return new Double2LongOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1311 */             if (Double2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Double2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[pos]) != 0L) consumer.accept(Double2LongOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Double2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1322 */             return Double2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Double2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1391 */     double[] key = this.key;
/* 1392 */     long[] value = this.value;
/* 1393 */     int mask = newN - 1;
/* 1394 */     double[] newKey = new double[newN + 1];
/* 1395 */     long[] newValue = new long[newN + 1];
/* 1396 */     int i = this.n;
/* 1397 */     for (int j = realSize(); j-- != 0; ) {
/* 1398 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1399 */       if (Double.doubleToLongBits(newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L) while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
...
/*      */     try {
/* 1425 */       c = (Double2LongOpenCustomHashMap)super.clone();
...
/* 1433 */     c.key = (double[])this.key.clone();
...
/* 1452 */       for (; Double.doubleToLongBits(this.key[i]) == 0L; i++);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2LongOpenCustomHashMap.class
