...
/*  839 */       Map.Entry<Double, Float> e = (Map.Entry<Double, Float>)o;
/*  840 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return HashCommon.double2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Double2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  950 */       if ((this.next = Double2FloatRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Double2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Double2FloatRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2FloatMap.Entry>)new AbstractObjectSortedSet<Double2FloatMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Double2FloatMap.Entry>)new Double2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(Double2FloatMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Double2FloatMap.Entry>)new Double2FloatRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Double2FloatRBTreeMap.Entry f = Double2FloatRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1089 */             Double2FloatRBTreeMap.Entry f = Double2FloatRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1090 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1091 */             Double2FloatRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Double2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Double2FloatRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2FloatMap.Entry first() {
/* 1107 */             return Double2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2FloatMap.Entry last() {
/* 1112 */             return Double2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry from, Double2FloatMap.Entry to) {
/* 1117 */             return Double2FloatRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry to) {
/* 1122 */             return Double2FloatRBTreeMap.this.headMap(to.getDoubleKey()).double2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry from) {
/* 1127 */             return Double2FloatRBTreeMap.this.tailMap(from.getDoubleKey()).double2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Double2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1169 */       return new Double2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (FloatIterator)new Double2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1227 */             return Double2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Double2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Double2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Double2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Double2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Double2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2FloatMap.Entry>)new AbstractObjectSortedSet<Double2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Double2FloatMap.Entry>)new Double2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(Double2FloatMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Double2FloatMap.Entry>)new Double2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2FloatMap.Entry> comparator() {
/* 1341 */               return Double2FloatRBTreeMap.this.double2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Double2FloatRBTreeMap.Entry f = Double2FloatRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1352 */               return (f != null && Double2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Double2FloatRBTreeMap.Entry f = Double2FloatRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1363 */               if (f != null && Double2FloatRBTreeMap.Submap.this.in(f.key)) Double2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Double2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Double2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Double2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2FloatMap.Entry first() {
/* 1386 */               return Double2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2FloatMap.Entry last() {
/* 1391 */               return Double2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry from, Double2FloatMap.Entry to) {
/* 1396 */               return Double2FloatRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry to) {
/* 1401 */               return Double2FloatRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry from) {
/* 1406 */               return Double2FloatRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2FloatEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2FloatSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1415 */         return new Double2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1420 */         return new Double2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1435 */               return (FloatIterator)new Double2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1440 */               return Double2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Double2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Double2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1460 */       return (in(k) && Double2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(double k) {
/* 1478 */       double kk = k; Double2FloatRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Double2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(double k, float v) {
/* 1484 */       Double2FloatRBTreeMap.this.modified = false;
...
/* 1486 */       float oldValue = Double2FloatRBTreeMap.this.put(k, v);
/* 1487 */       return Double2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(double k) {
/* 1493 */       Double2FloatRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       float oldValue = Double2FloatRBTreeMap.this.remove(k);
/* 1496 */       return Double2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1517 */       return Double2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2FloatSortedMap headMap(double to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Double2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2FloatSortedMap tailMap(double from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Double2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2FloatSortedMap subMap(double from, double to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Double2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Double2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Double2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Double2FloatRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Double2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Double2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Double2FloatRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2FloatRBTreeMap.Entry e;
/* 1569 */       if (Double2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Double2FloatRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Double2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Double2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Double2FloatRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1587 */       Double2FloatRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1594 */       Double2FloatRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Double2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Double2FloatRBTreeMap.Submap.this.bottom && Double2FloatRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Double2FloatRBTreeMap.Submap.this.top && Double2FloatRBTreeMap.this.compare(k, (this.prev = Double2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Double2FloatRBTreeMap.this.locateKey(k);
/* 1620 */             if (Double2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Double2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Double2FloatRBTreeMap.this.compare(this.prev.key, Double2FloatRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Double2FloatRBTreeMap.Submap.this.top && this.next != null && Double2FloatRBTreeMap.this.compare(this.next.key, Double2FloatRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Double2FloatMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Double2FloatRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readDouble(), s.readFloat());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readDouble(), s.readFloat());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readDouble(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatRBTreeMap.class
