...
/*  839 */       Map.Entry<Double, Short> e = (Map.Entry<Double, Short>)o;
/*  840 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Double2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  950 */       if ((this.next = Double2ShortRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Double2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Double2ShortRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ShortMap.Entry>)new AbstractObjectSortedSet<Double2ShortMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Double2ShortMap.Entry>)new Double2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Double2ShortMap.Entry>)new Double2ShortRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1089 */             Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1090 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1091 */             Double2ShortRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Double2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Double2ShortRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ShortMap.Entry first() {
/* 1107 */             return Double2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ShortMap.Entry last() {
/* 1112 */             return Double2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry to) {
/* 1117 */             return Double2ShortRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry to) {
/* 1122 */             return Double2ShortRBTreeMap.this.headMap(to.getDoubleKey()).double2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from) {
/* 1127 */             return Double2ShortRBTreeMap.this.tailMap(from.getDoubleKey()).double2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Double2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1169 */       return new Double2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (ShortIterator)new Double2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1227 */             return Double2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Double2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Double2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Double2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Double2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Double2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ShortRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ShortMap.Entry>)new AbstractObjectSortedSet<Double2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Double2ShortMap.Entry>)new Double2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Double2ShortMap.Entry>)new Double2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ShortMap.Entry> comparator() {
/* 1341 */               return Double2ShortRBTreeMap.this.double2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1352 */               return (f != null && Double2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1363 */               if (f != null && Double2ShortRBTreeMap.Submap.this.in(f.key)) Double2ShortRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Double2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Double2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Double2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ShortMap.Entry first() {
/* 1386 */               return Double2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ShortMap.Entry last() {
/* 1391 */               return Double2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry to) {
/* 1396 */               return Double2ShortRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry to) {
/* 1401 */               return Double2ShortRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from) {
/* 1406 */               return Double2ShortRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1415 */         return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1420 */         return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1435 */               return (ShortIterator)new Double2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1440 */               return Double2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Double2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Double2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1460 */       return (in(k) && Double2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(double k) {
/* 1478 */       double kk = k; Double2ShortRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Double2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(double k, short v) {
/* 1484 */       Double2ShortRBTreeMap.this.modified = false;
...
/* 1486 */       short oldValue = Double2ShortRBTreeMap.this.put(k, v);
/* 1487 */       return Double2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(double k) {
/* 1493 */       Double2ShortRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       short oldValue = Double2ShortRBTreeMap.this.remove(k);
/* 1496 */       return Double2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1517 */       return Double2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ShortSortedMap headMap(double to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Double2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ShortSortedMap tailMap(double from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Double2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ShortSortedMap subMap(double from, double to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Double2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Double2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Double2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Double2ShortRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Double2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Double2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Double2ShortRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ShortRBTreeMap.Entry e;
/* 1569 */       if (Double2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Double2ShortRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Double2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Double2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Double2ShortRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1587 */       Double2ShortRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1594 */       Double2ShortRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Double2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Double2ShortRBTreeMap.Submap.this.bottom && Double2ShortRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Double2ShortRBTreeMap.Submap.this.top && Double2ShortRBTreeMap.this.compare(k, (this.prev = Double2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Double2ShortRBTreeMap.this.locateKey(k);
/* 1620 */             if (Double2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Double2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Double2ShortRBTreeMap.this.compare(this.prev.key, Double2ShortRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Double2ShortRBTreeMap.Submap.this.top && this.next != null && Double2ShortRBTreeMap.this.compare(this.next.key, Double2ShortRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Double2ShortRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readDouble(), s.readShort());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readDouble(), s.readShort());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readDouble(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortRBTreeMap.class
