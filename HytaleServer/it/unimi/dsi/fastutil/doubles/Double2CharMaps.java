...
/*  49 */     ObjectSet<Double2CharMap.Entry> entries = map.double2CharEntrySet();
/*  50 */     return (entries instanceof Double2CharMap.FastEntrySet) ? ((Double2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Double2CharMap.Entry> entries = map.double2CharEntrySet();
/*  66 */     if (entries instanceof Double2CharMap.FastEntrySet) { ((Double2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Double2CharMap.Entry> entries = map.double2CharEntrySet();
/*  83 */     return (entries instanceof Double2CharMap.FastEntrySet) ? new ObjectIterable<Double2CharMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Double2CharMap.Entry> iterator() {
/*  86 */           return ((Double2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Double2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Double2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 147 */       return (ObjectSet<Double2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 157 */       return (CharCollection)CharSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Double2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     @Deprecated
/*     */     public boolean containsValue(Object ov) {
/* 226 */       return (((Character)ov).charValue() == this.value);
/*     */     }
/*     */ 
/*     */     
/*     */     public void putAll(Map<? extends Double, ? extends Character> m) {
...
/*     */     
/*     */     public ObjectSet<Double2CharMap.Entry> double2CharEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractDouble2CharMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */     
/*     */     public CharCollection values() {
/* 260 */       if (this.values == null) this.values = (CharCollection)CharSets.singleton(this.value); 
...
/* 316 */     return new Singleton(key.doubleValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Double2CharFunctions.SynchronizedFunction implements Double2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.double2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Character>> entrySet() {
/* 381 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 395 */         if (this.values == null) this.values = CharCollections.synchronize(this.map.values(), this.sync); 
...
/*     */     extends Double2CharFunctions.UnmodifiableFunction implements Double2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2CharMap map;
/*     */     protected transient ObjectSet<Double2CharMap.Entry> entries;
/*     */     protected transient DoubleSet keys;
...
/*     */     
/*     */     public ObjectSet<Double2CharMap.Entry> double2CharEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.double2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Character>> entrySet() {
/* 712 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */     
/*     */     public CharCollection values() {
/* 723 */       if (this.values == null) this.values = CharCollections.unmodifiable(this.map.values()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharMaps.class
