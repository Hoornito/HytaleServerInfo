...
/*   87 */     this.actualComparator = DoubleComparators.asDoubleComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  163 */     this(k, v, (Comparator<? super Double>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     return (this.actualComparator == null) ? Double.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  615 */     while (j-- != 0) {
/*  616 */       double ev = i.nextDouble();
/*  617 */       if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v)) return true; 
/*      */     } 
/*  619 */     return false;
/*      */   }
/*      */ 
...
/*  811 */       double oldValue = this.value;
...
/*  835 */       Map.Entry<Double, Double> e = (Map.Entry<Double, Double>)o;
/*  836 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  841 */       return HashCommon.double2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  942 */       this.next = Double2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  946 */       if ((this.next = Double2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  947 */         if (Double2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1000 */       updatePrevious();
/* 1001 */       updateNext();
/* 1002 */       Double2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1003 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1047 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2DoubleMap.Entry>)new AbstractObjectSortedSet<Double2DoubleMap.Entry>()
/*      */         {
...
/* 1057 */             return (ObjectBidirectionalIterator<Double2DoubleMap.Entry>)new Double2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry from) {
/* 1062 */             return (ObjectBidirectionalIterator<Double2DoubleMap.Entry>)new Double2DoubleRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1071 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1072 */             if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1073 */             Double2DoubleRBTreeMap.Entry f = Double2DoubleRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1083 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1084 */             if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1085 */             Double2DoubleRBTreeMap.Entry f = Double2DoubleRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1086 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double)e.getValue()).doubleValue())) return false; 
/* 1087 */             Double2DoubleRBTreeMap.this.remove(f.key);
/* 1088 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1093 */             return Double2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1098 */             Double2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2DoubleMap.Entry first() {
/* 1103 */             return Double2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2DoubleMap.Entry last() {
/* 1108 */             return Double2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry from, Double2DoubleMap.Entry to) {
/* 1113 */             return Double2DoubleRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry to) {
/* 1118 */             return Double2DoubleRBTreeMap.this.headMap(to.getDoubleKey()).double2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry from) {
/* 1123 */             return Double2DoubleRBTreeMap.this.tailMap(from.getDoubleKey()).double2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1160 */       return new Double2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1165 */       return new Double2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */     if (this.values == null) this.values = new AbstractDoubleCollection()
/*      */         {
/*      */           public DoubleIterator iterator() {
/* 1218 */             return new Double2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1223 */             return Double2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1228 */             return Double2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1233 */             Double2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1246 */     return new Submap(0.0D, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Double2DoubleSortedMap tailMap(double from) {
/* 1251 */     return new Submap(from, false, 0.0D, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1295 */       if (!bottom && !top && Double2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1296 */       this.from = from;
/* 1297 */       this.bottom = bottom;
/* 1298 */       this.to = to;
/* 1299 */       this.top = top;
/* 1300 */       this.defRetValue = Double2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1319 */       return ((this.bottom || Double2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
/* 1324 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2DoubleMap.Entry>)new AbstractObjectSortedSet<Double2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator() {
/* 1327 */               return (ObjectBidirectionalIterator<Double2DoubleMap.Entry>)new Double2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry from) {
/* 1332 */               return (ObjectBidirectionalIterator<Double2DoubleMap.Entry>)new Double2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2DoubleMap.Entry> comparator() {
/* 1337 */               return Double2DoubleRBTreeMap.this.double2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1345 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1346 */               if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1347 */               Double2DoubleRBTreeMap.Entry f = Double2DoubleRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1348 */               return (f != null && Double2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1356 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1357 */               if (e.getValue() == null || !(e.getValue() instanceof Double)) return false; 
/* 1358 */               Double2DoubleRBTreeMap.Entry f = Double2DoubleRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1359 */               if (f != null && Double2DoubleRBTreeMap.Submap.this.in(f.key)) Double2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1365 */               int c = 0;
/* 1366 */               for (ObjectBidirectionalIterator<Double2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1367 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Double2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Double2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2DoubleMap.Entry first() {
/* 1382 */               return Double2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2DoubleMap.Entry last() {
/* 1387 */               return Double2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry from, Double2DoubleMap.Entry to) {
/* 1392 */               return Double2DoubleRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry to) {
/* 1397 */               return Double2DoubleRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry from) {
/* 1402 */               return Double2DoubleRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1411 */         return new Double2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1416 */         return new Double2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public DoubleCollection values() {
/* 1428 */       if (this.values == null) this.values = new AbstractDoubleCollection()
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1431 */               return new Double2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1436 */               return Double2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Double2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Double2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1456 */       return (in(k) && Double2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/* 1465 */         if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v)) return true; 
/*      */       } 
/* 1467 */       return false;
/*      */     }
/*      */ 
...
/*      */     
/*      */     public double get(double k) {
/* 1474 */       double kk = k; Double2DoubleRBTreeMap.Entry e;
/* 1475 */       return (in(kk) && (e = Double2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(double k, double v) {
/* 1480 */       Double2DoubleRBTreeMap.this.modified = false;
...
/* 1482 */       double oldValue = Double2DoubleRBTreeMap.this.put(k, v);
/* 1483 */       return Double2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(double k) {
/* 1489 */       Double2DoubleRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k)) return this.defRetValue; 
/* 1491 */       double oldValue = Double2DoubleRBTreeMap.this.remove(k);
/* 1492 */       return Double2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1513 */       return Double2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2DoubleSortedMap headMap(double to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Double2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2DoubleSortedMap tailMap(double from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Double2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2DoubleSortedMap subMap(double from, double to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Double2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Double2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Double2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Double2DoubleRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Double2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Double2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Double2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2DoubleRBTreeMap.Entry e;
/* 1565 */       if (Double2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Double2DoubleRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Double2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Double2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Double2DoubleRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1583 */       Double2DoubleRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1590 */       Double2DoubleRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Double2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Double2DoubleRBTreeMap.Submap.this.bottom && Double2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Double2DoubleRBTreeMap.Submap.this.top && Double2DoubleRBTreeMap.this.compare(k, (this.prev = Double2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Double2DoubleRBTreeMap.this.locateKey(k);
/* 1616 */             if (Double2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Double2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Double2DoubleRBTreeMap.this.compare(this.prev.key, Double2DoubleRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Double2DoubleRBTreeMap.Submap.this.top && this.next != null && Double2DoubleRBTreeMap.this.compare(this.next.key, Double2DoubleRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Double2DoubleRBTreeMap)super.clone();
...
/* 1779 */       s.writeDouble(e.key);
/* 1780 */       s.writeDouble(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry entry = new Entry(s.readDouble(), s.readDouble());
...
/*      */ 
/*      */       
/* 1804 */       Entry entry = new Entry(s.readDouble(), s.readDouble());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry(s.readDouble(), s.readDouble()));
...
/* 1816 */     top.key = s.readDouble();
/* 1817 */     top.value = s.readDouble();
/* 1818 */     top.black(true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleRBTreeMap.class
