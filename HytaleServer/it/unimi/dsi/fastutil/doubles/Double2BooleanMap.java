...
/*     */   
/*     */   @Deprecated
/*     */   default ObjectSet<Map.Entry<Double, Boolean>> entrySet() {
/* 150 */     return (ObjectSet)double2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = double2BooleanEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Double.valueOf(entry.getDoubleKey()), Boolean.valueOf(entry.getBooleanValue()));
...
/* 502 */     Boolean newValue = remappingFunction.apply(Double.valueOf(key), Boolean.valueOf(oldValue));
...
/* 534 */     Boolean newValue = remappingFunction.apply(Double.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
...
/* 604 */       return Double.valueOf(getDoubleKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanMap.class
