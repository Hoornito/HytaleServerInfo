...
/*  733 */     for (int i = this.n; i-- != 0;) { if (Double.doubleToLongBits(key[i]) != 0L && Float.floatToIntBits(value[i]) == Float.floatToIntBits(v)) return true;  }
/*  734 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  780 */     if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) && Float.floatToIntBits(v) == Float.floatToIntBits(this.value[pos])) {
/*  781 */       removeEntry(pos);
/*  782 */       return true;
/*      */     } 
/*      */     while (true) {
/*  785 */       if (Double.doubleToLongBits(curr = key[pos = pos + 1 & this.mask]) == 0L) return false; 
/*  786 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) && Float.floatToIntBits(v) == Float.floatToIntBits(this.value[pos])) {
/*  787 */         removeEntry(pos);
/*  788 */         return true;
/*      */       } 
/*      */     } 
...
/*  854 */     Float newValue = remappingFunction.apply(Double.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Float newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  947 */       return Double2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double leftDouble() {
/*  952 */       return Double2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  957 */       return Double2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  962 */       return Double2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  967 */       float oldValue = Double2FloatLinkedOpenHashMap.this.value[this.index];
/*  968 */       Double2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleFloatPair right(float v) {
/*  974 */       Double2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*  986 */       return Double.valueOf(Double2FloatLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Float.valueOf(Double2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Double, Float> e = (Map.Entry<Double, Float>)o;
/* 1016 */       return (Double.doubleToLongBits(Double2FloatLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return HashCommon.double2int(Double2FloatLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.float2int(Double2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Double2FloatLinkedOpenHashMap.this.key[this.index] + "=>" + Double2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Double2FloatLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(double from) {
/* 1199 */       if (Double.doubleToLongBits(from) == 0L) {
/* 1200 */         if (Double2FloatLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Double2FloatLinkedOpenHashMap.this.link[Double2FloatLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Double2FloatLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Double.doubleToLongBits(Double2FloatLinkedOpenHashMap.this.key[Double2FloatLinkedOpenHashMap.this.last]) == Double.doubleToLongBits(from)) {
/* 1207 */         this.prev = Double2FloatLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Double2FloatLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = (int)HashCommon.mix(Double.doubleToRawLongBits(from)) & Double2FloatLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Double.doubleToLongBits(Double2FloatLinkedOpenHashMap.this.key[pos]) != 0L) {
/* 1215 */         if (Double.doubleToLongBits(Double2FloatLinkedOpenHashMap.this.key[pos]) == Double.doubleToLongBits(from)) {
/*      */           
/* 1217 */           this.next = (int)Double2FloatLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Double2FloatLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Double2FloatLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Double2FloatLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Double2FloatLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Double2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Double2FloatLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Double2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Double2FloatLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Double2FloatLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Double2FloatLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Double2FloatLinkedOpenHashMap.this.link[this.prev] = Double2FloatLinkedOpenHashMap.this.link[this.prev] ^ (Double2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Double2FloatLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Double2FloatLinkedOpenHashMap.this.link[this.next] = Double2FloatLinkedOpenHashMap.this.link[this.next] ^ (Double2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Double2FloatLinkedOpenHashMap.this.n) {
/* 1309 */         Double2FloatLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         double[] key = Double2FloatLinkedOpenHashMap.this.key; while (true) {
/*      */           double curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Double2FloatLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/* 1318 */               key[last] = 0.0D;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2FloatLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Double2FloatLinkedOpenHashMap.this.value[last] = Double2FloatLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Double2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Double2FloatMap.Entry>> implements ObjectListIterator<Double2FloatMap.Entry> {
...
/* 1368 */       action.accept(new Double2FloatLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2FloatLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Double2FloatLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2FloatLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Double2FloatLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Double2FloatMap.Entry>> implements ObjectListIterator<Double2FloatMap.Entry> {
/* 1389 */     final Double2FloatLinkedOpenHashMap.MapEntry entry = new Double2FloatLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Double2FloatMap.Entry>)new Double2FloatLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Double2FloatLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Double2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
...
/* 1472 */       if (Double2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
...
/* 1485 */       if (Double.doubleToLongBits(k) == 0L) return (Double2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[Double2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1487 */       double[] key = Double2FloatLinkedOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1490 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1491 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1494 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1495 */         if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) return (Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1509 */         if (Double2FloatLinkedOpenHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[Double2FloatLinkedOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1510 */           Double2FloatLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       double[] key = Double2FloatLinkedOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/* 1519 */       if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1520 */       if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
/* 1521 */         if (Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1522 */           Double2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask]) == 0L) return false; 
/* 1529 */         if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) && 
/* 1530 */           Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1531 */           Double2FloatLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Double2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Double2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Double2FloatLinkedOpenHashMap.EntryIterator(from.getDoubleKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Double2FloatLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Double2FloatLinkedOpenHashMap.FastEntryIterator(from.getDoubleKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2FloatMap.Entry> consumer) {
/* 1588 */       for (int i = Double2FloatLinkedOpenHashMap.this.size, next = Double2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Double2FloatLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Double2FloatLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Double2FloatLinkedOpenHashMap.MapEntry entry = new Double2FloatLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Double2FloatLinkedOpenHashMap.this.size, next = Double2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Double2FloatLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Double2FloatLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Double2FloatLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1645 */       return Double2FloatLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Double2FloatLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleListIterator iterator() {
/* 1659 */       return new Double2FloatLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return DoubleSpliterators.asSpliterator(iterator(), Size64.sizeOf(Double2FloatLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1675 */       for (int i = Double2FloatLinkedOpenHashMap.this.size, next = Double2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Double2FloatLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Double2FloatLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Double2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(double k) {
/* 1689 */       return Double2FloatLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(double k) {
/* 1694 */       int oldSize = Double2FloatLinkedOpenHashMap.this.size;
/* 1695 */       Double2FloatLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Double2FloatLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Double2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDouble() {
/* 1706 */       if (Double2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Double2FloatLinkedOpenHashMap.this.key[Double2FloatLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public double lastDouble() {
/* 1712 */       if (Double2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Double2FloatLinkedOpenHashMap.this.key[Double2FloatLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleComparator comparator() {
...
/* 1754 */       return Double2FloatLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Double2FloatLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1771 */       return Double2FloatLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (FloatIterator)new Double2FloatLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return FloatSpliterators.asSpliterator(iterator(), Size64.sizeOf(Double2FloatLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1798 */             for (int i = Double2FloatLinkedOpenHashMap.this.size, next = Double2FloatLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Double2FloatLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Double2FloatLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Double2FloatLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1812 */             return Double2FloatLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Double2FloatLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Double2FloatLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatLinkedOpenHashMap.class
