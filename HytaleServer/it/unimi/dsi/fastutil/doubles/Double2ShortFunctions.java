...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Double2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Double2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2ShortFunction singleton(Double key, Short value) {
/* 179 */     return new Singleton(key.doubleValue(), value.shortValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractDouble2ShortFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2ShortFunction function;
/*     */     
...
/* 544 */       Short v = this.function.apply(Double.valueOf(key));
...
/* 551 */       Short v = this.function.apply(Double.valueOf(key));
...
/* 597 */     if (f instanceof Double2ShortFunction) return (Double2ShortFunction)f; 
/* 598 */     if (f instanceof DoubleToIntFunction) return key -> SafeMath.safeIntToShort(((DoubleToIntFunction)f).applyAsInt(key)); 
/* 599 */     return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortFunctions.class
