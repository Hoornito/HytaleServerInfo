...
/*  601 */       if (Objects.equals(ev, v)) return true; 
/*      */     } 
/*  603 */     return false;
/*      */   }
/*      */ 
...
/*  819 */       Map.Entry<Double, V> e = (Map.Entry<Double, V>)o;
/*  820 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  825 */       return HashCommon.double2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Double2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(double k) {
/*  930 */       if ((this.next = Double2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Double2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Double2ObjectRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Double2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1046 */             return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1055 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1056 */             Double2ObjectRBTreeMap.Entry<V> f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1066 */             if (!(e.getKey() instanceof Double)) return false; 
/* 1067 */             Double2ObjectRBTreeMap.Entry<V> f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1068 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1069 */             Double2ObjectRBTreeMap.this.remove(f.key);
/* 1070 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1075 */             return Double2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1080 */             Double2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ObjectMap.Entry<V> first() {
/* 1085 */             return Double2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Double2ObjectMap.Entry<V> last() {
/* 1090 */             return Double2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) {
/* 1095 */             return Double2ObjectRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) {
/* 1100 */             return Double2ObjectRBTreeMap.this.headMap(to.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) {
/* 1105 */             return Double2ObjectRBTreeMap.this.tailMap(from.getDoubleKey()).double2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1142 */       return new Double2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1147 */       return new Double2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1197 */     if (this.values == null) this.values = (ObjectCollection<V>)new AbstractObjectCollection<V>()
/*      */         {
/*      */           public ObjectIterator<V> iterator() {
/* 1200 */             return (ObjectIterator<V>)new Double2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1205 */             return Double2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1210 */             return Double2ObjectRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1215 */             Double2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1228 */     return new Submap(0.0D, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Double2ObjectSortedMap<V> tailMap(double from) {
/* 1233 */     return new Submap(from, false, 0.0D, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1277 */       if (!bottom && !top && Double2ObjectRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1278 */       this.from = from;
/* 1279 */       this.bottom = bottom;
/* 1280 */       this.to = to;
/* 1281 */       this.top = top;
/* 1282 */       this.defRetValue = Double2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1301 */       return ((this.bottom || Double2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
/* 1306 */       if (this.entries == null) this.entries = (ObjectSortedSet<Double2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator() {
/* 1309 */               return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1314 */               return (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>>)new Double2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Double2ObjectMap.Entry<V>> comparator() {
/* 1319 */               return Double2ObjectRBTreeMap.this.double2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1327 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1328 */               Double2ObjectRBTreeMap.Entry<V> f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1329 */               return (f != null && Double2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1337 */               if (e.getKey() == null || !(e.getKey() instanceof Double)) return false; 
/* 1338 */               Double2ObjectRBTreeMap.Entry<V> f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1339 */               if (f != null && Double2ObjectRBTreeMap.Submap.this.in(f.key)) Double2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1340 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1345 */               int c = 0;
/* 1346 */               for (ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1347 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1352 */               return !(new Double2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1357 */               Double2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ObjectMap.Entry<V> first() {
/* 1362 */               return Double2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Double2ObjectMap.Entry<V> last() {
/* 1367 */               return Double2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) {
/* 1372 */               return Double2ObjectRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) {
/* 1377 */               return Double2ObjectRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) {
/* 1382 */               return Double2ObjectRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2ObjectEntrySet();
/*      */             }
/*      */           }; 
/* 1385 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractDouble2ObjectSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1391 */         return new Double2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1396 */         return new Double2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ObjectCollection<V> values() {
/* 1408 */       if (this.values == null) this.values = (ObjectCollection<V>)new AbstractObjectCollection<V>()
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1411 */               return (ObjectIterator<V>)new Double2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1416 */               return Double2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1421 */               return Double2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1426 */               Double2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1436 */       return (in(k) && Double2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/* 1445 */         if (Objects.equals(ev, v)) return true; 
/*      */       } 
/* 1447 */       return false;
/*      */     }
/*      */ 
...
/*      */     
/*      */     public V get(double k) {
/* 1454 */       double kk = k; Double2ObjectRBTreeMap.Entry<V> e;
/* 1455 */       return (in(kk) && (e = Double2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(double k, V v) {
/* 1460 */       Double2ObjectRBTreeMap.this.modified = false;
...
/* 1462 */       V oldValue = Double2ObjectRBTreeMap.this.put(k, v);
/* 1463 */       return Double2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(double k) {
/* 1469 */       Double2ObjectRBTreeMap.this.modified = false;
/* 1470 */       if (!in(k)) return this.defRetValue; 
/* 1471 */       V oldValue = Double2ObjectRBTreeMap.this.remove(k);
/* 1472 */       return Double2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1493 */       return Double2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> headMap(double to) {
/* 1498 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1499 */       return (Double2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> tailMap(double from) {
/* 1504 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1505 */       return (Double2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Double2ObjectSortedMap<V> subMap(double from, double to) {
/* 1510 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1511 */       if (!this.top) to = (Double2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1512 */       if (!this.bottom) from = (Double2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1523 */       if (Double2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1527 */       if (this.bottom) { e = Double2ObjectRBTreeMap.this.firstEntry; }
/*      */       else
/* 1529 */       { e = Double2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1531 */         if (Double2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1535 */       if (e == null || (!this.top && Double2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1536 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Double2ObjectRBTreeMap.Entry<V> e;
/* 1545 */       if (Double2ObjectRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1549 */       if (this.top) { e = Double2ObjectRBTreeMap.this.lastEntry; }
/*      */       else
/* 1551 */       { e = Double2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1553 */         if (Double2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1557 */       if (e == null || (!this.bottom && Double2ObjectRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1558 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public double firstDoubleKey() {
/* 1563 */       Double2ObjectRBTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1570 */       Double2ObjectRBTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1586 */         this.next = Double2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(double k) {
/* 1590 */         this();
/* 1591 */         if (this.next != null) {
/* 1592 */           if (!Double2ObjectRBTreeMap.Submap.this.bottom && Double2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1593 */           else if (!Double2ObjectRBTreeMap.Submap.this.top && Double2ObjectRBTreeMap.this.compare(k, (this.prev = Double2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1595 */           { this.next = Double2ObjectRBTreeMap.this.locateKey(k);
/* 1596 */             if (Double2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1607 */         if (!Double2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Double2ObjectRBTreeMap.this.compare(this.prev.key, Double2ObjectRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1612 */         this.next = this.next.next();
/* 1613 */         if (!Double2ObjectRBTreeMap.Submap.this.top && this.next != null && Double2ObjectRBTreeMap.this.compare(this.next.key, Double2ObjectRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1701 */       c = (Double2ObjectRBTreeMap<V>)super.clone();
...
/* 1774 */     if (n == 1) {
/* 1775 */       Entry<V> entry = new Entry<>(s.readDouble(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1784 */       Entry<V> entry = new Entry<>(s.readDouble(), (V)s.readObject());
/* 1785 */       entry.black(true);
/* 1786 */       entry.right(new Entry<>(s.readDouble(), (V)s.readObject()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\doubles\Double2ObjectRBTreeMap.class
