...
/*  50 */     return (entries instanceof Byte2DoubleMap.FastEntrySet) ? ((Byte2DoubleMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Byte2DoubleMap.Entry> entries = map.byte2DoubleEntrySet();
/*  66 */     if (entries instanceof Byte2DoubleMap.FastEntrySet) { ((Byte2DoubleMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Byte2DoubleMap.Entry> entries = map.byte2DoubleEntrySet();
/*  83 */     return (entries instanceof Byte2DoubleMap.FastEntrySet) ? new ObjectIterable<Byte2DoubleMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Byte2DoubleMap.Entry> iterator() {
/*  86 */           return ((Byte2DoubleMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Byte2DoubleMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Byte2DoubleMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractByte2DoubleMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)byte2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/*     */   
/*     */   public static Byte2DoubleMap singleton(Byte key, Double value) {
/* 316 */     return new Singleton(key.byteValue(), value.doubleValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Byte2DoubleFunctions.SynchronizedFunction implements Byte2DoubleMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2DoubleEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Double>> entrySet() {
/* 381 */       return (ObjectSet)byte2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/*     */     extends Byte2DoubleFunctions.UnmodifiableFunction implements Byte2DoubleMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2DoubleMap map;
/*     */     protected transient ObjectSet<Byte2DoubleMap.Entry> entries;
/*     */     protected transient ByteSet keys;
...
/*     */     
/*     */     public ObjectSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2DoubleEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Double>> entrySet() {
/* 712 */       return (ObjectSet)byte2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleMaps.class
