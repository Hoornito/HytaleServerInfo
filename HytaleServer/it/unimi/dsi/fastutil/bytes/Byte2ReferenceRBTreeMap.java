...
/*  820 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  930 */       if ((this.next = Byte2ReferenceRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Byte2ReferenceRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1046 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1056 */             Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1067 */             Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1068 */             if (f == null || f.getValue() != e.getValue()) return false; 
/* 1069 */             Byte2ReferenceRBTreeMap.this.remove(f.key);
/* 1070 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1075 */             return Byte2ReferenceRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1080 */             Byte2ReferenceRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> first() {
/* 1085 */             return Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> last() {
/* 1090 */             return Byte2ReferenceRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1095 */             return Byte2ReferenceRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1100 */             return Byte2ReferenceRBTreeMap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1105 */             return Byte2ReferenceRBTreeMap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1142 */       return new Byte2ReferenceRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1147 */       return new Byte2ReferenceRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1200 */             return (ObjectIterator<V>)new Byte2ReferenceRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1205 */             return Byte2ReferenceRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1210 */             return Byte2ReferenceRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1215 */             Byte2ReferenceRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1277 */       if (!bottom && !top && Byte2ReferenceRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1278 */       this.from = from;
/* 1279 */       this.bottom = bottom;
/* 1280 */       this.to = to;
/* 1281 */       this.top = top;
/* 1282 */       this.defRetValue = Byte2ReferenceRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1301 */       return ((this.bottom || Byte2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
/* 1306 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1309 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1314 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() {
/* 1319 */               return Byte2ReferenceRBTreeMap.this.byte2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1328 */               Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1329 */               return (f != null && Byte2ReferenceRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1338 */               Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1339 */               if (f != null && Byte2ReferenceRBTreeMap.Submap.this.in(f.key)) Byte2ReferenceRBTreeMap.Submap.this.remove(f.key); 
/* 1340 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1345 */               int c = 0;
/* 1346 */               for (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1347 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1352 */               return !(new Byte2ReferenceRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1357 */               Byte2ReferenceRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> first() {
/* 1362 */               return Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> last() {
/* 1367 */               return Byte2ReferenceRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1372 */               return Byte2ReferenceRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1377 */               return Byte2ReferenceRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1382 */               return Byte2ReferenceRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1391 */         return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1396 */         return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1411 */               return (ObjectIterator<V>)new Byte2ReferenceRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1416 */               return Byte2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1421 */               return Byte2ReferenceRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1426 */               Byte2ReferenceRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1436 */       return (in(k) && Byte2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1454 */       byte kk = k; Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1455 */       return (in(kk) && (e = Byte2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(byte k, V v) {
/* 1460 */       Byte2ReferenceRBTreeMap.this.modified = false;
...
/* 1462 */       V oldValue = Byte2ReferenceRBTreeMap.this.put(k, v);
/* 1463 */       return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1469 */       Byte2ReferenceRBTreeMap.this.modified = false;
/* 1470 */       if (!in(k)) return this.defRetValue; 
/* 1471 */       V oldValue = Byte2ReferenceRBTreeMap.this.remove(k);
/* 1472 */       return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1493 */       return Byte2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1498 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1499 */       return (Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1504 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1505 */       return (Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
/* 1510 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1511 */       if (!this.top) to = (Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1512 */       if (!this.bottom) from = (Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1523 */       if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1527 */       if (this.bottom) { e = Byte2ReferenceRBTreeMap.this.firstEntry; }
/*      */       else
/* 1529 */       { e = Byte2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1531 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1535 */       if (e == null || (!this.top && Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1536 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1545 */       if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1549 */       if (this.top) { e = Byte2ReferenceRBTreeMap.this.lastEntry; }
/*      */       else
/* 1551 */       { e = Byte2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1553 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1557 */       if (e == null || (!this.bottom && Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1558 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1563 */       Byte2ReferenceRBTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1570 */       Byte2ReferenceRBTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1586 */         this.next = Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1590 */         this();
/* 1591 */         if (this.next != null) {
/* 1592 */           if (!Byte2ReferenceRBTreeMap.Submap.this.bottom && Byte2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1593 */           else if (!Byte2ReferenceRBTreeMap.Submap.this.top && Byte2ReferenceRBTreeMap.this.compare(k, (this.prev = Byte2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1595 */           { this.next = Byte2ReferenceRBTreeMap.this.locateKey(k);
/* 1596 */             if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1607 */         if (!Byte2ReferenceRBTreeMap.Submap.this.bottom && this.prev != null && Byte2ReferenceRBTreeMap.this.compare(this.prev.key, Byte2ReferenceRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1612 */         this.next = this.next.next();
/* 1613 */         if (!Byte2ReferenceRBTreeMap.Submap.this.top && this.next != null && Byte2ReferenceRBTreeMap.this.compare(this.next.key, Byte2ReferenceRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1701 */       c = (Byte2ReferenceRBTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceRBTreeMap.class
