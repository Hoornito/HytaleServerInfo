...
/*  839 */       Map.Entry<Byte, Double> e = (Map.Entry<Byte, Double>)o;
/*  840 */       return (this.key == ((Byte)e.getKey()).byteValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Byte2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  950 */       if ((this.next = Byte2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Byte2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Byte2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2DoubleMap.Entry>)new AbstractObjectSortedSet<Byte2DoubleMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Byte2DoubleRBTreeMap.Entry f = Byte2DoubleRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1089 */             Byte2DoubleRBTreeMap.Entry f = Byte2DoubleRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1091 */             Byte2DoubleRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Byte2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Byte2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2DoubleMap.Entry first() {
/* 1107 */             return Byte2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2DoubleMap.Entry last() {
/* 1112 */             return Byte2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to) {
/* 1117 */             return Byte2DoubleRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to) {
/* 1122 */             return Byte2DoubleRBTreeMap.this.headMap(to.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from) {
/* 1127 */             return Byte2DoubleRBTreeMap.this.tailMap(from.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Byte2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1169 */       return new Byte2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (DoubleIterator)new Byte2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1227 */             return Byte2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Byte2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Byte2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Byte2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Byte2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Byte2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2DoubleMap.Entry>)new AbstractObjectSortedSet<Byte2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2DoubleMap.Entry> comparator() {
/* 1341 */               return Byte2DoubleRBTreeMap.this.byte2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Byte2DoubleRBTreeMap.Entry f = Byte2DoubleRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1352 */               return (f != null && Byte2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Byte2DoubleRBTreeMap.Entry f = Byte2DoubleRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1363 */               if (f != null && Byte2DoubleRBTreeMap.Submap.this.in(f.key)) Byte2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Byte2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Byte2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Byte2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2DoubleMap.Entry first() {
/* 1386 */               return Byte2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2DoubleMap.Entry last() {
/* 1391 */               return Byte2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to) {
/* 1396 */               return Byte2DoubleRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to) {
/* 1401 */               return Byte2DoubleRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from) {
/* 1406 */               return Byte2DoubleRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1415 */         return new Byte2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1420 */         return new Byte2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1435 */               return (DoubleIterator)new Byte2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1440 */               return Byte2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Byte2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Byte2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1460 */       return (in(k) && Byte2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(byte k) {
/* 1478 */       byte kk = k; Byte2DoubleRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Byte2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(byte k, double v) {
/* 1484 */       Byte2DoubleRBTreeMap.this.modified = false;
...
/* 1486 */       double oldValue = Byte2DoubleRBTreeMap.this.put(k, v);
/* 1487 */       return Byte2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(byte k) {
/* 1493 */       Byte2DoubleRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       double oldValue = Byte2DoubleRBTreeMap.this.remove(k);
/* 1496 */       return Byte2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1517 */       return Byte2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap headMap(byte to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Byte2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap tailMap(byte from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Byte2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap subMap(byte from, byte to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Byte2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Byte2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Byte2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Byte2DoubleRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Byte2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Byte2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Byte2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2DoubleRBTreeMap.Entry e;
/* 1569 */       if (Byte2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Byte2DoubleRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Byte2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Byte2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Byte2DoubleRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1587 */       Byte2DoubleRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1594 */       Byte2DoubleRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Byte2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Byte2DoubleRBTreeMap.Submap.this.bottom && Byte2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Byte2DoubleRBTreeMap.Submap.this.top && Byte2DoubleRBTreeMap.this.compare(k, (this.prev = Byte2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Byte2DoubleRBTreeMap.this.locateKey(k);
/* 1620 */             if (Byte2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Byte2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Byte2DoubleRBTreeMap.this.compare(this.prev.key, Byte2DoubleRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Byte2DoubleRBTreeMap.Submap.this.top && this.next != null && Byte2DoubleRBTreeMap.this.compare(this.next.key, Byte2DoubleRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Byte2DoubleRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readByte(), s.readDouble());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readByte(), s.readDouble());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readByte(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleRBTreeMap.class
