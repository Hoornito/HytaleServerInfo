...
/*  89 */     this(refArray, refArray.length, (ByteComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */     byte first = this.refArray[this.array[firstIndex]];
...
/* 170 */     int i = this.size;
/* 171 */     int lastIndex = --i;
/* 172 */     byte last = this.refArray[this.array[lastIndex]];
/* 173 */     if (this.c == null)
...
/* 287 */     byte top = this.refArray[this.array[findFirst()]];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\ByteArrayIndirectPriorityQueue.class
