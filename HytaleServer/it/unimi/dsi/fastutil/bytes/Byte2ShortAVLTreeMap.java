...
/*  885 */       Map.Entry<Byte, Short> e = (Map.Entry<Byte, Short>)o;
/*  886 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Byte2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  998 */       if ((this.next = Byte2ShortAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Byte2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ShortMap.Entry>)new AbstractObjectSortedSet<Byte2ShortMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1147 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1148 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1149 */             Byte2ShortAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Byte2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Byte2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ShortMap.Entry first() {
/* 1165 */             return Byte2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ShortMap.Entry last() {
/* 1170 */             return Byte2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) {
/* 1175 */             return Byte2ShortAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) {
/* 1180 */             return Byte2ShortAVLTreeMap.this.headMap(to.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) {
/* 1185 */             return Byte2ShortAVLTreeMap.this.tailMap(from.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Byte2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1227 */       return new Byte2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ShortIterator)new Byte2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1285 */             return Byte2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Byte2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Byte2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Byte2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Byte2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Byte2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ShortMap.Entry>)new AbstractObjectSortedSet<Byte2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2ShortMap.Entry> comparator() {
/* 1399 */               return Byte2ShortAVLTreeMap.this.byte2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1410 */               return (f != null && Byte2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1421 */               if (f != null && Byte2ShortAVLTreeMap.Submap.this.in(f.key)) Byte2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Byte2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Byte2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ShortMap.Entry first() {
/* 1444 */               return Byte2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ShortMap.Entry last() {
/* 1449 */               return Byte2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) {
/* 1454 */               return Byte2ShortAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) {
/* 1459 */               return Byte2ShortAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) {
/* 1464 */               return Byte2ShortAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1473 */         return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1478 */         return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1493 */               return (ShortIterator)new Byte2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1498 */               return Byte2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Byte2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1518 */       return (in(k) && Byte2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(byte k) {
/* 1536 */       byte kk = k; Byte2ShortAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Byte2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(byte k, short v) {
/* 1542 */       Byte2ShortAVLTreeMap.this.modified = false;
...
/* 1544 */       short oldValue = Byte2ShortAVLTreeMap.this.put(k, v);
/* 1545 */       return Byte2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(byte k) {
/* 1551 */       Byte2ShortAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       short oldValue = Byte2ShortAVLTreeMap.this.remove(k);
/* 1554 */       return Byte2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1575 */       return Byte2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ShortSortedMap headMap(byte to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ShortSortedMap tailMap(byte from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ShortSortedMap subMap(byte from, byte to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Byte2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Byte2ShortAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Byte2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2ShortAVLTreeMap.Entry e;
/* 1627 */       if (Byte2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Byte2ShortAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Byte2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1645 */       Byte2ShortAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1652 */       Byte2ShortAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Byte2ShortAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Byte2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Byte2ShortAVLTreeMap.Submap.this.bottom && Byte2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Byte2ShortAVLTreeMap.Submap.this.top && Byte2ShortAVLTreeMap.this.compare(k, (this.prev = Byte2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Byte2ShortAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Byte2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ShortAVLTreeMap.this.compare(this.prev.key, Byte2ShortAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Byte2ShortAVLTreeMap.Submap.this.top && this.next != null && Byte2ShortAVLTreeMap.this.compare(this.next.key, Byte2ShortAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Byte2ShortAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readByte(), s.readShort());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readByte(), s.readShort());
/* 1866 */       entry.right(new Entry(s.readByte(), s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortAVLTreeMap.class
