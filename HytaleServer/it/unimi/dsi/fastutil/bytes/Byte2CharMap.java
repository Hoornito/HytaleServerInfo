...
/* 150 */     return (ObjectSet)byte2CharEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = byte2CharEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Byte.valueOf(entry.getByteKey()), Character.valueOf(entry.getCharValue()));
...
/* 502 */     Character newValue = remappingFunction.apply(Byte.valueOf(key), Character.valueOf(oldValue));
...
/* 534 */     Character newValue = remappingFunction.apply(Byte.valueOf(key), contained ? Character.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharMap.class
