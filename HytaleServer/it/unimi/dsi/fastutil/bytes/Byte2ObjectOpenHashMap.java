...
/*  559 */       return Byte2ObjectOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  564 */       return Byte2ObjectOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  569 */       return Byte2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  574 */       return Byte2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  579 */       V oldValue = Byte2ObjectOpenHashMap.this.value[this.index];
/*  580 */       Byte2ObjectOpenHashMap.this.value[this.index] = v;
/*  581 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteObjectPair<V> right(V v) {
/*  586 */       Byte2ObjectOpenHashMap.this.value[this.index] = v;
/*  587 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  598 */       return Byte.valueOf(Byte2ObjectOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  606 */       return (Byte2ObjectOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Objects.equals(Byte2ObjectOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  611 */       return Byte2ObjectOpenHashMap.this.key[this.index] ^ ((Byte2ObjectOpenHashMap.this.value[this.index] == null) ? 0 : Byte2ObjectOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  616 */       return Byte2ObjectOpenHashMap.this.key[this.index] + "=>" + Byte2ObjectOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  627 */     int pos = Byte2ObjectOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  633 */     int last = -1;
/*      */     
/*  635 */     int c = Byte2ObjectOpenHashMap.this.size;
/*      */     
/*  637 */     boolean mustReturnNullKey = Byte2ObjectOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  656 */         return this.last = Byte2ObjectOpenHashMap.this.n;
/*      */       } 
/*  658 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
/*      */       while (true) {
/*  660 */         if (--this.pos < 0) {
/*      */           
/*  662 */           this.last = Integer.MIN_VALUE;
/*  663 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  664 */           int p = HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask;
/*  665 */           for (; k != key[p]; p = p + 1 & Byte2ObjectOpenHashMap.this.mask);
/*  666 */           return p;
/*      */         } 
...
/*  675 */         acceptOnIndex(action, this.last = Byte2ObjectOpenHashMap.this.n);
/*  676 */         this.c--;
/*      */       } 
/*  678 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
/*  679 */       while (this.c != 0) {
/*  680 */         if (--this.pos < 0) {
/*      */           
/*  682 */           this.last = Integer.MIN_VALUE;
/*  683 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  684 */           int p = HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask;
/*  685 */           for (; k != key[p]; p = p + 1 & Byte2ObjectOpenHashMap.this.mask);
...
/*  705 */       byte[] key = Byte2ObjectOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  707 */         pos = (last = pos) + 1 & Byte2ObjectOpenHashMap.this.mask;
/*      */         while (true) {
/*  709 */           if ((curr = key[pos]) == 0) {
/*  710 */             key[last] = 0;
/*  711 */             Byte2ObjectOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  714 */           int slot = HashCommon.mix(curr) & Byte2ObjectOpenHashMap.this.mask;
/*  715 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  716 */             break;  pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask;
/*      */         } 
/*  718 */         if (pos < last) {
...
/*      */         } 
/*  722 */         key[last] = curr;
/*  723 */         Byte2ObjectOpenHashMap.this.value[last] = Byte2ObjectOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  728 */       if (this.last == -1) throw new IllegalStateException(); 
/*  729 */       if (this.last == Byte2ObjectOpenHashMap.this.n)
/*  730 */       { Byte2ObjectOpenHashMap.this.containsNullKey = false;
/*  731 */         Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n] = null; }
/*  732 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  735 */       { Byte2ObjectOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  736 */         this.last = -1;
/*      */         return; }
/*      */       
/*  739 */       Byte2ObjectOpenHashMap.this.size--;
/*  740 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2ObjectMap.Entry<V>>> implements ObjectIterator<Byte2ObjectMap.Entry<V>> { public Byte2ObjectOpenHashMap<V>.MapEntry next() {
/*  756 */       return this.entry = new Byte2ObjectOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  762 */       action.accept(this.entry = new Byte2ObjectOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  773 */       this.entry = new Byte2ObjectOpenHashMap.MapEntry();
/*      */     }
...
/*  794 */     int pos = 0;
/*      */     
/*  796 */     int max = Byte2ObjectOpenHashMap.this.n;
/*      */     
/*  798 */     int c = 0;
/*      */     
/*  800 */     boolean mustReturnNull = Byte2ObjectOpenHashMap.this.containsNullKey;
/*      */     
...
/*  820 */         this.c++;
/*  821 */         acceptOnIndex(action, Byte2ObjectOpenHashMap.this.n);
/*  822 */         return true;
/*      */       } 
/*  824 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
...
/*  839 */         this.c++;
/*  840 */         acceptOnIndex(action, Byte2ObjectOpenHashMap.this.n);
/*      */       } 
/*  842 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
...
/*      */       {
/*  855 */         return (Byte2ObjectOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  860 */       return Math.min((Byte2ObjectOpenHashMap.this.size - this.c), (long)(Byte2ObjectOpenHashMap.this.realSize() / Byte2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  888 */         n--;
/*      */       } 
/*  890 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2ObjectMap.Entry<V>> action, int index) {
/*  918 */       action.accept(new Byte2ObjectOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  930 */       return new Byte2ObjectOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
/*  935 */       return new Byte2ObjectOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2ObjectMap.Entry<V>> spliterator() {
/*  940 */       return new Byte2ObjectOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  952 */       if (k == 0) return (Byte2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n], v));
/*      */       
/*  954 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  957 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask]) == 0) return false; 
/*  958 */       if (k == curr) return Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  961 */         if ((curr = key[pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask]) == 0) return false; 
/*  962 */         if (k == curr) return Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  974 */       if (k == 0) {
/*  975 */         if (Byte2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n], v)) {
/*  976 */           Byte2ObjectOpenHashMap.this.removeNullEntry();
/*  977 */           return true;
/*      */         } 
/*  979 */         return false;
/*      */       } 
/*      */       
/*  982 */       byte[] key = Byte2ObjectOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  985 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask]) == 0) return false; 
/*  986 */       if (curr == k) {
/*  987 */         if (Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v)) {
/*  988 */           Byte2ObjectOpenHashMap.this.removeEntry(pos);
/*  989 */           return true;
/*      */         } 
/*  991 */         return false;
/*      */       } 
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask]) == 0) return false; 
/*  995 */         if (curr == k && 
/*  996 */           Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v)) {
/*  997 */           Byte2ObjectOpenHashMap.this.removeEntry(pos);
/*  998 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1006 */       return Byte2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1011 */       Byte2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
/* 1017 */       if (Byte2ObjectOpenHashMap.this.containsNullKey) consumer.accept(new Byte2ObjectOpenHashMap.MapEntry(Byte2ObjectOpenHashMap.this.n)); 
/* 1018 */       for (int pos = Byte2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenHashMap.this.key[pos] != 0) consumer.accept(new Byte2ObjectOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
/* 1024 */       Byte2ObjectOpenHashMap<V>.MapEntry entry = new Byte2ObjectOpenHashMap.MapEntry();
/* 1025 */       if (Byte2ObjectOpenHashMap.this.containsNullKey) {
/* 1026 */         entry.index = Byte2ObjectOpenHashMap.this.n;
/* 1027 */         consumer.accept(entry);
/*      */       } 
/* 1029 */       for (int pos = Byte2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenHashMap.this.key[pos] != 0) {
...
/* 1060 */       action.accept(Byte2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1065 */       return Byte2ObjectOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1086 */       action.accept(Byte2ObjectOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1098 */       return new Byte2ObjectOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1103 */       return new Byte2ObjectOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1109 */       if (Byte2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Byte2ObjectOpenHashMap.this.key[Byte2ObjectOpenHashMap.this.n]); 
/* 1110 */       for (int pos = Byte2ObjectOpenHashMap.this.n; pos-- != 0; ) {
/* 1111 */         byte k = Byte2ObjectOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1118 */       return Byte2ObjectOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1123 */       return Byte2ObjectOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1128 */       int oldSize = Byte2ObjectOpenHashMap.this.size;
/* 1129 */       Byte2ObjectOpenHashMap.this.remove(k);
/* 1130 */       return (Byte2ObjectOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1135 */       Byte2ObjectOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1163 */       action.accept(Byte2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1168 */       return Byte2ObjectOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1189 */       action.accept(Byte2ObjectOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1203 */             return new Byte2ObjectOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1208 */             return new Byte2ObjectOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1214 */             if (Byte2ObjectOpenHashMap.this.containsNullKey) consumer.accept(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n]); 
/* 1215 */             for (int pos = Byte2ObjectOpenHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenHashMap.this.key[pos] != 0) consumer.accept(Byte2ObjectOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1220 */             return Byte2ObjectOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1225 */             return Byte2ObjectOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1230 */             Byte2ObjectOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1328 */       c = (Byte2ObjectOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectOpenHashMap.class
