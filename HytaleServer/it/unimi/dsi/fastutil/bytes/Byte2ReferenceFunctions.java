...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Byte2ReferenceFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Byte2ReferenceFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static <V> Byte2ReferenceFunction<V> singleton(Byte key, V value) {
/* 179 */     return new Singleton<>(key.byteValue(), value);
/*     */   }
/*     */   
...
/*     */     
/*     */     protected UnmodifiableFunction(Byte2ReferenceFunction<? extends V> f) {
...
/* 540 */       return (this.function.apply(Byte.valueOf(key)) != null);
/*     */     }
/*     */ 
/*     */     
/*     */     @Deprecated
...
/* 547 */       return (this.function.apply((Byte)key) != null);
/*     */     }
/*     */ 
/*     */     
/*     */     public V get(byte key) {
/* 552 */       V v = this.function.apply(Byte.valueOf(key));
...
/* 559 */       V v = this.function.apply(Byte.valueOf(key));
...
/* 568 */       return this.function.apply((Byte)key);
/*     */     }
/*     */ 
/*     */     
/*     */     @Deprecated
...
/*     */       V v;
/* 576 */       return ((v = this.function.apply((Byte)key)) == null) ? defaultValue : v;
/*     */     }
/*     */ 
/*     */     
/*     */     @Deprecated
...
/* 605 */     if (f instanceof Byte2ReferenceFunction) return (Byte2ReferenceFunction)f; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceFunctions.class
