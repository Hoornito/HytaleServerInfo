...
/* 150 */     return (ObjectSet)byte2LongEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = byte2LongEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Byte.valueOf(entry.getByteKey()), Long.valueOf(entry.getLongValue()));
...
/* 502 */     Long newValue = remappingFunction.apply(Byte.valueOf(key), Long.valueOf(oldValue));
...
/* 534 */     Long newValue = remappingFunction.apply(Byte.valueOf(key), contained ? Long.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2LongMap.class
