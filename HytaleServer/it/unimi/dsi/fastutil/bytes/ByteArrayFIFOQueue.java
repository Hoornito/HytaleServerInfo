...
/*     */ 
/*     */     
/*  64 */     this.array = new byte[Math.max(1, capacity + 1)];
...
/*  86 */     byte t = this.array[this.start];
...
/* 101 */     byte t = this.array[--this.end];
/* 102 */     reduce();
/* 103 */     return t;
/*     */   }
/*     */   
/*     */   private final void resize(int size, int newLength) {
/* 107 */     byte[] newArray = new byte[newLength];
...
/*     */   public void trim() {
/* 167 */     int size = size();
/* 168 */     byte[] newArray = new byte[size + 1];
...
/* 198 */     this.array = new byte[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 199 */     for (int i = 0; i < this.end; ) { this.array[i] = s.readByte(); i++; }
/*     */   
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\ByteArrayFIFOQueue.class
