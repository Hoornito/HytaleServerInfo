...
/*  519 */     Long newValue = remappingFunction.apply(Byte.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  532 */     int pos = find(k);
/*  533 */     Long newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  611 */       return Byte2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  616 */       return Byte2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  621 */       return Byte2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  626 */       return Byte2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  631 */       long oldValue = Byte2LongOpenHashMap.this.value[this.index];
/*  632 */       Byte2LongOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteLongPair right(long v) {
/*  638 */       Byte2LongOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  650 */       return Byte.valueOf(Byte2LongOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Long.valueOf(Byte2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Byte, Long> e = (Map.Entry<Byte, Long>)o;
/*  680 */       return (Byte2LongOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Byte2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Byte2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Byte2LongOpenHashMap.this.key[this.index] + "=>" + Byte2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Byte2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Byte2LongOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Byte2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Byte2LongOpenHashMap.this.n;
/*      */       } 
/*  732 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Byte2LongOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
...
/*  749 */         acceptOnIndex(action, this.last = Byte2LongOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Byte2LongOpenHashMap.this.mask);
...
/*  779 */       byte[] key = Byte2LongOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  781 */         pos = (last = pos) + 1 & Byte2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == 0) {
/*  784 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Byte2LongOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Byte2LongOpenHashMap.this.value[last] = Byte2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Byte2LongOpenHashMap.this.n)
/*  803 */       { Byte2LongOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Byte2LongOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Byte2LongOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2LongMap.Entry>> implements ObjectIterator<Byte2LongMap.Entry> { public Byte2LongOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Byte2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  834 */       action.accept(this.entry = new Byte2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Byte2LongOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Byte2LongOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Byte2LongOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Byte2LongOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       byte[] key = Byte2LongOpenHashMap.this.key;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Byte2LongOpenHashMap.this.n);
/*      */       } 
/*  914 */       byte[] key = Byte2LongOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Byte2LongOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Byte2LongOpenHashMap.this.size - this.c), (long)(Byte2LongOpenHashMap.this.realSize() / Byte2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       byte[] key = Byte2LongOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2LongMap.Entry> action, int index) {
/*  990 */       action.accept(new Byte2LongOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Byte2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2LongMap.Entry> fastIterator() {
/* 1007 */       return new Byte2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2LongMap.Entry> spliterator() {
/* 1012 */       return new Byte2LongOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */       if (k == 0) return (Byte2LongOpenHashMap.this.containsNullKey && Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n] == v);
/*      */       
/* 1027 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1031 */       if (k == curr) return (Byte2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Byte2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1035 */         if (k == curr) return (Byte2LongOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == 0) {
/* 1049 */         if (Byte2LongOpenHashMap.this.containsNullKey && Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n] == v) {
/* 1050 */           Byte2LongOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Byte2LongOpenHashMap.this.value[pos] == v) {
/* 1062 */           Byte2LongOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Byte2LongOpenHashMap.this.mask]) == 0) return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Byte2LongOpenHashMap.this.value[pos] == v) {
/* 1071 */           Byte2LongOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Byte2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Byte2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
/* 1091 */       if (Byte2LongOpenHashMap.this.containsNullKey) consumer.accept(new Byte2LongOpenHashMap.MapEntry(Byte2LongOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) { if (Byte2LongOpenHashMap.this.key[pos] != 0) consumer.accept(new Byte2LongOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2LongMap.Entry> consumer) {
/* 1098 */       Byte2LongOpenHashMap.MapEntry entry = new Byte2LongOpenHashMap.MapEntry();
/* 1099 */       if (Byte2LongOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Byte2LongOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) { if (Byte2LongOpenHashMap.this.key[pos] != 0) {
...
/* 1134 */       action.accept(Byte2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1139 */       return Byte2LongOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1160 */       action.accept(Byte2LongOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Byte2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1177 */       return new Byte2LongOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1183 */       if (Byte2LongOpenHashMap.this.containsNullKey) consumer.accept(Byte2LongOpenHashMap.this.key[Byte2LongOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         byte k = Byte2LongOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1192 */       return Byte2LongOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1197 */       return Byte2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1202 */       int oldSize = Byte2LongOpenHashMap.this.size;
/* 1203 */       Byte2LongOpenHashMap.this.remove(k);
/* 1204 */       return (Byte2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Byte2LongOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Byte2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1242 */       return Byte2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1263 */       action.accept(Byte2LongOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Byte2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1282 */             return new Byte2LongOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1288 */             if (Byte2LongOpenHashMap.this.containsNullKey) consumer.accept(Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) { if (Byte2LongOpenHashMap.this.key[pos] != 0) consumer.accept(Byte2LongOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Byte2LongOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1299 */             return Byte2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Byte2LongOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1402 */       c = (Byte2LongOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2LongOpenHashMap.class
