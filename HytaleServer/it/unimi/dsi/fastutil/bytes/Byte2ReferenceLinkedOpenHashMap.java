...
/*  150 */     this.key = new byte[this.n + 1];
...
/*  682 */     byte[] key = this.key;
/*  683 */     if (this.containsNullKey && value[this.n] == v) return true; 
/*  684 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0 && value[i] == v) return true;  }
/*  685 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  793 */     V newValue = remappingFunction.apply(Byte.valueOf(k), this.value[pos]);
...
/*  806 */     int pos = find(k);
/*  807 */     V newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? this.value[pos] : null);
...
/*  854 */     Arrays.fill(this.key, (byte)0);
...
/*  887 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  892 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  908 */       Byte2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteReferencePair<V> right(V v) {
/*  914 */       Byte2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  926 */       return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  933 */       Map.Entry<Byte, V> e = (Map.Entry<Byte, V>)o;
/*  934 */       return (Byte2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] ^ ((Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Byte2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Byte2ReferenceLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(byte from) {
/* 1117 */       if (from == 0) {
/* 1118 */         if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[Byte2ReferenceLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Byte2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last] == from) {
/* 1125 */         this.prev = Byte2ReferenceLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = HashCommon.mix(from) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Byte2ReferenceLinkedOpenHashMap.this.key[pos] != 0) {
/* 1133 */         if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1135 */           this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Byte2ReferenceLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Byte2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Byte2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] = Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Byte2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Byte2ReferenceLinkedOpenHashMap.this.link[this.next] = Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Byte2ReferenceLinkedOpenHashMap.this.n) {
/* 1227 */         Byte2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           byte curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if ((curr = key[pos]) == 0) {
/* 1237 */               key[last] = 0;
/* 1238 */               Byte2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = HashCommon.mix(curr) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Byte2ReferenceLinkedOpenHashMap.this.value[last] = Byte2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Byte2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2ReferenceMap.Entry<V>>> implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
...
/* 1288 */       action.accept(new Byte2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Byte2ReferenceMap.Entry<V>>> implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
/* 1309 */     final Byte2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Byte2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceMap.Entry<V> last() {
/* 1392 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1401 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1402 */       byte k = ((Byte)e.getKey()).byteValue();
/* 1403 */       V v = (V)e.getValue();
/* 1404 */       if (k == 0) return (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey && Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1406 */       byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1410 */       if (k == curr) return (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1413 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1414 */         if (k == curr) return (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1423 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1424 */       byte k = ((Byte)e.getKey()).byteValue();
/* 1425 */       V v = (V)e.getValue();
/* 1426 */       if (k == 0) {
/* 1427 */         if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey && Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1428 */           Byte2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1437 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1438 */       if (curr == k) {
/* 1439 */         if (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1440 */           Byte2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1447 */         if (curr == k && 
/* 1448 */           Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1449 */           Byte2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Byte2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Byte2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Byte2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1563 */       return Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteListIterator iterator() {
/* 1577 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return ByteSpliterators.asSpliterator(iterator(), Size64.sizeOf(Byte2ReferenceLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1593 */       for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1607 */       return Byte2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1612 */       int oldSize = Byte2ReferenceLinkedOpenHashMap.this.size;
/* 1613 */       Byte2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Byte2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByte() {
/* 1624 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte lastByte() {
/* 1630 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Byte2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Byte2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Byte2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Byte2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Byte2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Byte2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1799 */     byte[] key = this.key;
/* 1800 */     V[] value = this.value;
/* 1801 */     int mask = newN - 1;
/* 1802 */     byte[] newKey = new byte[newN + 1];
...
/*      */     Byte2ReferenceLinkedOpenHashMap<V> c;
/*      */     try {
/* 1855 */       c = (Byte2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1863 */     c.key = (byte[])this.key.clone();
...
/* 1911 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1919 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceLinkedOpenHashMap.class
