...
/* 164 */     return (ObjectSet)byte2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 256 */     ObjectSet<Entry<V>> entrySet = byte2ReferenceEntrySet();
/* 257 */     Consumer<Entry<V>> wrappingConsumer = entry -> consumer.accept(Byte.valueOf(entry.getByteKey()), entry.getValue());
...
/* 468 */     V newValue = remappingFunction.apply(Byte.valueOf(key), oldValue);
...
/* 499 */     V newValue = remappingFunction.apply(Byte.valueOf(key), contained ? oldValue : null);
...
/*     */     @Deprecated
/*     */     default Byte getKey() {
/* 568 */       return Byte.valueOf(getByteKey());
/*     */     }
/*     */     
/*     */     byte getByteKey();
/*     */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceMap.class
