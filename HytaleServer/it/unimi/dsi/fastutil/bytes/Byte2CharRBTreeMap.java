...
/*  839 */       Map.Entry<Byte, Character> e = (Map.Entry<Byte, Character>)o;
/*  840 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Byte2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  950 */       if ((this.next = Byte2CharRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Byte2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Byte2CharRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1089 */             Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1090 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1091 */             Byte2CharRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Byte2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Byte2CharRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2CharMap.Entry first() {
/* 1107 */             return Byte2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2CharMap.Entry last() {
/* 1112 */             return Byte2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1117 */             return Byte2CharRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1122 */             return Byte2CharRBTreeMap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1127 */             return Byte2CharRBTreeMap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Byte2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1169 */       return new Byte2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (CharIterator)new Byte2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1227 */             return Byte2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Byte2CharRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Byte2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Byte2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Byte2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Byte2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2CharRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2CharMap.Entry> comparator() {
/* 1341 */               return Byte2CharRBTreeMap.this.byte2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1352 */               return (f != null && Byte2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1363 */               if (f != null && Byte2CharRBTreeMap.Submap.this.in(f.key)) Byte2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Byte2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Byte2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Byte2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2CharMap.Entry first() {
/* 1386 */               return Byte2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2CharMap.Entry last() {
/* 1391 */               return Byte2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1396 */               return Byte2CharRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1401 */               return Byte2CharRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1406 */               return Byte2CharRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1415 */         return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1420 */         return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1435 */               return (CharIterator)new Byte2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1440 */               return Byte2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Byte2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Byte2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1460 */       return (in(k) && Byte2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(byte k) {
/* 1478 */       byte kk = k; Byte2CharRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Byte2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(byte k, char v) {
/* 1484 */       Byte2CharRBTreeMap.this.modified = false;
...
/* 1486 */       char oldValue = Byte2CharRBTreeMap.this.put(k, v);
/* 1487 */       return Byte2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(byte k) {
/* 1493 */       Byte2CharRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       char oldValue = Byte2CharRBTreeMap.this.remove(k);
/* 1496 */       return Byte2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1517 */       return Byte2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharSortedMap headMap(byte to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Byte2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharSortedMap tailMap(byte from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Byte2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharSortedMap subMap(byte from, byte to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Byte2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Byte2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Byte2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Byte2CharRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Byte2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Byte2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Byte2CharRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2CharRBTreeMap.Entry e;
/* 1569 */       if (Byte2CharRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Byte2CharRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Byte2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Byte2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Byte2CharRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1587 */       Byte2CharRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1594 */       Byte2CharRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Byte2CharRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Byte2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Byte2CharRBTreeMap.Submap.this.bottom && Byte2CharRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Byte2CharRBTreeMap.Submap.this.top && Byte2CharRBTreeMap.this.compare(k, (this.prev = Byte2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Byte2CharRBTreeMap.this.locateKey(k);
/* 1620 */             if (Byte2CharRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Byte2CharRBTreeMap.Submap.this.bottom && this.prev != null && Byte2CharRBTreeMap.this.compare(this.prev.key, Byte2CharRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Byte2CharRBTreeMap.Submap.this.top && this.next != null && Byte2CharRBTreeMap.this.compare(this.next.key, Byte2CharRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Byte2CharRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readByte(), s.readChar());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readByte(), s.readChar());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readByte(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharRBTreeMap.class
