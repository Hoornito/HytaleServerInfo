...
/*  61 */     return (entries instanceof Byte2IntSortedMap.FastSortedEntrySet) ? ((Byte2IntSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Byte2IntMap.Entry> entries = map.byte2IntEntrySet();
/*  77 */     Objects.requireNonNull((Byte2IntSortedMap.FastSortedEntrySet)entries); return (entries instanceof Byte2IntSortedMap.FastSortedEntrySet) ? (Byte2IntSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Byte2IntMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Byte2IntMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Byte, Integer>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2IntSortedMap headMap(byte to) {
/* 125 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2IntSortedMap tailMap(byte from) {
/* 130 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Byte2IntMap.Entry>)ObjectSortedSets.singleton(new AbstractByte2IntMap.BasicEntry(this.key, this.value), Byte2IntSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Byte2IntMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Integer>> entrySet() {
/* 248 */       return (ObjectSortedSet)byte2IntEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 260 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2IntSortedMap headMap(byte to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2IntSortedMap tailMap(byte from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Byte2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public byte firstByteKey() {
...
/* 369 */     return new Singleton(key.byteValue(), value.intValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Byte2IntMaps.SynchronizedMap implements Byte2IntSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Byte2IntMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.byte2IntEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Byte2IntMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Integer>> entrySet() {
/* 440 */       return (ObjectSortedSet)byte2IntEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/*     */     extends Byte2IntMaps.UnmodifiableMap implements Byte2IntSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2IntSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Byte2IntMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.byte2IntEntrySet()); 
/* 581 */       return (ObjectSortedSet<Byte2IntMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2IntSortedMaps.class
