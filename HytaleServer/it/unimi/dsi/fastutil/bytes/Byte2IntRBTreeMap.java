...
/*  839 */       Map.Entry<Byte, Integer> e = (Map.Entry<Byte, Integer>)o;
/*  840 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Byte2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  950 */       if ((this.next = Byte2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Byte2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Byte2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2IntMap.Entry>)new AbstractObjectSortedSet<Byte2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Byte2IntMap.Entry>)new Byte2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Byte2IntMap.Entry>)new Byte2IntRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1089 */             Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Byte2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Byte2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Byte2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2IntMap.Entry first() {
/* 1107 */             return Byte2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2IntMap.Entry last() {
/* 1112 */             return Byte2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to) {
/* 1117 */             return Byte2IntRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to) {
/* 1122 */             return Byte2IntRBTreeMap.this.headMap(to.getByteKey()).byte2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from) {
/* 1127 */             return Byte2IntRBTreeMap.this.tailMap(from.getByteKey()).byte2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Byte2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1169 */       return new Byte2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (IntIterator)new Byte2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Byte2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Byte2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Byte2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Byte2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Byte2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Byte2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2IntMap.Entry>)new AbstractObjectSortedSet<Byte2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Byte2IntMap.Entry>)new Byte2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Byte2IntMap.Entry>)new Byte2IntRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2IntMap.Entry> comparator() {
/* 1341 */               return Byte2IntRBTreeMap.this.byte2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1352 */               return (f != null && Byte2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1363 */               if (f != null && Byte2IntRBTreeMap.Submap.this.in(f.key)) Byte2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Byte2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Byte2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Byte2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2IntMap.Entry first() {
/* 1386 */               return Byte2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2IntMap.Entry last() {
/* 1391 */               return Byte2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to) {
/* 1396 */               return Byte2IntRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to) {
/* 1401 */               return Byte2IntRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from) {
/* 1406 */               return Byte2IntRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2IntEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractByte2IntSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1415 */         return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1420 */         return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Byte2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Byte2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Byte2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Byte2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1460 */       return (in(k) && Byte2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(byte k) {
/* 1478 */       byte kk = k; Byte2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Byte2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(byte k, int v) {
/* 1484 */       Byte2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Byte2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Byte2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(byte k) {
/* 1493 */       Byte2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Byte2IntRBTreeMap.this.remove(k);
/* 1496 */       return Byte2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1517 */       return Byte2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2IntSortedMap headMap(byte to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Byte2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2IntSortedMap tailMap(byte from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Byte2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2IntSortedMap subMap(byte from, byte to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Byte2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Byte2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Byte2IntRBTreeMap.Entry e;
/* 1547 */       if (Byte2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Byte2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Byte2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Byte2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2IntRBTreeMap.Entry e;
/* 1569 */       if (Byte2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Byte2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Byte2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Byte2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1587 */       Byte2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1594 */       Byte2IntRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Byte2IntRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Byte2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Byte2IntRBTreeMap.Submap.this.bottom && Byte2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Byte2IntRBTreeMap.Submap.this.top && Byte2IntRBTreeMap.this.compare(k, (this.prev = Byte2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Byte2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Byte2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Byte2IntRBTreeMap.Submap.this.bottom && this.prev != null && Byte2IntRBTreeMap.this.compare(this.prev.key, Byte2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Byte2IntRBTreeMap.Submap.this.top && this.next != null && Byte2IntRBTreeMap.this.compare(this.next.key, Byte2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Byte2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     Byte2IntRBTreeMap c;
/*      */     try {
/* 1725 */       c = (Byte2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readByte(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readByte(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readByte(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2IntRBTreeMap.class
