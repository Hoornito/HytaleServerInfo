...
/*  520 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  581 */     Arrays.fill(this.key, (byte)0);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  612 */       return Byte2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  617 */       return Byte2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  622 */       return Byte2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  627 */       return Byte2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  632 */       float oldValue = Byte2FloatOpenHashMap.this.value[this.index];
/*  633 */       Byte2FloatOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteFloatPair right(float v) {
/*  639 */       Byte2FloatOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  651 */       return Byte.valueOf(Byte2FloatOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Float.valueOf(Byte2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Byte, Float> e = (Map.Entry<Byte, Float>)o;
/*  681 */       return (Byte2FloatOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return Byte2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Byte2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Byte2FloatOpenHashMap.this.key[this.index] + "=>" + Byte2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Byte2FloatOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Byte2FloatOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Byte2FloatOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Byte2FloatOpenHashMap.this.n;
/*      */       } 
/*  733 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Byte2FloatOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Byte2FloatOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Byte2FloatOpenHashMap.this.mask);
...
/*  780 */       byte[] key = Byte2FloatOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  782 */         pos = (last = pos) + 1 & Byte2FloatOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == 0) {
/*  785 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(curr) & Byte2FloatOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
/*  793 */           if (this.wrapped == null) this.wrapped = new ByteArrayList(2); 
/*  794 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Byte2FloatOpenHashMap.this.value[last] = Byte2FloatOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Byte2FloatOpenHashMap.this.n)
/*  804 */       { Byte2FloatOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Byte2FloatOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Byte2FloatOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2FloatMap.Entry>> implements ObjectIterator<Byte2FloatMap.Entry> { public Byte2FloatOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Byte2FloatOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Byte2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Byte2FloatOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Byte2FloatOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Byte2FloatOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Byte2FloatOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       byte[] key = Byte2FloatOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Byte2FloatOpenHashMap.this.n);
/*      */       } 
/*  915 */       byte[] key = Byte2FloatOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Byte2FloatOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Byte2FloatOpenHashMap.this.size - this.c), (long)(Byte2FloatOpenHashMap.this.realSize() / Byte2FloatOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       byte[] key = Byte2FloatOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2FloatMap.Entry> action, int index) {
/*  991 */       action.accept(new Byte2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Byte2FloatOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2FloatMap.Entry> fastIterator() {
/* 1008 */       return new Byte2FloatOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2FloatMap.Entry> spliterator() {
/* 1013 */       return new Byte2FloatOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1022 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1023 */       if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1024 */       byte k = ((Byte)e.getKey()).byteValue();
/* 1025 */       float v = ((Float)e.getValue()).floatValue();
/* 1026 */       if (k == 0) return (Byte2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1028 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1032 */       if (k == curr) return (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1036 */         if (k == curr) return (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == 0) {
/* 1050 */         if (Byte2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1051 */           Byte2FloatOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1063 */           Byte2FloatOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1072 */           Byte2FloatOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Byte2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Byte2FloatOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/* 1092 */       if (Byte2FloatOpenHashMap.this.containsNullKey) consumer.accept(new Byte2FloatOpenHashMap.MapEntry(Byte2FloatOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenHashMap.this.key[pos] != 0) consumer.accept(new Byte2FloatOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/* 1099 */       Byte2FloatOpenHashMap.MapEntry entry = new Byte2FloatOpenHashMap.MapEntry();
/* 1100 */       if (Byte2FloatOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Byte2FloatOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenHashMap.this.key[pos] != 0) {
...
/* 1135 */       action.accept(Byte2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1140 */       return Byte2FloatOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1161 */       action.accept(Byte2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Byte2FloatOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1178 */       return new Byte2FloatOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1184 */       if (Byte2FloatOpenHashMap.this.containsNullKey) consumer.accept(Byte2FloatOpenHashMap.this.key[Byte2FloatOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         byte k = Byte2FloatOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Byte2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1198 */       return Byte2FloatOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1203 */       int oldSize = Byte2FloatOpenHashMap.this.size;
/* 1204 */       Byte2FloatOpenHashMap.this.remove(k);
/* 1205 */       return (Byte2FloatOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Byte2FloatOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Byte2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1243 */       return Byte2FloatOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1264 */       action.accept(Byte2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Byte2FloatOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1283 */             return new Byte2FloatOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1289 */             if (Byte2FloatOpenHashMap.this.containsNullKey) consumer.accept(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenHashMap.this.key[pos] != 0) consumer.accept(Byte2FloatOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Byte2FloatOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1300 */             return Byte2FloatOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Byte2FloatOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1369 */     byte[] key = this.key;
/* 1370 */     float[] value = this.value;
/* 1371 */     int mask = newN - 1;
/* 1372 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1403 */       c = (Byte2FloatOpenHashMap)super.clone();
...
/* 1411 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2FloatOpenHashMap.class
