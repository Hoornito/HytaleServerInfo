...
/*  50 */     return (entries instanceof Byte2BooleanMap.FastEntrySet) ? ((Byte2BooleanMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Byte2BooleanMap.Entry> entries = map.byte2BooleanEntrySet();
/*  66 */     if (entries instanceof Byte2BooleanMap.FastEntrySet) { ((Byte2BooleanMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Byte2BooleanMap.Entry> entries = map.byte2BooleanEntrySet();
/*  83 */     return (entries instanceof Byte2BooleanMap.FastEntrySet) ? new ObjectIterable<Byte2BooleanMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Byte2BooleanMap.Entry> iterator() {
/*  86 */           return ((Byte2BooleanMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Byte2BooleanMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Byte2BooleanMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractByte2BooleanMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)byte2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/*     */   
/*     */   public static Byte2BooleanMap singleton(Byte key, Boolean value) {
/* 316 */     return new Singleton(key.byteValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Byte2BooleanFunctions.SynchronizedFunction implements Byte2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2BooleanEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Boolean>> entrySet() {
/* 381 */       return (ObjectSet)byte2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/*     */     extends Byte2BooleanFunctions.UnmodifiableFunction implements Byte2BooleanMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2BooleanMap map;
/*     */     protected transient ObjectSet<Byte2BooleanMap.Entry> entries;
/*     */     protected transient ByteSet keys;
...
/*     */     
/*     */     public ObjectSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2BooleanEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Boolean>> entrySet() {
/* 712 */       return (ObjectSet)byte2BooleanEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanMaps.class
