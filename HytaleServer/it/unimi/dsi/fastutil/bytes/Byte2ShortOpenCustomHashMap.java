...
/*  543 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  635 */       return Byte2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  640 */       return Byte2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  645 */       return Byte2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  650 */       return Byte2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  655 */       short oldValue = Byte2ShortOpenCustomHashMap.this.value[this.index];
/*  656 */       Byte2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteShortPair right(short v) {
/*  662 */       Byte2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  674 */       return Byte.valueOf(Byte2ShortOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Short.valueOf(Byte2ShortOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Byte, Short> e = (Map.Entry<Byte, Short>)o;
/*  704 */       return (Byte2ShortOpenCustomHashMap.this.strategy.equals(Byte2ShortOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Byte2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Byte2ShortOpenCustomHashMap.this.strategy.hashCode(Byte2ShortOpenCustomHashMap.this.key[this.index]) ^ Byte2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Byte2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Byte2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Byte2ShortOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Byte2ShortOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Byte2ShortOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Byte2ShortOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ShortOpenCustomHashMap.this.mask;
/*  763 */           for (; !Byte2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2ShortOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Byte2ShortOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ShortOpenCustomHashMap.this.mask;
/*  783 */           for (; !Byte2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2ShortOpenCustomHashMap.this.mask);
...
/*  803 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  805 */         pos = (last = pos) + 1 & Byte2ShortOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2ShortOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Byte2ShortOpenCustomHashMap.this.value[last] = Byte2ShortOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Byte2ShortOpenCustomHashMap.this.n)
/*  827 */       { Byte2ShortOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Byte2ShortOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Byte2ShortOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2ShortMap.Entry>> implements ObjectIterator<Byte2ShortMap.Entry> { public Byte2ShortOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Byte2ShortOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Byte2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Byte2ShortOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Byte2ShortOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Byte2ShortOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Byte2ShortOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Byte2ShortOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Byte2ShortOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Byte2ShortOpenCustomHashMap.this.size - this.c), (long)(Byte2ShortOpenCustomHashMap.this.realSize() / Byte2ShortOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Byte2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2ShortMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2ShortMap.Entry> action, int index) {
/* 1014 */       action.accept(new Byte2ShortOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Byte2ShortOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2ShortMap.Entry> fastIterator() {
/* 1031 */       return new Byte2ShortOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2ShortMap.Entry> spliterator() {
/* 1036 */       return new Byte2ShortOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Byte2ShortOpenCustomHashMap.this.strategy.equals(k, (byte)0)) return (Byte2ShortOpenCustomHashMap.this.containsNullKey && Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Byte2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Byte2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Byte2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) return (Byte2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Byte2ShortOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/* 1073 */         if (Byte2ShortOpenCustomHashMap.this.containsNullKey && Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n] == v) {
/* 1074 */           Byte2ShortOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       byte[] key = Byte2ShortOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Byte2ShortOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Byte2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Byte2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Byte2ShortOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Byte2ShortOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Byte2ShortOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Byte2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Byte2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1115 */       if (Byte2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(new Byte2ShortOpenCustomHashMap.MapEntry(Byte2ShortOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Byte2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Byte2ShortOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1122 */       Byte2ShortOpenCustomHashMap.MapEntry entry = new Byte2ShortOpenCustomHashMap.MapEntry();
/* 1123 */       if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Byte2ShortOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Byte2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Byte2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1163 */       return Byte2ShortOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1184 */       action.accept(Byte2ShortOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Byte2ShortOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1201 */       return new Byte2ShortOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1207 */       if (Byte2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2ShortOpenCustomHashMap.this.key[Byte2ShortOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Byte2ShortOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         byte k = Byte2ShortOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Byte2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1221 */       return Byte2ShortOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1226 */       int oldSize = Byte2ShortOpenCustomHashMap.this.size;
/* 1227 */       Byte2ShortOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Byte2ShortOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Byte2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Byte2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1266 */       return Byte2ShortOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1287 */       action.accept(Byte2ShortOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Byte2ShortOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ShortSpliterator spliterator() {
/* 1306 */             return new Byte2ShortOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1312 */             if (Byte2ShortOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Byte2ShortOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Byte2ShortOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Byte2ShortOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1323 */             return Byte2ShortOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Byte2ShortOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Byte2ShortOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortOpenCustomHashMap.class
