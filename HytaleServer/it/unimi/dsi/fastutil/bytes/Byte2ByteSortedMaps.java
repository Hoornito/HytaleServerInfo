...
/*  60 */     ObjectSortedSet<Byte2ByteMap.Entry> entries = map.byte2ByteEntrySet();
/*  61 */     return (entries instanceof Byte2ByteSortedMap.FastSortedEntrySet) ? ((Byte2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Byte2ByteMap.Entry> entries = map.byte2ByteEntrySet();
/*  77 */     Objects.requireNonNull((Byte2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Byte2ByteSortedMap.FastSortedEntrySet) ? (Byte2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Byte2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Byte, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap headMap(byte to) {
/* 125 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap tailMap(byte from) {
/* 130 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractByte2ByteMap.BasicEntry(this.key, this.value), Byte2ByteSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
/* 248 */       return (ObjectSortedSet)byte2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 260 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap headMap(byte to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap tailMap(byte from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public byte firstByteKey() {
...
/* 353 */     return new Singleton(key.byteValue(), value.byteValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 369 */     return new Singleton(key.byteValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Byte2ByteMaps.SynchronizedMap implements Byte2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.byte2ByteEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
/* 440 */       return (ObjectSortedSet)byte2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/*     */     extends Byte2ByteMaps.UnmodifiableMap implements Byte2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2ByteSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.byte2ByteEntrySet()); 
/* 581 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
/* 593 */       return (ObjectSortedSet)byte2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteSortedMaps.class
