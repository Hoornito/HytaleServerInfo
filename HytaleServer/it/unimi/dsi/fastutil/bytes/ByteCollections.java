...
/*  72 */       return ByteIterators.EMPTY_ITERATOR;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ByteSpliterator spliterator() {
/*  78 */       return ByteSpliterators.EMPTY_SPLITERATOR;
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
...
/* 136 */       return ByteArrays.EMPTY_ARRAY;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 196 */       this.collection = Objects.<ByteCollection>requireNonNull(c);
/* 197 */       this.sync = sync;
/*     */     }
/*     */     
/*     */     protected SynchronizedCollection(ByteCollection c) {
/* 201 */       this.collection = Objects.<ByteCollection>requireNonNull(c);
/* 202 */       this.sync = this;
/*     */     }
/*     */ 
/*     */     
...
/* 243 */         return this.collection.toByteArray();
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/* 479 */       this.collection = Objects.<ByteCollection>requireNonNull(c);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean add(byte k) {
...
/*     */     
/*     */     public ByteIterator iterator() {
/* 509 */       return ByteIterators.unmodifiable(this.collection.iterator());
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSpliterator spliterator() {
...
/*     */     
/*     */     public byte[] toByteArray() {
/* 594 */       return this.collection.toByteArray();
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends AbstractByteCollection implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final ByteIterable iterable;
/*     */     
/*     */     protected IterableCollection(ByteIterable iterable) {
/* 685 */       this.iterable = Objects.<ByteIterable>requireNonNull(iterable);
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
...
/* 692 */       int c = 0;
/* 693 */       ByteIterator iterator = iterator();
/* 694 */       while (iterator.hasNext()) {
/* 695 */         iterator.nextByte();
/* 696 */         c++;
/*     */       } 
/* 698 */       return c;
/*     */     }
...
/* 734 */     if (iterable instanceof ByteCollection) return (ByteCollection)iterable;
/*     */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\ByteCollections.class
