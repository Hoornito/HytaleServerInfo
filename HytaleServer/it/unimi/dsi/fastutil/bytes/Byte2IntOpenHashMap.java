...
/*  519 */     Integer newValue = remappingFunction.apply(Byte.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  532 */     int pos = find(k);
/*  533 */     Integer newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*  611 */       return Byte2IntOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  616 */       return Byte2IntOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  621 */       return Byte2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  626 */       return Byte2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  631 */       int oldValue = Byte2IntOpenHashMap.this.value[this.index];
/*  632 */       Byte2IntOpenHashMap.this.value[this.index] = v;
/*  633 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteIntPair right(int v) {
/*  638 */       Byte2IntOpenHashMap.this.value[this.index] = v;
/*  639 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  650 */       return Byte.valueOf(Byte2IntOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  661 */       return Integer.valueOf(Byte2IntOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */       Map.Entry<Byte, Integer> e = (Map.Entry<Byte, Integer>)o;
/*  680 */       return (Byte2IntOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  685 */       return Byte2IntOpenHashMap.this.key[this.index] ^ Byte2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  690 */       return Byte2IntOpenHashMap.this.key[this.index] + "=>" + Byte2IntOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  701 */     int pos = Byte2IntOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */     int last = -1;
/*      */     
/*  709 */     int c = Byte2IntOpenHashMap.this.size;
/*      */     
/*  711 */     boolean mustReturnNullKey = Byte2IntOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  730 */         return this.last = Byte2IntOpenHashMap.this.n;
/*      */       } 
/*  732 */       byte[] key = Byte2IntOpenHashMap.this.key;
/*      */       while (true) {
/*  734 */         if (--this.pos < 0) {
/*      */           
/*  736 */           this.last = Integer.MIN_VALUE;
/*  737 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  738 */           int p = HashCommon.mix(k) & Byte2IntOpenHashMap.this.mask;
/*  739 */           for (; k != key[p]; p = p + 1 & Byte2IntOpenHashMap.this.mask);
/*  740 */           return p;
/*      */         } 
...
/*  749 */         acceptOnIndex(action, this.last = Byte2IntOpenHashMap.this.n);
/*  750 */         this.c--;
/*      */       } 
/*  752 */       byte[] key = Byte2IntOpenHashMap.this.key;
/*  753 */       while (this.c != 0) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(k) & Byte2IntOpenHashMap.this.mask;
/*  759 */           for (; k != key[p]; p = p + 1 & Byte2IntOpenHashMap.this.mask);
...
/*  779 */       byte[] key = Byte2IntOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  781 */         pos = (last = pos) + 1 & Byte2IntOpenHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == 0) {
/*  784 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(curr) & Byte2IntOpenHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  789 */             break;  pos = pos + 1 & Byte2IntOpenHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Byte2IntOpenHashMap.this.value[last] = Byte2IntOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  801 */       if (this.last == -1) throw new IllegalStateException(); 
/*  802 */       if (this.last == Byte2IntOpenHashMap.this.n)
/*  803 */       { Byte2IntOpenHashMap.this.containsNullKey = false; }
/*  804 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  807 */       { Byte2IntOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  808 */         this.last = -1;
/*      */         return; }
/*      */       
/*  811 */       Byte2IntOpenHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2IntMap.Entry>> implements ObjectIterator<Byte2IntMap.Entry> { public Byte2IntOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Byte2IntOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     private Byte2IntOpenHashMap.MapEntry entry;
/*      */     private EntryIterator() {}
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
/*  834 */       action.accept(this.entry = new Byte2IntOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  845 */       this.entry = new Byte2IntOpenHashMap.MapEntry();
/*      */     }
...
/*  866 */     int pos = 0;
/*      */     
/*  868 */     int max = Byte2IntOpenHashMap.this.n;
/*      */     
/*  870 */     int c = 0;
/*      */     
/*  872 */     boolean mustReturnNull = Byte2IntOpenHashMap.this.containsNullKey;
/*      */     
...
/*  892 */         this.c++;
/*  893 */         acceptOnIndex(action, Byte2IntOpenHashMap.this.n);
/*  894 */         return true;
/*      */       } 
/*  896 */       byte[] key = Byte2IntOpenHashMap.this.key;
...
/*  911 */         this.c++;
/*  912 */         acceptOnIndex(action, Byte2IntOpenHashMap.this.n);
/*      */       } 
/*  914 */       byte[] key = Byte2IntOpenHashMap.this.key;
...
/*      */       {
/*  927 */         return (Byte2IntOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  932 */       return Math.min((Byte2IntOpenHashMap.this.size - this.c), (long)(Byte2IntOpenHashMap.this.realSize() / Byte2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  960 */         n--;
/*      */       } 
/*  962 */       byte[] key = Byte2IntOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
/*  990 */       action.accept(new Byte2IntOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1002 */       return new Byte2IntOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2IntMap.Entry> fastIterator() {
/* 1007 */       return new Byte2IntOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2IntMap.Entry> spliterator() {
/* 1012 */       return new Byte2IntOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */       if (k == 0) return (Byte2IntOpenHashMap.this.containsNullKey && Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.n] == v);
/*      */       
/* 1027 */       byte[] key = Byte2IntOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1030 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2IntOpenHashMap.this.mask]) == 0) return false; 
/* 1031 */       if (k == curr) return (Byte2IntOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1034 */         if ((curr = key[pos = pos + 1 & Byte2IntOpenHashMap.this.mask]) == 0) return false; 
/* 1035 */         if (k == curr) return (Byte2IntOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1048 */       if (k == 0) {
/* 1049 */         if (Byte2IntOpenHashMap.this.containsNullKey && Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.n] == v) {
/* 1050 */           Byte2IntOpenHashMap.this.removeNullEntry();
/* 1051 */           return true;
/*      */         } 
/* 1053 */         return false;
/*      */       } 
/*      */       
/* 1056 */       byte[] key = Byte2IntOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1059 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2IntOpenHashMap.this.mask]) == 0) return false; 
/* 1060 */       if (curr == k) {
/* 1061 */         if (Byte2IntOpenHashMap.this.value[pos] == v) {
/* 1062 */           Byte2IntOpenHashMap.this.removeEntry(pos);
/* 1063 */           return true;
/*      */         } 
/* 1065 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1068 */         if ((curr = key[pos = pos + 1 & Byte2IntOpenHashMap.this.mask]) == 0) return false; 
/* 1069 */         if (curr == k && 
/* 1070 */           Byte2IntOpenHashMap.this.value[pos] == v) {
/* 1071 */           Byte2IntOpenHashMap.this.removeEntry(pos);
/* 1072 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1080 */       return Byte2IntOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1085 */       Byte2IntOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
/* 1091 */       if (Byte2IntOpenHashMap.this.containsNullKey) consumer.accept(new Byte2IntOpenHashMap.MapEntry(Byte2IntOpenHashMap.this.n)); 
/* 1092 */       for (int pos = Byte2IntOpenHashMap.this.n; pos-- != 0;) { if (Byte2IntOpenHashMap.this.key[pos] != 0) consumer.accept(new Byte2IntOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
/* 1098 */       Byte2IntOpenHashMap.MapEntry entry = new Byte2IntOpenHashMap.MapEntry();
/* 1099 */       if (Byte2IntOpenHashMap.this.containsNullKey) {
/* 1100 */         entry.index = Byte2IntOpenHashMap.this.n;
/* 1101 */         consumer.accept(entry);
/*      */       } 
/* 1103 */       for (int pos = Byte2IntOpenHashMap.this.n; pos-- != 0;) { if (Byte2IntOpenHashMap.this.key[pos] != 0) {
...
/* 1134 */       action.accept(Byte2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1139 */       return Byte2IntOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1160 */       action.accept(Byte2IntOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1172 */       return new Byte2IntOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1177 */       return new Byte2IntOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1183 */       if (Byte2IntOpenHashMap.this.containsNullKey) consumer.accept(Byte2IntOpenHashMap.this.key[Byte2IntOpenHashMap.this.n]); 
/* 1184 */       for (int pos = Byte2IntOpenHashMap.this.n; pos-- != 0; ) {
/* 1185 */         byte k = Byte2IntOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1192 */       return Byte2IntOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1197 */       return Byte2IntOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1202 */       int oldSize = Byte2IntOpenHashMap.this.size;
/* 1203 */       Byte2IntOpenHashMap.this.remove(k);
/* 1204 */       return (Byte2IntOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1209 */       Byte2IntOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1237 */       action.accept(Byte2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1242 */       return Byte2IntOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(IntConsumer action, int index) {
/* 1263 */       action.accept(Byte2IntOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1277 */             return new Byte2IntOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public IntSpliterator spliterator() {
/* 1282 */             return new Byte2IntOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1288 */             if (Byte2IntOpenHashMap.this.containsNullKey) consumer.accept(Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.n]); 
/* 1289 */             for (int pos = Byte2IntOpenHashMap.this.n; pos-- != 0;) { if (Byte2IntOpenHashMap.this.key[pos] != 0) consumer.accept(Byte2IntOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Byte2IntOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1299 */             return Byte2IntOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1304 */             Byte2IntOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1402 */       c = (Byte2IntOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2IntOpenHashMap.class
