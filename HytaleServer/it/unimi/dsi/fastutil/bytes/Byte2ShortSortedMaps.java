...
/*  61 */     return (entries instanceof Byte2ShortSortedMap.FastSortedEntrySet) ? ((Byte2ShortSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Byte2ShortMap.Entry> entries = map.byte2ShortEntrySet();
/*  77 */     Objects.requireNonNull((Byte2ShortSortedMap.FastSortedEntrySet)entries); return (entries instanceof Byte2ShortSortedMap.FastSortedEntrySet) ? (Byte2ShortSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Byte2ShortMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Byte2ShortMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Byte, Short>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ShortSortedMap headMap(byte to) {
/* 125 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ShortSortedMap tailMap(byte from) {
/* 130 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ShortMap.Entry>)ObjectSortedSets.singleton(new AbstractByte2ShortMap.BasicEntry(this.key, this.value), Byte2ShortSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Byte2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() {
/* 248 */       return (ObjectSortedSet)byte2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 260 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ShortSortedMap headMap(byte to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ShortSortedMap tailMap(byte from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public byte firstByteKey() {
...
/* 369 */     return new Singleton(key.byteValue(), value.shortValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Byte2ShortMaps.SynchronizedMap implements Byte2ShortSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ShortMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.byte2ShortEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Byte2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() {
/* 440 */       return (ObjectSortedSet)byte2ShortEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/*     */     extends Byte2ShortMaps.UnmodifiableMap implements Byte2ShortSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2ShortSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Byte2ShortMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.byte2ShortEntrySet()); 
/* 581 */       return (ObjectSortedSet<Byte2ShortMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortSortedMaps.class
