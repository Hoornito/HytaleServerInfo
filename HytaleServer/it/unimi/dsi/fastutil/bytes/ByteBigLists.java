...
/*   44 */       byte t = l.getByte(i);
/*   45 */       l.set(i, l.getByte(p));
/*   46 */       l.set(p, t);
/*      */     } 
/*   48 */     return l;
/*      */   }
...
/*  203 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  209 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  215 */       if (i == 0L) return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR; 
...
/*  222 */       return ByteSpliterators.EMPTY_SPLITERATOR;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     public Object clone() {
/*  270 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*  290 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  343 */       byte[] a = { this.element };
/*  344 */       return a;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  349 */       return ByteBigListIterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  354 */       if (i > 1L || i < 0L) throw new IndexOutOfBoundsException(); 
/*  355 */       ByteBigListIterator l = listIterator();
/*  356 */       if (i == 1L) l.nextByte(); 
/*  357 */       return l;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/*  362 */       return ByteSpliterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  371 */       if (from != 0L || to != 1L) return ByteBigLists.EMPTY_BIG_LIST; 
/*  372 */       return this;
/*      */     }
/*      */ 
/*      */     
...
/*  460 */     return new Singleton(((Byte)element).byteValue());
/*      */   }
/*      */   
...
/*  482 */         return this.list.getByte(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*  503 */         return this.list.removeByte(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*  592 */         return ByteBigLists.synchronize(this.list.subList(from, to), this.sync);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     public byte getByte(long i) {
/*  755 */       return this.list.getByte(i);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte set(long i, byte k) {
...
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  829 */       return ByteBigListIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  834 */       return ByteBigListIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigList subList(long from, long to) {
/*  839 */       return ByteBigLists.unmodifiable(this.list.subList(from, to));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean equals(Object o) {
...
/*      */     extends AbstractByteBigList implements Serializable {
/*      */     private static final long serialVersionUID = -7046029254386353129L;
...
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  977 */       return ByteBigListIterators.asBigListIterator(this.list.iterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  982 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long index) {
/*  987 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator(intIndex(index)));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean addAll(long index, Collection<? extends Byte> c) {
...
/*      */     
/*      */     public byte[] toByteArray() {
/* 1007 */       return this.list.toByteArray();
/*      */     }
/*      */ 
/*      */     
/*      */     public void removeElements(long from, long to) {
...
/* 1071 */       return this.list.getByte(intIndex(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public long indexOf(byte k) {
...
/* 1086 */       return this.list.removeByte(intIndex(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public byte set(long index, byte k) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\ByteBigLists.class
