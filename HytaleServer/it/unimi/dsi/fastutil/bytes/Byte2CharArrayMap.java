...
/*  94 */     this(m.size());
/*  95 */     int i = 0;
/*  96 */     for (ObjectIterator<Byte2CharMap.Entry> objectIterator = m.byte2CharEntrySet().iterator(); objectIterator.hasNext(); ) { Byte2CharMap.Entry e = objectIterator.next();
...
/* 110 */     this(m.size());
/* 111 */     int i = 0;
/* 112 */     for (Map.Entry<? extends Byte, ? extends Character> e : m.entrySet()) {
...
/* 145 */       return new ObjectIterator<Byte2CharMap.Entry>() {
/* 146 */           int curr = -1; int next = 0;
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 150 */             return (this.next < Byte2CharArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 157 */             return new AbstractByte2CharMap.BasicEntry(Byte2CharArrayMap.this.key[this.curr = this.next], Byte2CharArrayMap.this.value[this.next++]);
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
...
/* 163 */             this.curr = -1;
/* 164 */             int tail = Byte2CharArrayMap.this.size-- - this.next--;
/* 165 */             System.arraycopy(Byte2CharArrayMap.this.key, this.next + 1, Byte2CharArrayMap.this.key, this.next, tail);
/* 166 */             System.arraycopy(Byte2CharArrayMap.this.value, this.next + 1, Byte2CharArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
...
/* 173 */             int max = Byte2CharArrayMap.this.size;
/* 174 */             while (this.next < max) {
/* 175 */               action.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharArrayMap.this.key[this.curr = this.next], Byte2CharArrayMap.this.value[this.next++]));
/*     */             }
/*     */           }
/*     */         };
/*     */     }
...
/* 183 */       return new ObjectIterator<Byte2CharMap.Entry>() {
/* 184 */           int next = 0; int curr = -1;
/* 185 */           final AbstractByte2CharMap.BasicEntry entry = new AbstractByte2CharMap.BasicEntry();
/*     */ 
/*     */           
/*     */           public boolean hasNext() {
/* 189 */             return (this.next < Byte2CharArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 196 */             this.entry.key = Byte2CharArrayMap.this.key[this.curr = this.next];
/* 197 */             this.entry.value = Byte2CharArrayMap.this.value[this.next++];
...
/* 204 */             this.curr = -1;
/* 205 */             int tail = Byte2CharArrayMap.this.size-- - this.next--;
/* 206 */             System.arraycopy(Byte2CharArrayMap.this.key, this.next + 1, Byte2CharArrayMap.this.key, this.next, tail);
/* 207 */             System.arraycopy(Byte2CharArrayMap.this.value, this.next + 1, Byte2CharArrayMap.this.value, this.next, tail);
/*     */           }
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           public void forEachRemaining(Consumer<? super Byte2CharMap.Entry> action) {
/* 214 */             int max = Byte2CharArrayMap.this.size;
/* 215 */             while (this.next < max) {
/* 216 */               this.entry.key = Byte2CharArrayMap.this.key[this.curr = this.next];
/* 217 */               this.entry.value = Byte2CharArrayMap.this.value[this.next++];
...
/* 239 */         return new AbstractByte2CharMap.BasicEntry(Byte2CharArrayMap.this.key[location], Byte2CharArrayMap.this.value[location]);
/*     */       }
/*     */ 
/*     */       
...
/* 250 */       return new EntrySetSpliterator(0, Byte2CharArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 258 */       for (int i = 0, max = Byte2CharArrayMap.this.size; i < max; i++) {
/* 259 */         action.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharArrayMap.this.key[i], Byte2CharArrayMap.this.value[i]));
/*     */       }
/*     */     }
/*     */ 
/*     */ 
...
/* 267 */       AbstractByte2CharMap.BasicEntry entry = new AbstractByte2CharMap.BasicEntry();
/*     */       
/* 269 */       for (int i = 0, max = Byte2CharArrayMap.this.size; i < max; i++) {
/* 270 */         entry.key = Byte2CharArrayMap.this.key[i];
/* 271 */         entry.value = Byte2CharArrayMap.this.value[i];
...
/*     */     
/*     */     public int size() {
/* 278 */       return Byte2CharArrayMap.this.size;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 289 */       return (Byte2CharArrayMap.this.containsKey(k) && Byte2CharArrayMap.this.get(k) == ((Character)e.getValue()).charValue());
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 301 */       int oldPos = Byte2CharArrayMap.this.findKey(k);
/* 302 */       if (oldPos == -1 || v != Byte2CharArrayMap.this.value[oldPos]) return false; 
/* 303 */       int tail = Byte2CharArrayMap.this.size - oldPos - 1;
/* 304 */       System.arraycopy(Byte2CharArrayMap.this.key, oldPos + 1, Byte2CharArrayMap.this.key, oldPos, tail);
/* 305 */       System.arraycopy(Byte2CharArrayMap.this.value, oldPos + 1, Byte2CharArrayMap.this.value, oldPos, tail);
/* 306 */       Byte2CharArrayMap.this.size--;
/* 307 */       return true;
/*     */     }
/*     */   }
/*     */ 
...
/* 398 */       return (Byte2CharArrayMap.this.findKey(k) != -1);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean remove(byte k) {
/* 403 */       int oldPos = Byte2CharArrayMap.this.findKey(k);
/* 404 */       if (oldPos == -1) return false; 
/* 405 */       int tail = Byte2CharArrayMap.this.size - oldPos - 1;
/* 406 */       System.arraycopy(Byte2CharArrayMap.this.key, oldPos + 1, Byte2CharArrayMap.this.key, oldPos, tail);
/* 407 */       System.arraycopy(Byte2CharArrayMap.this.value, oldPos + 1, Byte2CharArrayMap.this.value, oldPos, tail);
/* 408 */       Byte2CharArrayMap.this.size--;
/* 409 */       return true;
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 419 */             return (this.pos < Byte2CharArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 426 */             return Byte2CharArrayMap.this.key[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 431 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 432 */             int tail = Byte2CharArrayMap.this.size - this.pos;
/* 433 */             System.arraycopy(Byte2CharArrayMap.this.key, this.pos, Byte2CharArrayMap.this.key, this.pos - 1, tail);
/* 434 */             System.arraycopy(Byte2CharArrayMap.this.value, this.pos, Byte2CharArrayMap.this.value, this.pos - 1, tail);
/* 435 */             Byte2CharArrayMap.this.size--;
/* 436 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 443 */             int max = Byte2CharArrayMap.this.size;
/* 444 */             while (this.pos < max)
/* 445 */               action.accept(Byte2CharArrayMap.this.key[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 465 */         return Byte2CharArrayMap.this.key[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(ByteConsumer action) {
/* 477 */         int max = Byte2CharArrayMap.this.size;
/* 478 */         while (this.pos < max) {
/* 479 */           action.accept(Byte2CharArrayMap.this.key[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 486 */       return new KeySetSpliterator(0, Byte2CharArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 493 */       for (int i = 0, max = Byte2CharArrayMap.this.size; i < max; i++) {
/* 494 */         action.accept(Byte2CharArrayMap.this.key[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 500 */       return Byte2CharArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 505 */       Byte2CharArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/* 518 */       return Byte2CharArrayMap.this.containsValue(v);
/*     */     }
/*     */ 
/*     */     
...
/*     */           
/*     */           public boolean hasNext() {
/* 528 */             return (this.pos < Byte2CharArrayMap.this.size);
/*     */           }
/*     */ 
/*     */ 
/*     */           
...
/* 535 */             return Byte2CharArrayMap.this.value[this.pos++];
/*     */           }
/*     */ 
/*     */           
/*     */           public void remove() {
/* 540 */             if (this.pos == 0) throw new IllegalStateException(); 
/* 541 */             int tail = Byte2CharArrayMap.this.size - this.pos;
/* 542 */             System.arraycopy(Byte2CharArrayMap.this.key, this.pos, Byte2CharArrayMap.this.key, this.pos - 1, tail);
/* 543 */             System.arraycopy(Byte2CharArrayMap.this.value, this.pos, Byte2CharArrayMap.this.value, this.pos - 1, tail);
/* 544 */             Byte2CharArrayMap.this.size--;
/* 545 */             this.pos--;
/*     */           }
/*     */ 
/*     */ 
...
/* 552 */             int max = Byte2CharArrayMap.this.size;
/* 553 */             while (this.pos < max)
/* 554 */               action.accept(Byte2CharArrayMap.this.value[this.pos++]); 
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 574 */         return Byte2CharArrayMap.this.value[location];
/*     */       }
/*     */ 
/*     */       
...
/*     */       
/*     */       public void forEachRemaining(CharConsumer action) {
/* 586 */         int max = Byte2CharArrayMap.this.size;
/* 587 */         while (this.pos < max) {
/* 588 */           action.accept(Byte2CharArrayMap.this.value[this.pos++]);
/*     */         }
/*     */       }
/*     */     }
/*     */ 
...
/* 595 */       return new ValuesSpliterator(0, Byte2CharArrayMap.this.size);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 602 */       for (int i = 0, max = Byte2CharArrayMap.this.size; i < max; i++) {
/* 603 */         action.accept(Byte2CharArrayMap.this.value[i]);
/*     */       }
/*     */     }
/*     */ 
/*     */     
/*     */     public int size() {
/* 609 */       return Byte2CharArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     
/*     */     public void clear() {
/* 614 */       Byte2CharArrayMap.this.clear();
/*     */     } }
/*     */ 
/*     */ 
/*     */   
...
/*     */     Byte2CharArrayMap c;
/*     */     try {
/* 638 */       c = (Byte2CharArrayMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharArrayMap.class
