...
/*  165 */     this(k, v, (Comparator<? super Byte>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  191 */     return (this.actualComparator == null) ? Byte.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  864 */       Map.Entry<Byte, V> e = (Map.Entry<Byte, V>)o;
/*  865 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Byte2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  977 */       if ((this.next = Byte2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Byte2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Byte2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1112 */             if (!(e.getKey() instanceof Byte)) return false; 
/* 1113 */             Byte2ReferenceAVLTreeMap.Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1123 */             if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1124 */             Byte2ReferenceAVLTreeMap.Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1125 */             if (f == null || f.getValue() != e.getValue()) return false; 
/* 1126 */             Byte2ReferenceAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Byte2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Byte2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> first() {
/* 1142 */             return Byte2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> last() {
/* 1147 */             return Byte2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1152 */             return Byte2ReferenceAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1157 */             return Byte2ReferenceAVLTreeMap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1162 */             return Byte2ReferenceAVLTreeMap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Byte2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1204 */       return new Byte2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Byte2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Byte2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Byte2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Byte2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Byte2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Byte2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Byte2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ReferenceAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() {
/* 1376 */               return Byte2ReferenceAVLTreeMap.this.byte2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1384 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1385 */               Byte2ReferenceAVLTreeMap.Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1386 */               return (f != null && Byte2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1394 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1395 */               Byte2ReferenceAVLTreeMap.Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1396 */               if (f != null && Byte2ReferenceAVLTreeMap.Submap.this.in(f.key)) Byte2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Byte2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Byte2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> first() {
/* 1419 */               return Byte2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> last() {
/* 1424 */               return Byte2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1429 */               return Byte2ReferenceAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1434 */               return Byte2ReferenceAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1439 */               return Byte2ReferenceAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */           }; 
/* 1442 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractByte2ReferenceSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1448 */         return new Byte2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1453 */         return new Byte2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Byte2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Byte2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Byte2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Byte2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1493 */       return (in(k) && Byte2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1511 */       byte kk = k; Byte2ReferenceAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Byte2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(byte k, V v) {
/* 1517 */       Byte2ReferenceAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Byte2ReferenceAVLTreeMap.this.put(k, v);
/* 1520 */       return Byte2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1526 */       Byte2ReferenceAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Byte2ReferenceAVLTreeMap.this.remove(k);
/* 1529 */       return Byte2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1550 */       return Byte2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Byte2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Byte2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Byte2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Byte2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Byte2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Byte2ReferenceAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Byte2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Byte2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Byte2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2ReferenceAVLTreeMap.Entry<V> e;
/* 1602 */       if (Byte2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Byte2ReferenceAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Byte2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Byte2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Byte2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1620 */       Byte2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1627 */       Byte2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Byte2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Byte2ReferenceAVLTreeMap.Submap.this.bottom && Byte2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Byte2ReferenceAVLTreeMap.Submap.this.top && Byte2ReferenceAVLTreeMap.this.compare(k, (this.prev = Byte2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Byte2ReferenceAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Byte2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Byte2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ReferenceAVLTreeMap.this.compare(this.prev.key, Byte2ReferenceAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Byte2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Byte2ReferenceAVLTreeMap.this.compare(this.next.key, Byte2ReferenceAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Byte2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1831 */     if (n == 1) {
/* 1832 */       Entry<V> entry = new Entry<>(s.readByte(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1840 */       Entry<V> entry = new Entry<>(s.readByte(), (V)s.readObject());
/* 1841 */       entry.right(new Entry<>(s.readByte(), (V)s.readObject()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceAVLTreeMap.class
