...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Byte2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Byte2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Byte2ShortFunction singleton(Byte key, Short value) {
/* 179 */     return new Singleton(key.byteValue(), value.shortValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractByte2ShortFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2ShortFunction function;
/*     */     
...
/*     */     
/*     */     protected PrimitiveFunction(Function<? super Byte, ? extends Short> function) {
...
/* 550 */       Short v = this.function.apply(Byte.valueOf(key));
...
/* 557 */       Short v = this.function.apply(Byte.valueOf(key));
...
/*     */ 
/*     */   
/*     */   public static Byte2ShortFunction primitive(Function<? super Byte, ? extends Short> f) {
/* 602 */     Objects.requireNonNull(f);
/* 603 */     if (f instanceof Byte2ShortFunction) return (Byte2ShortFunction)f; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortFunctions.class
