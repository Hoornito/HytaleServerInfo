...
/*      */ 
/*      */ 
/*      */ public class Byte2BooleanRBTreeMap
...
/*  819 */       Map.Entry<Byte, Boolean> e = (Map.Entry<Byte, Boolean>)o;
/*  820 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  926 */       this.next = Byte2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  930 */       if ((this.next = Byte2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  931 */         if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/*  984 */       updatePrevious();
/*  985 */       updateNext();
/*  986 */       Byte2BooleanRBTreeMap.this.remove(this.curr.key);
/*  987 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1031 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */         {
...
/* 1041 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1046 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1057 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1067 */             if (!(e.getKey() instanceof Byte)) return false; 
/* 1068 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1069 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1070 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue()) return false; 
/* 1071 */             Byte2BooleanRBTreeMap.this.remove(f.key);
/* 1072 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1077 */             return Byte2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1082 */             Byte2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2BooleanMap.Entry first() {
/* 1087 */             return Byte2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2BooleanMap.Entry last() {
/* 1092 */             return Byte2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1097 */             return Byte2BooleanRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1102 */             return Byte2BooleanRBTreeMap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1107 */             return Byte2BooleanRBTreeMap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1144 */       return new Byte2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1149 */       return new Byte2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1202 */             return (BooleanIterator)new Byte2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1207 */             return Byte2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1212 */             return Byte2BooleanRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1217 */             Byte2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1230 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Byte2BooleanSortedMap tailMap(byte from) {
/* 1235 */     return new Submap(from, false, (byte)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1279 */       if (!bottom && !top && Byte2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1280 */       this.from = from;
/* 1281 */       this.bottom = bottom;
/* 1282 */       this.to = to;
/* 1283 */       this.top = top;
/* 1284 */       this.defRetValue = Byte2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1303 */       return ((this.bottom || Byte2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 1308 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator() {
/* 1311 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1316 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2BooleanMap.Entry> comparator() {
/* 1321 */               return Byte2BooleanRBTreeMap.this.byte2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1329 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1330 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1331 */               Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1332 */               return (f != null && Byte2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1340 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1341 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1342 */               Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1343 */               if (f != null && Byte2BooleanRBTreeMap.Submap.this.in(f.key)) Byte2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1344 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1349 */               int c = 0;
/* 1350 */               for (ObjectBidirectionalIterator<Byte2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1351 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1356 */               return !(new Byte2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1361 */               Byte2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2BooleanMap.Entry first() {
/* 1366 */               return Byte2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2BooleanMap.Entry last() {
/* 1371 */               return Byte2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1376 */               return Byte2BooleanRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1381 */               return Byte2BooleanRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1386 */               return Byte2BooleanRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1395 */         return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1400 */         return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1415 */               return (BooleanIterator)new Byte2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1420 */               return Byte2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1425 */               return Byte2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1430 */               Byte2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1440 */       return (in(k) && Byte2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(byte k) {
/* 1458 */       byte kk = k; Byte2BooleanRBTreeMap.Entry e;
/* 1459 */       return (in(kk) && (e = Byte2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean put(byte k, boolean v) {
/* 1464 */       Byte2BooleanRBTreeMap.this.modified = false;
...
/* 1466 */       boolean oldValue = Byte2BooleanRBTreeMap.this.put(k, v);
/* 1467 */       return Byte2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1473 */       Byte2BooleanRBTreeMap.this.modified = false;
/* 1474 */       if (!in(k)) return this.defRetValue; 
/* 1475 */       boolean oldValue = Byte2BooleanRBTreeMap.this.remove(k);
/* 1476 */       return Byte2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1497 */       return Byte2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2BooleanSortedMap headMap(byte to) {
/* 1502 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1503 */       return (Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2BooleanSortedMap tailMap(byte from) {
/* 1508 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1509 */       return (Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2BooleanSortedMap subMap(byte from, byte to) {
/* 1514 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1515 */       if (!this.top) to = (Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1516 */       if (!this.bottom) from = (Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1527 */       if (Byte2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1531 */       if (this.bottom) { e = Byte2BooleanRBTreeMap.this.firstEntry; }
/*      */       else
/* 1533 */       { e = Byte2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1535 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1539 */       if (e == null || (!this.top && Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1540 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2BooleanRBTreeMap.Entry e;
/* 1549 */       if (Byte2BooleanRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1553 */       if (this.top) { e = Byte2BooleanRBTreeMap.this.lastEntry; }
/*      */       else
/* 1555 */       { e = Byte2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1557 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1561 */       if (e == null || (!this.bottom && Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1562 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1567 */       Byte2BooleanRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1574 */       Byte2BooleanRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Byte2BooleanRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1590 */         this.next = Byte2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null) {
/* 1596 */           if (!Byte2BooleanRBTreeMap.Submap.this.bottom && Byte2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1597 */           else if (!Byte2BooleanRBTreeMap.Submap.this.top && Byte2BooleanRBTreeMap.this.compare(k, (this.prev = Byte2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1599 */           { this.next = Byte2BooleanRBTreeMap.this.locateKey(k);
/* 1600 */             if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1611 */         if (!Byte2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Byte2BooleanRBTreeMap.this.compare(this.prev.key, Byte2BooleanRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
...
/*      */     try {
/* 1705 */       c = (Byte2BooleanRBTreeMap)super.clone();
...
/* 1778 */     if (n == 1) {
/* 1779 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1788 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
/* 1789 */       entry.black(true);
/* 1790 */       entry.right(new Entry(s.readByte(), s.readBoolean()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanRBTreeMap.class
