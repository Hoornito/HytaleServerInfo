...
/*  854 */     Character newValue = remappingFunction.apply(Byte.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  867 */     int pos = find(k);
/*  868 */     Character newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
...
/*  947 */       return Byte2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  952 */       return Byte2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  957 */       return Byte2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  962 */       return Byte2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  967 */       char oldValue = Byte2CharLinkedOpenHashMap.this.value[this.index];
/*  968 */       Byte2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  969 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteCharPair right(char v) {
/*  974 */       Byte2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  975 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  986 */       return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  997 */       return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1015 */       Map.Entry<Byte, Character> e = (Map.Entry<Byte, Character>)o;
/* 1016 */       return (Byte2CharLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1021 */       return Byte2CharLinkedOpenHashMap.this.key[this.index] ^ Byte2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1026 */       return Byte2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Byte2CharLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(byte from) {
/* 1199 */       if (from == 0) {
/* 1200 */         if (Byte2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1201 */           this.next = (int)Byte2CharLinkedOpenHashMap.this.link[Byte2CharLinkedOpenHashMap.this.n];
/* 1202 */           this.prev = Byte2CharLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.last] == from) {
/* 1207 */         this.prev = Byte2CharLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Byte2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = HashCommon.mix(from) & Byte2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Byte2CharLinkedOpenHashMap.this.key[pos] != 0) {
/* 1215 */         if (Byte2CharLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1217 */           this.next = (int)Byte2CharLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Byte2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Byte2CharLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Byte2CharLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1265 */       this.next = (int)Byte2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1274 */       this.prev = (int)(Byte2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1283 */         this.next = (int)Byte2CharLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1296 */         this.index--;
/* 1297 */         this.prev = (int)(Byte2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1298 */       else { this.next = (int)Byte2CharLinkedOpenHashMap.this.link[this.curr]; }
/* 1299 */        Byte2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1302 */       if (this.prev == -1) { Byte2CharLinkedOpenHashMap.this.first = this.next; }
/* 1303 */       else { Byte2CharLinkedOpenHashMap.this.link[this.prev] = Byte2CharLinkedOpenHashMap.this.link[this.prev] ^ (Byte2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1304 */        if (this.next == -1) { Byte2CharLinkedOpenHashMap.this.last = this.prev; }
/* 1305 */       else { Byte2CharLinkedOpenHashMap.this.link[this.next] = Byte2CharLinkedOpenHashMap.this.link[this.next] ^ (Byte2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1306 */        int pos = this.curr;
/* 1307 */       this.curr = -1;
/* 1308 */       if (pos == Byte2CharLinkedOpenHashMap.this.n) {
/* 1309 */         Byte2CharLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1312 */         byte[] key = Byte2CharLinkedOpenHashMap.this.key; while (true) {
/*      */           byte curr;
/*      */           int last;
/* 1315 */           pos = (last = pos) + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1317 */             if ((curr = key[pos]) == 0) {
/* 1318 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1321 */             int slot = HashCommon.mix(curr) & Byte2CharLinkedOpenHashMap.this.mask;
/* 1322 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1323 */               break;  pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Byte2CharLinkedOpenHashMap.this.value[last] = Byte2CharLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos) this.next = last; 
/* 1328 */           if (this.prev == pos) this.prev = last; 
/* 1329 */           Byte2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/* 1368 */       action.accept(new Byte2CharLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharLinkedOpenHashMap.MapEntry next() {
/* 1373 */       return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharLinkedOpenHashMap.MapEntry previous() {
/* 1378 */       return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1389 */     final Byte2CharLinkedOpenHashMap.MapEntry entry = new Byte2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1423 */       return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1441 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Byte2CharLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1466 */       if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1467 */       return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2CharMap.Entry last() {
/* 1472 */       if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1473 */       return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1485 */       if (k == 0) return (Byte2CharLinkedOpenHashMap.this.containsNullKey && Byte2CharLinkedOpenHashMap.this.value[Byte2CharLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1487 */       byte[] key = Byte2CharLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1490 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2CharLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1491 */       if (k == curr) return (Byte2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1494 */         if ((curr = key[pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1495 */         if (k == curr) return (Byte2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1508 */       if (k == 0) {
/* 1509 */         if (Byte2CharLinkedOpenHashMap.this.containsNullKey && Byte2CharLinkedOpenHashMap.this.value[Byte2CharLinkedOpenHashMap.this.n] == v) {
/* 1510 */           Byte2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1511 */           return true;
/*      */         } 
/* 1513 */         return false;
/*      */       } 
/*      */       
/* 1516 */       byte[] key = Byte2CharLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1519 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2CharLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1520 */       if (curr == k) {
/* 1521 */         if (Byte2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1522 */           Byte2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/* 1525 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1528 */         if ((curr = key[pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1529 */         if (curr == k && 
/* 1530 */           Byte2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1531 */           Byte2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1532 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1540 */       return Byte2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1545 */       Byte2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       return new Byte2CharLinkedOpenHashMap.EntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1569 */       return new Byte2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */       return new Byte2CharLinkedOpenHashMap.FastEntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2CharMap.Entry> consumer) {
/* 1588 */       for (int i = Byte2CharLinkedOpenHashMap.this.size, next = Byte2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1589 */         int curr = next;
/* 1590 */         next = (int)Byte2CharLinkedOpenHashMap.this.link[curr];
/* 1591 */         consumer.accept(new Byte2CharLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1598 */       Byte2CharLinkedOpenHashMap.MapEntry entry = new Byte2CharLinkedOpenHashMap.MapEntry();
/* 1599 */       for (int i = Byte2CharLinkedOpenHashMap.this.size, next = Byte2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1600 */         entry.index = next;
/* 1601 */         next = (int)Byte2CharLinkedOpenHashMap.this.link[next];
...
/* 1628 */       return Byte2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */       action.accept(Byte2CharLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1645 */       return Byte2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1654 */       return new Byte2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteListIterator iterator() {
/* 1659 */       return new Byte2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1669 */       return ByteSpliterators.asSpliterator(iterator(), Size64.sizeOf(Byte2CharLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1675 */       for (int i = Byte2CharLinkedOpenHashMap.this.size, next = Byte2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1676 */         int curr = next;
/* 1677 */         next = (int)Byte2CharLinkedOpenHashMap.this.link[curr];
/* 1678 */         consumer.accept(Byte2CharLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1684 */       return Byte2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1689 */       return Byte2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1694 */       int oldSize = Byte2CharLinkedOpenHashMap.this.size;
/* 1695 */       Byte2CharLinkedOpenHashMap.this.remove(k);
/* 1696 */       return (Byte2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1701 */       Byte2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByte() {
/* 1706 */       if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1707 */       return Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte lastByte() {
/* 1712 */       if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1713 */       return Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteComparator comparator() {
...
/* 1754 */       return Byte2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1766 */       action.accept(Byte2CharLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1771 */       return Byte2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1782 */             return (CharIterator)new Byte2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1792 */             return CharSpliterators.asSpliterator(iterator(), Size64.sizeOf(Byte2CharLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1798 */             for (int i = Byte2CharLinkedOpenHashMap.this.size, next = Byte2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1799 */               int curr = next;
/* 1800 */               next = (int)Byte2CharLinkedOpenHashMap.this.link[curr];
/* 1801 */               consumer.accept(Byte2CharLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1807 */             return Byte2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1812 */             return Byte2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1817 */             Byte2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1937 */       c = (Byte2CharLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharLinkedOpenHashMap.class
