...
/*  543 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  635 */       return Byte2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  640 */       return Byte2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  645 */       return Byte2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  650 */       return Byte2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  655 */       float oldValue = Byte2FloatOpenCustomHashMap.this.value[this.index];
/*  656 */       Byte2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteFloatPair right(float v) {
/*  662 */       Byte2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  674 */       return Byte.valueOf(Byte2FloatOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Float.valueOf(Byte2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Byte, Float> e = (Map.Entry<Byte, Float>)o;
/*  704 */       return (Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Byte2FloatOpenCustomHashMap.this.strategy.hashCode(Byte2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Byte2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Byte2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Byte2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Byte2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Byte2FloatOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Byte2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Byte2FloatOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask;
/*  763 */           for (; !Byte2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2FloatOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Byte2FloatOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask;
/*  783 */           for (; !Byte2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2FloatOpenCustomHashMap.this.mask);
...
/*  803 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  805 */         pos = (last = pos) + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2FloatOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Byte2FloatOpenCustomHashMap.this.value[last] = Byte2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Byte2FloatOpenCustomHashMap.this.n)
/*  827 */       { Byte2FloatOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Byte2FloatOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Byte2FloatOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2FloatMap.Entry>> implements ObjectIterator<Byte2FloatMap.Entry> { public Byte2FloatOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Byte2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Byte2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Byte2FloatOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Byte2FloatOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Byte2FloatOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Byte2FloatOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Byte2FloatOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Byte2FloatOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Byte2FloatOpenCustomHashMap.this.size - this.c), (long)(Byte2FloatOpenCustomHashMap.this.realSize() / Byte2FloatOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Byte2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2FloatMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2FloatMap.Entry> action, int index) {
/* 1014 */       action.accept(new Byte2FloatOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Byte2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2FloatMap.Entry> fastIterator() {
/* 1031 */       return new Byte2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2FloatMap.Entry> spliterator() {
/* 1036 */       return new Byte2FloatOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) return (Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1051 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) return (Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/* 1073 */         if (Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1074 */           Byte2FloatOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       byte[] key = Byte2FloatOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1086 */           Byte2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1095 */           Byte2FloatOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Byte2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Byte2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/* 1115 */       if (Byte2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(new Byte2FloatOpenCustomHashMap.MapEntry(Byte2FloatOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Byte2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Byte2FloatOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/* 1122 */       Byte2FloatOpenCustomHashMap.MapEntry entry = new Byte2FloatOpenCustomHashMap.MapEntry();
/* 1123 */       if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Byte2FloatOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Byte2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Byte2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1163 */       return Byte2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1184 */       action.accept(Byte2FloatOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Byte2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1201 */       return new Byte2FloatOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1207 */       if (Byte2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Byte2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         byte k = Byte2FloatOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Byte2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1221 */       return Byte2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1226 */       int oldSize = Byte2FloatOpenCustomHashMap.this.size;
/* 1227 */       Byte2FloatOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Byte2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Byte2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Byte2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1266 */       return Byte2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1287 */       action.accept(Byte2FloatOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Byte2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1306 */             return new Byte2FloatOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1312 */             if (Byte2FloatOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Byte2FloatOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2FloatOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Byte2FloatOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Byte2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1323 */             return Byte2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Byte2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Byte2FloatOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2FloatOpenCustomHashMap.class
