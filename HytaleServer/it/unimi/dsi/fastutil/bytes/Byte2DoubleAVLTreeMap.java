...
/*  885 */       Map.Entry<Byte, Double> e = (Map.Entry<Byte, Double>)o;
/*  886 */       return (this.key == ((Byte)e.getKey()).byteValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Byte2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  998 */       if ((this.next = Byte2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Byte2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Byte2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2DoubleMap.Entry>)new AbstractObjectSortedSet<Byte2DoubleMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Byte2DoubleAVLTreeMap.Entry f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1147 */             Byte2DoubleAVLTreeMap.Entry f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1149 */             Byte2DoubleAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Byte2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Byte2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2DoubleMap.Entry first() {
/* 1165 */             return Byte2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2DoubleMap.Entry last() {
/* 1170 */             return Byte2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to) {
/* 1175 */             return Byte2DoubleAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to) {
/* 1180 */             return Byte2DoubleAVLTreeMap.this.headMap(to.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from) {
/* 1185 */             return Byte2DoubleAVLTreeMap.this.tailMap(from.getByteKey()).byte2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Byte2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1227 */       return new Byte2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (DoubleIterator)new Byte2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1285 */             return Byte2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Byte2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Byte2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Byte2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Byte2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Byte2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2DoubleMap.Entry>)new AbstractObjectSortedSet<Byte2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Byte2DoubleMap.Entry>)new Byte2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2DoubleMap.Entry> comparator() {
/* 1399 */               return Byte2DoubleAVLTreeMap.this.byte2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Byte2DoubleAVLTreeMap.Entry f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1410 */               return (f != null && Byte2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Byte2DoubleAVLTreeMap.Entry f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1421 */               if (f != null && Byte2DoubleAVLTreeMap.Submap.this.in(f.key)) Byte2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Byte2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Byte2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Byte2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2DoubleMap.Entry first() {
/* 1444 */               return Byte2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2DoubleMap.Entry last() {
/* 1449 */               return Byte2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to) {
/* 1454 */               return Byte2DoubleAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to) {
/* 1459 */               return Byte2DoubleAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from) {
/* 1464 */               return Byte2DoubleAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2DoubleEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractByte2DoubleSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1473 */         return new Byte2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1478 */         return new Byte2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1493 */               return (DoubleIterator)new Byte2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1498 */               return Byte2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Byte2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Byte2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1518 */       return (in(k) && Byte2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(byte k) {
/* 1536 */       byte kk = k; Byte2DoubleAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Byte2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(byte k, double v) {
/* 1542 */       Byte2DoubleAVLTreeMap.this.modified = false;
...
/* 1544 */       double oldValue = Byte2DoubleAVLTreeMap.this.put(k, v);
/* 1545 */       return Byte2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(byte k) {
/* 1551 */       Byte2DoubleAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       double oldValue = Byte2DoubleAVLTreeMap.this.remove(k);
/* 1554 */       return Byte2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1575 */       return Byte2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap headMap(byte to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Byte2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap tailMap(byte from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Byte2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2DoubleSortedMap subMap(byte from, byte to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Byte2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Byte2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Byte2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Byte2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Byte2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Byte2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Byte2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2DoubleAVLTreeMap.Entry e;
/* 1627 */       if (Byte2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Byte2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Byte2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Byte2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Byte2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1645 */       Byte2DoubleAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1652 */       Byte2DoubleAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Byte2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Byte2DoubleAVLTreeMap.Submap.this.bottom && Byte2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Byte2DoubleAVLTreeMap.Submap.this.top && Byte2DoubleAVLTreeMap.this.compare(k, (this.prev = Byte2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Byte2DoubleAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Byte2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Byte2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2DoubleAVLTreeMap.this.compare(this.prev.key, Byte2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Byte2DoubleAVLTreeMap.Submap.this.top && this.next != null && Byte2DoubleAVLTreeMap.this.compare(this.next.key, Byte2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Byte2DoubleMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Byte2DoubleAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readByte(), s.readDouble());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readByte(), s.readDouble());
/* 1866 */       entry.right(new Entry(s.readByte(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleAVLTreeMap.class
