...
/*  49 */     return (entries instanceof Byte2ObjectMap.FastEntrySet) ? ((Byte2ObjectMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  64 */     ObjectSet<Byte2ObjectMap.Entry<V>> entries = map.byte2ObjectEntrySet();
/*  65 */     if (entries instanceof Byte2ObjectMap.FastEntrySet) { ((Byte2ObjectMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  81 */     final ObjectSet<Byte2ObjectMap.Entry<V>> entries = map.byte2ObjectEntrySet();
/*  82 */     return (entries instanceof Byte2ObjectMap.FastEntrySet) ? new ObjectIterable<Byte2ObjectMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() {
/*  85 */           return ((Byte2ObjectMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  95 */           ((Byte2ObjectMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  97 */       } : (ObjectIterable<Byte2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 135 */       return (ObjectSet<Byte2ObjectMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
/* 140 */       return ByteSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 155 */       return Byte2ObjectMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 227 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractByte2ObjectMap.BasicEntry<>(this.key, this.value)); 
...
/* 240 */       return (ObjectSet)byte2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
/* 245 */       if (this.keys == null) this.keys = ByteSets.singleton(this.key); 
...
/*     */   
/*     */   public static <V> Byte2ObjectMap<V> singleton(Byte key, V value) {
/* 307 */     return new Singleton<>(key.byteValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Byte2ObjectFunctions.SynchronizedFunction<V> implements Byte2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 345 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2ObjectEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, V>> entrySet() {
/* 359 */       return (ObjectSet)byte2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
/* 364 */       synchronized (this.sync) {
/* 365 */         if (this.keys == null) this.keys = ByteSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Byte2ObjectFunctions.UnmodifiableFunction<V> implements Byte2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 659 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2ObjectEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, V>> entrySet() {
/* 672 */       return (ObjectSet)byte2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
/* 677 */       if (this.keys == null) this.keys = ByteSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectMaps.class
