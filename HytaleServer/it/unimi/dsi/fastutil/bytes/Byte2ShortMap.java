...
/*     */   
/*     */   @Deprecated
/*     */   default ObjectSet<Map.Entry<Byte, Short>> entrySet() {
/* 150 */     return (ObjectSet)byte2ShortEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = byte2ShortEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Byte.valueOf(entry.getByteKey()), Short.valueOf(entry.getShortValue()));
...
/* 502 */     Short newValue = remappingFunction.apply(Byte.valueOf(key), Short.valueOf(oldValue));
...
/* 534 */     Short newValue = remappingFunction.apply(Byte.valueOf(key), contained ? Short.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortMap.class
