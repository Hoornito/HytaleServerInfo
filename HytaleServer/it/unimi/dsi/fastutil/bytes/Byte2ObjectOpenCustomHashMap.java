...
/*  260 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  262 */     byte[] key = this.key;
/*      */     byte curr;
/*      */     int pos;
...
/*  304 */     byte[] key = this.key; while (true) {
/*      */       byte curr; int last;
...
/*      */   
/*      */   public V get(byte k) {
/*  344 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  346 */     byte[] key = this.key;
/*      */     byte curr;
/*      */     int pos;
...
/*  361 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey;
/*      */     
/*  363 */     byte[] key = this.key;
/*      */     byte curr;
/*      */     int pos;
...
/*  388 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
...
/*  415 */     if (this.strategy.equals(k, (byte)0)) {
...
/*  489 */     V newValue = remappingFunction.apply(Byte.valueOf(k), this.value[pos]);
/*  490 */     if (newValue == null) {
/*  491 */       if (this.strategy.equals(k, (byte)0)) { removeNullEntry(); }
...
/*  502 */     int pos = find(k);
/*  503 */     V newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? this.value[pos] : null);
/*  504 */     if (newValue == null) {
/*  505 */       if (pos >= 0)
/*  506 */         if (this.strategy.equals(k, (byte)0)) { removeNullEntry(); }
...
/*  532 */       if (this.strategy.equals(k, (byte)0)) { removeNullEntry(); }
...
/*  550 */     Arrays.fill(this.key, (byte)0);
...
/*      */     implements Byte2ObjectMap.Entry<V>, Map.Entry<Byte, V>, ByteObjectPair<V>
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  582 */       return Byte2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  587 */       return Byte2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  592 */       return Byte2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  597 */       return Byte2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  602 */       V oldValue = Byte2ObjectOpenCustomHashMap.this.value[this.index];
/*  603 */       Byte2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  604 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteObjectPair<V> right(V v) {
/*  609 */       Byte2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  610 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  621 */       return Byte.valueOf(Byte2ObjectOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  628 */       Map.Entry<Byte, V> e = (Map.Entry<Byte, V>)o;
/*  629 */       return (Byte2ObjectOpenCustomHashMap.this.strategy.equals(Byte2ObjectOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  634 */       return Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(Byte2ObjectOpenCustomHashMap.this.key[this.index]) ^ ((Byte2ObjectOpenCustomHashMap.this.value[this.index] == null) ? 0 : Byte2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  639 */       return Byte2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Byte2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  650 */     int pos = Byte2ObjectOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  656 */     int last = -1;
/*      */     
/*  658 */     int c = Byte2ObjectOpenCustomHashMap.this.size;
/*      */     
/*  660 */     boolean mustReturnNullKey = Byte2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  679 */         return this.last = Byte2ObjectOpenCustomHashMap.this.n;
/*      */       } 
/*  681 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  683 */         if (--this.pos < 0) {
/*      */           
/*  685 */           this.last = Integer.MIN_VALUE;
/*  686 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  687 */           int p = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ObjectOpenCustomHashMap.this.mask;
/*  688 */           for (; !Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2ObjectOpenCustomHashMap.this.mask);
/*  689 */           return p;
/*      */         } 
...
/*  698 */         acceptOnIndex(action, this.last = Byte2ObjectOpenCustomHashMap.this.n);
/*  699 */         this.c--;
/*      */       } 
/*  701 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
/*  702 */       while (this.c != 0) {
/*  703 */         if (--this.pos < 0) {
/*      */           
/*  705 */           this.last = Integer.MIN_VALUE;
/*  706 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  707 */           int p = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ObjectOpenCustomHashMap.this.mask;
/*  708 */           for (; !Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2ObjectOpenCustomHashMap.this.mask);
...
/*  728 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  730 */         pos = (last = pos) + 1 & Byte2ObjectOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  732 */           if ((curr = key[pos]) == 0) {
/*  733 */             key[last] = 0;
/*  734 */             Byte2ObjectOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  737 */           int slot = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2ObjectOpenCustomHashMap.this.mask;
/*  738 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  739 */             break;  pos = pos + 1 & Byte2ObjectOpenCustomHashMap.this.mask;
/*      */         } 
/*  741 */         if (pos < last) {
/*  742 */           if (this.wrapped == null) this.wrapped = new ByteArrayList(2); 
/*  743 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  745 */         key[last] = curr;
/*  746 */         Byte2ObjectOpenCustomHashMap.this.value[last] = Byte2ObjectOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  751 */       if (this.last == -1) throw new IllegalStateException(); 
/*  752 */       if (this.last == Byte2ObjectOpenCustomHashMap.this.n)
/*  753 */       { Byte2ObjectOpenCustomHashMap.this.containsNullKey = false;
/*  754 */         Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n] = null; }
/*  755 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  758 */       { Byte2ObjectOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  759 */         this.last = -1;
/*      */         return; }
/*      */       
/*  762 */       Byte2ObjectOpenCustomHashMap.this.size--;
/*  763 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2ObjectMap.Entry<V>>> implements ObjectIterator<Byte2ObjectMap.Entry<V>> { public Byte2ObjectOpenCustomHashMap<V>.MapEntry next() {
/*  779 */       return this.entry = new Byte2ObjectOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  785 */       action.accept(this.entry = new Byte2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Byte2ObjectMap.Entry<V>>> implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
/*      */     private FastEntryIterator() {
/*  796 */       this.entry = new Byte2ObjectOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  817 */     int pos = 0;
/*      */     
/*  819 */     int max = Byte2ObjectOpenCustomHashMap.this.n;
/*      */     
/*  821 */     int c = 0;
/*      */     
/*  823 */     boolean mustReturnNull = Byte2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  843 */         this.c++;
/*  844 */         acceptOnIndex(action, Byte2ObjectOpenCustomHashMap.this.n);
/*  845 */         return true;
/*      */       } 
/*  847 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
...
/*  862 */         this.c++;
/*  863 */         acceptOnIndex(action, Byte2ObjectOpenCustomHashMap.this.n);
/*      */       } 
/*  865 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
...
/*      */       {
/*  878 */         return (Byte2ObjectOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  883 */       return Math.min((Byte2ObjectOpenCustomHashMap.this.size - this.c), (long)(Byte2ObjectOpenCustomHashMap.this.realSize() / Byte2ObjectOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  911 */         n--;
/*      */       } 
/*  913 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Byte2ObjectMap.Entry<V>>, EntrySpliterator> implements ObjectSpliterator<Byte2ObjectMap.Entry<V>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2ObjectMap.Entry<V>> action, int index) {
/*  941 */       action.accept(new Byte2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  953 */       return new Byte2ObjectOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
/*  958 */       return new Byte2ObjectOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2ObjectMap.Entry<V>> spliterator() {
/*  963 */       return new Byte2ObjectOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  972 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/*  973 */       byte k = ((Byte)e.getKey()).byteValue();
/*  974 */       V v = (V)e.getValue();
/*  975 */       if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, (byte)0)) return (Byte2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n], v));
/*      */       
/*  977 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  980 */       if ((curr = key[pos = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/*  981 */       if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  984 */         if ((curr = key[pos = pos + 1 & Byte2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/*  985 */         if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  994 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/*  995 */       byte k = ((Byte)e.getKey()).byteValue();
/*  996 */       V v = (V)e.getValue();
/*  997 */       if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/*  998 */         if (Byte2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n], v)) {
/*  999 */           Byte2ObjectOpenCustomHashMap.this.removeNullEntry();
/* 1000 */           return true;
/*      */         } 
/* 1002 */         return false;
/*      */       } 
/*      */       
/* 1005 */       byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1008 */       if ((curr = key[pos = HashCommon.mix(Byte2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1009 */       if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1010 */         if (Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1011 */           Byte2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1012 */           return true;
/*      */         } 
/* 1014 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Byte2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1018 */         if (Byte2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1019 */           Objects.equals(Byte2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1020 */           Byte2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1021 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1029 */       return Byte2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1034 */       Byte2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
/* 1040 */       if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(new Byte2ObjectOpenCustomHashMap.MapEntry(Byte2ObjectOpenCustomHashMap.this.n)); 
/* 1041 */       for (int pos = Byte2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Byte2ObjectOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
/* 1047 */       Byte2ObjectOpenCustomHashMap<V>.MapEntry entry = new Byte2ObjectOpenCustomHashMap.MapEntry();
/* 1048 */       if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) {
/* 1049 */         entry.index = Byte2ObjectOpenCustomHashMap.this.n;
/* 1050 */         consumer.accept(entry);
/*      */       } 
/* 1052 */       for (int pos = Byte2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1083 */       action.accept(Byte2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1088 */       return Byte2ObjectOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1109 */       action.accept(Byte2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1121 */       return new Byte2ObjectOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1126 */       return new Byte2ObjectOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1132 */       if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2ObjectOpenCustomHashMap.this.key[Byte2ObjectOpenCustomHashMap.this.n]); 
/* 1133 */       for (int pos = Byte2ObjectOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1134 */         byte k = Byte2ObjectOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1141 */       return Byte2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1146 */       return Byte2ObjectOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1151 */       int oldSize = Byte2ObjectOpenCustomHashMap.this.size;
/* 1152 */       Byte2ObjectOpenCustomHashMap.this.remove(k);
/* 1153 */       return (Byte2ObjectOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1158 */       Byte2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1186 */       action.accept(Byte2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1191 */       return Byte2ObjectOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1212 */       action.accept(Byte2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1226 */             return new Byte2ObjectOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1231 */             return new Byte2ObjectOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1237 */             if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2ObjectOpenCustomHashMap.this.value[Byte2ObjectOpenCustomHashMap.this.n]); 
/* 1238 */             for (int pos = Byte2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2ObjectOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Byte2ObjectOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1243 */             return Byte2ObjectOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1248 */             return Byte2ObjectOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1253 */             Byte2ObjectOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1317 */     byte[] key = this.key;
/* 1318 */     V[] value = this.value;
/* 1319 */     int mask = newN - 1;
/* 1320 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1351 */       c = (Byte2ObjectOpenCustomHashMap<V>)super.clone();
...
/* 1359 */     c.key = (byte[])this.key.clone();
...
/* 1407 */     byte[] key = this.key = new byte[this.n + 1];
/* 1408 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1411 */     for (int i = this.size; i-- != 0; ) {
/* 1412 */       int pos; byte k = s.readByte();
/* 1413 */       V v = (V)s.readObject();
/* 1414 */       if (this.strategy.equals(k, (byte)0)) {
/* 1415 */         pos = this.n;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectOpenCustomHashMap.class
