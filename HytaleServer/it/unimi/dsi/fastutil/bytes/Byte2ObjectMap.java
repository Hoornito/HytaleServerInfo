...
/* 156 */     return (ObjectSet)byte2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     ObjectSet<Entry<V>> entrySet = byte2ObjectEntrySet();
/* 249 */     Consumer<Entry<V>> wrappingConsumer = entry -> consumer.accept(Byte.valueOf(entry.getByteKey()), entry.getValue());
...
/* 460 */     V newValue = remappingFunction.apply(Byte.valueOf(key), oldValue);
...
/* 491 */     V newValue = remappingFunction.apply(Byte.valueOf(key), contained ? oldValue : null);
...
/*     */     @Deprecated
/*     */     default Byte getKey() {
/* 560 */       return Byte.valueOf(getByteKey());
/*     */     }
/*     */     
/*     */     byte getByteKey();
/*     */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectMap.class
