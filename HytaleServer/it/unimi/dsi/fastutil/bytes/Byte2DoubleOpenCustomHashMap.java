...
/*  542 */     Double newValue = remappingFunction.apply(Byte.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Double newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*  634 */       return Byte2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  639 */       return Byte2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double getDoubleValue() {
/*  644 */       return Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double rightDouble() {
/*  649 */       return Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double v) {
/*  654 */       double oldValue = Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*  655 */       Byte2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteDoublePair right(double v) {
/*  661 */       Byte2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  673 */       return Byte.valueOf(Byte2DoubleOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Double.valueOf(Byte2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Byte, Double> e = (Map.Entry<Byte, Double>)o;
/*  703 */       return (Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(Byte2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Byte2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Byte2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Byte2DoubleOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Byte2DoubleOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Byte2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Byte2DoubleOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*  762 */           for (; !Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2DoubleOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Byte2DoubleOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*  782 */           for (; !Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2DoubleOpenCustomHashMap.this.mask);
...
/*  802 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  804 */         pos = (last = pos) + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == 0) {
/*  807 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Byte2DoubleOpenCustomHashMap.this.value[last] = Byte2DoubleOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Byte2DoubleOpenCustomHashMap.this.n)
/*  826 */       { Byte2DoubleOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Byte2DoubleOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Byte2DoubleOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2DoubleMap.Entry>> implements ObjectIterator<Byte2DoubleMap.Entry> { public Byte2DoubleOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Byte2DoubleOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Byte2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Byte2DoubleOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Byte2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Byte2DoubleOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Byte2DoubleOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Byte2DoubleOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Byte2DoubleOpenCustomHashMap.this.size - this.c), (long)(Byte2DoubleOpenCustomHashMap.this.realSize() / Byte2DoubleOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2DoubleMap.Entry> action, int index) {
/* 1013 */       action.accept(new Byte2DoubleOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Byte2DoubleOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2DoubleMap.Entry> fastIterator() {
/* 1030 */       return new Byte2DoubleOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2DoubleMap.Entry> spliterator() {
/* 1035 */       return new Byte2DoubleOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) return (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       
/* 1050 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) return (Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/* 1072 */         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1073 */           Byte2DoubleOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1085 */           Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1094 */           Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Byte2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Byte2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
/* 1114 */       if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(new Byte2DoubleOpenCustomHashMap.MapEntry(Byte2DoubleOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Byte2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2DoubleOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Byte2DoubleOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
/* 1121 */       Byte2DoubleOpenCustomHashMap.MapEntry entry = new Byte2DoubleOpenCustomHashMap.MapEntry();
/* 1122 */       if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Byte2DoubleOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Byte2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2DoubleOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1157 */       action.accept(Byte2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1162 */       return Byte2DoubleOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1183 */       action.accept(Byte2DoubleOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Byte2DoubleOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1200 */       return new Byte2DoubleOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1206 */       if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Byte2DoubleOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         byte k = Byte2DoubleOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Byte2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1220 */       return Byte2DoubleOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1225 */       int oldSize = Byte2DoubleOpenCustomHashMap.this.size;
/* 1226 */       Byte2DoubleOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Byte2DoubleOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Byte2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Byte2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public double nextDouble() {
/* 1265 */       return Byte2DoubleOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(DoubleConsumer action, int index) {
/* 1286 */       action.accept(Byte2DoubleOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Byte2DoubleOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public DoubleSpliterator spliterator() {
/* 1305 */             return new Byte2DoubleOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1311 */             if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Byte2DoubleOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2DoubleOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Byte2DoubleOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Byte2DoubleOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double v) {
/* 1322 */             return Byte2DoubleOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Byte2DoubleOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Byte2DoubleOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleOpenCustomHashMap.class
