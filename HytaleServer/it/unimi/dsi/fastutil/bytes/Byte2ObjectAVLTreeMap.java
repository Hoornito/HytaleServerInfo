...
/*  865 */       return (this.key == ((Byte)e.getKey()).byteValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Byte2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  977 */       if ((this.next = Byte2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Byte2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1124 */             Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1125 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1126 */             Byte2ObjectAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Byte2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Byte2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> first() {
/* 1142 */             return Byte2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> last() {
/* 1147 */             return Byte2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1152 */             return Byte2ObjectAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1157 */             return Byte2ObjectAVLTreeMap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1162 */             return Byte2ObjectAVLTreeMap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Byte2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1204 */       return new Byte2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Byte2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Byte2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Byte2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Byte2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Byte2ObjectAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Byte2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Byte2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2ObjectMap.Entry<V>> comparator() {
/* 1376 */               return Byte2ObjectAVLTreeMap.this.byte2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1385 */               Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1386 */               return (f != null && Byte2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1395 */               Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1396 */               if (f != null && Byte2ObjectAVLTreeMap.Submap.this.in(f.key)) Byte2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Byte2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Byte2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> first() {
/* 1419 */               return Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> last() {
/* 1424 */               return Byte2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1429 */               return Byte2ObjectAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1434 */               return Byte2ObjectAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1439 */               return Byte2ObjectAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1448 */         return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1453 */         return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Byte2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Byte2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Byte2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Byte2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1493 */       return (in(k) && Byte2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1511 */       byte kk = k; Byte2ObjectAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Byte2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(byte k, V v) {
/* 1517 */       Byte2ObjectAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Byte2ObjectAVLTreeMap.this.put(k, v);
/* 1520 */       return Byte2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1526 */       Byte2ObjectAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Byte2ObjectAVLTreeMap.this.remove(k);
/* 1529 */       return Byte2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1550 */       return Byte2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ObjectSortedMap<V> headMap(byte to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Byte2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Byte2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Byte2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Byte2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Byte2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Byte2ObjectAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Byte2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Byte2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Byte2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2ObjectAVLTreeMap.Entry<V> e;
/* 1602 */       if (Byte2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Byte2ObjectAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Byte2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Byte2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Byte2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1620 */       Byte2ObjectAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1627 */       Byte2ObjectAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */       extends Byte2ObjectAVLTreeMap<V>.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Byte2ObjectAVLTreeMap.Submap.this.bottom && Byte2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Byte2ObjectAVLTreeMap.Submap.this.top && Byte2ObjectAVLTreeMap.this.compare(k, (this.prev = Byte2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Byte2ObjectAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Byte2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ObjectAVLTreeMap.this.compare(this.prev.key, Byte2ObjectAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Byte2ObjectAVLTreeMap.Submap.this.top && this.next != null && Byte2ObjectAVLTreeMap.this.compare(this.next.key, Byte2ObjectAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Byte2ObjectAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectAVLTreeMap.class
