...
/*      */     
/*      */     SetIterator() {
/*  897 */       this.next = ByteRBTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(byte k) {
/*  901 */       if ((this.next = ByteRBTreeSet.this.locateKey(k)) != null) {
/*  902 */         if (ByteRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/*  970 */       updatePrevious();
/*  971 */       updateNext();
/*  972 */       ByteRBTreeSet.this.remove(this.curr.key);
/*  973 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*  994 */     return new Subset((byte)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public ByteSortedSet tailSet(byte from) {
/*  999 */     return new Subset(from, false, (byte)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1037 */       if (!bottom && !top && ByteRBTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1038 */       this.from = from;
...
/* 1060 */       return ((this.bottom || ByteRBTreeSet.this.compare(k, this.from) >= 0) && (this.top || ByteRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1066 */       return (in(k) && ByteRBTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(byte k) {
...
/* 1072 */       return ByteRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1079 */       return ByteRBTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1100 */       return ByteRBTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator() {
...
/* 1116 */       return (ByteRBTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSortedSet tailSet(byte from) {
/* 1121 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1122 */       return (ByteRBTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSortedSet subSet(byte from, byte to) {
...
/* 1140 */       if (ByteRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1144 */       if (this.bottom) { e = ByteRBTreeSet.this.firstEntry; }
/*      */       else
/* 1146 */       { e = ByteRBTreeSet.this.locateKey(this.from);
/*      */         
/* 1148 */         if (ByteRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1152 */       if (e == null || (!this.top && ByteRBTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1153 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       ByteRBTreeSet.Entry e;
/* 1162 */       if (ByteRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1166 */       if (this.top) { e = ByteRBTreeSet.this.lastEntry; }
/*      */       else
/* 1168 */       { e = ByteRBTreeSet.this.locateKey(this.to);
/*      */         
/* 1170 */         if (ByteRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1174 */       if (e == null || (!this.bottom && ByteRBTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1175 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByte() {
/* 1180 */       ByteRBTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByte() {
/* 1187 */       ByteRBTreeSet.Entry e = lastEntry();
...
/*      */       extends ByteRBTreeSet.SetIterator
/*      */     {
/*      */       SubsetIterator() {
/* 1203 */         this.next = ByteRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(byte k) {
/* 1207 */         this();
/* 1208 */         if (this.next != null) {
/* 1209 */           if (!ByteRBTreeSet.Subset.this.bottom && ByteRBTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1210 */           else if (!ByteRBTreeSet.Subset.this.top && ByteRBTreeSet.this.compare(k, (this.prev = ByteRBTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1212 */           { this.next = ByteRBTreeSet.this.locateKey(k);
/* 1213 */             if (ByteRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1224 */         if (!ByteRBTreeSet.Subset.this.bottom && this.prev != null && ByteRBTreeSet.this.compare(this.prev.key, ByteRBTreeSet.Subset.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1229 */         this.next = this.next.next();
/* 1230 */         if (!ByteRBTreeSet.Subset.this.top && this.next != null && ByteRBTreeSet.this.compare(this.next.key, ByteRBTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     ByteRBTreeSet c;
/*      */     try {
/* 1249 */       c = (ByteRBTreeSet)super.clone();
...
/* 1301 */     for (; n-- != 0; s.writeByte(i.nextByte()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1314 */     if (n == 1) {
/* 1315 */       Entry entry = new Entry(s.readByte());
...
/*      */ 
/*      */       
/* 1324 */       Entry entry = new Entry(s.readByte());
/* 1325 */       entry.black(true);
/* 1326 */       entry.right(new Entry(s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\ByteRBTreeSet.class
