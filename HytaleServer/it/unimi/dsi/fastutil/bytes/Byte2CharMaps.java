...
/*  49 */     ObjectSet<Byte2CharMap.Entry> entries = map.byte2CharEntrySet();
/*  50 */     return (entries instanceof Byte2CharMap.FastEntrySet) ? ((Byte2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Byte2CharMap.Entry> entries = map.byte2CharEntrySet();
/*  66 */     if (entries instanceof Byte2CharMap.FastEntrySet) { ((Byte2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Byte2CharMap.Entry> entries = map.byte2CharEntrySet();
/*  83 */     return (entries instanceof Byte2CharMap.FastEntrySet) ? new ObjectIterable<Byte2CharMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Byte2CharMap.Entry> iterator() {
/*  86 */           return ((Byte2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Byte2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Byte2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 147 */       return (ObjectSet<Byte2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Byte2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractByte2CharMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/* 316 */     return new Singleton(key.byteValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Byte2CharFunctions.SynchronizedFunction implements Byte2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() {
/* 381 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/*     */     extends Byte2CharFunctions.UnmodifiableFunction implements Byte2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2CharMap map;
/*     */     protected transient ObjectSet<Byte2CharMap.Entry> entries;
/*     */     protected transient ByteSet keys;
...
/*     */     
/*     */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() {
/* 712 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ByteSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharMaps.class
