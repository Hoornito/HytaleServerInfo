...
/*  520 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  612 */       return Byte2ShortOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  617 */       return Byte2ShortOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short getShortValue() {
/*  622 */       return Byte2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short rightShort() {
/*  627 */       return Byte2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short v) {
/*  632 */       short oldValue = Byte2ShortOpenHashMap.this.value[this.index];
/*  633 */       Byte2ShortOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteShortPair right(short v) {
/*  639 */       Byte2ShortOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  651 */       return Byte.valueOf(Byte2ShortOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Short.valueOf(Byte2ShortOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Byte, Short> e = (Map.Entry<Byte, Short>)o;
/*  681 */       return (Byte2ShortOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return Byte2ShortOpenHashMap.this.key[this.index] ^ Byte2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Byte2ShortOpenHashMap.this.key[this.index] + "=>" + Byte2ShortOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Byte2ShortOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Byte2ShortOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Byte2ShortOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Byte2ShortOpenHashMap.this.n;
/*      */       } 
/*  733 */       byte[] key = Byte2ShortOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(k) & Byte2ShortOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Byte2ShortOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Byte2ShortOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       byte[] key = Byte2ShortOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(k) & Byte2ShortOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Byte2ShortOpenHashMap.this.mask);
...
/*  780 */       byte[] key = Byte2ShortOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  782 */         pos = (last = pos) + 1 & Byte2ShortOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == 0) {
/*  785 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(curr) & Byte2ShortOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Byte2ShortOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Byte2ShortOpenHashMap.this.value[last] = Byte2ShortOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Byte2ShortOpenHashMap.this.n)
/*  804 */       { Byte2ShortOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Byte2ShortOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Byte2ShortOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2ShortMap.Entry>> implements ObjectIterator<Byte2ShortMap.Entry> { public Byte2ShortOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Byte2ShortOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Byte2ShortOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Byte2ShortOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Byte2ShortOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Byte2ShortOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Byte2ShortOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       byte[] key = Byte2ShortOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Byte2ShortOpenHashMap.this.n);
/*      */       } 
/*  915 */       byte[] key = Byte2ShortOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Byte2ShortOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Byte2ShortOpenHashMap.this.size - this.c), (long)(Byte2ShortOpenHashMap.this.realSize() / Byte2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       byte[] key = Byte2ShortOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2ShortMap.Entry> action, int index) {
/*  991 */       action.accept(new Byte2ShortOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Byte2ShortOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2ShortMap.Entry> fastIterator() {
/* 1008 */       return new Byte2ShortOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2ShortMap.Entry> spliterator() {
/* 1013 */       return new Byte2ShortOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (k == 0) return (Byte2ShortOpenHashMap.this.containsNullKey && Byte2ShortOpenHashMap.this.value[Byte2ShortOpenHashMap.this.n] == v);
/*      */       
/* 1028 */       byte[] key = Byte2ShortOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ShortOpenHashMap.this.mask]) == 0) return false; 
/* 1032 */       if (k == curr) return (Byte2ShortOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Byte2ShortOpenHashMap.this.mask]) == 0) return false; 
/* 1036 */         if (k == curr) return (Byte2ShortOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == 0) {
/* 1050 */         if (Byte2ShortOpenHashMap.this.containsNullKey && Byte2ShortOpenHashMap.this.value[Byte2ShortOpenHashMap.this.n] == v) {
/* 1051 */           Byte2ShortOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       byte[] key = Byte2ShortOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ShortOpenHashMap.this.mask]) == 0) return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Byte2ShortOpenHashMap.this.value[pos] == v) {
/* 1063 */           Byte2ShortOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Byte2ShortOpenHashMap.this.mask]) == 0) return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Byte2ShortOpenHashMap.this.value[pos] == v) {
/* 1072 */           Byte2ShortOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Byte2ShortOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Byte2ShortOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1092 */       if (Byte2ShortOpenHashMap.this.containsNullKey) consumer.accept(new Byte2ShortOpenHashMap.MapEntry(Byte2ShortOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Byte2ShortOpenHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenHashMap.this.key[pos] != 0) consumer.accept(new Byte2ShortOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1099 */       Byte2ShortOpenHashMap.MapEntry entry = new Byte2ShortOpenHashMap.MapEntry();
/* 1100 */       if (Byte2ShortOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Byte2ShortOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Byte2ShortOpenHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenHashMap.this.key[pos] != 0) {
...
/* 1135 */       action.accept(Byte2ShortOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1140 */       return Byte2ShortOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1161 */       action.accept(Byte2ShortOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Byte2ShortOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1178 */       return new Byte2ShortOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1184 */       if (Byte2ShortOpenHashMap.this.containsNullKey) consumer.accept(Byte2ShortOpenHashMap.this.key[Byte2ShortOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Byte2ShortOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         byte k = Byte2ShortOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Byte2ShortOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1198 */       return Byte2ShortOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1203 */       int oldSize = Byte2ShortOpenHashMap.this.size;
/* 1204 */       Byte2ShortOpenHashMap.this.remove(k);
/* 1205 */       return (Byte2ShortOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Byte2ShortOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Byte2ShortOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1243 */       return Byte2ShortOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1264 */       action.accept(Byte2ShortOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Byte2ShortOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ShortSpliterator spliterator() {
/* 1283 */             return new Byte2ShortOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ShortConsumer consumer) {
/* 1289 */             if (Byte2ShortOpenHashMap.this.containsNullKey) consumer.accept(Byte2ShortOpenHashMap.this.value[Byte2ShortOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Byte2ShortOpenHashMap.this.n; pos-- != 0;) { if (Byte2ShortOpenHashMap.this.key[pos] != 0) consumer.accept(Byte2ShortOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Byte2ShortOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short v) {
/* 1300 */             return Byte2ShortOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Byte2ShortOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Byte2ShortOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortOpenHashMap.class
