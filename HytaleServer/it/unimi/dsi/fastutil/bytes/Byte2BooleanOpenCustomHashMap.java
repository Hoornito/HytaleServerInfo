...
/*  306 */     byte[] key = this.key; while (true) {
/*      */       byte curr; int last;
...
/*  345 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  347 */     byte[] key = this.key;
/*      */     byte curr;
/*      */     int pos;
...
/*  362 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey;
/*      */     
...
/*  389 */     if (this.strategy.equals(k, (byte)0)) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
...
/*  416 */     if (this.strategy.equals(k, (byte)0)) {
...
/*  502 */     Boolean newValue = remappingFunction.apply(Byte.valueOf(k), Boolean.valueOf(this.value[pos]));
/*  503 */     if (newValue == null) {
/*  504 */       if (this.strategy.equals(k, (byte)0)) { removeNullEntry(); }
...
/*  515 */     int pos = find(k);
/*  516 */     Boolean newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
/*  517 */     if (newValue == null) {
/*  518 */       if (pos >= 0)
/*  519 */         if (this.strategy.equals(k, (byte)0)) { removeNullEntry(); }
...
/*  563 */     Arrays.fill(this.key, (byte)0);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  594 */       return Byte2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte leftByte() {
/*  599 */       return Byte2BooleanOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  604 */       return Byte2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  609 */       return Byte2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  614 */       boolean oldValue = Byte2BooleanOpenCustomHashMap.this.value[this.index];
/*  615 */       Byte2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  616 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBooleanPair right(boolean v) {
/*  621 */       Byte2BooleanOpenCustomHashMap.this.value[this.index] = v;
/*  622 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  633 */       return Byte.valueOf(Byte2BooleanOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  644 */       return Boolean.valueOf(Byte2BooleanOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       Map.Entry<Byte, Boolean> e = (Map.Entry<Byte, Boolean>)o;
/*  663 */       return (Byte2BooleanOpenCustomHashMap.this.strategy.equals(Byte2BooleanOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Byte2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  668 */       return Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(Byte2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Byte2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  673 */       return Byte2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Byte2BooleanOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  684 */     int pos = Byte2BooleanOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  690 */     int last = -1;
/*      */     
/*  692 */     int c = Byte2BooleanOpenCustomHashMap.this.size;
/*      */     
/*  694 */     boolean mustReturnNullKey = Byte2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  713 */         return this.last = Byte2BooleanOpenCustomHashMap.this.n;
/*      */       } 
/*  715 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  717 */         if (--this.pos < 0) {
/*      */           
/*  719 */           this.last = Integer.MIN_VALUE;
/*  720 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  721 */           int p = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2BooleanOpenCustomHashMap.this.mask;
/*  722 */           for (; !Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2BooleanOpenCustomHashMap.this.mask);
/*  723 */           return p;
/*      */         } 
...
/*  732 */         acceptOnIndex(action, this.last = Byte2BooleanOpenCustomHashMap.this.n);
/*  733 */         this.c--;
/*      */       } 
...
/*  742 */           for (; !Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Byte2BooleanOpenCustomHashMap.this.mask);
...
/*  762 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  764 */         pos = (last = pos) + 1 & Byte2BooleanOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == 0) {
/*  767 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2BooleanOpenCustomHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  772 */             break;  pos = pos + 1 & Byte2BooleanOpenCustomHashMap.this.mask;
/*      */         } 
/*  774 */         if (pos < last) {
/*  775 */           if (this.wrapped == null) this.wrapped = new ByteArrayList(2); 
/*  776 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  778 */         key[last] = curr;
/*  779 */         Byte2BooleanOpenCustomHashMap.this.value[last] = Byte2BooleanOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  784 */       if (this.last == -1) throw new IllegalStateException(); 
/*  785 */       if (this.last == Byte2BooleanOpenCustomHashMap.this.n)
/*  786 */       { Byte2BooleanOpenCustomHashMap.this.containsNullKey = false; }
/*  787 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  790 */       { Byte2BooleanOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  791 */         this.last = -1;
/*      */         return; }
/*      */       
/*  794 */       Byte2BooleanOpenCustomHashMap.this.size--;
/*  795 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Byte2BooleanMap.Entry>> implements ObjectIterator<Byte2BooleanMap.Entry> { public Byte2BooleanOpenCustomHashMap.MapEntry next() {
/*  811 */       return this.entry = new Byte2BooleanOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  817 */       action.accept(this.entry = new Byte2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  828 */       this.entry = new Byte2BooleanOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  849 */     int pos = 0;
/*      */     
/*  851 */     int max = Byte2BooleanOpenCustomHashMap.this.n;
/*      */     
/*  853 */     int c = 0;
/*      */     
/*  855 */     boolean mustReturnNull = Byte2BooleanOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  875 */         this.c++;
/*  876 */         acceptOnIndex(action, Byte2BooleanOpenCustomHashMap.this.n);
/*  877 */         return true;
/*      */       } 
/*  879 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
...
/*  894 */         this.c++;
/*  895 */         acceptOnIndex(action, Byte2BooleanOpenCustomHashMap.this.n);
/*      */       } 
/*  897 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
...
/*      */       {
/*  910 */         return (Byte2BooleanOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  915 */       return Math.min((Byte2BooleanOpenCustomHashMap.this.size - this.c), (long)(Byte2BooleanOpenCustomHashMap.this.realSize() / Byte2BooleanOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  943 */         n--;
/*      */       } 
/*  945 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Byte2BooleanMap.Entry> action, int index) {
/*  973 */       action.accept(new Byte2BooleanOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  985 */       return new Byte2BooleanOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Byte2BooleanMap.Entry> fastIterator() {
/*  990 */       return new Byte2BooleanOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Byte2BooleanMap.Entry> spliterator() {
/*  995 */       return new Byte2BooleanOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1008 */       if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, (byte)0)) return (Byte2BooleanOpenCustomHashMap.this.containsNullKey && Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n] == v);
/*      */       
/* 1010 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1013 */       if ((curr = key[pos = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1014 */       if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Byte2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1018 */         if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) return (Byte2BooleanOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1027 */       if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1028 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1029 */       byte k = ((Byte)e.getKey()).byteValue();
/* 1030 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1031 */       if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/* 1032 */         if (Byte2BooleanOpenCustomHashMap.this.containsNullKey && Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n] == v) {
/* 1033 */           Byte2BooleanOpenCustomHashMap.this.removeNullEntry();
/* 1034 */           return true;
/*      */         } 
/* 1036 */         return false;
/*      */       } 
/*      */       
/* 1039 */       byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1042 */       if ((curr = key[pos = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1043 */       if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1044 */         if (Byte2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1045 */           Byte2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1046 */           return true;
/*      */         } 
/* 1048 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1051 */         if ((curr = key[pos = pos + 1 & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1052 */         if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1053 */           Byte2BooleanOpenCustomHashMap.this.value[pos] == v) {
/* 1054 */           Byte2BooleanOpenCustomHashMap.this.removeEntry(pos);
/* 1055 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1063 */       return Byte2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1068 */       Byte2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
/* 1074 */       if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(new Byte2BooleanOpenCustomHashMap.MapEntry(Byte2BooleanOpenCustomHashMap.this.n)); 
/* 1075 */       for (int pos = Byte2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2BooleanOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Byte2BooleanOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
/* 1081 */       Byte2BooleanOpenCustomHashMap.MapEntry entry = new Byte2BooleanOpenCustomHashMap.MapEntry();
/* 1082 */       if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
/* 1083 */         entry.index = Byte2BooleanOpenCustomHashMap.this.n;
/* 1084 */         consumer.accept(entry);
/*      */       } 
/* 1086 */       for (int pos = Byte2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2BooleanOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1117 */       action.accept(Byte2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1122 */       return Byte2BooleanOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1143 */       action.accept(Byte2BooleanOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1155 */       return new Byte2BooleanOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteSpliterator spliterator() {
/* 1160 */       return new Byte2BooleanOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ByteConsumer consumer) {
/* 1166 */       if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2BooleanOpenCustomHashMap.this.key[Byte2BooleanOpenCustomHashMap.this.n]); 
/* 1167 */       for (int pos = Byte2BooleanOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1168 */         byte k = Byte2BooleanOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1175 */       return Byte2BooleanOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(byte k) {
/* 1180 */       return Byte2BooleanOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1185 */       int oldSize = Byte2BooleanOpenCustomHashMap.this.size;
/* 1186 */       Byte2BooleanOpenCustomHashMap.this.remove(k);
/* 1187 */       return (Byte2BooleanOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1192 */       Byte2BooleanOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1220 */       action.accept(Byte2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1225 */       return Byte2BooleanOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1246 */       action.accept(Byte2BooleanOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1260 */             return new Byte2BooleanOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1265 */             return new Byte2BooleanOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1271 */             if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) consumer.accept(Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n]); 
/* 1272 */             for (int pos = Byte2BooleanOpenCustomHashMap.this.n; pos-- != 0;) { if (Byte2BooleanOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Byte2BooleanOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1277 */             return Byte2BooleanOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1282 */             return Byte2BooleanOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1287 */             Byte2BooleanOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1351 */     byte[] key = this.key;
/* 1352 */     boolean[] value = this.value;
/* 1353 */     int mask = newN - 1;
/* 1354 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1385 */       c = (Byte2BooleanOpenCustomHashMap)super.clone();
...
/* 1393 */     c.key = (byte[])this.key.clone();
...
/* 1440 */     byte[] key = this.key = new byte[this.n + 1];
/* 1441 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1444 */     for (int i = this.size; i-- != 0; ) {
/* 1445 */       int pos; byte k = s.readByte();
/* 1446 */       boolean v = s.readBoolean();
/* 1447 */       if (this.strategy.equals(k, (byte)0)) {
/* 1448 */         pos = this.n;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanOpenCustomHashMap.class
