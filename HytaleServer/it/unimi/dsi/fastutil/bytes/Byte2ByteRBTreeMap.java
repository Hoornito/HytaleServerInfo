...
/*   87 */     this.actualComparator = ByteComparators.asByteComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  163 */     this(k, v, (Comparator<? super Byte>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     return (this.actualComparator == null) ? Byte.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  248 */     Entry e = add(k);
/*  249 */     byte oldValue = e.value;
/*  250 */     e.value = (byte)(e.value + incr);
/*  251 */     return oldValue;
/*      */   }
/*      */ 
/*      */   
...
/*  835 */       Map.Entry<Byte, Byte> e = (Map.Entry<Byte, Byte>)o;
/*  836 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  942 */       this.next = Byte2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(byte k) {
/*  946 */       if ((this.next = Byte2ByteRBTreeMap.this.locateKey(k)) != null)
/*  947 */         if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1000 */       updatePrevious();
/* 1001 */       updateNext();
/* 1002 */       Byte2ByteRBTreeMap.this.remove(this.curr.key);
/* 1003 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1047 */     if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */         {
...
/* 1057 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1062 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1071 */             if (!(e.getKey() instanceof Byte)) return false; 
/* 1072 */             if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1073 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1083 */             if (!(e.getKey() instanceof Byte)) return false; 
/* 1084 */             if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1085 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1086 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1087 */             Byte2ByteRBTreeMap.this.remove(f.key);
/* 1088 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1093 */             return Byte2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1098 */             Byte2ByteRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ByteMap.Entry first() {
/* 1103 */             return Byte2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Byte2ByteMap.Entry last() {
/* 1108 */             return Byte2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1113 */             return Byte2ByteRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1118 */             return Byte2ByteRBTreeMap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1123 */             return Byte2ByteRBTreeMap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1160 */       return new Byte2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1165 */       return new Byte2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */     if (this.values == null) this.values = new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1218 */             return new Byte2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1223 */             return Byte2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1228 */             return Byte2ByteRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1233 */             Byte2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1246 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Byte2ByteSortedMap tailMap(byte from) {
/* 1251 */     return new Submap(from, false, (byte)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1295 */       if (!bottom && !top && Byte2ByteRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1296 */       this.from = from;
/* 1297 */       this.bottom = bottom;
/* 1298 */       this.to = to;
/* 1299 */       this.top = top;
/* 1300 */       this.defRetValue = Byte2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1319 */       return ((this.bottom || Byte2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ByteRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 1324 */       if (this.entries == null) this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator() {
/* 1327 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1332 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Byte2ByteMap.Entry> comparator() {
/* 1337 */               return Byte2ByteRBTreeMap.this.byte2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1345 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1346 */               if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1347 */               Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1348 */               return (f != null && Byte2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1356 */               if (e.getKey() == null || !(e.getKey() instanceof Byte)) return false; 
/* 1357 */               if (e.getValue() == null || !(e.getValue() instanceof Byte)) return false; 
/* 1358 */               Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1359 */               if (f != null && Byte2ByteRBTreeMap.Submap.this.in(f.key)) Byte2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1365 */               int c = 0;
/* 1366 */               for (ObjectBidirectionalIterator<Byte2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1367 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Byte2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Byte2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ByteMap.Entry first() {
/* 1382 */               return Byte2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Byte2ByteMap.Entry last() {
/* 1387 */               return Byte2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1392 */               return Byte2ByteRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1397 */               return Byte2ByteRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1402 */               return Byte2ByteRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ByteBidirectionalIterator iterator() {
/* 1411 */         return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1416 */         return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ByteCollection values() {
/* 1428 */       if (this.values == null) this.values = new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1431 */               return new Byte2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1436 */               return Byte2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Byte2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Byte2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1456 */       return (in(k) && Byte2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(byte k) {
/* 1474 */       byte kk = k; Byte2ByteRBTreeMap.Entry e;
/* 1475 */       return (in(kk) && (e = Byte2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(byte k, byte v) {
/* 1480 */       Byte2ByteRBTreeMap.this.modified = false;
...
/* 1482 */       byte oldValue = Byte2ByteRBTreeMap.this.put(k, v);
/* 1483 */       return Byte2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(byte k) {
/* 1489 */       Byte2ByteRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k)) return this.defRetValue; 
/* 1491 */       byte oldValue = Byte2ByteRBTreeMap.this.remove(k);
/* 1492 */       return Byte2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1513 */       return Byte2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ByteSortedMap headMap(byte to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Byte2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ByteSortedMap tailMap(byte from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Byte2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Byte2ByteSortedMap subMap(byte from, byte to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Byte2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Byte2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Byte2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Byte2ByteRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Byte2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Byte2ByteRBTreeMap.Entry e;
/* 1565 */       if (Byte2ByteRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Byte2ByteRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Byte2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte firstByteKey() {
/* 1583 */       Byte2ByteRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1590 */       Byte2ByteRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Byte2ByteRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Byte2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(byte k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Byte2ByteRBTreeMap.Submap.this.bottom && Byte2ByteRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Byte2ByteRBTreeMap.Submap.this.top && Byte2ByteRBTreeMap.this.compare(k, (this.prev = Byte2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Byte2ByteRBTreeMap.this.locateKey(k);
/* 1616 */             if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Byte2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Byte2ByteRBTreeMap.this.compare(this.prev.key, Byte2ByteRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Byte2ByteRBTreeMap.Submap.this.top && this.next != null && Byte2ByteRBTreeMap.this.compare(this.next.key, Byte2ByteRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1721 */       c = (Byte2ByteRBTreeMap)super.clone();
...
/* 1779 */       s.writeByte(e.key);
/* 1780 */       s.writeByte(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry entry = new Entry(s.readByte(), s.readByte());
...
/*      */ 
/*      */       
/* 1804 */       Entry entry = new Entry(s.readByte(), s.readByte());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry(s.readByte(), s.readByte()));
...
/* 1816 */     top.key = s.readByte();
/* 1817 */     top.value = s.readByte();
/* 1818 */     top.black(true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteRBTreeMap.class
