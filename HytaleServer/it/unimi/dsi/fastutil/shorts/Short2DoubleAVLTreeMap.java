...
/*  885 */       Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
/*  886 */       return (this.key == ((Short)e.getKey()).shortValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Short2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  998 */       if ((this.next = Short2DoubleAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Short2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Short2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1147 */             Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1149 */             Short2DoubleAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Short2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Short2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2DoubleMap.Entry first() {
/* 1165 */             return Short2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2DoubleMap.Entry last() {
/* 1170 */             return Short2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1175 */             return Short2DoubleAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1180 */             return Short2DoubleAVLTreeMap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1185 */             return Short2DoubleAVLTreeMap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Short2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1227 */       return new Short2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (DoubleIterator)new Short2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1285 */             return Short2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Short2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Short2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Short2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Short2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Short2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2DoubleMap.Entry> comparator() {
/* 1399 */               return Short2DoubleAVLTreeMap.this.short2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1410 */               return (f != null && Short2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1421 */               if (f != null && Short2DoubleAVLTreeMap.Submap.this.in(f.key)) Short2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Short2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Short2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Short2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2DoubleMap.Entry first() {
/* 1444 */               return Short2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2DoubleMap.Entry last() {
/* 1449 */               return Short2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1454 */               return Short2DoubleAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1459 */               return Short2DoubleAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1464 */               return Short2DoubleAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2DoubleSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1473 */         return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1478 */         return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1493 */               return (DoubleIterator)new Short2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1498 */               return Short2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Short2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Short2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1518 */       return (in(k) && Short2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(short k) {
/* 1536 */       short kk = k; Short2DoubleAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Short2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(short k, double v) {
/* 1542 */       Short2DoubleAVLTreeMap.this.modified = false;
...
/* 1544 */       double oldValue = Short2DoubleAVLTreeMap.this.put(k, v);
/* 1545 */       return Short2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(short k) {
/* 1551 */       Short2DoubleAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       double oldValue = Short2DoubleAVLTreeMap.this.remove(k);
/* 1554 */       return Short2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1575 */       return Short2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap headMap(short to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Short2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap tailMap(short from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Short2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap subMap(short from, short to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Short2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Short2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Short2DoubleAVLTreeMap.Entry e;
/* 1605 */       if (Short2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Short2DoubleAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Short2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Short2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Short2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2DoubleAVLTreeMap.Entry e;
/* 1627 */       if (Short2DoubleAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Short2DoubleAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Short2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Short2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Short2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1645 */       Short2DoubleAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1652 */       Short2DoubleAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Short2DoubleAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Short2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Short2DoubleAVLTreeMap.Submap.this.bottom && Short2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Short2DoubleAVLTreeMap.Submap.this.top && Short2DoubleAVLTreeMap.this.compare(k, (this.prev = Short2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Short2DoubleAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Short2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Short2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Short2DoubleAVLTreeMap.this.compare(this.prev.key, Short2DoubleAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Short2DoubleAVLTreeMap.Submap.this.top && this.next != null && Short2DoubleAVLTreeMap.this.compare(this.next.key, Short2DoubleAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2DoubleMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Short2DoubleAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readShort(), s.readDouble());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readShort(), s.readDouble());
/* 1866 */       entry.right(new Entry(s.readShort(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleAVLTreeMap.class
