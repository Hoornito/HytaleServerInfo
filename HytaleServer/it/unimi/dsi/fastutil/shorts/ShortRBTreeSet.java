...
/*      */     
/*      */     SetIterator() {
/*  897 */       this.next = ShortRBTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(short k) {
/*  901 */       if ((this.next = ShortRBTreeSet.this.locateKey(k)) != null) {
/*  902 */         if (ShortRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/*  970 */       updatePrevious();
/*  971 */       updateNext();
/*  972 */       ShortRBTreeSet.this.remove(this.curr.key);
/*  973 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*  994 */     return new Subset((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public ShortSortedSet tailSet(short from) {
/*  999 */     return new Subset(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1037 */       if (!bottom && !top && ShortRBTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1038 */       this.from = from;
...
/* 1060 */       return ((this.bottom || ShortRBTreeSet.this.compare(k, this.from) >= 0) && (this.top || ShortRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1066 */       return (in(k) && ShortRBTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(short k) {
...
/* 1072 */       return ShortRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1079 */       return ShortRBTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1100 */       return ShortRBTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator() {
...
/* 1116 */       return (ShortRBTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSortedSet tailSet(short from) {
/* 1121 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1122 */       return (ShortRBTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSortedSet subSet(short from, short to) {
/* 1127 */       if (this.top && this.bottom) return new Subset(from, false, to, false); 
/* 1128 */       if (!this.top) to = (ShortRBTreeSet.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1129 */       if (!this.bottom) from = (ShortRBTreeSet.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1140 */       if (ShortRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1144 */       if (this.bottom) { e = ShortRBTreeSet.this.firstEntry; }
/*      */       else
/* 1146 */       { e = ShortRBTreeSet.this.locateKey(this.from);
/*      */         
/* 1148 */         if (ShortRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1152 */       if (e == null || (!this.top && ShortRBTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1153 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       ShortRBTreeSet.Entry e;
/* 1162 */       if (ShortRBTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1166 */       if (this.top) { e = ShortRBTreeSet.this.lastEntry; }
/*      */       else
/* 1168 */       { e = ShortRBTreeSet.this.locateKey(this.to);
/*      */         
/* 1170 */         if (ShortRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1174 */       if (e == null || (!this.bottom && ShortRBTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1175 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1180 */       ShortRBTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShort() {
/* 1187 */       ShortRBTreeSet.Entry e = lastEntry();
...
/*      */     {
/*      */       SubsetIterator() {
/* 1203 */         this.next = ShortRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(short k) {
/* 1207 */         this();
/* 1208 */         if (this.next != null) {
/* 1209 */           if (!ShortRBTreeSet.Subset.this.bottom && ShortRBTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1210 */           else if (!ShortRBTreeSet.Subset.this.top && ShortRBTreeSet.this.compare(k, (this.prev = ShortRBTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1212 */           { this.next = ShortRBTreeSet.this.locateKey(k);
/* 1213 */             if (ShortRBTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1224 */         if (!ShortRBTreeSet.Subset.this.bottom && this.prev != null && ShortRBTreeSet.this.compare(this.prev.key, ShortRBTreeSet.Subset.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1229 */         this.next = this.next.next();
/* 1230 */         if (!ShortRBTreeSet.Subset.this.top && this.next != null && ShortRBTreeSet.this.compare(this.next.key, ShortRBTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     ShortRBTreeSet c;
/*      */     try {
/* 1249 */       c = (ShortRBTreeSet)super.clone();
...
/* 1301 */     for (; n-- != 0; s.writeShort(i.nextShort()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1314 */     if (n == 1) {
/* 1315 */       Entry entry = new Entry(s.readShort());
...
/*      */ 
/*      */       
/* 1324 */       Entry entry = new Entry(s.readShort());
/* 1325 */       entry.black(true);
/* 1326 */       entry.right(new Entry(s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\ShortRBTreeSet.class
