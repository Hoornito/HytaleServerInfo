...
/*   87 */     this.actualComparator = ShortComparators.asShortComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  163 */     this(k, v, (Comparator<? super Short>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     return (this.actualComparator == null) ? Short.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  248 */     Entry e = add(k);
/*  249 */     short oldValue = e.value;
/*  250 */     e.value = (short)(e.value + incr);
/*  251 */     return oldValue;
/*      */   }
/*      */ 
/*      */   
...
/*  835 */       Map.Entry<Short, Short> e = (Map.Entry<Short, Short>)o;
/*  836 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  942 */       this.next = Short2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  946 */       if ((this.next = Short2ShortRBTreeMap.this.locateKey(k)) != null)
/*  947 */         if (Short2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1000 */       updatePrevious();
/* 1001 */       updateNext();
/* 1002 */       Short2ShortRBTreeMap.this.remove(this.curr.key);
/* 1003 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1047 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2ShortMap.Entry>)new AbstractObjectSortedSet<Short2ShortMap.Entry>()
/*      */         {
...
/* 1057 */             return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) {
/* 1062 */             return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1071 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1072 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1073 */             Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1083 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1084 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1085 */             Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1086 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1087 */             Short2ShortRBTreeMap.this.remove(f.key);
/* 1088 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1093 */             return Short2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1098 */             Short2ShortRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ShortMap.Entry first() {
/* 1103 */             return Short2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ShortMap.Entry last() {
/* 1108 */             return Short2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) {
/* 1113 */             return Short2ShortRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) {
/* 1118 */             return Short2ShortRBTreeMap.this.headMap(to.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) {
/* 1123 */             return Short2ShortRBTreeMap.this.tailMap(from.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1160 */       return new Short2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1165 */       return new Short2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */     if (this.values == null) this.values = new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1218 */             return new Short2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1223 */             return Short2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1228 */             return Short2ShortRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1233 */             Short2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1246 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Short2ShortSortedMap tailMap(short from) {
/* 1251 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1295 */       if (!bottom && !top && Short2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1296 */       this.from = from;
/* 1297 */       this.bottom = bottom;
/* 1298 */       this.to = to;
/* 1299 */       this.top = top;
/* 1300 */       this.defRetValue = Short2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1319 */       return ((this.bottom || Short2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ShortRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
/* 1324 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2ShortMap.Entry>)new AbstractObjectSortedSet<Short2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator() {
/* 1327 */               return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) {
/* 1332 */               return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2ShortMap.Entry> comparator() {
/* 1337 */               return Short2ShortRBTreeMap.this.short2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1345 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1346 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1347 */               Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1348 */               return (f != null && Short2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1356 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1357 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1358 */               Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1359 */               if (f != null && Short2ShortRBTreeMap.Submap.this.in(f.key)) Short2ShortRBTreeMap.Submap.this.remove(f.key); 
/* 1360 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1365 */               int c = 0;
/* 1366 */               for (ObjectBidirectionalIterator<Short2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1367 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1372 */               return !(new Short2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1377 */               Short2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ShortMap.Entry first() {
/* 1382 */               return Short2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ShortMap.Entry last() {
/* 1387 */               return Short2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) {
/* 1392 */               return Short2ShortRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) {
/* 1397 */               return Short2ShortRBTreeMap.Submap.this.headMap(to.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) {
/* 1402 */               return Short2ShortRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */           }; 
/* 1405 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2ShortSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1411 */         return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1416 */         return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ShortCollection values() {
/* 1428 */       if (this.values == null) this.values = new AbstractShortCollection()
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1431 */               return new Short2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1436 */               return Short2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1441 */               return Short2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1446 */               Short2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1456 */       return (in(k) && Short2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(short k) {
/* 1474 */       short kk = k; Short2ShortRBTreeMap.Entry e;
/* 1475 */       return (in(kk) && (e = Short2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(short k, short v) {
/* 1480 */       Short2ShortRBTreeMap.this.modified = false;
...
/* 1482 */       short oldValue = Short2ShortRBTreeMap.this.put(k, v);
/* 1483 */       return Short2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(short k) {
/* 1489 */       Short2ShortRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k)) return this.defRetValue; 
/* 1491 */       short oldValue = Short2ShortRBTreeMap.this.remove(k);
/* 1492 */       return Short2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1513 */       return Short2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap headMap(short to) {
/* 1518 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1519 */       return (Short2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap tailMap(short from) {
/* 1524 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1525 */       return (Short2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap subMap(short from, short to) {
/* 1530 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1531 */       if (!this.top) to = (Short2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1532 */       if (!this.bottom) from = (Short2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1543 */       if (Short2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1547 */       if (this.bottom) { e = Short2ShortRBTreeMap.this.firstEntry; }
/*      */       else
/* 1549 */       { e = Short2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1551 */         if (Short2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1555 */       if (e == null || (!this.top && Short2ShortRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1556 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2ShortRBTreeMap.Entry e;
/* 1565 */       if (Short2ShortRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1569 */       if (this.top) { e = Short2ShortRBTreeMap.this.lastEntry; }
/*      */       else
/* 1571 */       { e = Short2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1573 */         if (Short2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1577 */       if (e == null || (!this.bottom && Short2ShortRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1578 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1583 */       Short2ShortRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1590 */       Short2ShortRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1606 */         this.next = Short2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1610 */         this();
/* 1611 */         if (this.next != null) {
/* 1612 */           if (!Short2ShortRBTreeMap.Submap.this.bottom && Short2ShortRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1613 */           else if (!Short2ShortRBTreeMap.Submap.this.top && Short2ShortRBTreeMap.this.compare(k, (this.prev = Short2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1615 */           { this.next = Short2ShortRBTreeMap.this.locateKey(k);
/* 1616 */             if (Short2ShortRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1627 */         if (!Short2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Short2ShortRBTreeMap.this.compare(this.prev.key, Short2ShortRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1632 */         this.next = this.next.next();
/* 1633 */         if (!Short2ShortRBTreeMap.Submap.this.top && this.next != null && Short2ShortRBTreeMap.this.compare(this.next.key, Short2ShortRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2ShortMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1721 */       c = (Short2ShortRBTreeMap)super.clone();
...
/* 1779 */       s.writeShort(e.key);
/* 1780 */       s.writeShort(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1794 */     if (n == 1) {
/* 1795 */       Entry entry = new Entry(s.readShort(), s.readShort());
...
/*      */ 
/*      */       
/* 1804 */       Entry entry = new Entry(s.readShort(), s.readShort());
/* 1805 */       entry.black(true);
/* 1806 */       entry.right(new Entry(s.readShort(), s.readShort()));
...
/* 1816 */     top.key = s.readShort();
/* 1817 */     top.value = s.readShort();
/* 1818 */     top.black(true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ShortRBTreeMap.class
