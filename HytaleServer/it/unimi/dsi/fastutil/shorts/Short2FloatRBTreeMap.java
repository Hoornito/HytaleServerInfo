...
/*  839 */       Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
/*  840 */       return (this.key == ((Short)e.getKey()).shortValue() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return this.key ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Short2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  950 */       if ((this.next = Short2FloatRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Short2FloatRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1089 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1090 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1091 */             Short2FloatRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Short2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Short2FloatRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2FloatMap.Entry first() {
/* 1107 */             return Short2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2FloatMap.Entry last() {
/* 1112 */             return Short2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1117 */             return Short2FloatRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1122 */             return Short2FloatRBTreeMap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1127 */             return Short2FloatRBTreeMap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Short2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1169 */       return new Short2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (FloatIterator)new Short2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1227 */             return Short2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Short2FloatRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Short2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Short2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Short2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Short2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2FloatMap.Entry> comparator() {
/* 1341 */               return Short2FloatRBTreeMap.this.short2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1352 */               return (f != null && Short2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1363 */               if (f != null && Short2FloatRBTreeMap.Submap.this.in(f.key)) Short2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Short2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Short2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Short2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2FloatMap.Entry first() {
/* 1386 */               return Short2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2FloatMap.Entry last() {
/* 1391 */               return Short2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1396 */               return Short2FloatRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1401 */               return Short2FloatRBTreeMap.Submap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1406 */               return Short2FloatRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2FloatSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1415 */         return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1420 */         return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1435 */               return (FloatIterator)new Short2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1440 */               return Short2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Short2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Short2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1460 */       return (in(k) && Short2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(short k) {
/* 1478 */       short kk = k; Short2FloatRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Short2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(short k, float v) {
/* 1484 */       Short2FloatRBTreeMap.this.modified = false;
...
/* 1486 */       float oldValue = Short2FloatRBTreeMap.this.put(k, v);
/* 1487 */       return Short2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(short k) {
/* 1493 */       Short2FloatRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       float oldValue = Short2FloatRBTreeMap.this.remove(k);
/* 1496 */       return Short2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1517 */       return Short2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap headMap(short to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Short2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap tailMap(short from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Short2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap subMap(short from, short to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Short2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Short2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Short2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Short2FloatRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Short2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2FloatRBTreeMap.Entry e;
/* 1569 */       if (Short2FloatRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Short2FloatRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Short2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1587 */       Short2FloatRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1594 */       Short2FloatRBTreeMap.Entry e = lastEntry();
...
/*      */       extends Short2FloatRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Short2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Short2FloatRBTreeMap.Submap.this.bottom && Short2FloatRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Short2FloatRBTreeMap.Submap.this.top && Short2FloatRBTreeMap.this.compare(k, (this.prev = Short2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Short2FloatRBTreeMap.this.locateKey(k);
/* 1620 */             if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Short2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Short2FloatRBTreeMap.this.compare(this.prev.key, Short2FloatRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Short2FloatRBTreeMap.Submap.this.top && this.next != null && Short2FloatRBTreeMap.this.compare(this.next.key, Short2FloatRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2FloatMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Short2FloatRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readShort(), s.readFloat());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readShort(), s.readFloat());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readShort(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatRBTreeMap.class
