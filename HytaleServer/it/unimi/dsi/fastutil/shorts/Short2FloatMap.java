...
/* 150 */     return (ObjectSet)short2FloatEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = short2FloatEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Short.valueOf(entry.getShortKey()), Float.valueOf(entry.getFloatValue()));
...
/* 502 */     Float newValue = remappingFunction.apply(Short.valueOf(key), Float.valueOf(oldValue));
...
/* 534 */     Float newValue = remappingFunction.apply(Short.valueOf(key), contained ? Float.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatMap.class
