...
/* 150 */     return (ObjectSet)short2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = short2BooleanEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Short.valueOf(entry.getShortKey()), Boolean.valueOf(entry.getBooleanValue()));
...
/* 502 */     Boolean newValue = remappingFunction.apply(Short.valueOf(key), Boolean.valueOf(oldValue));
...
/* 534 */     Boolean newValue = remappingFunction.apply(Short.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
...
/* 604 */       return Short.valueOf(getShortKey());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanMap.class
