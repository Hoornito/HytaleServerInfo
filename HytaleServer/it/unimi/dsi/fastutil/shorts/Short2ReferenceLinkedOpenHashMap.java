...
/*  887 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  892 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  897 */       return Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  902 */       return Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  907 */       V oldValue = Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  908 */       Short2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  909 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortReferencePair<V> right(V v) {
/*  914 */       Short2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  915 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  926 */       return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  934 */       return (Short2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  939 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index] ^ ((Short2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Short2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  944 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1112 */       this.next = Short2ReferenceLinkedOpenHashMap.this.first;
/* 1113 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(short from) {
/* 1117 */       if (from == 0) {
/* 1118 */         if (Short2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1119 */           this.next = (int)Short2ReferenceLinkedOpenHashMap.this.link[Short2ReferenceLinkedOpenHashMap.this.n];
/* 1120 */           this.prev = Short2ReferenceLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1122 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1124 */       if (Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last] == from) {
/* 1125 */         this.prev = Short2ReferenceLinkedOpenHashMap.this.last;
/* 1126 */         this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1130 */       int pos = HashCommon.mix(from) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1132 */       while (Short2ReferenceLinkedOpenHashMap.this.key[pos] != 0) {
/* 1133 */         if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1135 */           this.next = (int)Short2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1136 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1139 */         pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1158 */       if (this.next == -1) {
/* 1159 */         this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1162 */       int pos = Short2ReferenceLinkedOpenHashMap.this.first;
/* 1163 */       this.index = 1;
/* 1164 */       while (pos != this.prev) {
/* 1165 */         pos = (int)Short2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1166 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1183 */       this.next = (int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1192 */       this.prev = (int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1201 */         this.next = (int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1214 */         this.index--;
/* 1215 */         this.prev = (int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1216 */       else { this.next = (int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr]; }
/* 1217 */        Short2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1220 */       if (this.prev == -1) { Short2ReferenceLinkedOpenHashMap.this.first = this.next; }
/* 1221 */       else { Short2ReferenceLinkedOpenHashMap.this.link[this.prev] = Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1222 */        if (this.next == -1) { Short2ReferenceLinkedOpenHashMap.this.last = this.prev; }
/* 1223 */       else { Short2ReferenceLinkedOpenHashMap.this.link[this.next] = Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1224 */        int pos = this.curr;
/* 1225 */       this.curr = -1;
/* 1226 */       if (pos == Short2ReferenceLinkedOpenHashMap.this.n) {
/* 1227 */         Short2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1228 */         Short2ReferenceLinkedOpenHashMap.this.value[Short2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1231 */         short[] key = Short2ReferenceLinkedOpenHashMap.this.key; while (true) {
/*      */           short curr;
/*      */           int last;
/* 1234 */           pos = (last = pos) + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1236 */             if ((curr = key[pos]) == 0) {
/* 1237 */               key[last] = 0;
/* 1238 */               Short2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1241 */             int slot = HashCommon.mix(curr) & Short2ReferenceLinkedOpenHashMap.this.mask;
/* 1242 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1243 */               break;  pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1245 */           key[last] = curr;
/* 1246 */           Short2ReferenceLinkedOpenHashMap.this.value[last] = Short2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1247 */           if (this.next == pos) this.next = last; 
/* 1248 */           if (this.prev == pos) this.prev = last; 
/* 1249 */           Short2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2ReferenceMap.Entry<V>>> implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
...
/* 1288 */       action.accept(new Short2ReferenceLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/* 1293 */       return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1298 */       return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Short2ReferenceMap.Entry<V>>> implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
/* 1309 */     final Short2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Short2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1343 */       return (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>>)new Short2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1361 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Short2ReferenceLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1386 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1387 */       return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceMap.Entry<V> last() {
/* 1392 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1393 */       return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1404 */       if (k == 0) return (Short2ReferenceLinkedOpenHashMap.this.containsNullKey && Short2ReferenceLinkedOpenHashMap.this.value[Short2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1406 */       short[] key = Short2ReferenceLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k) & Short2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1410 */       if (k == curr) return (Short2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1413 */         if ((curr = key[pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1414 */         if (k == curr) return (Short2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1426 */       if (k == 0) {
/* 1427 */         if (Short2ReferenceLinkedOpenHashMap.this.containsNullKey && Short2ReferenceLinkedOpenHashMap.this.value[Short2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1428 */           Short2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1429 */           return true;
/*      */         } 
/* 1431 */         return false;
/*      */       } 
/*      */       
/* 1434 */       short[] key = Short2ReferenceLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1437 */       if ((curr = key[pos = HashCommon.mix(k) & Short2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1438 */       if (curr == k) {
/* 1439 */         if (Short2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1440 */           Short2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1441 */           return true;
/*      */         } 
/* 1443 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1446 */         if ((curr = key[pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1447 */         if (curr == k && 
/* 1448 */           Short2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1449 */           Short2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1450 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1458 */       return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1463 */       Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1476 */       return new Short2ReferenceLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1487 */       return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1500 */       return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
/* 1506 */       for (int i = Short2ReferenceLinkedOpenHashMap.this.size, next = Short2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1507 */         int curr = next;
/* 1508 */         next = (int)Short2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1509 */         consumer.accept(new Short2ReferenceLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1516 */       Short2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Short2ReferenceLinkedOpenHashMap.MapEntry();
/* 1517 */       for (int i = Short2ReferenceLinkedOpenHashMap.this.size, next = Short2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1518 */         entry.index = next;
/* 1519 */         next = (int)Short2ReferenceLinkedOpenHashMap.this.link[next];
...
/* 1546 */       return Short2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1558 */       action.accept(Short2ReferenceLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1563 */       return Short2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1572 */       return new Short2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1577 */       return new Short2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1587 */       return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2ReferenceLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1593 */       for (int i = Short2ReferenceLinkedOpenHashMap.this.size, next = Short2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Short2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1596 */         consumer.accept(Short2ReferenceLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1602 */       return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1607 */       return Short2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1612 */       int oldSize = Short2ReferenceLinkedOpenHashMap.this.size;
/* 1613 */       Short2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1614 */       return (Short2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1619 */       Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1624 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1625 */       return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public short lastShort() {
/* 1630 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1631 */       return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortComparator comparator() {
...
/*      */   {
/*      */     public V previous() {
/* 1672 */       return Short2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1684 */       action.accept(Short2ReferenceLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1689 */       return Short2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1700 */             return (ObjectIterator<V>)new Short2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1710 */             return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2ReferenceLinkedOpenHashMap.this), 80);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1716 */             for (int i = Short2ReferenceLinkedOpenHashMap.this.size, next = Short2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1717 */               int curr = next;
/* 1718 */               next = (int)Short2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1719 */               consumer.accept(Short2ReferenceLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1725 */             return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1730 */             return Short2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1735 */             Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1855 */       c = (Short2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceLinkedOpenHashMap.class
