...
/*  343 */     short[] key = this.key; while (true) {
/*      */       short curr; int last;
...
/*  804 */     Boolean newValue = remappingFunction.apply(Short.valueOf(k), Boolean.valueOf(this.value[pos]));
...
/*  817 */     int pos = find(k);
/*  818 */     Boolean newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
...
/*  865 */     Arrays.fill(this.key, (short)0);
...
/*      */     implements Short2BooleanMap.Entry, Map.Entry<Short, Boolean>, ShortBooleanPair
/*      */   {
/*      */     int index;
/*      */ 
/*      */ 
...
/*  897 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  902 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  907 */       return Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  912 */       return Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  917 */       boolean oldValue = Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*  918 */       Short2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  919 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBooleanPair right(boolean v) {
/*  924 */       Short2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  925 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  936 */       return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  947 */       return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  965 */       Map.Entry<Short, Boolean> e = (Map.Entry<Short, Boolean>)o;
/*  966 */       return (Short2BooleanLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  971 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index] ^ (Short2BooleanLinkedOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  976 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1144 */       this.next = Short2BooleanLinkedOpenHashMap.this.first;
/* 1145 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(short from) {
/* 1149 */       if (from == 0) {
/* 1150 */         if (Short2BooleanLinkedOpenHashMap.this.containsNullKey) {
/* 1151 */           this.next = (int)Short2BooleanLinkedOpenHashMap.this.link[Short2BooleanLinkedOpenHashMap.this.n];
/* 1152 */           this.prev = Short2BooleanLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1154 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1156 */       if (Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last] == from) {
/* 1157 */         this.prev = Short2BooleanLinkedOpenHashMap.this.last;
/* 1158 */         this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1162 */       int pos = HashCommon.mix(from) & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */       
/* 1164 */       while (Short2BooleanLinkedOpenHashMap.this.key[pos] != 0) {
/* 1165 */         if (Short2BooleanLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1167 */           this.next = (int)Short2BooleanLinkedOpenHashMap.this.link[pos];
/* 1168 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1171 */         pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1190 */       if (this.next == -1) {
/* 1191 */         this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1194 */       int pos = Short2BooleanLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 1;
/* 1196 */       while (pos != this.prev) {
/* 1197 */         pos = (int)Short2BooleanLinkedOpenHashMap.this.link[pos];
/* 1198 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1215 */       this.next = (int)Short2BooleanLinkedOpenHashMap.this.link[this.curr];
...
/* 1224 */       this.prev = (int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1233 */         this.next = (int)Short2BooleanLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1246 */         this.index--;
/* 1247 */         this.prev = (int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1248 */       else { this.next = (int)Short2BooleanLinkedOpenHashMap.this.link[this.curr]; }
/* 1249 */        Short2BooleanLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1252 */       if (this.prev == -1) { Short2BooleanLinkedOpenHashMap.this.first = this.next; }
/* 1253 */       else { Short2BooleanLinkedOpenHashMap.this.link[this.prev] = Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^ (Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1254 */        if (this.next == -1) { Short2BooleanLinkedOpenHashMap.this.last = this.prev; }
/* 1255 */       else { Short2BooleanLinkedOpenHashMap.this.link[this.next] = Short2BooleanLinkedOpenHashMap.this.link[this.next] ^ (Short2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1256 */        int pos = this.curr;
/* 1257 */       this.curr = -1;
/* 1258 */       if (pos == Short2BooleanLinkedOpenHashMap.this.n) {
/* 1259 */         Short2BooleanLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1262 */         short[] key = Short2BooleanLinkedOpenHashMap.this.key; while (true) {
/*      */           short curr;
/*      */           int last;
/* 1265 */           pos = (last = pos) + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1267 */             if ((curr = key[pos]) == 0) {
/* 1268 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1271 */             int slot = HashCommon.mix(curr) & Short2BooleanLinkedOpenHashMap.this.mask;
/* 1272 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1273 */               break;  pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1275 */           key[last] = curr;
/* 1276 */           Short2BooleanLinkedOpenHashMap.this.value[last] = Short2BooleanLinkedOpenHashMap.this.value[pos];
/* 1277 */           if (this.next == pos) this.next = last; 
/* 1278 */           if (this.prev == pos) this.prev = last; 
/* 1279 */           Short2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2BooleanMap.Entry>> implements ObjectListIterator<Short2BooleanMap.Entry> {
...
/* 1318 */       action.accept(new Short2BooleanLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2BooleanLinkedOpenHashMap.MapEntry next() {
/* 1323 */       return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2BooleanLinkedOpenHashMap.MapEntry previous() {
/* 1328 */       return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Short2BooleanMap.Entry>> implements ObjectListIterator<Short2BooleanMap.Entry> {
/* 1339 */     final Short2BooleanLinkedOpenHashMap.MapEntry entry = new Short2BooleanLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1373 */       return (ObjectBidirectionalIterator<Short2BooleanMap.Entry>)new Short2BooleanLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1391 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1416 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1417 */       return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2BooleanMap.Entry last() {
/* 1422 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1423 */       return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1431 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1432 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1433 */       short k = ((Short)e.getKey()).shortValue();
/* 1434 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1435 */       if (k == 0) return (Short2BooleanLinkedOpenHashMap.this.containsNullKey && Short2BooleanLinkedOpenHashMap.this.value[Short2BooleanLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1437 */       short[] key = Short2BooleanLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1440 */       if ((curr = key[pos = HashCommon.mix(k) & Short2BooleanLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1441 */       if (k == curr) return (Short2BooleanLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1444 */         if ((curr = key[pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1445 */         if (k == curr) return (Short2BooleanLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1454 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1455 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/* 1456 */       short k = ((Short)e.getKey()).shortValue();
/* 1457 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/* 1458 */       if (k == 0) {
/* 1459 */         if (Short2BooleanLinkedOpenHashMap.this.containsNullKey && Short2BooleanLinkedOpenHashMap.this.value[Short2BooleanLinkedOpenHashMap.this.n] == v) {
/* 1460 */           Short2BooleanLinkedOpenHashMap.this.removeNullEntry();
/* 1461 */           return true;
/*      */         } 
/* 1463 */         return false;
/*      */       } 
/*      */       
/* 1466 */       short[] key = Short2BooleanLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1469 */       if ((curr = key[pos = HashCommon.mix(k) & Short2BooleanLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1470 */       if (curr == k) {
/* 1471 */         if (Short2BooleanLinkedOpenHashMap.this.value[pos] == v) {
/* 1472 */           Short2BooleanLinkedOpenHashMap.this.removeEntry(pos);
/* 1473 */           return true;
/*      */         } 
/* 1475 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1478 */         if ((curr = key[pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1479 */         if (curr == k && 
/* 1480 */           Short2BooleanLinkedOpenHashMap.this.value[pos] == v) {
/* 1481 */           Short2BooleanLinkedOpenHashMap.this.removeEntry(pos);
/* 1482 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1490 */       return Short2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1495 */       Short2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1508 */       return new Short2BooleanLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1519 */       return new Short2BooleanLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1532 */       return new Short2BooleanLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
/* 1538 */       for (int i = Short2BooleanLinkedOpenHashMap.this.size, next = Short2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1539 */         int curr = next;
/* 1540 */         next = (int)Short2BooleanLinkedOpenHashMap.this.link[curr];
/* 1541 */         consumer.accept(new Short2BooleanLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1548 */       Short2BooleanLinkedOpenHashMap.MapEntry entry = new Short2BooleanLinkedOpenHashMap.MapEntry();
/* 1549 */       for (int i = Short2BooleanLinkedOpenHashMap.this.size, next = Short2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1550 */         entry.index = next;
/* 1551 */         next = (int)Short2BooleanLinkedOpenHashMap.this.link[next];
...
/* 1578 */       return Short2BooleanLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1590 */       action.accept(Short2BooleanLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1595 */       return Short2BooleanLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1604 */       return new Short2BooleanLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1609 */       return new Short2BooleanLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1619 */       return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1625 */       for (int i = Short2BooleanLinkedOpenHashMap.this.size, next = Short2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1626 */         int curr = next;
/* 1627 */         next = (int)Short2BooleanLinkedOpenHashMap.this.link[curr];
/* 1628 */         consumer.accept(Short2BooleanLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1634 */       return Short2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1639 */       return Short2BooleanLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1644 */       int oldSize = Short2BooleanLinkedOpenHashMap.this.size;
/* 1645 */       Short2BooleanLinkedOpenHashMap.this.remove(k);
/* 1646 */       return (Short2BooleanLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1651 */       Short2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1656 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1657 */       return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public short lastShort() {
/* 1662 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1663 */       return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortComparator comparator() {
...
/* 1704 */       return Short2BooleanLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1716 */       action.accept(Short2BooleanLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1721 */       return Short2BooleanLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1732 */             return (BooleanIterator)new Short2BooleanLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1742 */             return BooleanSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2BooleanLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1748 */             for (int i = Short2BooleanLinkedOpenHashMap.this.size, next = Short2BooleanLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1749 */               int curr = next;
/* 1750 */               next = (int)Short2BooleanLinkedOpenHashMap.this.link[curr];
/* 1751 */               consumer.accept(Short2BooleanLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1757 */             return Short2BooleanLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1762 */             return Short2BooleanLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1767 */             Short2BooleanLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1831 */     short[] key = this.key;
/* 1832 */     boolean[] value = this.value;
/* 1833 */     int mask = newN - 1;
/* 1834 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1887 */       c = (Short2BooleanLinkedOpenHashMap)super.clone();
...
/* 1895 */     c.key = (short[])this.key.clone();
...
/* 1942 */     short[] key = this.key = new short[this.n + 1];
...
/* 1950 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanLinkedOpenHashMap.class
