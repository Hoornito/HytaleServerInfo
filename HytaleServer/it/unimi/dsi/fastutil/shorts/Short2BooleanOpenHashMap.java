...
/*  106 */     this.key = new short[this.n + 1];
...
/*  283 */     short[] key = this.key; while (true) {
/*      */       short curr; int last;
...
/*  479 */     Boolean newValue = remappingFunction.apply(Short.valueOf(k), Boolean.valueOf(this.value[pos]));
...
/*  492 */     int pos = find(k);
/*  493 */     Boolean newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Boolean.valueOf(this.value[pos]) : null);
...
/*  540 */     Arrays.fill(this.key, (short)0);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  571 */       return Short2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  576 */       return Short2BooleanOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean getBooleanValue() {
/*  581 */       return Short2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean rightBoolean() {
/*  586 */       return Short2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean setValue(boolean v) {
/*  591 */       boolean oldValue = Short2BooleanOpenHashMap.this.value[this.index];
/*  592 */       Short2BooleanOpenHashMap.this.value[this.index] = v;
/*  593 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBooleanPair right(boolean v) {
/*  598 */       Short2BooleanOpenHashMap.this.value[this.index] = v;
/*  599 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  610 */       return Short.valueOf(Short2BooleanOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  621 */       return Boolean.valueOf(Short2BooleanOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */       Map.Entry<Short, Boolean> e = (Map.Entry<Short, Boolean>)o;
/*  640 */       return (Short2BooleanOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  645 */       return Short2BooleanOpenHashMap.this.key[this.index] ^ (Short2BooleanOpenHashMap.this.value[this.index] ? 1231 : 1237);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  650 */       return Short2BooleanOpenHashMap.this.key[this.index] + "=>" + Short2BooleanOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  661 */     int pos = Short2BooleanOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  667 */     int last = -1;
/*      */     
/*  669 */     int c = Short2BooleanOpenHashMap.this.size;
/*      */     
/*  671 */     boolean mustReturnNullKey = Short2BooleanOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  690 */         return this.last = Short2BooleanOpenHashMap.this.n;
/*      */       } 
/*  692 */       short[] key = Short2BooleanOpenHashMap.this.key;
/*      */       while (true) {
/*  694 */         if (--this.pos < 0) {
/*      */           
/*  696 */           this.last = Integer.MIN_VALUE;
/*  697 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  698 */           int p = HashCommon.mix(k) & Short2BooleanOpenHashMap.this.mask;
/*  699 */           for (; k != key[p]; p = p + 1 & Short2BooleanOpenHashMap.this.mask);
/*  700 */           return p;
/*      */         } 
...
/*  709 */         acceptOnIndex(action, this.last = Short2BooleanOpenHashMap.this.n);
/*  710 */         this.c--;
/*      */       } 
/*  712 */       short[] key = Short2BooleanOpenHashMap.this.key;
/*  713 */       while (this.c != 0) {
/*  714 */         if (--this.pos < 0) {
/*      */           
/*  716 */           this.last = Integer.MIN_VALUE;
/*  717 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  718 */           int p = HashCommon.mix(k) & Short2BooleanOpenHashMap.this.mask;
/*  719 */           for (; k != key[p]; p = p + 1 & Short2BooleanOpenHashMap.this.mask);
...
/*  739 */       short[] key = Short2BooleanOpenHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  741 */         pos = (last = pos) + 1 & Short2BooleanOpenHashMap.this.mask;
/*      */         while (true) {
/*  743 */           if ((curr = key[pos]) == 0) {
/*  744 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  747 */           int slot = HashCommon.mix(curr) & Short2BooleanOpenHashMap.this.mask;
/*  748 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  749 */             break;  pos = pos + 1 & Short2BooleanOpenHashMap.this.mask;
/*      */         } 
/*  751 */         if (pos < last) {
/*  752 */           if (this.wrapped == null) this.wrapped = new ShortArrayList(2); 
/*  753 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  755 */         key[last] = curr;
/*  756 */         Short2BooleanOpenHashMap.this.value[last] = Short2BooleanOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  761 */       if (this.last == -1) throw new IllegalStateException(); 
/*  762 */       if (this.last == Short2BooleanOpenHashMap.this.n)
/*  763 */       { Short2BooleanOpenHashMap.this.containsNullKey = false; }
/*  764 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  767 */       { Short2BooleanOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  768 */         this.last = -1;
/*      */         return; }
/*      */       
/*  771 */       Short2BooleanOpenHashMap.this.size--;
/*  772 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2BooleanMap.Entry>> implements ObjectIterator<Short2BooleanMap.Entry> { public Short2BooleanOpenHashMap.MapEntry next() {
/*  788 */       return this.entry = new Short2BooleanOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  794 */       action.accept(this.entry = new Short2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  805 */       this.entry = new Short2BooleanOpenHashMap.MapEntry();
/*      */     }
...
/*  826 */     int pos = 0;
/*      */     
/*  828 */     int max = Short2BooleanOpenHashMap.this.n;
/*      */     
/*  830 */     int c = 0;
/*      */     
/*  832 */     boolean mustReturnNull = Short2BooleanOpenHashMap.this.containsNullKey;
/*      */     
...
/*  852 */         this.c++;
/*  853 */         acceptOnIndex(action, Short2BooleanOpenHashMap.this.n);
/*  854 */         return true;
/*      */       } 
/*  856 */       short[] key = Short2BooleanOpenHashMap.this.key;
...
/*  871 */         this.c++;
/*  872 */         acceptOnIndex(action, Short2BooleanOpenHashMap.this.n);
/*      */       } 
/*  874 */       short[] key = Short2BooleanOpenHashMap.this.key;
...
/*      */       {
/*  887 */         return (Short2BooleanOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  892 */       return Math.min((Short2BooleanOpenHashMap.this.size - this.c), (long)(Short2BooleanOpenHashMap.this.realSize() / Short2BooleanOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  920 */         n--;
/*      */       } 
/*  922 */       short[] key = Short2BooleanOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2BooleanMap.Entry> action, int index) {
/*  950 */       action.accept(new Short2BooleanOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  962 */       return new Short2BooleanOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2BooleanMap.Entry> fastIterator() {
/*  967 */       return new Short2BooleanOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2BooleanMap.Entry> spliterator() {
/*  972 */       return new Short2BooleanOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  981 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/*  982 */       if (e.getValue() == null || !(e.getValue() instanceof Boolean)) return false; 
/*  983 */       short k = ((Short)e.getKey()).shortValue();
/*  984 */       boolean v = ((Boolean)e.getValue()).booleanValue();
/*  985 */       if (k == 0) return (Short2BooleanOpenHashMap.this.containsNullKey && Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n] == v);
/*      */       
/*  987 */       short[] key = Short2BooleanOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  990 */       if ((curr = key[pos = HashCommon.mix(k) & Short2BooleanOpenHashMap.this.mask]) == 0) return false; 
/*  991 */       if (k == curr) return (Short2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/*  994 */         if ((curr = key[pos = pos + 1 & Short2BooleanOpenHashMap.this.mask]) == 0) return false; 
/*  995 */         if (k == curr) return (Short2BooleanOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1008 */       if (k == 0) {
/* 1009 */         if (Short2BooleanOpenHashMap.this.containsNullKey && Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n] == v) {
/* 1010 */           Short2BooleanOpenHashMap.this.removeNullEntry();
/* 1011 */           return true;
/*      */         } 
/* 1013 */         return false;
/*      */       } 
/*      */       
/* 1016 */       short[] key = Short2BooleanOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1019 */       if ((curr = key[pos = HashCommon.mix(k) & Short2BooleanOpenHashMap.this.mask]) == 0) return false; 
/* 1020 */       if (curr == k) {
/* 1021 */         if (Short2BooleanOpenHashMap.this.value[pos] == v) {
/* 1022 */           Short2BooleanOpenHashMap.this.removeEntry(pos);
/* 1023 */           return true;
/*      */         } 
/* 1025 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1028 */         if ((curr = key[pos = pos + 1 & Short2BooleanOpenHashMap.this.mask]) == 0) return false; 
/* 1029 */         if (curr == k && 
/* 1030 */           Short2BooleanOpenHashMap.this.value[pos] == v) {
/* 1031 */           Short2BooleanOpenHashMap.this.removeEntry(pos);
/* 1032 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1040 */       return Short2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1045 */       Short2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
/* 1051 */       if (Short2BooleanOpenHashMap.this.containsNullKey) consumer.accept(new Short2BooleanOpenHashMap.MapEntry(Short2BooleanOpenHashMap.this.n)); 
/* 1052 */       for (int pos = Short2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Short2BooleanOpenHashMap.this.key[pos] != 0) consumer.accept(new Short2BooleanOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
/* 1058 */       Short2BooleanOpenHashMap.MapEntry entry = new Short2BooleanOpenHashMap.MapEntry();
/* 1059 */       if (Short2BooleanOpenHashMap.this.containsNullKey) {
/* 1060 */         entry.index = Short2BooleanOpenHashMap.this.n;
/* 1061 */         consumer.accept(entry);
/*      */       } 
/* 1063 */       for (int pos = Short2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Short2BooleanOpenHashMap.this.key[pos] != 0) {
...
/* 1094 */       action.accept(Short2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1099 */       return Short2BooleanOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1120 */       action.accept(Short2BooleanOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1132 */       return new Short2BooleanOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1137 */       return new Short2BooleanOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1143 */       if (Short2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n]); 
/* 1144 */       for (int pos = Short2BooleanOpenHashMap.this.n; pos-- != 0; ) {
/* 1145 */         short k = Short2BooleanOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1152 */       return Short2BooleanOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1157 */       return Short2BooleanOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1162 */       int oldSize = Short2BooleanOpenHashMap.this.size;
/* 1163 */       Short2BooleanOpenHashMap.this.remove(k);
/* 1164 */       return (Short2BooleanOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1169 */       Short2BooleanOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1197 */       action.accept(Short2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean nextBoolean() {
/* 1202 */       return Short2BooleanOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(BooleanConsumer action, int index) {
/* 1223 */       action.accept(Short2BooleanOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1237 */             return new Short2BooleanOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public BooleanSpliterator spliterator() {
/* 1242 */             return new Short2BooleanOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(BooleanConsumer consumer) {
/* 1248 */             if (Short2BooleanOpenHashMap.this.containsNullKey) consumer.accept(Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n]); 
/* 1249 */             for (int pos = Short2BooleanOpenHashMap.this.n; pos-- != 0;) { if (Short2BooleanOpenHashMap.this.key[pos] != 0) consumer.accept(Short2BooleanOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1254 */             return Short2BooleanOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(boolean v) {
/* 1259 */             return Short2BooleanOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1264 */             Short2BooleanOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1328 */     short[] key = this.key;
/* 1329 */     boolean[] value = this.value;
/* 1330 */     int mask = newN - 1;
/* 1331 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1362 */       c = (Short2BooleanOpenHashMap)super.clone();
...
/* 1370 */     c.key = (short[])this.key.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanOpenHashMap.class
