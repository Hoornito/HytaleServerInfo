...
/*  865 */       return (this.key == ((Short)e.getKey()).shortValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  870 */       return this.key ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Short2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  977 */       if ((this.next = Short2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Short2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Short2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1113 */             Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1124 */             Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1125 */             if (f == null || !Objects.equals(f.getValue(), e.getValue())) return false; 
/* 1126 */             Short2ObjectAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Short2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Short2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ObjectMap.Entry<V> first() {
/* 1142 */             return Short2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ObjectMap.Entry<V> last() {
/* 1147 */             return Short2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from, Short2ObjectMap.Entry<V> to) {
/* 1152 */             return Short2ObjectAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> to) {
/* 1157 */             return Short2ObjectAVLTreeMap.this.headMap(to.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from) {
/* 1162 */             return Short2ObjectAVLTreeMap.this.tailMap(from.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Short2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1204 */       return new Short2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Short2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Short2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Short2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Short2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1334 */       if (!bottom && !top && Short2ObjectAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Short2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Short2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2ObjectMap.Entry<V>> comparator() {
/* 1376 */               return Short2ObjectAVLTreeMap.this.short2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1385 */               Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1386 */               return (f != null && Short2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1395 */               Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1396 */               if (f != null && Short2ObjectAVLTreeMap.Submap.this.in(f.key)) Short2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Short2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Short2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ObjectMap.Entry<V> first() {
/* 1419 */               return Short2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ObjectMap.Entry<V> last() {
/* 1424 */               return Short2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from, Short2ObjectMap.Entry<V> to) {
/* 1429 */               return Short2ObjectAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> to) {
/* 1434 */               return Short2ObjectAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from) {
/* 1439 */               return Short2ObjectAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */           }; 
/* 1442 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2ObjectSortedMap<V>.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1448 */         return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1453 */         return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Short2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Short2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Short2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Short2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1493 */       return (in(k) && Short2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(short k) {
/* 1511 */       short kk = k; Short2ObjectAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Short2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(short k, V v) {
/* 1517 */       Short2ObjectAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Short2ObjectAVLTreeMap.this.put(k, v);
/* 1520 */       return Short2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(short k) {
/* 1526 */       Short2ObjectAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Short2ObjectAVLTreeMap.this.remove(k);
/* 1529 */       return Short2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1550 */       return Short2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ObjectSortedMap<V> headMap(short to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Short2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ObjectSortedMap<V> tailMap(short from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ObjectSortedMap<V> subMap(short from, short to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Short2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Short2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Short2ObjectAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Short2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Short2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Short2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2ObjectAVLTreeMap.Entry<V> e;
/* 1602 */       if (Short2ObjectAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Short2ObjectAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Short2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Short2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Short2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1620 */       Short2ObjectAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1627 */       Short2ObjectAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Short2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Short2ObjectAVLTreeMap.Submap.this.bottom && Short2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Short2ObjectAVLTreeMap.Submap.this.top && Short2ObjectAVLTreeMap.this.compare(k, (this.prev = Short2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Short2ObjectAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Short2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Short2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Short2ObjectAVLTreeMap.this.compare(this.prev.key, Short2ObjectAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Short2ObjectAVLTreeMap.Submap.this.top && this.next != null && Short2ObjectAVLTreeMap.this.compare(this.next.key, Short2ObjectAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Short2ObjectAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectAVLTreeMap.class
