...
/*  49 */     ObjectSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  50 */     return (entries instanceof Short2LongMap.FastEntrySet) ? ((Short2LongMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  66 */     if (entries instanceof Short2LongMap.FastEntrySet) { ((Short2LongMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  83 */     return (entries instanceof Short2LongMap.FastEntrySet) ? new ObjectIterable<Short2LongMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Short2LongMap.Entry> iterator() {
/*  86 */           return ((Short2LongMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Short2LongMap.FastEntrySet)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Short2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 147 */       return (ObjectSet<Short2LongMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Short2LongMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractShort2LongMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */   
/*     */   public static Short2LongMap singleton(Short key, Long value) {
/* 316 */     return new Singleton(key.shortValue(), value.longValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Short2LongFunctions.SynchronizedFunction implements Short2LongMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Long>> entrySet() {
/* 381 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */     extends Short2LongFunctions.UnmodifiableFunction implements Short2LongMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2LongMap map;
/*     */     protected transient ObjectSet<Short2LongMap.Entry> entries;
/*     */     protected transient ShortSet keys;
...
/*     */     
/*     */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Long>> entrySet() {
/* 712 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongMaps.class
