...
/*      */ 
/*      */ 
/*      */ public class Short2IntAVLTreeMap
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(Comparator<? super Short> c) {
/*   99 */     this();
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(Map<? extends Short, ? extends Integer> m) {
/*  110 */     this();
/*  111 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(SortedMap<Short, Integer> m) {
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(Short2IntMap m) {
/*  130 */     this();
/*  131 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(Short2IntSortedMap m) {
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(short[] k, int[] v, Comparator<? super Short> c) {
/*  153 */     this(c);
...
/*      */ 
/*      */   
/*      */   public Short2IntAVLTreeMap(short[] k, int[] v) {
...
/*  885 */       Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
/*  886 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Short2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  998 */       if ((this.next = Short2IntAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Short2IntAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1147 */             Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1148 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1149 */             Short2IntAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Short2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Short2IntAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2IntMap.Entry first() {
/* 1165 */             return Short2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2IntMap.Entry last() {
/* 1170 */             return Short2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1175 */             return Short2IntAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1180 */             return Short2IntAVLTreeMap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1185 */             return Short2IntAVLTreeMap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Short2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1227 */       return new Short2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (IntIterator)new Short2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1285 */             return Short2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Short2IntAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Short2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Short2IntAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Short2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Short2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2IntMap.Entry> comparator() {
/* 1399 */               return Short2IntAVLTreeMap.this.short2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1410 */               return (f != null && Short2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1421 */               if (f != null && Short2IntAVLTreeMap.Submap.this.in(f.key)) Short2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Short2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Short2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Short2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2IntMap.Entry first() {
/* 1444 */               return Short2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2IntMap.Entry last() {
/* 1449 */               return Short2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1454 */               return Short2IntAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1459 */               return Short2IntAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1464 */               return Short2IntAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1473 */         return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1478 */         return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1493 */               return (IntIterator)new Short2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1498 */               return Short2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Short2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Short2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1518 */       return (in(k) && Short2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(short k) {
/* 1536 */       short kk = k; Short2IntAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Short2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(short k, int v) {
/* 1542 */       Short2IntAVLTreeMap.this.modified = false;
...
/* 1544 */       int oldValue = Short2IntAVLTreeMap.this.put(k, v);
/* 1545 */       return Short2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(short k) {
/* 1551 */       Short2IntAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       int oldValue = Short2IntAVLTreeMap.this.remove(k);
/* 1554 */       return Short2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1575 */       return Short2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap headMap(short to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Short2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap tailMap(short from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Short2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap subMap(short from, short to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Short2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Short2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Short2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Short2IntAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Short2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2IntAVLTreeMap.Entry e;
/* 1627 */       if (Short2IntAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Short2IntAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Short2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1645 */       Short2IntAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1652 */       Short2IntAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Short2IntAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Short2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Short2IntAVLTreeMap.Submap.this.bottom && Short2IntAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Short2IntAVLTreeMap.Submap.this.top && Short2IntAVLTreeMap.this.compare(k, (this.prev = Short2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Short2IntAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Short2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Short2IntAVLTreeMap.this.compare(this.prev.key, Short2IntAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Short2IntAVLTreeMap.Submap.this.top && this.next != null && Short2IntAVLTreeMap.this.compare(this.next.key, Short2IntAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Short2IntAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readShort(), s.readInt());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readShort(), s.readInt());
/* 1866 */       entry.right(new Entry(s.readShort(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntAVLTreeMap.class
