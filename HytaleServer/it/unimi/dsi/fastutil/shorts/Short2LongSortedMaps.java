...
/*  61 */     return (entries instanceof Short2LongSortedMap.FastSortedEntrySet) ? ((Short2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  77 */     Objects.requireNonNull((Short2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Short2LongSortedMap.FastSortedEntrySet) ? (Short2LongSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Short2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Short2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Short, Long>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2LongSortedMap headMap(short to) {
/* 125 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2LongSortedMap tailMap(short from) {
/* 130 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Short2LongMap.Entry>)ObjectSortedSets.singleton(new AbstractShort2LongMap.BasicEntry(this.key, this.value), Short2LongSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Short2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Long>> entrySet() {
/* 248 */       return (ObjectSortedSet)short2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 260 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2LongSortedMap headMap(short to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2LongSortedMap tailMap(short from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Short2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public short firstShortKey() {
...
/* 369 */     return new Singleton(key.shortValue(), value.longValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Short2LongMaps.SynchronizedMap implements Short2LongSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Short2LongMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.short2LongEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Short2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Long>> entrySet() {
/* 440 */       return (ObjectSortedSet)short2LongEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/*     */     extends Short2LongMaps.UnmodifiableMap implements Short2LongSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2LongSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Short2LongMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.short2LongEntrySet()); 
/* 581 */       return (ObjectSortedSet<Short2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongSortedMaps.class
