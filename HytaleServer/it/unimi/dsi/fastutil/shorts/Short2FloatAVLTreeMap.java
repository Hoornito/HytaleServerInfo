...
/*      */ 
/*      */ 
/*      */ public class Short2FloatAVLTreeMap
...
/*  885 */       Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
/*  886 */       return (this.key == ((Short)e.getKey()).shortValue() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Short2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  998 */       if ((this.next = Short2FloatAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Short2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Short2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1147 */             Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1148 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float)e.getValue()).floatValue())) return false; 
/* 1149 */             Short2FloatAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Short2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Short2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2FloatMap.Entry first() {
/* 1165 */             return Short2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2FloatMap.Entry last() {
/* 1170 */             return Short2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1175 */             return Short2FloatAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1180 */             return Short2FloatAVLTreeMap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1185 */             return Short2FloatAVLTreeMap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Short2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1227 */       return new Short2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (FloatIterator)new Short2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float k) {
/* 1285 */             return Short2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Short2FloatAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Short2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Short2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Short2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Short2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2FloatMap.Entry> comparator() {
/* 1399 */               return Short2FloatAVLTreeMap.this.short2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1410 */               return (f != null && Short2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1421 */               if (f != null && Short2FloatAVLTreeMap.Submap.this.in(f.key)) Short2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Short2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Short2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Short2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2FloatMap.Entry first() {
/* 1444 */               return Short2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2FloatMap.Entry last() {
/* 1449 */               return Short2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1454 */               return Short2FloatAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1459 */               return Short2FloatAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1464 */               return Short2FloatAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1473 */         return new Short2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1478 */         return new Short2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1493 */               return (FloatIterator)new Short2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(float k) {
/* 1498 */               return Short2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Short2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Short2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1518 */       return (in(k) && Short2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(short k) {
/* 1536 */       short kk = k; Short2FloatAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Short2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float put(short k, float v) {
/* 1542 */       Short2FloatAVLTreeMap.this.modified = false;
...
/* 1544 */       float oldValue = Short2FloatAVLTreeMap.this.put(k, v);
/* 1545 */       return Short2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float remove(short k) {
/* 1551 */       Short2FloatAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       float oldValue = Short2FloatAVLTreeMap.this.remove(k);
/* 1554 */       return Short2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1575 */       return Short2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap headMap(short to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Short2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap tailMap(short from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Short2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2FloatSortedMap subMap(short from, short to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Short2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Short2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Short2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Short2FloatAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Short2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Short2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Short2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2FloatAVLTreeMap.Entry e;
/* 1627 */       if (Short2FloatAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Short2FloatAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Short2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Short2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Short2FloatAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1645 */       Short2FloatAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1652 */       Short2FloatAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Short2FloatAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Short2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Short2FloatAVLTreeMap.Submap.this.bottom && Short2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Short2FloatAVLTreeMap.Submap.this.top && Short2FloatAVLTreeMap.this.compare(k, (this.prev = Short2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Short2FloatAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Short2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Short2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Short2FloatAVLTreeMap.this.compare(this.prev.key, Short2FloatAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Short2FloatAVLTreeMap.Submap.this.top && this.next != null && Short2FloatAVLTreeMap.this.compare(this.next.key, Short2FloatAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Short2FloatAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readShort(), s.readFloat());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readShort(), s.readFloat());
/* 1866 */       entry.right(new Entry(s.readShort(), s.readFloat()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatAVLTreeMap.class
