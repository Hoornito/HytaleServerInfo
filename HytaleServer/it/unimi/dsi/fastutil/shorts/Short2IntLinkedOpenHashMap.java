...
/*  289 */     if (k == 0) return this.containsNullKey ? this.n : -(this.n + 1);
/*      */     
/*  291 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  294 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return -(pos + 1); 
/*  295 */     if (k == curr) return pos;
/*      */     
/*      */     while (true) {
/*  298 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return -(pos + 1); 
...
/*      */       short curr;
/*  361 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != 0) {
/*  362 */         if (curr == k) return addToValue(pos, incr); 
/*  363 */         while ((curr = key[pos = pos + 1 & this.mask]) != 0) { if (curr == k) return addToValue(pos, incr);  }
/*      */       
/*      */       } 
/*  366 */     }  this.key[pos] = k;
...
/*  392 */     short[] key = this.key; while (true) {
/*      */       short curr; int last;
/*  394 */       pos = (last = pos) + 1 & this.mask;
/*      */       while (true) {
/*  396 */         if ((curr = key[pos]) == 0) {
/*  397 */           key[last] = 0;
/*      */           return;
/*      */         } 
...
/*      */     } 
/*      */     
/*  418 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  421 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return this.defRetValue; 
/*  422 */     if (k == curr) return removeEntry(pos); 
/*      */     while (true) {
/*  424 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return this.defRetValue; 
...
/*      */     } 
/*      */     
/*  542 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  545 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return this.defRetValue; 
/*  546 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  552 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return this.defRetValue; 
/*  553 */       if (k == curr) {
...
/*      */     } 
/*      */     
/*  577 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  580 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return this.defRetValue; 
/*  581 */     if (k == curr) {
...
/*      */     
/*      */     while (true) {
/*  587 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return this.defRetValue; 
/*  588 */       if (k == curr) {
...
/*      */     } else {
/*      */       
/*  664 */       short[] key = this.key;
/*      */       short curr;
/*  666 */       if ((curr = key[pos = HashCommon.mix(k) & this.mask]) != 0) {
/*  667 */         if (curr == k) {
/*  668 */           moveIndexToLast(pos);
/*  669 */           return setValue(pos, v);
/*      */         } 
/*  671 */         while ((curr = key[pos = pos + 1 & this.mask]) != 0) { if (curr == k) {
...
/*  696 */     if (k == 0) return this.containsNullKey ? this.value[this.n] : this.defRetValue;
/*      */     
/*  698 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  701 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return this.defRetValue; 
/*  702 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  705 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return this.defRetValue; 
...
/*  713 */     if (k == 0) return this.containsNullKey;
/*      */     
/*  715 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  718 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return false; 
/*  719 */     if (k == curr) return true;
/*      */     
/*      */     while (true) {
/*  722 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return false; 
...
/*  730 */     short[] key = this.key;
/*  731 */     if (this.containsNullKey && value[this.n] == v) return true; 
/*  732 */     for (int i = this.n; i-- != 0;) { if (key[i] != 0 && value[i] == v) return true;  }
/*  733 */      return false;
/*      */   }
/*      */ 
/*      */ 
...
/*  740 */     if (k == 0) return this.containsNullKey ? this.value[this.n] : defaultValue;
/*      */     
/*  742 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  745 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return defaultValue; 
/*  746 */     if (k == curr) return this.value[pos];
/*      */     
/*      */     while (true) {
/*  749 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return defaultValue; 
...
/*      */     } 
/*      */     
/*  775 */     short[] key = this.key;
/*      */     short curr;
/*      */     int pos;
/*  778 */     if ((curr = key[pos = HashCommon.mix(k) & this.mask]) == 0) return false; 
/*  779 */     if (k == curr && v == this.value[pos]) {
/*  780 */       removeEntry(pos);
/*  781 */       return true;
/*      */     } 
/*      */     while (true) {
/*  784 */       if ((curr = key[pos = pos + 1 & this.mask]) == 0) return false; 
...
/*  853 */     Integer newValue = remappingFunction.apply(Short.valueOf(k), Integer.valueOf(this.value[pos]));
/*  854 */     if (newValue == null) {
/*  855 */       if (k == 0) { removeNullEntry(); }
...
/*  866 */     int pos = find(k);
/*  867 */     Integer newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
/*  868 */     if (newValue == null) {
/*  869 */       if (pos >= 0)
/*  870 */         if (k == 0) { removeNullEntry(); }
...
/*  946 */       return Short2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  951 */       return Short2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int getIntValue() {
/*  956 */       return Short2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int rightInt() {
/*  961 */       return Short2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public int setValue(int v) {
/*  966 */       int oldValue = Short2IntLinkedOpenHashMap.this.value[this.index];
/*  967 */       Short2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortIntPair right(int v) {
/*  973 */       Short2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  985 */       return Short.valueOf(Short2IntLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Integer.valueOf(Short2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
/* 1015 */       return (Short2IntLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Short2IntLinkedOpenHashMap.this.key[this.index] ^ Short2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Short2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Short2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Short2IntLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(short from) {
/* 1198 */       if (from == 0) {
/* 1199 */         if (Short2IntLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Short2IntLinkedOpenHashMap.this.link[Short2IntLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Short2IntLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Short2IntLinkedOpenHashMap.this.key[Short2IntLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Short2IntLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Short2IntLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Short2IntLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Short2IntLinkedOpenHashMap.this.key[pos] != 0) {
/* 1214 */         if (Short2IntLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Short2IntLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Short2IntLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Short2IntLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Short2IntLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Short2IntLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Short2IntLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Short2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Short2IntLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Short2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Short2IntLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Short2IntLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Short2IntLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Short2IntLinkedOpenHashMap.this.link[this.prev] = Short2IntLinkedOpenHashMap.this.link[this.prev] ^ (Short2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Short2IntLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Short2IntLinkedOpenHashMap.this.link[this.next] = Short2IntLinkedOpenHashMap.this.link[this.next] ^ (Short2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Short2IntLinkedOpenHashMap.this.n) {
/* 1308 */         Short2IntLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         short[] key = Short2IntLinkedOpenHashMap.this.key; while (true) {
/*      */           short curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Short2IntLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == 0) {
/* 1317 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Short2IntLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Short2IntLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Short2IntLinkedOpenHashMap.this.value[last] = Short2IntLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Short2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2IntMap.Entry>> implements ObjectListIterator<Short2IntMap.Entry> {
...
/* 1367 */       action.accept(new Short2IntLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Short2IntLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Short2IntLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Short2IntMap.Entry>> implements ObjectListIterator<Short2IntMap.Entry> {
/* 1388 */     final Short2IntLinkedOpenHashMap.MapEntry entry = new Short2IntLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Short2IntLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Short2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Short2IntLinkedOpenHashMap.MapEntry(Short2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntMap.Entry last() {
/* 1471 */       if (Short2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Short2IntLinkedOpenHashMap.MapEntry(Short2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1480 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1481 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1482 */       short k = ((Short)e.getKey()).shortValue();
/* 1483 */       int v = ((Integer)e.getValue()).intValue();
/* 1484 */       if (k == 0) return (Short2IntLinkedOpenHashMap.this.containsNullKey && Short2IntLinkedOpenHashMap.this.value[Short2IntLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       short[] key = Short2IntLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Short2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1490 */       if (k == curr) return (Short2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Short2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1494 */         if (k == curr) return (Short2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1503 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1504 */       if (e.getValue() == null || !(e.getValue() instanceof Integer)) return false; 
/* 1505 */       short k = ((Short)e.getKey()).shortValue();
/* 1506 */       int v = ((Integer)e.getValue()).intValue();
/* 1507 */       if (k == 0) {
/* 1508 */         if (Short2IntLinkedOpenHashMap.this.containsNullKey && Short2IntLinkedOpenHashMap.this.value[Short2IntLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Short2IntLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       short[] key = Short2IntLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Short2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Short2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Short2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Short2IntLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Short2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Short2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Short2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Short2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Short2IntLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Short2IntLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Short2IntLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
/* 1587 */       for (int i = Short2IntLinkedOpenHashMap.this.size, next = Short2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Short2IntLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Short2IntLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Short2IntLinkedOpenHashMap.MapEntry entry = new Short2IntLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Short2IntLinkedOpenHashMap.this.size, next = Short2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Short2IntLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Short2IntLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Short2IntLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1644 */       return Short2IntLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Short2IntLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1658 */       return new Short2IntLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2IntLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1674 */       for (int i = Short2IntLinkedOpenHashMap.this.size, next = Short2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Short2IntLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Short2IntLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Short2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1688 */       return Short2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1693 */       int oldSize = Short2IntLinkedOpenHashMap.this.size;
/* 1694 */       Short2IntLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Short2IntLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Short2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1705 */       if (Short2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Short2IntLinkedOpenHashMap.this.key[Short2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public short lastShort() {
/* 1711 */       if (Short2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Short2IntLinkedOpenHashMap.this.key[Short2IntLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortComparator comparator() {
...
/* 1753 */       return Short2IntLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Short2IntLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1770 */       return Short2IntLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (IntIterator)new Short2IntLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2IntLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1797 */             for (int i = Short2IntLinkedOpenHashMap.this.size, next = Short2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Short2IntLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Short2IntLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Short2IntLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int v) {
/* 1811 */             return Short2IntLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Short2IntLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1880 */     short[] key = this.key;
/* 1881 */     int[] value = this.value;
/* 1882 */     int mask = newN - 1;
/* 1883 */     short[] newKey = new short[newN + 1];
...
/* 1890 */       int pos; if (key[i] == 0) { pos = newN; }
/*      */       else
/* 1892 */       { pos = HashCommon.mix(key[i]) & mask;
/* 1893 */         for (; newKey[pos] != 0; pos = pos + 1 & mask); }
/*      */       
...
/*      */     try {
/* 1936 */       c = (Short2IntLinkedOpenHashMap)super.clone();
...
/* 1944 */     c.key = (short[])this.key.clone();
...
/* 1991 */     short[] key = this.key = new short[this.n + 1];
...
/* 1999 */       int pos; short k = s.readShort();
...
/* 2006 */         for (; key[pos] != 0; pos = pos + 1 & this.mask);
/*      */       } 
/* 2008 */       key[pos] = k;
/* 2009 */       value[pos] = v;
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntLinkedOpenHashMap.class
