...
/*  50 */     return (entries instanceof Short2ReferenceMap.FastEntrySet) ? ((Short2ReferenceMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Short2ReferenceMap.Entry<V>> entries = map.short2ReferenceEntrySet();
/*  66 */     if (entries instanceof Short2ReferenceMap.FastEntrySet) { ((Short2ReferenceMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Short2ReferenceMap.Entry<V>> entries = map.short2ReferenceEntrySet();
/*  83 */     return (entries instanceof Short2ReferenceMap.FastEntrySet) ? new ObjectIterable<Short2ReferenceMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() {
/*  86 */           return ((Short2ReferenceMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  96 */           ((Short2ReferenceMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Short2ReferenceMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 136 */       return (ObjectSet<Short2ReferenceMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 156 */       return Short2ReferenceMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
/* 228 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractShort2ReferenceMap.BasicEntry<>(this.key, this.value)); 
...
/* 241 */       return (ObjectSet)short2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 246 */       if (this.keys == null) this.keys = ShortSets.singleton(this.key); 
...
/*     */   
/*     */   public static <V> Short2ReferenceMap<V> singleton(Short key, V value) {
/* 308 */     return new Singleton<>(key.shortValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Short2ReferenceFunctions.SynchronizedFunction<V> implements Short2ReferenceMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 346 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2ReferenceEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, V>> entrySet() {
/* 360 */       return (ObjectSet)short2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 365 */       synchronized (this.sync) {
/* 366 */         if (this.keys == null) this.keys = ShortSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Short2ReferenceFunctions.UnmodifiableFunction<V> implements Short2ReferenceMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
/* 660 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2ReferenceEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, V>> entrySet() {
/* 673 */       return (ObjectSet)short2ReferenceEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 678 */       if (this.keys == null) this.keys = ShortSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceMaps.class
