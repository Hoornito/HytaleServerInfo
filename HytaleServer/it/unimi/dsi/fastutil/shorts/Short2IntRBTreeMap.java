...
/*  839 */       Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
/*  840 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Short2IntRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  950 */       if ((this.next = Short2IntRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Short2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Short2IntRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Short2IntRBTreeMap.Entry f = Short2IntRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1089 */             Short2IntRBTreeMap.Entry f = Short2IntRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1090 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue()) return false; 
/* 1091 */             Short2IntRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Short2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Short2IntRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2IntMap.Entry first() {
/* 1107 */             return Short2IntRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2IntMap.Entry last() {
/* 1112 */             return Short2IntRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1117 */             return Short2IntRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1122 */             return Short2IntRBTreeMap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1127 */             return Short2IntRBTreeMap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Short2IntRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1169 */       return new Short2IntRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (IntIterator)new Short2IntRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(int k) {
/* 1227 */             return Short2IntRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Short2IntRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Short2IntRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Short2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Short2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Short2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2IntRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2IntMap.Entry> comparator() {
/* 1341 */               return Short2IntRBTreeMap.this.short2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Short2IntRBTreeMap.Entry f = Short2IntRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1352 */               return (f != null && Short2IntRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Short2IntRBTreeMap.Entry f = Short2IntRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1363 */               if (f != null && Short2IntRBTreeMap.Submap.this.in(f.key)) Short2IntRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Short2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Short2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Short2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2IntMap.Entry first() {
/* 1386 */               return Short2IntRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2IntMap.Entry last() {
/* 1391 */               return Short2IntRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1396 */               return Short2IntRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1401 */               return Short2IntRBTreeMap.Submap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1406 */               return Short2IntRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2IntSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1415 */         return new Short2IntRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1420 */         return new Short2IntRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1435 */               return (IntIterator)new Short2IntRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(int k) {
/* 1440 */               return Short2IntRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Short2IntRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Short2IntRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1460 */       return (in(k) && Short2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(short k) {
/* 1478 */       short kk = k; Short2IntRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Short2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int put(short k, int v) {
/* 1484 */       Short2IntRBTreeMap.this.modified = false;
...
/* 1486 */       int oldValue = Short2IntRBTreeMap.this.put(k, v);
/* 1487 */       return Short2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int remove(short k) {
/* 1493 */       Short2IntRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       int oldValue = Short2IntRBTreeMap.this.remove(k);
/* 1496 */       return Short2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1517 */       return Short2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap headMap(short to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Short2IntRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap tailMap(short from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Short2IntRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2IntSortedMap subMap(short from, short to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Short2IntRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Short2IntRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Short2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Short2IntRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Short2IntRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Short2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Short2IntRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2IntRBTreeMap.Entry e;
/* 1569 */       if (Short2IntRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Short2IntRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Short2IntRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Short2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Short2IntRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1587 */       Short2IntRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1594 */       Short2IntRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Short2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Short2IntRBTreeMap.Submap.this.bottom && Short2IntRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Short2IntRBTreeMap.Submap.this.top && Short2IntRBTreeMap.this.compare(k, (this.prev = Short2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Short2IntRBTreeMap.this.locateKey(k);
/* 1620 */             if (Short2IntRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Short2IntRBTreeMap.Submap.this.bottom && this.prev != null && Short2IntRBTreeMap.this.compare(this.prev.key, Short2IntRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Short2IntRBTreeMap.Submap.this.top && this.next != null && Short2IntRBTreeMap.this.compare(this.next.key, Short2IntRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1725 */       c = (Short2IntRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readShort(), s.readInt());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readShort(), s.readInt());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readShort(), s.readInt()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntRBTreeMap.class
