...
/*  582 */       return Short2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  587 */       return Short2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V getValue() {
/*  592 */       return Short2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V right() {
/*  597 */       return Short2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public V setValue(V v) {
/*  602 */       V oldValue = Short2ObjectOpenCustomHashMap.this.value[this.index];
/*  603 */       Short2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  604 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortObjectPair<V> right(V v) {
/*  609 */       Short2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  610 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  621 */       return Short.valueOf(Short2ObjectOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  629 */       return (Short2ObjectOpenCustomHashMap.this.strategy.equals(Short2ObjectOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue()) && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  634 */       return Short2ObjectOpenCustomHashMap.this.strategy.hashCode(Short2ObjectOpenCustomHashMap.this.key[this.index]) ^ ((Short2ObjectOpenCustomHashMap.this.value[this.index] == null) ? 0 : Short2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  639 */       return Short2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Short2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  650 */     int pos = Short2ObjectOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  656 */     int last = -1;
/*      */     
/*  658 */     int c = Short2ObjectOpenCustomHashMap.this.size;
/*      */     
/*  660 */     boolean mustReturnNullKey = Short2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  679 */         return this.last = Short2ObjectOpenCustomHashMap.this.n;
/*      */       } 
/*  681 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  683 */         if (--this.pos < 0) {
/*      */           
/*  685 */           this.last = Integer.MIN_VALUE;
/*  686 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  687 */           int p = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ObjectOpenCustomHashMap.this.mask;
/*  688 */           for (; !Short2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2ObjectOpenCustomHashMap.this.mask);
/*  689 */           return p;
/*      */         } 
...
/*  698 */         acceptOnIndex(action, this.last = Short2ObjectOpenCustomHashMap.this.n);
/*  699 */         this.c--;
/*      */       } 
/*  701 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
/*  702 */       while (this.c != 0) {
/*  703 */         if (--this.pos < 0) {
/*      */           
/*  705 */           this.last = Integer.MIN_VALUE;
/*  706 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  707 */           int p = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ObjectOpenCustomHashMap.this.mask;
/*  708 */           for (; !Short2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2ObjectOpenCustomHashMap.this.mask);
...
/*  728 */       short[] key = Short2ObjectOpenCustomHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  730 */         pos = (last = pos) + 1 & Short2ObjectOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  732 */           if ((curr = key[pos]) == 0) {
/*  733 */             key[last] = 0;
/*  734 */             Short2ObjectOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  737 */           int slot = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Short2ObjectOpenCustomHashMap.this.mask;
/*  738 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  739 */             break;  pos = pos + 1 & Short2ObjectOpenCustomHashMap.this.mask;
/*      */         } 
/*  741 */         if (pos < last) {
...
/*      */         } 
/*  745 */         key[last] = curr;
/*  746 */         Short2ObjectOpenCustomHashMap.this.value[last] = Short2ObjectOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  751 */       if (this.last == -1) throw new IllegalStateException(); 
/*  752 */       if (this.last == Short2ObjectOpenCustomHashMap.this.n)
/*  753 */       { Short2ObjectOpenCustomHashMap.this.containsNullKey = false;
/*  754 */         Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n] = null; }
/*  755 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  758 */       { Short2ObjectOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  759 */         this.last = -1;
/*      */         return; }
/*      */       
/*  762 */       Short2ObjectOpenCustomHashMap.this.size--;
/*  763 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2ObjectMap.Entry<V>>> implements ObjectIterator<Short2ObjectMap.Entry<V>> { public Short2ObjectOpenCustomHashMap<V>.MapEntry next() {
/*  779 */       return this.entry = new Short2ObjectOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  785 */       action.accept(this.entry = new Short2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */     } }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Short2ObjectMap.Entry<V>>> implements ObjectIterator<Short2ObjectMap.Entry<V>> {
/*      */     private FastEntryIterator() {
/*  796 */       this.entry = new Short2ObjectOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  817 */     int pos = 0;
/*      */     
/*  819 */     int max = Short2ObjectOpenCustomHashMap.this.n;
/*      */     
/*  821 */     int c = 0;
/*      */     
/*  823 */     boolean mustReturnNull = Short2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  843 */         this.c++;
/*  844 */         acceptOnIndex(action, Short2ObjectOpenCustomHashMap.this.n);
/*  845 */         return true;
/*      */       } 
/*  847 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
...
/*  862 */         this.c++;
/*  863 */         acceptOnIndex(action, Short2ObjectOpenCustomHashMap.this.n);
/*      */       } 
/*  865 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
...
/*      */       {
/*  878 */         return (Short2ObjectOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  883 */       return Math.min((Short2ObjectOpenCustomHashMap.this.size - this.c), (long)(Short2ObjectOpenCustomHashMap.this.realSize() / Short2ObjectOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  911 */         n--;
/*      */       } 
/*  913 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Short2ObjectMap.Entry<V>>, EntrySpliterator> implements ObjectSpliterator<Short2ObjectMap.Entry<V>> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2ObjectMap.Entry<V>> action, int index) {
/*  941 */       action.accept(new Short2ObjectOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/*  953 */       return new Short2ObjectOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2ObjectMap.Entry<V>> fastIterator() {
/*  958 */       return new Short2ObjectOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2ObjectMap.Entry<V>> spliterator() {
/*  963 */       return new Short2ObjectOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  975 */       if (Short2ObjectOpenCustomHashMap.this.strategy.equals(k, (short)0)) return (Short2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n], v));
/*      */       
/*  977 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  980 */       if ((curr = key[pos = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/*  981 */       if (Short2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Short2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       while (true) {
/*  984 */         if ((curr = key[pos = pos + 1 & Short2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/*  985 */         if (Short2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) return Objects.equals(Short2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/*  997 */       if (Short2ObjectOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
/*  998 */         if (Short2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n], v)) {
/*  999 */           Short2ObjectOpenCustomHashMap.this.removeNullEntry();
/* 1000 */           return true;
/*      */         } 
/* 1002 */         return false;
/*      */       } 
/*      */       
/* 1005 */       short[] key = Short2ObjectOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1008 */       if ((curr = key[pos = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1009 */       if (Short2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1010 */         if (Objects.equals(Short2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1011 */           Short2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1012 */           return true;
/*      */         } 
/* 1014 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1017 */         if ((curr = key[pos = pos + 1 & Short2ObjectOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1018 */         if (Short2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1019 */           Objects.equals(Short2ObjectOpenCustomHashMap.this.value[pos], v)) {
/* 1020 */           Short2ObjectOpenCustomHashMap.this.removeEntry(pos);
/* 1021 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1029 */       return Short2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1034 */       Short2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
/* 1040 */       if (Short2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(new Short2ObjectOpenCustomHashMap.MapEntry(Short2ObjectOpenCustomHashMap.this.n)); 
/* 1041 */       for (int pos = Short2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2ObjectOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Short2ObjectOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
/* 1047 */       Short2ObjectOpenCustomHashMap<V>.MapEntry entry = new Short2ObjectOpenCustomHashMap.MapEntry();
/* 1048 */       if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
/* 1049 */         entry.index = Short2ObjectOpenCustomHashMap.this.n;
/* 1050 */         consumer.accept(entry);
/*      */       } 
/* 1052 */       for (int pos = Short2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2ObjectOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1083 */       action.accept(Short2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1088 */       return Short2ObjectOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1109 */       action.accept(Short2ObjectOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1121 */       return new Short2ObjectOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1126 */       return new Short2ObjectOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1132 */       if (Short2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2ObjectOpenCustomHashMap.this.key[Short2ObjectOpenCustomHashMap.this.n]); 
/* 1133 */       for (int pos = Short2ObjectOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1134 */         short k = Short2ObjectOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1141 */       return Short2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1146 */       return Short2ObjectOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1151 */       int oldSize = Short2ObjectOpenCustomHashMap.this.size;
/* 1152 */       Short2ObjectOpenCustomHashMap.this.remove(k);
/* 1153 */       return (Short2ObjectOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1158 */       Short2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1186 */       action.accept(Short2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public V next() {
/* 1191 */       return Short2ObjectOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super V> action, int index) {
/* 1212 */       action.accept(Short2ObjectOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1226 */             return new Short2ObjectOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSpliterator<V> spliterator() {
/* 1231 */             return new Short2ObjectOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1237 */             if (Short2ObjectOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n]); 
/* 1238 */             for (int pos = Short2ObjectOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2ObjectOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Short2ObjectOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1243 */             return Short2ObjectOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object v) {
/* 1248 */             return Short2ObjectOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1253 */             Short2ObjectOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1351 */       c = (Short2ObjectOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectOpenCustomHashMap.class
