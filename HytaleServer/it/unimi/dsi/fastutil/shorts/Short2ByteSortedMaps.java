...
/*  60 */     ObjectSortedSet<Short2ByteMap.Entry> entries = map.short2ByteEntrySet();
/*  61 */     return (entries instanceof Short2ByteSortedMap.FastSortedEntrySet) ? ((Short2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Short2ByteMap.Entry> entries = map.short2ByteEntrySet();
/*  77 */     Objects.requireNonNull((Short2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Short2ByteSortedMap.FastSortedEntrySet) ? (Short2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Short2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Short2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Short, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2ByteSortedMap headMap(short to) {
/* 125 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2ByteSortedMap tailMap(short from) {
/* 130 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Short2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractShort2ByteMap.BasicEntry(this.key, this.value), Short2ByteSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Short2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/* 248 */       return (ObjectSortedSet)short2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 260 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2ByteSortedMap headMap(short to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2ByteSortedMap tailMap(short from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public short firstShortKey() {
...
/* 353 */     return new Singleton(key.shortValue(), value.byteValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 369 */     return new Singleton(key.shortValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Short2ByteMaps.SynchronizedMap implements Short2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Short2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.short2ByteEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Short2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/* 440 */       return (ObjectSortedSet)short2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/*     */     extends Short2ByteMaps.UnmodifiableMap implements Short2ByteSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2ByteSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Short2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.short2ByteEntrySet()); 
/* 581 */       return (ObjectSortedSet<Short2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/* 593 */       return (ObjectSortedSet)short2ByteEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ByteSortedMaps.class
