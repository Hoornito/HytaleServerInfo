...
/*   71 */     this.actualComparator = ShortComparators.asShortComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     allocatePaths();
/*  131 */     for (; i.hasNext(); add(i.nextShort()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  141 */     this(ShortIterators.asShortIterator(i));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  154 */     this(c);
/*  155 */     ShortArrays.ensureOffsetLength(a, offset, length);
...
/*  167 */     this(a, offset, length, (Comparator<? super Short>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  216 */     return (this.actualComparator == null) ? Short.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     SetIterator() {
/*  940 */       this.next = ShortAVLTreeSet.this.firstEntry;
/*      */     }
/*      */     
/*      */     SetIterator(short k) {
/*  944 */       if ((this.next = ShortAVLTreeSet.this.locateKey(k)) != null) {
/*  945 */         if (ShortAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1013 */       updatePrevious();
/* 1014 */       updateNext();
/* 1015 */       ShortAVLTreeSet.this.remove(this.curr.key);
/* 1016 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/* 1037 */     return new Subset((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public ShortSortedSet tailSet(short from) {
/* 1042 */     return new Subset(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1080 */       if (!bottom && !top && ShortAVLTreeSet.this.compare(from, to) > 0) throw new IllegalArgumentException("Start element (" + from + ") is larger than end element (" + to + ")"); 
/* 1081 */       this.from = from;
...
/* 1103 */       return ((this.bottom || ShortAVLTreeSet.this.compare(k, this.from) >= 0) && (this.top || ShortAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1108 */       return (in(k) && ShortAVLTreeSet.this.contains(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean add(short k) {
...
/* 1114 */       return ShortAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1119 */       if (!in(k)) return false; 
/* 1120 */       return ShortAVLTreeSet.this.remove(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1141 */       return ShortAVLTreeSet.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator() {
...
/* 1157 */       return (ShortAVLTreeSet.this.compare(to, this.to) < 0) ? new Subset(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSortedSet tailSet(short from) {
/* 1162 */       if (this.bottom) return new Subset(from, false, this.to, this.top); 
/* 1163 */       return (ShortAVLTreeSet.this.compare(from, this.from) > 0) ? new Subset(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSortedSet subSet(short from, short to) {
/* 1168 */       if (this.top && this.bottom) return new Subset(from, false, to, false); 
/* 1169 */       if (!this.top) to = (ShortAVLTreeSet.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1170 */       if (!this.bottom) from = (ShortAVLTreeSet.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1181 */       if (ShortAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1185 */       if (this.bottom) { e = ShortAVLTreeSet.this.firstEntry; }
/*      */       else
/* 1187 */       { e = ShortAVLTreeSet.this.locateKey(this.from);
/*      */         
/* 1189 */         if (ShortAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1193 */       if (e == null || (!this.top && ShortAVLTreeSet.this.compare(e.key, this.to) >= 0)) return null; 
/* 1194 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       ShortAVLTreeSet.Entry e;
/* 1203 */       if (ShortAVLTreeSet.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1207 */       if (this.top) { e = ShortAVLTreeSet.this.lastEntry; }
/*      */       else
/* 1209 */       { e = ShortAVLTreeSet.this.locateKey(this.to);
/*      */         
/* 1211 */         if (ShortAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1215 */       if (e == null || (!this.bottom && ShortAVLTreeSet.this.compare(e.key, this.from) < 0)) return null; 
/* 1216 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1221 */       ShortAVLTreeSet.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShort() {
/* 1228 */       ShortAVLTreeSet.Entry e = lastEntry();
...
/*      */       extends ShortAVLTreeSet.SetIterator
/*      */     {
/*      */       SubsetIterator() {
/* 1244 */         this.next = ShortAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubsetIterator(short k) {
/* 1248 */         this();
/* 1249 */         if (this.next != null) {
/* 1250 */           if (!ShortAVLTreeSet.Subset.this.bottom && ShortAVLTreeSet.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1251 */           else if (!ShortAVLTreeSet.Subset.this.top && ShortAVLTreeSet.this.compare(k, (this.prev = ShortAVLTreeSet.Subset.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1253 */           { this.next = ShortAVLTreeSet.this.locateKey(k);
/* 1254 */             if (ShortAVLTreeSet.this.compare(this.next.key, k) <= 0)
...
/* 1265 */         if (!ShortAVLTreeSet.Subset.this.bottom && this.prev != null && ShortAVLTreeSet.this.compare(this.prev.key, ShortAVLTreeSet.Subset.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1270 */         this.next = this.next.next();
/* 1271 */         if (!ShortAVLTreeSet.Subset.this.top && this.next != null && ShortAVLTreeSet.this.compare(this.next.key, ShortAVLTreeSet.Subset.this.to) >= 0) this.next = null;
/*      */       
/*      */       }
/*      */     }
/*      */   }
...
/*      */     ShortAVLTreeSet c;
/*      */     try {
/* 1290 */       c = (ShortAVLTreeSet)super.clone();
...
/* 1342 */     for (; n-- != 0; s.writeShort(i.nextShort()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1355 */     if (n == 1) {
/* 1356 */       Entry entry = new Entry(s.readShort());
...
/*      */ 
/*      */       
/* 1364 */       Entry entry = new Entry(s.readShort());
/* 1365 */       entry.right(new Entry(s.readShort()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\ShortAVLTreeSet.class
