...
/*   78 */     if (capacity == 0L) { this.a = ShortBigArrays.EMPTY_BIG_ARRAY; }
/*   79 */     else { this.a = ShortBigArrays.newBigArray(capacity); }
/*      */   
/*      */   }
/*      */ 
/*      */   
/*      */   public ShortBigArrayBigList() {
/*   85 */     this.a = ShortBigArrays.DEFAULT_EMPTY_BIG_ARRAY;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*   96 */     ((ShortBigList)c).getElements(0L, this.a, 0L, this.size = Size64.sizeOf(c));
/*      */     
/*   98 */     for (ShortIterator i = c.iterator(); i.hasNext(); add(i.nextShort()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  140 */     this();
/*  141 */     for (; i.hasNext(); add(((Short)i.next()).shortValue()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  151 */     this();
/*  152 */     for (; i.hasNext(); add(i.nextShort()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  173 */     ShortBigArrayBigList l = new ShortBigArrayBigList(a, false);
/*  174 */     l.size = length;
/*  175 */     return l;
/*      */   }
/*      */ 
...
/*  194 */     return new ShortBigArrayBigList();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  218 */     if (capacity <= BigArrays.length(this.a) || this.a == ShortBigArrays.DEFAULT_EMPTY_BIG_ARRAY)
...
/*  233 */       return;  if (this.a != ShortBigArrays.DEFAULT_EMPTY_BIG_ARRAY) { capacity = Math.max(oldLength + (oldLength >> 1L), capacity); }
...
/*  278 */     short old = BigArrays.get(this.a, index);
/*  279 */     this.size--;
...
/*  297 */     short old = BigArrays.get(this.a, index);
...
/*  333 */         s = this.a[++ss];
/*      */       } 
/*  335 */       if (!c.contains(Short.valueOf(s[sd]))) {
/*  336 */         if (dd == 134217728) {
/*  337 */           d = this.a[++ds];
/*  338 */           dd = 0;
/*      */         } 
...
/*      */     // Byte code:
/*      */     //   0: aload_3
/*      */     //   1: instanceof it/unimi/dsi/fastutil/shorts/ShortList
/*      */     //   4: ifeq -> 17
/*      */     //   7: aload_0
/*      */     //   8: lload_1
/*      */     //   9: aload_3
/*      */     //   10: checkcast it/unimi/dsi/fastutil/shorts/ShortList
/*      */     //   13: invokevirtual addAll : (JLit/unimi/dsi/fastutil/shorts/ShortList;)Z
/*      */     //   16: ireturn
/*      */     //   17: aload_3
/*      */     //   18: instanceof it/unimi/dsi/fastutil/shorts/ShortBigList
/*      */     //   21: ifeq -> 34
/*      */     //   24: aload_0
/*      */     //   25: lload_1
/*      */     //   26: aload_3
/*      */     //   27: checkcast it/unimi/dsi/fastutil/shorts/ShortBigList
/*      */     //   30: invokevirtual addAll : (JLit/unimi/dsi/fastutil/shorts/ShortBigList;)Z
/*      */     //   33: ireturn
/*      */     //   34: aload_0
/*      */     //   35: lload_1
...
/*      */     //   84: lload_1
/*      */     //   85: lsub
/*      */     //   86: invokestatic copy : ([[SJ[[SJJ)V
/*      */     //   89: aload_3
/*      */     //   90: invokeinterface iterator : ()Lit/unimi/dsi/fastutil/shorts/ShortIterator;
/*      */     //   95: astore #5
/*      */     //   97: aload_0
/*      */     //   98: dup
/*      */     //   99: getfield size : J
...
/*      */     //   105: ladd
/*      */     //   106: putfield size : J
/*      */     //   109: getstatic it/unimi/dsi/fastutil/shorts/ShortBigArrayBigList.$assertionsDisabled : Z
/*      */     //   112: ifne -> 138
/*      */     //   115: aload_0
/*      */     //   116: getfield size : J
/*      */     //   119: aload_0
/*      */     //   120: getfield a : [[S
/*      */     //   123: invokestatic length : ([[S)J
/*      */     //   126: lcmp
/*      */     //   127: ifle -> 138
...
/*      */     //   154: lstore_1
/*      */     //   155: aload #5
/*      */     //   157: invokeinterface nextShort : ()S
/*      */     //   162: invokestatic set : ([[SJS)V
/*      */     //   165: goto -> 138
/*      */     //   168: iconst_1
/*      */     //   169: ireturn
/*      */     // Line number table:
...
/*      */     //   0	170	0	this	Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList;
/*      */     //   0	170	1	index	J
/*      */     //   0	170	3	c	Lit/unimi/dsi/fastutil/shorts/ShortCollection;
/*      */     //   47	123	4	n	I
/*      */     //   97	73	5	i	Lit/unimi/dsi/fastutil/shorts/ShortIterator;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  422 */     if (size > this.size) BigArrays.fill(this.a, this.size, size, (short)0); 
/*  423 */     this.size = size;
/*      */   }
/*      */ 
/*      */   
...
/*  471 */       return ShortBigArrayBigList.this.a;
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  478 */       return BigArrays.get(ShortBigArrayBigList.this.a, i + this.from);
/*      */     }
/*      */     
...
/*  490 */         return BigArrays.get(ShortBigArrayBigList.this.a, ShortBigArrayBigList.SubList.this.from + i);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void add(long i, short k) {
/*  495 */         ShortBigArrayBigList.SubList.this.add(i, k);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void set(long i, short k) {
/*  500 */         ShortBigArrayBigList.SubList.this.set(i, k);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final void remove(long i) {
/*  505 */         ShortBigArrayBigList.SubList.this.removeShort(i);
/*      */       }
/*      */ 
/*      */       
/*      */       protected final long getMaxPos() {
/*  510 */         return ShortBigArrayBigList.SubList.this.to - ShortBigArrayBigList.SubList.this.from;
/*      */       }
/*      */ 
/*      */       
/*      */       public short nextShort() {
/*  515 */         if (!hasNext()) throw new NoSuchElementException(); 
/*  516 */         return BigArrays.get(ShortBigArrayBigList.this.a, ShortBigArrayBigList.SubList.this.from + (this.lastReturned = this.pos++));
/*      */       }
/*      */ 
/*      */       
/*      */       public short previousShort() {
/*  521 */         if (!hasPrevious()) throw new NoSuchElementException(); 
/*  522 */         return BigArrays.get(ShortBigArrayBigList.this.a, ShortBigArrayBigList.SubList.this.from + (this.lastReturned = --this.pos));
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         // Byte code:
/*      */         //   0: aload_0
/*      */         //   1: getfield this$1 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList;
/*      */         //   4: getfield to : J
/*      */         //   7: aload_0
/*      */         //   8: getfield this$1 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList;
/*      */         //   11: getfield from : J
/*      */         //   14: lsub
/*      */         //   15: lstore_2
/*      */         //   16: aload_0
...
/*      */         //   25: aload_1
/*      */         //   26: aload_0
/*      */         //   27: getfield this$1 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList;
/*      */         //   30: getfield this$0 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList;
/*      */         //   33: getfield a : [[S
/*      */         //   36: aload_0
/*      */         //   37: getfield this$1 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList;
/*      */         //   40: getfield from : J
/*      */         //   43: aload_0
/*      */         //   44: aload_0
/*      */         //   45: dup
...
/*      */         //   59: ladd
/*      */         //   60: invokestatic get : ([[SJ)S
/*      */         //   63: invokeinterface accept : (S)V
/*      */         //   68: goto -> 16
/*      */         //   71: return
/*      */         // Line number table:
/*      */         //   Java source line number -> byte code offset
...
/*      */         // Local variable table:
/*      */         //   start	length	slot	name	descriptor
/*      */         //   0	72	0	this	Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList$SubListIterator;
/*      */         //   0	72	1	action	Lit/unimi/dsi/fastutil/shorts/ShortConsumer;
/*      */         //   16	56	2	max	J
/*      */       }
/*      */     }
/*      */ 
...
/*      */       SubListSpliterator() {
/*  542 */         super(ShortBigArrayBigList.SubList.this.from);
/*      */       }
/*      */       
...
/*  551 */         return ShortBigArrayBigList.SubList.this.to;
/*      */       }
/*      */ 
/*      */       
/*      */       protected final short get(long i) {
/*  556 */         return BigArrays.get(ShortBigArrayBigList.this.a, i);
/*      */       }
/*      */ 
/*      */       
...
/*  575 */         action.accept(BigArrays.get(ShortBigArrayBigList.this.a, this.pos++));
/*  576 */         return true;
/*      */       }
/*      */ 
/*      */ 
...
/*      */         //   14: aload_1
/*      */         //   15: aload_0
/*      */         //   16: getfield this$1 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList;
/*      */         //   19: getfield this$0 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList;
/*      */         //   22: getfield a : [[S
/*      */         //   25: aload_0
/*      */         //   26: dup
/*      */         //   27: getfield pos : J
...
/*      */         //   32: ladd
/*      */         //   33: putfield pos : J
/*      */         //   36: invokestatic get : ([[SJ)S
/*      */         //   39: invokeinterface accept : (S)V
/*      */         //   44: goto -> 5
/*      */         //   47: return
/*      */         // Line number table:
/*      */         //   Java source line number -> byte code offset
...
/*      */         // Local variable table:
/*      */         //   start	length	slot	name	descriptor
/*      */         //   0	48	0	this	Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$SubList$SubListSpliterator;
/*      */         //   0	48	1	action	Lit/unimi/dsi/fastutil/shorts/ShortConsumer;
/*      */         //   5	43	2	max	J
/*      */       }
/*      */     }
/*      */ 
...
/*  594 */       if (ShortBigArrayBigList.this.a == otherA && this.from == otherAFrom && this.to == otherATo) return true; 
...
/*      */ 
/*      */       
/*  603 */       while (--pos >= this.from) { if (BigArrays.get(ShortBigArrayBigList.this.a, pos) != BigArrays.get(otherA, --otherPos)) return false;  }
/*  604 */        return true;
/*      */     }
/*      */ 
/*      */     
...
/*  612 */       if (o instanceof ShortBigArrayBigList) {
/*      */         
/*  614 */         ShortBigArrayBigList other = (ShortBigArrayBigList)o;
...
/*  626 */       if (ShortBigArrayBigList.this.a == otherA && this.from == otherAFrom && this.to == otherATo) return 0;
/*      */ 
/*      */       
/*      */       long i;
/*      */       long j;
/*  631 */       for (i = this.from, j = otherAFrom; i < this.to && i < otherATo; i++, j++) {
/*  632 */         short e1 = BigArrays.get(ShortBigArrayBigList.this.a, i);
/*  633 */         short e2 = BigArrays.get(otherA, j); int r;
/*  634 */         if ((r = Short.compare(e1, e2)) != 0) return r; 
/*      */       } 
...
/*  641 */       if (l instanceof ShortBigArrayBigList) {
/*      */         
/*  643 */         ShortBigArrayBigList other = (ShortBigArrayBigList)l;
...
/*  748 */     return new ShortBigListIterator() {
/*  749 */         long pos = index; long last = -1L;
/*      */ 
/*      */         
/*      */         public boolean hasNext() {
/*  753 */           return (this.pos < ShortBigArrayBigList.this.size);
/*      */         }
/*      */ 
/*      */         
...
/*  764 */           return BigArrays.get(ShortBigArrayBigList.this.a, this.last = this.pos++);
/*      */         }
/*      */ 
/*      */         
/*      */         public short previousShort() {
/*  769 */           if (!hasPrevious()) throw new NoSuchElementException(); 
/*  770 */           return BigArrays.get(ShortBigArrayBigList.this.a, this.last = --this.pos);
/*      */         }
/*      */ 
/*      */         
...
/*  785 */           ShortBigArrayBigList.this.add(this.pos++, k);
/*  786 */           this.last = -1L;
/*      */         }
/*      */ 
/*      */         
...
/*  792 */           ShortBigArrayBigList.this.set(this.last, k);
/*      */         }
/*      */ 
/*      */         
/*      */         public void remove() {
/*  797 */           if (this.last == -1L) throw new IllegalStateException(); 
/*  798 */           ShortBigArrayBigList.this.removeShort(this.last);
/*      */           
...
/*      */           //   1: getfield pos : J
/*      */           //   4: aload_0
/*      */           //   5: getfield this$0 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList;
/*      */           //   8: getfield size : J
/*      */           //   11: lcmp
/*      */           //   12: ifge -> 50
/*      */           //   15: aload_1
/*      */           //   16: aload_0
/*      */           //   17: getfield this$0 : Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList;
/*      */           //   20: getfield a : [[S
/*      */           //   23: aload_0
/*      */           //   24: aload_0
/*      */           //   25: dup
...
/*      */           // Local variable table:
/*      */           //   start	length	slot	name	descriptor
/*      */           //   0	51	0	this	Lit/unimi/dsi/fastutil/shorts/ShortBigArrayBigList$1;
/*      */           //   0	51	1	action	Lit/unimi/dsi/fastutil/shorts/ShortConsumer;
/*      */         }
/*      */ 
/*      */ 
/*      */         
...
/*  814 */           long remaining = ShortBigArrayBigList.this.size - this.pos;
/*  815 */           if (n < remaining) {
/*  816 */             this.pos -= n;
/*      */           } else {
/*  818 */             n = remaining;
...
/*  828 */           long remaining = ShortBigArrayBigList.this.size - this.pos;
/*  829 */           if (n < remaining) {
/*  830 */             this.pos += n;
/*      */           } else {
/*  832 */             n = remaining;
/*  833 */             this.pos = ShortBigArrayBigList.this.size;
/*      */           } 
...
/*      */     
/*      */     public Spliterator() {
/*  849 */       this(0L, ShortBigArrayBigList.this.size, false);
/*      */     }
/*      */     
...
/*  860 */       return this.hasSplit ? this.max : ShortBigArrayBigList.this.size;
/*      */     }
/*      */ 
/*      */     
...
/*  876 */       action.accept(BigArrays.get(ShortBigArrayBigList.this.a, this.pos++));
/*  877 */       return true;
/*      */     }
/*      */ 
/*      */     
...
/*  883 */         action.accept(BigArrays.get(ShortBigArrayBigList.this.a, this.pos));
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/*  930 */     if (getClass() == ShortBigArrayBigList.class) {
/*  931 */       c = new ShortBigArrayBigList(this.size);
/*  932 */       c.size = this.size;
/*      */     } else {
/*      */       try {
/*  935 */         c = (ShortBigArrayBigList)super.clone();
/*  936 */       } catch (CloneNotSupportedException e) {
/*      */         
/*  938 */         throw new InternalError(e);
/*      */       } 
/*  940 */       c.a = ShortBigArrays.newBigArray(this.size);
/*      */     } 
...
/*  975 */     if (o instanceof ShortBigArrayBigList)
/*      */     {
/*  977 */       return equals((ShortBigArrayBigList)o);
/*      */     }
...
/* 1001 */     short[][] a1 = this.a, a2 = l.a;
/* 1002 */     if (a1 == a2 && s1 == s2) return 0;
/*      */     
/*      */     int i;
/* 1005 */     for (i = 0; i < s1 && i < s2; i++) {
/* 1006 */       short e1 = BigArrays.get(a1, i);
/* 1007 */       short e2 = BigArrays.get(a2, i); int r;
/* 1008 */       if ((r = Short.compare(e1, e2)) != 0) return r; 
/*      */     } 
...
/*      */   
/*      */   public int compareTo(BigList<? extends Short> l) {
/* 1015 */     if (l instanceof ShortBigArrayBigList) {
/* 1016 */       return compareTo((ShortBigArrayBigList)l);
/*      */     }
...
/* 1027 */     for (int i = 0; i < this.size; ) { s.writeShort(BigArrays.get(this.a, i)); i++; }
/*      */   
/*      */   }
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1031 */     s.defaultReadObject();
/* 1032 */     this.a = ShortBigArrays.newBigArray(this.size);
/* 1033 */     for (int i = 0; i < this.size; ) { BigArrays.set(this.a, i, s.readShort()); i++; }
/*      */   
/*      */   }
/*      */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\ShortBigArrayBigList.class
