...
/*  885 */       Map.Entry<Short, Byte> e = (Map.Entry<Short, Byte>)o;
/*  886 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Short2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  998 */       if ((this.next = Short2ByteAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Short2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Short2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2ByteMap.Entry>)new AbstractObjectSortedSet<Short2ByteMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Short2ByteMap.Entry>)new Short2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Short2ByteMap.Entry>)new Short2ByteAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1135 */             Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1147 */             Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1148 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue()) return false; 
/* 1149 */             Short2ByteAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Short2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Short2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ByteMap.Entry first() {
/* 1165 */             return Short2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ByteMap.Entry last() {
/* 1170 */             return Short2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) {
/* 1175 */             return Short2ByteAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) {
/* 1180 */             return Short2ByteAVLTreeMap.this.headMap(to.getShortKey()).short2ByteEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) {
/* 1185 */             return Short2ByteAVLTreeMap.this.tailMap(from.getShortKey()).short2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Short2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1227 */       return new Short2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (ByteIterator)new Short2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte k) {
/* 1285 */             return Short2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Short2ByteAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Short2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1357 */       if (!bottom && !top && Short2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Short2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Short2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2ByteMap.Entry>)new AbstractObjectSortedSet<Short2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Short2ByteMap.Entry>)new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Short2ByteMap.Entry>)new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2ByteMap.Entry> comparator() {
/* 1399 */               return Short2ByteAVLTreeMap.this.short2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1409 */               Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1410 */               return (f != null && Short2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1420 */               Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1421 */               if (f != null && Short2ByteAVLTreeMap.Submap.this.in(f.key)) Short2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Short2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Short2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Short2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ByteMap.Entry first() {
/* 1444 */               return Short2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ByteMap.Entry last() {
/* 1449 */               return Short2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) {
/* 1454 */               return Short2ByteAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) {
/* 1459 */               return Short2ByteAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2ByteEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) {
/* 1464 */               return Short2ByteAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2ByteEntrySet();
/*      */             }
/*      */           }; 
/* 1467 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2ByteSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1473 */         return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1478 */         return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1493 */               return (ByteIterator)new Short2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(byte k) {
/* 1498 */               return Short2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Short2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Short2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1518 */       return (in(k) && Short2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(short k) {
/* 1536 */       short kk = k; Short2ByteAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Short2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte put(short k, byte v) {
/* 1542 */       Short2ByteAVLTreeMap.this.modified = false;
...
/* 1544 */       byte oldValue = Short2ByteAVLTreeMap.this.put(k, v);
/* 1545 */       return Short2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte remove(short k) {
/* 1551 */       Short2ByteAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       byte oldValue = Short2ByteAVLTreeMap.this.remove(k);
/* 1554 */       return Short2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1575 */       return Short2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ByteSortedMap headMap(short to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Short2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ByteSortedMap tailMap(short from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Short2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ByteSortedMap subMap(short from, short to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Short2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Short2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Short2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Short2ByteAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Short2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Short2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Short2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2ByteAVLTreeMap.Entry e;
/* 1627 */       if (Short2ByteAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Short2ByteAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Short2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Short2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Short2ByteAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1645 */       Short2ByteAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1652 */       Short2ByteAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Short2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Short2ByteAVLTreeMap.Submap.this.bottom && Short2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Short2ByteAVLTreeMap.Submap.this.top && Short2ByteAVLTreeMap.this.compare(k, (this.prev = Short2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Short2ByteAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Short2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Short2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Short2ByteAVLTreeMap.this.compare(this.prev.key, Short2ByteAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Short2ByteAVLTreeMap.Submap.this.top && this.next != null && Short2ByteAVLTreeMap.this.compare(this.next.key, Short2ByteAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2ByteMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1783 */       c = (Short2ByteAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readShort(), s.readByte());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readShort(), s.readByte());
/* 1866 */       entry.right(new Entry(s.readShort(), s.readByte()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ByteAVLTreeMap.class
