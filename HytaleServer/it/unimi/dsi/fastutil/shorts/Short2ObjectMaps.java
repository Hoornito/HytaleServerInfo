...
/*  49 */     return (entries instanceof Short2ObjectMap.FastEntrySet) ? ((Short2ObjectMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  64 */     ObjectSet<Short2ObjectMap.Entry<V>> entries = map.short2ObjectEntrySet();
/*  65 */     if (entries instanceof Short2ObjectMap.FastEntrySet) { ((Short2ObjectMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  81 */     final ObjectSet<Short2ObjectMap.Entry<V>> entries = map.short2ObjectEntrySet();
/*  82 */     return (entries instanceof Short2ObjectMap.FastEntrySet) ? new ObjectIterable<Short2ObjectMap.Entry<V>>()
/*     */       {
/*     */         public ObjectIterator<Short2ObjectMap.Entry<V>> iterator() {
/*  85 */           return ((Short2ObjectMap.FastEntrySet<V>)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/*  95 */           ((Short2ObjectMap.FastEntrySet<V>)entries).fastForEach(consumer);
/*     */         }
/*  97 */       } : (ObjectIterable<Short2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 135 */       return (ObjectSet<Short2ObjectMap.Entry<V>>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 140 */       return ShortSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 155 */       return Short2ObjectMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 227 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(this.key, this.value)); 
...
/* 240 */       return (ObjectSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 245 */       if (this.keys == null) this.keys = ShortSets.singleton(this.key); 
...
/*     */   
/*     */   public static <V> Short2ObjectMap<V> singleton(Short key, V value) {
/* 307 */     return new Singleton<>(key.shortValue(), value);
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap<V>
/*     */     extends Short2ObjectFunctions.SynchronizedFunction<V> implements Short2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 345 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2ObjectEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, V>> entrySet() {
/* 359 */       return (ObjectSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 364 */       synchronized (this.sync) {
/* 365 */         if (this.keys == null) this.keys = ShortSets.synchronize(this.map.keySet(), this.sync); 
...
/*     */     extends Short2ObjectFunctions.UnmodifiableFunction<V> implements Short2ObjectMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 659 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2ObjectEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, V>> entrySet() {
/* 672 */       return (ObjectSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
/* 677 */       if (this.keys == null) this.keys = ShortSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectMaps.class
