...
/* 150 */     return (ObjectSet)short2DoubleEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = short2DoubleEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Short.valueOf(entry.getShortKey()), Double.valueOf(entry.getDoubleValue()));
...
/* 502 */     Double newValue = remappingFunction.apply(Short.valueOf(key), Double.valueOf(oldValue));
...
/* 534 */     Double newValue = remappingFunction.apply(Short.valueOf(key), contained ? Double.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleMap.class
