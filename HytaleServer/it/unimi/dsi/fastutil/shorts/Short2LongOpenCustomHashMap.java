...
/*  542 */     Long newValue = remappingFunction.apply(Short.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  555 */     int pos = find(k);
/*  556 */     Long newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  634 */       return Short2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  639 */       return Short2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Short2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  649 */       return Short2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  654 */       long oldValue = Short2LongOpenCustomHashMap.this.value[this.index];
/*  655 */       Short2LongOpenCustomHashMap.this.value[this.index] = v;
/*  656 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortLongPair right(long v) {
/*  661 */       Short2LongOpenCustomHashMap.this.value[this.index] = v;
/*  662 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  673 */       return Short.valueOf(Short2LongOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Long.valueOf(Short2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/*  703 */       return (Short2LongOpenCustomHashMap.this.strategy.equals(Short2LongOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue()) && Short2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Short2LongOpenCustomHashMap.this.strategy.hashCode(Short2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Short2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  713 */       return Short2LongOpenCustomHashMap.this.key[this.index] + "=>" + Short2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  724 */     int pos = Short2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Short2LongOpenCustomHashMap.this.size;
/*      */     
/*  734 */     boolean mustReturnNullKey = Short2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  753 */         return this.last = Short2LongOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       short[] key = Short2LongOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask;
/*  762 */           for (; !Short2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2LongOpenCustomHashMap.this.mask);
/*  763 */           return p;
/*      */         } 
...
/*  772 */         acceptOnIndex(action, this.last = Short2LongOpenCustomHashMap.this.n);
/*  773 */         this.c--;
/*      */       } 
/*  775 */       short[] key = Short2LongOpenCustomHashMap.this.key;
/*  776 */       while (this.c != 0) {
/*  777 */         if (--this.pos < 0) {
/*      */           
/*  779 */           this.last = Integer.MIN_VALUE;
/*  780 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  781 */           int p = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask;
/*  782 */           for (; !Short2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2LongOpenCustomHashMap.this.mask);
...
/*  802 */       short[] key = Short2LongOpenCustomHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  804 */         pos = (last = pos) + 1 & Short2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  806 */           if ((curr = key[pos]) == 0) {
/*  807 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  810 */           int slot = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Short2LongOpenCustomHashMap.this.mask;
/*  811 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  812 */             break;  pos = pos + 1 & Short2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  814 */         if (pos < last) {
...
/*      */         } 
/*  818 */         key[last] = curr;
/*  819 */         Short2LongOpenCustomHashMap.this.value[last] = Short2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  824 */       if (this.last == -1) throw new IllegalStateException(); 
/*  825 */       if (this.last == Short2LongOpenCustomHashMap.this.n)
/*  826 */       { Short2LongOpenCustomHashMap.this.containsNullKey = false; }
/*  827 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  830 */       { Short2LongOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  831 */         this.last = -1;
/*      */         return; }
/*      */       
/*  834 */       Short2LongOpenCustomHashMap.this.size--;
/*  835 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2LongMap.Entry>> implements ObjectIterator<Short2LongMap.Entry> { public Short2LongOpenCustomHashMap.MapEntry next() {
/*  851 */       return this.entry = new Short2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  857 */       action.accept(this.entry = new Short2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  889 */     int pos = 0;
/*      */     
/*  891 */     int max = Short2LongOpenCustomHashMap.this.n;
/*      */     
/*  893 */     int c = 0;
/*      */     
/*  895 */     boolean mustReturnNull = Short2LongOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  915 */         this.c++;
/*  916 */         acceptOnIndex(action, Short2LongOpenCustomHashMap.this.n);
/*  917 */         return true;
/*      */       } 
/*  919 */       short[] key = Short2LongOpenCustomHashMap.this.key;
...
/*  934 */         this.c++;
/*  935 */         acceptOnIndex(action, Short2LongOpenCustomHashMap.this.n);
/*      */       } 
/*  937 */       short[] key = Short2LongOpenCustomHashMap.this.key;
...
/*      */       {
/*  950 */         return (Short2LongOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  955 */       return Math.min((Short2LongOpenCustomHashMap.this.size - this.c), (long)(Short2LongOpenCustomHashMap.this.realSize() / Short2LongOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  983 */         n--;
/*      */       } 
/*  985 */       short[] key = Short2LongOpenCustomHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2LongMap.Entry> action, int index) {
/* 1013 */       action.accept(new Short2LongOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1025 */       return new Short2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2LongMap.Entry> fastIterator() {
/* 1030 */       return new Short2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2LongMap.Entry> spliterator() {
/* 1035 */       return new Short2LongOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       if (Short2LongOpenCustomHashMap.this.strategy.equals(k, (short)0)) return (Short2LongOpenCustomHashMap.this.containsNullKey && Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n] == v);
/*      */       
/* 1050 */       short[] key = Short2LongOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1053 */       if ((curr = key[pos = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1054 */       if (Short2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Short2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1057 */         if ((curr = key[pos = pos + 1 & Short2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1058 */         if (Short2LongOpenCustomHashMap.this.strategy.equals(k, curr)) return (Short2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1071 */       if (Short2LongOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
/* 1072 */         if (Short2LongOpenCustomHashMap.this.containsNullKey && Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n] == v) {
/* 1073 */           Short2LongOpenCustomHashMap.this.removeNullEntry();
/* 1074 */           return true;
/*      */         } 
/* 1076 */         return false;
/*      */       } 
/*      */       
/* 1079 */       short[] key = Short2LongOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1082 */       if ((curr = key[pos = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1083 */       if (Short2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1084 */         if (Short2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1085 */           Short2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1086 */           return true;
/*      */         } 
/* 1088 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1091 */         if ((curr = key[pos = pos + 1 & Short2LongOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1092 */         if (Short2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1093 */           Short2LongOpenCustomHashMap.this.value[pos] == v) {
/* 1094 */           Short2LongOpenCustomHashMap.this.removeEntry(pos);
/* 1095 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1103 */       return Short2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1108 */       Short2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
/* 1114 */       if (Short2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(new Short2LongOpenCustomHashMap.MapEntry(Short2LongOpenCustomHashMap.this.n)); 
/* 1115 */       for (int pos = Short2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2LongOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Short2LongOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2LongMap.Entry> consumer) {
/* 1121 */       Short2LongOpenCustomHashMap.MapEntry entry = new Short2LongOpenCustomHashMap.MapEntry();
/* 1122 */       if (Short2LongOpenCustomHashMap.this.containsNullKey) {
/* 1123 */         entry.index = Short2LongOpenCustomHashMap.this.n;
/* 1124 */         consumer.accept(entry);
/*      */       } 
/* 1126 */       for (int pos = Short2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2LongOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1157 */       action.accept(Short2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1162 */       return Short2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1183 */       action.accept(Short2LongOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1195 */       return new Short2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1200 */       return new Short2LongOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1206 */       if (Short2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n]); 
/* 1207 */       for (int pos = Short2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1208 */         short k = Short2LongOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1215 */       return Short2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1220 */       return Short2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1225 */       int oldSize = Short2LongOpenCustomHashMap.this.size;
/* 1226 */       Short2LongOpenCustomHashMap.this.remove(k);
/* 1227 */       return (Short2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1232 */       Short2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1260 */       action.accept(Short2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1265 */       return Short2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(LongConsumer action, int index) {
/* 1286 */       action.accept(Short2LongOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1300 */             return new Short2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public LongSpliterator spliterator() {
/* 1305 */             return new Short2LongOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1311 */             if (Short2LongOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n]); 
/* 1312 */             for (int pos = Short2LongOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2LongOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Short2LongOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1317 */             return Short2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1322 */             return Short2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1327 */             Short2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1425 */       c = (Short2LongOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongOpenCustomHashMap.class
