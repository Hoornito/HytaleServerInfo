...
/*  839 */       Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
/*  840 */       return (this.key == ((Short)e.getKey()).shortValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Short2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  950 */       if ((this.next = Short2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Short2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Short2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1077 */             Short2DoubleRBTreeMap.Entry f = Short2DoubleRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1089 */             Short2DoubleRBTreeMap.Entry f = Short2DoubleRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1091 */             Short2DoubleRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Short2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Short2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2DoubleMap.Entry first() {
/* 1107 */             return Short2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2DoubleMap.Entry last() {
/* 1112 */             return Short2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1117 */             return Short2DoubleRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1122 */             return Short2DoubleRBTreeMap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1127 */             return Short2DoubleRBTreeMap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Short2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1169 */       return new Short2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */             return (DoubleIterator)new Short2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(double k) {
/* 1227 */             return Short2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Short2DoubleRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Short2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1299 */       if (!bottom && !top && Short2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Short2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Short2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2DoubleMap.Entry> comparator() {
/* 1341 */               return Short2DoubleRBTreeMap.this.short2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1351 */               Short2DoubleRBTreeMap.Entry f = Short2DoubleRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1352 */               return (f != null && Short2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1362 */               Short2DoubleRBTreeMap.Entry f = Short2DoubleRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1363 */               if (f != null && Short2DoubleRBTreeMap.Submap.this.in(f.key)) Short2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Short2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Short2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Short2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2DoubleMap.Entry first() {
/* 1386 */               return Short2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2DoubleMap.Entry last() {
/* 1391 */               return Short2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1396 */               return Short2DoubleRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1401 */               return Short2DoubleRBTreeMap.Submap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1406 */               return Short2DoubleRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1415 */         return new Short2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1420 */         return new Short2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1435 */               return (DoubleIterator)new Short2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(double k) {
/* 1440 */               return Short2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Short2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Short2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1460 */       return (in(k) && Short2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(short k) {
/* 1478 */       short kk = k; Short2DoubleRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Short2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double put(short k, double v) {
/* 1484 */       Short2DoubleRBTreeMap.this.modified = false;
...
/* 1486 */       double oldValue = Short2DoubleRBTreeMap.this.put(k, v);
/* 1487 */       return Short2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double remove(short k) {
/* 1493 */       Short2DoubleRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       double oldValue = Short2DoubleRBTreeMap.this.remove(k);
/* 1496 */       return Short2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1517 */       return Short2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap headMap(short to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Short2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap tailMap(short from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Short2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2DoubleSortedMap subMap(short from, short to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Short2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Short2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1547 */       if (Short2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Short2DoubleRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Short2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Short2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Short2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2DoubleRBTreeMap.Entry e;
/* 1569 */       if (Short2DoubleRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Short2DoubleRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Short2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Short2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Short2DoubleRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1587 */       Short2DoubleRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1594 */       Short2DoubleRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Short2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Short2DoubleRBTreeMap.Submap.this.bottom && Short2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Short2DoubleRBTreeMap.Submap.this.top && Short2DoubleRBTreeMap.this.compare(k, (this.prev = Short2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Short2DoubleRBTreeMap.this.locateKey(k);
/* 1620 */             if (Short2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Short2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Short2DoubleRBTreeMap.this.compare(this.prev.key, Short2DoubleRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Short2DoubleRBTreeMap.Submap.this.top && this.next != null && Short2DoubleRBTreeMap.this.compare(this.next.key, Short2DoubleRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1725 */       c = (Short2DoubleRBTreeMap)super.clone();
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readShort(), s.readDouble());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readShort(), s.readDouble());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readShort(), s.readDouble()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleRBTreeMap.class
