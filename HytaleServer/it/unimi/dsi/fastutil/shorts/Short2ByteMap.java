...
/* 150 */     return (ObjectSet)short2ByteEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = short2ByteEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Short.valueOf(entry.getShortKey()), Byte.valueOf(entry.getByteValue()));
...
/* 502 */     Byte newValue = remappingFunction.apply(Short.valueOf(key), Byte.valueOf(oldValue));
...
/* 534 */     Byte newValue = remappingFunction.apply(Short.valueOf(key), contained ? Byte.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ByteMap.class
