...
/*  520 */     Float newValue = remappingFunction.apply(Short.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Float newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  581 */     Arrays.fill(this.key, (short)0);
/*      */   }
/*      */ 
/*      */   
/*      */   public int size() {
...
/*  612 */       return Short2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  617 */       return Short2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float getFloatValue() {
/*  622 */       return Short2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float rightFloat() {
/*  627 */       return Short2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float v) {
/*  632 */       float oldValue = Short2FloatOpenHashMap.this.value[this.index];
/*  633 */       Short2FloatOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortFloatPair right(float v) {
/*  639 */       Short2FloatOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  651 */       return Short.valueOf(Short2FloatOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Float.valueOf(Short2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
/*  681 */       return (Short2FloatOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return Short2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Short2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Short2FloatOpenHashMap.this.key[this.index] + "=>" + Short2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Short2FloatOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Short2FloatOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Short2FloatOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Short2FloatOpenHashMap.this.n;
/*      */       } 
/*  733 */       short[] key = Short2FloatOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Short2FloatOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Short2FloatOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       short[] key = Short2FloatOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Short2FloatOpenHashMap.this.mask);
...
/*  780 */       short[] key = Short2FloatOpenHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  782 */         pos = (last = pos) + 1 & Short2FloatOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == 0) {
/*  785 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(curr) & Short2FloatOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Short2FloatOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
/*  793 */           if (this.wrapped == null) this.wrapped = new ShortArrayList(2); 
/*  794 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Short2FloatOpenHashMap.this.value[last] = Short2FloatOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Short2FloatOpenHashMap.this.n)
/*  804 */       { Short2FloatOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Short2FloatOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Short2FloatOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2FloatMap.Entry>> implements ObjectIterator<Short2FloatMap.Entry> { public Short2FloatOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Short2FloatOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Short2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Short2FloatOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Short2FloatOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Short2FloatOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Short2FloatOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       short[] key = Short2FloatOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Short2FloatOpenHashMap.this.n);
/*      */       } 
/*  915 */       short[] key = Short2FloatOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Short2FloatOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Short2FloatOpenHashMap.this.size - this.c), (long)(Short2FloatOpenHashMap.this.realSize() / Short2FloatOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       short[] key = Short2FloatOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2FloatMap.Entry> action, int index) {
/*  991 */       action.accept(new Short2FloatOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Short2FloatOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2FloatMap.Entry> fastIterator() {
/* 1008 */       return new Short2FloatOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2FloatMap.Entry> spliterator() {
/* 1013 */       return new Short2FloatOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1022 */       if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1023 */       if (e.getValue() == null || !(e.getValue() instanceof Float)) return false; 
/* 1024 */       short k = ((Short)e.getKey()).shortValue();
/* 1025 */       float v = ((Float)e.getValue()).floatValue();
/* 1026 */       if (k == 0) return (Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       
/* 1028 */       short[] key = Short2FloatOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1032 */       if (k == curr) return (Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1036 */         if (k == curr) return (Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == 0) {
/* 1050 */         if (Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/* 1051 */           Short2FloatOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       short[] key = Short2FloatOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = HashCommon.mix(k) & Short2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1063 */           Short2FloatOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) == 0) return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/* 1072 */           Short2FloatOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Short2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Short2FloatOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
/* 1092 */       if (Short2FloatOpenHashMap.this.containsNullKey) consumer.accept(new Short2FloatOpenHashMap.MapEntry(Short2FloatOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Short2FloatOpenHashMap.this.n; pos-- != 0;) { if (Short2FloatOpenHashMap.this.key[pos] != 0) consumer.accept(new Short2FloatOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
/* 1099 */       Short2FloatOpenHashMap.MapEntry entry = new Short2FloatOpenHashMap.MapEntry();
/* 1100 */       if (Short2FloatOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Short2FloatOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Short2FloatOpenHashMap.this.n; pos-- != 0;) { if (Short2FloatOpenHashMap.this.key[pos] != 0) {
...
/* 1135 */       action.accept(Short2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1140 */       return Short2FloatOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1161 */       action.accept(Short2FloatOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Short2FloatOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1178 */       return new Short2FloatOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1184 */       if (Short2FloatOpenHashMap.this.containsNullKey) consumer.accept(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Short2FloatOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         short k = Short2FloatOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Short2FloatOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1198 */       return Short2FloatOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1203 */       int oldSize = Short2FloatOpenHashMap.this.size;
/* 1204 */       Short2FloatOpenHashMap.this.remove(k);
/* 1205 */       return (Short2FloatOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Short2FloatOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Short2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public float nextFloat() {
/* 1243 */       return Short2FloatOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(FloatConsumer action, int index) {
/* 1264 */       action.accept(Short2FloatOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Short2FloatOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public FloatSpliterator spliterator() {
/* 1283 */             return new Short2FloatOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(FloatConsumer consumer) {
/* 1289 */             if (Short2FloatOpenHashMap.this.containsNullKey) consumer.accept(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Short2FloatOpenHashMap.this.n; pos-- != 0;) { if (Short2FloatOpenHashMap.this.key[pos] != 0) consumer.accept(Short2FloatOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Short2FloatOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(float v) {
/* 1300 */             return Short2FloatOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Short2FloatOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1369 */     short[] key = this.key;
/* 1370 */     float[] value = this.value;
/* 1371 */     int mask = newN - 1;
/* 1372 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1403 */       c = (Short2FloatOpenHashMap)super.clone();
...
/* 1411 */     c.key = (short[])this.key.clone();
...
/* 1457 */     short[] key = this.key = new short[this.n + 1];
/* 1458 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1461 */     for (int i = this.size; i-- != 0; ) {
/* 1462 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatOpenHashMap.class
