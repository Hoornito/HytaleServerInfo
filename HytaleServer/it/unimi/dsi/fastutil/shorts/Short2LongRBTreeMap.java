...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(Comparator<? super Short> c) {
/*  100 */     this();
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(Map<? extends Short, ? extends Long> m) {
/*  111 */     this();
/*  112 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(SortedMap<Short, Long> m) {
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(Short2LongMap m) {
/*  131 */     this();
/*  132 */     putAll(m);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(Short2LongSortedMap m) {
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(short[] k, long[] v, Comparator<? super Short> c) {
/*  154 */     this(c);
...
/*      */ 
/*      */   
/*      */   public Short2LongRBTreeMap(short[] k, long[] v) {
/*  167 */     this(k, v, (Comparator<? super Short>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  193 */     return (this.actualComparator == null) ? Short.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  839 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/*  840 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  845 */       return this.key ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     TreeIterator() {
/*  946 */       this.next = Short2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  950 */       if ((this.next = Short2LongRBTreeMap.this.locateKey(k)) != null)
/*  951 */         if (Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1004 */       updatePrevious();
/* 1005 */       updateNext();
/* 1006 */       Short2LongRBTreeMap.this.remove(this.curr.key);
/* 1007 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1051 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */         {
...
/* 1061 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1066 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1075 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1076 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1077 */             Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1087 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1088 */             if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1089 */             Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1090 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue()) return false; 
/* 1091 */             Short2LongRBTreeMap.this.remove(f.key);
/* 1092 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1097 */             return Short2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1102 */             Short2LongRBTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2LongMap.Entry first() {
/* 1107 */             return Short2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2LongMap.Entry last() {
/* 1112 */             return Short2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1117 */             return Short2LongRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1122 */             return Short2LongRBTreeMap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1127 */             return Short2LongRBTreeMap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1164 */       return new Short2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1169 */       return new Short2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1219 */     if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1222 */             return (LongIterator)new Short2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long k) {
/* 1227 */             return Short2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1232 */             return Short2LongRBTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1237 */             Short2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1250 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Short2LongSortedMap tailMap(short from) {
/* 1255 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1299 */       if (!bottom && !top && Short2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1300 */       this.from = from;
/* 1301 */       this.bottom = bottom;
/* 1302 */       this.to = to;
/* 1303 */       this.top = top;
/* 1304 */       this.defRetValue = Short2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1323 */       return ((this.bottom || Short2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2LongRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 1328 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
/* 1331 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1336 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2LongMap.Entry> comparator() {
/* 1341 */               return Short2LongRBTreeMap.this.short2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1349 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1350 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1351 */               Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1352 */               return (f != null && Short2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1360 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1361 */               if (e.getValue() == null || !(e.getValue() instanceof Long)) return false; 
/* 1362 */               Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1363 */               if (f != null && Short2LongRBTreeMap.Submap.this.in(f.key)) Short2LongRBTreeMap.Submap.this.remove(f.key); 
/* 1364 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1369 */               int c = 0;
/* 1370 */               for (ObjectBidirectionalIterator<Short2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1371 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1376 */               return !(new Short2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1381 */               Short2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2LongMap.Entry first() {
/* 1386 */               return Short2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2LongMap.Entry last() {
/* 1391 */               return Short2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1396 */               return Short2LongRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1401 */               return Short2LongRBTreeMap.Submap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1406 */               return Short2LongRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */           }; 
/* 1409 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractShort2LongSortedMap.KeySet { private KeySet() {}
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1415 */         return new Short2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1420 */         return new Short2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public LongCollection values() {
/* 1432 */       if (this.values == null) this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1435 */               return (LongIterator)new Short2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(long k) {
/* 1440 */               return Short2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1445 */               return Short2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1450 */               Short2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1460 */       return (in(k) && Short2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1468 */         long ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public long get(short k) {
/* 1478 */       short kk = k; Short2LongRBTreeMap.Entry e;
/* 1479 */       return (in(kk) && (e = Short2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long put(short k, long v) {
/* 1484 */       Short2LongRBTreeMap.this.modified = false;
...
/* 1486 */       long oldValue = Short2LongRBTreeMap.this.put(k, v);
/* 1487 */       return Short2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long remove(short k) {
/* 1493 */       Short2LongRBTreeMap.this.modified = false;
/* 1494 */       if (!in(k)) return this.defRetValue; 
/* 1495 */       long oldValue = Short2LongRBTreeMap.this.remove(k);
/* 1496 */       return Short2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1517 */       return Short2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongSortedMap headMap(short to) {
/* 1522 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1523 */       return (Short2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongSortedMap tailMap(short from) {
/* 1528 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1529 */       return (Short2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongSortedMap subMap(short from, short to) {
/* 1534 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1535 */       if (!this.top) to = (Short2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom) from = (Short2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/*      */       Short2LongRBTreeMap.Entry e;
/* 1547 */       if (Short2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1551 */       if (this.bottom) { e = Short2LongRBTreeMap.this.firstEntry; }
/*      */       else
/* 1553 */       { e = Short2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1555 */         if (Short2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1559 */       if (e == null || (!this.top && Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1560 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2LongRBTreeMap.Entry e;
/* 1569 */       if (Short2LongRBTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1573 */       if (this.top) { e = Short2LongRBTreeMap.this.lastEntry; }
/*      */       else
/* 1575 */       { e = Short2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1577 */         if (Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1581 */       if (e == null || (!this.bottom && Short2LongRBTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1582 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1587 */       Short2LongRBTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1594 */       Short2LongRBTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1610 */         this.next = Short2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1614 */         this();
/* 1615 */         if (this.next != null) {
/* 1616 */           if (!Short2LongRBTreeMap.Submap.this.bottom && Short2LongRBTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1617 */           else if (!Short2LongRBTreeMap.Submap.this.top && Short2LongRBTreeMap.this.compare(k, (this.prev = Short2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1619 */           { this.next = Short2LongRBTreeMap.this.locateKey(k);
/* 1620 */             if (Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1631 */         if (!Short2LongRBTreeMap.Submap.this.bottom && this.prev != null && Short2LongRBTreeMap.this.compare(this.prev.key, Short2LongRBTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1636 */         this.next = this.next.next();
/* 1637 */         if (!Short2LongRBTreeMap.Submap.this.top && this.next != null && Short2LongRBTreeMap.this.compare(this.next.key, Short2LongRBTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
/*      */     private class SubmapEntryIterator
/*      */       extends SubmapIterator implements ObjectListIterator<Short2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     Short2LongRBTreeMap c;
/*      */     try {
/* 1725 */       c = (Short2LongRBTreeMap)super.clone();
...
/* 1783 */       s.writeShort(e.key);
/* 1784 */       s.writeLong(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1798 */     if (n == 1) {
/* 1799 */       Entry entry = new Entry(s.readShort(), s.readLong());
...
/*      */ 
/*      */       
/* 1808 */       Entry entry = new Entry(s.readShort(), s.readLong());
/* 1809 */       entry.black(true);
/* 1810 */       entry.right(new Entry(s.readShort(), s.readLong()));
...
/* 1820 */     top.key = s.readShort();
/* 1821 */     top.value = s.readLong();
/* 1822 */     top.black(true);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongRBTreeMap.class
