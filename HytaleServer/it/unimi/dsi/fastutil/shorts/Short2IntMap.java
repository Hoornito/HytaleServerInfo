...
/* 150 */     return (ObjectSet)short2IntEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     ObjectSet<Entry> entrySet = short2IntEntrySet();
/* 261 */     Consumer<Entry> wrappingConsumer = entry -> consumer.accept(Short.valueOf(entry.getShortKey()), Integer.valueOf(entry.getIntValue()));
...
/* 502 */     Integer newValue = remappingFunction.apply(Short.valueOf(key), Integer.valueOf(oldValue));
...
/* 534 */     Integer newValue = remappingFunction.apply(Short.valueOf(key), contained ? Integer.valueOf(oldValue) : null);
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntMap.class
