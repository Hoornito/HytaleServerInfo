...
/*  61 */     return (entries instanceof Short2DoubleSortedMap.FastSortedEntrySet) ? ((Short2DoubleSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Short2DoubleMap.Entry> entries = map.short2DoubleEntrySet();
/*  77 */     Objects.requireNonNull((Short2DoubleSortedMap.FastSortedEntrySet)entries); return (entries instanceof Short2DoubleSortedMap.FastSortedEntrySet) ? (Short2DoubleSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Short2DoubleMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Short2DoubleMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 110 */       return (ObjectSortedSet<Map.Entry<Short, Double>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 120 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2DoubleSortedMap headMap(short to) {
/* 125 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2DoubleSortedMap tailMap(short from) {
/* 130 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 235 */       if (this.entries == null) this.entries = (ObjectSet<Short2DoubleMap.Entry>)ObjectSortedSets.singleton(new AbstractShort2DoubleMap.BasicEntry(this.key, this.value), Short2DoubleSortedMaps.entryComparator(this.comparator)); 
/* 236 */       return (ObjectSortedSet<Short2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Double>> entrySet() {
/* 248 */       return (ObjectSortedSet)short2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 260 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2DoubleSortedMap headMap(short to) {
/* 265 */       if (compare(this.key, to) < 0) return this; 
/* 266 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2DoubleSortedMap tailMap(short from) {
/* 271 */       if (compare(from, this.key) <= 0) return this; 
/* 272 */       return Short2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public short firstShortKey() {
...
/* 369 */     return new Singleton(key.shortValue(), value.doubleValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     extends Short2DoubleMaps.SynchronizedMap implements Short2DoubleSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 427 */       if (this.entries == null) this.entries = (ObjectSet<Short2DoubleMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.short2DoubleEntrySet(), this.sync); 
/* 428 */       return (ObjectSortedSet<Short2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Double>> entrySet() {
/* 440 */       return (ObjectSortedSet)short2DoubleEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/*     */     extends Short2DoubleMaps.UnmodifiableMap implements Short2DoubleSortedMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2DoubleSortedMap sortedMap;
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 580 */       if (this.entries == null) this.entries = (ObjectSet<Short2DoubleMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.short2DoubleEntrySet()); 
/* 581 */       return (ObjectSortedSet<Short2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleSortedMaps.class
