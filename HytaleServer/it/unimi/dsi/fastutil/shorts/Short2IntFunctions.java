...
/*     */     
/*     */     public Object clone() {
/*  78 */       return Short2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
...
/*  98 */       return Short2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 179 */     return new Singleton(key.shortValue(), value.intValue());
/*     */   }
/*     */   
...
/*     */     extends AbstractShort2IntFunction implements Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2IntFunction function;
/*     */     
...
/* 550 */       Integer v = this.function.apply(Short.valueOf(key));
...
/* 557 */       Integer v = this.function.apply(Short.valueOf(key));
...
/* 603 */     if (f instanceof Short2IntFunction) return (Short2IntFunction)f; 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntFunctions.class
