...
/*  89 */     this(refArray, refArray.length, (ShortComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */     short first = this.refArray[this.array[firstIndex]];
...
/* 170 */     int i = this.size;
/* 171 */     int lastIndex = --i;
/* 172 */     short last = this.refArray[this.array[lastIndex]];
/* 173 */     if (this.c == null)
...
/* 287 */     short top = this.refArray[this.array[findFirst()]];
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\ShortArrayIndirectPriorityQueue.class
