...
/*  61 */     return (entries instanceof Short2ObjectSortedMap.FastSortedEntrySet) ? ((Short2ObjectSortedMap.FastSortedEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  76 */     ObjectSortedSet<Short2ObjectMap.Entry<V>> entries = map.short2ObjectEntrySet();
/*  77 */     Objects.requireNonNull((Short2ObjectSortedMap.FastSortedEntrySet)entries); return (entries instanceof Short2ObjectSortedMap.FastSortedEntrySet) ? (Short2ObjectSortedMap.FastSortedEntrySet)entries::fastIterator : (ObjectBidirectionalIterable<Short2ObjectMap.Entry<V>>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 121 */       return Short2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 133 */       return Short2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 251 */       if (this.entries == null) this.entries = (ObjectSet<Short2ObjectMap.Entry<V>>)ObjectSortedSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(this.key, this.value), Short2ObjectSortedMaps.entryComparator(this.comparator)); 
/* 252 */       return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, V>> entrySet() {
/* 264 */       return (ObjectSortedSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 277 */       return Short2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 284 */       return Short2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 291 */       return Short2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public short firstShortKey() {
...
/*     */     extends Short2ObjectMaps.SynchronizedMap<V> implements Short2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 446 */       if (this.entries == null) this.entries = (ObjectSet<Short2ObjectMap.Entry<V>>)ObjectSortedSets.synchronize(this.sortedMap.short2ObjectEntrySet(), this.sync); 
/* 447 */       return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, V>> entrySet() {
/* 459 */       return (ObjectSortedSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/*     */     extends Short2ObjectMaps.UnmodifiableMap<V> implements Short2ObjectSortedMap<V>, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     
/*     */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 599 */       if (this.entries == null) this.entries = (ObjectSet<Short2ObjectMap.Entry<V>>)ObjectSortedSets.unmodifiable(this.sortedMap.short2ObjectEntrySet()); 
/* 600 */       return (ObjectSortedSet<Short2ObjectMap.Entry<V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, V>> entrySet() {
/* 612 */       return (ObjectSortedSet)short2ObjectEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectSortedMaps.class
