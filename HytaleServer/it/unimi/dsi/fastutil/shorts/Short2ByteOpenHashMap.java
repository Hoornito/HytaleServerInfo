...
/*  520 */     Byte newValue = remappingFunction.apply(Short.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  533 */     int pos = find(k);
/*  534 */     Byte newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  612 */       return Short2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  617 */       return Short2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte getByteValue() {
/*  622 */       return Short2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte rightByte() {
/*  627 */       return Short2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public byte setValue(byte v) {
/*  632 */       byte oldValue = Short2ByteOpenHashMap.this.value[this.index];
/*  633 */       Short2ByteOpenHashMap.this.value[this.index] = v;
/*  634 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBytePair right(byte v) {
/*  639 */       Short2ByteOpenHashMap.this.value[this.index] = v;
/*  640 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  651 */       return Short.valueOf(Short2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */       return Byte.valueOf(Short2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */       Map.Entry<Short, Byte> e = (Map.Entry<Short, Byte>)o;
/*  681 */       return (Short2ByteOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  686 */       return Short2ByteOpenHashMap.this.key[this.index] ^ Short2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  691 */       return Short2ByteOpenHashMap.this.key[this.index] + "=>" + Short2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  702 */     int pos = Short2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  708 */     int last = -1;
/*      */     
/*  710 */     int c = Short2ByteOpenHashMap.this.size;
/*      */     
/*  712 */     boolean mustReturnNullKey = Short2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  731 */         return this.last = Short2ByteOpenHashMap.this.n;
/*      */       } 
/*  733 */       short[] key = Short2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  735 */         if (--this.pos < 0) {
/*      */           
/*  737 */           this.last = Integer.MIN_VALUE;
/*  738 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  739 */           int p = HashCommon.mix(k) & Short2ByteOpenHashMap.this.mask;
/*  740 */           for (; k != key[p]; p = p + 1 & Short2ByteOpenHashMap.this.mask);
/*  741 */           return p;
/*      */         } 
...
/*  750 */         acceptOnIndex(action, this.last = Short2ByteOpenHashMap.this.n);
/*  751 */         this.c--;
/*      */       } 
/*  753 */       short[] key = Short2ByteOpenHashMap.this.key;
/*  754 */       while (this.c != 0) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(k) & Short2ByteOpenHashMap.this.mask;
/*  760 */           for (; k != key[p]; p = p + 1 & Short2ByteOpenHashMap.this.mask);
...
/*  780 */       short[] key = Short2ByteOpenHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  782 */         pos = (last = pos) + 1 & Short2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  784 */           if ((curr = key[pos]) == 0) {
/*  785 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  788 */           int slot = HashCommon.mix(curr) & Short2ByteOpenHashMap.this.mask;
/*  789 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  790 */             break;  pos = pos + 1 & Short2ByteOpenHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Short2ByteOpenHashMap.this.value[last] = Short2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  802 */       if (this.last == -1) throw new IllegalStateException(); 
/*  803 */       if (this.last == Short2ByteOpenHashMap.this.n)
/*  804 */       { Short2ByteOpenHashMap.this.containsNullKey = false; }
/*  805 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  808 */       { Short2ByteOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  809 */         this.last = -1;
/*      */         return; }
/*      */       
/*  812 */       Short2ByteOpenHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2ByteMap.Entry>> implements ObjectIterator<Short2ByteMap.Entry> { public Short2ByteOpenHashMap.MapEntry next() {
/*  829 */       return this.entry = new Short2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  835 */       action.accept(this.entry = new Short2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  846 */       this.entry = new Short2ByteOpenHashMap.MapEntry();
/*      */     }
...
/*  867 */     int pos = 0;
/*      */     
/*  869 */     int max = Short2ByteOpenHashMap.this.n;
/*      */     
/*  871 */     int c = 0;
/*      */     
/*  873 */     boolean mustReturnNull = Short2ByteOpenHashMap.this.containsNullKey;
/*      */     
...
/*  893 */         this.c++;
/*  894 */         acceptOnIndex(action, Short2ByteOpenHashMap.this.n);
/*  895 */         return true;
/*      */       } 
/*  897 */       short[] key = Short2ByteOpenHashMap.this.key;
...
/*  912 */         this.c++;
/*  913 */         acceptOnIndex(action, Short2ByteOpenHashMap.this.n);
/*      */       } 
/*  915 */       short[] key = Short2ByteOpenHashMap.this.key;
...
/*      */       {
/*  928 */         return (Short2ByteOpenHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  933 */       return Math.min((Short2ByteOpenHashMap.this.size - this.c), (long)(Short2ByteOpenHashMap.this.realSize() / Short2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  961 */         n--;
/*      */       } 
/*  963 */       short[] key = Short2ByteOpenHashMap.this.key;
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2ByteMap.Entry> action, int index) {
/*  991 */       action.accept(new Short2ByteOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1003 */       return new Short2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2ByteMap.Entry> fastIterator() {
/* 1008 */       return new Short2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2ByteMap.Entry> spliterator() {
/* 1013 */       return new Short2ByteOpenHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       if (k == 0) return (Short2ByteOpenHashMap.this.containsNullKey && Short2ByteOpenHashMap.this.value[Short2ByteOpenHashMap.this.n] == v);
/*      */       
/* 1028 */       short[] key = Short2ByteOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1031 */       if ((curr = key[pos = HashCommon.mix(k) & Short2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1032 */       if (k == curr) return (Short2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1035 */         if ((curr = key[pos = pos + 1 & Short2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1036 */         if (k == curr) return (Short2ByteOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1049 */       if (k == 0) {
/* 1050 */         if (Short2ByteOpenHashMap.this.containsNullKey && Short2ByteOpenHashMap.this.value[Short2ByteOpenHashMap.this.n] == v) {
/* 1051 */           Short2ByteOpenHashMap.this.removeNullEntry();
/* 1052 */           return true;
/*      */         } 
/* 1054 */         return false;
/*      */       } 
/*      */       
/* 1057 */       short[] key = Short2ByteOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1060 */       if ((curr = key[pos = HashCommon.mix(k) & Short2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1061 */       if (curr == k) {
/* 1062 */         if (Short2ByteOpenHashMap.this.value[pos] == v) {
/* 1063 */           Short2ByteOpenHashMap.this.removeEntry(pos);
/* 1064 */           return true;
/*      */         } 
/* 1066 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1069 */         if ((curr = key[pos = pos + 1 & Short2ByteOpenHashMap.this.mask]) == 0) return false; 
/* 1070 */         if (curr == k && 
/* 1071 */           Short2ByteOpenHashMap.this.value[pos] == v) {
/* 1072 */           Short2ByteOpenHashMap.this.removeEntry(pos);
/* 1073 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1081 */       return Short2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1086 */       Short2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2ByteMap.Entry> consumer) {
/* 1092 */       if (Short2ByteOpenHashMap.this.containsNullKey) consumer.accept(new Short2ByteOpenHashMap.MapEntry(Short2ByteOpenHashMap.this.n)); 
/* 1093 */       for (int pos = Short2ByteOpenHashMap.this.n; pos-- != 0;) { if (Short2ByteOpenHashMap.this.key[pos] != 0) consumer.accept(new Short2ByteOpenHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2ByteMap.Entry> consumer) {
/* 1099 */       Short2ByteOpenHashMap.MapEntry entry = new Short2ByteOpenHashMap.MapEntry();
/* 1100 */       if (Short2ByteOpenHashMap.this.containsNullKey) {
/* 1101 */         entry.index = Short2ByteOpenHashMap.this.n;
/* 1102 */         consumer.accept(entry);
/*      */       } 
/* 1104 */       for (int pos = Short2ByteOpenHashMap.this.n; pos-- != 0;) { if (Short2ByteOpenHashMap.this.key[pos] != 0) {
...
/* 1135 */       action.accept(Short2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1140 */       return Short2ByteOpenHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1161 */       action.accept(Short2ByteOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1173 */       return new Short2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1178 */       return new Short2ByteOpenHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1184 */       if (Short2ByteOpenHashMap.this.containsNullKey) consumer.accept(Short2ByteOpenHashMap.this.key[Short2ByteOpenHashMap.this.n]); 
/* 1185 */       for (int pos = Short2ByteOpenHashMap.this.n; pos-- != 0; ) {
/* 1186 */         short k = Short2ByteOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1193 */       return Short2ByteOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1198 */       return Short2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1203 */       int oldSize = Short2ByteOpenHashMap.this.size;
/* 1204 */       Short2ByteOpenHashMap.this.remove(k);
/* 1205 */       return (Short2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1210 */       Short2ByteOpenHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1238 */       action.accept(Short2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public byte nextByte() {
/* 1243 */       return Short2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ByteConsumer action, int index) {
/* 1264 */       action.accept(Short2ByteOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1278 */             return new Short2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ByteSpliterator spliterator() {
/* 1283 */             return new Short2ByteOpenHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(ByteConsumer consumer) {
/* 1289 */             if (Short2ByteOpenHashMap.this.containsNullKey) consumer.accept(Short2ByteOpenHashMap.this.value[Short2ByteOpenHashMap.this.n]); 
/* 1290 */             for (int pos = Short2ByteOpenHashMap.this.n; pos-- != 0;) { if (Short2ByteOpenHashMap.this.key[pos] != 0) consumer.accept(Short2ByteOpenHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1295 */             return Short2ByteOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(byte v) {
/* 1300 */             return Short2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1305 */             Short2ByteOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1403 */       c = (Short2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ByteOpenHashMap.class
