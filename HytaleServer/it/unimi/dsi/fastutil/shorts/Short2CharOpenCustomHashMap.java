...
/*  543 */     Character newValue = remappingFunction.apply(Short.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  556 */     int pos = find(k);
/*  557 */     Character newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Character.valueOf(this.value[pos]) : null);
...
/*  635 */       return Short2CharOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  640 */       return Short2CharOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char getCharValue() {
/*  645 */       return Short2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char rightChar() {
/*  650 */       return Short2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char v) {
/*  655 */       char oldValue = Short2CharOpenCustomHashMap.this.value[this.index];
/*  656 */       Short2CharOpenCustomHashMap.this.value[this.index] = v;
/*  657 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortCharPair right(char v) {
/*  662 */       Short2CharOpenCustomHashMap.this.value[this.index] = v;
/*  663 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  674 */       return Short.valueOf(Short2CharOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  685 */       return Character.valueOf(Short2CharOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  703 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  704 */       return (Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue()) && Short2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Short2CharOpenCustomHashMap.this.strategy.hashCode(Short2CharOpenCustomHashMap.this.key[this.index]) ^ Short2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/*  714 */       return Short2CharOpenCustomHashMap.this.key[this.index] + "=>" + Short2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Short2CharOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */     int last = -1;
/*      */     
/*  733 */     int c = Short2CharOpenCustomHashMap.this.size;
/*      */     
/*  735 */     boolean mustReturnNullKey = Short2CharOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  754 */         return this.last = Short2CharOpenCustomHashMap.this.n;
/*      */       } 
/*  756 */       short[] key = Short2CharOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  758 */         if (--this.pos < 0) {
/*      */           
/*  760 */           this.last = Integer.MIN_VALUE;
/*  761 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  762 */           int p = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
/*  763 */           for (; !Short2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2CharOpenCustomHashMap.this.mask);
/*  764 */           return p;
/*      */         } 
...
/*  773 */         acceptOnIndex(action, this.last = Short2CharOpenCustomHashMap.this.n);
/*  774 */         this.c--;
/*      */       } 
/*  776 */       short[] key = Short2CharOpenCustomHashMap.this.key;
/*  777 */       while (this.c != 0) {
/*  778 */         if (--this.pos < 0) {
/*      */           
/*  780 */           this.last = Integer.MIN_VALUE;
/*  781 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  782 */           int p = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
/*  783 */           for (; !Short2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = p + 1 & Short2CharOpenCustomHashMap.this.mask);
...
/*  803 */       short[] key = Short2CharOpenCustomHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  805 */         pos = (last = pos) + 1 & Short2CharOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  807 */           if ((curr = key[pos]) == 0) {
/*  808 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  811 */           int slot = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Short2CharOpenCustomHashMap.this.mask;
/*  812 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*  813 */             break;  pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask;
/*      */         } 
/*  815 */         if (pos < last) {
...
/*      */         } 
/*  819 */         key[last] = curr;
/*  820 */         Short2CharOpenCustomHashMap.this.value[last] = Short2CharOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     
/*      */     public void remove() {
/*  825 */       if (this.last == -1) throw new IllegalStateException(); 
/*  826 */       if (this.last == Short2CharOpenCustomHashMap.this.n)
/*  827 */       { Short2CharOpenCustomHashMap.this.containsNullKey = false; }
/*  828 */       else if (this.pos >= 0) { shiftKeys(this.last); }
/*      */       else
/*      */       
/*  831 */       { Short2CharOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  832 */         this.last = -1;
/*      */         return; }
/*      */       
/*  835 */       Short2CharOpenCustomHashMap.this.size--;
/*  836 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2CharMap.Entry>> implements ObjectIterator<Short2CharMap.Entry> { public Short2CharOpenCustomHashMap.MapEntry next() {
/*  852 */       return this.entry = new Short2CharOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  858 */       action.accept(this.entry = new Short2CharOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*  869 */       this.entry = new Short2CharOpenCustomHashMap.MapEntry();
/*      */     }
...
/*  890 */     int pos = 0;
/*      */     
/*  892 */     int max = Short2CharOpenCustomHashMap.this.n;
/*      */     
/*  894 */     int c = 0;
/*      */     
/*  896 */     boolean mustReturnNull = Short2CharOpenCustomHashMap.this.containsNullKey;
/*      */     
...
/*  916 */         this.c++;
/*  917 */         acceptOnIndex(action, Short2CharOpenCustomHashMap.this.n);
/*  918 */         return true;
/*      */       } 
/*  920 */       short[] key = Short2CharOpenCustomHashMap.this.key;
...
/*  935 */         this.c++;
/*  936 */         acceptOnIndex(action, Short2CharOpenCustomHashMap.this.n);
/*      */       } 
/*  938 */       short[] key = Short2CharOpenCustomHashMap.this.key;
...
/*      */       {
/*  951 */         return (Short2CharOpenCustomHashMap.this.size - this.c);
/*      */       }
/*      */ 
/*      */ 
/*      */       
/*  956 */       return Math.min((Short2CharOpenCustomHashMap.this.size - this.c), (long)(Short2CharOpenCustomHashMap.this.realSize() / Short2CharOpenCustomHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1L : 0L));
/*      */     }
/*      */ 
/*      */     
...
/*  984 */         n--;
/*      */       } 
/*  986 */       short[] key = Short2CharOpenCustomHashMap.this.key;
...
/*      */     extends MapSpliterator<Consumer<? super Short2CharMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2CharMap.Entry> {
...
/*      */     
/*      */     final void acceptOnIndex(Consumer<? super Short2CharMap.Entry> action, int index) {
/* 1014 */       action.accept(new Short2CharOpenCustomHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
...
/* 1026 */       return new Short2CharOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectIterator<Short2CharMap.Entry> fastIterator() {
/* 1031 */       return new Short2CharOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSpliterator<Short2CharMap.Entry> spliterator() {
/* 1036 */       return new Short2CharOpenCustomHashMap.EntrySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       if (Short2CharOpenCustomHashMap.this.strategy.equals(k, (short)0)) return (Short2CharOpenCustomHashMap.this.containsNullKey && Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n] == v);
/*      */       
/* 1051 */       short[] key = Short2CharOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1054 */       if ((curr = key[pos = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1055 */       if (Short2CharOpenCustomHashMap.this.strategy.equals(k, curr)) return (Short2CharOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1058 */         if ((curr = key[pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1059 */         if (Short2CharOpenCustomHashMap.this.strategy.equals(k, curr)) return (Short2CharOpenCustomHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1072 */       if (Short2CharOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
/* 1073 */         if (Short2CharOpenCustomHashMap.this.containsNullKey && Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n] == v) {
/* 1074 */           Short2CharOpenCustomHashMap.this.removeNullEntry();
/* 1075 */           return true;
/*      */         } 
/* 1077 */         return false;
/*      */       } 
/*      */       
/* 1080 */       short[] key = Short2CharOpenCustomHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1083 */       if ((curr = key[pos = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1084 */       if (Short2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1085 */         if (Short2CharOpenCustomHashMap.this.value[pos] == v) {
/* 1086 */           Short2CharOpenCustomHashMap.this.removeEntry(pos);
/* 1087 */           return true;
/*      */         } 
/* 1089 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1092 */         if ((curr = key[pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask]) == 0) return false; 
/* 1093 */         if (Short2CharOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1094 */           Short2CharOpenCustomHashMap.this.value[pos] == v) {
/* 1095 */           Short2CharOpenCustomHashMap.this.removeEntry(pos);
/* 1096 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1104 */       return Short2CharOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1109 */       Short2CharOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
/* 1115 */       if (Short2CharOpenCustomHashMap.this.containsNullKey) consumer.accept(new Short2CharOpenCustomHashMap.MapEntry(Short2CharOpenCustomHashMap.this.n)); 
/* 1116 */       for (int pos = Short2CharOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2CharOpenCustomHashMap.this.key[pos] != 0) consumer.accept(new Short2CharOpenCustomHashMap.MapEntry(pos));
/*      */          }
/*      */     
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
/* 1122 */       Short2CharOpenCustomHashMap.MapEntry entry = new Short2CharOpenCustomHashMap.MapEntry();
/* 1123 */       if (Short2CharOpenCustomHashMap.this.containsNullKey) {
/* 1124 */         entry.index = Short2CharOpenCustomHashMap.this.n;
/* 1125 */         consumer.accept(entry);
/*      */       } 
/* 1127 */       for (int pos = Short2CharOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2CharOpenCustomHashMap.this.key[pos] != 0) {
...
/* 1158 */       action.accept(Short2CharOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1163 */       return Short2CharOpenCustomHashMap.this.key[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(ShortConsumer action, int index) {
/* 1184 */       action.accept(Short2CharOpenCustomHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1196 */       return new Short2CharOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/* 1201 */       return new Short2CharOpenCustomHashMap.KeySpliterator();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1207 */       if (Short2CharOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n]); 
/* 1208 */       for (int pos = Short2CharOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1209 */         short k = Short2CharOpenCustomHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1216 */       return Short2CharOpenCustomHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1221 */       return Short2CharOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1226 */       int oldSize = Short2CharOpenCustomHashMap.this.size;
/* 1227 */       Short2CharOpenCustomHashMap.this.remove(k);
/* 1228 */       return (Short2CharOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1233 */       Short2CharOpenCustomHashMap.this.clear();
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1261 */       action.accept(Short2CharOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public char nextChar() {
/* 1266 */       return Short2CharOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     final void acceptOnIndex(CharConsumer action, int index) {
/* 1287 */       action.accept(Short2CharOpenCustomHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
...
/* 1301 */             return new Short2CharOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public CharSpliterator spliterator() {
/* 1306 */             return new Short2CharOpenCustomHashMap.ValueSpliterator();
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(CharConsumer consumer) {
/* 1312 */             if (Short2CharOpenCustomHashMap.this.containsNullKey) consumer.accept(Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n]); 
/* 1313 */             for (int pos = Short2CharOpenCustomHashMap.this.n; pos-- != 0;) { if (Short2CharOpenCustomHashMap.this.key[pos] != 0) consumer.accept(Short2CharOpenCustomHashMap.this.value[pos]);  }
/*      */           
/*      */           }
/*      */           
/*      */           public int size() {
/* 1318 */             return Short2CharOpenCustomHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char v) {
/* 1323 */             return Short2CharOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1328 */             Short2CharOpenCustomHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1426 */       c = (Short2CharOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharOpenCustomHashMap.class
