...
/*  50 */     return (entries instanceof Short2FloatMap.FastEntrySet) ? ((Short2FloatMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Short2FloatMap.Entry> entries = map.short2FloatEntrySet();
/*  66 */     if (entries instanceof Short2FloatMap.FastEntrySet) { ((Short2FloatMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Short2FloatMap.Entry> entries = map.short2FloatEntrySet();
/*  83 */     return (entries instanceof Short2FloatMap.FastEntrySet) ? new ObjectIterable<Short2FloatMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Short2FloatMap.Entry> iterator() {
/*  86 */           return ((Short2FloatMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Short2FloatMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/*     */     public void forEach(BiConsumer<? super Short, ? super Float> consumer) {}
/*     */ 
/*     */     
/*     */     public Object clone() {
/* 166 */       return Short2FloatMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractShort2FloatMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)short2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */   
/*     */   public static Short2FloatMap singleton(Short key, Float value) {
/* 316 */     return new Singleton(key.shortValue(), value.floatValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Short2FloatFunctions.SynchronizedFunction implements Short2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2FloatEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Float>> entrySet() {
/* 381 */       return (ObjectSet)short2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */     extends Short2FloatFunctions.UnmodifiableFunction implements Short2FloatMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2FloatMap map;
/*     */     protected transient ObjectSet<Short2FloatMap.Entry> entries;
/*     */     protected transient ShortSet keys;
...
/*     */     
/*     */     public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2FloatEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Float>> entrySet() {
/* 712 */       return (ObjectSet)short2FloatEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatMaps.class
