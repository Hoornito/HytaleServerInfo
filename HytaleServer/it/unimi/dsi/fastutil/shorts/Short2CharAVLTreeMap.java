...
/*  885 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  886 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  994 */       this.next = Short2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  998 */       if ((this.next = Short2CharAVLTreeMap.this.locateKey(k)) != null)
/*  999 */         if (Short2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1052 */       updatePrevious();
/* 1053 */       updateNext();
/* 1054 */       Short2CharAVLTreeMap.this.remove(this.curr.key);
/* 1055 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1109 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */         {
...
/* 1119 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1124 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1133 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1135 */             Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1145 */             if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1146 */             if (!(e.getValue() instanceof Character)) return false; 
/* 1147 */             Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1148 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue()) return false; 
/* 1149 */             Short2CharAVLTreeMap.this.remove(f.key);
/* 1150 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1155 */             return Short2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1160 */             Short2CharAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2CharMap.Entry first() {
/* 1165 */             return Short2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2CharMap.Entry last() {
/* 1170 */             return Short2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1175 */             return Short2CharAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1180 */             return Short2CharAVLTreeMap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1185 */             return Short2CharAVLTreeMap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1222 */       return new Short2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1227 */       return new Short2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1280 */             return (CharIterator)new Short2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(char k) {
/* 1285 */             return Short2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1290 */             return Short2CharAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1295 */             Short2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1308 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Short2CharSortedMap tailMap(short from) {
/* 1313 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1357 */       if (!bottom && !top && Short2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1358 */       this.from = from;
/* 1359 */       this.bottom = bottom;
/* 1360 */       this.to = to;
/* 1361 */       this.top = top;
/* 1362 */       this.defRetValue = Short2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1381 */       return ((this.bottom || Short2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2CharAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
/* 1386 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator() {
/* 1389 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1394 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2CharMap.Entry> comparator() {
/* 1399 */               return Short2CharAVLTreeMap.this.short2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1407 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1408 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1409 */               Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1410 */               return (f != null && Short2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1418 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1419 */               if (e.getValue() == null || !(e.getValue() instanceof Character)) return false; 
/* 1420 */               Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1421 */               if (f != null && Short2CharAVLTreeMap.Submap.this.in(f.key)) Short2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1422 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1427 */               int c = 0;
/* 1428 */               for (ObjectBidirectionalIterator<Short2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1429 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Short2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1439 */               Short2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2CharMap.Entry first() {
/* 1444 */               return Short2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2CharMap.Entry last() {
/* 1449 */               return Short2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1454 */               return Short2CharAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1459 */               return Short2CharAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1464 */               return Short2CharAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1473 */         return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1478 */         return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1493 */               return (CharIterator)new Short2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(char k) {
/* 1498 */               return Short2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1503 */               return Short2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1508 */               Short2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1518 */       return (in(k) && Short2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(short k) {
/* 1536 */       short kk = k; Short2CharAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Short2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char put(short k, char v) {
/* 1542 */       Short2CharAVLTreeMap.this.modified = false;
...
/* 1544 */       char oldValue = Short2CharAVLTreeMap.this.put(k, v);
/* 1545 */       return Short2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char remove(short k) {
/* 1551 */       Short2CharAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k)) return this.defRetValue; 
/* 1553 */       char oldValue = Short2CharAVLTreeMap.this.remove(k);
/* 1554 */       return Short2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1575 */       return Short2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2CharSortedMap headMap(short to) {
/* 1580 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1581 */       return (Short2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2CharSortedMap tailMap(short from) {
/* 1586 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1587 */       return (Short2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2CharSortedMap subMap(short from, short to) {
/* 1592 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1593 */       if (!this.top) to = (Short2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1594 */       if (!this.bottom) from = (Short2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1605 */       if (Short2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) { e = Short2CharAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1611 */       { e = Short2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1613 */         if (Short2CharAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1617 */       if (e == null || (!this.top && Short2CharAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2CharAVLTreeMap.Entry e;
/* 1627 */       if (Short2CharAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1631 */       if (this.top) { e = Short2CharAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1633 */       { e = Short2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1635 */         if (Short2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1639 */       if (e == null || (!this.bottom && Short2CharAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1640 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1645 */       Short2CharAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1652 */       Short2CharAVLTreeMap.Entry e = lastEntry();
...
/*      */       extends Short2CharAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator() {
/* 1668 */         this.next = Short2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1672 */         this();
/* 1673 */         if (this.next != null) {
/* 1674 */           if (!Short2CharAVLTreeMap.Submap.this.bottom && Short2CharAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1675 */           else if (!Short2CharAVLTreeMap.Submap.this.top && Short2CharAVLTreeMap.this.compare(k, (this.prev = Short2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1677 */           { this.next = Short2CharAVLTreeMap.this.locateKey(k);
/* 1678 */             if (Short2CharAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1689 */         if (!Short2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Short2CharAVLTreeMap.this.compare(this.prev.key, Short2CharAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1694 */         this.next = this.next.next();
/* 1695 */         if (!Short2CharAVLTreeMap.Submap.this.top && this.next != null && Short2CharAVLTreeMap.this.compare(this.next.key, Short2CharAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Short2CharAVLTreeMap)super.clone();
...
/* 1856 */     if (n == 1) {
/* 1857 */       Entry entry = new Entry(s.readShort(), s.readChar());
...
/*      */ 
/*      */       
/* 1865 */       Entry entry = new Entry(s.readShort(), s.readChar());
/* 1866 */       entry.right(new Entry(s.readShort(), s.readChar()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharAVLTreeMap.class
