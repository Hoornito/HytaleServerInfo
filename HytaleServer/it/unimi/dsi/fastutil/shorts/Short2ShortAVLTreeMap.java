...
/*   86 */     this.actualComparator = ShortComparators.asShortComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  162 */     this(k, v, (Comparator<? super Short>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  188 */     return (this.actualComparator == null) ? Short.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  881 */       Map.Entry<Short, Short> e = (Map.Entry<Short, Short>)o;
/*  882 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  990 */       this.next = Short2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  994 */       if ((this.next = Short2ShortAVLTreeMap.this.locateKey(k)) != null)
/*  995 */         if (Short2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1048 */       updatePrevious();
/* 1049 */       updateNext();
/* 1050 */       Short2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1051 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1105 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2ShortMap.Entry>)new AbstractObjectSortedSet<Short2ShortMap.Entry>()
/*      */         {
...
/* 1115 */             return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) {
/* 1120 */             return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1129 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1130 */             if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1131 */             Short2ShortAVLTreeMap.Entry f = Short2ShortAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1141 */             if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1142 */             if (!(e.getValue() instanceof Short)) return false; 
/* 1143 */             Short2ShortAVLTreeMap.Entry f = Short2ShortAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1144 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue()) return false; 
/* 1145 */             Short2ShortAVLTreeMap.this.remove(f.key);
/* 1146 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1151 */             return Short2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1156 */             Short2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ShortMap.Entry first() {
/* 1161 */             return Short2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ShortMap.Entry last() {
/* 1166 */             return Short2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) {
/* 1171 */             return Short2ShortAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) {
/* 1176 */             return Short2ShortAVLTreeMap.this.headMap(to.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) {
/* 1181 */             return Short2ShortAVLTreeMap.this.tailMap(from.getShortKey()).short2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1218 */       return new Short2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1223 */       return new Short2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1273 */     if (this.values == null) this.values = new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1276 */             return new Short2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(short k) {
/* 1281 */             return Short2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1286 */             return Short2ShortAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1291 */             Short2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1304 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
/*      */   public Short2ShortSortedMap tailMap(short from) {
/* 1309 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */ 
/*      */   
...
/* 1353 */       if (!bottom && !top && Short2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1354 */       this.from = from;
/* 1355 */       this.bottom = bottom;
/* 1356 */       this.to = to;
/* 1357 */       this.top = top;
/* 1358 */       this.defRetValue = Short2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1377 */       return ((this.bottom || Short2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
/* 1382 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2ShortMap.Entry>)new AbstractObjectSortedSet<Short2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator() {
/* 1385 */               return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) {
/* 1390 */               return (ObjectBidirectionalIterator<Short2ShortMap.Entry>)new Short2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2ShortMap.Entry> comparator() {
/* 1395 */               return Short2ShortAVLTreeMap.this.short2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1403 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1404 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1405 */               Short2ShortAVLTreeMap.Entry f = Short2ShortAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1406 */               return (f != null && Short2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1414 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1415 */               if (e.getValue() == null || !(e.getValue() instanceof Short)) return false; 
/* 1416 */               Short2ShortAVLTreeMap.Entry f = Short2ShortAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1417 */               if (f != null && Short2ShortAVLTreeMap.Submap.this.in(f.key)) Short2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1418 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1423 */               int c = 0;
/* 1424 */               for (ObjectBidirectionalIterator<Short2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1425 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1430 */               return !(new Short2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1435 */               Short2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ShortMap.Entry first() {
/* 1440 */               return Short2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ShortMap.Entry last() {
/* 1445 */               return Short2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) {
/* 1450 */               return Short2ShortAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) {
/* 1455 */               return Short2ShortAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) {
/* 1460 */               return Short2ShortAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1469 */         return new Short2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1474 */         return new Short2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     
/*      */     public ShortCollection values() {
/* 1486 */       if (this.values == null) this.values = new AbstractShortCollection()
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1489 */               return new Short2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(short k) {
/* 1494 */               return Short2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1499 */               return Short2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1504 */               Short2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1514 */       return (in(k) && Short2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(short v) {
...
/* 1522 */         short ev = (i.nextEntry()).value;
...
/*      */     
/*      */     public short get(short k) {
/* 1532 */       short kk = k; Short2ShortAVLTreeMap.Entry e;
/* 1533 */       return (in(kk) && (e = Short2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short put(short k, short v) {
/* 1538 */       Short2ShortAVLTreeMap.this.modified = false;
...
/* 1540 */       short oldValue = Short2ShortAVLTreeMap.this.put(k, v);
/* 1541 */       return Short2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short remove(short k) {
/* 1547 */       Short2ShortAVLTreeMap.this.modified = false;
/* 1548 */       if (!in(k)) return this.defRetValue; 
/* 1549 */       short oldValue = Short2ShortAVLTreeMap.this.remove(k);
/* 1550 */       return Short2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1571 */       return Short2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap headMap(short to) {
/* 1576 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1577 */       return (Short2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap tailMap(short from) {
/* 1582 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1583 */       return (Short2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ShortSortedMap subMap(short from, short to) {
/* 1588 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1589 */       if (!this.top) to = (Short2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1590 */       if (!this.bottom) from = (Short2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Short2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1605 */       if (this.bottom) { e = Short2ShortAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1607 */       { e = Short2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1609 */         if (Short2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1613 */       if (e == null || (!this.top && Short2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1614 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2ShortAVLTreeMap.Entry e;
/* 1623 */       if (Short2ShortAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1627 */       if (this.top) { e = Short2ShortAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1629 */       { e = Short2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1631 */         if (Short2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1635 */       if (e == null || (!this.bottom && Short2ShortAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1636 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1641 */       Short2ShortAVLTreeMap.Entry e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1648 */       Short2ShortAVLTreeMap.Entry e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1664 */         this.next = Short2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1668 */         this();
/* 1669 */         if (this.next != null) {
/* 1670 */           if (!Short2ShortAVLTreeMap.Submap.this.bottom && Short2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1671 */           else if (!Short2ShortAVLTreeMap.Submap.this.top && Short2ShortAVLTreeMap.this.compare(k, (this.prev = Short2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1673 */           { this.next = Short2ShortAVLTreeMap.this.locateKey(k);
/* 1674 */             if (Short2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1685 */         if (!Short2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Short2ShortAVLTreeMap.this.compare(this.prev.key, Short2ShortAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1690 */         this.next = this.next.next();
/* 1691 */         if (!Short2ShortAVLTreeMap.Submap.this.top && this.next != null && Short2ShortAVLTreeMap.this.compare(this.next.key, Short2ShortAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1779 */       c = (Short2ShortAVLTreeMap)super.clone();
...
/* 1837 */       s.writeShort(e.key);
/* 1838 */       s.writeShort(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1852 */     if (n == 1) {
/* 1853 */       Entry entry = new Entry(s.readShort(), s.readShort());
...
/*      */ 
/*      */       
/* 1861 */       Entry entry = new Entry(s.readShort(), s.readShort());
/* 1862 */       entry.right(new Entry(s.readShort(), s.readShort()));
...
/* 1873 */     top.key = s.readShort();
/* 1874 */     top.value = s.readShort();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ShortAVLTreeMap.class
