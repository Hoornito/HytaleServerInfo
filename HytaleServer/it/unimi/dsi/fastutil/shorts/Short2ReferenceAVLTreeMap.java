...
/*  165 */     this(k, v, (Comparator<? super Short>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  191 */     return (this.actualComparator == null) ? Short.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  864 */       Map.Entry<Short, V> e = (Map.Entry<Short, V>)o;
/*  865 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == e.getValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*      */     
/*      */     TreeIterator() {
/*  973 */       this.next = Short2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     
/*      */     TreeIterator(short k) {
/*  977 */       if ((this.next = Short2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/*  978 */         if (Short2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1031 */       updatePrevious();
/* 1032 */       updateNext();
/* 1033 */       Short2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1034 */       this.curr = null;
/*      */     }
/*      */     
...
/* 1088 */     if (this.entries == null) this.entries = (ObjectSortedSet<Short2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1098 */             return (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>>)new Short2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) {
/* 1103 */             return (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>>)new Short2ReferenceAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/* 1112 */             if (!(e.getKey() instanceof Short)) return false; 
/* 1113 */             Short2ReferenceAVLTreeMap.Entry<V> f = Short2ReferenceAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1123 */             if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1124 */             Short2ReferenceAVLTreeMap.Entry<V> f = Short2ReferenceAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1125 */             if (f == null || f.getValue() != e.getValue()) return false; 
/* 1126 */             Short2ReferenceAVLTreeMap.this.remove(f.key);
/* 1127 */             return true;
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1132 */             return Short2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1137 */             Short2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ReferenceMap.Entry<V> first() {
/* 1142 */             return Short2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public Short2ReferenceMap.Entry<V> last() {
/* 1147 */             return Short2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> from, Short2ReferenceMap.Entry<V> to) {
/* 1152 */             return Short2ReferenceAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> to) {
/* 1157 */             return Short2ReferenceAVLTreeMap.this.headMap(to.getShortKey()).short2ReferenceEntrySet();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from) {
/* 1162 */             return Short2ReferenceAVLTreeMap.this.tailMap(from.getShortKey()).short2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1199 */       return new Short2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1204 */       return new Short2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */             return (ObjectIterator<V>)new Short2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(Object k) {
/* 1262 */             return Short2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1267 */             return Short2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1272 */             Short2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1285 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */ 
/*      */   
...
/* 1334 */       if (!bottom && !top && Short2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1335 */       this.from = from;
/* 1336 */       this.bottom = bottom;
/* 1337 */       this.to = to;
/* 1338 */       this.top = top;
/* 1339 */       this.defRetValue = Short2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
...
/* 1358 */       return ((this.bottom || Short2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ReferenceAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     
/*      */     public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
/* 1363 */       if (this.entries == null) this.entries = (ObjectSortedSet<Short2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator() {
/* 1366 */               return (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>>)new Short2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) {
/* 1371 */               return (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>>)new Short2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */ 
/*      */             
/*      */             public Comparator<? super Short2ReferenceMap.Entry<V>> comparator() {
/* 1376 */               return Short2ReferenceAVLTreeMap.this.short2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1384 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1385 */               Short2ReferenceAVLTreeMap.Entry<V> f = Short2ReferenceAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1386 */               return (f != null && Short2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */ 
/*      */             
...
/* 1394 */               if (e.getKey() == null || !(e.getKey() instanceof Short)) return false; 
/* 1395 */               Short2ReferenceAVLTreeMap.Entry<V> f = Short2ReferenceAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1396 */               if (f != null && Short2ReferenceAVLTreeMap.Submap.this.in(f.key)) Short2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1397 */               return (f != null);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1402 */               int c = 0;
/* 1403 */               for (ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); ) { c++; objectBidirectionalIterator.next(); }
/* 1404 */                return c;
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean isEmpty() {
/* 1409 */               return !(new Short2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1414 */               Short2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ReferenceMap.Entry<V> first() {
/* 1419 */               return Short2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public Short2ReferenceMap.Entry<V> last() {
/* 1424 */               return Short2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> from, Short2ReferenceMap.Entry<V> to) {
/* 1429 */               return Short2ReferenceAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> to) {
/* 1434 */               return Short2ReferenceAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from) {
/* 1439 */               return Short2ReferenceAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */       
/*      */       public ShortBidirectionalIterator iterator() {
/* 1448 */         return new Short2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */ 
/*      */       
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1453 */         return new Short2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1468 */               return (ObjectIterator<V>)new Short2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object k) {
/* 1473 */               return Short2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */ 
/*      */             
/*      */             public int size() {
/* 1478 */               return Short2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */ 
/*      */             
/*      */             public void clear() {
/* 1483 */               Short2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1493 */       return (in(k) && Short2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(short k) {
/* 1511 */       short kk = k; Short2ReferenceAVLTreeMap.Entry<V> e;
/* 1512 */       return (in(kk) && (e = Short2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V put(short k, V v) {
/* 1517 */       Short2ReferenceAVLTreeMap.this.modified = false;
...
/* 1519 */       V oldValue = Short2ReferenceAVLTreeMap.this.put(k, v);
/* 1520 */       return Short2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public V remove(short k) {
/* 1526 */       Short2ReferenceAVLTreeMap.this.modified = false;
/* 1527 */       if (!in(k)) return this.defRetValue; 
/* 1528 */       V oldValue = Short2ReferenceAVLTreeMap.this.remove(k);
/* 1529 */       return Short2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1550 */       return Short2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceSortedMap<V> headMap(short to) {
/* 1555 */       if (this.top) return new Submap(this.from, this.bottom, to, false); 
/* 1556 */       return (Short2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceSortedMap<V> tailMap(short from) {
/* 1561 */       if (this.bottom) return new Submap(from, false, this.to, this.top); 
/* 1562 */       return (Short2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2ReferenceSortedMap<V> subMap(short from, short to) {
/* 1567 */       if (this.top && this.bottom) return new Submap(from, false, to, false); 
/* 1568 */       if (!this.top) to = (Short2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1569 */       if (!this.bottom) from = (Short2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1580 */       if (Short2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1584 */       if (this.bottom) { e = Short2ReferenceAVLTreeMap.this.firstEntry; }
/*      */       else
/* 1586 */       { e = Short2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Short2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */          }
/*      */ 
/*      */       
/* 1592 */       if (e == null || (!this.top && Short2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0)) return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
/*      */ 
...
/*      */       Short2ReferenceAVLTreeMap.Entry<V> e;
/* 1602 */       if (Short2ReferenceAVLTreeMap.this.tree == null) return null;
/*      */ 
/*      */ 
/*      */       
/* 1606 */       if (this.top) { e = Short2ReferenceAVLTreeMap.this.lastEntry; }
/*      */       else
/* 1608 */       { e = Short2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Short2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */          }
/*      */ 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Short2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0)) return null; 
/* 1615 */       return e;
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShortKey() {
/* 1620 */       Short2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
...
/*      */     
/*      */     public short lastShortKey() {
/* 1627 */       Short2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Short2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       
/*      */       SubmapIterator(short k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null) {
/* 1649 */           if (!Short2ReferenceAVLTreeMap.Submap.this.bottom && Short2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) { this.prev = null; }
/* 1650 */           else if (!Short2ReferenceAVLTreeMap.Submap.this.top && Short2ReferenceAVLTreeMap.this.compare(k, (this.prev = Short2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) { this.next = null; }
/*      */           else
/* 1652 */           { this.next = Short2ReferenceAVLTreeMap.this.locateKey(k);
/* 1653 */             if (Short2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0)
...
/* 1664 */         if (!Short2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Short2ReferenceAVLTreeMap.this.compare(this.prev.key, Short2ReferenceAVLTreeMap.Submap.this.from) < 0) this.prev = null;
/*      */       
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Short2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Short2ReferenceAVLTreeMap.this.compare(this.next.key, Short2ReferenceAVLTreeMap.Submap.this.to) >= 0) this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1758 */       c = (Short2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1831 */     if (n == 1) {
/* 1832 */       Entry<V> entry = new Entry<>(s.readShort(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1840 */       Entry<V> entry = new Entry<>(s.readShort(), (V)s.readObject());
/* 1841 */       entry.right(new Entry<>(s.readShort(), (V)s.readObject()));
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceAVLTreeMap.class
