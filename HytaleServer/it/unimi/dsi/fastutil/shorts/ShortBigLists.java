...
/*  203 */       return ShortBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public ShortBigListIterator iterator() {
/*  209 */       return ShortBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator(long i) {
/*  215 */       if (i == 0L) return ShortBigListIterators.EMPTY_BIG_LIST_ITERATOR; 
...
/*  222 */       return ShortSpliterators.EMPTY_SPLITERATOR;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     public Object clone() {
/*  270 */       return ShortBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
...
/*  290 */       return ShortBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  343 */       short[] a = { this.element };
/*  344 */       return a;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator() {
/*  349 */       return ShortBigListIterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator(long i) {
/*  354 */       if (i > 1L || i < 0L) throw new IndexOutOfBoundsException(); 
/*  355 */       ShortBigListIterator l = listIterator();
/*  356 */       if (i == 1L) l.nextShort(); 
/*  357 */       return l;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortSpliterator spliterator() {
/*  362 */       return ShortSpliterators.singleton(this.element);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  371 */       if (from != 0L || to != 1L) return ShortBigLists.EMPTY_BIG_LIST; 
/*  372 */       return this;
/*      */     }
/*      */ 
/*      */     
...
/*  460 */     return new Singleton(((Short)element).shortValue());
/*      */   }
/*      */   
...
/*  482 */         return this.list.getShort(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*  503 */         return this.list.removeShort(i);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*  592 */         return ShortBigLists.synchronize(this.list.subList(from, to), this.sync);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/*      */     public short getShort(long i) {
/*  755 */       return this.list.getShort(i);
/*      */     }
/*      */ 
/*      */     
/*      */     public short set(long i, short k) {
...
/*      */     
/*      */     public ShortBigListIterator listIterator() {
/*  829 */       return ShortBigListIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator(long i) {
/*  834 */       return ShortBigListIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigList subList(long from, long to) {
/*  839 */       return ShortBigLists.unmodifiable(this.list.subList(from, to));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean equals(Object o) {
...
/*      */     extends AbstractShortBigList implements Serializable {
/*      */     private static final long serialVersionUID = -7046029254386353129L;
...
/*      */     
/*      */     public ShortBigListIterator iterator() {
/*  977 */       return ShortBigListIterators.asBigListIterator(this.list.iterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator() {
/*  982 */       return ShortBigListIterators.asBigListIterator(this.list.listIterator());
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortBigListIterator listIterator(long index) {
/*  987 */       return ShortBigListIterators.asBigListIterator(this.list.listIterator(intIndex(index)));
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean addAll(long index, Collection<? extends Short> c) {
...
/*      */     
/*      */     public short[] toShortArray() {
/* 1007 */       return this.list.toShortArray();
/*      */     }
/*      */ 
/*      */     
/*      */     public void removeElements(long from, long to) {
...
/* 1071 */       return this.list.getShort(intIndex(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public long indexOf(short k) {
...
/* 1086 */       return this.list.removeShort(intIndex(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public short set(long index, short k) {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\ShortBigLists.class
