...
/*  853 */     Long newValue = remappingFunction.apply(Short.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  866 */     int pos = find(k);
/*  867 */     Long newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  946 */       return Short2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short leftShort() {
/*  951 */       return Short2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long getLongValue() {
/*  956 */       return Short2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long rightLong() {
/*  961 */       return Short2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */ 
/*      */     
/*      */     public long setValue(long v) {
/*  966 */       long oldValue = Short2LongLinkedOpenHashMap.this.value[this.index];
/*  967 */       Short2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  968 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortLongPair right(long v) {
/*  973 */       Short2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  974 */       return this;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  985 */       return Short.valueOf(Short2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  996 */       return Long.valueOf(Short2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/* 1015 */       return (Short2LongLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     
/*      */     public int hashCode() {
/* 1020 */       return Short2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Short2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1025 */       return Short2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Short2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       this.next = Short2LongLinkedOpenHashMap.this.first;
/* 1194 */       this.index = 0;
/*      */     }
/*      */     
/*      */     private MapIterator(short from) {
/* 1198 */       if (from == 0) {
/* 1199 */         if (Short2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Short2LongLinkedOpenHashMap.this.link[Short2LongLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Short2LongLinkedOpenHashMap.this.n; return;
/*      */         } 
/* 1203 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1205 */       if (Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.last] == from) {
/* 1206 */         this.prev = Short2LongLinkedOpenHashMap.this.last;
/* 1207 */         this.index = Short2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1211 */       int pos = HashCommon.mix(from) & Short2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1213 */       while (Short2LongLinkedOpenHashMap.this.key[pos] != 0) {
/* 1214 */         if (Short2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1216 */           this.next = (int)Short2LongLinkedOpenHashMap.this.link[pos];
/* 1217 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1220 */         pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1239 */       if (this.next == -1) {
/* 1240 */         this.index = Short2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1243 */       int pos = Short2LongLinkedOpenHashMap.this.first;
/* 1244 */       this.index = 1;
/* 1245 */       while (pos != this.prev) {
/* 1246 */         pos = (int)Short2LongLinkedOpenHashMap.this.link[pos];
/* 1247 */         this.index++;
/*      */       } 
/*      */     }
/*      */     
...
/* 1264 */       this.next = (int)Short2LongLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Short2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/* 1282 */         this.next = (int)Short2LongLinkedOpenHashMap.this.link[this.curr];
...
/*      */       { 
/* 1295 */         this.index--;
/* 1296 */         this.prev = (int)(Short2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L); }
/* 1297 */       else { this.next = (int)Short2LongLinkedOpenHashMap.this.link[this.curr]; }
/* 1298 */        Short2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */       
/* 1301 */       if (this.prev == -1) { Short2LongLinkedOpenHashMap.this.first = this.next; }
/* 1302 */       else { Short2LongLinkedOpenHashMap.this.link[this.prev] = Short2LongLinkedOpenHashMap.this.link[this.prev] ^ (Short2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL; }
/* 1303 */        if (this.next == -1) { Short2LongLinkedOpenHashMap.this.last = this.prev; }
/* 1304 */       else { Short2LongLinkedOpenHashMap.this.link[this.next] = Short2LongLinkedOpenHashMap.this.link[this.next] ^ (Short2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L; }
/* 1305 */        int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Short2LongLinkedOpenHashMap.this.n) {
/* 1308 */         Short2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1311 */         short[] key = Short2LongLinkedOpenHashMap.this.key; while (true) {
/*      */           short curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == 0) {
/* 1317 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr) & Short2LongLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/* 1322 */               break;  pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1324 */           key[last] = curr;
/* 1325 */           Short2LongLinkedOpenHashMap.this.value[last] = Short2LongLinkedOpenHashMap.this.value[pos];
/* 1326 */           if (this.next == pos) this.next = last; 
/* 1327 */           if (this.prev == pos) this.prev = last; 
/* 1328 */           Short2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
/*      */     
...
/*      */   
/*      */   private final class EntryIterator extends MapIterator<Consumer<? super Short2LongMap.Entry>> implements ObjectListIterator<Short2LongMap.Entry> {
...
/* 1367 */       action.accept(new Short2LongLinkedOpenHashMap.MapEntry(index));
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongLinkedOpenHashMap.MapEntry next() {
/* 1372 */       return this.entry = new Short2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongLinkedOpenHashMap.MapEntry previous() {
/* 1377 */       return this.entry = new Short2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/*      */   }
/*      */   
/*      */   private final class FastEntryIterator extends MapIterator<Consumer<? super Short2LongMap.Entry>> implements ObjectListIterator<Short2LongMap.Entry> {
/* 1388 */     final Short2LongLinkedOpenHashMap.MapEntry entry = new Short2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1422 */       return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1440 */       return ObjectSpliterators.asSpliterator((ObjectIterator)iterator(), Size64.sizeOf(Short2LongLinkedOpenHashMap.this), 81);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (Short2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1466 */       return new Short2LongLinkedOpenHashMap.MapEntry(Short2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */ 
/*      */     
/*      */     public Short2LongMap.Entry last() {
/* 1471 */       if (Short2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1472 */       return new Short2LongLinkedOpenHashMap.MapEntry(Short2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/* 1484 */       if (k == 0) return (Short2LongLinkedOpenHashMap.this.containsNullKey && Short2LongLinkedOpenHashMap.this.value[Short2LongLinkedOpenHashMap.this.n] == v);
/*      */       
/* 1486 */       short[] key = Short2LongLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1489 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1490 */       if (k == curr) return (Short2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       while (true) {
/* 1493 */         if ((curr = key[pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1494 */         if (k == curr) return (Short2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       
/*      */       } 
/*      */     }
/*      */ 
...
/* 1507 */       if (k == 0) {
/* 1508 */         if (Short2LongLinkedOpenHashMap.this.containsNullKey && Short2LongLinkedOpenHashMap.this.value[Short2LongLinkedOpenHashMap.this.n] == v) {
/* 1509 */           Short2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1510 */           return true;
/*      */         } 
/* 1512 */         return false;
/*      */       } 
/*      */       
/* 1515 */       short[] key = Short2LongLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1518 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1519 */       if (curr == k) {
/* 1520 */         if (Short2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1521 */           Short2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1522 */           return true;
/*      */         } 
/* 1524 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1527 */         if ((curr = key[pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask]) == 0) return false; 
/* 1528 */         if (curr == k && 
/* 1529 */           Short2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1530 */           Short2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1531 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1539 */       return Short2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1544 */       Short2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1557 */       return new Short2LongLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1568 */       return new Short2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Short2LongLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
/* 1587 */       for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1588 */         int curr = next;
/* 1589 */         next = (int)Short2LongLinkedOpenHashMap.this.link[curr];
/* 1590 */         consumer.accept(new Short2LongLinkedOpenHashMap.MapEntry(curr));
/*      */       } 
/*      */     }
/*      */ 
/*      */ 
...
/* 1597 */       Short2LongLinkedOpenHashMap.MapEntry entry = new Short2LongLinkedOpenHashMap.MapEntry();
/* 1598 */       for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1599 */         entry.index = next;
/* 1600 */         next = (int)Short2LongLinkedOpenHashMap.this.link[next];
...
/* 1627 */       return Short2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1639 */       action.accept(Short2LongLinkedOpenHashMap.this.key[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public short nextShort() {
/* 1644 */       return Short2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
...
/* 1653 */       return new Short2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1658 */       return new Short2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1668 */       return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2LongLinkedOpenHashMap.this), 337);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void forEach(ShortConsumer consumer) {
/* 1674 */       for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1675 */         int curr = next;
/* 1676 */         next = (int)Short2LongLinkedOpenHashMap.this.link[curr];
/* 1677 */         consumer.accept(Short2LongLinkedOpenHashMap.this.key[curr]);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public int size() {
/* 1683 */       return Short2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean contains(short k) {
/* 1688 */       return Short2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1693 */       int oldSize = Short2LongLinkedOpenHashMap.this.size;
/* 1694 */       Short2LongLinkedOpenHashMap.this.remove(k);
/* 1695 */       return (Short2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */ 
/*      */     
/*      */     public void clear() {
/* 1700 */       Short2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public short firstShort() {
/* 1705 */       if (Short2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1706 */       return Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */ 
/*      */     
/*      */     public short lastShort() {
/* 1711 */       if (Short2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException(); 
/* 1712 */       return Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */ 
/*      */     
/*      */     public ShortComparator comparator() {
...
/* 1753 */       return Short2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1765 */       action.accept(Short2LongLinkedOpenHashMap.this.value[index]);
/*      */     }
/*      */ 
/*      */     
/*      */     public long nextLong() {
/* 1770 */       return Short2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1781 */             return (LongIterator)new Short2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */ 
/*      */ 
/*      */ 
...
/* 1791 */             return LongSpliterators.asSpliterator(iterator(), Size64.sizeOf(Short2LongLinkedOpenHashMap.this), 336);
/*      */           }
/*      */ 
/*      */ 
/*      */           
/*      */           public void forEach(LongConsumer consumer) {
/* 1797 */             for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1798 */               int curr = next;
/* 1799 */               next = (int)Short2LongLinkedOpenHashMap.this.link[curr];
/* 1800 */               consumer.accept(Short2LongLinkedOpenHashMap.this.value[curr]);
/*      */             } 
/*      */           }
/*      */ 
/*      */           
/*      */           public int size() {
/* 1806 */             return Short2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */ 
/*      */           
/*      */           public boolean contains(long v) {
/* 1811 */             return Short2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */ 
/*      */           
/*      */           public void clear() {
/* 1816 */             Short2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */         }; 
...
/*      */     try {
/* 1936 */       c = (Short2LongLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongLinkedOpenHashMap.class
