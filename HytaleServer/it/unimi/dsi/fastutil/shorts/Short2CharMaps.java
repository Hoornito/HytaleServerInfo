...
/*  50 */     return (entries instanceof Short2CharMap.FastEntrySet) ? ((Short2CharMap.FastEntrySet)entries).fastIterator() : entries.iterator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */     ObjectSet<Short2CharMap.Entry> entries = map.short2CharEntrySet();
/*  66 */     if (entries instanceof Short2CharMap.FastEntrySet) { ((Short2CharMap.FastEntrySet)entries).fastForEach(consumer); }
...
/*  82 */     final ObjectSet<Short2CharMap.Entry> entries = map.short2CharEntrySet();
/*  83 */     return (entries instanceof Short2CharMap.FastEntrySet) ? new ObjectIterable<Short2CharMap.Entry>()
/*     */       {
/*     */         public ObjectIterator<Short2CharMap.Entry> iterator() {
/*  86 */           return ((Short2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */ 
/*     */         
...
/* 147 */       return (ObjectSet<Short2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 166 */       return Short2CharMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public ObjectSet<Short2CharMap.Entry> short2CharEntrySet() {
/* 236 */       if (this.entries == null) this.entries = ObjectSets.singleton(new AbstractShort2CharMap.BasicEntry(this.key, this.value)); 
...
/* 249 */       return (ObjectSet)short2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/* 316 */     return new Singleton(key.shortValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedMap
/*     */     extends Short2CharFunctions.SynchronizedFunction implements Short2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
...
/* 367 */         if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Character>> entrySet() {
/* 381 */       return (ObjectSet)short2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */     extends Short2CharFunctions.UnmodifiableFunction implements Short2CharMap, Serializable {
/*     */     private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2CharMap map;
/*     */     protected transient ObjectSet<Short2CharMap.Entry> entries;
/*     */     protected transient ShortSet keys;
...
/*     */     
/*     */     public ObjectSet<Short2CharMap.Entry> short2CharEntrySet() {
/* 699 */       if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Character>> entrySet() {
/* 712 */       return (ObjectSet)short2CharEntrySet();
/*     */     }
/*     */ 
/*     */     
/*     */     public ShortSet keySet() {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharMaps.class
