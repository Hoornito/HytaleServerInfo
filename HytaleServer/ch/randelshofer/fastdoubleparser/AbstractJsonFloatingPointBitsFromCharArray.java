...
/*  31 */     int exponentOfTruncatedSignificand, endIndex = AbstractFloatValueParser.checkBounds(str.length, offset, length);
/*  32 */     int index = offset;
...
/* 102 */       boolean isExponentNegative = (ch == '-');
/* 103 */       if (isExponentNegative || ch == '+') {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\ch\randelshofer\fastdoubleparser\AbstractJsonFloatingPointBitsFromCharArray.class
