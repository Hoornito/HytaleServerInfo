...
/*  52 */     this.cooldownId = other.cooldownId;
/*     */   }
/*     */   
/*     */   @Nonnull
/*     */   public static CooldownConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
/*  57 */     CooldownConditionInteraction obj = new CooldownConditionInteraction();
...
/* 109 */       int cooldownIdLen = VarInt.peek(buf, varPos5);
/* 110 */       if (cooldownIdLen < 0) throw ProtocolException.negativeLength("CooldownId", cooldownIdLen); 
/* 111 */       if (cooldownIdLen > 4096000) throw ProtocolException.stringTooLong("CooldownId", cooldownIdLen, 4096000); 
/* 112 */       obj.cooldownId = PacketIO.readVarString(buf, varPos5, PacketIO.UTF8);
/*     */     } 
/*     */     
/* 115 */     return obj;
/*     */   }
...
/* 171 */     if (this.cooldownId != null) nullBits = (byte)(nullBits | 0x20); 
...
/* 191 */     int cooldownIdOffsetSlot = buf.writerIndex();
...
/*     */     } 
/* 225 */     if (this.cooldownId != null) {
/* 226 */       buf.setIntLE(cooldownIdOffsetSlot, buf.writerIndex() - varBlockStart);
/* 227 */       PacketIO.writeVarString(buf, this.cooldownId, 4096000);
/*     */     } else {
/* 229 */       buf.setIntLE(cooldownIdOffsetSlot, -1);
/*     */     } 
...
/* 243 */     if (this.cooldownId != null) size += PacketIO.stringSize(this.cooldownId);
/*     */     
/* 245 */     return size;
/*     */   }
/*     */   
...
/* 353 */       int cooldownIdOffset = buffer.getIntLE(offset + 39);
/* 354 */       if (cooldownIdOffset < 0) {
/* 355 */         return ValidationResult.error("Invalid offset for CooldownId");
/*     */       }
/* 357 */       int pos = offset + 43 + cooldownIdOffset;
/* 358 */       if (pos >= buffer.writerIndex()) {
/* 359 */         return ValidationResult.error("Offset out of bounds for CooldownId");
/*     */       }
/* 361 */       int cooldownIdLen = VarInt.peek(buffer, pos);
/* 362 */       if (cooldownIdLen < 0) {
/* 363 */         return ValidationResult.error("Invalid string length for CooldownId");
/*     */       }
/* 365 */       if (cooldownIdLen > 4096000) {
/* 366 */         return ValidationResult.error("CooldownId exceeds max length 4096000");
/*     */       }
/* 368 */       pos += VarInt.length(buffer, pos);
/* 369 */       pos += cooldownIdLen;
/* 370 */       if (pos > buffer.writerIndex()) {
/* 371 */         return ValidationResult.error("Buffer overflow reading CooldownId");
/*     */       }
/*     */     } 
...
/* 378 */     CooldownConditionInteraction copy = new CooldownConditionInteraction();
...
/* 420 */     result = 31 * result + Objects.hashCode(this.cooldownId);
/* 421 */     return result;
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\CooldownConditionInteraction.class
