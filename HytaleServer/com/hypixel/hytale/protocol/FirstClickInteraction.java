...
/*     */   }
/*     */   
/*     */   public FirstClickInteraction(@Nonnull FirstClickInteraction other) {
...
/*  50 */     this.click = other.click;
/*  51 */     this.held = other.held;
/*     */   }
/*     */   
/*     */   @Nonnull
/*     */   public static FirstClickInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
/*  56 */     FirstClickInteraction obj = new FirstClickInteraction();
...
/*  62 */     obj.click = buf.getIntLE(offset + 11);
/*  63 */     obj.held = buf.getIntLE(offset + 15);
/*     */     
...
/* 163 */     buf.writeIntLE(this.click);
/* 164 */     buf.writeIntLE(this.held);
/*     */     
...
/* 331 */     FirstClickInteraction copy = new FirstClickInteraction();
...
/* 370 */     result = 31 * result + Integer.hashCode(this.click);
/* 371 */     result = 31 * result + Integer.hashCode(this.held);
/* 372 */     return result;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\FirstClickInteraction.class
