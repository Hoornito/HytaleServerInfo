...
/* 41 */     BlockPosition obj = new BlockPosition();
/*    */     
...
/* 78 */     BlockPosition copy = new BlockPosition();
/* 79 */     copy.x = this.x;
/* 80 */     copy.y = this.y;
/* 81 */     copy.z = this.z;
/* 82 */     return copy;
...
/* 89 */     if (obj instanceof BlockPosition) { other = (BlockPosition)obj; } else { return false; }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\BlockPosition.class
