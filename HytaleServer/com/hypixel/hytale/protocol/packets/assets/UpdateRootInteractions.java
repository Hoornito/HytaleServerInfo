...
/*  51 */     UpdateRootInteractions obj = new UpdateRootInteractions();
...
/*  64 */         RootInteraction val = RootInteraction.deserialize(buf, pos);
/*  65 */         pos += RootInteraction.computeBytesConsumed(buf, pos);
...
/*  77 */       for (int i = 0; i < dictLen; ) { pos += 4; pos += RootInteraction.computeBytesConsumed(buf, pos); i++; }  }
...
/*     */     
/*  91 */     if (this.interactions != null) { if (this.interactions.size() > 4096000) throw ProtocolException.dictionaryTooLarge("Interactions", this.interactions.size(), 4096000);  VarInt.write(buf, this.interactions.size()); for (Map.Entry<Integer, RootInteraction> e : this.interactions.entrySet()) { buf.writeIntLE(((Integer)e.getKey()).intValue()); ((RootInteraction)e.getValue()).serialize(buf); }
/*     */        }
/*     */   
/*     */   }
...
/*  99 */       for (Map.Entry<Integer, RootInteraction> kvp : this.interactions.entrySet()) interactionsSize += 4 + ((RootInteraction)kvp.getValue()).computeSize(); 
...
/*     */         }
/* 129 */         pos += RootInteraction.computeBytesConsumed(buffer, pos);
/*     */       } 
/*     */     } 
/*     */     
...
/* 137 */     UpdateRootInteractions copy = new UpdateRootInteractions();
/* 138 */     copy.type = this.type;
/* 139 */     copy.maxId = this.maxId;
/* 140 */     if (this.interactions != null) {
/* 141 */       Map<Integer, RootInteraction> m = new HashMap<>();
/* 142 */       for (Map.Entry<Integer, RootInteraction> e : this.interactions.entrySet()) m.put(e.getKey(), ((RootInteraction)e.getValue()).clone()); 
/* 143 */       copy.interactions = m;
/*     */     } 
/* 145 */     return copy;
/*     */   }
/*     */ 
...
/*     */     UpdateRootInteractions other;
/* 151 */     if (this == obj) return true; 
/* 152 */     if (obj instanceof UpdateRootInteractions) { other = (UpdateRootInteractions)obj; } else { return false; }
/* 153 */      return (Objects.equals(this.type, other.type) && this.maxId == other.maxId && Objects.equals(this.interactions, other.interactions));
/*     */   }
/*     */ 
/*     */   
/*     */   public int hashCode() {
/* 158 */     return Objects.hash(new Object[] { this.type, Integer.valueOf(this.maxId), this.interactions });
/*     */   }
/*     */   
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\packets\assets\UpdateRootInteractions.class
