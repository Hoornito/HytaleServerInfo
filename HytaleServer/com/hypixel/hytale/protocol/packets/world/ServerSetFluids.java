...
/*     */   
/*     */   @Nonnull
/*  31 */   public SetFluidCmd[] cmds = new SetFluidCmd[0];
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*  52 */     ServerSetFluids obj = new ServerSetFluids();
/*     */     
...
/*  63 */     if ((pos + cmdsVarLen) + cmdsCount * 7L > buf.readableBytes())
/*  64 */       throw ProtocolException.bufferTooSmall("Cmds", pos + cmdsVarLen + cmdsCount * 7, buf.readableBytes()); 
/*  65 */     pos += cmdsVarLen;
/*  66 */     obj.cmds = new SetFluidCmd[cmdsCount];
/*  67 */     for (int i = 0; i < cmdsCount; i++) {
/*  68 */       obj.cmds[i] = SetFluidCmd.deserialize(buf, pos);
/*  69 */       pos += SetFluidCmd.computeBytesConsumed(buf, pos);
/*     */     } 
/*     */     
/*  72 */     return obj;
/*     */   }
...
/*  78 */     for (int i = 0; i < arrLen; ) { pos += SetFluidCmd.computeBytesConsumed(buf, pos); i++; }
...
/*     */     
/*  90 */     if (this.cmds.length > 4096000) throw ProtocolException.arrayTooLong("Cmds", this.cmds.length, 4096000);  VarInt.write(buf, this.cmds.length); for (SetFluidCmd item : this.cmds) item.serialize(buf);
/*     */   
/*     */   }
/*     */   
/*     */   public int computeSize() {
/*  95 */     int size = 12;
/*  96 */     size += VarInt.size(this.cmds.length) + this.cmds.length * 7;
/*     */     
/*  98 */     return size;
/*     */   }
/*     */   
...
/* 125 */     ServerSetFluids copy = new ServerSetFluids();
/* 126 */     copy.x = this.x;
/* 127 */     copy.y = this.y;
/* 128 */     copy.z = this.z;
/* 129 */     copy.cmds = (SetFluidCmd[])Arrays.<SetFluidCmd>stream(this.cmds).map(e -> e.clone()).toArray(x$0 -> new SetFluidCmd[x$0]);
/* 130 */     return copy;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean equals(Object obj) {
/*     */     ServerSetFluids other;
/* 136 */     if (this == obj) return true; 
/* 137 */     if (obj instanceof ServerSetFluids) { other = (ServerSetFluids)obj; } else { return false; }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\packets\world\ServerSetFluids.class
