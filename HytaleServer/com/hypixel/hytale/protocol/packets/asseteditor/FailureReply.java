...
/*  46 */     FailureReply obj = new FailureReply();
...
/* 104 */     FailureReply copy = new FailureReply();
...
/* 114 */     if (obj instanceof FailureReply) { other = (FailureReply)obj; } else { return false; }
/* 115 */      return (this.token == other.token && Objects.equals(this.message, other.message));
/*     */   }
/*     */ 
/*     */   
/*     */   public int hashCode() {
/* 120 */     return Objects.hash(new Object[] { Integer.valueOf(this.token), this.message });
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\packets\asseteditor\FailureReply.class
