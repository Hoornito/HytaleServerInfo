...
/*     */   
/*     */   public BuilderToolStringArg(@Nullable String defaultValue) {
/*  26 */     this.defaultValue = defaultValue;
/*     */   }
/*     */   
/*     */   public BuilderToolStringArg(@Nonnull BuilderToolStringArg other) {
/*  30 */     this.defaultValue = other.defaultValue;
/*     */   }
/*     */   
/*     */   @Nonnull
/*     */   public static BuilderToolStringArg deserialize(@Nonnull ByteBuf buf, int offset) {
/*  35 */     BuilderToolStringArg obj = new BuilderToolStringArg();
...
/* 101 */     BuilderToolStringArg copy = new BuilderToolStringArg();
...
/*     */     BuilderToolStringArg other;
/* 109 */     if (this == obj) return true; 
/* 110 */     if (obj instanceof BuilderToolStringArg) { other = (BuilderToolStringArg)obj; } else { return false; }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\packets\buildertools\BuilderToolStringArg.class
