...
/*  37 */     this.rootInteraction = rootInteraction;
/*     */   }
/*     */   
/*     */   public RunRootInteraction(@Nonnull RunRootInteraction other) {
...
/*  52 */     this.rootInteraction = other.rootInteraction;
/*     */   }
/*     */   
/*     */   @Nonnull
/*     */   public static RunRootInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
/*  57 */     RunRootInteraction obj = new RunRootInteraction();
...
/*  65 */     obj.rootInteraction = buf.getIntLE(offset + 19);
/*     */     
/*  67 */     if ((nullBits & 0x1) != 0) {
/*  68 */       int varPos0 = offset + 43 + buf.getIntLE(offset + 23);
/*  69 */       obj.effects = InteractionEffects.deserialize(buf, varPos0);
/*     */     } 
/*  71 */     if ((nullBits & 0x2) != 0) {
/*  72 */       int varPos1 = offset + 43 + buf.getIntLE(offset + 27);
...
/*  88 */       int varPos2 = offset + 43 + buf.getIntLE(offset + 31);
/*  89 */       obj.rules = InteractionRules.deserialize(buf, varPos2);
/*     */     } 
/*  91 */     if ((nullBits & 0x8) != 0) {
/*  92 */       int varPos3 = offset + 43 + buf.getIntLE(offset + 35);
...
/* 105 */       int varPos4 = offset + 43 + buf.getIntLE(offset + 39);
...
/* 116 */       int fieldOffset0 = buf.getIntLE(offset + 23);
/* 117 */       int pos0 = offset + 43 + fieldOffset0;
...
/* 122 */       int fieldOffset1 = buf.getIntLE(offset + 27);
/* 123 */       int pos1 = offset + 43 + fieldOffset1;
...
/* 129 */       int fieldOffset2 = buf.getIntLE(offset + 31);
/* 130 */       int pos2 = offset + 43 + fieldOffset2;
/* 131 */       pos2 += InteractionRules.computeBytesConsumed(buf, pos2);
/* 132 */       if (pos2 - offset > maxEnd) maxEnd = pos2 - offset; 
/*     */     } 
/* 134 */     if ((nullBits & 0x8) != 0) {
/* 135 */       int fieldOffset3 = buf.getIntLE(offset + 35);
/* 136 */       int pos3 = offset + 43 + fieldOffset3;
...
/* 141 */       int fieldOffset4 = buf.getIntLE(offset + 39);
/* 142 */       int pos4 = offset + 43 + fieldOffset4;
...
/* 167 */     buf.writeIntLE(this.rootInteraction);
/*     */     
...
/* 228 */     if (buffer.readableBytes() - offset < 43) {
/* 229 */       return ValidationResult.error("Buffer too small: expected at least 43 bytes");
/*     */     }
/*     */     
...
/* 236 */       int effectsOffset = buffer.getIntLE(offset + 23);
/* 237 */       if (effectsOffset < 0) {
/* 238 */         return ValidationResult.error("Invalid offset for Effects");
/*     */       }
/* 240 */       int pos = offset + 43 + effectsOffset;
...
/* 252 */       int settingsOffset = buffer.getIntLE(offset + 27);
/* 253 */       if (settingsOffset < 0) {
/* 254 */         return ValidationResult.error("Invalid offset for Settings");
/*     */       }
/* 256 */       int pos = offset + 43 + settingsOffset;
...
/* 277 */       int rulesOffset = buffer.getIntLE(offset + 31);
/* 278 */       if (rulesOffset < 0) {
/* 279 */         return ValidationResult.error("Invalid offset for Rules");
/*     */       }
/* 281 */       int pos = offset + 43 + rulesOffset;
...
/* 293 */       int tagsOffset = buffer.getIntLE(offset + 35);
/* 294 */       if (tagsOffset < 0) {
/* 295 */         return ValidationResult.error("Invalid offset for Tags");
/*     */       }
/* 297 */       int pos = offset + 43 + tagsOffset;
...
/* 316 */       int cameraOffset = buffer.getIntLE(offset + 39);
/* 317 */       if (cameraOffset < 0) {
/* 318 */         return ValidationResult.error("Invalid offset for Camera");
/*     */       }
/* 320 */       int pos = offset + 43 + cameraOffset;
...
/* 334 */     RunRootInteraction copy = new RunRootInteraction();
...
/* 376 */     result = 31 * result + Integer.hashCode(this.rootInteraction);
/* 377 */     return result;
/*     */   }
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\RunRootInteraction.class
