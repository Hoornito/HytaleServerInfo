...
/*    */       
/*    */       case 4:
/* 29 */        }  throw ProtocolException.unknownPolymorphicType("ParamValue", typeId);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 48 */     ParamValue paramValue = this; if (paramValue instanceof StringParamValue) { StringParamValue sub = (StringParamValue)paramValue; return 0; }
/* 49 */      paramValue = this; if (paramValue instanceof BoolParamValue) { BoolParamValue sub = (BoolParamValue)paramValue; return 1; }
/* 50 */      paramValue = this; if (paramValue instanceof DoubleParamValue) { DoubleParamValue sub = (DoubleParamValue)paramValue; return 2; }
/* 51 */      paramValue = this; if (paramValue instanceof IntParamValue) { IntParamValue sub = (IntParamValue)paramValue; return 3; }
/* 52 */      paramValue = this; if (paramValue instanceof LongParamValue) { LongParamValue sub = (LongParamValue)paramValue; return 4; }
...
/*    */ 
/*    */       
/* 80 */       ValidationResult.error("Unknown polymorphic type ID " + typeId + " for ParamValue");
/*    */   }
/*    */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\protocol\ParamValue.class
