...
/*    */   public ActionResetPath(@Nonnull BuilderActionResetPath builder) {
/* 15 */     super((BuilderActionBase)builder);
/*    */   }
/*    */ 
/*    */   
/*    */   public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store) {
/* 20 */     super.execute(ref, role, sensorInfo, dt, store);
/* 21 */     role.getWorldSupport().requestNewPath();
/* 22 */     return true;
/*    */   }
/*    */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\npc\corecomponents\world\ActionResetPath.class
