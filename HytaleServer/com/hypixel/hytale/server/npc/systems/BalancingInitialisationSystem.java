...
/*  67 */   private final Set<Dependency<EntityStore>> dependencies = Set.of(new SystemDependency(Order.AFTER, RoleBuilderSystem.class), new SystemDependency(Order.AFTER, EntityStatsSystems.Setup.class)); @Nonnull
