...
/*     */   {
/*     */     @Nonnull
/* 309 */     private static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemDependency(Order.AFTER, NPCPreTickSystem.class), new SystemDependency(Order.BEFORE, DeathSystems.CorpseRemoval.class));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*     */     @Nonnull
/* 408 */     private static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemDependency(Order.AFTER, NPCPreTickSystem.class), new SystemDependency(Order.BEFORE, DeathSystems.CorpseRemoval.class));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
