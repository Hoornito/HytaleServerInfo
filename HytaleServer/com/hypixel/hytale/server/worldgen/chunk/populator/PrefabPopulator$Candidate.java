...
/*     */   private final PrefabContainer.PrefabContainerEntry entry;
...
/*     */     //   0	7	0	this	Lcom/hypixel/hytale/server/worldgen/chunk/populator/PrefabPopulator$Candidate;
/*     */   }
/*     */   
...
/* 513 */     this.x = x; this.y = y; this.z = z; this.priority = priority; this.rotation = rotation; this.buffer = buffer; this.supplier = supplier; this.entry = entry; this.generator = generator; } public int x() { return this.x; } public int y() { return this.y; } public int z() { return this.z; } public int priority() { return this.priority; } public PrefabRotation rotation() { return this.rotation; } public IPrefabBuffer buffer() { return this.buffer; } public WorldGenPrefabSupplier supplier() { return this.supplier; } public PrefabContainer.PrefabContainerEntry entry() { return this.entry; } public PrefabPatternGenerator generator() { return this.generator; }
/*     */ 
/*     */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\worldgen\chunk\populator\PrefabPopulator$Candidate.class
