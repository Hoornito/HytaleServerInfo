...
/* 47 */     this.query = (Query<EntityStore>)Query.and(new Query[] { (Query)componentType, (Query)Interactable.getComponentType() });
/*    */   }
/*    */ 
/*    */   
/*    */   @Nullable
...
/*    */ 
/*    */     
/* 72 */     ((EntityInteractableSystems.QueueResource)store.getResource(EntityInteractableSystems.QueueResource.getResourceType())).queue.clear();
/*    */   }
/*    */ 
/*    */   
...
/*    */     
/* 81 */     if (((EntityInteractableSystems.QueueResource)commandBuffer.getResource(EntityInteractableSystems.QueueResource.getResourceType())).queue.remove(ref)) {
...
/* 90 */     update.type = ComponentUpdateType.Interactable;
/*    */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\core\modules\entity\system\EntityInteractableSystems$EntityTrackerUpdate.class
