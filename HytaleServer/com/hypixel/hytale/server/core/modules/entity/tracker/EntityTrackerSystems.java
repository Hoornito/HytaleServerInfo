...
/* 453 */     public static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemDependency(Order.AFTER, EntityTrackerSystems.ClearEntityViewers.class), new SystemGroupDependency(Order.AFTER, EntityTrackerSystems.FIND_VISIBLE_ENTITIES_GROUP));
/*     */ 
/*     */ 
/*     */     
...
/* 574 */     public static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemDependency(Order.AFTER, EntityTrackerSystems.AddToVisible.class), new SystemGroupDependency(Order.BEFORE, EntityTrackerSystems.QUEUE_UPDATE_GROUP));
/*     */ 
/*     */     
/*     */     private final ComponentType<EntityStore, EntityTrackerSystems.Visible> componentType;
/*     */ 
...
/* 753 */     public static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemGroupDependency(Order.AFTER, EntityTrackerSystems.QUEUE_UPDATE_GROUP));
/*     */ 
/*     */     
/*     */     private final ComponentType<EntityStore, EntityTrackerSystems.EntityViewer> componentType;
/*     */ 
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\core\modules\entity\tracker\EntityTrackerSystems.class
