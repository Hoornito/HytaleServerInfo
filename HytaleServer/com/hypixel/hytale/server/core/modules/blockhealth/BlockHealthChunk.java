...
/*     */     } 
/*     */     
/*  98 */     return (BlockHealth)Objects.requireNonNullElse(blockHealth, BlockHealth.NO_DAMAGE_INSTANCE);
/*     */   }
/*     */ 
/*     */   
/*     */   @Nonnull
/*     */   public BlockHealth repairBlock(@Nonnull World world, @Nonnull Vector3i block, float progress) {
/* 104 */     BlockHealth blockHealth = (BlockHealth)Objects.requireNonNullElse(this.blockHealthMap.computeIfPresent(block, (key, value) -> { value.setHealth(value.getHealth() + progress); return (value.getHealth() > 1.0D) ? value : null; }), BlockHealth.NO_DAMAGE_INSTANCE);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\core\modules\blockhealth\BlockHealthChunk.class
