...
/* 28 */     int soundEventIndex = SoundEvent.getAssetMap().getIndex(soundEventId);
/*    */     
/* 30 */     if (soundEventIndex == Integer.MIN_VALUE) {
/* 31 */       HytaleLogger.getLogger().at(Level.WARNING).log("Attempted to play an invalid sound event %s", soundEventId);
/* 32 */       soundEventIndex = 0;
/*    */     } 
/*    */     
/* 35 */     return soundEventIndex;
/*    */   }
/*    */ }


/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\cor\\util\TempAssetIdUtil.class
