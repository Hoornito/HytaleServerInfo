...
/*      */       
/*  259 */       this.generatorLoaded.complete((Void)null);
...
/*  586 */     if (this.store.isShutdown()) return CompletableFuture.completedFuture((Ref<ChunkStore>)null);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/*  597 */       if (chunkState == null) return CompletableFuture.completedFuture((Ref<ChunkStore>)null);
/*      */ 
/*      */       
...
/*  606 */           if (chunkState.future == null) return (CompletableFuture)CompletableFuture.completedFuture((Object)null); 
...
/*  663 */           return CompletableFuture.failedFuture(new RuntimeException("Chunk failure backoff", chunkState.throwable));
/*      */         }
/*      */ 
/*      */         
...
/*  795 */         return (CompletableFuture)CompletableFuture.completedFuture((Object)null);
/*      */       }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\cor\\universe\world\storage\ChunkStore.class
