...
/* 84 */         .thenRun(() -> sender.sendMessage(Message.translation("server.universe.addWorld.worldCreated").param("worldName", name).param("generator", (String)Objects.requireNonNullElse(generatorType, "default")).param("storage", (String)Objects.requireNonNullElse(chunkStorageType, "default"))))
/*    */ 
/*    */ 
/*    */         
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\server\cor\\universe\world\commands\world\WorldAddCommand.class
