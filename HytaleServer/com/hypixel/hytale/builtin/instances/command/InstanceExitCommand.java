...
/*    */ 
/*    */ public class InstanceExitCommand
/*    */   extends AbstractPlayerCommand {
/*    */   @Nonnull
/* 24 */   private static final Message MESSAGE_COMMANDS_INSTANCES_EXIT_FAIL = Message.translation("server.commands.instances.exit.fail");
/*    */   @Nonnull
/* 26 */   private static final Message MESSAGE_COMMANDS_INSTANCES_EXIT_SUCCESS_SELF = Message.translation("server.commands.instances.exit.success.self");
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public InstanceExitCommand() {
/* 32 */     super("exit", "server.commands.instances.exit.desc");
/* 33 */     addAliases(new String[] { "leave" });
/* 34 */     addUsageVariant((AbstractCommand)new InstanceExitOtherCommand());
/*    */   }
/*    */ 
/*    */   
/*    */   protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world) {
/*    */     try {
/* 40 */       InstancesPlugin.exitInstance(ref, (ComponentAccessor)store);
/* 41 */       context.sendMessage(MESSAGE_COMMANDS_INSTANCES_EXIT_SUCCESS_SELF);
/* 42 */     } catch (IllegalArgumentException e) {
/* 43 */       context.sendMessage(MESSAGE_COMMANDS_INSTANCES_EXIT_FAIL);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
/*    */   private static class InstanceExitOtherCommand
/*    */     extends CommandBase
/*    */   {
/*    */     @Nonnull
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\builtin\instances\command\InstanceExitCommand.class
