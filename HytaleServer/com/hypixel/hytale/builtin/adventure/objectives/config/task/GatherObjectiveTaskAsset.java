...
/*    */   
/*    */   static {
/* 18 */     CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(GatherObjectiveTaskAsset.class, GatherObjectiveTaskAsset::new, CountObjectiveTaskAsset.CODEC).append(new KeyedCodec("BlockTagOrItemId", (Codec)BlockTagOrItemIdField.CODEC), (gatherObjectiveTaskAsset, blockTagOrItemIdField) -> gatherObjectiveTaskAsset.blockTagOrItemIdField = blockTagOrItemIdField, gatherObjectiveTaskAsset -> gatherObjectiveTaskAsset.blockTagOrItemIdField).addValidator(Validators.nonNull()).add()).build();
/*    */   }
/*    */ 
/*    */   
...
/* 43 */     if (!(task instanceof GatherObjectiveTaskAsset)) return false;
/*    */     
/* 45 */     return ((GatherObjectiveTaskAsset)task).blockTagOrItemIdField.equals(this.blockTagOrItemIdField);
/*    */   }
/*    */ 
/*    */   
/*    */   @Nonnull
/*    */   public String toString() {
/* 51 */     return "GatherObjectiveTaskAsset{blockTagOrItemIdTask=" + String.valueOf(this.blockTagOrItemIdField) + "} " + super
/*    */       
/* 53 */       .toString();
/*    */   }
/*    */ }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\builtin\adventure\objectives\config\task\GatherObjectiveTaskAsset.class
