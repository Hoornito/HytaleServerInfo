...
/*    */ 
/*    */ public class MultiplierCurveAsset
/*    */   extends CurveAsset
/*    */ {
/*    */   public static final BuilderCodec<MultiplierCurveAsset> CODEC;
/*    */   
/*    */   static {
/* 18 */     CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MultiplierCurveAsset.class, MultiplierCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curves", (Codec)new ArrayCodec((Codec)CurveAsset.CODEC, x$0 -> new CurveAsset[x$0]), true), (t, k) -> t.curveAssets = k, k -> k.curveAssets).add()).build();
/*    */   }
...
/*    */           value *= inputCurves[i].applyAsDouble(in);
/*    */         }
/*    */         return value;
/*    */       };
/*    */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\builtin\hytalegenerator\assets\curves\MultiplierCurveAsset.class
