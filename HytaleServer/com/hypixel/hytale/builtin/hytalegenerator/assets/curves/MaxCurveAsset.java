...
/*    */ 
/*    */ public class MaxCurveAsset
/*    */   extends CurveAsset
/*    */ {
/*    */   public static final BuilderCodec<MaxCurveAsset> CODEC;
/*    */   
/*    */   static {
/* 18 */     CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MaxCurveAsset.class, MaxCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec("Curves", (Codec)new ArrayCodec((Codec)CurveAsset.CODEC, x$0 -> new CurveAsset[x$0]), true), (t, k) -> t.curveAssets = k, k -> k.curveAssets).add()).build();
/*    */   }
...
/* 41 */       return in -> Math.max(curveA.applyAsDouble(in), curveB.applyAsDouble(in));
/*    */     } 
/*    */     
...
/* 48 */       return in -> Math.max(Math.max(curveA.applyAsDouble(in), curveB.applyAsDouble(in)), curveC.applyAsDouble(in));
/*    */     } 
/*    */ 
/*    */     
/* 52 */     return in -> {
...
/*    */           value = Math.max(value, inputCurves[i].applyAsDouble(in));
/*    */         }
/*    */         return value;
/*    */       };
/*    */   }
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\hypixel\hytale\builtin\hytalegenerator\assets\curves\MaxCurveAsset.class
