...
/*     */   
/*     */   static {
/*  18 */     RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 33, 0, "", "UInt64Value");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  57 */     this.memoizedIsInitialized = -1; } private UInt64Value() { this.value_ = 0L; this.memoizedIsInitialized = -1; } public static final Descriptors.Descriptor getDescriptor() {
...
/*  72 */       output.writeUInt64(1, this.value_);
/*     */     }
...
/*  84 */       size += 
/*  85 */         CodedOutputStream.computeUInt64Size(1, this.value_);
/*     */     }
...
/*  95 */       return true;
/*     */     }
/*  97 */     if (!(obj instanceof UInt64Value)) {
/*  98 */       return super.equals(obj);
/*     */     }
/* 100 */     UInt64Value other = (UInt64Value)obj;
/*     */     
...
/* 157 */     return 
/* 158 */       GeneratedMessage.<UInt64Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 164 */     return 
/* 165 */       GeneratedMessage.<UInt64Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static UInt64Value parseDelimitedFrom(InputStream input) throws IOException {
/* 170 */     return 
/* 171 */       GeneratedMessage.<UInt64Value>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 178 */     return 
/* 179 */       GeneratedMessage.<UInt64Value>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static UInt64Value parseFrom(CodedInputStream input) throws IOException {
/* 184 */     return 
/* 185 */       GeneratedMessage.<UInt64Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 191 */     return 
/* 192 */       GeneratedMessage.<UInt64Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/* 224 */       return WrappersProto.internal_static_google_protobuf_UInt64Value_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
/* 230 */       return WrappersProto.internal_static_google_protobuf_UInt64Value_fieldAccessorTable
/* 231 */         .ensureFieldAccessorsInitialized((Class)UInt64Value.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 256 */       return WrappersProto.internal_static_google_protobuf_UInt64Value_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public UInt64Value getDefaultInstanceForType() {
/* 261 */       return UInt64Value.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public UInt64Value build() {
/* 266 */       UInt64Value result = buildPartial();
...
/* 275 */       UInt64Value result = new UInt64Value(this);
...
/* 290 */       if (other instanceof UInt64Value) {
/* 291 */         return mergeFrom((UInt64Value)other);
/*     */       }
...
/* 299 */       if (other == UInt64Value.getDefaultInstance()) return this; 
...
/*     */               continue;
/*     */             case 8:
/* 330 */               this.value_ = input.readUInt64();
...
/*     */ 
/*     */   
/* 389 */   private static final UInt64Value DEFAULT_INSTANCE = new UInt64Value();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 401 */   private static final Parser<UInt64Value> PARSER = new AbstractParser<UInt64Value>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 407 */         UInt64Value.Builder builder = UInt64Value.newBuilder();
/*     */         try {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\google\protobuf\UInt64Value.class
