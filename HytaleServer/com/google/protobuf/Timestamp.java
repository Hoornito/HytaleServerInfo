...
/*     */   
/*     */   static {
/*  18 */     RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 33, 0, "", "Timestamp");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  68 */     this.memoizedIsInitialized = -1; } private Timestamp() { this.seconds_ = 0L; this.nanos_ = 0; this.memoizedIsInitialized = -1; }
...
/*  76 */     return true; }
/*     */   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TimestampProto.internal_static_google_protobuf_Timestamp_fieldAccessorTable.ensureFieldAccessorsInitialized((Class)Timestamp.class, (Class)Builder.class); } public long getSeconds() {
...
/* 113 */       return true;
/*     */     }
/* 115 */     if (!(obj instanceof Timestamp)) {
/* 116 */       return super.equals(obj);
/*     */     }
/* 118 */     Timestamp other = (Timestamp)obj;
/*     */     
...
/* 179 */     return 
/* 180 */       GeneratedMessage.<Timestamp>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 186 */     return 
/* 187 */       GeneratedMessage.<Timestamp>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Timestamp parseDelimitedFrom(InputStream input) throws IOException {
/* 192 */     return 
/* 193 */       GeneratedMessage.<Timestamp>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 200 */     return 
/* 201 */       GeneratedMessage.<Timestamp>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Timestamp parseFrom(CodedInputStream input) throws IOException {
/* 206 */     return 
/* 207 */       GeneratedMessage.<Timestamp>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 213 */     return 
/* 214 */       GeneratedMessage.<Timestamp>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/*     */     
/*     */     public static final Descriptors.Descriptor getDescriptor() {
/* 246 */       return TimestampProto.internal_static_google_protobuf_Timestamp_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
/* 252 */       return TimestampProto.internal_static_google_protobuf_Timestamp_fieldAccessorTable
/* 253 */         .ensureFieldAccessorsInitialized((Class)Timestamp.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 279 */       return TimestampProto.internal_static_google_protobuf_Timestamp_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public Timestamp getDefaultInstanceForType() {
/* 284 */       return Timestamp.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public Timestamp build() {
/* 289 */       Timestamp result = buildPartial();
...
/* 298 */       Timestamp result = new Timestamp(this);
...
/* 316 */       if (other instanceof Timestamp) {
/* 317 */         return mergeFrom((Timestamp)other);
/*     */       }
...
/* 325 */       if (other == Timestamp.getDefaultInstance()) return this; 
...
/*     */ 
/*     */   
/* 455 */   private static final Timestamp DEFAULT_INSTANCE = new Timestamp();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 463 */   private static final Parser<Timestamp> PARSER = new AbstractParser<Timestamp>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 469 */         Timestamp.Builder builder = Timestamp.newBuilder();
/*     */         try {
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\google\protobuf\Timestamp.class
