...
/*     */   {
/*     */     @Nullable
/*  41 */     private HmacParameters parameters = null; @Nullable
...
/*  66 */       if (this.parameters.getVariant() == HmacParameters.Variant.NO_PREFIX) {
/*  67 */         return OutputPrefixUtil.EMPTY_PREFIX;
/*     */       }
/*  69 */       if (this.parameters.getVariant() == HmacParameters.Variant.LEGACY || this.parameters
/*  70 */         .getVariant() == HmacParameters.Variant.CRUNCHY) {
/*  71 */         return OutputPrefixUtil.getLegacyOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  73 */       if (this.parameters.getVariant() == HmacParameters.Variant.TINK) {
/*  74 */         return OutputPrefixUtil.getTinkOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  76 */       throw new IllegalStateException("Unknown HmacParameters.Variant: " + this.parameters.getVariant());
/*     */     }
/*     */     
...
/*  98 */       return new HmacKey(this.parameters, this.keyBytes, outputPrefix, this.idRequirement);
/*     */     }
/*     */ 
/*     */     
/*     */     private Builder() {}
...
/* 150 */     if (!(o instanceof HmacKey)) {
/* 151 */       return false;
/*     */     }
/* 153 */     HmacKey that = (HmacKey)o;
/*     */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\google\crypto\tink\mac\HmacKey.class
