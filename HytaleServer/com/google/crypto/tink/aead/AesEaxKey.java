...
/*     */   {
/*     */     @Nullable
/*  41 */     private AesEaxParameters parameters = null; @Nullable
...
/*  66 */       if (this.parameters.getVariant() == AesEaxParameters.Variant.NO_PREFIX) {
/*  67 */         return OutputPrefixUtil.EMPTY_PREFIX;
/*     */       }
/*  69 */       if (this.parameters.getVariant() == AesEaxParameters.Variant.CRUNCHY) {
/*  70 */         return OutputPrefixUtil.getLegacyOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  72 */       if (this.parameters.getVariant() == AesEaxParameters.Variant.TINK) {
/*  73 */         return OutputPrefixUtil.getTinkOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  75 */       throw new IllegalStateException("Unknown AesEaxParameters.Variant: " + this.parameters
/*  76 */           .getVariant());
/*     */     }
/*     */     
...
/*  98 */       return new AesEaxKey(this.parameters, this.keyBytes, outputPrefix, this.idRequirement);
/*     */     }
/*     */ 
/*     */     
/*     */     private Builder() {}
...
/* 150 */     if (!(o instanceof AesEaxKey)) {
/* 151 */       return false;
/*     */     }
/* 153 */     AesEaxKey that = (AesEaxKey)o;
/*     */     
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\google\crypto\tink\aead\AesEaxKey.class
