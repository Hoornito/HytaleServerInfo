...
/*     */ 
/*     */ @Immutable
/*     */ public final class AesGcmSivKey
/*     */   extends AeadKey
/*     */ {
...
/*     */   {
/*     */     @Nullable
/*  41 */     private AesGcmSivParameters parameters = null; @Nullable
...
/*  66 */       if (this.parameters.getVariant() == AesGcmSivParameters.Variant.NO_PREFIX) {
/*  67 */         return OutputPrefixUtil.EMPTY_PREFIX;
/*     */       }
/*  69 */       if (this.parameters.getVariant() == AesGcmSivParameters.Variant.CRUNCHY) {
/*  70 */         return OutputPrefixUtil.getLegacyOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  72 */       if (this.parameters.getVariant() == AesGcmSivParameters.Variant.TINK) {
/*  73 */         return OutputPrefixUtil.getTinkOutputPrefix(this.idRequirement.intValue());
/*     */       }
/*  75 */       throw new IllegalStateException("Unknown AesGcmSivParameters.Variant: " + this.parameters
/*  76 */           .getVariant());
/*     */     }
/*     */     
...
/*  98 */       return new AesGcmSivKey(this.parameters, this.keyBytes, outputPrefix, this.idRequirement);
/*     */     }
/*     */ 
/*     */     
/*     */     private Builder() {}
...
/* Location:              C:\Users\Agustin\AppData\Roaming\Hytale\install\release\package\game\latest\Server\HytaleServer.jar!\com\google\crypto\tink\aead\AesGcmSivKey.class
