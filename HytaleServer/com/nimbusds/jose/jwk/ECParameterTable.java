...
/* 136 */     if (Curve.SECP256K1.equals(curve))
/* 137 */       return SECP256K1_SPEC; 
/* 138 */     if (Curve.P_384.equals(curve))
/* 139 */       return P_384_SPEC; 
/* 140 */     if (Curve.P_521.equals(curve)) {
...
/*     */     }
/*     */     
/* 163 */     if (spec.getCurve().getField().getFieldSize() == P_256_SPEC.getCurve().getField().getFieldSize() && spec
/* 164 */       .getCurve().getA().equals(P_256_SPEC.getCurve().getA()) && spec
/* 165 */       .getCurve().getB().equals(P_256_SPEC.getCurve().getB()) && spec
/* 166 */       .getGenerator().getAffineX().equals(P_256_SPEC.getGenerator().getAffineX()) && spec
/* 167 */       .getGenerator().getAffineY().equals(P_256_SPEC.getGenerator().getAffineY()) && spec
/* 168 */       .getOrder().equals(P_256_SPEC.getOrder()) && spec
/* 169 */       .getCofactor() == P_256_SPEC.getCofactor())
/*     */     {
/* 171 */       return Curve.P_256;
/*     */     }
/* 173 */     if (spec.getCurve().getField().getFieldSize() == SECP256K1_SPEC.getCurve().getField().getFieldSize() && spec
/* 174 */       .getCurve().getA().equals(SECP256K1_SPEC.getCurve().getA()) && spec
/* 175 */       .getCurve().getB().equals(SECP256K1_SPEC.getCurve().getB()) && spec
/* 176 */       .getGenerator().getAffineX().equals(SECP256K1_SPEC.getGenerator().getAffineX()) && spec
/* 177 */       .getGenerator().getAffineY().equals(SECP256K1_SPEC.getGenerator().getAffineY()) && spec
/* 178 */       .getOrder().equals(SECP256K1_SPEC.getOrder()) && spec
/* 179 */       .getCofactor() == SECP256K1_SPEC.getCofactor())
/*     */     {
/* 181 */       return Curve.SECP256K1;
/*     */     }
/* 183 */     if (spec.getCurve().getField().getFieldSize() == P_384_SPEC.getCurve().getField().getFieldSize() && spec
/* 184 */       .getCurve().getA().equals(P_384_SPEC.getCurve().getA()) && spec
/* 185 */       .getCurve().getB().equals(P_384_SPEC.getCurve().getB()) && spec
/* 186 */       .getGenerator().getAffineX().equals(P_384_SPEC.getGenerator().getAffineX()) && spec
/* 187 */       .getGenerator().getAffineY().equals(P_384_SPEC.getGenerator().getAffineY()) && spec
/* 188 */       .getOrder().equals(P_384_SPEC.getOrder()) && spec
/* 189 */       .getCofactor() == P_384_SPEC.getCofactor())
/*     */     {
/* 191 */       return Curve.P_384;
/*     */     }
/* 193 */     if (spec.getCurve().getField().getFieldSize() == P_521_SPEC.getCurve().getField().getFieldSize() && spec
/* 194 */       .getCurve().getA().equals(P_521_SPEC.getCurve().getA()) && spec
/* 195 */       .getCurve().getB().equals(P_521_SPEC.getCurve().getB()) && spec
/* 196 */       .getGenerator().getAffineX().equals(P_521_SPEC.getGenerator().getAffineX()) && spec
/* 197 */       .getGenerator().getAffineY().equals(P_521_SPEC.getGenerator().getAffineY()) && spec
/* 198 */       .getOrder().equals(P_521_SPEC.getOrder()) && spec
/* 199 */       .getCofactor() == P_521_SPEC.getCofactor())
/*     */     {
