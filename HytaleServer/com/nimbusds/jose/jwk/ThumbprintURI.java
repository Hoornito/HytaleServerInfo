...
/*  75 */     if (hashAlg.isEmpty()) {
/*  76 */       throw new IllegalArgumentException("The hash algorithm must not be empty");
/*     */     }
/*  78 */     this.hashAlg = hashAlg;
/*     */     
/*  80 */     if (thumbprint.toString().isEmpty()) {
/*  81 */       throw new IllegalArgumentException("The thumbprint must not be empty");
/*     */     }
