...
/* 214 */     if (this.acceptedAudienceValues != null && !CollectionUtils.containsNull(this.acceptedAudienceValues))
/*     */     {
...
/*     */         } 
/* 299 */         if (!audMatch) {
/* 300 */           throw new BadJWTException("JWT aud claim rejected");
/*     */         }
/* 302 */       } else if (!CollectionUtils.containsNull(this.acceptedAudienceValues)) {
/* 303 */         throw new BadJWTException("JWT missing required aud claim");
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/* 329 */       if (!Objects.equals(expectedClaim, actualClaim)) {
/* 330 */         throw new BadJWTException("JWT " + exactMatch + " claim value rejected");
/*     */       }
/*     */     } 
/*     */ 
/*     */     
...
/* 342 */           throw new ExpiredJWTException("Expired JWT");
/*     */         }
/*     */       }
/*     */       
